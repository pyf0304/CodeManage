...
namespace com.taishsoft.commdb4odbc
{
    ...
    /// clsExcelSQL 的摘要说明。
    /// </summary>
    public class clsExcel2003SQL_OleDb : clsExcelBaseSQL
    {
        ...
        public clsExcel2003SQL_OleDb(string strExcelFileName)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
            mstrConnectString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + strExcelFileName + ";Extended Properties=Excel 8.0;";
       ...
       //mstrConnectString = "Driver={Microsoft Excel Driver (*.xls, *.xlsx, *.xlsm, *.xlsb)};DBQ=" +strExcelFileName;// path to xls/xlsx/xlsm/xlsb file
        ...
        public override List<string> GetExcelTableNameLstByFileName(string strExcelFileName)
        {
            ...
            if (File.Exists(mstrExcelFileName))
            {
                using (OleDbConnection conn = new OleDbConnection("Provider=Microsoft.Jet." +
                  "OLEDB.4.0;Extended Properties=\"Excel 8.0\";Data Source=" + strExcelFileName))
                {
                    conn.Open();
        ...
        /// <returns></returns>
        public static string GetExcelFirstTableNameByFileName(string excelFileName)
        {
            string tableName = null;
        ...
        /// <returns></returns>
        public override DataSet importExcelToDataSet(string FilePath, string sheet)
        {
