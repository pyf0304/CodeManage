...
namespace GetExcelFromDataTable
{
    ...
    public partial class clsGetExcelFromDataTable
    {
        ...
        /// <returns></returns>
        public static bool GetExcelFromDataTableByArr4Odbc(System.Data.DataTable objDT,
            ...
            string SavePathAndName)
        {
            ...
            return GetExcelFromDataTableByArr4Odbc(objDT,
            ...
            string strSheetName)
        {
            ...
            using (OleDbConnection con = new OleDbConnection(connString))
            {
                ...
                catch (Exception objException)
                {
                    ...
                    sbMsg.AppendFormat("(errid:BlEx000030)打开连接出错。(clsGetExcelFromDataTable:GetExcelFromDataTableByArr4Odbc)连接串：{0}，出错信息：{1}。", 
                        connString, 
                ...
                catch (Exception objException)
                {
                    LogErrorS(objException, "clsGetExcelFromDataTable4Odbc");
                    StringBuilder sbMsg = new StringBuilder();
                    sbMsg.AppendFormat("(errid:BlEx000031)导出Excel出错。(clsGetExcelFromDataTable:GetExcelFromDataTableByArr4Odbc)导出SQL语句：{0}，出错信息：{1}。",
                       strSQL.ToString(),
                       objException.Message);
