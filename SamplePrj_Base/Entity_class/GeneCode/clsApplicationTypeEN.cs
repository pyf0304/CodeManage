...
{
public const string _CurrTabName_S = "ApplicationType"; //当前表名,与该类相关的表名
...
public static string[] AttributeName = new string[] {"ApplicationTypeId", "ApplicationTypeName", "ApplicationTypeSimName", "ApplicationTypeENName", "ProgLangTypeId", "ProgLangTypeId2", "ProgLangTypeId3", "ProgLangTypeId4", "ProgLangTypeId5", "IsVisible", "VisitedNum", "OrderNum", "Memo", "ProgLangTypeName"};
//以下是属性变量
...
else if (strAttributeName  ==  conApplicationType.ProgLangTypeName)
{
...
mstrProgLangTypeName = value.ToString();
 AddUpdatedFld(conApplicationType.ProgLangTypeName);
}
}
}
...
else if (conApplicationType.ProgLangTypeName  ==  AttributeName[intIndex])
{
return mstrProgLangTypeName;
}
return null;
