...
namespace SimplePrj.Entity
{
 ...
 /// </summary>
public class K_id_School_XzSchool
{
...
public static string[] AttributeName = new string[] {"id_School", "SchoolId", "SchoolName", "IsCurrentUse", "Memo"};
//以下是属性变量
