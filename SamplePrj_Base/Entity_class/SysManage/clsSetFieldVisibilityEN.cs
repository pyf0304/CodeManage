...
{
public const string CurrTabName_S = "SetFieldVisibility"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 7;
public static string[] AttributeName = new string[] {"mId", "id_School", "ViewName", "FieldName", "CtrlType", "IsVisible", "Memo"};
//以下是属性变量
...
/// </summary>
 ...
 CurrTabName = "SetFieldVisibility";
