...
namespace SimplePrj.Entity
{
	...
	public partial class clsSysParaEN
	{
        ...
        /// 当前应用虚拟目录,带IP地址及根域名
        /// </summary>
        public static string spVirtualPath
        {
            get
            {
                return System.Web.HttpContext.Current.Request.ApplicationPath;
                //if (string.IsNullOrEmpty( mstrspVirtualPath) == true)
                //{
                //    string strMsg = string.Format("当前应用虚拟目录,带IP地址及根域名为空！({0})", 
                //        clsStackTrace.GetCurrClassFunctionByLevel(2));
                //    throw new Exception(strMsg);
                //}
                //return mstrspVirtualPath;
            }
        ...
        public static string spVirtualRoot
        {
            ...
            {
                return System.Web.HttpContext.Current.Request.ApplicationPath;
                //if (string.IsNullOrEmpty(mstrspVirtualRoot) == true)
                //{
                //    string strMsg = string.Format("当前应用虚拟目录,带IP地址及根域名为空！({0})", 
                //        clsStackTrace.GetCurrClassFunctionByLevel(3));
                //    throw new Exception(strMsg);
                //}
                //return mstrspVirtualRoot;
            }
