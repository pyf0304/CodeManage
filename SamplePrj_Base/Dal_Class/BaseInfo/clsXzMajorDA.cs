...
//以下是属性变量
 ...
 get
 {
 return clsXzMajorEN._CurrTabName_S;
 }
 }
...
strSQL = string.Format("Select Top {0} XzMajor.* from XzMajor Left Join {1} on {2} where {3} and XzMajor.id_Major not in (Select top {5} XzMajor.id_Major from XzMajor Left Join {1} on {2} where {3} order by {4} {6}) order by {4} {6} ",
...
else
{
 if (string.IsNullOrEmpty(strOrderBy) == true)
 {
 strSQL = string.Format("Select Top {0} * from XzMajor where {1} and id_Major not in (Select top {2} id_Major from XzMajor where {1}) ", intPageSize, strCondition, intTop_In);
 }
 else
 {
 strSQL = string.Format("Select Top {0} * from XzMajor where {1} and id_Major not in (Select top {3} id_Major from XzMajor where {1} order by {2}) order by {2} ", intPageSize, strCondition, strOrderBy, intTop_In);
 }
 }
objDT = objSQL.GetDataTable(strSQL);
return objDT;
...
objXzMajorEN.OrderNum = TransNullToInt(objRow[conXzMajor.OrderNum].ToString().Trim()); //排序
objXzMajorEN.InUse = TransNullToBool(objRow[conXzMajor.InUse].ToString().Trim()); //是否在用
objXzMajorEN.UpdDate = objRow[conXzMajor.UpdDate].ToString().Trim(); //修改日期
objXzMajorEN.UpdUser = objRow[conXzMajor.UpdUser].ToString().Trim(); //修改用户
}
 catch(Exception objException)
{
...
System.Data.DataTable objDT ; 
 ...
 //获取连接对象
 objSQL = clsXzMajorDA.GetSpecSQLObj();
strSQL = "Select * from XzMajor where id_Major = " + "'"+ objXzMajorEN.id_Major+"'";
objDT = objSQL.GetDataTable(strSQL);
if (objDT.Rows.Count  ==  0)
{
return false;
...
try
{
 objXzMajorEN.id_Major = objDT.Rows[0][conXzMajor.id_Major].ToString().Trim(); //专业流水号(字段类型:char,字段长度:8,是否可空:True)
 ...
 objXzMajorEN.OrderNum = TransNullToInt(objDT.Rows[0][conXzMajor.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 ...
 objXzMajorEN.UpdUser = objDT.Rows[0][conXzMajor.UpdUser].ToString().Trim(); //修改用户(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
return true;
 ...
 /// <returns>表对象</returns>
public clsXzMajorEN GetObjByid_Major(string strid_Major)
{
...
System.Data.DataTable objDT ; 
 ...
 //获取连接对象
 objSQL = clsXzMajorDA.GetSpecSQLObj();
strSQL = "Select * from XzMajor where id_Major = " + "'"+ strid_Major+"'";
objDT = objSQL.GetDataTable(strSQL);
if (objDT.Rows.Count  ==  0)
{
return null;
...
try
{
 objXzMajorEN.id_Major = objRow[conXzMajor.id_Major].ToString().Trim(); //专业流水号(字段类型:char,字段长度:8,是否可空:True)
 ...
 objXzMajorEN.IsMainMajor = clsEntityBase2.TransNullToBool_S(objRow[conXzMajor.IsMainMajor] == DBNull.Value ? null : objRow[conXzMajor.IsMainMajor].ToString().Trim()); //是否重要专业(字段类型:bit,字段长度:1,是否可空:False)
 objXzMajorEN.CollegeId = objRow[conXzMajor.CollegeId].ToString().Trim(); //学院Id(字段类型:varchar,字段长度:6,是否可空:False)
 objXzMajorEN.OrderNum = clsEntityBase2.TransNullToInt_S(objRow[conXzMajor.OrderNum] == DBNull.Value ? null : objRow[conXzMajor.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objXzMajorEN.InUse = clsEntityBase2.TransNullToBool_S(objRow[conXzMajor.InUse] == DBNull.Value ? null : objRow[conXzMajor.InUse].ToString().Trim()); //是否在用(字段类型:bit,字段长度:1,是否可空:True)
 ...
 objXzMajorEN.UpdUser = objRow[conXzMajor.UpdUser] == DBNull.Value ? null : objRow[conXzMajor.UpdUser].ToString().Trim(); //修改用户(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
throw new Exception(string.Format("根据关键字获取相关对象时,发生:{0},请检查!(clsXzMajorDA: GetObjByid_Major)", objException.Message));
}
return objXzMajorEN;
}
...
try
{
	clsXzMajorEN objXzMajorEN = new clsXzMajorEN()
{
id_Major = objRow[conXzMajor.id_Major].ToString().Trim(), //专业流水号
...
OrderNum = TransNullToInt(objRow[conXzMajor.OrderNum].ToString().Trim()), //排序
InUse = TransNullToBool(objRow[conXzMajor.InUse].ToString().Trim()), //是否在用
UpdDate = objRow[conXzMajor.UpdDate].ToString().Trim(), //修改日期
UpdUser = objRow[conXzMajor.UpdUser].ToString().Trim() //修改用户
};
objXzMajorEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objXzMajorEN;
}
...
//获取连接对象
objSQL = clsXzMajorDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsXzMajorEN._CurrTabName_S, conXzMajor.id_Major, 8, "");
return strMaxValue;
}
...
//获取连接对象
objSQL = clsXzMajorDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsXzMajorEN._CurrTabName_S, conXzMajor.id_Major, 8, strPrefix);
return strMaxValue;
}
...
string strSQL ;
 ...
 objSQL = clsXzMajorDA.GetSpecSQLObj();
string strKeyValue; 
strSQL = "Select id_Major from XzMajor where " + strCondition;
try
{
objDT = objSQL.GetDataTable(strSQL);
}
...
CheckPrimaryKey(strid_Major);
 ...
 //获取连接对象
 objSQL = clsXzMajorDA.GetSpecSQLObj();
if (objSQL.IsExistRecord("XzMajor", "id_Major = " + "'"+ strid_Major+"'"))
{
return true;
}
else
...
objRow[conXzMajor.id_Major] = objXzMajorEN.id_Major; //专业流水号
...
objRow[conXzMajor.OrderNum] = objXzMajorEN.OrderNum; //排序
...
objRow[conXzMajor.UpdDate] = objXzMajorEN.UpdDate; //修改日期
 ...
 {
objRow[conXzMajor.UpdUser] = objXzMajorEN.UpdUser; //修改用户
 }
objDS.Tables[clsXzMajorEN._CurrTabName_S].Rows.Add(objRow);
try
{
objDA.Update(objDS, clsXzMajorEN._CurrTabName_S);
}
catch (Exception objException)
{
clsGeneralTab2. LogErrorS(objException, "");
...
StringBuilder strSQL = new StringBuilder();
 ...
 if (objXzMajorEN.id_Major !=  null)
 {
 arrFieldListForInsert.Add(conXzMajor.id_Major);
 objXzMajorEN.id_Major = objXzMajorEN.id_Major.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objXzMajorEN.id_Major + "'");
 }
 
 if (objXzMajorEN.MajorID !=  null)
 {
 arrFieldListForInsert.Add(conXzMajor.MajorID);
 objXzMajorEN.MajorID = objXzMajorEN.MajorID.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objXzMajorEN.MajorID + "'");
 }
 
 if (objXzMajorEN.MajorName !=  null)
 {
 arrFieldListForInsert.Add(conXzMajor.MajorName);
 objXzMajorEN.MajorName = objXzMajorEN.MajorName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objXzMajorEN.MajorName + "'");
 }
 ...
 objXzMajorEN.CollegeId = objXzMajorEN.CollegeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objXzMajorEN.CollegeId + "'");
 }
 ...
 objXzMajorEN.UpdDate = objXzMajorEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objXzMajorEN.UpdDate + "'");
 }
 
 if (objXzMajorEN.UpdUser !=  null)
 {
 arrFieldListForInsert.Add(conXzMajor.UpdUser);
 objXzMajorEN.UpdUser = objXzMajorEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objXzMajorEN.UpdUser + "'");
 }
 //组织插入记录SQL串
...
System.Data.DataRow objRow;
 ...
 //获取连接对象
 objSQL = clsXzMajorDA.GetSpecSQLObj();
strSQL = "Select * from XzMajor where id_Major = '111'";
objDA = new System.Data.SqlClient.SqlDataAdapter(strSQL, objSQL.SQLConnect);
objCB = new System.Data.SqlClient.SqlCommandBuilder(objDA);
objDA.Fill(objDS, "XzMajor");
//检查关键字的唯一性
...
{
string strid_Major = oRow[conXzMajor.id_Major].ToString().Trim();
if (IsExist(strid_Major))
{
 string strResult = "关键字变量值为:" + string.Format("id_Major = {0}", strid_Major) + "的记录已存在,不能重复插入!" ;
...
foreach(System.Data.DataRow oRow in oDT.Rows)
{
objRow = objDS.Tables[clsXzMajorEN._CurrTabName_S ].NewRow();
objRow[conXzMajor.id_Major] = oRow[conXzMajor.id_Major].ToString().Trim(); //专业流水号
...
objRow[conXzMajor.OrderNum] = oRow[conXzMajor.OrderNum].ToString().Trim(); //排序
...
objRow[conXzMajor.UpdUser] = oRow[conXzMajor.UpdUser].ToString().Trim(); //修改用户
 objDS.Tables[clsXzMajorEN._CurrTabName_S].Rows.Add(objRow);
}
try
{
...
objDA = new System.Data.SqlClient.SqlDataAdapter(strSQL, objSQL.SQLConnect);
objCB = new System.Data.SqlClient.SqlCommandBuilder(objDA);
objDA.Fill(objDS, clsXzMajorEN._CurrTabName_S);
if (objDS.Tables[clsXzMajorEN._CurrTabName_S].Rows.Count  ==  0)
{
//MsgBox("没有相应的ID号:id_Major = " + "'"+ objXzMajorEN.id_Major+"'");
return false;
}
objRow = objDS.Tables[clsXzMajorEN._CurrTabName_S].Rows[0];
 if (objXzMajorEN.IsUpdated(conXzMajor.id_Major))
 {
objRow[conXzMajor.id_Major] = objXzMajorEN.id_Major; //专业流水号
 }
...
sbSQL.AppendFormat("Update XzMajor Set ");
 ...
 {
 objXzMajorEN.MajorID = objXzMajorEN.MajorID.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objXzMajorEN.MajorID, conXzMajor.MajorID); //MajorID
 }
 else
 {
 ...
 {
 objXzMajorEN.MajorName = objXzMajorEN.MajorName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objXzMajorEN.MajorName, conXzMajor.MajorName); //专业名称
 }
 else
 {
 ...
 {
 objXzMajorEN.CollegeId = objXzMajorEN.CollegeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objXzMajorEN.CollegeId, conXzMajor.CollegeId); //学院Id
 }
 else
 {
 ...
 if (objXzMajorEN.IsUpdated(conXzMajor.OrderNum))
 {
 sbSQL.AppendFormat("{1} = {0},",objXzMajorEN.OrderNum, conXzMajor.OrderNum); //排序
 }
 ...
 {
 objXzMajorEN.UpdDate = objXzMajorEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objXzMajorEN.UpdDate, conXzMajor.UpdDate); //修改日期
 }
 else
 {
 ...
 {
 objXzMajorEN.UpdUser = objXzMajorEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objXzMajorEN.UpdUser, conXzMajor.UpdUser); //修改用户
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzMajor.UpdUser); //修改用户
 }
 }
 sbSQL.Remove(sbSQL.Length - 1, 1);
 sbSQL.AppendFormat(" Where id_Major = '{0}'", objXzMajorEN.id_Major); 
...
sbSQL.AppendFormat("Update XzMajor Set ");
 ...
 {
 objXzMajorEN.MajorID = objXzMajorEN.MajorID.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" MajorID = '{0}',", objXzMajorEN.MajorID); //MajorID
 }
 else
 {
 ...
 {
 objXzMajorEN.MajorName = objXzMajorEN.MajorName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" MajorName = '{0}',", objXzMajorEN.MajorName); //专业名称
 }
 else
 {
 ...
 {
 objXzMajorEN.CollegeId = objXzMajorEN.CollegeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" CollegeId = '{0}',", objXzMajorEN.CollegeId); //学院Id
 }
 else
 {
 ...
 if (objXzMajorEN.IsUpdated(conXzMajor.OrderNum))
 {
 sbSQL.AppendFormat(" OrderNum = {0},", objXzMajorEN.OrderNum); //排序
 }
 ...
 {
 objXzMajorEN.UpdDate = objXzMajorEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" UpdDate = '{0}',", objXzMajorEN.UpdDate); //修改日期
 }
 else
 {
 ...
 {
 objXzMajorEN.UpdUser = objXzMajorEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" UpdUser = '{0}',", objXzMajorEN.UpdUser); //修改用户
 }
 else
 {
...
public bool DelRecordBySP(string strid_Major) 
{
CheckPrimaryKey(strid_Major);
//通过存储过程来
//直接使用
...
public bool DelRecord(string strid_Major, SqlConnection objSqlConnection, SqlTransaction objSqlTransaction) 
{
CheckPrimaryKey(strid_Major);
string strSQL = "";
 clsSpecSQLforSql objSQL;
...
strSQL = strSQL + "Delete from XzMajor where id_Major = " + "'"+ strid_Major+"'";
...
strSQL = "";
//删除XzMajor本表中与当前对象有关的记录
strSQL = strSQL + "Delete from XzMajor where id_Major in (" + strKeyList + ")";
...
public int DelRecord(string strid_Major) 
{
CheckPrimaryKey(strid_Major);
//删除单条记录
string strSQL = "";
...
//检查字段长度
clsCheckSql.CheckFieldLen(objXzMajorEN.id_Major, 8, conXzMajor.id_Major);
...
clsCheckSql.CheckFieldLen(objXzMajorEN.UpdUser, 20, conXzMajor.UpdUser);
//检查Sql注入
clsCheckSql.CheckSqlInjection4Field(objXzMajorEN.id_Major, conXzMajor.id_Major);
...
{
//获取某学院所有专业信息
string strSQL = "select id_Major, MajorName from XzMajor ";
...
return objDT;
 ...
 /// (AutoGCLib.clsGeneCodeBase:GenCheckUniquenessV2)
 /// </summary>
 /// <param name = "strid_Major">专业流水号(主键)</param>
 /// <param name = "strMajorName">专业名称(要求唯一的字段)</param>
 /// <returns></returns>
public bool CheckMajorNameUniqueness(string strid_Major, string strMajorName)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("id_Major !=  '{0}' and MajorName = '{1}'", strid_Major, strMajorName);
...
return true;
 ...
 /// <param name = "strMajorName">专业名称(要求唯一的字段)</param>
 /// <returns></returns>
public bool CheckMajorNameUniqueness(string strMajorName)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("MajorName = '{0}'", strMajorName);
if (IsExistCondRec(sbCondition.ToString())  ==  true)
{
return false;
}
...
return true;
 ...
 /// <returns></returns>
public bool CheckCollegeIdUniqueness(string strid_Major, string strCollegeId)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("id_Major !=  '{0}' and CollegeId = '{1}'", strid_Major, strCollegeId);
if (IsExistCondRec(sbCondition.ToString())  ==  true)
{
return false;
}
...
return true;
 ...
 /// <param name = "strCollegeId">学院Id(要求唯一的字段)</param>
 /// <returns></returns>
public bool CheckCollegeIdUniqueness(string strCollegeId)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("CollegeId = '{0}'", strCollegeId);
if (IsExistCondRec(sbCondition.ToString())  ==  true)
{
return false;
}
...
return true;
 ...
 /// <param name = "strCollegeId">学院Id(要求唯一的字段)</param>
 /// <returns></returns>
public bool CheckXzMajorUniqueness(string strid_Major , string strMajorName, string strCollegeId)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("id_Major !=  '{0}'", strid_Major);
 sbCondition.AppendFormat(" and MajorName = '{0}'", strMajorName);
 sbCondition.AppendFormat(" and CollegeId = '{0}'", strCollegeId);
if (IsExistCondRec(sbCondition.ToString())  ==  true)
{
return false;
}
...
return true;
 ...
 /// <param name = "strCollegeId">学院Id(要求唯一的字段)</param>
 /// <returns></returns>
public bool CheckXzMajorUniqueness(string strMajorName, string strCollegeId)
{
StringBuilder sbCondition = new StringBuilder();
...
public string GetUniCondStr_MajorName_CollegeId(clsXzMajorEN objXzMajorEN)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("1 = 1");
 if (objXzMajorEN.MajorName == null)
...
{
 sbCondition.AppendFormat(" and InUse is null");
}
else
{
 ...
 public static int GetRecCount()
{
 ...
 //获取连接对象
 objSQL = clsXzMajorDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsXzMajorEN._CurrTabName_S);
return intRecCount;
}
 ...
 public static int GetRecCountByCond(string strCondition)
{
 ...
 //获取连接对象
 objSQL = clsXzMajorDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsXzMajorEN._CurrTabName_S, strCondition);
return intRecCount;
}
