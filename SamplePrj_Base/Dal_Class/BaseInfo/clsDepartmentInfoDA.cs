...
//以下是属性变量
 ...
 get
 {
 return clsDepartmentInfoEN._CurrTabName_S;
 }
 }
...
objDepartmentInfoEN.UpDepartmentId = objRow[conDepartmentInfo.UpDepartmentId].ToString().Trim(); //所属部门号
objDepartmentInfoEN.DepartmentAbbrName = objRow[conDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //名称缩写
objDepartmentInfoEN.DepartmentTypeId = objRow[conDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId
objDepartmentInfoEN.OrderNum = TransNullToInt(objRow[conDepartmentInfo.OrderNum].ToString().Trim()); //排序
objDepartmentInfoEN.Memo = objRow[conDepartmentInfo.Memo].ToString().Trim(); //备注
}
 catch(Exception objException)
{
...
try
{
 ...
 objDepartmentInfoEN.DepartmentName = objDT.Rows[0][conDepartmentInfo.DepartmentName].ToString().Trim(); //部门名称(字段类型:varchar,字段长度:20,是否可空:True)
 objDepartmentInfoEN.UpDepartmentId = objDT.Rows[0][conDepartmentInfo.UpDepartmentId].ToString().Trim(); //所属部门号(字段类型:varchar,字段长度:6,是否可空:True)
 objDepartmentInfoEN.DepartmentAbbrName = objDT.Rows[0][conDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //名称缩写(字段类型:varchar,字段长度:6,是否可空:True)
 objDepartmentInfoEN.DepartmentTypeId = objDT.Rows[0][conDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId(字段类型:char,字段长度:2,是否可空:True)
 objDepartmentInfoEN.OrderNum = TransNullToInt(objDT.Rows[0][conDepartmentInfo.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objDepartmentInfoEN.Memo = objDT.Rows[0][conDepartmentInfo.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 ...
 objDepartmentInfoEN.DepartmentName = objRow[conDepartmentInfo.DepartmentName].ToString().Trim(); //部门名称(字段类型:varchar,字段长度:20,是否可空:True)
 objDepartmentInfoEN.UpDepartmentId = objRow[conDepartmentInfo.UpDepartmentId] == DBNull.Value ? null : objRow[conDepartmentInfo.UpDepartmentId].ToString().Trim(); //所属部门号(字段类型:varchar,字段长度:6,是否可空:True)
 objDepartmentInfoEN.DepartmentAbbrName = objRow[conDepartmentInfo.DepartmentAbbrName] == DBNull.Value ? null : objRow[conDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //名称缩写(字段类型:varchar,字段长度:6,是否可空:True)
 objDepartmentInfoEN.DepartmentTypeId = objRow[conDepartmentInfo.DepartmentTypeId] == DBNull.Value ? null : objRow[conDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId(字段类型:char,字段长度:2,是否可空:True)
 objDepartmentInfoEN.OrderNum = clsEntityBase2.TransNullToInt_S(objRow[conDepartmentInfo.OrderNum] == DBNull.Value ? null : objRow[conDepartmentInfo.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objDepartmentInfoEN.Memo = objRow[conDepartmentInfo.Memo] == DBNull.Value ? null : objRow[conDepartmentInfo.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
UpDepartmentId = objRow[conDepartmentInfo.UpDepartmentId].ToString().Trim(), //所属部门号
DepartmentAbbrName = objRow[conDepartmentInfo.DepartmentAbbrName].ToString().Trim(), //名称缩写
DepartmentTypeId = objRow[conDepartmentInfo.DepartmentTypeId].ToString().Trim(), //DepartmentTypeId
OrderNum = TransNullToInt(objRow[conDepartmentInfo.OrderNum].ToString().Trim()), //排序
Memo = objRow[conDepartmentInfo.Memo].ToString().Trim() //备注
};
objDepartmentInfoEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objDepartmentInfoEN;
}
...
//获取连接对象
objSQL = clsDepartmentInfoDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsDepartmentInfoEN._CurrTabName_S, conDepartmentInfo.DepartmentId, 6, "");
return strMaxValue;
}
...
//获取连接对象
objSQL = clsDepartmentInfoDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsDepartmentInfoEN._CurrTabName_S, conDepartmentInfo.DepartmentId, 6, strPrefix);
return strMaxValue;
}
...
objRow[conDepartmentInfo.DepartmentName] = objDepartmentInfoEN.DepartmentName; //部门名称
 ...
 {
objRow[conDepartmentInfo.UpDepartmentId] = objDepartmentInfoEN.UpDepartmentId; //所属部门号
 }
 if (objDepartmentInfoEN.DepartmentAbbrName !=  "")
 {
objRow[conDepartmentInfo.DepartmentAbbrName] = objDepartmentInfoEN.DepartmentAbbrName; //名称缩写
 }
 if (objDepartmentInfoEN.DepartmentTypeId !=  "")
 {
objRow[conDepartmentInfo.DepartmentTypeId] = objDepartmentInfoEN.DepartmentTypeId; //DepartmentTypeId
 }
objRow[conDepartmentInfo.OrderNum] = objDepartmentInfoEN.OrderNum; //排序
 if (objDepartmentInfoEN.Memo !=  "")
 {
objRow[conDepartmentInfo.Memo] = objDepartmentInfoEN.Memo; //备注
 }
objDS.Tables[clsDepartmentInfoEN._CurrTabName_S].Rows.Add(objRow);
try
{
objDA.Update(objDS, clsDepartmentInfoEN._CurrTabName_S);
}
catch (Exception objException)
{
clsGeneralTab2. LogErrorS(objException, "");
...
StringBuilder strSQL = new StringBuilder();
 ...
 objDepartmentInfoEN.DepartmentId = objDepartmentInfoEN.DepartmentId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDepartmentInfoEN.DepartmentId + "'");
 }
 
 if (objDepartmentInfoEN.DepartmentName !=  null)
 {
 arrFieldListForInsert.Add(conDepartmentInfo.DepartmentName);
 objDepartmentInfoEN.DepartmentName = objDepartmentInfoEN.DepartmentName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDepartmentInfoEN.DepartmentName + "'");
 }
 
 if (objDepartmentInfoEN.UpDepartmentId  ==  "")
 {
 objDepartmentInfoEN.UpDepartmentId = null;
 }
 if (objDepartmentInfoEN.UpDepartmentId !=  null)
 {
 arrFieldListForInsert.Add(conDepartmentInfo.UpDepartmentId);
 objDepartmentInfoEN.UpDepartmentId = objDepartmentInfoEN.UpDepartmentId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDepartmentInfoEN.UpDepartmentId + "'");
 }
 
 if (objDepartmentInfoEN.DepartmentAbbrName !=  null)
 {
 arrFieldListForInsert.Add(conDepartmentInfo.DepartmentAbbrName);
 objDepartmentInfoEN.DepartmentAbbrName = objDepartmentInfoEN.DepartmentAbbrName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDepartmentInfoEN.DepartmentAbbrName + "'");
 }
 
 if (objDepartmentInfoEN.DepartmentTypeId !=  null)
 {
 arrFieldListForInsert.Add(conDepartmentInfo.DepartmentTypeId);
 objDepartmentInfoEN.DepartmentTypeId = objDepartmentInfoEN.DepartmentTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDepartmentInfoEN.DepartmentTypeId + "'");
 }
 ...
 objDepartmentInfoEN.Memo = objDepartmentInfoEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDepartmentInfoEN.Memo + "'");
 }
 //组织插入记录SQL串
...
foreach(System.Data.DataRow oRow in oDT.Rows)
{
objRow = objDS.Tables[clsDepartmentInfoEN._CurrTabName_S ].NewRow();
...
objRow[conDepartmentInfo.UpDepartmentId] = oRow[conDepartmentInfo.UpDepartmentId].ToString().Trim(); //所属部门号
objRow[conDepartmentInfo.DepartmentAbbrName] = oRow[conDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //名称缩写
objRow[conDepartmentInfo.DepartmentTypeId] = oRow[conDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId
objRow[conDepartmentInfo.OrderNum] = oRow[conDepartmentInfo.OrderNum].ToString().Trim(); //排序
objRow[conDepartmentInfo.Memo] = oRow[conDepartmentInfo.Memo].ToString().Trim(); //备注
 objDS.Tables[clsDepartmentInfoEN._CurrTabName_S].Rows.Add(objRow);
}
try
{
...
objDA = new System.Data.SqlClient.SqlDataAdapter(strSQL, objSQL.SQLConnect);
objCB = new System.Data.SqlClient.SqlCommandBuilder(objDA);
objDA.Fill(objDS, clsDepartmentInfoEN._CurrTabName_S);
if (objDS.Tables[clsDepartmentInfoEN._CurrTabName_S].Rows.Count  ==  0)
{
//MsgBox("没有相应的ID号:DepartmentId = " + "'"+ objDepartmentInfoEN.DepartmentId+"'");
return false;
}
objRow = objDS.Tables[clsDepartmentInfoEN._CurrTabName_S].Rows[0];
...
sbSQL.AppendFormat("Update DepartmentInfo Set ");
 ...
 {
 objDepartmentInfoEN.DepartmentName = objDepartmentInfoEN.DepartmentName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDepartmentInfoEN.DepartmentName, conDepartmentInfo.DepartmentName); //部门名称
 }
 else
 {
 ...
 {
 objDepartmentInfoEN.UpDepartmentId = objDepartmentInfoEN.UpDepartmentId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDepartmentInfoEN.UpDepartmentId, conDepartmentInfo.UpDepartmentId); //所属部门号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDepartmentInfo.UpDepartmentId); //所属部门号
 }
 }
 ...
 {
 objDepartmentInfoEN.DepartmentAbbrName = objDepartmentInfoEN.DepartmentAbbrName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDepartmentInfoEN.DepartmentAbbrName, conDepartmentInfo.DepartmentAbbrName); //名称缩写
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDepartmentInfo.DepartmentAbbrName); //名称缩写
 }
 }
 ...
 {
 objDepartmentInfoEN.DepartmentTypeId = objDepartmentInfoEN.DepartmentTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDepartmentInfoEN.DepartmentTypeId, conDepartmentInfo.DepartmentTypeId); //DepartmentTypeId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDepartmentInfo.DepartmentTypeId); //DepartmentTypeId
 }
 }
 
 if (objDepartmentInfoEN.IsUpdated(conDepartmentInfo.OrderNum))
 {
 sbSQL.AppendFormat("{1} = {0},",objDepartmentInfoEN.OrderNum, conDepartmentInfo.OrderNum); //排序
 }
 ...
 {
 objDepartmentInfoEN.Memo = objDepartmentInfoEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDepartmentInfoEN.Memo, conDepartmentInfo.Memo); //备注
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDepartmentInfo.Memo); //备注
 }
 }
...
sbSQL.AppendFormat("Update DepartmentInfo Set ");
 ...
 {
 objDepartmentInfoEN.DepartmentName = objDepartmentInfoEN.DepartmentName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DepartmentName = '{0}',", objDepartmentInfoEN.DepartmentName); //部门名称
 }
 else
 {
 ...
 {
 objDepartmentInfoEN.UpDepartmentId = objDepartmentInfoEN.UpDepartmentId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" UpDepartmentId = '{0}',", objDepartmentInfoEN.UpDepartmentId); //所属部门号
 }
 else
 {
 ...
 {
 objDepartmentInfoEN.DepartmentAbbrName = objDepartmentInfoEN.DepartmentAbbrName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DepartmentAbbrName = '{0}',", objDepartmentInfoEN.DepartmentAbbrName); //名称缩写
 }
 else
 {
 ...
 {
 objDepartmentInfoEN.DepartmentTypeId = objDepartmentInfoEN.DepartmentTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DepartmentTypeId = '{0}',", objDepartmentInfoEN.DepartmentTypeId); //DepartmentTypeId
 }
 else
 {
 sbSQL.Append(" DepartmentTypeId = null,"); //DepartmentTypeId
 }
 }
 
 if (objDepartmentInfoEN.IsUpdated(conDepartmentInfo.OrderNum))
 {
 sbSQL.AppendFormat(" OrderNum = {0},", objDepartmentInfoEN.OrderNum); //排序
 }
 ...
 {
 objDepartmentInfoEN.Memo = objDepartmentInfoEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" Memo = '{0}',", objDepartmentInfoEN.Memo); //备注
 }
 else
 {
...
clsCheckSql.CheckFieldLen(objDepartmentInfoEN.DepartmentName, 20, conDepartmentInfo.DepartmentName);
clsCheckSql.CheckFieldLen(objDepartmentInfoEN.UpDepartmentId, 6, conDepartmentInfo.UpDepartmentId);
clsCheckSql.CheckFieldLen(objDepartmentInfoEN.DepartmentAbbrName, 6, conDepartmentInfo.DepartmentAbbrName);
...
return objDT;
 ...
 /// </summary>
 /// <param name = "strDepartmentId">部门ID(主键)</param>
 /// <returns></returns>
public bool CheckDepartmentInfoUniqueness(string strDepartmentId )
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("DepartmentId !=  '{0}'", strDepartmentId);
...
return true;
 ...
 /// </summary>
 /// <returns></returns>
public bool CheckDepartmentInfoUniqueness()
{
StringBuilder sbCondition = new StringBuilder();
...
return true;
 ...
 /// <summary>
 /// 获取唯一性条件串(Uniqueness)--DepartmentInfo(部门),根据唯一约束条件来生成
 /// (AutoGCLib.clsGeneCodeBase:GenGetUniquenessConditionString)
 /// </summary>
 /// <param name = "objDepartmentInfoEN">表对象</param>
 /// <returns>返回唯一性条件串</returns>
public string GetUniCondStr_AAA(clsDepartmentInfoEN objDepartmentInfoEN)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("1 = 1");
 ...
 public static int GetRecCount()
{
 ...
 //获取连接对象
 objSQL = clsDepartmentInfoDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsDepartmentInfoEN._CurrTabName_S);
return intRecCount;
}
 ...
 public static int GetRecCountByCond(string strCondition)
{
 ...
 //获取连接对象
 objSQL = clsDepartmentInfoDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsDepartmentInfoEN._CurrTabName_S, strCondition);
return intRecCount;
}
