...
//以下是属性变量
 ...
 get
 {
 return clsCollegeEN._CurrTabName_S;
 }
 }
...
objCollegeEN.OrderNum = TransNullToInt(objRow[conCollege.OrderNum].ToString().Trim()); //排序
objCollegeEN.InUse = TransNullToBool(objRow[conCollege.InUse].ToString().Trim()); //是否在用
objCollegeEN.Memo = objRow[conCollege.Memo].ToString().Trim(); //备注
}
 catch(Exception objException)
{
...
try
{
 ...
 objCollegeEN.OrderNum = TransNullToInt(objDT.Rows[0][conCollege.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objCollegeEN.InUse = TransNullToBool(objDT.Rows[0][conCollege.InUse].ToString().Trim()); //是否在用(字段类型:bit,字段长度:1,是否可空:True)
 objCollegeEN.Memo = objDT.Rows[0][conCollege.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 ...
 objCollegeEN.OrderNum = clsEntityBase2.TransNullToInt_S(objRow[conCollege.OrderNum] == DBNull.Value ? null : objRow[conCollege.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objCollegeEN.InUse = clsEntityBase2.TransNullToBool_S(objRow[conCollege.InUse] == DBNull.Value ? null : objRow[conCollege.InUse].ToString().Trim()); //是否在用(字段类型:bit,字段长度:1,是否可空:True)
 objCollegeEN.Memo = objRow[conCollege.Memo] == DBNull.Value ? null : objRow[conCollege.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
OrderNum = TransNullToInt(objRow[conCollege.OrderNum].ToString().Trim()), //排序
InUse = TransNullToBool(objRow[conCollege.InUse].ToString().Trim()), //是否在用
Memo = objRow[conCollege.Memo].ToString().Trim() //备注
};
objCollegeEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objCollegeEN;
}
...
//获取连接对象
objSQL = clsCollegeDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsCollegeEN._CurrTabName_S, conCollege.CollegeId, 6, "");
return strMaxValue;
}
...
//获取连接对象
objSQL = clsCollegeDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsCollegeEN._CurrTabName_S, conCollege.CollegeId, 6, strPrefix);
return strMaxValue;
}
...
objRow[conCollege.OrderNum] = objCollegeEN.OrderNum; //排序
objRow[conCollege.InUse] = objCollegeEN.InUse; //是否在用
 if (objCollegeEN.Memo !=  "")
 {
objRow[conCollege.Memo] = objCollegeEN.Memo; //备注
 }
objDS.Tables[clsCollegeEN._CurrTabName_S].Rows.Add(objRow);
try
{
objDA.Update(objDS, clsCollegeEN._CurrTabName_S);
}
catch (Exception objException)
{
clsGeneralTab2. LogErrorS(objException, "");
...
StringBuilder strSQL = new StringBuilder();
 ...
 objCollegeEN.CollegeId = objCollegeEN.CollegeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objCollegeEN.CollegeId + "'");
 }
 
 if (objCollegeEN.CollegeName !=  null)
 {
 arrFieldListForInsert.Add(conCollege.CollegeName);
 objCollegeEN.CollegeName = objCollegeEN.CollegeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objCollegeEN.CollegeName + "'");
 }
 ...
 objCollegeEN.Memo = objCollegeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objCollegeEN.Memo + "'");
 }
 //组织插入记录SQL串
...
foreach(System.Data.DataRow oRow in oDT.Rows)
{
objRow = objDS.Tables[clsCollegeEN._CurrTabName_S ].NewRow();
...
objRow[conCollege.OrderNum] = oRow[conCollege.OrderNum].ToString().Trim(); //排序
objRow[conCollege.InUse] = oRow[conCollege.InUse].ToString().Trim(); //是否在用
objRow[conCollege.Memo] = oRow[conCollege.Memo].ToString().Trim(); //备注
 objDS.Tables[clsCollegeEN._CurrTabName_S].Rows.Add(objRow);
}
try
{
...
objDA = new System.Data.SqlClient.SqlDataAdapter(strSQL, objSQL.SQLConnect);
objCB = new System.Data.SqlClient.SqlCommandBuilder(objDA);
objDA.Fill(objDS, clsCollegeEN._CurrTabName_S);
if (objDS.Tables[clsCollegeEN._CurrTabName_S].Rows.Count  ==  0)
{
//MsgBox("没有相应的ID号:CollegeId = " + "'"+ objCollegeEN.CollegeId+"'");
return false;
}
objRow = objDS.Tables[clsCollegeEN._CurrTabName_S].Rows[0];
...
sbSQL.AppendFormat("Update College Set ");
 ...
 {
 objCollegeEN.CollegeName = objCollegeEN.CollegeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objCollegeEN.CollegeName, conCollege.CollegeName); //学院名称
 }
 else
 {
 ...
 if (objCollegeEN.IsUpdated(conCollege.OrderNum))
 {
 sbSQL.AppendFormat("{1} = {0},",objCollegeEN.OrderNum, conCollege.OrderNum); //排序
 }
 ...
 {
 objCollegeEN.Memo = objCollegeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objCollegeEN.Memo, conCollege.Memo); //备注
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conCollege.Memo); //备注
 }
 }
...
sbSQL.AppendFormat("Update College Set ");
 ...
 {
 objCollegeEN.CollegeName = objCollegeEN.CollegeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" CollegeName = '{0}',", objCollegeEN.CollegeName); //学院名称
 }
 else
 {
 ...
 if (objCollegeEN.IsUpdated(conCollege.OrderNum))
 {
 sbSQL.AppendFormat(" OrderNum = {0},", objCollegeEN.OrderNum); //排序
 }
 ...
 {
 objCollegeEN.Memo = objCollegeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" Memo = '{0}',", objCollegeEN.Memo); //备注
 }
 else
 {
...
return objDT;
 ...
 /// </summary>
 /// <param name = "strCollegeId">学院Id(主键)</param>
 /// <returns></returns>
public bool CheckCollegeUniqueness(string strCollegeId )
{
...
return true;
 ...
 /// </summary>
 /// <returns></returns>
public bool CheckCollegeUniqueness()
{
StringBuilder sbCondition = new StringBuilder();
 ...
 public static int GetRecCount()
{
 ...
 //获取连接对象
 objSQL = clsCollegeDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsCollegeEN._CurrTabName_S);
return intRecCount;
}
 ...
 public static int GetRecCountByCond(string strCondition)
{
 ...
 //获取连接对象
 objSQL = clsCollegeDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsCollegeEN._CurrTabName_S, strCondition);
return intRecCount;
}
