...
//以下是属性变量
 ...
 get
 {
 return clsApplicationTypeEN._CurrTabName_S;
 }
 }
...
objApplicationTypeEN.ApplicationTypeSimName = objRow[conApplicationType.ApplicationTypeSimName].ToString().Trim(); //应用程序类型简称
objApplicationTypeEN.ApplicationTypeENName = objRow[conApplicationType.ApplicationTypeENName].ToString().Trim(); //应用类型英文名
objApplicationTypeEN.ProgLangTypeId = objRow[conApplicationType.ProgLangTypeId].ToString().Trim(); //编程语言类型Id
objApplicationTypeEN.ProgLangTypeId2 = objRow[conApplicationType.ProgLangTypeId2].ToString().Trim(); //编程语言类型Id2
objApplicationTypeEN.ProgLangTypeId3 = objRow[conApplicationType.ProgLangTypeId3].ToString().Trim(); //编程语言类型Id3
objApplicationTypeEN.ProgLangTypeId4 = objRow[conApplicationType.ProgLangTypeId4].ToString().Trim(); //编程语言类型Id4
objApplicationTypeEN.ProgLangTypeId5 = objRow[conApplicationType.ProgLangTypeId5].ToString().Trim(); //编程语言类型Id5
objApplicationTypeEN.IsVisible = TransNullToBool(objRow[conApplicationType.IsVisible].ToString().Trim()); //是否显示
objApplicationTypeEN.VisitedNum = TransNullToInt(objRow[conApplicationType.VisitedNum].ToString().Trim()); //访问数
objApplicationTypeEN.OrderNum = TransNullToInt(objRow[conApplicationType.OrderNum].ToString().Trim()); //排序
objApplicationTypeEN.Memo = objRow[conApplicationType.Memo].ToString().Trim(); //备注
objApplicationTypeEN.ProgLangTypeName = objRow[conApplicationType.ProgLangTypeName].ToString().Trim(); //编程语言类型名
}
 catch(Exception objException)
{
...
try
{
 ...
 objApplicationTypeEN.OrderNum = TransNullToInt(objDT.Rows[0][conApplicationType.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objApplicationTypeEN.Memo = objDT.Rows[0][conApplicationType.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 objApplicationTypeEN.ProgLangTypeName = objDT.Rows[0][conApplicationType.ProgLangTypeName].ToString().Trim(); //编程语言类型名(字段类型:varchar,字段长度:30,是否可空:False)
}
 catch(Exception objException)
{
...
try
{
 ...
 objApplicationTypeEN.IsVisible = clsEntityBase2.TransNullToBool_S(objRow[conApplicationType.IsVisible] == DBNull.Value ? null : objRow[conApplicationType.IsVisible].ToString().Trim()); //是否显示(字段类型:bit,字段长度:1,是否可空:True)
 objApplicationTypeEN.VisitedNum = clsEntityBase2.TransNullToInt_S(objRow[conApplicationType.VisitedNum] == DBNull.Value ? null : objRow[conApplicationType.VisitedNum].ToString().Trim()); //访问数(字段类型:int,字段长度:4,是否可空:True)
 objApplicationTypeEN.OrderNum = Int32.Parse(objRow[conApplicationType.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objApplicationTypeEN.Memo = objRow[conApplicationType.Memo] == DBNull.Value ? null : objRow[conApplicationType.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 objApplicationTypeEN.ProgLangTypeName = objRow[conApplicationType.ProgLangTypeName] == DBNull.Value ? null : objRow[conApplicationType.ProgLangTypeName].ToString().Trim(); //编程语言类型名(字段类型:varchar,字段长度:30,是否可空:False)
}
 catch(Exception objException)
{
...
ApplicationTypeSimName = objRow[conApplicationType.ApplicationTypeSimName].ToString().Trim(), //应用程序类型简称
ApplicationTypeENName = objRow[conApplicationType.ApplicationTypeENName].ToString().Trim(), //应用类型英文名
ProgLangTypeId = objRow[conApplicationType.ProgLangTypeId].ToString().Trim(), //编程语言类型Id
ProgLangTypeId2 = objRow[conApplicationType.ProgLangTypeId2].ToString().Trim(), //编程语言类型Id2
ProgLangTypeId3 = objRow[conApplicationType.ProgLangTypeId3].ToString().Trim(), //编程语言类型Id3
ProgLangTypeId4 = objRow[conApplicationType.ProgLangTypeId4].ToString().Trim(), //编程语言类型Id4
ProgLangTypeId5 = objRow[conApplicationType.ProgLangTypeId5].ToString().Trim(), //编程语言类型Id5
IsVisible = TransNullToBool(objRow[conApplicationType.IsVisible].ToString().Trim()), //是否显示
VisitedNum = TransNullToInt(objRow[conApplicationType.VisitedNum].ToString().Trim()), //访问数
OrderNum = TransNullToInt(objRow[conApplicationType.OrderNum].ToString().Trim()), //排序
Memo = objRow[conApplicationType.Memo].ToString().Trim(), //备注
ProgLangTypeName = objRow[conApplicationType.ProgLangTypeName].ToString().Trim() //编程语言类型名
};
objApplicationTypeEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objApplicationTypeEN;
}
...
//获取连接对象
objSQL = clsApplicationTypeDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsApplicationTypeEN._CurrTabName_S, conApplicationType.ApplicationTypeId, 4, "");
return strMaxValue;
}
...
//获取连接对象
objSQL = clsApplicationTypeDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsApplicationTypeEN._CurrTabName_S, conApplicationType.ApplicationTypeId, 4, strPrefix);
return strMaxValue;
}
...
objRow[conApplicationType.OrderNum] = objApplicationTypeEN.OrderNum; //排序
 if (objApplicationTypeEN.Memo !=  "")
 {
objRow[conApplicationType.Memo] = objApplicationTypeEN.Memo; //备注
 }
 if (objApplicationTypeEN.ProgLangTypeName !=  "")
 {
objRow[conApplicationType.ProgLangTypeName] = objApplicationTypeEN.ProgLangTypeName; //编程语言类型名
 }
objDS.Tables[clsApplicationTypeEN._CurrTabName_S].Rows.Add(objRow);
try
{
objDA.Update(objDS, clsApplicationTypeEN._CurrTabName_S);
}
catch (Exception objException)
{
clsGeneralTab2. LogErrorS(objException, "");
...
StringBuilder strSQL = new StringBuilder();
 ...
 objApplicationTypeEN.ApplicationTypeName = objApplicationTypeEN.ApplicationTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ApplicationTypeName + "'");
 }
 
 if (objApplicationTypeEN.ApplicationTypeSimName !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ApplicationTypeSimName);
 objApplicationTypeEN.ApplicationTypeSimName = objApplicationTypeEN.ApplicationTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ApplicationTypeSimName + "'");
 }
 
 if (objApplicationTypeEN.ApplicationTypeENName !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ApplicationTypeENName);
 objApplicationTypeEN.ApplicationTypeENName = objApplicationTypeEN.ApplicationTypeENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ApplicationTypeENName + "'");
 }
 
 if (objApplicationTypeEN.ProgLangTypeId !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ProgLangTypeId);
 objApplicationTypeEN.ProgLangTypeId = objApplicationTypeEN.ProgLangTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ProgLangTypeId + "'");
 }
 
 if (objApplicationTypeEN.ProgLangTypeId2 !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ProgLangTypeId2);
 objApplicationTypeEN.ProgLangTypeId2 = objApplicationTypeEN.ProgLangTypeId2.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ProgLangTypeId2 + "'");
 }
 
 if (objApplicationTypeEN.ProgLangTypeId3 !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ProgLangTypeId3);
 objApplicationTypeEN.ProgLangTypeId3 = objApplicationTypeEN.ProgLangTypeId3.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ProgLangTypeId3 + "'");
 }
 
 if (objApplicationTypeEN.ProgLangTypeId4 !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ProgLangTypeId4);
 objApplicationTypeEN.ProgLangTypeId4 = objApplicationTypeEN.ProgLangTypeId4.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ProgLangTypeId4 + "'");
 }
 
 if (objApplicationTypeEN.ProgLangTypeId5 !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ProgLangTypeId5);
 objApplicationTypeEN.ProgLangTypeId5 = objApplicationTypeEN.ProgLangTypeId5.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ProgLangTypeId5 + "'");
 }
 ...
 objApplicationTypeEN.Memo = objApplicationTypeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.Memo + "'");
 }
 
 if (objApplicationTypeEN.ProgLangTypeName !=  null)
 {
 arrFieldListForInsert.Add(conApplicationType.ProgLangTypeName);
 objApplicationTypeEN.ProgLangTypeName = objApplicationTypeEN.ProgLangTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objApplicationTypeEN.ProgLangTypeName + "'");
 }
 //组织插入记录SQL串
...
foreach(System.Data.DataRow oRow in oDT.Rows)
{
objRow = objDS.Tables[clsApplicationTypeEN._CurrTabName_S ].NewRow();
...
objRow[conApplicationType.OrderNum] = oRow[conApplicationType.OrderNum].ToString().Trim(); //排序
objRow[conApplicationType.Memo] = oRow[conApplicationType.Memo].ToString().Trim(); //备注
objRow[conApplicationType.ProgLangTypeName] = oRow[conApplicationType.ProgLangTypeName].ToString().Trim(); //编程语言类型名
 objDS.Tables[clsApplicationTypeEN._CurrTabName_S].Rows.Add(objRow);
}
try
{
...
objDA = new System.Data.SqlClient.SqlDataAdapter(strSQL, objSQL.SQLConnect);
objCB = new System.Data.SqlClient.SqlCommandBuilder(objDA);
objDA.Fill(objDS, clsApplicationTypeEN._CurrTabName_S);
if (objDS.Tables[clsApplicationTypeEN._CurrTabName_S].Rows.Count  ==  0)
{
//MsgBox("没有相应的ID号:ApplicationTypeId = " + ""+ objApplicationTypeEN.ApplicationTypeId+"");
return false;
}
objRow = objDS.Tables[clsApplicationTypeEN._CurrTabName_S].Rows[0];
...
objRow[conApplicationType.Memo] = objApplicationTypeEN.Memo; //备注
 ...
 if (objApplicationTypeEN.IsUpdated(conApplicationType.ProgLangTypeName))
 {
objRow[conApplicationType.ProgLangTypeName] = objApplicationTypeEN.ProgLangTypeName; //编程语言类型名
 }
try
...
sbSQL.AppendFormat("Update ApplicationType Set ");
 ...
 {
 objApplicationTypeEN.ApplicationTypeName = objApplicationTypeEN.ApplicationTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ApplicationTypeName, conApplicationType.ApplicationTypeName); //应用程序类型名称
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ApplicationTypeSimName = objApplicationTypeEN.ApplicationTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ApplicationTypeSimName, conApplicationType.ApplicationTypeSimName); //应用程序类型简称
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ApplicationTypeENName = objApplicationTypeEN.ApplicationTypeENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ApplicationTypeENName, conApplicationType.ApplicationTypeENName); //应用类型英文名
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId = objApplicationTypeEN.ProgLangTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ProgLangTypeId, conApplicationType.ProgLangTypeId); //编程语言类型Id
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId2 = objApplicationTypeEN.ProgLangTypeId2.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ProgLangTypeId2, conApplicationType.ProgLangTypeId2); //编程语言类型Id2
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId3 = objApplicationTypeEN.ProgLangTypeId3.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ProgLangTypeId3, conApplicationType.ProgLangTypeId3); //编程语言类型Id3
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId4 = objApplicationTypeEN.ProgLangTypeId4.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ProgLangTypeId4, conApplicationType.ProgLangTypeId4); //编程语言类型Id4
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId5 = objApplicationTypeEN.ProgLangTypeId5.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ProgLangTypeId5, conApplicationType.ProgLangTypeId5); //编程语言类型Id5
 }
 else
 {
 ...
 if (objApplicationTypeEN.IsUpdated(conApplicationType.OrderNum))
 {
 sbSQL.AppendFormat("{1} = {0},",objApplicationTypeEN.OrderNum, conApplicationType.OrderNum); //排序
 }
 ...
 {
 objApplicationTypeEN.Memo = objApplicationTypeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.Memo, conApplicationType.Memo); //备注
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conApplicationType.Memo); //备注
 }
 }
 ...
 {
 objApplicationTypeEN.ProgLangTypeName = objApplicationTypeEN.ProgLangTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objApplicationTypeEN.ProgLangTypeName, conApplicationType.ProgLangTypeName); //编程语言类型名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conApplicationType.ProgLangTypeName); //编程语言类型名
 }
 }
...
sbSQL.AppendFormat("Update ApplicationType Set ");
 ...
 {
 objApplicationTypeEN.ApplicationTypeName = objApplicationTypeEN.ApplicationTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ApplicationTypeName = '{0}',", objApplicationTypeEN.ApplicationTypeName); //应用程序类型名称
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ApplicationTypeSimName = objApplicationTypeEN.ApplicationTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ApplicationTypeSimName = '{0}',", objApplicationTypeEN.ApplicationTypeSimName); //应用程序类型简称
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ApplicationTypeENName = objApplicationTypeEN.ApplicationTypeENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ApplicationTypeENName = '{0}',", objApplicationTypeEN.ApplicationTypeENName); //应用类型英文名
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId = objApplicationTypeEN.ProgLangTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeId = '{0}',", objApplicationTypeEN.ProgLangTypeId); //编程语言类型Id
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId2 = objApplicationTypeEN.ProgLangTypeId2.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeId2 = '{0}',", objApplicationTypeEN.ProgLangTypeId2); //编程语言类型Id2
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId3 = objApplicationTypeEN.ProgLangTypeId3.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeId3 = '{0}',", objApplicationTypeEN.ProgLangTypeId3); //编程语言类型Id3
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId4 = objApplicationTypeEN.ProgLangTypeId4.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeId4 = '{0}',", objApplicationTypeEN.ProgLangTypeId4); //编程语言类型Id4
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeId5 = objApplicationTypeEN.ProgLangTypeId5.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeId5 = '{0}',", objApplicationTypeEN.ProgLangTypeId5); //编程语言类型Id5
 }
 else
 {
 ...
 if (objApplicationTypeEN.IsUpdated(conApplicationType.VisitedNum))
 {
 sbSQL.AppendFormat(" VisitedNum = {0},", objApplicationTypeEN.VisitedNum); //访问数
 }
 
 if (objApplicationTypeEN.IsUpdated(conApplicationType.OrderNum))
 {
 sbSQL.AppendFormat(" OrderNum = {0},", objApplicationTypeEN.OrderNum); //排序
 }
 ...
 {
 objApplicationTypeEN.Memo = objApplicationTypeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" Memo = '{0}',", objApplicationTypeEN.Memo); //备注
 }
 else
 {
 ...
 {
 objApplicationTypeEN.ProgLangTypeName = objApplicationTypeEN.ProgLangTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeName = '{0}',", objApplicationTypeEN.ProgLangTypeName); //编程语言类型名
 }
 else
 {
...
clsCheckSql.CheckFieldLen(objApplicationTypeEN.ProgLangTypeName, 30, conApplicationType.ProgLangTypeName);
//检查字段外键固定长度
...
clsCheckSql.CheckSqlInjection4Field(objApplicationTypeEN.ProgLangTypeName, conApplicationType.ProgLangTypeName);
//检查外键字段长度
 objApplicationTypeEN._IsCheckProperty = true;
}
...
return objDT;
 ...
 /// </summary>
 /// <param name = "intApplicationTypeId">应用程序类型ID(主键)</param>
 /// <returns></returns>
public bool CheckApplicationTypeUniqueness(int intApplicationTypeId )
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("ApplicationTypeId !=  {0}", intApplicationTypeId);
...
return true;
 ...
 /// </summary>
 /// <returns></returns>
public bool CheckApplicationTypeUniqueness()
{
StringBuilder sbCondition = new StringBuilder();
...
public string GetUniCondStr_ApplicationTypeName(clsApplicationTypeEN objApplicationTypeEN)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("1 = 1");
 ...
 public static int GetRecCount()
{
 ...
 //获取连接对象
 objSQL = clsApplicationTypeDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsApplicationTypeEN._CurrTabName_S);
return intRecCount;
}
 ...
 public static int GetRecCountByCond(string strCondition)
{
 ...
 //获取连接对象
 objSQL = clsApplicationTypeDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsApplicationTypeEN._CurrTabName_S, strCondition);
return intRecCount;
}
