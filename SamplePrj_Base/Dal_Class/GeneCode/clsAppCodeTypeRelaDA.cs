...
//以下是属性变量
 ...
 get
 {
 return clsAppCodeTypeRelaEN._CurrTabName_S;
 }
 }
...
objAppCodeTypeRelaEN.ViewTypeCode = TransNullToInt(objRow[conAppCodeTypeRela.ViewTypeCode].ToString().Trim()); //界面类型码
objAppCodeTypeRelaEN.TabMainTypeId = objRow[conAppCodeTypeRela.TabMainTypeId].ToString().Trim(); //表主类型Id
...
objAppCodeTypeRelaEN.OrderNum = TransNullToInt(objRow[conAppCodeTypeRela.OrderNum].ToString().Trim()); //排序
objAppCodeTypeRelaEN.UpdDate = objRow[conAppCodeTypeRela.UpdDate].ToString().Trim(); //修改日期
objAppCodeTypeRelaEN.UpdUser = objRow[conAppCodeTypeRela.UpdUser].ToString().Trim(); //修改用户
objAppCodeTypeRelaEN.Memo = objRow[conAppCodeTypeRela.Memo].ToString().Trim(); //备注
objAppCodeTypeRelaEN.ApplicationTypeName = objRow[conAppCodeTypeRela.ApplicationTypeName].ToString().Trim(); //应用程序类型名称
objAppCodeTypeRelaEN.CodeTypeSimName = objRow[conAppCodeTypeRela.CodeTypeSimName].ToString().Trim(); //简称
objAppCodeTypeRelaEN.CodeTypeName = objRow[conAppCodeTypeRela.CodeTypeName].ToString().Trim(); //代码类型名
objAppCodeTypeRelaEN.DependsOn = objRow[conAppCodeTypeRela.DependsOn].ToString().Trim(); //依赖于
objAppCodeTypeRelaEN.GroupName = objRow[conAppCodeTypeRela.GroupName].ToString().Trim(); //组名
objAppCodeTypeRelaEN.ProgLangTypeSimName = objRow[conAppCodeTypeRela.ProgLangTypeSimName].ToString().Trim(); //编程语言类型简称
objAppCodeTypeRelaEN.ProgLangTypeName = objRow[conAppCodeTypeRela.ProgLangTypeName].ToString().Trim(); //编程语言类型名
}
 catch(Exception objException)
{
...
try
{
 objAppCodeTypeRelaEN.mId = TransNullToInt(objDT.Rows[0][conAppCodeTypeRela.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objAppCodeTypeRelaEN.OrderNum = TransNullToInt(objDT.Rows[0][conAppCodeTypeRela.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 objAppCodeTypeRelaEN.UpdDate = objDT.Rows[0][conAppCodeTypeRela.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objAppCodeTypeRelaEN.UpdUser = objDT.Rows[0][conAppCodeTypeRela.UpdUser].ToString().Trim(); //修改用户(字段类型:varchar,字段长度:20,是否可空:True)
 objAppCodeTypeRelaEN.Memo = objDT.Rows[0][conAppCodeTypeRela.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 objAppCodeTypeRelaEN.ApplicationTypeName = objDT.Rows[0][conAppCodeTypeRela.ApplicationTypeName].ToString().Trim(); //应用程序类型名称(字段类型:varchar,字段长度:30,是否可空:False)
 objAppCodeTypeRelaEN.CodeTypeSimName = objDT.Rows[0][conAppCodeTypeRela.CodeTypeSimName].ToString().Trim(); //简称(字段类型:varchar,字段长度:50,是否可空:False)
 objAppCodeTypeRelaEN.CodeTypeName = objDT.Rows[0][conAppCodeTypeRela.CodeTypeName].ToString().Trim(); //代码类型名(字段类型:varchar,字段长度:50,是否可空:False)
 objAppCodeTypeRelaEN.DependsOn = objDT.Rows[0][conAppCodeTypeRela.DependsOn].ToString().Trim(); //依赖于(字段类型:varchar,字段长度:50,是否可空:True)
 objAppCodeTypeRelaEN.GroupName = objDT.Rows[0][conAppCodeTypeRela.GroupName].ToString().Trim(); //组名(字段类型:varchar,字段长度:30,是否可空:False)
 objAppCodeTypeRelaEN.ProgLangTypeSimName = objDT.Rows[0][conAppCodeTypeRela.ProgLangTypeSimName].ToString().Trim(); //编程语言类型简称(字段类型:varchar,字段长度:30,是否可空:True)
 objAppCodeTypeRelaEN.ProgLangTypeName = objDT.Rows[0][conAppCodeTypeRela.ProgLangTypeName].ToString().Trim(); //编程语言类型名(字段类型:varchar,字段长度:30,是否可空:False)
}
 catch(Exception objException)
{
...
try
{
 objAppCodeTypeRelaEN.mId = Int32.Parse(objRow[conAppCodeTypeRela.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objAppCodeTypeRelaEN.ViewTypeCode = clsEntityBase2.TransNullToInt_S(objRow[conAppCodeTypeRela.ViewTypeCode] == DBNull.Value ? null : objRow[conAppCodeTypeRela.ViewTypeCode].ToString().Trim()); //界面类型码(字段类型:int,字段长度:4,是否可空:False)
 ...
 objAppCodeTypeRelaEN.IsVisible = clsEntityBase2.TransNullToBool_S(objRow[conAppCodeTypeRela.IsVisible] == DBNull.Value ? null : objRow[conAppCodeTypeRela.IsVisible].ToString().Trim()); //是否显示(字段类型:bit,字段长度:1,是否可空:True)
 objAppCodeTypeRelaEN.IsInGroupGeneCode = clsEntityBase2.TransNullToBool_S(objRow[conAppCodeTypeRela.IsInGroupGeneCode] == DBNull.Value ? null : objRow[conAppCodeTypeRela.IsInGroupGeneCode].ToString().Trim()); //是否参与组生成代码(字段类型:bit,字段长度:1,是否可空:True)
 objAppCodeTypeRelaEN.OrderNum = Int32.Parse(objRow[conAppCodeTypeRela.OrderNum].ToString().Trim()); //排序(字段类型:int,字段长度:4,是否可空:True)
 ...
 objAppCodeTypeRelaEN.UpdUser = objRow[conAppCodeTypeRela.UpdUser] == DBNull.Value ? null : objRow[conAppCodeTypeRela.UpdUser].ToString().Trim(); //修改用户(字段类型:varchar,字段长度:20,是否可空:True)
 objAppCodeTypeRelaEN.Memo = objRow[conAppCodeTypeRela.Memo] == DBNull.Value ? null : objRow[conAppCodeTypeRela.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 objAppCodeTypeRelaEN.ApplicationTypeName = objRow[conAppCodeTypeRela.ApplicationTypeName] == DBNull.Value ? null : objRow[conAppCodeTypeRela.ApplicationTypeName].ToString().Trim(); //应用程序类型名称(字段类型:varchar,字段长度:30,是否可空:False)
 objAppCodeTypeRelaEN.CodeTypeSimName = objRow[conAppCodeTypeRela.CodeTypeSimName] == DBNull.Value ? null : objRow[conAppCodeTypeRela.CodeTypeSimName].ToString().Trim(); //简称(字段类型:varchar,字段长度:50,是否可空:False)
 objAppCodeTypeRelaEN.CodeTypeName = objRow[conAppCodeTypeRela.CodeTypeName] == DBNull.Value ? null : objRow[conAppCodeTypeRela.CodeTypeName].ToString().Trim(); //代码类型名(字段类型:varchar,字段长度:50,是否可空:False)
 objAppCodeTypeRelaEN.DependsOn = objRow[conAppCodeTypeRela.DependsOn] == DBNull.Value ? null : objRow[conAppCodeTypeRela.DependsOn].ToString().Trim(); //依赖于(字段类型:varchar,字段长度:50,是否可空:True)
 objAppCodeTypeRelaEN.GroupName = objRow[conAppCodeTypeRela.GroupName] == DBNull.Value ? null : objRow[conAppCodeTypeRela.GroupName].ToString().Trim(); //组名(字段类型:varchar,字段长度:30,是否可空:False)
 objAppCodeTypeRelaEN.ProgLangTypeSimName = objRow[conAppCodeTypeRela.ProgLangTypeSimName] == DBNull.Value ? null : objRow[conAppCodeTypeRela.ProgLangTypeSimName].ToString().Trim(); //编程语言类型简称(字段类型:varchar,字段长度:30,是否可空:True)
 objAppCodeTypeRelaEN.ProgLangTypeName = objRow[conAppCodeTypeRela.ProgLangTypeName] == DBNull.Value ? null : objRow[conAppCodeTypeRela.ProgLangTypeName].ToString().Trim(); //编程语言类型名(字段类型:varchar,字段长度:30,是否可空:False)
}
 catch(Exception objException)
{
...
ViewTypeCode = TransNullToInt(objRow[conAppCodeTypeRela.ViewTypeCode].ToString().Trim()), //界面类型码
TabMainTypeId = objRow[conAppCodeTypeRela.TabMainTypeId].ToString().Trim(), //表主类型Id
...
OrderNum = TransNullToInt(objRow[conAppCodeTypeRela.OrderNum].ToString().Trim()), //排序
UpdDate = objRow[conAppCodeTypeRela.UpdDate].ToString().Trim(), //修改日期
UpdUser = objRow[conAppCodeTypeRela.UpdUser].ToString().Trim(), //修改用户
Memo = objRow[conAppCodeTypeRela.Memo].ToString().Trim(), //备注
ApplicationTypeName = objRow[conAppCodeTypeRela.ApplicationTypeName].ToString().Trim(), //应用程序类型名称
CodeTypeSimName = objRow[conAppCodeTypeRela.CodeTypeSimName].ToString().Trim(), //简称
CodeTypeName = objRow[conAppCodeTypeRela.CodeTypeName].ToString().Trim(), //代码类型名
DependsOn = objRow[conAppCodeTypeRela.DependsOn].ToString().Trim(), //依赖于
GroupName = objRow[conAppCodeTypeRela.GroupName].ToString().Trim(), //组名
ProgLangTypeSimName = objRow[conAppCodeTypeRela.ProgLangTypeSimName].ToString().Trim(), //编程语言类型简称
ProgLangTypeName = objRow[conAppCodeTypeRela.ProgLangTypeName].ToString().Trim() //编程语言类型名
};
objAppCodeTypeRelaEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objAppCodeTypeRelaEN;
}
...
//获取连接对象
objSQL = clsAppCodeTypeRelaDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsAppCodeTypeRelaEN._CurrTabName_S, conAppCodeTypeRela.mId, 8, "");
return strMaxValue;
}
...
//获取连接对象
objSQL = clsAppCodeTypeRelaDA.GetSpecSQLObj();
string strMaxValue = objSQL.GetMaxStrId(clsAppCodeTypeRelaEN._CurrTabName_S, conAppCodeTypeRela.mId, 8, strPrefix);
return strMaxValue;
}
...
objRow[conAppCodeTypeRela.OrderNum] = objAppCodeTypeRelaEN.OrderNum; //排序
...
objRow[conAppCodeTypeRela.UpdDate] = objAppCodeTypeRelaEN.UpdDate; //修改日期
 ...
 {
objRow[conAppCodeTypeRela.UpdUser] = objAppCodeTypeRelaEN.UpdUser; //修改用户
 }
 if (objAppCodeTypeRelaEN.Memo !=  "")
 {
objRow[conAppCodeTypeRela.Memo] = objAppCodeTypeRelaEN.Memo; //备注
 }
 if (objAppCodeTypeRelaEN.ApplicationTypeName !=  "")
 {
objRow[conAppCodeTypeRela.ApplicationTypeName] = objAppCodeTypeRelaEN.ApplicationTypeName; //应用程序类型名称
 }
 if (objAppCodeTypeRelaEN.CodeTypeSimName !=  "")
 {
objRow[conAppCodeTypeRela.CodeTypeSimName] = objAppCodeTypeRelaEN.CodeTypeSimName; //简称
 }
 if (objAppCodeTypeRelaEN.CodeTypeName !=  "")
 {
objRow[conAppCodeTypeRela.CodeTypeName] = objAppCodeTypeRelaEN.CodeTypeName; //代码类型名
 }
 if (objAppCodeTypeRelaEN.DependsOn !=  "")
 {
objRow[conAppCodeTypeRela.DependsOn] = objAppCodeTypeRelaEN.DependsOn; //依赖于
 }
 if (objAppCodeTypeRelaEN.GroupName !=  "")
 {
objRow[conAppCodeTypeRela.GroupName] = objAppCodeTypeRelaEN.GroupName; //组名
 }
 if (objAppCodeTypeRelaEN.ProgLangTypeSimName !=  "")
 {
objRow[conAppCodeTypeRela.ProgLangTypeSimName] = objAppCodeTypeRelaEN.ProgLangTypeSimName; //编程语言类型简称
 }
 if (objAppCodeTypeRelaEN.ProgLangTypeName !=  "")
 {
objRow[conAppCodeTypeRela.ProgLangTypeName] = objAppCodeTypeRelaEN.ProgLangTypeName; //编程语言类型名
 }
objDS.Tables[clsAppCodeTypeRelaEN._CurrTabName_S].Rows.Add(objRow);
try
{
objDA.Update(objDS, clsAppCodeTypeRelaEN._CurrTabName_S);
}
catch (Exception objException)
{
clsGeneralTab2. LogErrorS(objException, "");
...
StringBuilder strSQL = new StringBuilder();
 ...
 objAppCodeTypeRelaEN.CodeTypeId = objAppCodeTypeRelaEN.CodeTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.CodeTypeId + "'");
 }
 ...
 objAppCodeTypeRelaEN.TabMainTypeId = objAppCodeTypeRelaEN.TabMainTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.TabMainTypeId + "'");
 }
 ...
 objAppCodeTypeRelaEN.UpdDate = objAppCodeTypeRelaEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.UpdDate + "'");
 }
 
 if (objAppCodeTypeRelaEN.UpdUser !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.UpdUser);
 objAppCodeTypeRelaEN.UpdUser = objAppCodeTypeRelaEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.UpdUser + "'");
 }
 
 if (objAppCodeTypeRelaEN.Memo !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.Memo);
 objAppCodeTypeRelaEN.Memo = objAppCodeTypeRelaEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.Memo + "'");
 }
 
 if (objAppCodeTypeRelaEN.ApplicationTypeName !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.ApplicationTypeName);
 objAppCodeTypeRelaEN.ApplicationTypeName = objAppCodeTypeRelaEN.ApplicationTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.ApplicationTypeName + "'");
 }
 
 if (objAppCodeTypeRelaEN.CodeTypeSimName !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.CodeTypeSimName);
 objAppCodeTypeRelaEN.CodeTypeSimName = objAppCodeTypeRelaEN.CodeTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.CodeTypeSimName + "'");
 }
 
 if (objAppCodeTypeRelaEN.CodeTypeName !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.CodeTypeName);
 objAppCodeTypeRelaEN.CodeTypeName = objAppCodeTypeRelaEN.CodeTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.CodeTypeName + "'");
 }
 
 if (objAppCodeTypeRelaEN.DependsOn !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.DependsOn);
 objAppCodeTypeRelaEN.DependsOn = objAppCodeTypeRelaEN.DependsOn.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.DependsOn + "'");
 }
 
 if (objAppCodeTypeRelaEN.GroupName !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.GroupName);
 objAppCodeTypeRelaEN.GroupName = objAppCodeTypeRelaEN.GroupName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.GroupName + "'");
 }
 
 if (objAppCodeTypeRelaEN.ProgLangTypeSimName !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.ProgLangTypeSimName);
 objAppCodeTypeRelaEN.ProgLangTypeSimName = objAppCodeTypeRelaEN.ProgLangTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.ProgLangTypeSimName + "'");
 }
 
 if (objAppCodeTypeRelaEN.ProgLangTypeName !=  null)
 {
 arrFieldListForInsert.Add(conAppCodeTypeRela.ProgLangTypeName);
 objAppCodeTypeRelaEN.ProgLangTypeName = objAppCodeTypeRelaEN.ProgLangTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objAppCodeTypeRelaEN.ProgLangTypeName + "'");
 }
 //组织插入记录SQL串
...
foreach(System.Data.DataRow oRow in oDT.Rows)
{
objRow = objDS.Tables[clsAppCodeTypeRelaEN._CurrTabName_S ].NewRow();
...
objRow[conAppCodeTypeRela.OrderNum] = oRow[conAppCodeTypeRela.OrderNum].ToString().Trim(); //排序
objRow[conAppCodeTypeRela.UpdDate] = oRow[conAppCodeTypeRela.UpdDate].ToString().Trim(); //修改日期
objRow[conAppCodeTypeRela.UpdUser] = oRow[conAppCodeTypeRela.UpdUser].ToString().Trim(); //修改用户
objRow[conAppCodeTypeRela.Memo] = oRow[conAppCodeTypeRela.Memo].ToString().Trim(); //备注
objRow[conAppCodeTypeRela.ApplicationTypeName] = oRow[conAppCodeTypeRela.ApplicationTypeName].ToString().Trim(); //应用程序类型名称
objRow[conAppCodeTypeRela.CodeTypeSimName] = oRow[conAppCodeTypeRela.CodeTypeSimName].ToString().Trim(); //简称
objRow[conAppCodeTypeRela.CodeTypeName] = oRow[conAppCodeTypeRela.CodeTypeName].ToString().Trim(); //代码类型名
objRow[conAppCodeTypeRela.DependsOn] = oRow[conAppCodeTypeRela.DependsOn].ToString().Trim(); //依赖于
objRow[conAppCodeTypeRela.GroupName] = oRow[conAppCodeTypeRela.GroupName].ToString().Trim(); //组名
objRow[conAppCodeTypeRela.ProgLangTypeSimName] = oRow[conAppCodeTypeRela.ProgLangTypeSimName].ToString().Trim(); //编程语言类型简称
objRow[conAppCodeTypeRela.ProgLangTypeName] = oRow[conAppCodeTypeRela.ProgLangTypeName].ToString().Trim(); //编程语言类型名
 objDS.Tables[clsAppCodeTypeRelaEN._CurrTabName_S].Rows.Add(objRow);
}
try
{
...
objDA = new System.Data.SqlClient.SqlDataAdapter(strSQL, objSQL.SQLConnect);
objCB = new System.Data.SqlClient.SqlCommandBuilder(objDA);
objDA.Fill(objDS, clsAppCodeTypeRelaEN._CurrTabName_S);
if (objDS.Tables[clsAppCodeTypeRelaEN._CurrTabName_S].Rows.Count  ==  0)
{
//MsgBox("没有相应的ID号:mId = " + ""+ objAppCodeTypeRelaEN.mId+"");
return false;
}
objRow = objDS.Tables[clsAppCodeTypeRelaEN._CurrTabName_S].Rows[0];
...
objRow[conAppCodeTypeRela.Memo] = objAppCodeTypeRelaEN.Memo; //备注
 ...
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.ApplicationTypeName))
 {
objRow[conAppCodeTypeRela.ApplicationTypeName] = objAppCodeTypeRelaEN.ApplicationTypeName; //应用程序类型名称
 }
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.CodeTypeSimName))
 {
objRow[conAppCodeTypeRela.CodeTypeSimName] = objAppCodeTypeRelaEN.CodeTypeSimName; //简称
 }
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.CodeTypeName))
 {
objRow[conAppCodeTypeRela.CodeTypeName] = objAppCodeTypeRelaEN.CodeTypeName; //代码类型名
 }
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.DependsOn))
 {
objRow[conAppCodeTypeRela.DependsOn] = objAppCodeTypeRelaEN.DependsOn; //依赖于
 }
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.GroupName))
 {
objRow[conAppCodeTypeRela.GroupName] = objAppCodeTypeRelaEN.GroupName; //组名
 }
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.ProgLangTypeSimName))
 {
objRow[conAppCodeTypeRela.ProgLangTypeSimName] = objAppCodeTypeRelaEN.ProgLangTypeSimName; //编程语言类型简称
 }
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.ProgLangTypeName))
 {
objRow[conAppCodeTypeRela.ProgLangTypeName] = objAppCodeTypeRelaEN.ProgLangTypeName; //编程语言类型名
 }
try
...
sbSQL.AppendFormat("Update AppCodeTypeRela Set ");
 ...
 {
 objAppCodeTypeRelaEN.CodeTypeId = objAppCodeTypeRelaEN.CodeTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.CodeTypeId, conAppCodeTypeRela.CodeTypeId); //代码类型Id
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.TabMainTypeId = objAppCodeTypeRelaEN.TabMainTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.TabMainTypeId, conAppCodeTypeRela.TabMainTypeId); //表主类型Id
 }
 else
 {
 ...
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.OrderNum))
 {
 sbSQL.AppendFormat("{1} = {0},",objAppCodeTypeRelaEN.OrderNum, conAppCodeTypeRela.OrderNum); //排序
 }
 ...
 {
 objAppCodeTypeRelaEN.UpdDate = objAppCodeTypeRelaEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.UpdDate, conAppCodeTypeRela.UpdDate); //修改日期
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.UpdUser = objAppCodeTypeRelaEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.UpdUser, conAppCodeTypeRela.UpdUser); //修改用户
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.UpdUser); //修改用户
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.Memo = objAppCodeTypeRelaEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.Memo, conAppCodeTypeRela.Memo); //备注
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.Memo); //备注
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.ApplicationTypeName = objAppCodeTypeRelaEN.ApplicationTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.ApplicationTypeName, conAppCodeTypeRela.ApplicationTypeName); //应用程序类型名称
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.ApplicationTypeName); //应用程序类型名称
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.CodeTypeSimName = objAppCodeTypeRelaEN.CodeTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.CodeTypeSimName, conAppCodeTypeRela.CodeTypeSimName); //简称
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.CodeTypeSimName); //简称
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.CodeTypeName = objAppCodeTypeRelaEN.CodeTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.CodeTypeName, conAppCodeTypeRela.CodeTypeName); //代码类型名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.CodeTypeName); //代码类型名
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.DependsOn = objAppCodeTypeRelaEN.DependsOn.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.DependsOn, conAppCodeTypeRela.DependsOn); //依赖于
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.DependsOn); //依赖于
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.GroupName = objAppCodeTypeRelaEN.GroupName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.GroupName, conAppCodeTypeRela.GroupName); //组名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.GroupName); //组名
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.ProgLangTypeSimName = objAppCodeTypeRelaEN.ProgLangTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.ProgLangTypeSimName, conAppCodeTypeRela.ProgLangTypeSimName); //编程语言类型简称
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.ProgLangTypeSimName); //编程语言类型简称
 }
 }
 ...
 {
 objAppCodeTypeRelaEN.ProgLangTypeName = objAppCodeTypeRelaEN.ProgLangTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objAppCodeTypeRelaEN.ProgLangTypeName, conAppCodeTypeRela.ProgLangTypeName); //编程语言类型名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conAppCodeTypeRela.ProgLangTypeName); //编程语言类型名
 }
 }
...
sbSQL.AppendFormat("Update AppCodeTypeRela Set ");
 ...
 {
 objAppCodeTypeRelaEN.CodeTypeId = objAppCodeTypeRelaEN.CodeTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" CodeTypeId = '{0}',", objAppCodeTypeRelaEN.CodeTypeId); //代码类型Id
 }
 else
 {
 ...
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.ViewTypeCode))
 {
 sbSQL.AppendFormat(" ViewTypeCode = {0},", objAppCodeTypeRelaEN.ViewTypeCode); //界面类型码
 }
 ...
 {
 objAppCodeTypeRelaEN.TabMainTypeId = objAppCodeTypeRelaEN.TabMainTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" TabMainTypeId = '{0}',", objAppCodeTypeRelaEN.TabMainTypeId); //表主类型Id
 }
 else
 {
 ...
 if (objAppCodeTypeRelaEN.IsUpdated(conAppCodeTypeRela.OrderNum))
 {
 sbSQL.AppendFormat(" OrderNum = {0},", objAppCodeTypeRelaEN.OrderNum); //排序
 }
 ...
 {
 objAppCodeTypeRelaEN.UpdDate = objAppCodeTypeRelaEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" UpdDate = '{0}',", objAppCodeTypeRelaEN.UpdDate); //修改日期
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.UpdUser = objAppCodeTypeRelaEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" UpdUser = '{0}',", objAppCodeTypeRelaEN.UpdUser); //修改用户
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.Memo = objAppCodeTypeRelaEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" Memo = '{0}',", objAppCodeTypeRelaEN.Memo); //备注
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.ApplicationTypeName = objAppCodeTypeRelaEN.ApplicationTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ApplicationTypeName = '{0}',", objAppCodeTypeRelaEN.ApplicationTypeName); //应用程序类型名称
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.CodeTypeSimName = objAppCodeTypeRelaEN.CodeTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" CodeTypeSimName = '{0}',", objAppCodeTypeRelaEN.CodeTypeSimName); //简称
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.CodeTypeName = objAppCodeTypeRelaEN.CodeTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" CodeTypeName = '{0}',", objAppCodeTypeRelaEN.CodeTypeName); //代码类型名
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.DependsOn = objAppCodeTypeRelaEN.DependsOn.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DependsOn = '{0}',", objAppCodeTypeRelaEN.DependsOn); //依赖于
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.GroupName = objAppCodeTypeRelaEN.GroupName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" GroupName = '{0}',", objAppCodeTypeRelaEN.GroupName); //组名
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.ProgLangTypeSimName = objAppCodeTypeRelaEN.ProgLangTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeSimName = '{0}',", objAppCodeTypeRelaEN.ProgLangTypeSimName); //编程语言类型简称
 }
 else
 {
 ...
 {
 objAppCodeTypeRelaEN.ProgLangTypeName = objAppCodeTypeRelaEN.ProgLangTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" ProgLangTypeName = '{0}',", objAppCodeTypeRelaEN.ProgLangTypeName); //编程语言类型名
 }
 else
 {
...
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.ApplicationTypeName, 30, conAppCodeTypeRela.ApplicationTypeName);
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.CodeTypeSimName, 50, conAppCodeTypeRela.CodeTypeSimName);
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.CodeTypeName, 50, conAppCodeTypeRela.CodeTypeName);
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.DependsOn, 50, conAppCodeTypeRela.DependsOn);
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.GroupName, 30, conAppCodeTypeRela.GroupName);
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.ProgLangTypeSimName, 30, conAppCodeTypeRela.ProgLangTypeSimName);
clsCheckSql.CheckFieldLen(objAppCodeTypeRelaEN.ProgLangTypeName, 30, conAppCodeTypeRela.ProgLangTypeName);
//检查字段外键固定长度
...
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.ApplicationTypeName, conAppCodeTypeRela.ApplicationTypeName);
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.CodeTypeSimName, conAppCodeTypeRela.CodeTypeSimName);
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.CodeTypeName, conAppCodeTypeRela.CodeTypeName);
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.DependsOn, conAppCodeTypeRela.DependsOn);
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.GroupName, conAppCodeTypeRela.GroupName);
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.ProgLangTypeSimName, conAppCodeTypeRela.ProgLangTypeSimName);
clsCheckSql.CheckSqlInjection4Field(objAppCodeTypeRelaEN.ProgLangTypeName, conAppCodeTypeRela.ProgLangTypeName);
//检查外键字段长度
 objAppCodeTypeRelaEN._IsCheckProperty = true;
}
 ...
 /// <returns></returns>
public bool CheckAppCodeTypeRelaUniqueness(long lngmId )
{
...
return true;
 ...
 /// </summary>
 /// <returns></returns>
public bool CheckAppCodeTypeRelaUniqueness()
{
StringBuilder sbCondition = new StringBuilder();
...
public string GetUniCondStr_ApplicationTypeId_CodeTypeId(clsAppCodeTypeRelaEN objAppCodeTypeRelaEN)
{
StringBuilder sbCondition = new StringBuilder();
sbCondition.AppendFormat("1 = 1");
 ...
 public static int GetRecCount()
{
 ...
 //获取连接对象
 objSQL = clsAppCodeTypeRelaDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsAppCodeTypeRelaEN._CurrTabName_S);
return intRecCount;
}
 ...
 public static int GetRecCountByCond(string strCondition)
{
 ...
 //获取连接对象
 objSQL = clsAppCodeTypeRelaDA.GetSpecSQLObj();
int intRecCount = objSQL.GetRecCount(clsAppCodeTypeRelaEN._CurrTabName_S, strCondition);
return intRecCount;
}
