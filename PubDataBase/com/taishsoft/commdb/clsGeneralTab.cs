...
namespace com.taishsoft.commdb
{
    ...
    public class clsGeneralTab
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static clsSpecSQLforSql GetSpecSQLObj_GeneralTab()
        {
            clsSpecSQLforSql objSQL = null;
            if (clsSpecSQLforSql.bolIsUseConnectStrName == true)
            {
                objSQL = new clsSpecSQLforSql(clsSpecSQLforSql.strConnectStrName, true);
                return objSQL;
            }
            if (string.IsNullOrEmpty(clsSpecSQLforSql.ConnectString) == true)
            {
                objSQL = new clsSpecSQLforSql();
            }
            else
            {
                objSQL = new clsSpecSQLforSql(clsSpecSQLforSql.ConnectString);
            }
            return objSQL;
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            int intRecCount = objSQL.GetRecCount(_CurrTabName);
            return intRecCount;
        }
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            int intRecCount = objSQL.GetRecCount(_CurrTabName, strCondtion);
            return intRecCount;
        }
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            int intRecCount = objSQL.SetFldDataOfTable(_CurrTabName, strFldName, strValue, strCondition);
            return intRecCount;
        }
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            int intRecCount = objSQL.SetFldDataOfTable(_CurrTabName, strFldName, fltValue, strCondition);
            return intRecCount;
        }
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            int intRecCount = objSQL.SetFldDataOfTable(_CurrTabName, strFldName, intValue, strCondition);
            return intRecCount;
        }
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            List<string> arrList = objSQL.GetFldDataOfTable(_CurrTabName, strFldName, strCondition);
            return arrList;
        }
        /// <summary>
        /// 功能：获取当前表中的符合条件的某字段的值，以列表返回
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            List<string> arrList = objSQL.GetFldDataOfTableNoDistinct(_CurrTabName, strFldName, strCondition);
            return arrList;
        }
        ...
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            List<string> arrList = objSQL.GetFldDataOfTableNoDistinct(strTabName, strFldName, strCondition);
            return arrList;
        }
        ...
        /// <returns>获取的字段值列表</returns>
        public static List<string> funGetFldValue(string strTabName, string strFldName, string strCondition, SqlConnection objSqlConnect, SqlTransaction objSqlTransaction)
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
            List<string> arrList = objSQL.GetFldDataOfTable(strTabName, strFldName, strCondition);
            return arrList;
        ...
        /// <param name="objSqlTransaction">SqlTransaction</param>
        /// <returns>如果存在就返回TRUE，否则返回FALSE</returns>
        public static bool IsExistCondRec(string strTabName, string strCondition, SqlConnection objSqlConnect, SqlTransaction objSqlTransaction)
        {
            clsSpecSQLforSql objSQL = clsGeneralTab.GetSpecSQLObj_GeneralTab();
        ...
        /// <returns></returns>
        public virtual List<string> GetID(string strCondtion)
        {
            return null;
        }
        ...
        {
            clsSpecSQLforSql mySql = clsGeneralTab.GetSpecSQLObj_GeneralTab();
