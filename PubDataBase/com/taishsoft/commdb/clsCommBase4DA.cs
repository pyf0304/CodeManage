...
namespace com.taishsoft.commdb
{
    ...
    /// 数据处理层公共基类，包括：一些公共函数
    /// </summary>
    public abstract class clsCommBase4DA
    {
        /// <summary>
        /// 当前表名
        /// </summary>
        public virtual string _CurrTabName
        {
            get
            {
                return "";
        ...
        {
            if (string.IsNullOrEmpty(_CurrTabName) == true)
            {
        ...
        public int SetFldValue<T>(string strFldName, T varValue, string strCondition)
        {
            ...
            //获取连接对象
            objSQL = GetSpecSQLObj_Obj();
            int intRecCount = objSQL.SetFldDataOfTable(_CurrTabName, strFldName, varValue, strCondition);
            return intRecCount;
        }
