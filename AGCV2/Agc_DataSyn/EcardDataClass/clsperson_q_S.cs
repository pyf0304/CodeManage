...
namespace EcardDataClass
{
    ...
    /// </summary>
    [Serializable]
    public class clsPERSON_q_S : clsGeneralTab2
    {
        /// <summary>
        /// 当前表名，与该类相关的表名
        /// </summary>
        ...
        public clsPERSON_q_S(string strAccount)
        {
        ...
        public clsPERSON_q_S(string strAccount, bool bolIsGetPERSON_q)
        {
        ...
        public static clsSpecSQLforSql GetSpecSQLObj()
        {
            ...
            if (string.IsNullOrEmpty(clsPERSON_q_S.ConnectString) == true)
            {
                objSQL = new clsSpecSQLforSql();
            }
            else
            {
                objSQL = new clsSpecSQLforSql(clsPERSON_q_S.ConnectString);
            }
            return objSQL;
        }
        ...
        public void CopyTo(clsPERSON_q_S objPERSON_q)
        {
        ...
        public void CopyTo(clsPERSON_q_S objPERSON_qS, clsPERSON_q_S objPERSON_qT)
        {
        ...
        public static int SynchRecordToServerB(string strConnectStringT, clsPERSON_q_S objPERSON_q)
        {
            ...
            {
                clsPERSON_q_S objPERSON_qT = null;
                //如果存在,就修改.
                //检查是否有<UptDate>字段
                if (objPERSON_q["UptDate"] != null)
                {
                    ...
                    //获取目标服务器中的同关键字的记录
                    objPERSON_qT = new clsPERSON_q_S();
        ...
        public clsPERSON_q_S GetPERSON_qObjByDataRow(DataRow objRow)
        {
            if (objRow == null)
            {
                return null;
            }
            clsPERSON_q_S objPERSON_q = new clsPERSON_q_S();
        ...
        public clsPERSON_q_S GetFirstPERSON_q(string strCondition)
        {
            string strSQL;
            System.Data.DataTable objDT;
            clsSpecSQLforSql objSQL = null;
        ...
        /// <param name="strCondition">条件串</param>
        /// <returns>第一条记录的对象</returns>
        public clsPERSON_q_S GetFirstPERSON_qBySP(string strCondition)
        {
            System.Data.DataTable objDT;
            clsSpecSQLforSql objSQL = null;
            //获取连接对象
        ...
        public static string GetFirstID_S(string strCondtion)
        {
            ...
            {
                LogErrorS(objException, "clsPERSON_q_S");
                throw new Exception(EXCEPTION_MSG + objException.Message, objException);
            }
            finally
            {
