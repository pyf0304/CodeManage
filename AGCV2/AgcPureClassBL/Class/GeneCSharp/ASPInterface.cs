...
public static string[] AttributeName = new string[] {"AspInterfaceId", "AspInterfaceName", "ClassName", "FileName", "UserId", "FuncModuleName"};
//以下是属性变量
...
/// <summary>
/// 文件名(说明:;字段类型:varchar;字段长度:50;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
