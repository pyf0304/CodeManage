...
public static string[] AttributeName = new string[] {"AspCompareValidatorId", "AspCompareValidatorName", "ControlToValidate", "ErrorMessage", "EnableClientScript", "Operator"};
//以下是属性变量
