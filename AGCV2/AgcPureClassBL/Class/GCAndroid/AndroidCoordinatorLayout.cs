...
public class AndroidCoordinatorLayout : AndroidControlEx
{
protected const int mintAttributeCount = 11;
public static string[] AttributeName = new string[] {"AndroidCoordinatorLayoutId", "AndroidCoordinatorLayoutName", "Text", "CssClass", "OnClick", "layout_behavior", "context", "showIn", "android", "app", "tools"};
//以下是属性变量

/// <summary>
/// AndroidCoordinatorLayoutId(说明:;字段类型:char;字段长度:8;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidCoordinatorLayoutId
{
get
{
return mstrAndroidCoordinatorLayoutId;
}
set
{
if (value  ==  "")
{
 mstrAndroidCoordinatorLayoutId = value;
}
else
{
 mstrAndroidCoordinatorLayoutId = value;
...
/// <summary>
/// AndroidCoordinatorLayoutName(说明:;字段类型:varchar;字段长度:30;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidCoordinatorLayoutName
{
get
{
return mstrAndroidCoordinatorLayoutName;
}
set
{
if (value  ==  "")
{
 mstrAndroidCoordinatorLayoutName = value;
}
else
{
 mstrAndroidCoordinatorLayoutName = value;
...
get
{
if (strAttributeName  ==  con_AndroidCoordinatorLayoutId)
{
return mstrAndroidCoordinatorLayoutId;
}
else if (strAttributeName  ==  con_AndroidCoordinatorLayoutName)
{
return mstrAndroidCoordinatorLayoutName;
}
...
if (strAttributeName  ==  con_AndroidCoordinatorLayoutId)
{
mstrAndroidCoordinatorLayoutId = value.ToString();
}
else if (strAttributeName  ==  con_AndroidCoordinatorLayoutName)
{
mstrAndroidCoordinatorLayoutName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_AndroidCoordinatorLayoutId  ==  AttributeName[intIndex])
{
return mstrAndroidCoordinatorLayoutId;
}
else if (con_AndroidCoordinatorLayoutName  ==  AttributeName[intIndex])
{
return mstrAndroidCoordinatorLayoutName;
}
...
/// </summary>
 public AndroidCoordinatorLayout()
 {
 }


 /// <summary>
 /// 常量:"AndroidCoordinatorLayoutId"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidCoordinatorLayoutId = "AndroidCoordinatorLayoutId";    //AndroidCoordinatorLayoutId

 /// <summary>
 /// 常量:"AndroidCoordinatorLayoutName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidCoordinatorLayoutName = "AndroidCoordinatorLayoutName";    //AndroidCoordinatorLayoutName
...
protected string mstrAndroidCoordinatorLayoutId;    //AndroidCoordinatorLayoutId
protected string mstrAndroidCoordinatorLayoutName;    //AndroidCoordinatorLayoutName
