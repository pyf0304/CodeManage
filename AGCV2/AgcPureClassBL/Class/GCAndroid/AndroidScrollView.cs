 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:AndroidScrollView
 表名:AndroidScrollView(00050446)
 生成代码版本:2019.10.18.1
 生成日期:2019/10/18 10:34:43
 生成者:
...
{
 /// <summary>
 /// Android滚动界面(AndroidScrollView)
 /// (AutoGCLib.PureClass4CSharp:GeneCode)
 /// </summary>
[Serializable]
[DataContractAttribute]
public class AndroidScrollView : AndroidControlEx
{
protected const int mintAttributeCount = 11;
public static string[] AttributeName = new string[] {"AndroidScrollViewId", "AndroidScrollViewName", "Text", "CssClass", "OnClick", "layout_behavior", "context", "showIn", "android", "app", "tools"};
//以下是属性变量

/// <summary>
/// AndroidScrollViewId(说明:;字段类型:char;字段长度:8;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidScrollViewId
{
get
{
return mstrAndroidScrollViewId;
}
set
{
if (value  ==  "")
{
 mstrAndroidScrollViewId = value;
}
else
{
 mstrAndroidScrollViewId = value;
...
/// <summary>
/// AndroidScrollViewName(说明:;字段类型:varchar;字段长度:30;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidScrollViewName
{
get
{
return mstrAndroidScrollViewName;
}
set
{
if (value  ==  "")
{
 mstrAndroidScrollViewName = value;
}
else
{
 mstrAndroidScrollViewName = value;
...
get
{
if (strAttributeName  ==  con_AndroidScrollViewId)
{
return mstrAndroidScrollViewId;
}
else if (strAttributeName  ==  con_AndroidScrollViewName)
{
return mstrAndroidScrollViewName;
}
...
if (strAttributeName  ==  con_AndroidScrollViewId)
{
mstrAndroidScrollViewId = value.ToString();
}
else if (strAttributeName  ==  con_AndroidScrollViewName)
{
mstrAndroidScrollViewName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_AndroidScrollViewId  ==  AttributeName[intIndex])
{
return mstrAndroidScrollViewId;
}
else if (con_AndroidScrollViewName  ==  AttributeName[intIndex])
{
return mstrAndroidScrollViewName;
}
...
/// </summary>
 public AndroidScrollView()
 {
 }


 /// <summary>
 /// 常量:"AndroidScrollViewId"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidScrollViewId = "AndroidScrollViewId";    //AndroidScrollViewId

 /// <summary>
 /// 常量:"AndroidScrollViewName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidScrollViewName = "AndroidScrollViewName";    //AndroidScrollViewName
...
protected string mstrAndroidScrollViewId;    //AndroidScrollViewId
protected string mstrAndroidScrollViewName;    //AndroidScrollViewName
