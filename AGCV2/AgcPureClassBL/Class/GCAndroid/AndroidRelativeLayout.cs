 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:AndroidRelativeLayout
 表名:AndroidRelativeLayout(00050445)
 生成代码版本:2019.10.18.1
 生成日期:2019/10/18 10:34:42
 生成者:
...
{
 /// <summary>
 /// Android相对布局(AndroidRelativeLayout)
 /// (AutoGCLib.PureClass4CSharp:GeneCode)
 /// </summary>
[Serializable]
[DataContractAttribute]
public class AndroidRelativeLayout : AndroidControlEx
{
protected const int mintAttributeCount = 10;
public static string[] AttributeName = new string[] {"AndroidRelativeLayoutId", "AndroidRelativeLayoutName", "Text", "CssClass", "OnClick", "layout_behavior", "context", "showIn", "orientation", "android"};
//以下是属性变量

/// <summary>
/// AndroidRelativeLayoutId(说明:;字段类型:char;字段长度:8;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidRelativeLayoutId
{
get
{
return mstrAndroidRelativeLayoutId;
}
set
{
if (value  ==  "")
{
 mstrAndroidRelativeLayoutId = value;
}
else
{
 mstrAndroidRelativeLayoutId = value;
...
/// <summary>
/// AndroidRelativeLayoutName(说明:;字段类型:varchar;字段长度:30;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidRelativeLayoutName
{
get
{
return mstrAndroidRelativeLayoutName;
}
set
{
if (value  ==  "")
{
 mstrAndroidRelativeLayoutName = value;
}
else
{
 mstrAndroidRelativeLayoutName = value;
...
get
{
if (strAttributeName  ==  con_AndroidRelativeLayoutId)
{
return mstrAndroidRelativeLayoutId;
}
else if (strAttributeName  ==  con_AndroidRelativeLayoutName)
{
return mstrAndroidRelativeLayoutName;
}
...
if (strAttributeName  ==  con_AndroidRelativeLayoutId)
{
mstrAndroidRelativeLayoutId = value.ToString();
}
else if (strAttributeName  ==  con_AndroidRelativeLayoutName)
{
mstrAndroidRelativeLayoutName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_AndroidRelativeLayoutId  ==  AttributeName[intIndex])
{
return mstrAndroidRelativeLayoutId;
}
else if (con_AndroidRelativeLayoutName  ==  AttributeName[intIndex])
{
return mstrAndroidRelativeLayoutName;
}
...
/// </summary>
 public AndroidRelativeLayout()
 {
 }


 /// <summary>
 /// 常量:"AndroidRelativeLayoutId"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidRelativeLayoutId = "AndroidRelativeLayoutId";    //AndroidRelativeLayoutId

 /// <summary>
 /// 常量:"AndroidRelativeLayoutName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidRelativeLayoutName = "AndroidRelativeLayoutName";    //AndroidRelativeLayoutName
...
protected string mstrAndroidRelativeLayoutId;    //AndroidRelativeLayoutId
protected string mstrAndroidRelativeLayoutName;    //AndroidRelativeLayoutName
