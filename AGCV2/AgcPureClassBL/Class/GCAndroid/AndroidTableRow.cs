...
{
 /// <summary>
 /// Android表格行(AndroidTableRow)
 /// (AutoGCLib.PureClass4CSharp:GeneCode)
 /// </summary>
[Serializable]
[DataContractAttribute]
public class AndroidTableRow : AndroidControlEx
{
protected const int mintAttributeCount = 10;
public static string[] AttributeName = new string[] {"AndroidTableRowId", "AndroidTableRowName", "Text", "CssClass", "OnClick", "layout_behavior", "context", "showIn", "orientation", "android"};
//以下是属性变量

/// <summary>
/// AndroidTableRowId(说明:;字段类型:char;字段长度:8;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidTableRowId
{
get
{
return mstrAndroidTableRowId;
}
set
{
if (value  ==  "")
{
 mstrAndroidTableRowId = value;
}
else
{
 mstrAndroidTableRowId = value;
...
/// <summary>
/// AndroidTableRowName(说明:;字段类型:varchar;字段长度:30;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidTableRowName
{
get
{
return mstrAndroidTableRowName;
}
set
{
if (value  ==  "")
{
 mstrAndroidTableRowName = value;
}
else
{
 mstrAndroidTableRowName = value;
...
get
{
if (strAttributeName  ==  con_AndroidTableRowId)
{
return mstrAndroidTableRowId;
}
else if (strAttributeName  ==  con_AndroidTableRowName)
{
return mstrAndroidTableRowName;
}
...
if (strAttributeName  ==  con_AndroidTableRowId)
{
mstrAndroidTableRowId = value.ToString();
}
else if (strAttributeName  ==  con_AndroidTableRowName)
{
mstrAndroidTableRowName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_AndroidTableRowId  ==  AttributeName[intIndex])
{
return mstrAndroidTableRowId;
}
else if (con_AndroidTableRowName  ==  AttributeName[intIndex])
{
return mstrAndroidTableRowName;
}
...
/// </summary>
 public AndroidTableRow()
 {
 }


 /// <summary>
 /// 常量:"AndroidTableRowId"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidTableRowId = "AndroidTableRowId";    //AndroidTableRowId

 /// <summary>
 /// 常量:"AndroidTableRowName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidTableRowName = "AndroidTableRowName";    //AndroidTableRowName
...
protected string mstrAndroidTableRowId;    //AndroidTableRowId
protected string mstrAndroidTableRowName;    //AndroidTableRowName
