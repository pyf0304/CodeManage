...
public class ISOscene : ISOControlEx
{
protected const int mintAttributeCount = 8;
public static string[] AttributeName = new string[] {"IsosceneId", "IsosceneName", "Text", "CssClass", "OnClick", "Style", "Width", "Height"};
//以下是属性变量

/// <summary>
/// Iso场景Id(说明:;字段类型:char;字段长度:10;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsosceneId
{
get
{
return mstrIsosceneId;
}
set
{
if (value  ==  "")
{
 mstrIsosceneId = value;
}
else
{
 mstrIsosceneId = value;
...
/// <summary>
/// Iso场景名(说明:;字段类型:varchar;字段长度:50;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsosceneName
{
get
{
return mstrIsosceneName;
}
set
{
if (value  ==  "")
{
 mstrIsosceneName = value;
}
else
{
 mstrIsosceneName = value;
...
get
{
if (strAttributeName  ==  con_IsosceneId)
{
return mstrIsosceneId;
}
else if (strAttributeName  ==  con_IsosceneName)
{
return mstrIsosceneName;
}
...
if (strAttributeName  ==  con_IsosceneId)
{
mstrIsosceneId = value.ToString();
}
else if (strAttributeName  ==  con_IsosceneName)
{
mstrIsosceneName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_IsosceneId  ==  AttributeName[intIndex])
{
return mstrIsosceneId;
}
else if (con_IsosceneName  ==  AttributeName[intIndex])
{
return mstrIsosceneName;
}
...
/// </summary>
 ...
 /// </summary>
 public const string con_IsosceneId = "IsosceneId";    //Iso场景Id

 /// <summary>
 /// 常量:"IsosceneName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_IsosceneName = "IsosceneName";    //Iso场景名
...
protected string mstrIsosceneId;    //Iso场景Id
protected string mstrIsosceneName;    //Iso场景名
