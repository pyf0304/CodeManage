...
public class ISOstoryBoard : ISOControlEx
{
protected const int mintAttributeCount = 8;
public static string[] AttributeName = new string[] {"IsostoryBoardId", "IsostoryBoardName", "Text", "CssClass", "OnClick", "Style", "Width", "Height"};
//以下是属性变量

/// <summary>
/// Iso故事板Id(说明:;字段类型:char;字段长度:10;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsostoryBoardId
{
get
{
return mstrIsostoryBoardId;
}
set
{
if (value  ==  "")
{
 mstrIsostoryBoardId = value;
}
else
{
 mstrIsostoryBoardId = value;
...
/// <summary>
/// Iso故事板名(说明:;字段类型:varchar;字段长度:50;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsostoryBoardName
{
get
{
return mstrIsostoryBoardName;
}
set
{
if (value  ==  "")
{
 mstrIsostoryBoardName = value;
}
else
{
 mstrIsostoryBoardName = value;
...
get
{
if (strAttributeName  ==  con_IsostoryBoardId)
{
return mstrIsostoryBoardId;
}
else if (strAttributeName  ==  con_IsostoryBoardName)
{
return mstrIsostoryBoardName;
}
...
if (strAttributeName  ==  con_IsostoryBoardId)
{
mstrIsostoryBoardId = value.ToString();
}
else if (strAttributeName  ==  con_IsostoryBoardName)
{
mstrIsostoryBoardName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_IsostoryBoardId  ==  AttributeName[intIndex])
{
return mstrIsostoryBoardId;
}
else if (con_IsostoryBoardName  ==  AttributeName[intIndex])
{
return mstrIsostoryBoardName;
}
...
/// </summary>
 ...
 /// </summary>
 public const string con_IsostoryBoardId = "IsostoryBoardId";    //Iso故事板Id

 /// <summary>
 /// 常量:"IsostoryBoardName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_IsostoryBoardName = "IsostoryBoardName";    //Iso故事板名
...
protected string mstrIsostoryBoardId;    //Iso故事板Id
protected string mstrIsostoryBoardName;    //Iso故事板名
