...
public class ISOview : ISOControlEx
{
protected const int mintAttributeCount = 8;
public static string[] AttributeName = new string[] {"IsoviewId", "IsoviewName", "Text", "CssClass", "OnClick", "Style", "Width", "Height"};
//以下是属性变量

/// <summary>
/// Iso视图Id(说明:;字段类型:char;字段长度:10;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsoviewId
{
get
{
return mstrIsoviewId;
}
set
{
if (value  ==  "")
...
/// <summary>
/// Iso视图名(说明:;字段类型:varchar;字段长度:50;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsoviewName
{
get
{
return mstrIsoviewName;
}
set
{
if (value  ==  "")
{
 mstrIsoviewName = value;
}
else
{
 mstrIsoviewName = value;
...
get
{
if (strAttributeName  ==  con_IsoviewId)
{
return mstrIsoviewId;
}
else if (strAttributeName  ==  con_IsoviewName)
{
return mstrIsoviewName;
}
...
if (strAttributeName  ==  con_IsoviewId)
{
mstrIsoviewId = value.ToString();
}
else if (strAttributeName  ==  con_IsoviewName)
{
mstrIsoviewName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_IsoviewId  ==  AttributeName[intIndex])
{
return mstrIsoviewId;
}
else if (con_IsoviewName  ==  AttributeName[intIndex])
{
return mstrIsoviewName;
}
...
/// </summary>
 ...
 /// </summary>
 public const string con_IsoviewId = "IsoviewId";    //Iso视图Id

 /// <summary>
 /// 常量:"IsoviewName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_IsoviewName = "IsoviewName";    //Iso视图名
...
protected string mstrIsoviewId;    //Iso视图Id
protected string mstrIsoviewName;    //Iso视图名
