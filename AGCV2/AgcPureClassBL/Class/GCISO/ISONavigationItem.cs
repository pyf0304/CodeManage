 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:ISONavigationItem
 表名:ISONavigationItem(00050364)
 生成代码版本:2019.10.18.1
 生成日期:2019/10/18 10:35:04
 生成者:
...
public class ISONavigationItem : ISOControlEx
{
protected const int mintAttributeCount = 8;
public static string[] AttributeName = new string[] {"IsoNavigationItemId", "IsoNavigationItemName", "Text", "CssClass", "OnClick", "Style", "Width", "Height"};
//以下是属性变量

/// <summary>
/// Iso导航项Id(说明:;字段类型:char;字段长度:10;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsoNavigationItemId
{
get
{
return mstrIsoNavigationItemId;
}
set
{
if (value  ==  "")
{
 mstrIsoNavigationItemId = value;
}
else
{
 mstrIsoNavigationItemId = value;
...
/// <summary>
/// Iso导航项名(说明:;字段类型:varchar;字段长度:50;是否可空:False)
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string IsoNavigationItemName
{
get
{
return mstrIsoNavigationItemName;
}
set
{
if (value  ==  "")
{
 mstrIsoNavigationItemName = value;
}
else
{
 mstrIsoNavigationItemName = value;
...
get
{
if (strAttributeName  ==  con_IsoNavigationItemId)
{
return mstrIsoNavigationItemId;
}
else if (strAttributeName  ==  con_IsoNavigationItemName)
{
return mstrIsoNavigationItemName;
}
...
if (strAttributeName  ==  con_IsoNavigationItemId)
{
mstrIsoNavigationItemId = value.ToString();
}
else if (strAttributeName  ==  con_IsoNavigationItemName)
{
mstrIsoNavigationItemName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_IsoNavigationItemId  ==  AttributeName[intIndex])
{
return mstrIsoNavigationItemId;
}
else if (con_IsoNavigationItemName  ==  AttributeName[intIndex])
{
return mstrIsoNavigationItemName;
}
...
/// </summary>
 public ISONavigationItem()
 {
 }


 /// <summary>
 /// 常量:"IsoNavigationItemId"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_IsoNavigationItemId = "IsoNavigationItemId";    //Iso导航项Id

 /// <summary>
 /// 常量:"IsoNavigationItemName"
 /// (AGC.PureClassEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_IsoNavigationItemName = "IsoNavigationItemName";    //Iso导航项名
...
protected string mstrIsoNavigationItemId;    //Iso导航项Id
protected string mstrIsoNavigationItemName;    //Iso导航项名
