...
namespace AGC.PureClassEx
{
    public static class clsAndroidLinearLayoutBLEx_Static
    {
        ...
        public static void GeneCode(this AndroidLinearLayoutEx objAndroidLinearLayoutENEx, enumApplicationType intApplicationTypeId,
        ...
        public class clsAndroidLinearLayoutBLEx 
    {
        ...
        /// <param name="strCodeForCs"></param>
        public static void Gen_LvFieldAssignment(AndroidLinearLayoutEx objAndroidLinearLayoutENEx, clsViewInfoEN objViewInfoENEx,
            StringBuilder strCodeForCs)
        {
            //string strTemp = objAndroidLinearLayoutENEx.objQryRegionFldsEN.ObjFieldTab_PC().FldName;

            //strCodeForCs.AppendFormat("\r\n /// ({0})", clsStackTrace.GetCurrClassFunction());
            //strCodeForCs.AppendFormat("\r\n //设置{0}({1})的值", objAndroidLinearLayoutENEx.objQryRegionFldsEN.ObjFieldTab_PC().Caption,
            //    objAndroidLinearLayoutENEx.objQryRegionFldsEN.ObjFieldTab_PC().FldName);

            //strCodeForCs.AppendFormat("\r\n public void set{0}_q({1} value)", strTemp, objAndroidLinearLayoutENEx.objQryRegionFldsEN.ObjFieldTab_PC().ObjDataTypeAbbr_PC().JavaType);
            //strCodeForCs.Append("\r\n{");
            strCodeForCs.AppendFormat("\r\n" + "tv{1}.setText(obj{0}EN.get{1}());",
               objViewInfoENEx.ObjOutRelaTab().TabName,
               objAndroidLinearLayoutENEx.objDGRegionFldsEN.ObjFieldTab_PC().FldName);
            //strCodeForCs.Append("\r\n }");
        }
    }
}