    ...
    public class clsGetAssembly
    {
        ...
        public static Assembly GetWebServiceAssembly(string p_Url, string p_NameSpace)
        {
            try
            {
                ...
                System.CodeDom.CodeNamespace _CodeNameSpace = null;
                if (string.IsNullOrEmpty(p_NameSpace) == true)
                {
                    _CodeNameSpace = new System.CodeDom.CodeNamespace();
                }
                else
                {
                    _CodeNameSpace = new System.CodeDom.CodeNamespace(p_NameSpace);
                }               
