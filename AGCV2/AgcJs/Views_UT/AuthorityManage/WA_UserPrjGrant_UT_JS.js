...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 /// <summary>
 /// WA_UserPrjGrant_UT_JS 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewUTScriptCSRJ4JavaScript:GeneCode)
 /// </summary>
var WA_UserPrjGrant_UT_JS = /** @class */ (function() {
function WA_UserPrjGrant_UT_JS()
{
}
...
WA_UserPrjGrant_UT_JS.btnIsExist_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_UserPrjGrant_UT_JS.btnIsExist_Cache_Click = async function() {
$('#hidDivName').val("divIsExist_Cache");
var strKeyId = $('#txtstrKeyId2').val();
var lngmId = Number(strKeyId);
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.IsExist_Cache(lngmId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "关键字:[" +strKeyId + "] 的记录不存在!";
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_UserPrjGrant_UT_JS.btnIsExistRecord_Click = async function() {
$('#hidDivName').val("divIsExistRecord");
var strWhereCond = $('#txtstrWhereCond3').val();
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.IsExistRecord(strWhereCond);
var returnBool = responseText;
if (returnBool == false)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_UserPrjGrant_UT_JS.btnIsExistRecord_Cache_Click = async function() {
$('#hidDivName').val("divIsExistRecord_Cache");
var objTabName_Cond = $('#txtobjTabName_Cond4').val();
var objUserPrjGrant_Cond = new clsUserPrjGrantEN_js_1.clsUserPrjGrantEN();
var arrFldComparisonObj = WA_UserPrjGrant_UT_JS.GetLocalObjLst();
console.log("字段比较对象记录数(本地获取)：" + arrFldComparisonObj.length);
arrFldComparisonObj.forEach(x => { objUserPrjGrant_Cond.SetCondFldValue(x.FldName, x.FldValue, x.ComparisonOperator); });
var objUserPrjGrantEN_Sim = clsUserPrjGrantBL_js_1.clsUserPrjGrantBL.GetSimObjFromObj(objUserPrjGrant_Cond);
console.log(objUserPrjGrantEN_Sim);
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.IsExistRecord_Cache(objUserPrjGrant_Cond);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "根据条件:[" +JSON.stringify(objUserPrjGrant_Cond) + "]的记录不存在!";
...
{
var strInfo = "根据条件:[" +JSON.stringify(objUserPrjGrant_Cond) + "]的相关记录存在!";
$('#lblResult4').val(strInfo);
//显示信息框
alert(strInfo);
}
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_UserPrjGrant_UT_JS.btnGetRecCountByCond_Click = async function() {
$('#hidDivName').val("divGetRecCountByCond");
var strWhereCond = $('#txtstrWhereCond5').val();
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetRecCountByCond(strWhereCond);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_UserPrjGrant_UT_JS.btnGetRecCountByCond_Cache_Click = async function() {
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetRecCountByCond_Cache(objUserPrjGrant_Cond);
var returnInt = Number(responseText);
var strInfo = "根据条件:[" +JSON.stringify(objUserPrjGrant_Cond) + "]的记录数:" +returnInt + "!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnAddNewRecord_Click = async function() {
$('#hidDivName').val("divAddNewRecord");
var objUserPrjGrantEN = new clsUserPrjGrantEN_js_1.clsUserPrjGrantEN();
objUserPrjGrantEN.UserId = "111111111111111111";
objUserPrjGrantEN.PrjId = "1111";
objUserPrjGrantEN.RoleId = "11111111";
objUserPrjGrantEN.VisitedNum = 0;
objUserPrjGrantEN.LastVisitedDate = "11111111111111";
objUserPrjGrantEN.OptId = "111111111111111111";
objUserPrjGrantEN.OptDate = "11111111111111111111";
objUserPrjGrantEN.Memo = "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.IsExist(objUserPrjGrantEN.mId);
var bolIsExist = responseText;
if (bolIsExist == true)
{
var strMsg = "添加记录时，关键字：" +objUserPrjGrantEN.mId  + "已经存在！";
alert(strMsg);
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnAddNewRecord4GetMaxStrId_Click = async function() {
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.AddNewRecord(objUserPrjGrantEN);
var returnBool = responseText;
if (returnBool == true)
{
var strInfo = "添加记录成功!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetMaxStrId_Click = async function() {
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetMaxStrIdByPrefix_Click = async function() {
$('#hidDivName').val("divGetMaxStrIdByPrefix");
var strPrefix = $('#txtstrPrefix10').val();
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetMaxStrIdByPrefix(strPrefix);
var returnString = responseText.toString();
if (returnString == "")
{
var strInfo = "获取表UserPrjGrant的最大关键字为空，不成功，请检查!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnUpdateRecord_Click = async function() {
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnDelRecord_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnDelUserPrjGrants_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnDelMultiRecordByCond_Click = async function() {
$('#hidDivName').val("divDelMultiRecordByCond");
var strWhereCond = $('#txtstrWhereCond14').val();
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.DelUserPrjGrantsByCond(strWhereCond);
var returnInt = responseText;
if (returnInt > 0)
{
var strInfo = "删除记录成功,共删除" +returnInt + "条记录!";
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetFirstObj_Click = async function() {
$('#hidDivName').val("divGetFirstObj");
var strWhereCond = $('#txtstrWhereCond15').val();
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetFirstObj(strWhereCond);
var objUserPrjGrantEN = responseText;
strWhereCond = $('#txtstrWhereCond15').val();
var strInfo = "根据条件:[" +strWhereCond + "] 获取第一个记录对象：" +objUserPrjGrantEN.mId  + "!";
$('#lblResult15').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowUserPrjGrantObj("divList15", objUserPrjGrantEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjBymId_Click = async function() 
{
...
var objUserPrjGrantEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objUserPrjGrantEN.mId  + "!";
$('#lblResult16').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowUserPrjGrantObj("divList16", objUserPrjGrantEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjBymId_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjBymId_Cache(lngmId);
var objUserPrjGrantEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objUserPrjGrantEN.mId  + "!";
$('#lblResult17').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowUserPrjGrantObj("divList17", objUserPrjGrantEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjBymId_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjBymId_WA_Cache(lngmId);
var objUserPrjGrantEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objUserPrjGrantEN.mId  + "!";
$('#lblResult18').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowUserPrjGrantObj("divList18", objUserPrjGrantEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLst_Click = async function() 
{
$('#hidDivName').val("divGetObjLst");
var strWhereCond = $('#txtstrWhereCond19').val();
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLst(strWhereCond);
var arrUserPrjGrantObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "]共获取对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult19').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList19", arrUserPrjGrantObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByKeyLst_Click = async function() 
{
...
var arrUserPrjGrantObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult20').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList20", arrUserPrjGrantObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByKeyLst_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLstBymIdLst_Cache(arrmId);
var arrUserPrjGrantObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult21').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList21", arrUserPrjGrantObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByKeyLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLstBymIdLst_WA_Cache(arrmId);
var arrUserPrjGrantObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult22').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList22", arrUserPrjGrantObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetSubObjLst_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetSubObjLst_Cache(objUserPrjGrant_Cond);
var arrUserPrjGrantObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objUserPrjGrant_Cond) + "],共获取对象列表子集数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult23').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList23", arrUserPrjGrantObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetSubObjLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetSubObjLst_WA_Cache(objUserPrjGrant_Cond);
var arrUserPrjGrantObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objUserPrjGrant_Cond) + "],共获取对象列表子集数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult24').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList24", arrUserPrjGrantObjLst);
}
catch(e)
{
var strMsg = "根据条件对象获取相应的对象列表子集不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetTopObjLst_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetTopObjLst(objTopPara);
var arrUserPrjGrantObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],顶部数:[" +intTopSize + "]共获取顶部对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult25').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList25", arrUserPrjGrantObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByPager_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLstByPager(objPagerPara);
var arrUserPrjGrantObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult26').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList26", arrUserPrjGrantObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByPager_Cache_Click = async function() 
{
...
var objUserPrjGrantEN_Sim = clsUserPrjGrantBL_js_1.clsUserPrjGrantBL.GetSimObjFromObj(objUserPrjGrant_Cond);
console.log(objUserPrjGrantEN_Sim);
strWhereCond = JSON.stringify(objUserPrjGrantEN_Sim);
var objPagerPara = {
PageIndex: intPageIndex,
PageSize: intPageSize,
WhereCond: strWhereCond,
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLstByPager_Cache(objPagerPara);
var arrUserPrjGrantObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult27').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList27", arrUserPrjGrantObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByPager_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLstByPager_WA_Cache(objPagerPara);
var arrUserPrjGrantObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult28').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList28", arrUserPrjGrantObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.btnGetObjLstByRange_Click = async function() 
{
...
try
{
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLstByRange(objRangePara);
var arrUserPrjGrantObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],最小记录号:[" +intMinNum + "],最大记录号:[" +intMaxNum + "],共获取分页对象列表数：" +arrUserPrjGrantObjLst.length + "!";
$('#lblResult29').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_UserPrjGrant("divList29", arrUserPrjGrantObjLst);
}
catch(e)
{
...
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindTab(o, arrUserPrjGrantObjLst, sstrFldName, sstrColHeader, "mId"); 
}
 ...
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.ShowUserPrjGrantObj = function(divContainer, objUserPrjGrant) 
{
var o = document.getElementById(divContainer);
if (o == null)
{
...
o.appendChild(ul);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.AddDPV_FldComparison = function(divName4Edit) {
var objLst = document.getElementsByTagName("div");
var strStartName = "divEditFldComparison";
let arrElement = WA_UserPrjGrant_UT_JS.GetArray(objLst) ;
...
console.log(e);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.GetFldNameLst = function(func) {
var arrFldName = new clsUserPrjGrantEN_js_1.clsUserPrjGrantEN().AttributeName;
...
func(strFldNameLst1);
 ...
 /// </summary>
 /// <returns></returns>
   WA_UserPrjGrant_UT_JS.GetLocalObjLst = function() {
...
return arrFldComparisonObj;
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.CreateCache = async function() 
{
clsPubFun_js_1.clsPubFun.SetCommFun4BL();
var strKey = "";
try
{
console.log("开始获取缓存：UserPrjGrant");
strKey = clsUserPrjGrantEN_js_1.clsUserPrjGrantEN._CurrTabName;
const responseText = await clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.GetObjLst_Cache();
console.log("获取缓存完成！UserPrjGrant");
var arrUserPrjGrantObjLst = CacheHelper_js_1.CacheHelper.Get(strKey);
if (arrUserPrjGrantObjLst != null)
{
var strInfo = "建立缓存Key=[" +strKey + "]完成: 共获取对象列表数：" + arrUserPrjGrantObjLst.length  + "!";
...
console.log("WA_UserPrjGrant_UT_JS: CreateCache()不成功！");
console.log(e);
...
$('#lblPageStatusContent').html(strInfo);
 ...
 /// </summary>
 /// <returns></returns>
WA_UserPrjGrant_UT_JS.GetArray = function(arr) {
...
return WA_UserPrjGrant_UT_JS;
}());
exports.WA_UserPrjGrant_UT_JS = WA_UserPrjGrant_UT_JS;
});