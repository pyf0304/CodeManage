...
{
define(["require", "exports", "../../Js/L0_Entity/PrjInterface/clsvViewInfoEN.js","../../Js/L3_ForWApi/PrjInterface/clsvViewInfoWApi.js","../../Js/L2_BLL/PrjInterface/clsvViewInfoBL.js","clscommonfunc4web","../../Js/PubFun/stuTopPara.js","../../Js/PubFun/stuRangePara.js","../../Js/PubFun/stuPagerPara.js","../../Js/PubFun/clsPubFun.js","cachehelper","clsfldcomparisonobj"], factory);
}
...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 /// <summary>
 /// WA_vViewInfo_UT_JS 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewUTScriptCSRJ4JavaScript:GeneCode)
 /// </summary>
var WA_vViewInfo_UT_JS = /** @class */ (function() {
function WA_vViewInfo_UT_JS()
{
}
...
WA_vViewInfo_UT_JS.btnIsExist_Click = async function() {
$('#hidDivName').val("divIsExist");
var strKeyId = $('#txtstrKeyId1').val();
var strViewId = strKeyId;
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.IsExist(strViewId);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vViewInfo_UT_JS.btnIsExist_Cache_Click = async function() {
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.IsExist_Cache(strViewId, strPrjId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "关键字:[" +strKeyId + "] 的记录不存在!";
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vViewInfo_UT_JS.btnIsExistRecord_Click = async function() {
$('#hidDivName').val("divIsExistRecord");
var strWhereCond = $('#txtstrWhereCond3').val();
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.IsExistRecord(strWhereCond);
var returnBool = responseText;
if (returnBool == false)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vViewInfo_UT_JS.btnIsExistRecord_Cache_Click = async function() {
$('#hidDivName').val("divIsExistRecord_Cache");
var objTabName_Cond = $('#txtobjTabName_Cond4').val();
var objvViewInfo_Cond = new clsvViewInfoEN_js_1.clsvViewInfoEN();
objvViewInfo_Cond.SetCondFldValue(clsvViewInfoEN_js_1.clsvViewInfoEN.con_PrjId,"0001", "=");
var arrFldComparisonObj = WA_vViewInfo_UT_JS.GetLocalObjLst();
console.log("字段比较对象记录数(本地获取)：" + arrFldComparisonObj.length);
arrFldComparisonObj.forEach(x => { objvViewInfo_Cond.SetCondFldValue(x.FldName, x.FldValue, x.ComparisonOperator); });
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.IsExistRecord_Cache(objvViewInfo_Cond, strPrjId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "根据条件:[" +JSON.stringify(objvViewInfo_Cond) + "]的记录不存在!";
...
{
var strInfo = "根据条件:[" +JSON.stringify(objvViewInfo_Cond) + "]的相关记录存在!";
$('#lblResult4').val(strInfo);
//显示信息框
alert(strInfo);
}
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vViewInfo_UT_JS.btnGetRecCountByCond_Click = async function() {
$('#hidDivName').val("divGetRecCountByCond");
var strWhereCond = $('#txtstrWhereCond5').val();
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetRecCountByCond(strWhereCond);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vViewInfo_UT_JS.btnGetRecCountByCond_Cache_Click = async function() {
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetRecCountByCond_Cache(objvViewInfo_Cond, strPrjId);
var returnInt = Number(responseText);
var strInfo = "根据条件:[" +JSON.stringify(objvViewInfo_Cond) + "]的记录数:" +returnInt + "!";
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetFirstObj_Click = async function() {
$('#hidDivName').val("divGetFirstObj");
var strWhereCond = $('#txtstrWhereCond15').val();
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetFirstObj(strWhereCond);
var objvViewInfoEN = responseText;
strWhereCond = $('#txtstrWhereCond15').val();
var strInfo = "根据条件:[" +strWhereCond + "] 获取第一个记录对象：" +objvViewInfoEN.ViewId  + "!";
$('#lblResult15').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvViewInfoObj("divList15", objvViewInfoEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjByViewId_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjByViewId(strViewId);
var objvViewInfoEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objvViewInfoEN.ViewId  + "!";
$('#lblResult16').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvViewInfoObj("divList16", objvViewInfoEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjByViewId_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjByViewId_Cache(strViewId, strPrjId);
var objvViewInfoEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objvViewInfoEN.ViewId  + "!";
$('#lblResult17').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvViewInfoObj("divList17", objvViewInfoEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjByViewId_WA_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjByViewId_WA_Cache(strViewId, strPrjId);
var objvViewInfoEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objvViewInfoEN.ViewId  + "!";
$('#lblResult18').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvViewInfoObj("divList18", objvViewInfoEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLst_Click = async function() 
{
$('#hidDivName').val("divGetObjLst");
var strWhereCond = $('#txtstrWhereCond19').val();
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLst(strWhereCond);
var arrvViewInfoObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "]共获取对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult19').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList19", arrvViewInfoObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByKeyLst_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByViewIdLst(arrViewId);
var arrvViewInfoObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult20').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList20", arrvViewInfoObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByKeyLst_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByViewIdLst_Cache(arrViewId, strPrjId);
var arrvViewInfoObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult21').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList21", arrvViewInfoObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByKeyLst_WA_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByViewIdLst_WA_Cache(arrViewId, strPrjId);
var arrvViewInfoObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult22').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList22", arrvViewInfoObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetSubObjLst_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetSubObjLst_Cache(objvViewInfo_Cond, strPrjId);
var arrvViewInfoObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objvViewInfo_Cond) + "],共获取对象列表子集数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult23').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList23", arrvViewInfoObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetSubObjLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetSubObjLst_WA_Cache(objvViewInfo_Cond);
var arrvViewInfoObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objvViewInfo_Cond) + "],共获取对象列表子集数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult24').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList24", arrvViewInfoObjLst);
}
catch(e)
{
var strMsg = "根据条件对象获取相应的对象列表子集不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetTopObjLst_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetTopObjLst(objTopPara);
var arrvViewInfoObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],顶部数:[" +intTopSize + "]共获取顶部对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult25').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList25", arrvViewInfoObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByPager_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByPager(objPagerPara);
var arrvViewInfoObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult26').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList26", arrvViewInfoObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByPager_Cache_Click = async function() 
{
...
var objvViewInfoEN_Sim = clsvViewInfoBL_js_1.clsvViewInfoBL.GetSimObjFromObj(objvViewInfo_Cond);
console.log(objvViewInfoEN_Sim);
strWhereCond = JSON.stringify(objvViewInfoEN_Sim);
var objPagerPara = {
PageIndex: intPageIndex,
PageSize: intPageSize,
WhereCond: strWhereCond,
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByPager_Cache(objPagerPara, strPrjId);
var arrvViewInfoObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult27').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList27", arrvViewInfoObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByPager_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByPager_WA_Cache(objPagerPara);
var arrvViewInfoObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult28').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList28", arrvViewInfoObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.btnGetObjLstByRange_Click = async function() 
{
...
try
{
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLstByRange(objRangePara);
var arrvViewInfoObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],最小记录号:[" +intMinNum + "],最大记录号:[" +intMaxNum + "],共获取分页对象列表数：" +arrvViewInfoObjLst.length + "!";
$('#lblResult29').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vViewInfo("divList29", arrvViewInfoObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "arrvViewInfoObjLst">需要绑定的对象列表</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.BindTab_vViewInfo = function(divContainer, arrvViewInfoObjLst) 
{
...
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindTab(o, arrvViewInfoObjLst, sstrFldName, sstrColHeader, "ViewId"); 
}
 ...
 /// </summary>
 /// <param name = "divContainer">显示容器</param>
 /// <param name = "objvViewInfo">需要显示的对象</param>
 /// <returns></returns>
WA_vViewInfo_UT_JS.ShowvViewInfoObj = function(divContainer, objvViewInfo) 
{
var o = document.getElementById(divContainer);
if (o == null)
{
...
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objvViewInfo);
var ul = document.createElement("ul");
for (let strKey of sstrKeys)
{
var strValue = objvViewInfo[strKey];
...
o.appendChild(ul);
 ...
 /// </summary>
 /// <returns></returns>
WA_vViewInfo_UT_JS.AddDPV_FldComparison = function(divName4Edit) {
var objLst = document.getElementsByTagName("div");
var strStartName = "divEditFldComparison";
let arrElement = WA_vViewInfo_UT_JS.GetArray(objLst) ;
...
console.log(e);
 ...
 /// </summary>
 /// <returns></returns>
WA_vViewInfo_UT_JS.GetFldNameLst = function(func) {
var arrFldName = new clsvViewInfoEN_js_1.clsvViewInfoEN().AttributeName;
...
func(strFldNameLst1);
 ...
 /// </summary>
 /// <returns></returns>
   WA_vViewInfo_UT_JS.GetLocalObjLst = function() {
...
return arrFldComparisonObj;
 ...
 /// </summary>
 /// <returns></returns>
WA_vViewInfo_UT_JS.CreateCache = async function() 
{
clsPubFun_js_1.clsPubFun.SetCommFun4BL();
var strKey = "";
try
{
console.log("开始获取缓存：vViewInfo");
var strPrjId = "0001";
var strKey =  clsvViewInfoEN_js_1.clsvViewInfoEN._CurrTabName + "_" + strPrjId ;
const responseText = await clsvViewInfoWApi_js_1.clsvViewInfoWApi.GetObjLst_Cache(strPrjId);
console.log("获取缓存完成！vViewInfo");
var arrvViewInfoObjLst = CacheHelper_js_1.CacheHelper.Get(strKey);
if (arrvViewInfoObjLst != null)
{
var strInfo = "建立缓存Key=[" +strKey + "]完成: 共获取对象列表数：" + arrvViewInfoObjLst.length  + "!";
...
console.log("WA_vViewInfo_UT_JS: CreateCache()不成功！");
console.log(e);
...
$('#lblPageStatusContent').html(strInfo);
 ...
 /// </summary>
 /// <returns></returns>
WA_vViewInfo_UT_JS.GetArray = function(arr) {
...
return WA_vViewInfo_UT_JS;
}());
exports.WA_vViewInfo_UT_JS = WA_vViewInfo_UT_JS;
});