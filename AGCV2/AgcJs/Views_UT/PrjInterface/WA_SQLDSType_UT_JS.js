...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 /// <summary>
 /// WA_SQLDSType_UT_JS 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewUTScriptCSRJ4JavaScript:GeneCode)
 /// </summary>
var WA_SQLDSType_UT_JS = /** @class */ (function() {
function WA_SQLDSType_UT_JS()
{
}
...
WA_SQLDSType_UT_JS.btnIsExist_Click = async function() {
$('#hidDivName').val("divIsExist");
var strKeyId = $('#txtstrKeyId1').val();
var strSQLDSTypeId = strKeyId;
try
{
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_SQLDSType_UT_JS.btnIsExist_Cache_Click = async function() {
$('#hidDivName').val("divIsExist_Cache");
var strKeyId = $('#txtstrKeyId2').val();
var strSQLDSTypeId = strKeyId;
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.IsExist_Cache(strSQLDSTypeId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "关键字:[" +strKeyId + "] 的记录不存在!";
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_SQLDSType_UT_JS.btnIsExistRecord_Click = async function() {
$('#hidDivName').val("divIsExistRecord");
var strWhereCond = $('#txtstrWhereCond3').val();
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.IsExistRecord(strWhereCond);
var returnBool = responseText;
if (returnBool == false)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_SQLDSType_UT_JS.btnIsExistRecord_Cache_Click = async function() {
...
var arrFldComparisonObj = WA_SQLDSType_UT_JS.GetLocalObjLst();
console.log("字段比较对象记录数(本地获取)：" + arrFldComparisonObj.length);
arrFldComparisonObj.forEach(x => { objSQLDSType_Cond.SetCondFldValue(x.FldName, x.FldValue, x.ComparisonOperator); });
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.IsExistRecord_Cache(objSQLDSType_Cond);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "根据条件:[" +JSON.stringify(objSQLDSType_Cond) + "]的记录不存在!";
...
{
var strInfo = "根据条件:[" +JSON.stringify(objSQLDSType_Cond) + "]的相关记录存在!";
$('#lblResult4').val(strInfo);
//显示信息框
alert(strInfo);
}
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_SQLDSType_UT_JS.btnGetRecCountByCond_Click = async function() {
$('#hidDivName').val("divGetRecCountByCond");
var strWhereCond = $('#txtstrWhereCond5').val();
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetRecCountByCond(strWhereCond);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_SQLDSType_UT_JS.btnGetRecCountByCond_Cache_Click = async function() {
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetRecCountByCond_Cache(objSQLDSType_Cond);
var returnInt = Number(responseText);
var strInfo = "根据条件:[" +JSON.stringify(objSQLDSType_Cond) + "]的记录数:" +returnInt + "!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnAddNewRecord_Click = async function() {
$('#hidDivName').val("divAddNewRecord");
var objSQLDSTypeEN = new clsSQLDSTypeEN_js_1.clsSQLDSTypeEN();
objSQLDSTypeEN.SQLDSTypeId = "11";
objSQLDSTypeEN.SqlDsTypeName = "11111111111111111111";
objSQLDSTypeEN.SqlDsTypeENName = "11111111111111111111111111111111111111111111111111";
objSQLDSTypeEN.Memo = "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
try
{
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnAddNewRecord4GetMaxStrId_Click = async function() {
...
var objSQLDSTypeEN = new clsSQLDSTypeEN_js_1.clsSQLDSTypeEN();
objSQLDSTypeEN.SQLDSTypeId = returnString;
objSQLDSTypeEN.SqlDsTypeName = "11111111111111111111";
objSQLDSTypeEN.SqlDsTypeENName = "11111111111111111111111111111111111111111111111111";
objSQLDSTypeEN.Memo = "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.AddNewRecord(objSQLDSTypeEN);
var returnBool = responseText;
if (returnBool == true)
{
var strInfo = "添加记录成功!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetMaxStrId_Click = async function() {
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetMaxStrIdByPrefix_Click = async function() {
$('#hidDivName').val("divGetMaxStrIdByPrefix");
var strPrefix = $('#txtstrPrefix10').val();
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetMaxStrIdByPrefix(strPrefix);
var returnString = responseText.toString();
if (returnString == "")
{
var strInfo = "获取表SQLDSType的最大关键字为空，不成功，请检查!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnUpdateRecord_Click = async function() {
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnDelRecord_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnDelSQLDSTypes_Click = async function() {
$('#hidDivName').val("divDel[TabName]s");
var strKeyIdLst = $('#txtarrKeyId13').val();
var arrSQLDSTypeId = strKeyIdLst.split(',');
try
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnDelMultiRecordByCond_Click = async function() {
$('#hidDivName').val("divDelMultiRecordByCond");
var strWhereCond = $('#txtstrWhereCond14').val();
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.DelSQLDSTypesByCond(strWhereCond);
var returnInt = responseText;
if (returnInt > 0)
{
var strInfo = "删除记录成功,共删除" +returnInt + "条记录!";
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetFirstObj_Click = async function() {
$('#hidDivName').val("divGetFirstObj");
var strWhereCond = $('#txtstrWhereCond15').val();
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetFirstObj(strWhereCond);
var objSQLDSTypeEN = responseText;
strWhereCond = $('#txtstrWhereCond15').val();
var strInfo = "根据条件:[" +strWhereCond + "] 获取第一个记录对象：" +objSQLDSTypeEN.SQLDSTypeId  + "!";
$('#lblResult15').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowSQLDSTypeObj("divList15", objSQLDSTypeEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjBySQLDSTypeId_Click = async function() 
{
...
var objSQLDSTypeEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objSQLDSTypeEN.SQLDSTypeId  + "!";
$('#lblResult16').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowSQLDSTypeObj("divList16", objSQLDSTypeEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjBySQLDSTypeId_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjBySQLDSTypeId_Cache(strSQLDSTypeId);
var objSQLDSTypeEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objSQLDSTypeEN.SQLDSTypeId  + "!";
$('#lblResult17').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowSQLDSTypeObj("divList17", objSQLDSTypeEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjBySQLDSTypeId_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjBySQLDSTypeId_WA_Cache(strSQLDSTypeId);
var objSQLDSTypeEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objSQLDSTypeEN.SQLDSTypeId  + "!";
$('#lblResult18').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowSQLDSTypeObj("divList18", objSQLDSTypeEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLst_Click = async function() 
{
$('#hidDivName').val("divGetObjLst");
var strWhereCond = $('#txtstrWhereCond19').val();
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLst(strWhereCond);
var arrSQLDSTypeObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "]共获取对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult19').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList19", arrSQLDSTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByKeyLst_Click = async function() 
{
...
var arrSQLDSTypeObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult20').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList20", arrSQLDSTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByKeyLst_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLstBySQLDSTypeIdLst_Cache(arrSQLDSTypeId);
var arrSQLDSTypeObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult21').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList21", arrSQLDSTypeObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByKeyLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLstBySQLDSTypeIdLst_WA_Cache(arrSQLDSTypeId);
var arrSQLDSTypeObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult22').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList22", arrSQLDSTypeObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetSubObjLst_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetSubObjLst_Cache(objSQLDSType_Cond);
var arrSQLDSTypeObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objSQLDSType_Cond) + "],共获取对象列表子集数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult23').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList23", arrSQLDSTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetSubObjLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetSubObjLst_WA_Cache(objSQLDSType_Cond);
var arrSQLDSTypeObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objSQLDSType_Cond) + "],共获取对象列表子集数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult24').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList24", arrSQLDSTypeObjLst);
}
catch(e)
{
var strMsg = "根据条件对象获取相应的对象列表子集不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetTopObjLst_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetTopObjLst(objTopPara);
var arrSQLDSTypeObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],顶部数:[" +intTopSize + "]共获取顶部对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult25').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList25", arrSQLDSTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByPager_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLstByPager(objPagerPara);
var arrSQLDSTypeObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult26').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList26", arrSQLDSTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByPager_Cache_Click = async function() 
{
...
var objSQLDSTypeEN_Sim = clsSQLDSTypeBL_js_1.clsSQLDSTypeBL.GetSimObjFromObj(objSQLDSType_Cond);
console.log(objSQLDSTypeEN_Sim);
strWhereCond = JSON.stringify(objSQLDSTypeEN_Sim);
var objPagerPara = {
PageIndex: intPageIndex,
PageSize: intPageSize,
WhereCond: strWhereCond,
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLstByPager_Cache(objPagerPara);
var arrSQLDSTypeObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult27').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList27", arrSQLDSTypeObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByPager_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLstByPager_WA_Cache(objPagerPara);
var arrSQLDSTypeObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult28').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList28", arrSQLDSTypeObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_SQLDSType_UT_JS.btnGetObjLstByRange_Click = async function() 
{
...
try
{
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLstByRange(objRangePara);
var arrSQLDSTypeObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],最小记录号:[" +intMinNum + "],最大记录号:[" +intMaxNum + "],共获取分页对象列表数：" +arrSQLDSTypeObjLst.length + "!";
$('#lblResult29').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_SQLDSType("divList29", arrSQLDSTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_SQLDSType_UT_JS.BindTab_SQLDSType = function(divContainer, arrSQLDSTypeObjLst) 
{
...
sstrFldName.push("SqlDsTypeENName"); sstrColHeader.push("Sql数据源英文名");
sstrFldName.push("Memo"); sstrColHeader.push("说明");
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindTab(o, arrSQLDSTypeObjLst, sstrFldName, sstrColHeader, "SQLDSTypeId"); 
}
 ...
 /// <returns></returns>
WA_SQLDSType_UT_JS.ShowSQLDSTypeObj = function(divContainer, objSQLDSType) 
{
var o = document.getElementById(divContainer);
if (o == null)
{
...
o.appendChild(ul);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.AddDPV_FldComparison = function(divName4Edit) {
var objLst = document.getElementsByTagName("div");
var strStartName = "divEditFldComparison";
let arrElement = WA_SQLDSType_UT_JS.GetArray(objLst) ;
...
console.log(e);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.GetFldNameLst = function(func) {
var arrFldName = new clsSQLDSTypeEN_js_1.clsSQLDSTypeEN().AttributeName;
...
func(strFldNameLst1);
 ...
 /// </summary>
 /// <returns></returns>
   WA_SQLDSType_UT_JS.GetLocalObjLst = function() {
...
return arrFldComparisonObj;
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.CreateCache = async function() 
{
clsPubFun_js_1.clsPubFun.SetCommFun4BL();
var strKey = "";
try
{
console.log("开始获取缓存：SQLDSType");
strKey = clsSQLDSTypeEN_js_1.clsSQLDSTypeEN._CurrTabName;
const responseText = await clsSQLDSTypeWApi_js_1.clsSQLDSTypeWApi.GetObjLst_Cache();
console.log("获取缓存完成！SQLDSType");
var arrSQLDSTypeObjLst = CacheHelper_js_1.CacheHelper.Get(strKey);
if (arrSQLDSTypeObjLst != null)
{
var strInfo = "建立缓存Key=[" +strKey + "]完成: 共获取对象列表数：" + arrSQLDSTypeObjLst.length  + "!";
...
console.log("WA_SQLDSType_UT_JS: CreateCache()不成功！");
console.log(e);
...
$('#lblPageStatusContent').html(strInfo);
 ...
 /// </summary>
 /// <returns></returns>
WA_SQLDSType_UT_JS.GetArray = function(arr) {
...
return WA_SQLDSType_UT_JS;
}());
exports.WA_SQLDSType_UT_JS = WA_SQLDSType_UT_JS;
});