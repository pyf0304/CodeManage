...
{
define(["require", "exports", "../../Js/L0_Entity/RegionManage/clsvQryRegionFldsEN.js","../../Js/L3_ForWApi/RegionManage/clsvQryRegionFldsWApi.js","../../Js/L2_BLL/RegionManage/clsvQryRegionFldsBL.js","clscommonfunc4web","../../Js/PubFun/stuTopPara.js","../../Js/PubFun/stuRangePara.js","../../Js/PubFun/stuPagerPara.js","../../Js/PubFun/clsPubFun.js","cachehelper","clsfldcomparisonobj"], factory);
}
...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 /// <summary>
 /// WA_vQryRegionFlds_UT_JS 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewUTScriptCSRJ4JavaScript:GeneCode)
 /// </summary>
var WA_vQryRegionFlds_UT_JS = /** @class */ (function() {
function WA_vQryRegionFlds_UT_JS()
{
}
...
WA_vQryRegionFlds_UT_JS.btnIsExist_Click = async function() {
$('#hidDivName').val("divIsExist");
var strKeyId = $('#txtstrKeyId1').val();
var lngmId = Number(strKeyId);
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.IsExist(lngmId);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vQryRegionFlds_UT_JS.btnIsExist_Cache_Click = async function() {
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.IsExist_Cache(lngmId, strPrjId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "关键字:[" +strKeyId + "] 的记录不存在!";
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vQryRegionFlds_UT_JS.btnIsExistRecord_Click = async function() {
$('#hidDivName').val("divIsExistRecord");
var strWhereCond = $('#txtstrWhereCond3').val();
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.IsExistRecord(strWhereCond);
var returnBool = responseText;
if (returnBool == false)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vQryRegionFlds_UT_JS.btnIsExistRecord_Cache_Click = async function() {
$('#hidDivName').val("divIsExistRecord_Cache");
var objTabName_Cond = $('#txtobjTabName_Cond4').val();
var objvQryRegionFlds_Cond = new clsvQryRegionFldsEN_js_1.clsvQryRegionFldsEN();
objvQryRegionFlds_Cond.SetCondFldValue(clsvQryRegionFldsEN_js_1.clsvQryRegionFldsEN.con_PrjId,"0001", "=");
var arrFldComparisonObj = WA_vQryRegionFlds_UT_JS.GetLocalObjLst();
console.log("字段比较对象记录数(本地获取)：" + arrFldComparisonObj.length);
arrFldComparisonObj.forEach(x => { objvQryRegionFlds_Cond.SetCondFldValue(x.FldName, x.FldValue, x.ComparisonOperator); });
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.IsExistRecord_Cache(objvQryRegionFlds_Cond, strPrjId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "根据条件:[" +JSON.stringify(objvQryRegionFlds_Cond) + "]的记录不存在!";
...
{
var strInfo = "根据条件:[" +JSON.stringify(objvQryRegionFlds_Cond) + "]的相关记录存在!";
$('#lblResult4').val(strInfo);
//显示信息框
alert(strInfo);
}
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vQryRegionFlds_UT_JS.btnGetRecCountByCond_Click = async function() {
$('#hidDivName').val("divGetRecCountByCond");
var strWhereCond = $('#txtstrWhereCond5').val();
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetRecCountByCond(strWhereCond);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_vQryRegionFlds_UT_JS.btnGetRecCountByCond_Cache_Click = async function() {
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetRecCountByCond_Cache(objvQryRegionFlds_Cond, strPrjId);
var returnInt = Number(responseText);
var strInfo = "根据条件:[" +JSON.stringify(objvQryRegionFlds_Cond) + "]的记录数:" +returnInt + "!";
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetFirstObj_Click = async function() {
$('#hidDivName').val("divGetFirstObj");
var strWhereCond = $('#txtstrWhereCond15').val();
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetFirstObj(strWhereCond);
var objvQryRegionFldsEN = responseText;
strWhereCond = $('#txtstrWhereCond15').val();
var strInfo = "根据条件:[" +strWhereCond + "] 获取第一个记录对象：" +objvQryRegionFldsEN.mId  + "!";
$('#lblResult15').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvQryRegionFldsObj("divList15", objvQryRegionFldsEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjBymId_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjBymId(lngmId);
var objvQryRegionFldsEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objvQryRegionFldsEN.mId  + "!";
$('#lblResult16').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvQryRegionFldsObj("divList16", objvQryRegionFldsEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjBymId_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjBymId_Cache(lngmId, strPrjId);
var objvQryRegionFldsEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objvQryRegionFldsEN.mId  + "!";
$('#lblResult17').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvQryRegionFldsObj("divList17", objvQryRegionFldsEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjBymId_WA_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjBymId_WA_Cache(lngmId, strPrjId);
var objvQryRegionFldsEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objvQryRegionFldsEN.mId  + "!";
$('#lblResult18').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowvQryRegionFldsObj("divList18", objvQryRegionFldsEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLst_Click = async function() 
{
$('#hidDivName').val("divGetObjLst");
var strWhereCond = $('#txtstrWhereCond19').val();
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLst(strWhereCond);
var arrvQryRegionFldsObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "]共获取对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult19').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList19", arrvQryRegionFldsObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByKeyLst_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstBymIdLst(arrmId);
var arrvQryRegionFldsObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult20').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList20", arrvQryRegionFldsObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByKeyLst_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstBymIdLst_Cache(arrmId, strPrjId);
var arrvQryRegionFldsObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult21').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList21", arrvQryRegionFldsObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByKeyLst_WA_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstBymIdLst_WA_Cache(arrmId, strPrjId);
var arrvQryRegionFldsObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult22').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList22", arrvQryRegionFldsObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetSubObjLst_Cache_Click = async function() 
{
...
{
var strPrjId = "0001";
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetSubObjLst_Cache(objvQryRegionFlds_Cond, strPrjId);
var arrvQryRegionFldsObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objvQryRegionFlds_Cond) + "],共获取对象列表子集数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult23').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList23", arrvQryRegionFldsObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetSubObjLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetSubObjLst_WA_Cache(objvQryRegionFlds_Cond);
var arrvQryRegionFldsObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objvQryRegionFlds_Cond) + "],共获取对象列表子集数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult24').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList24", arrvQryRegionFldsObjLst);
}
catch(e)
{
var strMsg = "根据条件对象获取相应的对象列表子集不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetTopObjLst_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetTopObjLst(objTopPara);
var arrvQryRegionFldsObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],顶部数:[" +intTopSize + "]共获取顶部对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult25').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList25", arrvQryRegionFldsObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByPager_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstByPager(objPagerPara);
var arrvQryRegionFldsObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult26').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList26", arrvQryRegionFldsObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByPager_Cache_Click = async function() 
{
...
var objvQryRegionFldsEN_Sim = clsvQryRegionFldsBL_js_1.clsvQryRegionFldsBL.GetSimObjFromObj(objvQryRegionFlds_Cond);
console.log(objvQryRegionFldsEN_Sim);
strWhereCond = JSON.stringify(objvQryRegionFldsEN_Sim);
var objPagerPara = {
PageIndex: intPageIndex,
PageSize: intPageSize,
WhereCond: strWhereCond,
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstByPager_Cache(objPagerPara, strPrjId);
var arrvQryRegionFldsObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult27').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList27", arrvQryRegionFldsObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByPager_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstByPager_WA_Cache(objPagerPara);
var arrvQryRegionFldsObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult28').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList28", arrvQryRegionFldsObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.btnGetObjLstByRange_Click = async function() 
{
...
try
{
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLstByRange(objRangePara);
var arrvQryRegionFldsObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],最小记录号:[" +intMinNum + "],最大记录号:[" +intMaxNum + "],共获取分页对象列表数：" +arrvQryRegionFldsObjLst.length + "!";
$('#lblResult29').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_vQryRegionFlds("divList29", arrvQryRegionFldsObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "arrvQryRegionFldsObjLst">需要绑定的对象列表</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.BindTab_vQryRegionFlds = function(divContainer, arrvQryRegionFldsObjLst) 
{
...
sstrFldName.push("RelaTabId"); sstrColHeader.push("RelaTabId");
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindTab(o, arrvQryRegionFldsObjLst, sstrFldName, sstrColHeader, "mId"); 
}
 ...
 /// </summary>
 /// <param name = "divContainer">显示容器</param>
 /// <param name = "objvQryRegionFlds">需要显示的对象</param>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.ShowvQryRegionFldsObj = function(divContainer, objvQryRegionFlds) 
{
var o = document.getElementById(divContainer);
if (o == null)
{
...
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objvQryRegionFlds);
var ul = document.createElement("ul");
for (let strKey of sstrKeys)
{
var strValue = objvQryRegionFlds[strKey];
...
o.appendChild(ul);
 ...
 /// </summary>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.AddDPV_FldComparison = function(divName4Edit) {
var objLst = document.getElementsByTagName("div");
var strStartName = "divEditFldComparison";
let arrElement = WA_vQryRegionFlds_UT_JS.GetArray(objLst) ;
...
console.log(e);
 ...
 /// </summary>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.GetFldNameLst = function(func) {
var arrFldName = new clsvQryRegionFldsEN_js_1.clsvQryRegionFldsEN().AttributeName;
...
func(strFldNameLst1);
 ...
 /// </summary>
 /// <returns></returns>
   WA_vQryRegionFlds_UT_JS.GetLocalObjLst = function() {
...
return arrFldComparisonObj;
 ...
 /// </summary>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.CreateCache = async function() 
{
clsPubFun_js_1.clsPubFun.SetCommFun4BL();
var strKey = "";
try
{
console.log("开始获取缓存：vQryRegionFlds");
var strPrjId = "0001";
var strKey =  clsvQryRegionFldsEN_js_1.clsvQryRegionFldsEN._CurrTabName + "_" + strPrjId ;
const responseText = await clsvQryRegionFldsWApi_js_1.clsvQryRegionFldsWApi.GetObjLst_Cache(strPrjId);
console.log("获取缓存完成！vQryRegionFlds");
var arrvQryRegionFldsObjLst = CacheHelper_js_1.CacheHelper.Get(strKey);
if (arrvQryRegionFldsObjLst != null)
{
var strInfo = "建立缓存Key=[" +strKey + "]完成: 共获取对象列表数：" + arrvQryRegionFldsObjLst.length  + "!";
...
console.log("WA_vQryRegionFlds_UT_JS: CreateCache()不成功！");
console.log(e);
...
$('#lblPageStatusContent').html(strInfo);
 ...
 /// </summary>
 /// <returns></returns>
WA_vQryRegionFlds_UT_JS.GetArray = function(arr) {
...
return WA_vQryRegionFlds_UT_JS;
}());
exports.WA_vQryRegionFlds_UT_JS = WA_vQryRegionFlds_UT_JS;
});