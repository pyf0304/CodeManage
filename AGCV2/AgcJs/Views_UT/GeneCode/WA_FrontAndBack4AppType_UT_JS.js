 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:WA_FrontAndBack4AppType_UT_JS
 表名:FrontAndBack4AppType(00050423)
 生成代码版本:2020.05.01.1
 生成日期:2020/05/01 02:49:54
 生成者:
 工程名称:AGC
 工程ID:0005
...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 /// <summary>
 /// WA_FrontAndBack4AppType_UT_JS 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewUTScriptCSRJ4JavaScript:GeneCode)
 /// </summary>
var WA_FrontAndBack4AppType_UT_JS = /** @class */ (function() {
function WA_FrontAndBack4AppType_UT_JS()
{
}
...
WA_FrontAndBack4AppType_UT_JS.btnIsExist_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_FrontAndBack4AppType_UT_JS.btnIsExist_Cache_Click = async function() {
$('#hidDivName').val("divIsExist_Cache");
var strKeyId = $('#txtstrKeyId2').val();
var lngmId = Number(strKeyId);
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.IsExist_Cache(lngmId);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "关键字:[" +strKeyId + "] 的记录不存在!";
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_FrontAndBack4AppType_UT_JS.btnIsExistRecord_Click = async function() {
$('#hidDivName').val("divIsExistRecord");
var strWhereCond = $('#txtstrWhereCond3').val();
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.IsExistRecord(strWhereCond);
var returnBool = responseText;
if (returnBool == false)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_FrontAndBack4AppType_UT_JS.btnIsExistRecord_Cache_Click = async function() {
$('#hidDivName').val("divIsExistRecord_Cache");
var objTabName_Cond = $('#txtobjTabName_Cond4').val();
var objFrontAndBack4AppType_Cond = new clsFrontAndBack4AppTypeEN_js_1.clsFrontAndBack4AppTypeEN();
var arrFldComparisonObj = WA_FrontAndBack4AppType_UT_JS.GetLocalObjLst();
console.log("字段比较对象记录数(本地获取)：" + arrFldComparisonObj.length);
arrFldComparisonObj.forEach(x => { objFrontAndBack4AppType_Cond.SetCondFldValue(x.FldName, x.FldValue, x.ComparisonOperator); });
var objFrontAndBack4AppTypeEN_Sim = clsFrontAndBack4AppTypeBL_js_1.clsFrontAndBack4AppTypeBL.GetSimObjFromObj(objFrontAndBack4AppType_Cond);
console.log(objFrontAndBack4AppTypeEN_Sim);
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.IsExistRecord_Cache(objFrontAndBack4AppType_Cond);
var returnBool = responseText;
if (returnBool == false)
{
var strInfo = "根据条件:[" +JSON.stringify(objFrontAndBack4AppType_Cond) + "]的记录不存在!";
...
{
var strInfo = "根据条件:[" +JSON.stringify(objFrontAndBack4AppType_Cond) + "]的相关记录存在!";
$('#lblResult4').val(strInfo);
//显示信息框
alert(strInfo);
}
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_FrontAndBack4AppType_UT_JS.btnGetRecCountByCond_Click = async function() {
$('#hidDivName').val("divGetRecCountByCond");
var strWhereCond = $('#txtstrWhereCond5').val();
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetRecCountByCond(strWhereCond);
...
alert(strMsg);
 ...
 /// <param name = "sender">发送者</param>
 /// <returns>返回是否存在</returns>
WA_FrontAndBack4AppType_UT_JS.btnGetRecCountByCond_Cache_Click = async function() {
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetRecCountByCond_Cache(objFrontAndBack4AppType_Cond);
var returnInt = Number(responseText);
var strInfo = "根据条件:[" +JSON.stringify(objFrontAndBack4AppType_Cond) + "]的记录数:" +returnInt + "!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnAddNewRecord_Click = async function() {
$('#hidDivName').val("divAddNewRecord");
var objFrontAndBack4AppTypeEN = new clsFrontAndBack4AppTypeEN_js_1.clsFrontAndBack4AppTypeEN();
objFrontAndBack4AppTypeEN.AppTypeId4Front = 0;
objFrontAndBack4AppTypeEN.AppTypeId4Back = 0;
objFrontAndBack4AppTypeEN.UpdDate = "11111111111111111111";
objFrontAndBack4AppTypeEN.UpdUser = "11111111111111111111";
objFrontAndBack4AppTypeEN.Memo = "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.IsExist(objFrontAndBack4AppTypeEN.mId);
var bolIsExist = responseText;
if (bolIsExist == true)
{
var strMsg = "添加记录时，关键字：" +objFrontAndBack4AppTypeEN.mId  + "已经存在！";
alert(strMsg);
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnAddNewRecord4GetMaxStrId_Click = async function() {
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.AddNewRecord(objFrontAndBack4AppTypeEN);
var returnBool = responseText;
if (returnBool == true)
{
var strInfo = "添加记录成功!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetMaxStrId_Click = async function() {
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetMaxStrIdByPrefix_Click = async function() {
$('#hidDivName').val("divGetMaxStrIdByPrefix");
var strPrefix = $('#txtstrPrefix10').val();
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetMaxStrIdByPrefix(strPrefix);
var returnString = responseText.toString();
if (returnString == "")
{
var strInfo = "获取表FrontAndBack4AppType的最大关键字为空，不成功，请检查!";
...
alert(strMsg);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnUpdateRecord_Click = async function() {
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnDelRecord_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnDelFrontAndBack4AppTypes_Click = async function() {
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnDelMultiRecordByCond_Click = async function() {
$('#hidDivName').val("divDelMultiRecordByCond");
var strWhereCond = $('#txtstrWhereCond14').val();
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.DelFrontAndBack4AppTypesByCond(strWhereCond);
var returnInt = responseText;
if (returnInt > 0)
{
var strInfo = "删除记录成功,共删除" +returnInt + "条记录!";
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetFirstObj_Click = async function() {
$('#hidDivName').val("divGetFirstObj");
var strWhereCond = $('#txtstrWhereCond15').val();
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetFirstObj(strWhereCond);
var objFrontAndBack4AppTypeEN = responseText;
strWhereCond = $('#txtstrWhereCond15').val();
var strInfo = "根据条件:[" +strWhereCond + "] 获取第一个记录对象：" +objFrontAndBack4AppTypeEN.mId  + "!";
$('#lblResult15').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowFrontAndBack4AppTypeObj("divList15", objFrontAndBack4AppTypeEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjBymId_Click = async function() 
{
...
var objFrontAndBack4AppTypeEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objFrontAndBack4AppTypeEN.mId  + "!";
$('#lblResult16').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowFrontAndBack4AppTypeObj("divList16", objFrontAndBack4AppTypeEN);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjBymId_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjBymId_Cache(lngmId);
var objFrontAndBack4AppTypeEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objFrontAndBack4AppTypeEN.mId  + "!";
$('#lblResult17').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowFrontAndBack4AppTypeObj("divList17", objFrontAndBack4AppTypeEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">参数列表</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjBymId_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjBymId_WA_Cache(lngmId);
var objFrontAndBack4AppTypeEN = responseText;
var strInfo = "根据关键字:[" +strKeyId + "]获取对象：" +objFrontAndBack4AppTypeEN.mId  + "!";
$('#lblResult18').val(strInfo);
//显示信息框
alert(strInfo);
this.ShowFrontAndBack4AppTypeObj("divList18", objFrontAndBack4AppTypeEN);
}
catch(e)
{
var strMsg = "根据关键字获取相应的记录的对象不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLst_Click = async function() 
{
$('#hidDivName').val("divGetObjLst");
var strWhereCond = $('#txtstrWhereCond19').val();
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLst(strWhereCond);
var arrFrontAndBack4AppTypeObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "]共获取对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult19').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList19", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByKeyLst_Click = async function() 
{
...
var arrFrontAndBack4AppTypeObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult20').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList20", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByKeyLst_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLstBymIdLst_Cache(arrmId);
var arrFrontAndBack4AppTypeObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult21').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList21", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByKeyLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLstBymIdLst_WA_Cache(arrmId);
var arrFrontAndBack4AppTypeObjLst  = responseText;
var strInfo = "根据关键字列表:[" +strKeyIdLst + "]共获取对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult22').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList22", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
var strMsg = "根据关键字列表获取相应对象列表不成功," +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetSubObjLst_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetSubObjLst_Cache(objFrontAndBack4AppType_Cond);
var arrFrontAndBack4AppTypeObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objFrontAndBack4AppType_Cond) + "],共获取对象列表子集数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult23').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList23", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetSubObjLst_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetSubObjLst_WA_Cache(objFrontAndBack4AppType_Cond);
var arrFrontAndBack4AppTypeObjLst = responseText;
var strInfo = "根据条件:[" +JSON.stringify(objFrontAndBack4AppType_Cond) + "],共获取对象列表子集数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult24').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList24", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
var strMsg = "根据条件对象获取相应的对象列表子集不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetTopObjLst_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetTopObjLst(objTopPara);
var arrFrontAndBack4AppTypeObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],顶部数:[" +intTopSize + "]共获取顶部对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult25').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList25", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByPager_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLstByPager(objPagerPara);
var arrFrontAndBack4AppTypeObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult26').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList26", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByPager_Cache_Click = async function() 
{
...
var objFrontAndBack4AppTypeEN_Sim = clsFrontAndBack4AppTypeBL_js_1.clsFrontAndBack4AppTypeBL.GetSimObjFromObj(objFrontAndBack4AppType_Cond);
console.log(objFrontAndBack4AppTypeEN_Sim);
strWhereCond = JSON.stringify(objFrontAndBack4AppTypeEN_Sim);
var objPagerPara = {
PageIndex: intPageIndex,
PageSize: intPageSize,
WhereCond: strWhereCond,
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLstByPager_Cache(objPagerPara);
var arrFrontAndBack4AppTypeObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult27').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList27", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByPager_WA_Cache_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLstByPager_WA_Cache(objPagerPara);
var arrFrontAndBack4AppTypeObjLst = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],每页记录数:[" +intPageSize + "],第[" +intPageIndex + "]页,共获取分页对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult28').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList28", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
var strMsg = "根据条件获取相应的分页对象列表不成功, " +e + ".";
alert(strMsg);
 ...
 /// <param name = "sender">事件发送者</param>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.btnGetObjLstByRange_Click = async function() 
{
...
try
{
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLstByRange(objRangePara);
var arrFrontAndBack4AppTypeObjLst  = responseText;
var strInfo = "根据条件:[" +strWhereCond + "],最小记录号:[" +intMinNum + "],最大记录号:[" +intMaxNum + "],共获取分页对象列表数：" +arrFrontAndBack4AppTypeObjLst.length + "!";
$('#lblResult29').val(strInfo);
//显示信息框
//alert(strInfo);
this.BindTab_FrontAndBack4AppType("divList29", arrFrontAndBack4AppTypeObjLst);
}
catch(e)
{
...
alert(strMsg);
 ...
 /// <summary>
 /// 显示FrontAndBack4AppType对象的所有属性值
 ...
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.BindTab_FrontAndBack4AppType = function(divContainer, arrFrontAndBack4AppTypeObjLst) 
{
...
sstrFldName.push("AppTypeId4Front"); sstrColHeader.push("应用类型Id4Front");
sstrFldName.push("AppTypeId4Back"); sstrColHeader.push("应用类型Id4Back");
...
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindTab(o, arrFrontAndBack4AppTypeObjLst, sstrFldName, sstrColHeader, "mId"); 
}
 ...
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.ShowFrontAndBack4AppTypeObj = function(divContainer, objFrontAndBack4AppType) 
{
var o = document.getElementById(divContainer);
if (o == null)
{
...
o.appendChild(ul);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.AddDPV_FldComparison = function(divName4Edit) {
var objLst = document.getElementsByTagName("div");
var strStartName = "divEditFldComparison";
let arrElement = WA_FrontAndBack4AppType_UT_JS.GetArray(objLst) ;
...
console.log(e);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.GetFldNameLst = function(func) {
var arrFldName = new clsFrontAndBack4AppTypeEN_js_1.clsFrontAndBack4AppTypeEN().AttributeName;
...
func(strFldNameLst1);
 ...
 /// </summary>
 /// <returns></returns>
   WA_FrontAndBack4AppType_UT_JS.GetLocalObjLst = function() {
...
return arrFldComparisonObj;
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.CreateCache = async function() 
{
clsPubFun_js_1.clsPubFun.SetCommFun4BL();
var strKey = "";
try
{
console.log("开始获取缓存：FrontAndBack4AppType");
strKey = clsFrontAndBack4AppTypeEN_js_1.clsFrontAndBack4AppTypeEN._CurrTabName;
const responseText = await clsFrontAndBack4AppTypeWApi_js_1.clsFrontAndBack4AppTypeWApi.GetObjLst_Cache();
console.log("获取缓存完成！FrontAndBack4AppType");
var arrFrontAndBack4AppTypeObjLst = CacheHelper_js_1.CacheHelper.Get(strKey);
if (arrFrontAndBack4AppTypeObjLst != null)
{
var strInfo = "建立缓存Key=[" +strKey + "]完成: 共获取对象列表数：" + arrFrontAndBack4AppTypeObjLst.length  + "!";
...
console.log("WA_FrontAndBack4AppType_UT_JS: CreateCache()不成功！");
console.log(e);
...
$('#lblPageStatusContent').html(strInfo);
 ...
 /// </summary>
 /// <returns></returns>
WA_FrontAndBack4AppType_UT_JS.GetArray = function(arr) {
...
return WA_FrontAndBack4AppType_UT_JS;
}());
exports.WA_FrontAndBack4AppType_UT_JS = WA_FrontAndBack4AppType_UT_JS;
});