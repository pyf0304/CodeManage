...
{
define(["require", "exports", "jquery", "../../L0_Entity/AuthorityManage/clsUserPrjGrantEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsUserPrjGrantExWApi = /** @class */ (function() {
function clsUserPrjGrantExWApi(pobjUserPrjGrantEN)
{
...
clsUserPrjGrantExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsUserPrjGrantExWApi.mstrController = "UserPrjGrantExApi";
return clsUserPrjGrantExWApi;
}());
exports.clsUserPrjGrantExWApi = clsUserPrjGrantExWApi;
});