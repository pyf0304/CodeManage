 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvProjectsExWApi
 表名:vProjects(00050167)
 生成代码版本:2020.04.08.1
 生成日期:2020/04/13 18:05:44
 生成者:
...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjManage/clsvProjectsEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvProjectsExWApi = /** @class */ (function() {
function clsvProjectsExWApi(pobjvProjectsEN)
{
...
clsvProjectsExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvProjectsExWApi.mstrController = "vProjectsExApi";
return clsvProjectsExWApi;
}());
exports.clsvProjectsExWApi = clsvProjectsExWApi;
});