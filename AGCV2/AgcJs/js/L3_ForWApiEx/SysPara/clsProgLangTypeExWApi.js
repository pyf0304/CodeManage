...
{
define(["require", "exports", "jquery", "../../L0_Entity/SysPara/clsProgLangTypeEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsProgLangTypeExWApi = /** @class */ (function() {
function clsProgLangTypeExWApi(pobjProgLangTypeEN)
{
...
clsProgLangTypeExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsProgLangTypeExWApi.mstrController = "ProgLangTypeExApi";
return clsProgLangTypeExWApi;
}());
exports.clsProgLangTypeExWApi = clsProgLangTypeExWApi;
});