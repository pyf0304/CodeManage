 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvCodeTypeExWApi
 表名:vCodeType(00050410)
 生成代码版本:2020.04.08.1
 生成日期:2020/04/12 16:00:04
 生成者:
...
{
define(["require", "exports", "jquery", "/Js/L0_Entity/SysPara/clsvCodeTypeEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvCodeTypeExWApi = /** @class */ (function() {
function clsvCodeTypeExWApi(pobjvCodeTypeEN)
{
...
clsvCodeTypeExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvCodeTypeExWApi.mstrController = "vCodeTypeExApi";
return clsvCodeTypeExWApi;
}());
exports.clsvCodeTypeExWApi = clsvCodeTypeExWApi;
});