...
{
define(["require", "exports", "jquery", "../../L0_Entity/ViewControlManage/clsCtlTypeAbbrEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsCtlTypeAbbrExWApi = /** @class */ (function() {
function clsCtlTypeAbbrExWApi(pobjCtlTypeAbbrEN)
{
...
clsCtlTypeAbbrExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsCtlTypeAbbrExWApi.mstrController = "CtlTypeAbbrExApi";
return clsCtlTypeAbbrExWApi;
}());
exports.clsCtlTypeAbbrExWApi = clsCtlTypeAbbrExWApi;
});