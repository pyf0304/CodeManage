...
{
define(["require", "exports", "jquery", "../../L0_Entity/ViewControlManage/clsDDLItemsOptionEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsDDLItemsOptionExWApi = /** @class */ (function() {
function clsDDLItemsOptionExWApi(pobjDDLItemsOptionEN)
{
...
clsDDLItemsOptionExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsDDLItemsOptionExWApi.mstrController = "DDLItemsOptionExApi";
return clsDDLItemsOptionExWApi;
}());
exports.clsDDLItemsOptionExWApi = clsDDLItemsOptionExWApi;
});