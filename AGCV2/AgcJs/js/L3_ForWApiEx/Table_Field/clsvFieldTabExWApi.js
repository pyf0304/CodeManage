 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFieldTabExWApi
 表名:vFieldTab(00050119)
 生成代码版本:2020.04.24.1
 生成日期:2020/04/29 17:57:59
 生成者:
...
{
define(["require", "exports", "jquery", "../../L0_Entity/Table_Field/clsvFieldTabEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvFieldTabExWApi = /** @class */ (function() {
function clsvFieldTabExWApi(pobjvFieldTabEN)
{
...
clsvFieldTabExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvFieldTabExWApi.mstrController = "vFieldTabExApi";
return clsvFieldTabExWApi;
}());
exports.clsvFieldTabExWApi = clsvFieldTabExWApi;
});