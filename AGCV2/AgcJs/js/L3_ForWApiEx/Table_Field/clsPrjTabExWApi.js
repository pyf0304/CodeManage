...
{
define(["require", "exports", "jquery", "../../L0_Entity/Table_Field/clsPrjTabEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsPrjTabExWApi = /** @class */ (function() {
function clsPrjTabExWApi(pobjPrjTabEN)
{
...
clsPrjTabExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsPrjTabExWApi.mstrController = "PrjTabExApi";
return clsPrjTabExWApi;
}());
exports.clsPrjTabExWApi = clsPrjTabExWApi;
});