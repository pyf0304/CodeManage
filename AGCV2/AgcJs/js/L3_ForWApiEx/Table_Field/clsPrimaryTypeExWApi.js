 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPrimaryTypeExWApi
 表名:PrimaryType(00050020)
 生成代码版本:2020.04.08.1
 生成日期:2020/04/13 16:56:04
 生成者:
...
{
define(["require", "exports", "jquery", "../../L0_Entity/Table_Field/clsPrimaryTypeEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsPrimaryTypeExWApi = /** @class */ (function() {
function clsPrimaryTypeExWApi(pobjPrimaryTypeEN)
{
...
clsPrimaryTypeExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsPrimaryTypeExWApi.mstrController = "PrimaryTypeExApi";
return clsPrimaryTypeExWApi;
}());
exports.clsPrimaryTypeExWApi = clsPrimaryTypeExWApi;
});