...
{
define(["require", "exports", "jquery", "../../L0_Entity/Table_Field/clsFieldTabEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsFieldTabExWApi = /** @class */ (function() {
function clsFieldTabExWApi(pobjFieldTabEN)
{
...
clsFieldTabExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsFieldTabExWApi.mstrController = "FieldTabExApi";
return clsFieldTabExWApi;
}());
exports.clsFieldTabExWApi = clsFieldTabExWApi;
});