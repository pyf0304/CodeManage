...
{
define(["require", "exports", "jquery", "../../L0_Entity/LogManage/clsUserLogEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsUserLogExWApi = /** @class */ (function() {
function clsUserLogExWApi(pobjUserLogEN)
{
...
clsUserLogExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsUserLogExWApi.mstrController = "UserLogExApi";
return clsUserLogExWApi;
}());
exports.clsUserLogExWApi = clsUserLogExWApi;
});