 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvViewInfo4GeneCodeExWApi
...
{
define(["require", "exports", "jquery", "../../L0_Entity/LogManage/clsvViewInfo4GeneCodeEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvViewInfo4GeneCodeExWApi = /** @class */ (function() {
function clsvViewInfo4GeneCodeExWApi(pobjvViewInfo4GeneCodeEN)
{
...
clsvViewInfo4GeneCodeExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvViewInfo4GeneCodeExWApi.mstrController = "vViewInfo4GeneCodeExApi";
return clsvViewInfo4GeneCodeExWApi;
}());
exports.clsvViewInfo4GeneCodeExWApi = clsvViewInfo4GeneCodeExWApi;
});