...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsViewTabTypeEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsViewTabTypeExWApi = /** @class */ (function() {
function clsViewTabTypeExWApi(pobjViewTabTypeEN)
{
...
clsViewTabTypeExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsViewTabTypeExWApi.mstrController = "ViewTabTypeExApi";
return clsViewTabTypeExWApi;
}());
exports.clsViewTabTypeExWApi = clsViewTabTypeExWApi;
});