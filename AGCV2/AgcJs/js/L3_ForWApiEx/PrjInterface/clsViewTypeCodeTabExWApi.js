...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsViewTypeCodeTabEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsViewTypeCodeTabExWApi = /** @class */ (function() {
function clsViewTypeCodeTabExWApi(pobjViewTypeCodeTabEN)
{
...
clsViewTypeCodeTabExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsViewTypeCodeTabExWApi.mstrController = "ViewTypeCodeTabExApi";
return clsViewTypeCodeTabExWApi;
}());
exports.clsViewTypeCodeTabExWApi = clsViewTypeCodeTabExWApi;
});