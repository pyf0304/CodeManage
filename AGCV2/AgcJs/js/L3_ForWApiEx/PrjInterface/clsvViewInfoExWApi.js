 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvViewInfoExWApi
 表名:vViewInfo(00050157)
 生成代码版本:2020.05.01.1
 生成日期:2020/05/01 00:23:44
 生成者:
...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsvViewInfoEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvViewInfoExWApi = /** @class */ (function() {
function clsvViewInfoExWApi(pobjvViewInfoEN)
{
...
clsvViewInfoExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvViewInfoExWApi.mstrController = "vViewInfoExApi";
return clsvViewInfoExWApi;
}());
exports.clsvViewInfoExWApi = clsvViewInfoExWApi;
});