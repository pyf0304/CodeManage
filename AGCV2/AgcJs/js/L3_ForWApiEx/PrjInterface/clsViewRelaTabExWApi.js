...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsViewRelaTabEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsViewRelaTabExWApi = /** @class */ (function() {
function clsViewRelaTabExWApi(pobjViewRelaTabEN)
{
...
clsViewRelaTabExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsViewRelaTabExWApi.mstrController = "ViewRelaTabExApi";
return clsViewRelaTabExWApi;
}());
exports.clsViewRelaTabExWApi = clsViewRelaTabExWApi;
});