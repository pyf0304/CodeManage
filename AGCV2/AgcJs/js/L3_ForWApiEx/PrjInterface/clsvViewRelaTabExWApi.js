...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsvViewRelaTabEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvViewRelaTabExWApi = /** @class */ (function() {
function clsvViewRelaTabExWApi(pobjvViewRelaTabEN)
{
...
clsvViewRelaTabExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvViewRelaTabExWApi.mstrController = "vViewRelaTabExApi";
return clsvViewRelaTabExWApi;
}());
exports.clsvViewRelaTabExWApi = clsvViewRelaTabExWApi;
});