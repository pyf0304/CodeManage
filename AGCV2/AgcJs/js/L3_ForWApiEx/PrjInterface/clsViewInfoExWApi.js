...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsViewInfoEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsViewInfoExWApi = /** @class */ (function() {
function clsViewInfoExWApi(pobjViewInfoEN)
{
...
clsViewInfoExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsViewInfoExWApi.mstrController = "ViewInfoExApi";
return clsViewInfoExWApi;
}());
exports.clsViewInfoExWApi = clsViewInfoExWApi;
});