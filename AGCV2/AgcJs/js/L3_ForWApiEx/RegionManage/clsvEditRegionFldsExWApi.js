...
{
define(["require", "exports", "jquery", "../../L0_Entity/RegionManage/clsvEditRegionFldsEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsvEditRegionFldsExWApi = /** @class */ (function() {
function clsvEditRegionFldsExWApi(pobjvEditRegionFldsEN)
{
...
clsvEditRegionFldsExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsvEditRegionFldsExWApi.mstrController = "vEditRegionFldsExApi";
return clsvEditRegionFldsExWApi;
}());
exports.clsvEditRegionFldsExWApi = clsvEditRegionFldsExWApi;
});