 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsRegionTypeExWApi
 表名:RegionType(00050081)
 生成代码版本:2020.04.08.1
 生成日期:2020/04/12 22:02:03
 生成者:
...
{
define(["require", "exports", "jquery", "../../L0_Entity/RegionManage/clsRegionTypeEN.js","clscommonfunc4web","clsstacktrace","clssyspara4webapi"], factory);
}
...
var clsSysPara4WebApi_js_1 = require("clssyspara4webapi");
 ...
 /// </summary>
var ResponseData;
var clsRegionTypeExWApi = /** @class */ (function() {
function clsRegionTypeExWApi(pobjRegionTypeEN)
{
...
clsRegionTypeExWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsRegionTypeExWApi.mstrController = "RegionTypeExApi";
return clsRegionTypeExWApi;
}());
exports.clsRegionTypeExWApi = clsRegionTypeExWApi;
});