...
var clsvPrjTab4GeneCodeBL_js_1 = require("../../L2_BLL/LogManage/clsvPrjTab4GeneCodeBL.js");
...
var clsPrjTabWApi_js_1 = require("../../L3_ForWApi/Table_Field/clsPrjTabWApi.js");
 ...
 /// </summary>
var ResponseData;
var clsvPrjTab4GeneCodeWApi = /** @class */ (function() {
function clsvPrjTab4GeneCodeWApi(pobjvPrjTab4GeneCodeEN)
{
...
this.objvPrjTab4GeneCodeEN = pobjvPrjTab4GeneCodeEN;
 ...
 /// <returns>对象</returns>
clsvPrjTab4GeneCodeWApi.GetObjByTabId = function(strTabId)  
{
var strAction = "GetObjByTabId";
let strUrl = this.GetWebApiUrl(clsvPrjTab4GeneCodeWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsvPrjTab4GeneCodeWApi.GetObjByTabId_Cache = async function(strTabId,strPrjId) {
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvPrjTab4GeneCodeEN_js_1.clsvPrjTab4GeneCodeEN();
try
{
var arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCodeObjLst_Cache.filter(x => x.TabId == strTabId);
var objvPrjTab4GeneCode;
if (arrvPrjTab4GeneCode_Sel.length > 0)
{
objvPrjTab4GeneCode = arrvPrjTab4GeneCode_Sel[0];
return objvPrjTab4GeneCode;
}
else
{
return obj;
...
return obj;
 ...
 /// <param name = "strTabId">关键字</param>
 /// <returns>对象</returns>
clsvPrjTab4GeneCodeWApi.GetObjByTabId_WA_Cache = function(strTabId, strPrjId)  
{
...
clsvPrjTab4GeneCodeWApi.GetFirstID = function(strWhereCond)  
{
...
clsvPrjTab4GeneCodeWApi.GetFirstObj = function(strWhereCond)  
{
...
clsvPrjTab4GeneCodeWApi.GetObjLst_Cache = async function(strPrjId)
{
var arrvPrjTab4GeneCodeObjLst_Cache;
switch (clsvPrjTab4GeneCodeWApi.CacheModeId)
{
case "04"://sessionStorage
arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_sessionStorage(strPrjId);
break;
case "03"://localStorage
arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_localStorage(strPrjId);
break;
case "02"://ClientCache
arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_ClientCache(strPrjId);
break;
default:
arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_ClientCache(strPrjId);
break;
}
return arrvPrjTab4GeneCodeObjLst_Cache;
}
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLst_ClientCache = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvPrjTab4GeneCodeWApi.InitListCache(); 
...
{
//缓存存在，直接取出返回
var arrvPrjTab4GeneCodeObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrvPrjTab4GeneCodeObjLst_Cache;
}
try
{
const responseText = await clsvPrjTab4GeneCodeWApi.GetObjLst(strWhereCond);
var arrvPrjTab4GeneCodeObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrvPrjTab4GeneCodeObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvPrjTab4GeneCodeObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLst_localStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvPrjTab4GeneCodeWApi.InitListCache(); 
...
var arrvPrjTab4GeneCodeObjLst_Cache = JSON.parse(strTempObjLst);
return arrvPrjTab4GeneCodeObjLst_Cache;
}
try
{
const responseText = await clsvPrjTab4GeneCodeWApi.GetObjLst(strWhereCond);
var arrvPrjTab4GeneCodeObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrvPrjTab4GeneCodeObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvPrjTab4GeneCodeObjLst.length+ " !";
console.log(strInfo);
return arrvPrjTab4GeneCodeObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLst_sessionStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvPrjTab4GeneCodeWApi.InitListCache(); 
...
const responseText = await clsvPrjTab4GeneCodeWApi.GetObjLst(strWhereCond);
var arrvPrjTab4GeneCodeObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrvPrjTab4GeneCodeObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvPrjTab4GeneCodeObjLst.length+ " !";
console.log(strInfo);
return arrvPrjTab4GeneCodeObjLst;
}
...
clsvPrjTab4GeneCodeWApi.GetObjLst_WA_Cache = function()  
{
...
clsvPrjTab4GeneCodeWApi.GetSubObjLst_Cache =  async function(objvPrjTab4GeneCode_Cond,strPrjId) {
var objvPrjTab4GeneCode_Sim = clsvPrjTab4GeneCodeBL_js_1.clsvPrjTab4GeneCodeBL.GetSimObjFromObj(objvPrjTab4GeneCode_Cond);
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCodeObjLst_Cache.filter(x => true);
if (objvPrjTab4GeneCode_Sim.sf_FldComparisonOp == null || objvPrjTab4GeneCode_Sim.sf_FldComparisonOp == "") return arrvPrjTab4GeneCode_Sel;
var dicFldComparisonOp = JSON.parse(objvPrjTab4GeneCode_Sim.sf_FldComparisonOp);
console.log("clsvPrjTab4GeneCodeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objvPrjTab4GeneCode_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objvPrjTab4GeneCode_Sim[strKey];
...
if (strComparisonOp == "=") {
arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCode_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCode_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCode_Sel.filter(x => x[strKey] == strValue);
}
...
return arrvPrjTab4GeneCode_Sel;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvPrjTab4GeneCode_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objvPrjTab4GeneCode_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetSubObjLst_WA_Cache = function(objvPrjTab4GeneCode_Cond)  
{
...
method: "POST",
dataType: "json",
data: objvPrjTab4GeneCodeEN_Sim,
success: function(data) {
if (data.ErrorId == 0)
{
var returnObjLst = JSON.parse(data.ReturnObjLst);
...
clsvPrjTab4GeneCodeWApi.GetObjLstByTabIdLst = function(arrTabId)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLstByTabIdLst_Cache =  async function(arrTabIdLst,strPrjId) {
try
{
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCodeObjLst_Cache.filter(x => arrTabIdLst.indexOf(x.TabId)>-1);
return arrvPrjTab4GeneCode_Sel;
}
catch (e)
{
...
return null;
 ...
 /// <param name = "arrTabId">关键字列表</param>
 /// <returns>对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLstByTabIdLst_WA_Cache = function(arrTabId, strPrjId)  
{
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLstByPager_Cache =  async function(objPagerPara,strPrjId) {
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCodeObjLst_Cache.filter(x => true);
...
console.log("clsvPrjTab4GeneCodeWApi->GetObjLstByPager_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCode_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCode_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCode_Sel.slice(intStart, intEnd);     
return arrvPrjTab4GeneCode_Sel;
}
catch (e) {
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvPrjTab4GeneCodeWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsvPrjTab4GeneCodeWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objstrTabId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsvPrjTab4GeneCodeWApi.IsExistRecord_Cache =  async function(objvPrjTab4GeneCode_Cond,strPrjId) {
var objvPrjTab4GeneCode_Sim = clsvPrjTab4GeneCodeBL_js_1.clsvPrjTab4GeneCodeBL.GetSimObjFromObj(objvPrjTab4GeneCode_Cond);
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCodeObjLst_Cache.filter(x => true);
if (objvPrjTab4GeneCode_Sim.sf_FldComparisonOp == null || objvPrjTab4GeneCode_Sim.sf_FldComparisonOp == "") return arrvPrjTab4GeneCode_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objvPrjTab4GeneCode_Sim.sf_FldComparisonOp);
console.log("clsvPrjTab4GeneCodeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objvPrjTab4GeneCode_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsvPrjTab4GeneCodeWApi.IsExist = function(strTabId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "strTabId">所给的关键字</param>
 /// <returns>对象</returns>
clsvPrjTab4GeneCodeWApi.IsExist_Cache = async function(strTabId,strPrjId) {
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvPrjTab4GeneCodeEN_js_1.clsvPrjTab4GeneCodeEN();
try
{
...
clsvPrjTab4GeneCodeWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsvPrjTab4GeneCodeWApi.GetRecCountByCond_Cache =  async function(objvPrjTab4GeneCode_Cond,strPrjId) {
var objvPrjTab4GeneCode_Sim = clsvPrjTab4GeneCodeBL_js_1.clsvPrjTab4GeneCodeBL.GetSimObjFromObj(objvPrjTab4GeneCode_Cond);
var arrvPrjTab4GeneCodeObjLst_Cache = await clsvPrjTab4GeneCodeWApi.GetObjLst_Cache(strPrjId);
var arrvPrjTab4GeneCode_Sel = arrvPrjTab4GeneCodeObjLst_Cache.filter(x => true);
if (objvPrjTab4GeneCode_Sim.sf_FldComparisonOp == null || objvPrjTab4GeneCode_Sim.sf_FldComparisonOp == "") return arrvPrjTab4GeneCode_Sel.length;
var dicFldComparisonOp = JSON.parse(objvPrjTab4GeneCode_Sim.sf_FldComparisonOp);
console.log("clsvPrjTab4GeneCodeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
return arrvPrjTab4GeneCode_Sel.length;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvPrjTab4GeneCode_Sim) + "]获取相应的对象不成功!";
throw new Error(strMsg);
...
clsvPrjTab4GeneCodeWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
/// <summary>
/// 为下拉框获取数据,从表:[vPrjTab4GeneCode]中获取
 /// (AutoGCLib.WA_Access4JavaScript:Gen_4WA_Js_DdlBind_Cache)
/// </summary>
/// <returns>获取主键字段、名称字段两列的所有记录记录的DataTable</returns>
clsvPrjTab4GeneCodeWApi.BindDdl_TabId_Cache2 = function(strDdlName, objvPrjTab4GeneCode_Cond, strPrjId) {
//var strWhereCond = " 1 =1 ";
...
try
{
var arrObjLst_Sel = clsvPrjTab4GeneCodeWApi.GetSubObjLst_Cache(objvPrjTab4GeneCode_Cond,strPrjId);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsvPrjTab4GeneCodeEN_js_1.clsvPrjTab4GeneCodeEN.con_TabId, clsvPrjTab4GeneCodeEN_js_1.clsvPrjTab4GeneCodeEN.con_TabName, "vPrjTab4GeneCode");
...
alert(strMsg);
 ...
 /// </summary>
clsvPrjTab4GeneCodeWApi.InitListCache = function() 
{
//初始化列表缓存
...
throw (strMsg);
 ...
 /// </summary>
clsvPrjTab4GeneCodeWApi. ReFreshThisCache = function(strPrjId)
{
var strMsg = "";
...
clsvPrjTab4GeneCodeWApi.BindDdl_TabId_Cache = async function(strDdlName, objvPrjTab4GeneCode_Cond, strPrjId)
{
var objDdl = document.getElementById(strDdlName);
if (objDdl == null)
{
...
var arrObjLst_Sel = await clsvPrjTab4GeneCodeWApi.GetSubObjLst_Cache(objvPrjTab4GeneCode_Cond, strPrjId);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsvPrjTab4GeneCodeEN_js_1.clsvPrjTab4GeneCodeEN.con_TabId, clsvPrjTab4GeneCodeEN_js_1.clsvPrjTab4GeneCodeEN.con_TabName, "vPrjTab4GeneCode");
}
clsvPrjTab4GeneCodeWApi.mstrController = "vPrjTab4GeneCodeApi";
clsvPrjTab4GeneCodeWApi.CacheModeId = ""; //
return clsvPrjTab4GeneCodeWApi;
}());
exports.clsvPrjTab4GeneCodeWApi = clsvPrjTab4GeneCodeWApi;
});