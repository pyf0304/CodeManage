...
{
define(["require", "exports", "jquery", "../../L0_Entity/PrjInterface/clsViewRelaTabEN.js","../../L2_BLL/PrjInterface/clsCommFun4WA4ViewRelaTab.js","clscommonfunc4web","clsstacktrace","../../L2_BLL/PrjInterface/clsViewRelaTabBL.js","tzdictionary","clssyspara4webapi","../../PubFun/stuTopPara.js","../../PubFun/stuRangePara.js","../../PubFun/stuPagerPara.js","cachehelper","clsfldcomparisonobj"], factory);
}
...
var clsCommFun4WA4ViewRelaTab_js_1 = require("../../L2_BLL/PrjInterface/clsCommFun4WA4ViewRelaTab.js");
var clsCommonFunc4Web_js_1 = require("clscommonfunc4web");
var clsStackTrace_js_1 = require("clsstacktrace");
var clsViewRelaTabBL_js_1 = require("../../L2_BLL/PrjInterface/clsViewRelaTabBL.js");
...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 ...
 /// </summary>
var ResponseData;
var clsViewRelaTabWApi = /** @class */ (function() {
function clsViewRelaTabWApi(pobjViewRelaTabEN)
{
this.objViewRelaTabEN = new clsViewRelaTabEN_js_1.clsViewRelaTabEN();
this.objViewRelaTabEN = pobjViewRelaTabEN;
}
 ...
 /// <returns>对象</returns>
clsViewRelaTabWApi.GetObjBymId = function(lngmId)  
{
var strAction = "GetObjBymId";
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsViewRelaTabWApi.GetObjBymId_Cache = async function(lngmId) {
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var obj = new clsViewRelaTabEN_js_1.clsViewRelaTabEN();
try
{
var arrViewRelaTab_Sel = arrViewRelaTabObjLst_Cache.filter(x => x.mId == lngmId);
var objViewRelaTab;
if (arrViewRelaTab_Sel.length > 0)
{
objViewRelaTab = arrViewRelaTab_Sel[0];
...
return obj;
 ...
 /// <param name = "lngmId">所给的关键字</param>
 /// <returns>对象</returns>
clsViewRelaTabWApi.SetCache = function() {
clsViewRelaTabWApi.objCommFun4BL = new clsCommFun4WA4ViewRelaTab_js_1.clsCommFun4WA4ViewRelaTab();
 //把以下三行添加到clsPubFun.js中
//"../L3_ForWApi/PrjInterface/clsViewRelaTabWApi.js"
//var clsViewRelaTabWApi_js_1 = require("../L3_ForWApi/PrjInterface/clsViewRelaTabWApi.js");
//clsViewRelaTabWApi_js_1.clsViewRelaTabWApi.SetCache();
};
 ...
 /// <param name = "lngmId">关键字</param>
 /// <returns>对象</returns>
clsViewRelaTabWApi.GetObjBymId_WA_Cache = function(lngmId)  
{
...
clsViewRelaTabWApi.GetFirstID = function(strWhereCond)  
{
...
clsViewRelaTabWApi.GetFirstObj = function(strWhereCond)  
{
...
clsViewRelaTabWApi.GetObjLst_Cache = async function() 
{
var arrViewRelaTabObjLst_Cache;
switch (clsViewRelaTabWApi.CacheModeId)
{
case "04"://sessionStorage
arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_sessionStorage();
break;
case "03"://localStorage
arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_localStorage();
break;
case "02"://ClientCache
arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_ClientCache();
break;
default:
arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_ClientCache();
break;
}
return arrViewRelaTabObjLst_Cache;
}
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsViewRelaTabWApi.GetObjLst_ClientCache = async function() 
{
//初始化列表缓存
var strWhereCond = "1=1";
clsViewRelaTabWApi.InitListCache(); 
var strKey = clsViewRelaTabEN_js_1.clsViewRelaTabEN._CurrTabName;
if (strKey == "")
{
...
{
//缓存存在，直接取出返回
var arrViewRelaTabObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrViewRelaTabObjLst_Cache;
}
try
{
const responseText = await clsViewRelaTabWApi.GetObjLst(strWhereCond);
var arrViewRelaTabObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrViewRelaTabObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrViewRelaTabObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsViewRelaTabWApi.GetObjLst_localStorage = async function() 
{
//初始化列表缓存
var strWhereCond = "1=1";
clsViewRelaTabWApi.InitListCache(); 
...
var arrViewRelaTabObjLst_Cache = JSON.parse(strTempObjLst);
return arrViewRelaTabObjLst_Cache;
}
try
{
const responseText = await clsViewRelaTabWApi.GetObjLst(strWhereCond);
var arrViewRelaTabObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrViewRelaTabObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrViewRelaTabObjLst.length+ " !";
console.log(strInfo);
return arrViewRelaTabObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsViewRelaTabWApi.GetObjLst_sessionStorage = async function() 
{
//初始化列表缓存
var strWhereCond = "1=1";
clsViewRelaTabWApi.InitListCache(); 
...
const responseText = await clsViewRelaTabWApi.GetObjLst(strWhereCond);
var arrViewRelaTabObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrViewRelaTabObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrViewRelaTabObjLst.length+ " !";
console.log(strInfo);
return arrViewRelaTabObjLst;
}
...
clsViewRelaTabWApi.GetObjLst_WA_Cache = function()  
{
...
clsViewRelaTabWApi.GetSubObjLst_Cache =  async function(objViewRelaTab_Cond) {
var objViewRelaTab_Sim = clsViewRelaTabBL_js_1.clsViewRelaTabBL.GetSimObjFromObj(objViewRelaTab_Cond);
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var arrViewRelaTab_Sel = arrViewRelaTabObjLst_Cache.filter(x => true);
if (objViewRelaTab_Sim.sf_FldComparisonOp == null || objViewRelaTab_Sim.sf_FldComparisonOp == "") return arrViewRelaTab_Sel;
var dicFldComparisonOp = JSON.parse(objViewRelaTab_Sim.sf_FldComparisonOp);
console.log("clsViewRelaTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objViewRelaTab_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objViewRelaTab_Sim[strKey];
...
if (strComparisonOp == "=") {
arrViewRelaTab_Sel = arrViewRelaTab_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrViewRelaTab_Sel = arrViewRelaTab_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrViewRelaTab_Sel = arrViewRelaTab_Sel.filter(x => x[strKey] == strValue);
}
...
var strMsg = "根据条件:[" +JSON.stringify( objViewRelaTab_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objViewRelaTab_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsViewRelaTabWApi.GetSubObjLst_WA_Cache = function(objViewRelaTab_Cond)  
{
...
clsViewRelaTabWApi.GetObjLstBymIdLst = function(arrmId)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsViewRelaTabWApi.GetObjLstBymIdLst_Cache =  async function(arrmIdLst) {
try
{
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var arrViewRelaTab_Sel = arrViewRelaTabObjLst_Cache.filter(x => arrmIdLst.indexOf(x.mId)>-1);
return arrViewRelaTab_Sel;
}
catch (e)
{
...
return null;
 ...
 /// <param name = "arrmId">关键字列表</param>
 /// <returns>对象列表</returns>
clsViewRelaTabWApi.GetObjLstBymIdLst_WA_Cache = function(arrmId)  
{
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsViewRelaTabWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsViewRelaTabWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsViewRelaTabWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsViewRelaTabWApi.GetObjLstByPager_Cache =  async function(objPagerPara) {
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var arrViewRelaTab_Sel = arrViewRelaTabObjLst_Cache.filter(x => true);
...
console.log("clsViewRelaTabWApi->GetObjLstByPager_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
arrViewRelaTab_Sel = arrViewRelaTab_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrViewRelaTab_Sel = arrViewRelaTab_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
arrViewRelaTab_Sel = arrViewRelaTab_Sel.slice(intStart, intEnd);     
return arrViewRelaTab_Sel;
}
catch (e) {
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsViewRelaTabWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsViewRelaTabWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsViewRelaTabWApi.DelRecord = function(lngmId)  
{
...
clsViewRelaTabWApi.DelRecordBySign = function(arrmId) 
{
...
clsViewRelaTabWApi.UnDelRecordBySign = function(arrmId) 
{
...
reject(result.statusText);
 ...
 /// <param name = "arrmId">关键字列表</param>
 /// <returns>实际删除记录的个数</returns>
clsViewRelaTabWApi.DelViewRelaTabs = function(arrmId) 
{
var strAction = "DelViewRelaTabs";
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
clsViewRelaTabWApi.DelViewRelaTabsByCond = function(strWhereCond) 
{
var strAction = "DelViewRelaTabsByCond";
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// </summary>
 /// <param name = "objViewRelaTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsViewRelaTabWApi.GoTop = function(objOrderByData) 
{
var strMsg = "";
var strAction = "GoTop";
...
throw strMsg;
 ...
 //var strJSON = JSON.stringify(objViewRelaTabEN_Sim);
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// <param name = "objViewRelaTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsViewRelaTabWApi.UpMove = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objViewRelaTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsViewRelaTabWApi.DownMove = function(objOrderByData)
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objViewRelaTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsViewRelaTabWApi.GoBottom = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objViewRelaTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsViewRelaTabWApi.ReOrder = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objViewRelaTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsViewRelaTabWApi.AddNewRecord = function(objViewRelaTabEN) 
{
var strMsg = "";
var strAction = "AddNewRecord";
var objViewRelaTabEN_Sim = clsViewRelaTabBL_js_1.clsViewRelaTabBL.GetSimObjFromObj(objViewRelaTabEN);
 //var strJSON = JSON.stringify(objViewRelaTabEN_Sim);
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
...
clsViewRelaTabWApi.AddNewRecordWithReturnKey = function(objViewRelaTabEN) 
{
...
clsViewRelaTabWApi.UpdateRecord = function(objViewRelaTabEN)  
{
var strMsg = "";
var strAction = "UpdateRecord";
 if (objViewRelaTabEN.sf_UpdFldSetStr === null || objViewRelaTabEN.sf_UpdFldSetStr === "")
{
strMsg = "对象(关键字: " + objViewRelaTabEN.mId + ")的【修改字段集】为空，不能修改!";
 throw strMsg;
 }
var objViewRelaTabEN_Sim = clsViewRelaTabBL_js_1.clsViewRelaTabBL.GetSimObjFromObj(objViewRelaTabEN);
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>返回的第一条记录的关键字值</returns>
clsViewRelaTabWApi.UpdateWithCondition = function(objViewRelaTabEN, strWhereCond ) 
{
var strAction = "UpdateWithCondition";
 if (objViewRelaTabEN.sf_UpdFldSetStr === null || objViewRelaTabEN.sf_UpdFldSetStr === "")
{
var strMsg = "对象(关键字:" + objViewRelaTabEN.mId + ")的【修改字段集】为空，不能修改!";
 throw new Error(strMsg);
 }
let strUrl = this.GetWebApiUrl(clsViewRelaTabWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
...
clsViewRelaTabWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objlngmId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsViewRelaTabWApi.IsExistRecord_Cache =  async function(objViewRelaTab_Cond) {
var objViewRelaTab_Sim = clsViewRelaTabBL_js_1.clsViewRelaTabBL.GetSimObjFromObj(objViewRelaTab_Cond);
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var arrViewRelaTab_Sel = arrViewRelaTabObjLst_Cache.filter(x => true);
if (objViewRelaTab_Sim.sf_FldComparisonOp == null || objViewRelaTab_Sim.sf_FldComparisonOp == "") return arrViewRelaTab_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objViewRelaTab_Sim.sf_FldComparisonOp);
console.log("clsViewRelaTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objViewRelaTab_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsViewRelaTabWApi.IsExist = function(lngmId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "lngmId">所给的关键字</param>
 /// <returns>对象</returns>
clsViewRelaTabWApi.IsExist_Cache = async function(lngmId) {
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var obj = new clsViewRelaTabEN_js_1.clsViewRelaTabEN();
try
{
...
clsViewRelaTabWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsViewRelaTabWApi.GetRecCountByCond_Cache =  async function(objViewRelaTab_Cond) {
var objViewRelaTab_Sim = clsViewRelaTabBL_js_1.clsViewRelaTabBL.GetSimObjFromObj(objViewRelaTab_Cond);
var arrViewRelaTabObjLst_Cache = await clsViewRelaTabWApi.GetObjLst_Cache();
var arrViewRelaTab_Sel = arrViewRelaTabObjLst_Cache.filter(x => true);
if (objViewRelaTab_Sim.sf_FldComparisonOp == null || objViewRelaTab_Sim.sf_FldComparisonOp == "") return arrViewRelaTab_Sel.length;
var dicFldComparisonOp = JSON.parse(objViewRelaTab_Sim.sf_FldComparisonOp);
console.log("clsViewRelaTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
return arrViewRelaTab_Sel.length;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objViewRelaTab_Sim) + "]获取相应的对象不成功!";
throw new Error(strMsg);
...
clsViewRelaTabWApi.GetMaxStrId = function()  
{
...
clsViewRelaTabWApi.GetMaxStrIdByPrefix = function(strPrefix)  
{
...
clsViewRelaTabWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
return strServiceUrl;
 ...
 /// </summary>
clsViewRelaTabWApi.InitListCache = function() 
{
//初始化列表缓存
//检查缓存刷新机制
var strMsg = "";
if (clsViewRelaTabWApi.objCommFun4BL == null)
{
strMsg = "类clsViewRelaTabWApi没有刷新缓存机制(clsViewRelaTabWApi.objCommFun4BL == null), 请联系程序员！(from " + clsStackTrace_js_1.clsStackTrace.GetCurrClassFunction() + ")";
throw new Error(strMsg);
}
}
 ...
 /// </summary>
clsViewRelaTabWApi.ReFreshCache = function()
{
if (clsViewRelaTabWApi.objCommFun4BL != null) 
{
...
clsViewRelaTabWApi.objCommFun4BL.ReFreshCache();
}
}
 ...
 /// </summary>
clsViewRelaTabWApi. ReFreshThisCache = function()
{
var strMsg = "";
...
clsViewRelaTabWApi.mstrController = "ViewRelaTabApi";
clsViewRelaTabWApi.CacheModeId = ""; //
return clsViewRelaTabWApi;
}());
exports.clsViewRelaTabWApi = clsViewRelaTabWApi;
});