...
{
define(["require", "exports", "jquery", "../../L0_Entity/RegionManage/clsvDGRegionFldsEN.js","clscommonfunc4web","clsstacktrace","../../L2_BLL/RegionManage/clsvDGRegionFldsBL.js","tzdictionary","clssyspara4webapi","../../PubFun/stuTopPara.js","../../PubFun/stuRangePara.js","../../PubFun/stuPagerPara.js","cachehelper","clsfldcomparisonobj","../../L3_ForWApi/RegionManage/clsDGRegionFldsWApi.js"], factory);
}
...
var clsvDGRegionFldsBL_js_1 = require("../../L2_BLL/RegionManage/clsvDGRegionFldsBL.js");
...
var clsDGRegionFldsWApi_js_1 = require("../../L3_ForWApi/RegionManage/clsDGRegionFldsWApi.js");
 ...
 /// </summary>
var ResponseData;
var clsvDGRegionFldsWApi = /** @class */ (function() {
function clsvDGRegionFldsWApi(pobjvDGRegionFldsEN)
{
...
this.objvDGRegionFldsEN = pobjvDGRegionFldsEN;
 ...
 /// <returns>对象</returns>
clsvDGRegionFldsWApi.GetObjBymId = function(lngmId)  
{
var strAction = "GetObjBymId";
let strUrl = this.GetWebApiUrl(clsvDGRegionFldsWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsvDGRegionFldsWApi.GetObjBymId_Cache = async function(lngmId,strPrjId) {
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvDGRegionFldsEN_js_1.clsvDGRegionFldsEN();
try
{
var arrvDGRegionFlds_Sel = arrvDGRegionFldsObjLst_Cache.filter(x => x.mId == lngmId);
var objvDGRegionFlds;
if (arrvDGRegionFlds_Sel.length > 0)
{
objvDGRegionFlds = arrvDGRegionFlds_Sel[0];
return objvDGRegionFlds;
}
else
{
return obj;
...
return obj;
 ...
 /// <param name = "lngmId">关键字</param>
 /// <returns>对象</returns>
clsvDGRegionFldsWApi.GetObjBymId_WA_Cache = function(lngmId, strPrjId)  
{
...
clsvDGRegionFldsWApi.GetFirstID = function(strWhereCond)  
{
...
clsvDGRegionFldsWApi.GetFirstObj = function(strWhereCond)  
{
...
clsvDGRegionFldsWApi.GetObjLst_Cache = async function(strPrjId)
{
var arrvDGRegionFldsObjLst_Cache;
switch (clsvDGRegionFldsWApi.CacheModeId)
{
case "04"://sessionStorage
arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_sessionStorage(strPrjId);
break;
case "03"://localStorage
arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_localStorage(strPrjId);
break;
case "02"://ClientCache
arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_ClientCache(strPrjId);
break;
default:
arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_ClientCache(strPrjId);
break;
}
return arrvDGRegionFldsObjLst_Cache;
}
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvDGRegionFldsWApi.GetObjLst_ClientCache = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvDGRegionFldsWApi.InitListCache(); 
...
{
//缓存存在，直接取出返回
var arrvDGRegionFldsObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrvDGRegionFldsObjLst_Cache;
}
try
{
const responseText = await clsvDGRegionFldsWApi.GetObjLst(strWhereCond);
var arrvDGRegionFldsObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrvDGRegionFldsObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvDGRegionFldsObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvDGRegionFldsWApi.GetObjLst_localStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvDGRegionFldsWApi.InitListCache(); 
...
var arrvDGRegionFldsObjLst_Cache = JSON.parse(strTempObjLst);
return arrvDGRegionFldsObjLst_Cache;
}
try
{
const responseText = await clsvDGRegionFldsWApi.GetObjLst(strWhereCond);
var arrvDGRegionFldsObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrvDGRegionFldsObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvDGRegionFldsObjLst.length+ " !";
console.log(strInfo);
return arrvDGRegionFldsObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvDGRegionFldsWApi.GetObjLst_sessionStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvDGRegionFldsWApi.InitListCache(); 
...
const responseText = await clsvDGRegionFldsWApi.GetObjLst(strWhereCond);
var arrvDGRegionFldsObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrvDGRegionFldsObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvDGRegionFldsObjLst.length+ " !";
console.log(strInfo);
return arrvDGRegionFldsObjLst;
}
...
clsvDGRegionFldsWApi.GetObjLst_WA_Cache = function()  
{
...
clsvDGRegionFldsWApi.GetSubObjLst_Cache =  async function(objvDGRegionFlds_Cond,strPrjId) {
var objvDGRegionFlds_Sim = clsvDGRegionFldsBL_js_1.clsvDGRegionFldsBL.GetSimObjFromObj(objvDGRegionFlds_Cond);
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var arrvDGRegionFlds_Sel = arrvDGRegionFldsObjLst_Cache.filter(x => true);
if (objvDGRegionFlds_Sim.sf_FldComparisonOp == null || objvDGRegionFlds_Sim.sf_FldComparisonOp == "") return arrvDGRegionFlds_Sel;
var dicFldComparisonOp = JSON.parse(objvDGRegionFlds_Sim.sf_FldComparisonOp);
console.log("clsvDGRegionFldsWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objvDGRegionFlds_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objvDGRegionFlds_Sim[strKey];
...
if (strComparisonOp == "=") {
arrvDGRegionFlds_Sel = arrvDGRegionFlds_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrvDGRegionFlds_Sel = arrvDGRegionFlds_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrvDGRegionFlds_Sel = arrvDGRegionFlds_Sel.filter(x => x[strKey] == strValue);
}
...
return arrvDGRegionFlds_Sel;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvDGRegionFlds_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objvDGRegionFlds_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvDGRegionFldsWApi.GetSubObjLst_WA_Cache = function(objvDGRegionFlds_Cond)  
{
...
clsvDGRegionFldsWApi.GetObjLstBymIdLst = function(arrmId)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvDGRegionFldsWApi.GetObjLstBymIdLst_Cache =  async function(arrmIdLst,strPrjId) {
try
{
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var arrvDGRegionFlds_Sel = arrvDGRegionFldsObjLst_Cache.filter(x => arrmIdLst.indexOf(x.mId)>-1);
return arrvDGRegionFlds_Sel;
}
catch (e)
{
...
return null;
 ...
 /// <param name = "arrmId">关键字列表</param>
 /// <returns>对象列表</returns>
clsvDGRegionFldsWApi.GetObjLstBymIdLst_WA_Cache = function(arrmId, strPrjId)  
{
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsvDGRegionFldsWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsvDGRegionFldsWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvDGRegionFldsWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvDGRegionFldsWApi.GetObjLstByPager_Cache =  async function(objPagerPara,strPrjId) {
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var arrvDGRegionFlds_Sel = arrvDGRegionFldsObjLst_Cache.filter(x => true);
...
console.log("clsvDGRegionFldsWApi->GetObjLstByPager_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
arrvDGRegionFlds_Sel = arrvDGRegionFlds_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrvDGRegionFlds_Sel = arrvDGRegionFlds_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
arrvDGRegionFlds_Sel = arrvDGRegionFlds_Sel.slice(intStart, intEnd);     
return arrvDGRegionFlds_Sel;
}
catch (e) {
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvDGRegionFldsWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvDGRegionFldsWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsvDGRegionFldsWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objlngmId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsvDGRegionFldsWApi.IsExistRecord_Cache =  async function(objvDGRegionFlds_Cond,strPrjId) {
var objvDGRegionFlds_Sim = clsvDGRegionFldsBL_js_1.clsvDGRegionFldsBL.GetSimObjFromObj(objvDGRegionFlds_Cond);
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var arrvDGRegionFlds_Sel = arrvDGRegionFldsObjLst_Cache.filter(x => true);
if (objvDGRegionFlds_Sim.sf_FldComparisonOp == null || objvDGRegionFlds_Sim.sf_FldComparisonOp == "") return arrvDGRegionFlds_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objvDGRegionFlds_Sim.sf_FldComparisonOp);
console.log("clsvDGRegionFldsWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objvDGRegionFlds_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsvDGRegionFldsWApi.IsExist = function(lngmId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "lngmId">所给的关键字</param>
 /// <returns>对象</returns>
clsvDGRegionFldsWApi.IsExist_Cache = async function(lngmId,strPrjId) {
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvDGRegionFldsEN_js_1.clsvDGRegionFldsEN();
try
{
...
clsvDGRegionFldsWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsvDGRegionFldsWApi.GetRecCountByCond_Cache =  async function(objvDGRegionFlds_Cond,strPrjId) {
var objvDGRegionFlds_Sim = clsvDGRegionFldsBL_js_1.clsvDGRegionFldsBL.GetSimObjFromObj(objvDGRegionFlds_Cond);
var arrvDGRegionFldsObjLst_Cache = await clsvDGRegionFldsWApi.GetObjLst_Cache(strPrjId);
var arrvDGRegionFlds_Sel = arrvDGRegionFldsObjLst_Cache.filter(x => true);
if (objvDGRegionFlds_Sim.sf_FldComparisonOp == null || objvDGRegionFlds_Sim.sf_FldComparisonOp == "") return arrvDGRegionFlds_Sel.length;
var dicFldComparisonOp = JSON.parse(objvDGRegionFlds_Sim.sf_FldComparisonOp);
console.log("clsvDGRegionFldsWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
return arrvDGRegionFlds_Sel.length;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvDGRegionFlds_Sim) + "]获取相应的对象不成功!";
throw new Error(strMsg);
...
clsvDGRegionFldsWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
return strServiceUrl;
 ...
 /// </summary>
clsvDGRegionFldsWApi.InitListCache = function() 
{
//初始化列表缓存
if (clsDGRegionFldsWApi_js_1.clsDGRegionFldsWApi.objCommFun4BL == null)
{
strMsg = "类clsDGRegionFldsWApi没有刷新缓存机制(clsDGRegionFldsWApi.objCommFun4BL == null), 请联系程序员！(from {clsStackTrace.GetCurrClassFunction()})";
throw (strMsg);
}
}
 ...
 /// </summary>
clsvDGRegionFldsWApi. ReFreshThisCache = function(strPrjId)
{
var strMsg = "";
...
clsvDGRegionFldsWApi.mstrController = "vDGRegionFldsApi";
clsvDGRegionFldsWApi.CacheModeId = ""; //
return clsvDGRegionFldsWApi;
}());
exports.clsvDGRegionFldsWApi = clsvDGRegionFldsWApi;
});