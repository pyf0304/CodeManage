...
{
define(["require", "exports", "jquery", "../../L0_Entity/RegionManage/clsvViewRegionEN.js","clscommonfunc4web","clsstacktrace","../../L2_BLL/RegionManage/clsvViewRegionBL.js","tzdictionary","clssyspara4webapi","../../PubFun/stuTopPara.js","../../PubFun/stuRangePara.js","../../PubFun/stuPagerPara.js","cachehelper","clsfldcomparisonobj","../../L3_ForWApi/RegionManage/clsViewRegionWApi.js"], factory);
}
...
var clsvViewRegionBL_js_1 = require("../../L2_BLL/RegionManage/clsvViewRegionBL.js");
...
var clsViewRegionWApi_js_1 = require("../../L3_ForWApi/RegionManage/clsViewRegionWApi.js");
 ...
 /// </summary>
var ResponseData;
var clsvViewRegionWApi = /** @class */ (function() {
function clsvViewRegionWApi(pobjvViewRegionEN)
{
this.objvViewRegionEN = new clsvViewRegionEN_js_1.clsvViewRegionEN();
this.objvViewRegionEN = pobjvViewRegionEN;
}
 ...
 /// <returns>对象</returns>
clsvViewRegionWApi.GetObjByRegionId = function(lngRegionId)  
{
var strAction = "GetObjByRegionId";
let strUrl = this.GetWebApiUrl(clsvViewRegionWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsvViewRegionWApi.GetObjByRegionId_Cache = async function(lngRegionId,strPrjId) {
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvViewRegionEN_js_1.clsvViewRegionEN();
try
{
var arrvViewRegion_Sel = arrvViewRegionObjLst_Cache.filter(x => x.RegionId == lngRegionId);
var objvViewRegion;
if (arrvViewRegion_Sel.length > 0)
{
objvViewRegion = arrvViewRegion_Sel[0];
...
return obj;
 ...
 /// <param name = "lngRegionId">关键字</param>
 /// <returns>对象</returns>
clsvViewRegionWApi.GetObjByRegionId_WA_Cache = function(lngRegionId, strPrjId)  
{
...
clsvViewRegionWApi.GetFirstID = function(strWhereCond)  
{
...
clsvViewRegionWApi.GetFirstObj = function(strWhereCond)  
{
...
clsvViewRegionWApi.GetObjLst_Cache = async function(strPrjId)
{
var arrvViewRegionObjLst_Cache;
switch (clsvViewRegionWApi.CacheModeId)
{
case "04"://sessionStorage
arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_sessionStorage(strPrjId);
break;
case "03"://localStorage
arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_localStorage(strPrjId);
break;
case "02"://ClientCache
arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_ClientCache(strPrjId);
break;
default:
arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_ClientCache(strPrjId);
break;
}
return arrvViewRegionObjLst_Cache;
}
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvViewRegionWApi.GetObjLst_ClientCache = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvViewRegionWApi.InitListCache(); 
...
{
//缓存存在，直接取出返回
var arrvViewRegionObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrvViewRegionObjLst_Cache;
}
try
{
const responseText = await clsvViewRegionWApi.GetObjLst(strWhereCond);
var arrvViewRegionObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrvViewRegionObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvViewRegionObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvViewRegionWApi.GetObjLst_localStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvViewRegionWApi.InitListCache(); 
...
var arrvViewRegionObjLst_Cache = JSON.parse(strTempObjLst);
return arrvViewRegionObjLst_Cache;
}
try
{
const responseText = await clsvViewRegionWApi.GetObjLst(strWhereCond);
var arrvViewRegionObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrvViewRegionObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvViewRegionObjLst.length+ " !";
console.log(strInfo);
return arrvViewRegionObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvViewRegionWApi.GetObjLst_sessionStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvViewRegionWApi.InitListCache(); 
...
const responseText = await clsvViewRegionWApi.GetObjLst(strWhereCond);
var arrvViewRegionObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrvViewRegionObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvViewRegionObjLst.length+ " !";
console.log(strInfo);
return arrvViewRegionObjLst;
}
...
clsvViewRegionWApi.GetObjLst_WA_Cache = function()  
{
...
clsvViewRegionWApi.GetSubObjLst_Cache =  async function(objvViewRegion_Cond,strPrjId) {
var objvViewRegion_Sim = clsvViewRegionBL_js_1.clsvViewRegionBL.GetSimObjFromObj(objvViewRegion_Cond);
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var arrvViewRegion_Sel = arrvViewRegionObjLst_Cache.filter(x => true);
if (objvViewRegion_Sim.sf_FldComparisonOp == null || objvViewRegion_Sim.sf_FldComparisonOp == "") return arrvViewRegion_Sel;
var dicFldComparisonOp = JSON.parse(objvViewRegion_Sim.sf_FldComparisonOp);
console.log("clsvViewRegionWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objvViewRegion_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objvViewRegion_Sim[strKey];
...
if (strComparisonOp == "=") {
arrvViewRegion_Sel = arrvViewRegion_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrvViewRegion_Sel = arrvViewRegion_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrvViewRegion_Sel = arrvViewRegion_Sel.filter(x => x[strKey] == strValue);
}
...
return arrvViewRegion_Sel;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvViewRegion_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objvViewRegion_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvViewRegionWApi.GetSubObjLst_WA_Cache = function(objvViewRegion_Cond)  
{
...
clsvViewRegionWApi.GetObjLstByRegionIdLst = function(arrRegionId)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvViewRegionWApi.GetObjLstByRegionIdLst_Cache =  async function(arrRegionIdLst,strPrjId) {
try
{
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var arrvViewRegion_Sel = arrvViewRegionObjLst_Cache.filter(x => arrRegionIdLst.indexOf(x.RegionId)>-1);
return arrvViewRegion_Sel;
}
catch (e)
{
...
return null;
 ...
 /// <param name = "arrRegionId">关键字列表</param>
 /// <returns>对象列表</returns>
clsvViewRegionWApi.GetObjLstByRegionIdLst_WA_Cache = function(arrRegionId, strPrjId)  
{
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsvViewRegionWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsvViewRegionWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvViewRegionWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvViewRegionWApi.GetObjLstByPager_Cache =  async function(objPagerPara,strPrjId) {
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var arrvViewRegion_Sel = arrvViewRegionObjLst_Cache.filter(x => true);
...
console.log("clsvViewRegionWApi->GetObjLstByPager_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
arrvViewRegion_Sel = arrvViewRegion_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrvViewRegion_Sel = arrvViewRegion_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
arrvViewRegion_Sel = arrvViewRegion_Sel.slice(intStart, intEnd);     
return arrvViewRegion_Sel;
}
catch (e) {
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvViewRegionWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvViewRegionWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsvViewRegionWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objlngRegionId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsvViewRegionWApi.IsExistRecord_Cache =  async function(objvViewRegion_Cond,strPrjId) {
var objvViewRegion_Sim = clsvViewRegionBL_js_1.clsvViewRegionBL.GetSimObjFromObj(objvViewRegion_Cond);
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var arrvViewRegion_Sel = arrvViewRegionObjLst_Cache.filter(x => true);
if (objvViewRegion_Sim.sf_FldComparisonOp == null || objvViewRegion_Sim.sf_FldComparisonOp == "") return arrvViewRegion_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objvViewRegion_Sim.sf_FldComparisonOp);
console.log("clsvViewRegionWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objvViewRegion_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsvViewRegionWApi.IsExist = function(lngRegionId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "lngRegionId">所给的关键字</param>
 /// <returns>对象</returns>
clsvViewRegionWApi.IsExist_Cache = async function(lngRegionId,strPrjId) {
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvViewRegionEN_js_1.clsvViewRegionEN();
try
{
...
clsvViewRegionWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsvViewRegionWApi.GetRecCountByCond_Cache =  async function(objvViewRegion_Cond,strPrjId) {
var objvViewRegion_Sim = clsvViewRegionBL_js_1.clsvViewRegionBL.GetSimObjFromObj(objvViewRegion_Cond);
var arrvViewRegionObjLst_Cache = await clsvViewRegionWApi.GetObjLst_Cache(strPrjId);
var arrvViewRegion_Sel = arrvViewRegionObjLst_Cache.filter(x => true);
if (objvViewRegion_Sim.sf_FldComparisonOp == null || objvViewRegion_Sim.sf_FldComparisonOp == "") return arrvViewRegion_Sel.length;
var dicFldComparisonOp = JSON.parse(objvViewRegion_Sim.sf_FldComparisonOp);
console.log("clsvViewRegionWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
return arrvViewRegion_Sel.length;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvViewRegion_Sim) + "]获取相应的对象不成功!";
throw new Error(strMsg);
...
clsvViewRegionWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
return strServiceUrl;
 ...
 /// </summary>
clsvViewRegionWApi.InitListCache = function() 
{
//初始化列表缓存
if (clsViewRegionWApi_js_1.clsViewRegionWApi.objCommFun4BL == null)
{
strMsg = "类clsViewRegionWApi没有刷新缓存机制(clsViewRegionWApi.objCommFun4BL == null), 请联系程序员！(from {clsStackTrace.GetCurrClassFunction()})";
throw (strMsg);
}
}
 ...
 /// </summary>
clsvViewRegionWApi. ReFreshThisCache = function(strPrjId)
{
var strMsg = "";
...
clsvViewRegionWApi.mstrController = "vViewRegionApi";
clsvViewRegionWApi.CacheModeId = ""; //
return clsvViewRegionWApi;
}());
exports.clsvViewRegionWApi = clsvViewRegionWApi;
});