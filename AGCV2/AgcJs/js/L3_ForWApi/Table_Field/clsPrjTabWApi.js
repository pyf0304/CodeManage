...
{
define(["require", "exports", "jquery", "../../L0_Entity/Table_Field/clsPrjTabEN.js","../../L2_BLL/Table_Field/clsCommFun4WA4PrjTab.js","clscommonfunc4web","clsstacktrace","../../L2_BLL/Table_Field/clsPrjTabBL.js","tzdictionary","clssyspara4webapi","../../PubFun/stuTopPara.js","../../PubFun/stuRangePara.js","../../PubFun/stuPagerPara.js","cachehelper","clsfldcomparisonobj"], factory);
}
...
var clsCommFun4WA4PrjTab_js_1 = require("../../L2_BLL/Table_Field/clsCommFun4WA4PrjTab.js");
var clsCommonFunc4Web_js_1 = require("clscommonfunc4web");
var clsStackTrace_js_1 = require("clsstacktrace");
var clsPrjTabBL_js_1 = require("../../L2_BLL/Table_Field/clsPrjTabBL.js");
...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 ...
 /// </summary>
var ResponseData;
var clsPrjTabWApi = /** @class */ (function() {
function clsPrjTabWApi(pobjPrjTabEN)
{
this.objPrjTabEN = new clsPrjTabEN_js_1.clsPrjTabEN();
this.objPrjTabEN = pobjPrjTabEN;
}
 ...
 /// <returns>对象</returns>
clsPrjTabWApi.GetObjByTabId = function(strTabId)  
{
var strAction = "GetObjByTabId";
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsPrjTabWApi.GetObjByTabId_Cache = async function(strTabId,strPrjId) {
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var obj = new clsPrjTabEN_js_1.clsPrjTabEN();
try
{
var arrPrjTab_Sel = arrPrjTabObjLst_Cache.filter(x => x.TabId == strTabId);
var objPrjTab;
if (arrPrjTab_Sel.length > 0)
{
objPrjTab = arrPrjTab_Sel[0];
return objPrjTab;
}
else
{
...
return obj;
 ...
 /// <param name = "strTabId">所给的关键字</param>
 /// <returns>对象</returns>
clsPrjTabWApi.SetCache = function() {
clsPrjTabWApi.objCommFun4BL = new clsCommFun4WA4PrjTab_js_1.clsCommFun4WA4PrjTab();
...
//clsPrjTabWApi_js_1.clsPrjTabWApi.SetCache();
 ...
 /// <param name = "strTabId">关键字</param>
 /// <returns>对象</returns>
clsPrjTabWApi.GetObjByTabId_WA_Cache = function(strTabId, strPrjId)  
{
...
clsPrjTabWApi.GetFirstID = function(strWhereCond)  
{
...
clsPrjTabWApi.GetFirstObj = function(strWhereCond)  
{
...
clsPrjTabWApi.GetObjLst_Cache = async function(strPrjId)
{
var arrPrjTabObjLst_Cache;
switch (clsPrjTabWApi.CacheModeId)
{
case "04"://sessionStorage
arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_sessionStorage(strPrjId);
break;
case "03"://localStorage
arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_localStorage(strPrjId);
break;
case "02"://ClientCache
arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_ClientCache(strPrjId);
break;
default:
arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_ClientCache(strPrjId);
break;
}
return arrPrjTabObjLst_Cache;
}
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsPrjTabWApi.GetObjLst_ClientCache = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsPrjTabWApi.InitListCache(); 
...
{
//缓存存在，直接取出返回
var arrPrjTabObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrPrjTabObjLst_Cache;
}
try
{
const responseText = await clsPrjTabWApi.GetObjLst(strWhereCond);
var arrPrjTabObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrPrjTabObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrPrjTabObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsPrjTabWApi.GetObjLst_localStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsPrjTabWApi.InitListCache(); 
...
var arrPrjTabObjLst_Cache = JSON.parse(strTempObjLst);
return arrPrjTabObjLst_Cache;
}
try
{
const responseText = await clsPrjTabWApi.GetObjLst(strWhereCond);
var arrPrjTabObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrPrjTabObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrPrjTabObjLst.length+ " !";
console.log(strInfo);
return arrPrjTabObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsPrjTabWApi.GetObjLst_sessionStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsPrjTabWApi.InitListCache(); 
...
const responseText = await clsPrjTabWApi.GetObjLst(strWhereCond);
var arrPrjTabObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrPrjTabObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrPrjTabObjLst.length+ " !";
console.log(strInfo);
return arrPrjTabObjLst;
}
...
clsPrjTabWApi.GetObjLst_WA_Cache = function()  
{
...
clsPrjTabWApi.GetSubObjLst_Cache =  async function(objPrjTab_Cond,strPrjId) {
var objPrjTab_Sim = clsPrjTabBL_js_1.clsPrjTabBL.GetSimObjFromObj(objPrjTab_Cond);
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var arrPrjTab_Sel = arrPrjTabObjLst_Cache.filter(x => true);
if (objPrjTab_Sim.sf_FldComparisonOp == null || objPrjTab_Sim.sf_FldComparisonOp == "") return arrPrjTab_Sel;
var dicFldComparisonOp = JSON.parse(objPrjTab_Sim.sf_FldComparisonOp);
console.log("clsPrjTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objPrjTab_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objPrjTab_Sim[strKey];
...
if (strComparisonOp == "=") {
arrPrjTab_Sel = arrPrjTab_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrPrjTab_Sel = arrPrjTab_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrPrjTab_Sel = arrPrjTab_Sel.filter(x => x[strKey] == strValue);
}
...
return arrPrjTab_Sel;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objPrjTab_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objPrjTab_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsPrjTabWApi.GetSubObjLst_WA_Cache = function(objPrjTab_Cond)  
{
...
clsPrjTabWApi.GetObjLstByTabIdLst = function(arrTabId)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsPrjTabWApi.GetObjLstByTabIdLst_Cache =  async function(arrTabIdLst,strPrjId) {
try
{
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var arrPrjTab_Sel = arrPrjTabObjLst_Cache.filter(x => arrTabIdLst.indexOf(x.TabId)>-1);
return arrPrjTab_Sel;
}
catch (e)
{
...
return null;
 ...
 /// <param name = "arrTabId">关键字列表</param>
 /// <returns>对象列表</returns>
clsPrjTabWApi.GetObjLstByTabIdLst_WA_Cache = function(arrTabId, strPrjId)  
{
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsPrjTabWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsPrjTabWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsPrjTabWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsPrjTabWApi.GetObjLstByPager_Cache =  async function(objPagerPara,strPrjId) {
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var arrPrjTab_Sel = arrPrjTabObjLst_Cache.filter(x => true);
...
console.log("clsPrjTabWApi->GetObjLstByPager_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
arrPrjTab_Sel = arrPrjTab_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrPrjTab_Sel = arrPrjTab_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
arrPrjTab_Sel = arrPrjTab_Sel.slice(intStart, intEnd);     
return arrPrjTab_Sel;
}
catch (e) {
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsPrjTabWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsPrjTabWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsPrjTabWApi.DelRecord = function(strTabId)  
{
var strAction = "DelRecord";
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
strUrl =  strUrl+ "/" +  strTabId;
var mapParam = new Dictionary_js_1.Dictionary();
...
clsPrjTabWApi.DelRecordBySign = function(arrTabId) 
{
...
clsPrjTabWApi.UnDelRecordBySign = function(arrTabId) 
{
...
reject(result.statusText);
 ...
 /// <param name = "arrTabId">关键字列表</param>
 /// <returns>实际删除记录的个数</returns>
clsPrjTabWApi.DelPrjTabs = function(arrTabId) 
{
var strAction = "DelPrjTabs";
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
clsPrjTabWApi.DelPrjTabsByCond = function(strWhereCond) 
{
var strAction = "DelPrjTabsByCond";
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// </summary>
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.AddNewRecordWithMaxId = function(objPrjTabEN) 
{
var strMsg = "";
var strAction = "AddNewRecordWithMaxId";
var objPrjTabEN_Sim = clsPrjTabBL_js_1.clsPrjTabBL.GetSimObjFromObj(objPrjTabEN);
 //var strJSON = JSON.stringify(objPrjTabEN_Sim);
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.GoTop = function(objOrderByData) 
{
var strMsg = "";
var strAction = "GoTop";
...
reject(result.statusText);
 ...
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.UpMove = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.DownMove = function(objOrderByData)
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.GoBottom = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.ReOrder = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objPrjTabEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsPrjTabWApi.AddNewRecord = function(objPrjTabEN) 
{
var strMsg = "";
...
clsPrjTabWApi.AddNewRecordWithReturnKey = function(objPrjTabEN) 
{
...
clsPrjTabWApi.UpdateRecord = function(objPrjTabEN)  
{
var strMsg = "";
var strAction = "UpdateRecord";
 if (objPrjTabEN.sf_UpdFldSetStr === null || objPrjTabEN.sf_UpdFldSetStr === "")
{
strMsg = "对象(关键字: " + objPrjTabEN.TabId + ")的【修改字段集】为空，不能修改!";
 throw strMsg;
 }
var objPrjTabEN_Sim = clsPrjTabBL_js_1.clsPrjTabBL.GetSimObjFromObj(objPrjTabEN);
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>返回的第一条记录的关键字值</returns>
clsPrjTabWApi.UpdateWithCondition = function(objPrjTabEN, strWhereCond ) 
{
var strAction = "UpdateWithCondition";
 if (objPrjTabEN.sf_UpdFldSetStr === null || objPrjTabEN.sf_UpdFldSetStr === "")
{
var strMsg = "对象(关键字:" + objPrjTabEN.TabId + ")的【修改字段集】为空，不能修改!";
 throw new Error(strMsg);
 }
let strUrl = this.GetWebApiUrl(clsPrjTabWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
...
clsPrjTabWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objstrTabId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsPrjTabWApi.IsExistRecord_Cache =  async function(objPrjTab_Cond,strPrjId) {
var objPrjTab_Sim = clsPrjTabBL_js_1.clsPrjTabBL.GetSimObjFromObj(objPrjTab_Cond);
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var arrPrjTab_Sel = arrPrjTabObjLst_Cache.filter(x => true);
if (objPrjTab_Sim.sf_FldComparisonOp == null || objPrjTab_Sim.sf_FldComparisonOp == "") return arrPrjTab_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objPrjTab_Sim.sf_FldComparisonOp);
console.log("clsPrjTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objPrjTab_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsPrjTabWApi.IsExist = function(strTabId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "strTabId">所给的关键字</param>
 /// <returns>对象</returns>
clsPrjTabWApi.IsExist_Cache = async function(strTabId,strPrjId) {
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var obj = new clsPrjTabEN_js_1.clsPrjTabEN();
try
{
...
clsPrjTabWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsPrjTabWApi.GetRecCountByCond_Cache =  async function(objPrjTab_Cond,strPrjId) {
var objPrjTab_Sim = clsPrjTabBL_js_1.clsPrjTabBL.GetSimObjFromObj(objPrjTab_Cond);
var arrPrjTabObjLst_Cache = await clsPrjTabWApi.GetObjLst_Cache(strPrjId);
var arrPrjTab_Sel = arrPrjTabObjLst_Cache.filter(x => true);
if (objPrjTab_Sim.sf_FldComparisonOp == null || objPrjTab_Sim.sf_FldComparisonOp == "") return arrPrjTab_Sel.length;
var dicFldComparisonOp = JSON.parse(objPrjTab_Sim.sf_FldComparisonOp);
console.log("clsPrjTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
clsPrjTabWApi.GetMaxStrId = function()  
{
...
clsPrjTabWApi.GetMaxStrIdByPrefix = function(strPrefix)  
{
...
clsPrjTabWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
clsPrjTabWApi.BindDdl_TabId_Cache2 = function(strDdlName, objPrjTab_Cond, strPrjId) {
//var strWhereCond = " 1 =1 ";
...
try
{
var arrObjLst_Sel = clsPrjTabWApi.GetSubObjLst_Cache(objPrjTab_Cond,strPrjId);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsPrjTabEN_js_1.clsPrjTabEN.con_TabId, clsPrjTabEN_js_1.clsPrjTabEN.con_TabName, "工程表");
...
alert(strMsg);
 ...
 /// </summary>
clsPrjTabWApi.InitListCache = function() 
{
//初始化列表缓存
//检查缓存刷新机制
var strMsg = "";
if (clsPrjTabWApi.objCommFun4BL == null)
{
strMsg = "类clsPrjTabWApi没有刷新缓存机制(clsPrjTabWApi.objCommFun4BL == null), 请联系程序员！(from " + clsStackTrace_js_1.clsStackTrace.GetCurrClassFunction() + ")";
throw new Error(strMsg);
}
}
 ...
 /// </summary>
clsPrjTabWApi.ReFreshCache = function(strPrjId)
{
if (clsPrjTabWApi.objCommFun4BL != null) 
{
...
clsPrjTabWApi.objCommFun4BL.ReFreshCache(strPrjId);
}
}
 ...
 /// </summary>
clsPrjTabWApi. ReFreshThisCache = function(strPrjId)
{
var strMsg = "";
...
clsPrjTabWApi.BindDdl_TabId_Cache = async function(strDdlName, objPrjTab_Cond, strPrjId)
{
var objDdl = document.getElementById(strDdlName);
if (objDdl == null)
{
...
var arrObjLst_Sel = await clsPrjTabWApi.GetSubObjLst_Cache(objPrjTab_Cond, strPrjId);
arrObjLst_Sel = arrObjLst_Sel.filter(x=>x.PrjId == strPrjId);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsPrjTabEN_js_1.clsPrjTabEN.con_TabId, clsPrjTabEN_js_1.clsPrjTabEN.con_TabName, "工程表");
}
clsPrjTabWApi.mstrController = "PrjTabApi";
clsPrjTabWApi.CacheModeId = ""; //
return clsPrjTabWApi;
}());
exports.clsPrjTabWApi = clsPrjTabWApi;
});