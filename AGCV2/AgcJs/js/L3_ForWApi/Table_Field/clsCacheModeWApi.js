...
{
define(["require", "exports", "jquery", "../../L0_Entity/Table_Field/clsCacheModeEN.js","../../L2_BLL/Table_Field/clsCommFun4WA4CacheMode.js","clscommonfunc4web","clsstacktrace","../../L2_BLL/Table_Field/clsCacheModeBL.js","tzdictionary","clssyspara4webapi","../../PubFun/stuTopPara.js","../../PubFun/stuRangePara.js","../../PubFun/stuPagerPara.js","cachehelper","clsfldcomparisonobj"], factory);
}
...
var clsCommFun4WA4CacheMode_js_1 = require("../../L2_BLL/Table_Field/clsCommFun4WA4CacheMode.js");
var clsCommonFunc4Web_js_1 = require("clscommonfunc4web");
var clsStackTrace_js_1 = require("clsstacktrace");
var clsCacheModeBL_js_1 = require("../../L2_BLL/Table_Field/clsCacheModeBL.js");
...
var clsFldComparisonObj_js_1 = require("clsfldcomparisonobj");
 ...
 /// </summary>
var ResponseData;
var clsCacheModeWApi = /** @class */ (function() {
function clsCacheModeWApi(pobjCacheModeEN)
{
this.objCacheModeEN = new clsCacheModeEN_js_1.clsCacheModeEN();
this.objCacheModeEN = pobjCacheModeEN;
}
 ...
 /// <returns>对象</returns>
clsCacheModeWApi.GetObjByCacheModeId = function(strCacheModeId)  
{
var strAction = "GetObjByCacheModeId";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
mapParam.add("CacheModeId", strCacheModeId);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsCacheModeWApi.GetObjByCacheModeId_Cache = async function(strCacheModeId) {
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var obj = new clsCacheModeEN_js_1.clsCacheModeEN();
try
{
var arrCacheMode_Sel = arrCacheModeObjLst_Cache.filter(x => x.CacheModeId == strCacheModeId);
var objCacheMode;
...
{
var strMsg = "根据关键字:[" + strCacheModeId  + "]获取相应的对象不成功!";
alert(strMsg);
}
return obj;
};
 ...
 /// <param name = "strCacheModeId">所给的关键字</param>
 /// <returns>对象</returns>
clsCacheModeWApi.SetCache = function() {
clsCacheModeWApi.objCommFun4BL = new clsCommFun4WA4CacheMode_js_1.clsCommFun4WA4CacheMode();
...
//clsCacheModeWApi_js_1.clsCacheModeWApi.SetCache();
 ...
 /// <param name = "strCacheModeId">关键字</param>
 /// <returns>对象</returns>
clsCacheModeWApi.GetObjByCacheModeId_WA_Cache = function(strCacheModeId)  
{
var strAction = "GetObjByCacheModeId_Cache";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
mapParam.add("CacheModeId", strCacheModeId);
let strData = mapParam.getParamText();// "例如: strIdentityID =01";
...
clsCacheModeWApi.GetFirstID = function(strWhereCond)  
{
...
clsCacheModeWApi.GetFirstObj = function(strWhereCond)  
{
...
clsCacheModeWApi.GetObjLst_Cache = async function() 
{
var arrCacheModeObjLst_Cache;
switch (clsCacheModeWApi.CacheModeId)
{
case "04"://sessionStorage
arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_sessionStorage();
break;
case "03"://localStorage
arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_localStorage();
break;
case "02"://ClientCache
arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_ClientCache();
break;
default:
arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_ClientCache();
break;
...
return arrCacheModeObjLst_Cache;
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsCacheModeWApi.GetObjLst_ClientCache = async function() 
{
//初始化列表缓存
var strWhereCond = "1=1";
clsCacheModeWApi.InitListCache(); 
var strKey = clsCacheModeEN_js_1.clsCacheModeEN._CurrTabName;
if (strKey == "")
{
...
{
//缓存存在，直接取出返回
var arrCacheModeObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrCacheModeObjLst_Cache;
}
try
{
const responseText = await clsCacheModeWApi.GetObjLst(strWhereCond);
var arrCacheModeObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrCacheModeObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrCacheModeObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsCacheModeWApi.GetObjLst_localStorage = async function() 
{
//初始化列表缓存
var strWhereCond = "1=1";
clsCacheModeWApi.InitListCache(); 
...
var arrCacheModeObjLst_Cache = JSON.parse(strTempObjLst);
return arrCacheModeObjLst_Cache;
}
try
{
const responseText = await clsCacheModeWApi.GetObjLst(strWhereCond);
var arrCacheModeObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrCacheModeObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrCacheModeObjLst.length+ " !";
console.log(strInfo);
return arrCacheModeObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsCacheModeWApi.GetObjLst_sessionStorage = async function() 
{
//初始化列表缓存
var strWhereCond = "1=1";
clsCacheModeWApi.InitListCache(); 
...
const responseText = await clsCacheModeWApi.GetObjLst(strWhereCond);
var arrCacheModeObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrCacheModeObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrCacheModeObjLst.length+ " !";
console.log(strInfo);
return arrCacheModeObjLst;
}
...
clsCacheModeWApi.GetObjLst_WA_Cache = function()  
{
...
reject(result.statusText);
 ...
 /// </summary>
 /// <param name = "objstrCacheModeId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsCacheModeWApi.GetSubObjLst_Cache =  async function(objCacheMode_Cond) {
var objCacheMode_Sim = clsCacheModeBL_js_1.clsCacheModeBL.GetSimObjFromObj(objCacheMode_Cond);
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var arrCacheMode_Sel = arrCacheModeObjLst_Cache.filter(x => true);
if (objCacheMode_Sim.sf_FldComparisonOp == null || objCacheMode_Sim.sf_FldComparisonOp == "") return arrCacheMode_Sel;
var dicFldComparisonOp = JSON.parse(objCacheMode_Sim.sf_FldComparisonOp);
console.log("clsCacheModeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objCacheMode_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objCacheMode_Sim[strKey];
...
if (strComparisonOp == "=") {
arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x[strKey] == strValue);
}
...
var strMsg = "根据条件:[" +JSON.stringify( objCacheMode_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objCacheMode_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsCacheModeWApi.GetSubObjLst_WA_Cache = function(objCacheMode_Cond)  
{
...
clsCacheModeWApi.GetObjLstByCacheModeIdLst = function(arrCacheModeId)  
{
var strAction = "GetObjLstByCacheModeIdLst";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
return new Promise(function(resolve, reject) {
$.ajax({
...
reject(result.statusText);
 ...
 /// </summary>
 /// <param name = "arrstrCacheModeIdLst">关键字列表</param>
 /// <returns>对象列表</returns>
clsCacheModeWApi.GetObjLstByCacheModeIdLst_Cache =  async function(arrCacheModeIdLst) {
try
{
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var arrCacheMode_Sel = arrCacheModeObjLst_Cache.filter(x => arrCacheModeIdLst.indexOf(x.CacheModeId)>-1);
return arrCacheMode_Sel;
}
catch (e)
{
var strMsg = "根据关键字:[" + arrCacheModeIdLst.join(",")  + "]获取相应的对象不成功!";
throw new Error(strMsg);
}
return null;
};
 ...
 /// <param name = "arrCacheModeId">关键字列表</param>
 /// <returns>对象列表</returns>
clsCacheModeWApi.GetObjLstByCacheModeIdLst_WA_Cache = function(arrCacheModeId)  
{
var strAction = "GetObjLstByCacheModeIdLst_Cache";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
return new Promise(function(resolve, reject) {
$.ajax({
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsCacheModeWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsCacheModeWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsCacheModeWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsCacheModeWApi.GetObjLstByPager_Cache =  async function(objPagerPara) {
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var arrCacheMode_Sel = arrCacheModeObjLst_Cache.filter(x => true);
...
arrCacheMode_Sel = arrCacheMode_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrCacheMode_Sel = arrCacheMode_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsCacheModeWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsCacheModeWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsCacheModeWApi.DelRecord = function(strCacheModeId)  
{
var strAction = "DelRecord";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
strUrl =  strUrl+ "/" +  strCacheModeId;
var mapParam = new Dictionary_js_1.Dictionary();
mapParam.add("strCacheModeId", strCacheModeId);
let strData = mapParam.getParamText();// "例如: strIdentityID =01";
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
clsCacheModeWApi.DelRecordBySign = function(arrCacheModeId) 
{
...
clsCacheModeWApi.UnDelRecordBySign = function(arrCacheModeId) 
{
...
reject(result.statusText);
 ...
 /// <param name = "arrCacheModeId">关键字列表</param>
 /// <returns>实际删除记录的个数</returns>
clsCacheModeWApi.DelCacheModes = function(arrCacheModeId) 
{
var strAction = "DelCacheModes";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
clsCacheModeWApi.DelCacheModesByCond = function(strWhereCond) 
{
var strAction = "DelCacheModesByCond";
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// </summary>
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.AddNewRecordWithMaxId = function(objCacheModeEN) 
{
var strMsg = "";
var strAction = "AddNewRecordWithMaxId";
var objCacheModeEN_Sim = clsCacheModeBL_js_1.clsCacheModeBL.GetSimObjFromObj(objCacheModeEN);
 //var strJSON = JSON.stringify(objCacheModeEN_Sim);
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
return new Promise(function(resolve, reject) {
$.ajax({
url: strUrl,
...
reject(result.statusText);
 ...
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.GoTop = function(objOrderByData) 
{
var strMsg = "";
var strAction = "GoTop";
...
reject(result.statusText);
 ...
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.UpMove = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.DownMove = function(objOrderByData)
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.GoBottom = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.ReOrder = function(objOrderByData) 
{
var strMsg = "";
...
reject(result.statusText);
 ...
 /// <param name = "objCacheModeEN">需要添加的对象</param>
 /// <returns>获取相应的记录的对象</returns>
clsCacheModeWApi.AddNewRecord = function(objCacheModeEN) 
{
var strMsg = "";
...
clsCacheModeWApi.AddNewRecordWithReturnKey = function(objCacheModeEN) 
{
...
clsCacheModeWApi.UpdateRecord = function(objCacheModeEN)  
{
var strMsg = "";
var strAction = "UpdateRecord";
 if (objCacheModeEN.sf_UpdFldSetStr === null || objCacheModeEN.sf_UpdFldSetStr === "")
{
strMsg = "对象(关键字: " + objCacheModeEN.CacheModeId + ")的【修改字段集】为空，不能修改!";
 throw strMsg;
 }
var objCacheModeEN_Sim = clsCacheModeBL_js_1.clsCacheModeBL.GetSimObjFromObj(objCacheModeEN);
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>返回的第一条记录的关键字值</returns>
clsCacheModeWApi.UpdateWithCondition = function(objCacheModeEN, strWhereCond ) 
{
var strAction = "UpdateWithCondition";
 if (objCacheModeEN.sf_UpdFldSetStr === null || objCacheModeEN.sf_UpdFldSetStr === "")
{
var strMsg = "对象(关键字:" + objCacheModeEN.CacheModeId + ")的【修改字段集】为空，不能修改!";
 throw new Error(strMsg);
 }
let strUrl = this.GetWebApiUrl(clsCacheModeWApi.mstrController, strAction);
var mapParam = new Dictionary_js_1.Dictionary();
...
clsCacheModeWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objstrCacheModeId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsCacheModeWApi.IsExistRecord_Cache =  async function(objCacheMode_Cond) {
var objCacheMode_Sim = clsCacheModeBL_js_1.clsCacheModeBL.GetSimObjFromObj(objCacheMode_Cond);
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var arrCacheMode_Sel = arrCacheModeObjLst_Cache.filter(x => true);
if (objCacheMode_Sim.sf_FldComparisonOp == null || objCacheMode_Sim.sf_FldComparisonOp == "") return arrCacheMode_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objCacheMode_Sim.sf_FldComparisonOp);
console.log("clsCacheModeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objCacheMode_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsCacheModeWApi.IsExist = function(strCacheModeId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "strCacheModeId">所给的关键字</param>
 /// <returns>对象</returns>
clsCacheModeWApi.IsExist_Cache = async function(strCacheModeId) {
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var obj = new clsCacheModeEN_js_1.clsCacheModeEN();
try
{
...
{
var strMsg = "根据关键字:[" + strCacheModeId  + "]判断是否存在不成功!";
alert(strMsg);
}
return false;
};
...
clsCacheModeWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsCacheModeWApi.GetRecCountByCond_Cache =  async function(objCacheMode_Cond) {
var objCacheMode_Sim = clsCacheModeBL_js_1.clsCacheModeBL.GetSimObjFromObj(objCacheMode_Cond);
var arrCacheModeObjLst_Cache = await clsCacheModeWApi.GetObjLst_Cache();
var arrCacheMode_Sel = arrCacheModeObjLst_Cache.filter(x => true);
if (objCacheMode_Sim.sf_FldComparisonOp == null || objCacheMode_Sim.sf_FldComparisonOp == "") return arrCacheMode_Sel.length;
var dicFldComparisonOp = JSON.parse(objCacheMode_Sim.sf_FldComparisonOp);
console.log("clsCacheModeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
clsCacheModeWApi.GetMaxStrId = function()  
{
...
clsCacheModeWApi.GetMaxStrIdByPrefix = function(strPrefix)  
{
...
clsCacheModeWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
/// <summary>
/// 为下拉框获取数据,从表:[CacheMode]中获取
 /// (AutoGCLib.WA_Access4JavaScript:Gen_4WA_Js_DdlBind_Cache)
/// </summary>
/// <returns>获取主键字段、名称字段两列的所有记录记录的DataTable</returns>
clsCacheModeWApi.BindDdl_CacheModeId_Cache2 = function(strDdlName, objCacheMode_Cond) {
//var strWhereCond = " 1 =1 ";
...
try
{
var arrObjLst_Sel = clsCacheModeWApi.GetSubObjLst_Cache(objCacheMode_Cond);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeId, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeName, "缓存方式");
console.log("完成BindDdl_CacheModeId!");
}
catch (e)
{
...
alert(strMsg);
 ...
 /// </summary>
clsCacheModeWApi.InitListCache = function() 
{
//初始化列表缓存
//检查缓存刷新机制
var strMsg = "";
...
{
strMsg = "类clsCacheModeWApi没有刷新缓存机制(clsCacheModeWApi.objCommFun4BL == null), 请联系程序员！(from " + clsStackTrace_js_1.clsStackTrace.GetCurrClassFunction() + ")";
throw new Error(strMsg);
}
}
 ...
 /// </summary>
clsCacheModeWApi.ReFreshCache = function()
{
if (clsCacheModeWApi.objCommFun4BL != null) 
{
...
clsCacheModeWApi.objCommFun4BL.ReFreshCache();
}
}
 ...
 /// </summary>
clsCacheModeWApi. ReFreshThisCache = function()
{
var strMsg = "";
...
clsCacheModeWApi.BindDdl_CacheModeId_Cache = async function(strDdlName, objCacheMode_Cond)
{
var objDdl = document.getElementById(strDdlName);
if (objDdl == null)
{
...
//为数据源于表的下拉框设置内容
console.log("开始：BindDdl_CacheModeId_Cache");
var arrObjLst_Sel = await clsCacheModeWApi.GetSubObjLst_Cache(objCacheMode_Cond);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeId, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeName, "缓存方式");
}
clsCacheModeWApi.mstrController = "CacheModeApi";
clsCacheModeWApi.CacheModeId = "03"; //localStorage
return clsCacheModeWApi;
}());
exports.clsCacheModeWApi = clsCacheModeWApi;
});