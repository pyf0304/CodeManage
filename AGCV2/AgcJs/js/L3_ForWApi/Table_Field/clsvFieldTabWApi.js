...
var clsvFieldTabBL_js_1 = require("../../L2_BLL/Table_Field/clsvFieldTabBL.js");
...
var clsFieldTabWApi_js_1 = require("../../L3_ForWApi/Table_Field/clsFieldTabWApi.js");
 ...
 /// </summary>
var ResponseData;
var clsvFieldTabWApi = /** @class */ (function() {
function clsvFieldTabWApi(pobjvFieldTabEN)
{
this.objvFieldTabEN = new clsvFieldTabEN_js_1.clsvFieldTabEN();
this.objvFieldTabEN = pobjvFieldTabEN;
 ...
 /// <returns>对象</returns>
clsvFieldTabWApi.GetObjByFldId = function(strFldId)  
{
var strAction = "GetObjByFldId";
let strUrl = this.GetWebApiUrl(clsvFieldTabWApi.mstrController, strAction);
...
reject(result.statusText);
 ...
 /// <returns>对象</returns>
clsvFieldTabWApi.GetObjByFldId_Cache = async function(strFldId,strPrjId) {
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvFieldTabEN_js_1.clsvFieldTabEN();
try
{
var arrvFieldTab_Sel = arrvFieldTabObjLst_Cache.filter(x => x.FldId == strFldId);
var objvFieldTab;
if (arrvFieldTab_Sel.length > 0)
{
objvFieldTab = arrvFieldTab_Sel[0];
return objvFieldTab;
}
else
{
...
return obj;
 ...
 /// <param name = "strFldId">关键字</param>
 /// <returns>对象</returns>
clsvFieldTabWApi.GetObjByFldId_WA_Cache = function(strFldId, strPrjId)  
{
...
clsvFieldTabWApi.GetFirstID = function(strWhereCond)  
{
...
clsvFieldTabWApi.GetFirstObj = function(strWhereCond)  
{
...
clsvFieldTabWApi.GetObjLst_Cache = async function(strPrjId)
{
var arrvFieldTabObjLst_Cache;
switch (clsvFieldTabWApi.CacheModeId)
{
case "04"://sessionStorage
arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_sessionStorage(strPrjId);
break;
case "03"://localStorage
arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_localStorage(strPrjId);
break;
case "02"://ClientCache
arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_ClientCache(strPrjId);
break;
default:
arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_ClientCache(strPrjId);
break;
}
return arrvFieldTabObjLst_Cache;
}
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvFieldTabWApi.GetObjLst_ClientCache = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvFieldTabWApi.InitListCache(); 
...
{
//缓存存在，直接取出返回
var arrvFieldTabObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
return arrvFieldTabObjLst_Cache;
}
try
{
const responseText = await clsvFieldTabWApi.GetObjLst(strWhereCond);
var arrvFieldTabObjLst = responseText;
CacheHelper_js_1.CacheHelper.Add(strKey, arrvFieldTabObjLst);
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvFieldTabObjLst.length+ " !";
console.log(strInfo);
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvFieldTabWApi.GetObjLst_localStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvFieldTabWApi.InitListCache(); 
...
var arrvFieldTabObjLst_Cache = JSON.parse(strTempObjLst);
return arrvFieldTabObjLst_Cache;
}
try
{
const responseText = await clsvFieldTabWApi.GetObjLst(strWhereCond);
var arrvFieldTabObjLst = responseText;
localStorage.setItem(strKey, JSON.stringify(arrvFieldTabObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvFieldTabObjLst.length+ " !";
console.log(strInfo);
return arrvFieldTabObjLst;
}
...
throw (strMsg);
 ...
 /// </summary>
 /// <returns>从本地缓存中获取的对象列表</returns>
clsvFieldTabWApi.GetObjLst_sessionStorage = async function(strPrjId)
{
//初始化列表缓存
var strWhereCond = "1=1";
clsvFieldTabWApi.InitListCache(); 
...
const responseText = await clsvFieldTabWApi.GetObjLst(strWhereCond);
var arrvFieldTabObjLst = responseText;
sessionStorage.setItem(strKey, JSON.stringify(arrvFieldTabObjLst));
var strInfo = "Key:[" + strKey+ " ]的缓存已经建立，对象列表数：" + arrvFieldTabObjLst.length+ " !";
console.log(strInfo);
return arrvFieldTabObjLst;
}
...
clsvFieldTabWApi.GetObjLst_WA_Cache = function()  
{
...
clsvFieldTabWApi.GetSubObjLst_Cache =  async function(objvFieldTab_Cond,strPrjId) {
var objvFieldTab_Sim = clsvFieldTabBL_js_1.clsvFieldTabBL.GetSimObjFromObj(objvFieldTab_Cond);
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var arrvFieldTab_Sel = arrvFieldTabObjLst_Cache.filter(x => true);
if (objvFieldTab_Sim.sf_FldComparisonOp == null || objvFieldTab_Sim.sf_FldComparisonOp == "") return arrvFieldTab_Sel;
var dicFldComparisonOp = JSON.parse(objvFieldTab_Sim.sf_FldComparisonOp);
console.log("clsvFieldTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
var sstrKeys = clsCommonFunc4Web_js_1.clsCommonFunc4Web.GetObjKeys(objvFieldTab_Sim);
console.log(sstrKeys);
for (let strKey of sstrKeys) {
if (dicFldComparisonOp.hasOwnProperty(strKey) == false) continue;
var strComparisonOp = dicFldComparisonOp[strKey];
var strValue = objvFieldTab_Sim[strKey];
...
if (strComparisonOp == "=") {
arrvFieldTab_Sel = arrvFieldTab_Sel.filter(x => x[strKey].toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrvFieldTab_Sel = arrvFieldTab_Sel.filter(x => x[strKey].toString().indexOf(strValue) != -1);
}
break;
case "number":
if (strValue == 0) continue;
if (strComparisonOp == "=") {
arrvFieldTab_Sel = arrvFieldTab_Sel.filter(x => x[strKey] == strValue);
}
...
return arrvFieldTab_Sel;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvFieldTab_Sim) + "]获取相应的对象不成功!";
...
return null;
 ...
 /// </summary>
 /// <param name = "objvFieldTab_Cond">条件对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvFieldTabWApi.GetSubObjLst_WA_Cache = function(objvFieldTab_Cond)  
{
...
clsvFieldTabWApi.GetObjLstByFldIdLst = function(arrFldId)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvFieldTabWApi.GetObjLstByFldIdLst_Cache =  async function(arrFldIdLst,strPrjId) {
try
{
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var arrvFieldTab_Sel = arrvFieldTabObjLst_Cache.filter(x => arrFldIdLst.indexOf(x.FldId)>-1);
return arrvFieldTab_Sel;
}
catch (e)
{
...
return null;
 ...
 /// <param name = "arrFldId">关键字列表</param>
 /// <returns>对象列表</returns>
clsvFieldTabWApi.GetObjLstByFldIdLst_WA_Cache = function(arrFldId, strPrjId)  
{
...
reject(result.statusText);
 ...
 /// <param name = "strWhereCond">条件</param>
 /// <returns>获取的相应对象列表</returns>
clsvFieldTabWApi.GetObjLst = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应对象列表</returns>
clsvFieldTabWApi.GetTopObjLst = function(objTopPara)  
{
...
reject(result.statusText);
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvFieldTabWApi.GetObjLstByRange = function(objRangePara)  
{
...
reject(result.statusText);
 ...
 /// <returns>对象列表</returns>
clsvFieldTabWApi.GetObjLstByPager_Cache =  async function(objPagerPara,strPrjId) {
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var arrvFieldTab_Sel = arrvFieldTabObjLst_Cache.filter(x => true);
...
console.log("clsvFieldTabWApi->GetObjLstByPager_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
arrvFieldTab_Sel = arrvFieldTab_Sel.sort((x, y) => x[strSortFld].localeCompare(y[strSortFld]));
}
else {
arrvFieldTab_Sel = arrvFieldTab_Sel.sort((x, y) => y[strSortFld].localeCompare(x[strSortFld]));
}
}
arrvFieldTab_Sel = arrvFieldTab_Sel.slice(intStart, intEnd);     
return arrvFieldTab_Sel;
}
catch (e) {
...
return null;
 ...
 /// <returns>获取的相应记录对象列表</returns>
clsvFieldTabWApi.GetObjLstByPager_WA_Cache = function(objPagerPara)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
 /// <returns>获取的相应记录对象列表</returns>
clsvFieldTabWApi.GetObjLstByPager = function(objPagerPara)  
{
...
clsvFieldTabWApi.IsExistRecord = function(strWhereCond)  
{
...
reject(result.statusText);
 ...
 /// <param name = "objstrFldId_Cond">条件对象</param>
 /// <returns>对象列表子集</returns>
clsvFieldTabWApi.IsExistRecord_Cache =  async function(objvFieldTab_Cond,strPrjId) {
var objvFieldTab_Sim = clsvFieldTabBL_js_1.clsvFieldTabBL.GetSimObjFromObj(objvFieldTab_Cond);
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var arrvFieldTab_Sel = arrvFieldTabObjLst_Cache.filter(x => true);
if (objvFieldTab_Sim.sf_FldComparisonOp == null || objvFieldTab_Sim.sf_FldComparisonOp == "") return arrvFieldTab_Sel.length>0?true:false;
var dicFldComparisonOp = JSON.parse(objvFieldTab_Sim.sf_FldComparisonOp);
console.log("clsvFieldTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
var strMsg = "根据条件:[" +JSON.stringify( objvFieldTab_Sim) + "]判断是否存在不成功!";
throw new Error(strMsg);
}
return false;
};
...
clsvFieldTabWApi.IsExist = function(strFldId) 
{
//检测记录是否存在
...
reject(result.statusText);
 ...
 /// <param name = "strFldId">所给的关键字</param>
 /// <returns>对象</returns>
clsvFieldTabWApi.IsExist_Cache = async function(strFldId,strPrjId) {
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var obj = new clsvFieldTabEN_js_1.clsvFieldTabEN();
try
{
...
clsvFieldTabWApi.GetRecCountByCond = function(strWhereCond)  
{
...
clsvFieldTabWApi.GetRecCountByCond_Cache =  async function(objvFieldTab_Cond,strPrjId) {
var objvFieldTab_Sim = clsvFieldTabBL_js_1.clsvFieldTabBL.GetSimObjFromObj(objvFieldTab_Cond);
var arrvFieldTabObjLst_Cache = await clsvFieldTabWApi.GetObjLst_Cache(strPrjId);
var arrvFieldTab_Sel = arrvFieldTabObjLst_Cache.filter(x => true);
if (objvFieldTab_Sim.sf_FldComparisonOp == null || objvFieldTab_Sim.sf_FldComparisonOp == "") return arrvFieldTab_Sel.length;
var dicFldComparisonOp = JSON.parse(objvFieldTab_Sim.sf_FldComparisonOp);
console.log("clsvFieldTabWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
console.log(dicFldComparisonOp);
try {
...
return arrvFieldTab_Sel.length;
}
catch (e) {
var strMsg = "根据条件:[" +JSON.stringify( objvFieldTab_Sim) + "]获取相应的对象不成功!";
throw new Error(strMsg);
...
clsvFieldTabWApi.GetWebApiUrl = function(strController, strAction) {
var strServiceUrl;
...
/// <summary>
/// 为下拉框获取数据,从表:[vFieldTab]中获取
 /// (AutoGCLib.WA_Access4JavaScript:Gen_4WA_Js_DdlBind_Cache)
/// </summary>
/// <returns>获取主键字段、名称字段两列的所有记录记录的DataTable</returns>
clsvFieldTabWApi.BindDdl_FldId_Cache2 = function(strDdlName, objvFieldTab_Cond, strPrjId) {
//var strWhereCond = " 1 =1 ";
...
try
{
var arrObjLst_Sel = clsvFieldTabWApi.GetSubObjLst_Cache(objvFieldTab_Cond,strPrjId);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsvFieldTabEN_js_1.clsvFieldTabEN.con_FldId, clsvFieldTabEN_js_1.clsvFieldTabEN.con_FldName, "vFieldTab");
...
alert(strMsg);
 ...
 /// </summary>
clsvFieldTabWApi.InitListCache = function() 
{
//初始化列表缓存
...
throw (strMsg);
 ...
 /// </summary>
clsvFieldTabWApi. ReFreshThisCache = function(strPrjId)
{
var strMsg = "";
...
clsvFieldTabWApi.BindDdl_FldId_Cache = async function(strDdlName, objvFieldTab_Cond, strPrjId)
{
var objDdl = document.getElementById(strDdlName);
if (objDdl == null)
{
...
var arrObjLst_Sel = await clsvFieldTabWApi.GetSubObjLst_Cache(objvFieldTab_Cond, strPrjId);
clsCommonFunc4Web_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsvFieldTabEN_js_1.clsvFieldTabEN.con_FldId, clsvFieldTabEN_js_1.clsvFieldTabEN.con_FldName, "vFieldTab");
}
clsvFieldTabWApi.mstrController = "vFieldTabApi";
clsvFieldTabWApi.CacheModeId = ""; //
return clsvFieldTabWApi;
}());
exports.clsvFieldTabWApi = clsvFieldTabWApi;
});