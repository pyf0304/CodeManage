...
var clsvFieldTabEN = function (strFldID) {
    ...
    /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
    /// </summary>
    var con_FldEnName = "FldEnName";    //字段英文详名
    ...
    /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToString2)
    /// </summary>
    this.getFldEnName = function () {
        return this.FldEnName;
    }
    /// <summary>
    /// 字段英文详名(说明:;字段类型:varchar;字段长度:200;是否可空:True)
    /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToString2)
    /// </summary>
    this.setFldEnName = function (value) {
        this.FldEnName = value;
        this.hmProperty.add("FldEnName", "true");
    }
