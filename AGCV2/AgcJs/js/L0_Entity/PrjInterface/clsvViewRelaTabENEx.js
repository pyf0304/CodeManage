...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsvViewRelaTabENEx = /** @class */ (function (_super) {
__extends(clsvViewRelaTabENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsvViewRelaTabENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsvViewRelaTabENEx;
}(clsvViewRelaTabEN_js_1.clsvViewRelaTabEN));
exports.clsvViewRelaTabENEx = clsvViewRelaTabENEx;
});