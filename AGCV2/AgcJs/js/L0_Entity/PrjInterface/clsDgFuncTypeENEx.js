...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsDgFuncTypeENEx = /** @class */ (function (_super) {
__extends(clsDgFuncTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsDgFuncTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsDgFuncTypeENEx;
}(clsDgFuncTypeEN_js_1.clsDgFuncTypeEN));
exports.clsDgFuncTypeENEx = clsDgFuncTypeENEx;
});