...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsSQLDSTypeENEx = /** @class */ (function (_super) {
__extends(clsSQLDSTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsSQLDSTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsSQLDSTypeENEx;
}(clsSQLDSTypeEN_js_1.clsSQLDSTypeEN));
exports.clsSQLDSTypeENEx = clsSQLDSTypeENEx;
});