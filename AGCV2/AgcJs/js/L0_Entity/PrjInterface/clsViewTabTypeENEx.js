...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsViewTabTypeENEx = /** @class */ (function (_super) {
__extends(clsViewTabTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsViewTabTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsViewTabTypeENEx;
}(clsViewTabTypeEN_js_1.clsViewTabTypeEN));
exports.clsViewTabTypeENEx = clsViewTabTypeENEx;
});