...
var $ = __importStar(require("jquery"));
 ...
 /// </summary>
var clsViewTabTypeEN_Sim = /** @class */ (function () {

/// <summary>
 /// (AutoGCLib.EntityLayerRJ_Sim4JavaScript:Gen_EN_ClsProperty)
/// </summary>
 function clsViewTabTypeEN_Sim()
 {
...
/// TabTypeFunction(说明:;字段类型:varchar;字段长度:500;是否可空:True)
 this.TabTypeFunction = "";

this.sf_UpdFldSetStr = "";     //专门用于记录某字段属性是否修改
this.sf_FldComparisonOp = "";     //专门用于记录条件对象某字段的比较运算符
 }
return clsViewTabTypeEN_Sim;
}());
exports.clsViewTabTypeEN_Sim = clsViewTabTypeEN_Sim;
});