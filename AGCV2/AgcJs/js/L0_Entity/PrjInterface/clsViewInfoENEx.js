...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsViewInfoENEx = /** @class */ (function (_super) {
__extends(clsViewInfoENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsViewInfoENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsViewInfoENEx;
}(clsViewInfoEN_js_1.clsViewInfoEN));
exports.clsViewInfoENEx = clsViewInfoENEx;
});