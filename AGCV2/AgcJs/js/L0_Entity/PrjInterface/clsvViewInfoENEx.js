...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsvViewInfoENEx = /** @class */ (function (_super) {
__extends(clsvViewInfoENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsvViewInfoENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsvViewInfoENEx;
}(clsvViewInfoEN_js_1.clsvViewInfoEN));
exports.clsvViewInfoENEx = clsvViewInfoENEx;
});