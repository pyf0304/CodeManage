...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsViewRegionENEx = /** @class */ (function (_super) {
__extends(clsViewRegionENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsViewRegionENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsViewRegionENEx;
}(clsViewRegionEN_js_1.clsViewRegionEN));
exports.clsViewRegionENEx = clsViewRegionENEx;
});