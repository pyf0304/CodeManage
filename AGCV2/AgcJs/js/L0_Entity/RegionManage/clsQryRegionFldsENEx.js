...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsQryRegionFldsENEx = /** @class */ (function (_super) {
__extends(clsQryRegionFldsENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsQryRegionFldsENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsQryRegionFldsENEx;
}(clsQryRegionFldsEN_js_1.clsQryRegionFldsEN));
exports.clsQryRegionFldsENEx = clsQryRegionFldsENEx;
});