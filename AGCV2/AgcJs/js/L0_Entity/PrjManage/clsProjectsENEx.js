...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsProjectsENEx = /** @class */ (function (_super) {
__extends(clsProjectsENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsProjectsENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsProjectsENEx;
}(clsProjectsEN_js_1.clsProjectsEN));
exports.clsProjectsENEx = clsProjectsENEx;
});