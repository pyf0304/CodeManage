...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsvCodeTypeENEx = /** @class */ (function (_super) {
__extends(clsvCodeTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsvCodeTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsvCodeTypeENEx;
}(clsvCodeTypeEN_js_1.clsvCodeTypeEN));
exports.clsvCodeTypeENEx = clsvCodeTypeENEx;
});