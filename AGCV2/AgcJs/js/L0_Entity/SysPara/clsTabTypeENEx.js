...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsTabTypeENEx = /** @class */ (function (_super) {
__extends(clsTabTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsTabTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsTabTypeENEx;
}(clsTabTypeEN_js_1.clsTabTypeEN));
exports.clsTabTypeENEx = clsTabTypeENEx;
});