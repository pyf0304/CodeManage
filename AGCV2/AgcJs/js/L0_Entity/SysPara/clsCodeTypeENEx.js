...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsCodeTypeENEx = /** @class */ (function (_super) {
__extends(clsCodeTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsCodeTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsCodeTypeENEx;
}(clsCodeTypeEN_js_1.clsCodeTypeEN));
exports.clsCodeTypeENEx = clsCodeTypeENEx;
});