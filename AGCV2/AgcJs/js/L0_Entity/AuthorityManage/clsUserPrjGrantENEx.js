...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsUserPrjGrantENEx = /** @class */ (function (_super) {
__extends(clsUserPrjGrantENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsUserPrjGrantENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsUserPrjGrantENEx;
}(clsUserPrjGrantEN_js_1.clsUserPrjGrantEN));
exports.clsUserPrjGrantENEx = clsUserPrjGrantENEx;
});