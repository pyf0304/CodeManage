...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsCacheModeENEx = /** @class */ (function (_super) {
__extends(clsCacheModeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsCacheModeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsCacheModeENEx;
}(clsCacheModeEN_js_1.clsCacheModeEN));
