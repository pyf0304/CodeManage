...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsvFieldTabENEx = /** @class */ (function (_super) {
__extends(clsvFieldTabENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsvFieldTabENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsvFieldTabENEx;
}(clsvFieldTabEN_js_1.clsvFieldTabEN));
exports.clsvFieldTabENEx = clsvFieldTabENEx;
});