...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsFieldTabENEx = /** @class */ (function (_super) {
__extends(clsFieldTabENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsFieldTabENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsFieldTabENEx;
}(clsFieldTabEN_js_1.clsFieldTabEN));
exports.clsFieldTabENEx = clsFieldTabENEx;
});