...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsTabStateENEx = /** @class */ (function (_super) {
__extends(clsTabStateENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsTabStateENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsTabStateENEx;
}(clsTabStateEN_js_1.clsTabStateEN));
exports.clsTabStateENEx = clsTabStateENEx;
});