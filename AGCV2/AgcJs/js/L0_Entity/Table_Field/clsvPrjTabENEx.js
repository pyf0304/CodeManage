...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsvPrjTabENEx = /** @class */ (function (_super) {
__extends(clsvPrjTabENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsvPrjTabENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsvPrjTabENEx;
}(clsvPrjTabEN_js_1.clsvPrjTabEN));
exports.clsvPrjTabENEx = clsvPrjTabENEx;
});