...
var clsGeneralTab_js_1 = require("clsgeneraltab");
 ...
 /// </summary>
var clsApplicationTypeENEx = /** @class */ (function (_super) {
__extends(clsApplicationTypeENEx, _super);

/// <summary>
/// 构造函数
 /// (AutoGCLib.EntityLayerRJEx4JavaScript:Gen_ENEx_ClassConstructor1)
/// </summary>
 function clsApplicationTypeENEx()
 {
 var _this = _super.call(this) || this;
  return _this;
 }
return clsApplicationTypeENEx;
}(clsApplicationTypeEN_js_1.clsApplicationTypeEN));
exports.clsApplicationTypeENEx = clsApplicationTypeENEx;
});