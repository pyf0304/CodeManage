...
{
define(["require", "exports", "clscommfun4bl","clssyspara4webapi","../../L3_ForWApi/AuthorityManage/clsUserPrjGrantWApi.js","../../L3_ForWApi/AuthorityManage/clsvUserPrjGrantWApi.js"], factory);
}
...
var clsvUserPrjGrantWApi_js_1 = require("../../L3_ForWApi/AuthorityManage/clsvUserPrjGrantWApi.js");
 /// <summary>
 /// UserPrjGrant(UserPrjGrant)
 /// 数据源类型:SQL表
 /// (AutoGCLib.CommFun4WARJ4JavaScript:GeneCode)
 /// </summary>
var clsCommFun4WA4UserPrjGrant = /** @class */ (function (_super) {
__extends(clsCommFun4WA4UserPrjGrant, _super);
function clsCommFun4WA4UserPrjGrant()
{
return _super !== null && _super.apply(this, arguments) || this;
 ...
 /// </summary>
 clsCommFun4WA4UserPrjGrant.prototype.ReFreshCache = function()
{
var strMsg = "";
...
clsUserPrjGrantWApi_js_1.clsUserPrjGrantWApi.ReFreshThisCache();
clsvUserPrjGrantWApi_js_1.clsvUserPrjGrantWApi.ReFreshThisCache();
}
return clsCommFun4WA4UserPrjGrant;
}(clsCommFun4BL_js_1.clsCommFun4BL));
exports.clsCommFun4WA4UserPrjGrant = clsCommFun4WA4UserPrjGrant;
});