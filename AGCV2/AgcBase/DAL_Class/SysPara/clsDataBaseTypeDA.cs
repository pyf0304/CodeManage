...
try
{
 ...
 objDataBaseTypeEN.DataBaseTypeENName = objDT.Rows[0][conDataBaseType.DataBaseTypeENName].ToString().Trim(); //数据库类型英文名(字段类型:varchar,字段长度:30,是否可空:True)
 objDataBaseTypeEN.DataBaseTypeSimName = objDT.Rows[0][conDataBaseType.DataBaseTypeSimName].ToString().Trim(); //数据库类型简名(字段类型:varchar,字段长度:30,是否可空:True)
 objDataBaseTypeEN.Memo = objDT.Rows[0][conDataBaseType.Memo].ToString().Trim(); //说明(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 ...
 objDataBaseTypeEN.DataBaseTypeENName = objRow[conDataBaseType.DataBaseTypeENName] == DBNull.Value ? null : objRow[conDataBaseType.DataBaseTypeENName].ToString().Trim(); //数据库类型英文名(字段类型:varchar,字段长度:30,是否可空:True)
 objDataBaseTypeEN.DataBaseTypeSimName = objRow[conDataBaseType.DataBaseTypeSimName] == DBNull.Value ? null : objRow[conDataBaseType.DataBaseTypeSimName].ToString().Trim(); //数据库类型简名(字段类型:varchar,字段长度:30,是否可空:True)
 objDataBaseTypeEN.Memo = objRow[conDataBaseType.Memo] == DBNull.Value ? null : objRow[conDataBaseType.Memo].ToString().Trim(); //说明(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
DataBaseTypeENName = objRow[conDataBaseType.DataBaseTypeENName] == DBNull.Value ? null : objRow[conDataBaseType.DataBaseTypeENName].ToString().Trim(), //数据库类型英文名
DataBaseTypeSimName = objRow[conDataBaseType.DataBaseTypeSimName] == DBNull.Value ? null : objRow[conDataBaseType.DataBaseTypeSimName].ToString().Trim(), //数据库类型简名
Memo = objRow[conDataBaseType.Memo] == DBNull.Value ? null : objRow[conDataBaseType.Memo].ToString().Trim() //说明
};
objDataBaseTypeEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objDataBaseTypeEN;
}
...
objRow[conDataBaseType.DataBaseTypeName] = objDataBaseTypeEN.DataBaseTypeName; //数据库类型名
 if (objDataBaseTypeEN.DataBaseTypeENName !=  "")
 {
objRow[conDataBaseType.DataBaseTypeENName] = objDataBaseTypeEN.DataBaseTypeENName; //数据库类型英文名
 }
 if (objDataBaseTypeEN.DataBaseTypeSimName !=  "")
 {
objRow[conDataBaseType.DataBaseTypeSimName] = objDataBaseTypeEN.DataBaseTypeSimName; //数据库类型简名
 }
 if (objDataBaseTypeEN.Memo !=  "")
 {
objRow[conDataBaseType.Memo] = objDataBaseTypeEN.Memo; //说明
 }
...
StringBuilder strSQL = new StringBuilder();
 ...
 objDataBaseTypeEN.DataBaseTypeId = objDataBaseTypeEN.DataBaseTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDataBaseTypeEN.DataBaseTypeId + "'");
 }
 
 if (objDataBaseTypeEN.DataBaseTypeName !=  null)
 {
 arrFieldListForInsert.Add(conDataBaseType.DataBaseTypeName);
 objDataBaseTypeEN.DataBaseTypeName = objDataBaseTypeEN.DataBaseTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDataBaseTypeEN.DataBaseTypeName + "'");
 }
 
 if (objDataBaseTypeEN.DataBaseTypeENName !=  null)
 {
 arrFieldListForInsert.Add(conDataBaseType.DataBaseTypeENName);
 objDataBaseTypeEN.DataBaseTypeENName = objDataBaseTypeEN.DataBaseTypeENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDataBaseTypeEN.DataBaseTypeENName + "'");
 }
 
 if (objDataBaseTypeEN.DataBaseTypeSimName !=  null)
 {
 arrFieldListForInsert.Add(conDataBaseType.DataBaseTypeSimName);
 objDataBaseTypeEN.DataBaseTypeSimName = objDataBaseTypeEN.DataBaseTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDataBaseTypeEN.DataBaseTypeSimName + "'");
 }
 
 if (objDataBaseTypeEN.Memo !=  null)
 {
 arrFieldListForInsert.Add(conDataBaseType.Memo);
 objDataBaseTypeEN.Memo = objDataBaseTypeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + objDataBaseTypeEN.Memo + "'");
 }
 //组织插入记录SQL串
...
ArrayList values = new ArrayList()
{
 ...
 objDataBaseTypeEN.DataBaseTypeENName,
 objDataBaseTypeEN.DataBaseTypeSimName,
...
objRow[conDataBaseType.DataBaseTypeENName] = oRow[conDataBaseType.DataBaseTypeENName].ToString().Trim(); //数据库类型英文名
objRow[conDataBaseType.DataBaseTypeSimName] = oRow[conDataBaseType.DataBaseTypeSimName].ToString().Trim(); //数据库类型简名
objRow[conDataBaseType.Memo] = oRow[conDataBaseType.Memo].ToString().Trim(); //说明
 objDS.Tables[clsDataBaseTypeEN._CurrTabName].Rows.Add(objRow);
}
try
{
...
objRow[conDataBaseType.DataBaseTypeName] = objDataBaseTypeEN.DataBaseTypeName; //数据库类型名
 ...
 if (objDataBaseTypeEN.IsUpdated(conDataBaseType.DataBaseTypeENName))
 {
objRow[conDataBaseType.DataBaseTypeENName] = objDataBaseTypeEN.DataBaseTypeENName; //数据库类型英文名
 }
 if (objDataBaseTypeEN.IsUpdated(conDataBaseType.DataBaseTypeSimName))
 {
objRow[conDataBaseType.DataBaseTypeSimName] = objDataBaseTypeEN.DataBaseTypeSimName; //数据库类型简名
 }
...
sbSQL.AppendFormat("Update DataBaseType Set ");
 ...
 {
 objDataBaseTypeEN.DataBaseTypeName = objDataBaseTypeEN.DataBaseTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDataBaseTypeEN.DataBaseTypeName, conDataBaseType.DataBaseTypeName); //数据库类型名
 }
 else
 {
 ...
 {
 objDataBaseTypeEN.DataBaseTypeENName = objDataBaseTypeEN.DataBaseTypeENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDataBaseTypeEN.DataBaseTypeENName, conDataBaseType.DataBaseTypeENName); //数据库类型英文名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDataBaseType.DataBaseTypeENName); //数据库类型英文名
 }
 }
 ...
 {
 objDataBaseTypeEN.DataBaseTypeSimName = objDataBaseTypeEN.DataBaseTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDataBaseTypeEN.DataBaseTypeSimName, conDataBaseType.DataBaseTypeSimName); //数据库类型简名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDataBaseType.DataBaseTypeSimName); //数据库类型简名
 }
 }
 ...
 {
 objDataBaseTypeEN.Memo = objDataBaseTypeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", objDataBaseTypeEN.Memo, conDataBaseType.Memo); //说明
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDataBaseType.Memo); //说明
 }
 }
...
sbSQL.AppendFormat("Update DataBaseType Set ");
 ...
 {
 objDataBaseTypeEN.DataBaseTypeName = objDataBaseTypeEN.DataBaseTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DataBaseTypeName = '{0}',", objDataBaseTypeEN.DataBaseTypeName); //数据库类型名
 }
 else
 {
 ...
 {
 objDataBaseTypeEN.DataBaseTypeENName = objDataBaseTypeEN.DataBaseTypeENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DataBaseTypeENName = '{0}',", objDataBaseTypeEN.DataBaseTypeENName); //数据库类型英文名
 }
 else
 {
 sbSQL.Append(" DataBaseTypeENName = null,"); //数据库类型英文名
 }
 }
 ...
 {
 objDataBaseTypeEN.DataBaseTypeSimName = objDataBaseTypeEN.DataBaseTypeSimName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DataBaseTypeSimName = '{0}',", objDataBaseTypeEN.DataBaseTypeSimName); //数据库类型简名
 }
 else
 {
 sbSQL.Append(" DataBaseTypeSimName = null,"); //数据库类型简名
 }
 }
 ...
 {
 objDataBaseTypeEN.Memo = objDataBaseTypeEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" Memo = '{0}',", objDataBaseTypeEN.Memo); //说明
 }
 else
 {
...
clsCheckSql.CheckFieldLen(objDataBaseTypeEN.DataBaseTypeENName, 30, conDataBaseType.DataBaseTypeENName);
clsCheckSql.CheckFieldLen(objDataBaseTypeEN.DataBaseTypeSimName, 30, conDataBaseType.DataBaseTypeSimName);
...
clsCheckSql.CheckSqlInjection4Field(objDataBaseTypeEN.DataBaseTypeENName, conDataBaseType.DataBaseTypeENName);
clsCheckSql.CheckSqlInjection4Field(objDataBaseTypeEN.DataBaseTypeSimName, conDataBaseType.DataBaseTypeSimName);
...
return objDT;
 ...
 /// </summary>
 /// <param name = "objDataBaseTypeEN">表对象</param>
 /// <returns>返回唯一性条件串</returns>
public string GetUniCondStrDataBaseTypeName(clsDataBaseTypeEN objDataBaseTypeEN)
{
