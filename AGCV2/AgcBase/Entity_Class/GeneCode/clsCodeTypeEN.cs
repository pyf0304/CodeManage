...
public static string[] AttributeName = new string[] {"CodeTypeId", "CodeTypeName", "CodeTypeSimName", "CodeTypeENName", "GroupName", "ProgLangTypeId", "RegionTypeId", "Prefix", "DependsOn", "FrontOrBack", "SqlDsTypeId", "ClassNameFormat", "FileNameFormat", "ClassNamePattern", "IsCSharp", "IsJava", "IsJavaScript", "IsTypeScript", "IsSilverLight", "IsSwift", "IsVB", "IsTableFldConst", "IsPubApp4WinWeb", "IsWeb", "IsAspMvc", "IsWebSrvAccess", "IsWin", "IsMobileApp", "IsExtend", "OrderNum", "WinOrWeb", "IsDirByTabName", "IsDefaultOverride", "InUse", "IsAutoParseFile", "UpdDate", "UpdUser", "Memo"};
