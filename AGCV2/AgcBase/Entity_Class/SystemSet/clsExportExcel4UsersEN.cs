...
public static string[] AttributeName = new string[] {"mId", "IdExportExcel4Users", "FieldName", "FieldCnName", "IsExport", "OrderNum", "ViewName", "UpdDate", "UpdUserId", "Memo"};
