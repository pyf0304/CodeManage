...
public static string[] AttributeName = new string[] {"IdSchool", "SchoolId", "SchoolName", "IsCurrentUse", "SchoolENName", "SchoolNameA", "SchoolTypeId", "UpdDate", "UpdUserId", "Memo"};
