...
public static string[] AttributeName = new string[] {"SqlViewId", "SqlViewText", "SqlViewText4Gene", "TextResouce", "TextResourceTypeId", "RelaTabId", "AnalysisDate", "GeneCodeDate", "CreateDate", "TopPercent", "DistinctFlag", "WhereCondition", "GroupBy", "HavingStr", "OrderBy", "ErrMsg", "PrjId", "UpdDate", "UpdUserId", "Memo"};
...
get
{
if (conSqlView.SqlViewId  ==  AttributeName[intIndex])
{
return mstrSqlViewId;
}
else if (conSqlView.SqlViewText  ==  AttributeName[intIndex])
{
return mstrSqlViewText;
}
else if (conSqlView.SqlViewText4Gene  ==  AttributeName[intIndex])
{
return mstrSqlViewText4Gene;
}
else if (conSqlView.TextResouce  ==  AttributeName[intIndex])
{
return mstrTextResouce;
}
else if (conSqlView.TextResourceTypeId  ==  AttributeName[intIndex])
{
return mstrTextResourceTypeId;
}
else if (conSqlView.RelaTabId  ==  AttributeName[intIndex])
{
return mstrRelaTabId;
}
else if (conSqlView.AnalysisDate  ==  AttributeName[intIndex])
{
return mstrAnalysisDate;
}
else if (conSqlView.GeneCodeDate  ==  AttributeName[intIndex])
{
return mstrGeneCodeDate;
}
else if (conSqlView.CreateDate  ==  AttributeName[intIndex])
{
return mstrCreateDate;
}
else if (conSqlView.TopPercent  ==  AttributeName[intIndex])
{
return mstrTopPercent;
}
else if (conSqlView.DistinctFlag  ==  AttributeName[intIndex])
{
return mstrDistinctFlag;
}
else if (conSqlView.WhereCondition  ==  AttributeName[intIndex])
{
return mstrWhereCondition;
}
else if (conSqlView.GroupBy  ==  AttributeName[intIndex])
{
return mstrGroupBy;
}
else if (conSqlView.HavingStr  ==  AttributeName[intIndex])
{
return mstrHavingStr;
}
else if (conSqlView.OrderBy  ==  AttributeName[intIndex])
{
return mstrOrderBy;
}
else if (conSqlView.ErrMsg  ==  AttributeName[intIndex])
{
return mstrErrMsg;
}
else if (conSqlView.PrjId  ==  AttributeName[intIndex])
{
return mstrPrjId;
}
else if (conSqlView.UpdDate  ==  AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (conSqlView.UpdUserId  ==  AttributeName[intIndex])
{
return mstrUpdUserId;
}
else if (conSqlView.Memo  ==  AttributeName[intIndex])
{
return mstrMemo;
}
return null;
