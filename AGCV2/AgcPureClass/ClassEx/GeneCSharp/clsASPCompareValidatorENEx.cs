...
/*-- -- -- -- -- -- -- -- -- -- --
类名:ASPCompareValidatorEx
表名:ASPCompareValidator(00050459)
生成代码版本:2019.04.30.1
生成日期:2019/04/30 16:15:24
生成者:
...
namespace AGC.PureClass
{
    ...
    /// </summary>
    [Serializable]
    public class ASPCompareValidatorEx : ASPCompareValidator
    {
        ...
        /// </summary>
        public ASPCompareValidatorEx()
        {
            this.ControlType = "ASPCompareValidatorEx";
        }
    }
}