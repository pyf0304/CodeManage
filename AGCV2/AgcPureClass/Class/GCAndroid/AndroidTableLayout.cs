 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:AndroidTableLayout
 表名:AndroidTableLayout(00050447)
 生成代码版本:2021.07.29.1
...
{
 /// <summary>
 /// Android表格布局(AndroidTableLayout)
 /// (AutoGCLib.PureClass4CSharp:GeneCode)
 /// </summary>
[Serializable]
[DataContractAttribute]
public class AndroidTableLayout : AndroidControlEx
{
protected const int mintAttributeCount = 10;
public static string[] AttributeName = new string[] {"AndroidTableLayoutId", "AndroidTableLayoutName", "Text", "CssClass", "OnClick", "layout_behavior", "context", "showIn", "orientation", "android"};
//以下是属性变量

protected string mstrAndroidTableLayoutId;    //AndroidTableLayoutId
protected string mstrAndroidTableLayoutName;    //AndroidTableLayoutName
...
protected string mstrandroid;    //android
 ...
 /// <summary>
 /// 常量:"AndroidTableLayoutId"
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidTableLayoutId = "AndroidTableLayoutId";    //AndroidTableLayoutId

 /// <summary>
 /// 常量:"AndroidTableLayoutName"
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_AndroidTableLayoutName = "AndroidTableLayoutName";    //AndroidTableLayoutName
...
get
{
if (strAttributeName  ==  con_AndroidTableLayoutId)
{
return mstrAndroidTableLayoutId;
}
else if (strAttributeName  ==  con_AndroidTableLayoutName)
{
return mstrAndroidTableLayoutName;
}
...
if (strAttributeName  ==  con_AndroidTableLayoutId)
{
mstrAndroidTableLayoutId = value.ToString();
}
else if (strAttributeName  ==  con_AndroidTableLayoutName)
{
mstrAndroidTableLayoutName = value.ToString();
}
else if (strAttributeName  ==  con_Text)
{
...
get
{
if (con_AndroidTableLayoutId  ==  AttributeName[intIndex])
{
return mstrAndroidTableLayoutId;
}
else if (con_AndroidTableLayoutName  ==  AttributeName[intIndex])
{
return mstrAndroidTableLayoutName;
}
...
/// <summary>
/// AndroidTableLayoutId(说明:;字段类型:char;字段长度:8;是否可空:False)
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidTableLayoutId
{
get
{
return mstrAndroidTableLayoutId;
...
if (value  ==  "")
{
 mstrAndroidTableLayoutId = value;
}
else
{
 mstrAndroidTableLayoutId = value;
...
/// <summary>
/// AndroidTableLayoutName(说明:;字段类型:varchar;字段长度:30;是否可空:False)
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToString4PureClass)
/// </summary>
  [DataMember]//非常重要
 public string AndroidTableLayoutName
{
get
{
return mstrAndroidTableLayoutName;
...
if (value  ==  "")
{
 mstrAndroidTableLayoutName = value;
}
else
{
 mstrAndroidTableLayoutName = value;
