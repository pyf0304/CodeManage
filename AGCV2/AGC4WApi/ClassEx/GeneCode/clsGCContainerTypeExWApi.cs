...
namespace AGC4WApi
{
public static class clsGCContainerTypeExWApi_Static
{
...
clsGCContainerTypeWApi.CopyTo(objGCContainerTypeENS, objGCContainerTypeENT);
...
public static bool EditRecordEx(this clsGCContainerTypeEN objGCContainerTypeEN)
{
try
{
objGCContainerTypeEN.sfUpdFldSetStr = objGCContainerTypeEN.getsfUpdFldSetStr();
bool bolResult = clsGCContainerTypeExWApi.EditRecordEx(objGCContainerTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsGCContainerTypeExWApi
{
private static readonly string mstrApiControllerName = "GCContainerTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsGCContainerTypeEN> arrGCContainerTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsGCContainerTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsGCContainerTypeEN objGCContainerTypeEN)
{
