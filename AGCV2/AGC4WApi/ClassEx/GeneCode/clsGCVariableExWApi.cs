...
namespace AGC4WApi
{
public static class clsGCVariableExWApi_Static
{
...
clsGCVariableWApi.CopyTo(objGCVariableENS, objGCVariableENT);
...
public static bool EditRecordEx(this clsGCVariableEN objGCVariableEN)
{
try
{
objGCVariableEN.sfUpdFldSetStr = objGCVariableEN.getsfUpdFldSetStr();
bool bolResult = clsGCVariableExWApi.EditRecordEx(objGCVariableEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsGCVariableExWApi
{
private static readonly string mstrApiControllerName = "GCVariableExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsGCVariableEN> arrGCVariableObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsGCVariableEN objGCVariableEN)
{
