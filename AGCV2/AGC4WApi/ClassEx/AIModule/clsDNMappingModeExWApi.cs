...
namespace AGC4WApi
{
public static class clsDnMappingModeExWApi_Static
{
...
clsDnMappingModeWApi.CopyTo(objDnMappingModeENS, objDnMappingModeENT);
...
public static bool EditRecordEx(this clsDnMappingModeEN objDnMappingModeEN)
{
try
{
objDnMappingModeEN.sfUpdFldSetStr = objDnMappingModeEN.getsfUpdFldSetStr();
bool bolResult = clsDnMappingModeExWApi.EditRecordEx(objDnMappingModeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDnMappingModeExWApi
{
        private static readonly string mstrApiControllerName = "DnMappingModeExApi";
        /// <summary>
        /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        public static List<clsDnMappingModeEN> arrDnMappingModeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDnMappingModeEN objDnMappingModeEN)
{
