...
namespace AGC4WApi
{
public static class clsDataNodeTypeExWApi_Static
{
...
clsDataNodeTypeWApi.CopyTo(objDataNodeTypeENS, objDataNodeTypeENT);
...
public static bool EditRecordEx(this clsDataNodeTypeEN objDataNodeTypeEN)
{
try
{
objDataNodeTypeEN.sfUpdFldSetStr = objDataNodeTypeEN.getsfUpdFldSetStr();
bool bolResult = clsDataNodeTypeExWApi.EditRecordEx(objDataNodeTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDataNodeTypeExWApi
{
private static readonly string mstrApiControllerName = "DataNodeTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDataNodeTypeEN> arrDataNodeTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDataNodeTypeEN objDataNodeTypeEN)
{
