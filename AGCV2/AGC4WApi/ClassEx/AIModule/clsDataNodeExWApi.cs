 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsDataNodeExWApi
 表名:DataNode(00050547)
 生成代码版本:2020.06.05.2
 生成日期:2020/06/09 01:17:40
 生成者:
...
namespace AGC4WApi
{
public static class clsDataNodeExWApi_Static
{
...
clsDataNodeWApi.CopyTo(objDataNodeENS, objDataNodeENT);
...
public static bool EditRecordEx(this clsDataNodeEN objDataNodeEN)
{
try
{
objDataNodeEN.sfUpdFldSetStr = objDataNodeEN.getsfUpdFldSetStr();
bool bolResult = clsDataNodeExWApi.EditRecordEx(objDataNodeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDataNodeExWApi
{
private static readonly string mstrApiControllerName = "DataNodeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDataNodeEN> arrDataNodeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDataNodeEN objDataNodeEN)
{
