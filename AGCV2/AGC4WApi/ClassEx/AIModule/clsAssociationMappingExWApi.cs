 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsAssociationMappingExWApi
 表名:AssociationMapping(00050550)
 生成代码版本:2020.06.05.2
 生成日期:2020/06/09 01:17:39
 生成者:
...
namespace AGC4WApi
{
public static class clsAssociationMappingExWApi_Static
{
...
clsAssociationMappingWApi.CopyTo(objAssociationMappingENS, objAssociationMappingENT);
...
public static bool EditRecordEx(this clsAssociationMappingEN objAssociationMappingEN)
{
try
{
objAssociationMappingEN.sfUpdFldSetStr = objAssociationMappingEN.getsfUpdFldSetStr();
bool bolResult = clsAssociationMappingExWApi.EditRecordEx(objAssociationMappingEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsAssociationMappingExWApi
{
private static readonly string mstrApiControllerName = "AssociationMappingExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsAssociationMappingEN> arrAssociationMappingObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsAssociationMappingExWApi()
 {
 }
...
public static bool EditRecordEx(clsAssociationMappingEN objAssociationMappingEN)
{
