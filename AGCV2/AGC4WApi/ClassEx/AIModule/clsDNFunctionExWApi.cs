 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsDnFunctionExWApi
 表名:DnFunction(00050552)
 生成代码版本:2020.06.05.2
 生成日期:2020/06/09 01:17:38
 生成者:
...
namespace AGC4WApi
{
public static class clsDnFunctionExWApi_Static
{
...
clsDnFunctionWApi.CopyTo(objDnFunctionENS, objDnFunctionENT);
...
public static bool EditRecordEx(this clsDnFunctionEN objDnFunctionEN)
{
try
{
objDnFunctionEN.sfUpdFldSetStr = objDnFunctionEN.getsfUpdFldSetStr();
bool bolResult = clsDnFunctionExWApi.EditRecordEx(objDnFunctionEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDnFunctionExWApi
{
private static readonly string mstrApiControllerName = "DnFunctionExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDnFunctionEN> arrDnFunctionObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDnFunctionEN objDnFunctionEN)
{
