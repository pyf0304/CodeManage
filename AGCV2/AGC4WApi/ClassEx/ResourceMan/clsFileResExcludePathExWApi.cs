 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsFileResExcludePathExWApi
 表名:FileResExcludePath(00050588)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/25 10:47:21
 生成者:pyf
...
namespace AGC4WApi
{
public static class clsFileResExcludePathExWApi_Static
{
...
clsFileResExcludePathWApi.CopyTo(objFileResExcludePathENS, objFileResExcludePathENT);
...
public static bool EditRecordEx(this clsFileResExcludePathEN objFileResExcludePathEN)
{
try
{
objFileResExcludePathEN.sfUpdFldSetStr = objFileResExcludePathEN.getsfUpdFldSetStr();
bool bolResult = clsFileResExcludePathExWApi.EditRecordEx(objFileResExcludePathEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFileResExcludePathExWApi
{
private static readonly string mstrApiControllerName = "FileResExcludePathExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsFileResExcludePathEN> arrFileResExcludePathObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsFileResExcludePathExWApi()
 {
 }
...
public static bool EditRecordEx(clsFileResExcludePathEN objFileResExcludePathEN)
{
