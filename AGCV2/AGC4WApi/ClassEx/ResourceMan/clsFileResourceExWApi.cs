...
namespace AGC4WApi
{
    public static class clsFileResourceExWApi_Static
    {
        ...
        public static clsFileResourceENEx CopyToEx(this clsFileResourceEN objFileResourceENS)
        {
            try
            {
                ...
                clsFileResourceWApi.CopyTo(objFileResourceENS, objFileResourceENT);
        ...
        public static bool EditRecordEx(this clsFileResourceEN objFileResourceEN)
        {
            try
            {
                objFileResourceEN.sfUpdFldSetStr = objFileResourceEN.getsfUpdFldSetStr();
                bool bolResult = clsFileResourceExWApi.EditRecordEx(objFileResourceEN);
    ...
    /// </summary>
    public class clsFileResourceExWApi
    {
        private static readonly string mstrApiControllerName = "FileResourceExApi";
        /// <summary>
        /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        public static List<clsFileResourceEN> arrFileResourceObjLst_Cache = null;
        /// <summary>
        /// 从缓存中查找失败的次数
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        ...
        public static bool EditRecordEx(clsFileResourceEN objFileResourceEN)
        {
        ...
        public static bool AnalysisFileByGenerateCode()
        {
           
            string strAction = "AnalysisFileByGenerateCode";
            string strErrMsg = string.Empty;
            //string strResult = "";
            Dictionary<string, string> dictParam = new Dictionary<string, string>();
            try
