...
namespace AGC4WApi
{
public static class clsCollegeExWApi_Static
{
...
clsCollegeWApi.CopyTo(objCollegeENS, objCollegeENT);
...
public static bool EditRecordEx(this clsCollegeEN objCollegeEN)
{
try
{
objCollegeEN.sfUpdFldSetStr = objCollegeEN.getsfUpdFldSetStr();
bool bolResult = clsCollegeExWApi.EditRecordEx(objCollegeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCollegeExWApi
{
private static readonly string mstrApiControllerName = "CollegeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCollegeEN> arrCollegeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCollegeEN objCollegeEN)
{
