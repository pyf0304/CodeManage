...
namespace AGC4WApi
{
public static class clsXzMajorExWApi_Static
{
...
clsXzMajorWApi.CopyTo(objXzMajorENS, objXzMajorENT);
...
public static bool EditRecordEx(this clsXzMajorEN objXzMajorEN)
{
try
{
objXzMajorEN.sfUpdFldSetStr = objXzMajorEN.getsfUpdFldSetStr();
bool bolResult = clsXzMajorExWApi.EditRecordEx(objXzMajorEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzMajorExWApi
{
private static readonly string mstrApiControllerName = "XzMajorExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzMajorEN> arrXzMajorObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzMajorEN objXzMajorEN)
{
