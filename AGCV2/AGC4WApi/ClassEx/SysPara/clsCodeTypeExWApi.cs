...
namespace AGC4WApi
{
    ...
    public class clsCodeTypeExWApi
    {
        ...
        /// <returns></returns>
        public static List<clsCodeTypeEN> GetCodeTypeObjLstByApplicationType4Back(int intApplicationTypeId, string strTabMainTypeId)
        {
            ...
            IEnumerable<clsAppCodeTypeRelaEN> arrAppCodeTypeRela = clsAppCodeTypeRelaExWApi.GetObjLstByApplicationTypeId_Cache(intApplicationTypeId)
            ...
            List<clsCodeTypeEN> arrCodeTypeObjLst_Cache = clsCodeTypeWApi.GetObjLst_Cache();
            List<clsCodeTypeEN> arrCodeTypeObjList =                 arrCodeTypeObjLst_Cache
     ...
     List<clsCodeTypeEN> arrObj = clsCodeTypeWApi.GetObjLst(strCondition);
        ...
        public static Tuple<string, string> GetCodeTypeIdByClassName(string strClassName, clsPubConst.LangType ltLangType)
        {
            ...
            IEnumerable<clsCodeTypeEN> arrCodeType = clsCodeTypeWApi.GetObjLst_Cache();
        ...
        public static List<clsCodeTypeEN> GetCodeTypeObjLstByApplicationType4Front4Web(int intApplicationTypeId)
        {
            ...
            string strKey = string.Format("{0}", clsCodeTypeEN._CurrTabName_S);
            List<clsCodeTypeEN> arrCodeTypeObjLst_Cache = clsCodeTypeWApi.GetObjLst_Cache();
            List<clsCodeTypeEN> arrCodeTypeObjList =
        ...
        public static string GetCodeTypeIdByClassName_Cache(clsPubConst.ClassName cnClassName, clsPubConst.LangType ltLangType)
        {
            ...
            string strKey = string.Format("{0}", clsCodeTypeEN._CurrTabName_S);
            List<clsCodeTypeEN> arrCodeTypeObjLst_Cache = clsCodeTypeWApi.GetObjLst_Cache();
            foreach (clsCodeTypeEN objCodeTypeEN in arrCodeTypeObjLst_Cache)
            {
