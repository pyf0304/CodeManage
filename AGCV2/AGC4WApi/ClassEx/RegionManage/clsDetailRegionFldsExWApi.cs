 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsDetailRegionFldsExWApi
 表名:DetailRegionFlds(00050544)
 生成代码版本:2020.05.28.1
 生成日期:2020/05/28 17:10:40
 生成者:
...
namespace AGC4WApi
{
public static class clsDetailRegionFldsExWApi_Static
{
...
clsDetailRegionFldsWApi.CopyTo(objDetailRegionFldsENS, objDetailRegionFldsENT);
...
public static bool EditRecordEx(this clsDetailRegionFldsEN objDetailRegionFldsEN)
{
try
{
objDetailRegionFldsEN.sfUpdFldSetStr = objDetailRegionFldsEN.getsfUpdFldSetStr();
bool bolResult = clsDetailRegionFldsExWApi.EditRecordEx(objDetailRegionFldsEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDetailRegionFldsExWApi
{
private static readonly string mstrApiControllerName = "DetailRegionFldsExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDetailRegionFldsEN> arrDetailRegionFldsObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsDetailRegionFldsExWApi()
 {
 }
...
public static bool EditRecordEx(clsDetailRegionFldsEN objDetailRegionFldsEN)
{
