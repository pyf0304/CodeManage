...
/*-- -- -- -- -- -- -- -- -- -- --
类名:clsPrjConstraintExWApi
表名:PrjConstraint(00050331)
生成代码版本:2019.07.15.2
生成日期:2019/07/16 19:01:45
生成者:
...
namespace AGC4WApi
{
    ...
    /// </summary>
    public class clsPrjConstraintExWApi
    {
        //private static readonly string mstrApiControllerName = "PrjConstraintExApi";
        /// <summary>
        /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        public static List<clsPrjConstraintEN> arrPrjConstraintObjLst_Cache = null;
        /// <summary>
        /// 从缓存中查找失败的次数
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        ...
        public static List<clsPrjConstraintENEx> GetObjExLst(string strCondition)
        {
            ...
            foreach (clsPrjConstraintEN objInFor in arrObjLst)
            {
                ...
                clsPrjConstraintWApi.CopyTo(objInFor, objPrjConstraintENEx);
