 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCodeDictTabExWApi
 表名:CodeDictTab(00050542)
 生成代码版本:2020.05.28.1
 生成日期:2020/05/28 17:10:38
 生成者:
...
namespace AGC4WApi
{
public static class clsCodeDictTabExWApi_Static
{
...
clsCodeDictTabWApi.CopyTo(objCodeDictTabENS, objCodeDictTabENT);
...
public static bool EditRecordEx(this clsCodeDictTabEN objCodeDictTabEN)
{
try
{
objCodeDictTabEN.sfUpdFldSetStr = objCodeDictTabEN.getsfUpdFldSetStr();
bool bolResult = clsCodeDictTabExWApi.EditRecordEx(objCodeDictTabEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCodeDictTabExWApi
{
private static readonly string mstrApiControllerName = "CodeDictTabExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCodeDictTabEN> arrCodeDictTabObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCodeDictTabEN objCodeDictTabEN)
{
