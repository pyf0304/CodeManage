...
namespace AGC4WApi
{
    ...
    /// </summary>
    public class clsCMFuncParaRelaExWApi
    {
        //private static readonly string mstrApiControllerName = "CMFuncParaRelaExApi";
        /// <summary>
        /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        public static List<clsCMFuncParaRelaEN> arrCMFuncParaRelaObjLst_Cache = null;
        /// <summary>
        /// 从缓存中查找失败的次数
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        ...
        /// </summary>
        public clsCMFuncParaRelaExWApi()
        {
        }
        public static clsCMFuncParaRelaEN AddCMFuncParaRela(clsCMFuncParaRelaEN objCMFuncParaRela)
        {
            ...
            bool bolIsExist = clsCMFuncParaRelaWApi.IsExistRecord(strCondition);

            if (bolIsExist)
            {
                objCMFuncParaRela.mId = clsCMFuncParaRelaWApi.GetFirstID(strCondition);
