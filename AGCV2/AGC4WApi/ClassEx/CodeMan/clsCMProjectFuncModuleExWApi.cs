 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCMProjectFuncModuleExWApi
 表名:CMProjectFuncModule(00050555)
 生成代码版本:2020.06.21.1
 生成日期:2020/06/27 00:01:06
 生成者:
...
namespace AGC4WApi
{
public static class clsCMProjectFuncModuleExWApi_Static
{
...
clsCMProjectFuncModuleWApi.CopyTo(objCMProjectFuncModuleENS, objCMProjectFuncModuleENT);
...
public static bool EditRecordEx(this clsCMProjectFuncModuleEN objCMProjectFuncModuleEN)
{
try
{
objCMProjectFuncModuleEN.sfUpdFldSetStr = objCMProjectFuncModuleEN.getsfUpdFldSetStr();
bool bolResult = clsCMProjectFuncModuleExWApi.EditRecordEx(objCMProjectFuncModuleEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCMProjectFuncModuleExWApi
{
private static readonly string mstrApiControllerName = "CMProjectFuncModuleExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCMProjectFuncModuleEN> arrCMProjectFuncModuleObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCMProjectFuncModuleExWApi()
 {
 }
...
public static bool EditRecordEx(clsCMProjectFuncModuleEN objCMProjectFuncModuleEN)
{
