 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvPrjRequirementExWApi
 表名:vPrjRequirement(00050260)
 生成代码版本:2019.07.15.2
 生成日期:2019/07/16 19:01:08
 生成者:
...
namespace AGC4WApi
{
 ...
 /// </summary>
public class clsvPrjRequirementExWApi
{
private static readonly string mstrApiControllerName = "vPrjRequirementExApi";
 /// <summary>
...
/// </summary>
 public clsvPrjRequirementExWApi()
 {
 }
}
}