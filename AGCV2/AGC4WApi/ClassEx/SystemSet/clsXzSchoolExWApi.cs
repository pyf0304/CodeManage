...
namespace AGC4WApi
{
public static class clsXzSchoolExWApi_Static
{
...
clsXzSchoolWApi.CopyTo(objXzSchoolENS, objXzSchoolENT);
...
public static bool EditRecordEx(this clsXzSchoolEN objXzSchoolEN)
{
try
{
objXzSchoolEN.sfUpdFldSetStr = objXzSchoolEN.getsfUpdFldSetStr();
bool bolResult = clsXzSchoolExWApi.EditRecordEx(objXzSchoolEN);
...
public static bool EditRecordEx(clsXzSchoolEN objXzSchoolEN)
{
