...
/*-- -- -- -- -- -- -- -- -- -- --
类名:clsUserWebSrvSetExWApi
表名:UserWebSrvSet(00050528)
生成代码版本:2020.01.02.1
生成日期:2020/01/03 16:12:40
生成者:
...
namespace AGC4WApi
{
    public static class clsUserWebSrvSetExWApi_Static
    {
        ...
        public static clsUserWebSrvSetENEx CopyToEx(this clsUserWebSrvSetEN objUserWebSrvSetENS)
        {
            try
            {
                ...
                clsUserWebSrvSetWApi.CopyTo(objUserWebSrvSetENS, objUserWebSrvSetENT);
        ...
        public static bool EditRecordEx(this clsUserWebSrvSetEN objUserWebSrvSetEN)
        {
           
            try
            {
                objUserWebSrvSetEN.sfUpdFldSetStr = objUserWebSrvSetEN.getsfUpdFldSetStr();
                bool bolResult = clsUserWebSrvSetExWApi.EditRecordEx(objUserWebSrvSetEN);
    ...
    /// </summary>
    public class clsUserWebSrvSetExWApi
    {
        private static readonly string mstrApiControllerName = "UserWebSrvSetExApi";
        /// <summary>
        /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        public static List<clsUserWebSrvSetEN> arrUserWebSrvSetObjLst_Cache = null;
        /// <summary>
        /// 从缓存中查找失败的次数
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        ...
        public static bool EditRecordEx(clsUserWebSrvSetEN objUserWebSrvSetEN)
        {
