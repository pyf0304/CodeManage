...
namespace AGC4WApi
{
public static class clsRelationTypeExWApi_Static
{
...
clsRelationTypeWApi.CopyTo(objRelationTypeENS, objRelationTypeENT);
...
public static bool EditRecordEx(this clsRelationTypeEN objRelationTypeEN)
{
try
{
objRelationTypeEN.sfUpdFldSetStr = objRelationTypeEN.getsfUpdFldSetStr();
bool bolResult = clsRelationTypeExWApi.EditRecordEx(objRelationTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsRelationTypeExWApi
{
private static readonly string mstrApiControllerName = "RelationTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsRelationTypeEN> arrRelationTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsRelationTypeEN objRelationTypeEN)
{
