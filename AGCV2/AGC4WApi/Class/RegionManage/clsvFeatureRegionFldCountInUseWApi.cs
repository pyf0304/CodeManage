...
if (clsvFeatureRegionFldCountInUseEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsvFeatureRegionFldCountInUseEN.AttributeName)
{
