...
if (objOperationType_Cond.IsUpdated(conOperationType.OpTypeId) == true)
{
string strComparisonOp_OpTypeId = objOperationType_Cond.dicFldComparisonOp[conOperationType.OpTypeId];
strWhereCond += string.Format(" And {0} {2} '{1}'", conOperationType.OpTypeId, objOperationType_Cond.OpTypeId, strComparisonOp_OpTypeId);
}
if (objOperationType_Cond.IsUpdated(conOperationType.OpTypeName) == true)
{
string strComparisonOp_OpTypeName = objOperationType_Cond.dicFldComparisonOp[conOperationType.OpTypeName];
strWhereCond += string.Format(" And {0} {2} '{1}'", conOperationType.OpTypeName, objOperationType_Cond.OpTypeName, strComparisonOp_OpTypeName);
}
...
try
{
objOperationTypeEN.sfUpdFldSetStr = objOperationTypeEN.getsfUpdFldSetStr();
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr_OpTypeName(this clsOperationTypeEN objOperationTypeEN)
{
//检测记录是否存在
...
try
{
 if (string.IsNullOrEmpty(objOperationTypeEN.OpTypeId) == true || clsOperationTypeWApi.IsExist(objOperationTypeEN.OpTypeId) == true)
 {
     objOperationTypeEN.OpTypeId = clsOperationTypeWApi.GetMaxStrId();
 }
clsOperationTypeWApi.CheckPropertyNew(objOperationTypeEN); 
...
{
clsOperationTypeWApi.CheckPropertyNew(objOperationTypeEN); 
string strOpTypeId = clsOperationTypeWApi.AddNewRecordWithMaxId(objOperationTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsOperationTypeWApi.ReFreshCache();
return strOpTypeId;
}
...
{
if (!Object.Equals(null, objOperationTypeEN.OpTypeId) && GetStrLen(objOperationTypeEN.OpTypeId) > 4)
{
 throw new Exception("字段[操作类型Id]的长度不能超过4!");
}
if (!Object.Equals(null, objOperationTypeEN.OpTypeName) && GetStrLen(objOperationTypeEN.OpTypeName) > 100)
{
 throw new Exception("字段[操作类型名称]的长度不能超过100!");
}
...
throw new Exception(strMsg);
 ...
 /// <param name = "strOpTypeId">表关键字</param>
 /// <returns>表对象</returns>
public static clsOperationTypeEN GetObjByOpTypeId_WA_Cache(string strOpTypeId)
{
string strAction = "GetObjByOpTypeId_Cache";
string strErrMsg = string.Empty;
string strResult = "";
clsOperationTypeEN objOperationTypeEN = null;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
...
public static clsOperationTypeEN GetObjByOpTypeId_Cache(string strOpTypeId)
{
if (string.IsNullOrEmpty(strOpTypeId) == true) return null;
//初始化列表缓存
...
where objOperationTypeEN.OpTypeId == strOpTypeId
select objOperationTypeEN;
if (arrOperationTypeObjLst_Sel.Count() == 0)
{
   clsOperationTypeEN obj = clsOperationTypeWApi.GetObjByOpTypeId(strOpTypeId);
   if (obj != null)
 {
...
public static string GetOpTypeNameByOpTypeId_Cache(string strOpTypeId)
{
...
if (arrOperationTypeObjLst_Sel.Count > 0)
{
return arrOperationTypeObjLst_Sel[0].OpTypeName;
}
string strErrMsgForGetObjById = string.Format("在OperationType对象缓存列表中,找不到记录[OpTypeId = {0}](函数:{1})", strOpTypeId, clsStackTrace.GetCurrFunction());
...
throw new Exception(strErrMsgForGetObjById);
 ...
 /// <param name = "strOpTypeId">所给的关键字</param>
 /// <returns>根据关键字获取的名称</returns>
public static string GetNameByOpTypeId_Cache(string strOpTypeId)
{
if (string.IsNullOrEmpty(strOpTypeId) == true) return "";
//初始化列表缓存
string strKey = string.Format("{0}", clsOperationTypeEN._CurrTabName);
...
string strErrMsgForGetObjById = string.Format("在OperationType对象缓存列表中,找不到记录的相关名称[OpTypeId = {0}](函数:{1})", strOpTypeId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsOperationTypeBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
throw new Exception(strMsg);
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsOperationTypeEN> GetObjLstByOpTypeIdLst(List<string> arrOpTypeId)
{
 List<clsOperationTypeEN> arrObjLst = null; 
string strAction = "GetObjLstByOpTypeIdLst";
string strErrMsg = string.Empty;
string strResult = "";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrOpTypeId);
...
throw new Exception(strMsg);
 ...
 /// <param name = "strOpTypeId">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
public static IEnumerable<clsOperationTypeEN> GetObjLstByOpTypeIdLst_Cache(List<string> arrOpTypeId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsOperationTypeEN._CurrTabName);
List<clsOperationTypeEN> arrOperationTypeObjLst_Cache = GetObjLst_Cache();
IEnumerable <clsOperationTypeEN> arrOperationTypeObjLst_Sel =
from objOperationTypeEN in arrOperationTypeObjLst_Cache
where arrOpTypeId.Contains(objOperationTypeEN.OpTypeId)
select objOperationTypeEN;
return arrOperationTypeObjLst_Sel;
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsOperationTypeEN> GetObjLstByOpTypeIdLst_WA_Cache(List<string> arrOpTypeId)
{
 List<clsOperationTypeEN> arrObjLst = null; 
string strAction = "GetObjLstByOpTypeIdLst_Cache";
string strErrMsg = string.Empty;
string strResult = "";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
try
{
 clsOperationTypeEN objOperationTypeEN = clsOperationTypeWApi.GetObjByOpTypeId(strOpTypeId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strOpTypeId.ToString(), out strResult, out strErrMsg) == true)
{
JObject jobjReturn = JObject.Parse(strResult);
if ((int)jobjReturn["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelOperationTypes(List<string> arrOpTypeId)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsOperationTypeWApi.ReFreshCache();
var strOpTypeId = (string)jobjReturn["returnStr"];
return strOpTypeId;
}
else
{
...
{
if (string.IsNullOrEmpty(objOperationTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时，修改标志串为空，请联系管理员.对象关键字:{0}.(from {1}).",
objOperationTypeEN.OpTypeId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
string strKey = string.Format("{0}", clsOperationTypeEN._CurrTabName);
CacheHelper.Remove(strKey);
clsOperationTypeWApi.objCommFun4WApi.ReFreshCache();
}
}
...
objDT.Columns.Add(conOperationType.OpTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conOperationType.OpTypeName, Type.GetType("System.String"));
objDT.Columns.Add(conOperationType.Memo, Type.GetType("System.String"));
foreach (clsOperationTypeEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conOperationType.OpTypeId] = objInFor[conOperationType.OpTypeId];
objDR[conOperationType.OpTypeName] = objInFor[conOperationType.OpTypeName];
