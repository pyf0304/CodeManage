 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCommFun4WA4CMProjectPrjTab
 表名:CMProjectPrjTab(00050530)
 生成代码版本:2021.07.15.1
 生成日期:2021/07/16 00:14:23
 生成者:pyf
...
clsCMProjectPrjTabWApi.ReFreshThisCache(strPrjId);
clsvCMProjectPrjTabWApi.ReFreshThisCache(strPrjId);
}
}
}