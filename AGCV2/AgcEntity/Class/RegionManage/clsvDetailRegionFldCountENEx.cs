 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvDetailRegionFldCountENEx
 表名:vDetailRegionFldCount(00050580)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 16:01:42
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvDetailRegionFldCountENEx : clsvDetailRegionFldCountEN
{
...
/// </summary>
 public clsvDetailRegionFldCountENEx()
 {
 }
}
}