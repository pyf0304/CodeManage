 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvDetailRegionFldCountInUseENEx
 表名:vDetailRegionFldCountInUse(00050586)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 23:22:02
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvDetailRegionFldCountInUseENEx : clsvDetailRegionFldCountInUseEN
{
...
/// </summary>
 public clsvDetailRegionFldCountInUseENEx()
 {
 }
}
}