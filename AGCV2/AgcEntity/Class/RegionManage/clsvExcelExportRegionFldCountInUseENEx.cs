 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvExcelExportRegionFldCountInUseENEx
 表名:vExcelExportRegionFldCountInUse(00050582)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 23:25:21
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvExcelExportRegionFldCountInUseENEx : clsvExcelExportRegionFldCountInUseEN
{
...
/// </summary>
 public clsvExcelExportRegionFldCountInUseENEx()
 {
 }
}
}