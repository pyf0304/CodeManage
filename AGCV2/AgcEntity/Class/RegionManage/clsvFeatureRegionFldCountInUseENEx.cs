 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFeatureRegionFldCountInUseENEx
 表名:vFeatureRegionFldCountInUse(00050584)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 23:18:26
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvFeatureRegionFldCountInUseENEx : clsvFeatureRegionFldCountInUseEN
{
...
/// </summary>
 public clsvFeatureRegionFldCountInUseENEx()
 {
 }
}
}