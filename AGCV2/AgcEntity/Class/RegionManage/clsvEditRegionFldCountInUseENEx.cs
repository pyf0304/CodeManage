 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvEditRegionFldCountInUseENEx
 表名:vEditRegionFldCountInUse(00050587)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 23:22:28
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvEditRegionFldCountInUseENEx : clsvEditRegionFldCountInUseEN
{
...
/// </summary>
 public clsvEditRegionFldCountInUseENEx()
 {
 }
}
}