 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvEditRegionFldCountENEx
 表名:vEditRegionFldCount(00050581)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 16:01:48
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvEditRegionFldCountENEx : clsvEditRegionFldCountEN
{
...
/// </summary>
 public clsvEditRegionFldCountENEx()
 {
 }
}
}