 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvRegionFeatureCountENEx
 表名:vRegionFeatureCount(00050575)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/03 10:05:35
 生成者:pyf
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvRegionFeatureCountENEx : clsvRegionFeatureCountEN
{
...
/// </summary>
 public clsvRegionFeatureCountENEx()
 {
 }
}
}