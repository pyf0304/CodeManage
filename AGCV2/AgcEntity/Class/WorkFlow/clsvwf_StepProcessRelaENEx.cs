 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvwf_StepProcessRelaENEx
 表名:vwf_StepProcessRela(00050494)
 生成代码版本:2019.08.22.1
 生成日期:2019/08/25 10:24:45
 生成者:
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvwf_StepProcessRelaENEx : clsvwf_StepProcessRelaEN
{
...
/// </summary>
 public clsvwf_StepProcessRelaENEx()
 {
 }
}
}