 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvCMProjectFuncModuleENEx
 表名:vCMProjectFuncModule(00050556)
 生成代码版本:2020.05.28.1
 生成日期:2020/06/02 12:38:38
 生成者:
...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvCMProjectFuncModuleENEx : clsvCMProjectFuncModuleEN
{
...
/// </summary>
 public clsvCMProjectFuncModuleENEx()
 {
 }
}
}