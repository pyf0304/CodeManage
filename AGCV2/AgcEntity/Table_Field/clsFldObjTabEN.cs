...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsFldObjTabEN : clsEntityBase2
{
public const string CurrTabName_S = "FldObjTab"; //当前表名,与该类相关的表名
...
/// </summary>
 public clsFldObjTabEN()
 {
 SetInit();
 mbolIsCheckProperty = false;
 _CurrTabName = "FldObjTab";
...
public clsFldObjTabEN(long lngmId)
 {
 if (lngmId  ==  0)
 {
