...
namespace AGC.Entity
{
    public class clsFieldTabENEx : clsFieldTabEN
    {
        ...
        private string mstrCodeTab_Name;
        private string mstrCodeTab_Code;
        ...
        public string FldName_Java
        {
            get
            {
                return CommProgramSet.clsComm.FstLcaseS(mstrFldName.ToLower());
            }
        }
        ...
        public string CodeTab_Name
        {
            get
            {
                return mstrCodeTab_Name;
            }

            set
            {
                mstrCodeTab_Name = value;
            }
        }

        public string CodeTab_Code
        {
            get
            {
                return mstrCodeTab_Code;
            }

            set
            {
                mstrCodeTab_Code = value;
            }
        }
