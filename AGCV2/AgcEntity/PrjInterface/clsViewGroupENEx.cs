...
namespace AGC.Entity
{
    public class clsViewGroupENEx : clsViewGroupEN
    {
        ...
        public List<clsvViewGroupFldsEN> arrvViewGroupFldSet = null;
        ...
        public string TabName_Java
        {
            get
            {
                return CommProgramSet.clsComm.FstLcaseS(this.objINPrjTab.TabName);
            }
        }
        /// <summary>
        /// 编程用表名,首字母小写
        ...
        public string TableNameForProg_FstLcase
        {
            get
            {
                return CommProgramSet.clsComm.FstLcaseS(this.TableNameForProg);
            }
        }
        /// <summary>
        /// 编程用表名,首字母大写
        ...
        public string TableNameForProg_FstUcase
        {
            get
            {
                string strTableName = new CommProgramSet.clsComm().FirstUcase(this.TableNameForProg);
                return strTableName;
            }
        }
        /// <summary>
