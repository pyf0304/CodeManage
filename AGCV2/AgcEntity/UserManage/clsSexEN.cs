...
{
public const string CurrTabName_S = "Sex"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "SexID"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 5;
public static string[] AttributeName = new string[] {"SexID", "SexDesc", "UpdUser", "UpdDate", "Memo"};
 //以下是属性变量
...
/// </summary>
/// <param name="mstrSexID">关键字：性别编号</param>
public clsSexEN(string strSexID)
 {
...
try
{
clsCommonRegular.CheckStrSQL_Weak(strSexID);
}
