...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvRoleMenusEN : clsEntityBase2
{
public const string CurrTabName_S = "vRoleMenus"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 23;
public static string[] AttributeName = new string[] {"mId", "RoleId", "MenuId", "ImgFile", "MenuName", "UpMenuId", "LinkFile", "OrderNum", "IsDisp", "PrjId", "IsLeafNode", "Memo", "MenuSetId", "MenuSetName", "MenuTitle", "PageDispModeId", "PageDispModeName", "PrjName", "qsParameters", "RoleName", "UpdDate", "UpdUserId", "UpMenuName"};
//以下是属性变量
...
protected string mstrUpMenuName;    //UpMenuName
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_QxPrjId  =  "QxPrjId";    //工程ID
...
/// </summary>
 public clsvRoleMenusEN()
 {
 SetInit();
 mbolIsCheckProperty  =  false;
 _CurrTabName  =  "vRoleMenus";
...
public clsvRoleMenusEN(long lngmId)
 {
 if (lngmId  ==  0)
 {
