...
namespace AGC.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsPrjMenusEN : clsEntityBase2
{
public const string CurrTabName_S = "PrjMenus"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "MenuId"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 16;
public static string[] AttributeName = new string[] {"MenuId", "MenuName", "OrderNum", "PrjId", "ImgFile", "LinkFile", "qsParameters", "RoleId", "UpMenuId", "IsLeafNode", "MenuSetId", "MenuTitle", "PageDispModeId", "UpdDate", "UpdUserId", "Memo"};
//以下是属性变量
...
/// </summary>
 public clsPrjMenusEN()
 {
 SetInit();
 mbolIsCheckProperty  =  false;
 _CurrTabName  =  "PrjMenus";
...
public clsPrjMenusEN(string strMenuId)
 {
strMenuId  =  strMenuId.Replace("'", "''");
if (strMenuId.Length > 8)
{
throw new Exception("在表:PrjMenus中,关键字长度不正确!");
}
if (string.IsNullOrEmpty(strMenuId)  ==  true)
{
throw new Exception("在表:PrjMenus中,关键字不能为空 或 null!");
}
try
{
