...
<%@ Control Language = "C#" AutoEventWireup = "true" CodeBehind = "wucvwf_Point4Gv.ascx.cs" Inherits = "AGC.Webform.wucvwf_Point4Gv" %>
...
runat = "server">
<asp:GridView id = "gvwf_Point" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvwf_Point_Sorting" 
OnPageIndexChanging = "gvwf_Point_PageIndexChanging" 
OnRowCreated = "gvwf_Point_RowCreated"
OnRowCommand = "gvwf_Point_RowCommand"
OnRowDeleting = "gvwf_Point_RowDeleting" 
OnRowUpdating = "gvwf_Point_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
<ItemTemplate>
<a name = "A_wf_Point<%# Eval("PointId").ToString().Trim() %>"></a>
...
<asp:BoundField DataField = "TabKeyId" SortExpression = "TabKeyId" HeaderText = "表关键字Id"></asp:BoundField>
