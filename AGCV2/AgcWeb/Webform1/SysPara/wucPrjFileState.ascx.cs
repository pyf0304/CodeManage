...
using AGC.BusinessLogicEx;
 ...
 /// <summary>
 ///		wucPrjFileState 的摘要说明。
 /// (AutoGCLib.WebCtlControlCode4CSharp:GeneCode)
 /// </summary>
public partial class wucPrjFileState : System.Web.UI.UserControl
{
...
get
{
return txtPrjFileStateId.Text.Trim();
}
set
{
txtPrjFileStateId.Text = value.ToString();
}
}
...
get
{
return txtPrjFileStateName.Text.Trim();
}
set
{
txtPrjFileStateName.Text = value.ToString();
}
}
...
get
{
return txtPrjFileStateENName.Text.Trim();
}
set
{
txtPrjFileStateENName.Text = value.ToString();
}
}
...
{
txtPrjFileStateId.ReadOnly = bolReadonly;
}
...
public void Clear()
{
txtPrjFileStateId.Text = "";
txtPrjFileStateName.Text = "";
txtPrjFileStateENName.Text = "";
txtOrderNum.Text = "0";
txtMemo.Text = "";
}
