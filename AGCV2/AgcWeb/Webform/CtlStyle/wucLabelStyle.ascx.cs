...
namespace AGC.Webform
{
	...
	///		wucLabelStyle 的摘要说明。
	/// </summary>
	public partial class wucLabelStyle : System.Web.UI.UserControl
	{
		...
		public string LabelStyleId
		{
			get
			{
				return txtLabelStyleId.Text.Trim();
			}
			set
			{
				txtLabelStyleId.Text = value.ToString();
			}
		}
		...
		public string LabelStyleName
		{
			get
			{
				return txtLabelStyleName.Text.Trim();
			}
			set
			{
				txtLabelStyleName.Text = value.ToString();
			}
		}
		...
		{
			txtLabelStyleId.ReadOnly = bolReadonly;
		}
		public void Clear()
		{
			txtLabelStyleId.Text = "";
			txtLabelStyleName.Text = "";
			txtStyle.Text = "";
			txtRunat.Text = "";
			txtFontSize.Text = "";
			txtFontName.Text = "";
