...
namespace AGC.Webform
{
    ...
    /// <summary>
    ///		wucErrorLevelB 的摘要说明。
    /// </summary>
    public partial class wucErrorLevelB : System.Web.UI.UserControl
    {
        ...
        public string ErrorLevelName
        {
            get
            {
                return txtErrorLevelName.Text.Trim();
            }
            set
            {
                txtErrorLevelName.Text = value.ToString();
            }
        }
        ...
        {
            txtErrorLevelId.ReadOnly = bolReadonly;
        }
        public void Clear()
        {
            txtErrorLevelId.Text = "";
            txtErrorLevelName.Text = "";
            txtMemo.Text = "";
        }
        /// <summary>
