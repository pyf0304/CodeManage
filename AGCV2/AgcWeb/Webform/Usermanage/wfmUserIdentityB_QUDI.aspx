<%@ Register TagPrefix="uc1" TagName="wucUserIdentityB" Src="wucUserIdentityB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmUserIdentityB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmUserIdentityB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>用户权限身份表维护的维护</title>
        ...
        <table id="tabLayout" style="z-index: 105; left: 0px; position: absolute; top: 0px" cellspacing="2"
            ...
            <tr>
                <td>
                    ...
                    <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                        <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >用户权限身份表维护
                        </asp:Label>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblIdentityIDq" 
                                    runat="server" Width="90px" CssClass="text-secondary">身份编号</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtIdentityIDq" 
                                    runat="server" Width="100px"  CssClass="TextBox_Defa">
                                </asp:TextBox>
                            </td>

                            <td>
                                <asp:Label ID="lblIdentityDescq" 
                                    runat="server" Width="90px" CssClass="text-secondary">身份描述</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtIdentityDescq" 
                                    runat="server" Width="100px"  CssClass="TextBox_Defa">
                                </asp:TextBox>
                            </td>
            ...
            <tr>
                <td>
                    ...
                    <table id="tabUserIdentityGridView" style="width: 100%"
                        runat="server">
                        <tr>
                            <td>
                                <table style="width: 100%; height: 32px" id="tabGridFunction">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblUserIdentityList" runat="server" 
                                                CssClass="h6" Width="250px">用户权限身份表列表</asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvUserIdentity"  runat="server"
                                    Width="100%" AutoGenerateColumns="False"
                                    PageSize="10" AllowPaging="true"
                                    AllowSorting="true"
                                    OnSorting="gvUserIdentity_Sorting"
                                    OnPageIndexChanging="gvUserIdentity_PageIndexChanging"
                                    OnRowCreated="gvUserIdentity_RowCreated"
                                    OnRowCommand="gvUserIdentity_RowCommand"
                                    OnRowDeleting="gvUserIdentity_RowDeleting"
                                    OnRowUpdating="gvUserIdentity_RowUpdating"
                                    BackColor="White"
                                    BorderColor="#E7E7FF"
                                    BorderStyle="None"
                                    BorderWidth="1px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IdentityID" SortExpression="IdentityID" HeaderText="身份编号"></asp:BoundField>
            ...
            <tr>
                <td>
                    <table id="tabEditUserIdentityRegion" style="z-index: 111; width: 100%; padding: 1px;"
                        border="1" runat="server">
                        <tr>
                            <td>
                                <asp:Label ID="lblEditUserIdentity"  runat="server"
                                    CssClass="h6">用户权限身份表编辑区域</asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="btnCancelUserIdentityEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelUserIdentityEdit_Click"></asp:Button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <uc1:wucUserIdentityB ID="wucUserIdentityB1" runat="server" />
                            </td>
                        </tr>
                    </table>
                </td>
