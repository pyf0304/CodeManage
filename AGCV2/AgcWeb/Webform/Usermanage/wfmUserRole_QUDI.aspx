<%@ Page Language="c#" CodeBehind="wfmUserRole_QUDI.aspx.cs" AutoEventWireup="True"
    Inherits="AGC.wfmUserRole_QUDI" %>

<%@ Register TagPrefix="uc1" TagName="wucUserRole" Src="wucUserRole.ascx" %>
...
<body>
    <form id="Form1" method="post" runat="server">
            ...
            <table id="tabLayout" style="z-index: 110; left: 448px; width: 373px; position: absolute;
                ...
                <tr>
                    <td>
                        <uc1:wucUserRole id="wucUserRole1" runat="server">
                        </uc1:wucUserRole></td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblRoleId_q" runat="server"  
                            >角色ID</asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtRoleId_q" runat="server" Width="83px" ></asp:TextBox></td>
                    <td>
                        <asp:Label ID="lblRole_q" runat="server" Width="56px" 
                            >角色名称</asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtRole_q" runat="server" Width="100px" ></asp:TextBox></td>
                    <td>
