            ...
            <tr>
                <td>
                    ...
                    <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                        <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >平台默认角色维护
                        </asp:Label>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblid_School_q" 
                                    runat="server" Width="54px" CssClass="text-secondary">学校流</asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lblPersonType_q" 
                                    runat="server" Width="67px" CssClass="text-secondary">人员类别</asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lblPrjId_q" 
                                    runat="server" Width="58px" CssClass="text-secondary">工程Id</asp:Label>
                            </td>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblPlatDefaRoleList" runat="server" 
                                                CssClass="h6" Width="250px">平台默认角色列表</asp:Label>
                                        </td>
                                        <td>
                                ...
                                <asp:GridView ID="gvPlatDefaRole"  runat="server"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="全选">
                                            ...
                                            <HeaderTemplate>
                                                 <asp:LinkButton ID="lbSelAll" CommandName="lbSelAll" runat="server" CssClass="GoStyle_SelAll" Text="全选" ></asp:LinkButton>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="IsCurrentUse" SortExpression="IsCurrentUse" HeaderText="是否当前使用"></asp:BoundField>
                                        <asp:BoundField DataField="SchoolName" SortExpression="SchoolName" HeaderText="学校名称"></asp:BoundField>
                                        <asp:BoundField DataField="PersonType" SortExpression="PersonType" HeaderText="人员类别"></asp:BoundField>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                  <asp:LinkButton ID="lbUpdate" runat="Server" CommandName="Update" Text="修改" CssClass="GoStyle"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbDelete" runat="Server" CommandName="Delete" Text="删除" CssClass="GoStyle"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <PagerTemplate>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblEditPlatDefaRole"  runat="server"
                                    CssClass="h6">平台默认角色编辑区域</asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="btnCancelPlatDefaRoleEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelPlatDefaRoleEdit_Click"></asp:Button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
