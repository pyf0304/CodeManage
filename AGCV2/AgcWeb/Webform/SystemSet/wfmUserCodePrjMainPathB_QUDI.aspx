<%@ Register TagPrefix="uc1" TagName="wucUserCodePrjMainPathB" Src="wucUserCodePrjMainPathB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmUserCodePrjMainPathB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmUserCodePrjMainPathB_QUDI" %>
        ...
        <div id="tabLayout" class="tab_layout"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblPrjIdq" 
                                runat="server" CssClass="text-secondary">工程</asp:Label>
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblUserCodePrjMainPathList" runat="server" 
                ...
                <asp:GridView ID="gvUserCodePrjMainPath" Style="z-index: 120;" runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvUserCodePrjMainPath_Sorting"
                    OnPageIndexChanging="gvUserCodePrjMainPath_PageIndexChanging"
                    OnRowCreated="gvUserCodePrjMainPath_RowCreated"
                    OnRowCommand="gvUserCodePrjMainPath_RowCommand"
                    OnRowDeleting="gvUserCodePrjMainPath_RowDeleting"
                    OnRowUpdating="gvUserCodePrjMainPath_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_UserCodePrjMainPath<%# Eval("mId").ToString().Trim() %>"></a>
                        ...
                        <asp:BoundField DataField="IsUsePrjMainPath" SortExpression="IsUsePrjMainPath" HeaderText="	是否使用项目主路径"></asp:BoundField>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditUserCodePrjMainPathRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditUserCodePrjMainPath"  runat="server"
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelUserCodePrjMainPathEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelUserCodePrjMainPathEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucUserCodePrjMainPathB ID="wucUserCodePrjMainPathB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
