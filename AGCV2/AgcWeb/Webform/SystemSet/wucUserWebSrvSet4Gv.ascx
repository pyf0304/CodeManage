...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucUserWebSrvSet4Gv.ascx.cs" Inherits = "AGC.Webform.wucUserWebSrvSet4Gv" %>
...
runat = "server">
<asp:GridView id = "gvUserWebSrvSet" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvUserWebSrvSet_Sorting" 
OnPageIndexChanging = "gvUserWebSrvSet_PageIndexChanging" 
OnRowCreated = "gvUserWebSrvSet_RowCreated"
OnRowCommand = "gvUserWebSrvSet_RowCommand"
OnRowDeleting = "gvUserWebSrvSet_RowDeleting" 
OnRowUpdating = "gvUserWebSrvSet_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
<ItemTemplate>
<a name = "A_UserWebSrvSet<%# Eval("mId").ToString().Trim() %>"></a>
...
<asp:BoundField DataField = "MachineName" SortExpression = "MachineName" HeaderText = "机器名"></asp:BoundField>
