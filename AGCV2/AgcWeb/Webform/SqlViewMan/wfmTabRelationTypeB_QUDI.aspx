<%@ Register TagPrefix="uc1" TagName="wucTabRelationTypeB" Src="wucTabRelationTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmTabRelationTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmTabRelationTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>表关表类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >表关表类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblTabRelationTypeIdq" 
                                runat="server" CssClass="text-secondary">表关系类型Id</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTabRelationTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblTabRelationTypeNameq" 
                                runat="server" CssClass="text-secondary">表关系类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTabRelationTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblTabRelationTypeList" runat="server" 
                                CssClass="h6" Width="250px">表关表类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvTabRelationType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvTabRelationType_Sorting"
                    OnPageIndexChanging="gvTabRelationType_PageIndexChanging"
                    OnRowCreated="gvTabRelationType_RowCreated"
                    OnRowCommand="gvTabRelationType_RowCommand"
                    OnRowDeleting="gvTabRelationType_RowDeleting"
                    OnRowUpdating="gvTabRelationType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    Height="1px"
                    DataKeyNames="TabRelationTypeId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TabRelationTypeId" SortExpression="TabRelationTypeId" HeaderText="表关系类型Id"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditTabRelationTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditTabRelationType"  runat="server"
                                    CssClass="h6">表关表类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelTabRelationTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelTabRelationTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucTabRelationTypeB id="wucTabRelationTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
