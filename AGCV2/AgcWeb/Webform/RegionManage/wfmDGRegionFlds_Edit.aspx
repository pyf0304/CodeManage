<%@ Page Title="表DGRegionFlds的查询、修改、删除、添加记录" Language="C#" MasterPageFile="~/Webform/MasterPage/ViewRegionEdit.Master" CodeBehind="wfmDGRegionFlds_Edit.aspx.cs" ValidateRequest="false"
    AutoEventWireup="True" Inherits="AGC.Webform.wfmDGRegionFlds_Edit" %>

<%@ Register TagPrefix="uc3" TagName="wucDGRegionFlds" Src="../View/wucDGRegionFlds.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 100%" class="mt-2">
        <div class="float-left">
            <div style="width: 1030px; overflow: scroll">
        ...
        <div id="tabEditDGRegionFldsRegion" style="width: 405px" class="float-right border border-info mr-1">

            <div style="width: 405px; position: relative; height: 28px">
                <ul class="nav">
                    <li class="nav-item">
                        <asp:Label ID="Label1" runat="server" CssClass="h6" Width="200px">编辑字段属性</asp:Label>
                    </li>
                    <li class="nav-item ml-2">
                        <asp:Button ID="btnOKUpd" CssClass="btn btn-outline-warning btn-sm" runat="server" Text="添加" OnClick="btnOKUpd_Click"></asp:Button>
                    </li>
                    <li class="nav-item ml-2">
                        <asp:Label ID="lblMsg" runat="server" Width="178px" ForeColor="Red"></asp:Label>
                    </li>
                </ul>
            </div>
            <div class="mt-2">
                <uc3:wucDGRegionFlds ID="wucDGRegionFlds1" runat="server"></uc3:wucDGRegionFlds>
            </div>
