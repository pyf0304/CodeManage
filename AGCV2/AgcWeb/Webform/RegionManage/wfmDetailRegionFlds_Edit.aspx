<%@ Register TagPrefix="uc1" TagName="wucDetailRegionFlds" Src="../View/wucDetailRegionFlds.ascx" %>
...
<%@ Page Title="表DetailRegionFlds的查询、修改、删除、添加记录" Language="C#" MasterPageFile="~/Webform/MasterPage/ViewRegionEdit.Master" CodeBehind="wfmDetailRegionFlds_Edit.aspx.cs" ValidateRequest="false"
    AutoEventWireup="True" Inherits="AGC.Webform.wfmDetailRegionFlds_Edit" %>
    ...
    <div style="width: 100%">
        ...
        <div class="float-left ml-1" style="width: 1000px">
            <ul class="nav nav-tabs" role="navigation">
                ...
                <li class="nav-item active"><a class="nav-link" href="#tab2" data-toggle="tab" role="tab">列表区字段</a></li>
        ...
        <div id="tabDetailDetailRegionFldsRegion" class="float-right mr-1 border border-info" style="width: 405px">
            <div>
                <ul class="nav">
                    <li class="nav-item">
                        <asp:Label ID="Label4"
                    ...
                    <li class="nav-item ml-3">
                        <asp:Label ID="lblMsg"
                            runat="server" Width="178px"></asp:Label>
                    </li>
