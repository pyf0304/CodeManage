...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmEditRegionFlds_Edit : CommWebPageBase
    {
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                wucEditRegion4Preview1.ShowControl4Regoin(getRegionId, clsPubVar.CurrSelPrjId, true, true);
                //	3、设置Gv控件的某些列不可见；
        ...
        private void GetDataFromEditRegionFldsClass(clsEditRegionFldsEN pobjEditRegionFlds)
		{
            ...
            clsvEditRegionFldsEN objvEditRegionFlds = clsvEditRegionFldsBL.GetFirstObj_S("RegionId = '" + getRegionId + "' and FldId = '" + pobjEditRegionFlds.FldId+"'");
			...
			//wucEditRegionFlds1.DsDataValueFieldId = pobjEditRegionFlds.DsDataValueFieldId;
			//wucEditRegionFlds1.DsDataTextFieldId = pobjEditRegionFlds.DsDataTextFieldId;
   //         wucEditRegionFlds1.Ds_CondFieldId = pobjEditRegionFlds.Ds_CondFieldId;
   //         wucEditRegionFlds1.Ds_SortFieldId = pobjEditRegionFlds.Ds_SortFieldId;
		...
		private void PutDataToEditRegionFldsClass(clsEditRegionFldsEN pobjEditRegionFlds)
		{
			...
			//pobjEditRegionFlds.DsDataValueFieldId = wucEditRegionFlds1.DsDataValueFieldId;
   //         pobjEditRegionFlds.DsDataTextFieldId = wucEditRegionFlds1.DsDataTextFieldId;
   //         pobjEditRegionFlds.Ds_CondFieldId = wucEditRegionFlds1.Ds_CondFieldId;
   //         pobjEditRegionFlds.Ds_SortFieldId = wucEditRegionFlds1.Ds_SortFieldId;
		...
		protected void btnDelete4Dg_Click(object sender, System.EventArgs e)
		{
            ...
            clsEditRegionFldsBLEx.ReOrder(getRegionId);
		...
		protected void btnCopyFldFromRelaTab_Click(object sender, System.EventArgs e)
		{
            ...
            clsEditRegionFldsBLEx.ImportRelaFlds(getRegionId, clsPubVar.CurrCmPrjId, UserId);
            //clsViewRegionBLEx.SetFldCount(getRegionId);
            //clsViewRegionBLEx.SetFldCountInUse(getRegionId);
        ...
        protected void btnCopyFromOtherView_Click(object sender, EventArgs e)
        {
            ...
            clsEditRegionFldsBLEx.CopyTo1(arrRegionId[0], getRegionId, clsPubVar.CurrCmPrjId, clsCommonSession.UserId);
            BindGv_vEditRegionFlds();
        }
    }
}