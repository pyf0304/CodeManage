<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvDetailRegionFlds4Gv.ascx.cs" Inherits="AGC.Webform.wucvDetailRegionFlds4Gv" %>

<%-- 列表层 --%>

<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvDetailRegionFlds" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvDetailRegionFlds_Sorting"
        OnPageIndexChanging="gvDetailRegionFlds_PageIndexChanging"
        OnRowCreated="gvDetailRegionFlds_RowCreated"
        OnRowCommand="gvDetailRegionFlds_RowCommand"
        OnRowDeleting="gvDetailRegionFlds_RowDeleting"
        OnRowUpdating="gvDetailRegionFlds_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        Height="1px"
        DataKeyNames="mId"
        CssClass="table table-striped table-bordered table-condensed" OnRowDataBound="gvDetailRegionFlds_RowDataBound">
        <Columns>
            <asp:TemplateField HeaderText="全选">
                ...
                <ItemTemplate>
                    <a name="A_DetailRegionFlds<%# Eval("mId").ToString().Trim() %>"></a>
