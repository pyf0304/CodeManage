...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmFeatureRegionFldsB_Edit : CommWebPageBase
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)	///如果本界面是初次被调用，而不是单击按钮事件所调用
            {
                ...
                clsViewRegionEN objViewRegion = clsViewRegionBL.GetObjByRegionIdCache(getRegionId, clsPubVar.CurrSelPrjId);
            ...
            try
            {
                ...
                //if (objPrjTab != null)
                //{
                //    wucFeatureRegionButton4Visible1.ShowButton4Regoin(getRegionId, objPrjTab.TabCnName, clsPubVar.CurrSelPrjId);

                //}
                //else
                //{
                //    wucFeatureRegionButton4Visible1.ShowButton4Regoin(getRegionId, "表名", clsPubVar.CurrSelPrjId);
                //}

                wucFeatureRegionButton4Visible1.ShowButton4View(getRegionId, clsPubVar.CurrSelPrjId);
        ...
        protected void btnCopyFldFromTemplate_Click(object sender, EventArgs e)
        {
            ...
            clsFeatureRegionFldsBLEx.ImportRelaFlds(getRegionId, clsPubVar.CurrCmPrjId, UserId);
            //clsViewRegionBLEx.SetFldCount(getRegionId);
            //clsViewRegionBLEx.SetFldCountInUse(getRegionId);
        ...
        protected void btnSaveSet_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                clsFeatureRegionFldsBLEx.AddFeatureRegionFldsRecordSave(getRegionId, vsApplicationTypeId, vsMainTabId, objFeatureRegionFlds, clsCommonSession.UserId);
    ...
    public partial class wfmFeatureRegionFldsB_Edit : CommWebPageBase
    {
        private void ShowData4CtrlId(string strCtrlId)
        {
            ...
            string strCondition = string.Format("{0}='{1}' and {2} in ({3})",
                convFeatureRegionFlds.ButtonName, strCtrlId,
                    convFeatureRegionFlds.RegionId, getRegionId);
        ...
        protected string CombinevFeatureRegionFldsCondition()
        {
            ...
            strWhereCond += string.Format(" and {0}='{1}' ",
                conViewRegionRela.RegionId, getRegionId);
...
//.SetMemo(wucFeatureRegionFldsB1.Memo);// 说明
        ...
        protected void AddFeatureRegionFldsRecord()
        {
            ...
            wucFeatureRegionFldsB1.SetDdl_TabFeatureId(vsMainTabId, clsPubVar.CurrSelPrjId);
        ...
        protected void btnGoFirstLine_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                clsFeatureRegionFldsBL.GoTop(arrViewFeatureId, getRegionId);
                //clsViewInfoBLEx.SetViewUpdDate(vsViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
            }
            catch (Exception objException)
            {
        ...
        protected void btnGoLastLine_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                clsFeatureRegionFldsBL.GoBottom(arrViewFeatureId, getRegionId);
                //clsViewInfoBLEx.SetViewUpdDate(vsViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
            }
        ...
        protected void btnUpMove_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                clsFeatureRegionFldsBL.AdjustOrderNum("UP", strViewFeatureId, getRegionId);
                //clsViewInfoBLEx.SetViewUpdDate(vsViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
            }
        ...
        protected void btnDownMove_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                clsFeatureRegionFldsBL.AdjustOrderNum("DOWN", strViewFeatureId, getRegionId);
                //clsViewInfoBLEx.SetViewUpdDate(vsViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
            }
            catch (Exception objException)
            {
        ...
        protected void btnReOrder_Click(object sender, System.EventArgs e)
        {
            ...
            clsFeatureRegionFldsBLEx.ReOrderEx(getRegionId);
            //clsViewInfoBLEx.SetViewUpdDate(vsViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
            BindGv_vFeatureRegionFlds();
        }
        ...
        protected void btnConfirmBatchAddFeature_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(getRegionId) == true)
            {
                clsCommonJsFunc.Alert(this, "当前区域Id为空，请重新登录！");
                return;
            }
        ...
        private void InitViewData()
        {
            ...
            K_RegionId_ViewRegion objKey = new K_RegionId_ViewRegion(getRegionId);
            clsViewRegionEN objViewRegionEN = objKey.GetObj();
            vsMainTabId = objViewRegionEN.TabId;
            vsApplicationTypeId = 0;// objViewRegionEN.ApplicationTypeId;
            wucFeatureRegionFldsB1.vsMainTabId = objViewRegionEN.TabId;
        }
        ///
        /// <summary>
        ...
        protected void btnDeleteTabFeature_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //clsTabFeatureBLEx.DelRecordEx(getRegionId);
                BindBtn_PrjFeature();
                BindGv_vFeatureRegionFlds();
            }
            catch (Exception objException)
        ...
        private void PutDataToViewFeatureFldsClass(clsViewFeatureFldsEN pobjViewFeatureFlds)
        {
            ...
            //pobjViewFeatureFlds.DsDataValueFieldId = wucViewFeatureFlds1.DsDataValueFieldId;
            //pobjViewFeatureFlds.DsDataTextFieldId = wucViewFeatureFlds1.DsDataTextFieldId;
            //pobjViewFeatureFlds.Ds_CondFieldId = wucViewFeatureFlds1.Ds_CondFieldId;
            //pobjViewFeatureFlds.Ds_SortFieldId = wucViewFeatureFlds1.Ds_SortFieldId;
        ...
        private void GetDataFromViewFeatureFldsClass(clsViewFeatureFldsEN pobjViewFeatureFlds)
        {
            ...
            //wucViewFeatureFlds1.DsDataValueFieldId = pobjViewFeatureFlds.DsDataValueFieldId;
            //wucViewFeatureFlds1.DsDataTextFieldId = pobjViewFeatureFlds.DsDataTextFieldId;

            //wucViewFeatureFlds1.Ds_CondFieldId = pobjViewFeatureFlds.Ds_CondFieldId;
            //wucViewFeatureFlds1.Ds_SortFieldId = pobjViewFeatureFlds.Ds_SortFieldId;
