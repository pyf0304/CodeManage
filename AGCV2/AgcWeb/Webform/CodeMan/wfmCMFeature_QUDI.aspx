...
<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCMFeature_QUDI.aspx.cs" Inherits="AGC.Webform.wfmCMFeature_QUDI" ValidateRequest="false" %>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFeatureNameq" Width="245px"
                                runat="server" CssClass="form-control-sm">
                            </asp:TextBox>
                        </td>
