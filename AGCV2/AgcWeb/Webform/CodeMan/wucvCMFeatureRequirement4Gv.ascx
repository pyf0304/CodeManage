<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvCMFeatureRequirement4Gv.ascx.cs" Inherits="AGC.Webform.wucvCMFeatureRequirement4Gv" %>
<%-- 列表层 --%>

<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvCMFeatureRequirement" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvCMFeatureRequirement_Sorting"
        OnPageIndexChanging="gvCMFeatureRequirement_PageIndexChanging"
        OnRowCreated="gvCMFeatureRequirement_RowCreated"
        OnRowCommand="gvCMFeatureRequirement_RowCommand"
        OnRowDeleting="gvCMFeatureRequirement_RowDeleting"
        OnRowUpdating="gvCMFeatureRequirement_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_CMFeatureRequirement<%# Eval("mId").ToString().Trim() %>"></a>
            ...
            <asp:BoundField DataField="RequirementName" SortExpression="RequirementName" HeaderText="需求"></asp:BoundField>
