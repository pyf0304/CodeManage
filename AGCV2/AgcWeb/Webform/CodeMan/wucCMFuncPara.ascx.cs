...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wucCMFuncPara : System.Web.UI.UserControl
    {
        /// <summary>
        ...
        public string CmFuncParaId
        {
            get
            {
                return txtCmFuncParaId.Text.Trim();
            }
            set
            {
                txtCmFuncParaId.Text = value.ToString();
            }
        }
        ...
        public string CmFunctionId
        {
            get
            {
                if (ddlCmFunctionId.SelectedValue == "0")
                    return "";
                return ddlCmFunctionId.SelectedValue;
            }
            set
            {
                if (ddlCmFunctionId.Items.Count > 0)
                {
                    if (value == "")
                    {
                        ddlCmFunctionId.SelectedValue = "0";
                    }
                    else
                    {
                        ddlCmFunctionId.SelectedValue = value;
                    }
                }
            }
        }
        ...
        {
            txtCmFuncParaId.ReadOnly = bolReadonly;
        }
        /// <summary>
        /// 清除用户自定义控件中，所有控件的值
        /// (AutoGCLib.AutoGC7Cs_CWeb_Net2005:A_GenCtlControlCodeforTab)
        ...
        public void Clear()
        {
            txtCmFuncParaId.Text = "";
            txtParaName.Text = "";
            txtParaCnName.Text = "";
            ddlCmFunctionId.SelectedIndex = 0;
        ...
        public void BindDdl_CmFunctionId(System.Web.UI.WebControls.DropDownList objDDL)
        {
            //为数据源于表的下拉框设置内容
            ListItem li = new ListItem("请选择...", "0");
            System.Data.DataTable objDT = GetCmFunctionId();
        ...
        public void SetDdl_CmFunctionId()
        {
