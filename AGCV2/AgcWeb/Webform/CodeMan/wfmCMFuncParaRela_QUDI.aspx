<%@ Register TagPrefix="uc1" TagName="wucCMFuncPara" Src="wucCMFuncPara.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCMFuncParaRela_QUDI.aspx.cs" Inherits="AGC.Webform.wfmCMFuncParaRela_QUDI" %>
        ...
        <div id="tabLayout" class="tab_layout"
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCmFunctionIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List"
                ...
                <div id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <ul class="nav">
                        <li class="nav-item">
                            <asp:Label ID="lblCMFuncParaRelaList" runat="server"
                ...
                <asp:GridView ID="gvCMFuncParaRela" Style="z-index: 117;" runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvCMFuncParaRela_Sorting"
                    OnPageIndexChanging="gvCMFuncParaRela_PageIndexChanging"
                    OnRowCreated="gvCMFuncParaRela_RowCreated"
                    OnRowCommand="gvCMFuncParaRela_RowCommand"
                    OnRowDeleting="gvCMFuncParaRela_RowDeleting"
                    OnRowUpdating="gvCMFuncParaRela_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    Height="1px"
                    DataKeyNames="mId"
                    CssClass="table table-striped table-bordered table-condensed" OnRowDataBound="gvCMFuncParaRela_RowDataBound" >
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_CMFuncParaRela<%# Eval("CmFuncParaId").ToString().Trim() %>"></a>
                                <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="OrderNum" SortExpression="OrderNum" HeaderText="序号"></asp:BoundField>
                        <asp:BoundField DataField="CmFunctionId" SortExpression="CmFunctionId" HeaderText="函数Id4Code"></asp:BoundField>
                        <asp:BoundField DataField="FunctionName" SortExpression="FunctionName" HeaderText="函数名4Code"></asp:BoundField>
                        <asp:BoundField DataField="FunctionSignature" SortExpression="FunctionSignature" HeaderText="函数签名"></asp:BoundField>
                        <asp:BoundField DataField="CmFuncParaId" SortExpression="CmFuncParaId" HeaderText="函数参数Id"></asp:BoundField>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditCMFuncParaRegion" class="tab_Edit"
                runat="server">
                <div>
                    <ul class="nav">
                        <li class="nav-item">
                            <asp:Label ID="lblEditCMFuncParaRela" runat="server" Width="300px"
                        ...
                        <li class="nav-item ml-3">
                            <asp:Button ID="btnCancelCMFuncParaEdit"
                                runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelCMFuncParaEdit_Click"></asp:Button>
                        </li>
                         <li class="nav-item ml-3">
                ...
                <div>
                    <uc1:wucCMFuncPara ID="wucCMFuncPara1" runat="server" />
                </div>
            </div>
        </div>
    </form>
