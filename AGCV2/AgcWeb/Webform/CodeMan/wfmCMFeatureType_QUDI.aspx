<%@ Register TagPrefix="uc1" TagName="wucCMFeatureType" Src="./wucCMFeatureType.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCMFeatureType_QUDI.aspx.cs" Inherits="AGC.Webform.wfmCMFeatureType_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>功能类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >功能类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblCmFeatureTypeIdq" 
                                runat="server" CssClass="text-secondary">功能类型Id</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCmFeatureTypeIdq" 
                                runat="server" CssClass="form-control-sm">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblFeatureTypeNameq" 
                                runat="server" CssClass="text-secondary">功能类型名称</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFeatureTypeNameq" 
                                runat="server" CssClass="form-control-sm">
                            </asp:TextBox>
                        </td>                    
                        <td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblCMFeatureTypeList" runat="server" 
                                CssClass="h6" Width="250px">功能类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvCMFeatureType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvCMFeatureType_Sorting"
                    OnPageIndexChanging="gvCMFeatureType_PageIndexChanging"
                    OnRowCreated="gvCMFeatureType_RowCreated"
                    OnRowCommand="gvCMFeatureType_RowCommand"
                    OnRowDeleting="gvCMFeatureType_RowDeleting"
                    OnRowUpdating="gvCMFeatureType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_CMFeatureType<%# Eval("CmFeatureTypeId").ToString().Trim() %>"></a>
                                <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="CmFeatureTypeId" SortExpression="CmFeatureTypeId" HeaderText="功能类型Id"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditCMFeatureTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditCMFeatureType"  runat="server"
                                    CssClass="h6">功能类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelCMFeatureTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelCMFeatureTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucCMFeatureType ID="wucCMFeatureType1" runat="server" />
                </div>
            </div>
        </div>
    </form>
