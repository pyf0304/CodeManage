...
namespace AGC.Webform
{
    ...
    /// <summary>
    ///		wucCMProjectFuncModule 的摘要说明。
    /// (AutoGCLib.WebCtlControlCode4CSharp:GeneCode)
    /// </summary>
    public partial class wucCMProjectFuncModule : System.Web.UI.UserControl
    {
        ...
        {
            //获取某学院所有专业信息
            string strSQL = "select FuncModuleAgcId, TabName from PrjTab ";
        ...
        public void BindDdl_FuncModuleAgcId(System.Web.UI.WebControls.DropDownList objDDL)
        {
            ...
            objDDL.DataValueField = conPrjTab.FuncModuleAgcId;
