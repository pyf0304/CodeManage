...
<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCMFuncPara_QUDI.aspx.cs" Inherits="AGC.Webform.wfmCMFuncPara_QUDI" %>
        ...
        <div id="tabLayout" class="tab_layout"
            ...
            <div id="divList" class="div_List"
                ...
                <div id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <ul class="nav">
                        <li class="nav-item">
                            <asp:Label ID="lblCMFuncParaList" runat="server"
                        ...
                        <li class="nav-item ml-3">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <asp:DropDownList ID="ddlCmFunctionId" runat="server" CssClass="TextBox_Defa ml-1">
                                </asp:DropDownList>
                            </div>
                        </li>
                        <li class="nav-item ml-3">
                ...
                <asp:GridView ID="gvCMFuncPara" Style="z-index: 117;" runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvCMFuncPara_Sorting"
                    OnPageIndexChanging="gvCMFuncPara_PageIndexChanging"
                    OnRowCreated="gvCMFuncPara_RowCreated"
                    OnRowCommand="gvCMFuncPara_RowCommand"
                    OnRowDeleting="gvCMFuncPara_RowDeleting"
                    OnRowUpdating="gvCMFuncPara_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    Height="1px"
                    DataKeyNames="CmFuncParaId"
                    CssClass="table table-striped table-bordered table-condensed" OnRowDataBound="gvCMFuncPara_RowDataBound">
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_CMFuncPara<%# Eval("CmFuncParaId").ToString().Trim() %>"></a>
                ...
                <div>
                    <ul class="nav">
                        <li class="nav-item">
                            ...
                            <asp:Label ID="lblEditCMFuncPara" runat="server" Width="200px"
