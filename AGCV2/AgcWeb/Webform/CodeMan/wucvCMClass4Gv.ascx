<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvCMClass4Gv.ascx.cs" Inherits="AGC.Webform.wucvCMClass4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvCMClass" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvCMClass_Sorting"
        OnPageIndexChanging="gvCMClass_PageIndexChanging"
        OnRowCreated="gvCMClass_RowCreated"
        OnRowCommand="gvCMClass_RowCommand"
        OnRowDeleting="gvCMClass_RowDeleting"
        OnRowUpdating="gvCMClass_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_CMClass<%# Eval("CMClassId").ToString().Trim() %>"></a>
                    <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="ClassName" SortExpression="ClassName" HeaderText="类名"></asp:BoundField>
            <asp:BoundField DataField="FuncNum" SortExpression="FuncNum" HeaderText="函数数"></asp:BoundField>
            <asp:BoundField DataField="ProgLangTypeSimName" SortExpression="ProgLangTypeSimName" HeaderText="语言"></asp:BoundField>
            ...
            <asp:BoundField DataField="ProjectPath" SortExpression="ProjectPath" HeaderText="工程路径"></asp:BoundField>
            ...
            <asp:BoundField DataField="FuncModuleNameSim" SortExpression="FuncModuleNameSim" HeaderText="模块"></asp:BoundField>
            <asp:BoundField DataField="CodeTypeSimName" SortExpression="CodeTypeSimName" HeaderText="代码类型"></asp:BoundField>
            ...
            <asp:BoundField DataField="UserId" SortExpression="UserId" HeaderText="用户"></asp:BoundField>
            <asp:BoundField DataField="CMClassId" SortExpression="CMClassId" HeaderText="类Id"></asp:BoundField>
