...
namespace AGC.Webform
{
	...
	/// <summary>
	///		wucDataTypeAbbr 的摘要说明。
	/// </summary>
	public partial class wucDataTypeAbbr : System.Web.UI.UserControl
	{
		...
		public string DataTypeId
		{
			get
			{
				return txtDataTypeId.Text.Trim();
			}
			set
			{
				txtDataTypeId.Text = value.ToString();
			}
		}
		...
		public string NetSysType
		{
			get
			{
				return txtNetSysType.Text.Trim();
			}
			set
			{
				txtNetSysType.Text = value.ToString();
			}
		}
		...
		public bool IsNeedQuote
		{
			get
			{
				return chkIsNeedQuote.Checked;
			}
			set
			{
				chkIsNeedQuote.Checked = value;
			}
		}
		...
		{
			txtDataTypeId.ReadOnly = bolReadonly;
		}
		public void Clear()
		{
			txtDataTypeId.Text = "";
