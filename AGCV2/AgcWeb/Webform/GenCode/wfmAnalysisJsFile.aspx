<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmAnalysisJsFile.aspx.cs"
    Inherits="AGC.Webform.wfmAnalysisJsFile" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Div1" class="tab_layout"
                ...
                <table id="tabQueryCondition" border="0" style="width: 848px; padding: 2px;"
                    ...
                    <tr>
                        <td style="text-align: right;">
                            <asp:Label ID="lblTabNameq" runat="server" CssClass="NameLabelRightAlign" Width="140px">Js文件</asp:Label>
                        </td>
                        <td >
                            <asp:TextBox ID="txtWebSrvUrl" runat="server" Width="774px">tzPubFun.js</asp:TextBox>
                        </td>
                        ...
                        <td ></td>
                        <td >
                            <asp:Button ID="btnDIspFunctionInfo" runat="server" OnClick="btnDIspFunctionInfo_Click" CssClass="btn btn-outline-info btn-sm" Text="显示函数信息" Width="110px" />
                        </td>
                        <td >&nbsp;</td>
            ...
            <div id="divList" class="div_List" runat="server">
                <asp:GridView ID="gvPrjTab" Style="z-index: 120; position: relative;" runat="server"
                    Width="100%" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True"
                    OnSorting="gvPrjTab_Sorting" OnPageIndexChanging="gvPrjTab_PageIndexChanging"
                    OnRowCreated="gvPrjTab_RowCreated" OnRowCommand="gvPrjTab_RowCommand" OnRowDeleting="gvPrjTab_RowDeleting"
                    OnRowUpdating="gvPrjTab_RowUpdating" BackColor="White" BorderColor="#E7E7FF"
