...
/*-- -- -- -- -- -- -- -- -- -- --
类名:wucWebSrvFuncParaB
表名:WebSrvFuncPara
生成代码版本:2017.07.08.1
生成日期:2017/07/30 10:07:00
生成者:
工程名称:AGC
工程ID:0005
模块中文名:生成C#代码
...
namespace AGC.Webform
{
    ...
    /// <summary>
    ///		wucWebSrvFuncParaB 的摘要说明。
    /// (AutoGCLib.AutoGC7Cs_CWeb_Net2005:A_GenCtlControlCodeforTab)
    /// </summary>
    public partial class wucWebSrvFuncParaB : System.Web.UI.UserControl
    {
        /// <summary>
        ...
        public string WebSrvFuncParaId
        {
            get
            {
                return txtWebSrvFuncParaId.Text.Trim();
            }
            set
            {
                txtWebSrvFuncParaId.Text = value.ToString();
            }
        }
        ...
        {
            txtWebSrvFuncParaId.ReadOnly = bolReadonly;
        }
        /// <summary>
        /// 清除用户自定义控件中，所有控件的值
        /// (AutoGCLib.AutoGC7Cs_CWeb_Net2005:A_GenCtlControlCodeforTab)
        ...
        public System.Data.DataTable GetDataTypeId()
        {
            ...
            clsSpecSQLforSql mySql = clsWebSrvFuncParaBL.GetSpecSQLObj();
