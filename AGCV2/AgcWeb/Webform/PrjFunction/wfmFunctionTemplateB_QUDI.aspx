<%@ Register TagPrefix="uc1" TagName="wucFunctionTemplateB" Src="wucFunctionTemplateB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmFunctionTemplateB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmFunctionTemplateB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>函数模板维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >函数模板维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFunctionTemplateIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblFunctionTemplateNameq" 
                                runat="server" CssClass="text-secondary">函数模板名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFunctionTemplateNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblCreateUserIdq" Style="z-index: 116;"
                                runat="server" CssClass="text-secondary">建立用户Id</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCreateUserIdq" Style="z-index: 117;"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblFunctionTemplateList" runat="server" 
                                CssClass="h6" Width="250px">函数模板列表</asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Button ID="btnSetTemplateFunction" OnClick="btnSetTemplateFunction_Click"  runat="server"
                                Width="100px" CssClass="btn btn-outline-info btn-sm" Text="维护相关函数"></asp:Button>
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="gvFunctionTemplate" Style="z-index: 120;" runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvFunctionTemplate_Sorting"
                    OnPageIndexChanging="gvFunctionTemplate_PageIndexChanging"
                    OnRowCreated="gvFunctionTemplate_RowCreated"
                    OnRowCommand="gvFunctionTemplate_RowCommand"
                    OnRowDeleting="gvFunctionTemplate_RowDeleting"
                    OnRowUpdating="gvFunctionTemplate_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    Height="1px"
                    DataKeyNames="FunctionTemplateId"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_FunctionTemplate<%# Eval("FunctionTemplateId").ToString().Trim() %>"></a>
                                <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="FunctionTemplateId" SortExpression="FunctionTemplateId" HeaderText="函数模板Id"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="FunctionCount" SortExpression="FunctionCount" HeaderText="函数数目"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditFunctionTemplateRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditFunctionTemplate"  runat="server"
                                    CssClass="h6">函数模板编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelFunctionTemplateEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelFunctionTemplateEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucFunctionTemplateB ID="wucFunctionTemplateB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
