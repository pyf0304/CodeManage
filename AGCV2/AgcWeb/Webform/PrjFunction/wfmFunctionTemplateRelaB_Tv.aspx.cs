...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmFunctionTemplateRelaB_Tv : CommWebPageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)    ///如果本界面是初次被调用,而不是单击按钮事件所调用
            {
                ...
                clsDropDownList.BindDdl_TrueAndFalse(ddlIsGeneCode);
                ...
                clsRegionTypeBL.BindDdl_RegionTypeIdCache(ddlRegionTypeIdq);
                ...
                clsCodeTypeBLEx.BindDdl_DependsOn(ddlDependsOn, ddlProgLangTypeIdq.SelectedValue);
                ddlDependsOn.SelectedValue = "Table";
                clsCodeTypeBLEx.BindDdl_GroupNameByDependsOn(ddlGroupName, "Table", ddlProgLangTypeIdq.SelectedValue);


                ddlFunctionTemplateIdq.SelectedValue = enumFunctionTemplate.AllFunctionSet_0001;
                ...
                BindTv_ApplicationType_CodeTypeByProgLangTypeId();
        ...
        protected void btnQuery_Click(object sender, System.EventArgs e)
        {
            ...
            //把表记录的内容显示在GridView中
            BindGv_vFunctionTemplateRela();
            if (wucvFunction4GeneCode4Gv1.Visible == true)
            {
        ...
        protected void BindGv_vFunctionTemplateRela()
        {
            ...
            try
            {
                ...
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.FunctionTemplateId, false);
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.FunctionTemplateName, false);
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.CodeTypeName, false);
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.CodeTypeId, false);
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.ProgLangTypeName, false);
        ...
        protected string CombinevFunctionTemplateRelaCondition()
        {
            ...
            try
            {
                ...
                {
                    strWhereCond += string.Format(" And {0} = '{1}'", convFunctionTemplateRela.RegionTypeId, this.ddlRegionTypeIdq.SelectedValue);
                }
        ...
        protected void ddlProgLangTypeId4CodeType_q_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                clsCodeTypeBLEx.BindDdl_GroupNameByDependsOn(ddlGroupName, ddlDependsOn.SelectedValue, strProgLangTypeId);
                ddlGroupName.SelectedIndex = 0;
        ...
        private void BindTv_ApplicationType_CodeType()
        {
            ...
            if (wucTreeView1.Nodes.Count == 0) return;
        ...
        private void BindTv_ApplicationType_CodeTypeByProgLangTypeId()
        {
            string strProgLangTypeId = "";
            if (ddlProgLangTypeId4CodeTypeq.SelectedIndex <= 0)
            {
            ...
            wucTreeView1.tmTreeModel = TreeModel.ApplicationType_CodeTypeByProgLangTypeId;
            wucTreeView1.ProgLangTypeId = strProgLangTypeId;
            wucTreeView1.DependsOn = strDependsOn;
            wucTreeView1.GroupName = strGroupName;
        ...
        protected void wucTreeView1_afterSelect_Tz(object sender, clsEventArgs4TreeView e)
        {
            ...
            switch (strTypeName)
            {
                ...
                case conApplicationType._CurrTabName:
                    if (string.IsNullOrEmpty(wucTreeView1.NodeData.CodeTypeId) == false)
                    {
   ...
   protected void btnSetIsGeneCode_Click(object sender, EventArgs e)
        {
            if (ddlIsGeneCode.SelectedIndex == 0)
            {
                clsCommonJsFunc.Alert(this, "请输入是否生成选择项！");
                ddlRegionTypeId.Focus();
                return;
            }
            List<long> lstMId = wucvFunctionTemplateRela4Gv1.GetAllCheckedKeysFromGv();
            if (lstMId == null) return;
            bool bolIsGeneCode = false;
            if (ddlIsGeneCode.SelectedIndex == 1)
            {
                bolIsGeneCode = true;
            }
        ...
        protected void btnSetRegionTypeId_Click(object sender, EventArgs e)
        {
            ...
            {
      clsCommonJsFunc.Alert(this, "请输入区域类型！");
                ddlRegionTypeId.Focus();
                return ;
            }
            List<long> lstMId = wucvFunctionTemplateRela4Gv1.GetAllCheckedKeysFromGv();
            ...
            try
            {
                ...
                {
                    clsFunctionTemplateRelaEN obj = clsFunctionTemplateRelaBL.GetObjBymId(lngmId);
                    obj.RegionTypeId = strRegionTypeId;
                    obj.SetUpdDate(clsDateTime.getTodayDateTimeStr(1))
                        .SetUpdUser(clsCommonSession.UserId);
                    obj.EditRecordEx();
                }
        ...
        protected void ddlFunctionTemplateId_q_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strFunctionTemplateId = ddlFunctionTemplateIdq.SelectedValue;
            if (strFunctionTemplateId == enumFunctionTemplate.RegionFunctionSet_0004 ||
                strFunctionTemplateId == enumFunctionTemplate.RegionFunctionDetailSet_0005)
            {
                ddlRegionTypeId.Enabled = true;
                btnSetRegionTypeId.Enabled = true;
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.RegionTypeId, true);
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.RegionTypeName, true);

            }
            else
            {
                ddlRegionTypeId.Enabled = false;
                btnSetRegionTypeId.Enabled = false;
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.RegionTypeId, false);
                wucvFunctionTemplateRela4Gv1.SetGvVisibility(convFunctionTemplateRela.RegionTypeName, false);
        ...
        protected void btnOKUpd2_Click(object sender, System.EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(vsCodeTypeId) == true)
            {
                strMsg = "代码类型Id不能为空!请在树中选择一个功能！";
                clsCommonJsFunc.Alert(this, strMsg);
                //lblMsgEdit.Text = strMsg;
                return;
            }
            if (lstFuncId4GC == null)
            {
                strMsg = "请在函数表中选择至少一个函数！";
                clsCommonJsFunc.Alert(this, strMsg);
                //lblMsgEdit.Text = strMsg;
                return;
            }
            foreach (var strFuncId4GC in lstFuncId4GC)
            {
                var objFunction4GeneCode = clsFunction4GeneCodeBL.GetObjByFuncId4GCCache(strFuncId4GC);
                if (objFunction4GeneCode == null) continue;
                clsFunctionTemplateRelaEN pobjFunctionTemplateRelaEN = new clsFunctionTemplateRelaEN();
                pobjFunctionTemplateRelaEN.SetCodeTypeId(vsCodeTypeId)// 功能
    .SetFuncId4GC(strFuncId4GC)// 需求
    ...
    .SetFunctionTemplateId(ddlFunctionTemplateIdq.SelectedValue);// 说明
                pobjFunctionTemplateRelaEN.EditRecordEx();
            }
            if (wucvFunctionTemplateRela4Gv1.Visible == true)
            {
                BindGv_vFunctionTemplateRela();
            }
            if (wucvFunction4GeneCode4Gv1.Visible == true)
            ...
            strMsg = string.Format("已经添加了{0}条功能需求关系!", lstFuncId4GC.Count);
            clsCommonJsFunc.Alert(this, strMsg);
        ...
        protected void BindGv_vFunction4GeneCode()
        {
            ...
            try
            {
                ...
                wucvFunction4GeneCode4Gv1.SetGvVisibility(convFunction4GeneCode.FuncCodeTypeName, false);
                wucvFunction4GeneCode4Gv1.SetGvVisibility(convFunction4GeneCode.ProgLangTypeName, false);
                wucvFunction4GeneCode4Gv1.SetGvVisibility(convFunction4GeneCode.FuncTypeName, false);
                wucvFunction4GeneCode4Gv1.SetGvVisibility(convFunction4GeneCode.ParsedWords, false);
                wucvFunction4GeneCode4Gv1.SetGvVisibility(convFunction4GeneCode.ParsedWordsExcluded, false);
        ...
        protected string CombineFunction4GeneCodeCondition()
        {
            ...
            {
                strWhereCond += string.Format(" and {0} = '{1}' ", conFunctionTemplateRela.FuncCodeTypeId, vsCodeTypeId);
                strWhereCond += string.Format(" And {0} Not In (Select {0} From {1} Where {2}= '{3}' and {4}='{5}') ",
             conFunction4GeneCode.FuncId4GC, conFunctionTemplateRela._CurrTabName,
             conFunctionTemplateRela.FuncCodeTypeId, vsCodeTypeId,
             conFunctionTemplateRela.FunctionTemplateId, strFunctionTemplateId);
            }
            else
            {
                strWhereCond += string.Format(" And {0} Not In (Select {0} From {1} Where {4}='{5}') ",
                    conFunction4GeneCode.FuncId4GC, conFunctionTemplateRela._CurrTabName,
                    conFunctionTemplateRela.FuncCodeTypeId, vsCodeTypeId,
                    conFunctionTemplateRela.FunctionTemplateId, strFunctionTemplateId);
            }
            ...
            try
            {
                ...
                if (this.txtFuncName_GC.Text.Trim() != "")
                {
                    strWhereCond += string.Format(" And {0} like '%{1}%'", convFunction4GeneCode.FuncName,
                        this.txtFuncName_GC.Text.Trim());
                }
        ...
        protected void btnDispFuncTemplateRela_Click(object sender, EventArgs e)
        {
            if (wucvFunctionTemplateRela4Gv1.Visible == true)
            {
                wucvFunctionTemplateRela4Gv1.Visible = false;
                btnDispFuncTemplateRela.Text = "显示函数模板关系列表";
            }
            else
            {
                wucvFunctionTemplateRela4Gv1.Visible = true;
                btnDispFuncTemplateRela.Text = "隐藏函数模板关系列表";
            }
        }

        protected void btnAddNewRecord_Click(object sender, EventArgs e)
        {
            //AddCodeTypeFunction4GeneCodeRecord();
            if (string.IsNullOrEmpty(vsCodeTypeId) == true || vsCodeTypeId == "0")
            {
                string strMsg = "代码类型Id不能为空!请在树中选择一个项目！";
                clsCommonJsFunc.Alert(this, strMsg);
                //lblMsgEdit.Text = strMsg;
                return;
            }
            if (btnAddNewRecord.Text == "隐藏函数列表")
            {
                btnAddNewRecord.Text = "批量函数列表";
                wucvFunction4GeneCode4Gv1.Visible = false;
            }
            else
            {
                wucvFunction4GeneCode4Gv1.Visible = true;
                clsCodeTypeEN objCodeType = clsCodeTypeBL.GetObjByCodeTypeId(vsCodeTypeId);
                if (objCodeType != null)
                {
                    btnOKUpd2.Text = string.Format("把所选的函数添加到代码类型:[{0}]中", objCodeType.CodeTypeName);
                }
                //            btnAddNewRecord.Text = "批量添加工程表";
                btnAddNewRecord.Text = "隐藏函数列表";
                BindGv_vFunction4GeneCode();
            }
        }
    }
