<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucFuncPara4CodeB.ascx.cs" Inherits="AGC.Webform.wucFuncPara4CodeB" %>

<table id="tabwucFuncPara4Code" style="width: 600px; padding: 1px;" border="0">
    <tr>
        <td class="NameTD">
            <asp:Label ID="lblFuncParaId4Code" runat="server" CssClass="col-form-label text-right">参数Id</asp:Label>
        </td>
        <td class="ValueTD">
            <asp:TextBox ID="txtFuncParaId4Code" runat="server" Width="400px" class="form-control-sm"></asp:TextBox>
        </td>
        <td></td>
        <td></td>
    </tr>
    ...
    <tr id="trFuncId4Code" runat="server" visible="false">
        <td class="NameTD">
            <asp:Label ID="lblFuncId4Code" runat="server" CssClass="col-form-label text-right">函数Id4Code</asp:Label>
        </td>
        <td class="ValueTD">
            <asp:DropDownList ID="ddlFuncId4Code" runat="server" Width="400px" class="form-control-sm"></asp:DropDownList>
        </td>
        <td></td>
        <td></td>
    </tr>
