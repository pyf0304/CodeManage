 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:wucMethodModifier
 界面名:wfmMethodModifier_QUDI(00050264)
 生成代码版本:2019.11.16.1
 生成日期:2019/11/17 09:45:41
 生成者:
 工程名称:AGC
 工程ID:0005
...
using AGC.BusinessLogicEx;
 ...
 /// <summary>
 ///		wucMethodModifier 的摘要说明。
 /// (AutoGCLib.WebCtlControlCode4CSharp:GeneCode)
 /// </summary>
public partial class wucMethodModifier : System.Web.UI.UserControl
{
...
get
{
return txtMethodModifierId.Text.Trim();
}
set
{
txtMethodModifierId.Text = value.ToString();
}
}
...
get
{
return txtMethodModifierName.Text.Trim();
}
set
{
txtMethodModifierName.Text = value.ToString();
}
}
...
{
txtMethodModifierId.ReadOnly = bolReadonly;
}
...
public void Clear()
{
txtMethodModifierId.Text = "";
txtMethodModifierName.Text = "";
txtOrderNum.Text = "0";
txtMemo.Text = "";
}
