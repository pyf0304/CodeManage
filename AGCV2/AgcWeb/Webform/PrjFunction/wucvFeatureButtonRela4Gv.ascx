<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvFeatureButtonRela4Gv.ascx.cs" Inherits="AGC.Webform.wucvFeatureButtonRela4Gv" %>

<%-- 列表层 --%>

<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvFeatureButtonRela"  runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvFeatureButtonRela_Sorting"
        OnPageIndexChanging="gvFeatureButtonRela_PageIndexChanging"
        OnRowCreated="gvFeatureButtonRela_RowCreated"
        OnRowCommand="gvFeatureButtonRela_RowCommand"
        OnRowDeleting="gvFeatureButtonRela_RowDeleting"
        OnRowUpdating="gvFeatureButtonRela_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="全选">
                ...
                <ItemTemplate>
                    <a name="A_FeatureButtonRela<%# Eval("mId").ToString().Trim() %>"></a>
            ...
            <asp:BoundField DataField="ApplicationTypeENName" SortExpression="ApplicationTypeENName" HeaderText="应用类型英文名" Visible="false"></asp:BoundField>
            ...
            <asp:BoundField DataField="ButtonName" SortExpression="ButtonName" HeaderText="按钮名称"></asp:BoundField>
            <asp:BoundField DataField="EventFuncName" SortExpression="EventFuncName" HeaderText="事件函数名"></asp:BoundField>
