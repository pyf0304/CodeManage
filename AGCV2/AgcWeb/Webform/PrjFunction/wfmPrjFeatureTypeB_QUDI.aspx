<%@ Register TagPrefix="uc1" TagName="wucPrjFeatureTypeB" Src="./wucPrjFeatureTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmPrjFeatureTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmPrjFeatureTypeB_QUDI" %>
        ...
        <div id="tabLayout" class="tab_layout"
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFeatureTypeIdq" 
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblPrjFeatureTypeList" runat="server" 
                ...
                <asp:GridView ID="gvPrjFeatureType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvPrjFeatureType_Sorting"
                    OnPageIndexChanging="gvPrjFeatureType_PageIndexChanging"
                    OnRowCreated="gvPrjFeatureType_RowCreated"
                    OnRowCommand="gvPrjFeatureType_RowCommand"
                    OnRowDeleting="gvPrjFeatureType_RowDeleting"
                    OnRowUpdating="gvPrjFeatureType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_PrjFeatureType<%# Eval("FeatureTypeId").ToString().Trim() %>"></a>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditPrjFeatureTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditPrjFeatureType"  runat="server"
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelPrjFeatureTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelPrjFeatureTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucPrjFeatureTypeB ID="wucPrjFeatureTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
