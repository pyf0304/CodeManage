...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucButtonTab4Gv.ascx.cs" Inherits = "AGC.Webform.wucButtonTab4Gv" %>
<link rel = "stylesheet" type = "text/css" href = "../../css/tz_base1.css"/>
<%-- 列表层 --%>

<div id = "divList" class = "div_List" 
runat = "server">
<asp:GridView id = "gvButtonTab" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvButtonTab_Sorting" 
OnPageIndexChanging = "gvButtonTab_PageIndexChanging" 
OnRowCreated = "gvButtonTab_RowCreated"
OnRowCommand = "gvButtonTab_RowCommand"
OnRowDeleting = "gvButtonTab_RowDeleting" 
OnRowUpdating = "gvButtonTab_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
<ItemTemplate>
<a name = "A_ButtonTab<%# Eval("ButtonId").ToString().Trim() %>"></a>
<asp:CheckBox id = "chkCheckRec" runat = "server"></asp:CheckBox>
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField = "ButtonId" SortExpression = "ButtonId" HeaderText = "按钮Id"></asp:BoundField>
...
<asp:BoundField DataField = "Height" SortExpression = "Height" HeaderText = "高度"></asp:BoundField>
...
<asp:BoundField DataField = "ImageUrl" SortExpression = "ImageUrl" HeaderText = "图片资源"></asp:BoundField>
