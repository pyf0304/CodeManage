...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmQryRegionFlds_QUDI2 : CommWebPageBase
    {
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)	///如果本界面是初次被调用，而不是单击按钮事件所调用
			{
                ...
                if (objViewRegionEN != null)
                {
                    ...
                    chkIsDisp.Checked = objViewRegionEN.IsDispInViewId(clsCommonSession.ViewId, clsPubVar.CurrCmPrjId);
            ...
            try
            {
                ...
                wucQryRegion4Preview1.ShowControl4Regoin(seRegionId, clsPubVar.CurrSelPrjId, chkInUse.Checked, chkIsDisp.Checked);
                //	3、设置Gv控件的某些列不可见；
		...
		private void GetDataFromQryRegionFldsClass(clsQryRegionFldsEN pobjQryRegionFlds)
		{
            ...
            clsvQryRegionFldsEN objvQryRegionFlds = clsvQryRegionFldsBL.GetFirstObj_S("RegionId = '" + seRegionId + "' and FldId = '" + pobjQryRegionFlds.FldId +"'");
...
//			btnOKUpd.Text = "确认添加";
		...
		protected void btnDelete4Dg_Click(object sender, System.EventArgs e)
		{
            ...
            clsQryRegionFldsBLEx.ReOrder(seRegionId);
		...
		protected void btnCopyFldFromRelaTab_Click(object sender, System.EventArgs e)
		{
            ...
            try
            {
                clsQryRegionFldsBLEx.ImportRelaFlds(seRegionId, clsPubVar.CurrCmPrjId, UserId);
                //clsViewRegionBLEx.SetFldCount(seRegionId);
                //clsViewRegionBLEx.SetFldCountInUse(seRegionId);
        ...
        private void ShowCodeTypeButton()
        {
            ...
            //clsCodeTypeEN objCodeType = clsCodeTypeBL.GetObjByCodeTypeIdCache(enumCodeType.WebViewCode_0004);
            //HtmlInputButton objHtmlInputButton1 = new HtmlInputButton();
            //objHtmlInputButton1.ID = string.Format("btn1");

            //objHtmlInputButton1.Name = string.Format("btn{0}1", enumCodeType.WebViewCode_0004);
            //objHtmlInputButton1.Attributes["class"] = "btn btn-outline-primary btn-sm";
            //objHtmlInputButton1.Value = string.Format("{0}({1})",
            //    objCodeType.CodeTypeName, clsProgLangTypeBL.GetNameByProgLangTypeIdCache( objCodeType.ProgLangTypeId));



            //objHtmlInputButton1.Attributes.Add("onclick", string.Format("GeneCode4Func('{0}','{1}','{2}','{3}')", 
            //    objCodeType.CodeTypeId, clsCommonSession.ViewId, "0000002471", intAppTypeId));
            ...
            //pnlCodeTypeLst.Controls.Add(objHtmlInputButton1);
