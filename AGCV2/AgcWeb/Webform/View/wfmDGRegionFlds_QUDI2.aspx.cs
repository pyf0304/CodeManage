...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmDGRegionFlds_QUDI2 : CommWebPageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)	///如果本界面是初次被调用，而不是单击按钮事件所调用
            {
                ...
                clsPubVar.CurrCmPrjId = objvViewRegion.PrjId;
                //1、为下拉框设置数据源，绑定列表数据
            ...
            if (vsIsDisp == false)
            {
                try
                {
                    wucListRegion4Preview1.ShowControl4Regoin(seRegionId, clsPubVar.CurrSelPrjId, 5, chkInUse.Checked, clsPubVar.CurrCmPrjId);
                    //	3、设置Gv控件的某些列不可见；
        ...
        private string CombinevDGRegionFldsCondition()
        {
            ...
            strWhereCond += " And RegionId='" + seRegionId + "'";
        ...
        private void GetDataFromDGRegionFldsClass(clsDGRegionFldsEN pobjDGRegionFlds)
        {
            ...
            //}
            //clsvDGRegionFldsEN objvDGRegionFlds = clsvDGRegionFldsBL.GetFirstObj_S("RegionId = '" + seRegionId + "' and TabFldId = " + pobjDGRegionFlds.TabFldId);
        ...
        private void PutDataToDGRegionFldsClass(clsDGRegionFldsEN pobjDGRegionFlds)
        {
            ...
            pobjDGRegionFlds.RegionId = seRegionId;
        ...
        protected void btnDelete4Dg_Click(object sender, System.EventArgs e)
        {
            ...
            clsViewInfoBLEx.SetViewUpdDate(vsViewId, clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
            clsDGRegionFldsBLEx.ReOrder(seRegionId);
            BindGv_vDGRegionFlds();
        }
        ...
        protected void btnCopyFldFromRelaTab_Click(object sender, System.EventArgs e)
        {
            ...
            clsDGRegionFldsBLEx.ImportRelaFlds(seRegionId, clsPubVar.CurrCmPrjId, UserId);
            //clsViewRegionBLEx.SetFldCount(seRegionId);
            //clsViewRegionBLEx.SetFldCountInUse(seRegionId);
        ...
        protected void btnSetDefaSort_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                List<clsDGRegionFldsEN> arrDGRegionFlds = clsDGRegionFldsBLEx.GetObjLstByRegionId4InUseExCache1(seRegionId, clsPubVar.CurrCmPrjId);
