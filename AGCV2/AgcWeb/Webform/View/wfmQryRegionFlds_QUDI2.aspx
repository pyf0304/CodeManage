...
<%@ Page Title="表QryRegionFlds的查询、修改、删除、添加记录" Language="C#" MasterPageFile="~/Webform/MasterPage/mpViewEdit.Master" CodeBehind="wfmQryRegionFlds_QUDI2.aspx.cs" AutoEventWireup="True"
    ValidateRequest="false" Inherits="AGC.Webform.wfmQryRegionFlds_QUDI2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-body">
            <ul class="nav">
                ...
                <li class="nav-item ml-2">
                    ...
                    <li class="nav-item ml-2">
                    <asp:CheckBox ID="chkIsDisp" Text="是否显示" runat="server" AutoPostBack="True" OnCheckedChanged="chkIsDisp_CheckedChanged" />
                </li>
            </ul>
        </div>
    </div>

    <div id="tabQryRegionFldsDataGrid" class="mt-2" width="100%" runat="server">
        <ul class="nav">
            <li class="nav-item">
    ...
    <div class="row mt-2">
        ...
        <div id="tabEditQryRegionFldsRegion" class="col-4">
            <div>
                <ul class="nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item ml-3">
                        <asp:Label ID="lblMsg" CssClass="text-warning" runat="server" Width="208px"></asp:Label>
                    </li>
