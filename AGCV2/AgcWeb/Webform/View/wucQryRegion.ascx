<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="wucQryRegion.ascx.cs"
    Inherits="AGC.Webform.wucQryRegion" %>

<table id="tabwucQryRegion" cellspacing="1" cellpadding="1" width="600" border="0">
    <tr>
        <td>
