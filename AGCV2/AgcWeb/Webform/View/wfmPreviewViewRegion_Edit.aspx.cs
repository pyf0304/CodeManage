...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmPreviewViewRegion_Edit : CommWebPageBase
    {
		//生成有关的变量定义代码
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)	///如果本界面是初次被调用，而不是单击按钮事件所调用
			{
                ...
                var arrRegionId = clsViewRegionRelaBLEx.GetRegionIdLstByViewIdCache(getViewId, clsPubVar.CurrSelPrjId);
                ...
                arrViewRegion_Curr.ForEach(x =>
                {
                    switch (x.RegionTypeId)
                    {
                        case enumRegionType.QueryRegion_0001:
                            chkInUse_QueryRegion.Checked = x.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
                            if (x.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId) == false)
                            {
                        ...
                        case enumRegionType.FeatureRegion_0008:
                            chkInUse_FeatureRegion.Checked = x.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
                            //if (x.IsDisp == false) chkInUse_FeatureRegion.CssClass += " text-warning";
                            break;
                        case enumRegionType.ListRegion_0002:
                            chkInUse_ListRegion.Checked = x.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
                            //if (x.IsDisp == false) chkInUse_ListRegion.CssClass += " text-danger";
                            break;
                        case enumRegionType.EditRegion_0003:
                            chkInUse_EditRegion.Checked = x.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
                            if (x.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId) == false)
                            {
                        ...
                        case enumRegionType.DetailRegion_0006:
                            chkInUse_DetailRegion.Checked = x.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
                            //if (x.IsDisp == false) chkInUse_DetailRegion.CssClass += " text-danger";
                            break;
                        case enumRegionType.ExcelExportRegion_0007:
                            chkInUse_ExcelExportRegion.Checked = x.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
        ...
        private void ShowAllRegion()
        {
            ...
            List<clsViewRegionENEx> arrViewRegion = clsViewRegionBLEx.GetObjExLstByViewIdCache(getViewId, clsPubVar.CurrSelPrjId);
            if (arrViewRegion.Count == 0) return;
            try
            {
                ...
                {
                    bool bolIsDisp = objViewRegion_Qry.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId);
                    bool bolInUse = objViewRegion_Qry.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
            ...
            try
            {
                ...
                {
                    bool bolIsDisp = objViewRegion_Feature.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId);
                    bool bolInUse = objViewRegion_Feature.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
            ...
            try
            {
                ...
                {
                    bool bolIsDisp = objViewRegion_List.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId);
                    bool bolInUse = objViewRegion_List.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
            ...
            try
            {
                ...
                {
                    bool bolIsDisp = objViewRegion_Edit.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId);
                    bool bolInUse = objViewRegion_Edit.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
            ...
            try
            {
                ...
                {
                    bool bolIsDisp = objViewRegion_Detail.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId);
                    bool bolInUse = objViewRegion_Detail.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
            ...
            try
            {
                ...
                {
                    bool bolIsDisp = objViewRegion_ExcelExport.IsDispInViewId(getViewId, clsPubVar.CurrSelPrjId);
                    bool bolInUse = objViewRegion_ExcelExport.InUseInViewId(getViewId, clsPubVar.CurrSelPrjId);
