<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="wucViewFldInfo.ascx.cs"
    Inherits="AGC.Webform.wucViewFldInfo" %>
<table id="tabwucViewFldInfo" cellspacing="1" cellpadding="1" width="344" border="0"
    style="width: 344px; height: 279px">
    <tr>
        <td>
            <asp:Label ID="lblFldID" runat="server">字段名</asp:Label>
        </td>
        <td>
