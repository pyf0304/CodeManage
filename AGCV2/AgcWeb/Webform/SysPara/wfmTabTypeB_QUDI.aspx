<%@ Register TagPrefix="uc1" TagName="wucTabTypeB" Src="wucTabTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmTabTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmTabTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>表类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5">表类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTabTypeIdq"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblTabTypeNameq" 
                                runat="server" CssClass="text-secondary">表类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTabTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnQuery" Style="z-index: 110; width: 80px;" runat="server" Text="查询" CssClass="btn btn-outline-warning btn-sm" OnClick="btnQuery_Click"></asp:Button>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblTabTypeList" runat="server"
                                CssClass="h6" Width="250px">表类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvTabType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvTabType_Sorting"
                    OnPageIndexChanging="gvTabType_PageIndexChanging"
                    OnRowCreated="gvTabType_RowCreated"
                    OnRowCommand="gvTabType_RowCommand"
                    OnRowDeleting="gvTabType_RowDeleting"
                    OnRowUpdating="gvTabType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TabTypeId" SortExpression="TabTypeId" HeaderText="表类型Id"></asp:BoundField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lbDelete" runat="Server" CommandName="Delete" CssClass="LinkButton_Defa" Text="删除"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <PagerTemplate>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditTabTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditTabType"  runat="server"
                                    CssClass="h6">表类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelTabTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelTabTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucTabTypeB ID="wucTabTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
