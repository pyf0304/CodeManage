...
///		wucTransWayB 的摘要说明。
/// </summary>
public partial class wucTransWayB : System.Web.UI.UserControl
{
...
get
{
return txtTransWayName.Text.Trim();
}
set
{
txtTransWayName.Text = value.ToString();
}
}
...
{
txtTransWayId.ReadOnly = bolReadonly;
}
public void Clear()
{
txtTransWayId.Text = "";
txtTransWayName.Text = "";
txtMemo.Text = "";
}
/// <summary>
