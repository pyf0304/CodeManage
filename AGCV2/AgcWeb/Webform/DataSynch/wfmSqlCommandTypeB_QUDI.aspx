<%@ Register TagPrefix="uc1" TagName="wucSqlCommandTypeB" Src="wucSqlCommandTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmSqlCommandTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmSqlCommandTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Sql命令类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >Sql命令类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSqlCommandTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblSqlCommandTypeNameq" 
                                runat="server" CssClass="text-secondary">Sql命令类型名称</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSqlCommandTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblSqlCommandTypeList" runat="server" 
                                CssClass="h6" Width="250px">Sql命令类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvSqlCommandType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvSqlCommandType_Sorting"
                    OnPageIndexChanging="gvSqlCommandType_PageIndexChanging"
                    OnRowCreated="gvSqlCommandType_RowCreated"
                    OnRowCommand="gvSqlCommandType_RowCommand"
                    OnRowDeleting="gvSqlCommandType_RowDeleting"
                    OnRowUpdating="gvSqlCommandType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SqlCommandTypeId" SortExpression="SqlCommandTypeId" HeaderText="Sql命令类型Id"></asp:BoundField>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditSqlCommandTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditSqlCommandType"  runat="server"
                                    CssClass="h6">Sql命令类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelSqlCommandTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelSqlCommandTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucSqlCommandTypeB ID="wucSqlCommandTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
