...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucvDNFunction4Gv.ascx.cs" Inherits = "AGC.Webform.wucvDNFunction4Gv" %>
...
runat = "server">
<asp:GridView id = "gvvDNFunction" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvvDNFunction_Sorting" 
OnPageIndexChanging = "gvvDNFunction_PageIndexChanging" 
OnRowCreated = "gvvDNFunction_RowCreated"
OnRowCommand = "gvvDNFunction_RowCommand"
OnRowDeleting = "gvvDNFunction_RowDeleting" 
OnRowUpdating = "gvvDNFunction_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
<ItemTemplate>
<a name = "A_DNFunction<%# Eval("DnFunctionId").ToString().Trim() %>"></a>
<asp:CheckBox id = "chkCheckRec" runat = "server"></asp:CheckBox>
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField = "DnFunctionId" SortExpression = "DnFunctionId" HeaderText = "DN函数Id"></asp:BoundField>
<asp:BoundField DataField = "DnFunctionName" SortExpression = "DnFunctionName" HeaderText = "DN函数"></asp:BoundField>
