<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucvwf_StepProcessRela4Gv.ascx.cs" Inherits="AGC.Webform.wucvwf_StepProcessRela4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvwf_StepProcessRela" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvwf_StepProcessRela_Sorting"
        OnPageIndexChanging="gvwf_StepProcessRela_PageIndexChanging"
        OnRowCreated="gvwf_StepProcessRela_RowCreated"
        OnRowCommand="gvwf_StepProcessRela_RowCommand"
        OnRowDeleting="gvwf_StepProcessRela_RowDeleting"
        OnRowUpdating="gvwf_StepProcessRela_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        Height="1px"
        DataKeyNames="WorkFlowStepProcessRelaId"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_wf_StepProcessRela<%# Eval("WorkFlowStepProcessRelaId").ToString().Trim() %>"></a>
            ...
            <asp:BoundField DataField="StartPoint" SortExpression="StartPoint" HeaderText="起点"></asp:BoundField>
            <asp:BoundField DataField="EndPoint" SortExpression="EndPoint" HeaderText="终点"></asp:BoundField>
            <asp:BoundField DataField="ProcessName" SortExpression="ProcessName" HeaderText="过程名称"></asp:BoundField>
            <asp:BoundField DataField="StartPointName" SortExpression="StartPointName" HeaderText="起点名"></asp:BoundField>
            <asp:BoundField DataField="EndPointName" SortExpression="EndPointName" HeaderText="终点名"></asp:BoundField>
