<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucFieldType4Gv.ascx.cs" Inherits="AGC.Webform.wucFieldType4Gv" %>
<%-- 列表层 --%>

<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvFieldType" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvFieldType_Sorting"
        OnPageIndexChanging="gvFieldType_PageIndexChanging"
        OnRowCreated="gvFieldType_RowCreated"
        OnRowCommand="gvFieldType_RowCommand"
        OnRowDeleting="gvFieldType_RowDeleting"
        OnRowUpdating="gvFieldType_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_FieldType<%# Eval("FieldTypeId").ToString().Trim() %>"></a>
            ...
            <asp:BoundField DataField="FieldTypeENName" SortExpression="FieldTypeENName" HeaderText="字段类型英文名"></asp:BoundField>
