...
namespace AGC.Webform
{
    ...
    ///		wucPrjTab 的摘要说明。
    /// </summary>
    public partial class wucPrjTab : System.Web.UI.UserControl
    {
        ...
        public string CacheClassifyField2
        {
            get
            {
                if (ddlCacheClassifyField2.SelectedValue == "0")
                {
                    return "";
                }
                return ddlCacheClassifyField2.SelectedValue;
            }
            set
            {
                if (value == "")
                {
                    ddlCacheClassifyField2.SelectedValue = "0";
                }
                else
                {
                    try
                    {
                        ddlCacheClassifyField2.SelectedValue = value;
                    }
                    catch (Exception objException)
                    {
                        string ss = objException.Message;
                    }
                    //if (ddlCacheClassifyField2.SelectedIndex > 0)
                    //{
                    //    string strFuncModuleId = ddlCacheClassifyField2.SelectedValue;
                    //    clsvPrjObjects4DdlBLEx.BindDdl_ObjId(ddlObjId, clsPubVar.CurrSelPrjId, strFuncModuleId);
                    //}
                }
            }
        ...
        public string CacheClassifyFieldTS
        {
            get
            {
                if (ddlCacheClassifyFieldTS.SelectedValue == "0")
                {
                    return "";
                }
                return ddlCacheClassifyFieldTS.SelectedValue;
            }
            set
            {
                if (value == "")
                {
                    ddlCacheClassifyFieldTS.SelectedValue = "0";
                }
                else
                {
                    try
                    {
                        ddlCacheClassifyFieldTS.SelectedValue = value;
                    }
                    catch (Exception objException)
                    {
                        string ss = objException.Message;
        ...
        public string CacheClassifyField2TS
        {
            get
            {
                if (ddlCacheClassifyField2TS.SelectedValue == "0")
                {
                    return "";
                }
                return ddlCacheClassifyField2TS.SelectedValue;
            }
            set
            {
                if (value == "")
                {
                    ddlCacheClassifyField2TS.SelectedValue = "0";
                }
                else
                {
                    try
                    {
                        ddlCacheClassifyField2TS.SelectedValue = value;
                    }
                    catch (Exception objException)
                    {
                        string ss = objException.Message;
        ...
        public string CacheModeId
        {
            get
            {
                if (ddlCacheModeId.SelectedValue == "0")
                    return "";
                return ddlCacheModeId.SelectedValue;
            }
            set
            {
                if (value == "")
                {
                    ddlCacheModeId.SelectedValue = "0";
                }
                else
                {
                    ddlCacheModeId.SelectedValue = value;
                }
            }
        }
        ...
        public string RelaTabId4View
        {
            get
            {
                if (ddlRelaTabId4View.SelectedValue == "0") return "";
        ...
        public void SetDdl_CacheModeIdCache()
        {
            clsCacheModeBL.BindDdl_CacheModeIdCache(ddlCacheModeId);
        }
        ...
        public void SetDdl_CacheClassifyField2(string strTabId)
        {
            clsvPrjTabFldBLEx.BindDdl_FldIDByTabId(ddlCacheClassifyField2, strTabId);
        }

        public void SetDdl_CacheClassifyFieldTS(string strTabId)
        {
            clsvPrjTabFldBLEx.BindDdl_FldIDByTabId(ddlCacheClassifyFieldTS, strTabId);
        }

        public void SetDdl_CacheClassifyField2TS(string strTabId)
        {
            clsvPrjTabFldBLEx.BindDdl_FldIDByTabId(ddlCacheClassifyField2TS, strTabId);
        }
