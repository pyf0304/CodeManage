<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="wucPrjTab.ascx.cs" Inherits="AGC.Webform.wucPrjTab" %>
<style type="text/css">
    .myNameTD {
        text-align: right;
    }
...
<table id="tabwucPrjTab" border="0">
    ...
    <tr>
        ...
        <td class="myNameTD">
            ...
            <asp:Label ID="Label9" runat="server">表主类型</asp:Label></td>
        <td class="myValueTD">
            <asp:DropDownList ID="ddlTabMainTypeId" runat="server" Width="300px" CssClass="nice">
            </asp:DropDownList></td>
    ...
    <tr>
        ...
        <td class="myNameTD">
            ...
            <asp:Label ID="Label11" runat="server">缓存分类字段2</asp:Label></td>
        <td class="myValueTD">
            <asp:DropDownList ID="ddlCacheClassifyField2" runat="server" Width="300px"
                CssClass="nice">
            </asp:DropDownList></td>

    </tr>
    <tr>
        <td class="myNameTD" colspan="2">

            <asp:Label ID="Label14" runat="server">基于Ts，Js的前端缓存设置</asp:Label></td>

    </tr>
    <tr>
        <td class="myNameTD">

            <asp:Label ID="Label10" runat="server">前台缓存模式</asp:Label></td>
        <td class="myValueTD">
            <asp:DropDownList ID="ddlCacheModeId" runat="server" Width="300px"
                CssClass="nice">
            </asp:DropDownList></td>
     ...
     <tr>
        <td class="myNameTD">
            ...
            <asp:Label ID="Label12" runat="server">缓存分类1TS</asp:Label></td>
        <td class="myValueTD">
            <asp:DropDownList ID="ddlCacheClassifyFieldTS" runat="server" Width="300px"
                CssClass="nice">
            </asp:DropDownList></td>
        ...
        <td class="myNameTD">
            ...
            <asp:Label ID="Label13" runat="server">缓存分类2TS</asp:Label></td>
        <td class="myValueTD">
            <asp:DropDownList ID="ddlCacheClassifyField2TS" runat="server" Width="300px"
                CssClass="nice">
            </asp:DropDownList></td>
