...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucvTabFunctionProp4Gv.ascx.cs" Inherits = "AGC.Webform.wucvTabFunctionProp4Gv" %>
<%-- 列表层 --%>

<div id = "divList" class = "div_List" 
runat = "server">
<asp:GridView id = "gvTabFunctionProp" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvTabFunctionProp_Sorting" 
OnPageIndexChanging = "gvTabFunctionProp_PageIndexChanging" 
OnRowCreated = "gvTabFunctionProp_RowCreated"
OnRowCommand = "gvTabFunctionProp_RowCommand"
OnRowDeleting = "gvTabFunctionProp_RowDeleting" 
OnRowUpdating = "gvTabFunctionProp_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
<ItemTemplate>
<a name = "A_TabFunctionProp<%# Eval("mId").ToString().Trim() %>"></a>
...
<asp:BoundField DataField = "FunctionTemplateName" SortExpression = "FunctionTemplateName" HeaderText = "函数模板名"></asp:BoundField>
...
<asp:BoundField DataField = "FuncCHName4Code" SortExpression = "FuncCHName4Code" HeaderText = "函数中文名4Code"></asp:BoundField>
...
<asp:BoundField DataField = "IsForAllTemplate" SortExpression = "IsForAllTemplate" HeaderText = "是否针对所有模板"></asp:BoundField>
...
<asp:BoundField DataField = "Order4Func" SortExpression = "Order4Func" HeaderText = "Order4函数"></asp:BoundField>
