            ...
            <td colspan="2">
                <div style="position: relative; width: 844px; height: 25px; left: 0px; top: 0px;">
                    ...
                    <asp:LinkButton ID="lbReturn" runat="server" OnClick="lbReturn_Click"
                        ...
                        Width="32px" Visible="False">返回</asp:LinkButton>
                </div>
            </td>
        </tr>
        <tr>
                        ...
                        <td style="width: 548px">
                            <div style="width: 484px; position: relative; left: 0px; top: 0px;" 
                                ...
                                <table style="width: 482px">
                                    <tr>
                                        <td colspan="2">
                                            <asp:Label ID="lblPrjTabFldList" runat="server" CssClass="h6">代码系统中表字段列表</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnSetFldProperty" runat="server" OnClick="btnSetFldProperty_Click"
                                                Text="设置字段属性" Width="100px" />
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnAddNewField" runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm"
                                                Text="添加新字段" OnClick="btnAddNewField_Click"></asp:Button>
                                        </td>
                                        <td style="width: 340px">
                                            <asp:Label ID="Label3" runat="server" CssClass="MemoStyle1" Width="328px">把所选SQL数据字段添加到生成代码系统中。</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td style="width: 340px">
                                            <asp:Label ID="Label7" runat="server" CssClass="MemoStyle1" Width="329px">同步字段：把所选SQL数据表字段同步到系统表字段中。</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td style="width: 340px">
                                            <asp:Label ID="Label8" runat="server" CssClass="MemoStyle1" Width="327px">删除：把所选代码系统中字段删除。</asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <td style="width: 548px">
                            <asp:GridView ID="gvPrjTabFld_Agc" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SequenceNumber" SortExpression="SequenceNumber" HeaderText="顺序号"
                                        Visible="False"></asp:BoundField>
                                    <asp:BoundField DataField="TabName" SortExpression="TabName" HeaderText="表名" Visible="False">
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="DataTypeName" SortExpression="DataTypeName" HeaderText="类型">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="FldLength" SortExpression="FldLength" HeaderText="长度">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="IsTabNullable" SortExpression="IsTabNullable" HeaderText="可空">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Caption" SortExpression="Caption" HeaderText="标题"></asp:BoundField>
                                    
                                    <asp:BoundField DataField="FldId" SortExpression="FldId" HeaderText="字段ID" Visible="False">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DefaultValue" SortExpression="DefaultValue" HeaderText="缺省值"
                                        Visible="False"></asp:BoundField>
                        ...
                        <td style="width: 423px" valign="top">
                            <div style="width: 451px; position: relative; left: 0px; top: 0px;" id="divSQL" runat="server">
                                <table style="width: 432px">
                                    <tr>
                                        <td colspan="3">
                                            <asp:Label ID="Label2" runat="server" CssClass="h6">SQL数据库表字段列表</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 70px">
                                            <asp:Button ID="btnReCheckConSistency" runat="server" CssClass="btn btn-outline-info btn-sm" Text="重新检查一致性"
                                    ...
                                    <tr>
                                        <td style="width: 70px">
                                            <asp:Button ID="btnAddFieldToSqlTable" runat="server" CssClass="btn btn-outline-info btn-sm" OnClick="btnAddFieldToSqlTable_Click"
                                                Text="添加新字段" Width="100px" />
                                        </td>
                                        <td style="width: 5px">
                                            <asp:Label ID="Label4" runat="server" CssClass="MemoStyle1" Width="293px">把系统中字段添加到SQL数据表中。</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 70px">
                                        ...
                                        <td style="width: 5px">
                                            <asp:Label ID="Label6" runat="server" CssClass="MemoStyle1" Width="293px">把系统中字段属性同步到SQL数据表中。</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 70px">
                                        ...
                                        <td style="width: 5px">
                                            <asp:Label ID="Label9" runat="server" CssClass="MemoStyle1" Width="327px">删除：把所选Sql字段删除。</asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
