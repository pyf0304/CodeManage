...
namespace AGC.Webform
{
    ...
    /// </summary>
    public partial class wfmPrjTab_Copy2 : CommWebPageBase
    {               
        ...
        private string CombinePrjTabCondition()
        {
            ...
            //{
            //    strWhereCond += " And vPrjTab.ObjId='" + this.ddlObjIdq.SelectedValue + "'";
            //}
        ...
        protected void ddlPrjId_q_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if (ddlPrjIdq.SelectedIndex > 0)
            {
                ...
                //clsvPrjTab4DdlBLEx.BindDdl_TabId(ddlTabIdq, strPrjId);
            }
        }
        ///生成绑定GridView的代码
        /// <summary>
