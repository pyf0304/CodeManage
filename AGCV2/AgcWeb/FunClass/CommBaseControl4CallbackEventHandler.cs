...
public abstract class CommBaseControl4CallbackEventHandler : System.Web.UI.UserControl, ICallbackEventHandler
{
    ...
    {
        string CallServer = @"function CallServer(arg, context){context.innerHTML = 'Loading';" + this.Page.ClientScript.GetCallbackEventReference(this, "arg", "ReceiveServerData", "context") + "}";
      this.Page.  ClientScript.RegisterClientScriptBlock(this.GetType(), "CallServer", CallServer, true);
    }
    #endregion
