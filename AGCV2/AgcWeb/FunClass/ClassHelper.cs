...

{
...

    {
        ...
        public static object CreateInstance(string ClsName, List<CustPropertyInfo> lcpi)

        {

            Type t = BuildType(ClsName);
        ...
        public static Type BuildType(string ClsName)

        {
            ...
            TypeBuilder myTypeBuilder = myModBuilder.DefineType(ClsName,
