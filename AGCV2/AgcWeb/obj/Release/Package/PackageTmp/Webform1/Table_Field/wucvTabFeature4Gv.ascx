...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucvTabFeature4Gv.ascx.cs" Inherits = "AGC.Webform.wucvTabFeature4Gv" %>
<link rel = "stylesheet" type = "text/css" href = "../../css/tz_base1.css"/>
<%-- 列表层 --%>

<div id = "divList" class = "div_List" 
runat = "server">
<asp:GridView id = "gvTabFeature" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvTabFeature_Sorting" 
OnPageIndexChanging = "gvTabFeature_PageIndexChanging" 
OnRowCreated = "gvTabFeature_RowCreated"
OnRowCommand = "gvTabFeature_RowCommand"
OnRowDeleting = "gvTabFeature_RowDeleting" 
OnRowUpdating = "gvTabFeature_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
Height = "1px" 
DataKeyNames = "TabFeatureId" 
CssClass = "GridValue" OnRowDataBound="gvTabFeature_RowDataBound">
<Columns>
...
<ItemTemplate>
<a name = "A_TabFeature<%# Eval("TabFeatureId").ToString().Trim() %>"></a>
<asp:CheckBox id = "chkCheckRec" runat = "server"></asp:CheckBox>
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField = "TabFeatureId" SortExpression = "TabFeatureId" HeaderText = "表功能Id"></asp:BoundField>
<asp:BoundField DataField = "TabFeatureName" SortExpression = "TabFeatureName" HeaderText = "表功能名"></asp:BoundField>
<asp:BoundField DataField = "TabName" SortExpression = "TabName" HeaderText = "表名"></asp:BoundField>
<asp:BoundField DataField = "FeatureName" SortExpression = "FeatureName" HeaderText = "功能名"></asp:BoundField>
    <asp:BoundField DataField = "ParentFeatureName" SortExpression = "ParentFeatureName" HeaderText = "父功能"></asp:BoundField>
