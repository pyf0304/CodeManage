<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvViewRegion4Gv.ascx.cs" Inherits="AGC.Webform.wucvViewRegion4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvvViewRegion" Style="z-index: 1000;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="15" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvvViewRegion_Sorting"
        OnPageIndexChanging="gvvViewRegion_PageIndexChanging"
        OnRowCreated="gvvViewRegion_RowCreated"
        OnRowCommand="gvvViewRegion_RowCommand"
        OnRowDeleting="gvvViewRegion_RowDeleting"
        OnRowUpdating="gvvViewRegion_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_vViewRegion<%# Eval("RegionId").ToString().Trim() %>"></a>
            ...
            <asp:BoundField DataField="RegionTypeSimName" SortExpression="RegionTypeSimName" HeaderText="区域类型"></asp:BoundField>
            <asp:BoundField DataField="FldCount" SortExpression="FldCount" HeaderText="字段数"></asp:BoundField>
            <asp:BoundField DataField="FldCountInUse" SortExpression="FldCountInUse" HeaderText="可用字段数"></asp:BoundField>
            ...
            <asp:BoundField DataField="ColNum" SortExpression="ColNum" HeaderText="列数"></asp:BoundField>
            <asp:BoundField DataField="ContainerTypeName" SortExpression="ContainerTypeName" HeaderText="容器类型"></asp:BoundField>
            <asp:BoundField DataField="PageDispModeName" SortExpression="PageDispModeName" HeaderText="显示模式"></asp:BoundField>
            <asp:BoundField DataField="InOutTypeName" SortExpression="InOutTypeName" HeaderText="InOut类型"></asp:BoundField>
            <asp:BoundField DataField="TabName" SortExpression="TabName" HeaderText="数据表"></asp:BoundField>
