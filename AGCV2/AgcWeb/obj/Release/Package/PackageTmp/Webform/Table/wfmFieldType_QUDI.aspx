<%@ Register TagPrefix="uc1" TagName="wucFieldType" Src="wucFieldType.ascx" %>
<%@ Register TagPrefix="uc2" TagName="wucFieldType4Gv" Src="wucFieldType4Gv.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmFieldType_QUDI.aspx.cs" Inherits="AGC.Webform.wfmFieldType_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>字段类型表维护的维护</title>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="col-form-label text-info">字段类型表维护
                </asp:Label>
            ...
            <div id="divQuery" style="margin: 10px;">
                <table id="tabQuery" style="width: 70%;" class="table table-bordered table-hover table td table-sm">
                    <tr>
                        <td>
                            <asp:Label ID="lblFieldTypeIdq" Style="width: 80px;" CssClass="col-form-label text-right" Width="90px" Text="字段类型Id" runat="server" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtFieldTypeIdq" CssClass="form-control" Width="200px" runat="server" />
                        </td>
                        <td>
                            <asp:Label ID="lblFieldTypeNameq" Style="width: 80px;" CssClass="col-form-label text-right" Width="90px" Text="字段类型名" runat="server" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtFieldTypeNameq" CssClass="form-control" Width="200px" runat="server" />
                        </td>
                        <td>
                            <asp:Label ID="lblFieldTypeENNameq" Style="width: 80px;" CssClass="col-form-label text-right" Width="90px" Text="字段类型英文名" runat="server" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtFieldTypeENNameq" CssClass="form-control" Width="200px" runat="server" />
                        </td>
                        <td>
            ...
            <div id="divFunction" class="table table-bordered table-hover">
                <ul class="nav">
                    <li class="nav-item">
                        <asp:Label ID="lblFieldTypeList" CssClass="col-form-label text-info" Width="250px" Text="字段类型表列表" runat="server" />
                    </li>
            ...
            <div id="divList" class="div_List mt-2" runat="server">
                <uc2:wucFieldType4Gv runat="server" ID="wucFieldType4Gv1"
                    OnGvUpdateClick="wucFieldType4Gv1_GvUpdateClick"
                    OnGvDeleteClick="wucFieldType4Gv1_GvDeleteClick" />
            </div>
            <%-- 编辑层 --%>
            <div id="tabEditFieldTypeRegion" class="tab_Edit mt-2"
                runat="server">
                <div style="width: 60%;">
                    <ul class="nav">
                        <li class="nav-item">
                            <asp:Label ID="lblEditFieldType" Style="z-index: 104;" Width="200px" runat="server"
                                CssClass="col-form-label text-info">字段类型表编辑区域</asp:Label>
                        </li>
                        <li class="nav-item ml-3">
                        ...
                        <li class="nav-item ml-3">
                            <asp:Button ID="btnCancelFieldTypeEdit"
                                runat="server" CssClass="btn btn-outline-info" Text="取消编辑" OnClick="btnCancelFieldTypeEdit_Click"></asp:Button>
                        </li>
                        <li class="nav-item ml-3">
                ...
                <div>
                    <uc1:wucFieldType ID="wucFieldType1" runat="server" />
                </div>
            </div>
        </div>
    </form>
