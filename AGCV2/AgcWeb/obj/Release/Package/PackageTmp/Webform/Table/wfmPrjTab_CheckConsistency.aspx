<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmPrjTab_CheckConsistency.aspx.cs"
    Inherits="AGC.Webform.wfmPrjTab_CheckConsistency" %>
                    ...
                    <div id="divPrjTabFldOp" class="tz-layout-menu" runat="server" style="width: 100%; height: 40px">
                        ...
                        <ul class="menu-bar">
                            <li class="menu-bar-nav">
                                <asp:Label ID="Label1" CssClass="btn btn-outline-info btn-sm" runat="server" Font-Bold="True"  Text="表名:"></asp:Label>

                            </li>
                            <li class="menu-bar-nav">
                                <asp:Label ID="lblTabName" CssClass="btn btn-outline-info btn-sm" runat="server" Font-Bold="False"  Text="表名"></asp:Label>
                            ...
                            <li class="menu-bar-nav">
                                ...
                                <ul class="menu-dropdown-menu">
                                    <li class="menu-bar-nav">
                                        <asp:LinkButton ID="btnCheckSqlView" runat="server" Text="视图详细信息" Width="100px" OnClick="btnCheckSqlView_Click" />
                                    </li>
                                    <li class="menu-bar-nav">
                                        <asp:LinkButton ID="btnCreateView4Sql"  runat="server"
                                            Width="105px" Text="建立视图4Sql" OnClick="btnCreateView4Sql_Click"></asp:LinkButton>
                                    </li>
                                    <li class="menu-bar-nav">
                                        <asp:LinkButton ID="btnImportSqlViewFromSqlServer"  runat="server"
                                            Width="100px"  Text="导入SQL视图" OnClick="btnImportSqlViewFromSqlServer_Click"></asp:LinkButton>
                                    </li>
                                    <li class="menu-bar-nav">
                                        <asp:LinkButton ID="btnAnalysis"  runat="server"
                                            Width="75px"  Text="分析字段" OnClick="btnAnalysis_Click"></asp:LinkButton>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-bar-nav">
                                <asp:Button ID="lbReturn" CssClass="btn btn-outline-info btn-sm" runat="server" OnClick="lbReturn_Click"
                                    Style="z-index: 106; left: 767px;" Width="135px" Text="返回[表字段列表]"></asp:Button>
                            </li>
                            <li class="menu-bar-nav">
                                <asp:Button ID="lbReturnPrjTabList" CssClass="btn btn-outline-info btn-sm" runat="server" OnClick="lbReturnPrjTabList_Click"
                                     Width="132px" Text="返回[工程表列表]"></asp:Button>
            ...
            <tr>
                            ...
                            <tr>
                                <td class="style1">
                                    <asp:Button ID="btnSetFldProperty" runat="server" OnClick="btnSetFldProperty_Click"
                                        Text="设置字段属性"  Width="100px" CssClass="btn btn-outline-info btn-sm" /></td>
                            ...
                            <tr>
                                <td class="style1">
                                    <asp:Button ID="btnDelRec" runat="server" OnClick="btnDelRec_Click" Text="删除表字段"
                                        Width="100px" CssClass="btn btn-outline-info btn-sm" /></td>
                                <td style="width: 340px">
                ...
                <td style="width: 50%">
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="width: 70px">
                                <asp:Button ID="btnAddFieldToSqlTable" runat="server" CssClass="btn btn-outline-info btn-sm"
