<%@ Register TagPrefix="uc1" TagName="wucApplicationTypeB" Src="wucApplicationTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmApplicationTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmApplicationTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>应用程序类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >应用程序类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtApplicationTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblApplicationTypeNameq" 
                                runat="server" CssClass="text-secondary">应用程序类型名称</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtApplicationTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                          <td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblApplicationTypeList" runat="server" 
                                CssClass="h6" Width="250px">应用程序类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvApplicationType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvApplicationType_Sorting"
                    OnPageIndexChanging="gvApplicationType_PageIndexChanging"
                    OnRowCreated="gvApplicationType_RowCreated"
                    OnRowCommand="gvApplicationType_RowCommand"
                    OnRowDeleting="gvApplicationType_RowDeleting"
                    OnRowUpdating="gvApplicationType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    Height="1px"
                    DataKeyNames="ApplicationTypeId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ApplicationTypeENName" SortExpression="ApplicationTypeName" HeaderText="应用程序类型英文名"></asp:BoundField>
                        <asp:BoundField DataField="ProgLangTypeName" SortExpression="ProgLangTypeName" HeaderText="语言"></asp:BoundField>
                        <asp:BoundField DataField="ProgLangTypeName2" SortExpression="ProgLangTypeName2" HeaderText="语言2"></asp:BoundField>
                        <asp:BoundField DataField="ProgLangTypeName3" SortExpression="ProgLangTypeName3" HeaderText="语言3"></asp:BoundField>
                         <asp:BoundField DataField="ProgLangTypeName4" SortExpression="ProgLangTypeName4" HeaderText="语言4"></asp:BoundField>
                         <asp:BoundField DataField="ProgLangTypeName5" SortExpression="ProgLangTypeName5" HeaderText="语言5"></asp:BoundField>
                 <asp:BoundField DataField = "CodeTypeCount" SortExpression = "CodeTypeCount" HeaderText = "代码类型数"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditApplicationTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditApplicationType"  runat="server"
                                    CssClass="h6">应用程序类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelApplicationTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelApplicationTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucApplicationTypeB id="wucApplicationTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
