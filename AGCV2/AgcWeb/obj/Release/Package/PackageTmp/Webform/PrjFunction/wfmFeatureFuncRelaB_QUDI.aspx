...
<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmFeatureFuncRelaB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmFeatureFuncRelaB_QUDI" %>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div id="divList" class="div_List mt-2"
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item ml-3">
                            <div class="btn-group col-2" role="group" aria-label="Basic example">
                                ...
                                <asp:Button ID="btnBatchAddFunc" OnClick="btnBatchAddFunc_Click" runat="server"
                                    Width="99px" CssClass="btn btn-outline-info btn-sm ml-1" Text="批量添加函数"></asp:Button>
                ...
                <div style="width: 100%;" id="divTree">
