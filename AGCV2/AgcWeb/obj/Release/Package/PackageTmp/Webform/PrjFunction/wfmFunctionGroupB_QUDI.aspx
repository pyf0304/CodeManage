<%@ Register TagPrefix="uc1" TagName="wucFunctionGroupB" Src="wucFunctionGroupB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmFunctionGroupB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmFunctionGroupB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>函数组维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >函数组维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblFunctionGroupIdq" 
                                runat="server" CssClass="text-secondary">函数组Id</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFunctionGroupIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblFunctionGroupNameq" 
                                runat="server" CssClass="text-secondary">函数组名称</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFunctionGroupNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblFunctionGroupList" runat="server" 
                                CssClass="h6" Width="250px">功能函数组列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvFunctionGroup" Style="z-index: 129;" runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvFunctionGroup_Sorting"
                    OnPageIndexChanging="gvFunctionGroup_PageIndexChanging"
                    OnRowCreated="gvFunctionGroup_RowCreated"
                    OnRowCommand="gvFunctionGroup_RowCommand"
                    OnRowDeleting="gvFunctionGroup_RowDeleting"
                    OnRowUpdating="gvFunctionGroup_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_FunctionGroup<%# Eval("FunctionGroupId").ToString().Trim() %>"></a>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditFunctionGroupRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditFunctionGroup"  runat="server"
                                    CssClass="h6">功能函数组编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelFunctionGroupEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelFunctionGroupEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucFunctionGroupB ID="wucFunctionGroupB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
