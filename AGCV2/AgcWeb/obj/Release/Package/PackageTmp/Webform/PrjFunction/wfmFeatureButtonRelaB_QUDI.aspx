...
<%@ Page Language="c#" AutoEventWireup="true" CodeBehind="wfmFeatureButtonRelaB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmFeatureButtonRelaB_QUDI" %>
            ...
            <div id="divFunction" class="div_Funttion" runat="server">
                <ul class="nav">
                    ...
                    <li class="nav-item ml-3">
                          ...
                          <asp:DropDownList ID="ddlEventFuncMode"
                                runat="server" CssClass="TextBox_Defa">
                              <asp:ListItem Value="01">独立函数</asp:ListItem>
                              <asp:ListItem Value="02">通用函数式</asp:ListItem>
                            </asp:DropDownList>
                        <asp:Button ID="btnSetEventFuncName" CssClass="btn btn-outline-info btn-sm text-nowrap" OnClick="btnSetEventFuncName_Click" Text="设置事件函数名" runat="server" />
                            </div>
                    </li>
                    <li class="nav-item ml-3">
