<%@ Register TagPrefix="uc1" TagName="wucPrjFunctionB" Src="wucPrjFunctionB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmPrjFunctionB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmPrjFunctionB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>工程函数维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >工程函数维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblFuncIdq" 
                                runat="server" CssClass="NameLabel">函数ID</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFuncIdq" 
                        ...
                        <td>
                            <asp:Label ID="lblFuncNameq" 
                                runat="server" CssClass="NameLabel">函数名</asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lblReturnTypeIDq" 
                                runat="server" CssClass="NameLabel">返回类型ID</asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblFuncTypeIDq" 
                                runat="server" CssClass="NameLabel">函数类型ID</asp:Label>
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblPrjFunctionList" runat="server" 
                                CssClass="h6" Width="250px">工程函数列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvPrjFunction" Style="z-index: 117;" runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvPrjFunction_Sorting"
                    OnPageIndexChanging="gvPrjFunction_PageIndexChanging"
                    OnRowCreated="gvPrjFunction_RowCreated"
                    OnRowCommand="gvPrjFunction_RowCommand"
                    OnRowDeleting="gvPrjFunction_RowDeleting"
                    OnRowUpdating="gvPrjFunction_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_PrjFunction<%# Eval("FuncId").ToString().Trim() %>"></a>
                                <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="FuncId" SortExpression="FuncId" HeaderText="函数ID"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="ReturnTypeID" SortExpression="ReturnTypeID" HeaderText="返回类型ID"></asp:BoundField>
                        <asp:BoundField DataField="DataTypeName" SortExpression="DataTypeName" HeaderText="数据类型名称"></asp:BoundField>
                        <asp:BoundField DataField="DataCnName" SortExpression="DataCnName" HeaderText="数据类型中文名称"></asp:BoundField>
                        <asp:BoundField DataField="CsType" SortExpression="CsType" HeaderText="CS类型"></asp:BoundField>
                        <asp:BoundField DataField="FuncTypeId" SortExpression="FuncTypeId" HeaderText="函数类型ID"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="FuncCode" SortExpression="FuncCode" HeaderText="函数代码"></asp:BoundField>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditPrjFunctionRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditPrjFunction"  runat="server"
                                    CssClass="h6">工程函数编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelPrjFunctionEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelPrjFunctionEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucPrjFunctionB ID="wucPrjFunctionB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
