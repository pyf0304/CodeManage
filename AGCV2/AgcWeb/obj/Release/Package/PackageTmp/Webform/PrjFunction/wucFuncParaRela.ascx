<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucFuncParaRela.ascx.cs" Inherits="AGC.Webform.wucFuncParaRelaB" %>

<table id="tabwucFuncParaRela" style="width: 600px; padding: 1px;" border="0">
    <tr>
        <td class="NameTD">
