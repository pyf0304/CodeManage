<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucwf_StepPointRela.ascx.cs" Inherits="AGC.Webform.wucwf_StepPointRela" %>
<link href="../../Content/bootstrap.min.css" rel="stylesheet" />
<link href="../../Content/bootstrap-grid.css.map" rel="stylesheet" />
<table id="tabwucwf_StepPointRela" style="width: 600px; padding: 1px; border: 0px" class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td class="ValueTD">
            <asp:DropDownList ID="ddlPointId" name="ddlPointId" CssClass="form-control" Width="200px" runat="server" />
        </td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        <td class="NameTD">
            <asp:Label ID="lblPointTypeId" name="lblPointTypeId" CssClass="col-form-label text-right" Width="90px" Text="工作流结点类型Id" runat="server" />
        </td>
        <td class="ValueTD">
            <asp:DropDownList ID="ddlPointTypeId" name="ddlPointTypeId" CssClass="form-control" Width="200px" runat="server" />
        </td>
        <td></td>
        <td></td>
    </tr>
