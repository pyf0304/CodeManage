<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucvwf_Process4Gv.ascx.cs" Inherits="AGC.Webform.wucvwf_Process4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvwf_Process" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvwf_Process_Sorting"
        OnPageIndexChanging="gvwf_Process_PageIndexChanging"
        OnRowCreated="gvwf_Process_RowCreated"
        OnRowCommand="gvwf_Process_RowCommand"
        OnRowDeleting="gvwf_Process_RowDeleting"
        OnRowUpdating="gvwf_Process_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_wf_Process<%# Eval("ProcessId").ToString().Trim() %>"></a>
                    <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="OrderNum" SortExpression="OrderNum" HeaderText="序号"></asp:BoundField>
            <asp:BoundField DataField="ProcessId" SortExpression="ProcessId" HeaderText="过程ID"></asp:BoundField>
