<%@ Page Title="表ViewInfo的查询、修改、删除、添加记录" Language="C#" MasterPageFile="~/Webform/MasterPage/ViewInfoEdit.Master" CodeBehind="wfmGenViewCode_Edit.aspx.cs" AutoEventWireup="True"
    ValidateRequest="false" Inherits="AGC.Webform.wfmGenViewCode_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
      ...
      <script type="text/javascript">
        function GeneCode(strCodeTypeId, strViewId, intApplicationTypeId) {
