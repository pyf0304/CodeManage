<%@ Register TagPrefix="uc1" TagName="wucViewImplementationB" Src="wucViewImplementationB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmViewImplementationB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmViewImplementationB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>界面实现方式维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >界面实现方式维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblViewImplNameq" 
                                runat="server" CssClass="text-secondary">界面实现名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtViewImplNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblViewImplENNameq" 
                                runat="server" CssClass="text-secondary">界面实现英文名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtViewImplENNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblViewImplementationList" runat="server" 
                                CssClass="h6" Width="250px">界面实现方式列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvViewImplementation"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvViewImplementation_Sorting"
                    OnPageIndexChanging="gvViewImplementation_PageIndexChanging"
                    OnRowCreated="gvViewImplementation_RowCreated"
                    OnRowCommand="gvViewImplementation_RowCommand"
                    OnRowDeleting="gvViewImplementation_RowDeleting"
                    OnRowUpdating="gvViewImplementation_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_ViewImplementation<%# Eval("ViewImplId").ToString().Trim() %>"></a>
                                <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="ViewImplId" SortExpression="ViewImplId" HeaderText="界面实现Id"></asp:BoundField>
                        <asp:BoundField DataField="ViewImplName" SortExpression="ViewImplName" HeaderText="界面实现名"></asp:BoundField>
                        <asp:BoundField DataField="ViewImplENName" SortExpression="ViewImplENName" HeaderText="界面实现英文名"></asp:BoundField>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditViewImplementationRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditViewImplementation"  runat="server"
                                    CssClass="h6">界面实现方式编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelViewImplementationEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelViewImplementationEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucViewImplementationB ID="wucViewImplementationB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
