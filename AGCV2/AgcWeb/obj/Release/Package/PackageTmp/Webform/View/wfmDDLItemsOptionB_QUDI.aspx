<%@ Register TagPrefix="uc1" TagName="wucDDLItemsOptionB" Src="wucDDLItemsOptionB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmDDLItemsOptionB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmDDLItemsOptionB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>下拉框列表选项维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >下拉框列表选项维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblDdlItemsOptionIdq" 
                                runat="server" CssClass="text-secondary">下拉框列表选项ID</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDdlItemsOptionIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblDdlItemsOptionNameq" 
                                runat="server" CssClass="text-secondary">下拉框列表选项名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDdlItemsOptionNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblDDLItemsOptionList" runat="server" 
                                CssClass="h6" Width="250px">下拉框列表选项列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvDDLItemsOption"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvDDLItemsOption_Sorting"
                    OnPageIndexChanging="gvDDLItemsOption_PageIndexChanging"
                    OnRowCreated="gvDDLItemsOption_RowCreated"
                    OnRowCommand="gvDDLItemsOption_RowCommand"
                    OnRowDeleting="gvDDLItemsOption_RowDeleting"
                    OnRowUpdating="gvDDLItemsOption_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DdlItemsOptionId" SortExpression="DdlItemsOptionId" HeaderText="下拉框列表选项ID"></asp:BoundField>
                        <asp:BoundField DataField="DdlItemsOptionName" SortExpression="DdlItemsOptionName" HeaderText="下拉框列表选项名"></asp:BoundField>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditDDLItemsOptionRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditDDLItemsOption"  runat="server"
                                    CssClass="h6">下拉框列表选项编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelDDLItemsOptionEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelDDLItemsOptionEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucDDLItemsOptionB id="wucDDLItemsOptionB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
