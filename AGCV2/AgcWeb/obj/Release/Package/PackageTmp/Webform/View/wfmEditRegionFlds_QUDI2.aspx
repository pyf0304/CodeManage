...
<%@ Page Title="表EditRegionFlds的查询、修改、删除、添加记录" Language="C#" MasterPageFile="~/Webform/MasterPage/mpViewEdit.Master" CodeBehind="wfmEditRegionFlds_QUDI2.aspx.cs" ValidateRequest="false"
    AutoEventWireup="True" Inherits="AGC.Webform.wfmEditRegionFlds_QUDI2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <li class="nav-item ml-2">
                    <div class="btn-group" role="group" aria-label="Basic example">
                      ...
                      <asp:TextBox ID="txtColNum" runat="server" Width="50px"></asp:TextBox>
                                <asp:Label ID="Label6" runat="server" Text="页面显示模式:" CssClass="text-primary ml-3"></asp:Label>
    ...
    <div class="row col-12" style="width: 100%">
        <div class="col-5 panel panel-info mt-2">
            <div class="panel-body">
        ...
        <div id="tabEditEditRegionFldsRegion" class="col-3" style="width: 100%">
            <div>
                <ul class="nav">
                    <li class="nav-item">
                        <asp:Label ID="Label4"
