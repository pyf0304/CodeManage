<%@ Page Title="表ExcelExportRegionFlds的查询、修改、删除、添加记录" Language="C#" MasterPageFile="~/Webform/MasterPage/mpViewEdit.Master" CodeBehind="wfmExcelExportRegionFlds_QUDI2.aspx.cs" ValidateRequest="false"
    AutoEventWireup="True" Inherits="AGC.Webform.wfmExcelExportRegionFlds_QUDI2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="tabExcelExportRegionFldsDataGrid" cellspacing="0" cellpadding="0" width="100%"
        ...
        <div class="row col-12">
            ...
            <div id="tabEditExcelExportRegionFldsRegion" class="col-3">
                <div>
                    <ul class="nav">
                        <li class="nav-item">
                        ...
                        <li class="nav-item ml-2">
                            <asp:Label ID="lblMsg" runat="server" Width="208px" Height="10px"></asp:Label>
                        </li>
                        <li class="nav-item ml-2">
                            <asp:Label ID="Label1" runat="server" Width="128px" Font-Size="Small" ForeColor="#004040"
                                Font-Bold="True">编辑字段属性</asp:Label>
                        </li>
                    </ul>
                </div>
                <div>
