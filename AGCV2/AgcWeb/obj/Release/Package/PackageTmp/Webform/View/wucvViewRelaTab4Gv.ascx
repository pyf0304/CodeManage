...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucvViewRelaTab4Gv.ascx.cs" Inherits = "AGC.Webform.wucvViewRelaTab4Gv" %>
...
runat = "server">
<asp:GridView id = "gvViewRelaTab" style = "z-index: 102;" runat = "server" 
Width = "100%" AutoGenerateColumns = "False" 
PageSize = "10" AllowPaging = "true" 
AllowSorting = "true" 
OnSorting = "gvViewRelaTab_Sorting" 
OnPageIndexChanging = "gvViewRelaTab_PageIndexChanging" 
OnRowCreated = "gvViewRelaTab_RowCreated"
OnRowCommand = "gvViewRelaTab_RowCommand"
OnRowDeleting = "gvViewRelaTab_RowDeleting" 
OnRowUpdating = "gvViewRelaTab_RowUpdating" 
BackColor = "White" 
BorderColor = "#E7E7FF" 
BorderStyle = "None" 
BorderWidth = "1px"
...
<ItemTemplate>
<a name = "A_ViewRelaTab<%# Eval("mId").ToString().Trim() %>"></a>
...
<asp:BoundField DataField = "InOutTypeName" SortExpression = "InOutTypeName" HeaderText = "INOUT类型名称"></asp:BoundField>
<asp:BoundField DataField = "ViewTabTypeName" SortExpression = "ViewTabTypeName" HeaderText = "ViewTabTypeName"></asp:BoundField>
<asp:BoundField DataField = "TabName" SortExpression = "TabName" HeaderText = "表名"></asp:BoundField>
<asp:BoundField DataField = "TabFunction" SortExpression = "TabFunction" HeaderText = "表功能说明"></asp:BoundField>
