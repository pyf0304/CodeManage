<%@ Register TagPrefix="uc1" TagName="wucDataBaseTypeB" Src="wucDataBaseTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmDataBaseTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmDataBaseTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>数据库类型的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >数据库类型
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblDataBaseTypeIdq" 
                                runat="server" CssClass="text-secondary">数据库类型ID</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDataBaseTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblDataBaseTypeNameq" 
                                runat="server" CssClass="text-secondary">数据库类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDataBaseTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblDataBaseTypeList" runat="server" 
                                CssClass="h6" Width="250px">数据库类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvDataBaseType"  runat="server"
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditDataBaseTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditDataBaseType"  runat="server"
                                    CssClass="h6">数据库类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelDataBaseTypeEdit" 
                ...
                <div>
                    <uc1:wucDataBaseTypeB id="wucDataBaseTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
