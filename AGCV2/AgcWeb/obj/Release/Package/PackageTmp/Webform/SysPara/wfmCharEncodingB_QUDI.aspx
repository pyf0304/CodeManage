<%@ Register TagPrefix="uc1" TagName="wucCharEncodingB" Src="wucCharEncodingB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCharEncodingB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmCharEncodingB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>字符编码维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >字符编码维护
                </asp:Label>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblCharEncodingIdq" 
                                runat="server" CssClass="text-secondary">字符编码</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCharEncodingIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblCharEncodingNameq" 
                                runat="server" CssClass="text-secondary">字符编码名称</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCharEncodingNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblCharEncodingList" runat="server" 
                                CssClass="h6" Width="250px">字符编码列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvCharEncoding"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvCharEncoding_Sorting"
                    OnPageIndexChanging="gvCharEncoding_PageIndexChanging"
                    OnRowCreated="gvCharEncoding_RowCreated"
                    OnRowCommand="gvCharEncoding_RowCommand"
                    OnRowDeleting="gvCharEncoding_RowDeleting"
                    OnRowUpdating="gvCharEncoding_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditCharEncodingRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditCharEncoding"  runat="server"
                                    CssClass="h6">字符编码编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelCharEncodingEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelCharEncodingEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucCharEncodingB ID="wucCharEncodingB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
