<%@ Register TagPrefix="uc1" TagName="wucAppPageTypeB" Src="wucAppPageTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmAppPageTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmAppPageTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>App页面类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >App页面类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblAppPageTypeIdq" 
                                runat="server" CssClass="text-secondary">App页面类型Id</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtAppPageTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblAppPageTypeNameq" 
                                runat="server" CssClass="text-secondary">App页面类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtAppPageTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                        ...
                        <td>
                            <asp:Label ID="lblAppPageTypeENNameq" 
                                runat="server" CssClass="text-secondary">App页面类型英文名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtAppPageTypeENNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List mt-2"
                ...
                <div id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <ul class="nav">
                        <li class="nav-item">
                            <asp:Label ID="lblAppPageTypeList" runat="server"
                                CssClass="h6" Width="250px">App页面类型列表</asp:Label>
                        </li>
                ...
                <div class="mt-2">
                <asp:GridView ID="gvAppPageType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvAppPageType_Sorting"
                    OnPageIndexChanging="gvAppPageType_PageIndexChanging"
                    OnRowCreated="gvAppPageType_RowCreated"
                    OnRowCommand="gvAppPageType_RowCommand"
                    OnRowDeleting="gvAppPageType_RowDeleting"
                    OnRowUpdating="gvAppPageType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_AppPageType<%# Eval("AppPageTypeId").ToString().Trim() %>"></a>
                                <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="AppPageTypeId" SortExpression="AppPageTypeId" HeaderText="App页面类型Id"></asp:BoundField>
                        <asp:BoundField DataField="AppPageTypeName" SortExpression="AppPageTypeName" HeaderText="App页面类型名"></asp:BoundField>
                        <asp:BoundField DataField="AppPageTypeENName" SortExpression="AppPageTypeENName" HeaderText="App页面类型英文名"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditAppPageTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditAppPageType"  runat="server"
                                    CssClass="h6">App页面类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelAppPageTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelAppPageTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucAppPageTypeB id="wucAppPageTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
