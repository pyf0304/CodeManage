<%@ Register TagPrefix="uc1" TagName="wucCMUserProject" Src="wucCMUserProject.ascx" %>
<%@ Register TagPrefix="uc2" TagName="wucvCMUserProject4Gv" Src="wucvCMUserProject4Gv.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCMUserProject_QUDI.aspx.cs" Inherits="AGC.Webform.wfmCMUserProject_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>CM用户工程维护的维护</title>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="col-form-label text-info">CM用户工程维护
                </asp:Label>
            ...
            <div id="divQuery" style="margin: 10px;">
                <table id="tabQuery" name="tabQuery" style="width: 70%;" class="table table-bordered table-hover table td table-sm">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCmPrjIdq" name="ddlCmPrjIdq" CssClass="form-control-sm" Width="200px" runat="server" />
                        </td>
                        <td>
            ...
            <div id="divFunction" class="table table-bordered table-hover">
                <ul class="nav">
                    <li class="nav-item">
                        <asp:Label ID="lblCMUserProjectList" name="lblCMUserProjectList" CssClass="col-form-label text-info" Width="250px" Text="CM用户工程列表" runat="server" />
                    </li>
...
<asp:Button id="btnCopyRecord" CssClass="btn btn-outline-info text-nowrap" OnClick="btnCopyRecord_Click" Text="复制记录" runat="server" />
            ...
            <div id="divList" class="div_List mt-2" runat="server">
                <uc2:wucvCMUserProject4Gv runat="server" id="wucvCMUserProject4Gv1"
                    OnGvUpdateClick="wucvCMUserProject4Gv1_GvUpdateClick"
                    OnGvDeleteClick="wucvCMUserProject4Gv1_GvDeleteClick" />
            </div>
            <%-- 编辑层 --%>
            <div id="tabEditCMUserProjectRegion" class="tab_Edit mt-2"
                runat="server">
                <div style="width: 60%;">
                    <ul class="nav">
                        <li class="nav-item">
                            <asp:Label ID="lblEditCMUserProject" Style="z-index: 104;" Width="200px" runat="server"
                                CssClass="col-form-label text-info">CM用户工程编辑区域</asp:Label>
                        </li>
                        <li class="nav-item ml-3">
                        ...
                        <li class="nav-item ml-3">
                            <asp:Button ID="btnCancelCMUserProjectEdit"
                                runat="server" CssClass="btn btn-outline-info" Text="取消编辑" OnClick="btnCancelCMUserProjectEdit_Click"></asp:Button>
                        </li>
                        <li class="nav-item ml-3">
                ...
                <div>
                    <uc1:wucCMUserProject id="wucCMUserProject1" runat="server" />
                </div>
            </div>
        </div>
    </form>
