<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvCMUserProject4Gv.ascx.cs" Inherits="AGC.Webform.wucvCMUserProject4Gv" %>
<%-- 列表层 --%>

<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvCMUserProject" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvCMUserProject_Sorting"
        OnPageIndexChanging="gvCMUserProject_PageIndexChanging"
        OnRowCreated="gvCMUserProject_RowCreated"
        OnRowCommand="gvCMUserProject_RowCommand"
        OnRowDeleting="gvCMUserProject_RowDeleting"
        OnRowUpdating="gvCMUserProject_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_CMUserProject<%# Eval("mId").ToString().Trim() %>"></a>
            ...
            <asp:BoundField DataField="ProjectFileName" SortExpression="ProjectFileName" HeaderText="工程文件名"></asp:BoundField>
