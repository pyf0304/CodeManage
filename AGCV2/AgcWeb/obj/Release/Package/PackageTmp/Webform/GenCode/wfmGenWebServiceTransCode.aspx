<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmGenWebServiceTransCode.aspx.cs"
    Inherits="AGC.Webform.wfmGenWebServiceTransCode" ValidateRequest="false" %>
        ...
        <div id="Div1" class="tab_layout"
            ...
            <div style="position: relative; width: 100%; height: 25px; left: 0px; top: 0px;">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" Width="212px">表字段管理->项目表维护                    </asp:Label>
                        </td>

                        <%--   <td>
                            <asp:CheckBox ID="chkIsForSilverLight" runat="server" Text="针对SilverLight" Width="140px" />
                        </td>--%><%-- <td style="width: 370px">
                            <asp:RadioButtonList ID="rblNetOrJava" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblNetOrJava_SelectedIndexChanged"
                                RepeatDirection="Horizontal"  Width="370px">
                                <asp:ListItem Selected="True">DotNet</asp:ListItem>
                            ...
                            <asp:RadioButtonList ID="rblSqlOrOracle" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblSqlOrOracle_SelectedIndexChanged"
            ...
            <div id="divList" class="div_List" runat="server">
                <asp:GridView ID="gvWebSrvFunctions" Style="z-index: 120; position: relative;" runat="server"
                    Width="100%" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True"
                    OnSorting="gvWebSrvFunctions_Sorting" OnPageIndexChanging="gvWebSrvFunctions_PageIndexChanging"
                    OnRowCreated="gvWebSrvFunctions_RowCreated" OnRowCommand="gvWebSrvFunctions_RowCommand" OnRowDeleting="gvWebSrvFunctions_RowDeleting"
                    OnRowUpdating="gvWebSrvFunctions_RowUpdating" BackColor="White" BorderColor="#E7E7FF"
                    BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" Height="1px"
                    DataKeyNames="WebSrvFunctionId" CssClass="table table-striped table-bordered table-condensed">
                    <Columns>
                        ...
                        <asp:BoundField DataField="WebSrvFunctionId" SortExpression="WebSrvFunctionId" HeaderText="序号" Visible="true"></asp:BoundField>
                        <asp:BoundField DataField="FunctionName" SortExpression="FunctionName" HeaderText="函数名">
