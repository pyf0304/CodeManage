<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucvReferFiles4Gv.ascx.cs" Inherits="AGC.Webform.wucvReferFiles4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvReferFiles"  runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvReferFiles_Sorting"
        OnPageIndexChanging="gvReferFiles_PageIndexChanging"
        OnRowCreated="gvReferFiles_RowCreated"
        OnRowCommand="gvReferFiles_RowCommand"
        OnRowDeleting="gvReferFiles_RowDeleting"
        OnRowUpdating="gvReferFiles_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_ReferFiles<%# Eval("ReferFileId").ToString().Trim() %>"></a>
                    <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="ReferFileId" SortExpression="ReferFileId" HeaderText="引用文件Id"></asp:BoundField>
