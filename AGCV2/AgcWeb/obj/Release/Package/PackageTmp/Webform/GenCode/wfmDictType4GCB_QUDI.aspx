<%@ Register TagPrefix="uc1" TagName="wucDictType4GCB" Src="./wucDictType4GCB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmDictType4GCB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmDictType4GCB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset = utf-8" />
    <title>生成代码字典类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >生成代码字典类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDictTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblDictTypeNameq" 
                                runat="server" CssClass="text-secondary">字典类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDictTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblDictType4GCList" runat="server" 
                                CssClass="h6" Width="250px">生成代码字典类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvDictType4GC"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvDictType4GC_Sorting"
                    OnPageIndexChanging="gvDictType4GC_PageIndexChanging"
                    OnRowCreated="gvDictType4GC_RowCreated"
                    OnRowCommand="gvDictType4GC_RowCommand"
                    OnRowDeleting="gvDictType4GC_RowDeleting"
                    OnRowUpdating="gvDictType4GC_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="全选">
                            ...
                            <ItemTemplate>
                                <a name="A_DictType4GC<%# Eval("DictTypeId").ToString().Trim() %>"></a>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditDictType4GCRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditDictType4GC"  runat="server"
                                    CssClass="h6">生成代码字典类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelDictType4GCEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelDictType4GCEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucDictType4GCB ID="wucDictType4GCB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
