<%@ Register TagPrefix="uc1" TagName="wucSqlViewRelaTabB" Src="wucSqlViewRelaTabB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmSqlViewRelaTabB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmSqlViewRelaTabB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Sql视图相关表维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >Sql视图相关表维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblTabRelationTypeIdq" Style="z-index: 116;"
                                runat="server" CssClass="text-secondary">表关系类型Id</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlTabRelationTypeIdq" Style="z-index: 117;"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:DropDownList>
                        </td>

                        <td>
                            <asp:Label ID="lblTabNameq" Style="z-index: 119;"
                                runat="server" CssClass="text-secondary">表名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTabNameq" Style="z-index: 120;"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblSqlViewRelaTabList" runat="server" 
                                CssClass="h6" Width="250px">Sql视图相关表列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvSqlViewRelaTab" Style="z-index: 126;" runat="server"
                    ...
                    <Columns>
                       ...
                       <asp:BoundField DataField="RelaTabId" SortExpression="RelaTabId" HeaderText="相关表Id"></asp:BoundField>
                        <asp:BoundField DataField="SqlViewId" SortExpression="SqlViewId" HeaderText="Sql视图Id"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditSqlViewRelaTabRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditSqlViewRelaTab"  runat="server"
                                    CssClass="h6">Sql视图相关表编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelSqlViewRelaTabEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelSqlViewRelaTabEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucSqlViewRelaTabB ID="wucSqlViewRelaTabB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
