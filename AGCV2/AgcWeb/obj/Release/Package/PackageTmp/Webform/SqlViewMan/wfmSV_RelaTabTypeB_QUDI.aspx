<%@ Register TagPrefix="uc1" TagName="wucSV_RelaTabTypeB" Src="wucSV_RelaTabTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmSV_RelaTabTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmSV_RelaTabTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Sql视图相关表类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >Sql视图相关表类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblSvRelaTabTypeIdq" 
                                runat="server" CssClass="text-secondary">Sql视图相关表类型Id</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSvRelaTabTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblSvRelaTabTypeNameq" 
                                runat="server" CssClass="text-secondary">Sql视图相关表类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSvRelaTabTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblSV_RelaTabTypeList" runat="server" 
                                CssClass="h6" Width="250px">Sql视图相关表类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvSV_RelaTabType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvSV_RelaTabType_Sorting"
                    OnPageIndexChanging="gvSV_RelaTabType_PageIndexChanging"
                    OnRowCreated="gvSV_RelaTabType_RowCreated"
                    OnRowCommand="gvSV_RelaTabType_RowCommand"
                    OnRowDeleting="gvSV_RelaTabType_RowDeleting"
                    OnRowUpdating="gvSV_RelaTabType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SvRelaTabTypeId" SortExpression="SvRelaTabTypeId" HeaderText="Sql视图相关表类型Id"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditSV_RelaTabTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditSV_RelaTabType"  runat="server"
                                    CssClass="h6">Sql视图相关表类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelSV_RelaTabTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelSV_RelaTabTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucSV_RelaTabTypeB id="wucSV_RelaTabTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
