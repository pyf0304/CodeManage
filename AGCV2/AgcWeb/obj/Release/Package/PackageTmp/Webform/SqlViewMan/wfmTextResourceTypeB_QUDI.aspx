<%@ Register TagPrefix="uc1" TagName="wucTextResourceTypeB" Src="wucTextResourceTypeB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmTextResourceTypeB_QUDI.aspx.cs" Inherits="AGC.Webform.wfmTextResourceTypeB_QUDI" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>文本来源类型维护的维护</title>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="h5" >文本来源类型维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTextResourceTypeIdq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblTextResourceTypeNameq" 
                                runat="server" CssClass="text-secondary">文本来源类型名</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTextResourceTypeNameq" 
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>
            ...
            <div id="divList" class="div_List"
                ...
                <table id="tabGridFunction" style="width: 100%; height: 32px" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblTextResourceTypeList" runat="server" 
                                CssClass="h6" Width="250px">文本来源类型列表</asp:Label>
                        </td>
                        <td>
                ...
                <asp:GridView ID="gvTextResourceType"  runat="server"
                    Width="100%" AutoGenerateColumns="False"
                    PageSize="10" AllowPaging="true"
                    AllowSorting="true"
                    OnSorting="gvTextResourceType_Sorting"
                    OnPageIndexChanging="gvTextResourceType_PageIndexChanging"
                    OnRowCreated="gvTextResourceType_RowCreated"
                    OnRowCommand="gvTextResourceType_RowCommand"
                    OnRowDeleting="gvTextResourceType_RowDeleting"
                    OnRowUpdating="gvTextResourceType_RowUpdating"
                    BackColor="White"
                    BorderColor="#E7E7FF"
                    BorderStyle="None"
                    BorderWidth="1px"
                    ...
                    Height="1px"
                    DataKeyNames="TextResourceTypeId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TextResourceTypeId" SortExpression="TextResourceTypeId" HeaderText="文本来源类型Id"></asp:BoundField>
                        <asp:BoundField DataField="TextResourceTypeName" SortExpression="TextResourceTypeName" HeaderText="文本来源类型名"></asp:BoundField>
...
<asp:ListItem>15</asp:ListItem>
            ...
            <%-- 编辑层 --%>
            <div id="tabEditTextResourceTypeRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditTextResourceType"  runat="server"
                                    CssClass="h6">文本来源类型编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                &nbsp;
                                <asp:Button ID="btnCancelTextResourceTypeEdit" 
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelTextResourceTypeEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucTextResourceTypeB id="wucTextResourceTypeB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
