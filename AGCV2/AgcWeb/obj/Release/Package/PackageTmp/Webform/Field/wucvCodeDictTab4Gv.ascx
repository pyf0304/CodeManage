<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvCodeDictTab4Gv.ascx.cs" Inherits="AGC.Webform.wucvCodeDictTab4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvCodeDictTab" Style="z-index: 102;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvCodeDictTab_Sorting"
        OnPageIndexChanging="gvCodeDictTab_PageIndexChanging"
        OnRowCreated="gvCodeDictTab_RowCreated"
        OnRowCommand="gvCodeDictTab_RowCommand"
        OnRowDeleting="gvCodeDictTab_RowDeleting"
        OnRowUpdating="gvCodeDictTab_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
                    <a name="A_CodeDictTab<%# Eval("CodeTabCodeId").ToString().Trim() %>"></a>
                    <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="CodeTab" SortExpression="CodeTab" HeaderText="代码表"></asp:BoundField>
            <asp:BoundField DataField="CodeTabCode" SortExpression="CodeTabCode" HeaderText="代码表_代码"></asp:BoundField>
            <asp:BoundField DataField="CodeTabName" SortExpression="CodeTabName" HeaderText="代码表_名称"></asp:BoundField>
            ...
            <asp:BoundField DataField="CodeTabId" SortExpression="CodeTabId" HeaderText="代码表Id"></asp:BoundField>
            <asp:BoundField DataField="CodeTabCodeId" SortExpression="CodeTabCodeId" HeaderText="代码Id"></asp:BoundField>
            <asp:BoundField DataField="CodeTabNameId" SortExpression="CodeTabNameId" HeaderText="代码_名Id"></asp:BoundField>
