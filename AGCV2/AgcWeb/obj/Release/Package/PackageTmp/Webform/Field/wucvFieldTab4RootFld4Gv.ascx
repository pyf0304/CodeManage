<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvFieldTab4RootFld4Gv.ascx.cs" Inherits="AGC.Webform.wucvFieldTab4RootFld4Gv" %>
...
<div id="divList" class="div_List"
    ...
    <asp:GridView ID="gvFieldTab"  runat="server"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TabName" HeaderText="源表" SortExpression="TabName" />
            ...
            <asp:CheckBoxField DataField="IsNeedTransCode" HeaderText="转换？" SortExpression="IsNeedTransCode" Visible="false" />
            <asp:CheckBoxField DataField="IsRootFld" HeaderText="根字段?" SortExpression="IsRootFld" />
            <asp:BoundField DataField="Root4TabName" HeaderText="主根表" SortExpression="Root4TabName" Visible="true" />
            <asp:BoundField DataField="RootFldName" HeaderText="根字段" SortExpression="RootFldName" Visible="true" />
            <asp:BoundField DataField="RootTabName" HeaderText="根表" SortExpression="RootTabName" Visible="true" />
            <asp:BoundField DataField="RootFldId" HeaderText="根Id" SortExpression="RootFldId" Visible="true" />
            ...
            <asp:BoundField DataField="IsPrimaryKey" SortExpression="IsPrimaryKey" HeaderText="是否主键"></asp:BoundField>
