...
<%@ Page Language="c#" CodeBehind="wfmFieldTab_Check.aspx.cs" AutoEventWireup="True"
    Inherits="AGC.Webform.wfmFieldTab_Check" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Label ID="Label3" Style="z-index: 103; left: 2px; position: absolute; top: 8px"
            ...
            ForeColor="Blue">表字段管理->字段核实</asp:Label>
                                ...
                                <table id="Table1" style="width: 832px; height: 40px" cellspacing="1" cellpadding="1"
                                    ...
                                    <tr>
                                        <td style="width: 107px" align="right" colspan="1" rowspan="1">
                                            <asp:Label ID="Label4" runat="server">相关对象</asp:Label></td>
                                        <td style="width: 124px">
                                            <asp:DropDownList ID="ddlObjIdq" runat="server" Width="143px">
                                            </asp:DropDownList></td>
                                        <td>
  ...
  字段状态</asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td style="height: 16px"></td>
                            <td style="height: 16px">
                                <asp:LinkButton ID="lbSetChecked" runat="server" OnClick="lbSetChecked_Click">设置审核</asp:LinkButton></td>
                        </tr>
                        <tr>
                            <td colspan="4">
