<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvFieldTab4GvBak.ascx.cs" Inherits="AGC.Webform.wucvFieldTab4GvBak" %>
...
<div id="divList" class="div_List"
    ...
    <asp:GridView ID="gvFieldTab"  runat="server"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="IsNeedTransCode" HeaderText="转换？" SortExpression="IsNeedTransCode" />
            ...
            <asp:BoundField DataField="IsRootFld" SortExpression="IsRootFld" HeaderText="是否根字段"></asp:BoundField>
            <asp:BoundField DataField="RootFldId" SortExpression="RootFldId" HeaderText="根字段Id"></asp:BoundField>
