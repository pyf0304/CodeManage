...
namespace AGC.frm
{
    public class clsMSProject
    {
        ...
        public static bool AddCompileFile(string filePath)
        {
            ...
            _csProj.Save();
            if (IsExistFilePath(filePath) == false) return false;
            return true;
        }
        ...
        public static bool IsExistFileName(string fileName)
        {
            //string strEvaluatedInclude = "";
        ...
        public static string GetEvaluatedIncludeByFileName(string fileName)
        {
            //string strEvaluatedInclude = "";
            ...
            if (objProjectItem_Sel != null)
            {
                return objProjectItem_Sel.EvaluatedInclude;
            }
        ...
        /// <summary>
        /// 根据简单文件名删除类文件，从某根文件夹向下找
        /// </summary>
        /// <param name="strSimpleFileName">简单文件名</param>
        /// <param name="strFolderName_Root">根文件夹</param>
        /// <returns>是否成功</returns>
        public static bool DeleteClassFileBySimpleFileName(string strSimpleFileName, string strFolderName_Root)
        {
