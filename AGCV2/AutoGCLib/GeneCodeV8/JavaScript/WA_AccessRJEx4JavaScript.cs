...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AccessRJEx4JavaScript : clsGeneCodeBase
    {
        public bool Is4RJ { get; set; }
        #region 构造函数

        public WA_AccessRJEx4JavaScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public WA_AccessRJEx4JavaScript(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WA_AccessRJEx4JavaScript(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
   ...
   //         });
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                strBuilder.AppendFormat("\r\n" + "const cls{0}ExWApi = /** @class **/ (function() {{",
                  objPrjTabENEx.TabName);
                ...
                //strBuilder.Append("\r\n" + "};");
                strBuilder.AppendFormat("\r\n" + "{1}.mstrController = \"{0}ExApi\";", objPrjTabENEx.TabName, objPrjTabENEx.ClsName);
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WA_AccessRJEx4JavaScript);
        ...
        {
            this.ClsName = string.Format("cls{0}ExWApi", objPrjTabENEx.TabName);
        }

        public string Gen_4WAEx_Js_GetWebApiUrl()
        {
