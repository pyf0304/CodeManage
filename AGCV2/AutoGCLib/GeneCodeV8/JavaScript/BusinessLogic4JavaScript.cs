...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class BusinessLogic4JavaScript : clsGeneCodeBase
    {
        #region 构造函数

        public BusinessLogic4JavaScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public BusinessLogic4JavaScript(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            objPrjTabENEx.ClsName = "js" + objPrjTabENEx.TabName + "BL";
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "const cls{0}BL = function()", objPrjTabENEx.TabName);
                strCodeForCs.Append("\r\n" + "{");
        ...
        public string A_GeneFuncCode_JavaScript(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(BusinessLogic4JavaScript);
