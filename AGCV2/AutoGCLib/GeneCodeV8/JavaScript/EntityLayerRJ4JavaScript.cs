...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayerRJ4JavaScript : clsGeneCodeBase
    {
        ...
        public EntityLayerRJ4JavaScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public EntityLayerRJ4JavaScript(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "const cls{0}EN = /** @class **/ (function (_super) {{", //extends clsGeneralTab",
                    objPrjTabENEx.TabName);
                strCodeForCs.AppendFormat("\r\n" + "__extends(cls{0}EN, _super);", objPrjTabENEx.TabName);
                ...
                strCodeForCs.AppendFormat("\r\n" + "{0}._CurrTabName = \"{1}\"; //当前表名,与该类相关的表名", objPrjTabENEx.ClsName, objPrjTabENEx.TabName);
                strCodeForCs.AppendFormat("\r\n" + "{0}._KeyFldName = \"{1}\"; //当前表中的关键字名称,与该类相关的表中关键字名",
                    objPrjTabENEx.ClsName,
                    objPrjTabENEx.KeyFldNameLstStr);

                strCodeForCs.AppendFormat("\r\n" + "return {0};", objPrjTabENEx.ClsName);
                strCodeForCs.AppendFormat("\r\n" + "}}({0}));",
                         ImportClass.GetOutString(string.Format("clsGeneralTab", objPrjTabENEx.TabName), this.Is4RJ));
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(EntityLayerRJ4JavaScript);
        ...
        public string Gen_EN_ClassConstructor1()
        {
            ...
            strCodeForCs.AppendFormat("\r\n" + "_this.AttributeName = new Array({0});",
                strTemp);
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                strCodeForCs.AppendFormat("\r\n" + "_this.{0} = {1}; //{2},",
                        objField.PrivFuncName, objField.ObjFieldTabENEx.InitValue_TypeScript, objField.ObjFieldTabENEx.Caption);
            }
            strCodeForCs.AppendFormat("\r\n" + "  return _this;");
