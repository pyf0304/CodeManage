...
namespace AutoGCLib
{
    ...
    partial class WA_Access4JavaScript : clsGeneCodeBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenWebApiTransCode_JavaScript_SelfDefWs(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strResult = "";
            ...
            try
            {
                ...
                strBuilder.Append("\r\n" + "};");
                //生成所有的函数
                clsvFunction4GeneCodeEN objvFunction4GeneCodeEN = clsvFunction4GeneCodeBLEx.GetObjByFuncName_CacheEx("Gen_4WA_main_JavaScript_SelfDefWs");
                ...
                foreach (clsWebSrvFunctionsENEx objWebSrvFunctionsENEx in objWebSrvClassENEx.arrWebSrvFunctionsENExObjLst)
                {
                    ...
                    try
                    {
                        strTemp = Gen_4WA_ByCommonFunction_JavaScript(objWebSrvFunctionsENEx);
                        if (string.IsNullOrEmpty(strTemp) == false)
                        {
                            strBuilder.Append("\r\n" + strTemp);
                ...
                objvFunction4GeneCodeEN = clsvFunction4GeneCodeBLEx.GetObjByFuncName_CacheEx("Gen_4WA_CallWebApi_JavaScript_SelfDefWs");

                strTemp = A_GeneFuncCode(objvFunction4GeneCodeEN, ref Re_objFunction4Code);
                strBuilder.Append("\r\n" + strTemp);
                objvFunction4GeneCodeEN = clsvFunction4GeneCodeBLEx.GetObjByFuncName_CacheEx("Gen_4WA_getReturnValue_JavaScript");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_AddNewRecord_JavaScript()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "if (obj{0}EN.get{1}() === null || obj{0}EN.get{1}() === \"\")",
              ...
              objKeyField.FldName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "const strMsg = String.format(\"需要的对象的关键字为空，不能添加!\");");
            strBuilder.Append("\r\n" + "throw strMsg;");
            strBuilder.Append("\r\n" + "}");
           ...
           objPrjTabENEx.TabName);
            ...
            strBuilder.Append("\r\n" + "try");
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "this.CallWebApi(strMethodName, mapParam, this.WEB_SERVICE_URL);");

            strBuilder.Append("\r\n" + "}");
            strBuilder.Append("\r\n" + "catch(objException)");
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "strMsg = \"在调用WebApi函数时出错，错误信息：\\(String(describing: objException.reason))\";");
            strBuilder.Append("\r\n" + "throw strMsg;");
            strBuilder.Append("\r\n" + "}");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_UpdateRecord_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 调用WebApi来修改记录，数据传递使用JSON串");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_DelRecord_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 调用WebApi来删除记录");
            ...
            strBuilder.Append("\r\n" + "catch(objException)");
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "const strMsg = \"在调用WebApi函数时出错，错误信息：\\(String(describing: objException.reason))\";");
            strBuilder.Append("\r\n" + "throw strMsg;");
            strBuilder.Append("\r\n" + "}");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_IsExistRecord_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的记录对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetRecCountByCond_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 获取某一条件的记录数");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetObjLst_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的记录对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetTopObjLst_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的记录对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetObjLstByPager_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的记录对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetFirstObj_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的记录对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetMaxStrId_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的记录对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetMaxStrIdByPrefix_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_CallWebApi_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 通用的调用WebApi函数");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_CallWebApi_JavaScript_SelfDefWs()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 通用的调用WebApi函数");
//            strBuilder.AppendFormat("\r\n /// mapParam样例:{0} = \"01\"", objWebSrvClassENEx.ClassName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_main_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 继承Runnable类必须实现的【run】函数");
...
objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_main_JavaScript_SelfDefWA()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 继承Runnable类必须实现的【run】函数");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_start_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 继承Runnable类必须实现的【run】函数");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_GetObjByKey_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据关键字获取相应的记录的对象");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_getReturnValue_JavaScript()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 获取返回值函数");
...
//            strBuilder.Append("\r\n" + "const responseMessage = textNode.nodeValue;");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4WA_ByCommonFunction_JavaScript(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            string strMsg = "";
            ...
            strBuilder.AppendFormat("\r\n" + "catch (objException)");
            strBuilder.Append("\r\n" + "{        ");
            strBuilder.AppendFormat("\r\n" + "const strMsg = String.format(\"在调用WebApi函数:[{0}]时出错，错误信息:%s\", objException.message);",
                objWebSrvFunctionsENEx.FunctionName);
            strBuilder.AppendFormat("\r\n" + "throw strMsg;");
            strBuilder.Append("\r\n" + "}");
        ...
        public bool A_CheckFuncExist(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN)
        {
            string strFuncName = objvFunction4GeneCodeEN.FuncName;
            try
            {
