...
namespace AutoGCLib
{
    ...
    class EntityLayer4TypeScript : clsGeneCodeBase, IImportClass
    {
        ...
        public EntityLayer4TypeScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public EntityLayer4TypeScript(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public override string GeneCode(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                strCodeForCs.AppendFormat("\r\n" + "public static {0} = \"{1}\"; //{2}",
                        conPrjTab.CacheModeId, objPrjTabENEx.CacheModeId, clsCacheModeBL.GetNameByCacheModeIdCache(objPrjTabENEx.CacheModeId));

                strCodeForCs.AppendFormat("\r\n" + "public static {0} = \"{1}\"; //{2}",
                                        conPrjTabFld.PrimaryTypeId, strPrimaryTypeId, 
                                        clsPrimaryTypeBL.GetNameByPrimaryTypeIdCache(strPrimaryTypeId));                

                strCodeForCs.AppendFormat("\r\n" + "public static IsUseDelSign = {0}; //使用删除标志,记录不能删除,仅设置删除标志",
                        objPrjTabENEx.IsUseDelSign?"true": "false");

                strCodeForCs.AppendFormat("\r\n" + "public static {0} = \"{1}\"; //{2}",
                                        conPrjTab.WhereFormat, objPrjTabENEx.WhereFormat, "条件格式串");
