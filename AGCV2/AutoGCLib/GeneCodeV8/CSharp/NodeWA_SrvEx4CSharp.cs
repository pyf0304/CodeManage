...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class NodeWA_SrvEx4CSharp : clsGeneCodeBase
    {

        #region 构造函数

        public NodeWA_SrvEx4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public NodeWA_SrvEx4CSharp(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public NodeWA_SrvEx4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
