...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class BusinessLogic4Mvc4CSharp : clsGeneCodeBase
    {
     

        #region 构造函数

        public BusinessLogic4Mvc4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public BusinessLogic4Mvc4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
