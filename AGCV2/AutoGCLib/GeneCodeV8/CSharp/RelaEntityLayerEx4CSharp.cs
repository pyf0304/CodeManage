...
namespace AutoGCLib
{
    ...
    /// </summary>
    class RelaEntityLayerEx4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public RelaEntityLayerEx4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public RelaEntityLayerEx4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
