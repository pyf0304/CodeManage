...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class BusinessLogicEx4CSharp : clsGeneCodeBase
    {
        ...
        public BusinessLogicEx4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
