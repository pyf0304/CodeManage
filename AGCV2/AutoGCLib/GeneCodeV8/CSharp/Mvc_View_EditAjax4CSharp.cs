...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class Mvc_View_EditAjax4CSharp : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public Mvc_View_EditAjax4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
