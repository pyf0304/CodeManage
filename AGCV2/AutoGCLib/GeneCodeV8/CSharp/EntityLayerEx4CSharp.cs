...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayerEx4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public EntityLayerEx4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public EntityLayerEx4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
