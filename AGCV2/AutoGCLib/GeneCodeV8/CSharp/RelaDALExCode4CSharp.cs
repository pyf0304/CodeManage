...
namespace AutoGCLib
{
    ...
    /// </summary>
    class RelaDALExCode4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public RelaDALExCode4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public RelaDALExCode4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
