...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AccessEx4CSharp : clsGeneCodeBase
    {

        #region 构造函数

        public WA_AccessEx4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public WA_AccessEx4CSharp(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WA_AccessEx4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
