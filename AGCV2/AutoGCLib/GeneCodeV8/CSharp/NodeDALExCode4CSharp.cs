...
namespace AutoGCLib
{
    ...
    /// </summary>
    class NodeDALExCode4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public NodeDALExCode4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public NodeDALExCode4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
