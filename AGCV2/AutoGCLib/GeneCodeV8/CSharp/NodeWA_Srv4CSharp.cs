...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class NodeWA_Srv4CSharp : clsGeneCodeBase
    {
        ...
        public NodeWA_Srv4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public NodeWA_Srv4CSharp(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public NodeWA_Srv4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
