...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayer4CSharp_MySql : clsGeneCodeBase
    {
       
        #region 构造函数

        public EntityLayer4CSharp_MySql()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public EntityLayer4CSharp_MySql(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
