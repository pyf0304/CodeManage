...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_ViewUTScript4CSharp : clsGeneCodeBase
    {

        public WA_ViewUTScript4CSharp()
        {
        ...
        public WA_ViewUTScript4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
