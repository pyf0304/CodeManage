...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class Mvc_View_Query4CSharp : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public Mvc_View_Query4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
