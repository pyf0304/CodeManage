...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class RelaWA_Access4CSharp : clsGeneCodeBase
    {
        private string strKeyFldName_ObjName = "";

        #region 构造函数

        public RelaWA_Access4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public RelaWA_Access4CSharp(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public RelaWA_Access4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
