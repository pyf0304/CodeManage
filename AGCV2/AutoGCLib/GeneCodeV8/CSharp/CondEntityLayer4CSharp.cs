...
namespace AutoGCLib
{
    ...
    /// </summary>
    class CondEntityLayer4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public CondEntityLayer4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public CondEntityLayer4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
