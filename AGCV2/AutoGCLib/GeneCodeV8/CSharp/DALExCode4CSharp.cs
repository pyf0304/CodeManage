...
namespace AutoGCLib
{
    ...
    /// </summary>
    class DALExCode4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public DALExCode4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public DALExCode4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
