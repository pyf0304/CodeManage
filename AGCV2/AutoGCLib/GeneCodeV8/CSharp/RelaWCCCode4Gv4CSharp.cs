...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class RelaWCCCode4Gv4CSharp : clsGeneCodeBase
    {
     ...
     : base("", strViewId, "", "")
        ...
        public RelaWCCCode4Gv4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
