...
namespace AutoGCLib
{
    ...
    /// </summary>
    class RelaDALCode4CSharp : clsGeneCodeBase
    {
        #region 构造函数

        public RelaDALCode4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public RelaDALCode4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
