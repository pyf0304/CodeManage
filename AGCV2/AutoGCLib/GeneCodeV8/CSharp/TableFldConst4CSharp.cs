...
namespace AutoGCLib
{
    ...
    /// </summary>
    class TableFldConst4CSharp : clsGeneCodeBase
    {


        #region 构造函数

        public TableFldConst4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public TableFldConst4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
