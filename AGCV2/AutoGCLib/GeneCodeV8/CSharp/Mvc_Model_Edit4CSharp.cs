...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class Mvc_Model_Edit4CSharp : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public Mvc_Model_Edit4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
