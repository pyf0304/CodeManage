...
namespace AutoGCLib
{
    ...
    /// </summary>
    class RelaEntityLayer4CSharp : clsGeneCodeBase
    {
        #region 构造函数

        public RelaEntityLayer4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public RelaEntityLayer4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
