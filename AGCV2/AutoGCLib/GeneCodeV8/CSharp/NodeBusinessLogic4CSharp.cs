...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class NodeBusinessLogic4CSharp : clsGeneCodeBase
    {
        private string strKeyFldName_ObjName = "";

        #region 构造函数

        public NodeBusinessLogic4CSharp()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public NodeBusinessLogic4CSharp(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
