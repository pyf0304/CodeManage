...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewQryScript4JAVA : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public AppViewQryScript4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
