...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayer4JAVA : clsGeneCodeBase
    {
        ...
        public EntityLayer4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public EntityLayer4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
