...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewUTScript4JAVA : clsGeneCodeBase
    {        

        #region 构造函数

        public AppViewUTScript4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public AppViewUTScript4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
