...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewListViewAdapter4JAVA : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public AppViewListViewAdapter4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
