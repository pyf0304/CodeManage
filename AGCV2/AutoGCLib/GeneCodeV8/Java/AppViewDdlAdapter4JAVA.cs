...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewDdlAdapter4JAVA : clsGeneCodeBase
    {        

        #region 构造函数

        public AppViewDdlAdapter4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public AppViewDdlAdapter4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
