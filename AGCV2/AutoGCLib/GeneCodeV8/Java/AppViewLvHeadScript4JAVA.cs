...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewLvHeadScript4JAVA : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public AppViewLvHeadScript4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
