...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewScriptContent4JAVA : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public AppViewScriptContent4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
