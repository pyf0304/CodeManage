...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_AppViewUTScript4JAVA : clsGeneCodeBase
    {

        #region 构造函数
        public WA_AppViewUTScript4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
    ...
    List<string> arrValueLst)
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenController_Java_SelfDefWA4UTScript(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            ...
            try
            {
                ...
                //    }
                //}
                strTemp = A_GeneFuncCodeByFuncName("Gen_WA_Controller_Java_DefButtontvMsg");
                if (string.IsNullOrEmpty(strTemp) == false)
                {
                    strCodeForCs.Append("\r\n" + strTemp);
                }
