...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewEdtScript4JAVA : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public AppViewEdtScript4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
