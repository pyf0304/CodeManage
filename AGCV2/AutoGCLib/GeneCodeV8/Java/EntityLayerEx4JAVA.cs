...
namespace AutoGCLib
{
    ...
    /// </summary>
    class EntityLayerEx4JAVA : clsGeneCodeBase
    {
        ...
        public EntityLayerEx4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public EntityLayerEx4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
