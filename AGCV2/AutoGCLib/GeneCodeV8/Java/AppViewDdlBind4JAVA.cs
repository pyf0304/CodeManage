...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewDdlBind4JAVA : clsGeneCodeBase
    {
        ...
        public AppViewDdlBind4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public AppViewDdlBind4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
