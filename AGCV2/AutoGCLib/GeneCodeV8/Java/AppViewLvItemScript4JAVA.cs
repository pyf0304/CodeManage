...
namespace AutoGCLib
{
    ...
    /// </summary>
    public class AppViewLvItemScript4JAVA : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public AppViewLvItemScript4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
