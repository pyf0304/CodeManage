...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class BusinessLogicEx4JAVA : clsGeneCodeBase
    {

        #region 构造函数

        public BusinessLogicEx4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public BusinessLogicEx4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
