...
namespace AutoGCLib
{
    ...
    /// </summary>
    abstract partial class AppController4JAVABase : clsGeneCodeBase
    {

        #region 构造函数

        public AppController4JAVABase()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public AppController4JAVABase(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
