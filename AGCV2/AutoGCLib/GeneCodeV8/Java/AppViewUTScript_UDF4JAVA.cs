...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class AppViewUTScript_UDF4JAVA : clsGeneCodeBase
    {        

        #region 构造函数

        public AppViewUTScript_UDF4JAVA()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public AppViewUTScript_UDF4JAVA(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
