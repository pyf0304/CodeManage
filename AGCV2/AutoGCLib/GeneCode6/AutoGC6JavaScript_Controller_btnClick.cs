...
namespace AutoGCLib
{
    ...
    partial class AutoGC6_Controller : AutoGCPubFuncV6
    {
        ...
        public string A_GeneFuncCode_JavaScript_btnClick(string strFuncName)
        {
            try
            {
                switch (strFuncName)
                {
                    ...
                    case "Gen_Controller_JavaScript_btnClickGetFirstJSONObj":
                        return Gen_Controller_JavaScript_btnClickGetFirstJSONObj();

                    case "Gen_Controller_JavaScript_btnClickGetJSONObjByKey":
                        return Gen_Controller_JavaScript_btnClickGetJSONObjByKey();

                    case "Gen_Controller_JavaScript_btnClickDelRecord":
                        return Gen_Controller_JavaScript_btnClickDelRecord();

                    case "Gen_Controller_JavaScript_btnClickAddNewRecord":
                        return Gen_Controller_JavaScript_btnClickAddNewRecord();

                    case "Gen_Controller_JavaScript_btnClickAddNewRecord4GetMaxStrId":
                        return Gen_Controller_JavaScript_btnClickAddNewRecord4GetMaxStrId();
                    case "Gen_Controller_JavaScript_btnClickGetMaxStrId":
                        return Gen_Controller_JavaScript_btnClickGetMaxStrId();
                    case "Gen_Controller_JavaScript_btnClickGetMaxStrIdByPrefix":
                        return Gen_Controller_JavaScript_btnClickGetMaxStrIdByPrefix();

                    case "Gen_Controller_JavaScript_btnClickUpdateRecord":
                        return Gen_Controller_JavaScript_btnClickUpdateRecord();

                    case "Gen_Controller_JavaScript_btnClickIsExistRecord":
                        return Gen_Controller_JavaScript_btnClickIsExistRecord();

                    case "Gen_Controller_JavaScript_btnClickGetRecCountByCond":
                        return Gen_Controller_JavaScript_btnClickGetRecCountByCond();

                    case "Gen_Controller_JavaScript_btnClickGetJSONObjLst":
                        return Gen_Controller_JavaScript_btnClickGetJSONObjLst();

                    case "Gen_Controller_JavaScript_btnClickGetTopJSONObjLst":
                        return Gen_Controller_JavaScript_btnClickGetTopJSONObjLst();

                    case "Gen_Controller_JavaScript_btnClickGetJSONObjLstByPager":
                        return Gen_Controller_JavaScript_btnClickGetJSONObjLstByPager();
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_JavaScript_btnClickAddNewRecord()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}_AddNewRecordEx = new icls{0}_AddNewRecordEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_AddNewRecordEx.main();",
                objPrjTabENEx.TabName);

            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}_AddNewRecordEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}_AddNewRecordEx.prototype = new icls{0}_AddNewRecord();",
objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickAddNewRecord4GetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}_AddNewRecord4GetMaxStrIdEx = new icls{0}_AddNewRecord4GetMaxStrIdEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_AddNewRecord4GetMaxStrIdEx.main();",
                objPrjTabENEx.TabName);

            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}_AddNewRecord4GetMaxStrIdEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}_AddNewRecord4GetMaxStrIdEx.prototype = new icls{0}_AddNewRecord4GetMaxStrId();",
                objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetMaxStrIdEx = new icls{0}GetMaxStrIdEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetMaxStrIdEx.main();",
                objPrjTabENEx.TabName);

            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}GetMaxStrIdEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetMaxStrIdEx.prototype = new icls{0}GetMaxStrId();",
objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetMaxStrIdByPrefix()
        {
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetMaxStrIdByPrefixEx = new icls{0}GetMaxStrIdByPrefixEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetMaxStrIdByPrefixEx.main();",
                objPrjTabENEx.TabName);

            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}GetMaxStrIdByPrefixEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetMaxStrIdByPrefixEx.prototype = new icls{0}GetMaxStrIdByPrefix();",
                objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickUpdateRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}_UpdateRecordEx = new icls{0}_UpdateRecordEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_UpdateRecordEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}_UpdateRecordEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}_UpdateRecordEx.prototype = new icls{0}_UpdateRecord();",
objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickDelRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 删除记录");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}_DelRecordEx = new icls{0}_DelRecordEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_DelRecordEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}_DelRecordEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}_DelRecordEx.prototype = new icls{0}_DelRecord();",
                objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_JavaScript_btnClickIsExistRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 检查相应关键字的记录是否存在");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}_IsExistRecordEx = new icls{0}_IsExistRecordEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_IsExistRecordEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}_IsExistRecordEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "icls{0}_IsExistRecordEx.prototype = new icls{0}_IsExistRecord();",
              objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_JavaScript_btnClickGetRecCountByCond()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 检查相应关键字的记录是否存在");
            ...
            strBuilder.Append("\r\n" + "this.btnGetRecCountByCond_Click = function() {");


            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetRecCountByCondEx = new icls{0}GetRecCountByCondEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetRecCountByCondEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}GetRecCountByCondEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetRecCountByCondEx.prototype = new icls{0}GetRecCountByCond();",
  objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的对象列表");
            ...
            strBuilder.AppendFormat("\r\n" + "this.btnGetJSONObjLst_Click = function() ",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetJSONObjLstEx = new icls{0}GetJSONObjLstEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetJSONObjLstEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}GetJSONObjLstEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetJSONObjLstEx.prototype = new icls{0}GetJSONObjLst();",
objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetTopJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的对象列表");
            ...
            strBuilder.AppendFormat("\r\n" + "this.btnGetTopJSONObjLst_Click = function() ",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetTopJSONObjLstEx = new icls{0}GetTopJSONObjLstEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetTopJSONObjLstEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}GetTopJSONObjLstEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetTopJSONObjLstEx.prototype = new icls{0}GetTopJSONObjLst();",
  objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "this.init = function()");
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetJSONObjLstByPager()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的对象列表");
            ...
            strBuilder.AppendFormat("\r\n" + "this.btnGetJSONObjLstByPager_Click = function() ",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetJSONObjLstByPagerEx = new icls{0}GetJSONObjLstByPagerEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetJSONObjLstByPagerEx.main();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}GetJSONObjLstByPagerEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetJSONObjLstByPagerEx.prototype = new icls{0}GetJSONObjLstByPager();",
  objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "this.init = function()");
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetJSONObjByKey()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据关键字获取相应的记录的对象");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetObjBy{1}Ex = new icls{0}GetObjBy{1}Ex();",
                objPrjTabENEx.TabName,
                objKeyField.FldName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetObjBy{1}Ex.main();",
                objPrjTabENEx.TabName,
                objKeyField.FldName);
            strBuilder.Append("\r\n" + "}");

            strBuilder.AppendFormat("\r\n" + "const icls{0}GetObjBy{1}Ex = function()",
                objPrjTabENEx.TabName,
                objKeyField.FldName);

            strBuilder.Append("\r\n" + "{");
            strBuilder.AppendFormat("\r\n" + "icls{0}GetObjBy{1}Ex.prototype = new icls{0}GetObjBy{1}();",
                objPrjTabENEx.TabName,
                objKeyField.FldName);
            strBuilder.AppendFormat("\r\n" + "obj{0}EN = new cls{0}EN();",
                objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickGetFirstJSONObj()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的第一条记录的对象");
            ...
            strBuilder.AppendFormat("\r\n" + "const iobj{0}GetFirstObjEx = new icls{0}GetFirstObjEx();",
                objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}GetFirstObjEx.main();",
                objPrjTabENEx.TabName);

            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}GetFirstObjEx = function()",
                objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "icls{0}GetFirstObjEx.prototype = new icls{0}GetFirstObj();",
objPrjTabENEx.TabName);
    ...
    objPrjTabENEx.TabName);
        ...
        public string Gen_Controller_JavaScript_btnClickByCommonFunction(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            string strMsg = "";
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            ...
            //  strBuilder.Append("\r\n /// <param name = \"sender\">事件发送者</param>");
            strBuilder.Append("\r\n /// <returns></returns>");
            strBuilder.AppendFormat("\r\n" + "this.btn{0}_Click = function() ",
                objWebSrvFunctionsENEx.FunctionName);
            strBuilder.Append("\r\n" + "{");

            strBuilder.AppendFormat("\r\n" + "const iobj{0}_{1} = new icls{0}_{1}Ex();",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strBuilder.AppendFormat("\r\n" + "iobj{0}_{1}.main();",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "const icls{0}_{1}Ex = function()",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            strBuilder.Append("\r\n" + "{");
            
            strBuilder.AppendFormat("\r\n" + "icls{0}_{1}Ex.prototype = new icls{0}_{1}();",
                objWebSrvClassENEx.ClsName, objWebSrvFunctionsENEx.FunctionName);
            ...
            strBuilder.Append("\r\n" + "objTableObjWS4ControllerDelegate4SD = new clsTableObjWS4ControllerDelegate();");
            strBuilder.AppendFormat("\r\n" + "objTableObjWS4ControllerDelegate4SD.{0} = function(objResponseData, strClassName, strFunctionName) ",
     ...
     enumDict4GC_DictKey2.conFinished));
            ...
            strBuilder.AppendFormat("\r\n" + "{0}_{1}(objResponseData, strClassName, strFunctionName);",
                ...
                enumDict4GC_DictKey2.conFinished));
            strBuilder.Append("\r\n" + "}");
            strBuilder.AppendFormat("\r\n" + "objTableObjWS4ControllerDelegate4SD.{0} = function(strResult, strClassName, strFunctionName) ",
                clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conSelfDefFunc,
                enumDict4GC_DictKey2.conCorrectFinished));
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.AppendFormat("\r\n" + "function {0}_{1}( returnString, strClassName, strFunctionName)",
                objWebSrvClassENEx.ClsName, clsDict4GCBLEx.GetDictValueByKeyCache(enumDict4GC_DictKey1.conSelfDefFunc,
                enumDict4GC_DictKey2.conCorrectFinished));

            strBuilder.Append("\r\n" + "{");


            strBuilder.Append("\r\n" + "const strInfo = String.format(\"返回值为：{0}!\", returnString);");
            strBuilder.Append("\r\n" + "//显示信息框");
