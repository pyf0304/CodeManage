...
namespace AutoGCLib
{
    ...
    /// </summary>
    class AutoGC6Swift3_M : clsGeneCodeBase
    {
        ...
        public AutoGC6Swift3_M()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public AutoGC6Swift3_M(string strViewId, string strPrjDataBaseId, string strPrjId)
        ...
        public string gfunClsProperty(clsPrjTabENEx objPrjTabENEx)
        {
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                ...
                clsString.FstUcase_S(ref strTemp);
                strBuilder.AppendFormat("\r\n //获取{0}({1})的值", objField.objFieldTabENEx.Caption, objField.objFieldTabENEx.FldName);
                ...
                strBuilder.Append("\r\n }");
                strBuilder.AppendFormat("\r\n //设置{0}({1})的值", objField.objFieldTabENEx.Caption, objField.objFieldTabENEx.FldName);
        ...
        public string gfunAddnewMultiRec(clsPrjTabENEx objPrjTabENEx)
        {
            ...
            if (objKeyField.objFieldTabENEx.IsIdentity == false)
            {
                ...
                else
                {
                    ...
                    strBuilder.Append("\r\n{");
                    strBuilder.Append("\r\nstrResult = \"关键字" + objKeyField.objFieldTabENEx.FldName + "为:\" + " + objKeyField.objFieldTabENEx.PrivFuncName + " + \"的记录已存在，不能重复插入!\" ;");
                    strBuilder.Append("\r\nreturn false;");
                    strBuilder.Append("\r\n}");
                    strBuilder.Append("\r\n}");
                }
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                if (objField.IsTabNullable == false && objField.objFieldTabENEx.IsIdentity == false)
                {
                    if (objField.objFieldTabENEx.objDataTypeAbbrEN.JavaType != "int" && objField.objFieldTabENEx.objDataTypeAbbrEN.JavaType != "boolean")
                    {
                        ...
                        strBuilder.Append(")");
                        strBuilder.Append("\r\n{");
                        strBuilder.Append("\r\nstrResult = \"字段[" + objField.objFieldTabENEx.Caption + "]不能为空(NULL)!\";");
                        strBuilder.Append("\r\nreturn false;");
                        strBuilder.Append("\r\n}");
                    }
                }
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                if (objField.IsTabNullable == false && objField.objFieldTabENEx.IsIdentity == false)
                {
                    ...
                    && objField.objFieldTabENEx.objDataTypeAbbrEN.JavaType != "long")
                    {
                        ...
                        strBuilder.Append(")");
                        strBuilder.Append("\r\n{");
                        strBuilder.Append("\r\n throw new dbobjexception(\"字段[" + objField.objFieldTabENEx.Caption + "]不能为空(NULL)!\");");
                        strBuilder.Append("\r\n}");
                    }
                }
            }
        ...
        public string GenDdlBindFunction(clsPrjTabENEx objPrjTabENEx)
        {
            ...
            try
            {
                ...
                if (strValueFieldName != "" && strTextFieldName != "")
                {
                    ...
                    strCodeForCs.AppendFormat("\r\n" + "System.Web.UI.WebControls.ListItem li = new System.Web.UI.WebControls.ListItem(\"请选择[{0}]...\",\"0\");",
        ...
        public string GenBindListView(clsPrjTabENEx objPrjTabENEx)
        {
            ...
            try
            {
                ...
                foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
                {
                    if (objField.FieldTypeId != "04" && objField.objFieldTabENEx.objDataTypeAbbrEN.JavaObjType != "Byte[]") //不是管理字段
                    {
