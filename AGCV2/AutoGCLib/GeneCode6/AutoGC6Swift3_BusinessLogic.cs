...
namespace AutoGCLib
{
    ...
    partial class AutoGC6Cs_Business : AutoGCPubFuncV6
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4BL_Swift3_getRecObjByJSONStr()
        {
            ...
            objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "public static func GetObjByJSONStr(strJSON : String) throws -> cls{0}EN",
                  objPrjTabENEx.TabName);
            strBuilder.Append("\r\n" + "{");
            ...
            strBuilder.AppendFormat("\r\n" + "let data : NSData! = strJSON.data(using: String.Encoding.utf8) as NSData!;");
            ...
            strBuilder.Append("\r\n" + "}");
            strBuilder.Append("\r\n" + "//获取JSON对象中所有的关键字集合");
            strBuilder.Append("\r\n" + "let jsonAllKeys : NSArray = json.allKeys as NSArray;");
            strBuilder.Append("\r\n" + "//遍历关键字集合,并打印出来!");
            ...
            strBuilder.Append("\r\n" + "//if (jsonAllKeys.contains(\"Memo1\") == true)");
            strBuilder.Append("\r\n" + "//{");
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                ...
                //    );
                string strResult = SetPropertyByJson_Swift3(objField);
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4BL_Swift3_getJSONStrByRecObj()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.AppendFormat("\r\n /// <summary>");
            strBuilder.AppendFormat("\r\n /// 把一个对象转化为一个JSON串");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4BL_Swift3_getObjLstByJSONStr()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.AppendFormat("\r\n /// <summary>");
            strBuilder.AppendFormat("\r\n /// 把一个JSON串转化为一个对象列表");
            ...
            //  objPrjTabENEx.TabName);
            strBuilder.AppendFormat("\r\n" + "let jsonArr = try JSONSerialization.jsonObject(with: myData! as Data, options: JSONSerialization.ReadingOptions.mutableContainers) as!NSArray;");

            //strBuilder.AppendFormat("\r\n" + "json = new JSONObject(strJSON);");
            strBuilder.AppendFormat("\r\n" + "for json in jsonArr");
            strBuilder.Append("\r\n" + "{");
            strBuilder.Append("\r\n" + "//获取JSON对象中所有的关键字集合");
            strBuilder.Append("\r\n" + "let jsonAllKeys : NSArray = (json as AnyObject).allKeys! as NSArray;");
            strBuilder.Append("\r\n" + "//遍历关键字集合,并打印出来!");
            strBuilder.Append("\r\n" + "//for strKey in jsonAllKeys");
            strBuilder.Append("\r\n" + "//{");
            strBuilder.Append("\r\n" + "//print(strKey);");
            ...
            foreach (clsPrjTabFldENEx objField in objPrjTabENEx.arrFldSet)
            {
                ...
                //     objField.ObjFieldTabENEx.FldName
                //    );
                string strResult = SetPropertyByJson4ObjLst_Swift3(objField);
                strBuilder.Append(strResult); 
            }
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_4BL_Swift3_getDictionaryObjByRecObj()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.AppendFormat("\r\n /// 把一个对象转化为一个JSON串");
        ...
        /// </summary>
        /// <returns></returns>
        public string A_GenBusinessLogicCode_Swift3(ref string strRe_ClsName, ref string strRe_FileNameWithModuleName)
        {
            string strFuncName = "";
            string strResult = "";
        ...
        private string SetPropertyByJson4ObjLst_Swift3(clsPrjTabFldENEx objField)
        {
            StringBuilder strBuilder = new StringBuilder();
            ...
            switch (objField.ObjFieldTabENEx.objDataTypeAbbrEN.SwiftType)
            {
                ...
                case "Bool":
                    ...
                    break;
                case "Date":
                    strBuilder.AppendFormat("\r\n" + "obj{0}EN.{1} = clsPubFun.myDate(myObj: (json as AnyObject).object(forKey: \"{1}\") as AnyObject);",
                          objPrjTabENEx.TabName,
                          objField.ObjFieldTabENEx.FldName
                         );
                    break;
        ...
        private string SetPropertyByJson_Swift3(clsPrjTabFldENEx objField)
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.AppendFormat("\r\n" + "if (jsonAllKeys.contains(\"{0}\") == true)",
                 objField.ObjFieldTabENEx.FldName);
            ...
            switch (objField.ObjFieldTabENEx.objDataTypeAbbrEN.SwiftType)
            {
                ...
                case "Bool":
                    ...
                    break;
                case "Date":
                    strBuilder.AppendFormat("\r\n" + "obj{0}EN.{1} = clsPubFun.myDate(myObj: json.object(forKey: \"{1}\") as AnyObject);",
                          objPrjTabENEx.TabName,
                          objField.ObjFieldTabENEx.FldName
                         );
                    break;
        ...
        public string A_GeneFuncCode_Swift3(string strFuncName)
        {
            try
            {
                switch (strFuncName)
                {
                    ...
                    case "Gen_4BL_getRecObjByJSONStr_Swift3":
                        return Gen_4BL_Swift3_getRecObjByJSONStr();
                    case "Gen_4BL_getObjLstByJSONStr_Swift3":
                        return Gen_4BL_Swift3_getObjLstByJSONStr();

                    case "Gen_4BL_getJSONStrByRecObj_Swift3":
                        return Gen_4BL_Swift3_getJSONStrByRecObj();


                    case "Gen_4BL_getDictionaryObjByRecObj_Swift3":
                        return Gen_4BL_Swift3_getDictionaryObjByRecObj();
