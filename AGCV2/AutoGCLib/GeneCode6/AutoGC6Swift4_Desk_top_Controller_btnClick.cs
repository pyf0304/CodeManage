...
namespace AutoGCLib
{
    ...
    partial class AutoGC6_Controller : AutoGCPubFuncV6
    {
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjByKey()
        {
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetFirstJSONObj()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的第一条记录的对象");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickByCommonFunction(clsWebSrvFunctionsENEx objWebSrvFunctionsENEx)
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的对象列表");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetTopJSONObjLst()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的顶部多条对象列表");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLstByPager()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 根据条件获取相应的顶部多条对象列表");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_Desk_top_btnClickIsExistRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 检查相应关键字的记录是否存在");
        ...
        ///// </summary>
        ///// <returns></returns>
        //public string Gen_Controller_Swift4_Desk_top_btnClickGetRecCountByCond()
        //{
        //    StringBuilder strBuilder = new StringBuilder();
        //    strBuilder.Append("\r\n /// <summary>");
        //    strBuilder.Append("\r\n /// 获取相应条件的记录数");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickDelRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 删除记录");
        ...
        /// </summary>
        /// <returns></returns>
        public string Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord4GetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 添加新记录");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrId()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrIdByPrefix()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
        ...
        public string Gen_Controller_Swift4_Desk_top_btnClickUpdateRecord()
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append("\r\n /// <summary>");
            strBuilder.Append("\r\n /// 修改记录");
        ...
        public string A_GeneFuncCode_Swift4_Desk_top_btnClick(string strFuncName)
        {
            try
            {
                switch (strFuncName)
                {
                    ...
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetFirstJSONObj":
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetFirstJSONObj_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetFirstJSONObj();

                    case "Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjByKey":
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjByKey_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjByKey();


                    case "Gen_Controller_Swift4_Desk_top_btnClickDelRecord":
                    case "Gen_Controller_Swift4_Desk_top_btnClickDelRecord_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickDelRecord();


                    case "Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord":
                    case "Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord();


                    case "Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord4GetMaxStrId":
                    case "Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord4GetMaxStrId_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickAddNewRecord4GetMaxStrId();
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrId":
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrId_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrId();
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrIdByPrefix":
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrIdByPrefix_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetMaxStrIdByPrefix();


                    case "Gen_Controller_Swift4_Desk_top_btnClickUpdateRecord":
                    case "Gen_Controller_Swift4_Desk_top_btnClickUpdateRecord_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickUpdateRecord();

                    case "Gen_Controller_Swift4_Desk_top_btnClickIsExistRecord":
                    case "Gen_Controller_Swift4_Desk_top_btnClickIsExistRecord_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickIsExistRecord();

                    case "Gen_Controller_Swift4_Desk_top_btnClickGetRecCountByCond":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetRecCountByCond();

                    case "Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLst":
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLst_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLst();
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetTopJSONObjLst":
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetTopJSONObjLst_Click4tvc":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetTopJSONObjLst();
                    case "Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLstByPager":
                        return Gen_Controller_Swift4_Desk_top_btnClickGetJSONObjLstByPager();
