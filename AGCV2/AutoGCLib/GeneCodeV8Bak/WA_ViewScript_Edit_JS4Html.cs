...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WA_ViewScript_Edit_JS4Html : clsGeneCodeBase
    {
       ...
       : base("", strViewId, "", "")
        ...
        public WA_ViewScript_Edit_JS4Html(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
