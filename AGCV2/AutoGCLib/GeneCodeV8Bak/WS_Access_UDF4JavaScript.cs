...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WS_Access_UDF4JavaScript : clsGeneCodeBase
    {

        #region 构造函数

        public WS_Access_UDF4JavaScript()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public WS_Access_UDF4JavaScript(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WS_Access_UDF4JavaScript(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
...
//            strBuilder.Append("\r\n" + "const responseMessage = textNode.nodeValue;");
        ...
        public override string A_GeneFuncCode(clsvFunction4GeneCodeEN objvFunction4GeneCodeEN, ref clsFunction4CodeEN Re_objFunction4Code)
        {
            ...
            {
                string strCode = "";
                Type t = typeof(WS_Access_UDF4JavaScript);
                MethodInfo mt = t.GetMethod(strFuncName, BindingFlags.Instance | BindingFlags.Public);
        ...
        {
            this.ClsName = string.Format("{0}WS", objWebSrvClassENEx.ClassName);
