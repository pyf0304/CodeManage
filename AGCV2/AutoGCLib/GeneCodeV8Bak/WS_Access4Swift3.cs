...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WS_Access4Swift3 : clsGeneCodeBase
    {
        #region 构造函数

        public WS_Access4Swift3()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public WS_Access4Swift3(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WS_Access4Swift3(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
