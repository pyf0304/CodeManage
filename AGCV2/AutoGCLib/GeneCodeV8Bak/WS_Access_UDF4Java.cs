...
namespace AutoGCLib
{
    ...
    /// </summary>
    partial class WS_Access_UDF4Java : clsGeneCodeBase
    {


        #region 构造函数

        public WS_Access_UDF4Java()
        {
            // 
            // TODO: 在此处添加构造函数逻辑
            //
        }
        public WS_Access_UDF4Java(string strPrjId)
          : base(strPrjId)
        {
            // 
            // TODO: 在此处添加构造函数逻辑
        ...
        public WS_Access_UDF4Java(string strTabId, string strViewId, string strPrjDataBaseId, string strPrjId)
