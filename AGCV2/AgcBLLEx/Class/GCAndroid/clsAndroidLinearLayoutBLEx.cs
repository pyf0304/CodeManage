...
namespace AGC.BusinessLogicEx
{
    public static class clsAndroidLinearLayoutBLEx_Static
    {
        ...
        public static void GeneCode(this clsAndroidLinearLayoutENEx objAndroidLinearLayoutENEx,
            StringBuilder strCodeForCs)
        {
            ...
            foreach (clsAndroidControlENEx objSubAndroidControlENEx in objAndroidLinearLayoutENEx.arrSubAndroidControlLst2)
            {
        ...
        public class clsAndroidLinearLayoutBLEx 
    {
        ...
        public static void Gen_FieldVarDef(clsAndroidLinearLayoutENEx objAndroidLinearLayoutENEx,
            StringBuilder strCodeForCs)
        {
        ...
        /// <param name="objAndroidLinearLayoutENEx"></param>
        /// <param name="strCodeForCs"></param>
        public static void Gen_FieldVarBind(clsAndroidLinearLayoutENEx objAndroidLinearLayoutENEx,
            StringBuilder strCodeForCs)
        {
        ...
        /// <param name="objAndroidLinearLayoutENEx"></param>
        /// <param name="strCodeForCs"></param>
        public static void Gen_FieldVarBind4ListView(clsAndroidLinearLayoutENEx objAndroidLinearLayoutENEx,
            StringBuilder strCodeForCs)
        {
            //txtExamTypeId = (EditText)findViewById(R.id.txtExamTypeId);
        ...
        /// <param name="strCodeForCs"></param>
        public static void Gen_LvFieldAssignment(clsAndroidLinearLayoutENEx objAndroidLinearLayoutENEx, clsViewInfoENEx objViewInfoENEx,
            StringBuilder strCodeForCs)
        {
