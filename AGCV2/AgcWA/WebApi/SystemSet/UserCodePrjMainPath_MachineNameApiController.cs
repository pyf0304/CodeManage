...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsUserCodePrjMainPath_MachineNameEN> arrUserCodePrjMainPath_MachineNameObjLst = clsUserCodePrjMainPath_MachineNameBL.GetObjLstCache(strCmPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrUserCodePrjMainPath_MachineNameObjLst });
 }
 catch (Exception objException)
 {
...
IEnumerable<clsUserCodePrjMainPath_MachineNameEN> arrUserCodePrjMainPath_MachineNameObjLst = clsUserCodePrjMainPath_MachineNameBL.GetObjLstByKeyLstsCache(lstKeyLst, CmPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrUserCodePrjMainPath_MachineNameObjLst });
 }
 catch (Exception objException)
 {
