...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsViewIdGCVariableRelaEN> arrViewIdGCVariableRelaObjLst = clsViewIdGCVariableRelaBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewIdGCVariableRelaObjLst });
 }
 catch (Exception objException)
 {
...
IEnumerable<clsViewIdGCVariableRelaEN> arrViewIdGCVariableRelaObjLst = clsViewIdGCVariableRelaBL.GetObjLstByKeyLstsCache(lstKeyLst);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewIdGCVariableRelaObjLst });
 }
 catch (Exception objException)
 {
