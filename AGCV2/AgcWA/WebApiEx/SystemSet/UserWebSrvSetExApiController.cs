...
/*-- -- -- -- -- -- -- -- -- -- --
类名:UserWebSrvSetExApiController
表名:UserWebSrvSet(00050528)
生成代码版本:2020.01.02.1
生成日期:2020/01/03 15:55:07
生成者:
...
{
    /// <summary>
    /// UserWebSrvSetExApiController 的摘要说明
    /// (AutoGCLib.WA_SrvEx4CSharp:GeneCode)
    /// </summary>
    public class UserWebSrvSetExApiController : UserWebSrvSetApiController
    {
        ...
        public ActionResult EditRecordEx([FromBody]clsUserWebSrvSetEN objUserWebSrvSet)
        {
            ...
            string strUserWebSrvSetJSONObj = clsJSON.GetJsonFromObj(objUserWebSrvSet);
            ...
            try
            {
                ...
                if (bolIsExist)
                {
                    ...
                    bolResult = objUserWebSrvSet.UpdateWithCondition(strCondition);
                }
                else
                {
                    bolResult = objUserWebSrvSet.AddNewRecord();
                }
        ...
        /// </summary>
        public UserWebSrvSetExApiController()
        {
        }
