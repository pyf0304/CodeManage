...
namespace AGC.WebApi
{
    ...
    /// </summary>
    public class DataNodeExApiController : DataNodeApiController
    {
        ...
        public ActionResult GetConnectedNode_Prev(string strEndNodeId, string strPrjId)
        {
        ...
        public ActionResult GetConnectedNode(string strStartNodeId, string strPrjId)
        {
            string strFunctionName = clsStackTrace.GetCurrFunction();
            Dictionary<string, string> dictParam = new Dictionary<string, string>();
        ...
        public ActionResult GetGraphPath(string strStartNodeId, string strEndNodeId, string strPrjId)
        {
            string strFunctionName = clsStackTrace.GetCurrFunction();
            Dictionary<string, string> dictParam = new Dictionary<string, string>();
            dictParam.Add("strStartNodeId", strStartNodeId);
        ...
        /// <returns>返回删除的记录数</returns>
        [HttpPost("DelDataNodesEx")]
        public ActionResult DelDataNodesEx([FromBody] string[] arrDnFuncMapId)
        {
            string strFunctionName = clsStackTrace.GetCurrFunction();
            ...
            try
            {
                int intRecNum = clsDataNodeBLEx.DelDataNodesEx(arrLst);
                return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
            }
            catch (Exception objException)
            {
        ...
        /// <returns>返回是否存在?</returns>
        [HttpGet("DelRecordEx")]
        public ActionResult DelRecordEx(string strDataNodeId, string strPrjId)
        {
            string strFunctionName = clsStackTrace.GetCurrFunction();
            Dictionary<string, string> dictParam = new Dictionary<string, string>();
            dictParam.Add("strDataNodeId", strDataNodeId);
            dictParam.Add("strPrjId", strPrjId);
            clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
            try
            {
        ...
        public ActionResult CheckDataNode(string strDataNodeId, string strPrjId, string strOpUserId)
        {
            string strFunctionName = clsStackTrace.GetCurrFunction();
            Dictionary<string, string> dictParam = new Dictionary<string, string>();
            dictParam.Add("strDataNodeId", strDataNodeId);
