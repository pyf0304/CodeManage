...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsViewInfoCmPrjIdRelaEN> arrViewInfoCmPrjIdRelaObjLst = clsViewInfoCmPrjIdRelaBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewInfoCmPrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
...
IEnumerable<clsViewInfoCmPrjIdRelaEN> arrViewInfoCmPrjIdRelaObjLst = clsViewInfoCmPrjIdRelaBL.GetObjLstByKeyLstsCache(lstKeyLst);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrViewInfoCmPrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
