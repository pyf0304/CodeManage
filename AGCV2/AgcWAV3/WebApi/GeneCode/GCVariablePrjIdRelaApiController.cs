...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
...
IEnumerable<clsGCVariablePrjIdRelaEN> arrGCVariablePrjIdRelaObjLst = clsGCVariablePrjIdRelaBL.GetObjLstByKeyLstsCache(lstKeyLst);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrGCVariablePrjIdRelaObjLst });
 }
 catch (Exception objException)
 {
