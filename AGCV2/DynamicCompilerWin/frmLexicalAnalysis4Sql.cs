...
{
    public partial class frmLexicalAnalysis4Sql : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            clsLexicalAnalysis4Sql objLexicalAnalysis4Sql = new clsLexicalAnalysis4Sql(strCode_In);
            objLexicalAnalysis4Sql.CodeLines = txtCode_In.Lines;
            strCode_In = objLexicalAnalysis4Sql.fnPretreatment();
            string strCode_Out = null;
            objLexicalAnalysis4Sql.fnAnalyzeV3();
            try
            {
                List<clsWord_LA> arrResultWord = objLexicalAnalysis4Sql.ResultWord;
                lbWords.Items.Clear();
                foreach (clsWord_LA objWord_LA in arrResultWord)
                {
                    lbWords.Items.Add(objWord_LA.Word);
                }
                strCode_Out = objLexicalAnalysis4Sql.fnShowAllWordType();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                clsLexicalAnalysis4Sql objLexicalAnalysis4Sql = new clsLexicalAnalysis4Sql(text);
                objLexicalAnalysis4Sql.CodeLines = txtCode_In.Lines;
                string strCode_Out = objLexicalAnalysis4Sql.fnPretreatment();
