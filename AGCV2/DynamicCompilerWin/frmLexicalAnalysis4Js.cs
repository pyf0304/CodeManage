...
{
    public partial class frmLexicalAnalysis4Js : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            clsLexicalAnalysis4Js objLexicalAnalysis4Js = new clsLexicalAnalysis4Js(strCode_In);
            objLexicalAnalysis4Js.CodeLines = txtCode_In.Lines;
            strCode_In = objLexicalAnalysis4Js.fnPretreatment();
            string strCode_Out = null;
            objLexicalAnalysis4Js.fnAnalyzeV3();
            try
            {
                strCode_Out = objLexicalAnalysis4Js.fnShowAllWordType();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                clsLexicalAnalysis4Js objLexicalAnalysis4Js = new clsLexicalAnalysis4Js(text);
                objLexicalAnalysis4Js.CodeLines = txtCode_In.Lines;
                string strCode_Out = objLexicalAnalysis4Js.fnPretreatment();
        ...
        //    this.SuspendLayout();
        //    // 
        //    // frmLexicalAnalysis4Js
        //    // 
        //    this.ClientSize = new System.Drawing.Size(284, 261);
        //    this.Name = "frmLexicalAnalysis4Js";
