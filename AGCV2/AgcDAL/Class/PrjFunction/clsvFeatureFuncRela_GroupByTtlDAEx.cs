 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFeatureFuncRela_GroupByTtlDAEx
 表名:vFeatureFuncRela_GroupByTtl(00050537)
 生成代码版本:2020.03.20.1
 生成日期:2020/03/26 08:44:20
 生成者:
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvFeatureFuncRela_GroupByTtlDAEx : clsvFeatureFuncRela_GroupByTtlDA
{
//以下是属性变量
...
/// </summary>
 public clsvFeatureFuncRela_GroupByTtlDAEx()
 {
 }
}
}