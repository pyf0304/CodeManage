 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFunctionTemplateRela_SimDAEx
 表名:vFunctionTemplateRela_Sim(00050604)
 生成代码版本:2022.01.17.1
 生成日期:2022/01/23 20:58:32
 生成者:pyf
 生成服务器IP:
 工程名称:AGC(0005)
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvFunctionTemplateRela_SimDAEx : clsvFunctionTemplateRela_SimDA
{
//以下是属性变量
...
/// </summary>
 public clsvFunctionTemplateRela_SimDAEx()
 {
 }
}
}