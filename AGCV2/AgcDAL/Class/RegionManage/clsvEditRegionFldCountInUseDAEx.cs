 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvEditRegionFldCountInUseDAEx
 表名:vEditRegionFldCountInUse(00050587)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 23:22:32
 生成者:pyf
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvEditRegionFldCountInUseDAEx : clsvEditRegionFldCountInUseDA
{
//以下是属性变量
...
/// </summary>
 public clsvEditRegionFldCountInUseDAEx()
 {
 }
}
}