 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvExcelExportRegionFldCountInUseDAEx
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvExcelExportRegionFldCountInUseDAEx : clsvExcelExportRegionFldCountInUseDA
{
//以下是属性变量
...
/// </summary>
 public clsvExcelExportRegionFldCountInUseDAEx()
 {
 }
}
}