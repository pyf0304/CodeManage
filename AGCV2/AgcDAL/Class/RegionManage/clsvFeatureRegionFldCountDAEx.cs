 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFeatureRegionFldCountDAEx
 表名:vFeatureRegionFldCount(00050578)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 16:01:53
 生成者:pyf
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvFeatureRegionFldCountDAEx : clsvFeatureRegionFldCountDA
{
//以下是属性变量
...
/// </summary>
 public clsvFeatureRegionFldCountDAEx()
 {
 }
}
}