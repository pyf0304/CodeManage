 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFeatureRegionFldCountInUseDAEx
 表名:vFeatureRegionFldCountInUse(00050584)
 生成代码版本:2020.09.24.1
 生成日期:2020/10/05 23:18:29
 生成者:pyf
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvFeatureRegionFldCountInUseDAEx : clsvFeatureRegionFldCountInUseDA
{
//以下是属性变量
...
/// </summary>
 public clsvFeatureRegionFldCountInUseDAEx()
 {
 }
}
}