 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFeatureRegionFlds_TtlDAEx
 表名:vFeatureRegionFlds_Ttl(00050474)
 生成代码版本:2019.05.25.1
 生成日期:2019/05/25 23:38:37
 生成者:
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvFeatureRegionFlds_TtlDAEx : clsvFeatureRegionFlds_TtlDA
{
//以下是属性变量
...
/// </summary>
 public clsvFeatureRegionFlds_TtlDAEx()
 {
 }
}
}