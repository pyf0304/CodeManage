 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCMFeatureRequirementDAEx
 表名:CMFeatureRequirement(00050520)
 生成代码版本:2019.11.08.1
 生成日期:2019/11/12 22:58:04
 生成者:
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsCMFeatureRequirementDAEx : clsCMFeatureRequirementDA
{
//以下是属性变量
...
/// </summary>
 public clsCMFeatureRequirementDAEx()
 {
 }
}
}