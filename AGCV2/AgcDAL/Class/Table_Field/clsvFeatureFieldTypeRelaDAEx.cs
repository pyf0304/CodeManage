 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvFeatureFieldTypeRelaDAEx
 表名:vFeatureFieldTypeRela(00050458)
 生成代码版本:2019.04.27.1
 生成日期:2019/04/30 04:19:38
 生成者:
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsvFeatureFieldTypeRelaDAEx : clsvFeatureFieldTypeRelaDA
{
//以下是属性变量
...
/// </summary>
 public clsvFeatureFieldTypeRelaDAEx()
 {
 }
}
}