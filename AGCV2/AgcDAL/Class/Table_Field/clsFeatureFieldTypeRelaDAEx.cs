 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsFeatureFieldTypeRelaDAEx
 表名:FeatureFieldTypeRela(00050457)
 生成代码版本:2019.04.27.1
 生成日期:2019/04/30 04:19:36
 生成者:
...
namespace AGC.DAL
{
 ...
 /// </summary>
public class clsFeatureFieldTypeRelaDAEx : clsFeatureFieldTypeRelaDA
{
//以下是属性变量
...
/// </summary>
 public clsFeatureFieldTypeRelaDAEx()
 {
 }
}
}