 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:QuestionStuFinishedStatusApiController
...
{
 /// <summary>
 /// QuestionStuFinishedStatusController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  QuestionStuFinishedStatusApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQuestionStuFinishedStatusEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst = clsQuestionStuFinishedStatusBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQuestionStuFinishedStatusObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst = clsQuestionStuFinishedStatusBL.GetObjLstCache(strIdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQuestionStuFinishedStatusObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/QuestionStuFinishedStatusapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst = clsQuestionStuFinishedStatusBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQuestionStuFinishedStatusObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst = clsQuestionStuFinishedStatusBL.GetObjLstByMIdLstCache(lstMId, IdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQuestionStuFinishedStatusObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst = clsQuestionStuFinishedStatusBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQuestionStuFinishedStatusObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clsQuestionStuFinishedStatusBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN = clsQuestionStuFinishedStatusBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQuestionStuFinishedStatusEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst;
 try
 {
 arrQuestionStuFinishedStatusObjLst = clsQuestionStuFinishedStatusBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQuestionStuFinishedStatusObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsQuestionStuFinishedStatusBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsQuestionStuFinishedStatusBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsQuestionStuFinishedStatusBL.SetFldValue(clsQuestionStuFinishedStatusEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsQuestionStuFinishedStatusBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/QuestionStuFinishedStatusApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsQuestionStuFinishedStatusBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/QuestionStuFinishedStatusApi/AddNewRecord
 /// 在Body区传输objQuestionStuFinishedStatusEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objQuestionStuFinishedStatusEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQuestionStuFinishedStatusJSONObj = clsJSON.GetJsonFromObj(objQuestionStuFinishedStatusEN);
dictParam.Add("strQuestionStuFinishedStatusJSONObj", strQuestionStuFinishedStatusJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsQuestionStuFinishedStatusBL.AccessFldValueNull(objQuestionStuFinishedStatusEN);
bool bolResult = objQuestionStuFinishedStatusEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/QuestionStuFinishedStatusApi/AddNewRecordWithReturnKey
 /// 在Body区传输objQuestionStuFinishedStatusEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objQuestionStuFinishedStatusEN", JsonConvert.SerializeObject(objQuestionStuFinishedStatusEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsQuestionStuFinishedStatusBL.AccessFldValueNull(objQuestionStuFinishedStatusEN);
string strKey = clsQuestionStuFinishedStatusBL.AddNewRecordBySql2WithReturnKey(objQuestionStuFinishedStatusEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/QuestionStuFinishedStatusApi/UpdateRecord
 /// 在Body区传输objQuestionStuFinishedStatusEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strQuestionStuFinishedStatusJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQuestionStuFinishedStatusJSONObj = clsJSON.GetJsonFromObj(objQuestionStuFinishedStatusEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsQuestionStuFinishedStatusBL.SetUpdFlag(objQuestionStuFinishedStatusEN);
    clsQuestionStuFinishedStatusBL.AccessFldValueNull(objQuestionStuFinishedStatusEN);
bool bolResult = objQuestionStuFinishedStatusEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/QuestionStuFinishedStatusApi/EditRecordEx
 /// 在Body区传输objQuestionStuFinishedStatusEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQuestionStuFinishedStatusJSONObj = clsJSON.GetJsonFromObj(objQuestionStuFinishedStatusEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsQuestionStuFinishedStatusBL.SetUpdFlag(objQuestionStuFinishedStatusEN);
    clsQuestionStuFinishedStatusBL.AccessFldValueNull(objQuestionStuFinishedStatusEN);
bool bolResult = objQuestionStuFinishedStatusEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/QuestionStuFinishedStatusApi/UpdateWithCondition
 /// 在Body区传输objQuestionStuFinishedStatusEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsQuestionStuFinishedStatusBL.AccessFldValueNull(objQuestionStuFinishedStatusEN);
bool bolResult = objQuestionStuFinishedStatusEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/QuestionStuFinishedStatusApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsQuestionStuFinishedStatusBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/QuestionStuFinishedStatusApi/DelQuestionStuFinishedStatuss
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelQuestionStuFinishedStatuss")]
public ActionResult DelQuestionStuFinishedStatuss([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsQuestionStuFinishedStatusBL.DelQuestionStuFinishedStatuss(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/QuestionStuFinishedStatusApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsQuestionStuFinishedStatusBL.DelQuestionStuFinishedStatuss(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/QuestionStuFinishedStatusApi/DelQuestionStuFinishedStatussByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelQuestionStuFinishedStatussByCond")]
public ActionResult DelQuestionStuFinishedStatussByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsQuestionStuFinishedStatusBL.DelQuestionStuFinishedStatussByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
