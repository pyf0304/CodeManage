...
{
 /// <summary>
 /// ge_KnowledgesClsMasterController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  ge_KnowledgesClsMasterApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetObjByIdCurrEduCls?IdCurrEduCls=value
...
public ActionResult GetObjByKeyLst(string strIdCurrEduCls,string strCourseKnowledgeId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objge_KnowledgesClsMasterEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsge_KnowledgesClsMasterEN> arrge_KnowledgesClsMasterObjLst = clsge_KnowledgesClsMasterBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesClsMasterObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsge_KnowledgesClsMasterEN> arrge_KnowledgesClsMasterObjLst = clsge_KnowledgesClsMasterBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesClsMasterObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/ge_KnowledgesClsMasterapi/GetObjLstByIdCurrEduClsLst
...
IEnumerable<clsge_KnowledgesClsMasterEN> arrge_KnowledgesClsMasterObjLst = clsge_KnowledgesClsMasterBL.GetObjLstByKeyLstsCache(lstKeyLst);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesClsMasterObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsge_KnowledgesClsMasterEN> arrge_KnowledgesClsMasterObjLst = clsge_KnowledgesClsMasterBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesClsMasterObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strIdCurrEduCls = clsge_KnowledgesClsMasterBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsge_KnowledgesClsMasterEN objge_KnowledgesClsMasterEN = clsge_KnowledgesClsMasterBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objge_KnowledgesClsMasterEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsge_KnowledgesClsMasterEN> arrge_KnowledgesClsMasterObjLst;
 try
 {
 arrge_KnowledgesClsMasterObjLst = clsge_KnowledgesClsMasterBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesClsMasterObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsge_KnowledgesClsMasterBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsge_KnowledgesClsMasterBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsge_KnowledgesClsMasterBL.SetFldValue(clsge_KnowledgesClsMasterEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsge_KnowledgesClsMasterBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/ge_KnowledgesClsMasterApi/IsExist?IdCurrEduCls=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strIdCurrEduCls">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strIdCurrEduCls,string strCourseKnowledgeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsge_KnowledgesClsMasterBL.IsExist(strIdCurrEduCls,strCourseKnowledgeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/ge_KnowledgesClsMasterApi/AddNewRecord
 /// 在Body区传输objge_KnowledgesClsMasterEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objge_KnowledgesClsMasterEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsge_KnowledgesClsMasterEN objge_KnowledgesClsMasterEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strge_KnowledgesClsMasterJSONObj = clsJSON.GetJsonFromObj(objge_KnowledgesClsMasterEN);
dictParam.Add("strge_KnowledgesClsMasterJSONObj", strge_KnowledgesClsMasterJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objge_KnowledgesClsMasterEN.IdCurrEduCls, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
    clsge_KnowledgesClsMasterBL.AccessFldValueNull(objge_KnowledgesClsMasterEN);
bool bolResult = objge_KnowledgesClsMasterEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ge_KnowledgesClsMasterApi/AddNewRecordWithReturnKey
 /// 在Body区传输objge_KnowledgesClsMasterEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objge_KnowledgesClsMasterEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsge_KnowledgesClsMasterEN objge_KnowledgesClsMasterEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objge_KnowledgesClsMasterEN", JsonConvert.SerializeObject(objge_KnowledgesClsMasterEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsge_KnowledgesClsMasterBL.AccessFldValueNull(objge_KnowledgesClsMasterEN);
string strKey = clsge_KnowledgesClsMasterBL.AddNewRecordBySql2WithReturnKey(objge_KnowledgesClsMasterEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/ge_KnowledgesClsMasterApi/UpdateRecord
 /// 在Body区传输objge_KnowledgesClsMasterEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strge_KnowledgesClsMasterJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsge_KnowledgesClsMasterEN objge_KnowledgesClsMasterEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strge_KnowledgesClsMasterJSONObj = clsJSON.GetJsonFromObj(objge_KnowledgesClsMasterEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsge_KnowledgesClsMasterBL.SetUpdFlag(objge_KnowledgesClsMasterEN);
    clsge_KnowledgesClsMasterBL.AccessFldValueNull(objge_KnowledgesClsMasterEN);
bool bolResult = objge_KnowledgesClsMasterEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/ge_KnowledgesClsMasterApi/UpdateWithCondition
 /// 在Body区传输objge_KnowledgesClsMasterEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsge_KnowledgesClsMasterEN objge_KnowledgesClsMasterEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsge_KnowledgesClsMasterBL.AccessFldValueNull(objge_KnowledgesClsMasterEN);
bool bolResult = objge_KnowledgesClsMasterEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/ge_KnowledgesClsMasterApi/DelRecord/Id
...
public ActionResult DelRecKeyLst(string strIdCurrEduCls,string strCourseKnowledgeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsge_KnowledgesClsMasterBL.DelRecord(strIdCurrEduCls,strCourseKnowledgeId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ge_KnowledgesClsMasterApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsge_KnowledgesClsMasterBL.DelRecKeyLsts(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/ge_KnowledgesClsMasterApi/Delge_KnowledgesClsMastersByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delge_KnowledgesClsMastersByCond")]
public ActionResult Delge_KnowledgesClsMastersByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsge_KnowledgesClsMasterBL.Delge_KnowledgesClsMastersByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
