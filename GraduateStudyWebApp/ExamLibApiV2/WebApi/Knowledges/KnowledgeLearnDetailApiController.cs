...
{
 /// <summary>
 /// KnowledgeLearnDetailController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  KnowledgeLearnDetailApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objKnowledgeLearnDetailEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst = clsKnowledgeLearnDetailBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrKnowledgeLearnDetailObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst = clsKnowledgeLearnDetailBL.GetObjLstCache(strCourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrKnowledgeLearnDetailObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/KnowledgeLearnDetailapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst = clsKnowledgeLearnDetailBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrKnowledgeLearnDetailObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst = clsKnowledgeLearnDetailBL.GetObjLstByMIdLstCache(lstMId, CourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrKnowledgeLearnDetailObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst = clsKnowledgeLearnDetailBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrKnowledgeLearnDetailObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clsKnowledgeLearnDetailBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN = clsKnowledgeLearnDetailBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objKnowledgeLearnDetailEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst;
 try
 {
 arrKnowledgeLearnDetailObjLst = clsKnowledgeLearnDetailBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrKnowledgeLearnDetailObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsKnowledgeLearnDetailBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsKnowledgeLearnDetailBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsKnowledgeLearnDetailBL.SetFldValue(clsKnowledgeLearnDetailEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsKnowledgeLearnDetailBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/KnowledgeLearnDetailApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsKnowledgeLearnDetailBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/KnowledgeLearnDetailApi/AddNewRecord
 /// 在Body区传输objKnowledgeLearnDetailEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objKnowledgeLearnDetailEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strKnowledgeLearnDetailJSONObj = clsJSON.GetJsonFromObj(objKnowledgeLearnDetailEN);
dictParam.Add("strKnowledgeLearnDetailJSONObj", strKnowledgeLearnDetailJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsKnowledgeLearnDetailEN objKnowledgeLearnDetailCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsKnowledgeLearnDetailBL.AccessFldValueNull(objKnowledgeLearnDetailEN);
bool bolResult = objKnowledgeLearnDetailEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/KnowledgeLearnDetailApi/AddNewRecordWithReturnKey
 /// 在Body区传输objKnowledgeLearnDetailEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objKnowledgeLearnDetailEN", JsonConvert.SerializeObject(objKnowledgeLearnDetailEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsKnowledgeLearnDetailBL.AccessFldValueNull(objKnowledgeLearnDetailEN);
string strKey = clsKnowledgeLearnDetailBL.AddNewRecordBySql2WithReturnKey(objKnowledgeLearnDetailEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/KnowledgeLearnDetailApi/UpdateRecord
 /// 在Body区传输objKnowledgeLearnDetailEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strKnowledgeLearnDetailJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strKnowledgeLearnDetailJSONObj = clsJSON.GetJsonFromObj(objKnowledgeLearnDetailEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsKnowledgeLearnDetailBL.SetUpdFlag(objKnowledgeLearnDetailEN);
    clsKnowledgeLearnDetailBL.AccessFldValueNull(objKnowledgeLearnDetailEN);
bool bolResult = objKnowledgeLearnDetailEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/KnowledgeLearnDetailApi/EditRecordEx
 /// 在Body区传输objKnowledgeLearnDetailEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strKnowledgeLearnDetailJSONObj = clsJSON.GetJsonFromObj(objKnowledgeLearnDetailEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsKnowledgeLearnDetailBL.SetUpdFlag(objKnowledgeLearnDetailEN);
    clsKnowledgeLearnDetailBL.AccessFldValueNull(objKnowledgeLearnDetailEN);
bool bolResult = objKnowledgeLearnDetailEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/KnowledgeLearnDetailApi/UpdateWithCondition
 /// 在Body区传输objKnowledgeLearnDetailEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsKnowledgeLearnDetailBL.AccessFldValueNull(objKnowledgeLearnDetailEN);
bool bolResult = objKnowledgeLearnDetailEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/KnowledgeLearnDetailApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsKnowledgeLearnDetailBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/KnowledgeLearnDetailApi/DelKnowledgeLearnDetails
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelKnowledgeLearnDetails")]
public ActionResult DelKnowledgeLearnDetails([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsKnowledgeLearnDetailBL.DelKnowledgeLearnDetails(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/KnowledgeLearnDetailApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsKnowledgeLearnDetailBL.DelKnowledgeLearnDetails(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/KnowledgeLearnDetailApi/DelKnowledgeLearnDetailsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelKnowledgeLearnDetailsByCond")]
public ActionResult DelKnowledgeLearnDetailsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsKnowledgeLearnDetailBL.DelKnowledgeLearnDetailsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
