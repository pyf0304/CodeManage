...
{
 /// <summary>
 /// ge_KnowledgesUserMasterController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  ge_KnowledgesUserMasterApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objge_KnowledgesUserMasterEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsge_KnowledgesUserMasterEN> arrge_KnowledgesUserMasterObjLst = clsge_KnowledgesUserMasterBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesUserMasterObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsge_KnowledgesUserMasterEN> arrge_KnowledgesUserMasterObjLst = clsge_KnowledgesUserMasterBL.GetObjLstCache(strCourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesUserMasterObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/ge_KnowledgesUserMasterapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsge_KnowledgesUserMasterEN> arrge_KnowledgesUserMasterObjLst = clsge_KnowledgesUserMasterBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesUserMasterObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsge_KnowledgesUserMasterEN> arrge_KnowledgesUserMasterObjLst = clsge_KnowledgesUserMasterBL.GetObjLstByMIdLstCache(lstMId, CourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesUserMasterObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsge_KnowledgesUserMasterEN> arrge_KnowledgesUserMasterObjLst = clsge_KnowledgesUserMasterBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesUserMasterObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clsge_KnowledgesUserMasterBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterEN = clsge_KnowledgesUserMasterBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objge_KnowledgesUserMasterEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsge_KnowledgesUserMasterEN> arrge_KnowledgesUserMasterObjLst;
 try
 {
 arrge_KnowledgesUserMasterObjLst = clsge_KnowledgesUserMasterBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrge_KnowledgesUserMasterObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsge_KnowledgesUserMasterBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsge_KnowledgesUserMasterBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsge_KnowledgesUserMasterBL.SetFldValue(clsge_KnowledgesUserMasterEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsge_KnowledgesUserMasterBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/ge_KnowledgesUserMasterApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsge_KnowledgesUserMasterBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/ge_KnowledgesUserMasterApi/AddNewRecord
 /// 在Body区传输objge_KnowledgesUserMasterEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objge_KnowledgesUserMasterEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strge_KnowledgesUserMasterJSONObj = clsJSON.GetJsonFromObj(objge_KnowledgesUserMasterEN);
dictParam.Add("strge_KnowledgesUserMasterJSONObj", strge_KnowledgesUserMasterJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsge_KnowledgesUserMasterBL.AccessFldValueNull(objge_KnowledgesUserMasterEN);
bool bolResult = objge_KnowledgesUserMasterEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ge_KnowledgesUserMasterApi/AddNewRecordWithReturnKey
 /// 在Body区传输objge_KnowledgesUserMasterEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objge_KnowledgesUserMasterEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objge_KnowledgesUserMasterEN", JsonConvert.SerializeObject(objge_KnowledgesUserMasterEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsge_KnowledgesUserMasterBL.AccessFldValueNull(objge_KnowledgesUserMasterEN);
string strKey = clsge_KnowledgesUserMasterBL.AddNewRecordBySql2WithReturnKey(objge_KnowledgesUserMasterEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/ge_KnowledgesUserMasterApi/UpdateRecord
 /// 在Body区传输objge_KnowledgesUserMasterEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strge_KnowledgesUserMasterJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strge_KnowledgesUserMasterJSONObj = clsJSON.GetJsonFromObj(objge_KnowledgesUserMasterEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsge_KnowledgesUserMasterBL.SetUpdFlag(objge_KnowledgesUserMasterEN);
    clsge_KnowledgesUserMasterBL.AccessFldValueNull(objge_KnowledgesUserMasterEN);
bool bolResult = objge_KnowledgesUserMasterEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/ge_KnowledgesUserMasterApi/EditRecordEx
 /// 在Body区传输objge_KnowledgesUserMasterEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strge_KnowledgesUserMasterJSONObj = clsJSON.GetJsonFromObj(objge_KnowledgesUserMasterEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsge_KnowledgesUserMasterBL.SetUpdFlag(objge_KnowledgesUserMasterEN);
    clsge_KnowledgesUserMasterBL.AccessFldValueNull(objge_KnowledgesUserMasterEN);
bool bolResult = objge_KnowledgesUserMasterEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/ge_KnowledgesUserMasterApi/UpdateWithCondition
 /// 在Body区传输objge_KnowledgesUserMasterEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsge_KnowledgesUserMasterEN objge_KnowledgesUserMasterEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsge_KnowledgesUserMasterBL.AccessFldValueNull(objge_KnowledgesUserMasterEN);
bool bolResult = objge_KnowledgesUserMasterEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/ge_KnowledgesUserMasterApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsge_KnowledgesUserMasterBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ge_KnowledgesUserMasterApi/Delge_KnowledgesUserMasters
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("Delge_KnowledgesUserMasters")]
public ActionResult Delge_KnowledgesUserMasters([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsge_KnowledgesUserMasterBL.Delge_KnowledgesUserMasters(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ge_KnowledgesUserMasterApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsge_KnowledgesUserMasterBL.Delge_KnowledgesUserMasters(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/ge_KnowledgesUserMasterApi/Delge_KnowledgesUserMastersByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delge_KnowledgesUserMastersByCond")]
public ActionResult Delge_KnowledgesUserMastersByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsge_KnowledgesUserMasterBL.Delge_KnowledgesUserMastersByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
