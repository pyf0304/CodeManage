 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vQuestionNumByKnowledgeIdApiController
 表名:vQuestionNumByKnowledgeId(01120937)
 * 版本:2023.08.23.1(服务器:WIN-SRV103-116)
 日期:2023/08/24 15:17:23
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
{
 /// <summary>
 /// vQuestionNumByKnowledgeIdController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vQuestionNumByKnowledgeIdApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetObjByCourseKnowledgeId?CourseKnowledgeId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvQuestionNumByKnowledgeIdEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvQuestionNumByKnowledgeIdEN> arrvQuestionNumByKnowledgeIdObjLst = clsvQuestionNumByKnowledgeIdBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvQuestionNumByKnowledgeIdObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvQuestionNumByKnowledgeIdEN> arrvQuestionNumByKnowledgeIdObjLst = clsvQuestionNumByKnowledgeIdBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvQuestionNumByKnowledgeIdObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vQuestionNumByKnowledgeIdapi/GetObjLstByCourseKnowledgeIdLst
...
List<string> lstCourseKnowledgeId = new(arrCourseKnowledgeId);
 try
 {
List<clsvQuestionNumByKnowledgeIdEN> arrvQuestionNumByKnowledgeIdObjLst = clsvQuestionNumByKnowledgeIdBL.GetObjLstByCourseKnowledgeIdLst(lstCourseKnowledgeId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvQuestionNumByKnowledgeIdObjLst });
 }
 catch (Exception objException)
 {
...
public ActionResult GetObjLstByCourseKnowledgeIdLstCache([FromBody]string[] arrCourseKnowledgeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrCourseKnowledgeId);
...
List<string> lstCourseKnowledgeId = new(arrCourseKnowledgeId);
 try
 {
IEnumerable<clsvQuestionNumByKnowledgeIdEN> arrvQuestionNumByKnowledgeIdObjLst = clsvQuestionNumByKnowledgeIdBL.GetObjLstByCourseKnowledgeIdLstCache(lstCourseKnowledgeId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvQuestionNumByKnowledgeIdObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvQuestionNumByKnowledgeIdEN> arrvQuestionNumByKnowledgeIdObjLst = clsvQuestionNumByKnowledgeIdBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvQuestionNumByKnowledgeIdObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strCourseKnowledgeId = clsvQuestionNumByKnowledgeIdBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvQuestionNumByKnowledgeIdEN objvQuestionNumByKnowledgeIdEN = clsvQuestionNumByKnowledgeIdBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvQuestionNumByKnowledgeIdEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvQuestionNumByKnowledgeIdEN> arrvQuestionNumByKnowledgeIdObjLst;
 try
 {
 arrvQuestionNumByKnowledgeIdObjLst = clsvQuestionNumByKnowledgeIdBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvQuestionNumByKnowledgeIdObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvQuestionNumByKnowledgeIdBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvQuestionNumByKnowledgeIdBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvQuestionNumByKnowledgeIdBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vQuestionNumByKnowledgeIdApi/IsExist?CourseKnowledgeId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvQuestionNumByKnowledgeIdBL.IsExist(strCourseKnowledgeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
