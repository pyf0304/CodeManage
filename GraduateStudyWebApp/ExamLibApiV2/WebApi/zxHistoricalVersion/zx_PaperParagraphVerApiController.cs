 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:zx_PaperParagraphVerApiController
...
{
 /// <summary>
 /// zx_PaperParagraphVerController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  zx_PaperParagraphVerApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetObjByParagraphVId?ParagraphVId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objzx_PaperParagraphVerEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clszx_PaperParagraphVerEN> arrzx_PaperParagraphVerObjLst = clszx_PaperParagraphVerBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_PaperParagraphVerObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clszx_PaperParagraphVerEN> arrzx_PaperParagraphVerObjLst = clszx_PaperParagraphVerBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_PaperParagraphVerObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/zx_PaperParagraphVerapi/GetObjLstByParagraphVIdLst
...
List<long> lstParagraphVId = lstParagraphVId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clszx_PaperParagraphVerEN> arrzx_PaperParagraphVerObjLst = clszx_PaperParagraphVerBL.GetObjLstByParagraphVIdLst(lstParagraphVId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_PaperParagraphVerObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstParagraphVId = lstParagraphVId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clszx_PaperParagraphVerEN> arrzx_PaperParagraphVerObjLst = clszx_PaperParagraphVerBL.GetObjLstByParagraphVIdLstCache(lstParagraphVId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_PaperParagraphVerObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clszx_PaperParagraphVerEN> arrzx_PaperParagraphVerObjLst = clszx_PaperParagraphVerBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_PaperParagraphVerObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngParagraphVId = clszx_PaperParagraphVerBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clszx_PaperParagraphVerEN objzx_PaperParagraphVerEN = clszx_PaperParagraphVerBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objzx_PaperParagraphVerEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clszx_PaperParagraphVerEN> arrzx_PaperParagraphVerObjLst;
 try
 {
 arrzx_PaperParagraphVerObjLst = clszx_PaperParagraphVerBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_PaperParagraphVerObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clszx_PaperParagraphVerBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clszx_PaperParagraphVerBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clszx_PaperParagraphVerBL.SetFldValue(clszx_PaperParagraphVerEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clszx_PaperParagraphVerBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/zx_PaperParagraphVerApi/IsExist?ParagraphVId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clszx_PaperParagraphVerBL.IsExist(lngParagraphVId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/zx_PaperParagraphVerApi/AddNewRecord
 /// 在Body区传输objzx_PaperParagraphVerEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objzx_PaperParagraphVerEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clszx_PaperParagraphVerEN objzx_PaperParagraphVerEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strzx_PaperParagraphVerJSONObj = clsJSON.GetJsonFromObj(objzx_PaperParagraphVerEN);
dictParam.Add("strzx_PaperParagraphVerJSONObj", strzx_PaperParagraphVerJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clszx_PaperParagraphVerBL.AccessFldValueNull(objzx_PaperParagraphVerEN);
bool bolResult = objzx_PaperParagraphVerEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/zx_PaperParagraphVerApi/AddNewRecordWithReturnKey
 /// 在Body区传输objzx_PaperParagraphVerEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objzx_PaperParagraphVerEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clszx_PaperParagraphVerEN objzx_PaperParagraphVerEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objzx_PaperParagraphVerEN", JsonConvert.SerializeObject(objzx_PaperParagraphVerEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clszx_PaperParagraphVerBL.AccessFldValueNull(objzx_PaperParagraphVerEN);
string strKey = clszx_PaperParagraphVerBL.AddNewRecordBySql2WithReturnKey(objzx_PaperParagraphVerEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/zx_PaperParagraphVerApi/UpdateRecord
 /// 在Body区传输objzx_PaperParagraphVerEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strzx_PaperParagraphVerJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clszx_PaperParagraphVerEN objzx_PaperParagraphVerEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strzx_PaperParagraphVerJSONObj = clsJSON.GetJsonFromObj(objzx_PaperParagraphVerEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clszx_PaperParagraphVerBL.SetUpdFlag(objzx_PaperParagraphVerEN);
    clszx_PaperParagraphVerBL.AccessFldValueNull(objzx_PaperParagraphVerEN);
bool bolResult = objzx_PaperParagraphVerEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/zx_PaperParagraphVerApi/UpdateWithCondition
 /// 在Body区传输objzx_PaperParagraphVerEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clszx_PaperParagraphVerEN objzx_PaperParagraphVerEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clszx_PaperParagraphVerBL.AccessFldValueNull(objzx_PaperParagraphVerEN);
bool bolResult = objzx_PaperParagraphVerEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/zx_PaperParagraphVerApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clszx_PaperParagraphVerBL.DelRecord(lngParagraphVId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/zx_PaperParagraphVerApi/Delzx_PaperParagraphVers
 ...
 /// <returns>返回删除的记录数</returns>
[HttpPost("Delzx_PaperParagraphVers")]
public ActionResult Delzx_PaperParagraphVers([FromBody]string[] arrParagraphVId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrParagraphVId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clszx_PaperParagraphVerBL.Delzx_PaperParagraphVers(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/zx_PaperParagraphVerApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clszx_PaperParagraphVerBL.Delzx_PaperParagraphVers(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/zx_PaperParagraphVerApi/Delzx_PaperParagraphVersByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delzx_PaperParagraphVersByCond")]
public ActionResult Delzx_PaperParagraphVersByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clszx_PaperParagraphVerBL.Delzx_PaperParagraphVersByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
