...
{
 /// <summary>
 /// zx_QuestionsController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  zx_QuestionsApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/zx_QuestionsApi/GetObjByzxQuestionsId?zxQuestionsId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId)
 /// </summary>
 /// <param name = "strzxQuestionsId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjByzxQuestionsId")]
public ActionResult GetObjByzxQuestionsId(string strzxQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
["strzxQuestionsId"] = strzxQuestionsId,
 };
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objzx_QuestionsEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/zx_QuestionsApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clszx_QuestionsEN> arrzx_QuestionsObjLst = clszx_QuestionsBL.GetObjLst(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/zx_QuestionsApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clszx_QuestionsEN> arrzx_QuestionsObjLst = clszx_QuestionsBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_QuestionsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/zx_Questionsapi/GetObjLstByZxQuestionsIdLst
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjLstByKeyLst)
 /// </summary>
 /// <param name = "arrZxQuestionsIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByZxQuestionsIdLst")]
public ActionResult GetObjLstByZxQuestionsIdLst([FromBody]string[] arrZxQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrZxQuestionsId);
dictParam.Add("arrzxQuestionsId", clsArray.GetSqlInStrByArray(arrLst, true));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
if (arrZxQuestionsId.Length == 0)
{
string strMsg = string.Format("根据关键字列表串获取对象列表时,给定的关键字值列表的JSON串不能为空!({0})", clsStackTrace.GetCurrClassFunction());
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
return Ok(new { errorId = 1, errorMsg = strMsg });
}
List<string> lstZxQuestionsId = new(arrZxQuestionsId);
 try
 {
List<clszx_QuestionsEN> arrzx_QuestionsObjLst = clszx_QuestionsBL.GetObjLstByZxQuestionsIdLst(lstZxQuestionsId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_QuestionsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrZxQuestionsIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstByZxQuestionsIdLstCache")]
public ActionResult GetObjLstByZxQuestionsIdLstCache([FromBody]string[] arrZxQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrZxQuestionsId);
...
List<string> lstZxQuestionsId = new(arrZxQuestionsId);
 try
 {
IEnumerable<clszx_QuestionsEN> arrzx_QuestionsObjLst = clszx_QuestionsBL.GetObjLstByZxQuestionsIdLstCache(lstZxQuestionsId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_QuestionsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/zx_QuestionsApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clszx_QuestionsEN> arrzx_QuestionsObjLst = clszx_QuestionsBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_QuestionsObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/zx_QuestionsApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strzxQuestionsId = clszx_QuestionsBL.GetFirstID_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnStr = strzxQuestionsId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/zx_QuestionsApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clszx_QuestionsEN objzx_QuestionsEN = clszx_QuestionsBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objzx_QuestionsEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/zx_QuestionsApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clszx_QuestionsEN> arrzx_QuestionsObjLst;
 try
 {
 arrzx_QuestionsObjLst = clszx_QuestionsBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrzx_QuestionsObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/zx_QuestionsApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clszx_QuestionsBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/zx_QuestionsApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clszx_QuestionsBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/zx_QuestionsApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clszx_QuestionsBL.SetFldValue(clszx_QuestionsEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/zx_QuestionsApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clszx_QuestionsBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/zx_QuestionsApi/IsExist?zxQuestionsId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strzxQuestionsId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strzxQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clszx_QuestionsBL.IsExist(strzxQuestionsId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/zx_QuestionsApi/GetMaxStrId?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
string strMaxstrzxQuestionsId = clszx_QuestionsBL.GetMaxStrId_S();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strMaxstrzxQuestionsId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/zx_QuestionsApi/AddNewRecord
 /// 在Body区传输objzx_QuestionsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objzx_QuestionsEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clszx_QuestionsEN objzx_QuestionsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strzx_QuestionsJSONObj = clsJSON.GetJsonFromObj(objzx_QuestionsEN);
dictParam.Add("strzx_QuestionsJSONObj", strzx_QuestionsJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clszx_QuestionsEN objzx_QuestionsCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 if (string.IsNullOrEmpty(objzx_QuestionsEN.zxQuestionsId) == true || clszx_QuestionsBL.IsExist(objzx_QuestionsEN.zxQuestionsId) == true)
 {
    ...
    clszx_QuestionsBL.AccessFldValueNull(objzx_QuestionsEN);
bool bolResult = objzx_QuestionsEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/zx_QuestionsApi/AddNewRecordWithMaxId
 /// 在Body区传输objzx_QuestionsEN的JSON对象
...
public ActionResult AddNewRecordWithMaxId([FromBody]clszx_QuestionsEN objzx_QuestionsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strzx_QuestionsJSONObj = clsJSON.GetJsonFromObj(objzx_QuestionsEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 {
    clszx_QuestionsBL.AccessFldValueNull(objzx_QuestionsEN);
string strzxQuestionsId = objzx_QuestionsEN.AddNewRecordWithMaxId();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strzxQuestionsId });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/zx_QuestionsApi/AddNewRecordWithReturnKey
 /// 在Body区传输objzx_QuestionsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objzx_QuestionsEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clszx_QuestionsEN objzx_QuestionsEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objzx_QuestionsEN", JsonConvert.SerializeObject(objzx_QuestionsEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clszx_QuestionsBL.AccessFldValueNull(objzx_QuestionsEN);
string strKey = clszx_QuestionsBL.AddNewRecordBySql2WithReturnKey(objzx_QuestionsEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/zx_QuestionsApi/UpdateRecord
 /// 在Body区传输objzx_QuestionsEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strzx_QuestionsJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clszx_QuestionsEN objzx_QuestionsEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strzx_QuestionsJSONObj = clsJSON.GetJsonFromObj(objzx_QuestionsEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clszx_QuestionsBL.SetUpdFlag(objzx_QuestionsEN);
    clszx_QuestionsBL.AccessFldValueNull(objzx_QuestionsEN);
bool bolResult = objzx_QuestionsEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/zx_QuestionsApi/GoTop
...
List<string> lstzxQuestionsId = new(objOrderByData.KeyIdLst);
try
{
bool bolResult = clszx_QuestionsBL.GoTop(lstzxQuestionsId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/zx_QuestionsApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
foreach(var x in lstzxQuestionsId)
{
clszx_QuestionsBL.AdjustOrderNum("UP", x);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/zx_QuestionsApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
List<string> lstzxQuestionsId = new(objOrderByData.KeyIdLst);
lstzxQuestionsId.Reverse();
try
{
foreach(var x in lstzxQuestionsId)
{
clszx_QuestionsBL.AdjustOrderNum("DOWN", x);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/zx_QuestionsApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
bool bolResult = clszx_QuestionsBL.GoBottom(lstzxQuestionsId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/zx_QuestionsApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
bool bolResult = clszx_QuestionsBL.ReOrder();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/zx_QuestionsApi/UpdateWithCondition
 /// 在Body区传输objzx_QuestionsEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clszx_QuestionsEN objzx_QuestionsEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clszx_QuestionsBL.AccessFldValueNull(objzx_QuestionsEN);
bool bolResult = objzx_QuestionsEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/zx_QuestionsApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clszx_QuestionsBL.DelRecord(strzxQuestionsId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/zx_QuestionsApi/Delzx_Questionss
 /// 在Body区传输arrzxQuestionsId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrzxQuestionsId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("Delzx_Questionss")]
public ActionResult Delzx_Questionss([FromBody]string[] arrzxQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrzxQuestionsId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clszx_QuestionsBL.Delzx_Questionss(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/zx_QuestionsApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clszx_QuestionsBL.Delzx_Questionss(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/zx_QuestionsApi/Delzx_QuestionssByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delzx_QuestionssByCond")]
public ActionResult Delzx_QuestionssByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clszx_QuestionsBL.Delzx_QuestionssByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
