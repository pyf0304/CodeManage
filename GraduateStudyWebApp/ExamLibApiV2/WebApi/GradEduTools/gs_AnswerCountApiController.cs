...
{
 /// <summary>
 /// gs_AnswerCountController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  gs_AnswerCountApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/gs_AnswerCountApi/GetObjByAnswerCountId?AnswerCountId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objgs_AnswerCountEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/gs_AnswerCountApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsgs_AnswerCountEN> arrgs_AnswerCountObjLst = clsgs_AnswerCountBL.GetObjLst(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/gs_AnswerCountApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsgs_AnswerCountEN> arrgs_AnswerCountObjLst = clsgs_AnswerCountBL.GetObjLstCache(strIdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_AnswerCountObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/gs_AnswerCountapi/GetObjLstByAnswerCountIdLst
...
List<string> lstAnswerCountId = new(arrAnswerCountId);
 try
 {
List<clsgs_AnswerCountEN> arrgs_AnswerCountObjLst = clsgs_AnswerCountBL.GetObjLstByAnswerCountIdLst(lstAnswerCountId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_AnswerCountObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstAnswerCountId = new(arrAnswerCountId);
 try
 {
IEnumerable<clsgs_AnswerCountEN> arrgs_AnswerCountObjLst = clsgs_AnswerCountBL.GetObjLstByAnswerCountIdLstCache(lstAnswerCountId, IdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_AnswerCountObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/gs_AnswerCountApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsgs_AnswerCountEN> arrgs_AnswerCountObjLst = clsgs_AnswerCountBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_AnswerCountObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/gs_AnswerCountApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strAnswerCountId = clsgs_AnswerCountBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/gs_AnswerCountApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsgs_AnswerCountEN objgs_AnswerCountEN = clsgs_AnswerCountBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objgs_AnswerCountEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/gs_AnswerCountApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsgs_AnswerCountEN> arrgs_AnswerCountObjLst;
 try
 {
 arrgs_AnswerCountObjLst = clsgs_AnswerCountBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_AnswerCountObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/gs_AnswerCountApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsgs_AnswerCountBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/gs_AnswerCountApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsgs_AnswerCountBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/gs_AnswerCountApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsgs_AnswerCountBL.SetFldValue(clsgs_AnswerCountEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/gs_AnswerCountApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsgs_AnswerCountBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/gs_AnswerCountApi/IsExist?AnswerCountId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsgs_AnswerCountBL.IsExist(strAnswerCountId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/gs_AnswerCountApi/GetMaxStrId?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
string strMaxstrAnswerCountId = clsgs_AnswerCountBL.GetMaxStrId_S();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/gs_AnswerCountApi/AddNewRecord
...
public ActionResult AddNewRecord([FromBody]clsgs_AnswerCountEN objgs_AnswerCountEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 if (string.IsNullOrEmpty(objgs_AnswerCountEN.AnswerCountId) == true || clsgs_AnswerCountBL.IsExist(objgs_AnswerCountEN.AnswerCountId) == true)
 {
    ...
    clsgs_AnswerCountBL.AccessFldValueNull(objgs_AnswerCountEN);
bool bolResult = objgs_AnswerCountEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/gs_AnswerCountApi/AddNewRecordWithReturnKey
 /// 在Body区传输objgs_AnswerCountEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objgs_AnswerCountEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsgs_AnswerCountEN objgs_AnswerCountEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objgs_AnswerCountEN", JsonConvert.SerializeObject(objgs_AnswerCountEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsgs_AnswerCountBL.AccessFldValueNull(objgs_AnswerCountEN);
string strKey = clsgs_AnswerCountBL.AddNewRecordBySql2WithReturnKey(objgs_AnswerCountEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/gs_AnswerCountApi/UpdateRecord
 /// 在Body区传输objgs_AnswerCountEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strgs_AnswerCountJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsgs_AnswerCountEN objgs_AnswerCountEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strgs_AnswerCountJSONObj = clsJSON.GetJsonFromObj(objgs_AnswerCountEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsgs_AnswerCountBL.SetUpdFlag(objgs_AnswerCountEN);
    clsgs_AnswerCountBL.AccessFldValueNull(objgs_AnswerCountEN);
bool bolResult = objgs_AnswerCountEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/gs_AnswerCountApi/EditRecordEx
 /// 在Body区传输objgs_AnswerCountEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsgs_AnswerCountEN objgs_AnswerCountEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strgs_AnswerCountJSONObj = clsJSON.GetJsonFromObj(objgs_AnswerCountEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsgs_AnswerCountBL.SetUpdFlag(objgs_AnswerCountEN);
    clsgs_AnswerCountBL.AccessFldValueNull(objgs_AnswerCountEN);
bool bolResult = objgs_AnswerCountEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/gs_AnswerCountApi/UpdateWithCondition
 /// 在Body区传输objgs_AnswerCountEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsgs_AnswerCountEN objgs_AnswerCountEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsgs_AnswerCountBL.AccessFldValueNull(objgs_AnswerCountEN);
bool bolResult = objgs_AnswerCountEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/gs_AnswerCountApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsgs_AnswerCountBL.DelRecord(strAnswerCountId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/gs_AnswerCountApi/Delgs_AnswerCounts
 ...
 /// <returns>返回删除的记录数</returns>
[HttpPost("Delgs_AnswerCounts")]
public ActionResult Delgs_AnswerCounts([FromBody]string[] arrAnswerCountId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrAnswerCountId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsgs_AnswerCountBL.Delgs_AnswerCounts(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/gs_AnswerCountApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsgs_AnswerCountBL.Delgs_AnswerCounts(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/gs_AnswerCountApi/Delgs_AnswerCountsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delgs_AnswerCountsByCond")]
public ActionResult Delgs_AnswerCountsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsgs_AnswerCountBL.Delgs_AnswerCountsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
