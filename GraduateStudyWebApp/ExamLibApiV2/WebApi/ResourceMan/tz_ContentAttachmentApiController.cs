 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:tz_ContentAttachmentApiController
...
{
 /// <summary>
 /// tz_ContentAttachmentController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  tz_ContentAttachmentApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objtz_ContentAttachmentEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst = clstz_ContentAttachmentBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_ContentAttachmentObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst = clstz_ContentAttachmentBL.GetObjLstCache(strCourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_ContentAttachmentObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/tz_ContentAttachmentapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst = clstz_ContentAttachmentBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_ContentAttachmentObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst = clstz_ContentAttachmentBL.GetObjLstByMIdLstCache(lstMId, CourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_ContentAttachmentObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst = clstz_ContentAttachmentBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_ContentAttachmentObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clstz_ContentAttachmentBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clstz_ContentAttachmentEN objtz_ContentAttachmentEN = clstz_ContentAttachmentBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objtz_ContentAttachmentEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst;
 try
 {
 arrtz_ContentAttachmentObjLst = clstz_ContentAttachmentBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrtz_ContentAttachmentObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clstz_ContentAttachmentBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/tz_ContentAttachmentApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clstz_ContentAttachmentBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/tz_ContentAttachmentApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clstz_ContentAttachmentBL.SetFldValue(clstz_ContentAttachmentEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/tz_ContentAttachmentApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clstz_ContentAttachmentBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/tz_ContentAttachmentApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clstz_ContentAttachmentBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/tz_ContentAttachmentApi/AddNewRecord
 /// 在Body区传输objtz_ContentAttachmentEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objtz_ContentAttachmentEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clstz_ContentAttachmentEN objtz_ContentAttachmentEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strtz_ContentAttachmentJSONObj = clsJSON.GetJsonFromObj(objtz_ContentAttachmentEN);
dictParam.Add("strtz_ContentAttachmentJSONObj", strtz_ContentAttachmentJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clstz_ContentAttachmentEN objtz_ContentAttachmentCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clstz_ContentAttachmentBL.AccessFldValueNull(objtz_ContentAttachmentEN);
bool bolResult = objtz_ContentAttachmentEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/tz_ContentAttachmentApi/AddNewRecordWithReturnKey
 /// 在Body区传输objtz_ContentAttachmentEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clstz_ContentAttachmentEN objtz_ContentAttachmentEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objtz_ContentAttachmentEN", JsonConvert.SerializeObject(objtz_ContentAttachmentEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clstz_ContentAttachmentBL.AccessFldValueNull(objtz_ContentAttachmentEN);
string strKey = clstz_ContentAttachmentBL.AddNewRecordBySql2WithReturnKey(objtz_ContentAttachmentEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/tz_ContentAttachmentApi/UpdateRecord
 /// 在Body区传输objtz_ContentAttachmentEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strtz_ContentAttachmentJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clstz_ContentAttachmentEN objtz_ContentAttachmentEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strtz_ContentAttachmentJSONObj = clsJSON.GetJsonFromObj(objtz_ContentAttachmentEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clstz_ContentAttachmentBL.SetUpdFlag(objtz_ContentAttachmentEN);
    clstz_ContentAttachmentBL.AccessFldValueNull(objtz_ContentAttachmentEN);
bool bolResult = objtz_ContentAttachmentEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/tz_ContentAttachmentApi/EditRecordEx
 /// 在Body区传输objtz_ContentAttachmentEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clstz_ContentAttachmentEN objtz_ContentAttachmentEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strtz_ContentAttachmentJSONObj = clsJSON.GetJsonFromObj(objtz_ContentAttachmentEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clstz_ContentAttachmentBL.SetUpdFlag(objtz_ContentAttachmentEN);
    clstz_ContentAttachmentBL.AccessFldValueNull(objtz_ContentAttachmentEN);
bool bolResult = objtz_ContentAttachmentEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/tz_ContentAttachmentApi/GoTop
...
if (jobjOrderByData.ContainsKey("tableNameKey"))
{
strTableNameKey = jobjOrderByData["tableNameKey"].ToString();
}
else if (jobjOrderByData.ContainsKey("tablenamekey"))
{
strTableNameKey = jobjOrderByData["tablenamekey"].ToString();
}
else
{
string strMsg = string.Format("在从前台传来的OrderByData的数据中不存在关键字:[tableNameKey]的数据,请检查!", "tableNameKey|tablenamekey");
return Ok(new { errorId = 1, errorMsg = strMsg });
}
bool bolResult = clstz_ContentAttachmentBL.GoTop(lstmId ,strTableNameKey);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/tz_ContentAttachmentApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clstz_ContentAttachmentBL.AdjustOrderNum("UP", x ,strTableNameKey);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/tz_ContentAttachmentApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clstz_ContentAttachmentBL.AdjustOrderNum("DOWN", x ,strTableNameKey);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/tz_ContentAttachmentApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clstz_ContentAttachmentBL.GoBottom(lstmId ,strTableNameKey);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/tz_ContentAttachmentApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clstz_ContentAttachmentBL.ReOrder(strTableNameKey);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/tz_ContentAttachmentApi/UpdateWithCondition
 /// 在Body区传输objtz_ContentAttachmentEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clstz_ContentAttachmentEN objtz_ContentAttachmentEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clstz_ContentAttachmentBL.AccessFldValueNull(objtz_ContentAttachmentEN);
bool bolResult = objtz_ContentAttachmentEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/tz_ContentAttachmentApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clstz_ContentAttachmentBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/tz_ContentAttachmentApi/Deltz_ContentAttachments
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("Deltz_ContentAttachments")]
public ActionResult Deltz_ContentAttachments([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clstz_ContentAttachmentBL.Deltz_ContentAttachments(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/tz_ContentAttachmentApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clstz_ContentAttachmentBL.Deltz_ContentAttachments(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/tz_ContentAttachmentApi/Deltz_ContentAttachmentsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Deltz_ContentAttachmentsByCond")]
public ActionResult Deltz_ContentAttachmentsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clstz_ContentAttachmentBL.Deltz_ContentAttachmentsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
