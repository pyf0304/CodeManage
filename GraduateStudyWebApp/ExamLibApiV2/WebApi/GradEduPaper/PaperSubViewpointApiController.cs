...
{
 /// <summary>
 /// PaperSubViewpointController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  PaperSubViewpointApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/PaperSubViewpointApi/GetObjBySubViewpointId?SubViewpointId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjByKeyId)
 /// </summary>
 /// <param name = "lngSubViewpointId">表关键字</param>
 /// <returns>表对象</returns>
[HttpGet("GetObjBySubViewpointId")]
public ActionResult GetObjBySubViewpointId(long lngSubViewpointId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
["lngSubViewpointId"] = lngSubViewpointId.ToString(),
 };
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objPaperSubViewpointEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/PaperSubViewpointApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsPaperSubViewpointEN> arrPaperSubViewpointObjLst = clsPaperSubViewpointBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPaperSubViewpointObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/PaperSubViewpointApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsPaperSubViewpointEN> arrPaperSubViewpointObjLst = clsPaperSubViewpointBL.GetObjLstCache(strIdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPaperSubViewpointObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/PaperSubViewpointapi/GetObjLstBySubViewpointIdLst
 /// (AutoGCLib.WA_Srv4CSharp:Gen_GetObjLstByKeyLst)
 /// </summary>
 /// <param name = "arrSubViewpointIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstBySubViewpointIdLst")]
public ActionResult GetObjLstBySubViewpointIdLst([FromBody]string[] arrSubViewpointId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrSubViewpointId);
dictParam.Add("arrSubViewpointId", clsArray.GetSqlInStrByArray(arrLst, true));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
if (arrSubViewpointId.Length == 0)
{
string strMsg = string.Format("根据关键字列表串获取对象列表时,给定的关键字值列表的JSON串不能为空!({0})", clsStackTrace.GetCurrClassFunction());
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
return Ok(new { errorId = 1, errorMsg = strMsg });
}
List<string> lstSubViewpointId_Str = new List<string>(arrSubViewpointId);
List<long> lstSubViewpointId = lstSubViewpointId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsPaperSubViewpointEN> arrPaperSubViewpointObjLst = clsPaperSubViewpointBL.GetObjLstBySubViewpointIdLst(lstSubViewpointId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPaperSubViewpointObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <param name = "arrSubViewpointIdLst">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
[HttpPost("GetObjLstBySubViewpointIdLstCache")]
public ActionResult GetObjLstBySubViewpointIdLstCache([FromBody]string[] arrSubViewpointId, string IdCurrEduCls)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrSubViewpointId);
...
List<long> lstSubViewpointId = lstSubViewpointId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsPaperSubViewpointEN> arrPaperSubViewpointObjLst = clsPaperSubViewpointBL.GetObjLstBySubViewpointIdLstCache(lstSubViewpointId, IdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPaperSubViewpointObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/PaperSubViewpointApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsPaperSubViewpointEN> arrPaperSubViewpointObjLst = clsPaperSubViewpointBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPaperSubViewpointObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PaperSubViewpointApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngSubViewpointId = clsPaperSubViewpointBL.GetFirstID_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnStr = lngSubViewpointId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/PaperSubViewpointApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsPaperSubViewpointEN objPaperSubViewpointEN = clsPaperSubViewpointBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objPaperSubViewpointEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/PaperSubViewpointApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsPaperSubViewpointEN> arrPaperSubViewpointObjLst;
 try
 {
 arrPaperSubViewpointObjLst = clsPaperSubViewpointBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPaperSubViewpointObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/PaperSubViewpointApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsPaperSubViewpointBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PaperSubViewpointApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsPaperSubViewpointBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/PaperSubViewpointApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsPaperSubViewpointBL.SetFldValue(clsPaperSubViewpointEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/PaperSubViewpointApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsPaperSubViewpointBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/PaperSubViewpointApi/IsExist?SubViewpointId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "lngSubViewpointId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(long lngSubViewpointId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsPaperSubViewpointBL.IsExist(lngSubViewpointId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
public ActionResult AddNewRecord([FromBody]clsPaperSubViewpointEN objPaperSubViewpointEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsPaperSubViewpointEN objPaperSubViewpointCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clsPaperSubViewpointBL.AccessFldValueNull(objPaperSubViewpointEN);
bool bolResult = objPaperSubViewpointEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PaperSubViewpointApi/AddNewRecordWithReturnKey
 /// 在Body区传输objPaperSubViewpointEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clsPaperSubViewpointEN objPaperSubViewpointEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objPaperSubViewpointEN", JsonConvert.SerializeObject(objPaperSubViewpointEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
...
public ActionResult UpdateRecord([FromBody]clsPaperSubViewpointEN objPaperSubViewpointEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPaperSubViewpointJSONObj = clsJSON.GetJsonFromObj(objPaperSubViewpointEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/PaperSubViewpointApi/EditRecordEx
 /// 在Body区传输objPaperSubViewpointEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsPaperSubViewpointEN objPaperSubViewpointEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPaperSubViewpointJSONObj = clsJSON.GetJsonFromObj(objPaperSubViewpointEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsPaperSubViewpointBL.SetUpdFlag(objPaperSubViewpointEN);
    clsPaperSubViewpointBL.AccessFldValueNull(objPaperSubViewpointEN);
bool bolResult = objPaperSubViewpointEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/PaperSubViewpointApi/GoTop
...
List<string> lstSubViewpointId_T = new(objOrderByData.KeyIdLst);
List<long> lstSubViewpointId = lstSubViewpointId_T.Select(x=>long.Parse(x)).ToList();
try
{
JObject jobjOrderByData = JObject.Parse(objOrderByData.ClassificationFieldValueLst);

string strPaperRWId = "";
if (jobjOrderByData.ContainsKey("paperRWId"))
{
strPaperRWId = jobjOrderByData["paperRWId"].ToString();
}
else if (jobjOrderByData.ContainsKey("paperrwid"))
{
strPaperRWId = jobjOrderByData["paperrwid"].ToString();
}
else
{
string strMsg = string.Format("在从前台传来的OrderByData的数据中不存在关键字:[paperRWId]的数据,请检查!", "paperRWId|paperrwid");
return Ok(new { errorId = 1, errorMsg = strMsg });
}

string strSubViewpointTypeId = "";
if (jobjOrderByData.ContainsKey("subViewpointTypeId"))
{
strSubViewpointTypeId = jobjOrderByData["subViewpointTypeId"].ToString();
}
else if (jobjOrderByData.ContainsKey("subviewpointtypeid"))
{
strSubViewpointTypeId = jobjOrderByData["subviewpointtypeid"].ToString();
}
else
{
string strMsg = string.Format("在从前台传来的OrderByData的数据中不存在关键字:[subViewpointTypeId]的数据,请检查!", "subViewpointTypeId|subviewpointtypeid");
return Ok(new { errorId = 1, errorMsg = strMsg });
}
bool bolResult = clsPaperSubViewpointBL.GoTop(lstSubViewpointId ,strPaperRWId,strSubViewpointTypeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/PaperSubViewpointApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
foreach(var x in lstSubViewpointId)
{
JObject jobjOrderByData = JObject.Parse(objOrderByData.ClassificationFieldValueLst);
...
clsPaperSubViewpointBL.AdjustOrderNum("UP", x ,strPaperRWId,strSubViewpointTypeId);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/PaperSubViewpointApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
clsPaperSubViewpointBL.AdjustOrderNum("DOWN", x ,strPaperRWId,strSubViewpointTypeId);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/PaperSubViewpointApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clsPaperSubViewpointBL.GoBottom(lstSubViewpointId ,strPaperRWId,strSubViewpointTypeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/PaperSubViewpointApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
bool bolResult = clsPaperSubViewpointBL.ReOrder(strPaperRWId,strSubViewpointTypeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/PaperSubViewpointApi/UpdateWithCondition
 /// 在Body区传输objPaperSubViewpointEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsPaperSubViewpointEN objPaperSubViewpointEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsPaperSubViewpointBL.AccessFldValueNull(objPaperSubViewpointEN);
bool bolResult = objPaperSubViewpointEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
{
long lngSubViewpointId = Id;
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
["Id"] = lngSubViewpointId.ToString()
 };
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 if (lngSubViewpointId <= 0)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPaperSubViewpointBL.DelRecord(lngSubViewpointId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelPaperSubViewpoints")]
public ActionResult DelPaperSubViewpoints([FromBody]string[] arrSubViewpointId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrSubViewpointId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPaperSubViewpointBL.DelPaperSubViewpoints(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/PaperSubViewpointApi/DelPaperSubViewpointsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelPaperSubViewpointsByCond")]
public ActionResult DelPaperSubViewpointsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPaperSubViewpointBL.DelPaperSubViewpointsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
