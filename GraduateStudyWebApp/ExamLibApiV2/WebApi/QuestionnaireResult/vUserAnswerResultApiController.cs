 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vUserAnswerResultApiController
 表名:vUserAnswerResult(01120022)
 * 版本:2024.11.08.1(服务器:WIN-SRV103-116)
 日期:2024/11/10 05:50:37
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
{
 /// <summary>
 /// vUserAnswerResultController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vUserAnswerResultApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vUserAnswerResultApi/GetObjByMinId?MinId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
clsvUserAnswerResultEN objvUserAnswerResultEN = clsvUserAnswerResultBL.GetObjByMinId(lngMinId);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvUserAnswerResultEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vUserAnswerResultApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvUserAnswerResultEN> arrvUserAnswerResultObjLst = clsvUserAnswerResultBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvUserAnswerResultObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vUserAnswerResultApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvUserAnswerResultEN> arrvUserAnswerResultObjLst = clsvUserAnswerResultBL.GetObjLstCache(strCourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvUserAnswerResultObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vUserAnswerResultapi/GetObjLstByMinIdLst
...
List<long> lstMinId = lstMinId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsvUserAnswerResultEN> arrvUserAnswerResultObjLst = clsvUserAnswerResultBL.GetObjLstByMinIdLst(lstMinId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvUserAnswerResultObjLst });
 }
 catch (Exception objException)
 {
...
public ActionResult GetObjLstByMinIdLstCache([FromBody]string[] arrMinId, string CourseId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrMinId);
...
List<long> lstMinId = lstMinId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsvUserAnswerResultEN> arrvUserAnswerResultObjLst = clsvUserAnswerResultBL.GetObjLstByMinIdLstCache(lstMinId, CourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvUserAnswerResultObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vUserAnswerResultApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvUserAnswerResultEN> arrvUserAnswerResultObjLst = clsvUserAnswerResultBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvUserAnswerResultObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vUserAnswerResultApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngMinId = clsvUserAnswerResultBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vUserAnswerResultApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvUserAnswerResultEN objvUserAnswerResultEN = clsvUserAnswerResultBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvUserAnswerResultEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vUserAnswerResultApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvUserAnswerResultEN> arrvUserAnswerResultObjLst;
 try
 {
 arrvUserAnswerResultObjLst = clsvUserAnswerResultBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvUserAnswerResultObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vUserAnswerResultApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvUserAnswerResultBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vUserAnswerResultApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvUserAnswerResultBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vUserAnswerResultApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvUserAnswerResultBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vUserAnswerResultApi/IsExist?MinId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvUserAnswerResultBL.IsExist(lngMinId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
