 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vCourseLearningCaseApiController
 表名:vCourseLearningCase(01120267)
 * 版本:2024.02.19.1(服务器:WIN-SRV103-116)
 日期:2024/02/27 16:06:42
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
{
 /// <summary>
 /// vCourseLearningCaseController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vCourseLearningCaseApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetObjByIdCourseLearningCase?IdCourseLearningCase=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvCourseLearningCaseEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvCourseLearningCaseEN> arrvCourseLearningCaseObjLst = clsvCourseLearningCaseBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvCourseLearningCaseObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvCourseLearningCaseEN> arrvCourseLearningCaseObjLst = clsvCourseLearningCaseBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvCourseLearningCaseObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vCourseLearningCaseapi/GetObjLstByIdCourseLearningCaseLst
...
List<string> lstIdCourseLearningCase = new(arrIdCourseLearningCase);
 try
 {
List<clsvCourseLearningCaseEN> arrvCourseLearningCaseObjLst = clsvCourseLearningCaseBL.GetObjLstByIdCourseLearningCaseLst(lstIdCourseLearningCase);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvCourseLearningCaseObjLst });
 }
 catch (Exception objException)
 {
...
public ActionResult GetObjLstByIdCourseLearningCaseLstCache([FromBody]string[] arrIdCourseLearningCase)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrIdCourseLearningCase);
...
List<string> lstIdCourseLearningCase = new(arrIdCourseLearningCase);
 try
 {
IEnumerable<clsvCourseLearningCaseEN> arrvCourseLearningCaseObjLst = clsvCourseLearningCaseBL.GetObjLstByIdCourseLearningCaseLstCache(lstIdCourseLearningCase);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvCourseLearningCaseObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvCourseLearningCaseEN> arrvCourseLearningCaseObjLst = clsvCourseLearningCaseBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvCourseLearningCaseObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strIdCourseLearningCase = clsvCourseLearningCaseBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvCourseLearningCaseEN objvCourseLearningCaseEN = clsvCourseLearningCaseBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvCourseLearningCaseEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvCourseLearningCaseEN> arrvCourseLearningCaseObjLst;
 try
 {
 arrvCourseLearningCaseObjLst = clsvCourseLearningCaseBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvCourseLearningCaseObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvCourseLearningCaseBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vCourseLearningCaseApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvCourseLearningCaseBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vCourseLearningCaseApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvCourseLearningCaseBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vCourseLearningCaseApi/IsExist?IdCourseLearningCase=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvCourseLearningCaseBL.IsExist(strIdCourseLearningCase);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
