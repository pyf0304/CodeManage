...
{
 /// <summary>
 /// cc_WorkStuRelation4GoodLibController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  cc_WorkStuRelation4GoodLibApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetObjBymId?mId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objcc_WorkStuRelation4GoodLibEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clscc_WorkStuRelation4GoodLibEN> arrcc_WorkStuRelation4GoodLibObjLst = clscc_WorkStuRelation4GoodLibBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrcc_WorkStuRelation4GoodLibObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clscc_WorkStuRelation4GoodLibEN> arrcc_WorkStuRelation4GoodLibObjLst = clscc_WorkStuRelation4GoodLibBL.GetObjLstCache(strCourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrcc_WorkStuRelation4GoodLibObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/cc_WorkStuRelation4GoodLibapi/GetObjLstByMIdLst
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clscc_WorkStuRelation4GoodLibEN> arrcc_WorkStuRelation4GoodLibObjLst = clscc_WorkStuRelation4GoodLibBL.GetObjLstByMIdLst(lstMId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrcc_WorkStuRelation4GoodLibObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMId = lstMId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clscc_WorkStuRelation4GoodLibEN> arrcc_WorkStuRelation4GoodLibObjLst = clscc_WorkStuRelation4GoodLibBL.GetObjLstByMIdLstCache(lstMId, CourseId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrcc_WorkStuRelation4GoodLibObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clscc_WorkStuRelation4GoodLibEN> arrcc_WorkStuRelation4GoodLibObjLst = clscc_WorkStuRelation4GoodLibBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrcc_WorkStuRelation4GoodLibObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngmId = clscc_WorkStuRelation4GoodLibBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibEN = clscc_WorkStuRelation4GoodLibBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objcc_WorkStuRelation4GoodLibEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clscc_WorkStuRelation4GoodLibEN> arrcc_WorkStuRelation4GoodLibObjLst;
 try
 {
 arrcc_WorkStuRelation4GoodLibObjLst = clscc_WorkStuRelation4GoodLibBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrcc_WorkStuRelation4GoodLibObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clscc_WorkStuRelation4GoodLibBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clscc_WorkStuRelation4GoodLibBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clscc_WorkStuRelation4GoodLibBL.SetFldValue(clscc_WorkStuRelation4GoodLibEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clscc_WorkStuRelation4GoodLibBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/cc_WorkStuRelation4GoodLibApi/IsExist?mId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clscc_WorkStuRelation4GoodLibBL.IsExist(lngmId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/cc_WorkStuRelation4GoodLibApi/AddNewRecord
 /// 在Body区传输objcc_WorkStuRelation4GoodLibEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objcc_WorkStuRelation4GoodLibEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strcc_WorkStuRelation4GoodLibJSONObj = clsJSON.GetJsonFromObj(objcc_WorkStuRelation4GoodLibEN);
dictParam.Add("strcc_WorkStuRelation4GoodLibJSONObj", strcc_WorkStuRelation4GoodLibJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibCond = new();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
    ...
    clscc_WorkStuRelation4GoodLibBL.AccessFldValueNull(objcc_WorkStuRelation4GoodLibEN);
bool bolResult = objcc_WorkStuRelation4GoodLibEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/cc_WorkStuRelation4GoodLibApi/AddNewRecordWithReturnKey
 /// 在Body区传输objcc_WorkStuRelation4GoodLibEN的JSON对象
...
public ActionResult AddNewRecordWithReturnKey(clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objcc_WorkStuRelation4GoodLibEN", JsonConvert.SerializeObject(objcc_WorkStuRelation4GoodLibEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clscc_WorkStuRelation4GoodLibBL.AccessFldValueNull(objcc_WorkStuRelation4GoodLibEN);
string strKey = clscc_WorkStuRelation4GoodLibBL.AddNewRecordBySql2WithReturnKey(objcc_WorkStuRelation4GoodLibEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/cc_WorkStuRelation4GoodLibApi/UpdateRecord
 /// 在Body区传输objcc_WorkStuRelation4GoodLibEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strcc_WorkStuRelation4GoodLibJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strcc_WorkStuRelation4GoodLibJSONObj = clsJSON.GetJsonFromObj(objcc_WorkStuRelation4GoodLibEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clscc_WorkStuRelation4GoodLibBL.SetUpdFlag(objcc_WorkStuRelation4GoodLibEN);
    clscc_WorkStuRelation4GoodLibBL.AccessFldValueNull(objcc_WorkStuRelation4GoodLibEN);
bool bolResult = objcc_WorkStuRelation4GoodLibEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/cc_WorkStuRelation4GoodLibApi/EditRecordEx
 /// 在Body区传输objcc_WorkStuRelation4GoodLibEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strcc_WorkStuRelation4GoodLibJSONObj = clsJSON.GetJsonFromObj(objcc_WorkStuRelation4GoodLibEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clscc_WorkStuRelation4GoodLibBL.SetUpdFlag(objcc_WorkStuRelation4GoodLibEN);
    clscc_WorkStuRelation4GoodLibBL.AccessFldValueNull(objcc_WorkStuRelation4GoodLibEN);
bool bolResult = objcc_WorkStuRelation4GoodLibEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/cc_WorkStuRelation4GoodLibApi/UpdateWithCondition
 /// 在Body区传输objcc_WorkStuRelation4GoodLibEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clscc_WorkStuRelation4GoodLibEN objcc_WorkStuRelation4GoodLibEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clscc_WorkStuRelation4GoodLibBL.AccessFldValueNull(objcc_WorkStuRelation4GoodLibEN);
bool bolResult = objcc_WorkStuRelation4GoodLibEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/cc_WorkStuRelation4GoodLibApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clscc_WorkStuRelation4GoodLibBL.DelRecord(lngmId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/cc_WorkStuRelation4GoodLibApi/Delcc_WorkStuRelation4GoodLibs
 /// 在Body区传输arrmId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrmId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("Delcc_WorkStuRelation4GoodLibs")]
public ActionResult Delcc_WorkStuRelation4GoodLibs([FromBody]string[] arrmId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrmId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clscc_WorkStuRelation4GoodLibBL.Delcc_WorkStuRelation4GoodLibs(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/cc_WorkStuRelation4GoodLibApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clscc_WorkStuRelation4GoodLibBL.Delcc_WorkStuRelation4GoodLibs(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/cc_WorkStuRelation4GoodLibApi/Delcc_WorkStuRelation4GoodLibsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delcc_WorkStuRelation4GoodLibsByCond")]
public ActionResult Delcc_WorkStuRelation4GoodLibsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clscc_WorkStuRelation4GoodLibBL.Delcc_WorkStuRelation4GoodLibsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
