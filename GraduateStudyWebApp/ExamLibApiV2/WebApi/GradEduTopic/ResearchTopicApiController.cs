...
{
 /// <summary>
 /// ResearchTopicController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  ResearchTopicApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/ResearchTopicApi/GetObjByTopicId?TopicId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objResearchTopicEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ResearchTopicApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsResearchTopicEN> arrResearchTopicObjLst = clsResearchTopicBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrResearchTopicObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/ResearchTopicApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsResearchTopicEN> arrResearchTopicObjLst = clsResearchTopicBL.GetObjLstCache(strIdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrResearchTopicObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/ResearchTopicapi/GetObjLstByTopicIdLst
...
List<string> lstTopicId = new(arrTopicId);
 try
 {
List<clsResearchTopicEN> arrResearchTopicObjLst = clsResearchTopicBL.GetObjLstByTopicIdLst(lstTopicId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrResearchTopicObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstTopicId = new(arrTopicId);
 try
 {
IEnumerable<clsResearchTopicEN> arrResearchTopicObjLst = clsResearchTopicBL.GetObjLstByTopicIdLstCache(lstTopicId, IdCurrEduCls);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrResearchTopicObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/ResearchTopicApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsResearchTopicEN> arrResearchTopicObjLst = clsResearchTopicBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrResearchTopicObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ResearchTopicApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strTopicId = clsResearchTopicBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/ResearchTopicApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsResearchTopicEN objResearchTopicEN = clsResearchTopicBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objResearchTopicEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/ResearchTopicApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsResearchTopicEN> arrResearchTopicObjLst;
 try
 {
 arrResearchTopicObjLst = clsResearchTopicBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrResearchTopicObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/ResearchTopicApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsResearchTopicBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ResearchTopicApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsResearchTopicBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/ResearchTopicApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsResearchTopicBL.SetFldValue(clsResearchTopicEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/ResearchTopicApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsResearchTopicBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/ResearchTopicApi/IsExist?TopicId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsResearchTopicBL.IsExist(strTopicId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/ResearchTopicApi/GetMaxStrId?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
string strMaxstrTopicId = clsResearchTopicBL.GetMaxStrId_S();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strMaxstrTopicId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/ResearchTopicApi/AddNewRecord
 /// 在Body区传输objResearchTopicEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objResearchTopicEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsResearchTopicEN objResearchTopicEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strResearchTopicJSONObj = clsJSON.GetJsonFromObj(objResearchTopicEN);
dictParam.Add("strResearchTopicJSONObj", strResearchTopicJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
 if (string.IsNullOrEmpty(objResearchTopicEN.TopicId) == true || clsResearchTopicBL.IsExist(objResearchTopicEN.TopicId) == true)
 {
    ...
    clsResearchTopicBL.AccessFldValueNull(objResearchTopicEN);
bool bolResult = objResearchTopicEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/ResearchTopicApi/AddNewRecordWithMaxId
 /// 在Body区传输objResearchTopicEN的JSON对象
...
public ActionResult AddNewRecordWithMaxId([FromBody]clsResearchTopicEN objResearchTopicEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strResearchTopicJSONObj = clsJSON.GetJsonFromObj(objResearchTopicEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 ...
 {
    clsResearchTopicBL.AccessFldValueNull(objResearchTopicEN);
string strTopicId = objResearchTopicEN.AddNewRecordWithMaxId();
return Ok(new { errorId = 0, errorMsg = "", returnStr =  strTopicId });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ResearchTopicApi/AddNewRecordWithReturnKey
 /// 在Body区传输objResearchTopicEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objResearchTopicEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsResearchTopicEN objResearchTopicEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objResearchTopicEN", JsonConvert.SerializeObject(objResearchTopicEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsResearchTopicBL.AccessFldValueNull(objResearchTopicEN);
string strKey = clsResearchTopicBL.AddNewRecordBySql2WithReturnKey(objResearchTopicEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/ResearchTopicApi/UpdateRecord
 /// 在Body区传输objResearchTopicEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strResearchTopicJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsResearchTopicEN objResearchTopicEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strResearchTopicJSONObj = clsJSON.GetJsonFromObj(objResearchTopicEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsResearchTopicBL.SetUpdFlag(objResearchTopicEN);
    clsResearchTopicBL.AccessFldValueNull(objResearchTopicEN);
bool bolResult = objResearchTopicEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/ResearchTopicApi/EditRecordEx
 /// 在Body区传输objResearchTopicEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsResearchTopicEN objResearchTopicEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strResearchTopicJSONObj = clsJSON.GetJsonFromObj(objResearchTopicEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsResearchTopicBL.SetUpdFlag(objResearchTopicEN);
    clsResearchTopicBL.AccessFldValueNull(objResearchTopicEN);
bool bolResult = objResearchTopicEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移顶
 /// 调用方法: POST /api/ResearchTopicApi/GoTop
...
List<string> lstTopicId = new(objOrderByData.KeyIdLst);
try
{
bool bolResult = clsResearchTopicBL.GoTop(lstTopicId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录上移
 /// 调用方法: POST /api/ResearchTopicApi/UpMove
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
foreach(var x in lstTopicId)
{
clsResearchTopicBL.AdjustOrderNum("UP", x);
}
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录下移
 /// 调用方法: POST /api/ResearchTopicApi/DownMove
 /// 在Body区传输clsOrderByData的JSON对象
...
foreach(var x in lstTopicId)
{
clsResearchTopicBL.AdjustOrderNum("DOWN", x);
}
return Ok(new { errorId = 0, errorMsg = "", returnBool = true });
}
 catch (Exception objException)
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/ResearchTopicApi/GoBottom
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
bool bolResult = clsResearchTopicBL.GoBottom(lstTopicId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 把所给的关键字列表相关的记录移底
 /// 调用方法: POST /api/ResearchTopicApi/ReOrder
 /// 在Body区传输clsOrderByData的JSON对象
...
try
{
bool bolResult = clsResearchTopicBL.ReOrder();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/ResearchTopicApi/UpdateWithCondition
 /// 在Body区传输objResearchTopicEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsResearchTopicEN objResearchTopicEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsResearchTopicBL.AccessFldValueNull(objResearchTopicEN);
bool bolResult = objResearchTopicEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsResearchTopicBL.DelRecord(strTopicId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ResearchTopicApi/DelResearchTopics
 /// 在Body区传输arrTopicId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrTopicId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelResearchTopics")]
public ActionResult DelResearchTopics([FromBody]string[] arrTopicId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrTopicId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsResearchTopicBL.DelResearchTopics(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/ResearchTopicApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsResearchTopicBL.DelResearchTopics(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/ResearchTopicApi/DelResearchTopicsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelResearchTopicsByCond")]
public ActionResult DelResearchTopicsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsResearchTopicBL.DelResearchTopicsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
