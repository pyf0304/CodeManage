...
{
 /// <summary>
 /// Aqa_QuestionsExController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  Aqa_QuestionsExApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetObjByStuId?StuId=value
...
public ActionResult GetObjByKeyLst(string strStuId,string strQuestionsId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objAqa_QuestionsExEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsAqa_QuestionsExEN> arrAqa_QuestionsExObjLst = clsAqa_QuestionsExBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrAqa_QuestionsExObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetObjLst_Cache?
...
// try
// {
//List<clsAqa_QuestionsExEN> arrAqa_QuestionsExObjLst = clsAqa_QuestionsExBL.GetObjLstCache();
//return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrAqa_QuestionsExObjLst });
// }
// catch (Exception objException)
// {
...
//}
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/Aqa_QuestionsExapi/GetObjLstByStuIdLst
...
//dictParam.Add("arrStuId", clsArray.GetSqlInStrByArray(arrLst, true));
//clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
//IEnumerable<clsAqa_QuestionsExEN> arrAqa_QuestionsExObjLst = clsAqa_QuestionsExBL.GetObjLstByKeyLstsCache(lstKeyLst);
//return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrAqa_QuestionsExObjLst });
// }
// catch (Exception objException)
// {
...
//}
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsAqa_QuestionsExEN> arrAqa_QuestionsExObjLst = clsAqa_QuestionsExBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrAqa_QuestionsExObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strStuId = clsAqa_QuestionsExBL.GetFirstID_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnStr = strStuId });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsAqa_QuestionsExEN objAqa_QuestionsExEN = clsAqa_QuestionsExBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objAqa_QuestionsExEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsAqa_QuestionsExEN> arrAqa_QuestionsExObjLst;
 try
 {
 arrAqa_QuestionsExObjLst = clsAqa_QuestionsExBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrAqa_QuestionsExObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsAqa_QuestionsExBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/Aqa_QuestionsExApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsAqa_QuestionsExBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/Aqa_QuestionsExApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsAqa_QuestionsExBL.SetFldValue(clsAqa_QuestionsExEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/Aqa_QuestionsExApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsAqa_QuestionsExBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/Aqa_QuestionsExApi/IsExist?StuId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "strStuId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(string strStuId,string strQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsAqa_QuestionsExBL.IsExist(strStuId,strQuestionsId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/Aqa_QuestionsExApi/AddNewRecord
 /// 在Body区传输objAqa_QuestionsExEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objAqa_QuestionsExEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsAqa_QuestionsExEN objAqa_QuestionsExEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strAqa_QuestionsExJSONObj = clsJSON.GetJsonFromObj(objAqa_QuestionsExEN);
dictParam.Add("strAqa_QuestionsExJSONObj", strAqa_QuestionsExJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objAqa_QuestionsExEN.StuId, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
    clsAqa_QuestionsExBL.AccessFldValueNull(objAqa_QuestionsExEN);
bool bolResult = objAqa_QuestionsExEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/Aqa_QuestionsExApi/AddNewRecordWithReturnKey
 /// 在Body区传输objAqa_QuestionsExEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objAqa_QuestionsExEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsAqa_QuestionsExEN objAqa_QuestionsExEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objAqa_QuestionsExEN", JsonConvert.SerializeObject(objAqa_QuestionsExEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsAqa_QuestionsExBL.AccessFldValueNull(objAqa_QuestionsExEN);
string strKey = clsAqa_QuestionsExBL.AddNewRecordBySql2WithReturnKey(objAqa_QuestionsExEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/Aqa_QuestionsExApi/UpdateRecord
 /// 在Body区传输objAqa_QuestionsExEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strAqa_QuestionsExJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsAqa_QuestionsExEN objAqa_QuestionsExEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strAqa_QuestionsExJSONObj = clsJSON.GetJsonFromObj(objAqa_QuestionsExEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsAqa_QuestionsExBL.SetUpdFlag(objAqa_QuestionsExEN);
    clsAqa_QuestionsExBL.AccessFldValueNull(objAqa_QuestionsExEN);
bool bolResult = objAqa_QuestionsExEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/Aqa_QuestionsExApi/UpdateWithCondition
 /// 在Body区传输objAqa_QuestionsExEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsAqa_QuestionsExEN objAqa_QuestionsExEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsAqa_QuestionsExBL.AccessFldValueNull(objAqa_QuestionsExEN);
bool bolResult = objAqa_QuestionsExEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/Aqa_QuestionsExApi/DelRecord/Id
...
public ActionResult DelRecKeyLst(string strStuId,string strQuestionsId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsAqa_QuestionsExBL.DelRecord(strStuId,strQuestionsId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/Aqa_QuestionsExApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsAqa_QuestionsExBL.DelRecKeyLsts(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/Aqa_QuestionsExApi/DelAqa_QuestionsExsByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelAqa_QuestionsExsByCond")]
public ActionResult DelAqa_QuestionsExsByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsAqa_QuestionsExBL.DelAqa_QuestionsExsByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
