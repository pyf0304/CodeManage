 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:gs_MeetingMinutesVerApiController
...
{
 /// <summary>
 /// gs_MeetingMinutesVerController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  gs_MeetingMinutesVerApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetObjByMeetingVId?MeetingVId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objgs_MeetingMinutesVerEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsgs_MeetingMinutesVerEN> arrgs_MeetingMinutesVerObjLst = clsgs_MeetingMinutesVerBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_MeetingMinutesVerObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsgs_MeetingMinutesVerEN> arrgs_MeetingMinutesVerObjLst = clsgs_MeetingMinutesVerBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_MeetingMinutesVerObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/gs_MeetingMinutesVerapi/GetObjLstByMeetingVIdLst
...
List<long> lstMeetingVId = lstMeetingVId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
List<clsgs_MeetingMinutesVerEN> arrgs_MeetingMinutesVerObjLst = clsgs_MeetingMinutesVerBL.GetObjLstByMeetingVIdLst(lstMeetingVId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_MeetingMinutesVerObjLst });
 }
 catch (Exception objException)
 {
...
List<long> lstMeetingVId = lstMeetingVId_Str.Select(x=>long.Parse(x)).ToList();
 try
 {
IEnumerable<clsgs_MeetingMinutesVerEN> arrgs_MeetingMinutesVerObjLst = clsgs_MeetingMinutesVerBL.GetObjLstByMeetingVIdLstCache(lstMeetingVId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_MeetingMinutesVerObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsgs_MeetingMinutesVerEN> arrgs_MeetingMinutesVerObjLst = clsgs_MeetingMinutesVerBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_MeetingMinutesVerObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 lngMeetingVId = clsgs_MeetingMinutesVerBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsgs_MeetingMinutesVerEN objgs_MeetingMinutesVerEN = clsgs_MeetingMinutesVerBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objgs_MeetingMinutesVerEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsgs_MeetingMinutesVerEN> arrgs_MeetingMinutesVerObjLst;
 try
 {
 arrgs_MeetingMinutesVerObjLst = clsgs_MeetingMinutesVerBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrgs_MeetingMinutesVerObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsgs_MeetingMinutesVerBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsgs_MeetingMinutesVerBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsgs_MeetingMinutesVerBL.SetFldValue(clsgs_MeetingMinutesVerEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsgs_MeetingMinutesVerBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/gs_MeetingMinutesVerApi/IsExist?MeetingVId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsgs_MeetingMinutesVerBL.IsExist(lngMeetingVId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/gs_MeetingMinutesVerApi/AddNewRecord
 /// 在Body区传输objgs_MeetingMinutesVerEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objgs_MeetingMinutesVerEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsgs_MeetingMinutesVerEN objgs_MeetingMinutesVerEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strgs_MeetingMinutesVerJSONObj = clsJSON.GetJsonFromObj(objgs_MeetingMinutesVerEN);
dictParam.Add("strgs_MeetingMinutesVerJSONObj", strgs_MeetingMinutesVerJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsgs_MeetingMinutesVerBL.AccessFldValueNull(objgs_MeetingMinutesVerEN);
bool bolResult = objgs_MeetingMinutesVerEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/gs_MeetingMinutesVerApi/AddNewRecordWithReturnKey
 /// 在Body区传输objgs_MeetingMinutesVerEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objgs_MeetingMinutesVerEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsgs_MeetingMinutesVerEN objgs_MeetingMinutesVerEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objgs_MeetingMinutesVerEN", JsonConvert.SerializeObject(objgs_MeetingMinutesVerEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsgs_MeetingMinutesVerBL.AccessFldValueNull(objgs_MeetingMinutesVerEN);
string strKey = clsgs_MeetingMinutesVerBL.AddNewRecordBySql2WithReturnKey(objgs_MeetingMinutesVerEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/gs_MeetingMinutesVerApi/UpdateRecord
 /// 在Body区传输objgs_MeetingMinutesVerEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strgs_MeetingMinutesVerJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsgs_MeetingMinutesVerEN objgs_MeetingMinutesVerEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strgs_MeetingMinutesVerJSONObj = clsJSON.GetJsonFromObj(objgs_MeetingMinutesVerEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsgs_MeetingMinutesVerBL.SetUpdFlag(objgs_MeetingMinutesVerEN);
    clsgs_MeetingMinutesVerBL.AccessFldValueNull(objgs_MeetingMinutesVerEN);
bool bolResult = objgs_MeetingMinutesVerEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: Post /api/gs_MeetingMinutesVerApi/EditRecordEx
 /// 在Body区传输objgs_MeetingMinutesVerEN的JSON对象
...
public ActionResult EditRecordEx([FromBody]clsgs_MeetingMinutesVerEN objgs_MeetingMinutesVerEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strgs_MeetingMinutesVerJSONObj = clsJSON.GetJsonFromObj(objgs_MeetingMinutesVerEN);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
    clsgs_MeetingMinutesVerBL.SetUpdFlag(objgs_MeetingMinutesVerEN);
    clsgs_MeetingMinutesVerBL.AccessFldValueNull(objgs_MeetingMinutesVerEN);
bool bolResult = objgs_MeetingMinutesVerEN.EditRecordEx();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/gs_MeetingMinutesVerApi/UpdateWithCondition
 /// 在Body区传输objgs_MeetingMinutesVerEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsgs_MeetingMinutesVerEN objgs_MeetingMinutesVerEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsgs_MeetingMinutesVerBL.AccessFldValueNull(objgs_MeetingMinutesVerEN);
bool bolResult = objgs_MeetingMinutesVerEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/gs_MeetingMinutesVerApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsgs_MeetingMinutesVerBL.DelRecord(lngMeetingVId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/gs_MeetingMinutesVerApi/Delgs_MeetingMinutesVers
 /// 在Body区传输arrMeetingVId(关键字值列表)的JSON串
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecord)
 /// </summary>
 /// <param name = "arrMeetingVId">给定的关键字值列表</param>
 /// <returns>返回删除的记录数</returns>
[HttpPost("Delgs_MeetingMinutesVers")]
public ActionResult Delgs_MeetingMinutesVers([FromBody]string[] arrMeetingVId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrMeetingVId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsgs_MeetingMinutesVerBL.Delgs_MeetingMinutesVers(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/gs_MeetingMinutesVerApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsgs_MeetingMinutesVerBL.Delgs_MeetingMinutesVers(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/gs_MeetingMinutesVerApi/Delgs_MeetingMinutesVersByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("Delgs_MeetingMinutesVersByCond")]
public ActionResult Delgs_MeetingMinutesVersByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsgs_MeetingMinutesVerBL.Delgs_MeetingMinutesVersByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
