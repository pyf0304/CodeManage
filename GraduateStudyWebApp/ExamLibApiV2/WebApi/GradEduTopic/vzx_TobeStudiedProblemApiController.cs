 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:vzx_TobeStudiedProblemApiController
...
{
 /// <summary>
 /// vzx_TobeStudiedProblemController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  vzx_TobeStudiedProblemApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetObjByProblemId?ProblemId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvzx_TobeStudiedProblemEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsvzx_TobeStudiedProblemEN> arrvzx_TobeStudiedProblemObjLst = clsvzx_TobeStudiedProblemBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvzx_TobeStudiedProblemObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsvzx_TobeStudiedProblemEN> arrvzx_TobeStudiedProblemObjLst = clsvzx_TobeStudiedProblemBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvzx_TobeStudiedProblemObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/vzx_TobeStudiedProblemapi/GetObjLstByProblemIdLst
...
List<string> lstProblemId = new(arrProblemId);
 try
 {
List<clsvzx_TobeStudiedProblemEN> arrvzx_TobeStudiedProblemObjLst = clsvzx_TobeStudiedProblemBL.GetObjLstByProblemIdLst(lstProblemId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvzx_TobeStudiedProblemObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstProblemId = new(arrProblemId);
 try
 {
IEnumerable<clsvzx_TobeStudiedProblemEN> arrvzx_TobeStudiedProblemObjLst = clsvzx_TobeStudiedProblemBL.GetObjLstByProblemIdLstCache(lstProblemId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvzx_TobeStudiedProblemObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsvzx_TobeStudiedProblemEN> arrvzx_TobeStudiedProblemObjLst = clsvzx_TobeStudiedProblemBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvzx_TobeStudiedProblemObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strProblemId = clsvzx_TobeStudiedProblemBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsvzx_TobeStudiedProblemEN objvzx_TobeStudiedProblemEN = clsvzx_TobeStudiedProblemBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objvzx_TobeStudiedProblemEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsvzx_TobeStudiedProblemEN> arrvzx_TobeStudiedProblemObjLst;
 try
 {
 arrvzx_TobeStudiedProblemObjLst = clsvzx_TobeStudiedProblemBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrvzx_TobeStudiedProblemObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsvzx_TobeStudiedProblemBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsvzx_TobeStudiedProblemBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvzx_TobeStudiedProblemBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/vzx_TobeStudiedProblemApi/IsExist?ProblemId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsvzx_TobeStudiedProblemBL.IsExist(strProblemId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
