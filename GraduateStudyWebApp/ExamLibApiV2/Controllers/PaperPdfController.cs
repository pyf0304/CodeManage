...
namespace Comm.WebApi
{
    ...
    public class PaperPdfController : ControllerBase
    {
        ...
        public ActionResult Plus(int a, int b)
        {
            ...
            return Ok(new { errorId = 0, errorMsg = "", returnInt = c });
        }
        ...
        public ActionResult Test()
        {
            ...
            return Ok(new { errorId = 0, errorMsg = "", returnStr = "测试成功" });
        }
        //base64字符串转化成图片  
        ...
        public ActionResult GetPaperPdfLst()
        {
            ...
            try
            {
                ...
                return Ok(new { success = true, status = 0, message = "获取成功", fileNameLst = string.Join(",", arrFileNameLst), code = "0" });
            }

            catch (Exception ex)
            {

                return Ok(new { success = false, status = -3, message = "获取论文Pdf列表失败", data = ex.Message, code = "" });
            }
