...
try
{
objUserStateEN.sf_UpdFldSetStr = objUserStateEN.getsf_UpdFldSetStr();
...
string strResult = "";
clsUserStateEN objUserStateEN = null;
...
{
objUserStateEN = JsonConvert.DeserializeObject<clsUserStateEN>((string)jobjReturn["ReturnObj"]);
return objUserStateEN;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strUserStateId">表关键字</param>
 /// <returns>表对象</returns>
public static clsUserStateEN GetObjByUserStateId_WA_Cache(string strUserStateId)
{
...
from objUserStateEN in arrUserStateObjLst_Cache
...
{
 List<clsUserStateEN> arrObjLst = null; 
...
if ((int)jobjReturn["ErrorId"] == 0)
{
arrObjLst = JsonConvert.DeserializeObject<List<clsUserStateEN>>((string)jobjReturn["ReturnObjLst"]);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strUserStateId">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
public static IEnumerable<clsUserStateEN> GetObjLstByUserStateIdLst_Cache(List<string> arrUserStateId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsUserStateEN._CurrTabName_S);
List<clsUserStateEN> arrUserStateObjLst_Cache = GetObjLst_Cache();
...
return arrUserStateObjLst_Sel;
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsUserStateEN> GetObjLstByUserStateIdLst_WA_Cache(List<string> arrUserStateId)
{
 List<clsUserStateEN> arrObjLst = null; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsUserStateEN> GetObjLstByPager_Cache(stuPagerPara objPagerPara)
{
 List<clsUserStateEN> arrObjLst = null; 
...
{
if (string.IsNullOrEmpty(objUserStateEN.sf_UpdFldSetStr) == true)
{
...
if (clsUserStateEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
...
{
//Columns
foreach (string strAttrName in clsUserStateEN.AttributeName)
{
...
//{
//arrUserStateObjLst_Cache = await clsUserStateWApi.GetObjLst(strWhereCond);
//}
}
...
string strKey = string.Format("{0}", clsUserStateEN._CurrTabName_S);
CacheHelper.Remove(strKey);
clsUserStateWApi.objCommFun4BL.ReFreshCache();
}
}
