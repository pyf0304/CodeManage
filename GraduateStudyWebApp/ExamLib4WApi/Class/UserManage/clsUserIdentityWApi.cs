...
{
public static class clsUserIdentityWApi_Static
{
...
try
{
objUserIdentityEN.sf_UpdFldSetStr = objUserIdentityEN.getsf_UpdFldSetStr();
clsUserIdentityWApi.CheckPropertyNew(objUserIdentityEN); 
bool bolResult = clsUserIdentityWApi.UpdateRecord(objUserIdentityEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserIdentityWApi.ReFreshCache();
return bolResult;
}
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsUserIdentityWApi.IsExist(objUserIdentityEN.IdentityID) == true)
 {
...
{
clsUserIdentityWApi.CheckPropertyNew(objUserIdentityEN); 
bool bolResult = clsUserIdentityWApi.AddNewRecord(objUserIdentityEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserIdentityWApi.ReFreshCache();
return bolResult;
}
...
{
clsUserIdentityWApi.CheckPropertyNew(objUserIdentityEN); 
string strIdentityID = clsUserIdentityWApi.AddNewRecordWithMaxId(objUserIdentityEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserIdentityWApi.ReFreshCache();
...
{
clsUserIdentityWApi.CheckPropertyNew(objUserIdentityEN); 
bool bolResult = clsUserIdentityWApi.UpdateWithCondition(objUserIdentityEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserIdentityWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsUserIdentityWApi
{
private static readonly string mstrApiControllerName = "UserIdentityApi";
...
List<clsUserIdentityEN> arrObjLst = GetObjLst("1=1");
...
List<clsUserIdentityEN> arrObjLst = clsUserIdentityWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
{
if (!Object.Equals(null, objUserIdentityEN.IdentityID) && GetStrLen(objUserIdentityEN.IdentityID) > 2)
{
 throw new Exception("字段[身份编号]的长度不能超过2!");
}
if (!Object.Equals(null, objUserIdentityEN.IdentityDesc) && GetStrLen(objUserIdentityEN.IdentityDesc) > 20)
{
 throw new Exception("字段[身份描述]的长度不能超过20!");
}
if (!Object.Equals(null, objUserIdentityEN.Memo) && GetStrLen(objUserIdentityEN.Memo) > 1000)
{
...
string strResult = "";
clsUserIdentityEN objUserIdentityEN = null;
...
{
objUserIdentityEN = JsonConvert.DeserializeObject<clsUserIdentityEN>((string)jobjReturn["ReturnObj"]);
return objUserIdentityEN;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strIdentityID">表关键字</param>
 /// <returns>表对象</returns>
public static clsUserIdentityEN GetObjByIdentityID_WA_Cache(string strIdentityID)
{
string strAction = "GetObjByIdentityID_Cache";
string strErrMsg = string.Empty;
string strResult = "";
clsUserIdentityEN objUserIdentityEN = null;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsUserIdentityEN GetFirstObj(string strWhereCond)
{
...
from objUserIdentityEN in arrUserIdentityObjLst_Cache
where objUserIdentityEN.IdentityID == strIdentityID
select objUserIdentityEN;
if (arrUserIdentityObjLst_Sel.Count() == 0)
{
   clsUserIdentityEN obj = clsUserIdentityWApi.GetObjByIdentityID(strIdentityID);
   if (obj != null)
 {
...
string strKey = string.Format("{0}", clsUserIdentityEN._CurrTabName_S);
List<clsUserIdentityEN> arrUserIdentityObjLst_Cache = GetObjLst_Cache();
IEnumerable <clsUserIdentityEN> arrUserIdentityObjLst_Sel1 =
from objUserIdentityEN in arrUserIdentityObjLst_Cache
where objUserIdentityEN.IdentityID == strIdentityID
select objUserIdentityEN;
List <clsUserIdentityEN> arrUserIdentityObjLst_Sel = new List<clsUserIdentityEN>();
foreach (clsUserIdentityEN obj in arrUserIdentityObjLst_Sel1)
{
arrUserIdentityObjLst_Sel.Add(obj);
}
if (arrUserIdentityObjLst_Sel.Count > 0)
{
return arrUserIdentityObjLst_Sel[0].IdentityDesc;
}
string strErrMsgForGetObjById = string.Format("在UserIdentity对象缓存列表中,找不到记录[IdentityID = {0}](函数:{1})", strIdentityID, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsUserIdentityBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
...
string strErrMsgForGetObjById = string.Format("在UserIdentity对象缓存列表中,找不到记录的相关名称[IdentityID = {0}](函数:{1})", strIdentityID, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsUserIdentityBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
{
 List<clsUserIdentityEN> arrObjLst = null; 
...
if ((int)jobjReturn["ErrorId"] == 0)
{
arrObjLst = JsonConvert.DeserializeObject<List<clsUserIdentityEN>>((string)jobjReturn["ReturnObjLst"]);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsUserIdentityEN> GetObjLstByIdentityIDLst(List<string> arrIdentityID)
{
 List<clsUserIdentityEN> arrObjLst = null; 
...
throw new Exception(strMsg);
 ...
 /// <param name = "strIdentityID">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
public static IEnumerable<clsUserIdentityEN> GetObjLstByIdentityIDLst_Cache(List<string> arrIdentityID)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsUserIdentityEN._CurrTabName_S);
List<clsUserIdentityEN> arrUserIdentityObjLst_Cache = GetObjLst_Cache();
IEnumerable <clsUserIdentityEN> arrUserIdentityObjLst_Sel =
from objUserIdentityEN in arrUserIdentityObjLst_Cache
where arrIdentityID.Contains(objUserIdentityEN.IdentityID)
select objUserIdentityEN;
return arrUserIdentityObjLst_Sel;
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsUserIdentityEN> GetObjLstByIdentityIDLst_WA_Cache(List<string> arrIdentityID)
{
 List<clsUserIdentityEN> arrObjLst = null; 
string strAction = "GetObjLstByIdentityIDLst_Cache";
string strErrMsg = string.Empty;
string strResult = "";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsUserIdentityEN> GetObjLstByPager_Cache(stuPagerPara objPagerPara)
{
 List<clsUserIdentityEN> arrObjLst = null; 
...
try
{
 clsUserIdentityEN objUserIdentityEN = clsUserIdentityWApi.GetObjByIdentityID(strIdentityID);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strIdentityID.ToString(), out strResult, out strErrMsg) == true)
{
JObject jobjReturn = JObject.Parse(strResult);
if ((int)jobjReturn["ErrorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelUserIdentitys(List<string> arrIdentityID)
{
string strAction = "DelUserIdentitys";
string strErrMsg = string.Empty;
string strResult = "";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
...
{
string strAction = "DelUserIdentitysByCond";
string strErrMsg = string.Empty;
string strResult = "";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
public static bool AddNewRecord(clsUserIdentityEN objUserIdentityEN)
{
...
try
{
string strJson = clsJSON.GetJsonFromObj<clsUserIdentityEN>(objUserIdentityEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out strResult, out strErrMsg) == true)
{
JObject jobjReturn = JObject.Parse(strResult);
if ((int)jobjReturn["ErrorId"] == 0)
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static string AddNewRecordWithMaxId(clsUserIdentityEN objUserIdentityEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserIdentityWApi.ReFreshCache();
var strIdentityID = (string)jobjReturn["ReturnStr"];
return strIdentityID;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsUserIdentityEN objUserIdentityEN)
{
if (string.IsNullOrEmpty(objUserIdentityEN.sf_UpdFldSetStr) == true)
{
string strMsg = string.Format("修改时，修改标志串为空，请联系管理员.对象关键字:{0}.(from {1}).",
objUserIdentityEN.IdentityID, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsUserIdentityEN objUserIdentityEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objUserIdentityEN.sf_UpdFldSetStr) == true)
{
string strMsg = string.Format("修改时，修改标志串为空，请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsUserIdentityEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsUserIdentityEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsUserIdentityEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsUserIdentityEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsUserIdentityEN objInFor in arrObj)
{
//Rows
...
//{
//arrUserIdentityObjLst_Cache = await clsUserIdentityWApi.GetObjLst(strWhereCond);
//}
}
...
string strKey = string.Format("{0}", clsUserIdentityEN._CurrTabName_S);
CacheHelper.Remove(strKey);
clsUserIdentityWApi.objCommFun4BL.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsUserIdentityEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conUserIdentity.IdentityID, Type.GetType("System.String"));
objDT.Columns.Add(conUserIdentity.IdentityDesc, Type.GetType("System.String"));
objDT.Columns.Add(conUserIdentity.Memo, Type.GetType("System.String"));
foreach (clsUserIdentityEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conUserIdentity.IdentityID] = objInFor[conUserIdentity.IdentityID];
objDR[conUserIdentity.IdentityDesc] = objInFor[conUserIdentity.IdentityDesc];
objDR[conUserIdentity.Memo] = objInFor[conUserIdentity.Memo];
...
return objDT;
 ...
 /// </summary>
public class clsCommFun4WA4UserIdentity : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserIdentityWApi.ReFreshThisCache();
}
}
