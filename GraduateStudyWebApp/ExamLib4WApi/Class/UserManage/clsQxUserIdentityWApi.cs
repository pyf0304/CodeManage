...
public static string GetCombineCondition(this clsQxUserIdentityEN objQxUserIdentity_Cond)
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
string strWhereCond = " 1 = 1 ";
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
if (objQxUserIdentity_Cond.IsUpdated(conQxUserIdentity.IdentityID) == true)
{
string strComparisonOp_IdentityID = objQxUserIdentity_Cond.dicFldComparisonOp[conQxUserIdentity.IdentityID];
strWhereCond += string.Format(" And {0} {2} '{1}'", conQxUserIdentity.IdentityID, objQxUserIdentity_Cond.IdentityID, strComparisonOp_IdentityID);
}
if (objQxUserIdentity_Cond.IsUpdated(conQxUserIdentity.IdentityDesc) == true)
{
string strComparisonOp_IdentityDesc = objQxUserIdentity_Cond.dicFldComparisonOp[conQxUserIdentity.IdentityDesc];
strWhereCond += string.Format(" And {0} {2} '{1}'", conQxUserIdentity.IdentityDesc, objQxUserIdentity_Cond.IdentityDesc, strComparisonOp_IdentityDesc);
}
if (objQxUserIdentity_Cond.IsUpdated(conQxUserIdentity.Memo) == true)
{
string strComparisonOp_Memo = objQxUserIdentity_Cond.dicFldComparisonOp[conQxUserIdentity.Memo];
strWhereCond += string.Format(" And {0} {2} '{1}'", conQxUserIdentity.Memo, objQxUserIdentity_Cond.Memo, strComparisonOp_Memo);
}
 return strWhereCond;
}
...
try
{
objQxUserIdentityEN.sf_UpdFldSetStr = objQxUserIdentityEN.getsf_UpdFldSetStr();
...
{
objQxUserIdentityEN = JsonConvert.DeserializeObject<clsQxUserIdentityEN>((string)jobjReturn["ReturnObj"]);
return objQxUserIdentityEN;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strIdentityID">表关键字</param>
 /// <returns>表对象</returns>
public static clsQxUserIdentityEN GetObjByIdentityID_WA_Cache(string strIdentityID)
{
...
//初始化列表缓存
string strKey = string.Format("{0}", clsQxUserIdentityEN._CurrTabName_S);
List<clsQxUserIdentityEN> arrQxUserIdentityObjLst_Cache = GetObjLst_Cache();
IEnumerable <clsQxUserIdentityEN> arrQxUserIdentityObjLst_Sel =
from objQxUserIdentityEN in arrQxUserIdentityObjLst_Cache
...
{
 List<clsQxUserIdentityEN> arrObjLst = null; 
...
if ((int)jobjReturn["ErrorId"] == 0)
{
arrObjLst = JsonConvert.DeserializeObject<List<clsQxUserIdentityEN>>((string)jobjReturn["ReturnObjLst"]);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strIdentityID">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
public static IEnumerable<clsQxUserIdentityEN> GetObjLstByIdentityIDLst_Cache(List<string> arrIdentityID)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsQxUserIdentityEN._CurrTabName_S);
List<clsQxUserIdentityEN> arrQxUserIdentityObjLst_Cache = GetObjLst_Cache();
...
return arrQxUserIdentityObjLst_Sel;
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsQxUserIdentityEN> GetObjLstByIdentityIDLst_WA_Cache(List<string> arrIdentityID)
{
 List<clsQxUserIdentityEN> arrObjLst = null; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxUserIdentityEN> GetObjLstByPager_Cache(stuPagerPara objPagerPara)
{
 List<clsQxUserIdentityEN> arrObjLst = null; 
...
{
if (string.IsNullOrEmpty(objQxUserIdentityEN.sf_UpdFldSetStr) == true)
{
...
//{
//arrQxUserIdentityObjLst_Cache = await clsQxUserIdentityWApi.GetObjLst(strWhereCond);
//}
}
...
string strKey = string.Format("{0}", clsQxUserIdentityEN._CurrTabName_S);
CacheHelper.Remove(strKey);
clsQxUserIdentityWApi.objCommFun4BL.ReFreshCache();
}
}
...
public static List<clsQxUserIdentityEN> GetObjLst_Cache()
{
//初始化列表缓存
InitListCache(); 
string strKey = string.Format("{0}", clsQxUserIdentityEN._CurrTabName_S);
List<clsQxUserIdentityEN> arrQxUserIdentityObjLst_Cache = CacheHelper.GetCache(strKey, () => { return GetObjLst("1=1"); });
return arrQxUserIdentityObjLst_Cache;
}
