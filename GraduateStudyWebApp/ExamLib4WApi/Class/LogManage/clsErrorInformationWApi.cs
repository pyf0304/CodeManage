...
clsCheckSql.CheckFieldLen(strUserId, 20, conErrorInformation.UserId);
...
objErrorInformationEN.FunctionName = strFunctionName; //函数名
if (string.IsNullOrEmpty(strComparisonOp) == false)
{
...
public static clsErrorInformationEN SetCreateTime(this clsErrorInformationEN objErrorInformationEN, DateTime dteCreateTime, string strComparisonOp="")
	{
objErrorInformationEN.CreateTime = dteCreateTime; //CreateTime
if (string.IsNullOrEmpty(strComparisonOp) == false)
{
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr_UserId_PageName_FunctionName(this clsErrorInformationEN objErrorInformationEN)
{
//检测记录是否存在
...
if (!Object.Equals(null, objErrorInformationEN.UserId) && GetStrLen(objErrorInformationEN.UserId) > 20)
{
...
{
objErrorInformationEN = JsonConvert.DeserializeObject<clsErrorInformationEN>((string)jobjReturn["ReturnObj"]);
return objErrorInformationEN;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "lngErrorID">表关键字</param>
 /// <returns>表对象</returns>
public static clsErrorInformationEN GetObjByErrorID_WA_Cache(long lngErrorID)
{
string strAction = "GetObjByErrorID_Cache";
string strErrMsg = string.Empty;
string strResult = "";
clsErrorInformationEN objErrorInformationEN = null;
Dictionary<string, string> dictParam = new Dictionary<string, string>()
...
from objErrorInformationEN in arrErrorInformationObjLst_Cache
...
{
 List<clsErrorInformationEN> arrObjLst = null; 
...
if ((int)jobjReturn["ErrorId"] == 0)
{
arrObjLst = JsonConvert.DeserializeObject<List<clsErrorInformationEN>>((string)jobjReturn["ReturnObjLst"]);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "lngErrorID">所给的关键字</param>
 /// <returns>根据关键字获取的对象</returns>
public static IEnumerable<clsErrorInformationEN> GetObjLstByErrorIDLst_Cache(List<long> arrErrorID)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsErrorInformationEN._CurrTabName_S);
List<clsErrorInformationEN> arrErrorInformationObjLst_Cache = GetObjLst_Cache();
...
return arrErrorInformationObjLst_Sel;
 ...
 /// <param name = "strWhereCond">给定条件</param>
 /// <returns>返回对象列表</returns>
public static List<clsErrorInformationEN> GetObjLstByErrorIDLst_WA_Cache(List<long> arrErrorID)
{
 List<clsErrorInformationEN> arrObjLst = null; 
string strAction = "GetObjLstByErrorIDLst_Cache";
string strErrMsg = string.Empty;
string strResult = "";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsErrorInformationEN> GetObjLstByPager_Cache(stuPagerPara objPagerPara)
{
 List<clsErrorInformationEN> arrObjLst = null; 
...
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, lngErrorID.ToString(), out strResult, out strErrMsg) == true)
{
JObject jobjReturn = JObject.Parse(strResult);
if ((int)jobjReturn["ErrorId"] == 0)
{
...
//检查缓存刷新机制
string strMsg = "";
if (clsErrorInformationWApi.objCommFun4BL == null)
{
strMsg = string.Format("类clsErrorInformationWApi没有刷新缓存机制(clsErrorInformationWApi.objCommFun4BL == null), 请联系程序员！(from {0})", clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
//初始化列表缓存
...
//{
//arrErrorInformationObjLst_Cache = await clsErrorInformationWApi.GetObjLst(strWhereCond);
//}
}
...
string strKey = string.Format("{0}", clsErrorInformationEN._CurrTabName_S);
CacheHelper.Remove(strKey);
clsErrorInformationWApi.objCommFun4BL.ReFreshCache();
}
}
