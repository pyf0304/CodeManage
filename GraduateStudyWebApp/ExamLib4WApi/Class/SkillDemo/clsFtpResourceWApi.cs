...
public static clsFtpResourceEN Setid_FtpResource(this clsFtpResourceEN objFtpResourceEN, string strid_FtpResource, string strComparisonOp="")
	{
clsCheckSql.CheckFieldLen(strid_FtpResource, 8, conFtpResource.id_FtpResource);
clsCheckSql.CheckFieldForeignKey(strid_FtpResource, 8, conFtpResource.id_FtpResource);
objFtpResourceEN.id_FtpResource = strid_FtpResource; //FTP资源流水号
if (string.IsNullOrEmpty(strComparisonOp) == false)
{
if (objFtpResourceEN.dicFldComparisonOp.ContainsKey(conFtpResource.id_FtpResource) == false)
{
objFtpResourceEN.dicFldComparisonOp.Add(conFtpResource.id_FtpResource, strComparisonOp);
}
else
{
objFtpResourceEN.dicFldComparisonOp[conFtpResource.id_FtpResource] = strComparisonOp;
}
}
...
return objFtpResourceEN;
 ...
 /// <param name = "strComparisonOp">比较运算符,如果有值，可用于组织条件串</param>
 /// <returns>返回对象，可以继续连写</returns>
public static clsFtpResourceEN SetFileName_Bak(this clsFtpResourceEN objFtpResourceEN, string strFileName_Bak, string strComparisonOp="")
	{
clsCheckSql.CheckFieldLen(strFileName_Bak, 500, conFtpResource.FileName_Bak);
objFtpResourceEN.FileName_Bak = strFileName_Bak; //FileName_Bak
if (string.IsNullOrEmpty(strComparisonOp) == false)
{
if (objFtpResourceEN.dicFldComparisonOp.ContainsKey(conFtpResource.FileName_Bak) == false)
{
objFtpResourceEN.dicFldComparisonOp.Add(conFtpResource.FileName_Bak, strComparisonOp);
}
else
{
objFtpResourceEN.dicFldComparisonOp[conFtpResource.FileName_Bak] = strComparisonOp;
}
}
return objFtpResourceEN;
	}
...
if (objFtpResource_Cond.IsUpdated(conFtpResource.id_FtpResource) == true)
{
string strComparisonOp_id_FtpResource = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.id_FtpResource];
strWhereCond += string.Format(" And {0} {2} '{1}'", conFtpResource.id_FtpResource, objFtpResource_Cond.id_FtpResource, strComparisonOp_id_FtpResource);
}
...
if (objFtpResource_Cond.IsUpdated(conFtpResource.CheckDateTime) == true)
{
string strComparisonOp_CheckDateTime = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.CheckDateTime];
strWhereCond += string.Format(" And {0} {2} '{1}'", conFtpResource.CheckDateTime, objFtpResource_Cond.CheckDateTime, strComparisonOp_CheckDateTime);
}
...
if (objFtpResource_Cond.IsUpdated(conFtpResource.IsExistFile) == true)
{
if (objFtpResource_Cond.IsExistFile == true)
{
...
if (objFtpResource_Cond.IsUpdated(conFtpResource.FuncModuleId) == true)
{
string strComparisonOp_FuncModuleId = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.FuncModuleId];
strWhereCond += string.Format(" And {0} {2} '{1}'", conFtpResource.FuncModuleId, objFtpResource_Cond.FuncModuleId, strComparisonOp_FuncModuleId);
}
if (objFtpResource_Cond.IsUpdated(conFtpResource.FileResourceID) == true)
{
string strComparisonOp_FileResourceID = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.FileResourceID];
strWhereCond += string.Format(" And {0} {2} {1}", conFtpResource.FileResourceID, objFtpResource_Cond.FileResourceID, strComparisonOp_FileResourceID);
}
if (objFtpResource_Cond.IsUpdated(conFtpResource.FileName_Bak) == true)
{
string strComparisonOp_FileName_Bak = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.FileName_Bak];
strWhereCond += string.Format(" And {0} {2} '{1}'", conFtpResource.FileName_Bak, objFtpResource_Cond.FileName_Bak, strComparisonOp_FileName_Bak);
}
if (objFtpResource_Cond.IsUpdated(conFtpResource.UpdDate) == true)
{
string strComparisonOp_UpdDate = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.UpdDate];
strWhereCond += string.Format(" And {0} {2} '{1}'", conFtpResource.UpdDate, objFtpResource_Cond.UpdDate, strComparisonOp_UpdDate);
}
if (objFtpResource_Cond.IsUpdated(conFtpResource.UpdUser) == true)
{
string strComparisonOp_UpdUser = objFtpResource_Cond.dicFldComparisonOp[conFtpResource.UpdUser];
strWhereCond += string.Format(" And {0} {2} '{1}'", conFtpResource.UpdUser, objFtpResource_Cond.UpdUser, strComparisonOp_UpdUser);
}
 return strWhereCond;
}
...
{
 if (string.IsNullOrEmpty(objFtpResourceEN.id_FtpResource) == true)
 {
...
try
{
objFtpResourceEN.sf_UpdFldSetStr = objFtpResourceEN.getsf_UpdFldSetStr();
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsFtpResourceWApi.IsExist(objFtpResourceEN.id_FtpResource) == true)
 {
string strMsg = string.Format("添加记录时，关键字:[{0}]已经存在!(from {1})\r\n", objFtpResourceEN.id_FtpResource, 
clsStackTrace.GetCurrClassFunction()); 
 throw new Exception(strMsg);
 }
try
...
{
clsFtpResourceWApi.CheckPropertyNew(objFtpResourceEN); 
string strid_FtpResource = clsFtpResourceWApi.AddNewRecordWithMaxId(objFtpResourceEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFtpResourceWApi.ReFreshCache();
return strid_FtpResource;
}
catch (Exception objException)
{
...
public static void BindDdl_id_FtpResource(System.Web.UI.WebControls.DropDownList objDDL)
{
//为数据源于表的下拉框设置内容
System.Web.UI.WebControls.ListItem li = new System.Web.UI.WebControls.ListItem("选[FTP资源]...","0");
List<clsFtpResourceEN> arrObjLst = GetObjLst("1=1");
objDDL.DataValueField="id_FtpResource";
objDDL.DataTextField="FileRename";
...
public static void BindCbo_id_FtpResource(System.Windows.Forms.ComboBox objComboBox )
{
//为数据源为表的下拉框设置内容
string strCondition = string.Format("1 =1 Order By {0}", conFtpResource.id_FtpResource); 
List<clsFtpResourceEN> arrObjLst = clsFtpResourceWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
arrObjLst.Insert(0, objFtpResourceEN);
//设置下拉框的数据源、以及设置值项、显示项
objComboBox.ValueMember = conFtpResource.id_FtpResource;
objComboBox.DisplayMember = conFtpResource.FileRename;
...
{
if (!Object.Equals(null, objFtpResourceEN.id_FtpResource) && GetStrLen(objFtpResourceEN.id_FtpResource) > 8)
{
...
if (!Object.Equals(null, objFtpResourceEN.FileSize) && GetStrLen(objFtpResourceEN.FileSize) > 50)
{
...
if (!Object.Equals(null, objFtpResourceEN.CheckDateTime) && GetStrLen(objFtpResourceEN.CheckDateTime) > 30)
{
...
{
 throw new Exception("字段[上传者]的长度不能超过50!");
}
if (!Object.Equals(null, objFtpResourceEN.FuncModuleId) && GetStrLen(objFtpResourceEN.FuncModuleId) > 4)
{
 throw new Exception("字段[功能模块Id]的长度不能超过4!");
}
if (!Object.Equals(null, objFtpResourceEN.FileName_Bak) && GetStrLen(objFtpResourceEN.FileName_Bak) > 500)
{
 throw new Exception("字段[FileName_Bak]的长度不能超过500!");
}
if (!Object.Equals(null, objFtpResourceEN.UpdDate) && GetStrLen(objFtpResourceEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objFtpResourceEN.UpdUser) && GetStrLen(objFtpResourceEN.UpdUser) > 20)
{
 ...
 /// <returns>表对象</returns>
public static clsFtpResourceEN GetObjByid_FtpResource(string strid_FtpResource)
{
...
throw new Exception(strMsg);
 ...
 /// <param name = "strid_FtpResource">表关键字</param>
 /// <returns>表对象</returns>
public static clsFtpResourceEN GetObjByid_FtpResource_WA_Cache(string strid_FtpResource)
{
...
public static clsFtpResourceEN GetObjByid_FtpResource_Cache(string strid_FtpResource)
{
if (string.IsNullOrEmpty(strid_FtpResource) == true) return null;
//初始化列表缓存
string strKey = string.Format("{0}", clsFtpResourceEN._CurrTabName_S);
...
where objFtpResourceEN.id_FtpResource == strid_FtpResource
select objFtpResourceEN;
if (arrFtpResourceObjLst_Sel.Count() == 0)
{
   clsFtpResourceEN obj = clsFtpResourceWApi.GetObjByid_FtpResource(strid_FtpResource);
   if (obj != null)
 {
...
public static string GetFileRenameByid_FtpResource_Cache(string strid_FtpResource)
{
if (string.IsNullOrEmpty(strid_FtpResource) == true) return "";
//初始化列表缓存
string strKey = string.Format("{0}", clsFtpResourceEN._CurrTabName_S);
List<clsFtpResourceEN> arrFtpResourceObjLst_Cache = GetObjLst_Cache();
IEnumerable <clsFtpResourceEN> arrFtpResourceObjLst_Sel1 =
from objFtpResourceEN in arrFtpResourceObjLst_Cache
where objFtpResourceEN.id_FtpResource == strid_FtpResource
select objFtpResourceEN;
List <clsFtpResourceEN> arrFtpResourceObjLst_Sel = new List<clsFtpResourceEN>();
foreach (clsFtpResourceEN obj in arrFtpResourceObjLst_Sel1)
{
arrFtpResourceObjLst_Sel.Add(obj);
}
if (arrFtpResourceObjLst_Sel.Count > 0)
{
return arrFtpResourceObjLst_Sel[0].FileRename;
}
string strErrMsgForGetObjById = string.Format("在FtpResource对象缓存列表中,找不到记录[id_FtpResource = {0}](函数:{1})", strid_FtpResource, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsFtpResourceBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
 ...
 /// <param name = "strid_FtpResource">所给的关键字</param>
 /// <returns>根据关键字获取的名称</returns>
public static string GetNameByid_FtpResource_Cache(string strid_FtpResource)
{
if (string.IsNullOrEmpty(strid_FtpResource) == true) return "";
//初始化列表缓存
string strKey = string.Format("{0}", clsFtpResourceEN._CurrTabName_S);
...
string strErrMsgForGetObjById = string.Format("在FtpResource对象缓存列表中,找不到记录的相关名称[id_FtpResource = {0}](函数:{1})", strid_FtpResource, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsFtpResourceBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
IEnumerable <clsFtpResourceEN> arrFtpResourceObjLst_Sel =
from objFtpResourceEN in arrFtpResourceObjLst_Cache
where arrId_FtpResource.Contains(objFtpResourceEN.id_FtpResource)
select objFtpResourceEN;
...
public static int DelRecord(string strid_FtpResource)
{
...
try
{
 clsFtpResourceEN objFtpResourceEN = clsFtpResourceWApi.GetObjByid_FtpResource(strid_FtpResource);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strid_FtpResource.ToString(), out strResult, out strErrMsg) == true)
{
JObject jobjReturn = JObject.Parse(strResult);
if ((int)jobjReturn["ErrorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelFtpResources(List<string> arrid_FtpResource)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsFtpResourceWApi.ReFreshCache();
var strid_FtpResource = (string)jobjReturn["ReturnStr"];
return strid_FtpResource;
}
else
{
...
{
if (string.IsNullOrEmpty(objFtpResourceEN.sf_UpdFldSetStr) == true)
{
string strMsg = string.Format("修改时，修改标志串为空，请联系管理员.对象关键字:{0}.(from {1}).",
objFtpResourceEN.id_FtpResource, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
try
{
objFtpResourceENT.id_FtpResource = objFtpResourceENS.id_FtpResource; //FTP资源流水号
...
objFtpResourceENT.FileName_Bak = objFtpResourceENS.FileName_Bak; //FileName_Bak
...
string strKey = string.Format("{0}", clsFtpResourceEN._CurrTabName_S);
CacheHelper.Remove(strKey);
clsFtpResourceWApi.objCommFun4BL.ReFreshCache();
}
}
...
objDT.Columns.Add(conFtpResource.id_FtpResource, Type.GetType("System.String"));
...
objDT.Columns.Add(conFtpResource.FileSize, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.FileType, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.CheckDateTime, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.ResourceOwner, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.IsExistFile, Type.GetType("System.Boolean"));
objDT.Columns.Add(conFtpResource.FuncModuleId, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.FileResourceID, Type.GetType("System.Int64"));
objDT.Columns.Add(conFtpResource.FileName_Bak, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conFtpResource.UpdUser, Type.GetType("System.String"));
foreach (clsFtpResourceEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conFtpResource.id_FtpResource] = objInFor[conFtpResource.id_FtpResource];
...
objDR[conFtpResource.CheckDateTime] = objInFor[conFtpResource.CheckDateTime];
objDR[conFtpResource.ResourceOwner] = objInFor[conFtpResource.ResourceOwner];
objDR[conFtpResource.IsExistFile] = objInFor[conFtpResource.IsExistFile];
objDR[conFtpResource.FuncModuleId] = objInFor[conFtpResource.FuncModuleId];
objDR[conFtpResource.FileResourceID] = objInFor[conFtpResource.FileResourceID];
objDR[conFtpResource.FileName_Bak] = objInFor[conFtpResource.FileName_Bak];
objDR[conFtpResource.UpdDate] = objInFor[conFtpResource.UpdDate];
objDR[conFtpResource.UpdUser] = objInFor[conFtpResource.UpdUser];
