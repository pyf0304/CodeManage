 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsXzGrade_psExWApi
 表名:XzGrade_ps(01120367)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:43:42
 生成者:pyf
...
{
public static class clsXzGrade_psExWApi_Static
{
...
clsXzGrade_psWApi.CopyTo(objXzGrade_psENS, objXzGrade_psENT);
...
public static bool EditRecordEx(this clsXzGrade_psEN objXzGrade_psEN)
{
try
{
objXzGrade_psEN.sf_UpdFldSetStr = objXzGrade_psEN.getsf_UpdFldSetStr();
bool bolResult = clsXzGrade_psExWApi.EditRecordEx(objXzGrade_psEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzGrade_psExWApi
{
//private static readonly string mstrApiControllerName = "XzGrade_psExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzGrade_psEN> arrXzGrade_psObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzGrade_psEN objXzGrade_psEN)
{
