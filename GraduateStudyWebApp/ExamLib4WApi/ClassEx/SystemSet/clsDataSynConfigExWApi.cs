 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsDataSynConfigExWApi
 表名:DataSynConfig(01120226)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:47:43
 生成者:pyf
...
{
public static class clsDataSynConfigExWApi_Static
{
...
clsDataSynConfigWApi.CopyTo(objDataSynConfigENS, objDataSynConfigENT);
...
public static bool EditRecordEx(this clsDataSynConfigEN objDataSynConfigEN)
{
try
{
objDataSynConfigEN.sf_UpdFldSetStr = objDataSynConfigEN.getsf_UpdFldSetStr();
bool bolResult = clsDataSynConfigExWApi.EditRecordEx(objDataSynConfigEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDataSynConfigExWApi
{
//private static readonly string mstrApiControllerName = "DataSynConfigExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDataSynConfigEN> arrDataSynConfigObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDataSynConfigEN objDataSynConfigEN)
{
if (string.IsNullOrEmpty(objDataSynConfigEN.sf_UpdFldSetStr) == true)
{
