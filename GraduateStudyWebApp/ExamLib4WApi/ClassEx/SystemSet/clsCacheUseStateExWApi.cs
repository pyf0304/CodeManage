...
{
public static class clsCacheUseStateExWApi_Static
{
...
clsCacheUseStateWApi.CopyTo(objCacheUseStateENS, objCacheUseStateENT);
...
public static bool EditRecordEx(this clsCacheUseStateEN objCacheUseStateEN)
{
try
{
objCacheUseStateEN.sf_UpdFldSetStr = objCacheUseStateEN.getsf_UpdFldSetStr();
bool bolResult = clsCacheUseStateExWApi.EditRecordEx(objCacheUseStateEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCacheUseStateExWApi
{
//private static readonly string mstrApiControllerName = "CacheUseStateExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCacheUseStateEN> arrCacheUseStateObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCacheUseStateEN objCacheUseStateEN)
{
