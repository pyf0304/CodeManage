...
{
public static class clsExportExcelSetExWApi_Static
{
...
clsExportExcelSetWApi.CopyTo(objExportExcelSetENS, objExportExcelSetENT);
...
public static bool EditRecordEx(this clsExportExcelSetEN objExportExcelSetEN)
{
try
{
objExportExcelSetEN.sf_UpdFldSetStr = objExportExcelSetEN.getsf_UpdFldSetStr();
bool bolResult = clsExportExcelSetExWApi.EditRecordEx(objExportExcelSetEN);
...
/// </summary>
 public clsExportExcelSetExWApi()
 {
 }
...
public static bool EditRecordEx(clsExportExcelSetEN objExportExcelSetEN)
{
