...
{
public static class clsGroupPicRelationExWApi_Static
{
 ...
 public static clsGroupPicRelationENEx CopyToEx(this clsGroupPicRelationEN objGroupPicRelationENS)
{
try
{
 clsGroupPicRelationENEx objGroupPicRelationENT = new clsGroupPicRelationENEx();
clsGroupPicRelationWApi.CopyTo(objGroupPicRelationENS, objGroupPicRelationENT);
...
public static bool EditRecordEx(this clsGroupPicRelationEN objGroupPicRelationEN)
{
try
{
objGroupPicRelationEN.sf_UpdFldSetStr = objGroupPicRelationEN.getsf_UpdFldSetStr();
bool bolResult = clsGroupPicRelationExWApi.EditRecordEx(objGroupPicRelationEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsGroupPicRelationExWApi
{
//private static readonly string mstrApiControllerName = "GroupPicRelationExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsGroupPicRelationEN> arrGroupPicRelationObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsGroupPicRelationExWApi()
 {
 }
...
public static bool EditRecordEx(clsGroupPicRelationEN objGroupPicRelationEN)
{
