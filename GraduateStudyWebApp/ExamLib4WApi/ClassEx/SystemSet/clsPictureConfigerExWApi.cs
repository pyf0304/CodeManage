 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPictureConfigerExWApi
 表名:PictureConfiger(01120039)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:38:14
 生成者:pyf
...
{
public static class clsPictureConfigerExWApi_Static
{
 ...
 public static clsPictureConfigerENEx CopyToEx(this clsPictureConfigerEN objPictureConfigerENS)
{
try
{
 clsPictureConfigerENEx objPictureConfigerENT = new clsPictureConfigerENEx();
clsPictureConfigerWApi.CopyTo(objPictureConfigerENS, objPictureConfigerENT);
...
public static bool EditRecordEx(this clsPictureConfigerEN objPictureConfigerEN)
{
try
{
objPictureConfigerEN.sf_UpdFldSetStr = objPictureConfigerEN.getsf_UpdFldSetStr();
bool bolResult = clsPictureConfigerExWApi.EditRecordEx(objPictureConfigerEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPictureConfigerExWApi
{
//private static readonly string mstrApiControllerName = "PictureConfigerExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPictureConfigerEN> arrPictureConfigerObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPictureConfigerExWApi()
 {
 }
...
public static bool EditRecordEx(clsPictureConfigerEN objPictureConfigerEN)
{
