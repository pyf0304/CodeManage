...
{
public static class clsFunctionNameTabExWApi_Static
{
 ...
 public static clsFunctionNameTabENEx CopyToEx(this clsFunctionNameTabEN objFunctionNameTabENS)
{
try
{
 clsFunctionNameTabENEx objFunctionNameTabENT = new clsFunctionNameTabENEx();
clsFunctionNameTabWApi.CopyTo(objFunctionNameTabENS, objFunctionNameTabENT);
...
public static bool EditRecordEx(this clsFunctionNameTabEN objFunctionNameTabEN)
{
try
{
objFunctionNameTabEN.sf_UpdFldSetStr = objFunctionNameTabEN.getsf_UpdFldSetStr();
bool bolResult = clsFunctionNameTabExWApi.EditRecordEx(objFunctionNameTabEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFunctionNameTabExWApi
{
//private static readonly string mstrApiControllerName = "FunctionNameTabExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsFunctionNameTabEN> arrFunctionNameTabObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsFunctionNameTabExWApi()
 {
 }
...
public static bool EditRecordEx(clsFunctionNameTabEN objFunctionNameTabEN)
{
