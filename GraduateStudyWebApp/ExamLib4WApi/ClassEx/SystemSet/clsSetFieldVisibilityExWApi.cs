...
{
public static class clsSetFieldVisibilityExWApi_Static
{
 ...
 public static clsSetFieldVisibilityENEx CopyToEx(this clsSetFieldVisibilityEN objSetFieldVisibilityENS)
{
try
{
 clsSetFieldVisibilityENEx objSetFieldVisibilityENT = new clsSetFieldVisibilityENEx();
clsSetFieldVisibilityWApi.CopyTo(objSetFieldVisibilityENS, objSetFieldVisibilityENT);
...
public static bool EditRecordEx(this clsSetFieldVisibilityEN objSetFieldVisibilityEN)
{
try
{
objSetFieldVisibilityEN.sf_UpdFldSetStr = objSetFieldVisibilityEN.getsf_UpdFldSetStr();
bool bolResult = clsSetFieldVisibilityExWApi.EditRecordEx(objSetFieldVisibilityEN);
...
/// </summary>
 public clsSetFieldVisibilityExWApi()
 {
 }
...
public static bool EditRecordEx(clsSetFieldVisibilityEN objSetFieldVisibilityEN)
{
