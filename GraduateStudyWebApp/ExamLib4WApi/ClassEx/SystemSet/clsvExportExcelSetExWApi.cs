...
{
public static class clsvExportExcelSetExWApi_Static
{
...
clsvExportExcelSetWApi.CopyTo(objvExportExcelSetENS, objvExportExcelSetENT);
...
/// </summary>
 public clsvExportExcelSetExWApi()
 {
 }
...
public static bool EditRecordEx(clsvExportExcelSetEN objvExportExcelSetEN)
{
if (string.IsNullOrEmpty(objvExportExcelSetEN.sf_UpdFldSetStr) == true)
{
string strMsg = string.Format("修改时，修改标志串为空，请联系管理员.对象关键字:{0}.(from {1}).",
objvExportExcelSetEN.id_ExportExcel4Users, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
