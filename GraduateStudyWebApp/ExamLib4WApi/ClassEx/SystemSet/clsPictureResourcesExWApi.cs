...
{
public static class clsPictureResourcesExWApi_Static
{
 ...
 public static clsPictureResourcesENEx CopyToEx(this clsPictureResourcesEN objPictureResourcesENS)
{
try
{
 clsPictureResourcesENEx objPictureResourcesENT = new clsPictureResourcesENEx();
clsPictureResourcesWApi.CopyTo(objPictureResourcesENS, objPictureResourcesENT);
...
public static bool EditRecordEx(this clsPictureResourcesEN objPictureResourcesEN)
{
try
{
objPictureResourcesEN.sf_UpdFldSetStr = objPictureResourcesEN.getsf_UpdFldSetStr();
bool bolResult = clsPictureResourcesExWApi.EditRecordEx(objPictureResourcesEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPictureResourcesExWApi
{
//private static readonly string mstrApiControllerName = "PictureResourcesExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPictureResourcesEN> arrPictureResourcesObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPictureResourcesExWApi()
 {
 }
...
public static bool EditRecordEx(clsPictureResourcesEN objPictureResourcesEN)
{
