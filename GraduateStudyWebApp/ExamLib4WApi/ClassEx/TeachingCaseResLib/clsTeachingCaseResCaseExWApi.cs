...
{
public static class clsTeachingCaseResCaseExWApi_Static
{
...
clsTeachingCaseResCaseWApi.CopyTo(objTeachingCaseResCaseENS, objTeachingCaseResCaseENT);
...
public static bool EditRecordEx(this clsTeachingCaseResCaseEN objTeachingCaseResCaseEN)
{
try
{
objTeachingCaseResCaseEN.sf_UpdFldSetStr = objTeachingCaseResCaseEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachingCaseResCaseExWApi.EditRecordEx(objTeachingCaseResCaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachingCaseResCaseExWApi
{
//private static readonly string mstrApiControllerName = "TeachingCaseResCaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachingCaseResCaseEN> arrTeachingCaseResCaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsTeachingCaseResCaseExWApi()
 {
 }
...
public static bool EditRecordEx(clsTeachingCaseResCaseEN objTeachingCaseResCaseEN)
{
