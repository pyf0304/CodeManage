...
{
public static class clsUserAnswerResultExWApi_Static
{
...
clsUserAnswerResultWApi.CopyTo(objUserAnswerResultENS, objUserAnswerResultENT);
...
public static bool EditRecordEx(this clsUserAnswerResultEN objUserAnswerResultEN)
{
try
{
objUserAnswerResultEN.sf_UpdFldSetStr = objUserAnswerResultEN.getsf_UpdFldSetStr();
bool bolResult = clsUserAnswerResultExWApi.EditRecordEx(objUserAnswerResultEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsUserAnswerResultExWApi
{
//private static readonly string mstrApiControllerName = "UserAnswerResultExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsUserAnswerResultEN> arrUserAnswerResultObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsUserAnswerResultExWApi()
 {
 }
...
public static bool EditRecordEx(clsUserAnswerResultEN objUserAnswerResultEN)
{
