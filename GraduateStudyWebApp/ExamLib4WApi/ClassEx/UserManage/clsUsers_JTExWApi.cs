...
{
public static class clsUsers_JTExWApi_Static
{
 ...
 /// <returns>目标对象=>clsUsers_JTEN:objUsers_JTENT</returns>
 public static clsUsers_JTENEx CopyToEx(this clsUsers_JTEN objUsers_JTENS)
{
try
{
 clsUsers_JTENEx objUsers_JTENT = new clsUsers_JTENEx();
clsUsers_JTWApi.CopyTo(objUsers_JTENS, objUsers_JTENT);
...
public static bool EditRecordEx(this clsUsers_JTEN objUsers_JTEN)
{
try
{
objUsers_JTEN.sf_UpdFldSetStr = objUsers_JTEN.getsf_UpdFldSetStr();
bool bolResult = clsUsers_JTExWApi.EditRecordEx(objUsers_JTEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsUsers_JTExWApi
{
//private static readonly string mstrApiControllerName = "Users_JTExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsUsers_JTEN> arrUsers_JTObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsUsers_JTEN objUsers_JTEN)
{
