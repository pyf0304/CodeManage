...
{
public static class clsStudentInfoExWApi_Static
{
 ...
 public static clsStudentInfoENEx CopyToEx(this clsStudentInfoEN objStudentInfoENS)
{
try
{
 clsStudentInfoENEx objStudentInfoENT = new clsStudentInfoENEx();
clsStudentInfoWApi.CopyTo(objStudentInfoENS, objStudentInfoENT);
...
public static bool EditRecordEx(this clsStudentInfoEN objStudentInfoEN)
{
try
{
objStudentInfoEN.sf_UpdFldSetStr = objStudentInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsStudentInfoExWApi.EditRecordEx(objStudentInfoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsStudentInfoExWApi
{
//private static readonly string mstrApiControllerName = "StudentInfoExApi";
 /// <summary>
...
public static bool EditRecordEx(clsStudentInfoEN objStudentInfoEN)
{
