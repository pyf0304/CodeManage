...
{
public static class clsUsersExWApi_Static
{
...
clsUsersWApi.CopyTo(objUsersENS, objUsersENT);
 return objUsersENT;
}
...
public static bool EditRecordEx(this clsUsersEN objUsersEN)
{
try
{
objUsersEN.sf_UpdFldSetStr = objUsersEN.getsf_UpdFldSetStr();
bool bolResult = clsUsersExWApi.EditRecordEx(objUsersEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsUsersExWApi
{
//private static readonly string mstrApiControllerName = "UsersExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsUsersEN> arrUsersObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsUsersEN objUsersEN)
{
