...
{
public static class clsQxUserStateExWApi_Static
{
...
clsQxUserStateWApi.CopyTo(objQxUserStateENS, objQxUserStateENT);
...
public static bool EditRecordEx(this clsQxUserStateEN objQxUserStateEN)
{
try
{
objQxUserStateEN.sf_UpdFldSetStr = objQxUserStateEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserStateExWApi.EditRecordEx(objQxUserStateEN);
...
{
//private static readonly string mstrApiControllerName = "QxUserStateExApi";
 /// <summary>
...
public static bool EditRecordEx(clsQxUserStateEN objQxUserStateEN)
{
