...
{
public static class clsManagedDepartmentExWApi_Static
{
...
clsManagedDepartmentWApi.CopyTo(objManagedDepartmentENS, objManagedDepartmentENT);
...
public static bool EditRecordEx(this clsManagedDepartmentEN objManagedDepartmentEN)
{
try
{
objManagedDepartmentEN.sf_UpdFldSetStr = objManagedDepartmentEN.getsf_UpdFldSetStr();
bool bolResult = clsManagedDepartmentExWApi.EditRecordEx(objManagedDepartmentEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsManagedDepartmentExWApi
{
//private static readonly string mstrApiControllerName = "ManagedDepartmentExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsManagedDepartmentEN> arrManagedDepartmentObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsManagedDepartmentExWApi()
 {
 }
...
public static bool EditRecordEx(clsManagedDepartmentEN objManagedDepartmentEN)
{
