...
{
public static class clsQxDepartmentInfoExWApi_Static
{
...
clsQxDepartmentInfoWApi.CopyTo(objQxDepartmentInfoENS, objQxDepartmentInfoENT);
...
public static bool EditRecordEx(this clsQxDepartmentInfoEN objQxDepartmentInfoEN)
{
try
{
objQxDepartmentInfoEN.sf_UpdFldSetStr = objQxDepartmentInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsQxDepartmentInfoExWApi.EditRecordEx(objQxDepartmentInfoEN);
...
/// </summary>
 public clsQxDepartmentInfoExWApi()
 {
 }
...
public static bool EditRecordEx(clsQxDepartmentInfoEN objQxDepartmentInfoEN)
{
