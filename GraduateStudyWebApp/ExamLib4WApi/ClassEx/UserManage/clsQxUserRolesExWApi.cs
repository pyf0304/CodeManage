...
{
public static class clsQxUserRolesExWApi_Static
{
 ...
 /// <returns>目标对象=>clsQxUserRolesEN:objQxUserRolesENT</returns>
 public static clsQxUserRolesENEx CopyToEx(this clsQxUserRolesEN objQxUserRolesENS)
{
try
{
 clsQxUserRolesENEx objQxUserRolesENT = new clsQxUserRolesENEx();
clsQxUserRolesWApi.CopyTo(objQxUserRolesENS, objQxUserRolesENT);
...
public static bool EditRecordEx(this clsQxUserRolesEN objQxUserRolesEN)
{
try
{
objQxUserRolesEN.sf_UpdFldSetStr = objQxUserRolesEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserRolesExWApi.EditRecordEx(objQxUserRolesEN);
...
public static bool EditRecordEx(clsQxUserRolesEN objQxUserRolesEN)
{
