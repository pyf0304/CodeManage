...
{
public static class clsQxUserIdentityExWApi_Static
{
...
clsQxUserIdentityWApi.CopyTo(objQxUserIdentityENS, objQxUserIdentityENT);
...
public static bool EditRecordEx(this clsQxUserIdentityEN objQxUserIdentityEN)
{
try
{
objQxUserIdentityEN.sf_UpdFldSetStr = objQxUserIdentityEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserIdentityExWApi.EditRecordEx(objQxUserIdentityEN);
...
{
//private static readonly string mstrApiControllerName = "QxUserIdentityExApi";
 /// <summary>
...
/// </summary>
 public clsQxUserIdentityExWApi()
 {
 }
...
public static bool EditRecordEx(clsQxUserIdentityEN objQxUserIdentityEN)
{
