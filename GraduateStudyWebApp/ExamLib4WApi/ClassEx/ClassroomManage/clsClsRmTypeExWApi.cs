...
{
public static class clsClsRmTypeExWApi_Static
{
...
clsClsRmTypeWApi.CopyTo(objClsRmTypeENS, objClsRmTypeENT);
...
public static bool EditRecordEx(this clsClsRmTypeEN objClsRmTypeEN)
{
try
{
objClsRmTypeEN.sf_UpdFldSetStr = objClsRmTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsClsRmTypeExWApi.EditRecordEx(objClsRmTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsClsRmTypeExWApi
{
//private static readonly string mstrApiControllerName = "ClsRmTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsClsRmTypeEN> arrClsRmTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsClsRmTypeEN objClsRmTypeEN)
{
