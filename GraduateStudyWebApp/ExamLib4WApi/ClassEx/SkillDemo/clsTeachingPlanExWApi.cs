 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachingPlanExWApi
 表名:TeachingPlan(01120387)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:51:43
 生成者:pyf
...
{
public static class clsTeachingPlanExWApi_Static
{
 ...
 public static clsTeachingPlanENEx CopyToEx(this clsTeachingPlanEN objTeachingPlanENS)
{
try
{
 clsTeachingPlanENEx objTeachingPlanENT = new clsTeachingPlanENEx();
clsTeachingPlanWApi.CopyTo(objTeachingPlanENS, objTeachingPlanENT);
...
public static bool EditRecordEx(this clsTeachingPlanEN objTeachingPlanEN)
{
try
{
objTeachingPlanEN.sf_UpdFldSetStr = objTeachingPlanEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachingPlanExWApi.EditRecordEx(objTeachingPlanEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachingPlanExWApi
{
//private static readonly string mstrApiControllerName = "TeachingPlanExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachingPlanEN> arrTeachingPlanObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsTeachingPlanEN objTeachingPlanEN)
{
