 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachCaseRelaInfoTypeExWApi
...
{
public static class clsTeachCaseRelaInfoTypeExWApi_Static
{
...
clsTeachCaseRelaInfoTypeWApi.CopyTo(objTeachCaseRelaInfoTypeENS, objTeachCaseRelaInfoTypeENT);
...
public static bool EditRecordEx(this clsTeachCaseRelaInfoTypeEN objTeachCaseRelaInfoTypeEN)
{
try
{
objTeachCaseRelaInfoTypeEN.sf_UpdFldSetStr = objTeachCaseRelaInfoTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachCaseRelaInfoTypeExWApi.EditRecordEx(objTeachCaseRelaInfoTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachCaseRelaInfoTypeExWApi
{
//private static readonly string mstrApiControllerName = "TeachCaseRelaInfoTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachCaseRelaInfoTypeEN> arrTeachCaseRelaInfoTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsTeachCaseRelaInfoTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsTeachCaseRelaInfoTypeEN objTeachCaseRelaInfoTypeEN)
{
