 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachCase_Resource_RelExWApi
...
{
public static class clsTeachCase_Resource_RelExWApi_Static
{
...
clsTeachCase_Resource_RelWApi.CopyTo(objTeachCase_Resource_RelENS, objTeachCase_Resource_RelENT);
...
public static bool EditRecordEx(this clsTeachCase_Resource_RelEN objTeachCase_Resource_RelEN)
{
try
{
objTeachCase_Resource_RelEN.sf_UpdFldSetStr = objTeachCase_Resource_RelEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachCase_Resource_RelExWApi.EditRecordEx(objTeachCase_Resource_RelEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachCase_Resource_RelExWApi
{
//private static readonly string mstrApiControllerName = "TeachCase_Resource_RelExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachCase_Resource_RelEN> arrTeachCase_Resource_RelObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsTeachCase_Resource_RelExWApi()
 {
 }
...
public static bool EditRecordEx(clsTeachCase_Resource_RelEN objTeachCase_Resource_RelEN)
{
