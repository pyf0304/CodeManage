 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachCaseExWApi
 表名:TeachCase(01120383)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:42:28
 生成者:pyf
...
{
public static class clsTeachCaseExWApi_Static
{
...
clsTeachCaseWApi.CopyTo(objTeachCaseENS, objTeachCaseENT);
...
public static bool EditRecordEx(this clsTeachCaseEN objTeachCaseEN)
{
try
{
objTeachCaseEN.sf_UpdFldSetStr = objTeachCaseEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachCaseExWApi.EditRecordEx(objTeachCaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachCaseExWApi
{
//private static readonly string mstrApiControllerName = "TeachCaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachCaseEN> arrTeachCaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsTeachCaseEN objTeachCaseEN)
{
