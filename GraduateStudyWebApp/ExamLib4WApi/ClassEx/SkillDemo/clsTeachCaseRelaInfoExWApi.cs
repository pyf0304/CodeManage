 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachCaseRelaInfoExWApi
 表名:TeachCaseRelaInfo(01120513)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:49:58
 生成者:pyf
...
{
public static class clsTeachCaseRelaInfoExWApi_Static
{
...
clsTeachCaseRelaInfoWApi.CopyTo(objTeachCaseRelaInfoENS, objTeachCaseRelaInfoENT);
...
public static bool EditRecordEx(this clsTeachCaseRelaInfoEN objTeachCaseRelaInfoEN)
{
try
{
objTeachCaseRelaInfoEN.sf_UpdFldSetStr = objTeachCaseRelaInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachCaseRelaInfoExWApi.EditRecordEx(objTeachCaseRelaInfoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachCaseRelaInfoExWApi
{
//private static readonly string mstrApiControllerName = "TeachCaseRelaInfoExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachCaseRelaInfoEN> arrTeachCaseRelaInfoObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsTeachCaseRelaInfoExWApi()
 {
 }
...
public static bool EditRecordEx(clsTeachCaseRelaInfoEN objTeachCaseRelaInfoEN)
{
