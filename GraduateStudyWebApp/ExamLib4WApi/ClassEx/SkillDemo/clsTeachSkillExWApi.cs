...
{
public static class clsTeachSkillExWApi_Static
{
...
clsTeachSkillWApi.CopyTo(objTeachSkillENS, objTeachSkillENT);
...
public static bool EditRecordEx(this clsTeachSkillEN objTeachSkillEN)
{
try
{
objTeachSkillEN.sf_UpdFldSetStr = objTeachSkillEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachSkillExWApi.EditRecordEx(objTeachSkillEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachSkillExWApi
{
//private static readonly string mstrApiControllerName = "TeachSkillExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachSkillEN> arrTeachSkillObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsTeachSkillEN objTeachSkillEN)
{
