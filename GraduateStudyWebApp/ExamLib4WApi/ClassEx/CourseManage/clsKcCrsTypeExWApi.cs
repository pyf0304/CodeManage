...
{
public static class clsKcCrsTypeExWApi_Static
{
...
clsKcCrsTypeWApi.CopyTo(objKcCrsTypeENS, objKcCrsTypeENT);
...
public static bool EditRecordEx(this clsKcCrsTypeEN objKcCrsTypeEN)
{
try
{
objKcCrsTypeEN.sf_UpdFldSetStr = objKcCrsTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsKcCrsTypeExWApi.EditRecordEx(objKcCrsTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKcCrsTypeExWApi
{
//private static readonly string mstrApiControllerName = "KcCrsTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKcCrsTypeEN> arrKcCrsTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsKcCrsTypeEN objKcCrsTypeEN)
{
