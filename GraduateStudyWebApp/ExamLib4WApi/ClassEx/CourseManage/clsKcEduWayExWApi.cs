...
{
public static class clsKcEduWayExWApi_Static
{
...
clsKcEduWayWApi.CopyTo(objKcEduWayENS, objKcEduWayENT);
...
public static bool EditRecordEx(this clsKcEduWayEN objKcEduWayEN)
{
try
{
objKcEduWayEN.sf_UpdFldSetStr = objKcEduWayEN.getsf_UpdFldSetStr();
bool bolResult = clsKcEduWayExWApi.EditRecordEx(objKcEduWayEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKcEduWayExWApi
{
//private static readonly string mstrApiControllerName = "KcEduWayExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKcEduWayEN> arrKcEduWayObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsKcEduWayEN objKcEduWayEN)
{
