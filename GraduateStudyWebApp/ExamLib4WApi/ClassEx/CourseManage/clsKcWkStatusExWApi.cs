...
{
public static class clsKcWkStatusExWApi_Static
{
...
clsKcWkStatusWApi.CopyTo(objKcWkStatusENS, objKcWkStatusENT);
...
public static bool EditRecordEx(this clsKcWkStatusEN objKcWkStatusEN)
{
try
{
objKcWkStatusEN.sf_UpdFldSetStr = objKcWkStatusEN.getsf_UpdFldSetStr();
bool bolResult = clsKcWkStatusExWApi.EditRecordEx(objKcWkStatusEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKcWkStatusExWApi
{
//private static readonly string mstrApiControllerName = "KcWkStatusExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKcWkStatusEN> arrKcWkStatusObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsKcWkStatusEN objKcWkStatusEN)
{
