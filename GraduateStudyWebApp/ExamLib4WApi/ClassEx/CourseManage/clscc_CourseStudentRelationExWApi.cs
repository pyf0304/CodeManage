...
{
public static class clscc_CourseStudentRelationExWApi_Static
{
...
clscc_CourseStudentRelationWApi.CopyTo(objcc_CourseStudentRelationENS, objcc_CourseStudentRelationENT);
...
public static bool EditRecordEx(this clscc_CourseStudentRelationEN objcc_CourseStudentRelationEN)
{
try
{
objcc_CourseStudentRelationEN.sf_UpdFldSetStr = objcc_CourseStudentRelationEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseStudentRelationExWApi.EditRecordEx(objcc_CourseStudentRelationEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseStudentRelationExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseStudentRelationExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseStudentRelationEN> arrcc_CourseStudentRelationObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_CourseStudentRelationExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_CourseStudentRelationEN objcc_CourseStudentRelationEN)
{
