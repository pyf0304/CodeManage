...
{
public static class clsPaperSubViewpointAppraiseExWApi_Static
{
...
clsPaperSubViewpointAppraiseWApi.CopyTo(objPaperSubViewpointAppraiseENS, objPaperSubViewpointAppraiseENT);
...
public static bool EditRecordEx(this clsPaperSubViewpointAppraiseEN objPaperSubViewpointAppraiseEN)
{
try
{
objPaperSubViewpointAppraiseEN.sf_UpdFldSetStr = objPaperSubViewpointAppraiseEN.getsf_UpdFldSetStr();
bool bolResult = clsPaperSubViewpointAppraiseExWApi.EditRecordEx(objPaperSubViewpointAppraiseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPaperSubViewpointAppraiseExWApi
{
//private static readonly string mstrApiControllerName = "PaperSubViewpointAppraiseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPaperSubViewpointAppraiseEN> arrPaperSubViewpointAppraiseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPaperSubViewpointAppraiseExWApi()
 {
 }
...
public static bool EditRecordEx(clsPaperSubViewpointAppraiseEN objPaperSubViewpointAppraiseEN)
{
