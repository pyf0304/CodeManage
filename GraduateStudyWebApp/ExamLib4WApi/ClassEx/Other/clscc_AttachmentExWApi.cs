...
{
public static class clscc_AttachmentExWApi_Static
{
 ...
 public static clscc_AttachmentENEx CopyToEx(this clscc_AttachmentEN objcc_AttachmentENS)
{
try
{
 clscc_AttachmentENEx objcc_AttachmentENT = new clscc_AttachmentENEx();
clscc_AttachmentWApi.CopyTo(objcc_AttachmentENS, objcc_AttachmentENT);
...
public static bool EditRecordEx(this clscc_AttachmentEN objcc_AttachmentEN)
{
try
{
objcc_AttachmentEN.sf_UpdFldSetStr = objcc_AttachmentEN.getsf_UpdFldSetStr();
bool bolResult = clscc_AttachmentExWApi.EditRecordEx(objcc_AttachmentEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_AttachmentExWApi
{
//private static readonly string mstrApiControllerName = "cc_AttachmentExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_AttachmentEN> arrcc_AttachmentObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clscc_AttachmentEN objcc_AttachmentEN)
{
