 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsAllDataTypeExWApi
 表名:AllDataType(01120531)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:45:58
 生成者:pyf
...
{
public static class clsAllDataTypeExWApi_Static
{
 ...
 public static clsAllDataTypeENEx CopyToEx(this clsAllDataTypeEN objAllDataTypeENS)
{
try
{
 clsAllDataTypeENEx objAllDataTypeENT = new clsAllDataTypeENEx();
clsAllDataTypeWApi.CopyTo(objAllDataTypeENS, objAllDataTypeENT);
...
public static bool EditRecordEx(this clsAllDataTypeEN objAllDataTypeEN)
{
try
{
objAllDataTypeEN.sf_UpdFldSetStr = objAllDataTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsAllDataTypeExWApi.EditRecordEx(objAllDataTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsAllDataTypeExWApi
{
//private static readonly string mstrApiControllerName = "AllDataTypeExApi";
 /// <summary>
...
public static bool EditRecordEx(clsAllDataTypeEN objAllDataTypeEN)
{
