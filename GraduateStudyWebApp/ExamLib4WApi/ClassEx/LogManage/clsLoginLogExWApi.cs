...
{
public static class clsLoginLogExWApi_Static
{
...
clsLoginLogWApi.CopyTo(objLoginLogENS, objLoginLogENT);
...
public static bool EditRecordEx(this clsLoginLogEN objLoginLogEN)
{
try
{
objLoginLogEN.sf_UpdFldSetStr = objLoginLogEN.getsf_UpdFldSetStr();
bool bolResult = clsLoginLogExWApi.EditRecordEx(objLoginLogEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsLoginLogExWApi
{
//private static readonly string mstrApiControllerName = "LoginLogExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsLoginLogEN> arrLoginLogObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsLoginLogEN objLoginLogEN)
{
