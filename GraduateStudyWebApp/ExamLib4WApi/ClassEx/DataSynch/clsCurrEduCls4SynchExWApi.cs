...
{
public static class clsCurrEduCls4SynchExWApi_Static
{
...
clsCurrEduCls4SynchWApi.CopyTo(objCurrEduCls4SynchENS, objCurrEduCls4SynchENT);
...
public static bool EditRecordEx(this clsCurrEduCls4SynchEN objCurrEduCls4SynchEN)
{
try
{
objCurrEduCls4SynchEN.sf_UpdFldSetStr = objCurrEduCls4SynchEN.getsf_UpdFldSetStr();
bool bolResult = clsCurrEduCls4SynchExWApi.EditRecordEx(objCurrEduCls4SynchEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCurrEduCls4SynchExWApi
{
//private static readonly string mstrApiControllerName = "CurrEduCls4SynchExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCurrEduCls4SynchEN> arrCurrEduCls4SynchObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCurrEduCls4SynchExWApi()
 {
 }
...
public static bool EditRecordEx(clsCurrEduCls4SynchEN objCurrEduCls4SynchEN)
{
