...
{
public static class clsResourceTypeExWApi_Static
{
 ...
 public static clsResourceTypeENEx CopyToEx(this clsResourceTypeEN objResourceTypeENS)
{
try
{
 clsResourceTypeENEx objResourceTypeENT = new clsResourceTypeENEx();
clsResourceTypeWApi.CopyTo(objResourceTypeENS, objResourceTypeENT);
...
public static bool EditRecordEx(this clsResourceTypeEN objResourceTypeEN)
{
try
{
objResourceTypeEN.sf_UpdFldSetStr = objResourceTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsResourceTypeExWApi.EditRecordEx(objResourceTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsResourceTypeExWApi
{
//private static readonly string mstrApiControllerName = "ResourceTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsResourceTypeEN> arrResourceTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsResourceTypeEN objResourceTypeEN)
{
