...
{
public static class clstz_ContentAttachmentExWApi_Static
{
 ...
 public static clstz_ContentAttachmentENEx CopyToEx(this clstz_ContentAttachmentEN objtz_ContentAttachmentENS)
{
try
{
 clstz_ContentAttachmentENEx objtz_ContentAttachmentENT = new clstz_ContentAttachmentENEx();
clstz_ContentAttachmentWApi.CopyTo(objtz_ContentAttachmentENS, objtz_ContentAttachmentENT);
...
public static bool EditRecordEx(this clstz_ContentAttachmentEN objtz_ContentAttachmentEN)
{
try
{
objtz_ContentAttachmentEN.sf_UpdFldSetStr = objtz_ContentAttachmentEN.getsf_UpdFldSetStr();
bool bolResult = clstz_ContentAttachmentExWApi.EditRecordEx(objtz_ContentAttachmentEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clstz_ContentAttachmentExWApi
{
//private static readonly string mstrApiControllerName = "tz_ContentAttachmentExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clstz_ContentAttachmentEN> arrtz_ContentAttachmentObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clstz_ContentAttachmentExWApi()
 {
 }
...
public static bool EditRecordEx(clstz_ContentAttachmentEN objtz_ContentAttachmentEN)
{
