...
{
public static class clsResourceExWApi_Static
{
...
clsResourceWApi.CopyTo(objResourceENS, objResourceENT);
...
public static bool EditRecordEx(this clsResourceEN objResourceEN)
{
try
{
objResourceEN.sf_UpdFldSetStr = objResourceEN.getsf_UpdFldSetStr();
bool bolResult = clsResourceExWApi.EditRecordEx(objResourceEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsResourceExWApi
{
//private static readonly string mstrApiControllerName = "ResourceExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsResourceEN> arrResourceObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsResourceEN objResourceEN)
{
