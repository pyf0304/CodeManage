 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsVideoLibExWApi
 表名:VideoLib(01120261)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:50:26
 生成者:pyf
...
{
public static class clsVideoLibExWApi_Static
{
...
clsVideoLibWApi.CopyTo(objVideoLibENS, objVideoLibENT);
...
public static bool EditRecordEx(this clsVideoLibEN objVideoLibEN)
{
try
{
objVideoLibEN.sf_UpdFldSetStr = objVideoLibEN.getsf_UpdFldSetStr();
bool bolResult = clsVideoLibExWApi.EditRecordEx(objVideoLibEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsVideoLibExWApi
{
//private static readonly string mstrApiControllerName = "VideoLibExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsVideoLibEN> arrVideoLibObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsVideoLibEN objVideoLibEN)
{
