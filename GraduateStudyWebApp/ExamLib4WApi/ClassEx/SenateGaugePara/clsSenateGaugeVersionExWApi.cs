 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsSenateGaugeVersionExWApi
 表名:SenateGaugeVersion(01120297)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:45:42
 生成者:pyf
...
{
public static class clsSenateGaugeVersionExWApi_Static
{
...
clsSenateGaugeVersionWApi.CopyTo(objSenateGaugeVersionENS, objSenateGaugeVersionENT);
...
public static bool EditRecordEx(this clsSenateGaugeVersionEN objSenateGaugeVersionEN)
{
try
{
objSenateGaugeVersionEN.sf_UpdFldSetStr = objSenateGaugeVersionEN.getsf_UpdFldSetStr();
bool bolResult = clsSenateGaugeVersionExWApi.EditRecordEx(objSenateGaugeVersionEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsSenateGaugeVersionExWApi
{
//private static readonly string mstrApiControllerName = "SenateGaugeVersionExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsSenateGaugeVersionEN> arrSenateGaugeVersionObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsSenateGaugeVersionExWApi()
 {
 }
...
public static bool EditRecordEx(clsSenateGaugeVersionEN objSenateGaugeVersionEN)
{
