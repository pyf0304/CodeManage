 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsSenateGaugeSubItemsExWApi
 表名:SenateGaugeSubItems(01120478)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:41:55
 生成者:pyf
...
{
public static class clsSenateGaugeSubItemsExWApi_Static
{
 ...
 public static clsSenateGaugeSubItemsENEx CopyToEx(this clsSenateGaugeSubItemsEN objSenateGaugeSubItemsENS)
{
try
{
 clsSenateGaugeSubItemsENEx objSenateGaugeSubItemsENT = new clsSenateGaugeSubItemsENEx();
clsSenateGaugeSubItemsWApi.CopyTo(objSenateGaugeSubItemsENS, objSenateGaugeSubItemsENT);
...
public static bool EditRecordEx(this clsSenateGaugeSubItemsEN objSenateGaugeSubItemsEN)
{
try
{
objSenateGaugeSubItemsEN.sf_UpdFldSetStr = objSenateGaugeSubItemsEN.getsf_UpdFldSetStr();
bool bolResult = clsSenateGaugeSubItemsExWApi.EditRecordEx(objSenateGaugeSubItemsEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsSenateGaugeSubItemsExWApi
{
//private static readonly string mstrApiControllerName = "SenateGaugeSubItemsExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsSenateGaugeSubItemsEN> arrSenateGaugeSubItemsObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsSenateGaugeSubItemsExWApi()
 {
 }
...
public static bool EditRecordEx(clsSenateGaugeSubItemsEN objSenateGaugeSubItemsEN)
{
