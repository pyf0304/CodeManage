 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsAppraiseTypeKindSetExWApi
...
{
public static class clsAppraiseTypeKindSetExWApi_Static
{
 ...
 public static clsAppraiseTypeKindSetENEx CopyToEx(this clsAppraiseTypeKindSetEN objAppraiseTypeKindSetENS)
{
try
{
 clsAppraiseTypeKindSetENEx objAppraiseTypeKindSetENT = new clsAppraiseTypeKindSetENEx();
clsAppraiseTypeKindSetWApi.CopyTo(objAppraiseTypeKindSetENS, objAppraiseTypeKindSetENT);
...
public static bool EditRecordEx(this clsAppraiseTypeKindSetEN objAppraiseTypeKindSetEN)
{
try
{
objAppraiseTypeKindSetEN.sf_UpdFldSetStr = objAppraiseTypeKindSetEN.getsf_UpdFldSetStr();
bool bolResult = clsAppraiseTypeKindSetExWApi.EditRecordEx(objAppraiseTypeKindSetEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsAppraiseTypeKindSetExWApi
{
//private static readonly string mstrApiControllerName = "AppraiseTypeKindSetExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsAppraiseTypeKindSetEN> arrAppraiseTypeKindSetObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsAppraiseTypeKindSetExWApi()
 {
 }
...
public static bool EditRecordEx(clsAppraiseTypeKindSetEN objAppraiseTypeKindSetEN)
{
