...
{
public static class clsRecommendedDegreeExWApi_Static
{
...
clsRecommendedDegreeWApi.CopyTo(objRecommendedDegreeENS, objRecommendedDegreeENT);
...
public static bool EditRecordEx(this clsRecommendedDegreeEN objRecommendedDegreeEN)
{
try
{
objRecommendedDegreeEN.sf_UpdFldSetStr = objRecommendedDegreeEN.getsf_UpdFldSetStr();
bool bolResult = clsRecommendedDegreeExWApi.EditRecordEx(objRecommendedDegreeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsRecommendedDegreeExWApi
{
//private static readonly string mstrApiControllerName = "RecommendedDegreeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsRecommendedDegreeEN> arrRecommendedDegreeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsRecommendedDegreeExWApi()
 {
 }
...
public static bool EditRecordEx(clsRecommendedDegreeEN objRecommendedDegreeEN)
{
