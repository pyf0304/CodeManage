...
{
public static class clsXzAdminClsExWApi_Static
{
...
clsXzAdminClsWApi.CopyTo(objXzAdminClsENS, objXzAdminClsENT);
...
public static bool EditRecordEx(this clsXzAdminClsEN objXzAdminClsEN)
{
try
{
objXzAdminClsEN.sf_UpdFldSetStr = objXzAdminClsEN.getsf_UpdFldSetStr();
bool bolResult = clsXzAdminClsExWApi.EditRecordEx(objXzAdminClsEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzAdminClsExWApi
{
//private static readonly string mstrApiControllerName = "XzAdminClsExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzAdminClsEN> arrXzAdminClsObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzAdminClsEN objXzAdminClsEN)
{
