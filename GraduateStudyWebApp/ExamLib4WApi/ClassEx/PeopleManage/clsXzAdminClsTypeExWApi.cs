...
{
public static class clsXzAdminClsTypeExWApi_Static
{
...
clsXzAdminClsTypeWApi.CopyTo(objXzAdminClsTypeENS, objXzAdminClsTypeENT);
...
public static bool EditRecordEx(this clsXzAdminClsTypeEN objXzAdminClsTypeEN)
{
try
{
objXzAdminClsTypeEN.sf_UpdFldSetStr = objXzAdminClsTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsXzAdminClsTypeExWApi.EditRecordEx(objXzAdminClsTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzAdminClsTypeExWApi
{
//private static readonly string mstrApiControllerName = "XzAdminClsTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzAdminClsTypeEN> arrXzAdminClsTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsXzAdminClsTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsXzAdminClsTypeEN objXzAdminClsTypeEN)
{
