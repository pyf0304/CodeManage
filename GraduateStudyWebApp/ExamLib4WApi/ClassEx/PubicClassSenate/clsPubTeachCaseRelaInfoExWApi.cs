 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubTeachCaseRelaInfoExWApi
 表名:PubTeachCaseRelaInfo(01120409)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:43:50
 生成者:pyf
...
{
public static class clsPubTeachCaseRelaInfoExWApi_Static
{
...
clsPubTeachCaseRelaInfoWApi.CopyTo(objPubTeachCaseRelaInfoENS, objPubTeachCaseRelaInfoENT);
...
public static bool EditRecordEx(this clsPubTeachCaseRelaInfoEN objPubTeachCaseRelaInfoEN)
{
try
{
objPubTeachCaseRelaInfoEN.sf_UpdFldSetStr = objPubTeachCaseRelaInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsPubTeachCaseRelaInfoExWApi.EditRecordEx(objPubTeachCaseRelaInfoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPubTeachCaseRelaInfoExWApi
{
//private static readonly string mstrApiControllerName = "PubTeachCaseRelaInfoExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPubTeachCaseRelaInfoEN> arrPubTeachCaseRelaInfoObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPubTeachCaseRelaInfoExWApi()
 {
 }
...
public static bool EditRecordEx(clsPubTeachCaseRelaInfoEN objPubTeachCaseRelaInfoEN)
{
