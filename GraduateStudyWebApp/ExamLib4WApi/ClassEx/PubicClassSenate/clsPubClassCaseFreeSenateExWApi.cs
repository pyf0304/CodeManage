 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCaseFreeSenateExWApi
...
{
public static class clsPubClassCaseFreeSenateExWApi_Static
{
 ...
 public static clsPubClassCaseFreeSenateENEx CopyToEx(this clsPubClassCaseFreeSenateEN objPubClassCaseFreeSenateENS)
{
try
{
 clsPubClassCaseFreeSenateENEx objPubClassCaseFreeSenateENT = new clsPubClassCaseFreeSenateENEx();
clsPubClassCaseFreeSenateWApi.CopyTo(objPubClassCaseFreeSenateENS, objPubClassCaseFreeSenateENT);
...
public static bool EditRecordEx(this clsPubClassCaseFreeSenateEN objPubClassCaseFreeSenateEN)
{
try
{
objPubClassCaseFreeSenateEN.sf_UpdFldSetStr = objPubClassCaseFreeSenateEN.getsf_UpdFldSetStr();
bool bolResult = clsPubClassCaseFreeSenateExWApi.EditRecordEx(objPubClassCaseFreeSenateEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPubClassCaseFreeSenateExWApi
{
//private static readonly string mstrApiControllerName = "PubClassCaseFreeSenateExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPubClassCaseFreeSenateEN> arrPubClassCaseFreeSenateObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPubClassCaseFreeSenateExWApi()
 {
 }
...
public static bool EditRecordEx(clsPubClassCaseFreeSenateEN objPubClassCaseFreeSenateEN)
{
