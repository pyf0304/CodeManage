...
{
public static class clsSenateGaugeExWApi_Static
{
 ...
 public static clsSenateGaugeENEx CopyToEx(this clsSenateGaugeEN objSenateGaugeENS)
{
try
{
 clsSenateGaugeENEx objSenateGaugeENT = new clsSenateGaugeENEx();
clsSenateGaugeWApi.CopyTo(objSenateGaugeENS, objSenateGaugeENT);
...
public static bool EditRecordEx(this clsSenateGaugeEN objSenateGaugeEN)
{
try
{
objSenateGaugeEN.sf_UpdFldSetStr = objSenateGaugeEN.getsf_UpdFldSetStr();
bool bolResult = clsSenateGaugeExWApi.EditRecordEx(objSenateGaugeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsSenateGaugeExWApi
{
//private static readonly string mstrApiControllerName = "SenateGaugeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsSenateGaugeEN> arrSenateGaugeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsSenateGaugeEN objSenateGaugeEN)
{
