 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCaseSenateExWApi
...
{
public static class clsPubClassCaseSenateExWApi_Static
{
...
clsPubClassCaseSenateWApi.CopyTo(objPubClassCaseSenateENS, objPubClassCaseSenateENT);
...
public static bool EditRecordEx(this clsPubClassCaseSenateEN objPubClassCaseSenateEN)
{
try
{
objPubClassCaseSenateEN.sf_UpdFldSetStr = objPubClassCaseSenateEN.getsf_UpdFldSetStr();
bool bolResult = clsPubClassCaseSenateExWApi.EditRecordEx(objPubClassCaseSenateEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPubClassCaseSenateExWApi
{
//private static readonly string mstrApiControllerName = "PubClassCaseSenateExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPubClassCaseSenateEN> arrPubClassCaseSenateObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPubClassCaseSenateExWApi()
 {
 }
...
public static bool EditRecordEx(clsPubClassCaseSenateEN objPubClassCaseSenateEN)
{
