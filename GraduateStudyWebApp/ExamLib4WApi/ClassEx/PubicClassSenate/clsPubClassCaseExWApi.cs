 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCaseExWApi
 表名:PubClassCase(01120385)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:46:51
 生成者:pyf
...
{
public static class clsPubClassCaseExWApi_Static
{
...
clsPubClassCaseWApi.CopyTo(objPubClassCaseENS, objPubClassCaseENT);
...
public static bool EditRecordEx(this clsPubClassCaseEN objPubClassCaseEN)
{
try
{
objPubClassCaseEN.sf_UpdFldSetStr = objPubClassCaseEN.getsf_UpdFldSetStr();
bool bolResult = clsPubClassCaseExWApi.EditRecordEx(objPubClassCaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPubClassCaseExWApi
{
//private static readonly string mstrApiControllerName = "PubClassCaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPubClassCaseEN> arrPubClassCaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsPubClassCaseEN objPubClassCaseEN)
{
