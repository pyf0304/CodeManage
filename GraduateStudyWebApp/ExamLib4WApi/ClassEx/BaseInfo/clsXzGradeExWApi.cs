...
{
public static class clsXzGradeExWApi_Static
{
...
clsXzGradeWApi.CopyTo(objXzGradeENS, objXzGradeENT);
...
public static bool EditRecordEx(this clsXzGradeEN objXzGradeEN)
{
try
{
objXzGradeEN.sf_UpdFldSetStr = objXzGradeEN.getsf_UpdFldSetStr();
bool bolResult = clsXzGradeExWApi.EditRecordEx(objXzGradeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzGradeExWApi
{
//private static readonly string mstrApiControllerName = "XzGradeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzGradeEN> arrXzGradeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzGradeEN objXzGradeEN)
{
