...
{
public static class clsTeacherInfoExWApi_Static
{
...
clsTeacherInfoWApi.CopyTo(objTeacherInfoENS, objTeacherInfoENT);
...
public static bool EditRecordEx(this clsTeacherInfoEN objTeacherInfoEN)
{
try
{
objTeacherInfoEN.sf_UpdFldSetStr = objTeacherInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsTeacherInfoExWApi.EditRecordEx(objTeacherInfoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeacherInfoExWApi
{
//private static readonly string mstrApiControllerName = "TeacherInfoExApi";
 /// <summary>
...
public static bool EditRecordEx(clsTeacherInfoEN objTeacherInfoEN)
{
