...
{
public static class clsXzMajorShoolTypeExWApi_Static
{
...
clsXzMajorShoolTypeWApi.CopyTo(objXzMajorShoolTypeENS, objXzMajorShoolTypeENT);
...
public static bool EditRecordEx(this clsXzMajorShoolTypeEN objXzMajorShoolTypeEN)
{
try
{
objXzMajorShoolTypeEN.sf_UpdFldSetStr = objXzMajorShoolTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsXzMajorShoolTypeExWApi.EditRecordEx(objXzMajorShoolTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzMajorShoolTypeExWApi
{
//private static readonly string mstrApiControllerName = "XzMajorShoolTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzMajorShoolTypeEN> arrXzMajorShoolTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsXzMajorShoolTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsXzMajorShoolTypeEN objXzMajorShoolTypeEN)
{
