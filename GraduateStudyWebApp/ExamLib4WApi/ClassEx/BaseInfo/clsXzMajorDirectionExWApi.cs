...
{
public static class clsXzMajorDirectionExWApi_Static
{
...
clsXzMajorDirectionWApi.CopyTo(objXzMajorDirectionENS, objXzMajorDirectionENT);
...
public static bool EditRecordEx(this clsXzMajorDirectionEN objXzMajorDirectionEN)
{
try
{
objXzMajorDirectionEN.sf_UpdFldSetStr = objXzMajorDirectionEN.getsf_UpdFldSetStr();
bool bolResult = clsXzMajorDirectionExWApi.EditRecordEx(objXzMajorDirectionEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzMajorDirectionExWApi
{
//private static readonly string mstrApiControllerName = "XzMajorDirectionExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzMajorDirectionEN> arrXzMajorDirectionObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsXzMajorDirectionExWApi()
 {
 }
...
public static bool EditRecordEx(clsXzMajorDirectionEN objXzMajorDirectionEN)
{
