...
{
public static class clsQxUsersExWApi_Static
{
...
clsQxUsersWApi.CopyTo(objQxUsersENS, objQxUsersENT);
...
public static bool EditRecordEx(this clsQxUsersEN objQxUsersEN)
{
try
{
objQxUsersEN.sf_UpdFldSetStr = objQxUsersEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUsersExWApi.EditRecordEx(objQxUsersEN);
...
public static bool EditRecordEx(clsQxUsersEN objQxUsersEN)
{
