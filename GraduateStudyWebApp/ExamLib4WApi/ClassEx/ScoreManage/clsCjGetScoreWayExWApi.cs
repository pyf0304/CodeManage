 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCjGetScoreWayExWApi
 表名:CjGetScoreWay(01120575)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:47:24
 生成者:pyf
...
{
public static class clsCjGetScoreWayExWApi_Static
{
...
clsCjGetScoreWayWApi.CopyTo(objCjGetScoreWayENS, objCjGetScoreWayENT);
...
public static bool EditRecordEx(this clsCjGetScoreWayEN objCjGetScoreWayEN)
{
try
{
objCjGetScoreWayEN.sf_UpdFldSetStr = objCjGetScoreWayEN.getsf_UpdFldSetStr();
bool bolResult = clsCjGetScoreWayExWApi.EditRecordEx(objCjGetScoreWayEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCjGetScoreWayExWApi
{
//private static readonly string mstrApiControllerName = "CjGetScoreWayExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCjGetScoreWayEN> arrCjGetScoreWayObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCjGetScoreWayEN objCjGetScoreWayEN)
{
