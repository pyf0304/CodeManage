 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCjClsScoreTtlExWApi
 表名:CjClsScoreTtl(01120330)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:42:21
 生成者:pyf
...
{
public static class clsCjClsScoreTtlExWApi_Static
{
...
clsCjClsScoreTtlWApi.CopyTo(objCjClsScoreTtlENS, objCjClsScoreTtlENT);
...
public static bool EditRecordEx(this clsCjClsScoreTtlEN objCjClsScoreTtlEN)
{
try
{
objCjClsScoreTtlEN.sf_UpdFldSetStr = objCjClsScoreTtlEN.getsf_UpdFldSetStr();
bool bolResult = clsCjClsScoreTtlExWApi.EditRecordEx(objCjClsScoreTtlEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCjClsScoreTtlExWApi
{
//private static readonly string mstrApiControllerName = "CjClsScoreTtlExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCjClsScoreTtlEN> arrCjClsScoreTtlObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCjClsScoreTtlEN objCjClsScoreTtlEN)
{
