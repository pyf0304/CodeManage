...
{
public static class clsCjScoreTypeExWApi_Static
{
...
clsCjScoreTypeWApi.CopyTo(objCjScoreTypeENS, objCjScoreTypeENT);
...
public static bool EditRecordEx(this clsCjScoreTypeEN objCjScoreTypeEN)
{
try
{
objCjScoreTypeEN.sf_UpdFldSetStr = objCjScoreTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsCjScoreTypeExWApi.EditRecordEx(objCjScoreTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCjScoreTypeExWApi
{
//private static readonly string mstrApiControllerName = "CjScoreTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCjScoreTypeEN> arrCjScoreTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCjScoreTypeEN objCjScoreTypeEN)
{
