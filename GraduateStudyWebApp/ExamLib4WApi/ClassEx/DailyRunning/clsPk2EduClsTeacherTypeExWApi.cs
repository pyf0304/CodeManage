...
{
public static class clsPk2EduClsTeacherTypeExWApi_Static
{
...
clsPk2EduClsTeacherTypeWApi.CopyTo(objPk2EduClsTeacherTypeENS, objPk2EduClsTeacherTypeENT);
...
public static bool EditRecordEx(this clsPk2EduClsTeacherTypeEN objPk2EduClsTeacherTypeEN)
{
try
{
objPk2EduClsTeacherTypeEN.sf_UpdFldSetStr = objPk2EduClsTeacherTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsPk2EduClsTeacherTypeExWApi.EditRecordEx(objPk2EduClsTeacherTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsPk2EduClsTeacherTypeExWApi
{
//private static readonly string mstrApiControllerName = "Pk2EduClsTeacherTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsPk2EduClsTeacherTypeEN> arrPk2EduClsTeacherTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsPk2EduClsTeacherTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsPk2EduClsTeacherTypeEN objPk2EduClsTeacherTypeEN)
{
