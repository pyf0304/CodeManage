...
{
public static class clsCurrEduClsStuExWApi_Static
{
 ...
 public static clsCurrEduClsStuENEx CopyToEx(this clsCurrEduClsStuEN objCurrEduClsStuENS)
{
try
{
 clsCurrEduClsStuENEx objCurrEduClsStuENT = new clsCurrEduClsStuENEx();
clsCurrEduClsStuWApi.CopyTo(objCurrEduClsStuENS, objCurrEduClsStuENT);
...
public static bool EditRecordEx(this clsCurrEduClsStuEN objCurrEduClsStuEN)
{
try
{
objCurrEduClsStuEN.sf_UpdFldSetStr = objCurrEduClsStuEN.getsf_UpdFldSetStr();
bool bolResult = clsCurrEduClsStuExWApi.EditRecordEx(objCurrEduClsStuEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCurrEduClsStuExWApi
{
//private static readonly string mstrApiControllerName = "CurrEduClsStuExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCurrEduClsStuEN> arrCurrEduClsStuObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCurrEduClsStuEN objCurrEduClsStuEN)
{
