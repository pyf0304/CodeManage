 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCurrEduCls_SynExWApi
 表名:CurrEduCls_Syn(01120927)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:44:58
 生成者:pyf
...
{
public static class clsCurrEduCls_SynExWApi_Static
{
...
clsCurrEduCls_SynWApi.CopyTo(objCurrEduCls_SynENS, objCurrEduCls_SynENT);
...
public static bool EditRecordEx(this clsCurrEduCls_SynEN objCurrEduCls_SynEN)
{
try
{
objCurrEduCls_SynEN.sf_UpdFldSetStr = objCurrEduCls_SynEN.getsf_UpdFldSetStr();
bool bolResult = clsCurrEduCls_SynExWApi.EditRecordEx(objCurrEduCls_SynEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCurrEduCls_SynExWApi
{
//private static readonly string mstrApiControllerName = "CurrEduCls_SynExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCurrEduCls_SynEN> arrCurrEduCls_SynObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCurrEduCls_SynExWApi()
 {
 }
...
public static bool EditRecordEx(clsCurrEduCls_SynEN objCurrEduCls_SynEN)
{
