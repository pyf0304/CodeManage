...
{
public static class clsCaseLearningLogExWApi_Static
{
 ...
 public static clsCaseLearningLogENEx CopyToEx(this clsCaseLearningLogEN objCaseLearningLogENS)
{
try
{
 clsCaseLearningLogENEx objCaseLearningLogENT = new clsCaseLearningLogENEx();
clsCaseLearningLogWApi.CopyTo(objCaseLearningLogENS, objCaseLearningLogENT);
...
public static bool EditRecordEx(this clsCaseLearningLogEN objCaseLearningLogEN)
{
try
{
objCaseLearningLogEN.sf_UpdFldSetStr = objCaseLearningLogEN.getsf_UpdFldSetStr();
bool bolResult = clsCaseLearningLogExWApi.EditRecordEx(objCaseLearningLogEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCaseLearningLogExWApi
{
//private static readonly string mstrApiControllerName = "CaseLearningLogExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCaseLearningLogEN> arrCaseLearningLogObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCaseLearningLogExWApi()
 {
 }
...
public static bool EditRecordEx(clsCaseLearningLogEN objCaseLearningLogEN)
{
