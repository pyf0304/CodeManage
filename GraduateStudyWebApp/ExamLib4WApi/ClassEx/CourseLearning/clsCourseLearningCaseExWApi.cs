 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCourseLearningCaseExWApi
 表名:CourseLearningCase(01120274)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:50:40
 生成者:pyf
...
{
public static class clsCourseLearningCaseExWApi_Static
{
...
clsCourseLearningCaseWApi.CopyTo(objCourseLearningCaseENS, objCourseLearningCaseENT);
...
public static bool EditRecordEx(this clsCourseLearningCaseEN objCourseLearningCaseEN)
{
try
{
objCourseLearningCaseEN.sf_UpdFldSetStr = objCourseLearningCaseEN.getsf_UpdFldSetStr();
bool bolResult = clsCourseLearningCaseExWApi.EditRecordEx(objCourseLearningCaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCourseLearningCaseExWApi
{
//private static readonly string mstrApiControllerName = "CourseLearningCaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCourseLearningCaseEN> arrCourseLearningCaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCourseLearningCaseExWApi()
 {
 }
...
public static bool EditRecordEx(clsCourseLearningCaseEN objCourseLearningCaseEN)
{
