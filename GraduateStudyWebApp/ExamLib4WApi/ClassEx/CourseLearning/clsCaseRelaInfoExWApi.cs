...
{
public static class clsCaseRelaInfoExWApi_Static
{
 ...
 public static clsCaseRelaInfoENEx CopyToEx(this clsCaseRelaInfoEN objCaseRelaInfoENS)
{
try
{
 clsCaseRelaInfoENEx objCaseRelaInfoENT = new clsCaseRelaInfoENEx();
clsCaseRelaInfoWApi.CopyTo(objCaseRelaInfoENS, objCaseRelaInfoENT);
...
public static bool EditRecordEx(this clsCaseRelaInfoEN objCaseRelaInfoEN)
{
try
{
objCaseRelaInfoEN.sf_UpdFldSetStr = objCaseRelaInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsCaseRelaInfoExWApi.EditRecordEx(objCaseRelaInfoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCaseRelaInfoExWApi
{
//private static readonly string mstrApiControllerName = "CaseRelaInfoExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCaseRelaInfoEN> arrCaseRelaInfoObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsCaseRelaInfoEN objCaseRelaInfoEN)
{
