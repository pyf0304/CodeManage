 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCaseCourseExamRelaExWApi
...
{
public static class clsCaseCourseExamRelaExWApi_Static
{
...
clsCaseCourseExamRelaWApi.CopyTo(objCaseCourseExamRelaENS, objCaseCourseExamRelaENT);
...
public static bool EditRecordEx(this clsCaseCourseExamRelaEN objCaseCourseExamRelaEN)
{
try
{
objCaseCourseExamRelaEN.sf_UpdFldSetStr = objCaseCourseExamRelaEN.getsf_UpdFldSetStr();
bool bolResult = clsCaseCourseExamRelaExWApi.EditRecordEx(objCaseCourseExamRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCaseCourseExamRelaExWApi
{
//private static readonly string mstrApiControllerName = "CaseCourseExamRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCaseCourseExamRelaEN> arrCaseCourseExamRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCaseCourseExamRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clsCaseCourseExamRelaEN objCaseCourseExamRelaEN)
{
