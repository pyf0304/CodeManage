...
{
public static class clscc_ThemesExWApi_Static
{
...
clscc_ThemesWApi.CopyTo(objcc_ThemesENS, objcc_ThemesENT);
...
public static bool EditRecordEx(this clscc_ThemesEN objcc_ThemesEN)
{
try
{
objcc_ThemesEN.sf_UpdFldSetStr = objcc_ThemesEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ThemesExWApi.EditRecordEx(objcc_ThemesEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ThemesExWApi
{
//private static readonly string mstrApiControllerName = "cc_ThemesExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ThemesEN> arrcc_ThemesObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clscc_ThemesEN objcc_ThemesEN)
{
