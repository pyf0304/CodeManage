...
{
public static class clscc_ExcellentTypeExWApi_Static
{
...
clscc_ExcellentTypeWApi.CopyTo(objcc_ExcellentTypeENS, objcc_ExcellentTypeENT);
...
public static bool EditRecordEx(this clscc_ExcellentTypeEN objcc_ExcellentTypeEN)
{
try
{
objcc_ExcellentTypeEN.sf_UpdFldSetStr = objcc_ExcellentTypeEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExcellentTypeExWApi.EditRecordEx(objcc_ExcellentTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExcellentTypeExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExcellentTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExcellentTypeEN> arrcc_ExcellentTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_ExcellentTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_ExcellentTypeEN objcc_ExcellentTypeEN)
{
