...
{
public static class clsTeachingSolutionExWApi_Static
{
...
clsTeachingSolutionWApi.CopyTo(objTeachingSolutionENS, objTeachingSolutionENT);
...
public static bool EditRecordEx(this clsTeachingSolutionEN objTeachingSolutionEN)
{
try
{
objTeachingSolutionEN.sf_UpdFldSetStr = objTeachingSolutionEN.getsf_UpdFldSetStr();
bool bolResult = clsTeachingSolutionExWApi.EditRecordEx(objTeachingSolutionEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTeachingSolutionExWApi
{
//private static readonly string mstrApiControllerName = "TeachingSolutionExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTeachingSolutionEN> arrTeachingSolutionObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsTeachingSolutionExWApi()
 {
 }
...
public static bool EditRecordEx(clsTeachingSolutionEN objTeachingSolutionEN)
{
