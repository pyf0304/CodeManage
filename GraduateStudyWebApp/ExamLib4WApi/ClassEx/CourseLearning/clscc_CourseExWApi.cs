...
{
public static class clscc_CourseExWApi_Static
{
...
clscc_CourseWApi.CopyTo(objcc_CourseENS, objcc_CourseENT);
...
public static bool EditRecordEx(this clscc_CourseEN objcc_CourseEN)
{
try
{
objcc_CourseEN.sf_UpdFldSetStr = objcc_CourseEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseExWApi.EditRecordEx(objcc_CourseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseEN> arrcc_CourseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clscc_CourseEN objcc_CourseEN)
{
