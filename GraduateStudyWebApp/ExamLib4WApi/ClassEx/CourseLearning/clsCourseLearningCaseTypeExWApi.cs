 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCourseLearningCaseTypeExWApi
 表名:CourseLearningCaseType(01120275)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:46:42
 生成者:pyf
...
{
public static class clsCourseLearningCaseTypeExWApi_Static
{
...
clsCourseLearningCaseTypeWApi.CopyTo(objCourseLearningCaseTypeENS, objCourseLearningCaseTypeENT);
...
public static bool EditRecordEx(this clsCourseLearningCaseTypeEN objCourseLearningCaseTypeEN)
{
try
{
objCourseLearningCaseTypeEN.sf_UpdFldSetStr = objCourseLearningCaseTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsCourseLearningCaseTypeExWApi.EditRecordEx(objCourseLearningCaseTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCourseLearningCaseTypeExWApi
{
//private static readonly string mstrApiControllerName = "CourseLearningCaseTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCourseLearningCaseTypeEN> arrCourseLearningCaseTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCourseLearningCaseTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsCourseLearningCaseTypeEN objCourseLearningCaseTypeEN)
{
