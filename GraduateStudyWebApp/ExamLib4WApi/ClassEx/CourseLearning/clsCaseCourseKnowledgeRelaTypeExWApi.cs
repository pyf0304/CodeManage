 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCaseCourseKnowledgeRelaTypeExWApi
...
{
public static class clsCaseCourseKnowledgeRelaTypeExWApi_Static
{
...
clsCaseCourseKnowledgeRelaTypeWApi.CopyTo(objCaseCourseKnowledgeRelaTypeENS, objCaseCourseKnowledgeRelaTypeENT);
...
public static bool EditRecordEx(this clsCaseCourseKnowledgeRelaTypeEN objCaseCourseKnowledgeRelaTypeEN)
{
try
{
objCaseCourseKnowledgeRelaTypeEN.sf_UpdFldSetStr = objCaseCourseKnowledgeRelaTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsCaseCourseKnowledgeRelaTypeExWApi.EditRecordEx(objCaseCourseKnowledgeRelaTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCaseCourseKnowledgeRelaTypeExWApi
{
//private static readonly string mstrApiControllerName = "CaseCourseKnowledgeRelaTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCaseCourseKnowledgeRelaTypeEN> arrCaseCourseKnowledgeRelaTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCaseCourseKnowledgeRelaTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsCaseCourseKnowledgeRelaTypeEN objCaseCourseKnowledgeRelaTypeEN)
{
