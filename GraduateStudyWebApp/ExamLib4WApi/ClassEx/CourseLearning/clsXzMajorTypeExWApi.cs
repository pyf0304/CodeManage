...
{
public static class clsXzMajorTypeExWApi_Static
{
...
clsXzMajorTypeWApi.CopyTo(objXzMajorTypeENS, objXzMajorTypeENT);
...
public static bool EditRecordEx(this clsXzMajorTypeEN objXzMajorTypeEN)
{
try
{
objXzMajorTypeEN.sf_UpdFldSetStr = objXzMajorTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsXzMajorTypeExWApi.EditRecordEx(objXzMajorTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzMajorTypeExWApi
{
//private static readonly string mstrApiControllerName = "XzMajorTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzMajorTypeEN> arrXzMajorTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzMajorTypeEN objXzMajorTypeEN)
{
