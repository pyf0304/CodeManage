 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCaseCourseKnowledgeRelaExWApi
...
{
public static class clsCaseCourseKnowledgeRelaExWApi_Static
{
...
clsCaseCourseKnowledgeRelaWApi.CopyTo(objCaseCourseKnowledgeRelaENS, objCaseCourseKnowledgeRelaENT);
...
public static bool EditRecordEx(this clsCaseCourseKnowledgeRelaEN objCaseCourseKnowledgeRelaEN)
{
try
{
objCaseCourseKnowledgeRelaEN.sf_UpdFldSetStr = objCaseCourseKnowledgeRelaEN.getsf_UpdFldSetStr();
bool bolResult = clsCaseCourseKnowledgeRelaExWApi.EditRecordEx(objCaseCourseKnowledgeRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCaseCourseKnowledgeRelaExWApi
{
//private static readonly string mstrApiControllerName = "CaseCourseKnowledgeRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCaseCourseKnowledgeRelaEN> arrCaseCourseKnowledgeRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCaseCourseKnowledgeRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clsCaseCourseKnowledgeRelaEN objCaseCourseKnowledgeRelaEN)
{
