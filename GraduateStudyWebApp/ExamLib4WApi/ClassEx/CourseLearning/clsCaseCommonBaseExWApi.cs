...
{
public static class clsCaseCommonBaseExWApi_Static
{
 ...
 public static clsCaseCommonBaseENEx CopyToEx(this clsCaseCommonBaseEN objCaseCommonBaseENS)
{
try
{
 clsCaseCommonBaseENEx objCaseCommonBaseENT = new clsCaseCommonBaseENEx();
clsCaseCommonBaseWApi.CopyTo(objCaseCommonBaseENS, objCaseCommonBaseENT);
...
public static bool EditRecordEx(this clsCaseCommonBaseEN objCaseCommonBaseEN)
{
try
{
objCaseCommonBaseEN.sf_UpdFldSetStr = objCaseCommonBaseEN.getsf_UpdFldSetStr();
bool bolResult = clsCaseCommonBaseExWApi.EditRecordEx(objCaseCommonBaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCaseCommonBaseExWApi
{
//private static readonly string mstrApiControllerName = "CaseCommonBaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCaseCommonBaseEN> arrCaseCommonBaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCaseCommonBaseExWApi()
 {
 }
...
public static bool EditRecordEx(clsCaseCommonBaseEN objCaseCommonBaseEN)
{
