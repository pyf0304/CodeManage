...
{
public static class clsQuestionnaireSetExWApi_Static
{
...
clsQuestionnaireSetWApi.CopyTo(objQuestionnaireSetENS, objQuestionnaireSetENT);
...
public static bool EditRecordEx(this clsQuestionnaireSetEN objQuestionnaireSetEN)
{
try
{
objQuestionnaireSetEN.sf_UpdFldSetStr = objQuestionnaireSetEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionnaireSetExWApi.EditRecordEx(objQuestionnaireSetEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionnaireSetExWApi
{
//private static readonly string mstrApiControllerName = "QuestionnaireSetExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionnaireSetEN> arrQuestionnaireSetObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQuestionnaireSetExWApi()
 {
 }
...
public static bool EditRecordEx(clsQuestionnaireSetEN objQuestionnaireSetEN)
{
