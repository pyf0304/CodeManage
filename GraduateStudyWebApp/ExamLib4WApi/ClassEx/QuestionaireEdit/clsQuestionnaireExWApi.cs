...
{
public static class clsQuestionnaireExWApi_Static
{
...
clsQuestionnaireWApi.CopyTo(objQuestionnaireENS, objQuestionnaireENT);
...
public static bool EditRecordEx(this clsQuestionnaireEN objQuestionnaireEN)
{
try
{
objQuestionnaireEN.sf_UpdFldSetStr = objQuestionnaireEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionnaireExWApi.EditRecordEx(objQuestionnaireEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionnaireExWApi
{
//private static readonly string mstrApiControllerName = "QuestionnaireExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionnaireEN> arrQuestionnaireObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsQuestionnaireEN objQuestionnaireEN)
{
