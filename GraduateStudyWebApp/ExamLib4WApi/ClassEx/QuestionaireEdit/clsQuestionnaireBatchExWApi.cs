...
{
public static class clsQuestionnaireBatchExWApi_Static
{
...
clsQuestionnaireBatchWApi.CopyTo(objQuestionnaireBatchENS, objQuestionnaireBatchENT);
...
public static bool EditRecordEx(this clsQuestionnaireBatchEN objQuestionnaireBatchEN)
{
try
{
objQuestionnaireBatchEN.sf_UpdFldSetStr = objQuestionnaireBatchEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionnaireBatchExWApi.EditRecordEx(objQuestionnaireBatchEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionnaireBatchExWApi
{
//private static readonly string mstrApiControllerName = "QuestionnaireBatchExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionnaireBatchEN> arrQuestionnaireBatchObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQuestionnaireBatchExWApi()
 {
 }
...
public static bool EditRecordEx(clsQuestionnaireBatchEN objQuestionnaireBatchEN)
{
