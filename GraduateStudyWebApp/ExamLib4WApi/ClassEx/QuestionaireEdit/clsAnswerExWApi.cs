...
{
public static class clsAnswerExWApi_Static
{
 ...
 public static clsAnswerENEx CopyToEx(this clsAnswerEN objAnswerENS)
{
try
{
 clsAnswerENEx objAnswerENT = new clsAnswerENEx();
clsAnswerWApi.CopyTo(objAnswerENS, objAnswerENT);
 return objAnswerENT;
}
...
public static bool EditRecordEx(this clsAnswerEN objAnswerEN)
{
try
{
objAnswerEN.sf_UpdFldSetStr = objAnswerEN.getsf_UpdFldSetStr();
bool bolResult = clsAnswerExWApi.EditRecordEx(objAnswerEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsAnswerExWApi
{
//private static readonly string mstrApiControllerName = "AnswerExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsAnswerEN> arrAnswerObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsAnswerEN objAnswerEN)
{
