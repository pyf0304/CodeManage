...
{
public static class clsQuestionOptionsExWApi_Static
{
...
clsQuestionOptionsWApi.CopyTo(objQuestionOptionsENS, objQuestionOptionsENT);
...
public static bool EditRecordEx(this clsQuestionOptionsEN objQuestionOptionsEN)
{
try
{
objQuestionOptionsEN.sf_UpdFldSetStr = objQuestionOptionsEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionOptionsExWApi.EditRecordEx(objQuestionOptionsEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionOptionsExWApi
{
//private static readonly string mstrApiControllerName = "QuestionOptionsExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionOptionsEN> arrQuestionOptionsObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQuestionOptionsExWApi()
 {
 }
...
public static bool EditRecordEx(clsQuestionOptionsEN objQuestionOptionsEN)
{
