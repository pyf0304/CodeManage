 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQuestionnaireAddiExWApi
 表名:QuestionnaireAddi(01120886)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:48:58
 生成者:pyf
...
{
public static class clsQuestionnaireAddiExWApi_Static
{
...
clsQuestionnaireAddiWApi.CopyTo(objQuestionnaireAddiENS, objQuestionnaireAddiENT);
...
public static bool EditRecordEx(this clsQuestionnaireAddiEN objQuestionnaireAddiEN)
{
try
{
objQuestionnaireAddiEN.sf_UpdFldSetStr = objQuestionnaireAddiEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionnaireAddiExWApi.EditRecordEx(objQuestionnaireAddiEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionnaireAddiExWApi
{
//private static readonly string mstrApiControllerName = "QuestionnaireAddiExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionnaireAddiEN> arrQuestionnaireAddiObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQuestionnaireAddiExWApi()
 {
 }
...
public static bool EditRecordEx(clsQuestionnaireAddiEN objQuestionnaireAddiEN)
{
