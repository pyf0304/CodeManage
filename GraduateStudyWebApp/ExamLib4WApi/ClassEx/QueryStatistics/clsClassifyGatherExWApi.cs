...
{
public static class clsClassifyGatherExWApi_Static
{
...
clsClassifyGatherWApi.CopyTo(objClassifyGatherENS, objClassifyGatherENT);
...
public static bool EditRecordEx(this clsClassifyGatherEN objClassifyGatherEN)
{
try
{
objClassifyGatherEN.sf_UpdFldSetStr = objClassifyGatherEN.getsf_UpdFldSetStr();
bool bolResult = clsClassifyGatherExWApi.EditRecordEx(objClassifyGatherEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsClassifyGatherExWApi
{
//private static readonly string mstrApiControllerName = "ClassifyGatherExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsClassifyGatherEN> arrClassifyGatherObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsClassifyGatherExWApi()
 {
 }
...
public static bool EditRecordEx(clsClassifyGatherEN objClassifyGatherEN)
{
