 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQuestionStuFinishedStatusExWApi
...
{
public static class clsQuestionStuFinishedStatusExWApi_Static
{
...
clsQuestionStuFinishedStatusWApi.CopyTo(objQuestionStuFinishedStatusENS, objQuestionStuFinishedStatusENT);
...
public static bool EditRecordEx(this clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN)
{
try
{
objQuestionStuFinishedStatusEN.sf_UpdFldSetStr = objQuestionStuFinishedStatusEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionStuFinishedStatusExWApi.EditRecordEx(objQuestionStuFinishedStatusEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionStuFinishedStatusExWApi
{
//private static readonly string mstrApiControllerName = "QuestionStuFinishedStatusExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionStuFinishedStatusEN> arrQuestionStuFinishedStatusObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQuestionStuFinishedStatusExWApi()
 {
 }
...
public static bool EditRecordEx(clsQuestionStuFinishedStatusEN objQuestionStuFinishedStatusEN)
{
