 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsClassifyGatherFieldExWApi
...
{
public static class clsClassifyGatherFieldExWApi_Static
{
...
clsClassifyGatherFieldWApi.CopyTo(objClassifyGatherFieldENS, objClassifyGatherFieldENT);
...
public static bool EditRecordEx(this clsClassifyGatherFieldEN objClassifyGatherFieldEN)
{
try
{
objClassifyGatherFieldEN.sf_UpdFldSetStr = objClassifyGatherFieldEN.getsf_UpdFldSetStr();
bool bolResult = clsClassifyGatherFieldExWApi.EditRecordEx(objClassifyGatherFieldEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsClassifyGatherFieldExWApi
{
//private static readonly string mstrApiControllerName = "ClassifyGatherFieldExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsClassifyGatherFieldEN> arrClassifyGatherFieldObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsClassifyGatherFieldExWApi()
 {
 }
...
public static bool EditRecordEx(clsClassifyGatherFieldEN objClassifyGatherFieldEN)
{
