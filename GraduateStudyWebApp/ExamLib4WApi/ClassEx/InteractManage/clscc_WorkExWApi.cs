...
{
public static class clscc_WorkExWApi_Static
{
 ...
 public static clscc_WorkENEx CopyToEx(this clscc_WorkEN objcc_WorkENS)
{
try
{
 clscc_WorkENEx objcc_WorkENT = new clscc_WorkENEx();
clscc_WorkWApi.CopyTo(objcc_WorkENS, objcc_WorkENT);
...
public static bool EditRecordEx(this clscc_WorkEN objcc_WorkEN)
{
try
{
objcc_WorkEN.sf_UpdFldSetStr = objcc_WorkEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkExWApi.EditRecordEx(objcc_WorkEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkEN> arrcc_WorkObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clscc_WorkEN objcc_WorkEN)
{
