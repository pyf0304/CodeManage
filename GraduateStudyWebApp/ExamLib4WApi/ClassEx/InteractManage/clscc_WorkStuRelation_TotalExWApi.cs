 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation_TotalExWApi
 表名:cc_WorkStuRelation_Total(01120167)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:44:46
 生成者:pyf
...
{
public static class clscc_WorkStuRelation_TotalExWApi_Static
{
...
clscc_WorkStuRelation_TotalWApi.CopyTo(objcc_WorkStuRelation_TotalENS, objcc_WorkStuRelation_TotalENT);
...
public static bool EditRecordEx(this clscc_WorkStuRelation_TotalEN objcc_WorkStuRelation_TotalEN)
{
try
{
objcc_WorkStuRelation_TotalEN.sf_UpdFldSetStr = objcc_WorkStuRelation_TotalEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkStuRelation_TotalExWApi.EditRecordEx(objcc_WorkStuRelation_TotalEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkStuRelation_TotalExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkStuRelation_TotalExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkStuRelation_TotalEN> arrcc_WorkStuRelation_TotalObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_WorkStuRelation_TotalExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_WorkStuRelation_TotalEN objcc_WorkStuRelation_TotalEN)
{
