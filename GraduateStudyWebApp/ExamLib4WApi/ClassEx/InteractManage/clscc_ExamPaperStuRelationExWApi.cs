...
{
public static class clscc_ExamPaperStuRelationExWApi_Static
{
 ...
 public static clscc_ExamPaperStuRelationENEx CopyToEx(this clscc_ExamPaperStuRelationEN objcc_ExamPaperStuRelationENS)
{
try
{
 clscc_ExamPaperStuRelationENEx objcc_ExamPaperStuRelationENT = new clscc_ExamPaperStuRelationENEx();
clscc_ExamPaperStuRelationWApi.CopyTo(objcc_ExamPaperStuRelationENS, objcc_ExamPaperStuRelationENT);
...
public static bool EditRecordEx(this clscc_ExamPaperStuRelationEN objcc_ExamPaperStuRelationEN)
{
try
{
objcc_ExamPaperStuRelationEN.sf_UpdFldSetStr = objcc_ExamPaperStuRelationEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExamPaperStuRelationExWApi.EditRecordEx(objcc_ExamPaperStuRelationEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExamPaperStuRelationExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExamPaperStuRelationExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExamPaperStuRelationEN> arrcc_ExamPaperStuRelationObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_ExamPaperStuRelationExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_ExamPaperStuRelationEN objcc_ExamPaperStuRelationEN)
{
