 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_ExamPaperEduClsRelaExWApi
 表名:cc_ExamPaperEduClsRela(01120233)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:42:54
 生成者:pyf
...
{
public static class clscc_ExamPaperEduClsRelaExWApi_Static
{
...
clscc_ExamPaperEduClsRelaWApi.CopyTo(objcc_ExamPaperEduClsRelaENS, objcc_ExamPaperEduClsRelaENT);
...
public static bool EditRecordEx(this clscc_ExamPaperEduClsRelaEN objcc_ExamPaperEduClsRelaEN)
{
try
{
objcc_ExamPaperEduClsRelaEN.sf_UpdFldSetStr = objcc_ExamPaperEduClsRelaEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExamPaperEduClsRelaExWApi.EditRecordEx(objcc_ExamPaperEduClsRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExamPaperEduClsRelaExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExamPaperEduClsRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExamPaperEduClsRelaEN> arrcc_ExamPaperEduClsRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_ExamPaperEduClsRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_ExamPaperEduClsRelaEN objcc_ExamPaperEduClsRelaEN)
{
