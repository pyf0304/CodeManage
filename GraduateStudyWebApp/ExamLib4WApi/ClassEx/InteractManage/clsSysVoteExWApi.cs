...
{
public static class clsSysVoteExWApi_Static
{
...
clsSysVoteWApi.CopyTo(objSysVoteENS, objSysVoteENT);
...
public static bool EditRecordEx(this clsSysVoteEN objSysVoteEN)
{
try
{
objSysVoteEN.sf_UpdFldSetStr = objSysVoteEN.getsf_UpdFldSetStr();
bool bolResult = clsSysVoteExWApi.EditRecordEx(objSysVoteEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsSysVoteExWApi
{
//private static readonly string mstrApiControllerName = "SysVoteExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsSysVoteEN> arrSysVoteObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsSysVoteEN objSysVoteEN)
{
