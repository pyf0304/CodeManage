...
{
public static class clsAnswer4WorkExWApi_Static
{
...
clsAnswer4WorkWApi.CopyTo(objAnswer4WorkENS, objAnswer4WorkENT);
...
public static bool EditRecordEx(this clsAnswer4WorkEN objAnswer4WorkEN)
{
try
{
objAnswer4WorkEN.sf_UpdFldSetStr = objAnswer4WorkEN.getsf_UpdFldSetStr();
bool bolResult = clsAnswer4WorkExWApi.EditRecordEx(objAnswer4WorkEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsAnswer4WorkExWApi
{
//private static readonly string mstrApiControllerName = "Answer4WorkExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsAnswer4WorkEN> arrAnswer4WorkObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsAnswer4WorkEN objAnswer4WorkEN)
{
