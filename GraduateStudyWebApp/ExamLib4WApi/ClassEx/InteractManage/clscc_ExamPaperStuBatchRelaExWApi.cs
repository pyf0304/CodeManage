...
{
public static class clscc_ExamPaperStuBatchRelaExWApi_Static
{
...
clscc_ExamPaperStuBatchRelaWApi.CopyTo(objcc_ExamPaperStuBatchRelaENS, objcc_ExamPaperStuBatchRelaENT);
...
public static bool EditRecordEx(this clscc_ExamPaperStuBatchRelaEN objcc_ExamPaperStuBatchRelaEN)
{
try
{
objcc_ExamPaperStuBatchRelaEN.sf_UpdFldSetStr = objcc_ExamPaperStuBatchRelaEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExamPaperStuBatchRelaExWApi.EditRecordEx(objcc_ExamPaperStuBatchRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExamPaperStuBatchRelaExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExamPaperStuBatchRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExamPaperStuBatchRelaEN> arrcc_ExamPaperStuBatchRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_ExamPaperStuBatchRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_ExamPaperStuBatchRelaEN objcc_ExamPaperStuBatchRelaEN)
{
