 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkEduClsRelaExWApi
 表名:cc_WorkEduClsRela(01120164)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:39:15
 生成者:pyf
...
{
public static class clscc_WorkEduClsRelaExWApi_Static
{
...
clscc_WorkEduClsRelaWApi.CopyTo(objcc_WorkEduClsRelaENS, objcc_WorkEduClsRelaENT);
...
public static bool EditRecordEx(this clscc_WorkEduClsRelaEN objcc_WorkEduClsRelaEN)
{
try
{
objcc_WorkEduClsRelaEN.sf_UpdFldSetStr = objcc_WorkEduClsRelaEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkEduClsRelaExWApi.EditRecordEx(objcc_WorkEduClsRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkEduClsRelaExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkEduClsRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkEduClsRelaEN> arrcc_WorkEduClsRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_WorkEduClsRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_WorkEduClsRelaEN objcc_WorkEduClsRelaEN)
{
