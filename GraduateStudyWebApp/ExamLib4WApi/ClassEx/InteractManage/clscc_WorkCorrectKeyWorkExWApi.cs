 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkCorrectKeyWorkExWApi
...
{
public static class clscc_WorkCorrectKeyWorkExWApi_Static
{
 ...
 public static clscc_WorkCorrectKeyWorkENEx CopyToEx(this clscc_WorkCorrectKeyWorkEN objcc_WorkCorrectKeyWorkENS)
{
try
{
 clscc_WorkCorrectKeyWorkENEx objcc_WorkCorrectKeyWorkENT = new clscc_WorkCorrectKeyWorkENEx();
clscc_WorkCorrectKeyWorkWApi.CopyTo(objcc_WorkCorrectKeyWorkENS, objcc_WorkCorrectKeyWorkENT);
...
public static bool EditRecordEx(this clscc_WorkCorrectKeyWorkEN objcc_WorkCorrectKeyWorkEN)
{
try
{
objcc_WorkCorrectKeyWorkEN.sf_UpdFldSetStr = objcc_WorkCorrectKeyWorkEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkCorrectKeyWorkExWApi.EditRecordEx(objcc_WorkCorrectKeyWorkEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkCorrectKeyWorkExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkCorrectKeyWorkExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkCorrectKeyWorkEN> arrcc_WorkCorrectKeyWorkObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_WorkCorrectKeyWorkExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_WorkCorrectKeyWorkEN objcc_WorkCorrectKeyWorkEN)
{
