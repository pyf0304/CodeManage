 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation4CorrectExWApi
 表名:cc_WorkStuRelation4Correct(01120182)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:41:11
 生成者:pyf
...
{
public static class clscc_WorkStuRelation4CorrectExWApi_Static
{
...
clscc_WorkStuRelation4CorrectWApi.CopyTo(objcc_WorkStuRelation4CorrectENS, objcc_WorkStuRelation4CorrectENT);
...
public static bool EditRecordEx(this clscc_WorkStuRelation4CorrectEN objcc_WorkStuRelation4CorrectEN)
{
try
{
objcc_WorkStuRelation4CorrectEN.sf_UpdFldSetStr = objcc_WorkStuRelation4CorrectEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkStuRelation4CorrectExWApi.EditRecordEx(objcc_WorkStuRelation4CorrectEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkStuRelation4CorrectExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkStuRelation4CorrectExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkStuRelation4CorrectEN> arrcc_WorkStuRelation4CorrectObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_WorkStuRelation4CorrectExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_WorkStuRelation4CorrectEN objcc_WorkStuRelation4CorrectEN)
{
