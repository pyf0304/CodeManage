...
{
public static class clsqa_AnswerExWApi_Static
{
...
clsqa_AnswerWApi.CopyTo(objqa_AnswerENS, objqa_AnswerENT);
...
public static bool EditRecordEx(this clsqa_AnswerEN objqa_AnswerEN)
{
try
{
objqa_AnswerEN.sf_UpdFldSetStr = objqa_AnswerEN.getsf_UpdFldSetStr();
bool bolResult = clsqa_AnswerExWApi.EditRecordEx(objqa_AnswerEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsqa_AnswerExWApi
{
//private static readonly string mstrApiControllerName = "qa_AnswerExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsqa_AnswerEN> arrqa_AnswerObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsqa_AnswerEN objqa_AnswerEN)
{
