...
{
public static class clsqa_PushExWApi_Static
{
...
clsqa_PushWApi.CopyTo(objqa_PushENS, objqa_PushENT);
...
public static bool EditRecordEx(this clsqa_PushEN objqa_PushEN)
{
try
{
objqa_PushEN.sf_UpdFldSetStr = objqa_PushEN.getsf_UpdFldSetStr();
bool bolResult = clsqa_PushExWApi.EditRecordEx(objqa_PushEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsqa_PushExWApi
{
//private static readonly string mstrApiControllerName = "qa_PushExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsqa_PushEN> arrqa_PushObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsqa_PushEN objqa_PushEN)
{
