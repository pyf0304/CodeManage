 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_PaperStuBatchQuesRelaExWApi
 表名:cc_PaperStuBatchQuesRela(01120240)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:47:38
 生成者:pyf
...
{
public static class clscc_PaperStuBatchQuesRelaExWApi_Static
{
...
clscc_PaperStuBatchQuesRelaWApi.CopyTo(objcc_PaperStuBatchQuesRelaENS, objcc_PaperStuBatchQuesRelaENT);
...
public static bool EditRecordEx(this clscc_PaperStuBatchQuesRelaEN objcc_PaperStuBatchQuesRelaEN)
{
try
{
objcc_PaperStuBatchQuesRelaEN.sf_UpdFldSetStr = objcc_PaperStuBatchQuesRelaEN.getsf_UpdFldSetStr();
bool bolResult = clscc_PaperStuBatchQuesRelaExWApi.EditRecordEx(objcc_PaperStuBatchQuesRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_PaperStuBatchQuesRelaExWApi
{
//private static readonly string mstrApiControllerName = "cc_PaperStuBatchQuesRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_PaperStuBatchQuesRelaEN> arrcc_PaperStuBatchQuesRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_PaperStuBatchQuesRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_PaperStuBatchQuesRelaEN objcc_PaperStuBatchQuesRelaEN)
{
