...
{
public static class clscc_Answer4WorkExWApi_Static
{
...
clscc_Answer4WorkWApi.CopyTo(objcc_Answer4WorkENS, objcc_Answer4WorkENT);
...
public static bool EditRecordEx(this clscc_Answer4WorkEN objcc_Answer4WorkEN)
{
try
{
objcc_Answer4WorkEN.sf_UpdFldSetStr = objcc_Answer4WorkEN.getsf_UpdFldSetStr();
bool bolResult = clscc_Answer4WorkExWApi.EditRecordEx(objcc_Answer4WorkEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_Answer4WorkExWApi
{
//private static readonly string mstrApiControllerName = "cc_Answer4WorkExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_Answer4WorkEN> arrcc_Answer4WorkObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_Answer4WorkExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_Answer4WorkEN objcc_Answer4WorkEN)
{
