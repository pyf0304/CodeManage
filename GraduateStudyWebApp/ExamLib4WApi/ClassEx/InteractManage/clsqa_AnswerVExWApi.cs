...
{
public static class clsqa_AnswerVExWApi_Static
{
 ...
 public static clsqa_AnswerVENEx CopyToEx(this clsqa_AnswerVEN objqa_AnswerVENS)
{
try
{
 clsqa_AnswerVENEx objqa_AnswerVENT = new clsqa_AnswerVENEx();
clsqa_AnswerVWApi.CopyTo(objqa_AnswerVENS, objqa_AnswerVENT);
...
public static bool EditRecordEx(this clsqa_AnswerVEN objqa_AnswerVEN)
{
try
{
objqa_AnswerVEN.sf_UpdFldSetStr = objqa_AnswerVEN.getsf_UpdFldSetStr();
bool bolResult = clsqa_AnswerVExWApi.EditRecordEx(objqa_AnswerVEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsqa_AnswerVExWApi
{
//private static readonly string mstrApiControllerName = "qa_AnswerVExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsqa_AnswerVEN> arrqa_AnswerVObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsqa_AnswerVEN objqa_AnswerVEN)
{
