 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_ExamPaperQuestionTypeRelaExWApi
 表名:cc_ExamPaperQuestionTypeRela(01120237)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:46:33
 生成者:pyf
...
{
public static class clscc_ExamPaperQuestionTypeRelaExWApi_Static
{
...
clscc_ExamPaperQuestionTypeRelaWApi.CopyTo(objcc_ExamPaperQuestionTypeRelaENS, objcc_ExamPaperQuestionTypeRelaENT);
...
public static bool EditRecordEx(this clscc_ExamPaperQuestionTypeRelaEN objcc_ExamPaperQuestionTypeRelaEN)
{
try
{
objcc_ExamPaperQuestionTypeRelaEN.sf_UpdFldSetStr = objcc_ExamPaperQuestionTypeRelaEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExamPaperQuestionTypeRelaExWApi.EditRecordEx(objcc_ExamPaperQuestionTypeRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExamPaperQuestionTypeRelaExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExamPaperQuestionTypeRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExamPaperQuestionTypeRelaEN> arrcc_ExamPaperQuestionTypeRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_ExamPaperQuestionTypeRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_ExamPaperQuestionTypeRelaEN objcc_ExamPaperQuestionTypeRelaEN)
{
