...
{
public static class clscc_WorkStuRelationExWApi_Static
{
 ...
 public static clscc_WorkStuRelationENEx CopyToEx(this clscc_WorkStuRelationEN objcc_WorkStuRelationENS)
{
try
{
 clscc_WorkStuRelationENEx objcc_WorkStuRelationENT = new clscc_WorkStuRelationENEx();
clscc_WorkStuRelationWApi.CopyTo(objcc_WorkStuRelationENS, objcc_WorkStuRelationENT);
...
public static bool EditRecordEx(this clscc_WorkStuRelationEN objcc_WorkStuRelationEN)
{
try
{
objcc_WorkStuRelationEN.sf_UpdFldSetStr = objcc_WorkStuRelationEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkStuRelationExWApi.EditRecordEx(objcc_WorkStuRelationEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkStuRelationExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkStuRelationExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkStuRelationEN> arrcc_WorkStuRelationObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_WorkStuRelationExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_WorkStuRelationEN objcc_WorkStuRelationEN)
{
