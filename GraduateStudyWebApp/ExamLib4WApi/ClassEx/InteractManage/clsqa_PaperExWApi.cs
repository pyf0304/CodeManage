...
{
public static class clsqa_PaperExWApi_Static
{
...
clsqa_PaperWApi.CopyTo(objqa_PaperENS, objqa_PaperENT);
...
public static bool EditRecordEx(this clsqa_PaperEN objqa_PaperEN)
{
try
{
objqa_PaperEN.sf_UpdFldSetStr = objqa_PaperEN.getsf_UpdFldSetStr();
bool bolResult = clsqa_PaperExWApi.EditRecordEx(objqa_PaperEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsqa_PaperExWApi
{
//private static readonly string mstrApiControllerName = "qa_PaperExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsqa_PaperEN> arrqa_PaperObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsqa_PaperEN objqa_PaperEN)
{
