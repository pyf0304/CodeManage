 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation4ErrorLibExWApi
...
{
public static class clscc_WorkStuRelation4ErrorLibExWApi_Static
{
...
clscc_WorkStuRelation4ErrorLibWApi.CopyTo(objcc_WorkStuRelation4ErrorLibENS, objcc_WorkStuRelation4ErrorLibENT);
...
public static bool EditRecordEx(this clscc_WorkStuRelation4ErrorLibEN objcc_WorkStuRelation4ErrorLibEN)
{
try
{
objcc_WorkStuRelation4ErrorLibEN.sf_UpdFldSetStr = objcc_WorkStuRelation4ErrorLibEN.getsf_UpdFldSetStr();
bool bolResult = clscc_WorkStuRelation4ErrorLibExWApi.EditRecordEx(objcc_WorkStuRelation4ErrorLibEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_WorkStuRelation4ErrorLibExWApi
{
//private static readonly string mstrApiControllerName = "cc_WorkStuRelation4ErrorLibExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_WorkStuRelation4ErrorLibEN> arrcc_WorkStuRelation4ErrorLibObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_WorkStuRelation4ErrorLibExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_WorkStuRelation4ErrorLibEN objcc_WorkStuRelation4ErrorLibEN)
{
