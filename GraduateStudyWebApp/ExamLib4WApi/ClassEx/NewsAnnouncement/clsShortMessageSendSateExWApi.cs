 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsShortMessageSendSateExWApi
...
{
public static class clsShortMessageSendSateExWApi_Static
{
 ...
 public static clsShortMessageSendSateENEx CopyToEx(this clsShortMessageSendSateEN objShortMessageSendSateENS)
{
try
{
 clsShortMessageSendSateENEx objShortMessageSendSateENT = new clsShortMessageSendSateENEx();
clsShortMessageSendSateWApi.CopyTo(objShortMessageSendSateENS, objShortMessageSendSateENT);
...
public static bool EditRecordEx(this clsShortMessageSendSateEN objShortMessageSendSateEN)
{
try
{
objShortMessageSendSateEN.sf_UpdFldSetStr = objShortMessageSendSateEN.getsf_UpdFldSetStr();
bool bolResult = clsShortMessageSendSateExWApi.EditRecordEx(objShortMessageSendSateEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsShortMessageSendSateExWApi
{
//private static readonly string mstrApiControllerName = "ShortMessageSendSateExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsShortMessageSendSateEN> arrShortMessageSendSateObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsShortMessageSendSateExWApi()
 {
 }
...
public static bool EditRecordEx(clsShortMessageSendSateEN objShortMessageSendSateEN)
{
