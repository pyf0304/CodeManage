...
{
public static class clsXzPhotoNewsExWApi_Static
{
 ...
 public static clsXzPhotoNewsENEx CopyToEx(this clsXzPhotoNewsEN objXzPhotoNewsENS)
{
try
{
 clsXzPhotoNewsENEx objXzPhotoNewsENT = new clsXzPhotoNewsENEx();
clsXzPhotoNewsWApi.CopyTo(objXzPhotoNewsENS, objXzPhotoNewsENT);
...
public static bool EditRecordEx(this clsXzPhotoNewsEN objXzPhotoNewsEN)
{
try
{
objXzPhotoNewsEN.sf_UpdFldSetStr = objXzPhotoNewsEN.getsf_UpdFldSetStr();
bool bolResult = clsXzPhotoNewsExWApi.EditRecordEx(objXzPhotoNewsEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzPhotoNewsExWApi
{
//private static readonly string mstrApiControllerName = "XzPhotoNewsExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzPhotoNewsEN> arrXzPhotoNewsObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzPhotoNewsEN objXzPhotoNewsEN)
{
