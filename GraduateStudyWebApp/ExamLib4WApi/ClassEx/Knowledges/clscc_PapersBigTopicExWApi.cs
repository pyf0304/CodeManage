 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_PapersBigTopicExWApi
 表名:cc_PapersBigTopic(01120077)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:41:20
 生成者:pyf
...
{
public static class clscc_PapersBigTopicExWApi_Static
{
...
clscc_PapersBigTopicWApi.CopyTo(objcc_PapersBigTopicENS, objcc_PapersBigTopicENT);
...
public static bool EditRecordEx(this clscc_PapersBigTopicEN objcc_PapersBigTopicEN)
{
try
{
objcc_PapersBigTopicEN.sf_UpdFldSetStr = objcc_PapersBigTopicEN.getsf_UpdFldSetStr();
bool bolResult = clscc_PapersBigTopicExWApi.EditRecordEx(objcc_PapersBigTopicEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_PapersBigTopicExWApi
{
//private static readonly string mstrApiControllerName = "cc_PapersBigTopicExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_PapersBigTopicEN> arrcc_PapersBigTopicObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_PapersBigTopicExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_PapersBigTopicEN objcc_PapersBigTopicEN)
{
