...
{
public static class clscc_KnowledgesExamLibRelaExWApi_Static
{
...
clscc_KnowledgesExamLibRelaWApi.CopyTo(objcc_KnowledgesExamLibRelaENS, objcc_KnowledgesExamLibRelaENT);
...
public static bool EditRecordEx(this clscc_KnowledgesExamLibRelaEN objcc_KnowledgesExamLibRelaEN)
{
try
{
objcc_KnowledgesExamLibRelaEN.sf_UpdFldSetStr = objcc_KnowledgesExamLibRelaEN.getsf_UpdFldSetStr();
bool bolResult = clscc_KnowledgesExamLibRelaExWApi.EditRecordEx(objcc_KnowledgesExamLibRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_KnowledgesExamLibRelaExWApi
{
//private static readonly string mstrApiControllerName = "cc_KnowledgesExamLibRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_KnowledgesExamLibRelaEN> arrcc_KnowledgesExamLibRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_KnowledgesExamLibRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_KnowledgesExamLibRelaEN objcc_KnowledgesExamLibRelaEN)
{
