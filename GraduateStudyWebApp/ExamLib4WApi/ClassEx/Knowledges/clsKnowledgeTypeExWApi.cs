...
{
public static class clsKnowledgeTypeExWApi_Static
{
...
clsKnowledgeTypeWApi.CopyTo(objKnowledgeTypeENS, objKnowledgeTypeENT);
...
public static bool EditRecordEx(this clsKnowledgeTypeEN objKnowledgeTypeEN)
{
try
{
objKnowledgeTypeEN.sf_UpdFldSetStr = objKnowledgeTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsKnowledgeTypeExWApi.EditRecordEx(objKnowledgeTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKnowledgeTypeExWApi
{
//private static readonly string mstrApiControllerName = "KnowledgeTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKnowledgeTypeEN> arrKnowledgeTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsKnowledgeTypeEN objKnowledgeTypeEN)
{
