...
{
public static class clscc_CourseChapterExWApi_Static
{
...
clscc_CourseChapterWApi.CopyTo(objcc_CourseChapterENS, objcc_CourseChapterENT);
...
public static bool EditRecordEx(this clscc_CourseChapterEN objcc_CourseChapterEN)
{
try
{
objcc_CourseChapterEN.sf_UpdFldSetStr = objcc_CourseChapterEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseChapterExWApi.EditRecordEx(objcc_CourseChapterEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseChapterExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseChapterExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseChapterEN> arrcc_CourseChapterObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_CourseChapterExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_CourseChapterEN objcc_CourseChapterEN)
{
