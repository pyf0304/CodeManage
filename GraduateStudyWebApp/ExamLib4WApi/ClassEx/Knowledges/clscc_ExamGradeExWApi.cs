...
{
public static class clscc_ExamGradeExWApi_Static
{
...
clscc_ExamGradeWApi.CopyTo(objcc_ExamGradeENS, objcc_ExamGradeENT);
...
public static bool EditRecordEx(this clscc_ExamGradeEN objcc_ExamGradeEN)
{
try
{
objcc_ExamGradeEN.sf_UpdFldSetStr = objcc_ExamGradeEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExamGradeExWApi.EditRecordEx(objcc_ExamGradeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExamGradeExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExamGradeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExamGradeEN> arrcc_ExamGradeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clscc_ExamGradeEN objcc_ExamGradeEN)
{
