...
{
public static class clsKnowledgeLearnTotalExWApi_Static
{
...
clsKnowledgeLearnTotalWApi.CopyTo(objKnowledgeLearnTotalENS, objKnowledgeLearnTotalENT);
...
public static bool EditRecordEx(this clsKnowledgeLearnTotalEN objKnowledgeLearnTotalEN)
{
try
{
objKnowledgeLearnTotalEN.sf_UpdFldSetStr = objKnowledgeLearnTotalEN.getsf_UpdFldSetStr();
bool bolResult = clsKnowledgeLearnTotalExWApi.EditRecordEx(objKnowledgeLearnTotalEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKnowledgeLearnTotalExWApi
{
//private static readonly string mstrApiControllerName = "KnowledgeLearnTotalExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKnowledgeLearnTotalEN> arrKnowledgeLearnTotalObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsKnowledgeLearnTotalExWApi()
 {
 }
...
public static bool EditRecordEx(clsKnowledgeLearnTotalEN objKnowledgeLearnTotalEN)
{
