...
{
public static class clscc_PaperDispModeExWApi_Static
{
...
clscc_PaperDispModeWApi.CopyTo(objcc_PaperDispModeENS, objcc_PaperDispModeENT);
...
public static bool EditRecordEx(this clscc_PaperDispModeEN objcc_PaperDispModeEN)
{
try
{
objcc_PaperDispModeEN.sf_UpdFldSetStr = objcc_PaperDispModeEN.getsf_UpdFldSetStr();
bool bolResult = clscc_PaperDispModeExWApi.EditRecordEx(objcc_PaperDispModeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_PaperDispModeExWApi
{
//private static readonly string mstrApiControllerName = "cc_PaperDispModeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_PaperDispModeEN> arrcc_PaperDispModeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_PaperDispModeExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_PaperDispModeEN objcc_PaperDispModeEN)
{
