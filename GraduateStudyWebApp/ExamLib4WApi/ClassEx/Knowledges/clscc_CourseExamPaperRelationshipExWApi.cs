 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseExamPaperRelationshipExWApi
 表名:cc_CourseExamPaperRelationship(01120076)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:50:44
 生成者:pyf
...
{
public static class clscc_CourseExamPaperRelationshipExWApi_Static
{
...
clscc_CourseExamPaperRelationshipWApi.CopyTo(objcc_CourseExamPaperRelationshipENS, objcc_CourseExamPaperRelationshipENT);
...
public static bool EditRecordEx(this clscc_CourseExamPaperRelationshipEN objcc_CourseExamPaperRelationshipEN)
{
try
{
objcc_CourseExamPaperRelationshipEN.sf_UpdFldSetStr = objcc_CourseExamPaperRelationshipEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseExamPaperRelationshipExWApi.EditRecordEx(objcc_CourseExamPaperRelationshipEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseExamPaperRelationshipExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseExamPaperRelationshipExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseExamPaperRelationshipEN> arrcc_CourseExamPaperRelationshipObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_CourseExamPaperRelationshipExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_CourseExamPaperRelationshipEN objcc_CourseExamPaperRelationshipEN)
{
