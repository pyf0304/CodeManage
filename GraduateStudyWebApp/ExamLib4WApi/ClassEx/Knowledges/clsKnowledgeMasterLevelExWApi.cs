...
{
public static class clsKnowledgeMasterLevelExWApi_Static
{
...
clsKnowledgeMasterLevelWApi.CopyTo(objKnowledgeMasterLevelENS, objKnowledgeMasterLevelENT);
...
public static bool EditRecordEx(this clsKnowledgeMasterLevelEN objKnowledgeMasterLevelEN)
{
try
{
objKnowledgeMasterLevelEN.sf_UpdFldSetStr = objKnowledgeMasterLevelEN.getsf_UpdFldSetStr();
bool bolResult = clsKnowledgeMasterLevelExWApi.EditRecordEx(objKnowledgeMasterLevelEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKnowledgeMasterLevelExWApi
{
//private static readonly string mstrApiControllerName = "KnowledgeMasterLevelExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKnowledgeMasterLevelEN> arrKnowledgeMasterLevelObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsKnowledgeMasterLevelExWApi()
 {
 }
...
public static bool EditRecordEx(clsKnowledgeMasterLevelEN objKnowledgeMasterLevelEN)
{
