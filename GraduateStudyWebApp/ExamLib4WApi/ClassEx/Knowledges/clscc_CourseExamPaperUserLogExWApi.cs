 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseExamPaperUserLogExWApi
...
{
public static class clscc_CourseExamPaperUserLogExWApi_Static
{
...
clscc_CourseExamPaperUserLogWApi.CopyTo(objcc_CourseExamPaperUserLogENS, objcc_CourseExamPaperUserLogENT);
...
public static bool EditRecordEx(this clscc_CourseExamPaperUserLogEN objcc_CourseExamPaperUserLogEN)
{
try
{
objcc_CourseExamPaperUserLogEN.sf_UpdFldSetStr = objcc_CourseExamPaperUserLogEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseExamPaperUserLogExWApi.EditRecordEx(objcc_CourseExamPaperUserLogEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseExamPaperUserLogExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseExamPaperUserLogExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseExamPaperUserLogEN> arrcc_CourseExamPaperUserLogObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_CourseExamPaperUserLogExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_CourseExamPaperUserLogEN objcc_CourseExamPaperUserLogEN)
{
