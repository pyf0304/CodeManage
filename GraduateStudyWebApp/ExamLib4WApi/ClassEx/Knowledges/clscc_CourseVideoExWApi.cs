...
{
public static class clscc_CourseVideoExWApi_Static
{
 ...
 public static clscc_CourseVideoENEx CopyToEx(this clscc_CourseVideoEN objcc_CourseVideoENS)
{
try
{
 clscc_CourseVideoENEx objcc_CourseVideoENT = new clscc_CourseVideoENEx();
clscc_CourseVideoWApi.CopyTo(objcc_CourseVideoENS, objcc_CourseVideoENT);
...
public static bool EditRecordEx(this clscc_CourseVideoEN objcc_CourseVideoEN)
{
try
{
objcc_CourseVideoEN.sf_UpdFldSetStr = objcc_CourseVideoEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseVideoExWApi.EditRecordEx(objcc_CourseVideoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseVideoExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseVideoExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseVideoEN> arrcc_CourseVideoObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_CourseVideoExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_CourseVideoEN objcc_CourseVideoEN)
{
