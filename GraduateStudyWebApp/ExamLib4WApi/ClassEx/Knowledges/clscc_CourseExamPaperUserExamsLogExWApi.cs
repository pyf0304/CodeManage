 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseExamPaperUserExamsLogExWApi
...
{
public static class clscc_CourseExamPaperUserExamsLogExWApi_Static
{
...
clscc_CourseExamPaperUserExamsLogWApi.CopyTo(objcc_CourseExamPaperUserExamsLogENS, objcc_CourseExamPaperUserExamsLogENT);
...
public static bool EditRecordEx(this clscc_CourseExamPaperUserExamsLogEN objcc_CourseExamPaperUserExamsLogEN)
{
try
{
objcc_CourseExamPaperUserExamsLogEN.sf_UpdFldSetStr = objcc_CourseExamPaperUserExamsLogEN.getsf_UpdFldSetStr();
bool bolResult = clscc_CourseExamPaperUserExamsLogExWApi.EditRecordEx(objcc_CourseExamPaperUserExamsLogEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_CourseExamPaperUserExamsLogExWApi
{
//private static readonly string mstrApiControllerName = "cc_CourseExamPaperUserExamsLogExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_CourseExamPaperUserExamsLogEN> arrcc_CourseExamPaperUserExamsLogObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_CourseExamPaperUserExamsLogExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_CourseExamPaperUserExamsLogEN objcc_CourseExamPaperUserExamsLogEN)
{
