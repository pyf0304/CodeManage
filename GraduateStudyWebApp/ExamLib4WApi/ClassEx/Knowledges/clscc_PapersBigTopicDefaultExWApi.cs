 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_PapersBigTopicDefaultExWApi
...
{
public static class clscc_PapersBigTopicDefaultExWApi_Static
{
...
clscc_PapersBigTopicDefaultWApi.CopyTo(objcc_PapersBigTopicDefaultENS, objcc_PapersBigTopicDefaultENT);
...
public static bool EditRecordEx(this clscc_PapersBigTopicDefaultEN objcc_PapersBigTopicDefaultEN)
{
try
{
objcc_PapersBigTopicDefaultEN.sf_UpdFldSetStr = objcc_PapersBigTopicDefaultEN.getsf_UpdFldSetStr();
bool bolResult = clscc_PapersBigTopicDefaultExWApi.EditRecordEx(objcc_PapersBigTopicDefaultEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_PapersBigTopicDefaultExWApi
{
//private static readonly string mstrApiControllerName = "cc_PapersBigTopicDefaultExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_PapersBigTopicDefaultEN> arrcc_PapersBigTopicDefaultObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_PapersBigTopicDefaultExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_PapersBigTopicDefaultEN objcc_PapersBigTopicDefaultEN)
{
