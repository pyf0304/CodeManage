...
{
public static class clsKnowledgeLearnDetailExWApi_Static
{
...
clsKnowledgeLearnDetailWApi.CopyTo(objKnowledgeLearnDetailENS, objKnowledgeLearnDetailENT);
...
public static bool EditRecordEx(this clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN)
{
try
{
objKnowledgeLearnDetailEN.sf_UpdFldSetStr = objKnowledgeLearnDetailEN.getsf_UpdFldSetStr();
bool bolResult = clsKnowledgeLearnDetailExWApi.EditRecordEx(objKnowledgeLearnDetailEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKnowledgeLearnDetailExWApi
{
//private static readonly string mstrApiControllerName = "KnowledgeLearnDetailExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKnowledgeLearnDetailEN> arrKnowledgeLearnDetailObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsKnowledgeLearnDetailExWApi()
 {
 }
...
public static bool EditRecordEx(clsKnowledgeLearnDetailEN objKnowledgeLearnDetailEN)
{
