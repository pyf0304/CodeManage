...
{
public static class clsKnowledgeMasterTypeExWApi_Static
{
...
clsKnowledgeMasterTypeWApi.CopyTo(objKnowledgeMasterTypeENS, objKnowledgeMasterTypeENT);
...
public static bool EditRecordEx(this clsKnowledgeMasterTypeEN objKnowledgeMasterTypeEN)
{
try
{
objKnowledgeMasterTypeEN.sf_UpdFldSetStr = objKnowledgeMasterTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsKnowledgeMasterTypeExWApi.EditRecordEx(objKnowledgeMasterTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsKnowledgeMasterTypeExWApi
{
//private static readonly string mstrApiControllerName = "KnowledgeMasterTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsKnowledgeMasterTypeEN> arrKnowledgeMasterTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsKnowledgeMasterTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsKnowledgeMasterTypeEN objKnowledgeMasterTypeEN)
{
