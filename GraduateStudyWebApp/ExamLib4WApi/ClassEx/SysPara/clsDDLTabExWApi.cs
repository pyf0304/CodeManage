...
{
public static class clsDDLTabExWApi_Static
{
...
clsDDLTabWApi.CopyTo(objDDLTabENS, objDDLTabENT);
 return objDDLTabENT;
}
...
public static bool EditRecordEx(this clsDDLTabEN objDDLTabEN)
{
try
{
objDDLTabEN.sf_UpdFldSetStr = objDDLTabEN.getsf_UpdFldSetStr();
bool bolResult = clsDDLTabExWApi.EditRecordEx(objDDLTabEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDDLTabExWApi
{
//private static readonly string mstrApiControllerName = "DDLTabExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDDLTabEN> arrDDLTabObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDDLTabEN objDDLTabEN)
{
