 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsXzSchool_PsExWApi
 表名:XzSchool_Ps(01120102)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:52:04
 生成者:pyf
...
{
public static class clsXzSchool_PsExWApi_Static
{
...
clsXzSchool_PsWApi.CopyTo(objXzSchool_PsENS, objXzSchool_PsENT);
...
public static bool EditRecordEx(this clsXzSchool_PsEN objXzSchool_PsEN)
{
try
{
objXzSchool_PsEN.sf_UpdFldSetStr = objXzSchool_PsEN.getsf_UpdFldSetStr();
bool bolResult = clsXzSchool_PsExWApi.EditRecordEx(objXzSchool_PsEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzSchool_PsExWApi
{
//private static readonly string mstrApiControllerName = "XzSchool_PsExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzSchool_PsEN> arrXzSchool_PsObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzSchool_PsEN objXzSchool_PsEN)
{
