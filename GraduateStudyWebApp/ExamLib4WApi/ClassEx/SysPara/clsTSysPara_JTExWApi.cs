...
{
public static class clsTSysPara_JTExWApi_Static
{
 ...
 public static clsTSysPara_JTENEx CopyToEx(this clsTSysPara_JTEN objTSysPara_JTENS)
{
try
{
 clsTSysPara_JTENEx objTSysPara_JTENT = new clsTSysPara_JTENEx();
clsTSysPara_JTWApi.CopyTo(objTSysPara_JTENS, objTSysPara_JTENT);
...
public static bool EditRecordEx(this clsTSysPara_JTEN objTSysPara_JTEN)
{
try
{
objTSysPara_JTEN.sf_UpdFldSetStr = objTSysPara_JTEN.getsf_UpdFldSetStr();
bool bolResult = clsTSysPara_JTExWApi.EditRecordEx(objTSysPara_JTEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsTSysPara_JTExWApi
{
//private static readonly string mstrApiControllerName = "TSysPara_JTExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsTSysPara_JTEN> arrTSysPara_JTObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsTSysPara_JTEN objTSysPara_JTEN)
{
