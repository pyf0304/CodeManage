 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQuestionType4CourseExWApi
...
{
public static class clsQuestionType4CourseExWApi_Static
{
...
clsQuestionType4CourseWApi.CopyTo(objQuestionType4CourseENS, objQuestionType4CourseENT);
...
public static bool EditRecordEx(this clsQuestionType4CourseEN objQuestionType4CourseEN)
{
try
{
objQuestionType4CourseEN.sf_UpdFldSetStr = objQuestionType4CourseEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionType4CourseExWApi.EditRecordEx(objQuestionType4CourseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionType4CourseExWApi
{
//private static readonly string mstrApiControllerName = "QuestionType4CourseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionType4CourseEN> arrQuestionType4CourseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQuestionType4CourseExWApi()
 {
 }
...
public static bool EditRecordEx(clsQuestionType4CourseEN objQuestionType4CourseEN)
{
