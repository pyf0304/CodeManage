...
{
public static class clsTSysParaExWApi_Static
{
...
clsTSysParaWApi.CopyTo(objTSysParaENS, objTSysParaENT);
...
public static bool EditRecordEx(this clsTSysParaEN objTSysParaEN)
{
try
{
objTSysParaEN.sf_UpdFldSetStr = objTSysParaEN.getsf_UpdFldSetStr();
bool bolResult = clsTSysParaExWApi.EditRecordEx(objTSysParaEN);
...
public static bool EditRecordEx(clsTSysParaEN objTSysParaEN)
{
