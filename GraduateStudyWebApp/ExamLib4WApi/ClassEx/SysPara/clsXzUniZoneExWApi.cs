...
{
public static class clsXzUniZoneExWApi_Static
{
...
clsXzUniZoneWApi.CopyTo(objXzUniZoneENS, objXzUniZoneENT);
...
public static bool EditRecordEx(this clsXzUniZoneEN objXzUniZoneEN)
{
try
{
objXzUniZoneEN.sf_UpdFldSetStr = objXzUniZoneEN.getsf_UpdFldSetStr();
bool bolResult = clsXzUniZoneExWApi.EditRecordEx(objXzUniZoneEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzUniZoneExWApi
{
//private static readonly string mstrApiControllerName = "XzUniZoneExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzUniZoneEN> arrXzUniZoneObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzUniZoneEN objXzUniZoneEN)
{
