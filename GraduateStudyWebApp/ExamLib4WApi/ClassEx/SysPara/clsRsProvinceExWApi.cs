...
{
public static class clsRsProvinceExWApi_Static
{
...
clsRsProvinceWApi.CopyTo(objRsProvinceENS, objRsProvinceENT);
...
public static bool EditRecordEx(this clsRsProvinceEN objRsProvinceEN)
{
try
{
objRsProvinceEN.sf_UpdFldSetStr = objRsProvinceEN.getsf_UpdFldSetStr();
bool bolResult = clsRsProvinceExWApi.EditRecordEx(objRsProvinceEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsRsProvinceExWApi
{
//private static readonly string mstrApiControllerName = "RsProvinceExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsRsProvinceEN> arrRsProvinceObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsRsProvinceEN objRsProvinceEN)
{
