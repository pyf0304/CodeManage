...
{
public static class clsDiscipline_psExWApi_Static
{
...
clsDiscipline_psWApi.CopyTo(objDiscipline_psENS, objDiscipline_psENT);
...
public static bool EditRecordEx(this clsDiscipline_psEN objDiscipline_psEN)
{
try
{
objDiscipline_psEN.sf_UpdFldSetStr = objDiscipline_psEN.getsf_UpdFldSetStr();
bool bolResult = clsDiscipline_psExWApi.EditRecordEx(objDiscipline_psEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDiscipline_psExWApi
{
//private static readonly string mstrApiControllerName = "Discipline_psExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDiscipline_psEN> arrDiscipline_psObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDiscipline_psEN objDiscipline_psEN)
{
