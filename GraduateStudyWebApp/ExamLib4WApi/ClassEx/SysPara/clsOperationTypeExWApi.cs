...
{
public static class clsOperationTypeExWApi_Static
{
...
clsOperationTypeWApi.CopyTo(objOperationTypeENS, objOperationTypeENT);
...
public static bool EditRecordEx(this clsOperationTypeEN objOperationTypeEN)
{
try
{
objOperationTypeEN.sf_UpdFldSetStr = objOperationTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsOperationTypeExWApi.EditRecordEx(objOperationTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsOperationTypeExWApi
{
//private static readonly string mstrApiControllerName = "OperationTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsOperationTypeEN> arrOperationTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsOperationTypeEN objOperationTypeEN)
{
