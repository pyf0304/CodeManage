...
{
public static class clscc_ExamPaperTypeExWApi_Static
{
...
clscc_ExamPaperTypeWApi.CopyTo(objcc_ExamPaperTypeENS, objcc_ExamPaperTypeENT);
...
public static bool EditRecordEx(this clscc_ExamPaperTypeEN objcc_ExamPaperTypeEN)
{
try
{
objcc_ExamPaperTypeEN.sf_UpdFldSetStr = objcc_ExamPaperTypeEN.getsf_UpdFldSetStr();
bool bolResult = clscc_ExamPaperTypeExWApi.EditRecordEx(objcc_ExamPaperTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clscc_ExamPaperTypeExWApi
{
//private static readonly string mstrApiControllerName = "cc_ExamPaperTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clscc_ExamPaperTypeEN> arrcc_ExamPaperTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clscc_ExamPaperTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clscc_ExamPaperTypeEN objcc_ExamPaperTypeEN)
{
