 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsFunctionMenuExWApi
 表名:FunctionMenu(01120475)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:40:59
 生成者:pyf
...
{
public static class clsFunctionMenuExWApi_Static
{
...
clsFunctionMenuWApi.CopyTo(objFunctionMenuENS, objFunctionMenuENT);
...
public static bool EditRecordEx(this clsFunctionMenuEN objFunctionMenuEN)
{
try
{
objFunctionMenuEN.sf_UpdFldSetStr = objFunctionMenuEN.getsf_UpdFldSetStr();
bool bolResult = clsFunctionMenuExWApi.EditRecordEx(objFunctionMenuEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFunctionMenuExWApi
{
//private static readonly string mstrApiControllerName = "FunctionMenuExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsFunctionMenuEN> arrFunctionMenuObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsFunctionMenuEN objFunctionMenuEN)
{
