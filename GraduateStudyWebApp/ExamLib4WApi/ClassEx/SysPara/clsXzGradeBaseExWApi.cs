...
{
public static class clsXzGradeBaseExWApi_Static
{
...
clsXzGradeBaseWApi.CopyTo(objXzGradeBaseENS, objXzGradeBaseENT);
...
public static bool EditRecordEx(this clsXzGradeBaseEN objXzGradeBaseEN)
{
try
{
objXzGradeBaseEN.sf_UpdFldSetStr = objXzGradeBaseEN.getsf_UpdFldSetStr();
bool bolResult = clsXzGradeBaseExWApi.EditRecordEx(objXzGradeBaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsXzGradeBaseExWApi
{
//private static readonly string mstrApiControllerName = "XzGradeBaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsXzGradeBaseEN> arrXzGradeBaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsXzGradeBaseEN objXzGradeBaseEN)
{
