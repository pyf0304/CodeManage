...
{
public static class clsDDLDataItemExWApi_Static
{
...
clsDDLDataItemWApi.CopyTo(objDDLDataItemENS, objDDLDataItemENT);
...
public static bool EditRecordEx(this clsDDLDataItemEN objDDLDataItemEN)
{
try
{
objDDLDataItemEN.sf_UpdFldSetStr = objDDLDataItemEN.getsf_UpdFldSetStr();
bool bolResult = clsDDLDataItemExWApi.EditRecordEx(objDDLDataItemEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsDDLDataItemExWApi
{
//private static readonly string mstrApiControllerName = "DDLDataItemExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsDDLDataItemEN> arrDDLDataItemObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsDDLDataItemEN objDDLDataItemEN)
{
