...
{
public static class clsQuestionTypeExWApi_Static
{
...
clsQuestionTypeWApi.CopyTo(objQuestionTypeENS, objQuestionTypeENT);
...
public static bool EditRecordEx(this clsQuestionTypeEN objQuestionTypeEN)
{
try
{
objQuestionTypeEN.sf_UpdFldSetStr = objQuestionTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsQuestionTypeExWApi.EditRecordEx(objQuestionTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQuestionTypeExWApi
{
//private static readonly string mstrApiControllerName = "QuestionTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQuestionTypeEN> arrQuestionTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsQuestionTypeEN objQuestionTypeEN)
{
