...
{
public static class clsClientVersionExWApi_Static
{
...
clsClientVersionWApi.CopyTo(objClientVersionENS, objClientVersionENT);
...
public static bool EditRecordEx(this clsClientVersionEN objClientVersionEN)
{
try
{
objClientVersionEN.sf_UpdFldSetStr = objClientVersionEN.getsf_UpdFldSetStr();
bool bolResult = clsClientVersionExWApi.EditRecordEx(objClientVersionEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsClientVersionExWApi
{
//private static readonly string mstrApiControllerName = "ClientVersionExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsClientVersionEN> arrClientVersionObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsClientVersionEN objClientVersionEN)
{
