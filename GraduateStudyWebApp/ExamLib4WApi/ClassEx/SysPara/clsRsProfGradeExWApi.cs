...
{
public static class clsRsProfGradeExWApi_Static
{
...
clsRsProfGradeWApi.CopyTo(objRsProfGradeENS, objRsProfGradeENT);
...
public static bool EditRecordEx(this clsRsProfGradeEN objRsProfGradeEN)
{
try
{
objRsProfGradeEN.sf_UpdFldSetStr = objRsProfGradeEN.getsf_UpdFldSetStr();
bool bolResult = clsRsProfGradeExWApi.EditRecordEx(objRsProfGradeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsRsProfGradeExWApi
{
//private static readonly string mstrApiControllerName = "RsProfGradeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsRsProfGradeEN> arrRsProfGradeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsRsProfGradeEN objRsProfGradeEN)
{
