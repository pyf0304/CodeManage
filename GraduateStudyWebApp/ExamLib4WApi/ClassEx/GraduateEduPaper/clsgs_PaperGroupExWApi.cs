...
{
public static class clsgs_PaperGroupExWApi_Static
{
...
clsgs_PaperGroupWApi.CopyTo(objgs_PaperGroupENS, objgs_PaperGroupENT);
...
public static bool EditRecordEx(this clsgs_PaperGroupEN objgs_PaperGroupEN)
{
try
{
objgs_PaperGroupEN.sf_UpdFldSetStr = objgs_PaperGroupEN.getsf_UpdFldSetStr();
bool bolResult = clsgs_PaperGroupExWApi.EditRecordEx(objgs_PaperGroupEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsgs_PaperGroupExWApi
{
private static readonly string mstrApiControllerName = "gs_PaperGroupExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsgs_PaperGroupEN> arrgs_PaperGroupObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsgs_PaperGroupEN objgs_PaperGroupEN)
{
