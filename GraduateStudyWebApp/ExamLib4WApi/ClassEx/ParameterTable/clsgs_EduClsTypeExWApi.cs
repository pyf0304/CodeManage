...
{
public static class clsgs_EduClsTypeExWApi_Static
{
...
clsgs_EduClsTypeWApi.CopyTo(objgs_EduClsTypeENS, objgs_EduClsTypeENT);
...
public static bool EditRecordEx(this clsgs_EduClsTypeEN objgs_EduClsTypeEN)
{
try
{
objgs_EduClsTypeEN.sf_UpdFldSetStr = objgs_EduClsTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsgs_EduClsTypeExWApi.EditRecordEx(objgs_EduClsTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsgs_EduClsTypeExWApi
{
//private static readonly string mstrApiControllerName = "gs_EduClsTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsgs_EduClsTypeEN> arrgs_EduClsTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsgs_EduClsTypeEN objgs_EduClsTypeEN)
{
