...
{
public static class clsQxProjectsExWApi_Static
{
...
clsQxProjectsWApi.CopyTo(objQxProjectsENS, objQxProjectsENT);
...
public static bool EditRecordEx(this clsQxProjectsEN objQxProjectsEN)
{
try
{
objQxProjectsEN.sf_UpdFldSetStr = objQxProjectsEN.getsf_UpdFldSetStr();
bool bolResult = clsQxProjectsExWApi.EditRecordEx(objQxProjectsEN);
...
public static bool EditRecordEx(clsQxProjectsEN objQxProjectsEN)
{
