 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroTeachCaseRelaInfoTypeExWApi
...
{
public static class clsMicroTeachCaseRelaInfoTypeExWApi_Static
{
...
clsMicroTeachCaseRelaInfoTypeWApi.CopyTo(objMicroTeachCaseRelaInfoTypeENS, objMicroTeachCaseRelaInfoTypeENT);
...
public static bool EditRecordEx(this clsMicroTeachCaseRelaInfoTypeEN objMicroTeachCaseRelaInfoTypeEN)
{
try
{
objMicroTeachCaseRelaInfoTypeEN.sf_UpdFldSetStr = objMicroTeachCaseRelaInfoTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsMicroTeachCaseRelaInfoTypeExWApi.EditRecordEx(objMicroTeachCaseRelaInfoTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsMicroTeachCaseRelaInfoTypeExWApi
{
//private static readonly string mstrApiControllerName = "MicroTeachCaseRelaInfoTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsMicroTeachCaseRelaInfoTypeEN> arrMicroTeachCaseRelaInfoTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsMicroTeachCaseRelaInfoTypeExWApi()
 {
 }
...
public static bool EditRecordEx(clsMicroTeachCaseRelaInfoTypeEN objMicroTeachCaseRelaInfoTypeEN)
{
