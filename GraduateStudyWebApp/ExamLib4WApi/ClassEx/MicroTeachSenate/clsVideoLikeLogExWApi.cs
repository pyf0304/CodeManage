 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsVideoLikeLogExWApi
 表名:VideoLikeLog(01120291)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:41:30
 生成者:pyf
...
{
public static class clsVideoLikeLogExWApi_Static
{
 ...
 public static clsVideoLikeLogENEx CopyToEx(this clsVideoLikeLogEN objVideoLikeLogENS)
{
try
{
 clsVideoLikeLogENEx objVideoLikeLogENT = new clsVideoLikeLogENEx();
clsVideoLikeLogWApi.CopyTo(objVideoLikeLogENS, objVideoLikeLogENT);
...
public static bool EditRecordEx(this clsVideoLikeLogEN objVideoLikeLogEN)
{
try
{
objVideoLikeLogEN.sf_UpdFldSetStr = objVideoLikeLogEN.getsf_UpdFldSetStr();
bool bolResult = clsVideoLikeLogExWApi.EditRecordEx(objVideoLikeLogEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsVideoLikeLogExWApi
{
//private static readonly string mstrApiControllerName = "VideoLikeLogExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsVideoLikeLogEN> arrVideoLikeLogObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsVideoLikeLogEN objVideoLikeLogEN)
{
