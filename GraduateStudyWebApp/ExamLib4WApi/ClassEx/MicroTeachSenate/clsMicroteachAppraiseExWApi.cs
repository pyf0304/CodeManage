 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroteachAppraiseExWApi
...
{
public static class clsMicroteachAppraiseExWApi_Static
{
 ...
 public static clsMicroteachAppraiseENEx CopyToEx(this clsMicroteachAppraiseEN objMicroteachAppraiseENS)
{
try
{
 clsMicroteachAppraiseENEx objMicroteachAppraiseENT = new clsMicroteachAppraiseENEx();
clsMicroteachAppraiseWApi.CopyTo(objMicroteachAppraiseENS, objMicroteachAppraiseENT);
...
public static bool EditRecordEx(this clsMicroteachAppraiseEN objMicroteachAppraiseEN)
{
try
{
objMicroteachAppraiseEN.sf_UpdFldSetStr = objMicroteachAppraiseEN.getsf_UpdFldSetStr();
bool bolResult = clsMicroteachAppraiseExWApi.EditRecordEx(objMicroteachAppraiseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsMicroteachAppraiseExWApi
{
//private static readonly string mstrApiControllerName = "MicroteachAppraiseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsMicroteachAppraiseEN> arrMicroteachAppraiseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsMicroteachAppraiseExWApi()
 {
 }
...
public static bool EditRecordEx(clsMicroteachAppraiseEN objMicroteachAppraiseEN)
{
