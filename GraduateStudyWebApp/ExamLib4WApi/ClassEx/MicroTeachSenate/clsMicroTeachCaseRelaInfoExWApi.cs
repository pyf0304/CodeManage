 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroTeachCaseRelaInfoExWApi
 表名:MicroTeachCaseRelaInfo(01120318)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:46:29
 生成者:pyf
...
{
public static class clsMicroTeachCaseRelaInfoExWApi_Static
{
...
clsMicroTeachCaseRelaInfoWApi.CopyTo(objMicroTeachCaseRelaInfoENS, objMicroTeachCaseRelaInfoENT);
...
public static bool EditRecordEx(this clsMicroTeachCaseRelaInfoEN objMicroTeachCaseRelaInfoEN)
{
try
{
objMicroTeachCaseRelaInfoEN.sf_UpdFldSetStr = objMicroTeachCaseRelaInfoEN.getsf_UpdFldSetStr();
bool bolResult = clsMicroTeachCaseRelaInfoExWApi.EditRecordEx(objMicroTeachCaseRelaInfoEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsMicroTeachCaseRelaInfoExWApi
{
//private static readonly string mstrApiControllerName = "MicroTeachCaseRelaInfoExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsMicroTeachCaseRelaInfoEN> arrMicroTeachCaseRelaInfoObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsMicroTeachCaseRelaInfoExWApi()
 {
 }
...
public static bool EditRecordEx(clsMicroTeachCaseRelaInfoEN objMicroTeachCaseRelaInfoEN)
{
