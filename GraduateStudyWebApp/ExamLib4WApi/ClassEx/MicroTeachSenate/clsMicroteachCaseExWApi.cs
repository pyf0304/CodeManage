...
{
public static class clsMicroteachCaseExWApi_Static
{
...
clsMicroteachCaseWApi.CopyTo(objMicroteachCaseENS, objMicroteachCaseENT);
...
public static bool EditRecordEx(this clsMicroteachCaseEN objMicroteachCaseEN)
{
try
{
objMicroteachCaseEN.sf_UpdFldSetStr = objMicroteachCaseEN.getsf_UpdFldSetStr();
bool bolResult = clsMicroteachCaseExWApi.EditRecordEx(objMicroteachCaseEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsMicroteachCaseExWApi
{
//private static readonly string mstrApiControllerName = "MicroteachCaseExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsMicroteachCaseEN> arrMicroteachCaseObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsMicroteachCaseExWApi()
 {
 }
...
public static bool EditRecordEx(clsMicroteachCaseEN objMicroteachCaseEN)
{
