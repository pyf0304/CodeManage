...
{
public static class clsAppraiseTypeExWApi_Static
{
 ...
 public static clsAppraiseTypeENEx CopyToEx(this clsAppraiseTypeEN objAppraiseTypeENS)
{
try
{
 clsAppraiseTypeENEx objAppraiseTypeENT = new clsAppraiseTypeENEx();
clsAppraiseTypeWApi.CopyTo(objAppraiseTypeENS, objAppraiseTypeENT);
...
public static bool EditRecordEx(this clsAppraiseTypeEN objAppraiseTypeEN)
{
try
{
objAppraiseTypeEN.sf_UpdFldSetStr = objAppraiseTypeEN.getsf_UpdFldSetStr();
bool bolResult = clsAppraiseTypeExWApi.EditRecordEx(objAppraiseTypeEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsAppraiseTypeExWApi
{
//private static readonly string mstrApiControllerName = "AppraiseTypeExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsAppraiseTypeEN> arrAppraiseTypeObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsAppraiseTypeEN objAppraiseTypeEN)
{
