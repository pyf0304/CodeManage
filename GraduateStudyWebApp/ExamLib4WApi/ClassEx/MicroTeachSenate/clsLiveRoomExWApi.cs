...
{
public static class clsLiveRoomExWApi_Static
{
 ...
 public static clsLiveRoomENEx CopyToEx(this clsLiveRoomEN objLiveRoomENS)
{
try
{
 clsLiveRoomENEx objLiveRoomENT = new clsLiveRoomENEx();
clsLiveRoomWApi.CopyTo(objLiveRoomENS, objLiveRoomENT);
...
public static bool EditRecordEx(this clsLiveRoomEN objLiveRoomEN)
{
try
{
objLiveRoomEN.sf_UpdFldSetStr = objLiveRoomEN.getsf_UpdFldSetStr();
bool bolResult = clsLiveRoomExWApi.EditRecordEx(objLiveRoomEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsLiveRoomExWApi
{
//private static readonly string mstrApiControllerName = "LiveRoomExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsLiveRoomEN> arrLiveRoomObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsLiveRoomEN objLiveRoomEN)
{
