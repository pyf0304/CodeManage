...
{
public static class clsQxUserRightRelaExWApi_Static
{
 ...
 public static clsQxUserRightRelaENEx CopyToEx(this clsQxUserRightRelaEN objQxUserRightRelaENS)
{
try
{
 clsQxUserRightRelaENEx objQxUserRightRelaENT = new clsQxUserRightRelaENEx();
clsQxUserRightRelaWApi.CopyTo(objQxUserRightRelaENS, objQxUserRightRelaENT);
...
public static bool EditRecordEx(this clsQxUserRightRelaEN objQxUserRightRelaEN)
{
try
{
objQxUserRightRelaEN.sf_UpdFldSetStr = objQxUserRightRelaEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserRightRelaExWApi.EditRecordEx(objQxUserRightRelaEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxUserRightRelaExWApi
{
//private static readonly string mstrApiControllerName = "QxUserRightRelaExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQxUserRightRelaEN> arrQxUserRightRelaObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQxUserRightRelaExWApi()
 {
 }
...
public static bool EditRecordEx(clsQxUserRightRelaEN objQxUserRightRelaEN)
{
