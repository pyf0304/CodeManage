...
{
public static class clsQxRightExWApi_Static
{
...
clsQxRightWApi.CopyTo(objQxRightENS, objQxRightENT);
...
public static bool EditRecordEx(this clsQxRightEN objQxRightEN)
{
try
{
objQxRightEN.sf_UpdFldSetStr = objQxRightEN.getsf_UpdFldSetStr();
bool bolResult = clsQxRightExWApi.EditRecordEx(objQxRightEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxRightExWApi
{
//private static readonly string mstrApiControllerName = "QxRightExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQxRightEN> arrQxRightObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsQxRightEN objQxRightEN)
{
