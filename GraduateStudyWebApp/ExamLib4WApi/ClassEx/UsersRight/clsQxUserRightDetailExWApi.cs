 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxUserRightDetailExWApi
 表名:QxUserRightDetail(01120178)
 生成代码版本:2021.09.20.1
 生成日期:2021/09/21 02:38:44
 生成者:pyf
...
{
public static class clsQxUserRightDetailExWApi_Static
{
 ...
 public static clsQxUserRightDetailENEx CopyToEx(this clsQxUserRightDetailEN objQxUserRightDetailENS)
{
try
{
 clsQxUserRightDetailENEx objQxUserRightDetailENT = new clsQxUserRightDetailENEx();
clsQxUserRightDetailWApi.CopyTo(objQxUserRightDetailENS, objQxUserRightDetailENT);
...
public static bool EditRecordEx(this clsQxUserRightDetailEN objQxUserRightDetailEN)
{
try
{
objQxUserRightDetailEN.sf_UpdFldSetStr = objQxUserRightDetailEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserRightDetailExWApi.EditRecordEx(objQxUserRightDetailEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxUserRightDetailExWApi
{
//private static readonly string mstrApiControllerName = "QxUserRightDetailExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQxUserRightDetailEN> arrQxUserRightDetailObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsQxUserRightDetailExWApi()
 {
 }
...
public static bool EditRecordEx(clsQxUserRightDetailEN objQxUserRightDetailEN)
{
