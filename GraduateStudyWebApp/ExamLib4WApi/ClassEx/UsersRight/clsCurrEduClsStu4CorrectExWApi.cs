 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCurrEduClsStu4CorrectExWApi
...
{
public static class clsCurrEduClsStu4CorrectExWApi_Static
{
...
clsCurrEduClsStu4CorrectWApi.CopyTo(objCurrEduClsStu4CorrectENS, objCurrEduClsStu4CorrectENT);
...
public static bool EditRecordEx(this clsCurrEduClsStu4CorrectEN objCurrEduClsStu4CorrectEN)
{
try
{
objCurrEduClsStu4CorrectEN.sf_UpdFldSetStr = objCurrEduClsStu4CorrectEN.getsf_UpdFldSetStr();
bool bolResult = clsCurrEduClsStu4CorrectExWApi.EditRecordEx(objCurrEduClsStu4CorrectEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsCurrEduClsStu4CorrectExWApi
{
//private static readonly string mstrApiControllerName = "CurrEduClsStu4CorrectExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsCurrEduClsStu4CorrectEN> arrCurrEduClsStu4CorrectObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
/// </summary>
 public clsCurrEduClsStu4CorrectExWApi()
 {
 }
...
public static bool EditRecordEx(clsCurrEduClsStu4CorrectEN objCurrEduClsStu4CorrectEN)
{
