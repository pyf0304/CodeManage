...
{
public static class clsQxUserRoleRelationExWApi_Static
{
...
clsQxUserRoleRelationWApi.CopyTo(objQxUserRoleRelationENS, objQxUserRoleRelationENT);
...
public static bool EditRecordEx(this clsQxUserRoleRelationEN objQxUserRoleRelationEN)
{
try
{
objQxUserRoleRelationEN.sf_UpdFldSetStr = objQxUserRoleRelationEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserRoleRelationExWApi.EditRecordEx(objQxUserRoleRelationEN);
...
/// </summary>
 public clsQxUserRoleRelationExWApi()
 {
 }
...
public static bool EditRecordEx(clsQxUserRoleRelationEN objQxUserRoleRelationEN)
{
