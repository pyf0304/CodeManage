...
{
public static class clsQxUserRoleRelation4SynchExWApi_Static
{
 ...
 public static clsQxUserRoleRelation4SynchENEx CopyToEx(this clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchENS)
{
try
{
 clsQxUserRoleRelation4SynchENEx objQxUserRoleRelation4SynchENT = new clsQxUserRoleRelation4SynchENEx();
clsQxUserRoleRelation4SynchWApi.CopyTo(objQxUserRoleRelation4SynchENS, objQxUserRoleRelation4SynchENT);
...
public static bool EditRecordEx(this clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN)
{
try
{
objQxUserRoleRelation4SynchEN.sf_UpdFldSetStr = objQxUserRoleRelation4SynchEN.getsf_UpdFldSetStr();
bool bolResult = clsQxUserRoleRelation4SynchExWApi.EditRecordEx(objQxUserRoleRelation4SynchEN);
...
{
//private static readonly string mstrApiControllerName = "QxUserRoleRelation4SynchExApi";
 /// <summary>
...
/// </summary>
 public clsQxUserRoleRelation4SynchExWApi()
 {
 }
...
public static bool EditRecordEx(clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN)
{
