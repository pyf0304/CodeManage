...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApicc_PapersBigTopic_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApicc_PapersBigTopic_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>试卷大题目的WApi单元测试</title>
...
<div id="divGetObjByPapersBigTopicId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByPapersBigTopicId" name="btnExpandGetObjByPapersBigTopicId" onclick="ExpandDiv('divGetObjByPapersBigTopicId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByPapersBigTopicId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByPapersBigTopicId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByPapersBigTopicId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByPapersBigTopicId_WA_Cache" name="btnExpandGetObjByPapersBigTopicId_WA_Cache" onclick="ExpandDiv('divGetObjByPapersBigTopicId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByPapersBigTopicId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByPapersBigTopicId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="PapersBigTopicId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="PapersBigTopicId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="PapersBigTopicId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="PapersBigTopicId Asc" runat="server" />
</div>
