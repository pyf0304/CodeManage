...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApicc_PaperDispMode_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApicc_PaperDispMode_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>试卷显示模式的WApi单元测试</title>
...
<div id="divGetObjByPaperDispModeId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByPaperDispModeId" name="btnExpandGetObjByPaperDispModeId" onclick="ExpandDiv('divGetObjByPaperDispModeId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByPaperDispModeId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByPaperDispModeId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByPaperDispModeId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByPaperDispModeId_WA_Cache" name="btnExpandGetObjByPaperDispModeId_WA_Cache" onclick="ExpandDiv('divGetObjByPaperDispModeId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByPaperDispModeId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByPaperDispModeId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="PaperDispModeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="PaperDispModeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="PaperDispModeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="PaperDispModeId Asc" runat="server" />
</div>
