...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiXzGrade_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiXzGrade_UT" %>
<!DOCTYPE html>
...
<div id="divGetObjByid_Grade" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByid_Grade" name="btnExpandGetObjByid_Grade" onclick="ExpandDiv('divGetObjByid_Grade');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByid_Grade" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByid_Grade_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByid_Grade_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByid_Grade_WA_Cache" name="btnExpandGetObjByid_Grade_WA_Cache" onclick="ExpandDiv('divGetObjByid_Grade_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByid_Grade_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByid_Grade_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="id_Grade Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="id_Grade Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="id_Grade Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="id_Grade Asc" runat="server" />
</div>
