...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApigs_TopicTaskStatus_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApigs_TopicTaskStatus_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>主题任务状态的WApi单元测试</title>
...
<div id="divGetObjByStatusId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByStatusId" name="btnExpandGetObjByStatusId" onclick="ExpandDiv('divGetObjByStatusId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByStatusId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByStatusId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByStatusId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByStatusId_WA_Cache" name="btnExpandGetObjByStatusId_WA_Cache" onclick="ExpandDiv('divGetObjByStatusId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByStatusId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByStatusId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="StatusId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="StatusId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="StatusId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="StatusId Asc" runat="server" />
</div>
