...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiTopicUserRole_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiTopicUserRole_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>主题用户角色的WApi单元测试</title>
...
<div id="divGetObjByTopicUserRoleId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByTopicUserRoleId" name="btnExpandGetObjByTopicUserRoleId" onclick="ExpandDiv('divGetObjByTopicUserRoleId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByTopicUserRoleId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByTopicUserRoleId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByTopicUserRoleId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByTopicUserRoleId_WA_Cache" name="btnExpandGetObjByTopicUserRoleId_WA_Cache" onclick="ExpandDiv('divGetObjByTopicUserRoleId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByTopicUserRoleId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByTopicUserRoleId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="TopicUserRoleId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="TopicUserRoleId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="TopicUserRoleId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="TopicUserRoleId Asc" runat="server" />
</div>
