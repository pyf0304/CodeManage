...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiCaseExerciseRela_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiCaseExerciseRela_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>案例习题关系的WApi单元测试</title>
...
<div id="divGetObjByid_CaseExerciseRela" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByid_CaseExerciseRela" name="btnExpandGetObjByid_CaseExerciseRela" onclick="ExpandDiv('divGetObjByid_CaseExerciseRela');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByid_CaseExerciseRela" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByid_CaseExerciseRela_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByid_CaseExerciseRela_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByid_CaseExerciseRela_WA_Cache" name="btnExpandGetObjByid_CaseExerciseRela_WA_Cache" onclick="ExpandDiv('divGetObjByid_CaseExerciseRela_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByid_CaseExerciseRela_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByid_CaseExerciseRela_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="id_CaseExerciseRela Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="id_CaseExerciseRela Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="id_CaseExerciseRela Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="id_CaseExerciseRela Asc" runat="server" />
</div>
