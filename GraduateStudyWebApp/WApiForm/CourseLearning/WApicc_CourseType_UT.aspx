...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApicc_CourseType_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApicc_CourseType_UT" %>
<!DOCTYPE html>
...
<div id="divGetObjByCourseTypeID" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByCourseTypeID" name="btnExpandGetObjByCourseTypeID" onclick="ExpandDiv('divGetObjByCourseTypeID');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByCourseTypeID" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByCourseTypeID_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByCourseTypeID_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByCourseTypeID_WA_Cache" name="btnExpandGetObjByCourseTypeID_WA_Cache" onclick="ExpandDiv('divGetObjByCourseTypeID_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByCourseTypeID_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByCourseTypeID_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="CourseTypeID Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="CourseTypeID Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="CourseTypeID Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="CourseTypeID Asc" runat="server" />
</div>
