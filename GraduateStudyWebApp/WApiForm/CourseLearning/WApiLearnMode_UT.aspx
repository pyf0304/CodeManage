...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiLearnMode_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiLearnMode_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>学习模式的WApi单元测试</title>
...
<div id="divGetObjByLearnModeId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByLearnModeId" name="btnExpandGetObjByLearnModeId" onclick="ExpandDiv('divGetObjByLearnModeId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByLearnModeId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByLearnModeId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByLearnModeId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByLearnModeId_WA_Cache" name="btnExpandGetObjByLearnModeId_WA_Cache" onclick="ExpandDiv('divGetObjByLearnModeId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByLearnModeId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByLearnModeId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="LearnModeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="LearnModeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="LearnModeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="LearnModeId Asc" runat="server" />
</div>
