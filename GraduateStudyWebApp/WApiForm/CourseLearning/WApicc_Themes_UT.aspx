...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApicc_Themes_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApicc_Themes_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>课程主题的WApi单元测试</title>
...
<div id="divGetObjByThemeId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByThemeId" name="btnExpandGetObjByThemeId" onclick="ExpandDiv('divGetObjByThemeId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByThemeId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByThemeId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByThemeId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByThemeId_WA_Cache" name="btnExpandGetObjByThemeId_WA_Cache" onclick="ExpandDiv('divGetObjByThemeId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByThemeId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByThemeId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="ThemeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="ThemeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="ThemeId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="ThemeId Asc" runat="server" />
</div>
