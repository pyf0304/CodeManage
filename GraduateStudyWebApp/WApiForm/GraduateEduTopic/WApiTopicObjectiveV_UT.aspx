...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiTopicObjectiveV_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiTopicObjectiveV_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>主题客观版本的WApi单元测试</title>
...
<div id="divGetObjByTopicObjectiveVId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByTopicObjectiveVId" name="btnExpandGetObjByTopicObjectiveVId" onclick="ExpandDiv('divGetObjByTopicObjectiveVId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByTopicObjectiveVId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByTopicObjectiveVId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByTopicObjectiveVId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByTopicObjectiveVId_WA_Cache" name="btnExpandGetObjByTopicObjectiveVId_WA_Cache" onclick="ExpandDiv('divGetObjByTopicObjectiveVId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByTopicObjectiveVId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByTopicObjectiveVId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="TopicObjectiveVId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="TopicObjectiveVId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="TopicObjectiveVId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="TopicObjectiveVId Asc" runat="server" />
</div>
