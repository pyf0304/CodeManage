...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiqa_Questions_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiqa_Questions_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>答疑提问表的WApi单元测试</title>
...
<div id="divGetObjByQuestionsId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByQuestionsId" name="btnExpandGetObjByQuestionsId" onclick="ExpandDiv('divGetObjByQuestionsId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByQuestionsId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByQuestionsId_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByQuestionsId_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByQuestionsId_WA_Cache" name="btnExpandGetObjByQuestionsId_WA_Cache" onclick="ExpandDiv('divGetObjByQuestionsId_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByQuestionsId_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByQuestionsId_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="QuestionsId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="QuestionsId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="QuestionsId Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="QuestionsId Asc" runat="server" />
</div>
