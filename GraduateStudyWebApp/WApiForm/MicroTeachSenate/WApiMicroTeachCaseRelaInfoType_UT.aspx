...
<%@ Page language = "c#" AutoEventWireup = "true" CodeBehind = "WApiMicroTeachCaseRelaInfoType_UT.aspx.cs" Inherits = "ExamLib.WApiForm.WApiMicroTeachCaseRelaInfoType_UT" %>
<!DOCTYPE html>
<html xmlns = "http://www.w3.org/1999/xhtml">
<head runat = "server">
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8" />
<title>微格案例相关信息类型的WApi单元测试</title>
...
<div id="divAddNewRecord4GetMaxStrId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
<asp:Label id="lblTitle5" name="lblTitle5" CssClass="h6" Width="700px" Text="测试：5、添加记录(最大关键字)(AddNewRecord4GetMaxStrId)" runat="server" />
</div>
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandAddNewRecord4GetMaxStrId" name="btnExpandAddNewRecord4GetMaxStrId" onclick="ExpandDiv('divAddNewRecord4GetMaxStrId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
<div id="divParaGroup5" style="width: 100%; float: left">
<div id="divParastrFunction4CodeJSONObj5" style="width: 100%; float: left">
<asp:Label id="lblParastrFunction4CodeJSONObj5" name="lblParastrFunction4CodeJSONObj5" Width="200px" Text="strFunction4CodeJSONObj" runat="server" />
<asp:TextBox id="txtstrFunction4CodeJSONObj5" name="txtstrFunction4CodeJSONObj5" Width="80px" runat="server" />
</div>
</div>
<div id="divList5" style="width: 100%; float: left">
<asp:Button id="btnAddNewRecord4GetMaxStrId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnAddNewRecord4GetMaxStrId_Click" Text="5、添加记录(最大关键字)" runat="server" />
<asp:Label id="lblResult5" name="lblResult5" CssClass="Content" Width="600px" Text="结果" runat="server" />
<div>
</div>
</div>
</div>
...
<div id="divGetMaxStrId" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
<asp:Label id="lblTitle6" name="lblTitle6" CssClass="h6" Width="700px" Text="测试：6、获取最大关键字值(GetMaxStrId)" runat="server" />
</div>
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetMaxStrId" name="btnExpandGetMaxStrId" onclick="ExpandDiv('divGetMaxStrId');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
<div id="divParaGroup6" style="width: 100%; float: left">
</div>
<div id="divList6" style="width: 100%; float: left">
<asp:Button id="btnGetMaxStrId" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetMaxStrId_Click" Text="6、获取最大关键字值" runat="server" />
<asp:Label id="lblResult6" name="lblResult6" CssClass="Content" Width="600px" Text="结果" runat="server" />
<div>
</div>
</div>
</div>
...
<div id="divGetMaxStrIdByPrefix" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
<asp:Label id="lblTitle7" name="lblTitle7" CssClass="h6" Width="700px" Text="测试：7、获取最大关键字值,根据前缀(GetMaxStrIdByPrefix)" runat="server" />
</div>
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetMaxStrIdByPrefix" name="btnExpandGetMaxStrIdByPrefix" onclick="ExpandDiv('divGetMaxStrIdByPrefix');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
<div id="divParaGroup7" style="width: 100%; float: left">
<div id="divParastrPrefix7" style="width: 100%; float: left">
<asp:Label id="lblParastrPrefix7" name="lblParastrPrefix7" Width="200px" Text="strPrefix" runat="server" />
<asp:TextBox id="txtstrPrefix7" name="txtstrPrefix7" Width="80px" runat="server" />
</div>
</div>
<div id="divList7" style="width: 100%; float: left">
<asp:Button id="btnGetMaxStrIdByPrefix" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetMaxStrIdByPrefix_Click" Text="7、获取最大关键字值,根据前缀" runat="server" />
<asp:Label id="lblResult7" name="lblResult7" CssClass="Content" Width="600px" Text="结果" runat="server" />
<div>
</div>
</div>
</div>
...
<div id="divGetObjByid_MicroTeachCaseRelaInfoType" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByid_MicroTeachCaseRelaInfoType" name="btnExpandGetObjByid_MicroTeachCaseRelaInfoType" onclick="ExpandDiv('divGetObjByid_MicroTeachCaseRelaInfoType');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByid_MicroTeachCaseRelaInfoType" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByid_MicroTeachCaseRelaInfoType_Click" Text="12、根据关键字获取对象" runat="server" />
...
<div id="divGetObjByid_MicroTeachCaseRelaInfoType_WA_Cache" style="width: 100%; float: left; margin-bottom:5px;" class="function">
<hr />
<div style="width:100%; height:25px;" class="title">
<div style="float:left; width:80%;">
...
<div style="float:right; width:20%;">
<input type='button'  id="btnExpandGetObjByid_MicroTeachCaseRelaInfoType_WA_Cache" name="btnExpandGetObjByid_MicroTeachCaseRelaInfoType_WA_Cache" onclick="ExpandDiv('divGetObjByid_MicroTeachCaseRelaInfoType_WA_Cache');" value="展开"  />
</div>
</div>
<div style="width: 100%" class="content">
...
<asp:Button id="btnGetObjByid_MicroTeachCaseRelaInfoType_WA_Cache" CssClass="btn btn-outline-info btn-sm" Width="350px" OnClick="btnGetObjByid_MicroTeachCaseRelaInfoType_WA_Cache_Click" Text="13、根据关键字获取对象, 使用WebApi缓存" runat="server" />
...
<asp:TextBox id="txtstrOrderBy18" name="txtstrOrderBy18" Width="80px" Text="id_MicroTeachCaseRelaInfoType Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy19" name="txtstrOrderBy19" Width="80px" Text="id_MicroTeachCaseRelaInfoType Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy20" name="txtstrOrderBy20" Width="80px" Text="id_MicroTeachCaseRelaInfoType Asc" runat="server" />
</div>
...
<asp:TextBox id="txtstrOrderBy21" name="txtstrOrderBy21" Width="80px" Text="id_MicroTeachCaseRelaInfoType Asc" runat="server" />
</div>
