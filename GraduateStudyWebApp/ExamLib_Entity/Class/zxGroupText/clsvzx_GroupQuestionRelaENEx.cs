 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvzx_GroupQuestionRelaENEx
 表名:vzx_GroupQuestionRela(01120736)
 生成代码版本:2020.09.09.1
 生成日期:2020/09/15 14:13:42
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvzx_GroupQuestionRelaENEx : clsvzx_GroupQuestionRelaEN
{
...
/// </summary>
 public clsvzx_GroupQuestionRelaENEx()
 {
 }
}
}