 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachCaseRelaInfoTypeENEx
 表名:TeachCaseRelaInfoType(01120512)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:35:19
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsTeachCaseRelaInfoTypeENEx : clsTeachCaseRelaInfoTypeEN
{
...
/// </summary>
 public clsTeachCaseRelaInfoTypeENEx()
 {
 }
}
}