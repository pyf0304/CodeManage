 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseExamPaperUserLogENEx
 表名:cc_CourseExamPaperUserLog(01120090)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:24:45
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clscc_CourseExamPaperUserLogENEx : clscc_CourseExamPaperUserLogEN
{
...
/// </summary>
 public clscc_CourseExamPaperUserLogENEx()
 {
 }
}
}