 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_StructureChartNodeENEx
 表名:ge_StructureChartNode(01120894)
 生成代码版本:2021.03.13.1
 生成日期:2021/03/24 19:46:38
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsge_StructureChartNodeENEx : clsge_StructureChartNodeEN
{
...
/// </summary>
 public clsge_StructureChartNodeENEx()
 {
 }
}
}