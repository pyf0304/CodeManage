 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_KnowledgesUserMasterENEx
 表名:ge_KnowledgesUserMaster(01120892)
 生成代码版本:2021.03.10.1
 生成日期:2021/03/11 14:20:56
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsge_KnowledgesUserMasterENEx : clsge_KnowledgesUserMasterEN
{
...
/// </summary>
 public clsge_KnowledgesUserMasterENEx()
 {
 }
}
}