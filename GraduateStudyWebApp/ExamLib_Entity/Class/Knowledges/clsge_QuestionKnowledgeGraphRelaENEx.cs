 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_QuestionKnowledgeGraphRelaENEx
 表名:ge_QuestionKnowledgeGraphRela(01120909)
 生成代码版本:2021.03.30.1
 生成日期:2021/04/01 22:26:13
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsge_QuestionKnowledgeGraphRelaENEx : clsge_QuestionKnowledgeGraphRelaEN
{
...
/// </summary>
 public clsge_QuestionKnowledgeGraphRelaENEx()
 {
 }
}
}