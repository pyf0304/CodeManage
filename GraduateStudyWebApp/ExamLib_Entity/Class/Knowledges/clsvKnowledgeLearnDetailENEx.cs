 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvKnowledgeLearnDetailENEx
 表名:vKnowledgeLearnDetail(01120157)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:51:46
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvKnowledgeLearnDetailENEx : clsvKnowledgeLearnDetailEN
{
...
/// </summary>
 public clsvKnowledgeLearnDetailENEx()
 {
 }
}
}