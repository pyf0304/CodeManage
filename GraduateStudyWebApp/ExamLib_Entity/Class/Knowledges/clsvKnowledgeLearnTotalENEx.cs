 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvKnowledgeLearnTotalENEx
 表名:vKnowledgeLearnTotal(01120156)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:51:39
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvKnowledgeLearnTotalENEx : clsvKnowledgeLearnTotalEN
{
...
/// </summary>
 public clsvKnowledgeLearnTotalENEx()
 {
 }
}
}