 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_StructureSubmitResultsENEx
 表名:ge_StructureSubmitResults(01120903)
 生成代码版本:2021.03.13.1
 生成日期:2021/03/24 17:52:34
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsge_StructureSubmitResultsENEx : clsge_StructureSubmitResultsEN
{
...
/// </summary>
 public clsge_StructureSubmitResultsENEx()
 {
 }
}
}