 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseExamPaperUserExamsLogENEx
 表名:cc_CourseExamPaperUserExamsLog(01120091)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:24:36
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clscc_CourseExamPaperUserExamsLogENEx : clscc_CourseExamPaperUserExamsLogEN
{
...
/// </summary>
 public clscc_CourseExamPaperUserExamsLogENEx()
 {
 }
}
}