 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_CourseExamPaperRelationshipENEx
 表名:vcc_CourseExamPaperRelationship(01120075)
 生成代码版本:2020.05.28.1
 生成日期:2020/06/02 14:44:08
 生成者:
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvcc_CourseExamPaperRelationshipENEx : clsvcc_CourseExamPaperRelationshipEN
{
...
/// </summary>
 public clsvcc_CourseExamPaperRelationshipENEx()
 {
 }
}
}