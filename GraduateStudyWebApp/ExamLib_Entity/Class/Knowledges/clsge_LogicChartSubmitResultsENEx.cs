 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_LogicChartSubmitResultsENEx
 表名:ge_LogicChartSubmitResults(01120912)
 生成代码版本:2021.03.30.1
 生成日期:2021/04/03 19:01:01
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsge_LogicChartSubmitResultsENEx : clsge_LogicChartSubmitResultsEN
{
...
/// </summary>
 public clsge_LogicChartSubmitResultsENEx()
 {
 }
}
}