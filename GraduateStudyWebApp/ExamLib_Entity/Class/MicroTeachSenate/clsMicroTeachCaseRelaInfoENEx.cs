 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroTeachCaseRelaInfoENEx
 表名:MicroTeachCaseRelaInfo(01120318)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:30:53
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsMicroTeachCaseRelaInfoENEx : clsMicroTeachCaseRelaInfoEN
{
...
/// </summary>
 public clsMicroTeachCaseRelaInfoENEx()
 {
 }
}
}