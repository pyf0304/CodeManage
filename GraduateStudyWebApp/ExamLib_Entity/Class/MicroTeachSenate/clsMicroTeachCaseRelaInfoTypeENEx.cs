 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroTeachCaseRelaInfoTypeENEx
 表名:MicroTeachCaseRelaInfoType(01120317)
 生成代码版本:2021.02.21.1
 生成日期:2021/02/23 19:53:16
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsMicroTeachCaseRelaInfoTypeENEx : clsMicroTeachCaseRelaInfoTypeEN
{
...
/// </summary>
 public clsMicroTeachCaseRelaInfoTypeENEx()
 {
 }
}
}