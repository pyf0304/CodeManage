 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachingCaseResCaseTypeENEx
 表名:TeachingCaseResCaseType(01120514)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:36:01
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsTeachingCaseResCaseTypeENEx : clsTeachingCaseResCaseTypeEN
{
...
/// </summary>
 public clsTeachingCaseResCaseTypeENEx()
 {
 }
}
}