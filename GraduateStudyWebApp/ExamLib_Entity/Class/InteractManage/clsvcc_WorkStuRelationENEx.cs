 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_WorkStuRelationENEx
 表名:vcc_WorkStuRelation(01120198)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/27 00:36:24
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvcc_WorkStuRelationENEx : clsvcc_WorkStuRelationEN
{
...
/// </summary>
 public clsvcc_WorkStuRelationENEx()
 {
 }
}
}