 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_WorkStuRelationTtlENEx
 表名:vcc_WorkStuRelationTtl(01120356)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/27 00:41:10
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvcc_WorkStuRelationTtlENEx : clsvcc_WorkStuRelationTtlEN
{
...
/// </summary>
 public clsvcc_WorkStuRelationTtlENEx()
 {
 }
}
}