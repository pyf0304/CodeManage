 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_ExamPaperQuestionTypeRelaENEx
 表名:vcc_ExamPaperQuestionTypeRela(01120238)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:52:43
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvcc_ExamPaperQuestionTypeRelaENEx : clsvcc_ExamPaperQuestionTypeRelaEN
{
...
/// </summary>
 public clsvcc_ExamPaperQuestionTypeRelaENEx()
 {
 }
}
}