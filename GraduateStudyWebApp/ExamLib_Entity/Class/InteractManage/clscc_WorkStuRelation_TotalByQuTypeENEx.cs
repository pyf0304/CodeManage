 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation_TotalByQuTypeENEx
 表名:cc_WorkStuRelation_TotalByQuType(01120354)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/26 15:21:02
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clscc_WorkStuRelation_TotalByQuTypeENEx : clscc_WorkStuRelation_TotalByQuTypeEN
{
...
/// </summary>
 public clscc_WorkStuRelation_TotalByQuTypeENEx()
 {
 }
}
}