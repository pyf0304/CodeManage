 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_ExamPaperStuBatchRelaENEx
 表名:vcc_ExamPaperStuBatchRela(01120242)
 生成代码版本:2021.06.19.1
 生成日期:2021/06/19 18:30:35
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvcc_ExamPaperStuBatchRelaENEx : clsvcc_ExamPaperStuBatchRelaEN
{
...
/// </summary>
 public clsvcc_ExamPaperStuBatchRelaENEx()
 {
 }
}
}