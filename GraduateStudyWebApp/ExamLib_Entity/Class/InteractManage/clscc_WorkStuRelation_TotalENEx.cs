 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation_TotalENEx
 表名:cc_WorkStuRelation_Total(01120167)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/26 15:16:16
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clscc_WorkStuRelation_TotalENEx : clscc_WorkStuRelation_TotalEN
{
...
/// </summary>
 public clscc_WorkStuRelation_TotalENEx()
 {
 }
}
}