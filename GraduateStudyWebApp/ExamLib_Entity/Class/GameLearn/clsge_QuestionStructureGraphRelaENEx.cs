 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_QuestionStructureGraphRelaENEx
 表名:ge_QuestionStructureGraphRela(01120906)
 生成代码版本:2021.03.27.2
 生成日期:2021/03/27 18:06:11
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsge_QuestionStructureGraphRelaENEx : clsge_QuestionStructureGraphRelaEN
{
...
/// </summary>
 public clsge_QuestionStructureGraphRelaENEx()
 {
 }
}
}