 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvzx_TotalDataStatisticsENEx
 表名:vzx_TotalDataStatistics(01120841)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:57:53
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvzx_TotalDataStatisticsENEx : clsvzx_TotalDataStatisticsEN
{
...
/// </summary>
 public clsvzx_TotalDataStatisticsENEx()
 {
 }
}
}