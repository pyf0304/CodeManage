 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvzx_SysScoreSummaryENEx
 表名:vzx_SysScoreSummary(01120838)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:56:20
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvzx_SysScoreSummaryENEx : clsvzx_SysScoreSummaryEN
{
...
/// </summary>
 public clsvzx_SysScoreSummaryENEx()
 {
 }
}
}