 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_ViewpointLikeLogENEx
 表名:zx_ViewpointLikeLog(01120858)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:58:02
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clszx_ViewpointLikeLogENEx : clszx_ViewpointLikeLogEN
{
...
/// </summary>
 public clszx_ViewpointLikeLogENEx()
 {
 }
}
}