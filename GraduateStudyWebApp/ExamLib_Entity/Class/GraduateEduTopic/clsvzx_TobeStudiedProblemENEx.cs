 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvzx_TobeStudiedProblemENEx
 表名:vzx_TobeStudiedProblem(01120840)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:56:49
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvzx_TobeStudiedProblemENEx : clsvzx_TobeStudiedProblemEN
{
...
/// </summary>
 public clsvzx_TobeStudiedProblemENEx()
 {
 }
}
}