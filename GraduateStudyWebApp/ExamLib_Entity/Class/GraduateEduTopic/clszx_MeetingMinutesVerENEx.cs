 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_MeetingMinutesVerENEx
 表名:zx_MeetingMinutesVer(01120800)
 * 版本:2023.01.12.1(服务器:WIN-SRV103-116)
 日期:2023/01/12 15:50:13
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clszx_MeetingMinutesVerENEx : clszx_MeetingMinutesVerEN
{
...
/// </summary>
 public clszx_MeetingMinutesVerENEx()
 {
 }
}
}