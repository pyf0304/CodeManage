 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_TobeStudiedProblemVerENEx
 表名:zx_TobeStudiedProblemVer(01120805)
 * 版本:2023.01.12.1(服务器:WIN-SRV103-116)
 日期:2023/01/12 15:28:42
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clszx_TobeStudiedProblemVerENEx : clszx_TobeStudiedProblemVerEN
{
...
/// </summary>
 public clszx_TobeStudiedProblemVerENEx()
 {
 }
}
}