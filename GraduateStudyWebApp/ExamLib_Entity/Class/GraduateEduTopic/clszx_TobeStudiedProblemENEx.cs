 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_TobeStudiedProblemENEx
 表名:zx_TobeStudiedProblem(01120804)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:56:52
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clszx_TobeStudiedProblemENEx : clszx_TobeStudiedProblemEN
{
...
/// </summary>
 public clszx_TobeStudiedProblemENEx()
 {
 }
}
}