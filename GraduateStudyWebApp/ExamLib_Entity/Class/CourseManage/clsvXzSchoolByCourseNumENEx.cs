 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvXzSchoolByCourseNumENEx
 表名:vXzSchoolByCourseNum(01120335)
 生成代码版本:2020.09.24.1
 生成日期:2020/09/28 12:17:23
 生成者:pyf2
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvXzSchoolByCourseNumENEx : clsvXzSchoolByCourseNumEN
{
...
/// </summary>
 public clsvXzSchoolByCourseNumENEx()
 {
 }
}
}