 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_SysOperationTypeENEx
 表名:zx_SysOperationType(01120824)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:59:23
 生成者:pyf
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clszx_SysOperationTypeENEx : clszx_SysOperationTypeEN
{
...
/// </summary>
 public clszx_SysOperationTypeENEx()
 {
 }
}
}