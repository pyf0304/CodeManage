 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQuestionStuFinishedStatusENEx
 表名:vQuestionStuFinishedStatus(01120218)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:50:56
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvQuestionStuFinishedStatusENEx : clsvQuestionStuFinishedStatusEN
{
...
/// </summary>
 public clsvQuestionStuFinishedStatusENEx()
 {
 }
}
}