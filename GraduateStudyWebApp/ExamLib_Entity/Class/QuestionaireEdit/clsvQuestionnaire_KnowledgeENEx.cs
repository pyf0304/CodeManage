 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQuestionnaire_KnowledgeENEx
 表名:vQuestionnaire_Knowledge(01120143)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:51:14
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvQuestionnaire_KnowledgeENEx : clsvQuestionnaire_KnowledgeEN
{
...
/// </summary>
 public clsvQuestionnaire_KnowledgeENEx()
 {
 }
}
}