 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQuestionnaire_AnswerENEx
 表名:vQuestionnaire_Answer(01120020)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:51:21
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvQuestionnaire_AnswerENEx : clsvQuestionnaire_AnswerEN
{
...
/// </summary>
 public clsvQuestionnaire_AnswerENEx()
 {
 }
}
}