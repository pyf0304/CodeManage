 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvtz_ContentAttachmentENEx
 表名:vtz_ContentAttachment(01120208)
 生成代码版本:2020.05.28.1
 生成日期:2020/06/02 14:44:14
 生成者:
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvtz_ContentAttachmentENEx : clsvtz_ContentAttachmentEN
{
...
/// </summary>
 public clsvtz_ContentAttachmentENEx()
 {
 }
}
}