 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCaseSenateClassENEx
 表名:PubClassCaseSenateClass(01120509)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:31:40
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsPubClassCaseSenateClassENEx : clsPubClassCaseSenateClassEN
{
...
/// </summary>
 public clsPubClassCaseSenateClassENEx()
 {
 }
}
}