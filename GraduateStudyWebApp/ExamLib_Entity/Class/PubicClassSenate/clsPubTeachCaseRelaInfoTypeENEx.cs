 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubTeachCaseRelaInfoTypeENEx
 表名:PubTeachCaseRelaInfoType(01120510)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:32:00
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsPubTeachCaseRelaInfoTypeENEx : clsPubTeachCaseRelaInfoTypeEN
{
...
/// </summary>
 public clsPubTeachCaseRelaInfoTypeENEx()
 {
 }
}
}