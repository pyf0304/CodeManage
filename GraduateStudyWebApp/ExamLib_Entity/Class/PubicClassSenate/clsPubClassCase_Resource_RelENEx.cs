 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCase_Resource_RelENEx
 表名:PubClassCase_Resource_Rel(01120408)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:31:16
 生成者:yy
...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsPubClassCase_Resource_RelENEx : clsPubClassCase_Resource_RelEN
{
...
/// </summary>
 public clsPubClassCase_Resource_RelENEx()
 {
 }
}
}