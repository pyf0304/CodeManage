(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../GraduateEduPublicPage/Public_Concept.js", "../GraduateEduPublicPage/Public_SysSkill.js", "../GraduateEduPublicPage/Public_SysSocialRelations.js", "../GraduateEduPublicPage/Public_TopicObjective.js", "../GraduateEduPublicPage/Public_Viewpoint.js", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperReadWriteEN.js", "../TS/L0_Entity/GraduateEduTools/clsSysCommentEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperReadWriteWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsvSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvgs_PaperReportWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchResultWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_AnswerWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsSysCommentExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsSysPara4WebApi2.js"], factory);
    }
    ...
    */
     ...
     */
        async SubmitAppraise_Click() {
            ...
            objSysCommentEN.pubParentId = $("#hidPubParentId").val();
            objSysCommentEN.userId = $("#hidUser").val(); //被评论用户
            ...
            if (strvalue != "" && strvalue != undefined) {
                ...
                if ($("#txtAppraiseContent").val() != "") {
                    ...
                    objSysCommentEN.score = parseFloat(strScore); // 打分
                    objSysCommentEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
                    objSysCommentEN.updUser = strUserId; // 修改用户Id
                    try {
        ...
        async SynStatistics() {
            ...
            if (strCommentTypeId == "02") {
                ...
                if (strRoleId != "00620003") {
                    ...
                    if (returnBool == true) {
                        //刷新缓存
                        (0, clsvPaperReadWriteWApi_js_1.vPaperReadWrite_ReFreshThisCache)(clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls());
