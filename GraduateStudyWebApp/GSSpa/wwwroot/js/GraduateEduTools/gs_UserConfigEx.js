(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/ExamManage/clsgs_UserConfigEN.js", "../TS/L3_ForWApi/ExamManage/clsgs_UserConfigWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsvgs_UserConfigWApi.js", "../TS/L3_ForWApi/ParameterTable/clsgs_ShareWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/ExamManage/clsgs_UserConfigExWApi.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
    ...
    */
    ...
    const clsvgs_UserConfigWApi_js_1 = require("../TS/L3_ForWApi/GraduateEduTools/clsvgs_UserConfigWApi.js");
    ...
    */
    class gs_UserConfigEx extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        ...
        async SelectConfigAddSave() {
            try {
                const responseText2 = await (0, clsgs_UserConfigExWApi_js_1.gs_UserConfigEx_GetAddConfig)(clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId());
     ...
     */
        Combinevgs_UserConfig() {
            ...
            try {
                ...
                if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_RoleId() == "00620003") {
                    ...
                    //管理员 教师 
                    //strWhereCond += ` And ${clsvgs_UserConfigEN.con_ con_id_CurrEduCls} = '${clsPublocalStorage.Getid_CurrEduCls()}'`;
                }
       ...
       */
        async BindGv_gs_UserConfig() {
            var strWhereCond = this.Combinevgs_UserConfig();
        ...
        async BtnShardName_Click(strkey, strShardId) {
            ...
            if (objgs_UserConfigEN != null) {
                ...
                objgs_UserConfigUpdEN.shareId = strShardId;
