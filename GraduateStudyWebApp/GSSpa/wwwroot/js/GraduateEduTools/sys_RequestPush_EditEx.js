(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./sys_RequestPush_Edit.js"], factory);
    }
    ...
    */
    ...
    //import * as QQ from "q";
    const sys_RequestPush_Edit_js_1 = require("./sys_RequestPush_Edit.js");
        ...
        static btnEdit_Click(strCommandName, strKeyId) {
            ...
            switch (strCommandName) {
                ...
                case "Submit": //提交
                    ...
                    break;
                default:
                    var strMsg = '命令:' + strCommandName + "在函数(sys_RequestPush_EditExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
