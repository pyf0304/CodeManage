(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsDropDownList.js", "../TS/L0_Entity/DailyRunning/clsvCurrEduClsStuEN.js", "../TS/L0_Entity/GraduateEduTools/clsgs_AnswerCountEN.js", "../TS/L0_Entity/GraduateEduTools/clsSysCommentEN.js", "../TS/L0_Entity/GraduateEduTools/clsvgs_TotalDataStatisticsEN.js", "../TS/L0_Entity/UserManage/clsvUsersSimEN.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_AnswerCountWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TotalDataTypeWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsvgs_TotalDataStatisticsWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsSysCommentExWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_AnswerCountExWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsvgs_TotalDataStatisticsExWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "./gs_TeachingDate_EditEx.js"], factory);
    }
        ...
        async Page_Load() {
            ...
            try {
                if (clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls() != "") {
                    ...
                    await (0, clsgs_TotalDataTypeWApi_js_1.gs_TotalDataType_BindDdl_TotalDataTypeIdInDiv_Cache)("", "ddlTotalDataTypeId_q");
    ...
    */
        ...
        async BindGv_UserNumTable() {
            var strid_CurrEdu = "";
            var strWhereCond = this.CombineCondition1(strid_CurrEdu);
            //周合集、观点合集
    ...
    */
        ...
        async BindChart_TeaClassComment(strid_CurrEdu, Number, strUserIdorCurrEduClsId) {
            //var strWhereCond = this.CombineCondition3();
        ...
        async BindChart_UserCommentNum(strid_CurrEdu, Number, strUserIdorCurrEduClsId) {
            //var strWhereCond = this.CombineCondition3(strid_CurrEdu);
            var objclsSysComment_Cond = this.CombineConditionObj3(strid_CurrEdu);
            var strWhereCond = JSON.stringify(objclsSysComment_Cond);
            ...
            try {
                //var strWhereCond2 = " id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "' order by stuName Asc";
        ...
        async BindChart_UserDiscussNum(strid_CurrEdu, Number, strUserIdorCurrEduClsId) {
            var strWhereCond = this.CombineCondition1(strid_CurrEdu);
            //var strWhereCond = this.CombineConditionObj1(strid_CurrEdu);
            var strId_CurrEduCls = "";
            if (strid_CurrEdu == "") {
                strId_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
            }
        ...
        async BindGv_UserDiscussNumTable() {
            var strId_CurrEduCls = "";
            var strWhereCond = this.CombineCondition1(strId_CurrEduCls);
            var arrgs_AnswerCountUserNum = [];
