(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTools/clsgs_TotalDataStatisticsEN.js", "../TS/L0_Entity/GraduateEduTools/clsgs_TotalDataTypeEN.js", "../TS/L0_Entity/GraduateEduTools/clsvSysScoreSummaryEN.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TotalDataStatisticsWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TotalDataTypeWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsvSysScoreSummaryWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
    ...
    */
    class TotalDataStatisticsDetail extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        ...
        async Page_Load() {
            ...
            try {
                ...
                if (clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls() != "" || strId_CurrEduCls != "") {
                    var strId_CurrEduCls = $("#hidId_CurrEduClspara").val();
                    if (strId_CurrEduCls != "") {
                        $("#topTitle").hide();
                    }
    ...
    */
      ...
      */
        async BindGv_vSysScoreSummary() {
            ...
            if (hidId_CurrEduCls == "") {
                hidId_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
            }
     ...
     */
        Combinegs_TotalDetailCondition() {
            ...
            try {
                ...
                var strUserId = $("#hidUserId").val();
                if (strUserId == "") {
                    strWhereCond += " and dataUser ='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "'";
                }
                else {
                    //获取当前用户自己数据
        ...
        Combinegs_TotalConditionDetailObj() {
            ...
            try {
                ...
                if (strUserId == "") {
                    ...
                    var strSessionUserId = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId();
