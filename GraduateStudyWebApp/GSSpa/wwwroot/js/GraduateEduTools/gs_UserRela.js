(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsTeacherWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_UserRelaPositionWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_UserRelaWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_UserRelaExWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_UserRelaPositionExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
    ...
    class gs_UserRela {
        ...
        async btnSaveUserRela_Click(strUserRelax_y, strid_CurrEdu) {
            ...
            for (var i = 0; i < strUserRelax_y.length; i++) {
                ...
                var updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
        ...
        DelRecord() {
            return new Promise((resolve, reject) => {
                try {
                    var strWhere = " id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls() + "' and updUser='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "'";
