(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./gs_TeachingDate_Edit.js", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduTools/clsgs_TeachingDateEN.js", "../TS/L0_Entity/GraduateEduTools/clsvgs_TeachingDateEN.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsSysCommentExWApi.js"], factory);
    }
    ...
    */
    ...
    //import * as QQ from "q";
    const gs_TeachingDate_Edit_js_1 = require("./gs_TeachingDate_Edit.js");
                            ...
                            if (this.OpType == "AddWithMaxId") {
                                ...
                                const responseText2 = await this.AddNewRecordSave().then((jsonData) => {
                                    ...
                                    if (returnBool == true) {
                                        ...
                                        if (returnBool3 == true) {
                                            const responseText5 = (0, clsSysCommentExWApi_js_1.SysCommentEx_UpdateCommentWeekAsync)(strId_CurrEduCls, clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId());
    ...
    */
      ...
      */
        PutDataTogs_TeachingDateClass(pobjgs_TeachingDateEN) {
            ...
            pobjgs_TeachingDateEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate_ymd(); // 修改日期
            pobjgs_TeachingDateEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId();
