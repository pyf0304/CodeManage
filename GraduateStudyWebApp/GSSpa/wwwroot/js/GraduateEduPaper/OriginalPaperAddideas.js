(function (factory) {
    ...
    */
    class OriginalPaperAddideas extends clsOperateList2_js_1.clsOperateList {
        constructor() {
       ...
       */
        ...
        async GetPaperData() {
            ...
            var arrvPaperObjLst = [];
            objvPaper_Cond.SetCondFldValue(clsvPaperEN_js_1.clsvPaperEN.con_PaperId, strPaperId, "=");
            arrvPaperObjLst = await (0, clsvPaperExWApi_js_1.vPaperEx_GetSubObjLstById_CurrEduCls_Cache)(objvPaper_Cond, strid_CurrEducls);
            var arrvUsersObjLst = await (0, clsvUsersSimWApi_js_1.vUsersSim_GetObjLst_Cache)();
            var strhtml = "";
            ...
            try {
                ...
                for (var i = 0; i < arrvPaperObjLst.length; i++) {
                    ...
                    var objUser = arrvUsersObjLst.find(x => x.userId == arrvPaperObjLst[i].updUser);
                    if (objUser != null) {
     ...
     */
      ...
      */
        async BindGv_vRTExpegs_PViewpointRela() {
            ...
            var strWhereCond = this.CombinevRTExpegs_PViewpointRelaCondition();
            var intCurrPageIndex = this.CurrPageIndexViewpoint; //获取当前页
            var arrvgs_PViewpointRelaObjLst = [];
            try {
                const responseRecCount = await (0, clsvgs_PViewpointRelaWApi_js_1.vgs_PViewpointRela_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
    ...
    */
        //public BindTab_vRTExpegs_PViewpointRela(divContainer: string, arrvgs_PViewpointRelaObjLst: Array<clsvgs_PViewpointRelaEN>) {
        ...
        //            },
        //        ];
        //    clsCommonFunc4Web.BindTabV2Where(o, arrvgs_PViewpointRelaObjLst, arrDataColumn, "mId", "TopicRTExpertViewpoint");
        //    //clsCommonFunc4Web.BindTabV2(o, arrvgs_PViewpointRelaObjLst, arrDataColumn, "mId");
        //    if (this.RecCount > 10) {
     ...
     */
      ...
      */
        async BindGv_vgs_PViewpointRela() {
            ...
            var strWhereCond = this.Combinevgs_PViewpointRelaCondition();
            var intCurrPageIndex = this.CurrPageIndexViewpoint; //获取当前页
            var arrvgs_PViewpointRelaObjLst = [];
            try {
                const responseRecCount = await (0, clsvgs_PViewpointRelaWApi_js_1.vgs_PViewpointRela_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
        ...
        //public BindTab_vgs_PViewpointRela(divContainer: string, arrvgs_PViewpointRelaObjLst: Array<clsvgs_PViewpointRelaEN>) {
        //    var o: HTMLDivElement = document.getElementById(divContainer) as HTMLDivElement;
        //    if (o == null) {
        //        alert(`${divContainer}不存在！`);
        //        return;
        ...
        //            },
        //        ];
        //    clsCommonFunc4Web.BindTabV2Where(o, arrvgs_PViewpointRelaObjLst, arrDataColumn, "mId", "TopicRTViewpoint");
        //    //clsCommonFunc4Web.BindTabV2(o, arrvgs_PViewpointRelaObjLst, arrDataColumn, "mId");
        //    if (this.RecCount > 10) {
        //        this.objPager.RecCount = this.RecCount;
        //        this.objPager.pageSize = this.pageSize;
    ...
    */
     ...
     */
      ...
      */
        CombinevViewpointCondition() {
            ...
            //例如 1 = 1 && userName = '张三'
            var strWhereCond = " 1 = 1 ";
            var strPaperId = $('#hidTopicRelaId').val();
     ...
     */
        PutDataTogs_PViewpointRelaClass(pobjgs_PViewpointRelaEN) {
            ...
            var strViewpointId = $("#hidViewpointId").val();
            var strUserId = $("#hidUserId").val();
            pobjgs_PViewpointRelaEN.paperId = strPaperId; // 主题编号
            pobjgs_PViewpointRelaEN.sectionId = $("#ddlSectionId1").val(); // 主题编号
            pobjgs_PViewpointRelaEN.viewpointId = strViewpointId; // 观点Id
            pobjgs_PViewpointRelaEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            pobjgs_PViewpointRelaEN.updUser = strUserId; // 修改用户Id// 修改用户Id
            //pobjgs_PViewpointRelaEN.memo = this.memo;// 备注
        }
        //   /*
        //* 获取当前时间
        //*/
    ...
    */
        async BindGv_vgs_PConceptRela() {
            ...
            var strWhereCond = this.Combinevgs_PConceptRelaCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            var arrvgs_PConceptRelaObjLst = [];
            try {
                const responseRecCount = await (0, clsvgs_PConceptRelaWApi_js_1.vgs_PConceptRela_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                    this.RecCount = jsonData;
                });
                var objPagerPara = {
                    pageIndex: intCurrPageIndex,
    ...
    */
        async BindGv_vgs_PTopicObjectiveRela() {
            ...
            var strWhereCond = this.Combinevgs_PTopicObjectiveRelaCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            var arrvgs_PTopicObjectiveRelaObjLst = [];
            try {
                const responseRecCount = await (0, clsvgs_PTopicObjectiveRelaWApi_js_1.vgs_PTopicObjectiveRela_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                    this.RecCount = jsonData;
                });
                var objPagerPara = {
                    pageIndex: intCurrPageIndex,
    ...
    */
        async BindGv_vgs_PSkillRela() {
            ...
            var strWhereCond = this.Combinevgs_PSkillRelaCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            var arrvgs_PSkillRelaObjLst = [];
            //var arrvUsersObjLst: Array<clsvUsersSimEN> = [];
            try {
                const responseRecCount = await (0, clsvgs_PSkillRelaWApi_js_1.vgs_PSkillRela_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                    this.RecCount = jsonData;
                });
                var objPagerPara = {
                    pageIndex: intCurrPageIndex,
    ...
    */
        BindTab_vgs_PSkillRela(arrvgs_PSkillRelaObjLst, arrvUsersObjLst) {
            var strhtml = "";
    ...
    */
        async BindGv_vgs_PSocialRela() {
            ...
            var strWhereCond = this.Combinevgs_PSocialRelaCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            var arrvgs_PSocialRelaObjLst = [];
            //var arrvUsersObjLst: Array<clsvUsersSimEN> = [];
            try {
                const responseRecCount = await (0, clsvgs_PSocialRelaWApi_js_1.vgs_PSocialRela_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                    this.RecCount = jsonData;
                });
                var objPagerPara = {
                    pageIndex: intCurrPageIndex,
        ...
        //public BindTab_vgs_PSocialRela(arrvgs_PSocialRelaObjLst: Array<clsvgs_PSocialRelaEN>, arrvUsersObjLst: Array<clsvUsersSimEN>) {
        //    var strhtml = "";
