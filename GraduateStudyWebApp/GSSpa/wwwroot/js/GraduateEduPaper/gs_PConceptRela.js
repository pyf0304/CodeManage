(function (factory) {
    ...
    */
    class gs_PConceptRela extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
            //论文列表
    ...
    */
       ...
       */
        BindTab_Concept(divContainer, arrConceptObjLst) {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindTabV2Where(o, arrConceptObjLst, arrDataColumn, "conceptId", "TopicConcept");
    ...
    */
       ...
       */
        PutDataTogs_PConcepRelaClass(pobjgs_PConcepRelaEN) {
            ...
            var strConceptId = $("#hidConceptId").val();
            var strUserId = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId();
            pobjgs_PConcepRelaEN.paperId = strPaperId; // 主题编号
            pobjgs_PConcepRelaEN.sectionId = $("#ddlSectionId2").val(); // 主题编号
            pobjgs_PConcepRelaEN.conceptId = strConceptId; // 概念Id
            pobjgs_PConcepRelaEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            pobjgs_PConcepRelaEN.updUser = strUserId; // 修改用户Id
            pobjgs_PConcepRelaEN.memo = this.memo; // 备注
        }
        /* 概念
      */
