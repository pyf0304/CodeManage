(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L3_ForWApi/GraduateEduPaper/clsAcademicJournalsWApi.js", "../TS/L3_ForWApiEx/GraduateEduPaper/clsAcademicJournalsExWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsString2.js", "./AcademicJournalsCRUD.js", "./AcademicJournals_EditEx.js"], factory);
    }
    ...
    */
    ...
    const AcademicJournalsCRUD_js_1 = require("./AcademicJournalsCRUD.js");
       ...
       */
        ...
        */
        static btn_Click(strCommandName, strKeyId) {
            var objPage = new AcademicJournalsCRUDEx();
            var objPage_Edit = new AcademicJournals_EditEx_js_1.AcademicJournals_EditEx(objPage);
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    var strMsg = '命令:' + strCommandName + "在函数(AcademicJournalsCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
        ...
        async btnImportData_Click() {
            //$("#divImportExcel").css("display", "block");
            //$("#divImportExcel").css("display", "none");
            //AcademicJournals.clsAcademicJournalsExWApi.ImportDataFromCsv(csv, strUserId);
            ...
            try {
                const responseText = await clsAcademicJournalsExWApi_js_1.clsAcademicJournalsExWApi.ImportDataFromCsv(strCsv1, strUserId);
