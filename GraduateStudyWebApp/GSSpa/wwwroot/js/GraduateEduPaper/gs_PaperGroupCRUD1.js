(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduPaper/clsgs_PaperGroupEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsString2.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gs_PaperGroupCRUD1 = void 0;
    /**
    * 类名:gs_PaperGroupCRUD1(界面:gs_PaperGroupCRUD1)
    * 表名:gs_PaperGroup(01120749)
    * 生成代码版本:2021.10.18.1
    * 生成日期:2021/10/22 11:45:56
    * 生成者:
    * 工程名称:问卷调查
    * 工程ID:0112
    ...
    **/
    ...
    /** gs_PaperGroupCRUD1 的摘要说明。其中Q代表查询,U代表修改
    * (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:GeneCode)
    **/
    class gs_PaperGroupCRUD1 extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super();
            ...
            this.RecCount = 0;
            gs_PaperGroupCRUD1.objPage_CRUD = this;
        }
        /**
        * 每页记录数，在扩展类可以修改
        **/
        ...
        **/
        async ExportExcel_gs_PaperGroup_Cache() {
            ...
            objgs_PaperGroup_Cond.SetCondFldValue(clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_UpdUser, gs_PaperGroupCRUD1.strUpdUser_Cache, "=");
            const strWhereCond = JSON.stringify(objgs_PaperGroup_Cond);
            const intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            let arrgs_PaperGroupObjLst = [];
            try {
                this.RecCount = await (0, clsgs_PaperGroupWApi_js_1.gs_PaperGroup_GetRecCountByCond_Cache)(objgs_PaperGroup_Cond, gs_PaperGroupCRUD1.strUpdUser_Cache);
                if (this.RecCount == 0) {
                    const lblMsg = document.createElement("span");
                ...
                arrgs_PaperGroupObjLst = await (0, clsgs_PaperGroupWApi_js_1.gs_PaperGroup_GetSubObjLst_Cache)(objgs_PaperGroup_Cond, gs_PaperGroupCRUD1.strUpdUser_Cache);
            }
            catch (e) {
                const strMsg = clsString2_js_1.clsString.Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            if (arrgs_PaperGroupObjLst.length == 0) {
                const strKey = clsString2_js_1.clsString.Format("{0}_{1}", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN._CurrTabName, gs_PaperGroupCRUD1.strUpdUser_Cache);
        ...
        **/
        async BindGv_gs_PaperGroup_Cache() {
            ...
            try {
                ...
                arrgs_PaperGroupObjLst = await (0, clsgs_PaperGroupWApi_js_1.gs_PaperGroup_GetObjLstByPager_Cache)(objPagerPara, gs_PaperGroupCRUD1.strUpdUser_Cache);
            }
            catch (e) {
                const strMsg = clsString2_js_1.clsString.Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
    ...
    exports.gs_PaperGroupCRUD1 = gs_PaperGroupCRUD1;
    gs_PaperGroupCRUD1.strUpdUser_Cache = "99999999999999999991"; //缓存分类字段
});
