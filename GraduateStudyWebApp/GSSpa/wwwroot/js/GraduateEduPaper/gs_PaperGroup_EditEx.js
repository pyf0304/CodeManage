(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./gs_PaperGroup_Edit.js"], factory);
    }
    ...
    **/
    ...
    //import * as QQ from "q";
    const gs_PaperGroup_Edit_js_1 = require("./gs_PaperGroup_Edit.js");
        ...
        static btnEdit_Click(strCommandName, strKeyId) {
            ...
            switch (strCommandName) {
                case "Submit": //提交
                    ...
                    break;
                default:
                    var strMsg = '命令:' + strCommandName + "在函数(gs_PaperGroup_EditExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
