(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/DailyRunning/clsCurrEduClsStuEN.js", "../TS/L0_Entity/UserManage/clsStudentInfoEN.js", "../TS/L0_Entity/UserManage/clsvStudentInfoEN.js", "../TS/L3_ForWApi/DailyRunning/clsCurrEduClsStuWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsPager.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsOperateList2.js", "../TS/L3_ForWApi/UserManage/clsStudentInfoWApi.js", "../TS/L3_ForWApi/UserManage/clsvStudentInfoWApi.js"], factory);
    }
    ...
    */
    ...
    const clsvStudentInfoEN_js_1 = require("../TS/L0_Entity/UserManage/clsvStudentInfoEN.js");
    ...
    const clsvStudentInfoWApi_js_1 = require("../TS/L3_ForWApi/UserManage/clsvStudentInfoWApi.js");
    /* StudentInfoCRUD 的摘要说明。其中Q代表查询,U代表修改
     (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:GeneCode)
    */
    class StudentInfoList extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        async SelectRecord(strid_StudentInfo) {
            try {
                ...
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.Redirect("/Index/Main_vStudentInfo");
            }
            catch (e) {
                console.error(e);
       ...
       */
        ...
        (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj)
         <returns>条件串(strWhereCond)</returns>
       */
        CombinevStudentInfoConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && userName = '张三'
            var strWhereCond = " 1 = 1 ";
       ...
       */
        BindTab_vStudentInfo(divContainer, arrvStudentInfoObjLst) {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindTabV2(o, arrvStudentInfoObjLst, arrDataColumn, "id_StudentInfo");
    ...
    */
       ...
       */
        ShowStudentInfoObj(divContainer, objStudentInfo) {
            ...
            var sstrKeys = clsCommonFunc4Web2_js_1.clsCommonFunc4Web.GetObjKeys(objStudentInfo);
