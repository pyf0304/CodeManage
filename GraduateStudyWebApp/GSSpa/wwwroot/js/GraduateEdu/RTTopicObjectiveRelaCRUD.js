...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTopic/clsRTTopicObjectiveRelaEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvRTTopicObjectiveRelaEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvRTTopicObjectiveRelaWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsString2.js"], factory);
    }
    ...
    */
    class RTTopicObjectiveRelaCRUD extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super();
       ...
       */
        CombineData(arrvRTTopicObjectiveRelaObjLst, arrDataColumn) {
            ...
            for (var i = 0; i < intRowNum; i++) {
                ...
                var objEN = arrvRTTopicObjectiveRelaObjLst[i];
                for (var j = 0; j < intColNum; j++) {
            ...
            var strFileName = clsString2_js_1.clsString.Format("主题客观关系表({0})导出.xlsx", clsvRTTopicObjectiveRelaEN_js_1.clsvRTTopicObjectiveRelaEN._CurrTabName);
       ...
       */
        async ExportExcel_vRTTopicObjectiveRela_Cache() {
            ...
            try {
                this.RecCount = await (0, clsvRTTopicObjectiveRelaWApi_js_1.vRTTopicObjectiveRela_GetRecCountByCond_Cache)(objvRTTopicObjectiveRela_Cond);
                if (this.RecCount == 0) {
                    var lblMsg = document.createElement("span");
                    lblMsg.innerHTML = clsString2_js_1.clsString.Format("根据条件:[{0}]获取的对象列表数为0！", objvRTTopicObjectiveRela_Cond.whereCond);
                    var divDataLst = document.getElementById("divDataLst");
                    if (divDataLst != null) {
                        divDataLst.innerText = "";
                        divDataLst.appendChild(lblMsg);
                    }
                    var strMsg = `在绑定Gv_Cache过程中，根据条件:[${objvRTTopicObjectiveRela_Cond.whereCond}]获取的对象列表数为0！`;
                    console.error("Error: ", strMsg);
                    //console.trace();
                    alert(strMsg);
                    return;
                }
                var arrvRTTopicObjectiveRelaObjLst = await (0, clsvRTTopicObjectiveRelaWApi_js_1.vRTTopicObjectiveRela_GetSubObjLst_Cache)(objvRTTopicObjectiveRela_Cond);
            }
            catch (e) {
            ...
            if (arrvRTTopicObjectiveRelaObjLst.length == 0) {
                var strKey = `${clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN._CurrTabName}`;
       ...
       */
        async ExportExcel_vRTTopicObjectiveRela() {
            ...
            try {
                ...
                var arrvRTTopicObjectiveRelaObjLst = await (0, clsvRTTopicObjectiveRelaWApi_js_1.vRTTopicObjectiveRela_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
                var strMsg = `绑定GridView不成功,${e}.`;
                console.error(strMsg);
       ...
       */
        async DelRecord(lngmId) {
            try {
                ...
                if (returnInt > 0) {
                    (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_ReFreshCache)();
       ...
       */
        async SelectRecord(lngmId) {
            try {
                const responseText = await (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_GetObjBymIdAsync)(lngmId);
                var objRTTopicObjectiveRelaEN = responseText;
                console.log("完成SelectRecord!");
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.Redirect("/Index/Main_vRTTopicObjectiveRela");
            }
            catch (e) {
       ...
       */
        CombinevRTTopicObjectiveRelaCondition() {
            ...
            try {
                ...
                var strMsg = `(errid:WiTsCs0009)在组合查询条件(CombineRTTopicObjectiveRelaCondition)时出错!请联系管理员!${objException}`;
                throw strMsg;
            }
            return strWhereCond;
        }
        ...
        (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj)
         <returns>条件串(strWhereCond)</returns>
       */
        CombinevRTTopicObjectiveRelaConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && userName = '张三'
            var strWhereCond = " 1 = 1 ";
            var objvRTTopicObjectiveRela_Cond = new clsvRTTopicObjectiveRelaEN_js_1.clsvRTTopicObjectiveRelaEN();
            //如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
            try {
                if (this.ObjectiveName_q != "") {
                    strWhereCond += ` And ${clsvRTTopicObjectiveRelaEN_js_1.clsvRTTopicObjectiveRelaEN.con_ObjectiveName} like '% ${this.ObjectiveName_q}%'`;
                ...
                var strMsg = `(errid:WiTsCs0010)在组合查询条件对象(CombineRTTopicObjectiveRelaConditionObj)时出错!请联系管理员!${objException}`;
                throw strMsg;
            }
        ...
        (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj4ExportExcel)
         <returns>条件串(strWhereCond)</returns>
       */
        CombinevRTTopicObjectiveRelaConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && userName = '张三'
            var strWhereCond = " 1 = 1 ";
            var objvRTTopicObjectiveRela_Cond = new clsvRTTopicObjectiveRelaEN_js_1.clsvRTTopicObjectiveRelaEN();
            ...
            try {
                ...
                var strMsg = `(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTTopicObjectiveRelaConditionObj4ExportExcel)时出错!请联系管理员!${objException}`;
                throw strMsg;
            }
            objvRTTopicObjectiveRela_Cond.whereCond = strWhereCond;
            return objvRTTopicObjectiveRela_Cond;
       ...
       */
        BindTab_vRTTopicObjectiveRela(divContainer, arrvRTTopicObjectiveRelaObjLst) {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindTabV4(o, arrvRTTopicObjectiveRelaObjLst, arrDataColumn, "mId", this);
        ...
        async BindGv_vRTTopicObjectiveRela_Cache() {
            ...
            try {
                ...
                var objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: this.hidSortvRTTopicObjectiveRelaBy,
                    sortFun: clsvRTTopicObjectiveRelaWApi_js_1.vRTTopicObjectiveRela_SortFun_Defa
                };
                var arrvRTTopicObjectiveRelaObjLst = await (0, clsvRTTopicObjectiveRelaWApi_js_1.vRTTopicObjectiveRela_GetObjLstByPager_Cache)(objPagerPara);
            }
            catch (e) {
                var strMsg = `绑定GridView不成功,${e}.`;
                console.error(strMsg);
       ...
       */
        async CopyRecord(arrmId) {
            try {
                const responseText = await (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_GetObjLstBymIdLstAsync)(arrmId);
                console.log('responseText=');
                console.log(responseText);
                var intCount = 0;
                var arrRTTopicObjectiveRelaObjLst = responseText;
                for (let objInFor of arrRTTopicObjectiveRelaObjLst) {
                    const responseText2 = await (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_AddNewRecordAsync)(objInFor);
       ...
       */
        async DelMultiRecord(arrmId) {
            try {
                const responseText = await (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_DelRTTopicObjectiveRelasAsync)(arrmId);
                var returnInt = responseText;
                if (returnInt > 0) {
                    (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_ReFreshCache)();
                    var strInfo = `删除记录成功,共删除${returnInt}条记录!`;
       ...
       */
        ShowRTTopicObjectiveRelaObj(divContainer, objRTTopicObjectiveRela) {
            ...
            var sstrKeys = clsCommonFunc4Web2_js_1.clsCommonFunc4Web.GetObjKeys(objRTTopicObjectiveRela);
       ...
       */
        get ObjectiveName_q() {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.CheckControlExist(this.divName4Query, "input", "txtObjectiveName_q");
       ...
       */
        get TopicName_q() {
            var objDiv = $(`#${this.divName4Query}`);
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.CheckControlExist(this.divName4Query, "input", "txtTopicName_q");
