...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "jquery", "../../L0_Entity/Knowledges/clsgs_KnowledgesLogicRelaEN.js", "../../L0_Entity/Knowledges/clsgs_KnowledgesLogicRelaENEx.js", "../../L3_ForWApi/Knowledges/clsgs_KnowledgesLogicRelaWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubFun/clsSysPara4WebApi.js"], factory);
    }
    ...
    */
    async function gs_KnowledgesLogicRelaEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrgs_KnowledgesLogicRelaExObjLst = await (0, clsgs_KnowledgesLogicRelaWApi_js_1.gs_KnowledgesLogicRela_GetObjLstAsync)(objPagerPara.whereCond);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrgs_KnowledgesLogicRelaExObjLst) {
                const conFuncMap = await gs_KnowledgesLogicRelaEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
