...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "jquery", "../../PubFun/clsCommonFunc4Web2.js", "../../L0_Entity/UserManage/clsUsersEN.js", "../../PubFun/tzDictionary.js", "../../PubFun/clsSysPara4WebApi2.js", "../../PubFun/stuTopPara.js", "../../PubFun/stuRangePara.js", "../../PubFun/stuPagerPara.js", "../../PubFun/clsStackTrace.js", "../../PubFun/CacheHelper.js", "../../PubFun/tzPubFun.js", "../../PubFun/jsString.js", "../../L3_ForWApi/UserManage/clsUsersWApi.js", "../../L3_ForWApi/UserManage/clsvUsersWApi.js"], factory);
    }
    ...
    */
    ...
    class clsUsersWApiEx {
        ...
        /// <returns>对象</returns>
        static GetObjByUserIdAsync(strUserId) {
        ...
        /// <param name = "strUserId">关键字</param>
        /// <returns>对象</returns>
        static GetObjByUserId_WA_CacheAsync(strUserId) {
        ...
        static GetFirstIDAsync(strWhereCond) {
        ...
        static GetFirstObjAsync(strWhereCond) {
        ...
        static GetObjLstAsync(strWhereCond) {
        ...
        /// <param name = "strWhereCond">条件</param>
        /// <returns>获取的相应对象列表</returns>
        static GetObjLst_WA_CacheAsync() {
        ...
        static GetObjLstByUserIdLstAsync(arrUserId) {
        ...
        /// <param name = "arrUserId">关键字列表</param>
        /// <returns>对象列表</returns>
        static GetObjLstByUserIdLst_WA_CacheAsync(arrUserId) {
        ...
        /// <returns>获取的相应对象列表</returns>
        static GetTopObjLstAsync(objTopPara) {
        ...
        static GetObjLstByRangeAsync(objRangePara) {
        ...
        /// <returns>获取的相应记录对象列表</returns>
        static GetObjLstByPager_WA_CacheAsync(objPagerPara) {
        ...
        /// <param name = "objPagerPara">分页获取对象列表的参数对象</param>
        /// <returns>获取的相应记录对象列表</returns>
        static GetObjLstByPagerAsync(objPagerPara) {
        ...
        static DelRecordAsync(strUserId) {
        ...
        static DelUserssAsync(arrUserId) {
        ...
        /// </summary>
        /// <returns>实际删除记录的个数</returns>
        static DelUserssByCondAsync(strWhereCond) {
        ...
        static AddNewRecordAsync(objUsersEN) {
            var strMsg = "";
        ...
        /// <param name = "objUsersEN">需要添加的对象</param>
        /// <returns>获取相应的记录的对象</returns>
        static AddNewRecordWithMaxIdAsync(objUsersEN) {
            var strMsg = "";
        ...
        static AddNewRecordWithReturnKeyAsync(objUsersEN) {
        ...
        static UpdateRecordAsync(objUsersEN) {
            var strMsg = "";
        ...
        /// <returns>返回的第一条记录的关键字值</returns>
        static UpdateWithConditionAsync(objUsersEN, strWhereCond) {
        ...
        static IsExistRecordAsync(strWhereCond) {
        ...
        static GetRecCountByCondAsync(strWhereCond) {
        ...
        static GetMaxStrIdByPrefixAsync(strPrefix) {
        ...
        async BindDdl_UserId_Cache2(strDdlName, objUsers_Cond) {
            ...
            try {
                ...
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsUsersEN_js_1.clsUsersEN.con_UserId, clsUsersEN_js_1.clsUsersEN.con_UserName, "用户");
        ...
        static ReFreshThisCache() {
            ...
            if (clsSysPara4WebApi2_js_1.clsSysPara4WebApi2.spSetRefreshCacheOn == true) {
                ...
                strMsg = `刷新缓存已经关闭。(clsSysPara4WebApi2.spSetRefreshCacheOn == false)(${clsStackTrace_js_1.clsStackTrace.GetCurrClassFunctionByLevel(3)}->${clsStackTrace_js_1.clsStackTrace.GetCurrClassFunctionByLevel(2)}->${clsStackTrace_js_1.clsStackTrace.GetCurrClassFunction()})`;
                console.log(strMsg);
            }
        }
        /// <summary>
    ...
    class clsUsersBL {
        ...
        CheckPropertyNew(pobjUsersEN) {
            ...
            //检查字段的数据类型是否正确
            if (null !== pobjUsersEN.userId && undefined !== pobjUsersEN.userId && jsString_js_1.tzDataType.isString(pobjUsersEN.userId) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|用户ID(userId)]的值:[$(pobjUsersEN.userId)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.userName && undefined !== pobjUsersEN.userName && jsString_js_1.tzDataType.isString(pobjUsersEN.userName) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|用户名(userName)]的值:[$(pobjUsersEN.userName)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.departmentId && undefined !== pobjUsersEN.departmentId && jsString_js_1.tzDataType.isString(pobjUsersEN.departmentId) === false) {
            ...
            if (null !== pobjUsersEN.userStateId && undefined !== pobjUsersEN.userStateId && jsString_js_1.tzDataType.isString(pobjUsersEN.userStateId) === false) {
            ...
            if (null !== pobjUsersEN.password && undefined !== pobjUsersEN.password && jsString_js_1.tzDataType.isString(pobjUsersEN.password) === false) {
            ...
            if (null !== pobjUsersEN.schoolID1 && undefined !== pobjUsersEN.schoolID1 && jsString_js_1.tzDataType.isString(pobjUsersEN.schoolID1) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|学校编号(schoolID1)]的值:[$(pobjUsersEN.schoolID1)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.beginYearMonth && undefined !== pobjUsersEN.beginYearMonth && jsString_js_1.tzDataType.isString(pobjUsersEN.beginYearMonth) === false) {
            ...
            if (null !== pobjUsersEN.endYearMonth && undefined !== pobjUsersEN.endYearMonth && jsString_js_1.tzDataType.isString(pobjUsersEN.endYearMonth) === false) {
            ...
            if (null !== pobjUsersEN.id_GradeBase && undefined !== pobjUsersEN.id_GradeBase && jsString_js_1.tzDataType.isString(pobjUsersEN.id_GradeBase) === false) {
            ...
            if (null !== pobjUsersEN.id_XzCollege && undefined !== pobjUsersEN.id_XzCollege && jsString_js_1.tzDataType.isString(pobjUsersEN.id_XzCollege) === false) {
            ...
            if (null !== pobjUsersEN.id_XzMajor && undefined !== pobjUsersEN.id_XzMajor && jsString_js_1.tzDataType.isString(pobjUsersEN.id_XzMajor) === false) {
            ...
            if (null !== pobjUsersEN.stuIdTeacherId && undefined !== pobjUsersEN.stuIdTeacherId && jsString_js_1.tzDataType.isString(pobjUsersEN.stuIdTeacherId) === false) {
            ...
            if (null !== pobjUsersEN.email && undefined !== pobjUsersEN.email && jsString_js_1.tzDataType.isString(pobjUsersEN.email) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|电子邮箱(email)]的值:[$(pobjUsersEN.email)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.phoneNumber && undefined !== pobjUsersEN.phoneNumber && jsString_js_1.tzDataType.isString(pobjUsersEN.phoneNumber) === false) {
            ...
            if (null !== pobjUsersEN.avatarsPicture && undefined !== pobjUsersEN.avatarsPicture && jsString_js_1.tzDataType.isString(pobjUsersEN.avatarsPicture) === false) {
            ...
            if (null !== pobjUsersEN.identityID && undefined !== pobjUsersEN.identityID && jsString_js_1.tzDataType.isString(pobjUsersEN.identityID) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|身份编号(identityID)]的值:[$(pobjUsersEN.identityID)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.auditDate && undefined !== pobjUsersEN.auditDate && jsString_js_1.tzDataType.isString(pobjUsersEN.auditDate) === false) {
            ...
            if (null !== pobjUsersEN.auditUser && undefined !== pobjUsersEN.auditUser && jsString_js_1.tzDataType.isString(pobjUsersEN.auditUser) === false) {
            ...
            if (null !== pobjUsersEN.registerDate && undefined !== pobjUsersEN.registerDate && jsString_js_1.tzDataType.isString(pobjUsersEN.registerDate) === false) {
            ...
            if (null !== pobjUsersEN.mobilePhone && undefined !== pobjUsersEN.mobilePhone && jsString_js_1.tzDataType.isString(pobjUsersEN.mobilePhone) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|手机(mobilePhone)]的值:[$(pobjUsersEN.mobilePhone)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.openId && undefined !== pobjUsersEN.openId && jsString_js_1.tzDataType.isString(pobjUsersEN.openId) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|微信openId(openId)]的值:[$(pobjUsersEN.openId)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.updDate && undefined !== pobjUsersEN.updDate && jsString_js_1.tzDataType.isString(pobjUsersEN.updDate) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|修改日期(updDate)]的值:[$(pobjUsersEN.updDate)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.updUser && undefined !== pobjUsersEN.updUser && jsString_js_1.tzDataType.isString(pobjUsersEN.updUser) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|修改人(updUser)]的值:[$(pobjUsersEN.updUser)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.memo && undefined !== pobjUsersEN.memo && jsString_js_1.tzDataType.isString(pobjUsersEN.memo) === false) {
                throw new Error("(errid:Watl000060)字段[用户(Users)|备注(memo)]的值:[$(pobjUsersEN.memo)], 非法，应该为字符型!(Users_CheckPropertyNew)");
            }
            if (null !== pobjUsersEN.headPic && undefined !== pobjUsersEN.headPic && jsString_js_1.tzDataType.isString(pobjUsersEN.headPic) === false) {
