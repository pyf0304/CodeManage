...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "jquery", "../../L0_Entity/GraduateEduTools/clsSysCommentEN.js", "../../PubFun/CacheHelper.js", "../../PubFun/clsStackTrace.js", "../../PubFun/clsSysPara4WebApi2.js", "../../PubFun/tzDictionary.js", "../../L0_Entity/GraduateEduTools/clsSysCommentENEx.js", "../../L3_ForWApi/GraduateEduTools/clsSysCommentWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubFun/clsSysPara4WebApi.js"], factory);
    }
    ...
    */
    ...
    async function SysCommentEx_GetTotalRevalidationAsync(TeaUserId) {
        ...
        mapParam.add("updUserId", TeaUserId);
    ...
    async function SysCommentEx_UpdateCommentWeekAsync(strId_CurrEduCls, updUser) {
        ...
        mapParam.add("strUpdUser", updUser);
        let strData = mapParam.getParamText(); // "例如: strIdentityID =01";
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: strUrl,
