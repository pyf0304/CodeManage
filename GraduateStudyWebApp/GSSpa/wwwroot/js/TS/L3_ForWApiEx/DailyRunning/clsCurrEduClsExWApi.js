(function (factory) {
    ...
    const clsCurrEduClsENEx_js_1 = require("../../L0_Entity/DailyRunning/clsCurrEduClsENEx.js");
    const clsCurrEduClsWApi_js_2 = require("../../L3_ForWApi/DailyRunning/clsCurrEduClsWApi.js");
    ...
    */
    async function CurrEduClsEx_GetObjExLstByPager_Cache(objPagerPara) {
        ...
        const arrCurrEduClsObjLst = await (0, clsCurrEduClsWApi_js_2.CurrEduCls_GetObjLst_Cache)();
    ...
    */
    async function CurrEduClsEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrCurrEduClsExObjLst = await (0, clsCurrEduClsWApi_js_1.CurrEduCls_GetObjLstAsync)(objPagerPara.whereCond);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrCurrEduClsExObjLst) {
                const conFuncMap = await CurrEduClsEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
    ...
    */
    ...
    async function CurrEduClsEx_SetObjLst_localStorage(strid_CurrEduCls) {
        //清空本类缓存
        const responseText0 = await (0, clsCurrEduClsWApi_js_1.CurrEduCls_ReFreshThisCache)();
        //初始化列表缓存
