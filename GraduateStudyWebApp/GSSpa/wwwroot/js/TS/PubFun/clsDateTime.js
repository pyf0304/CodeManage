(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./DateTime.js", "./clsString2.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.clsDateTime = void 0;
    ...
    class clsDateTime extends DateTime_js_1.DateTime {
        constructor(strDateTimeStr) {
            ...
            // TODO: 在此处添加构造函数逻辑
            //
            if (clsString2_js_1.clsString.IsNullOrEmpty(strDateTimeStr) == true) {
            ...
            try {
                ...
                if (clsString2_js_1.clsString.IsNullOrEmpty(strDay) == true) {
                    this.Day = 0;
                }
                else {
                    this.Day = Number(strDay);
                }
                if (clsString2_js_1.clsString.IsNullOrEmpty(strHour) == true) {
                    this.Hour = 0;
                }
                else {
                    this.Hour = Number(strHour);
                }
                if (clsString2_js_1.clsString.IsNullOrEmpty(strMinute) == true) {
                    this.Minute = 0;
                }
                else {
                    this.Minute = Number(strMinute);
                }
                if (clsString2_js_1.clsString.IsNullOrEmpty(strSecond) == true) {
                    this.Second = 0;
                }
                else {
        ...
        static getDateStr(strDateTimeStr, intFormat) {
            if (clsString2_js_1.clsString.IsNullOrEmpty(strDateTimeStr))
                return "00-00-00";
            ...
            if (strDateTimeStr.length == 14) {
                ...
                var strMsg = clsString2_js_1.clsString.Format("日期串:{0}格式不正确！", strDateTimeStr);
        ...
        static ChangeDateToDate10(strDate) {
            ...
            if (strDate.length != 8)
                return "";
            if (clsString2_js_1.clsString.IsNullOrEmpty(strDate) == true)
                return "";
            try {
        ...
        static GetDateStrWithYMD(strDate) {
            var strResult = "";
            if (clsString2_js_1.clsString.IsNullOrEmpty(strDate)) {
                return "年   月   日";
            }
            if (strDate.length != 8) {
                return "日期格式不正确!";
        ...
        getDateStr(intFormat) {
            ...
            switch (intFormat) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    strDateStr = clsString2_js_1.clsString.Format("{0}/{1}/{2}", strDay, strMonth, strYear);
                    break;
                case 4:
                    strDateStr = clsString2_js_1.clsString.Format("{1}/{0}/{2}", strDay, strMonth, strYear);
                    break;
            }
            return strDateStr;
        }
        ...
        static GetEnglighOrdinalByNum(intOrdinal) {
            ...
            switch (intOrdinal) {
                ...
                case 19:
                    ...
                    break;
                case 20:
                    strDay_EN = clsString2_js_1.clsString.Format("twentieth");
                    break;
                case 21:
        ...
        getEnglighDay_EN() {
            ...
            strBirthDay_EN = clsString2_js_1.clsString.Format("{0} {1}, {2}", strMonth_EN, this.Day, this.year);
        ...
        getBirthDay_EN() {
            ...
            switch (this.Day) {
                ...
                case 19:
                case 20:
                    strDay_EN = clsString2_js_1.clsString.Format("{0}th", this.Day);
                    break;
                case 21:
                    strDay_EN = "21st";
                    break;
            ...
            strBirthDay_EN = clsString2_js_1.clsString.Format("{0} {1} {2}", strDay_EN, strMonth_EN, this.year);
            return strBirthDay_EN;
        }
        /// <summary>
        ...
        getBirthDay_EN2() {
            ...
            switch (this.Day) {
                ...
                case 8:
                case 9:
                    strDay_EN = clsString2_js_1.clsString.Format("{0}", this.Day);
                    break;
                case 10:
                case 11:
                case 12:
            ...
            strBirthDay_EN = clsString2_js_1.clsString.Format("{0} {1} {2}", strMonth_EN, strDay_EN, this.year);
            return strBirthDay_EN;
        }
        /// <summary>
        ...
        static CheckYearMonth6(strYearMonth) {
            ...
            if (strYearMonth.length != 6) {
                var strMsg = clsString2_js_1.clsString.Format("年月:<{0}>长度不正确！应该为6位，但目前为:{1},不正确.", strYearMonth, strYearMonth.length);
                throw new Error(strMsg);
            }
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("年月:<{0}>中检查<年>:<{1}>不正确！错误：{2}", strYearMonth, strYear, objException);
                throw new Error(strMsg);
            }
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("年月:<{0}>中检查<月>:<{1}>不正确！错误：{2}", strYearMonth, strMonth, objException);
                throw new Error(strMsg);
            }
            return true;
        }
        ...
        static CheckDate8(strDate) {
            ...
            if (strDate == "无")
                return true;
            if (strDate.length != 8) {
                var strMsg = clsString2_js_1.clsString.Format("日期:<{0}>长度不正确！应该为8位，但目前为:{1},不正确.", strDate, strDate.length);
                throw new Error(strMsg);
            }
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("日期:<{0}>中检查<年>:<{1}>不正确！错误：{2}", strDate, strYear, objException);
                throw new Error(strMsg);
            }
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("日期:<{0}>中检查<月>:<{1}>不正确！错误：{2}", strDate, strMonth, objException);
                throw new Error(strMsg);
            }
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("日期:<{0}>中检查<日>:<{1}>不正确！错误：{2}", strDate, strDay, objException);
                throw new Error(strMsg);
            }
            return true;
        }
        ...
        static CheckYear(strYear) {
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("<年>:<{0}>不正确！错误：{1}", strYear, objException);
                throw new Error(strMsg);
            }
            if (intYear < 1900) {
                var strMsg = clsString2_js_1.clsString.Format("<年>:<{0}>小于1900,不正确！", intYear);
                throw new Error(strMsg);
            }
            if (intYear > 3000) {
                var strMsg = clsString2_js_1.clsString.Format("<年>:<{0}>大于3000,不正确！", intYear);
                throw new Error(strMsg);
            }
            return true;
        }
        ...
        static CheckMonth(strMonth) {
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("<月>:<{0}>不正确！错误：{1}", strMonth, objException);
                throw new Error(strMsg);
            }
            if (intMonth < 1) {
                var strMsg = clsString2_js_1.clsString.Format("<月>:<{0}>小于1,不正确！", intMonth);
                throw new Error(strMsg);
            }
            if (intMonth > 12) {
                var strMsg = clsString2_js_1.clsString.Format("<月>:<{0}>大于12,不正确！", intMonth);
                throw new Error(strMsg);
            }
            return true;
        }
        ...
        static CheckDay(strDay) {
            ...
            try {
                ...
                var strMsg = clsString2_js_1.clsString.Format("<日>:<{0}>不正确！错误：{1}", strDay, objException);
                throw new Error(strMsg);
            }
            if (intDay < 1) {
                var strMsg = clsString2_js_1.clsString.Format("<日>:<{0}>小于1,不正确！", intDay);
                throw new Error(strMsg);
            }
            if (intDay > 31) {
                var strMsg = clsString2_js_1.clsString.Format("<日>:<{0}>大于31,不正确！", intDay);
                throw new Error(strMsg);
            }
            return true;
        }
