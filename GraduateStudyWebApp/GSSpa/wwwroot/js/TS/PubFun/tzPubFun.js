...
(function (factory) {
    ...
    exports.LogError = exports.getHostAddress_web = exports.getRootPath_web = exports.getVirtualRootPath_web = exports.GetStrLen = exports.GetCurrClassFunc = exports.myShowErrorMsg = exports.OnlyShowDiv = exports.ReceiveServerData = exports.Tz_HideDiv4Element = exports.Tz_ShowDiv4Element = exports.Tz_HideDiv = exports.Tz_ShowDiv = exports.SetShowSelectFileDiv = exports.ShowSelectFileDiv2 = exports.ShowSelectFileDiv = exports.WindowClose = exports.ParentClose = exports.getBrowserInfo = exports.getOsInfo4Page = exports.IsContainByID = exports.getObjByObjListAndId = exports.getObjByTagAndId2 = exports.getObjLstByClass = exports.getObjByClassAndId = exports.getObjByTagAndId = exports.getValueByObjListAndName = exports.getValueByTagAndName2 = exports.getValueByTagAndName = exports.GetObjectLstByTypeTagNameAndStartIdName = exports.GetObjectLstByTypeTagNameAndStartName = exports.btnQuery4SelectFileId_Click = exports.SetQuery4SelectFileId = exports.getRootPath = exports.btnQuery4SelectFileId = void 0;
    ...
    function GetObjectLstByTypeTagNameAndStartName(strType, strTagName, strStartName) {
        ...
        let arrLst = GetArray(objLst);
        let arrFind = arrLst.filter((x) => (x.name.indexOf(strStartName) > -1 && x.type == strType));
    ...
    function GetObjectLstByTypeTagNameAndStartIdName(strType, strTagName, strStartIdName) {
        var objLst = document.getElementsByTagName(strTagName);
        let arrLst = GetArray(objLst);
        let arrFind = arrLst.filter((x) => (x.id.indexOf(strStartIdName) > -1 && x.type == strType));
    ...
    function getValueByTagAndName(TagType, varName) {
        ...
        let arrLst = GetArray(ObjList);
        let arrFind = arrLst.filter((x) => x.name.indexOf(varName));
        if (arrFind.length > 0)
    ...
    function getValueByTagAndName2(TagType, varName1, varName2) {
        var ObjList = document.forms[0].getElementsByTagName(TagType);
        let arrLst = GetArray(ObjList);
        let arrFind = arrLst.filter((x) => x.name.indexOf(varName1) && x.name.indexOf(varName2));
        if (arrFind.length > 0)
            return arrFind[0].value;
    ...
    function getObjByTagAndId(TagType, varId) {
        var ObjList = document.forms[0].getElementsByTagName(TagType);
        let arrLst = GetArray(ObjList);
        let arrFind = arrLst.filter((x) => x.id == varId);
        if (arrFind.length > 0)
            return arrFind[0];
        return null;
        //for (var i = 0; i < ObjList.length; i++) {
    ...
    function getObjByClassAndId(className, varId) {
        ...
        let arrLst = GetArray(ObjList);
        let arrFind = arrLst.filter((x) => x.id.indexOf(varId));
        if (arrFind.length > 0)
            return arrFind[0];
        return null;
    }
    ...
    function getObjByTagAndId2(TagType, varId1, varId2) {
        var ObjList = document.forms[0].getElementsByTagName(TagType);
        let arrLst = GetArray(ObjList);
        let arrFind = arrLst.filter((x) => x.id.indexOf(varId1) && x.id.indexOf(varId2));
        if (arrFind.length > 0)
            return arrFind[0];
        return null;
    }
