(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../FunClass/clsPubVar4Web.js", "./clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SessionStorage_GetKeyByPrefix = exports.LocalStorage_GetKeyByPrefix = exports.GetSession_CacheAdditionCondition = exports.CacheHelper = void 0;
    const clsPubVar4Web_js_1 = require("../FunClass/clsPubVar4Web.js");
    ...
    function GetSession_CacheAdditionCondition(strTabName) {
        const arrTabCacheAdditionCondition = (0, clsPubVar4Web_js_1.GetLst_TabCacheAdditionCondition)();
        const objCacheAdditionCondition = arrTabCacheAdditionCondition.find(x => x.tabName == strTabName);
        if (objCacheAdditionCondition == null)
            return "";
        return objCacheAdditionCondition.cacheAdditionCondition;
    }
    exports.GetSession_CacheAdditionCondition = GetSession_CacheAdditionCondition;
    /**
