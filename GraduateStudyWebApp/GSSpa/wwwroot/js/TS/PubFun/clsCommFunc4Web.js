(function (factory) {
    ...
    exports.confirm_del = exports.Redirect = exports.SortFun = exports.GetObjKeys = exports.getRootPath = exports.GetExceptionStr = exports.SetAllCkechedKeysV2 = exports.SetNotCkechedItem4KeyId = exports.BindDdl_ObjLst_V = exports.BindDdl_ObjLst = exports.BindDdl_ObjLstInDiv_V = exports.BindDdl_ObjLstInDiv = exports.myShowErrorMsg = exports.getElementByIdInDiv = exports.BindDdl_TrueAndFalseInDiv = exports.BindDdl_TrueAndFalse = exports.BindDdl_CboObjectInDiv = exports.BindDdl_CboObject = exports.confirm_del4Msg = exports.GetObjValueOfKey = exports.GetObjValueOfKeyV2 = exports.SetAllNotCkechedItem = exports.GetWidthByWordStr = exports.GetSortExpressInfo = exports.GetSortExpress = exports.ObjectAssignV2 = exports.ObjectAssign = exports.GetSpan4BoolTrue = exports.GetSpan4BoolFalse = exports.HideDiv = exports.ShowDiv = exports.ShowTr = exports.HideTd = exports.HideTr = exports.ShowDialog = exports.HideDialog = exports.BindTab = exports.clsCommFunc4WebBak = exports.ChkClick1 = exports.arrSelectedKeys = void 0;
    /*
     * 功能:为Web提供一些公共的功能函数
     * 版本:2021-06-06-01
     * 作者:潘以锋
    ...
    */
    ...
    function BindDdl_CboObjectInDiv(strDivName, strDdlName, arrObjLst, strValueFldName, strTextFldName, strTabCnName) {
        ...
        const arrSelect = objDiv.getElementsByTagName("select");
        const arrElements = (0, clsCommFunc4Ctrl_js_1.GetArray)(arrSelect);
        const sltDdl = arrElements.find(x => x.id == strDdlName);
        if (sltDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("在层:[{0}]内，不存在下拉框:[{1}], 请检查！", strDivName, strDdlName);
            throw (strMsg);
        }
    ...
    */
    function BindDdl_TrueAndFalseInDiv(strDivName, ddlTrueAndFalse) {
        ...
        const arrSelect = objDiv.getElementsByTagName("select");
        const arrElements = (0, clsCommFunc4Ctrl_js_1.GetArray)(arrSelect);
        const sltDdl = arrElements.find(x => x.id == ddlTrueAndFalse);
        if (sltDdl == null) {
