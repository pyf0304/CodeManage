(function (factory) {
    ...
    **/
    ...
    clsSysCommentEN.AttributeName = ["commentId", "comment", "score", "commentTypeId", "scoreType", "parentId", "tableKey", "updUser", "updDate", "memo", "okCount", "pubParentId", "id_CurrEduCls", "userId", "month", "week", "weekTimeRange"];
});
