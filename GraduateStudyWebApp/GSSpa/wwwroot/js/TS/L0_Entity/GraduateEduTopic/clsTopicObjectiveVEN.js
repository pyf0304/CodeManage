(function (factory) {
    ...
    exports.clsTopicObjectiveVEN = void 0;
    /**
    * 类名:clsTopicObjectiveVEN
    ...
    **/
    ...
    class clsTopicObjectiveVEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        GetFldValue(strFldName) {
            ...
            switch (strFldName) {
                ...
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[TopicObjectiveV]中不存在！`;
        ...
        SetFldValue(strFldName, strValue) {
            ...
            switch (strFldName) {
                ...
                case "sf_FldComparisonOp":
                    ...
                    break;
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[TopicObjectiveV]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
                    console.error(strMsg);
                    break;
            }
        }
    ...
    exports.clsTopicObjectiveVEN = clsTopicObjectiveVEN;
    clsTopicObjectiveVEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsTopicObjectiveVEN.CacheModeId = "05"; //未知
    clsTopicObjectiveVEN._CurrTabName = "TopicObjectiveV"; //当前表名,与该类相关的表名
    clsTopicObjectiveVEN._KeyFldName = "TopicObjectiveVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsTopicObjectiveVEN.mintAttributeCount = 13;
    clsTopicObjectiveVEN.AttributeName = ["topicObjectiveVId", "topicObjectiveId", "objectiveName", "objectiveContent", "objectiveType", "conclusion", "sourceId", "updDate", "updUser", "id_CurrEduCls", "pdfContent", "pdfPageNum", "memo"];
});
