(function (factory) {
    ...
    exports.clsViewpointVEN = void 0;
    /**
    * 类名:clsViewpointVEN
    ...
    **/
    ...
    class clsViewpointVEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsViewpointVEN = clsViewpointVEN;
    clsViewpointVEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsViewpointVEN.CacheModeId = "05"; //未知
    clsViewpointVEN._CurrTabName = "ViewpointV"; //当前表名,与该类相关的表名
    clsViewpointVEN._KeyFldName = "ViewpointVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsViewpointVEN.mintAttributeCount = 16;
    clsViewpointVEN.AttributeName = ["viewpointVId", "viewpointId", "viewpointName", "viewpointContent", "viewpointTypeId", "reason", "source", "vpProposePeople", "userTypeId", "citationId", "updDate", "updUser", "pdfContent", "pdfPageNum", "id_CurrEduCls", "memo"];
});
