(function (factory) {
    ...
    **/
    ...
    class clsgs_KnowledgesGraphEN extends clsGeneralTab_js_1.clsGeneralTab {
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_EduClassName() { return "eduClassName"; } //教学班
        /**
        * 常量:"CourseName"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    clsgs_KnowledgesGraphEN.CacheModeId = "02"; //客户端缓存
    ...
    clsgs_KnowledgesGraphEN.mintAttributeCount = 18;
    clsgs_KnowledgesGraphEN.AttributeName = ["knowledgeGraphId", "knowledgeGraphName", "id_CurrEduCls", "courseId", "createUser", "updDate", "updUser", "memo", "graphTypeId", "isDisplay", "isExtend", "isRecommend", "isAnswer", "isSubmit", "startTime", "submitTime", "eduClassName", "courseName"];
});
