(function (factory) {
    ...
    exports.clsvgs_PaperVEN = void 0;
    /**
    * 类名:clsvgs_PaperVEN
    ...
    **/
    ...
    class clsvgs_PaperVEN extends clsGeneralTabV_js_1.clsGeneralTabV {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsvgs_PaperVEN = clsvgs_PaperVEN;
    clsvgs_PaperVEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsvgs_PaperVEN.CacheModeId = "05"; //未知
    clsvgs_PaperVEN._CurrTabName = "vgs_PaperV"; //当前表名,与该类相关的表名
    clsvgs_PaperVEN._KeyFldName = "PaperVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsvgs_PaperVEN.mintAttributeCount = 26;
    clsvgs_PaperVEN.AttributeName = ["paperVId", "paperId", "paperTitle", "paperContent", "periodical", "author", "researchQuestion", "keyword", "literatureSources", "literatureLink", "uploadfileUrl", "isQuotethesis", "isSubmit", "isChecked", "quoteId", "checker", "literatureTypeId", "literatureTypeName", "updUser", "updDate", "id_CurrEduCls", "paperTypeId", "paperTypeName", "paperStatusId", "paperStatusName", "memo"];
});
