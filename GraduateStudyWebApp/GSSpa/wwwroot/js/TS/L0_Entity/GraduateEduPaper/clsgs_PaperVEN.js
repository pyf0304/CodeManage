(function (factory) {
    ...
    **/
    ...
    class clsgs_PaperVEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsgs_PaperVEN = clsgs_PaperVEN;
    clsgs_PaperVEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_PaperVEN.CacheModeId = "05"; //未知
    clsgs_PaperVEN._CurrTabName = "gs_PaperV"; //当前表名,与该类相关的表名
    clsgs_PaperVEN._KeyFldName = "PaperVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_PaperVEN.mintAttributeCount = 23;
    clsgs_PaperVEN.AttributeName = ["paperVId", "paperId", "paperTitle", "paperContent", "periodical", "author", "researchQuestion", "keyword", "literatureSources", "literatureLink", "uploadfileUrl", "isQuotethesis", "isSubmit", "isChecked", "quoteId", "checker", "literatureTypeId", "updUser", "updDate", "id_CurrEduCls", "paperTypeId", "paperStatusId", "memo"];
});
