(function (factory) {
    ...
    **/
    ...
    clsgs_TagsEN.mintAttributeCount = 21;
    clsgs_TagsEN.AttributeName = ["tagsId", "tagsContent", "pdfContent", "pdfPageNum", "voteCount", "orderNum", "updUser", "updDate", "pdfLineNum", "pdfX", "pdfY", "memo", "id_CurrEduCls", "paperId", "shareId", "pdfPageNumIn", "pdfPageTop", "pdfDivLet", "pdfDivTop", "pdfZoom", "tagsTypeId"];
});
