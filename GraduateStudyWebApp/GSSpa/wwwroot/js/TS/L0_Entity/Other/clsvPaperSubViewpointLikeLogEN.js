(function (factory) {
    ...
    **/
    ...
    class clsvPaperSubViewpointLikeLogEN extends clsGeneralTabV_js_1.clsGeneralTabV {
        ...
        */
        constructor() {
            ...
            */
            this.paperSubViewpointLikeLogId = 0; //PaperSubViewpointLikeLogId
            this.updDate = ""; //修改日期
            this.memo = ""; //备注
            this.rwTitle = ""; //读写标题
        ...
        */
        static get con_PaperSubViewpointLikeLogId() { return "paperSubViewpointLikeLogId"; } //PaperSubViewpointLikeLogId
        /**
        * 常量:"UpdDate"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    clsvPaperSubViewpointLikeLogEN.AttributeName = ["paperSubViewpointLikeLogId", "updDate", "memo", "rwTitle", "subViewpointContent", "explainContent", "paperRWId", "subViewpointId", "updUser"];
});
