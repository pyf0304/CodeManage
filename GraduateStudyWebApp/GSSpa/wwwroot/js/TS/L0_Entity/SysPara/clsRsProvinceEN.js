(function (factory) {
    ...
    exports.clsRsProvinceEN_Sim = exports.clsRsProvinceEN = void 0;
    /**
    * 类名:clsRsProvinceEN
    ...
    **/
    ...
    class clsRsProvinceEN extends clsGeneralTab2_js_1.clsGeneralTab2 {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        constructor() {
            ...
            this.mstrProvinceID = ""; //ProvinceID
            this.mstrProvinceName = ""; //ProvinceName
            this.mstrProvinceRecuitID = ""; //ProvinceRecuitID
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_ProvinceID() { return "ProvinceID"; } //ProvinceID
        /**
        * 常量:"ProvinceName"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_ProvinceRecuitID() { return "ProvinceRecuitID"; } //ProvinceRecuitID
        /**
        * 常量:"modifyDate"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    exports.clsRsProvinceEN = clsRsProvinceEN;
    clsRsProvinceEN._CurrTabName = "RsProvince"; //当前表名,与该类相关的表名
    clsRsProvinceEN._KeyFldName = "id_Province"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsRsProvinceEN.mintAttributeCount = 6;
    clsRsProvinceEN.AttributeName = ["id_Province", "ProvinceID", "ProvinceName", "ProvinceRecuitID", "modifyDate", "modifyUserID"];
    /**
    * 省份(RsProvince)
    * (AutoGCLib.EntityLayer4TypeScript:GeneCode)
    **/
    class clsRsProvinceEN_Sim {
        constructor() {
            //以下是属性变量
            /**
             * 省份流水号(说明:;字段类型:char;字段长度:4;是否可空:False)
    ...
    exports.clsRsProvinceEN_Sim = clsRsProvinceEN_Sim;
});
