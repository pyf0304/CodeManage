...
(function (factory) {
    ...
    **/
    async function sys_RequestType_GetObjByRequestTypeIdAsync(strRequestTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strRequestTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strRequestTypeId]不能为空！(In GetObjByRequestTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strRequestTypeId.length != 2) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strRequestTypeId]的长度:[{0}]不正确！", strRequestTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sys_RequestType_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sys_RequestType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sys_RequestType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function sys_RequestType_GetObjByRequestTypeId_Cache(strRequestTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strRequestTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strRequestTypeId]不能为空！(In GetObjByRequestTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strRequestTypeId.length != 2) {
        ...
        try {
            ...
            if (arrsys_RequestType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objsys_RequestType = await sys_RequestType_GetObjByRequestTypeIdAsync(strRequestTypeId);
    ...
    */
    async function sys_RequestType_GetObjByRequestTypeId_localStorage(strRequestTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strRequestTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strRequestTypeId]不能为空！(In GetObjByRequestTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strRequestTypeId.length != 2) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN._CurrTabName, strRequestTypeId);
        if (strKey == "") {
    ...
    */
    async function sys_RequestType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function sys_RequestType_GetObjLst_ClientCache() {
        ...
        clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clssys_RequestTypeEN_js_1.clssys_RequestTypeEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrsys_RequestTypeExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrsys_RequestTypeExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrsys_RequestTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function sys_RequestType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrsys_RequestTypeExObjLst.length);
            console.log(strInfo);
            return arrsys_RequestTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function sys_RequestType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrsys_RequestTypeExObjLst.length);
            console.log(strInfo);
            return arrsys_RequestTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function sys_RequestType_DelRecordAsync(strRequestTypeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strRequestTypeId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strRequestTypeId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function sys_RequestType_UpdateRecordAsync(objsys_RequestTypeEN) {
        ...
        if (objsys_RequestTypeEN.sf_UpdFldSetStr === undefined || objsys_RequestTypeEN.sf_UpdFldSetStr === null || objsys_RequestTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objsys_RequestTypeEN.requestTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sys_RequestType_Controller, strAction);
        try {
    ...
    */
    async function sys_RequestType_IsExistRecord_Cache(objsys_RequestType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objsys_RequestType_Cond), exports.sys_RequestType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function sys_RequestType_IsExist_Cache(strRequestTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strRequestTypeId, exports.sys_RequestType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function sys_RequestType_CheckPropertyNew(pobjsys_RequestTypeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjsys_RequestTypeEN.requestTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTypeName) == false && (0, clsString_js_1.GetStrLen)(pobjsys_RequestTypeEN.requestTypeName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTable) == false && (0, clsString_js_1.GetStrLen)(pobjsys_RequestTypeEN.requestTable) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTableId) == false && (0, clsString_js_1.GetStrLen)(pobjsys_RequestTypeEN.requestTableId) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjsys_RequestTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTypeId) == false && undefined !== pobjsys_RequestTypeEN.requestTypeId && jsString_js_1.tzDataType.isString(pobjsys_RequestTypeEN.requestTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTypeName) == false && undefined !== pobjsys_RequestTypeEN.requestTypeName && jsString_js_1.tzDataType.isString(pobjsys_RequestTypeEN.requestTypeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTable) == false && undefined !== pobjsys_RequestTypeEN.requestTable && jsString_js_1.tzDataType.isString(pobjsys_RequestTypeEN.requestTable) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTableId) == false && undefined !== pobjsys_RequestTypeEN.requestTableId && jsString_js_1.tzDataType.isString(pobjsys_RequestTypeEN.requestTableId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.memo) == false && undefined !== pobjsys_RequestTypeEN.memo && jsString_js_1.tzDataType.isString(pobjsys_RequestTypeEN.memo) === false) {
    ...
    */
    function sys_RequestType_CheckProperty4Update(pobjsys_RequestTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjsys_RequestTypeEN.requestTypeId) === true) {
    ...
    */
    function sys_RequestType_GetCombineCondition(objsys_RequestType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objsys_RequestType_Cond.dicFldComparisonOp, clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTypeId, objsys_RequestType_Cond.requestTypeId, strComparisonOp_RequestTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestType_Cond.dicFldComparisonOp, clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTypeName, objsys_RequestType_Cond.requestTypeName, strComparisonOp_RequestTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestType_Cond.dicFldComparisonOp, clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTable) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTable, objsys_RequestType_Cond.requestTable, strComparisonOp_RequestTable);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestType_Cond.dicFldComparisonOp, clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTableId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_RequestTableId, objsys_RequestType_Cond.requestTableId, strComparisonOp_RequestTableId);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestType_Cond.dicFldComparisonOp, clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clssys_RequestTypeEN_js_1.clssys_RequestTypeEN.con_Memo, objsys_RequestType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function sys_RequestType_GetUniCondStr_RequestTableId_RequestTypeId(objsys_RequestTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and RequestTableId = '{0}'", objsys_RequestTypeEN.requestTableId);
        strWhereCond += (0, clsString_js_1.Format)(" and RequestTypeId = '{0}'", objsys_RequestTypeEN.requestTypeId);
        return strWhereCond;
    }
