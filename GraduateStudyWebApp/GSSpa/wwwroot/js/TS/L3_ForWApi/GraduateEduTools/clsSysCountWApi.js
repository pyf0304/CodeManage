...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTools/clsSysCountEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function SysCount_GetObjByCountIdAsync(strCountId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysCount_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysCount_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysCount_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function SysCount_DelRecordAsync(strCountId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strCountId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strCountId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function SysCount_UpdateRecordAsync(objSysCountEN) {
        ...
        if (objSysCountEN.sf_UpdFldSetStr === undefined || objSysCountEN.sf_UpdFldSetStr === null || objSysCountEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysCountEN.countId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysCount_Controller, strAction);
        try {
    ...
    */
    function SysCount_CheckPropertyNew(pobjSysCountEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.countId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.countId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.countTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.countTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.tableKey) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.tableKey) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.parentId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.parentId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjSysCountEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.countId) == false && undefined !== pobjSysCountEN.countId && jsString_js_1.tzDataType.isString(pobjSysCountEN.countId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.countTypeId) == false && undefined !== pobjSysCountEN.countTypeId && jsString_js_1.tzDataType.isString(pobjSysCountEN.countTypeId) === false) {
        ...
        if (null != pobjSysCountEN.paperRWCount && undefined !== pobjSysCountEN.paperRWCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.paperRWCount) === false) {
        ...
        if (null != pobjSysCountEN.okCount && undefined !== pobjSysCountEN.okCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.okCount) === false) {
        ...
        if (null != pobjSysCountEN.collectionCount && undefined !== pobjSysCountEN.collectionCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.collectionCount) === false) {
            throw new Error("(errid:Watl000060)字段[收藏数(collectionCount)]的值:[$(pobjSysCountEN.collectionCount)], 非法，应该为数值型(In 统计数据(SysCount))!(clsSysCountBL:CheckPropertyNew)");
        }
        if (null != pobjSysCountEN.downloadCount && undefined !== pobjSysCountEN.downloadCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.downloadCount) === false) {
        ...
        if (null != pobjSysCountEN.attachmentCount && undefined !== pobjSysCountEN.attachmentCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.attachmentCount) === false) {
        ...
        if (null != pobjSysCountEN.commentCount && undefined !== pobjSysCountEN.commentCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.commentCount) === false) {
        ...
        if (null != pobjSysCountEN.score && undefined !== pobjSysCountEN.score && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.score) === false) {
        ...
        if (null != pobjSysCountEN.stuScore && undefined !== pobjSysCountEN.stuScore && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.stuScore) === false) {
        ...
        if (null != pobjSysCountEN.teaScore && undefined !== pobjSysCountEN.teaScore && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.teaScore) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.tableKey) == false && undefined !== pobjSysCountEN.tableKey && jsString_js_1.tzDataType.isString(pobjSysCountEN.tableKey) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.parentId) == false && undefined !== pobjSysCountEN.parentId && jsString_js_1.tzDataType.isString(pobjSysCountEN.parentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.updUser) == false && undefined !== pobjSysCountEN.updUser && jsString_js_1.tzDataType.isString(pobjSysCountEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.updDate) == false && undefined !== pobjSysCountEN.updDate && jsString_js_1.tzDataType.isString(pobjSysCountEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.memo) == false && undefined !== pobjSysCountEN.memo && jsString_js_1.tzDataType.isString(pobjSysCountEN.memo) === false) {
    ...
    */
    function SysCount_CheckProperty4Update(pobjSysCountEN) {
        ...
        if (null != pobjSysCountEN.collectionCount && undefined !== pobjSysCountEN.collectionCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.collectionCount) === false) {
            throw new Error("(errid:Watl000063)字段[收藏数(collectionCount)]的值:[$(pobjSysCountEN.collectionCount)], 非法，应该为数值型(In 统计数据(SysCount))!(clsSysCountBL:CheckProperty4Update)");
        }
        if (null != pobjSysCountEN.downloadCount && undefined !== pobjSysCountEN.downloadCount && jsString_js_1.tzDataType.isNumber(pobjSysCountEN.downloadCount) === false) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCountEN.countId) === true) {
    ...
    */
    function SysCount_GetCombineCondition(objSysCount_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_CountId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_CountId, objSysCount_Cond.countId, strComparisonOp_CountId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_CountTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_CountTypeId, objSysCount_Cond.countTypeId, strComparisonOp_CountTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_PaperRWCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_PaperRWCount, objSysCount_Cond.paperRWCount, strComparisonOp_PaperRWCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_OkCount, objSysCount_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_CollectionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_CollectionCount, objSysCount_Cond.collectionCount, strComparisonOp_CollectionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_DownloadCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_DownloadCount, objSysCount_Cond.downloadCount, strComparisonOp_DownloadCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_AttachmentCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_AttachmentCount, objSysCount_Cond.attachmentCount, strComparisonOp_AttachmentCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_CommentCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_CommentCount, objSysCount_Cond.commentCount, strComparisonOp_CommentCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_score, objSysCount_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_StuScore, objSysCount_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCountEN_js_1.clsSysCountEN.con_TeaScore, objSysCount_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_TableKey) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_TableKey, objSysCount_Cond.tableKey, strComparisonOp_TableKey);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_ParentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_ParentId, objSysCount_Cond.parentId, strComparisonOp_ParentId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_UpdUser, objSysCount_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_UpdDate, objSysCount_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCount_Cond.dicFldComparisonOp, clsSysCountEN_js_1.clsSysCountEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCountEN_js_1.clsSysCountEN.con_Memo, objSysCount_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function SysCount_GetUniCondStr_CountTypeId_TableKey(objSysCountEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and CountTypeId = '{0}'", objSysCountEN.countTypeId);
        strWhereCond += (0, clsString_js_1.Format)(" and TableKey = '{0}'", objSysCountEN.tableKey);
        return strWhereCond;
    }
    ...
    **/
    function SysCount_GetUniCondStr4Update_CountTypeId_TableKey(objSysCountEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and CountId <> '{0}'", objSysCountEN.countId);
        strWhereCond += (0, clsString_js_1.Format)(" and CountTypeId = '{0}'", objSysCountEN.countTypeId);
        strWhereCond += (0, clsString_js_1.Format)(" and TableKey = '{0}'", objSysCountEN.tableKey);
        return strWhereCond;
    }
    ...
    */
    function SysCount_CopyObjTo(objSysCountENS, objSysCountENT) {
        ...
        objSysCountENT.collectionCount = objSysCountENS.collectionCount; //收藏数
