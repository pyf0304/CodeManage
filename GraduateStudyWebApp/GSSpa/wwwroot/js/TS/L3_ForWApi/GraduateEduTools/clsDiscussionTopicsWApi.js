...
(function (factory) {
    ...
    **/
    async function DiscussionTopics_GetObjByTopicsIdAsync(strTopicsId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicsId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicsId]不能为空！(In GetObjByTopicsIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicsId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicsId]的长度:[{0}]不正确！", strTopicsId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.discussionTopics_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.discussionTopics_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.discussionTopics_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function DiscussionTopics_GetObjByTopicsId_Cache(strTopicsId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicsId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicsId]不能为空！(In GetObjByTopicsId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicsId.length != 8) {
        ...
        try {
            ...
            if (arrDiscussionTopics_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objDiscussionTopics = await DiscussionTopics_GetObjByTopicsIdAsync(strTopicsId);
    ...
    */
    async function DiscussionTopics_GetObjByTopicsId_localStorage(strTopicsId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicsId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicsId]不能为空！(In GetObjByTopicsId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicsId.length != 8) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN._CurrTabName, strTopicsId);
        if (strKey == "") {
    ...
    */
    async function DiscussionTopics_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function DiscussionTopics_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN._CurrTabName, strid_CurrEduCls);
        clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrDiscussionTopicsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrDiscussionTopicsExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrDiscussionTopicsExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function DiscussionTopics_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrDiscussionTopicsExObjLst.length);
            console.log(strInfo);
            return arrDiscussionTopicsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function DiscussionTopics_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrDiscussionTopicsExObjLst.length);
            console.log(strInfo);
            return arrDiscussionTopicsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function DiscussionTopics_DelRecordAsync(strTopicsId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strTopicsId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strTopicsId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function DiscussionTopics_UpdateRecordAsync(objDiscussionTopicsEN) {
        ...
        if (objDiscussionTopicsEN.sf_UpdFldSetStr === undefined || objDiscussionTopicsEN.sf_UpdFldSetStr === null || objDiscussionTopicsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objDiscussionTopicsEN.topicsId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.discussionTopics_Controller, strAction);
        try {
    ...
    */
    async function DiscussionTopics_IsExistRecord_Cache(objDiscussionTopics_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objDiscussionTopics_Cond), exports.discussionTopics_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function DiscussionTopics_IsExist_Cache(strTopicsId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTopicsId, exports.discussionTopics_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function DiscussionTopics_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsDiscussionTopicsWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function DiscussionTopics_CheckPropertyNew(pobjDiscussionTopicsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.discussionTypeId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.topicsId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.topicsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.discussionTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.discussionTypeId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.topicsTitle) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.topicsTitle) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionTopicsEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.topicsId) == false && undefined !== pobjDiscussionTopicsEN.topicsId && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.topicsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.discussionTypeId) == false && undefined !== pobjDiscussionTopicsEN.discussionTypeId && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.discussionTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.topicsTitle) == false && undefined !== pobjDiscussionTopicsEN.topicsTitle && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.topicsTitle) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.topicsContent) == false && undefined !== pobjDiscussionTopicsEN.topicsContent && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.topicsContent) === false) {
        ...
        if (null != pobjDiscussionTopicsEN.isAudit && undefined !== pobjDiscussionTopicsEN.isAudit && jsString_js_1.tzDataType.isBoolean(pobjDiscussionTopicsEN.isAudit) === false) {
        ...
        if (null != pobjDiscussionTopicsEN.isTop && undefined !== pobjDiscussionTopicsEN.isTop && jsString_js_1.tzDataType.isBoolean(pobjDiscussionTopicsEN.isTop) === false) {
        ...
        if (null != pobjDiscussionTopicsEN.browseNumber && undefined !== pobjDiscussionTopicsEN.browseNumber && jsString_js_1.tzDataType.isNumber(pobjDiscussionTopicsEN.browseNumber) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.updDate) == false && undefined !== pobjDiscussionTopicsEN.updDate && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.updUser) == false && undefined !== pobjDiscussionTopicsEN.updUser && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.memo) == false && undefined !== pobjDiscussionTopicsEN.memo && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.id_CurrEduCls) == false && undefined !== pobjDiscussionTopicsEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjDiscussionTopicsEN.id_CurrEduCls) === false) {
        ...
        if (null != pobjDiscussionTopicsEN.subCount && undefined !== pobjDiscussionTopicsEN.subCount && jsString_js_1.tzDataType.isNumber(pobjDiscussionTopicsEN.subCount) === false) {
    ...
    */
    function DiscussionTopics_CheckProperty4Update(pobjDiscussionTopicsEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionTopicsEN.topicsId) === true) {
    ...
    */
    function DiscussionTopics_GetCombineCondition(objDiscussionTopics_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_TopicsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_TopicsId, objDiscussionTopics_Cond.topicsId, strComparisonOp_TopicsId);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_DiscussionTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_DiscussionTypeId, objDiscussionTopics_Cond.discussionTypeId, strComparisonOp_DiscussionTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_topicsTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_topicsTitle, objDiscussionTopics_Cond.topicsTitle, strComparisonOp_topicsTitle);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_IsAudit) == true) {
            if (objDiscussionTopics_Cond.isAudit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_IsAudit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_IsAudit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_IsTop) == true) {
            if (objDiscussionTopics_Cond.isTop == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_IsTop);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_IsTop);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_BrowseNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_BrowseNumber, objDiscussionTopics_Cond.browseNumber, strComparisonOp_BrowseNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_UpdDate, objDiscussionTopics_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_UpdUser, objDiscussionTopics_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_Memo, objDiscussionTopics_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_id_CurrEduCls, objDiscussionTopics_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionTopics_Cond.dicFldComparisonOp, clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_SubCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsDiscussionTopicsEN_js_1.clsDiscussionTopicsEN.con_SubCount, objDiscussionTopics_Cond.subCount, strComparisonOp_SubCount);
        }
        return strWhereCond;
    }
