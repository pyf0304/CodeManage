...
(function (factory) {
    ...
    */
    async function vgs_TeachingDate_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvgs_TeachingDateEN_js_1.clsvgs_TeachingDateEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvgs_TeachingDateEN_js_1.clsvgs_TeachingDateEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vgs_TeachingDate_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvgs_TeachingDateEN_js_1.clsvgs_TeachingDateEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvgs_TeachingDateEN_js_1.clsvgs_TeachingDateEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_TeachingDateExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvgs_TeachingDateExObjLst);
