...
(function (factory) {
    ...
    async function SysComment_GetObjByCommentIdAsync(strCommentId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysComment_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysComment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysComment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrSysComment_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objSysComment = await SysComment_GetObjByCommentIdAsync(strCommentId);
    ...
    */
    async function SysComment_GetObjByCommentId_localStorage(strCommentId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSysCommentEN_js_1.clsSysCommentEN._CurrTabName, strCommentId);
        if (strKey == "") {
    ...
    */
    async function SysComment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsSysCommentEN_js_1.clsSysCommentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsSysCommentEN_js_1.clsSysCommentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function SysComment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSysCommentEN_js_1.clsSysCommentEN._CurrTabName, strid_CurrEduCls);
        clsSysCommentEN_js_1.clsSysCommentEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsSysCommentEN_js_1.clsSysCommentEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsSysCommentEN_js_1.clsSysCommentEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsSysCommentEN_js_1.clsSysCommentEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysCommentExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrSysCommentExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysCommentExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysComment_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysCommentExObjLst.length);
            console.log(strInfo);
            return arrSysCommentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysComment_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysCommentExObjLst.length);
            console.log(strInfo);
            return arrSysCommentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysComment_UpdateRecordAsync(objSysCommentEN) {
        ...
        if (objSysCommentEN.sf_UpdFldSetStr === undefined || objSysCommentEN.sf_UpdFldSetStr === null || objSysCommentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysCommentEN.commentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysComment_Controller, strAction);
        try {
    ...
    */
    async function SysComment_IsExistRecord_Cache(objSysComment_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysComment_Cond), exports.sysComment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysComment_IsExist_Cache(strCommentId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCommentId, exports.sysComment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function SysComment_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsSysCommentWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function SysComment_CheckPropertyNew(pobjSysCommentEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.commentTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[评论类型Id]不能为空(In 系统评论表)!(clsSysCommentBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.parentId) === true) {
            throw new Error("(errid:Watl000058)字段[父Id]不能为空(In 系统评论表)!(clsSysCommentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.commentId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.commentId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.comment) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.comment) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.commentTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.commentTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.scoreType) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.scoreType) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.parentId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.parentId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.tableKey) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.tableKey) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.pubParentId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.pubParentId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.userId) > 20) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过20(In 系统评论表(SysComment))!值:$(pobjSysCommentEN.userId)(clsSysCommentBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.weekTimeRange) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.weekTimeRange) > 100) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.commentId) == false && undefined !== pobjSysCommentEN.commentId && jsString_js_1.tzDataType.isString(pobjSysCommentEN.commentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.comment) == false && undefined !== pobjSysCommentEN.comment && jsString_js_1.tzDataType.isString(pobjSysCommentEN.comment) === false) {
        ...
        if (null != pobjSysCommentEN.score && undefined !== pobjSysCommentEN.score && jsString_js_1.tzDataType.isNumber(pobjSysCommentEN.score) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.commentTypeId) == false && undefined !== pobjSysCommentEN.commentTypeId && jsString_js_1.tzDataType.isString(pobjSysCommentEN.commentTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.scoreType) == false && undefined !== pobjSysCommentEN.scoreType && jsString_js_1.tzDataType.isString(pobjSysCommentEN.scoreType) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.parentId) == false && undefined !== pobjSysCommentEN.parentId && jsString_js_1.tzDataType.isString(pobjSysCommentEN.parentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.tableKey) == false && undefined !== pobjSysCommentEN.tableKey && jsString_js_1.tzDataType.isString(pobjSysCommentEN.tableKey) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.updUser) == false && undefined !== pobjSysCommentEN.updUser && jsString_js_1.tzDataType.isString(pobjSysCommentEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.updDate) == false && undefined !== pobjSysCommentEN.updDate && jsString_js_1.tzDataType.isString(pobjSysCommentEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.memo) == false && undefined !== pobjSysCommentEN.memo && jsString_js_1.tzDataType.isString(pobjSysCommentEN.memo) === false) {
        ...
        if (null != pobjSysCommentEN.okCount && undefined !== pobjSysCommentEN.okCount && jsString_js_1.tzDataType.isNumber(pobjSysCommentEN.okCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.pubParentId) == false && undefined !== pobjSysCommentEN.pubParentId && jsString_js_1.tzDataType.isString(pobjSysCommentEN.pubParentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.id_CurrEduCls) == false && undefined !== pobjSysCommentEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjSysCommentEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.userId) == false && undefined !== pobjSysCommentEN.userId && jsString_js_1.tzDataType.isString(pobjSysCommentEN.userId) === false) {
        ...
        if (null != pobjSysCommentEN.month && undefined !== pobjSysCommentEN.month && jsString_js_1.tzDataType.isNumber(pobjSysCommentEN.month) === false) {
        ...
        if (null != pobjSysCommentEN.week && undefined !== pobjSysCommentEN.week && jsString_js_1.tzDataType.isNumber(pobjSysCommentEN.week) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.weekTimeRange) == false && undefined !== pobjSysCommentEN.weekTimeRange && jsString_js_1.tzDataType.isString(pobjSysCommentEN.weekTimeRange) === false) {
    ...
    */
    function SysComment_CheckProperty4Update(pobjSysCommentEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.userId) > 20) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过20(In 系统评论表(SysComment))!值:$(pobjSysCommentEN.userId)(clsSysCommentBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.weekTimeRange) == false && (0, clsString_js_1.GetStrLen)(pobjSysCommentEN.weekTimeRange) > 100) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysCommentEN.commentId) === true) {
    ...
    */
    function SysComment_GetCombineCondition(objSysComment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_CommentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_CommentId, objSysComment_Cond.commentId, strComparisonOp_CommentId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_Comment) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_Comment, objSysComment_Cond.comment, strComparisonOp_Comment);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCommentEN_js_1.clsSysCommentEN.con_score, objSysComment_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_CommentTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_CommentTypeId, objSysComment_Cond.commentTypeId, strComparisonOp_CommentTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_ScoreType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_ScoreType, objSysComment_Cond.scoreType, strComparisonOp_ScoreType);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_ParentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_ParentId, objSysComment_Cond.parentId, strComparisonOp_ParentId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_TableKey) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_TableKey, objSysComment_Cond.tableKey, strComparisonOp_TableKey);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_UpdUser, objSysComment_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_UpdDate, objSysComment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_Memo, objSysComment_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCommentEN_js_1.clsSysCommentEN.con_OkCount, objSysComment_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_PubParentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_PubParentId, objSysComment_Cond.pubParentId, strComparisonOp_PubParentId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_id_CurrEduCls, objSysComment_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_UserId, objSysComment_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_Month) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCommentEN_js_1.clsSysCommentEN.con_Month, objSysComment_Cond.month, strComparisonOp_Month);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_Week) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysCommentEN_js_1.clsSysCommentEN.con_Week, objSysComment_Cond.week, strComparisonOp_Week);
        }
        if (Object.prototype.hasOwnProperty.call(objSysComment_Cond.dicFldComparisonOp, clsSysCommentEN_js_1.clsSysCommentEN.con_WeekTimeRange) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysCommentEN_js_1.clsSysCommentEN.con_WeekTimeRange, objSysComment_Cond.weekTimeRange, strComparisonOp_WeekTimeRange);
        }
        return strWhereCond;
    }
    ...
    **/
    function SysComment_GetUniCondStr_CommentId(objSysCommentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and CommentId = '{0}'", objSysCommentEN.commentId);
        return strWhereCond;
    }
