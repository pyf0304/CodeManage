...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTools/clsDiscussionSubContentEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function DiscussionSubContent_GetObjBySubContentIdAsync(strSubContentId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.discussionSubContent_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.discussionSubContent_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.discussionSubContent_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function DiscussionSubContent_DelRecordAsync(strSubContentId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strSubContentId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strSubContentId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function DiscussionSubContent_UpdateRecordAsync(objDiscussionSubContentEN) {
        ...
        if (objDiscussionSubContentEN.sf_UpdFldSetStr === undefined || objDiscussionSubContentEN.sf_UpdFldSetStr === null || objDiscussionSubContentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objDiscussionSubContentEN.subContentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.discussionSubContent_Controller, strAction);
        try {
    ...
    */
    function DiscussionSubContent_CheckPropertyNew(pobjDiscussionSubContentEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContentId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.subContentId) > 10) {
            throw new Error("(errid:Watl000059)字段[字内容Id(subContentId)]的长度不能超过10(In 讨论子内容(DiscussionSubContent))!值:$(pobjDiscussionSubContentEN.subContentId)(clsDiscussionSubContentBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.topicsId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.topicsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.parentId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.parentId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.userId) > 20) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过20(In 讨论子内容(DiscussionSubContent))!值:$(pobjDiscussionSubContentEN.userId)(clsDiscussionSubContentBL:CheckPropertyNew)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContentId) == false && undefined !== pobjDiscussionSubContentEN.subContentId && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.subContentId) === false) {
            throw new Error("(errid:Watl000060)字段[字内容Id(subContentId)]的值:[$(pobjDiscussionSubContentEN.subContentId)], 非法，应该为字符型(In 讨论子内容(DiscussionSubContent))!(clsDiscussionSubContentBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContent) == false && undefined !== pobjDiscussionSubContentEN.subContent && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.subContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.topicsId) == false && undefined !== pobjDiscussionSubContentEN.topicsId && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.topicsId) === false) {
        ...
        if (null != pobjDiscussionSubContentEN.isTop && undefined !== pobjDiscussionSubContentEN.isTop && jsString_js_1.tzDataType.isBoolean(pobjDiscussionSubContentEN.isTop) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.updDate) == false && undefined !== pobjDiscussionSubContentEN.updDate && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.updUser) == false && undefined !== pobjDiscussionSubContentEN.updUser && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.memo) == false && undefined !== pobjDiscussionSubContentEN.memo && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.parentId) == false && undefined !== pobjDiscussionSubContentEN.parentId && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.parentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.userId) == false && undefined !== pobjDiscussionSubContentEN.userId && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.userId) === false) {
    ...
    */
    function DiscussionSubContent_CheckProperty4Update(pobjDiscussionSubContentEN) {
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContentId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.subContentId) > 10) {
            throw new Error("(errid:Watl000062)字段[字内容Id(subContentId)]的长度不能超过10(In 讨论子内容(DiscussionSubContent))!值:$(pobjDiscussionSubContentEN.subContentId)(clsDiscussionSubContentBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.topicsId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.topicsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.userId) > 20) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过20(In 讨论子内容(DiscussionSubContent))!值:$(pobjDiscussionSubContentEN.userId)(clsDiscussionSubContentBL:CheckProperty4Update)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContentId) == false && undefined !== pobjDiscussionSubContentEN.subContentId && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.subContentId) === false) {
            throw new Error("(errid:Watl000063)字段[字内容Id(subContentId)]的值:[$(pobjDiscussionSubContentEN.subContentId)], 非法，应该为字符型(In 讨论子内容(DiscussionSubContent))!(clsDiscussionSubContentBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContent) == false && undefined !== pobjDiscussionSubContentEN.subContent && jsString_js_1.tzDataType.isString(pobjDiscussionSubContentEN.subContent) === false) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.subContentId) === true) {
            throw new Error("(errid:Watl000064)字段[字内容Id]不能为空(In 讨论子内容)!(clsDiscussionSubContentBL:CheckProperty4Update)");
        }
        //检查外键， 作为外键应该和主键的字段长度是一样的， 若不一样，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjDiscussionSubContentEN.topicsId) == false && (0, clsString_js_1.GetStrLen)(pobjDiscussionSubContentEN.topicsId) != 8) {
    ...
    */
    function DiscussionSubContent_GetCombineCondition(objDiscussionSubContent_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_SubContentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_SubContentId, objDiscussionSubContent_Cond.subContentId, strComparisonOp_SubContentId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_TopicsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_TopicsId, objDiscussionSubContent_Cond.topicsId, strComparisonOp_TopicsId);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_IsTop) == true) {
            if (objDiscussionSubContent_Cond.isTop == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_IsTop);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_IsTop);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_UpdDate, objDiscussionSubContent_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_UpdUser, objDiscussionSubContent_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_Memo, objDiscussionSubContent_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_ParentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_ParentId, objDiscussionSubContent_Cond.parentId, strComparisonOp_ParentId);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN.con_UserId, objDiscussionSubContent_Cond.userId, strComparisonOp_UserId);
        }
        return strWhereCond;
    }
    ...
    * @param lngSubContentId: 子内容Id(要求唯一的字段)
    * @returns 条件串(strWhereCond)
    **/
    function DiscussionSubContent_GetUniCondStr_SubContentId(objDiscussionSubContentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and subContentId = '{0}'", objDiscussionSubContentEN.subContentId);
        return strWhereCond;
    }
    ...
    */
    function DiscussionSubContent_CopyObjTo(objDiscussionSubContentENS, objDiscussionSubContentENT) {
        objDiscussionSubContentENT.subContentId = objDiscussionSubContentENS.subContentId; //字内容Id
