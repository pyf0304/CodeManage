...
(function (factory) {
    ...
    * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    ...
    const clsvgs_UserConfigEN_js_1 = require("../../L0_Entity/GraduateEduTools/clsvgs_UserConfigEN.js");
    ...
    */
    async function vgs_UserConfig_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vgs_UserConfig_GetObjLst_ClientCache() {
        ...
        clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_UserConfigExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvgs_UserConfigExObjLst);
