...
(function (factory) {
    ...
    async function gs_UserRelaPosition_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_UserRelaPosition_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_UserRelaPosition_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_UserRelaPosition_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrgs_UserRelaPosition_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_UserRelaPosition = await gs_UserRelaPosition_GetObjBymIdAsync(lngmId);
    ...
    */
    async function gs_UserRelaPosition_GetObjBymId_localStorage(lngmId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_UserRelaPosition_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_UserRelaPosition_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN._CurrTabName, strid_CurrEduCls);
        clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_UserRelaPositionExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_UserRelaPositionExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_UserRelaPositionExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_UserRelaPosition_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_UserRelaPositionExObjLst.length);
            console.log(strInfo);
            return arrgs_UserRelaPositionExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_UserRelaPosition_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_UserRelaPositionExObjLst.length);
            console.log(strInfo);
            return arrgs_UserRelaPositionExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_UserRelaPosition_UpdateRecordAsync(objgs_UserRelaPositionEN) {
        ...
        if (objgs_UserRelaPositionEN.sf_UpdFldSetStr === undefined || objgs_UserRelaPositionEN.sf_UpdFldSetStr === null || objgs_UserRelaPositionEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_UserRelaPositionEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_UserRelaPosition_Controller, strAction);
        try {
    ...
    */
    async function gs_UserRelaPosition_IsExistRecord_Cache(objgs_UserRelaPosition_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_UserRelaPosition_Cond), exports.gs_UserRelaPosition_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_UserRelaPosition_IsExist_Cache(lngmId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_UserRelaPosition_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_UserRelaPosition_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_UserRelaPositionWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function gs_UserRelaPosition_CheckPropertyNew(pobjgs_UserRelaPositionEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.userId) > 20) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过20(In 用户关系坐标位置(gs_UserRelaPosition))!值:$(pobjgs_UserRelaPositionEN.userId)(clsgs_UserRelaPositionBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_UserRelaPositionEN.mId && undefined !== pobjgs_UserRelaPositionEN.mId && jsString_js_1.tzDataType.isNumber(pobjgs_UserRelaPositionEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.userId) == false && undefined !== pobjgs_UserRelaPositionEN.userId && jsString_js_1.tzDataType.isString(pobjgs_UserRelaPositionEN.userId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.updUser) == false && undefined !== pobjgs_UserRelaPositionEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_UserRelaPositionEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.updDate) == false && undefined !== pobjgs_UserRelaPositionEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_UserRelaPositionEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.id_CurrEduCls) == false && undefined !== pobjgs_UserRelaPositionEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_UserRelaPositionEN.id_CurrEduCls) === false) {
        ...
        if (null != pobjgs_UserRelaPositionEN.orderNum && undefined !== pobjgs_UserRelaPositionEN.orderNum && jsString_js_1.tzDataType.isNumber(pobjgs_UserRelaPositionEN.orderNum) === false) {
        ...
        if (null != pobjgs_UserRelaPositionEN.x_Position && undefined !== pobjgs_UserRelaPositionEN.x_Position && jsString_js_1.tzDataType.isNumber(pobjgs_UserRelaPositionEN.x_Position) === false) {
        ...
        if (null != pobjgs_UserRelaPositionEN.y_Position && undefined !== pobjgs_UserRelaPositionEN.y_Position && jsString_js_1.tzDataType.isNumber(pobjgs_UserRelaPositionEN.y_Position) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.memo) == false && undefined !== pobjgs_UserRelaPositionEN.memo && jsString_js_1.tzDataType.isString(pobjgs_UserRelaPositionEN.memo) === false) {
    ...
    */
    function gs_UserRelaPosition_CheckProperty4Update(pobjgs_UserRelaPositionEN) {
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.userId) > 20) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过20(In 用户关系坐标位置(gs_UserRelaPosition))!值:$(pobjgs_UserRelaPositionEN.userId)(clsgs_UserRelaPositionBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_UserRelaPositionEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_UserRelaPositionEN.updUser) > 20) {
    ...
    */
    function gs_UserRelaPosition_GetCombineCondition(objgs_UserRelaPosition_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_mId, objgs_UserRelaPosition_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_UserId, objgs_UserRelaPosition_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_UpdUser, objgs_UserRelaPosition_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_UpdDate, objgs_UserRelaPosition_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_id_CurrEduCls, objgs_UserRelaPosition_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_OrderNum, objgs_UserRelaPosition_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_X_Position) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_X_Position, objgs_UserRelaPosition_Cond.x_Position, strComparisonOp_X_Position);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_Y_Position) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_Y_Position, objgs_UserRelaPosition_Cond.y_Position, strComparisonOp_Y_Position);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRelaPosition_Cond.dicFldComparisonOp, clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_UserRelaPositionEN_js_1.clsgs_UserRelaPositionEN.con_Memo, objgs_UserRelaPosition_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_UserRelaPosition_GetUniCondStr_mId(objgs_UserRelaPositionEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objgs_UserRelaPositionEN.mId);
        return strWhereCond;
    }
