...
(function (factory) {
    ...
    **/
    async function gs_AnswerCount_GetObjByAnswerCountIdAsync(strAnswerCountId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAnswerCountId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAnswerCountId]不能为空！(In GetObjByAnswerCountIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAnswerCountId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strAnswerCountId]的长度:[{0}]不正确！", strAnswerCountId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_AnswerCount_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_AnswerCount_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_AnswerCount_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_AnswerCount_GetObjByAnswerCountId_Cache(strAnswerCountId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAnswerCountId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAnswerCountId]不能为空！(In GetObjByAnswerCountId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAnswerCountId.length != 10) {
        ...
        try {
            ...
            if (arrgs_AnswerCount_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_AnswerCount = await gs_AnswerCount_GetObjByAnswerCountIdAsync(strAnswerCountId);
    ...
    */
    async function gs_AnswerCount_GetObjByAnswerCountId_localStorage(strAnswerCountId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAnswerCountId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAnswerCountId]不能为空！(In GetObjByAnswerCountId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAnswerCountId.length != 10) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN._CurrTabName, strAnswerCountId);
        if (strKey == "") {
    ...
    */
    async function gs_AnswerCount_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_AnswerCount_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN._CurrTabName, strid_CurrEduCls);
        clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_AnswerCountExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_AnswerCountExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_AnswerCountExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_AnswerCount_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_AnswerCountExObjLst.length);
            console.log(strInfo);
            return arrgs_AnswerCountExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_AnswerCount_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_AnswerCountExObjLst.length);
            console.log(strInfo);
            return arrgs_AnswerCountExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_AnswerCount_DelRecordAsync(strAnswerCountId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strAnswerCountId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strAnswerCountId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function gs_AnswerCount_UpdateRecordAsync(objgs_AnswerCountEN) {
        ...
        if (objgs_AnswerCountEN.sf_UpdFldSetStr === undefined || objgs_AnswerCountEN.sf_UpdFldSetStr === null || objgs_AnswerCountEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_AnswerCountEN.answerCountId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_AnswerCount_Controller, strAction);
        try {
    ...
    */
    async function gs_AnswerCount_IsExistRecord_Cache(objgs_AnswerCount_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_AnswerCount_Cond), exports.gs_AnswerCount_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_AnswerCount_IsExist_Cache(strAnswerCountId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strAnswerCountId, exports.gs_AnswerCount_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_AnswerCount_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_AnswerCountWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function gs_AnswerCount_CheckPropertyNew(pobjgs_AnswerCountEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerCountId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.answerCountId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.dataUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.dataUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.dataAddDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.dataAddDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.weekTimeRange) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.weekTimeRange) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.answerId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.answerTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.questionsId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.questionsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.scoreType) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.scoreType) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.userName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.userName) > 50) {
            throw new Error("(errid:Watl000059)字段[用户名(userName)]的长度不能超过50(In 问题讨论回答统计(gs_AnswerCount))!值:$(pobjgs_AnswerCountEN.userName)(clsgs_AnswerCountBL:CheckPropertyNew)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.memo) == false && undefined !== pobjgs_AnswerCountEN.memo && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerCountId) == false && undefined !== pobjgs_AnswerCountEN.answerCountId && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.answerCountId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.dataUser) == false && undefined !== pobjgs_AnswerCountEN.dataUser && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.dataUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.dataAddDate) == false && undefined !== pobjgs_AnswerCountEN.dataAddDate && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.dataAddDate) === false) {
        ...
        if (null != pobjgs_AnswerCountEN.month && undefined !== pobjgs_AnswerCountEN.month && jsString_js_1.tzDataType.isNumber(pobjgs_AnswerCountEN.month) === false) {
        ...
        if (null != pobjgs_AnswerCountEN.week && undefined !== pobjgs_AnswerCountEN.week && jsString_js_1.tzDataType.isNumber(pobjgs_AnswerCountEN.week) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.weekTimeRange) == false && undefined !== pobjgs_AnswerCountEN.weekTimeRange && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.weekTimeRange) === false) {
        ...
        if (null != pobjgs_AnswerCountEN.isRecommend && undefined !== pobjgs_AnswerCountEN.isRecommend && jsString_js_1.tzDataType.isBoolean(pobjgs_AnswerCountEN.isRecommend) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerId) == false && undefined !== pobjgs_AnswerCountEN.answerId && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.answerId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerTypeId) == false && undefined !== pobjgs_AnswerCountEN.answerTypeId && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.answerTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.questionsId) == false && undefined !== pobjgs_AnswerCountEN.questionsId && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.questionsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.topicId) == false && undefined !== pobjgs_AnswerCountEN.topicId && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.paperId) == false && undefined !== pobjgs_AnswerCountEN.paperId && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.id_CurrEduCls) == false && undefined !== pobjgs_AnswerCountEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerContent) == false && undefined !== pobjgs_AnswerCountEN.answerContent && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.answerContent) === false) {
        ...
        if (null != pobjgs_AnswerCountEN.score && undefined !== pobjgs_AnswerCountEN.score && jsString_js_1.tzDataType.isNumber(pobjgs_AnswerCountEN.score) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.scoreType) == false && undefined !== pobjgs_AnswerCountEN.scoreType && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.scoreType) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.updUser) == false && undefined !== pobjgs_AnswerCountEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.updDate) == false && undefined !== pobjgs_AnswerCountEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.userName) == false && undefined !== pobjgs_AnswerCountEN.userName && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.userName) === false) {
    ...
    */
    function gs_AnswerCount_CheckProperty4Update(pobjgs_AnswerCountEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.userName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_AnswerCountEN.userName) > 50) {
            throw new Error("(errid:Watl000062)字段[用户名(userName)]的长度不能超过50(In 问题讨论回答统计(gs_AnswerCount))!值:$(pobjgs_AnswerCountEN.userName)(clsgs_AnswerCountBL:CheckProperty4Update)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.memo) == false && undefined !== pobjgs_AnswerCountEN.memo && jsString_js_1.tzDataType.isString(pobjgs_AnswerCountEN.memo) === false) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_AnswerCountEN.answerCountId) === true) {
    ...
    */
    function gs_AnswerCount_GetCombineCondition(objgs_AnswerCount_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_Memo, objgs_AnswerCount_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_AnswerCountId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_AnswerCountId, objgs_AnswerCount_Cond.answerCountId, strComparisonOp_AnswerCountId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_DataUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_DataUser, objgs_AnswerCount_Cond.dataUser, strComparisonOp_DataUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_DataAddDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_DataAddDate, objgs_AnswerCount_Cond.dataAddDate, strComparisonOp_DataAddDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_Month) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_Month, objgs_AnswerCount_Cond.month, strComparisonOp_Month);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_Week) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_Week, objgs_AnswerCount_Cond.week, strComparisonOp_Week);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_WeekTimeRange) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_WeekTimeRange, objgs_AnswerCount_Cond.weekTimeRange, strComparisonOp_WeekTimeRange);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_IsRecommend) == true) {
            if (objgs_AnswerCount_Cond.isRecommend == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_IsRecommend);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_IsRecommend);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_AnswerId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_AnswerId, objgs_AnswerCount_Cond.answerId, strComparisonOp_AnswerId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_AnswerTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_AnswerTypeId, objgs_AnswerCount_Cond.answerTypeId, strComparisonOp_AnswerTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_QuestionsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_QuestionsId, objgs_AnswerCount_Cond.questionsId, strComparisonOp_QuestionsId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_TopicId, objgs_AnswerCount_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_PaperId, objgs_AnswerCount_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_id_CurrEduCls, objgs_AnswerCount_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_score, objgs_AnswerCount_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_ScoreType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_ScoreType, objgs_AnswerCount_Cond.scoreType, strComparisonOp_ScoreType);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_UpdUser, objgs_AnswerCount_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_UpdDate, objgs_AnswerCount_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_AnswerCount_Cond.dicFldComparisonOp, clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_UserName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_AnswerCountEN_js_1.clsgs_AnswerCountEN.con_UserName, objgs_AnswerCount_Cond.userName, strComparisonOp_UserName);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_AnswerCount_GetUniCondStr_AnswerCountId(objgs_AnswerCountEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and AnswerCountId = '{0}'", objgs_AnswerCountEN.answerCountId);
        return strWhereCond;
    }
