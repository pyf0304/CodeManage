...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTools/clsSysScoreWeightEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function SysScoreWeight_GetObjByScoreWeightIdAsync(strScoreWeightId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strScoreWeightId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strScoreWeightId]不能为空！(In GetObjByScoreWeightIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strScoreWeightId.length != 1) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strScoreWeightId]的长度:[{0}]不正确！", strScoreWeightId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysScoreWeight_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysScoreWeight_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysScoreWeight_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function SysScoreWeight_DelRecordAsync(strScoreWeightId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strScoreWeightId);
        try {
    ...
    **/
    async function SysScoreWeight_UpdateRecordAsync(objSysScoreWeightEN) {
        ...
        if (objSysScoreWeightEN.sf_UpdFldSetStr === undefined || objSysScoreWeightEN.sf_UpdFldSetStr === null || objSysScoreWeightEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysScoreWeightEN.scoreWeightId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysScoreWeight_Controller, strAction);
        try {
    ...
    */
    function SysScoreWeight_CheckPropertyNew(pobjSysScoreWeightEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreWeightValue) === true) {
            throw new Error("(errid:Watl000058)字段[分数权重值]不能为空(In 系统分数权重表)!(clsSysScoreWeightBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreWeightId) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.scoreWeightId) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.scoreTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreWeightValue) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.scoreWeightValue) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjSysScoreWeightEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreWeightId) == false && undefined !== pobjSysScoreWeightEN.scoreWeightId && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.scoreWeightId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.memo) == false && undefined !== pobjSysScoreWeightEN.memo && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.memo) === false) {
        ...
        if (null != pobjSysScoreWeightEN.isPublic && undefined !== pobjSysScoreWeightEN.isPublic && jsString_js_1.tzDataType.isBoolean(pobjSysScoreWeightEN.isPublic) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreTypeId) == false && undefined !== pobjSysScoreWeightEN.scoreTypeId && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.scoreTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreWeightValue) == false && undefined !== pobjSysScoreWeightEN.scoreWeightValue && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.scoreWeightValue) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.updDate) == false && undefined !== pobjSysScoreWeightEN.updDate && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.updUser) == false && undefined !== pobjSysScoreWeightEN.updUser && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.id_CurrEduCls) == false && undefined !== pobjSysScoreWeightEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjSysScoreWeightEN.id_CurrEduCls) === false) {
    ...
    */
    function SysScoreWeight_CheckProperty4Update(pobjSysScoreWeightEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysScoreWeightEN.scoreWeightId) === true) {
    ...
    */
    function SysScoreWeight_GetCombineCondition(objSysScoreWeight_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_ScoreWeightId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_ScoreWeightId, objSysScoreWeight_Cond.scoreWeightId, strComparisonOp_ScoreWeightId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_Memo, objSysScoreWeight_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_IsPublic) == true) {
            if (objSysScoreWeight_Cond.isPublic == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_IsPublic);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_IsPublic);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_ScoreTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_ScoreTypeId, objSysScoreWeight_Cond.scoreTypeId, strComparisonOp_ScoreTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_ScoreWeightValue) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_ScoreWeightValue, objSysScoreWeight_Cond.scoreWeightValue, strComparisonOp_ScoreWeightValue);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_UpdDate, objSysScoreWeight_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_UpdUser, objSysScoreWeight_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreWeight_Cond.dicFldComparisonOp, clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysScoreWeightEN_js_1.clsSysScoreWeightEN.con_id_CurrEduCls, objSysScoreWeight_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
