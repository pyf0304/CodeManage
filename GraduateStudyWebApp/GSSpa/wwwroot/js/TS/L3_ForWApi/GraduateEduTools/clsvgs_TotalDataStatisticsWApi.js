...
(function (factory) {
    ...
    */
    async function vgs_TotalDataStatistics_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvgs_TotalDataStatisticsEN_js_1.clsvgs_TotalDataStatisticsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvgs_TotalDataStatisticsEN_js_1.clsvgs_TotalDataStatisticsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vgs_TotalDataStatistics_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvgs_TotalDataStatisticsEN_js_1.clsvgs_TotalDataStatisticsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvgs_TotalDataStatisticsEN_js_1.clsvgs_TotalDataStatisticsEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_TotalDataStatisticsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvgs_TotalDataStatisticsExObjLst);
