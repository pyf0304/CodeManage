...
(function (factory) {
        ...
        try {
            ...
            if (arrvDiscussionTopics_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objvDiscussionTopics = await vDiscussionTopics_GetObjByTopicsIdAsync(strTopicsId);
    ...
    */
    async function vDiscussionTopics_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvDiscussionTopicsEN_js_1.clsvDiscussionTopicsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvDiscussionTopicsEN_js_1.clsvDiscussionTopicsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vDiscussionTopics_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvDiscussionTopicsEN_js_1.clsvDiscussionTopicsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvDiscussionTopicsEN_js_1.clsvDiscussionTopicsEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvDiscussionTopicsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvDiscussionTopicsExObjLst);
