...
(function (factory) {
    ...
    **/
    async function gs_TotalDataType_GetObjByTotalDataTypeIdAsync(strTotalDataTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataTypeId]不能为空！(In GetObjByTotalDataTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataTypeId.length != 2) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTotalDataTypeId]的长度:[{0}]不正确！", strTotalDataTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TotalDataType_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TotalDataType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TotalDataType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TotalDataType_GetObjByTotalDataTypeId_Cache(strTotalDataTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataTypeId]不能为空！(In GetObjByTotalDataTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataTypeId.length != 2) {
        ...
        try {
            ...
            if (arrgs_TotalDataType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_TotalDataType = await gs_TotalDataType_GetObjByTotalDataTypeIdAsync(strTotalDataTypeId);
    ...
    */
    async function gs_TotalDataType_GetObjByTotalDataTypeId_localStorage(strTotalDataTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataTypeId]不能为空！(In GetObjByTotalDataTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataTypeId.length != 2) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN._CurrTabName, strTotalDataTypeId);
        if (strKey == "") {
    ...
    */
    async function gs_TotalDataType_GetNameByTotalDataTypeId_Cache(strTotalDataTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataTypeId]不能为空！(In GetNameByTotalDataTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataTypeId.length != 2) {
    ...
    */
    async function gs_TotalDataType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_TotalDataType_GetObjLst_ClientCache() {
        ...
        clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TotalDataTypeExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_TotalDataTypeExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TotalDataType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_TotalDataTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TotalDataType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_TotalDataTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TotalDataType_DelRecordAsync(strTotalDataTypeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strTotalDataTypeId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strTotalDataTypeId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function gs_TotalDataType_UpdateRecordAsync(objgs_TotalDataTypeEN) {
        ...
        if (objgs_TotalDataTypeEN.sf_UpdFldSetStr === undefined || objgs_TotalDataTypeEN.sf_UpdFldSetStr === null || objgs_TotalDataTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TotalDataTypeEN.totalDataTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TotalDataType_Controller, strAction);
        try {
    ...
    */
    async function gs_TotalDataType_IsExistRecord_Cache(objgs_TotalDataType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TotalDataType_Cond), exports.gs_TotalDataType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TotalDataType_IsExist_Cache(strTotalDataTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTotalDataTypeId, exports.gs_TotalDataType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function gs_TotalDataType_BindDdl_TotalDataTypeIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_TotalDataTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_TotalDataType_CheckPropertyNew(pobjgs_TotalDataTypeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.totalDataTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataTypeEN.totalDataTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.totalDataTypeName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataTypeEN.totalDataTypeName) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.dataTable) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataTypeEN.dataTable) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.dataTableId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataTypeEN.dataTableId) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataTypeEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.onlyId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataTypeEN.onlyId) > 20) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.totalDataTypeId) == false && undefined !== pobjgs_TotalDataTypeEN.totalDataTypeId && jsString_js_1.tzDataType.isString(pobjgs_TotalDataTypeEN.totalDataTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.totalDataTypeName) == false && undefined !== pobjgs_TotalDataTypeEN.totalDataTypeName && jsString_js_1.tzDataType.isString(pobjgs_TotalDataTypeEN.totalDataTypeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.dataTable) == false && undefined !== pobjgs_TotalDataTypeEN.dataTable && jsString_js_1.tzDataType.isString(pobjgs_TotalDataTypeEN.dataTable) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.dataTableId) == false && undefined !== pobjgs_TotalDataTypeEN.dataTableId && jsString_js_1.tzDataType.isString(pobjgs_TotalDataTypeEN.dataTableId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.memo) == false && undefined !== pobjgs_TotalDataTypeEN.memo && jsString_js_1.tzDataType.isString(pobjgs_TotalDataTypeEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.onlyId) == false && undefined !== pobjgs_TotalDataTypeEN.onlyId && jsString_js_1.tzDataType.isString(pobjgs_TotalDataTypeEN.onlyId) === false) {
    ...
    */
    function gs_TotalDataType_CheckProperty4Update(pobjgs_TotalDataTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataTypeEN.totalDataTypeId) === true) {
    ...
    */
    function gs_TotalDataType_GetCombineCondition(objgs_TotalDataType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataType_Cond.dicFldComparisonOp, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_TotalDataTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_TotalDataTypeId, objgs_TotalDataType_Cond.totalDataTypeId, strComparisonOp_TotalDataTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataType_Cond.dicFldComparisonOp, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_TotalDataTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_TotalDataTypeName, objgs_TotalDataType_Cond.totalDataTypeName, strComparisonOp_TotalDataTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataType_Cond.dicFldComparisonOp, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_DataTable) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_DataTable, objgs_TotalDataType_Cond.dataTable, strComparisonOp_DataTable);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataType_Cond.dicFldComparisonOp, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_DataTableId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_DataTableId, objgs_TotalDataType_Cond.dataTableId, strComparisonOp_DataTableId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataType_Cond.dicFldComparisonOp, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_Memo, objgs_TotalDataType_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataType_Cond.dicFldComparisonOp, clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_OnlyId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataTypeEN_js_1.clsgs_TotalDataTypeEN.con_OnlyId, objgs_TotalDataType_Cond.onlyId, strComparisonOp_OnlyId);
        }
        return strWhereCond;
    }
