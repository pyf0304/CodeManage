...
(function (factory) {
    ...
    **/
    async function gs_TotalDataStatistics_GetObjByTotalDataIdAsync(strTotalDataId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataId]不能为空！(In GetObjByTotalDataIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataId.length != 12) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTotalDataId]的长度:[{0}]不正确！", strTotalDataId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TotalDataStatistics_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TotalDataStatistics_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TotalDataStatistics_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TotalDataStatistics_GetObjByTotalDataId_Cache(strTotalDataId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataId]不能为空！(In GetObjByTotalDataId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataId.length != 12) {
        ...
        try {
            ...
            if (arrgs_TotalDataStatistics_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_TotalDataStatistics = await gs_TotalDataStatistics_GetObjByTotalDataIdAsync(strTotalDataId);
    ...
    */
    async function gs_TotalDataStatistics_GetObjByTotalDataId_localStorage(strTotalDataId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTotalDataId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTotalDataId]不能为空！(In GetObjByTotalDataId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTotalDataId.length != 12) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN._CurrTabName, strTotalDataId);
        if (strKey == "") {
    ...
    */
    async function gs_TotalDataStatistics_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_TotalDataStatistics_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN._CurrTabName, strid_CurrEduCls);
        clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TotalDataStatisticsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_TotalDataStatisticsExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataStatisticsExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TotalDataStatistics_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataStatisticsExObjLst.length);
            console.log(strInfo);
            return arrgs_TotalDataStatisticsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TotalDataStatistics_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataStatisticsExObjLst.length);
            console.log(strInfo);
            return arrgs_TotalDataStatisticsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TotalDataStatistics_DelRecordAsync(strTotalDataId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strTotalDataId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strTotalDataId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function gs_TotalDataStatistics_UpdateRecordAsync(objgs_TotalDataStatisticsEN) {
        ...
        if (objgs_TotalDataStatisticsEN.sf_UpdFldSetStr === undefined || objgs_TotalDataStatisticsEN.sf_UpdFldSetStr === null || objgs_TotalDataStatisticsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TotalDataStatisticsEN.totalDataId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TotalDataStatistics_Controller, strAction);
        try {
    ...
    */
    async function gs_TotalDataStatistics_IsExistRecord_Cache(objgs_TotalDataStatistics_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TotalDataStatistics_Cond), exports.gs_TotalDataStatistics_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TotalDataStatistics_IsExist_Cache(strTotalDataId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTotalDataId, exports.gs_TotalDataStatistics_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_TotalDataStatistics_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_TotalDataStatisticsWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function gs_TotalDataStatistics_CheckPropertyNew(pobjgs_TotalDataStatisticsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.id_CurrEduCls) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.totalDataTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[总数据类型Id]不能为空(In 总数据统计)!(clsgs_TotalDataStatisticsBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.totalDataId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.totalDataId) > 12) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.totalDataTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.totalDataTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.tableKey) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.tableKey) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.dataUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.dataUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.dataAddDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.dataAddDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.weekTimeRange) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TotalDataStatisticsEN.weekTimeRange) > 100) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.totalDataId) == false && undefined !== pobjgs_TotalDataStatisticsEN.totalDataId && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.totalDataId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.id_CurrEduCls) == false && undefined !== pobjgs_TotalDataStatisticsEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.totalDataTypeId) == false && undefined !== pobjgs_TotalDataStatisticsEN.totalDataTypeId && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.totalDataTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.tableKey) == false && undefined !== pobjgs_TotalDataStatisticsEN.tableKey && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.tableKey) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.dataUser) == false && undefined !== pobjgs_TotalDataStatisticsEN.dataUser && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.dataUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.dataAddDate) == false && undefined !== pobjgs_TotalDataStatisticsEN.dataAddDate && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.dataAddDate) === false) {
        ...
        if (null != pobjgs_TotalDataStatisticsEN.month && undefined !== pobjgs_TotalDataStatisticsEN.month && jsString_js_1.tzDataType.isNumber(pobjgs_TotalDataStatisticsEN.month) === false) {
        ...
        if (null != pobjgs_TotalDataStatisticsEN.week && undefined !== pobjgs_TotalDataStatisticsEN.week && jsString_js_1.tzDataType.isNumber(pobjgs_TotalDataStatisticsEN.week) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.updDate) == false && undefined !== pobjgs_TotalDataStatisticsEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.updUser) == false && undefined !== pobjgs_TotalDataStatisticsEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.memo) == false && undefined !== pobjgs_TotalDataStatisticsEN.memo && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.memo) === false) {
        ...
        if (null != pobjgs_TotalDataStatisticsEN.score && undefined !== pobjgs_TotalDataStatisticsEN.score && jsString_js_1.tzDataType.isNumber(pobjgs_TotalDataStatisticsEN.score) === false) {
        ...
        if (null != pobjgs_TotalDataStatisticsEN.teaScore && undefined !== pobjgs_TotalDataStatisticsEN.teaScore && jsString_js_1.tzDataType.isNumber(pobjgs_TotalDataStatisticsEN.teaScore) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.weekTimeRange) == false && undefined !== pobjgs_TotalDataStatisticsEN.weekTimeRange && jsString_js_1.tzDataType.isString(pobjgs_TotalDataStatisticsEN.weekTimeRange) === false) {
        ...
        if (null != pobjgs_TotalDataStatisticsEN.stuScore && undefined !== pobjgs_TotalDataStatisticsEN.stuScore && jsString_js_1.tzDataType.isNumber(pobjgs_TotalDataStatisticsEN.stuScore) === false) {
    ...
    */
    function gs_TotalDataStatistics_CheckProperty4Update(pobjgs_TotalDataStatisticsEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TotalDataStatisticsEN.totalDataId) === true) {
    ...
    */
    function gs_TotalDataStatistics_GetCombineCondition(objgs_TotalDataStatistics_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TotalDataId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TotalDataId, objgs_TotalDataStatistics_Cond.totalDataId, strComparisonOp_TotalDataId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_id_CurrEduCls, objgs_TotalDataStatistics_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TotalDataTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TotalDataTypeId, objgs_TotalDataStatistics_Cond.totalDataTypeId, strComparisonOp_TotalDataTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TableKey) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TableKey, objgs_TotalDataStatistics_Cond.tableKey, strComparisonOp_TableKey);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_DataUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_DataUser, objgs_TotalDataStatistics_Cond.dataUser, strComparisonOp_DataUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_DataAddDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_DataAddDate, objgs_TotalDataStatistics_Cond.dataAddDate, strComparisonOp_DataAddDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_Month) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_Month, objgs_TotalDataStatistics_Cond.month, strComparisonOp_Month);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_Week) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_Week, objgs_TotalDataStatistics_Cond.week, strComparisonOp_Week);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_UpdDate, objgs_TotalDataStatistics_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_UpdUser, objgs_TotalDataStatistics_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_Memo, objgs_TotalDataStatistics_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_score, objgs_TotalDataStatistics_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_TeaScore, objgs_TotalDataStatistics_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_WeekTimeRange) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_WeekTimeRange, objgs_TotalDataStatistics_Cond.weekTimeRange, strComparisonOp_WeekTimeRange);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataStatistics_Cond.dicFldComparisonOp, clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TotalDataStatisticsEN_js_1.clsgs_TotalDataStatisticsEN.con_StuScore, objgs_TotalDataStatistics_Cond.stuScore, strComparisonOp_StuScore);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_TotalDataStatistics_GetUniCondStr_TotalDataTypeId_TableKey(objgs_TotalDataStatisticsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and TotalDataTypeId = '{0}'", objgs_TotalDataStatisticsEN.totalDataTypeId);
        strWhereCond += (0, clsString_js_1.Format)(" and TableKey = '{0}'", objgs_TotalDataStatisticsEN.tableKey);
        return strWhereCond;
    }
    ...
    **/
    function gs_TotalDataStatistics_GetUniCondStr4Update_TotalDataTypeId_TableKey(objgs_TotalDataStatisticsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and TotalDataId <> '{0}'", objgs_TotalDataStatisticsEN.totalDataId);
        strWhereCond += (0, clsString_js_1.Format)(" and TotalDataTypeId = '{0}'", objgs_TotalDataStatisticsEN.totalDataTypeId);
        strWhereCond += (0, clsString_js_1.Format)(" and TableKey = '{0}'", objgs_TotalDataStatisticsEN.tableKey);
        return strWhereCond;
    }
