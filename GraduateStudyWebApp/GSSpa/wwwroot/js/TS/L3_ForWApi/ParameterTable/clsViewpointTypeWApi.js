...
(function (factory) {
    ...
    **/
    async function ViewpointType_GetObjByViewpointTypeIdAsync(strViewpointTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strViewpointTypeId]不能为空！(In GetObjByViewpointTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointTypeId.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strViewpointTypeId]的长度:[{0}]不正确！", strViewpointTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpointType_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpointType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpointType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ViewpointType_GetObjByViewpointTypeId_Cache(strViewpointTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strViewpointTypeId]不能为空！(In GetObjByViewpointTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointTypeId.length != 4) {
    ...
    */
    async function ViewpointType_GetObjByViewpointTypeId_localStorage(strViewpointTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strViewpointTypeId]不能为空！(In GetObjByViewpointTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointTypeId.length != 4) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsViewpointTypeEN_js_1.clsViewpointTypeEN._CurrTabName, strViewpointTypeId);
        if (strKey == "") {
    ...
    */
    async function ViewpointType_GetNameByViewpointTypeId_Cache(strViewpointTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strViewpointTypeId]不能为空！(In GetNameByViewpointTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointTypeId.length != 4) {
    ...
    */
    async function ViewpointType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsViewpointTypeEN_js_1.clsViewpointTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsViewpointTypeEN_js_1.clsViewpointTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function ViewpointType_GetObjLst_ClientCache() {
        ...
        clsViewpointTypeEN_js_1.clsViewpointTypeEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsViewpointTypeEN_js_1.clsViewpointTypeEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsViewpointTypeEN_js_1.clsViewpointTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsViewpointTypeEN_js_1.clsViewpointTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrViewpointTypeExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrViewpointTypeExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ViewpointType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointTypeExObjLst.length);
            console.log(strInfo);
            return arrViewpointTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ViewpointType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointTypeExObjLst.length);
            console.log(strInfo);
            return arrViewpointTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ViewpointType_DelRecordAsync(strViewpointTypeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strViewpointTypeId);
        try {
    ...
    **/
    async function ViewpointType_UpdateRecordAsync(objViewpointTypeEN) {
        ...
        if (objViewpointTypeEN.sf_UpdFldSetStr === undefined || objViewpointTypeEN.sf_UpdFldSetStr === null || objViewpointTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointTypeEN.viewpointTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpointType_Controller, strAction);
        try {
    ...
    */
    async function ViewpointType_IsExistRecord_Cache(objViewpointType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objViewpointType_Cond), exports.viewpointType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ViewpointType_IsExist_Cache(strViewpointTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strViewpointTypeId, exports.viewpointType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function ViewpointType__Cache(strDivName, strDdlName) {
    ...
    exports.ViewpointType__Cache = ViewpointType__Cache;
    /**
    ...
    */
    function ViewpointType_CheckPropertyNew(pobjViewpointTypeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.viewpointTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointTypeEN.viewpointTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.viewpointTypeName) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointTypeEN.viewpointTypeName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.viewpointTypeId) == false && undefined !== pobjViewpointTypeEN.viewpointTypeId && jsString_js_1.tzDataType.isString(pobjViewpointTypeEN.viewpointTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.viewpointTypeName) == false && undefined !== pobjViewpointTypeEN.viewpointTypeName && jsString_js_1.tzDataType.isString(pobjViewpointTypeEN.viewpointTypeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.memo) == false && undefined !== pobjViewpointTypeEN.memo && jsString_js_1.tzDataType.isString(pobjViewpointTypeEN.memo) === false) {
    ...
    */
    function ViewpointType_CheckProperty4Update(pobjViewpointTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointTypeEN.viewpointTypeId) === true
    ...
    */
    function ViewpointType_GetCombineCondition(objViewpointType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpointType_Cond.dicFldComparisonOp, clsViewpointTypeEN_js_1.clsViewpointTypeEN.con_ViewpointTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointTypeEN_js_1.clsViewpointTypeEN.con_ViewpointTypeId, objViewpointType_Cond.viewpointTypeId, strComparisonOp_ViewpointTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointType_Cond.dicFldComparisonOp, clsViewpointTypeEN_js_1.clsViewpointTypeEN.con_ViewpointTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointTypeEN_js_1.clsViewpointTypeEN.con_ViewpointTypeName, objViewpointType_Cond.viewpointTypeName, strComparisonOp_ViewpointTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointType_Cond.dicFldComparisonOp, clsViewpointTypeEN_js_1.clsViewpointTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointTypeEN_js_1.clsViewpointTypeEN.con_Memo, objViewpointType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function ViewpointType_GetUniCondStr_ViewpointTypeName(objViewpointTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointTypeName = '{0}'", objViewpointTypeEN.viewpointTypeName);
        return strWhereCond;
    }
    ...
    **/
    function ViewpointType_GetUniCondStr4Update_ViewpointTypeName(objViewpointTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointTypeId <> '{0}'", objViewpointTypeEN.viewpointTypeId);
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointTypeName = '{0}'", objViewpointTypeEN.viewpointTypeName);
        return strWhereCond;
    }
