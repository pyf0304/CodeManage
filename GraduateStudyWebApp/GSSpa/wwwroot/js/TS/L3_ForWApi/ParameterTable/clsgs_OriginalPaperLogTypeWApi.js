...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/ParameterTable/clsgs_OriginalPaperLogTypeEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_OriginalPaperLogType_GetObjByLogTypeIdAsync(strLogTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strLogTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strLogTypeId]不能为空！(In GetObjByLogTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLogTypeId.length != 2) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strLogTypeId]的长度:[{0}]不正确！", strLogTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_OriginalPaperLogType_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_OriginalPaperLogType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_OriginalPaperLogType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function gs_OriginalPaperLogType_DelRecordAsync(strLogTypeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strLogTypeId);
        try {
    ...
    **/
    async function gs_OriginalPaperLogType_UpdateRecordAsync(objgs_OriginalPaperLogTypeEN) {
        ...
        if (objgs_OriginalPaperLogTypeEN.sf_UpdFldSetStr === undefined || objgs_OriginalPaperLogTypeEN.sf_UpdFldSetStr === null || objgs_OriginalPaperLogTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_OriginalPaperLogTypeEN.logTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_OriginalPaperLogType_Controller, strAction);
        try {
    ...
    */
    function gs_OriginalPaperLogType_CheckPropertyNew(pobjgs_OriginalPaperLogTypeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.logTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogTypeEN.logTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.logTypeName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogTypeEN.logTypeName) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogTypeEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.logTypeId) == false && undefined !== pobjgs_OriginalPaperLogTypeEN.logTypeId && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogTypeEN.logTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.logTypeName) == false && undefined !== pobjgs_OriginalPaperLogTypeEN.logTypeName && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogTypeEN.logTypeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.updUser) == false && undefined !== pobjgs_OriginalPaperLogTypeEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogTypeEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.updDate) == false && undefined !== pobjgs_OriginalPaperLogTypeEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.memo) == false && undefined !== pobjgs_OriginalPaperLogTypeEN.memo && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogTypeEN.memo) === false) {
    ...
    */
    function gs_OriginalPaperLogType_CheckProperty4Update(pobjgs_OriginalPaperLogTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogTypeEN.logTypeId) === true) {
    ...
    */
    function gs_OriginalPaperLogType_GetCombineCondition(objgs_OriginalPaperLogType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLogType_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_LogTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_LogTypeId, objgs_OriginalPaperLogType_Cond.logTypeId, strComparisonOp_LogTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLogType_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_LogTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_LogTypeName, objgs_OriginalPaperLogType_Cond.logTypeName, strComparisonOp_LogTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLogType_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_UpdUser, objgs_OriginalPaperLogType_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLogType_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_UpdDate, objgs_OriginalPaperLogType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLogType_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogTypeEN_js_1.clsgs_OriginalPaperLogTypeEN.con_Memo, objgs_OriginalPaperLogType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_OriginalPaperLogType_GetUniCondStr_LogTypeId(objgs_OriginalPaperLogTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and LogTypeId = '{0}'", objgs_OriginalPaperLogTypeEN.logTypeId);
        return strWhereCond;
    }
