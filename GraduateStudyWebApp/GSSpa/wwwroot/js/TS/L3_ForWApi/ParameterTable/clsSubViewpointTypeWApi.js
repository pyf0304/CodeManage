...
(function (factory) {
    ...
    **/
    async function SubViewpointType_GetObjBySubViewpointTypeIdAsync(strSubViewpointTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSubViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSubViewpointTypeId]不能为空！(In GetObjBySubViewpointTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointTypeId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strSubViewpointTypeId]的长度:[{0}]不正确！", strSubViewpointTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.subViewpointType_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.subViewpointType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.subViewpointType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SubViewpointType_GetObjBySubViewpointTypeId_Cache(strSubViewpointTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSubViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSubViewpointTypeId]不能为空！(In GetObjBySubViewpointTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointTypeId.length != 8) {
        ...
        try {
            ...
            if (arrSubViewpointType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objSubViewpointType = await SubViewpointType_GetObjBySubViewpointTypeIdAsync(strSubViewpointTypeId);
    ...
    */
    async function SubViewpointType_GetObjBySubViewpointTypeId_localStorage(strSubViewpointTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSubViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSubViewpointTypeId]不能为空！(In GetObjBySubViewpointTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointTypeId.length != 8) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN._CurrTabName, strSubViewpointTypeId);
        if (strKey == "") {
    ...
    */
    async function SubViewpointType_GetNameBySubViewpointTypeId_Cache(strSubViewpointTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSubViewpointTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSubViewpointTypeId]不能为空！(In GetNameBySubViewpointTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointTypeId.length != 8) {
    ...
    */
    async function SubViewpointType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function SubViewpointType_GetObjLst_ClientCache() {
        ...
        clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSubViewpointTypeExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrSubViewpointTypeExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSubViewpointTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SubViewpointType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSubViewpointTypeExObjLst.length);
            console.log(strInfo);
            return arrSubViewpointTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SubViewpointType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSubViewpointTypeExObjLst.length);
            console.log(strInfo);
            return arrSubViewpointTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SubViewpointType_DelRecordAsync(strSubViewpointTypeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strSubViewpointTypeId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strSubViewpointTypeId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function SubViewpointType_UpdateRecordAsync(objSubViewpointTypeEN) {
        ...
        if (objSubViewpointTypeEN.sf_UpdFldSetStr === undefined || objSubViewpointTypeEN.sf_UpdFldSetStr === null || objSubViewpointTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSubViewpointTypeEN.subViewpointTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.subViewpointType_Controller, strAction);
        try {
    ...
    */
    async function SubViewpointType_IsExistRecord_Cache(objSubViewpointType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSubViewpointType_Cond), exports.subViewpointType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SubViewpointType_IsExist_Cache(strSubViewpointTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strSubViewpointTypeId, exports.subViewpointType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function SubViewpointType_BindDdl_SubViewpointTypeIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_SubViewpointTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function SubViewpointType_CheckPropertyNew(pobjSubViewpointTypeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.subViewpointTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjSubViewpointTypeEN.subViewpointTypeId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.subViewpointTypeName) == false && (0, clsString_js_1.GetStrLen)(pobjSubViewpointTypeEN.subViewpointTypeName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.defaTitle) == false && (0, clsString_js_1.GetStrLen)(pobjSubViewpointTypeEN.defaTitle) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjSubViewpointTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjSubViewpointTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjSubViewpointTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.subViewpointTypeId) == false && undefined !== pobjSubViewpointTypeEN.subViewpointTypeId && jsString_js_1.tzDataType.isString(pobjSubViewpointTypeEN.subViewpointTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.subViewpointTypeName) == false && undefined !== pobjSubViewpointTypeEN.subViewpointTypeName && jsString_js_1.tzDataType.isString(pobjSubViewpointTypeEN.subViewpointTypeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.defaTitle) == false && undefined !== pobjSubViewpointTypeEN.defaTitle && jsString_js_1.tzDataType.isString(pobjSubViewpointTypeEN.defaTitle) === false) {
        ...
        if (null != pobjSubViewpointTypeEN.orderNum && undefined !== pobjSubViewpointTypeEN.orderNum && jsString_js_1.tzDataType.isNumber(pobjSubViewpointTypeEN.orderNum) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.updDate) == false && undefined !== pobjSubViewpointTypeEN.updDate && jsString_js_1.tzDataType.isString(pobjSubViewpointTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.updUserId) == false && undefined !== pobjSubViewpointTypeEN.updUserId && jsString_js_1.tzDataType.isString(pobjSubViewpointTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.memo) == false && undefined !== pobjSubViewpointTypeEN.memo && jsString_js_1.tzDataType.isString(pobjSubViewpointTypeEN.memo) === false) {
    ...
    */
    function SubViewpointType_CheckProperty4Update(pobjSubViewpointTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSubViewpointTypeEN.subViewpointTypeId) === true
    ...
    */
    function SubViewpointType_GetCombineCondition(objSubViewpointType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_SubViewpointTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_SubViewpointTypeId, objSubViewpointType_Cond.subViewpointTypeId, strComparisonOp_SubViewpointTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_SubViewpointTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_SubViewpointTypeName, objSubViewpointType_Cond.subViewpointTypeName, strComparisonOp_SubViewpointTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_DefaTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_DefaTitle, objSubViewpointType_Cond.defaTitle, strComparisonOp_DefaTitle);
        }
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_OrderNum, objSubViewpointType_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_UpdDate, objSubViewpointType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_UpdUserId, objSubViewpointType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objSubViewpointType_Cond.dicFldComparisonOp, clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_Memo, objSubViewpointType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function SubViewpointType_GetUniCondStr_SubViewpointTypeName(objSubViewpointTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and SubViewpointTypeName = '{0}'", objSubViewpointTypeEN.subViewpointTypeName);
        return strWhereCond;
    }
    ...
    **/
    function SubViewpointType_GetUniCondStr4Update_SubViewpointTypeName(objSubViewpointTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and SubViewpointTypeId <> '{0}'", objSubViewpointTypeEN.subViewpointTypeId);
        strWhereCond += (0, clsString_js_1.Format)(" and SubViewpointTypeName = '{0}'", objSubViewpointTypeEN.subViewpointTypeName);
        return strWhereCond;
    }
