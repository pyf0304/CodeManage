...
(function (factory) {
    ...
    **/
    async function gs_PaperStatus_GetObjByPaperStatusIdAsync(strPaperStatusId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperStatusId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperStatusId]不能为空！(In GetObjByPaperStatusIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperStatusId.length != 2) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strPaperStatusId]的长度:[{0}]不正确！", strPaperStatusId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperStatus_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperStatus_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperStatus_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperStatus_GetObjByPaperStatusId_Cache(strPaperStatusId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperStatusId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperStatusId]不能为空！(In GetObjByPaperStatusId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperStatusId.length != 2) {
    ...
    */
    async function gs_PaperStatus_GetObjByPaperStatusId_localStorage(strPaperStatusId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperStatusId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperStatusId]不能为空！(In GetObjByPaperStatusId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperStatusId.length != 2) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN._CurrTabName, strPaperStatusId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperStatus_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_PaperStatus_GetObjLst_ClientCache() {
        ...
        clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperStatusExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_PaperStatusExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperStatusExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperStatus_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperStatusExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperStatusExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperStatus_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperStatusExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperStatusExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperStatus_DelRecordAsync(strPaperStatusId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strPaperStatusId);
        try {
    ...
    **/
    async function gs_PaperStatus_UpdateRecordAsync(objgs_PaperStatusEN) {
        ...
        if (objgs_PaperStatusEN.sf_UpdFldSetStr === undefined || objgs_PaperStatusEN.sf_UpdFldSetStr === null || objgs_PaperStatusEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperStatusEN.paperStatusId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperStatus_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperStatus_IsExistRecord_Cache(objgs_PaperStatus_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperStatus_Cond), exports.gs_PaperStatus_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperStatus_IsExist_Cache(strPaperStatusId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strPaperStatusId, exports.gs_PaperStatus_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_PaperStatus_CheckPropertyNew(pobjgs_PaperStatusEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.paperStatusId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperStatusEN.paperStatusId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.paperStatusName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperStatusEN.paperStatusName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperStatusEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperStatusEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperStatusEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.paperStatusId) == false && undefined !== pobjgs_PaperStatusEN.paperStatusId && jsString_js_1.tzDataType.isString(pobjgs_PaperStatusEN.paperStatusId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.paperStatusName) == false && undefined !== pobjgs_PaperStatusEN.paperStatusName && jsString_js_1.tzDataType.isString(pobjgs_PaperStatusEN.paperStatusName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.updUser) == false && undefined !== pobjgs_PaperStatusEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_PaperStatusEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.updDate) == false && undefined !== pobjgs_PaperStatusEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_PaperStatusEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.memo) == false && undefined !== pobjgs_PaperStatusEN.memo && jsString_js_1.tzDataType.isString(pobjgs_PaperStatusEN.memo) === false) {
    ...
    */
    function gs_PaperStatus_CheckProperty4Update(pobjgs_PaperStatusEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperStatusEN.paperStatusId) === true) {
    ...
    */
    function gs_PaperStatus_GetCombineCondition(objgs_PaperStatus_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperStatus_Cond.dicFldComparisonOp, clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_PaperStatusId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_PaperStatusId, objgs_PaperStatus_Cond.paperStatusId, strComparisonOp_PaperStatusId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperStatus_Cond.dicFldComparisonOp, clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_PaperStatusName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_PaperStatusName, objgs_PaperStatus_Cond.paperStatusName, strComparisonOp_PaperStatusName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperStatus_Cond.dicFldComparisonOp, clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_UpdUser, objgs_PaperStatus_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperStatus_Cond.dicFldComparisonOp, clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_UpdDate, objgs_PaperStatus_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperStatus_Cond.dicFldComparisonOp, clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperStatusEN_js_1.clsgs_PaperStatusEN.con_Memo, objgs_PaperStatus_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperStatus_GetUniCondStr_PaperStatusId(objgs_PaperStatusEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperStatusId = '{0}'", objgs_PaperStatusEN.paperStatusId);
        return strWhereCond;
    }
