...
(function (factory) {
    ...
    **/
    async function gs_PaperSubViewsAttitudes_GetObjByAttitudesIdAsync(strAttitudesId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAttitudesId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAttitudesId]不能为空！(In GetObjByAttitudesIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAttitudesId.length != 2) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strAttitudesId]的长度:[{0}]不正确！", strAttitudesId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperSubViewsAttitudes_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperSubViewsAttitudes_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperSubViewsAttitudes_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperSubViewsAttitudes_GetObjByAttitudesId_Cache(strAttitudesId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAttitudesId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAttitudesId]不能为空！(In GetObjByAttitudesId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAttitudesId.length != 2) {
        ...
        try {
            ...
            if (arrgs_PaperSubViewsAttitudes_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_PaperSubViewsAttitudes = await gs_PaperSubViewsAttitudes_GetObjByAttitudesIdAsync(strAttitudesId);
    ...
    */
    async function gs_PaperSubViewsAttitudes_GetObjByAttitudesId_localStorage(strAttitudesId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAttitudesId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAttitudesId]不能为空！(In GetObjByAttitudesId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAttitudesId.length != 2) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN._CurrTabName, strAttitudesId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperSubViewsAttitudes_GetNameByAttitudesId_Cache(strAttitudesId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAttitudesId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAttitudesId]不能为空！(In GetNameByAttitudesId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAttitudesId.length != 2) {
    ...
    */
    async function gs_PaperSubViewsAttitudes_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_PaperSubViewsAttitudes_GetObjLst_ClientCache() {
        ...
        clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperSubViewsAttitudesExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_PaperSubViewsAttitudesExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperSubViewsAttitudesExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperSubViewsAttitudes_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperSubViewsAttitudesExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperSubViewsAttitudesExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperSubViewsAttitudes_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperSubViewsAttitudesExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperSubViewsAttitudesExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperSubViewsAttitudes_DelRecordAsync(strAttitudesId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strAttitudesId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strAttitudesId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function gs_PaperSubViewsAttitudes_UpdateRecordAsync(objgs_PaperSubViewsAttitudesEN) {
        ...
        if (objgs_PaperSubViewsAttitudesEN.sf_UpdFldSetStr === undefined || objgs_PaperSubViewsAttitudesEN.sf_UpdFldSetStr === null || objgs_PaperSubViewsAttitudesEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperSubViewsAttitudesEN.attitudesId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperSubViewsAttitudes_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperSubViewsAttitudes_IsExistRecord_Cache(objgs_PaperSubViewsAttitudes_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperSubViewsAttitudes_Cond), exports.gs_PaperSubViewsAttitudes_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperSubViewsAttitudes_IsExist_Cache(strAttitudesId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strAttitudesId, exports.gs_PaperSubViewsAttitudes_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperSubViewsAttitudes_BindDdl_AttitudesIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_AttitudesIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_PaperSubViewsAttitudes_CheckPropertyNew(pobjgs_PaperSubViewsAttitudesEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.attitudesId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperSubViewsAttitudesEN.attitudesId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.attitudesName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperSubViewsAttitudesEN.attitudesName) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperSubViewsAttitudesEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperSubViewsAttitudesEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PaperSubViewsAttitudesEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.attitudesId) == false && undefined !== pobjgs_PaperSubViewsAttitudesEN.attitudesId && jsString_js_1.tzDataType.isString(pobjgs_PaperSubViewsAttitudesEN.attitudesId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.attitudesName) == false && undefined !== pobjgs_PaperSubViewsAttitudesEN.attitudesName && jsString_js_1.tzDataType.isString(pobjgs_PaperSubViewsAttitudesEN.attitudesName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.updUser) == false && undefined !== pobjgs_PaperSubViewsAttitudesEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_PaperSubViewsAttitudesEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.updDate) == false && undefined !== pobjgs_PaperSubViewsAttitudesEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_PaperSubViewsAttitudesEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.memo) == false && undefined !== pobjgs_PaperSubViewsAttitudesEN.memo && jsString_js_1.tzDataType.isString(pobjgs_PaperSubViewsAttitudesEN.memo) === false) {
    ...
    */
    function gs_PaperSubViewsAttitudes_CheckProperty4Update(pobjgs_PaperSubViewsAttitudesEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PaperSubViewsAttitudesEN.attitudesId) === true) {
    ...
    */
    function gs_PaperSubViewsAttitudes_GetCombineCondition(objgs_PaperSubViewsAttitudes_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperSubViewsAttitudes_Cond.dicFldComparisonOp, clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_AttitudesId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_AttitudesId, objgs_PaperSubViewsAttitudes_Cond.attitudesId, strComparisonOp_AttitudesId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperSubViewsAttitudes_Cond.dicFldComparisonOp, clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_AttitudesName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_AttitudesName, objgs_PaperSubViewsAttitudes_Cond.attitudesName, strComparisonOp_AttitudesName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperSubViewsAttitudes_Cond.dicFldComparisonOp, clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_UpdUser, objgs_PaperSubViewsAttitudes_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperSubViewsAttitudes_Cond.dicFldComparisonOp, clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_UpdDate, objgs_PaperSubViewsAttitudes_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperSubViewsAttitudes_Cond.dicFldComparisonOp, clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PaperSubViewsAttitudesEN_js_1.clsgs_PaperSubViewsAttitudesEN.con_Memo, objgs_PaperSubViewsAttitudes_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperSubViewsAttitudes_GetUniCondStr_AttitudesId(objgs_PaperSubViewsAttitudesEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and AttitudesId = '{0}'", objgs_PaperSubViewsAttitudesEN.attitudesId);
        return strWhereCond;
    }
