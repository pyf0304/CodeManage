...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/NewsAnnouncement/clsMessagePushUsersRelationEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function MessagePushUsersRelation_GetObjByMessagePushUsersRelationIdAsync(lngMessagePushUsersRelationId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.messagePushUsersRelation_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.messagePushUsersRelation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.messagePushUsersRelation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function MessagePushUsersRelation_DelRecordAsync(lngMessagePushUsersRelationId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngMessagePushUsersRelationId);
        try {
    ...
    **/
    async function MessagePushUsersRelation_UpdateRecordAsync(objMessagePushUsersRelationEN) {
        ...
        if (objMessagePushUsersRelationEN.sf_UpdFldSetStr === undefined || objMessagePushUsersRelationEN.sf_UpdFldSetStr === null || objMessagePushUsersRelationEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objMessagePushUsersRelationEN.messagePushUsersRelationId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.messagePushUsersRelation_Controller, strAction);
        try {
    ...
    */
    function MessagePushUsersRelation_CheckPropertyNew(pobjMessagePushUsersRelationEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.messagePushId) === true) {
            throw new Error("(errid:Watl000058)字段[消息Id]不能为空(In 消息推送与用户关系)!(clsMessagePushUsersRelationBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.receivePeople) === true) {
            throw new Error("(errid:Watl000058)字段[接收人员]不能为空(In 消息推送与用户关系)!(clsMessagePushUsersRelationBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.messagePushId) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushUsersRelationEN.messagePushId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.receivePeople) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushUsersRelationEN.receivePeople) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.createTime) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushUsersRelationEN.createTime) > 16) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushUsersRelationEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjMessagePushUsersRelationEN.messagePushUsersRelationId && undefined !== pobjMessagePushUsersRelationEN.messagePushUsersRelationId && jsString_js_1.tzDataType.isNumber(pobjMessagePushUsersRelationEN.messagePushUsersRelationId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.messagePushId) == false && undefined !== pobjMessagePushUsersRelationEN.messagePushId && jsString_js_1.tzDataType.isString(pobjMessagePushUsersRelationEN.messagePushId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.receivePeople) == false && undefined !== pobjMessagePushUsersRelationEN.receivePeople && jsString_js_1.tzDataType.isString(pobjMessagePushUsersRelationEN.receivePeople) === false) {
        ...
        if (null != pobjMessagePushUsersRelationEN.isReceive && undefined !== pobjMessagePushUsersRelationEN.isReceive && jsString_js_1.tzDataType.isBoolean(pobjMessagePushUsersRelationEN.isReceive) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.createTime) == false && undefined !== pobjMessagePushUsersRelationEN.createTime && jsString_js_1.tzDataType.isString(pobjMessagePushUsersRelationEN.createTime) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushUsersRelationEN.memo) == false && undefined !== pobjMessagePushUsersRelationEN.memo && jsString_js_1.tzDataType.isString(pobjMessagePushUsersRelationEN.memo) === false) {
    ...
    */
    function MessagePushUsersRelation_GetCombineCondition(objMessagePushUsersRelation_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objMessagePushUsersRelation_Cond.dicFldComparisonOp, clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_MessagePushUsersRelationId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_MessagePushUsersRelationId, objMessagePushUsersRelation_Cond.messagePushUsersRelationId, strComparisonOp_MessagePushUsersRelationId);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePushUsersRelation_Cond.dicFldComparisonOp, clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_MessagePushId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_MessagePushId, objMessagePushUsersRelation_Cond.messagePushId, strComparisonOp_MessagePushId);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePushUsersRelation_Cond.dicFldComparisonOp, clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_ReceivePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_ReceivePeople, objMessagePushUsersRelation_Cond.receivePeople, strComparisonOp_ReceivePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePushUsersRelation_Cond.dicFldComparisonOp, clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_IsReceive) == true) {
            if (objMessagePushUsersRelation_Cond.isReceive == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_IsReceive);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_IsReceive);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePushUsersRelation_Cond.dicFldComparisonOp, clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_CreateTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_CreateTime, objMessagePushUsersRelation_Cond.createTime, strComparisonOp_CreateTime);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePushUsersRelation_Cond.dicFldComparisonOp, clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushUsersRelationEN_js_1.clsMessagePushUsersRelationEN.con_Memo, objMessagePushUsersRelation_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function MessagePushUsersRelation_GetUniCondStr_MessagePushId_ReceivePeople(objMessagePushUsersRelationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and messagePushId = '{0}'", objMessagePushUsersRelationEN.messagePushId);
        strWhereCond += (0, clsString_js_1.Format)(" and receivePeople = '{0}'", objMessagePushUsersRelationEN.receivePeople);
        return strWhereCond;
    }
    ...
    **/
    function MessagePushUsersRelation_GetUniCondStr4Update_MessagePushId_ReceivePeople(objMessagePushUsersRelationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and MessagePushUsersRelationId <> '{0}'", objMessagePushUsersRelationEN.messagePushUsersRelationId);
        strWhereCond += (0, clsString_js_1.Format)(" and messagePushId = '{0}'", objMessagePushUsersRelationEN.messagePushId);
        strWhereCond += (0, clsString_js_1.Format)(" and receivePeople = '{0}'", objMessagePushUsersRelationEN.receivePeople);
        return strWhereCond;
    }
