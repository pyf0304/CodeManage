...
(function (factory) {
    ...
    async function MessagePush_GetObjByMessagePushIdAsync(strMessagePushId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.messagePush_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.messagePush_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.messagePush_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function MessagePush_DelRecordAsync(strMessagePushId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strMessagePushId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strMessagePushId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function MessagePush_UpdateRecordAsync(objMessagePushEN) {
        ...
        if (objMessagePushEN.sf_UpdFldSetStr === undefined || objMessagePushEN.sf_UpdFldSetStr === null || objMessagePushEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objMessagePushEN.messagePushId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.messagePush_Controller, strAction);
        try {
    ...
    */
    function MessagePush_CheckPropertyNew(pobjMessagePushEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[消息类型Id]不能为空(In 消息推送)!(clsMessagePushBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messagePushId) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.messagePushId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messagePushNumber) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.messagePushNumber) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageTitle) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.messageTitle) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageContent) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.messageContent) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.receivePeople) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.receivePeople) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.messageTypeId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.clientVersionTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.clientVersionTypeId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjMessagePushEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messagePushId) == false && undefined !== pobjMessagePushEN.messagePushId && jsString_js_1.tzDataType.isString(pobjMessagePushEN.messagePushId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messagePushNumber) == false && undefined !== pobjMessagePushEN.messagePushNumber && jsString_js_1.tzDataType.isString(pobjMessagePushEN.messagePushNumber) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageTitle) == false && undefined !== pobjMessagePushEN.messageTitle && jsString_js_1.tzDataType.isString(pobjMessagePushEN.messageTitle) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageContent) == false && undefined !== pobjMessagePushEN.messageContent && jsString_js_1.tzDataType.isString(pobjMessagePushEN.messageContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.receivePeople) == false && undefined !== pobjMessagePushEN.receivePeople && jsString_js_1.tzDataType.isString(pobjMessagePushEN.receivePeople) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messageTypeId) == false && undefined !== pobjMessagePushEN.messageTypeId && jsString_js_1.tzDataType.isString(pobjMessagePushEN.messageTypeId) === false) {
        ...
        if (null != pobjMessagePushEN.isAllpush && undefined !== pobjMessagePushEN.isAllpush && jsString_js_1.tzDataType.isBoolean(pobjMessagePushEN.isAllpush) === false) {
        ...
        if (null != pobjMessagePushEN.isReceive && undefined !== pobjMessagePushEN.isReceive && jsString_js_1.tzDataType.isBoolean(pobjMessagePushEN.isReceive) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.clientVersionTypeId) == false && undefined !== pobjMessagePushEN.clientVersionTypeId && jsString_js_1.tzDataType.isString(pobjMessagePushEN.clientVersionTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.updDate) == false && undefined !== pobjMessagePushEN.updDate && jsString_js_1.tzDataType.isString(pobjMessagePushEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.memo) == false && undefined !== pobjMessagePushEN.memo && jsString_js_1.tzDataType.isString(pobjMessagePushEN.memo) === false) {
    ...
    */
    function MessagePush_CheckProperty4Update(pobjMessagePushEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjMessagePushEN.messagePushId) === true) {
    ...
    */
    function MessagePush_GetCombineCondition(objMessagePush_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_MessagePushId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_MessagePushId, objMessagePush_Cond.messagePushId, strComparisonOp_MessagePushId);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_MessagePushNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_MessagePushNumber, objMessagePush_Cond.messagePushNumber, strComparisonOp_MessagePushNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_MessageTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_MessageTitle, objMessagePush_Cond.messageTitle, strComparisonOp_MessageTitle);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_MessageContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_MessageContent, objMessagePush_Cond.messageContent, strComparisonOp_MessageContent);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_ReceivePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_ReceivePeople, objMessagePush_Cond.receivePeople, strComparisonOp_ReceivePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_MessageTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_MessageTypeId, objMessagePush_Cond.messageTypeId, strComparisonOp_MessageTypeId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_ClientVersionTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_ClientVersionTypeId, objMessagePush_Cond.clientVersionTypeId, strComparisonOp_ClientVersionTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_UpdDate, objMessagePush_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objMessagePush_Cond.dicFldComparisonOp, clsMessagePushEN_js_1.clsMessagePushEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsMessagePushEN_js_1.clsMessagePushEN.con_Memo, objMessagePush_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
