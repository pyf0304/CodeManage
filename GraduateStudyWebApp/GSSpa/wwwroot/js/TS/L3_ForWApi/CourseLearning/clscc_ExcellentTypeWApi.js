...
(function (factory) {
    ...
    **/
    async function cc_ExcellentType_GetObjByExcellentTypeIdAsync(strExcellentTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strExcellentTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strExcellentTypeId]不能为空！(In GetObjByExcellentTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExcellentTypeId.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strExcellentTypeId]的长度:[{0}]不正确！", strExcellentTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cc_ExcellentType_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cc_ExcellentType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cc_ExcellentType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function cc_ExcellentType_GetObjByExcellentTypeId_Cache(strExcellentTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strExcellentTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strExcellentTypeId]不能为空！(In GetObjByExcellentTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExcellentTypeId.length != 4) {
    ...
    */
    async function cc_ExcellentType_GetObjByExcellentTypeId_localStorage(strExcellentTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strExcellentTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strExcellentTypeId]不能为空！(In GetObjByExcellentTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExcellentTypeId.length != 4) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN._CurrTabName, strExcellentTypeId);
        if (strKey == "") {
    ...
    */
    async function cc_ExcellentType_GetNameByExcellentTypeId_Cache(strExcellentTypeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strExcellentTypeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strExcellentTypeId]不能为空！(In GetNameByExcellentTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExcellentTypeId.length != 4) {
    ...
    */
    async function cc_ExcellentType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function cc_ExcellentType_GetObjLst_ClientCache() {
        ...
        clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrcc_ExcellentTypeExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrcc_ExcellentTypeExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_ExcellentTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function cc_ExcellentType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_ExcellentTypeExObjLst.length);
            console.log(strInfo);
            return arrcc_ExcellentTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_ExcellentType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_ExcellentTypeExObjLst.length);
            console.log(strInfo);
            return arrcc_ExcellentTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_ExcellentType_DelRecordAsync(strExcellentTypeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strExcellentTypeId);
        try {
    ...
    **/
    async function cc_ExcellentType_UpdateRecordAsync(objcc_ExcellentTypeEN) {
        ...
        if (objcc_ExcellentTypeEN.sf_UpdFldSetStr === undefined || objcc_ExcellentTypeEN.sf_UpdFldSetStr === null || objcc_ExcellentTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objcc_ExcellentTypeEN.excellentTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cc_ExcellentType_Controller, strAction);
        try {
    ...
    */
    async function cc_ExcellentType_IsExistRecord_Cache(objcc_ExcellentType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objcc_ExcellentType_Cond), exports.cc_ExcellentType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function cc_ExcellentType_IsExist_Cache(strExcellentTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strExcellentTypeId, exports.cc_ExcellentType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function cc_ExcellentType__Cache(strDivName, strDdlName) {
    ...
    exports.cc_ExcellentType__Cache = cc_ExcellentType__Cache;
    /**
    ...
    */
    function cc_ExcellentType_CheckPropertyNew(pobjcc_ExcellentTypeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.excellentTypeName) === true) {
            throw new Error("(errid:Watl000058)字段[精品课程类型名称]不能为空(In 精品课程类型)!(clscc_ExcellentTypeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.excellentTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExcellentTypeEN.excellentTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.excellentTypeName) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExcellentTypeEN.excellentTypeName) > 30) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.id_School) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExcellentTypeEN.id_School) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExcellentTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExcellentTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExcellentTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.excellentTypeId) == false && undefined !== pobjcc_ExcellentTypeEN.excellentTypeId && jsString_js_1.tzDataType.isString(pobjcc_ExcellentTypeEN.excellentTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.excellentTypeName) == false && undefined !== pobjcc_ExcellentTypeEN.excellentTypeName && jsString_js_1.tzDataType.isString(pobjcc_ExcellentTypeEN.excellentTypeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.id_School) == false && undefined !== pobjcc_ExcellentTypeEN.id_School && jsString_js_1.tzDataType.isString(pobjcc_ExcellentTypeEN.id_School) === false) {
        ...
        if (null != pobjcc_ExcellentTypeEN.isUse && undefined !== pobjcc_ExcellentTypeEN.isUse && jsString_js_1.tzDataType.isBoolean(pobjcc_ExcellentTypeEN.isUse) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.updDate) == false && undefined !== pobjcc_ExcellentTypeEN.updDate && jsString_js_1.tzDataType.isString(pobjcc_ExcellentTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.updUserId) == false && undefined !== pobjcc_ExcellentTypeEN.updUserId && jsString_js_1.tzDataType.isString(pobjcc_ExcellentTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.memo) == false && undefined !== pobjcc_ExcellentTypeEN.memo && jsString_js_1.tzDataType.isString(pobjcc_ExcellentTypeEN.memo) === false) {
    ...
    */
    function cc_ExcellentType_CheckProperty4Update(pobjcc_ExcellentTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExcellentTypeEN.excellentTypeId) === true
    ...
    */
    function cc_ExcellentType_GetCombineCondition(objcc_ExcellentType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_ExcellentTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_ExcellentTypeId, objcc_ExcellentType_Cond.excellentTypeId, strComparisonOp_ExcellentTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_ExcellentTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_ExcellentTypeName, objcc_ExcellentType_Cond.excellentTypeName, strComparisonOp_ExcellentTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_id_School) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_id_School, objcc_ExcellentType_Cond.id_School, strComparisonOp_id_School);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_IsUse) == true) {
            if (objcc_ExcellentType_Cond.isUse == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_IsUse);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_IsUse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_UpdDate, objcc_ExcellentType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_UpdUserId, objcc_ExcellentType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExcellentType_Cond.dicFldComparisonOp, clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExcellentTypeEN_js_1.clscc_ExcellentTypeEN.con_Memo, objcc_ExcellentType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
