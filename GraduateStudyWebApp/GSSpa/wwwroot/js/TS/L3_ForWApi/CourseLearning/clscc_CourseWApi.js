...
(function (factory) {
    ...
    async function cc_Course_GetObjByCourseIdAsync(strCourseId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cc_Course_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cc_Course_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cc_Course_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function cc_Course_GetObjByCourseId_localStorage(strCourseId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clscc_CourseEN_js_1.clscc_CourseEN._CurrTabName, strCourseId);
        if (strKey == "") {
    ...
    */
    async function cc_Course_GetNameByCourseId_Cache(strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseId]不能为空！(In GetNameByCourseId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
    ...
    */
    async function cc_Course_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clscc_CourseEN_js_1.clscc_CourseEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clscc_CourseEN_js_1.clscc_CourseEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function cc_Course_GetObjLst_ClientCache() {
        ...
        clscc_CourseEN_js_1.clscc_CourseEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clscc_CourseEN_js_1.clscc_CourseEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clscc_CourseEN_js_1.clscc_CourseEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clscc_CourseEN_js_1.clscc_CourseEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrcc_CourseExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrcc_CourseExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function cc_Course_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_Course_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_Course_DelRecordAsync(strCourseId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strCourseId);
        try {
    ...
    **/
    async function cc_Course_UpdateRecordAsync(objcc_CourseEN) {
        ...
        if (objcc_CourseEN.sf_UpdFldSetStr === undefined || objcc_CourseEN.sf_UpdFldSetStr === null || objcc_CourseEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objcc_CourseEN.courseId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cc_Course_Controller, strAction);
        try {
    ...
    */
    async function cc_Course_IsExistRecord_Cache(objcc_Course_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objcc_Course_Cond), exports.cc_Course_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function cc_Course_IsExist_Cache(strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCourseId, exports.cc_Course_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function cc_Course__Cache(strDivName, strDdlName) {
    ...
    exports.cc_Course__Cache = cc_Course__Cache;
    /**
    ...
    */
    function cc_Course_CheckPropertyNew(pobjcc_CourseEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseName) === true) {
            throw new Error("(errid:Watl000058)字段[课程名称]不能为空(In 课程)!(clscc_CourseBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.courseId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseCode) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.courseCode) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseDescription) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.courseDescription) > 8000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseName) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.courseName) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseTypeID) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.courseTypeID) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.createDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.createDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.excellentTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.excellentTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.operationDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.operationDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.outerLink) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.outerLink) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.themeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.themeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.id_School) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.id_School) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.id_XzMajor) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.id_XzCollege) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseId) == false && undefined !== pobjcc_CourseEN.courseId && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.courseId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseCode) == false && undefined !== pobjcc_CourseEN.courseCode && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.courseCode) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseDescription) == false && undefined !== pobjcc_CourseEN.courseDescription && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.courseDescription) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseName) == false && undefined !== pobjcc_CourseEN.courseName && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.courseName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseTypeID) == false && undefined !== pobjcc_CourseEN.courseTypeID && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.courseTypeID) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.createDate) == false && undefined !== pobjcc_CourseEN.createDate && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.createDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.excellentTypeId) == false && undefined !== pobjcc_CourseEN.excellentTypeId && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.excellentTypeId) === false) {
        ...
        if (null != pobjcc_CourseEN.excellentYear && undefined !== pobjcc_CourseEN.excellentYear && jsString_js_1.tzDataType.isNumber(pobjcc_CourseEN.excellentYear) === false) {
        ...
        if (null != pobjcc_CourseEN.isBuildingCourse && undefined !== pobjcc_CourseEN.isBuildingCourse && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseEN.isBuildingCourse) === false) {
        ...
        if (null != pobjcc_CourseEN.isDoubleLanguageCourse && undefined !== pobjcc_CourseEN.isDoubleLanguageCourse && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseEN.isDoubleLanguageCourse) === false) {
        ...
        if (null != pobjcc_CourseEN.isOpen && undefined !== pobjcc_CourseEN.isOpen && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseEN.isOpen) === false) {
        ...
        if (null != pobjcc_CourseEN.isRecommendedCourse && undefined !== pobjcc_CourseEN.isRecommendedCourse && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseEN.isRecommendedCourse) === false) {
        ...
        if (null != pobjcc_CourseEN.isSelfPropelledCourse && undefined !== pobjcc_CourseEN.isSelfPropelledCourse && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseEN.isSelfPropelledCourse) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.operationDate) == false && undefined !== pobjcc_CourseEN.operationDate && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.operationDate) === false) {
        ...
        if (null != pobjcc_CourseEN.orderNum && undefined !== pobjcc_CourseEN.orderNum && jsString_js_1.tzDataType.isNumber(pobjcc_CourseEN.orderNum) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.outerLink) == false && undefined !== pobjcc_CourseEN.outerLink && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.outerLink) === false) {
        ...
        if (null != pobjcc_CourseEN.viewCount && undefined !== pobjcc_CourseEN.viewCount && jsString_js_1.tzDataType.isNumber(pobjcc_CourseEN.viewCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.themeId) == false && undefined !== pobjcc_CourseEN.themeId && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.themeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.id_School) == false && undefined !== pobjcc_CourseEN.id_School && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.id_School) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.id_XzMajor) == false && undefined !== pobjcc_CourseEN.id_XzMajor && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.id_XzCollege) == false && undefined !== pobjcc_CourseEN.id_XzCollege && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.updDate) == false && undefined !== pobjcc_CourseEN.updDate && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.updUserId) == false && undefined !== pobjcc_CourseEN.updUserId && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.memo) == false && undefined !== pobjcc_CourseEN.memo && jsString_js_1.tzDataType.isString(pobjcc_CourseEN.memo) === false) {
    ...
    */
    function cc_Course_CheckProperty4Update(pobjcc_CourseEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseEN.courseId) === true
    ...
    */
    function cc_Course_GetCombineCondition(objcc_Course_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_CourseId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_CourseId, objcc_Course_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_CourseCode) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_CourseCode, objcc_Course_Cond.courseCode, strComparisonOp_CourseCode);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_CourseDescription) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_CourseDescription, objcc_Course_Cond.courseDescription, strComparisonOp_CourseDescription);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_CourseName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_CourseName, objcc_Course_Cond.courseName, strComparisonOp_CourseName);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_CourseTypeID) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_CourseTypeID, objcc_Course_Cond.courseTypeID, strComparisonOp_CourseTypeID);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_CreateDate, objcc_Course_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_ExcellentTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_ExcellentTypeId, objcc_Course_Cond.excellentTypeId, strComparisonOp_ExcellentTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_ExcellentYear) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseEN_js_1.clscc_CourseEN.con_ExcellentYear, objcc_Course_Cond.excellentYear, strComparisonOp_ExcellentYear);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_IsBuildingCourse) == true) {
            if (objcc_Course_Cond.isBuildingCourse == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsBuildingCourse);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsBuildingCourse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_IsDoubleLanguageCourse) == true) {
            if (objcc_Course_Cond.isDoubleLanguageCourse == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsDoubleLanguageCourse);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsDoubleLanguageCourse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_IsOpen) == true) {
            if (objcc_Course_Cond.isOpen == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsOpen);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsOpen);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_IsRecommendedCourse) == true) {
            if (objcc_Course_Cond.isRecommendedCourse == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsRecommendedCourse);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsRecommendedCourse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_IsSelfPropelledCourse) == true) {
            if (objcc_Course_Cond.isSelfPropelledCourse == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsSelfPropelledCourse);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseEN_js_1.clscc_CourseEN.con_IsSelfPropelledCourse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_OperationDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_OperationDate, objcc_Course_Cond.operationDate, strComparisonOp_OperationDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseEN_js_1.clscc_CourseEN.con_OrderNum, objcc_Course_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_OuterLink) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_OuterLink, objcc_Course_Cond.outerLink, strComparisonOp_OuterLink);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_ViewCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseEN_js_1.clscc_CourseEN.con_ViewCount, objcc_Course_Cond.viewCount, strComparisonOp_ViewCount);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_ThemeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_ThemeId, objcc_Course_Cond.themeId, strComparisonOp_ThemeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_id_School) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_id_School, objcc_Course_Cond.id_School, strComparisonOp_id_School);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_id_XzMajor, objcc_Course_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_id_XzCollege, objcc_Course_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_UpdDate, objcc_Course_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_UpdUserId, objcc_Course_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_Course_Cond.dicFldComparisonOp, clscc_CourseEN_js_1.clscc_CourseEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseEN_js_1.clscc_CourseEN.con_Memo, objcc_Course_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function cc_Course_GetUniCondStr_CourseId(objcc_CourseEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and CourseId = '{0}'", objcc_CourseEN.courseId);
        return strWhereCond;
    }
