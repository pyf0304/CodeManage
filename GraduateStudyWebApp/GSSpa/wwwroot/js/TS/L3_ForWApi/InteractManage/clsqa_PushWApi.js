...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/InteractManage/clsqa_PushEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function qa_Push_GetObjByPushIdAsync(lngPushId) {
        ...
        if (lngPushId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPushId]不能为空！(In GetObjByPushIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.qa_Push_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.qa_Push_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.qa_Push_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function qa_Push_DelRecordAsync(lngPushId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngPushId);
        try {
    ...
    **/
    async function qa_Push_UpdateRecordAsync(objqa_PushEN) {
        ...
        if (objqa_PushEN.sf_UpdFldSetStr === undefined || objqa_PushEN.sf_UpdFldSetStr === null || objqa_PushEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objqa_PushEN.pushId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.qa_Push_Controller, strAction);
        try {
    ...
    */
    function qa_Push_CheckPropertyNew(pobjqa_PushEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.questionsId) === true) {
            throw new Error("(errid:Watl000058)字段[提问Id]不能为空(In 答疑推送)!(clsqa_PushBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.questionsId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.questionsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.receiveUser) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.receiveUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.receiveDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.receiveDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.replyDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_PushEN.replyDate) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjqa_PushEN.pushId && undefined !== pobjqa_PushEN.pushId && jsString_js_1.tzDataType.isNumber(pobjqa_PushEN.pushId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.questionsId) == false && undefined !== pobjqa_PushEN.questionsId && jsString_js_1.tzDataType.isString(pobjqa_PushEN.questionsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.receiveUser) == false && undefined !== pobjqa_PushEN.receiveUser && jsString_js_1.tzDataType.isString(pobjqa_PushEN.receiveUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.receiveDate) == false && undefined !== pobjqa_PushEN.receiveDate && jsString_js_1.tzDataType.isString(pobjqa_PushEN.receiveDate) === false) {
        ...
        if (null != pobjqa_PushEN.isReceive && undefined !== pobjqa_PushEN.isReceive && jsString_js_1.tzDataType.isBoolean(pobjqa_PushEN.isReceive) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.updDate) == false && undefined !== pobjqa_PushEN.updDate && jsString_js_1.tzDataType.isString(pobjqa_PushEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.memo) == false && undefined !== pobjqa_PushEN.memo && jsString_js_1.tzDataType.isString(pobjqa_PushEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.id_CurrEduCls) == false && undefined !== pobjqa_PushEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjqa_PushEN.id_CurrEduCls) === false) {
        ...
        if (null != pobjqa_PushEN.isReply && undefined !== pobjqa_PushEN.isReply && jsString_js_1.tzDataType.isBoolean(pobjqa_PushEN.isReply) === false) {
        ...
        if (null != pobjqa_PushEN.isRequestReply && undefined !== pobjqa_PushEN.isRequestReply && jsString_js_1.tzDataType.isBoolean(pobjqa_PushEN.isRequestReply) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_PushEN.replyDate) == false && undefined !== pobjqa_PushEN.replyDate && jsString_js_1.tzDataType.isString(pobjqa_PushEN.replyDate) === false) {
    ...
    */
    function qa_Push_GetCombineCondition(objqa_Push_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_PushId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_PushEN_js_1.clsqa_PushEN.con_PushId, objqa_Push_Cond.pushId, strComparisonOp_PushId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_QuestionsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_QuestionsId, objqa_Push_Cond.questionsId, strComparisonOp_QuestionsId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_ReceiveUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_ReceiveUser, objqa_Push_Cond.receiveUser, strComparisonOp_ReceiveUser);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_ReceiveDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_ReceiveDate, objqa_Push_Cond.receiveDate, strComparisonOp_ReceiveDate);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_IsReceive) == true) {
            if (objqa_Push_Cond.isReceive == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_PushEN_js_1.clsqa_PushEN.con_IsReceive);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_PushEN_js_1.clsqa_PushEN.con_IsReceive);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_UpdDate, objqa_Push_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_Memo, objqa_Push_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_id_CurrEduCls, objqa_Push_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_IsReply) == true) {
            if (objqa_Push_Cond.isReply == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_PushEN_js_1.clsqa_PushEN.con_IsReply);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_PushEN_js_1.clsqa_PushEN.con_IsReply);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_IsRequestReply) == true) {
            if (objqa_Push_Cond.isRequestReply == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_PushEN_js_1.clsqa_PushEN.con_IsRequestReply);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_PushEN_js_1.clsqa_PushEN.con_IsRequestReply);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Push_Cond.dicFldComparisonOp, clsqa_PushEN_js_1.clsqa_PushEN.con_ReplyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_PushEN_js_1.clsqa_PushEN.con_ReplyDate, objqa_Push_Cond.replyDate, strComparisonOp_ReplyDate);
        }
        return strWhereCond;
    }
    ...
    **/
    function qa_Push_GetUniCondStr_PushId(objqa_PushEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PushId = '{0}'", objqa_PushEN.pushId);
        return strWhereCond;
    }
