...
(function (factory) {
    ...
    async function qa_Questions_GetObjByQuestionsIdAsync(strQuestionsId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.qa_Questions_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.qa_Questions_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.qa_Questions_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrqa_Questions_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objqa_Questions = await qa_Questions_GetObjByQuestionsIdAsync(strQuestionsId);
    ...
    */
    async function qa_Questions_GetObjByQuestionsId_localStorage(strQuestionsId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN._CurrTabName, strQuestionsId);
        if (strKey == "") {
    ...
    */
    async function qa_Questions_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function qa_Questions_GetObjLst_ClientCache() {
        ...
        clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsqa_QuestionsEN_js_1.clsqa_QuestionsEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrqa_QuestionsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrqa_QuestionsExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_QuestionsExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function qa_Questions_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_QuestionsExObjLst.length);
            console.log(strInfo);
            return arrqa_QuestionsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function qa_Questions_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_QuestionsExObjLst.length);
            console.log(strInfo);
            return arrqa_QuestionsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function qa_Questions_DelRecordAsync(strQuestionsId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strQuestionsId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strQuestionsId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function qa_Questions_UpdateRecordAsync(objqa_QuestionsEN) {
        ...
        if (objqa_QuestionsEN.sf_UpdFldSetStr === undefined || objqa_QuestionsEN.sf_UpdFldSetStr === null || objqa_QuestionsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objqa_QuestionsEN.questionsId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.qa_Questions_Controller, strAction);
        try {
    ...
    */
    async function qa_Questions_IsExistRecord_Cache(objqa_Questions_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objqa_Questions_Cond), exports.qa_Questions_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function qa_Questions_IsExist_Cache(strQuestionsId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strQuestionsId, exports.qa_Questions_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function qa_Questions_CheckPropertyNew(pobjqa_QuestionsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.questionsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.qa_PaperId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.qa_PaperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsContent) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.questionsContent) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfContent) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.pdfContent) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfDivLet) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.pdfDivLet) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfDivTop) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.pdfDivTop) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfPageNumIn) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.pdfPageNumIn) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfZoom) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.pdfZoom) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.userId) > 20) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过20(In 答疑提问表(qa_Questions))!值:$(pobjqa_QuestionsEN.userId)(clsqa_QuestionsBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.questionsTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.createDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.createDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsId) == false && undefined !== pobjqa_QuestionsEN.questionsId && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.questionsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.qa_PaperId) == false && undefined !== pobjqa_QuestionsEN.qa_PaperId && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.qa_PaperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsContent) == false && undefined !== pobjqa_QuestionsEN.questionsContent && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.questionsContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfContent) == false && undefined !== pobjqa_QuestionsEN.pdfContent && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.pdfContent) === false) {
        ...
        if (null != pobjqa_QuestionsEN.pdfPageNum && undefined !== pobjqa_QuestionsEN.pdfPageNum && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.pdfPageNum) === false) {
        ...
        if (null != pobjqa_QuestionsEN.isDelete && undefined !== pobjqa_QuestionsEN.isDelete && jsString_js_1.tzDataType.isBoolean(pobjqa_QuestionsEN.isDelete) === false) {
        ...
        if (null != pobjqa_QuestionsEN.isPublic && undefined !== pobjqa_QuestionsEN.isPublic && jsString_js_1.tzDataType.isBoolean(pobjqa_QuestionsEN.isPublic) === false) {
        ...
        if (null != pobjqa_QuestionsEN.isEnd && undefined !== pobjqa_QuestionsEN.isEnd && jsString_js_1.tzDataType.isBoolean(pobjqa_QuestionsEN.isEnd) === false) {
        ...
        if (null != pobjqa_QuestionsEN.voteCount && undefined !== pobjqa_QuestionsEN.voteCount && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.voteCount) === false) {
        ...
        if (null != pobjqa_QuestionsEN.answerCount && undefined !== pobjqa_QuestionsEN.answerCount && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.answerCount) === false) {
        ...
        if (null != pobjqa_QuestionsEN.orderNum && undefined !== pobjqa_QuestionsEN.orderNum && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.orderNum) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.updUser) == false && undefined !== pobjqa_QuestionsEN.updUser && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.updDate) == false && undefined !== pobjqa_QuestionsEN.updDate && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.memo) == false && undefined !== pobjqa_QuestionsEN.memo && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfDivLet) == false && undefined !== pobjqa_QuestionsEN.pdfDivLet && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.pdfDivLet) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfDivTop) == false && undefined !== pobjqa_QuestionsEN.pdfDivTop && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.pdfDivTop) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfPageNumIn) == false && undefined !== pobjqa_QuestionsEN.pdfPageNumIn && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.pdfPageNumIn) === false) {
        ...
        if (null != pobjqa_QuestionsEN.pdfPageTop && undefined !== pobjqa_QuestionsEN.pdfPageTop && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.pdfPageTop) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.pdfZoom) == false && undefined !== pobjqa_QuestionsEN.pdfZoom && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.pdfZoom) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.paperId) == false && undefined !== pobjqa_QuestionsEN.paperId && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.userId) == false && undefined !== pobjqa_QuestionsEN.userId && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.userId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsTypeId) == false && undefined !== pobjqa_QuestionsEN.questionsTypeId && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.questionsTypeId) === false) {
        ...
        if (null != pobjqa_QuestionsEN.discussCount && undefined !== pobjqa_QuestionsEN.discussCount && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.discussCount) === false) {
        ...
        if (null != pobjqa_QuestionsEN.groupDiscussCount && undefined !== pobjqa_QuestionsEN.groupDiscussCount && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.groupDiscussCount) === false) {
        ...
        if (null != pobjqa_QuestionsEN.recommendAnswerCount && undefined !== pobjqa_QuestionsEN.recommendAnswerCount && jsString_js_1.tzDataType.isNumber(pobjqa_QuestionsEN.recommendAnswerCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.createDate) == false && undefined !== pobjqa_QuestionsEN.createDate && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.createDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.id_CurrEduCls) == false && undefined !== pobjqa_QuestionsEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjqa_QuestionsEN.id_CurrEduCls) === false) {
    ...
    */
    function qa_Questions_CheckProperty4Update(pobjqa_QuestionsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.userId) > 20) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过20(In 答疑提问表(qa_Questions))!值:$(pobjqa_QuestionsEN.userId)(clsqa_QuestionsBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_QuestionsEN.questionsTypeId) > 2) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_QuestionsEN.questionsId) === true) {
    ...
    */
    function qa_Questions_GetCombineCondition(objqa_Questions_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_QuestionsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_QuestionsId, objqa_Questions_Cond.questionsId, strComparisonOp_QuestionsId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_qa_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_qa_PaperId, objqa_Questions_Cond.qa_PaperId, strComparisonOp_qa_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_QuestionsContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_QuestionsContent, objqa_Questions_Cond.questionsContent, strComparisonOp_QuestionsContent);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfContent, objqa_Questions_Cond.pdfContent, strComparisonOp_PdfContent);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfPageNum, objqa_Questions_Cond.pdfPageNum, strComparisonOp_PdfPageNum);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsDelete) == true) {
            if (objqa_Questions_Cond.isDelete == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsDelete);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsDelete);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsPublic) == true) {
            if (objqa_Questions_Cond.isPublic == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsPublic);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsPublic);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsEnd) == true) {
            if (objqa_Questions_Cond.isEnd == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsEnd);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_IsEnd);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_VoteCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_VoteCount, objqa_Questions_Cond.voteCount, strComparisonOp_VoteCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_AnswerCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_AnswerCount, objqa_Questions_Cond.answerCount, strComparisonOp_AnswerCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_OrderNum, objqa_Questions_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_UpdUser, objqa_Questions_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_UpdDate, objqa_Questions_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_Memo, objqa_Questions_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfDivLet) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfDivLet, objqa_Questions_Cond.pdfDivLet, strComparisonOp_PdfDivLet);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfDivTop) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfDivTop, objqa_Questions_Cond.pdfDivTop, strComparisonOp_PdfDivTop);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfPageNumIn) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfPageNumIn, objqa_Questions_Cond.pdfPageNumIn, strComparisonOp_PdfPageNumIn);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfPageTop) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfPageTop, objqa_Questions_Cond.pdfPageTop, strComparisonOp_PdfPageTop);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfZoom) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PdfZoom, objqa_Questions_Cond.pdfZoom, strComparisonOp_PdfZoom);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_PaperId, objqa_Questions_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_UserId, objqa_Questions_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_QuestionsTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_QuestionsTypeId, objqa_Questions_Cond.questionsTypeId, strComparisonOp_QuestionsTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_DiscussCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_DiscussCount, objqa_Questions_Cond.discussCount, strComparisonOp_DiscussCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_GroupDiscussCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_GroupDiscussCount, objqa_Questions_Cond.groupDiscussCount, strComparisonOp_GroupDiscussCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_RecommendAnswerCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_RecommendAnswerCount, objqa_Questions_Cond.recommendAnswerCount, strComparisonOp_RecommendAnswerCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_CreateDate, objqa_Questions_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Questions_Cond.dicFldComparisonOp, clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_QuestionsEN_js_1.clsqa_QuestionsEN.con_id_CurrEduCls, objqa_Questions_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function qa_Questions_GetUniCondStr_QuestionsId(objqa_QuestionsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and QuestionsId = '{0}'", objqa_QuestionsEN.questionsId);
        return strWhereCond;
    }
