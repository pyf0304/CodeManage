...
(function (factory) {
    ...
    async function gs_Tags_GetObjByTagsIdAsync(strTagsId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_Tags_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_Tags_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_Tags_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_Tags_GetObjByTagsId_Cache(strTagsId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTagsId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTagsId]不能为空！(In GetObjByTagsId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTagsId.length != 10) {
    ...
    */
    async function gs_Tags_GetObjByTagsId_localStorage(strTagsId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTagsId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTagsId]不能为空！(In GetObjByTagsId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTagsId.length != 10) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_TagsEN_js_1.clsgs_TagsEN._CurrTabName, strTagsId);
        if (strKey == "") {
    ...
    */
    async function gs_Tags_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_TagsEN_js_1.clsgs_TagsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_TagsEN_js_1.clsgs_TagsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_Tags_GetObjLst_ClientCache() {
        ...
        clsgs_TagsEN_js_1.clsgs_TagsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_TagsEN_js_1.clsgs_TagsEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_TagsEN_js_1.clsgs_TagsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_TagsEN_js_1.clsgs_TagsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TagsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_TagsExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TagsExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_Tags_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TagsExObjLst.length);
            console.log(strInfo);
            return arrgs_TagsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_Tags_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TagsExObjLst.length);
            console.log(strInfo);
            return arrgs_TagsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_Tags_DelRecordAsync(strTagsId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strTagsId);
        try {
    ...
    **/
    async function gs_Tags_UpdateRecordAsync(objgs_TagsEN) {
        ...
        if (objgs_TagsEN.sf_UpdFldSetStr === undefined || objgs_TagsEN.sf_UpdFldSetStr === null || objgs_TagsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TagsEN.tagsId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_Tags_Controller, strAction);
        try {
    ...
    */
    async function gs_Tags_IsExistRecord_Cache(objgs_Tags_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_Tags_Cond), exports.gs_Tags_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_Tags_IsExist_Cache(strTagsId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTagsId, exports.gs_Tags_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_Tags_CheckPropertyNew(pobjgs_TagsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.tagsId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.tagsId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfContent) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfContent) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfX) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfX) > 50) {
            throw new Error("(errid:Watl000059)字段[PdfX(pdfX)]的长度不能超过50(In 标注(gs_Tags))!值:$(pobjgs_TagsEN.pdfX)(clsgs_TagsBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfY) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfY) > 50) {
            throw new Error("(errid:Watl000059)字段[PdfY(pdfY)]的长度不能超过50(In 标注(gs_Tags))!值:$(pobjgs_TagsEN.pdfY)(clsgs_TagsBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.memo) > 1000) {
            throw new Error("(errid:Watl000059)字段[备注(memo)]的长度不能超过1000(In 标注(gs_Tags))!值:$(pobjgs_TagsEN.memo)(clsgs_TagsBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.shareId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.shareId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfPageNumIn) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfPageNumIn) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfDivLet) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfDivLet) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfDivTop) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfDivTop) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfZoom) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.pdfZoom) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.tagsTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TagsEN.tagsTypeId) > 2) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.tagsId) == false && undefined !== pobjgs_TagsEN.tagsId && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.tagsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.tagsContent) == false && undefined !== pobjgs_TagsEN.tagsContent && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.tagsContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfContent) == false && undefined !== pobjgs_TagsEN.pdfContent && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfContent) === false) {
        ...
        if (null != pobjgs_TagsEN.pdfPageNum && undefined !== pobjgs_TagsEN.pdfPageNum && jsString_js_1.tzDataType.isNumber(pobjgs_TagsEN.pdfPageNum) === false) {
        ...
        if (null != pobjgs_TagsEN.voteCount && undefined !== pobjgs_TagsEN.voteCount && jsString_js_1.tzDataType.isNumber(pobjgs_TagsEN.voteCount) === false) {
        ...
        if (null != pobjgs_TagsEN.orderNum && undefined !== pobjgs_TagsEN.orderNum && jsString_js_1.tzDataType.isNumber(pobjgs_TagsEN.orderNum) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.updUser) == false && undefined !== pobjgs_TagsEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.updDate) == false && undefined !== pobjgs_TagsEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.updDate) === false) {
        ...
        if (null != pobjgs_TagsEN.pdfLineNum && undefined !== pobjgs_TagsEN.pdfLineNum && jsString_js_1.tzDataType.isNumber(pobjgs_TagsEN.pdfLineNum) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfX) == false && undefined !== pobjgs_TagsEN.pdfX && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfX) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfY) == false && undefined !== pobjgs_TagsEN.pdfY && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfY) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.memo) == false && undefined !== pobjgs_TagsEN.memo && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.memo) === false) {
            throw new Error("(errid:Watl000060)字段[备注(memo)]的值:[$(pobjgs_TagsEN.memo)], 非法，应该为字符型(In 标注(gs_Tags))!(clsgs_TagsBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.id_CurrEduCls) == false && undefined !== pobjgs_TagsEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.paperId) == false && undefined !== pobjgs_TagsEN.paperId && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.shareId) == false && undefined !== pobjgs_TagsEN.shareId && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.shareId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfPageNumIn) == false && undefined !== pobjgs_TagsEN.pdfPageNumIn && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfPageNumIn) === false) {
        ...
        if (null != pobjgs_TagsEN.pdfPageTop && undefined !== pobjgs_TagsEN.pdfPageTop && jsString_js_1.tzDataType.isNumber(pobjgs_TagsEN.pdfPageTop) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfDivLet) == false && undefined !== pobjgs_TagsEN.pdfDivLet && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfDivLet) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfDivTop) == false && undefined !== pobjgs_TagsEN.pdfDivTop && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfDivTop) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.pdfZoom) == false && undefined !== pobjgs_TagsEN.pdfZoom && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.pdfZoom) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.tagsTypeId) == false && undefined !== pobjgs_TagsEN.tagsTypeId && jsString_js_1.tzDataType.isString(pobjgs_TagsEN.tagsTypeId) === false) {
    ...
    */
    function gs_Tags_CheckProperty4Update(pobjgs_TagsEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TagsEN.tagsId) === true) {
    ...
    */
    function gs_Tags_GetCombineCondition(objgs_Tags_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_TagsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_TagsId, objgs_Tags_Cond.tagsId, strComparisonOp_TagsId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfContent, objgs_Tags_Cond.pdfContent, strComparisonOp_PdfContent);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfPageNum, objgs_Tags_Cond.pdfPageNum, strComparisonOp_PdfPageNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_VoteCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TagsEN_js_1.clsgs_TagsEN.con_VoteCount, objgs_Tags_Cond.voteCount, strComparisonOp_VoteCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TagsEN_js_1.clsgs_TagsEN.con_OrderNum, objgs_Tags_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_UpdUser, objgs_Tags_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_UpdDate, objgs_Tags_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfLineNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfLineNum, objgs_Tags_Cond.pdfLineNum, strComparisonOp_PdfLineNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfX) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfX, objgs_Tags_Cond.pdfX, strComparisonOp_PdfX);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfY) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfY, objgs_Tags_Cond.pdfY, strComparisonOp_PdfY);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_Memo, objgs_Tags_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_id_CurrEduCls, objgs_Tags_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PaperId, objgs_Tags_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_ShareId, objgs_Tags_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfPageNumIn) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfPageNumIn, objgs_Tags_Cond.pdfPageNumIn, strComparisonOp_PdfPageNumIn);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfPageTop) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfPageTop, objgs_Tags_Cond.pdfPageTop, strComparisonOp_PdfPageTop);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfDivLet) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfDivLet, objgs_Tags_Cond.pdfDivLet, strComparisonOp_PdfDivLet);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfDivTop) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfDivTop, objgs_Tags_Cond.pdfDivTop, strComparisonOp_PdfDivTop);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfZoom) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_PdfZoom, objgs_Tags_Cond.pdfZoom, strComparisonOp_PdfZoom);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Tags_Cond.dicFldComparisonOp, clsgs_TagsEN_js_1.clsgs_TagsEN.con_TagsTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TagsEN_js_1.clsgs_TagsEN.con_TagsTypeId, objgs_Tags_Cond.tagsTypeId, strComparisonOp_TagsTypeId);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_Tags_GetUniCondStr_PaperId_TagsId(objgs_TagsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objgs_TagsEN.paperId);
        strWhereCond += (0, clsString_js_1.Format)(" and TagsId = '{0}'", objgs_TagsEN.tagsId);
        return strWhereCond;
    }
