...
(function (factory) {
    ...
    */
    async function vqa_Paper_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvqa_PaperEN_js_1.clsvqa_PaperEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvqa_PaperEN_js_1.clsvqa_PaperEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vqa_Paper_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvqa_PaperEN_js_1.clsvqa_PaperEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvqa_PaperEN_js_1.clsvqa_PaperEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvqa_PaperExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvqa_PaperExObjLst);
