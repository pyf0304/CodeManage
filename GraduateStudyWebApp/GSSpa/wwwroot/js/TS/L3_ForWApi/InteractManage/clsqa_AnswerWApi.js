...
(function (factory) {
    ...
    async function qa_Answer_GetObjByAnswerIdAsync(strAnswerId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.qa_Answer_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.qa_Answer_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.qa_Answer_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrqa_Answer_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objqa_Answer = await qa_Answer_GetObjByAnswerIdAsync(strAnswerId);
    ...
    */
    async function qa_Answer_GetObjByAnswerId_localStorage(strAnswerId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN._CurrTabName, strAnswerId);
        if (strKey == "") {
    ...
    */
    async function qa_Answer_func(strInFldName, strOutFldName, strInValue, strTopicId_C) {
        ...
        if (clsqa_AnswerEN_js_1.clsqa_AnswerEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsqa_AnswerEN_js_1.clsqa_AnswerEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function qa_Answer_GetObjLst_ClientCache(strTopicId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN._CurrTabName, strTopicId);
        clsqa_AnswerEN_js_1.clsqa_AnswerEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsqa_AnswerEN_js_1.clsqa_AnswerEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsqa_AnswerEN_js_1.clsqa_AnswerEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsqa_AnswerEN_js_1.clsqa_AnswerEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrqa_AnswerExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrqa_AnswerExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_AnswerExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function qa_Answer_GetObjLst_localStorage(strTopicId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_AnswerExObjLst.length);
            console.log(strInfo);
            return arrqa_AnswerExObjLst;
        }
        catch (e) {
    ...
    **/
    async function qa_Answer_GetObjLst_sessionStorage(strTopicId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_AnswerExObjLst.length);
            console.log(strInfo);
            return arrqa_AnswerExObjLst;
        }
        catch (e) {
    ...
    **/
    async function qa_Answer_DelRecordAsync(strAnswerId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strAnswerId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strAnswerId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function qa_Answer_UpdateRecordAsync(objqa_AnswerEN) {
        ...
        if (objqa_AnswerEN.sf_UpdFldSetStr === undefined || objqa_AnswerEN.sf_UpdFldSetStr === null || objqa_AnswerEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objqa_AnswerEN.answerId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.qa_Answer_Controller, strAction);
        try {
    ...
    */
    async function qa_Answer_IsExistRecord_Cache(objqa_Answer_Cond, strTopicId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objqa_Answer_Cond), exports.qa_Answer_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function qa_Answer_IsExist_Cache(strAnswerId, strTopicId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strAnswerId, exports.qa_Answer_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function qa_Answer_ReFreshCache(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId]不能为空！(In clsqa_AnswerWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
    ...
    */
    function qa_Answer_CheckPropertyNew(pobjqa_AnswerEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.questionsId) === true) {
            throw new Error("(errid:Watl000058)字段[提问Id]不能为空(In 答疑回答)!(clsqa_AnswerBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.answerId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.answerId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.questionsId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.questionsId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.scoreType) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.scoreType) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.parentId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.parentId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.answerTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.answerTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.createDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.createDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjqa_AnswerEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.answerId) == false && undefined !== pobjqa_AnswerEN.answerId && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.answerId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.questionsId) == false && undefined !== pobjqa_AnswerEN.questionsId && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.questionsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.answerContent) == false && undefined !== pobjqa_AnswerEN.answerContent && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.answerContent) === false) {
        ...
        if (null != pobjqa_AnswerEN.score && undefined !== pobjqa_AnswerEN.score && jsString_js_1.tzDataType.isNumber(pobjqa_AnswerEN.score) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.scoreType) == false && undefined !== pobjqa_AnswerEN.scoreType && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.scoreType) === false) {
        ...
        if (null != pobjqa_AnswerEN.isRight && undefined !== pobjqa_AnswerEN.isRight && jsString_js_1.tzDataType.isBoolean(pobjqa_AnswerEN.isRight) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.parentId) == false && undefined !== pobjqa_AnswerEN.parentId && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.parentId) === false) {
        ...
        if (null != pobjqa_AnswerEN.voteCount && undefined !== pobjqa_AnswerEN.voteCount && jsString_js_1.tzDataType.isNumber(pobjqa_AnswerEN.voteCount) === false) {
        ...
        if (null != pobjqa_AnswerEN.isRecommend && undefined !== pobjqa_AnswerEN.isRecommend && jsString_js_1.tzDataType.isBoolean(pobjqa_AnswerEN.isRecommend) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.topicId) == false && undefined !== pobjqa_AnswerEN.topicId && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.answerTypeId) == false && undefined !== pobjqa_AnswerEN.answerTypeId && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.answerTypeId) === false) {
        ...
        if (null != pobjqa_AnswerEN.isSubmit && undefined !== pobjqa_AnswerEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjqa_AnswerEN.isSubmit) === false) {
        ...
        if (null != pobjqa_AnswerEN.appraiseCount && undefined !== pobjqa_AnswerEN.appraiseCount && jsString_js_1.tzDataType.isNumber(pobjqa_AnswerEN.appraiseCount) === false) {
        ...
        if (null != pobjqa_AnswerEN.stuScore && undefined !== pobjqa_AnswerEN.stuScore && jsString_js_1.tzDataType.isNumber(pobjqa_AnswerEN.stuScore) === false) {
        ...
        if (null != pobjqa_AnswerEN.teaScore && undefined !== pobjqa_AnswerEN.teaScore && jsString_js_1.tzDataType.isNumber(pobjqa_AnswerEN.teaScore) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.createDate) == false && undefined !== pobjqa_AnswerEN.createDate && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.createDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.id_CurrEduCls) == false && undefined !== pobjqa_AnswerEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.updUser) == false && undefined !== pobjqa_AnswerEN.updUser && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.updDate) == false && undefined !== pobjqa_AnswerEN.updDate && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.memo) == false && undefined !== pobjqa_AnswerEN.memo && jsString_js_1.tzDataType.isString(pobjqa_AnswerEN.memo) === false) {
    ...
    */
    function qa_Answer_CheckProperty4Update(pobjqa_AnswerEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjqa_AnswerEN.answerId) === true) {
    ...
    */
    function qa_Answer_GetCombineCondition(objqa_Answer_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_AnswerId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_AnswerId, objqa_Answer_Cond.answerId, strComparisonOp_AnswerId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_QuestionsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_QuestionsId, objqa_Answer_Cond.questionsId, strComparisonOp_QuestionsId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_score, objqa_Answer_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_ScoreType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_ScoreType, objqa_Answer_Cond.scoreType, strComparisonOp_ScoreType);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsRight) == true) {
            if (objqa_Answer_Cond.isRight == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsRight);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsRight);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_ParentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_ParentId, objqa_Answer_Cond.parentId, strComparisonOp_ParentId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_VoteCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_VoteCount, objqa_Answer_Cond.voteCount, strComparisonOp_VoteCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsRecommend) == true) {
            if (objqa_Answer_Cond.isRecommend == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsRecommend);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsRecommend);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_TopicId, objqa_Answer_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_AnswerTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_AnswerTypeId, objqa_Answer_Cond.answerTypeId, strComparisonOp_AnswerTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsSubmit) == true) {
            if (objqa_Answer_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_AppraiseCount, objqa_Answer_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_StuScore, objqa_Answer_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_TeaScore, objqa_Answer_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_CreateDate, objqa_Answer_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_id_CurrEduCls, objqa_Answer_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_UpdUser, objqa_Answer_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_UpdDate, objqa_Answer_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_Answer_Cond.dicFldComparisonOp, clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsqa_AnswerEN_js_1.clsqa_AnswerEN.con_Memo, objqa_Answer_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function qa_Answer_GetUniCondStr_AnswerId(objqa_AnswerEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and AnswerId = '{0}'", objqa_AnswerEN.answerId);
        return strWhereCond;
    }
