...
(function (factory) {
    ...
    **/
    async function cc_ExamPaperStuRelation_GetObjById_ExamPaperStuRelationAsync(lngId_ExamPaperStuRelation) {
        ...
        if (lngId_ExamPaperStuRelation == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngId_ExamPaperStuRelation]不能为空！(In GetObjById_ExamPaperStuRelationAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cc_ExamPaperStuRelation_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cc_ExamPaperStuRelation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cc_ExamPaperStuRelation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function cc_ExamPaperStuRelation_GetObjById_ExamPaperStuRelation_Cache(lngId_ExamPaperStuRelation, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngId_ExamPaperStuRelation == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngId_ExamPaperStuRelation]不能为空！(In GetObjById_ExamPaperStuRelation_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrcc_ExamPaperStuRelation_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objcc_ExamPaperStuRelation = await cc_ExamPaperStuRelation_GetObjById_ExamPaperStuRelationAsync(lngId_ExamPaperStuRelation);
    ...
    */
    async function cc_ExamPaperStuRelation_GetObjById_ExamPaperStuRelation_localStorage(lngId_ExamPaperStuRelation) {
        ...
        if (lngId_ExamPaperStuRelation == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngId_ExamPaperStuRelation]不能为空！(In GetObjById_ExamPaperStuRelation_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN._CurrTabName, lngId_ExamPaperStuRelation);
        if (strKey == "") {
    ...
    */
    async function cc_ExamPaperStuRelation_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function cc_ExamPaperStuRelation_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN._CurrTabName, strid_CurrEduCls);
        clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrcc_ExamPaperStuRelationExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrcc_ExamPaperStuRelationExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_ExamPaperStuRelationExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function cc_ExamPaperStuRelation_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_ExamPaperStuRelationExObjLst.length);
            console.log(strInfo);
            return arrcc_ExamPaperStuRelationExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_ExamPaperStuRelation_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_ExamPaperStuRelationExObjLst.length);
            console.log(strInfo);
            return arrcc_ExamPaperStuRelationExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_ExamPaperStuRelation_DelRecordAsync(lngId_ExamPaperStuRelation) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngId_ExamPaperStuRelation);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": lngId_ExamPaperStuRelation, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function cc_ExamPaperStuRelation_UpdateRecordAsync(objcc_ExamPaperStuRelationEN) {
        ...
        if (objcc_ExamPaperStuRelationEN.sf_UpdFldSetStr === undefined || objcc_ExamPaperStuRelationEN.sf_UpdFldSetStr === null || objcc_ExamPaperStuRelationEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objcc_ExamPaperStuRelationEN.id_ExamPaperStuRelation);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cc_ExamPaperStuRelation_Controller, strAction);
        try {
    ...
    */
    async function cc_ExamPaperStuRelation_IsExistRecord_Cache(objcc_ExamPaperStuRelation_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objcc_ExamPaperStuRelation_Cond), exports.cc_ExamPaperStuRelation_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function cc_ExamPaperStuRelation_IsExist_Cache(lngId_ExamPaperStuRelation, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngId_ExamPaperStuRelation, exports.cc_ExamPaperStuRelation_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function cc_ExamPaperStuRelation_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clscc_ExamPaperStuRelationWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function cc_ExamPaperStuRelation_CheckPropertyNew(pobjcc_ExamPaperStuRelationEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.id_CurrEduCls) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.specifyCompletionDate) === true) {
            throw new Error("(errid:Watl000058)字段[指定完成日期]不能为空(In 考卷与学生关系)!(clscc_ExamPaperStuRelationBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.id_StudentInfo) === true) {
            throw new Error("(errid:Watl000058)字段[学生流水号]不能为空(In 考卷与学生关系)!(clscc_ExamPaperStuRelationBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.workTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[作业类型Id]不能为空(In 考卷与学生关系)!(clscc_ExamPaperStuRelationBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.courseExamPaperId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.courseExamPaperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.specifyCompletionDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.specifyCompletionDate) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.id_StudentInfo) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.id_StudentInfo) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerModeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.answerModeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerOptionId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.answerOptionId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerMultiOptions) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.answerMultiOptions) > 300) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.applySendBackDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.applySendBackDate) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.realFinishDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.realFinishDate) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.operateTime) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.operateTime) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.markerId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.markerId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.markDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.markDate) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.workTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.workTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerIP) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.answerIP) > 30) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.answerDate) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerTime) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.answerTime) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.schoolYear) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.schoolYear) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.schoolTerm) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.schoolTerm) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjcc_ExamPaperStuRelationEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjcc_ExamPaperStuRelationEN.id_ExamPaperStuRelation && undefined !== pobjcc_ExamPaperStuRelationEN.id_ExamPaperStuRelation && jsString_js_1.tzDataType.isNumber(pobjcc_ExamPaperStuRelationEN.id_ExamPaperStuRelation) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.courseExamPaperId) == false && undefined !== pobjcc_ExamPaperStuRelationEN.courseExamPaperId && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.courseExamPaperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.id_CurrEduCls) == false && undefined !== pobjcc_ExamPaperStuRelationEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.id_CurrEduCls) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.scores && undefined !== pobjcc_ExamPaperStuRelationEN.scores && jsString_js_1.tzDataType.isNumber(pobjcc_ExamPaperStuRelationEN.scores) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.specifyCompletionDate) == false && undefined !== pobjcc_ExamPaperStuRelationEN.specifyCompletionDate && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.specifyCompletionDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.id_StudentInfo) == false && undefined !== pobjcc_ExamPaperStuRelationEN.id_StudentInfo && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.id_StudentInfo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerModeId) == false && undefined !== pobjcc_ExamPaperStuRelationEN.answerModeId && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.answerModeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerOptionId) == false && undefined !== pobjcc_ExamPaperStuRelationEN.answerOptionId && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.answerOptionId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerMultiOptions) == false && undefined !== pobjcc_ExamPaperStuRelationEN.answerMultiOptions && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.answerMultiOptions) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.stuAnswerText) == false && undefined !== pobjcc_ExamPaperStuRelationEN.stuAnswerText && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.stuAnswerText) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isPublish && undefined !== pobjcc_ExamPaperStuRelationEN.isPublish && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isPublish) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isLook && undefined !== pobjcc_ExamPaperStuRelationEN.isLook && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isLook) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isSave && undefined !== pobjcc_ExamPaperStuRelationEN.isSave && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isSave) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isSubmit && undefined !== pobjcc_ExamPaperStuRelationEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.applySendBackDate) == false && undefined !== pobjcc_ExamPaperStuRelationEN.applySendBackDate && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.applySendBackDate) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isApplySendBack && undefined !== pobjcc_ExamPaperStuRelationEN.isApplySendBack && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isApplySendBack) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.realFinishDate) == false && undefined !== pobjcc_ExamPaperStuRelationEN.realFinishDate && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.realFinishDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.operateTime) == false && undefined !== pobjcc_ExamPaperStuRelationEN.operateTime && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.operateTime) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.score && undefined !== pobjcc_ExamPaperStuRelationEN.score && jsString_js_1.tzDataType.isNumber(pobjcc_ExamPaperStuRelationEN.score) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.comment) == false && undefined !== pobjcc_ExamPaperStuRelationEN.comment && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.comment) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isMarking && undefined !== pobjcc_ExamPaperStuRelationEN.isMarking && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isMarking) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.markerId) == false && undefined !== pobjcc_ExamPaperStuRelationEN.markerId && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.markerId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.markDate) == false && undefined !== pobjcc_ExamPaperStuRelationEN.markDate && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.markDate) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isSendBack && undefined !== pobjcc_ExamPaperStuRelationEN.isSendBack && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isSendBack) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isInErrorQuestion && undefined !== pobjcc_ExamPaperStuRelationEN.isInErrorQuestion && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isInErrorQuestion) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.workTypeId) == false && undefined !== pobjcc_ExamPaperStuRelationEN.workTypeId && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.workTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerIP) == false && undefined !== pobjcc_ExamPaperStuRelationEN.answerIP && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.answerIP) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerDate) == false && undefined !== pobjcc_ExamPaperStuRelationEN.answerDate && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.answerDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.answerTime) == false && undefined !== pobjcc_ExamPaperStuRelationEN.answerTime && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.answerTime) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isRight && undefined !== pobjcc_ExamPaperStuRelationEN.isRight && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isRight) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isAccessKnowledge && undefined !== pobjcc_ExamPaperStuRelationEN.isAccessKnowledge && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isAccessKnowledge) === false) {
        ...
        if (null != pobjcc_ExamPaperStuRelationEN.isNotProcessTimeout && undefined !== pobjcc_ExamPaperStuRelationEN.isNotProcessTimeout && jsString_js_1.tzDataType.isBoolean(pobjcc_ExamPaperStuRelationEN.isNotProcessTimeout) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.schoolYear) == false && undefined !== pobjcc_ExamPaperStuRelationEN.schoolYear && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.schoolYear) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.schoolTerm) == false && undefined !== pobjcc_ExamPaperStuRelationEN.schoolTerm && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.schoolTerm) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.updDate) == false && undefined !== pobjcc_ExamPaperStuRelationEN.updDate && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.updUserId) == false && undefined !== pobjcc_ExamPaperStuRelationEN.updUserId && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_ExamPaperStuRelationEN.memo) == false && undefined !== pobjcc_ExamPaperStuRelationEN.memo && jsString_js_1.tzDataType.isString(pobjcc_ExamPaperStuRelationEN.memo) === false) {
    ...
    */
    function cc_ExamPaperStuRelation_GetCombineCondition(objcc_ExamPaperStuRelation_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Id_ExamPaperStuRelation) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Id_ExamPaperStuRelation, objcc_ExamPaperStuRelation_Cond.id_ExamPaperStuRelation, strComparisonOp_Id_ExamPaperStuRelation);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_CourseExamPaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_CourseExamPaperId, objcc_ExamPaperStuRelation_Cond.courseExamPaperId, strComparisonOp_CourseExamPaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_id_CurrEduCls, objcc_ExamPaperStuRelation_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Scores) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Scores, objcc_ExamPaperStuRelation_Cond.scores, strComparisonOp_Scores);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_SpecifyCompletionDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_SpecifyCompletionDate, objcc_ExamPaperStuRelation_Cond.specifyCompletionDate, strComparisonOp_SpecifyCompletionDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_id_StudentInfo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_id_StudentInfo, objcc_ExamPaperStuRelation_Cond.id_StudentInfo, strComparisonOp_id_StudentInfo);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerModeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerModeId, objcc_ExamPaperStuRelation_Cond.answerModeId, strComparisonOp_AnswerModeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerOptionId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerOptionId, objcc_ExamPaperStuRelation_Cond.answerOptionId, strComparisonOp_AnswerOptionId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerMultiOptions) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerMultiOptions, objcc_ExamPaperStuRelation_Cond.answerMultiOptions, strComparisonOp_AnswerMultiOptions);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsPublish) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isPublish == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsPublish);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsPublish);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsLook) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isLook == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsLook);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsLook);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSave) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isSave == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSave);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSave);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSubmit) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_ApplySendBackDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_ApplySendBackDate, objcc_ExamPaperStuRelation_Cond.applySendBackDate, strComparisonOp_ApplySendBackDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsApplySendBack) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isApplySendBack == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsApplySendBack);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsApplySendBack);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_RealFinishDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_RealFinishDate, objcc_ExamPaperStuRelation_Cond.realFinishDate, strComparisonOp_RealFinishDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_OperateTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_OperateTime, objcc_ExamPaperStuRelation_Cond.operateTime, strComparisonOp_OperateTime);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Score, objcc_ExamPaperStuRelation_Cond.score, strComparisonOp_Score);
        }
        //数据类型string(text)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsMarking) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isMarking == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsMarking);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsMarking);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_MarkerId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_MarkerId, objcc_ExamPaperStuRelation_Cond.markerId, strComparisonOp_MarkerId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_MarkDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_MarkDate, objcc_ExamPaperStuRelation_Cond.markDate, strComparisonOp_MarkDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSendBack) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isSendBack == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSendBack);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsSendBack);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsInErrorQuestion) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isInErrorQuestion == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsInErrorQuestion);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsInErrorQuestion);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_WorkTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_WorkTypeId, objcc_ExamPaperStuRelation_Cond.workTypeId, strComparisonOp_WorkTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerIP) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerIP, objcc_ExamPaperStuRelation_Cond.answerIP, strComparisonOp_AnswerIP);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerDate, objcc_ExamPaperStuRelation_Cond.answerDate, strComparisonOp_AnswerDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_AnswerTime, objcc_ExamPaperStuRelation_Cond.answerTime, strComparisonOp_AnswerTime);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsRight) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isRight == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsRight);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsRight);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsAccessKnowledge) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isAccessKnowledge == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsAccessKnowledge);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsAccessKnowledge);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsNotProcessTimeout) == true) {
            if (objcc_ExamPaperStuRelation_Cond.isNotProcessTimeout == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsNotProcessTimeout);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_IsNotProcessTimeout);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_SchoolYear) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_SchoolYear, objcc_ExamPaperStuRelation_Cond.schoolYear, strComparisonOp_SchoolYear);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_SchoolTerm) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_SchoolTerm, objcc_ExamPaperStuRelation_Cond.schoolTerm, strComparisonOp_SchoolTerm);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_UpdDate, objcc_ExamPaperStuRelation_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_UpdUserId, objcc_ExamPaperStuRelation_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_ExamPaperStuRelation_Cond.dicFldComparisonOp, clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_ExamPaperStuRelationEN_js_1.clscc_ExamPaperStuRelationEN.con_Memo, objcc_ExamPaperStuRelation_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function cc_ExamPaperStuRelation_GetUniCondStr_CourseExamPaperId_id_StudentInfo_id_CurrEduCls(objcc_ExamPaperStuRelationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and CourseExamPaperId = '{0}'", objcc_ExamPaperStuRelationEN.courseExamPaperId);
        strWhereCond += (0, clsString_js_1.Format)(" and id_StudentInfo = '{0}'", objcc_ExamPaperStuRelationEN.id_StudentInfo);
        strWhereCond += (0, clsString_js_1.Format)(" and id_CurrEduCls = '{0}'", objcc_ExamPaperStuRelationEN.id_CurrEduCls);
        return strWhereCond;
    }
    ...
    **/
    function cc_ExamPaperStuRelation_GetUniCondStr4Update_CourseExamPaperId_id_StudentInfo_id_CurrEduCls(objcc_ExamPaperStuRelationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and Id_ExamPaperStuRelation <> '{0}'", objcc_ExamPaperStuRelationEN.id_ExamPaperStuRelation);
        strWhereCond += (0, clsString_js_1.Format)(" and CourseExamPaperId = '{0}'", objcc_ExamPaperStuRelationEN.courseExamPaperId);
        strWhereCond += (0, clsString_js_1.Format)(" and id_StudentInfo = '{0}'", objcc_ExamPaperStuRelationEN.id_StudentInfo);
        strWhereCond += (0, clsString_js_1.Format)(" and id_CurrEduCls = '{0}'", objcc_ExamPaperStuRelationEN.id_CurrEduCls);
        return strWhereCond;
