...
(function (factory) {
    ...
    async function QxUserRoleRelation_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.qxUserRoleRelation_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.qxUserRoleRelation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.qxUserRoleRelation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function QxUserRoleRelation_GetObjBymId_localStorage(lngmId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function QxUserRoleRelation_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function QxUserRoleRelation_GetObjLst_ClientCache() {
        ...
        clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrQxUserRoleRelationExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrQxUserRoleRelationExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrQxUserRoleRelationExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function QxUserRoleRelation_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrQxUserRoleRelationExObjLst.length);
            console.log(strInfo);
            return arrQxUserRoleRelationExObjLst;
        }
        catch (e) {
    ...
    **/
    async function QxUserRoleRelation_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrQxUserRoleRelationExObjLst.length);
            console.log(strInfo);
            return arrQxUserRoleRelationExObjLst;
        }
        catch (e) {
    ...
    **/
    async function QxUserRoleRelation_UpdateRecordAsync(objQxUserRoleRelationEN) {
        ...
        if (objQxUserRoleRelationEN.sf_UpdFldSetStr === undefined || objQxUserRoleRelationEN.sf_UpdFldSetStr === null || objQxUserRoleRelationEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objQxUserRoleRelationEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.qxUserRoleRelation_Controller, strAction);
        try {
    ...
    */
    async function QxUserRoleRelation_IsExistRecord_Cache(objQxUserRoleRelation_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objQxUserRoleRelation_Cond), exports.qxUserRoleRelation_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function QxUserRoleRelation_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.qxUserRoleRelation_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function QxUserRoleRelation_CheckPropertyNew(pobjQxUserRoleRelationEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.roleId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.qxPrjId) === true) {
            throw new Error("(errid:Watl000058)字段[QxPrjId]不能为空(In Qx用户角色关系)!(clsQxUserRoleRelationBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In Qx用户角色关系)!(clsQxUserRoleRelationBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.userId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.roleId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.roleId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.qxPrjId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.qxPrjId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.questionnaireSetId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.questionnaireSetId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUserRoleRelationEN.updUserId) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjQxUserRoleRelationEN.mId && undefined !== pobjQxUserRoleRelationEN.mId && jsString_js_1.tzDataType.isNumber(pobjQxUserRoleRelationEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.userId) == false && undefined !== pobjQxUserRoleRelationEN.userId && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.userId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.roleId) == false && undefined !== pobjQxUserRoleRelationEN.roleId && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.roleId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.qxPrjId) == false && undefined !== pobjQxUserRoleRelationEN.qxPrjId && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.qxPrjId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.memo) == false && undefined !== pobjQxUserRoleRelationEN.memo && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.questionnaireSetId) == false && undefined !== pobjQxUserRoleRelationEN.questionnaireSetId && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.questionnaireSetId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updDate) == false && undefined !== pobjQxUserRoleRelationEN.updDate && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updUser) == false && undefined !== pobjQxUserRoleRelationEN.updUser && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUserRoleRelationEN.updUserId) == false && undefined !== pobjQxUserRoleRelationEN.updUserId && jsString_js_1.tzDataType.isString(pobjQxUserRoleRelationEN.updUserId) === false) {
    ...
    */
    function QxUserRoleRelation_GetCombineCondition(objQxUserRoleRelation_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_mId, objQxUserRoleRelation_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UserId, objQxUserRoleRelation_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_RoleId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_RoleId, objQxUserRoleRelation_Cond.roleId, strComparisonOp_RoleId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_QxPrjId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_QxPrjId, objQxUserRoleRelation_Cond.qxPrjId, strComparisonOp_QxPrjId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_Memo, objQxUserRoleRelation_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_QuestionnaireSetId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_QuestionnaireSetId, objQxUserRoleRelation_Cond.questionnaireSetId, strComparisonOp_QuestionnaireSetId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UpdDate, objQxUserRoleRelation_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UpdUser, objQxUserRoleRelation_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelation_Cond.dicFldComparisonOp, clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUserRoleRelationEN_js_1.clsQxUserRoleRelationEN.con_UpdUserId, objQxUserRoleRelation_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        return strWhereCond;
    }
    ...
    **/
    function QxUserRoleRelation_GetUniCondStr_RoleId_UserId(objQxUserRoleRelationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and RoleId = '{0}'", objQxUserRoleRelationEN.roleId);
        strWhereCond += (0, clsString_js_1.Format)(" and UserId = '{0}'", objQxUserRoleRelationEN.userId);
        return strWhereCond;
    }
    ...
    **/
    function QxUserRoleRelation_GetUniCondStr4Update_RoleId_UserId(objQxUserRoleRelationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId <> '{0}'", objQxUserRoleRelationEN.mId);
        strWhereCond += (0, clsString_js_1.Format)(" and RoleId = '{0}'", objQxUserRoleRelationEN.roleId);
        strWhereCond += (0, clsString_js_1.Format)(" and UserId = '{0}'", objQxUserRoleRelationEN.userId);
        return strWhereCond;
    }
