...
(function (factory) {
    ...
    **/
    async function PaperAttachment_GetObjByPaperAttachmentIdAsync(lngPaperAttachmentId) {
        ...
        if (lngPaperAttachmentId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperAttachmentId]不能为空！(In GetObjByPaperAttachmentIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperAttachment_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperAttachment_GetObjByPaperAttachmentId_Cache(lngPaperAttachmentId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngPaperAttachmentId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperAttachmentId]不能为空！(In GetObjByPaperAttachmentId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrPaperAttachment_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objPaperAttachment = await PaperAttachment_GetObjByPaperAttachmentIdAsync(lngPaperAttachmentId);
    ...
    */
    async function PaperAttachment_GetObjByPaperAttachmentId_localStorage(lngPaperAttachmentId) {
        ...
        if (lngPaperAttachmentId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperAttachmentId]不能为空！(In GetObjByPaperAttachmentId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN._CurrTabName, lngPaperAttachmentId);
        if (strKey == "") {
    ...
    */
    async function PaperAttachment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function PaperAttachment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN._CurrTabName, strid_CurrEduCls);
        clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsPaperAttachmentEN_js_1.clsPaperAttachmentEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperAttachmentExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrPaperAttachmentExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperAttachmentExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperAttachment_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperAttachmentExObjLst.length);
            console.log(strInfo);
            return arrPaperAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperAttachment_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperAttachmentExObjLst.length);
            console.log(strInfo);
            return arrPaperAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperAttachment_DelRecordAsync(lngPaperAttachmentId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngPaperAttachmentId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": lngPaperAttachmentId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function PaperAttachment_UpdateRecordAsync(objPaperAttachmentEN) {
        ...
        if (objPaperAttachmentEN.sf_UpdFldSetStr === undefined || objPaperAttachmentEN.sf_UpdFldSetStr === null || objPaperAttachmentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperAttachmentEN.paperAttachmentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperAttachment_Controller, strAction);
        try {
    ...
    */
    async function PaperAttachment_IsExistRecord_Cache(objPaperAttachment_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperAttachment_Cond), exports.paperAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperAttachment_IsExist_Cache(lngPaperAttachmentId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperAttachmentId, exports.paperAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function PaperAttachment_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsPaperAttachmentWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function PaperAttachment_CheckPropertyNew(pobjPaperAttachmentEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.filePath) === true) {
            throw new Error("(errid:Watl000058)字段[文件路径]不能为空(In 论文附件)!(clsPaperAttachmentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.paperAttachmentName) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.paperAttachmentName) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.filePath) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.filePath) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjPaperAttachmentEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperAttachmentEN.paperAttachmentId && undefined !== pobjPaperAttachmentEN.paperAttachmentId && jsString_js_1.tzDataType.isNumber(pobjPaperAttachmentEN.paperAttachmentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.paperAttachmentName) == false && undefined !== pobjPaperAttachmentEN.paperAttachmentName && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.paperAttachmentName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.paperId) == false && undefined !== pobjPaperAttachmentEN.paperId && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.filePath) == false && undefined !== pobjPaperAttachmentEN.filePath && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.filePath) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.id_CurrEduCls) == false && undefined !== pobjPaperAttachmentEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.updUserId) == false && undefined !== pobjPaperAttachmentEN.updUserId && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.updDate) == false && undefined !== pobjPaperAttachmentEN.updDate && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperAttachmentEN.memo) == false && undefined !== pobjPaperAttachmentEN.memo && jsString_js_1.tzDataType.isString(pobjPaperAttachmentEN.memo) === false) {
    ...
    */
    function PaperAttachment_GetCombineCondition(objPaperAttachment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_PaperAttachmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_PaperAttachmentId, objPaperAttachment_Cond.paperAttachmentId, strComparisonOp_PaperAttachmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_PaperAttachmentName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_PaperAttachmentName, objPaperAttachment_Cond.paperAttachmentName, strComparisonOp_PaperAttachmentName);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_PaperId, objPaperAttachment_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_FilePath) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_FilePath, objPaperAttachment_Cond.filePath, strComparisonOp_FilePath);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_id_CurrEduCls, objPaperAttachment_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_UpdUserId, objPaperAttachment_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_UpdDate, objPaperAttachment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAttachment_Cond.dicFldComparisonOp, clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperAttachmentEN_js_1.clsPaperAttachmentEN.con_Memo, objPaperAttachment_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperAttachment_GetUniCondStr_PaperAttachmentName_PaperId(objPaperAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperAttachmentName = '{0}'", objPaperAttachmentEN.paperAttachmentName);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objPaperAttachmentEN.paperId);
        return strWhereCond;
    }
    ...
    **/
    function PaperAttachment_GetUniCondStr4Update_PaperAttachmentName_PaperId(objPaperAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperAttachmentId <> '{0}'", objPaperAttachmentEN.paperAttachmentId);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperAttachmentName = '{0}'", objPaperAttachmentEN.paperAttachmentName);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objPaperAttachmentEN.paperId);
        return strWhereCond;
    }
