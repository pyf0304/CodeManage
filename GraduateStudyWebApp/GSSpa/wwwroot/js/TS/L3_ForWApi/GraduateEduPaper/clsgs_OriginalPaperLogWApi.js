...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsgs_OriginalPaperLogEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_OriginalPaperLog_GetObjByPaperLogIdAsync(lngPaperLogId) {
        ...
        if (lngPaperLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperLogId]不能为空！(In GetObjByPaperLogIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_OriginalPaperLog_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_OriginalPaperLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_OriginalPaperLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function gs_OriginalPaperLog_DelRecordAsync(lngPaperLogId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngPaperLogId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": lngPaperLogId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function gs_OriginalPaperLog_UpdateRecordAsync(objgs_OriginalPaperLogEN) {
        ...
        if (objgs_OriginalPaperLogEN.sf_UpdFldSetStr === undefined || objgs_OriginalPaperLogEN.sf_UpdFldSetStr === null || objgs_OriginalPaperLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_OriginalPaperLogEN.paperLogId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_OriginalPaperLog_Controller, strAction);
        try {
    ...
    */
    function gs_OriginalPaperLog_CheckPropertyNew(pobjgs_OriginalPaperLogEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.logTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[日志类型Id]不能为空(In 论文日志表)!(clsgs_OriginalPaperLogBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.logTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogEN.logTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.logDescription) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogEN.logDescription) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_OriginalPaperLogEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_OriginalPaperLogEN.paperLogId && undefined !== pobjgs_OriginalPaperLogEN.paperLogId && jsString_js_1.tzDataType.isNumber(pobjgs_OriginalPaperLogEN.paperLogId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.paperId) == false && undefined !== pobjgs_OriginalPaperLogEN.paperId && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.logTypeId) == false && undefined !== pobjgs_OriginalPaperLogEN.logTypeId && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogEN.logTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.logDescription) == false && undefined !== pobjgs_OriginalPaperLogEN.logDescription && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogEN.logDescription) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.updUser) == false && undefined !== pobjgs_OriginalPaperLogEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.updDate) == false && undefined !== pobjgs_OriginalPaperLogEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_OriginalPaperLogEN.memo) == false && undefined !== pobjgs_OriginalPaperLogEN.memo && jsString_js_1.tzDataType.isString(pobjgs_OriginalPaperLogEN.memo) === false) {
    ...
    */
    function gs_OriginalPaperLog_GetCombineCondition(objgs_OriginalPaperLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_PaperLogId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_PaperLogId, objgs_OriginalPaperLog_Cond.paperLogId, strComparisonOp_PaperLogId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_PaperId, objgs_OriginalPaperLog_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_LogTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_LogTypeId, objgs_OriginalPaperLog_Cond.logTypeId, strComparisonOp_LogTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_LogDescription) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_LogDescription, objgs_OriginalPaperLog_Cond.logDescription, strComparisonOp_LogDescription);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_UpdUser, objgs_OriginalPaperLog_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_UpdDate, objgs_OriginalPaperLog_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_OriginalPaperLog_Cond.dicFldComparisonOp, clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_OriginalPaperLogEN_js_1.clsgs_OriginalPaperLogEN.con_Memo, objgs_OriginalPaperLog_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_OriginalPaperLog_GetUniCondStr_PaperLogId(objgs_OriginalPaperLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperLogId = '{0}'", objgs_OriginalPaperLogEN.paperLogId);
        return strWhereCond;
    }
