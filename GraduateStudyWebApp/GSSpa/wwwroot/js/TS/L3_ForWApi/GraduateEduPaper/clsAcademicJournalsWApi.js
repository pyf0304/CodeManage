...
(function (factory) {
    ...
    **/
    async function AcademicJournals_GetObjByJournalIdAsync(strJournalId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalId]不能为空！(In GetObjByJournalIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalId.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strJournalId]的长度:[{0}]不正确！", strJournalId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.academicJournals_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.academicJournals_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.academicJournals_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function AcademicJournals_GetObjByJournalId_Cache(strJournalId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalId]不能为空！(In GetObjByJournalId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalId.length != 4) {
    ...
    */
    async function AcademicJournals_GetObjByJournalId_localStorage(strJournalId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalId]不能为空！(In GetObjByJournalId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalId.length != 4) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN._CurrTabName, strJournalId);
        if (strKey == "") {
    ...
    */
    async function AcademicJournals_GetNameByJournalId_Cache(strJournalId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalId]不能为空！(In GetNameByJournalId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalId.length != 4) {
    ...
    */
    async function AcademicJournals_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function AcademicJournals_GetObjLst_ClientCache() {
        ...
        clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsAcademicJournalsEN_js_1.clsAcademicJournalsEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrAcademicJournalsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrAcademicJournalsExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrAcademicJournalsExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function AcademicJournals_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrAcademicJournalsExObjLst.length);
            console.log(strInfo);
            return arrAcademicJournalsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function AcademicJournals_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrAcademicJournalsExObjLst.length);
            console.log(strInfo);
            return arrAcademicJournalsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function AcademicJournals_DelRecordAsync(strJournalId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strJournalId);
        try {
    ...
    **/
    async function AcademicJournals_UpdateRecordAsync(objAcademicJournalsEN) {
        ...
        if (objAcademicJournalsEN.sf_UpdFldSetStr === undefined || objAcademicJournalsEN.sf_UpdFldSetStr === null || objAcademicJournalsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objAcademicJournalsEN.journalId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.academicJournals_Controller, strAction);
        try {
    ...
    */
    async function AcademicJournals_IsExistRecord_Cache(objAcademicJournals_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objAcademicJournals_Cond), exports.academicJournals_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function AcademicJournals_IsExist_Cache(strJournalId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strJournalId, exports.academicJournals_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function AcademicJournals_CheckPropertyNew(pobjAcademicJournalsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalName) === true) {
            throw new Error("(errid:Watl000058)字段[期刊名称]不能为空(In 学术期刊)!(clsAcademicJournalsBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalId) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.journalId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalName) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.journalName) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalSubjectCategoryId) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.journalSubjectCategoryId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalSubjectId) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.journalSubjectId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjAcademicJournalsEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalId) == false && undefined !== pobjAcademicJournalsEN.journalId && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.journalId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalName) == false && undefined !== pobjAcademicJournalsEN.journalName && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.journalName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalSubjectCategoryId) == false && undefined !== pobjAcademicJournalsEN.journalSubjectCategoryId && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.journalSubjectCategoryId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalSubjectId) == false && undefined !== pobjAcademicJournalsEN.journalSubjectId && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.journalSubjectId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.updDate) == false && undefined !== pobjAcademicJournalsEN.updDate && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.updUser) == false && undefined !== pobjAcademicJournalsEN.updUser && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.memo) == false && undefined !== pobjAcademicJournalsEN.memo && jsString_js_1.tzDataType.isString(pobjAcademicJournalsEN.memo) === false) {
    ...
    */
    function AcademicJournals_CheckProperty4Update(pobjAcademicJournalsEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjAcademicJournalsEN.journalId) === true) {
    ...
    */
    function AcademicJournals_GetCombineCondition(objAcademicJournals_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalId, objAcademicJournals_Cond.journalId, strComparisonOp_JournalId);
        }
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalName, objAcademicJournals_Cond.journalName, strComparisonOp_JournalName);
        }
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalSubjectCategoryId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalSubjectCategoryId, objAcademicJournals_Cond.journalSubjectCategoryId, strComparisonOp_JournalSubjectCategoryId);
        }
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalSubjectId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_JournalSubjectId, objAcademicJournals_Cond.journalSubjectId, strComparisonOp_JournalSubjectId);
        }
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_UpdDate, objAcademicJournals_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_UpdUser, objAcademicJournals_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objAcademicJournals_Cond.dicFldComparisonOp, clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsAcademicJournalsEN_js_1.clsAcademicJournalsEN.con_Memo, objAcademicJournals_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function AcademicJournals_GetUniCondStr_JournalName(objAcademicJournalsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and JournalName = '{0}'", objAcademicJournalsEN.journalName);
        return strWhereCond;
    }
    ...
    **/
    function AcademicJournals_GetUniCondStr4Update_JournalName(objAcademicJournalsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and JournalId <> '{0}'", objAcademicJournalsEN.journalId);
        strWhereCond += (0, clsString_js_1.Format)(" and JournalName = '{0}'", objAcademicJournalsEN.journalName);
        return strWhereCond;
    }
