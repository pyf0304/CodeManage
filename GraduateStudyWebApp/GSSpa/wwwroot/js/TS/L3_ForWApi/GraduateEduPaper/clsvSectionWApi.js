...
(function (factory) {
    ...
    */
    async function vSection_GetObjBySectionId_Cache(strSectionId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSectionId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSectionId]不能为空！(In GetObjBySectionId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSectionId.length != 8) {
    ...
    */
    async function vSection_GetObjBySectionId_localStorage(strSectionId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSectionId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSectionId]不能为空！(In GetObjBySectionId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSectionId.length != 8) {
    ...
    */
    async function vSection_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvSectionEN_js_1.clsvSectionEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvSectionEN_js_1.clsvSectionEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vSection_GetObjLst_ClientCache() {
        ...
        clsvSectionEN_js_1.clsvSectionEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvSectionEN_js_1.clsvSectionEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvSectionExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvSectionExObjLst);
