...
(function (factory) {
    ...
    **/
    async function PaperReadWrite_GetObjByPaperRWIdAsync(strPaperRWId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperRWId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperRWId]不能为空！(In GetObjByPaperRWIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperRWId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！", strPaperRWId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperReadWrite_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperReadWrite_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperReadWrite_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperReadWrite_GetObjByPaperRWId_Cache(strPaperRWId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperRWId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperRWId]不能为空！(In GetObjByPaperRWId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperRWId.length != 8) {
    ...
    */
    async function PaperReadWrite_GetObjByPaperRWId_localStorage(strPaperRWId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperRWId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperRWId]不能为空！(In GetObjByPaperRWId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperRWId.length != 8) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN._CurrTabName, strPaperRWId);
        if (strKey == "") {
    ...
    */
    async function PaperReadWrite_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function PaperReadWrite_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN._CurrTabName, strid_CurrEduCls);
        clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsPaperReadWriteEN_js_1.clsPaperReadWriteEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperReadWriteExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrPaperReadWriteExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperReadWriteExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperReadWrite_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperReadWriteExObjLst.length);
            console.log(strInfo);
            return arrPaperReadWriteExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperReadWrite_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperReadWriteExObjLst.length);
            console.log(strInfo);
            return arrPaperReadWriteExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperReadWrite_DelRecordAsync(strPaperRWId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strPaperRWId);
        try {
    ...
    **/
    async function PaperReadWrite_UpdateRecordAsync(objPaperReadWriteEN) {
        ...
        if (objPaperReadWriteEN.sf_UpdFldSetStr === undefined || objPaperReadWriteEN.sf_UpdFldSetStr === null || objPaperReadWriteEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperReadWriteEN.paperRWId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperReadWrite_Controller, strAction);
        try {
    ...
    */
    async function PaperReadWrite_IsExistRecord_Cache(objPaperReadWrite_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperReadWrite_Cond), exports.paperReadWrite_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperReadWrite_IsExist_Cache(strPaperRWId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strPaperRWId, exports.paperReadWrite_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function PaperReadWrite_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsPaperReadWriteWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function PaperReadWrite_CheckPropertyNew(pobjPaperReadWriteEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.operationTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[操作类型ID]不能为空(In 论文读写表)!(clsPaperReadWriteBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.updDate) === true) {
            throw new Error("(errid:Watl000058)字段[修改日期]不能为空(In 论文读写表)!(clsPaperReadWriteBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.paperRWId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.paperRWId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.readerId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.readerId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.researchQuestion) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.researchQuestion) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.operationTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.operationTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.submitter) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.submitter) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.createDate) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.createDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.shareId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.shareId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjPaperReadWriteEN.updUser) > 20) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.paperRWId) == false && undefined !== pobjPaperReadWriteEN.paperRWId && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.paperRWId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.readerId) == false && undefined !== pobjPaperReadWriteEN.readerId && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.readerId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.paperId) == false && undefined !== pobjPaperReadWriteEN.paperId && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.researchQuestion) == false && undefined !== pobjPaperReadWriteEN.researchQuestion && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.researchQuestion) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.operationTypeId) == false && undefined !== pobjPaperReadWriteEN.operationTypeId && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.operationTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.updDate) == false && undefined !== pobjPaperReadWriteEN.updDate && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.memo) == false && undefined !== pobjPaperReadWriteEN.memo && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.memo) === false) {
        ...
        if (null != pobjPaperReadWriteEN.isSubmit && undefined !== pobjPaperReadWriteEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjPaperReadWriteEN.isSubmit) === false) {
        ...
        if (null != pobjPaperReadWriteEN.isPublic && undefined !== pobjPaperReadWriteEN.isPublic && jsString_js_1.tzDataType.isBoolean(pobjPaperReadWriteEN.isPublic) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.submitter) == false && undefined !== pobjPaperReadWriteEN.submitter && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.submitter) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.id_CurrEduCls) == false && undefined !== pobjPaperReadWriteEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.id_CurrEduCls) === false) {
        ...
        if (null != pobjPaperReadWriteEN.subVCount && undefined !== pobjPaperReadWriteEN.subVCount && jsString_js_1.tzDataType.isNumber(pobjPaperReadWriteEN.subVCount) === false) {
        ...
        if (null != pobjPaperReadWriteEN.teaCount && undefined !== pobjPaperReadWriteEN.teaCount && jsString_js_1.tzDataType.isNumber(pobjPaperReadWriteEN.teaCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.createDate) == false && undefined !== pobjPaperReadWriteEN.createDate && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.createDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.shareId) == false && undefined !== pobjPaperReadWriteEN.shareId && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.shareId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.updUser) == false && undefined !== pobjPaperReadWriteEN.updUser && jsString_js_1.tzDataType.isString(pobjPaperReadWriteEN.updUser) === false) {
    ...
    */
    function PaperReadWrite_CheckProperty4Update(pobjPaperReadWriteEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperReadWriteEN.paperRWId) === true) {
    ...
    */
    function PaperReadWrite_GetCombineCondition(objPaperReadWrite_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_PaperRWId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_PaperRWId, objPaperReadWrite_Cond.paperRWId, strComparisonOp_PaperRWId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_ReaderId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_ReaderId, objPaperReadWrite_Cond.readerId, strComparisonOp_ReaderId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_PaperId, objPaperReadWrite_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_ResearchQuestion) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_ResearchQuestion, objPaperReadWrite_Cond.researchQuestion, strComparisonOp_ResearchQuestion);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_OperationTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_OperationTypeId, objPaperReadWrite_Cond.operationTypeId, strComparisonOp_OperationTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_UpdDate, objPaperReadWrite_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_Memo, objPaperReadWrite_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_IsSubmit) == true) {
            if (objPaperReadWrite_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_IsPublic) == true) {
            if (objPaperReadWrite_Cond.isPublic == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_IsPublic);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_IsPublic);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_Submitter) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_Submitter, objPaperReadWrite_Cond.submitter, strComparisonOp_Submitter);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_id_CurrEduCls, objPaperReadWrite_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_SubVCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_SubVCount, objPaperReadWrite_Cond.subVCount, strComparisonOp_SubVCount);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_TeaCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_TeaCount, objPaperReadWrite_Cond.teaCount, strComparisonOp_TeaCount);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_CreateDate, objPaperReadWrite_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_ShareId, objPaperReadWrite_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperReadWrite_Cond.dicFldComparisonOp, clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperReadWriteEN_js_1.clsPaperReadWriteEN.con_UpdUser, objPaperReadWrite_Cond.updUser, strComparisonOp_UpdUser);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperReadWrite_GetUniCondStr_ReaderId_PaperId(objPaperReadWriteEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ReaderId = '{0}'", objPaperReadWriteEN.readerId);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objPaperReadWriteEN.paperId);
        return strWhereCond;
    }
    ...
    **/
    function PaperReadWrite_GetUniCondStr4Update_ReaderId_PaperId(objPaperReadWriteEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperRWId <> '{0}'", objPaperReadWriteEN.paperRWId);
        strWhereCond += (0, clsString_js_1.Format)(" and ReaderId = '{0}'", objPaperReadWriteEN.readerId);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objPaperReadWriteEN.paperId);
        return strWhereCond;
    }
