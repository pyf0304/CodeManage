...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/CacheHelper.js", "../../L0_Entity/GraduateEduPaper/clsJournalSubjectEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function JournalSubject_GetObjByJournalSubjectIdAsync(strJournalSubjectId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalSubjectId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalSubjectId]不能为空！(In GetObjByJournalSubjectIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalSubjectId.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strJournalSubjectId]的长度:[{0}]不正确！", strJournalSubjectId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.journalSubject_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.journalSubject_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.journalSubject_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function JournalSubject_GetObjByJournalSubjectId_Cache(strJournalSubjectId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalSubjectId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalSubjectId]不能为空！(In GetObjByJournalSubjectId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalSubjectId.length != 4) {
    ...
    */
    async function JournalSubject_GetObjByJournalSubjectId_localStorage(strJournalSubjectId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalSubjectId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalSubjectId]不能为空！(In GetObjByJournalSubjectId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalSubjectId.length != 4) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsJournalSubjectEN_js_1.clsJournalSubjectEN._CurrTabName, strJournalSubjectId);
        if (strKey == "") {
    ...
    */
    async function JournalSubject_GetNameByJournalSubjectId_Cache(strJournalSubjectId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strJournalSubjectId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strJournalSubjectId]不能为空！(In GetNameByJournalSubjectId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strJournalSubjectId.length != 4) {
    ...
    */
    async function JournalSubject_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsJournalSubjectEN_js_1.clsJournalSubjectEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsJournalSubjectEN_js_1.clsJournalSubjectEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function JournalSubject_GetObjLst_ClientCache() {
        ...
        clsJournalSubjectEN_js_1.clsJournalSubjectEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsJournalSubjectEN_js_1.clsJournalSubjectEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsJournalSubjectEN_js_1.clsJournalSubjectEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsJournalSubjectEN_js_1.clsJournalSubjectEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrJournalSubjectExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrJournalSubjectExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrJournalSubjectExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function JournalSubject_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrJournalSubjectExObjLst.length);
            console.log(strInfo);
            return arrJournalSubjectExObjLst;
        }
        catch (e) {
    ...
    **/
    async function JournalSubject_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrJournalSubjectExObjLst.length);
            console.log(strInfo);
            return arrJournalSubjectExObjLst;
        }
        catch (e) {
    ...
    **/
    async function JournalSubject_DelRecordAsync(strJournalSubjectId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strJournalSubjectId);
        try {
    ...
    **/
    async function JournalSubject_UpdateRecordAsync(objJournalSubjectEN) {
        ...
        if (objJournalSubjectEN.sf_UpdFldSetStr === undefined || objJournalSubjectEN.sf_UpdFldSetStr === null || objJournalSubjectEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objJournalSubjectEN.journalSubjectId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.journalSubject_Controller, strAction);
        try {
    ...
    */
    async function JournalSubject_IsExistRecord_Cache(objJournalSubject_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objJournalSubject_Cond), exports.journalSubject_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function JournalSubject_IsExist_Cache(strJournalSubjectId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strJournalSubjectId, exports.journalSubject_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function JournalSubject_BindDdl_JournalSubjectIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_JournalSubjectIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function JournalSubject_CheckPropertyNew(pobjJournalSubjectEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectCode) === true) {
            throw new Error("(errid:Watl000058)字段[期刊学科代码]不能为空(In 期刊学科)!(clsJournalSubjectBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectName) === true) {
            throw new Error("(errid:Watl000058)字段[期刊学科名称]不能为空(In 期刊学科)!(clsJournalSubjectBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectCategoryId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectId) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.journalSubjectId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectCode) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.journalSubjectCode) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectName) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.journalSubjectName) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectCategoryId) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.journalSubjectCategoryId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjJournalSubjectEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectId) == false && undefined !== pobjJournalSubjectEN.journalSubjectId && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.journalSubjectId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectCode) == false && undefined !== pobjJournalSubjectEN.journalSubjectCode && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.journalSubjectCode) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectName) == false && undefined !== pobjJournalSubjectEN.journalSubjectName && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.journalSubjectName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectCategoryId) == false && undefined !== pobjJournalSubjectEN.journalSubjectCategoryId && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.journalSubjectCategoryId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.updDate) == false && undefined !== pobjJournalSubjectEN.updDate && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.updUser) == false && undefined !== pobjJournalSubjectEN.updUser && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.memo) == false && undefined !== pobjJournalSubjectEN.memo && jsString_js_1.tzDataType.isString(pobjJournalSubjectEN.memo) === false) {
    ...
    */
    function JournalSubject_CheckProperty4Update(pobjJournalSubjectEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjJournalSubjectEN.journalSubjectId) === true
    ...
    */
    function JournalSubject_GetCombineCondition(objJournalSubject_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectId, objJournalSubject_Cond.journalSubjectId, strComparisonOp_JournalSubjectId);
        }
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCode) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCode, objJournalSubject_Cond.journalSubjectCode, strComparisonOp_JournalSubjectCode);
        }
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectName, objJournalSubject_Cond.journalSubjectName, strComparisonOp_JournalSubjectName);
        }
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCategoryId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCategoryId, objJournalSubject_Cond.journalSubjectCategoryId, strComparisonOp_JournalSubjectCategoryId);
        }
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdDate, objJournalSubject_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdUser, objJournalSubject_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objJournalSubject_Cond.dicFldComparisonOp, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_Memo, objJournalSubject_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function JournalSubject_GetUniCondStr_JournalSubjectCategoryId_JournalSubjectName(objJournalSubjectEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and JournalSubjectCategoryId = '{0}'", objJournalSubjectEN.journalSubjectCategoryId);
        strWhereCond += (0, clsString_js_1.Format)(" and JournalSubjectName = '{0}'", objJournalSubjectEN.journalSubjectName);
        return strWhereCond;
    }
    ...
    **/
    function JournalSubject_GetUniCondStr4Update_JournalSubjectCategoryId_JournalSubjectName(objJournalSubjectEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and JournalSubjectId <> '{0}'", objJournalSubjectEN.journalSubjectId);
        strWhereCond += (0, clsString_js_1.Format)(" and JournalSubjectCategoryId = '{0}'", objJournalSubjectEN.journalSubjectCategoryId);
        strWhereCond += (0, clsString_js_1.Format)(" and JournalSubjectName = '{0}'", objJournalSubjectEN.journalSubjectName);
        return strWhereCond;
    }
