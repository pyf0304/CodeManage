...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsgs_PSkillRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function gs_PSkillRela_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PSkillRela_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PSkillRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PSkillRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function gs_PSkillRela_UpdateRecordAsync(objgs_PSkillRelaEN) {
        ...
        if (objgs_PSkillRelaEN.sf_UpdFldSetStr === undefined || objgs_PSkillRelaEN.sf_UpdFldSetStr === null || objgs_PSkillRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PSkillRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PSkillRela_Controller, strAction);
        try {
    ...
    */
    function gs_PSkillRela_CheckPropertyNew(pobjgs_PSkillRelaEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.paperId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.skillId) === true) {
            throw new Error("(errid:Watl000058)字段[技能Id]不能为空(In 论文技能关系)!(clsgs_PSkillRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PSkillRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.sectionId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PSkillRelaEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.skillId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PSkillRelaEN.skillId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PSkillRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PSkillRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PSkillRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_PSkillRelaEN.mId && undefined !== pobjgs_PSkillRelaEN.mId && jsString_js_1.tzDataType.isNumber(pobjgs_PSkillRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.paperId) == false && undefined !== pobjgs_PSkillRelaEN.paperId && jsString_js_1.tzDataType.isString(pobjgs_PSkillRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.sectionId) == false && undefined !== pobjgs_PSkillRelaEN.sectionId && jsString_js_1.tzDataType.isString(pobjgs_PSkillRelaEN.sectionId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.skillId) == false && undefined !== pobjgs_PSkillRelaEN.skillId && jsString_js_1.tzDataType.isString(pobjgs_PSkillRelaEN.skillId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.updDate) == false && undefined !== pobjgs_PSkillRelaEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_PSkillRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.updUser) == false && undefined !== pobjgs_PSkillRelaEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_PSkillRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PSkillRelaEN.memo) == false && undefined !== pobjgs_PSkillRelaEN.memo && jsString_js_1.tzDataType.isString(pobjgs_PSkillRelaEN.memo) === false) {
    ...
    */
    function gs_PSkillRela_GetCombineCondition(objgs_PSkillRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_mId, objgs_PSkillRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_PaperId, objgs_PSkillRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_SectionId, objgs_PSkillRela_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_SkillId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_SkillId, objgs_PSkillRela_Cond.skillId, strComparisonOp_SkillId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_UpdDate, objgs_PSkillRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_UpdUser, objgs_PSkillRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSkillRela_Cond.dicFldComparisonOp, clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PSkillRelaEN_js_1.clsgs_PSkillRelaEN.con_Memo, objgs_PSkillRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PSkillRela_GetUniCondStr_mId(objgs_PSkillRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objgs_PSkillRelaEN.mId);
        return strWhereCond;
    }
