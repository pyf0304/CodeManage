...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsgs_PViewpointRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function gs_PViewpointRela_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PViewpointRela_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PViewpointRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PViewpointRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function gs_PViewpointRela_UpdateRecordAsync(objgs_PViewpointRelaEN) {
        ...
        if (objgs_PViewpointRelaEN.sf_UpdFldSetStr === undefined || objgs_PViewpointRelaEN.sf_UpdFldSetStr === null || objgs_PViewpointRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PViewpointRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PViewpointRela_Controller, strAction);
        try {
    ...
    */
    function gs_PViewpointRela_CheckPropertyNew(pobjgs_PViewpointRelaEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.paperId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.viewpointId) === true) {
            throw new Error("(errid:Watl000058)字段[观点Id]不能为空(In 论文观点关系表)!(clsgs_PViewpointRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.sectionId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.viewpointId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.proposePeople) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.proposePeople) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_PViewpointRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_PViewpointRelaEN.mId && undefined !== pobjgs_PViewpointRelaEN.mId && jsString_js_1.tzDataType.isNumber(pobjgs_PViewpointRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.paperId) == false && undefined !== pobjgs_PViewpointRelaEN.paperId && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.sectionId) == false && undefined !== pobjgs_PViewpointRelaEN.sectionId && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.sectionId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.viewpointId) == false && undefined !== pobjgs_PViewpointRelaEN.viewpointId && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.proposePeople) == false && undefined !== pobjgs_PViewpointRelaEN.proposePeople && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.proposePeople) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.updDate) == false && undefined !== pobjgs_PViewpointRelaEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.updUser) == false && undefined !== pobjgs_PViewpointRelaEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_PViewpointRelaEN.memo) == false && undefined !== pobjgs_PViewpointRelaEN.memo && jsString_js_1.tzDataType.isString(pobjgs_PViewpointRelaEN.memo) === false) {
    ...
    */
    function gs_PViewpointRela_GetCombineCondition(objgs_PViewpointRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_mId, objgs_PViewpointRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_PaperId, objgs_PViewpointRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_SectionId, objgs_PViewpointRela_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_ViewpointId, objgs_PViewpointRela_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_ProposePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_ProposePeople, objgs_PViewpointRela_Cond.proposePeople, strComparisonOp_ProposePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_UpdDate, objgs_PViewpointRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_UpdUser, objgs_PViewpointRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PViewpointRela_Cond.dicFldComparisonOp, clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_PViewpointRelaEN_js_1.clsgs_PViewpointRelaEN.con_Memo, objgs_PViewpointRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PViewpointRela_GetUniCondStr_mId(objgs_PViewpointRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objgs_PViewpointRelaEN.mId);
        return strWhereCond;
    }
    ...
    **/
    function gs_PViewpointRela_GetUniCondStr_PaperId(objgs_PViewpointRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objgs_PViewpointRelaEN.paperId);
        return strWhereCond;
    }
