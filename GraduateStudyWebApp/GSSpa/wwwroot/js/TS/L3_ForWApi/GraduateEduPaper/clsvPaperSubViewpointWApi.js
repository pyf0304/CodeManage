...
(function (factory) {
        ...
        try {
            ...
            if (arrvPaperSubViewpoint_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objvPaperSubViewpoint = await vPaperSubViewpoint_GetObjBySubViewpointIdAsync(strSubViewpointId);
    ...
    */
    async function vPaperSubViewpoint_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvPaperSubViewpointEN_js_1.clsvPaperSubViewpointEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvPaperSubViewpointEN_js_1.clsvPaperSubViewpointEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vPaperSubViewpoint_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvPaperSubViewpointEN_js_1.clsvPaperSubViewpointEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvPaperSubViewpointEN_js_1.clsvPaperSubViewpointEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvPaperSubViewpointExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvPaperSubViewpointExObjLst);
