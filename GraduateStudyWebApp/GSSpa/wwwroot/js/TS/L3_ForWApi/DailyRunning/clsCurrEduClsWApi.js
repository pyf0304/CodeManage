...
(function (factory) {
    ...
    **/
    async function CurrEduCls_GetObjByid_CurrEduClsAsync(strid_CurrEduCls) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.currEduCls_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.currEduCls_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.currEduCls_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
     ...
     * @returns 对象
    */
    async function CurrEduCls_GetObjByid_CurrEduCls_Cache(strid_CurrEduCls, bolTryAsyncOnce = true) {
    ...
    */
    async function CurrEduCls_GetObjByid_CurrEduCls_localStorage(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsCurrEduClsEN_js_1.clsCurrEduClsEN._CurrTabName, strid_CurrEduCls);
        if (strKey == "") {
     ...
     * @returns 对象
    */
    async function CurrEduCls_UpdateObjInLst_Cache(objCurrEduCls) {
     ...
     * @returns 对象
    */
    async function CurrEduCls_GetNameByid_CurrEduCls_Cache(strid_CurrEduCls) {
     ...
     * @returns 返回一个输出字段值
    */
    async function CurrEduCls_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsCurrEduClsEN_js_1.clsCurrEduClsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsCurrEduClsEN_js_1.clsCurrEduClsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function CurrEduCls_GetObjLst_ClientCache() {
        const strThisFuncName = "GetObjLst_ClientCache";
        //初始化列表缓存
        let strWhereCond = "1=1";
        const strKey = clsCurrEduClsEN_js_1.clsCurrEduClsEN._CurrTabName;
        clsCurrEduClsEN_js_1.clsCurrEduClsEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsCurrEduClsEN_js_1.clsCurrEduClsEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsCurrEduClsEN_js_1.clsCurrEduClsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsCurrEduClsEN_js_1.clsCurrEduClsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrCurrEduClsExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrCurrEduClsExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsExObjLst.length);
            console.log(strInfo);
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function CurrEduCls_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsExObjLst.length);
            console.log(strInfo);
            return arrCurrEduClsExObjLst;
        }
        catch (e) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function CurrEduCls_GetObjLst_localStorage_PureCache() {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function CurrEduCls_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsExObjLst.length);
            console.log(strInfo);
            return arrCurrEduClsExObjLst;
        }
        catch (e) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function CurrEduCls_GetObjLst_sessionStorage_PureCache() {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function CurrEduCls_GetObjLst_Cache() {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function CurrEduCls_GetObjLst_PureCache() {
     ...
     * @returns 对象列表子集
    */
    async function CurrEduCls_GetSubObjLst_Cache(objCurrEduCls_Cond) {
    ...
    **/
     ...
     * @returns 对象列表
    */
    async function CurrEduCls_GetObjLstByid_CurrEduClsLst_Cache(arrid_CurrEduClsLst) {
    ...
    */
     ...
     * @returns 对象列表
    */
    async function CurrEduCls_GetObjLstByPager_Cache(objPagerPara) {
    ...
    **/
    async function CurrEduCls_DelRecordAsync(strid_CurrEduCls) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strid_CurrEduCls);
        try {
    ...
    **/
    async function CurrEduCls_UpdateRecordAsync(objCurrEduClsEN) {
        ...
        if (objCurrEduClsEN.sf_UpdFldSetStr === undefined || objCurrEduClsEN.sf_UpdFldSetStr === null || objCurrEduClsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objCurrEduClsEN.id_CurrEduCls);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.currEduCls_Controller, strAction);
        try {
    ...
    **/
     ...
     * @returns 对象列表子集
    */
    async function CurrEduCls_IsExistRecord_Cache(objCurrEduCls_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objCurrEduCls_Cond), exports.currEduCls_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
     ...
     * @returns 对象
    */
    async function CurrEduCls_IsExist_Cache(strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_CurrEduCls, exports.currEduCls_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
     ...
     * @returns 对象列表记录数
    */
    async function CurrEduCls_GetRecCountByCond_Cache(objCurrEduCls_Cond) {
    ...
    **/
    function CurrEduCls_ReFreshCache() {
    ...
    **/
    function CurrEduCls_ReFreshThisCache() {
    ...
    */
    async function CurrEduCls_BindDdl_id_CurrEduClsInDiv_Cache(strDivName, strDdlName) {
        const strThisFuncName = "BindDdl_id_CurrEduClsInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_id_CurrEduClsInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function CurrEduCls_CheckPropertyNew(pobjCurrEduClsEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.currEduClsId) === true) {
            throw new Error("(errid:Watl000058)字段[教学班Id]不能为空(In 当前教学班)!(clsCurrEduClsBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_XzMajor) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.currEduClsId) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.currEduClsId) > 15) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.eduClsName) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.eduClsName) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.eduClsTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.eduClsTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.courseId) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.courseId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.teachingSolutionId) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.teachingSolutionId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_XzCollege) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_XzMajor) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_EduWay) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_EduWay) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_ClassRoomType) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_ClassRoomType) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.weekStatusID) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.weekStatusID) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.customerWeek) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.customerWeek) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_UniZone) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_UniZone) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_GradeBase) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_GradeBase) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.schoolYear) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.schoolYear) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.schoolTerm) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.schoolTerm) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_CourseType) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_CourseType) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_ScoreType) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_ScoreType) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.getScoreWayId) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.getScoreWayId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_ExamType) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.id_ExamType) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.examTime) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.examTime) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.modifyDate) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.modifyDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.modifyUserID) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.modifyUserID) > 18) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjCurrEduClsEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_CurrEduCls) == false && undefined !== pobjCurrEduClsEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.currEduClsId) == false && undefined !== pobjCurrEduClsEN.currEduClsId && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.currEduClsId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.eduClsName) == false && undefined !== pobjCurrEduClsEN.eduClsName && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.eduClsName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.eduClsTypeId) == false && undefined !== pobjCurrEduClsEN.eduClsTypeId && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.eduClsTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.courseId) == false && undefined !== pobjCurrEduClsEN.courseId && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.courseId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.teachingSolutionId) == false && undefined !== pobjCurrEduClsEN.teachingSolutionId && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.teachingSolutionId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_XzCollege) == false && undefined !== pobjCurrEduClsEN.id_XzCollege && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_XzMajor) == false && undefined !== pobjCurrEduClsEN.id_XzMajor && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_EduWay) == false && undefined !== pobjCurrEduClsEN.id_EduWay && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_EduWay) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_ClassRoomType) == false && undefined !== pobjCurrEduClsEN.id_ClassRoomType && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_ClassRoomType) === false) {
        ...
        if (null != pobjCurrEduClsEN.totalLessonQty && undefined !== pobjCurrEduClsEN.totalLessonQty && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.totalLessonQty) === false) {
        ...
        if (null != pobjCurrEduClsEN.maxStuQty && undefined !== pobjCurrEduClsEN.maxStuQty && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.maxStuQty) === false) {
        ...
        if (null != pobjCurrEduClsEN.weekQty && undefined !== pobjCurrEduClsEN.weekQty && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.weekQty) === false) {
        ...
        if (null != pobjCurrEduClsEN.scheUnitPW && undefined !== pobjCurrEduClsEN.scheUnitPW && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.scheUnitPW) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.weekStatusID) == false && undefined !== pobjCurrEduClsEN.weekStatusID && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.weekStatusID) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.customerWeek) == false && undefined !== pobjCurrEduClsEN.customerWeek && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.customerWeek) === false) {
        ...
        if (null != pobjCurrEduClsEN.lessonQtyPerWeek && undefined !== pobjCurrEduClsEN.lessonQtyPerWeek && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.lessonQtyPerWeek) === false) {
        ...
        if (null != pobjCurrEduClsEN.mark && undefined !== pobjCurrEduClsEN.mark && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.mark) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_UniZone) == false && undefined !== pobjCurrEduClsEN.id_UniZone && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_UniZone) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_GradeBase) == false && undefined !== pobjCurrEduClsEN.id_GradeBase && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_GradeBase) === false) {
        ...
        if (null != pobjCurrEduClsEN.isEffective && undefined !== pobjCurrEduClsEN.isEffective && jsString_js_1.tzDataType.isBoolean(pobjCurrEduClsEN.isEffective) === false) {
        ...
        if (null != pobjCurrEduClsEN.isForPaperReading && undefined !== pobjCurrEduClsEN.isForPaperReading && jsString_js_1.tzDataType.isBoolean(pobjCurrEduClsEN.isForPaperReading) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.schoolYear) == false && undefined !== pobjCurrEduClsEN.schoolYear && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.schoolYear) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.schoolTerm) == false && undefined !== pobjCurrEduClsEN.schoolTerm && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.schoolTerm) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_CourseType) == false && undefined !== pobjCurrEduClsEN.id_CourseType && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_CourseType) === false) {
        ...
        if (null != pobjCurrEduClsEN.isDegree && undefined !== pobjCurrEduClsEN.isDegree && jsString_js_1.tzDataType.isBoolean(pobjCurrEduClsEN.isDegree) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_ScoreType) == false && undefined !== pobjCurrEduClsEN.id_ScoreType && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_ScoreType) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.getScoreWayId) == false && undefined !== pobjCurrEduClsEN.getScoreWayId && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.getScoreWayId) === false) {
        ...
        if (null != pobjCurrEduClsEN.isProportionalCtrl && undefined !== pobjCurrEduClsEN.isProportionalCtrl && jsString_js_1.tzDataType.isBoolean(pobjCurrEduClsEN.isProportionalCtrl) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_ExamType) == false && undefined !== pobjCurrEduClsEN.id_ExamType && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.id_ExamType) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.examTime) == false && undefined !== pobjCurrEduClsEN.examTime && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.examTime) === false) {
        ...
        if (null != pobjCurrEduClsEN.beginWeek && undefined !== pobjCurrEduClsEN.beginWeek && jsString_js_1.tzDataType.isNumber(pobjCurrEduClsEN.beginWeek) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.modifyDate) == false && undefined !== pobjCurrEduClsEN.modifyDate && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.modifyDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.modifyUserID) == false && undefined !== pobjCurrEduClsEN.modifyUserID && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.modifyUserID) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.memo) == false && undefined !== pobjCurrEduClsEN.memo && jsString_js_1.tzDataType.isString(pobjCurrEduClsEN.memo) === false) {
    ...
    */
    function CurrEduCls_CheckProperty4Update(pobjCurrEduClsEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjCurrEduClsEN.id_CurrEduCls) === true
    ...
    */
    function CurrEduCls_GetCombineCondition(objCurrEduCls_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_CurrEduCls, objCurrEduCls_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_CurrEduClsId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_CurrEduClsId, objCurrEduCls_Cond.currEduClsId, strComparisonOp_CurrEduClsId);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_EduClsName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_EduClsName, objCurrEduCls_Cond.eduClsName, strComparisonOp_EduClsName);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_EduClsTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_EduClsTypeId, objCurrEduCls_Cond.eduClsTypeId, strComparisonOp_EduClsTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_CourseId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_CourseId, objCurrEduCls_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_TeachingSolutionId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_TeachingSolutionId, objCurrEduCls_Cond.teachingSolutionId, strComparisonOp_TeachingSolutionId);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_XzCollege, objCurrEduCls_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_XzMajor, objCurrEduCls_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_EduWay) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_EduWay, objCurrEduCls_Cond.id_EduWay, strComparisonOp_id_EduWay);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_ClassRoomType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_ClassRoomType, objCurrEduCls_Cond.id_ClassRoomType, strComparisonOp_id_ClassRoomType);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_TotalLessonQty) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_TotalLessonQty, objCurrEduCls_Cond.totalLessonQty, strComparisonOp_TotalLessonQty);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_MaxStuQty) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_MaxStuQty, objCurrEduCls_Cond.maxStuQty, strComparisonOp_MaxStuQty);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_WeekQty) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_WeekQty, objCurrEduCls_Cond.weekQty, strComparisonOp_WeekQty);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_WeekStatusID) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_WeekStatusID, objCurrEduCls_Cond.weekStatusID, strComparisonOp_WeekStatusID);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_CustomerWeek) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_CustomerWeek, objCurrEduCls_Cond.customerWeek, strComparisonOp_CustomerWeek);
        }
        //数据类型number(smallint)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_Mark) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_Mark, objCurrEduCls_Cond.mark, strComparisonOp_Mark);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_UniZone) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_UniZone, objCurrEduCls_Cond.id_UniZone, strComparisonOp_id_UniZone);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_GradeBase) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_GradeBase, objCurrEduCls_Cond.id_GradeBase, strComparisonOp_id_GradeBase);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsEffective) == true) {
            if (objCurrEduCls_Cond.isEffective == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsEffective);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsEffective);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsForPaperReading) == true) {
            if (objCurrEduCls_Cond.isForPaperReading == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsForPaperReading);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsForPaperReading);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_SchoolYear) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_SchoolYear, objCurrEduCls_Cond.schoolYear, strComparisonOp_SchoolYear);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_SchoolTerm) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_SchoolTerm, objCurrEduCls_Cond.schoolTerm, strComparisonOp_SchoolTerm);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_CourseType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_CourseType, objCurrEduCls_Cond.id_CourseType, strComparisonOp_id_CourseType);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsDegree) == true) {
            if (objCurrEduCls_Cond.isDegree == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsDegree);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsDegree);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_ScoreType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_ScoreType, objCurrEduCls_Cond.id_ScoreType, strComparisonOp_id_ScoreType);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_GetScoreWayId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_GetScoreWayId, objCurrEduCls_Cond.getScoreWayId, strComparisonOp_GetScoreWayId);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsProportionalCtrl) == true) {
            if (objCurrEduCls_Cond.isProportionalCtrl == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsProportionalCtrl);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_IsProportionalCtrl);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_ExamType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_ExamType, objCurrEduCls_Cond.id_ExamType, strComparisonOp_id_ExamType);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_ExamTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_ExamTime, objCurrEduCls_Cond.examTime, strComparisonOp_ExamTime);
        }
        //数据类型number(smallint)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_ModifyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_ModifyDate, objCurrEduCls_Cond.modifyDate, strComparisonOp_ModifyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_ModifyUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_ModifyUserID, objCurrEduCls_Cond.modifyUserID, strComparisonOp_ModifyUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduCls_Cond.dicFldComparisonOp, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_Memo, objCurrEduCls_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function CurrEduCls_GetUniCondStr_EduClsName(objCurrEduClsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and EduClsName = '{0}'", objCurrEduClsEN.eduClsName);
        return strWhereCond;
    }
    ...
    **/
    function CurrEduCls_GetUniCondStr4Update_EduClsName(objCurrEduClsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and id_CurrEduCls <> '{0}'", objCurrEduClsEN.id_CurrEduCls);
        strWhereCond += (0, clsString_js_1.Format)(" and EduClsName = '{0}'", objCurrEduClsEN.eduClsName);
        return strWhereCond;
    }
