...
(function (factory) {
    ...
    */
    async function vCurrEduClsTeacher_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvCurrEduClsTeacherEN_js_1.clsvCurrEduClsTeacherEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvCurrEduClsTeacherEN_js_1.clsvCurrEduClsTeacherEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vCurrEduClsTeacher_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvCurrEduClsTeacherEN_js_1.clsvCurrEduClsTeacherEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvCurrEduClsTeacherEN_js_1.clsvCurrEduClsTeacherEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvCurrEduClsTeacherExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvCurrEduClsTeacherExObjLst);
