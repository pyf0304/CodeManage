...
(function (factory) {
    ...
    */
    async function vStudentInfo_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvStudentInfoEN_js_1.clsvStudentInfoEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvStudentInfoEN_js_1.clsvStudentInfoEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vStudentInfo_GetObjLst_ClientCache() {
        ...
        clsvStudentInfoEN_js_1.clsvStudentInfoEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvStudentInfoEN_js_1.clsvStudentInfoEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvStudentInfoExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvStudentInfoExObjLst);
