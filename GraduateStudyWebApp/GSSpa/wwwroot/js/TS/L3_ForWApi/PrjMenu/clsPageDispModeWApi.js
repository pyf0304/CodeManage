...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/CacheHelper.js", "../../L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function PageDispMode_GetObjByPageDispModeIdAsync(strPageDispModeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPageDispModeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPageDispModeId]不能为空！(In GetObjByPageDispModeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPageDispModeId.length != 2) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strPageDispModeId]的长度:[{0}]不正确！", strPageDispModeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.pageDispMode_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.pageDispMode_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.pageDispMode_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PageDispMode_GetObjByPageDispModeId_Cache(strPageDispModeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPageDispModeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPageDispModeId]不能为空！(In GetObjByPageDispModeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPageDispModeId.length != 2) {
    ...
    */
    async function PageDispMode_GetObjByPageDispModeId_localStorage(strPageDispModeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPageDispModeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPageDispModeId]不能为空！(In GetObjByPageDispModeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPageDispModeId.length != 2) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPageDispModeEN_js_1.clsPageDispModeEN._CurrTabName, strPageDispModeId);
        if (strKey == "") {
    ...
    */
    async function PageDispMode_GetNameByPageDispModeId_Cache(strPageDispModeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPageDispModeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPageDispModeId]不能为空！(In GetNameByPageDispModeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPageDispModeId.length != 2) {
    ...
    */
    async function PageDispMode_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsPageDispModeEN_js_1.clsPageDispModeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsPageDispModeEN_js_1.clsPageDispModeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function PageDispMode_GetObjLst_ClientCache() {
        ...
        clsPageDispModeEN_js_1.clsPageDispModeEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsPageDispModeEN_js_1.clsPageDispModeEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsPageDispModeEN_js_1.clsPageDispModeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsPageDispModeEN_js_1.clsPageDispModeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPageDispModeExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrPageDispModeExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPageDispModeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PageDispMode_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPageDispModeExObjLst.length);
            console.log(strInfo);
            return arrPageDispModeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PageDispMode_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPageDispModeExObjLst.length);
            console.log(strInfo);
            return arrPageDispModeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PageDispMode_DelRecordAsync(strPageDispModeId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strPageDispModeId);
        try {
    ...
    **/
    async function PageDispMode_UpdateRecordAsync(objPageDispModeEN) {
        ...
        if (objPageDispModeEN.sf_UpdFldSetStr === undefined || objPageDispModeEN.sf_UpdFldSetStr === null || objPageDispModeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPageDispModeEN.pageDispModeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.pageDispMode_Controller, strAction);
        try {
    ...
    */
    async function PageDispMode_IsExistRecord_Cache(objPageDispMode_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPageDispMode_Cond), exports.pageDispMode_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PageDispMode_IsExist_Cache(strPageDispModeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strPageDispModeId, exports.pageDispMode_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function PageDispMode_CheckPropertyNew(pobjPageDispModeEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeName) === true) {
            throw new Error("(errid:Watl000058)字段[页面显示模式名称]不能为空(In 页面显示模式)!(clsPageDispModeBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeENName) === true) {
            throw new Error("(errid:Watl000058)字段[页面显示模式英文名]不能为空(In 页面显示模式)!(clsPageDispModeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeId) == false && (0, clsString_js_1.GetStrLen)(pobjPageDispModeEN.pageDispModeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeName) == false && (0, clsString_js_1.GetStrLen)(pobjPageDispModeEN.pageDispModeName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeENName) == false && (0, clsString_js_1.GetStrLen)(pobjPageDispModeEN.pageDispModeENName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjPageDispModeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeId) == false && undefined !== pobjPageDispModeEN.pageDispModeId && jsString_js_1.tzDataType.isString(pobjPageDispModeEN.pageDispModeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeName) == false && undefined !== pobjPageDispModeEN.pageDispModeName && jsString_js_1.tzDataType.isString(pobjPageDispModeEN.pageDispModeName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeENName) == false && undefined !== pobjPageDispModeEN.pageDispModeENName && jsString_js_1.tzDataType.isString(pobjPageDispModeEN.pageDispModeENName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.memo) == false && undefined !== pobjPageDispModeEN.memo && jsString_js_1.tzDataType.isString(pobjPageDispModeEN.memo) === false) {
    ...
    */
    function PageDispMode_CheckProperty4Update(pobjPageDispModeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPageDispModeEN.pageDispModeId) === true) {
    ...
    */
    function PageDispMode_GetCombineCondition(objPageDispMode_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPageDispMode_Cond.dicFldComparisonOp, clsPageDispModeEN_js_1.clsPageDispModeEN.con_PageDispModeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPageDispModeEN_js_1.clsPageDispModeEN.con_PageDispModeId, objPageDispMode_Cond.pageDispModeId, strComparisonOp_PageDispModeId);
        }
        if (Object.prototype.hasOwnProperty.call(objPageDispMode_Cond.dicFldComparisonOp, clsPageDispModeEN_js_1.clsPageDispModeEN.con_PageDispModeName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPageDispModeEN_js_1.clsPageDispModeEN.con_PageDispModeName, objPageDispMode_Cond.pageDispModeName, strComparisonOp_PageDispModeName);
        }
        if (Object.prototype.hasOwnProperty.call(objPageDispMode_Cond.dicFldComparisonOp, clsPageDispModeEN_js_1.clsPageDispModeEN.con_PageDispModeENName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPageDispModeEN_js_1.clsPageDispModeEN.con_PageDispModeENName, objPageDispMode_Cond.pageDispModeENName, strComparisonOp_PageDispModeENName);
        }
        if (Object.prototype.hasOwnProperty.call(objPageDispMode_Cond.dicFldComparisonOp, clsPageDispModeEN_js_1.clsPageDispModeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPageDispModeEN_js_1.clsPageDispModeEN.con_Memo, objPageDispMode_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PageDispMode_GetUniCondStr_PageDispModeName(objPageDispModeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PageDispModeName = '{0}'", objPageDispModeEN.pageDispModeName);
        return strWhereCond;
    }
    ...
    **/
    function PageDispMode_GetUniCondStr4Update_PageDispModeName(objPageDispModeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PageDispModeId <> '{0}'", objPageDispModeEN.pageDispModeId);
        strWhereCond += (0, clsString_js_1.Format)(" and PageDispModeName = '{0}'", objPageDispModeEN.pageDispModeName);
        return strWhereCond;
    }
