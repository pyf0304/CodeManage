...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/SysPara/clsPlatDefaRoleEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function PlatDefaRole_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.platDefaRole_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.platDefaRole_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.platDefaRole_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function PlatDefaRole_UpdateRecordAsync(objPlatDefaRoleEN) {
        ...
        if (objPlatDefaRoleEN.sf_UpdFldSetStr === undefined || objPlatDefaRoleEN.sf_UpdFldSetStr === null || objPlatDefaRoleEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPlatDefaRoleEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.platDefaRole_Controller, strAction);
        try {
    ...
    */
    function PlatDefaRole_CheckPropertyNew(pobjPlatDefaRoleEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.personType) === true) {
            throw new Error("(errid:Watl000058)字段[人员类别]不能为空(In 平台默认角色)!(clsPlatDefaRoleBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.prjId) === true) {
            throw new Error("(errid:Watl000058)字段[PrjId]不能为空(In 平台默认角色)!(clsPlatDefaRoleBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.roleId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.id_School) == false && (0, clsString_js_1.GetStrLen)(pobjPlatDefaRoleEN.id_School) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.personType) == false && (0, clsString_js_1.GetStrLen)(pobjPlatDefaRoleEN.personType) > 30) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.prjId) == false && (0, clsString_js_1.GetStrLen)(pobjPlatDefaRoleEN.prjId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.roleId) == false && (0, clsString_js_1.GetStrLen)(pobjPlatDefaRoleEN.roleId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjPlatDefaRoleEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPlatDefaRoleEN.mId && undefined !== pobjPlatDefaRoleEN.mId && jsString_js_1.tzDataType.isNumber(pobjPlatDefaRoleEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.id_School) == false && undefined !== pobjPlatDefaRoleEN.id_School && jsString_js_1.tzDataType.isString(pobjPlatDefaRoleEN.id_School) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.personType) == false && undefined !== pobjPlatDefaRoleEN.personType && jsString_js_1.tzDataType.isString(pobjPlatDefaRoleEN.personType) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.prjId) == false && undefined !== pobjPlatDefaRoleEN.prjId && jsString_js_1.tzDataType.isString(pobjPlatDefaRoleEN.prjId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.roleId) == false && undefined !== pobjPlatDefaRoleEN.roleId && jsString_js_1.tzDataType.isString(pobjPlatDefaRoleEN.roleId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPlatDefaRoleEN.memo) == false && undefined !== pobjPlatDefaRoleEN.memo && jsString_js_1.tzDataType.isString(pobjPlatDefaRoleEN.memo) === false) {
    ...
    */
    function PlatDefaRole_GetCombineCondition(objPlatDefaRole_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPlatDefaRole_Cond.dicFldComparisonOp, clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_mId, objPlatDefaRole_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objPlatDefaRole_Cond.dicFldComparisonOp, clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_id_School) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_id_School, objPlatDefaRole_Cond.id_School, strComparisonOp_id_School);
        }
        if (Object.prototype.hasOwnProperty.call(objPlatDefaRole_Cond.dicFldComparisonOp, clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_PersonType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_PersonType, objPlatDefaRole_Cond.personType, strComparisonOp_PersonType);
        }
        if (Object.prototype.hasOwnProperty.call(objPlatDefaRole_Cond.dicFldComparisonOp, clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_PrjId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_PrjId, objPlatDefaRole_Cond.prjId, strComparisonOp_PrjId);
        }
        if (Object.prototype.hasOwnProperty.call(objPlatDefaRole_Cond.dicFldComparisonOp, clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_RoleId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_RoleId, objPlatDefaRole_Cond.roleId, strComparisonOp_RoleId);
        }
        if (Object.prototype.hasOwnProperty.call(objPlatDefaRole_Cond.dicFldComparisonOp, clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPlatDefaRoleEN_js_1.clsPlatDefaRoleEN.con_Memo, objPlatDefaRole_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PlatDefaRole_GetUniCondStr_id_School_PrjId_RoleId(objPlatDefaRoleEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and id_School = '{0}'", objPlatDefaRoleEN.id_School);
        strWhereCond += (0, clsString_js_1.Format)(" and PrjId = '{0}'", objPlatDefaRoleEN.prjId);
        strWhereCond += (0, clsString_js_1.Format)(" and RoleId = '{0}'", objPlatDefaRoleEN.roleId);
        return strWhereCond;
    }
    ...
    **/
    function PlatDefaRole_GetUniCondStr4Update_id_School_PrjId_RoleId(objPlatDefaRoleEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId <> '{0}'", objPlatDefaRoleEN.mId);
        strWhereCond += (0, clsString_js_1.Format)(" and id_School = '{0}'", objPlatDefaRoleEN.id_School);
        strWhereCond += (0, clsString_js_1.Format)(" and PrjId = '{0}'", objPlatDefaRoleEN.prjId);
        strWhereCond += (0, clsString_js_1.Format)(" and RoleId = '{0}'", objPlatDefaRoleEN.roleId);
        return strWhereCond;
