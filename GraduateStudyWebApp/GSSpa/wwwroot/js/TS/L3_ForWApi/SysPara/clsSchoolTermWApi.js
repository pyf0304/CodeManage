...
(function (factory) {
    ...
    **/
    async function SchoolTerm_GetObjBySchoolTermAsync(strSchoolTerm) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSchoolTerm) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSchoolTerm]不能为空！(In GetObjBySchoolTermAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSchoolTerm.length != 1) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strSchoolTerm]的长度:[{0}]不正确！", strSchoolTerm.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.schoolTerm_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.schoolTerm_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.schoolTerm_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SchoolTerm_GetObjBySchoolTerm_Cache(strSchoolTerm, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSchoolTerm) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSchoolTerm]不能为空！(In GetObjBySchoolTerm_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSchoolTerm.length != 1) {
    ...
    */
    async function SchoolTerm_GetObjBySchoolTerm_localStorage(strSchoolTerm) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSchoolTerm) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSchoolTerm]不能为空！(In GetObjBySchoolTerm_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSchoolTerm.length != 1) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSchoolTermEN_js_1.clsSchoolTermEN._CurrTabName, strSchoolTerm);
        if (strKey == "") {
    ...
    */
    async function SchoolTerm_GetNameBySchoolTerm_Cache(strSchoolTerm) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSchoolTerm) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSchoolTerm]不能为空！(In GetNameBySchoolTerm_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSchoolTerm.length != 1) {
    ...
    */
    async function SchoolTerm_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSchoolTermEN_js_1.clsSchoolTermEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsSchoolTermEN_js_1.clsSchoolTermEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function SchoolTerm_GetObjLst_ClientCache() {
        ...
        clsSchoolTermEN_js_1.clsSchoolTermEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsSchoolTermEN_js_1.clsSchoolTermEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsSchoolTermEN_js_1.clsSchoolTermEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsSchoolTermEN_js_1.clsSchoolTermEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSchoolTermExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrSchoolTermExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSchoolTermExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SchoolTerm_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSchoolTermExObjLst.length);
            console.log(strInfo);
            return arrSchoolTermExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SchoolTerm_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSchoolTermExObjLst.length);
            console.log(strInfo);
            return arrSchoolTermExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SchoolTerm_DelRecordAsync(strSchoolTerm) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strSchoolTerm);
        try {
    ...
    **/
    async function SchoolTerm_UpdateRecordAsync(objSchoolTermEN) {
        ...
        if (objSchoolTermEN.sf_UpdFldSetStr === undefined || objSchoolTermEN.sf_UpdFldSetStr === null || objSchoolTermEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSchoolTermEN.schoolTerm);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.schoolTerm_Controller, strAction);
        try {
    ...
    */
    async function SchoolTerm_IsExistRecord_Cache(objSchoolTerm_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSchoolTerm_Cond), exports.schoolTerm_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SchoolTerm_IsExist_Cache(strSchoolTerm) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strSchoolTerm, exports.schoolTerm_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function SchoolTerm_BindDdl_SchoolTermInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_SchoolTermInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function SchoolTerm_CheckPropertyNew(pobjSchoolTermEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSchoolTermEN.schoolTerm) == false && (0, clsString_js_1.GetStrLen)(pobjSchoolTermEN.schoolTerm) > 1) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSchoolTermEN.schoolTermName) == false && (0, clsString_js_1.GetStrLen)(pobjSchoolTermEN.schoolTermName) > 1) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSchoolTermEN.schoolTerm) == false && undefined !== pobjSchoolTermEN.schoolTerm && jsString_js_1.tzDataType.isString(pobjSchoolTermEN.schoolTerm) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSchoolTermEN.schoolTermName) == false && undefined !== pobjSchoolTermEN.schoolTermName && jsString_js_1.tzDataType.isString(pobjSchoolTermEN.schoolTermName) === false) {
        ...
        if (null != pobjSchoolTermEN.isCurrentSchoolTerm && undefined !== pobjSchoolTermEN.isCurrentSchoolTerm && jsString_js_1.tzDataType.isBoolean(pobjSchoolTermEN.isCurrentSchoolTerm) === false) {
    ...
    */
    function SchoolTerm_CheckProperty4Update(pobjSchoolTermEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSchoolTermEN.schoolTerm) === true
    ...
    */
    function SchoolTerm_GetCombineCondition(objSchoolTerm_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSchoolTerm_Cond.dicFldComparisonOp, clsSchoolTermEN_js_1.clsSchoolTermEN.con_SchoolTerm) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSchoolTermEN_js_1.clsSchoolTermEN.con_SchoolTerm, objSchoolTerm_Cond.schoolTerm, strComparisonOp_SchoolTerm);
        }
        if (Object.prototype.hasOwnProperty.call(objSchoolTerm_Cond.dicFldComparisonOp, clsSchoolTermEN_js_1.clsSchoolTermEN.con_SchoolTermName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSchoolTermEN_js_1.clsSchoolTermEN.con_SchoolTermName, objSchoolTerm_Cond.schoolTermName, strComparisonOp_SchoolTermName);
        }
        if (Object.prototype.hasOwnProperty.call(objSchoolTerm_Cond.dicFldComparisonOp, clsSchoolTermEN_js_1.clsSchoolTermEN.con_IsCurrentSchoolTerm) == true) {
            if (objSchoolTerm_Cond.isCurrentSchoolTerm == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsSchoolTermEN_js_1.clsSchoolTermEN.con_IsCurrentSchoolTerm);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsSchoolTermEN_js_1.clsSchoolTermEN.con_IsCurrentSchoolTerm);
            }
        }
        return strWhereCond;
    }
