...
(function (factory) {
    ...
    **/
    async function cc_CourseExamPaper_GetObjByCourseExamPaperIdAsync(strCourseExamPaperId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseExamPaperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseExamPaperId]不能为空！(In GetObjByCourseExamPaperIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseExamPaperId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseExamPaperId]的长度:[{0}]不正确！", strCourseExamPaperId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cc_CourseExamPaper_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cc_CourseExamPaper_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cc_CourseExamPaper_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function cc_CourseExamPaper_GetObjByCourseExamPaperId_Cache(strCourseExamPaperId, strCourseId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseExamPaperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseExamPaperId]不能为空！(In GetObjByCourseExamPaperId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseExamPaperId.length != 8) {
    ...
    */
    async function cc_CourseExamPaper_GetObjByCourseExamPaperId_localStorage(strCourseExamPaperId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseExamPaperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseExamPaperId]不能为空！(In GetObjByCourseExamPaperId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseExamPaperId.length != 8) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN._CurrTabName, strCourseExamPaperId);
        if (strKey == "") {
    ...
    */
    async function cc_CourseExamPaper_GetNameByCourseExamPaperId_Cache(strCourseExamPaperId, strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseExamPaperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseExamPaperId]不能为空！(In GetNameByCourseExamPaperId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseExamPaperId.length != 8) {
    ...
    */
    async function cc_CourseExamPaper_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if (clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function cc_CourseExamPaper_GetObjLst_ClientCache(strCourseId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN._CurrTabName, strCourseId);
        clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrcc_CourseExamPaperExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrcc_CourseExamPaperExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseExamPaperExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function cc_CourseExamPaper_GetObjLst_localStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseExamPaperExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseExamPaperExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_CourseExamPaper_GetObjLst_sessionStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseExamPaperExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseExamPaperExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_CourseExamPaper_DelRecordAsync(strCourseExamPaperId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strCourseExamPaperId);
        try {
    ...
    **/
    async function cc_CourseExamPaper_UpdateRecordAsync(objcc_CourseExamPaperEN) {
        ...
        if (objcc_CourseExamPaperEN.sf_UpdFldSetStr === undefined || objcc_CourseExamPaperEN.sf_UpdFldSetStr === null || objcc_CourseExamPaperEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objcc_CourseExamPaperEN.courseExamPaperId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cc_CourseExamPaper_Controller, strAction);
        try {
    ...
    */
    async function cc_CourseExamPaper_IsExistRecord_Cache(objcc_CourseExamPaper_Cond, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objcc_CourseExamPaper_Cond), exports.cc_CourseExamPaper_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function cc_CourseExamPaper_IsExist_Cache(strCourseExamPaperId, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCourseExamPaperId, exports.cc_CourseExamPaper_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function cc_CourseExamPaper_ReFreshCache(strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseId]不能为空！(In clscc_CourseExamPaperWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
    ...
    */
    async function cc_CourseExamPaper__Cache(strDivName, strDdlName, strCourseId) {
    ...
    exports.cc_CourseExamPaper__Cache = cc_CourseExamPaper__Cache;
    /**
    ...
    */
    function cc_CourseExamPaper_CheckPropertyNew(pobjcc_CourseExamPaperEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examPaperTypeId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseExamPaperId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.courseExamPaperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.courseId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examPaperName) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.examPaperName) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examPaperTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.examPaperTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.id_XzMajor) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.paperDispModeId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.paperDispModeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examCreateTime) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.examCreateTime) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.createUserID) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.createUserID) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseChapterId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.courseChapterId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjcc_CourseExamPaperEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseExamPaperId) == false && undefined !== pobjcc_CourseExamPaperEN.courseExamPaperId && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.courseExamPaperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseId) == false && undefined !== pobjcc_CourseExamPaperEN.courseId && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.courseId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examPaperName) == false && undefined !== pobjcc_CourseExamPaperEN.examPaperName && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.examPaperName) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.paperIndex && undefined !== pobjcc_CourseExamPaperEN.paperIndex && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.paperIndex) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examPaperTypeId) == false && undefined !== pobjcc_CourseExamPaperEN.examPaperTypeId && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.examPaperTypeId) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.isShow && undefined !== pobjcc_CourseExamPaperEN.isShow && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseExamPaperEN.isShow) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.totalScore && undefined !== pobjcc_CourseExamPaperEN.totalScore && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.totalScore) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.viewCount && undefined !== pobjcc_CourseExamPaperEN.viewCount && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.viewCount) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.doneNumber && undefined !== pobjcc_CourseExamPaperEN.doneNumber && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.doneNumber) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.paperTime && undefined !== pobjcc_CourseExamPaperEN.paperTime && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.paperTime) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.downloadNumber && undefined !== pobjcc_CourseExamPaperEN.downloadNumber && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.downloadNumber) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.collectionCount && undefined !== pobjcc_CourseExamPaperEN.collectionCount && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.collectionCount) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.likeCount && undefined !== pobjcc_CourseExamPaperEN.likeCount && jsString_js_1.tzDataType.isNumber(pobjcc_CourseExamPaperEN.likeCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.id_XzMajor) == false && undefined !== pobjcc_CourseExamPaperEN.id_XzMajor && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.paperDispModeId) == false && undefined !== pobjcc_CourseExamPaperEN.paperDispModeId && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.paperDispModeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.examCreateTime) == false && undefined !== pobjcc_CourseExamPaperEN.examCreateTime && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.examCreateTime) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.createUserID) == false && undefined !== pobjcc_CourseExamPaperEN.createUserID && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.createUserID) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.isOpenToAllStu && undefined !== pobjcc_CourseExamPaperEN.isOpenToAllStu && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseExamPaperEN.isOpenToAllStu) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.isOpenToSchool && undefined !== pobjcc_CourseExamPaperEN.isOpenToSchool && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseExamPaperEN.isOpenToSchool) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.isOpenToSocial && undefined !== pobjcc_CourseExamPaperEN.isOpenToSocial && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseExamPaperEN.isOpenToSocial) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseChapterId) == false && undefined !== pobjcc_CourseExamPaperEN.courseChapterId && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.courseChapterId) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.isAutoGeneQuestion && undefined !== pobjcc_CourseExamPaperEN.isAutoGeneQuestion && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseExamPaperEN.isAutoGeneQuestion) === false) {
        ...
        if (null != pobjcc_CourseExamPaperEN.isCanMultiDo && undefined !== pobjcc_CourseExamPaperEN.isCanMultiDo && jsString_js_1.tzDataType.isBoolean(pobjcc_CourseExamPaperEN.isCanMultiDo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.updDate) == false && undefined !== pobjcc_CourseExamPaperEN.updDate && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.updUserId) == false && undefined !== pobjcc_CourseExamPaperEN.updUserId && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.memo) == false && undefined !== pobjcc_CourseExamPaperEN.memo && jsString_js_1.tzDataType.isString(pobjcc_CourseExamPaperEN.memo) === false) {
    ...
    */
    function cc_CourseExamPaper_CheckProperty4Update(pobjcc_CourseExamPaperEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjcc_CourseExamPaperEN.courseExamPaperId) === true
    ...
    */
    function cc_CourseExamPaper_GetCombineCondition(objcc_CourseExamPaper_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CourseExamPaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CourseExamPaperId, objcc_CourseExamPaper_Cond.courseExamPaperId, strComparisonOp_CourseExamPaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CourseId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CourseId, objcc_CourseExamPaper_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ExamPaperName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ExamPaperName, objcc_CourseExamPaper_Cond.examPaperName, strComparisonOp_ExamPaperName);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_PaperIndex) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_PaperIndex, objcc_CourseExamPaper_Cond.paperIndex, strComparisonOp_PaperIndex);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ExamPaperTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ExamPaperTypeId, objcc_CourseExamPaper_Cond.examPaperTypeId, strComparisonOp_ExamPaperTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsShow) == true) {
            if (objcc_CourseExamPaper_Cond.isShow == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsShow);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsShow);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_TotalScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_TotalScore, objcc_CourseExamPaper_Cond.totalScore, strComparisonOp_TotalScore);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ViewCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ViewCount, objcc_CourseExamPaper_Cond.viewCount, strComparisonOp_ViewCount);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_DoneNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_DoneNumber, objcc_CourseExamPaper_Cond.doneNumber, strComparisonOp_DoneNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_PaperTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_PaperTime, objcc_CourseExamPaper_Cond.paperTime, strComparisonOp_PaperTime);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_DownloadNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_DownloadNumber, objcc_CourseExamPaper_Cond.downloadNumber, strComparisonOp_DownloadNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CollectionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CollectionCount, objcc_CourseExamPaper_Cond.collectionCount, strComparisonOp_CollectionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_LikeCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_LikeCount, objcc_CourseExamPaper_Cond.likeCount, strComparisonOp_LikeCount);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_id_XzMajor, objcc_CourseExamPaper_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_PaperDispModeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_PaperDispModeId, objcc_CourseExamPaper_Cond.paperDispModeId, strComparisonOp_PaperDispModeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ExamCreateTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_ExamCreateTime, objcc_CourseExamPaper_Cond.examCreateTime, strComparisonOp_ExamCreateTime);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CreateUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CreateUserID, objcc_CourseExamPaper_Cond.createUserID, strComparisonOp_CreateUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToAllStu) == true) {
            if (objcc_CourseExamPaper_Cond.isOpenToAllStu == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToAllStu);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToAllStu);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToSchool) == true) {
            if (objcc_CourseExamPaper_Cond.isOpenToSchool == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToSchool);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToSchool);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToSocial) == true) {
            if (objcc_CourseExamPaper_Cond.isOpenToSocial == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToSocial);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsOpenToSocial);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CourseChapterId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_CourseChapterId, objcc_CourseExamPaper_Cond.courseChapterId, strComparisonOp_CourseChapterId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsAutoGeneQuestion) == true) {
            if (objcc_CourseExamPaper_Cond.isAutoGeneQuestion == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsAutoGeneQuestion);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsAutoGeneQuestion);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsCanMultiDo) == true) {
            if (objcc_CourseExamPaper_Cond.isCanMultiDo == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsCanMultiDo);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_IsCanMultiDo);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_UpdDate, objcc_CourseExamPaper_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_UpdUserId, objcc_CourseExamPaper_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseExamPaper_Cond.dicFldComparisonOp, clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clscc_CourseExamPaperEN_js_1.clscc_CourseExamPaperEN.con_Memo, objcc_CourseExamPaper_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function cc_CourseExamPaper_GetUniCondStr_ExamPaperName(objcc_CourseExamPaperEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ExamPaperName = '{0}'", objcc_CourseExamPaperEN.examPaperName);
        return strWhereCond;
    }
    ...
    **/
    function cc_CourseExamPaper_GetUniCondStr4Update_ExamPaperName(objcc_CourseExamPaperEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and CourseExamPaperId <> '{0}'", objcc_CourseExamPaperEN.courseExamPaperId);
        strWhereCond += (0, clsString_js_1.Format)(" and ExamPaperName = '{0}'", objcc_CourseExamPaperEN.examPaperName);
        return strWhereCond;
    }
