...
(function (factory) {
    ...
    async function gs_KnowledgesLogic_User_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_KnowledgesLogic_User_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_KnowledgesLogic_User_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_KnowledgesLogic_User_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrgs_KnowledgesLogic_User_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_KnowledgesLogic_User = await gs_KnowledgesLogic_User_GetObjBymIdAsync(lngmId);
    ...
    */
    async function gs_KnowledgesLogic_User_GetObjBymId_localStorage(lngmId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_KnowledgesLogic_User_UpdateObjInLst_Cache(objgs_KnowledgesLogic_User) {
        ...
        try {
            const arrgs_KnowledgesLogic_UserObjLst_Cache = await gs_KnowledgesLogic_User_GetObjLst_Cache();
            const obj = arrgs_KnowledgesLogic_UserObjLst_Cache.find(x => x.mId == objgs_KnowledgesLogic_User.mId);
            if (obj != null) {
    ...
    */
    async function gs_KnowledgesLogic_User_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_KnowledgesLogic_User_GetObjLst_ClientCache() {
        ...
        clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_KnowledgesLogic_UserExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_KnowledgesLogic_UserExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesLogic_UserExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_KnowledgesLogic_User_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesLogic_UserExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesLogic_UserExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_KnowledgesLogic_User_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesLogic_UserExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesLogic_UserExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_KnowledgesLogic_User_UpdateRecordAsync(objgs_KnowledgesLogic_UserEN) {
        ...
        if (objgs_KnowledgesLogic_UserEN.sf_UpdFldSetStr === undefined || objgs_KnowledgesLogic_UserEN.sf_UpdFldSetStr === null || objgs_KnowledgesLogic_UserEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_KnowledgesLogic_UserEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_KnowledgesLogic_User_Controller, strAction);
        try {
    ...
    */
    async function gs_KnowledgesLogic_User_IsExistRecord_Cache(objgs_KnowledgesLogic_User_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_KnowledgesLogic_User_Cond), exports.gs_KnowledgesLogic_User_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_KnowledgesLogic_User_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_KnowledgesLogic_User_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_KnowledgesLogic_User_CheckPropertyNew(pobjgs_KnowledgesLogic_UserEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.courseKnowledgeId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.knowledgeGraphId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.courseKnowledgeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesLogic_UserEN.courseKnowledgeId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.knowledgeGraphId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesLogic_UserEN.knowledgeGraphId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.className) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesLogic_UserEN.className) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesLogic_UserEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesLogic_UserEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesLogic_UserEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_KnowledgesLogic_UserEN.mId && undefined !== pobjgs_KnowledgesLogic_UserEN.mId && jsString_js_1.tzDataType.isNumber(pobjgs_KnowledgesLogic_UserEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.courseKnowledgeId) == false && undefined !== pobjgs_KnowledgesLogic_UserEN.courseKnowledgeId && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogic_UserEN.courseKnowledgeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.knowledgeGraphId) == false && undefined !== pobjgs_KnowledgesLogic_UserEN.knowledgeGraphId && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogic_UserEN.knowledgeGraphId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.className) == false && undefined !== pobjgs_KnowledgesLogic_UserEN.className && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogic_UserEN.className) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.updDate) == false && undefined !== pobjgs_KnowledgesLogic_UserEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogic_UserEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.updUser) == false && undefined !== pobjgs_KnowledgesLogic_UserEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogic_UserEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesLogic_UserEN.memo) == false && undefined !== pobjgs_KnowledgesLogic_UserEN.memo && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogic_UserEN.memo) === false) {
    ...
    */
    function gs_KnowledgesLogic_User_GetCombineCondition(objgs_KnowledgesLogic_User_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_mId, objgs_KnowledgesLogic_User_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_CourseKnowledgeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_CourseKnowledgeId, objgs_KnowledgesLogic_User_Cond.courseKnowledgeId, strComparisonOp_CourseKnowledgeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_KnowledgeGraphId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_KnowledgeGraphId, objgs_KnowledgesLogic_User_Cond.knowledgeGraphId, strComparisonOp_KnowledgeGraphId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_ClassName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_ClassName, objgs_KnowledgesLogic_User_Cond.className, strComparisonOp_ClassName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_UpdDate, objgs_KnowledgesLogic_User_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_UpdUser, objgs_KnowledgesLogic_User_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogic_User_Cond.dicFldComparisonOp, clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogic_UserEN_js_1.clsgs_KnowledgesLogic_UserEN.con_Memo, objgs_KnowledgesLogic_User_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    * @returns 条件串(strWhereCond)
    **/
    function gs_KnowledgesLogic_User_GetUniCondStr_mId(objgs_KnowledgesLogic_UserEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objgs_KnowledgesLogic_UserEN.mId);
        return strWhereCond;
    }
    exports.gs_KnowledgesLogic_User_GetUniCondStr_mId = gs_KnowledgesLogic_User_GetUniCondStr_mId;
    /**
    *获取唯一性条件串(Uniqueness)--gs_KnowledgesLogic_User(知识点逻辑点_个性化用户),根据唯一约束条件来生成
    ...
    * @returns 条件串(strWhereCond)
    **/
    function gs_KnowledgesLogic_User_GetUniCondStr4Update_mId(objgs_KnowledgesLogic_UserEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId <> '{0}'", objgs_KnowledgesLogic_UserEN.mId);
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objgs_KnowledgesLogic_UserEN.mId);
        return strWhereCond;
    }
    exports.gs_KnowledgesLogic_User_GetUniCondStr4Update_mId = gs_KnowledgesLogic_User_GetUniCondStr4Update_mId;
    /**
     * 把同一个类的对象,复制到另一个对象
