...
(function (factory) {
    ...
    */
    async function vcc_CourseExamPaper_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if (clsvcc_CourseExamPaperEN_js_1.clsvcc_CourseExamPaperEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvcc_CourseExamPaperEN_js_1.clsvcc_CourseExamPaperEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vcc_CourseExamPaper_GetObjLst_ClientCache(strCourseId) {
        ...
        clsvcc_CourseExamPaperEN_js_1.clsvcc_CourseExamPaperEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvcc_CourseExamPaperEN_js_1.clsvcc_CourseExamPaperEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvcc_CourseExamPaperExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvcc_CourseExamPaperExObjLst);
