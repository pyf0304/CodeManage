...
(function (factory) {
    ...
    */
    async function vQxUsers_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvQxUsersEN_js_1.clsvQxUsersEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvQxUsersEN_js_1.clsvQxUsersEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vQxUsers_GetObjLst_ClientCache() {
        ...
        clsvQxUsersEN_js_1.clsvQxUsersEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvQxUsersEN_js_1.clsvQxUsersEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvQxUsersExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvQxUsersExObjLst);
