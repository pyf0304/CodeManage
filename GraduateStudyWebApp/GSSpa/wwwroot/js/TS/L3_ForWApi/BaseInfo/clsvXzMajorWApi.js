...
(function (factory) {
    ...
    * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    ...
    const clsvXzMajorEN_js_1 = require("../../L0_Entity/BaseInfo/clsvXzMajorEN.js");
    ...
    */
    async function vXzMajor_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvXzMajorEN_js_1.clsvXzMajorEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvXzMajorEN_js_1.clsvXzMajorEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vXzMajor_GetObjLst_ClientCache() {
        ...
        clsvXzMajorEN_js_1.clsvXzMajorEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvXzMajorEN_js_1.clsvXzMajorEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvXzMajorExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvXzMajorExObjLst);
