...
(function (factory) {
    ...
    async function QxUsers_GetObjByUserIdAsync(strUserId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.qxUsers_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.qxUsers_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.qxUsers_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrQxUsers_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objQxUsers = await QxUsers_GetObjByUserIdAsync(strUserId);
                    if (objQxUsers != null) {
    ...
    */
    async function QxUsers_GetObjByUserId_localStorage(strUserId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsQxUsersEN_js_1.clsQxUsersEN._CurrTabName, strUserId);
        if (strKey == "") {
    ...
    */
    async function QxUsers_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsQxUsersEN_js_1.clsQxUsersEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsQxUsersEN_js_1.clsQxUsersEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function QxUsers_GetObjLst_ClientCache() {
        ...
        clsQxUsersEN_js_1.clsQxUsersEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsQxUsersEN_js_1.clsQxUsersEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsQxUsersEN_js_1.clsQxUsersEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsQxUsersEN_js_1.clsQxUsersEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrQxUsersExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrQxUsersExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrQxUsersExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function QxUsers_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrQxUsersExObjLst.length);
            console.log(strInfo);
            return arrQxUsersExObjLst;
        }
        catch (e) {
    ...
    **/
    async function QxUsers_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrQxUsersExObjLst.length);
            console.log(strInfo);
            return arrQxUsersExObjLst;
        }
        catch (e) {
    ...
    **/
    async function QxUsers_UpdateRecordAsync(objQxUsersEN) {
        ...
        if (objQxUsersEN.sf_UpdFldSetStr === undefined || objQxUsersEN.sf_UpdFldSetStr === null || objQxUsersEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objQxUsersEN.userId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.qxUsers_Controller, strAction);
        try {
    ...
    */
    async function QxUsers_IsExistRecord_Cache(objQxUsers_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objQxUsers_Cond), exports.qxUsers_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function QxUsers_IsExist_Cache(strUserId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strUserId, exports.qxUsers_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function QxUsers_CheckPropertyNew(pobjQxUsersEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userName) === true) {
            throw new Error("(errid:Watl000058)字段[用户名]不能为空(In Qx用户)!(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userStateId) === true) {
            throw new Error("(errid:Watl000058)字段[用户状态Id]不能为空(In Qx用户)!(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effitiveBeginDate) === true) {
            throw new Error("(errid:Watl000058)字段[EffitiveBeginDate]不能为空(In Qx用户)!(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effitiveEndDate) === true) {
            throw new Error("(errid:Watl000058)字段[EffitiveEndDate]不能为空(In Qx用户)!(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_College) === true
            || pobjQxUsersEN.id_College.toString() === "0") {
            throw new Error("(errid:Watl000058)字段[学院流水号]不能为空(In Qx用户)!(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.stuTeacherID) === true) {
            throw new Error("(errid:Watl000058)字段[学工号]不能为空(In Qx用户)!(clsQxUsersBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.userId) > 20) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过20(In Qx用户(QxUsers))!值:$(pobjQxUsersEN.userId)(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userName) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.userName) > 50) {
            throw new Error("(errid:Watl000059)字段[用户名(userName)]的长度不能超过50(In Qx用户(QxUsers))!值:$(pobjQxUsersEN.userName)(clsQxUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.departmentId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.departmentId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_XzCollege) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userStateId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.userStateId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_GradeBase) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.id_GradeBase) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.card_State) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.card_State) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.cardNo) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.cardNo) > 18) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.beginYearMonth) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.beginYearMonth) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.endYearMonth) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.endYearMonth) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.optUser) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.optUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.optDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.optDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.password) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.password) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.schoolID1) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.schoolID1) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.avatarsPicture) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.avatarsPicture) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.email) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.email) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.phoneNumber) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.phoneNumber) > 15) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effectiveDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.effectiveDate) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effitiveBeginDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.effitiveBeginDate) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effitiveEndDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.effitiveEndDate) > 14) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_College) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.id_College) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.stuTeacherID) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.stuTeacherID) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.identityID) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.identityID) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.headimgUrl) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.headimgUrl) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.openId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.openId) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.nickName) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.nickName) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.synchDate) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.synchDate) > 30) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userId) == false && undefined !== pobjQxUsersEN.userId && jsString_js_1.tzDataType.isString(pobjQxUsersEN.userId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userName) == false && undefined !== pobjQxUsersEN.userName && jsString_js_1.tzDataType.isString(pobjQxUsersEN.userName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.departmentId) == false && undefined !== pobjQxUsersEN.departmentId && jsString_js_1.tzDataType.isString(pobjQxUsersEN.departmentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_XzCollege) == false && undefined !== pobjQxUsersEN.id_XzCollege && jsString_js_1.tzDataType.isString(pobjQxUsersEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userStateId) == false && undefined !== pobjQxUsersEN.userStateId && jsString_js_1.tzDataType.isString(pobjQxUsersEN.userStateId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_GradeBase) == false && undefined !== pobjQxUsersEN.id_GradeBase && jsString_js_1.tzDataType.isString(pobjQxUsersEN.id_GradeBase) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.card_State) == false && undefined !== pobjQxUsersEN.card_State && jsString_js_1.tzDataType.isString(pobjQxUsersEN.card_State) === false) {
        ...
        if (null != pobjQxUsersEN.isLeaved && undefined !== pobjQxUsersEN.isLeaved && jsString_js_1.tzDataType.isBoolean(pobjQxUsersEN.isLeaved) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.cardNo) == false && undefined !== pobjQxUsersEN.cardNo && jsString_js_1.tzDataType.isString(pobjQxUsersEN.cardNo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.beginYearMonth) == false && undefined !== pobjQxUsersEN.beginYearMonth && jsString_js_1.tzDataType.isString(pobjQxUsersEN.beginYearMonth) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.endYearMonth) == false && undefined !== pobjQxUsersEN.endYearMonth && jsString_js_1.tzDataType.isString(pobjQxUsersEN.endYearMonth) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.optUser) == false && undefined !== pobjQxUsersEN.optUser && jsString_js_1.tzDataType.isString(pobjQxUsersEN.optUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.optDate) == false && undefined !== pobjQxUsersEN.optDate && jsString_js_1.tzDataType.isString(pobjQxUsersEN.optDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.memo) == false && undefined !== pobjQxUsersEN.memo && jsString_js_1.tzDataType.isString(pobjQxUsersEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.password) == false && undefined !== pobjQxUsersEN.password && jsString_js_1.tzDataType.isString(pobjQxUsersEN.password) === false) {
        ...
        if (null != pobjQxUsersEN.isGpUser && undefined !== pobjQxUsersEN.isGpUser && jsString_js_1.tzDataType.isBoolean(pobjQxUsersEN.isGpUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.schoolID1) == false && undefined !== pobjQxUsersEN.schoolID1 && jsString_js_1.tzDataType.isString(pobjQxUsersEN.schoolID1) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.avatarsPicture) == false && undefined !== pobjQxUsersEN.avatarsPicture && jsString_js_1.tzDataType.isString(pobjQxUsersEN.avatarsPicture) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.email) == false && undefined !== pobjQxUsersEN.email && jsString_js_1.tzDataType.isString(pobjQxUsersEN.email) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.phoneNumber) == false && undefined !== pobjQxUsersEN.phoneNumber && jsString_js_1.tzDataType.isString(pobjQxUsersEN.phoneNumber) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effectiveDate) == false && undefined !== pobjQxUsersEN.effectiveDate && jsString_js_1.tzDataType.isString(pobjQxUsersEN.effectiveDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.updDate) == false && undefined !== pobjQxUsersEN.updDate && jsString_js_1.tzDataType.isString(pobjQxUsersEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.updUser) == false && undefined !== pobjQxUsersEN.updUser && jsString_js_1.tzDataType.isString(pobjQxUsersEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effitiveBeginDate) == false && undefined !== pobjQxUsersEN.effitiveBeginDate && jsString_js_1.tzDataType.isString(pobjQxUsersEN.effitiveBeginDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.effitiveEndDate) == false && undefined !== pobjQxUsersEN.effitiveEndDate && jsString_js_1.tzDataType.isString(pobjQxUsersEN.effitiveEndDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.id_College) == false && undefined !== pobjQxUsersEN.id_College && jsString_js_1.tzDataType.isString(pobjQxUsersEN.id_College) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.stuTeacherID) == false && undefined !== pobjQxUsersEN.stuTeacherID && jsString_js_1.tzDataType.isString(pobjQxUsersEN.stuTeacherID) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.identityID) == false && undefined !== pobjQxUsersEN.identityID && jsString_js_1.tzDataType.isString(pobjQxUsersEN.identityID) === false) {
        ...
        if (null != pobjQxUsersEN.isArchive && undefined !== pobjQxUsersEN.isArchive && jsString_js_1.tzDataType.isBoolean(pobjQxUsersEN.isArchive) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.headimgUrl) == false && undefined !== pobjQxUsersEN.headimgUrl && jsString_js_1.tzDataType.isString(pobjQxUsersEN.headimgUrl) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.openId) == false && undefined !== pobjQxUsersEN.openId && jsString_js_1.tzDataType.isString(pobjQxUsersEN.openId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.nickName) == false && undefined !== pobjQxUsersEN.nickName && jsString_js_1.tzDataType.isString(pobjQxUsersEN.nickName) === false) {
        ...
        if (null != pobjQxUsersEN.isSynch && undefined !== pobjQxUsersEN.isSynch && jsString_js_1.tzDataType.isBoolean(pobjQxUsersEN.isSynch) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.synchDate) == false && undefined !== pobjQxUsersEN.synchDate && jsString_js_1.tzDataType.isString(pobjQxUsersEN.synchDate) === false) {
    ...
    */
    function QxUsers_CheckProperty4Update(pobjQxUsersEN) {
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.userId) > 20) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过20(In Qx用户(QxUsers))!值:$(pobjQxUsersEN.userId)(clsQxUsersBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userName) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.userName) > 50) {
            throw new Error("(errid:Watl000062)字段[用户名(userName)]的长度不能超过50(In Qx用户(QxUsers))!值:$(pobjQxUsersEN.userName)(clsQxUsersBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.departmentId) == false && (0, clsString_js_1.GetStrLen)(pobjQxUsersEN.departmentId) > 8) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjQxUsersEN.userId) === true) {
    ...
    */
    function QxUsers_GetCombineCondition(objQxUsers_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_UserId, objQxUsers_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_UserName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_UserName, objQxUsers_Cond.userName, strComparisonOp_UserName);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_DepartmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_DepartmentId, objQxUsers_Cond.departmentId, strComparisonOp_DepartmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_id_XzCollege, objQxUsers_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_UserStateId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_UserStateId, objQxUsers_Cond.userStateId, strComparisonOp_UserStateId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_id_GradeBase) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_id_GradeBase, objQxUsers_Cond.id_GradeBase, strComparisonOp_id_GradeBase);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_Card_State) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_Card_State, objQxUsers_Cond.card_State, strComparisonOp_Card_State);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_IsLeaved) == true) {
            if (objQxUsers_Cond.isLeaved == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsLeaved);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsLeaved);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_CardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_CardNo, objQxUsers_Cond.cardNo, strComparisonOp_CardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_BeginYearMonth) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_BeginYearMonth, objQxUsers_Cond.beginYearMonth, strComparisonOp_BeginYearMonth);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_EndYearMonth) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_EndYearMonth, objQxUsers_Cond.endYearMonth, strComparisonOp_EndYearMonth);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_OptUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_OptUser, objQxUsers_Cond.optUser, strComparisonOp_OptUser);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_OptDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_OptDate, objQxUsers_Cond.optDate, strComparisonOp_OptDate);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_Memo, objQxUsers_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_Password) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_Password, objQxUsers_Cond.password, strComparisonOp_Password);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_IsGpUser) == true) {
            if (objQxUsers_Cond.isGpUser == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsGpUser);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsGpUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_SchoolID1) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_SchoolID1, objQxUsers_Cond.schoolID1, strComparisonOp_SchoolID1);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_AvatarsPicture) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_AvatarsPicture, objQxUsers_Cond.avatarsPicture, strComparisonOp_AvatarsPicture);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_Email) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_Email, objQxUsers_Cond.email, strComparisonOp_Email);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_PhoneNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_PhoneNumber, objQxUsers_Cond.phoneNumber, strComparisonOp_PhoneNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_EffectiveDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_EffectiveDate, objQxUsers_Cond.effectiveDate, strComparisonOp_EffectiveDate);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_UpdDate, objQxUsers_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_UpdUser, objQxUsers_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_EffitiveBeginDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_EffitiveBeginDate, objQxUsers_Cond.effitiveBeginDate, strComparisonOp_EffitiveBeginDate);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_EffitiveEndDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_EffitiveEndDate, objQxUsers_Cond.effitiveEndDate, strComparisonOp_EffitiveEndDate);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_id_College) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_id_College, objQxUsers_Cond.id_College, strComparisonOp_id_College);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_StuTeacherID) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_StuTeacherID, objQxUsers_Cond.stuTeacherID, strComparisonOp_StuTeacherID);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_IdentityID) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_IdentityID, objQxUsers_Cond.identityID, strComparisonOp_IdentityID);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_IsArchive) == true) {
            if (objQxUsers_Cond.isArchive == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsArchive);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsArchive);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_headimgUrl) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_headimgUrl, objQxUsers_Cond.headimgUrl, strComparisonOp_headimgUrl);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_OpenId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_OpenId, objQxUsers_Cond.openId, strComparisonOp_OpenId);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_NickName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_NickName, objQxUsers_Cond.nickName, strComparisonOp_NickName);
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_IsSynch) == true) {
            if (objQxUsers_Cond.isSynch == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsSynch);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsQxUsersEN_js_1.clsQxUsersEN.con_IsSynch);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objQxUsers_Cond.dicFldComparisonOp, clsQxUsersEN_js_1.clsQxUsersEN.con_SynchDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsQxUsersEN_js_1.clsQxUsersEN.con_SynchDate, objQxUsers_Cond.synchDate, strComparisonOp_SynchDate);
        }
        return strWhereCond;
    }
