...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsViewpointLikeLogEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function ViewpointLikeLog_GetObjByViewpointLikeLogIdAsync(lngViewpointLikeLogId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpointLikeLog_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpointLikeLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpointLikeLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function ViewpointLikeLog_DelRecordAsync(lngViewpointLikeLogId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngViewpointLikeLogId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": lngViewpointLikeLogId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function ViewpointLikeLog_UpdateRecordAsync(objViewpointLikeLogEN) {
        ...
        if (objViewpointLikeLogEN.sf_UpdFldSetStr === undefined || objViewpointLikeLogEN.sf_UpdFldSetStr === null || objViewpointLikeLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointLikeLogEN.viewpointLikeLogId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpointLikeLog_Controller, strAction);
        try {
    ...
    */
    function ViewpointLikeLog_CheckPropertyNew(pobjViewpointLikeLogEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.viewpointId) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointLikeLogEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointLikeLogEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointLikeLogEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointLikeLogEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjViewpointLikeLogEN.viewpointLikeLogId && undefined !== pobjViewpointLikeLogEN.viewpointLikeLogId && jsString_js_1.tzDataType.isNumber(pobjViewpointLikeLogEN.viewpointLikeLogId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.viewpointId) == false && undefined !== pobjViewpointLikeLogEN.viewpointId && jsString_js_1.tzDataType.isString(pobjViewpointLikeLogEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.updDate) == false && undefined !== pobjViewpointLikeLogEN.updDate && jsString_js_1.tzDataType.isString(pobjViewpointLikeLogEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.updUserId) == false && undefined !== pobjViewpointLikeLogEN.updUserId && jsString_js_1.tzDataType.isString(pobjViewpointLikeLogEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointLikeLogEN.memo) == false && undefined !== pobjViewpointLikeLogEN.memo && jsString_js_1.tzDataType.isString(pobjViewpointLikeLogEN.memo) === false) {
    ...
    */
    function ViewpointLikeLog_GetCombineCondition(objViewpointLikeLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpointLikeLog_Cond.dicFldComparisonOp, clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_ViewpointLikeLogId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_ViewpointLikeLogId, objViewpointLikeLog_Cond.viewpointLikeLogId, strComparisonOp_ViewpointLikeLogId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointLikeLog_Cond.dicFldComparisonOp, clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_ViewpointId, objViewpointLikeLog_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointLikeLog_Cond.dicFldComparisonOp, clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_UpdDate, objViewpointLikeLog_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointLikeLog_Cond.dicFldComparisonOp, clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_UpdUserId, objViewpointLikeLog_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointLikeLog_Cond.dicFldComparisonOp, clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointLikeLogEN_js_1.clsViewpointLikeLogEN.con_Memo, objViewpointLikeLog_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function ViewpointLikeLog_GetUniCondStr_ViewpointLikeLogId_ViewpointId(objViewpointLikeLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointLikeLogId = '{0}'", objViewpointLikeLogEN.viewpointLikeLogId);
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointId = '{0}'", objViewpointLikeLogEN.viewpointId);
        return strWhereCond;
    }
