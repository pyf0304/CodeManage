...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsRTResearchResultEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function RTResearchResult_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTResearchResult_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTResearchResult_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTResearchResult_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function RTResearchResult_UpdateRecordAsync(objRTResearchResultEN) {
        ...
        if (objRTResearchResultEN.sf_UpdFldSetStr === undefined || objRTResearchResultEN.sf_UpdFldSetStr === null || objRTResearchResultEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTResearchResultEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTResearchResult_Controller, strAction);
        try {
    ...
    */
    function RTResearchResult_CheckPropertyNew(pobjRTResearchResultEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 研究结果)!(clsRTResearchResultBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjRTResearchResultEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjRTResearchResultEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjRTResearchResultEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjRTResearchResultEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjRTResearchResultEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjRTResearchResultEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTResearchResultEN.mId && undefined !== pobjRTResearchResultEN.mId && jsString_js_1.tzDataType.isNumber(pobjRTResearchResultEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.topicId) == false && undefined !== pobjRTResearchResultEN.topicId && jsString_js_1.tzDataType.isString(pobjRTResearchResultEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.paperId) == false && undefined !== pobjRTResearchResultEN.paperId && jsString_js_1.tzDataType.isString(pobjRTResearchResultEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.updDate) == false && undefined !== pobjRTResearchResultEN.updDate && jsString_js_1.tzDataType.isString(pobjRTResearchResultEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.updUser) == false && undefined !== pobjRTResearchResultEN.updUser && jsString_js_1.tzDataType.isString(pobjRTResearchResultEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.memo) == false && undefined !== pobjRTResearchResultEN.memo && jsString_js_1.tzDataType.isString(pobjRTResearchResultEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTResearchResultEN.id_CurrEduCls) == false && undefined !== pobjRTResearchResultEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjRTResearchResultEN.id_CurrEduCls) === false) {
    ...
    */
    function RTResearchResult_GetCombineCondition(objRTResearchResult_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_mId, objRTResearchResult_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_TopicId, objRTResearchResult_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_PaperId, objRTResearchResult_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_UpdDate, objRTResearchResult_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_UpdUser, objRTResearchResult_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_Memo, objRTResearchResult_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTResearchResult_Cond.dicFldComparisonOp, clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTResearchResultEN_js_1.clsRTResearchResultEN.con_id_CurrEduCls, objRTResearchResult_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTResearchResult_GetUniCondStr_mId_TopicId_PaperId(objRTResearchResultEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objRTResearchResultEN.mId);
        strWhereCond += (0, clsString_js_1.Format)(" and TopicId = '{0}'", objRTResearchResultEN.topicId);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objRTResearchResultEN.paperId);
        return strWhereCond;
    }
