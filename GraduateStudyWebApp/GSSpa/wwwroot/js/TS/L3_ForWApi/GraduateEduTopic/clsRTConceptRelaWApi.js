...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsRTConceptRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function RTConceptRela_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTConceptRela_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTConceptRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTConceptRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function RTConceptRela_UpdateRecordAsync(objRTConceptRelaEN) {
        ...
        if (objRTConceptRelaEN.sf_UpdFldSetStr === undefined || objRTConceptRelaEN.sf_UpdFldSetStr === null || objRTConceptRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTConceptRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTConceptRela_Controller, strAction);
        try {
    ...
    */
    function RTConceptRela_CheckPropertyNew(pobjRTConceptRelaEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.conceptId) === true) {
            throw new Error("(errid:Watl000058)字段[概念Id]不能为空(In 主题概念关系表)!(clsRTConceptRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.conceptId) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.conceptId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.classificationId) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.classificationId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjRTConceptRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTConceptRelaEN.mId && undefined !== pobjRTConceptRelaEN.mId && jsString_js_1.tzDataType.isNumber(pobjRTConceptRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.topicId) == false && undefined !== pobjRTConceptRelaEN.topicId && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.conceptId) == false && undefined !== pobjRTConceptRelaEN.conceptId && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.conceptId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.updDate) == false && undefined !== pobjRTConceptRelaEN.updDate && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.memo) == false && undefined !== pobjRTConceptRelaEN.memo && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.updUser) == false && undefined !== pobjRTConceptRelaEN.updUser && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.classificationId) == false && undefined !== pobjRTConceptRelaEN.classificationId && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.classificationId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTConceptRelaEN.id_CurrEduCls) == false && undefined !== pobjRTConceptRelaEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjRTConceptRelaEN.id_CurrEduCls) === false) {
    ...
    */
    function RTConceptRela_GetCombineCondition(objRTConceptRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_mId, objRTConceptRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_TopicId, objRTConceptRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_ConceptId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_ConceptId, objRTConceptRela_Cond.conceptId, strComparisonOp_ConceptId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_UpdDate, objRTConceptRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_Memo, objRTConceptRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_UpdUser, objRTConceptRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_ClassificationId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_ClassificationId, objRTConceptRela_Cond.classificationId, strComparisonOp_ClassificationId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTConceptRela_Cond.dicFldComparisonOp, clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTConceptRelaEN_js_1.clsRTConceptRelaEN.con_id_CurrEduCls, objRTConceptRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTConceptRela_GetUniCondStr_mId_TopicId_ConceptId(objRTConceptRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objRTConceptRelaEN.mId);
        strWhereCond += (0, clsString_js_1.Format)(" and TopicId = '{0}'", objRTConceptRelaEN.topicId);
        strWhereCond += (0, clsString_js_1.Format)(" and ConceptId = '{0}'", objRTConceptRelaEN.conceptId);
        return strWhereCond;
    }
