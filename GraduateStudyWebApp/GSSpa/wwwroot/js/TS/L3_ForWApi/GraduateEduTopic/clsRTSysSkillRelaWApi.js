...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsRTSysSkillRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function RTSysSkillRela_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTSysSkillRela_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTSysSkillRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTSysSkillRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function RTSysSkillRela_UpdateRecordAsync(objRTSysSkillRelaEN) {
        ...
        if (objRTSysSkillRelaEN.sf_UpdFldSetStr === undefined || objRTSysSkillRelaEN.sf_UpdFldSetStr === null || objRTSysSkillRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTSysSkillRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTSysSkillRela_Controller, strAction);
        try {
    ...
    */
    function RTSysSkillRela_CheckPropertyNew(pobjRTSysSkillRelaEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.skillId) === true) {
            throw new Error("(errid:Watl000058)字段[技能Id]不能为空(In RTSysSkillRela)!(clsRTSysSkillRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.skillId) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.skillId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.classificationId) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.classificationId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjRTSysSkillRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTSysSkillRelaEN.mId && undefined !== pobjRTSysSkillRelaEN.mId && jsString_js_1.tzDataType.isNumber(pobjRTSysSkillRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.topicId) == false && undefined !== pobjRTSysSkillRelaEN.topicId && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.skillId) == false && undefined !== pobjRTSysSkillRelaEN.skillId && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.skillId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.updDate) == false && undefined !== pobjRTSysSkillRelaEN.updDate && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.updUser) == false && undefined !== pobjRTSysSkillRelaEN.updUser && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.memo) == false && undefined !== pobjRTSysSkillRelaEN.memo && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.classificationId) == false && undefined !== pobjRTSysSkillRelaEN.classificationId && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.classificationId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTSysSkillRelaEN.id_CurrEduCls) == false && undefined !== pobjRTSysSkillRelaEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjRTSysSkillRelaEN.id_CurrEduCls) === false) {
    ...
    */
    function RTSysSkillRela_GetCombineCondition(objRTSysSkillRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_mId, objRTSysSkillRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_TopicId, objRTSysSkillRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_SkillId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_SkillId, objRTSysSkillRela_Cond.skillId, strComparisonOp_SkillId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_UpdDate, objRTSysSkillRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_UpdUser, objRTSysSkillRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_Memo, objRTSysSkillRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_ClassificationId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_ClassificationId, objRTSysSkillRela_Cond.classificationId, strComparisonOp_ClassificationId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSkillRela_Cond.dicFldComparisonOp, clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTSysSkillRelaEN_js_1.clsRTSysSkillRelaEN.con_id_CurrEduCls, objRTSysSkillRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTSysSkillRela_GetUniCondStr_mId(objRTSysSkillRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objRTSysSkillRelaEN.mId);
        return strWhereCond;
    }
