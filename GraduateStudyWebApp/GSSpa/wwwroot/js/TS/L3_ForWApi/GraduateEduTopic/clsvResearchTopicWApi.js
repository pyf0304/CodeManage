...
(function (factory) {
    ...
    */
    async function vResearchTopic_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvResearchTopicEN_js_1.clsvResearchTopicEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvResearchTopicEN_js_1.clsvResearchTopicEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vResearchTopic_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvResearchTopicEN_js_1.clsvResearchTopicEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvResearchTopicEN_js_1.clsvResearchTopicEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvResearchTopicExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvResearchTopicExObjLst);
