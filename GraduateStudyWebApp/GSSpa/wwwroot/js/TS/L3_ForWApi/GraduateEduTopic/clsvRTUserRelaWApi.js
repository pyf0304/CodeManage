...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/CacheHelper.js", "../../L0_Entity/GraduateEduTopic/clsvRTUserRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/clsString.js"], factory);
    }
        ...
        try {
            ...
            if (arrvRTUserRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objvRTUserRela = await vRTUserRela_GetObjBymIdAsync(lngmId);
    ...
    */
    async function vRTUserRela_func(strInFldName, strOutFldName, strInValue, strTopicId_C) {
        ...
        if (clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vRTUserRela_GetObjLst_ClientCache(strTopicId) {
        ...
        clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvRTUserRelaExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvRTUserRelaExObjLst);
