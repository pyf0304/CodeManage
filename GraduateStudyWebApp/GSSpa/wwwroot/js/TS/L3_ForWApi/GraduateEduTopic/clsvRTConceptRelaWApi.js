...
(function (factory) {
    ...
    */
    async function vRTConceptRela_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvRTConceptRelaEN_js_1.clsvRTConceptRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvRTConceptRelaEN_js_1.clsvRTConceptRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vRTConceptRela_GetObjLst_ClientCache() {
        ...
        clsvRTConceptRelaEN_js_1.clsvRTConceptRelaEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvRTConceptRelaEN_js_1.clsvRTConceptRelaEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvRTConceptRelaExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvRTConceptRelaExObjLst);
