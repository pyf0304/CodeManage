...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsgs_MeetingMinutesEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    async function gs_MeetingMinutes_GetObjByMeetingIdAsync(strMeetingId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_MeetingMinutes_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_MeetingMinutes_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_MeetingMinutes_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    **/
    async function gs_MeetingMinutes_DelRecordAsync(strMeetingId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strMeetingId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": strMeetingId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function gs_MeetingMinutes_UpdateRecordAsync(objgs_MeetingMinutesEN) {
        ...
        if (objgs_MeetingMinutesEN.sf_UpdFldSetStr === undefined || objgs_MeetingMinutesEN.sf_UpdFldSetStr === null || objgs_MeetingMinutesEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_MeetingMinutesEN.meetingId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_MeetingMinutes_Controller, strAction);
        try {
    ...
    */
    function gs_MeetingMinutes_CheckPropertyNew(pobjgs_MeetingMinutesEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.meetingId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.meetingId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.meetingDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.meetingDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.year) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.year) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.month) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.month) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.participants) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.participants) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_MeetingMinutesEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.meetingId) == false && undefined !== pobjgs_MeetingMinutesEN.meetingId && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.meetingId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.topicId) == false && undefined !== pobjgs_MeetingMinutesEN.topicId && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.topicId) === false) {
        ...
        if (null != pobjgs_MeetingMinutesEN.isSubmit && undefined !== pobjgs_MeetingMinutesEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjgs_MeetingMinutesEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.meetingContent) == false && undefined !== pobjgs_MeetingMinutesEN.meetingContent && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.meetingContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.meetingDate) == false && undefined !== pobjgs_MeetingMinutesEN.meetingDate && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.meetingDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.updDate) == false && undefined !== pobjgs_MeetingMinutesEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.updUser) == false && undefined !== pobjgs_MeetingMinutesEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.year) == false && undefined !== pobjgs_MeetingMinutesEN.year && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.year) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.month) == false && undefined !== pobjgs_MeetingMinutesEN.month && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.month) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.memo) == false && undefined !== pobjgs_MeetingMinutesEN.memo && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.memo) === false) {
        ...
        if (null != pobjgs_MeetingMinutesEN.versionCount && undefined !== pobjgs_MeetingMinutesEN.versionCount && jsString_js_1.tzDataType.isNumber(pobjgs_MeetingMinutesEN.versionCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.participants) == false && undefined !== pobjgs_MeetingMinutesEN.participants && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.participants) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.id_CurrEduCls) == false && undefined !== pobjgs_MeetingMinutesEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_MeetingMinutesEN.id_CurrEduCls) === false) {
    ...
    */
    function gs_MeetingMinutes_CheckProperty4Update(pobjgs_MeetingMinutesEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_MeetingMinutesEN.meetingId) === true) {
    ...
    */
    function gs_MeetingMinutes_GetCombineCondition(objgs_MeetingMinutes_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_MeetingId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_MeetingId, objgs_MeetingMinutes_Cond.meetingId, strComparisonOp_MeetingId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_TopicId, objgs_MeetingMinutes_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_IsSubmit) == true) {
            if (objgs_MeetingMinutes_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_IsSubmit);
            }
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_MeetingDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_MeetingDate, objgs_MeetingMinutes_Cond.meetingDate, strComparisonOp_MeetingDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_UpdDate, objgs_MeetingMinutes_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_UpdUser, objgs_MeetingMinutes_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Year) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Year, objgs_MeetingMinutes_Cond.year, strComparisonOp_Year);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Month) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Month, objgs_MeetingMinutes_Cond.month, strComparisonOp_Month);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Memo, objgs_MeetingMinutes_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_VersionCount, objgs_MeetingMinutes_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Participants) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_Participants, objgs_MeetingMinutes_Cond.participants, strComparisonOp_Participants);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_MeetingMinutes_Cond.dicFldComparisonOp, clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN.con_id_CurrEduCls, objgs_MeetingMinutes_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_MeetingMinutes_GetUniCondStr_MeetingId(objgs_MeetingMinutesEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and MeetingId = '{0}'", objgs_MeetingMinutesEN.meetingId);
        return strWhereCond;
    }
