...
(function (factory) {
    ...
    async function ConceptAttachment_GetObjByConceptAttachmentIdAsync(lngConceptAttachmentId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.conceptAttachment_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.conceptAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.conceptAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ConceptAttachment_GetObjByConceptAttachmentId_localStorage(lngConceptAttachmentId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN._CurrTabName, lngConceptAttachmentId);
        if (strKey == "") {
    ...
    */
    async function ConceptAttachment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function ConceptAttachment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN._CurrTabName, strid_CurrEduCls);
        clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsConceptAttachmentEN_js_1.clsConceptAttachmentEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrConceptAttachmentExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrConceptAttachmentExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrConceptAttachmentExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ConceptAttachment_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrConceptAttachmentExObjLst.length);
            console.log(strInfo);
            return arrConceptAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ConceptAttachment_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrConceptAttachmentExObjLst.length);
            console.log(strInfo);
            return arrConceptAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ConceptAttachment_DelRecordAsync(lngConceptAttachmentId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngConceptAttachmentId);
        try {
    ...
    **/
    async function ConceptAttachment_UpdateRecordAsync(objConceptAttachmentEN) {
        ...
        if (objConceptAttachmentEN.sf_UpdFldSetStr === undefined || objConceptAttachmentEN.sf_UpdFldSetStr === null || objConceptAttachmentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objConceptAttachmentEN.conceptAttachmentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.conceptAttachment_Controller, strAction);
        try {
    ...
    */
    async function ConceptAttachment_IsExistRecord_Cache(objConceptAttachment_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objConceptAttachment_Cond), exports.conceptAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ConceptAttachment_IsExist_Cache(lngConceptAttachmentId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngConceptAttachmentId, exports.conceptAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function ConceptAttachment_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsConceptAttachmentWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function ConceptAttachment_CheckPropertyNew(pobjConceptAttachmentEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.conceptId) === true) {
            throw new Error("(errid:Watl000058)字段[概念Id]不能为空(In 概念附件)!(clsConceptAttachmentBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.filePath) === true) {
            throw new Error("(errid:Watl000058)字段[文件路径]不能为空(In 概念附件)!(clsConceptAttachmentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.conceptAttachmentName) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.conceptAttachmentName) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.conceptId) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.conceptId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.filePath) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.filePath) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.updUserId) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjConceptAttachmentEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjConceptAttachmentEN.conceptAttachmentId && undefined !== pobjConceptAttachmentEN.conceptAttachmentId && jsString_js_1.tzDataType.isNumber(pobjConceptAttachmentEN.conceptAttachmentId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.conceptAttachmentName) == false && undefined !== pobjConceptAttachmentEN.conceptAttachmentName && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.conceptAttachmentName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.conceptId) == false && undefined !== pobjConceptAttachmentEN.conceptId && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.conceptId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.filePath) == false && undefined !== pobjConceptAttachmentEN.filePath && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.filePath) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.updDate) == false && undefined !== pobjConceptAttachmentEN.updDate && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.updUserId) == false && undefined !== pobjConceptAttachmentEN.updUserId && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.updUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.memo) == false && undefined !== pobjConceptAttachmentEN.memo && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjConceptAttachmentEN.id_CurrEduCls) == false && undefined !== pobjConceptAttachmentEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjConceptAttachmentEN.id_CurrEduCls) === false) {
    ...
    */
    function ConceptAttachment_GetCombineCondition(objConceptAttachment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_ConceptAttachmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_ConceptAttachmentId, objConceptAttachment_Cond.conceptAttachmentId, strComparisonOp_ConceptAttachmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_ConceptAttachmentName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_ConceptAttachmentName, objConceptAttachment_Cond.conceptAttachmentName, strComparisonOp_ConceptAttachmentName);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_ConceptId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_ConceptId, objConceptAttachment_Cond.conceptId, strComparisonOp_ConceptId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_FilePath) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_FilePath, objConceptAttachment_Cond.filePath, strComparisonOp_FilePath);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_UpdDate, objConceptAttachment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_UpdUserId, objConceptAttachment_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_Memo, objConceptAttachment_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptAttachment_Cond.dicFldComparisonOp, clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsConceptAttachmentEN_js_1.clsConceptAttachmentEN.con_id_CurrEduCls, objConceptAttachment_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function ConceptAttachment_GetUniCondStr_ConceptAttachmentId_ConceptId(objConceptAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ConceptAttachmentId = '{0}'", objConceptAttachmentEN.conceptAttachmentId);
        strWhereCond += (0, clsString_js_1.Format)(" and ConceptId = '{0}'", objConceptAttachmentEN.conceptId);
        return strWhereCond;
    }
