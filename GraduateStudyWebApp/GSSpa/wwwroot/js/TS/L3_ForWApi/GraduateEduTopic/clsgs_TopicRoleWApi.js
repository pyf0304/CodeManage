...
(function (factory) {
    ...
    **/
    async function gs_TopicRole_GetObjByTopicRoleIdAsync(strTopicRoleId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicRoleId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicRoleId]不能为空！(In GetObjByTopicRoleIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicRoleId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicRoleId]的长度:[{0}]不正确！", strTopicRoleId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TopicRole_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TopicRole_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TopicRole_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TopicRole_GetObjByTopicRoleId_Cache(strTopicRoleId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicRoleId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicRoleId]不能为空！(In GetObjByTopicRoleId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicRoleId.length != 10) {
    ...
    */
    async function gs_TopicRole_GetObjByTopicRoleId_localStorage(strTopicRoleId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicRoleId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicRoleId]不能为空！(In GetObjByTopicRoleId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicRoleId.length != 10) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN._CurrTabName, strTopicRoleId);
        if (strKey == "") {
    ...
    */
    async function gs_TopicRole_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_TopicRole_GetObjLst_ClientCache() {
        ...
        clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TopicRoleExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_TopicRoleExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TopicRoleExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TopicRole_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TopicRoleExObjLst.length);
            console.log(strInfo);
            return arrgs_TopicRoleExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TopicRole_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TopicRoleExObjLst.length);
            console.log(strInfo);
            return arrgs_TopicRoleExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TopicRole_DelRecordAsync(strTopicRoleId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strTopicRoleId);
        try {
    ...
    **/
    async function gs_TopicRole_UpdateRecordAsync(objgs_TopicRoleEN) {
        ...
        if (objgs_TopicRoleEN.sf_UpdFldSetStr === undefined || objgs_TopicRoleEN.sf_UpdFldSetStr === null || objgs_TopicRoleEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TopicRoleEN.topicRoleId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TopicRole_Controller, strAction);
        try {
    ...
    */
    async function gs_TopicRole_IsExistRecord_Cache(objgs_TopicRole_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TopicRole_Cond), exports.gs_TopicRole_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TopicRole_IsExist_Cache(strTopicRoleId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTopicRoleId, exports.gs_TopicRole_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_TopicRole_CheckPropertyNew(pobjgs_TopicRoleEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.topicRoleId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.topicRoleId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.menuNum) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.menuNum) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.menuName) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.menuName) > 100) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TopicRoleEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.topicRoleId) == false && undefined !== pobjgs_TopicRoleEN.topicRoleId && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.topicRoleId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.topicId) == false && undefined !== pobjgs_TopicRoleEN.topicId && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.menuNum) == false && undefined !== pobjgs_TopicRoleEN.menuNum && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.menuNum) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.menuName) == false && undefined !== pobjgs_TopicRoleEN.menuName && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.menuName) === false) {
        ...
        if (null != pobjgs_TopicRoleEN.menuIsHide && undefined !== pobjgs_TopicRoleEN.menuIsHide && jsString_js_1.tzDataType.isBoolean(pobjgs_TopicRoleEN.menuIsHide) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.updDate) == false && undefined !== pobjgs_TopicRoleEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.updUser) == false && undefined !== pobjgs_TopicRoleEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.memo) == false && undefined !== pobjgs_TopicRoleEN.memo && jsString_js_1.tzDataType.isString(pobjgs_TopicRoleEN.memo) === false) {
        ...
        if (null != pobjgs_TopicRoleEN.isDefault && undefined !== pobjgs_TopicRoleEN.isDefault && jsString_js_1.tzDataType.isBoolean(pobjgs_TopicRoleEN.isDefault) === false) {
    ...
    */
    function gs_TopicRole_CheckProperty4Update(pobjgs_TopicRoleEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TopicRoleEN.topicRoleId) === true) {
    ...
    */
    function gs_TopicRole_GetCombineCondition(objgs_TopicRole_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_TopicRoleId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_TopicRoleId, objgs_TopicRole_Cond.topicRoleId, strComparisonOp_TopicRoleId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_TopicId, objgs_TopicRole_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuNum, objgs_TopicRole_Cond.menuNum, strComparisonOp_MenuNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuName, objgs_TopicRole_Cond.menuName, strComparisonOp_MenuName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuIsHide) == true) {
            if (objgs_TopicRole_Cond.menuIsHide == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuIsHide);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_MenuIsHide);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_UpdDate, objgs_TopicRole_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_UpdUser, objgs_TopicRole_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_Memo, objgs_TopicRole_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicRole_Cond.dicFldComparisonOp, clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_IsDefault) == true) {
            if (objgs_TopicRole_Cond.isDefault == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_IsDefault);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsgs_TopicRoleEN_js_1.clsgs_TopicRoleEN.con_IsDefault);
            }
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_TopicRole_GetUniCondStr_TopicRoleId(objgs_TopicRoleEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and TopicRoleId = '{0}'", objgs_TopicRoleEN.topicRoleId);
        return strWhereCond;
    }
