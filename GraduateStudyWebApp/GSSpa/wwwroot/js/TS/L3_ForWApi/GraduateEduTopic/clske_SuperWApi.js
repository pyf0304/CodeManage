...
(function (factory) {
    ...
    **/
    async function ke_Super_GetObjByke_SuperIdAsync(strke_SuperId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strke_SuperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strke_SuperId]不能为空！(In GetObjByke_SuperIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SuperId.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strke_SuperId]的长度:[{0}]不正确！", strke_SuperId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.ke_Super_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.ke_Super_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.ke_Super_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ke_Super_GetObjByke_SuperId_Cache(strke_SuperId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strke_SuperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strke_SuperId]不能为空！(In GetObjByke_SuperId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SuperId.length != 4) {
    ...
    */
    async function ke_Super_GetObjByke_SuperId_localStorage(strke_SuperId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strke_SuperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strke_SuperId]不能为空！(In GetObjByke_SuperId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SuperId.length != 4) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clske_SuperEN_js_1.clske_SuperEN._CurrTabName, strke_SuperId);
        if (strKey == "") {
    ...
    */
    async function ke_Super_GetNameByke_SuperId_Cache(strke_SuperId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strke_SuperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strke_SuperId]不能为空！(In GetNameByke_SuperId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SuperId.length != 4) {
    ...
    */
    async function ke_Super_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clske_SuperEN_js_1.clske_SuperEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clske_SuperEN_js_1.clske_SuperEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function ke_Super_GetObjLst_ClientCache() {
        ...
        clske_SuperEN_js_1.clske_SuperEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clske_SuperEN_js_1.clske_SuperEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clske_SuperEN_js_1.clske_SuperEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clske_SuperEN_js_1.clske_SuperEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrke_SuperExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrke_SuperExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SuperExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ke_Super_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SuperExObjLst.length);
            console.log(strInfo);
            return arrke_SuperExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ke_Super_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SuperExObjLst.length);
            console.log(strInfo);
            return arrke_SuperExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ke_Super_DelRecordAsync(strke_SuperId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strke_SuperId);
        try {
    ...
    **/
    async function ke_Super_UpdateRecordAsync(objke_SuperEN) {
        ...
        if (objke_SuperEN.sf_UpdFldSetStr === undefined || objke_SuperEN.sf_UpdFldSetStr === null || objke_SuperEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objke_SuperEN.ke_SuperId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.ke_Super_Controller, strAction);
        try {
    ...
    */
    async function ke_Super_IsExistRecord_Cache(objke_Super_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objke_Super_Cond), exports.ke_Super_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ke_Super_IsExist_Cache(strke_SuperId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strke_SuperId, exports.ke_Super_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function ke_Super_BindDdl_ke_SuperIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_ke_SuperIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function ke_Super_CheckPropertyNew(pobjke_SuperEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperName_cn) === true) {
            throw new Error("(errid:Watl000058)字段[知识分类名]不能为空(In 知识经济父类)!(clske_SuperBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperId) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.ke_SuperId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperName_cn) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.ke_SuperName_cn) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperName_en) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.ke_SuperName_en) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperDescribe_cn) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.ke_SuperDescribe_cn) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperDescribe_en) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.ke_SuperDescribe_en) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjke_SuperEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperId) == false && undefined !== pobjke_SuperEN.ke_SuperId && jsString_js_1.tzDataType.isString(pobjke_SuperEN.ke_SuperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperName_cn) == false && undefined !== pobjke_SuperEN.ke_SuperName_cn && jsString_js_1.tzDataType.isString(pobjke_SuperEN.ke_SuperName_cn) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperName_en) == false && undefined !== pobjke_SuperEN.ke_SuperName_en && jsString_js_1.tzDataType.isString(pobjke_SuperEN.ke_SuperName_en) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperDescribe_cn) == false && undefined !== pobjke_SuperEN.ke_SuperDescribe_cn && jsString_js_1.tzDataType.isString(pobjke_SuperEN.ke_SuperDescribe_cn) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperDescribe_en) == false && undefined !== pobjke_SuperEN.ke_SuperDescribe_en && jsString_js_1.tzDataType.isString(pobjke_SuperEN.ke_SuperDescribe_en) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.updDate) == false && undefined !== pobjke_SuperEN.updDate && jsString_js_1.tzDataType.isString(pobjke_SuperEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.updUser) == false && undefined !== pobjke_SuperEN.updUser && jsString_js_1.tzDataType.isString(pobjke_SuperEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.memo) == false && undefined !== pobjke_SuperEN.memo && jsString_js_1.tzDataType.isString(pobjke_SuperEN.memo) === false) {
    ...
    */
    function ke_Super_CheckProperty4Update(pobjke_SuperEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjke_SuperEN.ke_SuperId) === true) {
    ...
    */
    function ke_Super_GetCombineCondition(objke_Super_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperId, objke_Super_Cond.ke_SuperId, strComparisonOp_ke_SuperId);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperName_cn) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperName_cn, objke_Super_Cond.ke_SuperName_cn, strComparisonOp_ke_SuperName_cn);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperName_en) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperName_en, objke_Super_Cond.ke_SuperName_en, strComparisonOp_ke_SuperName_en);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperDescribe_cn) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperDescribe_cn, objke_Super_Cond.ke_SuperDescribe_cn, strComparisonOp_ke_SuperDescribe_cn);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperDescribe_en) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_ke_SuperDescribe_en, objke_Super_Cond.ke_SuperDescribe_en, strComparisonOp_ke_SuperDescribe_en);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_UpdDate, objke_Super_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_UpdUser, objke_Super_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN_js_1.clske_SuperEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clske_SuperEN_js_1.clske_SuperEN.con_Memo, objke_Super_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
