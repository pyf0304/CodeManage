...
(function (factory) {
    ...
    **/
    async function gs_ResearchPlan_GetObjByPlanIdAsync(strPlanId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPlanId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPlanId]不能为空！(In GetObjByPlanIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPlanId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strPlanId]的长度:[{0}]不正确！", strPlanId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ResearchPlan_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ResearchPlan_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ResearchPlan_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_ResearchPlan_GetObjByPlanId_Cache(strPlanId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPlanId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPlanId]不能为空！(In GetObjByPlanId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPlanId.length != 8) {
        ...
        try {
            ...
            if (arrgs_ResearchPlan_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objgs_ResearchPlan = await gs_ResearchPlan_GetObjByPlanIdAsync(strPlanId);
    ...
    */
    async function gs_ResearchPlan_GetObjByPlanId_localStorage(strPlanId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPlanId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPlanId]不能为空！(In GetObjByPlanId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPlanId.length != 8) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN._CurrTabName, strPlanId);
        if (strKey == "") {
    ...
    */
    async function gs_ResearchPlan_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_ResearchPlan_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN._CurrTabName, strid_CurrEduCls);
        clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_ResearchPlanExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_ResearchPlanExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ResearchPlanExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_ResearchPlan_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ResearchPlanExObjLst.length);
            console.log(strInfo);
            return arrgs_ResearchPlanExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_ResearchPlan_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ResearchPlanExObjLst.length);
            console.log(strInfo);
            return arrgs_ResearchPlanExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_ResearchPlan_DelRecordAsync(strPlanId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strPlanId);
        try {
    ...
    **/
    async function gs_ResearchPlan_UpdateRecordAsync(objgs_ResearchPlanEN) {
        ...
        if (objgs_ResearchPlanEN.sf_UpdFldSetStr === undefined || objgs_ResearchPlanEN.sf_UpdFldSetStr === null || objgs_ResearchPlanEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ResearchPlanEN.planId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ResearchPlan_Controller, strAction);
        try {
    ...
    */
    async function gs_ResearchPlan_IsExistRecord_Cache(objgs_ResearchPlan_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_ResearchPlan_Cond), exports.gs_ResearchPlan_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_ResearchPlan_IsExist_Cache(strPlanId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strPlanId, exports.gs_ResearchPlan_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_ResearchPlan_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_ResearchPlanWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function gs_ResearchPlan_CheckPropertyNew(pobjgs_ResearchPlanEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.topicId) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.statusId) === true) {
            throw new Error("(errid:Watl000058)字段[状态Id]不能为空(In 主题研究计划)!(clsgs_ResearchPlanBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.planId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.statusId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.statusId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planContent) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.planContent) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.responsibleUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.responsibleUser) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.startDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.startDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.endDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.endDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.actualFinishingDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.actualFinishingDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.acceptanceUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.acceptanceUser) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.planTypeId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_ResearchPlanEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planId) == false && undefined !== pobjgs_ResearchPlanEN.planId && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.planId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.topicId) == false && undefined !== pobjgs_ResearchPlanEN.topicId && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.statusId) == false && undefined !== pobjgs_ResearchPlanEN.statusId && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.statusId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planContent) == false && undefined !== pobjgs_ResearchPlanEN.planContent && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.planContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.responsibleUser) == false && undefined !== pobjgs_ResearchPlanEN.responsibleUser && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.responsibleUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.startDate) == false && undefined !== pobjgs_ResearchPlanEN.startDate && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.startDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.endDate) == false && undefined !== pobjgs_ResearchPlanEN.endDate && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.endDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.actualFinishingDate) == false && undefined !== pobjgs_ResearchPlanEN.actualFinishingDate && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.actualFinishingDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.acceptanceUser) == false && undefined !== pobjgs_ResearchPlanEN.acceptanceUser && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.acceptanceUser) === false) {
        ...
        if (null != pobjgs_ResearchPlanEN.isSubmit && undefined !== pobjgs_ResearchPlanEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjgs_ResearchPlanEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.updUser) == false && undefined !== pobjgs_ResearchPlanEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.updDate) == false && undefined !== pobjgs_ResearchPlanEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.memo) == false && undefined !== pobjgs_ResearchPlanEN.memo && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planTypeId) == false && undefined !== pobjgs_ResearchPlanEN.planTypeId && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.planTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.id_CurrEduCls) == false && undefined !== pobjgs_ResearchPlanEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_ResearchPlanEN.id_CurrEduCls) === false) {
    ...
    */
    function gs_ResearchPlan_CheckProperty4Update(pobjgs_ResearchPlanEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_ResearchPlanEN.planId) === true) {
    ...
    */
    function gs_ResearchPlan_GetCombineCondition(objgs_ResearchPlan_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_PlanId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_PlanId, objgs_ResearchPlan_Cond.planId, strComparisonOp_PlanId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_TopicId, objgs_ResearchPlan_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_StatusId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_StatusId, objgs_ResearchPlan_Cond.statusId, strComparisonOp_StatusId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_PlanContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_PlanContent, objgs_ResearchPlan_Cond.planContent, strComparisonOp_PlanContent);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_ResponsibleUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_ResponsibleUser, objgs_ResearchPlan_Cond.responsibleUser, strComparisonOp_ResponsibleUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_StartDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_StartDate, objgs_ResearchPlan_Cond.startDate, strComparisonOp_StartDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_EndDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_EndDate, objgs_ResearchPlan_Cond.endDate, strComparisonOp_EndDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_ActualFinishingDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_ActualFinishingDate, objgs_ResearchPlan_Cond.actualFinishingDate, strComparisonOp_ActualFinishingDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_AcceptanceUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_AcceptanceUser, objgs_ResearchPlan_Cond.acceptanceUser, strComparisonOp_AcceptanceUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_IsSubmit) == true) {
            if (objgs_ResearchPlan_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_UpdUser, objgs_ResearchPlan_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_UpdDate, objgs_ResearchPlan_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_Memo, objgs_ResearchPlan_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_PlanTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_PlanTypeId, objgs_ResearchPlan_Cond.planTypeId, strComparisonOp_PlanTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchPlan_Cond.dicFldComparisonOp, clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_ResearchPlanEN_js_1.clsgs_ResearchPlanEN.con_id_CurrEduCls, objgs_ResearchPlan_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ResearchPlan_GetUniCondStr_PlanId(objgs_ResearchPlanEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PlanId = '{0}'", objgs_ResearchPlanEN.planId);
        return strWhereCond;
    }
