...
(function (factory) {
        ...
        try {
            ...
            if (arrvViewpoint_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objvViewpoint = await vViewpoint_GetObjByViewpointIdAsync(strViewpointId);
    ...
    */
    async function vViewpoint_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsvViewpointEN_js_1.clsvViewpointEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvViewpointEN_js_1.clsvViewpointEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vViewpoint_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        clsvViewpointEN_js_1.clsvViewpointEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvViewpointEN_js_1.clsvViewpointEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvViewpointExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvViewpointExObjLst);
