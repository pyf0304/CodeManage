...
(function (factory) {
    ...
    **/
    async function ResearchTopic_GetObjByTopicIdAsync(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId]不能为空！(In GetObjByTopicIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.researchTopic_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.researchTopic_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.researchTopic_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ResearchTopic_GetObjByTopicId_Cache(strTopicId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId]不能为空！(In GetObjByTopicId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
        ...
        try {
            ...
            if (arrResearchTopic_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objResearchTopic = await ResearchTopic_GetObjByTopicIdAsync(strTopicId);
    ...
    */
    async function ResearchTopic_GetObjByTopicId_localStorage(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId]不能为空！(In GetObjByTopicId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsResearchTopicEN_js_1.clsResearchTopicEN._CurrTabName, strTopicId);
        if (strKey == "") {
    ...
    */
    async function ResearchTopic_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsResearchTopicEN_js_1.clsResearchTopicEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsResearchTopicEN_js_1.clsResearchTopicEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function ResearchTopic_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsResearchTopicEN_js_1.clsResearchTopicEN._CurrTabName, strid_CurrEduCls);
        clsResearchTopicEN_js_1.clsResearchTopicEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsResearchTopicEN_js_1.clsResearchTopicEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsResearchTopicEN_js_1.clsResearchTopicEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsResearchTopicEN_js_1.clsResearchTopicEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrResearchTopicExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrResearchTopicExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrResearchTopicExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ResearchTopic_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrResearchTopicExObjLst.length);
            console.log(strInfo);
            return arrResearchTopicExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ResearchTopic_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrResearchTopicExObjLst.length);
            console.log(strInfo);
            return arrResearchTopicExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ResearchTopic_UpdateRecordAsync(objResearchTopicEN) {
        ...
        if (objResearchTopicEN.sf_UpdFldSetStr === undefined || objResearchTopicEN.sf_UpdFldSetStr === null || objResearchTopicEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objResearchTopicEN.topicId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.researchTopic_Controller, strAction);
        try {
    ...
    */
    async function ResearchTopic_IsExistRecord_Cache(objResearchTopic_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objResearchTopic_Cond), exports.researchTopic_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ResearchTopic_IsExist_Cache(strTopicId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTopicId, exports.researchTopic_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function ResearchTopic_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsResearchTopicWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function ResearchTopic_CheckPropertyNew(pobjResearchTopicEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.shareId) === true) {
            throw new Error("(errid:Watl000058)字段[分享Id]不能为空(In 研究主题)!(clsResearchTopicBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicName) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.topicName) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicProposePeople) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.topicProposePeople) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.shareId) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.shareId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjResearchTopicEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicId) == false && undefined !== pobjResearchTopicEN.topicId && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicName) == false && undefined !== pobjResearchTopicEN.topicName && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.topicName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicContent) == false && undefined !== pobjResearchTopicEN.topicContent && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.topicContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicProposePeople) == false && undefined !== pobjResearchTopicEN.topicProposePeople && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.topicProposePeople) === false) {
        ...
        if (null != pobjResearchTopicEN.orderNum && undefined !== pobjResearchTopicEN.orderNum && jsString_js_1.tzDataType.isNumber(pobjResearchTopicEN.orderNum) === false) {
        ...
        if (null != pobjResearchTopicEN.isSubmit && undefined !== pobjResearchTopicEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjResearchTopicEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.id_CurrEduCls) == false && undefined !== pobjResearchTopicEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.shareId) == false && undefined !== pobjResearchTopicEN.shareId && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.shareId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.updDate) == false && undefined !== pobjResearchTopicEN.updDate && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.updUser) == false && undefined !== pobjResearchTopicEN.updUser && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.memo) == false && undefined !== pobjResearchTopicEN.memo && jsString_js_1.tzDataType.isString(pobjResearchTopicEN.memo) === false) {
    ...
    */
    function ResearchTopic_CheckProperty4Update(pobjResearchTopicEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjResearchTopicEN.topicId) === true
    ...
    */
    function ResearchTopic_GetCombineCondition(objResearchTopic_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicId, objResearchTopic_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicName, objResearchTopic_Cond.topicName, strComparisonOp_TopicName);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicProposePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicProposePeople, objResearchTopic_Cond.topicProposePeople, strComparisonOp_TopicProposePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsResearchTopicEN_js_1.clsResearchTopicEN.con_OrderNum, objResearchTopic_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_IsSubmit) == true) {
            if (objResearchTopic_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_id_CurrEduCls, objResearchTopic_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_ShareId, objResearchTopic_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_UpdDate, objResearchTopic_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_UpdUser, objResearchTopic_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objResearchTopic_Cond.dicFldComparisonOp, clsResearchTopicEN_js_1.clsResearchTopicEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsResearchTopicEN_js_1.clsResearchTopicEN.con_Memo, objResearchTopic_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function ResearchTopic_GetUniCondStr_TopicId(objResearchTopicEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and TopicId = '{0}'", objResearchTopicEN.topicId);
        return strWhereCond;
    }
