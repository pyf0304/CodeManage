...
(function (factory) {
    ...
    **/
    async function SysSkill_GetObjBySkillIdAsync(strSkillId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSkillId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSkillId]不能为空！(In GetObjBySkillIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSkillId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strSkillId]的长度:[{0}]不正确！", strSkillId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysSkill_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysSkill_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysSkill_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysSkill_GetObjBySkillId_Cache(strSkillId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSkillId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSkillId]不能为空！(In GetObjBySkillId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSkillId.length != 10) {
    ...
    */
    async function SysSkill_GetObjBySkillId_localStorage(strSkillId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSkillId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSkillId]不能为空！(In GetObjBySkillId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSkillId.length != 10) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSysSkillEN_js_1.clsSysSkillEN._CurrTabName, strSkillId);
        if (strKey == "") {
    ...
    */
    async function SysSkill_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsSysSkillEN_js_1.clsSysSkillEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsSysSkillEN_js_1.clsSysSkillEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function SysSkill_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSysSkillEN_js_1.clsSysSkillEN._CurrTabName, strid_CurrEduCls);
        clsSysSkillEN_js_1.clsSysSkillEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsSysSkillEN_js_1.clsSysSkillEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsSysSkillEN_js_1.clsSysSkillEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsSysSkillEN_js_1.clsSysSkillEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysSkillExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrSysSkillExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSkillExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysSkill_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSkillExObjLst.length);
            console.log(strInfo);
            return arrSysSkillExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysSkill_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSkillExObjLst.length);
            console.log(strInfo);
            return arrSysSkillExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysSkill_DelRecordAsync(strSkillId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strSkillId);
        try {
    ...
    **/
    async function SysSkill_UpdateRecordAsync(objSysSkillEN) {
        ...
        if (objSysSkillEN.sf_UpdFldSetStr === undefined || objSysSkillEN.sf_UpdFldSetStr === null || objSysSkillEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysSkillEN.skillId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysSkill_Controller, strAction);
        try {
    ...
    */
    async function SysSkill_IsExistRecord_Cache(objSysSkill_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysSkill_Cond), exports.sysSkill_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysSkill_IsExist_Cache(strSkillId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strSkillId, exports.sysSkill_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function SysSkill_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsSysSkillWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function SysSkill_CheckPropertyNew(pobjSysSkillEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.skillId) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.skillId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.skillName) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.skillName) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.operationTypeId) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.operationTypeId) > 4) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.levelId) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.levelId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.citationId) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.citationId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.pdfContent) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.pdfContent) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.createDate) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.createDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.shareId) == false && (0, clsString_js_1.GetStrLen)(pobjSysSkillEN.shareId) > 2) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.skillId) == false && undefined !== pobjSysSkillEN.skillId && jsString_js_1.tzDataType.isString(pobjSysSkillEN.skillId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.skillName) == false && undefined !== pobjSysSkillEN.skillName && jsString_js_1.tzDataType.isString(pobjSysSkillEN.skillName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.operationTypeId) == false && undefined !== pobjSysSkillEN.operationTypeId && jsString_js_1.tzDataType.isString(pobjSysSkillEN.operationTypeId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.process) == false && undefined !== pobjSysSkillEN.process && jsString_js_1.tzDataType.isString(pobjSysSkillEN.process) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.levelId) == false && undefined !== pobjSysSkillEN.levelId && jsString_js_1.tzDataType.isString(pobjSysSkillEN.levelId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.updUser) == false && undefined !== pobjSysSkillEN.updUser && jsString_js_1.tzDataType.isString(pobjSysSkillEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.updDate) == false && undefined !== pobjSysSkillEN.updDate && jsString_js_1.tzDataType.isString(pobjSysSkillEN.updDate) === false) {
        ...
        if (null != pobjSysSkillEN.isSubmit && undefined !== pobjSysSkillEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjSysSkillEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.citationId) == false && undefined !== pobjSysSkillEN.citationId && jsString_js_1.tzDataType.isString(pobjSysSkillEN.citationId) === false) {
        ...
        if (null != pobjSysSkillEN.okCount && undefined !== pobjSysSkillEN.okCount && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.okCount) === false) {
        ...
        if (null != pobjSysSkillEN.appraiseCount && undefined !== pobjSysSkillEN.appraiseCount && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.appraiseCount) === false) {
        ...
        if (null != pobjSysSkillEN.score && undefined !== pobjSysSkillEN.score && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.score) === false) {
        ...
        if (null != pobjSysSkillEN.stuScore && undefined !== pobjSysSkillEN.stuScore && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.stuScore) === false) {
        ...
        if (null != pobjSysSkillEN.teaScore && undefined !== pobjSysSkillEN.teaScore && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.teaScore) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.id_CurrEduCls) == false && undefined !== pobjSysSkillEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjSysSkillEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.pdfContent) == false && undefined !== pobjSysSkillEN.pdfContent && jsString_js_1.tzDataType.isString(pobjSysSkillEN.pdfContent) === false) {
        ...
        if (null != pobjSysSkillEN.pdfPageNum && undefined !== pobjSysSkillEN.pdfPageNum && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.pdfPageNum) === false) {
        ...
        if (null != pobjSysSkillEN.citationCount && undefined !== pobjSysSkillEN.citationCount && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.citationCount) === false) {
        ...
        if (null != pobjSysSkillEN.versionCount && undefined !== pobjSysSkillEN.versionCount && jsString_js_1.tzDataType.isNumber(pobjSysSkillEN.versionCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.memo) == false && undefined !== pobjSysSkillEN.memo && jsString_js_1.tzDataType.isString(pobjSysSkillEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.createDate) == false && undefined !== pobjSysSkillEN.createDate && jsString_js_1.tzDataType.isString(pobjSysSkillEN.createDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.shareId) == false && undefined !== pobjSysSkillEN.shareId && jsString_js_1.tzDataType.isString(pobjSysSkillEN.shareId) === false) {
    ...
    */
    function SysSkill_CheckProperty4Update(pobjSysSkillEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjSysSkillEN.skillId) === true) {
    ...
    */
    function SysSkill_GetCombineCondition(objSysSkill_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_SkillId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_SkillId, objSysSkill_Cond.skillId, strComparisonOp_SkillId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_SkillName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_SkillName, objSysSkill_Cond.skillName, strComparisonOp_SkillName);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_OperationTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_OperationTypeId, objSysSkill_Cond.operationTypeId, strComparisonOp_OperationTypeId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_LevelId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_LevelId, objSysSkill_Cond.levelId, strComparisonOp_LevelId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_UpdUser, objSysSkill_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_UpdDate, objSysSkill_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_IsSubmit) == true) {
            if (objSysSkill_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsSysSkillEN_js_1.clsSysSkillEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsSysSkillEN_js_1.clsSysSkillEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_CitationId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_CitationId, objSysSkill_Cond.citationId, strComparisonOp_CitationId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_OkCount, objSysSkill_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_AppraiseCount, objSysSkill_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_score, objSysSkill_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_StuScore, objSysSkill_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_TeaScore, objSysSkill_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_id_CurrEduCls, objSysSkill_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_PdfContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_PdfContent, objSysSkill_Cond.pdfContent, strComparisonOp_PdfContent);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_PdfPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_PdfPageNum, objSysSkill_Cond.pdfPageNum, strComparisonOp_PdfPageNum);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_CitationCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_CitationCount, objSysSkill_Cond.citationCount, strComparisonOp_CitationCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsSysSkillEN_js_1.clsSysSkillEN.con_VersionCount, objSysSkill_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_Memo, objSysSkill_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_CreateDate, objSysSkill_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSkill_Cond.dicFldComparisonOp, clsSysSkillEN_js_1.clsSysSkillEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsSysSkillEN_js_1.clsSysSkillEN.con_ShareId, objSysSkill_Cond.shareId, strComparisonOp_ShareId);
        }
        return strWhereCond;
    }
    ...
    **/
    function SysSkill_GetUniCondStr_SkillId(objSysSkillEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and SkillId = '{0}'", objSysSkillEN.skillId);
        return strWhereCond;
    }
