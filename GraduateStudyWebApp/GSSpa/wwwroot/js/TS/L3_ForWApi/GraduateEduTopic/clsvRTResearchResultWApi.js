...
(function (factory) {
    ...
    */
    async function vRTResearchResult_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvRTResearchResultEN_js_1.clsvRTResearchResultEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvRTResearchResultEN_js_1.clsvRTResearchResultEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vRTResearchResult_GetObjLst_ClientCache() {
        ...
        clsvRTResearchResultEN_js_1.clsvRTResearchResultEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvRTResearchResultEN_js_1.clsvRTResearchResultEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvRTResearchResultExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvRTResearchResultExObjLst);
