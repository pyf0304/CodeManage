...
(function (factory) {
    ...
    */
    async function vRTPaperRela_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvRTPaperRelaEN_js_1.clsvRTPaperRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvRTPaperRelaEN_js_1.clsvRTPaperRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vRTPaperRela_GetObjLst_ClientCache() {
        ...
        clsvRTPaperRelaEN_js_1.clsvRTPaperRelaEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvRTPaperRelaEN_js_1.clsvRTPaperRelaEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvRTPaperRelaExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvRTPaperRelaExObjLst);
