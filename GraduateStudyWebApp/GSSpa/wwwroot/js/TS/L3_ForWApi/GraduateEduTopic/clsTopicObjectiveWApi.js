...
(function (factory) {
    ...
    async function TopicObjective_GetObjByTopicObjectiveIdAsync(strTopicObjectiveId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.topicObjective_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.topicObjective_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.topicObjective_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function TopicObjective_GetObjByTopicObjectiveId_localStorage(strTopicObjectiveId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN._CurrTabName, strTopicObjectiveId);
        if (strKey == "") {
    ...
    */
    async function TopicObjective_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if (clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function TopicObjective_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN._CurrTabName, strid_CurrEduCls);
        clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsTopicObjectiveEN_js_1.clsTopicObjectiveEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrTopicObjectiveExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrTopicObjectiveExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTopicObjectiveExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function TopicObjective_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTopicObjectiveExObjLst.length);
            console.log(strInfo);
            return arrTopicObjectiveExObjLst;
        }
        catch (e) {
    ...
    **/
    async function TopicObjective_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTopicObjectiveExObjLst.length);
            console.log(strInfo);
            return arrTopicObjectiveExObjLst;
        }
        catch (e) {
    ...
    **/
    async function TopicObjective_DelRecordAsync(strTopicObjectiveId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, strTopicObjectiveId);
        try {
    ...
    **/
    async function TopicObjective_UpdateRecordAsync(objTopicObjectiveEN) {
        ...
        if (objTopicObjectiveEN.sf_UpdFldSetStr === undefined || objTopicObjectiveEN.sf_UpdFldSetStr === null || objTopicObjectiveEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objTopicObjectiveEN.topicObjectiveId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.topicObjective_Controller, strAction);
        try {
    ...
    */
    async function TopicObjective_IsExistRecord_Cache(objTopicObjective_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objTopicObjective_Cond), exports.topicObjective_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function TopicObjective_IsExist_Cache(strTopicObjectiveId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTopicObjectiveId, exports.topicObjective_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function TopicObjective_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls]不能为空！(In clsTopicObjectiveWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
    ...
    */
    function TopicObjective_CheckPropertyNew(pobjTopicObjectiveEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.topicObjectiveId) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.topicObjectiveId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.objectiveName) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.objectiveName) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.objectiveType) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.objectiveType) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.sourceId) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.sourceId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.pdfContent) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.pdfContent) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.createDate) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.createDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.shareId) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.shareId) > 2) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjTopicObjectiveEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.topicObjectiveId) == false && undefined !== pobjTopicObjectiveEN.topicObjectiveId && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.topicObjectiveId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.objectiveName) == false && undefined !== pobjTopicObjectiveEN.objectiveName && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.objectiveName) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.objectiveContent) == false && undefined !== pobjTopicObjectiveEN.objectiveContent && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.objectiveContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.objectiveType) == false && undefined !== pobjTopicObjectiveEN.objectiveType && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.objectiveType) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.sourceId) == false && undefined !== pobjTopicObjectiveEN.sourceId && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.sourceId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.conclusion) == false && undefined !== pobjTopicObjectiveEN.conclusion && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.conclusion) === false) {
        ...
        if (null != pobjTopicObjectiveEN.isSubmit && undefined !== pobjTopicObjectiveEN.isSubmit && jsString_js_1.tzDataType.isBoolean(pobjTopicObjectiveEN.isSubmit) === false) {
        ...
        if (null != pobjTopicObjectiveEN.appraiseCount && undefined !== pobjTopicObjectiveEN.appraiseCount && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.appraiseCount) === false) {
        ...
        if (null != pobjTopicObjectiveEN.okCount && undefined !== pobjTopicObjectiveEN.okCount && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.okCount) === false) {
        ...
        if (null != pobjTopicObjectiveEN.score && undefined !== pobjTopicObjectiveEN.score && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.score) === false) {
        ...
        if (null != pobjTopicObjectiveEN.stuScore && undefined !== pobjTopicObjectiveEN.stuScore && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.stuScore) === false) {
        ...
        if (null != pobjTopicObjectiveEN.teaScore && undefined !== pobjTopicObjectiveEN.teaScore && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.teaScore) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.id_CurrEduCls) == false && undefined !== pobjTopicObjectiveEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.pdfContent) == false && undefined !== pobjTopicObjectiveEN.pdfContent && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.pdfContent) === false) {
        ...
        if (null != pobjTopicObjectiveEN.pdfPageNum && undefined !== pobjTopicObjectiveEN.pdfPageNum && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.pdfPageNum) === false) {
        ...
        if (null != pobjTopicObjectiveEN.citationCount && undefined !== pobjTopicObjectiveEN.citationCount && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.citationCount) === false) {
        ...
        if (null != pobjTopicObjectiveEN.versionCount && undefined !== pobjTopicObjectiveEN.versionCount && jsString_js_1.tzDataType.isNumber(pobjTopicObjectiveEN.versionCount) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.createDate) == false && undefined !== pobjTopicObjectiveEN.createDate && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.createDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.shareId) == false && undefined !== pobjTopicObjectiveEN.shareId && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.shareId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.updUser) == false && undefined !== pobjTopicObjectiveEN.updUser && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.updDate) == false && undefined !== pobjTopicObjectiveEN.updDate && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.memo) == false && undefined !== pobjTopicObjectiveEN.memo && jsString_js_1.tzDataType.isString(pobjTopicObjectiveEN.memo) === false) {
    ...
    */
    function TopicObjective_CheckProperty4Update(pobjTopicObjectiveEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjTopicObjectiveEN.topicObjectiveId) === true) {
    ...
    */
    function TopicObjective_GetCombineCondition(objTopicObjective_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_TopicObjectiveId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_TopicObjectiveId, objTopicObjective_Cond.topicObjectiveId, strComparisonOp_TopicObjectiveId);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_ObjectiveName) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_ObjectiveName, objTopicObjective_Cond.objectiveName, strComparisonOp_ObjectiveName);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_ObjectiveType) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_ObjectiveType, objTopicObjective_Cond.objectiveType, strComparisonOp_ObjectiveType);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_SourceId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_SourceId, objTopicObjective_Cond.sourceId, strComparisonOp_SourceId);
        }
        //数据类型string(text)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_IsSubmit) == true) {
            if (objTopicObjective_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_AppraiseCount, objTopicObjective_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_OkCount, objTopicObjective_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_score) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_score, objTopicObjective_Cond.score, strComparisonOp_score);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_StuScore, objTopicObjective_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_TeaScore, objTopicObjective_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_id_CurrEduCls, objTopicObjective_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_PdfContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_PdfContent, objTopicObjective_Cond.pdfContent, strComparisonOp_PdfContent);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_PdfPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_PdfPageNum, objTopicObjective_Cond.pdfPageNum, strComparisonOp_PdfPageNum);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_CitationCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_CitationCount, objTopicObjective_Cond.citationCount, strComparisonOp_CitationCount);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_VersionCount, objTopicObjective_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_CreateDate, objTopicObjective_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_ShareId, objTopicObjective_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_UpdUser, objTopicObjective_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_UpdDate, objTopicObjective_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicObjective_Cond.dicFldComparisonOp, clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsTopicObjectiveEN_js_1.clsTopicObjectiveEN.con_Memo, objTopicObjective_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function TopicObjective_GetUniCondStr_ObjectiveName_id_CurrEduCls(objTopicObjectiveEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ObjectiveName = '{0}'", objTopicObjectiveEN.objectiveName);
        strWhereCond += (0, clsString_js_1.Format)(" and id_CurrEduCls = '{0}'", objTopicObjectiveEN.id_CurrEduCls);
        return strWhereCond;
    }
    ...
    **/
    function TopicObjective_GetUniCondStr4Update_ObjectiveName_id_CurrEduCls(objTopicObjectiveEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and TopicObjectiveId <> '{0}'", objTopicObjectiveEN.topicObjectiveId);
        strWhereCond += (0, clsString_js_1.Format)(" and ObjectiveName = '{0}'", objTopicObjectiveEN.objectiveName);
        strWhereCond += (0, clsString_js_1.Format)(" and id_CurrEduCls = '{0}'", objTopicObjectiveEN.id_CurrEduCls);
        return strWhereCond;
    }
