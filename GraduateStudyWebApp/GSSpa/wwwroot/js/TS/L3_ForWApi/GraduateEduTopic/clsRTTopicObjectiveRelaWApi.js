...
(function (factory) {
    ...
    async function RTTopicObjectiveRela_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTTopicObjectiveRela_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTTopicObjectiveRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTTopicObjectiveRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (arrRTTopicObjectiveRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objRTTopicObjectiveRela = await RTTopicObjectiveRela_GetObjBymIdAsync(lngmId);
    ...
    */
    async function RTTopicObjectiveRela_GetObjBymId_localStorage(lngmId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function RTTopicObjectiveRela_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function RTTopicObjectiveRela_GetObjLst_ClientCache() {
        ...
        clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrRTTopicObjectiveRelaExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrRTTopicObjectiveRelaExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTTopicObjectiveRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function RTTopicObjectiveRela_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTTopicObjectiveRelaExObjLst.length);
            console.log(strInfo);
            return arrRTTopicObjectiveRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function RTTopicObjectiveRela_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTTopicObjectiveRelaExObjLst.length);
            console.log(strInfo);
            return arrRTTopicObjectiveRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function RTTopicObjectiveRela_UpdateRecordAsync(objRTTopicObjectiveRelaEN) {
        ...
        if (objRTTopicObjectiveRelaEN.sf_UpdFldSetStr === undefined || objRTTopicObjectiveRelaEN.sf_UpdFldSetStr === null || objRTTopicObjectiveRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTTopicObjectiveRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTTopicObjectiveRela_Controller, strAction);
        try {
    ...
    */
    async function RTTopicObjectiveRela_IsExistRecord_Cache(objRTTopicObjectiveRela_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objRTTopicObjectiveRela_Cond), exports.rTTopicObjectiveRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function RTTopicObjectiveRela_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.rTTopicObjectiveRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function RTTopicObjectiveRela_CheckPropertyNew(pobjRTTopicObjectiveRelaEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.topicObjectiveId) === true) {
            throw new Error("(errid:Watl000058)字段[客观Id]不能为空(In 主题客观关系表)!(clsRTTopicObjectiveRelaBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 主题客观关系表)!(clsRTTopicObjectiveRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.topicObjectiveId) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.topicObjectiveId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.classificationId) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.classificationId) > 10) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjRTTopicObjectiveRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTTopicObjectiveRelaEN.mId && undefined !== pobjRTTopicObjectiveRelaEN.mId && jsString_js_1.tzDataType.isNumber(pobjRTTopicObjectiveRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.topicId) == false && undefined !== pobjRTTopicObjectiveRelaEN.topicId && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.topicObjectiveId) == false && undefined !== pobjRTTopicObjectiveRelaEN.topicObjectiveId && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.topicObjectiveId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.updDate) == false && undefined !== pobjRTTopicObjectiveRelaEN.updDate && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.updUser) == false && undefined !== pobjRTTopicObjectiveRelaEN.updUser && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.memo) == false && undefined !== pobjRTTopicObjectiveRelaEN.memo && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.classificationId) == false && undefined !== pobjRTTopicObjectiveRelaEN.classificationId && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.classificationId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjRTTopicObjectiveRelaEN.id_CurrEduCls) == false && undefined !== pobjRTTopicObjectiveRelaEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjRTTopicObjectiveRelaEN.id_CurrEduCls) === false) {
    ...
    */
    function RTTopicObjectiveRela_GetCombineCondition(objRTTopicObjectiveRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_mId, objRTTopicObjectiveRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_TopicId, objRTTopicObjectiveRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_TopicObjectiveId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_TopicObjectiveId, objRTTopicObjectiveRela_Cond.topicObjectiveId, strComparisonOp_TopicObjectiveId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_UpdDate, objRTTopicObjectiveRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_UpdUser, objRTTopicObjectiveRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_Memo, objRTTopicObjectiveRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_ClassificationId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_ClassificationId, objRTTopicObjectiveRela_Cond.classificationId, strComparisonOp_ClassificationId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTTopicObjectiveRela_Cond.dicFldComparisonOp, clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN.con_id_CurrEduCls, objRTTopicObjectiveRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTTopicObjectiveRela_GetUniCondStr_mId_TopicId_TopicObjectiveId(objRTTopicObjectiveRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objRTTopicObjectiveRelaEN.mId);
        strWhereCond += (0, clsString_js_1.Format)(" and TopicId = '{0}'", objRTTopicObjectiveRelaEN.topicId);
        strWhereCond += (0, clsString_js_1.Format)(" and TopicObjectiveId = '{0}'", objRTTopicObjectiveRelaEN.topicObjectiveId);
        return strWhereCond;
    }
