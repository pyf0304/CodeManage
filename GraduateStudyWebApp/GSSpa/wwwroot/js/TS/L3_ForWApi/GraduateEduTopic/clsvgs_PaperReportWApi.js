...
(function (factory) {
    ...
    */
    async function vgs_PaperReport_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvgs_PaperReportEN_js_1.clsvgs_PaperReportEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvgs_PaperReportEN_js_1.clsvgs_PaperReportEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vgs_PaperReport_GetObjLst_ClientCache() {
        ...
        clsvgs_PaperReportEN_js_1.clsvgs_PaperReportEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvgs_PaperReportEN_js_1.clsvgs_PaperReportEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_PaperReportExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvgs_PaperReportExObjLst);
