...
(function (factory) {
    ...
    async function gs_TeacherTask_GetObjBymIdAsync(lngmId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TeacherTask_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TeacherTask_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TeacherTask_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TeacherTask_GetObjBymId_localStorage(lngmId) {
        ...
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_TeacherTask_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_TeacherTask_GetObjLst_ClientCache() {
        ...
        clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TeacherTaskExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrgs_TeacherTaskExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TeacherTaskExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TeacherTask_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TeacherTaskExObjLst.length);
            console.log(strInfo);
            return arrgs_TeacherTaskExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TeacherTask_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TeacherTaskExObjLst.length);
            console.log(strInfo);
            return arrgs_TeacherTaskExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TeacherTask_UpdateRecordAsync(objgs_TeacherTaskEN) {
        ...
        if (objgs_TeacherTaskEN.sf_UpdFldSetStr === undefined || objgs_TeacherTaskEN.sf_UpdFldSetStr === null || objgs_TeacherTaskEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TeacherTaskEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TeacherTask_Controller, strAction);
        try {
    ...
    */
    async function gs_TeacherTask_IsExistRecord_Cache(objgs_TeacherTask_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TeacherTask_Cond), exports.gs_TeacherTask_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TeacherTask_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_TeacherTask_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_TeacherTask_CheckPropertyNew(pobjgs_TeacherTaskEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.id_CurrEduCls) === true
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.topicId) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.topicId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.id_CurrEduCls) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.missionStatement) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.missionStatement) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.missionRequirement) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.missionRequirement) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjgs_TeacherTaskEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_TeacherTaskEN.mId && undefined !== pobjgs_TeacherTaskEN.mId && jsString_js_1.tzDataType.isNumber(pobjgs_TeacherTaskEN.mId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.topicId) == false && undefined !== pobjgs_TeacherTaskEN.topicId && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.topicId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.id_CurrEduCls) == false && undefined !== pobjgs_TeacherTaskEN.id_CurrEduCls && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.missionStatement) == false && undefined !== pobjgs_TeacherTaskEN.missionStatement && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.missionStatement) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.missionRequirement) == false && undefined !== pobjgs_TeacherTaskEN.missionRequirement && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.missionRequirement) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.updDate) == false && undefined !== pobjgs_TeacherTaskEN.updDate && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.updUser) == false && undefined !== pobjgs_TeacherTaskEN.updUser && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_TeacherTaskEN.memo) == false && undefined !== pobjgs_TeacherTaskEN.memo && jsString_js_1.tzDataType.isString(pobjgs_TeacherTaskEN.memo) === false) {
    ...
    */
    function gs_TeacherTask_GetCombineCondition(objgs_TeacherTask_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_mId, objgs_TeacherTask_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_TopicId, objgs_TeacherTask_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_id_CurrEduCls, objgs_TeacherTask_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_MissionStatement) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_MissionStatement, objgs_TeacherTask_Cond.missionStatement, strComparisonOp_MissionStatement);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_MissionRequirement) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_MissionRequirement, objgs_TeacherTask_Cond.missionRequirement, strComparisonOp_MissionRequirement);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_UpdDate, objgs_TeacherTask_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_UpdUser, objgs_TeacherTask_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeacherTask_Cond.dicFldComparisonOp, clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN.con_Memo, objgs_TeacherTask_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_TeacherTask_GetUniCondStr_mId(objgs_TeacherTaskEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and mId = '{0}'", objgs_TeacherTaskEN.mId);
        return strWhereCond;
    }
