...
(function (factory) {
    ...
    **/
    async function LoginLog_GetObjByLoginLogIdAsync(lngLoginLogId) {
        ...
        if (lngLoginLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngLoginLogId]不能为空！(In GetObjByLoginLogIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.loginLog_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.loginLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.loginLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function LoginLog_GetObjByLoginLogId_Cache(lngLoginLogId, bolTryAsyncOnce = true) {
        ...
        if (lngLoginLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngLoginLogId]不能为空！(In GetObjByLoginLogId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrLoginLog_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objLoginLog = await LoginLog_GetObjByLoginLogIdAsync(lngLoginLogId);
                    if (objLoginLog != null) {
    ...
    */
    async function LoginLog_GetObjByLoginLogId_localStorage(lngLoginLogId) {
        ...
        if (lngLoginLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngLoginLogId]不能为空！(In GetObjByLoginLogId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsLoginLogEN_js_1.clsLoginLogEN._CurrTabName, lngLoginLogId);
        if (strKey == "") {
    ...
    */
    async function LoginLog_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsLoginLogEN_js_1.clsLoginLogEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsLoginLogEN_js_1.clsLoginLogEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function LoginLog_GetObjLst_ClientCache() {
        ...
        clsLoginLogEN_js_1.clsLoginLogEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsLoginLogEN_js_1.clsLoginLogEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsLoginLogEN_js_1.clsLoginLogEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsLoginLogEN_js_1.clsLoginLogEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrLoginLogExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrLoginLogExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrLoginLogExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function LoginLog_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrLoginLogExObjLst.length);
            console.log(strInfo);
            return arrLoginLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function LoginLog_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrLoginLogExObjLst.length);
            console.log(strInfo);
            return arrLoginLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function LoginLog_DelRecordAsync(lngLoginLogId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngLoginLogId);
        try {
            const response = await axios_1.default.delete(strUrl, {
                params: { "Id": lngLoginLogId, }
            });
            const data = response.data;
            if (data.errorId == 0) {
    ...
    **/
    async function LoginLog_UpdateRecordAsync(objLoginLogEN) {
        ...
        if (objLoginLogEN.sf_UpdFldSetStr === undefined || objLoginLogEN.sf_UpdFldSetStr === null || objLoginLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objLoginLogEN.loginLogId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.loginLog_Controller, strAction);
        try {
    ...
    */
    async function LoginLog_IsExistRecord_Cache(objLoginLog_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objLoginLog_Cond), exports.loginLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function LoginLog_IsExist_Cache(lngLoginLogId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngLoginLogId, exports.loginLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function LoginLog_CheckPropertyNew(pobjLoginLogEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginLogNumber) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.loginLogNumber) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginIP) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.loginIP) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.failReason) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.failReason) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginResult) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.loginResult) > 500) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginTime) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.loginTime) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginUserId) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.loginUserId) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.onlineTime) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.onlineTime) > 200) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.outTime) == false && (0, clsString_js_1.GetStrLen)(pobjLoginLogEN.outTime) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjLoginLogEN.loginLogId && undefined !== pobjLoginLogEN.loginLogId && jsString_js_1.tzDataType.isNumber(pobjLoginLogEN.loginLogId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginLogNumber) == false && undefined !== pobjLoginLogEN.loginLogNumber && jsString_js_1.tzDataType.isString(pobjLoginLogEN.loginLogNumber) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginIP) == false && undefined !== pobjLoginLogEN.loginIP && jsString_js_1.tzDataType.isString(pobjLoginLogEN.loginIP) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.failReason) == false && undefined !== pobjLoginLogEN.failReason && jsString_js_1.tzDataType.isString(pobjLoginLogEN.failReason) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginResult) == false && undefined !== pobjLoginLogEN.loginResult && jsString_js_1.tzDataType.isString(pobjLoginLogEN.loginResult) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginTime) == false && undefined !== pobjLoginLogEN.loginTime && jsString_js_1.tzDataType.isString(pobjLoginLogEN.loginTime) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.loginUserId) == false && undefined !== pobjLoginLogEN.loginUserId && jsString_js_1.tzDataType.isString(pobjLoginLogEN.loginUserId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.memo) == false && undefined !== pobjLoginLogEN.memo && jsString_js_1.tzDataType.isString(pobjLoginLogEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.onlineTime) == false && undefined !== pobjLoginLogEN.onlineTime && jsString_js_1.tzDataType.isString(pobjLoginLogEN.onlineTime) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjLoginLogEN.outTime) == false && undefined !== pobjLoginLogEN.outTime && jsString_js_1.tzDataType.isString(pobjLoginLogEN.outTime) === false) {
    ...
    */
    function LoginLog_GetCombineCondition(objLoginLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_LoginLogId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsLoginLogEN_js_1.clsLoginLogEN.con_LoginLogId, objLoginLog_Cond.loginLogId, strComparisonOp_LoginLogId);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_LoginLogNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_LoginLogNumber, objLoginLog_Cond.loginLogNumber, strComparisonOp_LoginLogNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_LoginIP) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_LoginIP, objLoginLog_Cond.loginIP, strComparisonOp_LoginIP);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_FailReason) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_FailReason, objLoginLog_Cond.failReason, strComparisonOp_FailReason);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_LoginResult) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_LoginResult, objLoginLog_Cond.loginResult, strComparisonOp_LoginResult);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_LoginTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_LoginTime, objLoginLog_Cond.loginTime, strComparisonOp_LoginTime);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_LoginUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_LoginUserId, objLoginLog_Cond.loginUserId, strComparisonOp_LoginUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_Memo, objLoginLog_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_OnlineTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_OnlineTime, objLoginLog_Cond.onlineTime, strComparisonOp_OnlineTime);
        }
        if (Object.prototype.hasOwnProperty.call(objLoginLog_Cond.dicFldComparisonOp, clsLoginLogEN_js_1.clsLoginLogEN.con_OutTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsLoginLogEN_js_1.clsLoginLogEN.con_OutTime, objLoginLog_Cond.outTime, strComparisonOp_OutTime);
        }
        return strWhereCond;
    }
    ...
    **/
    function LoginLog_GetUniCondStr_LoginUserId_LoginIP_LoginTime(objLoginLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and LoginUserId = '{0}'", objLoginLogEN.loginUserId);
        strWhereCond += (0, clsString_js_1.Format)(" and LoginIP = '{0}'", objLoginLogEN.loginIP);
        strWhereCond += (0, clsString_js_1.Format)(" and LoginTime = '{0}'", objLoginLogEN.loginTime);
        return strWhereCond;
    }
    ...
    **/
    function LoginLog_GetUniCondStr4Update_LoginUserId_LoginIP_LoginTime(objLoginLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and LoginLogId <> '{0}'", objLoginLogEN.loginLogId);
        strWhereCond += (0, clsString_js_1.Format)(" and LoginUserId = '{0}'", objLoginLogEN.loginUserId);
        strWhereCond += (0, clsString_js_1.Format)(" and LoginIP = '{0}'", objLoginLogEN.loginIP);
        strWhereCond += (0, clsString_js_1.Format)(" and LoginTime = '{0}'", objLoginLogEN.loginTime);
        return strWhereCond;
