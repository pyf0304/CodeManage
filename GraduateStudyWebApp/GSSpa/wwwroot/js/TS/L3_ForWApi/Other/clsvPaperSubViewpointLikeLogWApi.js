...
(function (factory) {
    ...
    */
    async function vPaperSubViewpointLikeLog_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvPaperSubViewpointLikeLogEN_js_1.clsvPaperSubViewpointLikeLogEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvPaperSubViewpointLikeLogEN_js_1.clsvPaperSubViewpointLikeLogEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vPaperSubViewpointLikeLog_GetObjLst_ClientCache() {
        ...
        clsvPaperSubViewpointLikeLogEN_js_1.clsvPaperSubViewpointLikeLogEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvPaperSubViewpointLikeLogEN_js_1.clsvPaperSubViewpointLikeLogEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvPaperSubViewpointLikeLogExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvPaperSubViewpointLikeLogExObjLst);
