...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/CacheHelper.js", "../../L0_Entity/Other/clsViewpointAppraiseEN.js", "../../L3_ForWApi/Other/clsvViewpointAppraiseWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    ...
    const clsViewpointAppraiseEN_js_1 = require("../../L0_Entity/Other/clsViewpointAppraiseEN.js");
    const clsvViewpointAppraiseWApi_js_1 = require("../../L3_ForWApi/Other/clsvViewpointAppraiseWApi.js");
    ...
    **/
    async function ViewpointAppraise_GetObjByViewpointAppraiseIdAsync(lngViewpointAppraiseId) {
        ...
        if (lngViewpointAppraiseId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngViewpointAppraiseId]不能为空！(In GetObjByViewpointAppraiseIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpointAppraise_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpointAppraise_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpointAppraise_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ViewpointAppraise_GetObjByViewpointAppraiseId_Cache(lngViewpointAppraiseId, bolTryAsyncOnce = true) {
        ...
        if (lngViewpointAppraiseId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngViewpointAppraiseId]不能为空！(In GetObjByViewpointAppraiseId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function ViewpointAppraise_GetObjByViewpointAppraiseId_localStorage(lngViewpointAppraiseId) {
        ...
        if (lngViewpointAppraiseId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngViewpointAppraiseId]不能为空！(In GetObjByViewpointAppraiseId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN._CurrTabName, lngViewpointAppraiseId);
        if (strKey == "") {
    ...
    */
    async function ViewpointAppraise_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function ViewpointAppraise_GetObjLst_ClientCache() {
        ...
        clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrViewpointAppraiseExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrViewpointAppraiseExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAppraiseExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ViewpointAppraise_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAppraiseExObjLst.length);
            console.log(strInfo);
            return arrViewpointAppraiseExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ViewpointAppraise_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAppraiseExObjLst.length);
            console.log(strInfo);
            return arrViewpointAppraiseExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ViewpointAppraise_DelRecordAsync(lngViewpointAppraiseId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngViewpointAppraiseId);
        try {
    ...
    **/
    async function ViewpointAppraise_UpdateRecordAsync(objViewpointAppraiseEN) {
        ...
        if (objViewpointAppraiseEN.sf_UpdFldSetStr === undefined || objViewpointAppraiseEN.sf_UpdFldSetStr === null || objViewpointAppraiseEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointAppraiseEN.viewpointAppraiseId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpointAppraise_Controller, strAction);
        try {
    ...
    */
    async function ViewpointAppraise_IsExistRecord_Cache(objViewpointAppraise_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objViewpointAppraise_Cond), exports.viewpointAppraise_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ViewpointAppraise_IsExist_Cache(lngViewpointAppraiseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngViewpointAppraiseId, exports.viewpointAppraise_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function ViewpointAppraise_CheckPropertyNew(pobjViewpointAppraiseEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.viewpointId) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointAppraiseEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.appraiseContent) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointAppraiseEN.appraiseContent) > 2000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointAppraiseEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointAppraiseEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjViewpointAppraiseEN.updUser) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjViewpointAppraiseEN.viewpointAppraiseId && undefined !== pobjViewpointAppraiseEN.viewpointAppraiseId && jsString_js_1.tzDataType.isNumber(pobjViewpointAppraiseEN.viewpointAppraiseId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.viewpointId) == false && undefined !== pobjViewpointAppraiseEN.viewpointId && jsString_js_1.tzDataType.isString(pobjViewpointAppraiseEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.appraiseContent) == false && undefined !== pobjViewpointAppraiseEN.appraiseContent && jsString_js_1.tzDataType.isString(pobjViewpointAppraiseEN.appraiseContent) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.updDate) == false && undefined !== pobjViewpointAppraiseEN.updDate && jsString_js_1.tzDataType.isString(pobjViewpointAppraiseEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.memo) == false && undefined !== pobjViewpointAppraiseEN.memo && jsString_js_1.tzDataType.isString(pobjViewpointAppraiseEN.memo) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjViewpointAppraiseEN.updUser) == false && undefined !== pobjViewpointAppraiseEN.updUser && jsString_js_1.tzDataType.isString(pobjViewpointAppraiseEN.updUser) === false) {
    ...
    */
    function ViewpointAppraise_GetCombineCondition(objViewpointAppraise_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_ViewpointAppraiseId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_ViewpointAppraiseId, objViewpointAppraise_Cond.viewpointAppraiseId, strComparisonOp_ViewpointAppraiseId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_ViewpointId, objViewpointAppraise_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_AppraiseContent) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_AppraiseContent, objViewpointAppraise_Cond.appraiseContent, strComparisonOp_AppraiseContent);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_UpdDate, objViewpointAppraise_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_Memo, objViewpointAppraise_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsViewpointAppraiseEN_js_1.clsViewpointAppraiseEN.con_UpdUser, objViewpointAppraise_Cond.updUser, strComparisonOp_UpdUser);
        }
        return strWhereCond;
    }
    ...
    **/
    function ViewpointAppraise_GetUniCondStr_ViewpointAppraiseId_ViewpointId(objViewpointAppraiseEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointAppraiseId = '{0}'", objViewpointAppraiseEN.viewpointAppraiseId);
        strWhereCond += (0, clsString_js_1.Format)(" and ViewpointId = '{0}'", objViewpointAppraiseEN.viewpointId);
        return strWhereCond;
    }
