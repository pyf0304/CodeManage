...
(function (factory) {
    ...
    **/
    async function PaperLikeLog_GetObjByPaperLikeLogIdAsync(lngPaperLikeLogId) {
        ...
        if (lngPaperLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperLikeLogId]不能为空！(In GetObjByPaperLikeLogIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperLikeLog_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperLikeLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperLikeLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperLikeLog_GetObjByPaperLikeLogId_Cache(lngPaperLikeLogId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperLikeLogId]不能为空！(In GetObjByPaperLikeLogId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function PaperLikeLog_GetObjByPaperLikeLogId_localStorage(lngPaperLikeLogId) {
        ...
        if (lngPaperLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperLikeLogId]不能为空！(In GetObjByPaperLikeLogId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN._CurrTabName, lngPaperLikeLogId);
        if (strKey == "") {
    ...
    */
    async function PaperLikeLog_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function PaperLikeLog_GetObjLst_ClientCache() {
        ...
        clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsPaperLikeLogEN_js_1.clsPaperLikeLogEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperLikeLogExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrPaperLikeLogExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperLikeLogExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperLikeLog_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperLikeLogExObjLst.length);
            console.log(strInfo);
            return arrPaperLikeLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperLikeLog_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperLikeLogExObjLst.length);
            console.log(strInfo);
            return arrPaperLikeLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperLikeLog_DelRecordAsync(lngPaperLikeLogId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngPaperLikeLogId);
        try {
    ...
    **/
    async function PaperLikeLog_UpdateRecordAsync(objPaperLikeLogEN) {
        ...
        if (objPaperLikeLogEN.sf_UpdFldSetStr === undefined || objPaperLikeLogEN.sf_UpdFldSetStr === null || objPaperLikeLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperLikeLogEN.paperLikeLogId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperLikeLog_Controller, strAction);
        try {
    ...
    */
    async function PaperLikeLog_IsExistRecord_Cache(objPaperLikeLog_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperLikeLog_Cond), exports.paperLikeLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperLikeLog_IsExist_Cache(lngPaperLikeLogId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperLikeLogId, exports.paperLikeLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function PaperLikeLog_CheckPropertyNew(pobjPaperLikeLogEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 论文点赞表)!(clsPaperLikeLogBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.paperId) == false && (0, clsString_js_1.GetStrLen)(pobjPaperLikeLogEN.paperId) > 8) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjPaperLikeLogEN.updUser) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjPaperLikeLogEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjPaperLikeLogEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperLikeLogEN.paperLikeLogId && undefined !== pobjPaperLikeLogEN.paperLikeLogId && jsString_js_1.tzDataType.isNumber(pobjPaperLikeLogEN.paperLikeLogId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.paperId) == false && undefined !== pobjPaperLikeLogEN.paperId && jsString_js_1.tzDataType.isString(pobjPaperLikeLogEN.paperId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.updUser) == false && undefined !== pobjPaperLikeLogEN.updUser && jsString_js_1.tzDataType.isString(pobjPaperLikeLogEN.updUser) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.updDate) == false && undefined !== pobjPaperLikeLogEN.updDate && jsString_js_1.tzDataType.isString(pobjPaperLikeLogEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperLikeLogEN.memo) == false && undefined !== pobjPaperLikeLogEN.memo && jsString_js_1.tzDataType.isString(pobjPaperLikeLogEN.memo) === false) {
    ...
    */
    function PaperLikeLog_GetCombineCondition(objPaperLikeLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperLikeLog_Cond.dicFldComparisonOp, clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_PaperLikeLogId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_PaperLikeLogId, objPaperLikeLog_Cond.paperLikeLogId, strComparisonOp_PaperLikeLogId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperLikeLog_Cond.dicFldComparisonOp, clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_PaperId, objPaperLikeLog_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperLikeLog_Cond.dicFldComparisonOp, clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_UpdUser, objPaperLikeLog_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperLikeLog_Cond.dicFldComparisonOp, clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_UpdDate, objPaperLikeLog_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperLikeLog_Cond.dicFldComparisonOp, clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperLikeLogEN_js_1.clsPaperLikeLogEN.con_Memo, objPaperLikeLog_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperLikeLog_GetUniCondStr_PaperId_UpdUser(objPaperLikeLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objPaperLikeLogEN.paperId);
        strWhereCond += (0, clsString_js_1.Format)(" and UpdUser = '{0}'", objPaperLikeLogEN.updUser);
        return strWhereCond;
    }
    ...
    **/
    function PaperLikeLog_GetUniCondStr4Update_PaperId_UpdUser(objPaperLikeLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperLikeLogId <> '{0}'", objPaperLikeLogEN.paperLikeLogId);
        strWhereCond += (0, clsString_js_1.Format)(" and PaperId = '{0}'", objPaperLikeLogEN.paperId);
        strWhereCond += (0, clsString_js_1.Format)(" and UpdUser = '{0}'", objPaperLikeLogEN.updUser);
        return strWhereCond;
    }
