...
(function (factory) {
    ...
    **/
    async function PaperSubViewpointLikeLog_GetObjByPaperSubViewpointLikeLogIdAsync(lngPaperSubViewpointLikeLogId) {
        ...
        if (lngPaperSubViewpointLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In GetObjByPaperSubViewpointLikeLogIdAsync)");
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObj == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperSubViewpointLikeLog_ConstructorName, strThisFuncName);
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperSubViewpointLikeLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperSubViewpointLikeLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperSubViewpointLikeLog_GetObjByPaperSubViewpointLikeLogId_Cache(lngPaperSubViewpointLikeLogId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperSubViewpointLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In GetObjByPaperSubViewpointLikeLogId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function PaperSubViewpointLikeLog_GetObjByPaperSubViewpointLikeLogId_localStorage(lngPaperSubViewpointLikeLogId) {
        ...
        if (lngPaperSubViewpointLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In GetObjByPaperSubViewpointLikeLogId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN._CurrTabName, lngPaperSubViewpointLikeLogId);
        if (strKey == "") {
    ...
    */
    async function PaperSubViewpointLikeLog_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function PaperSubViewpointLikeLog_GetObjLst_ClientCache() {
        ...
        clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN._CurrTabName);
        if ((0, clsString_js_1.IsNullOrEmpty)(clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_1.Format)(" and {0}", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperSubViewpointLikeLogExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrPaperSubViewpointLikeLogExObjLst);
            const strInfo = (0, clsString_js_1.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointLikeLogExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperSubViewpointLikeLog_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointLikeLogExObjLst.length);
            console.log(strInfo);
            return arrPaperSubViewpointLikeLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperSubViewpointLikeLog_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_1.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointLikeLogExObjLst.length);
            console.log(strInfo);
            return arrPaperSubViewpointLikeLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperSubViewpointLikeLog_DelRecordAsync(lngPaperSubViewpointLikeLogId) {
        ...
        strUrl = (0, clsString_js_1.Format)("{0}/?Id={1}", strUrl, lngPaperSubViewpointLikeLogId);
        try {
    ...
    **/
    async function PaperSubViewpointLikeLog_UpdateRecordAsync(objPaperSubViewpointLikeLogEN) {
        ...
        if (objPaperSubViewpointLikeLogEN.sf_UpdFldSetStr === undefined || objPaperSubViewpointLikeLogEN.sf_UpdFldSetStr === null || objPaperSubViewpointLikeLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_1.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperSubViewpointLikeLogEN.paperSubViewpointLikeLogId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperSubViewpointLikeLog_Controller, strAction);
        try {
    ...
    */
    async function PaperSubViewpointLikeLog_IsExistRecord_Cache(objPaperSubViewpointLikeLog_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperSubViewpointLikeLog_Cond), exports.paperSubViewpointLikeLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperSubViewpointLikeLog_IsExist_Cache(lngPaperSubViewpointLikeLogId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperSubViewpointLikeLogId, exports.paperSubViewpointLikeLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function PaperSubViewpointLikeLog_CheckPropertyNew(pobjPaperSubViewpointLikeLogEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperSubViewpointLikeLogEN.updDate) == false && (0, clsString_js_1.GetStrLen)(pobjPaperSubViewpointLikeLogEN.updDate) > 20) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperSubViewpointLikeLogEN.memo) == false && (0, clsString_js_1.GetStrLen)(pobjPaperSubViewpointLikeLogEN.memo) > 1000) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperSubViewpointLikeLogEN.updUser) == false && (0, clsString_js_1.GetStrLen)(pobjPaperSubViewpointLikeLogEN.updUser) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperSubViewpointLikeLogEN.paperSubViewpointLikeLogId && undefined !== pobjPaperSubViewpointLikeLogEN.paperSubViewpointLikeLogId && jsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointLikeLogEN.paperSubViewpointLikeLogId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperSubViewpointLikeLogEN.updDate) == false && undefined !== pobjPaperSubViewpointLikeLogEN.updDate && jsString_js_1.tzDataType.isString(pobjPaperSubViewpointLikeLogEN.updDate) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperSubViewpointLikeLogEN.memo) == false && undefined !== pobjPaperSubViewpointLikeLogEN.memo && jsString_js_1.tzDataType.isString(pobjPaperSubViewpointLikeLogEN.memo) === false) {
        ...
        if (null != pobjPaperSubViewpointLikeLogEN.subViewpointId && undefined !== pobjPaperSubViewpointLikeLogEN.subViewpointId && jsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointLikeLogEN.subViewpointId) === false) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjPaperSubViewpointLikeLogEN.updUser) == false && undefined !== pobjPaperSubViewpointLikeLogEN.updUser && jsString_js_1.tzDataType.isString(pobjPaperSubViewpointLikeLogEN.updUser) === false) {
    ...
    */
    function PaperSubViewpointLikeLog_GetCombineCondition(objPaperSubViewpointLikeLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointLikeLog_Cond.dicFldComparisonOp, clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_PaperSubViewpointLikeLogId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_PaperSubViewpointLikeLogId, objPaperSubViewpointLikeLog_Cond.paperSubViewpointLikeLogId, strComparisonOp_PaperSubViewpointLikeLogId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointLikeLog_Cond.dicFldComparisonOp, clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_UpdDate, objPaperSubViewpointLikeLog_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointLikeLog_Cond.dicFldComparisonOp, clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_Memo, objPaperSubViewpointLikeLog_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointLikeLog_Cond.dicFldComparisonOp, clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_SubViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} {1}", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_SubViewpointId, objPaperSubViewpointLikeLog_Cond.subViewpointId, strComparisonOp_SubViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointLikeLog_Cond.dicFldComparisonOp, clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointLikeLogEN_js_1.clsPaperSubViewpointLikeLogEN.con_UpdUser, objPaperSubViewpointLikeLog_Cond.updUser, strComparisonOp_UpdUser);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperSubViewpointLikeLog_GetUniCondStr_PaperSubViewpointLikeLogId_SubViewpointId(objPaperSubViewpointLikeLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_1.Format)(" and PaperSubViewpointLikeLogId = '{0}'", objPaperSubViewpointLikeLogEN.paperSubViewpointLikeLogId);
        strWhereCond += (0, clsString_js_1.Format)(" and SubViewpointId = '{0}'", objPaperSubViewpointLikeLogEN.subViewpointId);
        return strWhereCond;
    }
