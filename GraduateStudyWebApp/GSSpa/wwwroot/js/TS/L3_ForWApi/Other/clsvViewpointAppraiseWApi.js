...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/CacheHelper.js", "../../L0_Entity/Other/clsvViewpointAppraiseEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/clsString.js"], factory);
    }
        ...
        try {
            ...
            if (arrvViewpointAppraise_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    objvViewpointAppraise = await vViewpointAppraise_GetObjByViewpointAppraiseIdAsync(lngViewpointAppraiseId);
    ...
    */
    async function vViewpointAppraise_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvViewpointAppraiseEN_js_1.clsvViewpointAppraiseEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strInFldName, clsvViewpointAppraiseEN_js_1.clsvViewpointAppraiseEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function vViewpointAppraise_GetObjLst_ClientCache() {
        ...
        clsvViewpointAppraiseEN_js_1.clsvViewpointAppraiseEN.CacheAddiCondition = (0, CacheHelper_js_1.GetSession_CacheAdditionCondition)(clsvViewpointAppraiseEN_js_1.clsvViewpointAppraiseEN._CurrTabName);
        ...
        if (CacheHelper_js_2.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvViewpointAppraiseExObjLst_Cache = CacheHelper_js_2.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_2.CacheHelper.Add(strKey, arrvViewpointAppraiseExObjLst);
