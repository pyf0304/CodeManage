(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../GraduateEduPublicPage/Public_Concept.js", "../GraduateEduPublicPage/Public_SysSkill.js", "../GraduateEduPublicPage/Public_SysSocialRelations.js", "../GraduateEduPublicPage/Public_TopicObjective.js", "../GraduateEduPublicPage/Public_Viewpoint.js", "../TS/L0_Entity/GraduateEduPaper/clsvgs_PaperParagraphEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvgs_MeetingMinutesEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvgs_TobeStudiedProblemEN.js", "../TS/L0_Entity/InteractManage/clsvqa_AnswerEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphVWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperVWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsConceptVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvgs_MeetingMinutesWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvgs_TobeStudiedProblemWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsViewpointVWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_AnswerVWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_AnswerWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsvPaperExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsSysPara4WebApi2.js"], factory);
    }
    ...
    const clsvgs_PaperVWApi_js_1 = require("../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperVWApi.js");
    ...
    */
            ...
            try {
                ...
                if (objvgs_PaperParagraph != null) {
                    ...
                    if (varPaperId != "" && varPaperId != null) {
                        var objPaper = await (0, clsvPaperExWApi_js_1.vPaperEx_GetObjByPaperIdById_CurrEduCls_Cache)(varPaperId, strid_CurrEducls);
        ...
        async Bind_vPaper() {
            ...
            try {
                var arrUsers = await (0, clsvUsersSimWApi_js_1.vUsersSim_GetObjLst_Cache)();
                const responseObjLst = await (0, clsvPaperWApi_js_1.vPaper_GetFirstObjAsync)(strWhereCond).then((jsonData) => {
                    ObjvPaper = jsonData;
                    var strhtml = "";
                    if (ObjvPaper != null) {
                        //自研论文
        ...
        async Bind_ViewpointVersion() {
            ...
            try {
                const responseText1 = await (0, clsViewpointVWApi_js_1.ViewpointV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async Bind_ConceptVersion() {
            ...
            try {
                const responseText1 = await (0, clsConceptVWApi_js_1.ConceptV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async Bind_TopicObjectiveVersion() {
            ...
            try {
                const responseText1 = await (0, clsTopicObjectiveVWApi_js_1.TopicObjectiveV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async Bind_SysSkillVersion() {
            ...
            try {
                const responseText1 = await (0, clsSysSkillVWApi_js_1.SysSkillV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async Bind_SysSocialRelationsVersion() {
            ...
            try {
                const responseText1 = await (0, clsSysSocialRelationsVWApi_js_1.SysSocialRelationsV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async BindList_vPaperVersion() {
            ...
            try {
                const responseText1 = await (0, clsvgs_PaperVWApi_js_1.vgs_PaperV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async BindList_vqa_AnswerVersion() {
            ...
            try {
                const responseText1 = await (0, clsqa_AnswerVWApi_js_1.qa_AnswerV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async BindList_vgs_PaperParagraphVersion() {
            ...
            try {
                const responseText1 = await (0, clsgs_PaperParagraphVWApi_js_1.gs_PaperParagraphV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async BindList_gs_MeetingMinutesVersion() {
            ...
            try {
                const responseText1 = await (0, clsgs_MeetingMinutesVWApi_js_1.gs_MeetingMinutesV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        async BindList_gs_TobeStudiedProblemVersion() {
            ...
            try {
                const responseText1 = await (0, clsgs_TobeStudiedProblemVWApi_js_1.gs_TobeStudiedProblemV_GetObjLstAsync)(strWhereCond).then((jsonData) => {
