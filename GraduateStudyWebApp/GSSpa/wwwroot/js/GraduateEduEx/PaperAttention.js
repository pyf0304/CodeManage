       ...
       */
        ...
        async BindDdl_PaperGroupId(ddlPaperGroupId) {
            ...
            try {
                ...
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindDdl_ObjLst(ddlPaperGroupId, arrObjLst_Sel, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupName, "论文组");
        ...
        async PaperAttentionTree() {
            ...
            if ($("#hidMyResearch").val() == 1) {
                ...
                if (arrvgs_PaperIdNumObjLst.length > 0) {
                    ...
                    var strWhereCond3 = " paperId in(" + arrPaperId + ") and userId='" + clsPublocalStorage_js_1.clsPublocalStorage.GetUserId() + "'";
            ...
            if (arrgs_PaperGroupObjLst.length > 0) {
                for (var i = 0; i < arrgs_PaperGroupObjLst.length; i++) {
                    ...
                    for (var j = 0; j < arrvgs_PaperAttentionObjLst.length; j++) {
                        ...
                        strhtml += '<li id="' + strPaperId + '" onclick=btnSelectPaper("' + strPaperId + '",' + arrvgs_PaperAttentionObjLst[j].paperAttentionId + ',"' + clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls() + '")>';
                        //默认存放第一条数据显示；
                        //判断存放的id控件是否为空；
                        if ($("#hidPaperId").val() == "") {
                            //存放Id
     ...
     */
      ...
      */
        ...
        async btnAddVote_Click(strSubViewpointId, strUserId) {
            ...
            var strWhereCond = " 1 =1 and updUser='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "' and tableKey=" + strSubViewpointId;
            try {
