(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsDropDownList.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperEduClsRelaEN.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperReadWriteEN.js", "../TS/L0_Entity/GraduateEduPaper/clsvPaperEN.js", "../TS/L0_Entity/GraduateEduPaper/clsvPaperReadWriteEN.js", "../TS/L0_Entity/InteractManage/clsvSysVoteEN.js", "../TS/L0_Entity/UserManage/clsvUsersSimEN.js", "../TS/L3_ForWApi/GraduateEduTools/clsvSysCommentWApi.js", "../TS/L3_ForWApi/InteractManage/clsvSysVoteWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsvPaperExWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsvPaperReadWriteWApiEx.js", "../TS/L3_ForWApiEx/GraduateEdu/clsvPaperSubViewpointExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsString2.js"], factory);
    }
    ...
    */
        ...
        CombineCondition1() {
            ...
            if ($("#txtid_CurrEduCls").val() == "") {
                ...
                if (clsString2_js_1.clsString.IsNullOrEmpty(strId_CurrEduCls)) {
                    strId_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
                }
            }
            var strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                //教师
                    ...
                    $("#td_UserId").hide();
                    strWhereCond += clsString2_js_1.clsString.Format(" and {0}='{1}'", clsvPaperReadWriteEN_js_1.clsvPaperReadWriteEN.con_id_CurrEduCls, strId_CurrEduCls);
                }
                //学生
                else {
                    $("#td_UserId").hide();
        ...
        CombineCondition_Paper() {
            ...
            try {
                ...
                //教师
                    ...
                    $("#td_UserId").hide();
                    strWhereCond += clsString2_js_1.clsString.Format(" and {0} in (Select {0} From {1} Where {2}='{3}')", clsvPaperEN_js_1.clsvPaperEN.con_PaperId, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN._CurrTabName, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_id_CurrEduCls, strId_CurrEduCls);
                }
                //学生
                else {
                    $("#td_UserId").hide();
        ...
        async BindGv_vPaper_Statistics() {
            ...
            try {
                //获取用户缓存数据
                var arrUsers = await (0, clsvUsersSimWApi_js_1.vUsersSim_GetObjLst_Cache)();
                const arrvPaperObjLst = await (0, clsvPaperExWApi_js_1.vPaperEx_GetUserNumObjLstAsync)(strCon_Paper);
                console.log("2-1");
                ...
                for (var i = 0; i < arrvPaperObjLst.length; i++) {
                    var strUserName = "";
                    var strUpdUser = arrvPaperObjLst[i].updUser;
