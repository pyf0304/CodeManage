(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/UserManage/clsUsersEN.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js", "../TS/L3_ForWApi/UserManage/clsUsersWApi.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.WApiUsers_QUDI_TS = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    ...
    */
    class WApiUsers_QUDI_TS extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        async BindGv_Users() {
            ...
            var arrUsersObjLst = [];
            try {
                const responseRecCount = await (0, clsUsersWApi_js_1.Users_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                ...
                const responseObjLst = await (0, clsUsersWApi_js_1.Users_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
       ...
       */
        BindTab_Users(divContainer, arrUsersObjLst) {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindTabV2(o, arrUsersObjLst, arrDataColumn, "userId");
       ...
       */
        async btnExportExcel_Click() {
            ...
            try {
                const responseText = await (0, clsUsersWApi_js_1.Users_GetObjLstAsync)(strWhereCond).then((jsonData) => {
                    var arrUsersObjLst = jsonData;
       ...
       */
        CombineUsersCondition() {
            ...
            try {
                if (this.UserName_q != "") {
                    strWhereCond += ` And ${clsUsersEN_js_1.clsUsersEN.con_UserName} like '% ${this.UserName_q}%'`;
                }
            }
            catch (objException) {
       ...
       */
        async Page_Load() {
            ...
            try {
                ...
                var strWhereCond = this.CombineUsersCondition();
                const responseText = await (0, clsUsersWApi_js_1.Users_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                    this.RecCount = jsonData;
                });
        ...
        QueryUsersLst(strListDiv) {
            ...
            return new Promise((resolve, reject) => {
                try {
                    ...
                    const responseText = (0, clsUsersWApi_js_1.Users_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                        var arrUsersObjLst = jsonData;
                        this.BindTab_Users(strListDiv, arrUsersObjLst);
       ...
       */
        async SelectRecord(strUserId) {
            try {
                ...
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.Redirect("/Index/Main_Users");
            }
            catch (e) {
                console.error(e);
                var strMsg = `根据关键字获取相应的记录的对象不成功,${e}.`;
    ...
    exports.WApiUsers_QUDI_TS = WApiUsers_QUDI_TS;
});
