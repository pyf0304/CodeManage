(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L3_ForWApiEx/UserManage/clswxUserInfoExWApi.js", "../TS/L0_Entity/BaseInfo/clsQxUsersEN.js", "../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js"], factory);
    }
            ...
            try {
                if (this.userId != "") {
                    ...
                    if (this.password != "") {
                        ...
                        var objUsers = new clsQxUsersEN_js_1.clsQxUsersEN();
                        const responseRecCount = await (0, clsQxUsersWApi_js_1.QxUsers_GetFirstObjAsync)(strWhereCond).then((jsonData) => {
                            objUsers = jsonData;
                        });
                        if (objUsers != null) {
