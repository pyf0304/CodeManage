(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/ParameterTable/clsSubViewpointTypeEN.js", "../TS/L3_ForWApi/ParameterTable/clsSubViewpointTypeWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SubViewpointType_QUDI_TS = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    ...
    */
    class SubViewpointType_QUDI_TS extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        async AddNewRecordSave() {
            ...
            try {
                const responseText = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_IsExistAsync)(objSubViewpointTypeEN.subViewpointTypeId);
                var bolIsExist = responseText;
                if (bolIsExist == true) {
                    var strMsg = `添加记录时，关键字：${objSubViewpointTypeEN.subViewpointTypeId}已经存在！`;
                    alert(strMsg);
                    return responseText; //一定要有一个返回值，否则会出错！
                }
                const responseText2 = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_AddNewRecordAsync)(objSubViewpointTypeEN);
       ...
       */
        BindTab_SubViewpointType(divContainer, arrSubViewpointTypeObjLst) {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindTabV2(o, arrSubViewpointTypeObjLst, arrDataColumn, "subViewpointTypeId");
       ...
       */
        async btnExportExcel_Click() {
            ...
            try {
                const responseText = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        CombineSubViewpointTypeCondition() {
            ...
            try {
                if (this.SubViewpointTypeName_q != "") {
                    strWhereCond += ` And ${clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN.con_SubViewpointTypeName} like '% ${this.SubViewpointTypeName_q}%'`;
                }
            }
            catch (objException) {
       ...
       */
        DelMultiRecord(arrSubViewpointTypeId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_DelSubViewpointTypesAsync)(arrSubViewpointTypeId).then((jsonData) => {
       ...
       */
        DelRecord(strSubViewpointTypeId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_DelRecordAsync)(strSubViewpointTypeId).then((jsonData) => {
                        var returnInt = jsonData;
                        if (returnInt > 0) {
                            var strInfo = `删除记录成功,共删除${returnInt}条记录!`;
                            //显示信息框
       ...
       */
        DetailRecord(strSubViewpointTypeId) {
            this.btnOKUpd = "";
            this.btnCancel = "关闭";
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetObjBySubViewpointTypeIdAsync)(strSubViewpointTypeId).then((jsonData) => {
                        var objSubViewpointTypeEN = jsonData;
       ...
       */
        async GetMaxStrId(strKeyCtrlName) {
            ...
            try {
                const responseText = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetMaxStrIdAsync)();
                var returnString = responseText.toString();
                if (returnString == "") {
                    var strInfo = `获取表SubViewpointType的最大关键字为空，不成功，请检查!`;
                    ...
                    var strInfo = `获取表SubViewpointType的最大关键字为：${returnString}!`;
                    $('#lblResult35').val(strInfo);
                    //显示信息框
                    alert(strInfo);
                    $(strKeyCtrlName).val(returnString);
       ...
       */
        QuerySubViewpointTypeLst(strListDiv) {
            var strWhereCond = this.CombineSubViewpointTypeCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            return new Promise((resolve, reject) => {
                try {
                    ...
                    const responseText = (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                        var arrSubViewpointTypeObjLst = jsonData;
                        this.BindTab_SubViewpointType(strListDiv, arrSubViewpointTypeObjLst);
       ...
       */
        async SelectRecord(strSubViewpointTypeId) {
            try {
                const responseText = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetObjBySubViewpointTypeIdAsync)(strSubViewpointTypeId);
                var objSubViewpointTypeEN = responseText;
                console.log("完成SelectRecord!");
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.Redirect("/Index/Main_SubViewpointType");
            }
            catch (e) {
                console.error(e);
                var strMsg = `根据关键字获取相应的记录的对象不成功,${e}.`;
       ...
       */
        async ShowData(strSubViewpointTypeId) {
            ...
            var objSubViewpointTypeEN = new clsSubViewpointTypeEN_js_1.clsSubViewpointTypeEN();
            try {
                const responseText = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_IsExistAsync)(strSubViewpointTypeId);
                var returnBool = responseText;
                if (returnBool == false) {
                    var strInfo = `关键字:[${strSubViewpointTypeId}] 的记录不存在!`;
            ...
            try {
                const responseText = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetObjBySubViewpointTypeIdAsync)(strSubViewpointTypeId);
                objSubViewpointTypeEN = responseText;
            }
            catch (e) {
                var strMsg = `根据关键字获取相应的记录的对象不成功,${e}.`;
                alert(strMsg);
       ...
       */
        ShowSubViewpointTypeObj(divContainer, objSubViewpointType) {
            ...
            var sstrKeys = clsCommonFunc4Web2_js_1.clsCommonFunc4Web.GetObjKeys(objSubViewpointType);
       ...
       */
        ...
        /* 根据关键字获取相应的记录的对象
         ...
         <param name = "sender">参数列表</param>
       */
        UpdateRecord(strSubViewpointTypeId) {
            this.btnOKUpd = "确认修改";
            this.btnCancel = "取消修改";
       ...
       */
        UpdateRecordSave() {
            ...
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_UpdateRecordAsync)(objSubViewpointTypeEN).then((jsonData) => {
                        var returnBool = jsonData;
                        if (returnBool == true) {
                            var strInfo = `修改记录成功!`;
       ...
       */
        set hidSortSubViewpointTypeBy(value) {
            $("#hidSortSubViewpointTypeBy").val(value);
        }
        /*
        * 设置排序字段
       */
        get hidSortSubViewpointTypeBy() {
    ...
    exports.SubViewpointType_QUDI_TS = SubViewpointType_QUDI_TS;
});
