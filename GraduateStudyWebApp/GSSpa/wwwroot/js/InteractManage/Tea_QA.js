(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/FunClass/clsPublicParagraph.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperEN.js", "../TS/L0_Entity/GraduateEduTools/clsgs_AnswerCountEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvRTUserRelaEN.js", "../TS/L0_Entity/InteractManage/clsqa_AnswerEN.js", "../TS/L0_Entity/InteractManage/clsqa_AnswerVEN.js", "../TS/L0_Entity/InteractManage/clsqa_PushEN.js", "../TS/L0_Entity/InteractManage/clsqa_QuestionsEN.js", "../TS/L0_Entity/InteractManage/clsSysVoteEN.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsTeacherWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_AnswerCountWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_AnswerVWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_AnswerWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_PushWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../TS/L3_ForWApi/InteractManage/clsSysVoteWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_AnswerWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_QuestionsWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_AnswerCountExWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js", "../TS/L3_ForWApiEx/InteractManage/clsqa_AnswerExWApi.js", "../TS/L3_ForWApiEx/InteractManage/clsvqa_AnswerExWApi.js", "../TS/PubFun/clsOrderByData.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsStackTrace.js"], factory);
    }
    ...
    const clsqa_AnswerVEN_js_1 = require("../TS/L0_Entity/InteractManage/clsqa_AnswerVEN.js");
    ...
    const clsqa_AnswerVWApi_js_1 = require("../TS/L3_ForWApi/InteractManage/clsqa_AnswerVWApi.js");
    ...
    class Tea_QA {
       ...
       */
        ...
        async btnShowAnswer_Click() {
            ...
            try {
                ...
                var objqa_Questions = await (0, clsqa_QuestionsWApi_js_1.qa_Questions_GetFirstObjAsync)(strQWhereCond);
      ...
      */
        ...
        async AddNewqa_Push() {
            try {
                ...
                var strWhereCond = " id_CurrEduCls='" + this.Id_CurrEduCls + "' order by stuName Asc";
                ...
                for (var i = 0; i < arrCurrEduClsStuObjLst.length; i++) {
                    ...
                    objqa_PushEN.isRequestReply = true; // 是否要求回复
                    objqa_PushEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate();
      ...
      */
        PutDataToqa_QuestionsClass(pobjqa_QuestionsEN) {
            pobjqa_QuestionsEN.paperId = $("#hidPaperId").val();
            pobjqa_QuestionsEN.qa_PaperId = "00000000";
            pobjqa_QuestionsEN.questionsTypeId = "02";
            pobjqa_QuestionsEN.id_CurrEduCls = this.Id_CurrEduCls; //教学班Id
            ...
            pobjqa_QuestionsEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            pobjqa_QuestionsEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
        }
      ...
      */
       ...
       */
        ...
        async SynQuestions() {
            ...
            objPaperEN.teaQCount = intQuestionsCount;
            ...
            try {
                if ($('#hidAnswerTypeId').val() == "01") {
                    if ($('#hidParentId').val() == "root") {
                        var strWhere = " answerTypeId='01' and questionsId='" + this.questionsId + "' and updUser='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "' and isRecommend=0 and parentId='root'";
      ...
      */
            ...
            try {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strAnswerId, "11", "1", this.Id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        var strAnswerId = $('#hidAnswerId').val();
                        const responseText7 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strAnswerId, "11", "2", this.Id_CurrEduCls);
        ...
        async AddVersionRecordSave() {
            var objqa_AnswerVEN = new clsqa_AnswerVEN_js_1.clsqa_AnswerVEN();
            objqa_AnswerVEN.answerId = this.answerId;
            this.PutDataToqa_AnswerVClass(objqa_AnswerVEN);
            try {
                const responseText2 = await (0, clsqa_AnswerVWApi_js_1.qa_AnswerV_AddNewRecordAsync)(objqa_AnswerVEN);
      ...
      */
        PutDataToqa_AnswerVClass(pobjqa_AnswerVEN) {
            var strUserId = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId();
            pobjqa_AnswerVEN.questionsId = this.questionsId; //问题ID
            pobjqa_AnswerVEN.isRecommend = true;
            if ($("#hidTopicId").val() != "") {
                pobjqa_AnswerVEN.topicId = $("#hidTopicId").val();
            }
            //pobjqa_AnswerEN.parentId = "root";//父节点
            pobjqa_AnswerVEN.answerTypeId = $("#hidAnswerTypeId").val(); //回答类型Id
            pobjqa_AnswerVEN.parentId = $("#hidParentId").val(); //父节点
            pobjqa_AnswerVEN.answerContent = this.answerContent; // 答案内容
            pobjqa_AnswerVEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            pobjqa_AnswerVEN.updUser = strUserId; // 修改用户Id
            //是否提交
            pobjqa_AnswerVEN.isSubmit = this.isSubmit;
        }
      ...
      */
       ...
       */
        ...
        async DiscussSubmit_Click() {
            //this.DivName = "divAddNewRecordWithMaxIdSave";
            var objqa_AnswerEN = new clsqa_AnswerEN_js_1.clsqa_AnswerEN();
            objqa_AnswerEN.questionsId = this.questionsId; //问题ID
            objqa_AnswerEN.topicId = $("#hidTopicId").val();
            objqa_AnswerEN.answerTypeId = $("#hidAnswerTypeId").val(); //回答类型Id
            objqa_AnswerEN.parentId = $("#hidParentId").val(); //父节点
            //objqa_AnswerEN.parentId = "root";//父节点
            objqa_AnswerEN.answerContent = $("#txtDiscussContent").val(); // 讨论内容
            objqa_AnswerEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            objqa_AnswerEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            //是否提交
            objqa_AnswerEN.isSubmit = true;
            try {
                const responseText2 = await (0, clsqa_AnswerWApi_js_1.qa_Answer_AddNewRecordWithReturnKeyAsync)(objqa_AnswerEN);
     ...
     */
        async UpdateRecordSave2() {
            ...
            if ($("#hidIsRecommend").val() != "") {
                ...
                // var intVersionCount = await qa_AnswerV_GetRecCountByCondAsync(strWhereCond2);
                const responseText = await (0, clsqa_AnswerVWApi_js_1.qa_AnswerV_GetFirstObjAsync)(strWhereCond2).then((jsonData) => {
                    var objqa_AnswerVEN = jsonData;
                    if (objqa_AnswerVEN != null) {
                        //需要去标签的更改数据存放
                        $("#inpLeft").val(objqa_AnswerVEN.answerContent);
                        //存放老的带标签的数据不更改
                        $("#inpOldData").val(objqa_AnswerVEN.answerContent);
                        strHisToryUserId = objqa_AnswerVEN.updUser;
                    }
                });
                //调用比较方法
                startCompare();
       ...
       */
        async btnDelAnswer_Click(strAnswerId) {
            try {
                //先删除总表数据信息
                // var strAnswerId = $('#hidAnswerId').val();
                const responseText7 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strAnswerId, "11", "3", this.Id_CurrEduCls);
                var returnBool6 = !!responseText7;
                if (returnBool6 == true) {
                    console.log("论文子观点数据总表同步成功；");
                }
      ...
      */
        ...
        PutDataToqa_AnswerClass(pobjqa_AnswerEN) {
            ...
            if ($("#hidIsRecommend").val() != "") {
                pobjqa_AnswerEN.isRecommend = true;
            }
            if ($("#hidTopicId").val() != "") {
                pobjqa_AnswerEN.topicId = $("#hidTopicId").val();
            }
            //pobjqa_AnswerEN.parentId = "root";//父节点
            pobjqa_AnswerEN.answerTypeId = $("#hidAnswerTypeId").val(); //回答类型Id
            pobjqa_AnswerEN.parentId = $("#hidParentId").val(); //父节点
            pobjqa_AnswerEN.id_CurrEduCls = this.Id_CurrEduCls; //教学班Id
            pobjqa_AnswerEN.answerContent = this.answerContent; // 答案内容
            pobjqa_AnswerEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            pobjqa_AnswerEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            //是否提交
            pobjqa_AnswerEN.isSubmit = this.isSubmit;
        }
        ...
        async SynAnswer() {
            ...
            if (strAnswerTypeId == "01") {
                ...
                objqa_QuestionsEN.discussCount = intAnswerCount2;
            }
            else {
                objqa_QuestionsEN.groupDiscussCount = intAnswerCount2;
            }
            objqa_QuestionsEN.sf_UpdFldSetStr = objqa_QuestionsEN.updFldString; //设置哪些字段被修改(脏字段)
            if (objqa_QuestionsEN.questionsId == "" || objqa_QuestionsEN.questionsId == undefined) {
                throw "关键字不能为空!";
      ...
      */
        ...
        PutDataTogs_AnswerCountClass(pobjgs_AnswerCountEN) {
            pobjgs_AnswerCountEN.id_CurrEduCls = $("#hidId_CurrEduCls").val(); //教学班ID
            pobjgs_AnswerCountEN.paperId = $("#hidPaperId").val(); //论文ID
            pobjgs_AnswerCountEN.questionsId = this.questionsId; //问题ID
            if ($("#hidIsRecommend").val() != "") {
                pobjgs_AnswerCountEN.isRecommend = true;
            }
            if ($("#hidTopicId").val() != "") {
                pobjgs_AnswerCountEN.topicId = $("#hidTopicId").val();
            }
            //pobjgs_AnswerCountEN.parentId = "root";//父节点
            pobjgs_AnswerCountEN.answerId = this.answerId;
            pobjgs_AnswerCountEN.answerTypeId = $("#hidAnswerTypeId").val(); //回答类型Id
            //pobjgs_AnswerCountEN.parentId = $("#hidParentId").val();//父节点
            pobjgs_AnswerCountEN.answerContent = this.answerContent; // 答案内容
            pobjgs_AnswerCountEN.dataUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            pobjgs_AnswerCountEN.userName = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserName(); // 修改人
            pobjgs_AnswerCountEN.dataAddDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            pobjgs_AnswerCountEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            pobjgs_AnswerCountEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            //是否提交
            //pobjgs_AnswerCountEN.isSubmit = this.isSubmit;
        }
        /////////////////////////////////////////////////////////点赞——邀请其他人/////////////////////////////////////////////////////
        /**
         * 添加点赞
        ...
        async InviteOthers_Click() {
            var strWhereCond = "1=1 and id_CurrEduCls='" + this.Id_CurrEduCls + "'";
            var strUserId = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId();
            //var objqa_Questions: clsqa_QuestionsEN = null;
