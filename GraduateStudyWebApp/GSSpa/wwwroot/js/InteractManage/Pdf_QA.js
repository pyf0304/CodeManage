(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduTools/clsgs_TagsTypeEN.js", "../TS/L0_Entity/InteractManage/clsgs_TagsEN.js", "../TS/L0_Entity/InteractManage/clsqa_AnswerEN.js", "../TS/L0_Entity/InteractManage/clsqa_PaperEN.js", "../TS/L0_Entity/InteractManage/clsqa_PushEN.js", "../TS/L0_Entity/InteractManage/clsqa_QuestionsEN.js", "../TS/L0_Entity/InteractManage/clsSysVoteEN.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsTeacherWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TagsTypeWApi.js", "../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_AnswerWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_PushWApi.js", "../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../TS/L3_ForWApi/InteractManage/clsSysVoteWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_AnswerWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_QuestionsWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/InteractManage/clsvqa_QuestionsExWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsString2.js"], factory);
    }
    ...
    */
    class Pdf_QA {
       ...
       */
        ...
        async BindDdl_gs_TagsType_Cache(ddlTagsTypeId) {
            ...
            try {
                ...
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindDdl_ObjLst(ddlTagsTypeId, arrObjLst_Sel, clsgs_TagsTypeEN_js_1.clsgs_TagsTypeEN.con_TagsTypeId, clsgs_TagsTypeEN_js_1.clsgs_TagsTypeEN.con_TagsTypeName, "标注类型");
      ...
      */
        PutDataToqa_QuestionsClass(pobjqa_QuestionsEN) {
            ...
            pobjqa_QuestionsEN.pdfPageNumIn = $("#page_cache").val();
            pobjqa_QuestionsEN.pdfPageTop = $("#page_top").val();
            pobjqa_QuestionsEN.pdfZoom = $("#pdf_zoom").val();
     ...
     */
      ...
      */
        async UpdateRecordSave3() {
            ...
            objgs_TagsEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            objgs_TagsEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
     ...
     */
        PutDataTogs_TagsClass(pobjgs_TagsEN) {
            ...
            pobjgs_TagsEN.pdfPageNumIn = $("#page_cache").val();
            pobjgs_TagsEN.pdfPageTop = $("#page_top").val();
            pobjgs_TagsEN.pdfZoom = $("#pdf_zoom").val();
            var pdfDiv_top = $("#pdfDiv_top").val();
            pdfDiv_top = pdfDiv_top.substr(0, pdfDiv_top.length - 2);
            var pdfDiv_left = $("#pdfDiv_left").val();
            pdfDiv_left = pdfDiv_left.substr(0, pdfDiv_left.length - 2);
            ...
            pobjgs_TagsEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
            pobjgs_TagsEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
        }
        /* pdf标记删除记录
        (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_btnDelRecord_Click)
       */
      ...
      */
       ...
       */
        ...
        async SynTags() {
            ...
            var objqa_PaperEN = new clsqa_PaperEN_js_1.clsqa_PaperEN();
            objqa_PaperEN.qa_PaperId = strqa_PaperId;
            objqa_PaperEN.tagsCount = intTagsCount;
            objqa_PaperEN.sf_UpdFldSetStr = objqa_PaperEN.updFldString; //设置哪些字段被修改(脏字段)
            if (objqa_PaperEN.qa_PaperId == "" || objqa_PaperEN.qa_PaperId == undefined) {
                throw "关键字不能为空!";
            }
