    ...
    class TeaTest_QA {
       ...
       */
        ...
        async Showdiv_Questions() {
            //var strWhereCond1 = "1=1 and questionsTypeId='03' and paperId='" + $("#hidPaperId").val() + "'";
            var strWhereCond = "1=1 and questionsTypeId='03' and paperId='" + $("#hidPaperId").val() + "' order by orderNum Asc";
        ...
        async Showdiv_PdfQuestions() {
            var strWhereCond = "1=1 and questionsTypeId='03' and paperId='" + $("#hidPaperId").val() + "' order by updDate Asc";
            var strUserId = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId();
            //var objqa_Questions: clsqa_QuestionsEN = null;
            ...
            try {
                ...
                if (strTopicId != "") {
                    ...
                    if (strRoleId == "00620003") {
                        ...
                        strWhereCond4 += " questionsId='" + strQuestionsId + "' and topicId<>'' ";
                    }
      ...
      */
        PutDataToqa_QuestionsClass(pobjqa_QuestionsEN) {
            ...
            pobjqa_QuestionsEN.questionsTypeId = "03";
      ...
      */
       ...
       */
        ...
        async SynQuestions() {
            ...
            var strWhereCond = " questionsTypeId='03' and paperId=" + strPaperId;
     ...
     */
        async UpdateRecordSave2() {
            ...
            if ($("#hidIsRecommend").val() != "") {
                ...
                var strNewTextContent = clsPublicParagraph_js_1.clsPublicParagraph.GetNewStringList(strOld, strNew);
                //把得到新的数据存入编辑控件
