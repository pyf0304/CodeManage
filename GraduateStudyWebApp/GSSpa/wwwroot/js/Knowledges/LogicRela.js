(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L3_ForWApi/Knowledges/clscc_CourseKnowledgesWApi.js", "../TS/L3_ForWApi/Knowledges/clsgs_KnowledgesLogicRelaWApi.js", "../TS/L3_ForWApi/Knowledges/clsgs_KnowledgesLogicWApi.js", "../TS/L3_ForWApiEx/Knowledges/clsgs_KnowledgesLogicExWApi.js", "../TS/L3_ForWApiEx/Knowledges/clsgs_KnowledgesLogicRelaExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
    ...
    const clscc_CourseKnowledgesWApi_js_1 = require("../TS/L3_ForWApi/Knowledges/clscc_CourseKnowledgesWApi.js");
       ...
       */
        ...
        async btnSaveLogicRela_Click(ojson) {
            ...
            for (var i = 0; i < ojson.server.length; i++) {
                ...
                var strUpdUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改人
                //var strid_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
                strLogicJson += '{';
                strLogicJson += '"courseKnowledgeId":"' + strCourseKnowledgeId + '",';
                strLogicJson += '"courseKnowledgeTitle":"' + strCourseKnowledgeTitle + '",';
        ...
        DelRecord1() {
            return new Promise((resolve, reject) => {
                try {
                    var strKnowledgeGraphId = $("#hidKnowledgeGraphId").val();
                    var strWhere = " knowledgeGraphId='" + strKnowledgeGraphId + "' and updUser='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "'";
