(function (factory) {
   ...
   */
    class TopicObjective_QUDI_TS extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
    ...
    exports.TopicObjective_QUDI_TS = TopicObjective_QUDI_TS;
});
