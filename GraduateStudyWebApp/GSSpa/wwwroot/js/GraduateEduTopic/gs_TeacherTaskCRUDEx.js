(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTopic/clsgs_TeacherTaskEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
    ...
    */
    ...
    class gs_TeacherTaskCRUDEx extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
            this.RecCount = 0;
            //布置任务
    ...
    */
        async BindGv_gs_TeacherTask() {
            ...
            try {
                this.BindTab_gs_TeacherTask(arrgs_TeacherTaskObjLst);
    ...
    */
        BindTab_gs_TeacherTask(arrgs_TeacherTaskObjLst) {
            var strhtml = "";
            ...
            for (var i = 0; i < arrgs_TeacherTaskObjLst.length; i++) {
                ...
                if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_RoleId() == "00620001") {
                    ...
                    //登录用户和upduser一致则显示；
                    if (arrgs_TeacherTaskObjLst[i].updUser == clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId()) {
                        strhtml += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="gsTeacherTaskDel" style="float:right;" title="删除" class="layui-btn-danger layui-btn layui-btn layui-btn-xs" onclick="btnDelgs_TeacherTask_Click(' + arrgs_TeacherTaskObjLst[i].mId + ')" > <i class="layui-icon" >&#xe640;</i>移除</button>';
                        strhtml += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="gsTeacherTaskUpd" style="float:right;" title="修改" class="layui-btn layui-btn layui-btn layui-btn-xs" onclick=btnUpdategs_TeacherTask_Click("' + arrgs_TeacherTaskObjLst[i].mId + '") > <i class="layui-icon" >&#xe642;</i>修改</button>';
                    }
                }
