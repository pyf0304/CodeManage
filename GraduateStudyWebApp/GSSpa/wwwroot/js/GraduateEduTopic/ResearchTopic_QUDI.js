(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTopic/clsResearchTopicEN.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsPager.js", "../TS/PubFun/clsOperateList2.js", "../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvResearchTopicWApi.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ResearchTopic_QUDI = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    ...
    */
    class ResearchTopic_QUDI extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        async btnExportExcel_Click() {
            ...
            try {
                const responseText = await (0, clsvResearchTopicWApi_js_1.vResearchTopic_GetObjLstAsync)(strWhereCond).then((jsonData) => {
        ...
        CombineResearchTopicCondition() {
            ...
            try {
                ...
                if (this.TopicProposePeople_q != "") {
                    strWhereCond += ` And ${clsResearchTopicEN_js_1.clsResearchTopicEN.con_TopicProposePeople} like '% ${this.TopicProposePeople_q}%'`;
                }
            }
            catch (objException) {
       ...
       */
        DelMultiRecord(arrTopicId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsResearchTopicWApi_js_1.ResearchTopic_DelResearchTopicsAsync)(arrTopicId).then((jsonData) => {
       ...
       */
        DelRecord(strTopicId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsResearchTopicWApi_js_1.ResearchTopic_DelRecordAsync)(strTopicId).then((jsonData) => {
                        var returnInt = jsonData;
                        if (returnInt > 0) {
                            var strInfo = `删除记录成功,共删除${returnInt}条记录!`;
                            //显示信息框
       ...
       */
        async GetMaxStrId(strKeyCtrlName) {
            ...
            try {
                const responseText = await (0, clsResearchTopicWApi_js_1.ResearchTopic_GetMaxStrIdAsync)();
                var returnString = responseText.toString();
                if (returnString == "") {
                    var strInfo = `获取表ResearchTopic的最大关键字为空，不成功，请检查!`;
                    ...
                    var strInfo = `获取表ResearchTopic的最大关键字为：${returnString}!`;
                    $('#lblResult35').val(strInfo);
                    //显示信息框
                    alert(strInfo);
                    $(strKeyCtrlName).val(returnString);
       ...
       */
        async Page_Load() {
            ...
            try {
                ...
                var strWhereCond = this.CombineResearchTopicCondition();
                const responseText = await (0, clsResearchTopicWApi_js_1.ResearchTopic_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
                    this.RecCount = jsonData;
                });
       ...
       */
        QueryResearchTopicLst(strListDiv) {
            var strWhereCond = this.CombineResearchTopicCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            return new Promise((resolve, reject) => {
                try {
                    ...
                    const responseText = (0, clsvResearchTopicWApi_js_1.vResearchTopic_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                        var arrResearchTopicObjLst = jsonData;
                        this.BindTab_ResearchTopic(strListDiv, arrResearchTopicObjLst);
       ...
       */
        async SelectRecord(strTopicId) {
            try {
                const responseText = await (0, clsResearchTopicWApi_js_1.ResearchTopic_GetObjByTopicIdAsync)(strTopicId);
                var objResearchTopicEN = responseText;
                console.log("完成SelectRecord!");
                clsCommonFunc4Web2_js_1.clsCommonFunc4Web.Redirect("/Index/Main_ResearchTopic");
            }
            catch (e) {
                console.error(e);
                var strMsg = `根据关键字获取相应的记录的对象不成功,${e}.`;
       ...
       */
        async ShowData(strTopicId) {
            ...
            var objResearchTopicEN = new clsResearchTopicEN_js_1.clsResearchTopicEN();
            try {
                const responseText = await (0, clsResearchTopicWApi_js_1.ResearchTopic_IsExistAsync)(strTopicId);
                var returnBool = responseText;
                if (returnBool == false) {
                    var strInfo = `关键字:[${strTopicId}] 的记录不存在!`;
            ...
            try {
                const responseText = await (0, clsResearchTopicWApi_js_1.ResearchTopic_GetObjByTopicIdAsync)(strTopicId);
                objResearchTopicEN = responseText;
            }
            catch (e) {
                var strMsg = `根据关键字获取相应的记录的对象不成功,${e}.`;
                alert(strMsg);
       ...
       */
        ShowResearchTopicObj(divContainer, objResearchTopic) {
            ...
            var sstrKeys = clsCommonFunc4Web2_js_1.clsCommonFunc4Web.GetObjKeys(objResearchTopic);
    ...
    exports.ResearchTopic_QUDI = ResearchTopic_QUDI;
});
