(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperReadWriteEN.js", "../TS/L0_Entity/GraduateEduTools/clssys_RequestPushEN.js", "../TS/L0_Entity/GraduateEduTopic/clsRTUserRelaEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvResearchTopicEN.js", "../TS/L3_ForWApi/DailyRunning/clsCurrEduClsWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvResearchTopicWApi.js", "../TS/L3_ForWApi/ParameterTable/clsgs_ColorWApi.js", "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsOrderByData.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "../TS/PubFun/clsStackTrace.js", "../TS/PubFun/clsString2.js"], factory);
    }
    ...
    */
    class ApplyTopic extends clsOperateList2_js_1.clsOperateList {
        ...
        async Page_Load() {
            ...
            try {
                ...
                if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() != "") {
                    ...
                    //请求
                    const gvResult3 = await this.BindGv_sys_RequestPush("1");
                    //通知
    ...
    */
        ...
        async history_Request_Click() {
            try {
                //请求
                const gvResult3 = await this.BindGv_sys_RequestPush("3");
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
        ...
        async history_Notice_Click() {
            try {
                //历史通知
                const gvResult3 = await this.BindGv_sys_RequestPush("4");
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
        ...
        CombineCondition1() {
            ...
            try {
                ...
                if (clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls() == "00000050") {
                    ...
                    strWhereCond += " and topicId not in(select topicId from RTUserRela where UserID='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "')";
                }
            }
            catch (objException) {
        ...
        async BindGv_Topic() {
            ...
            try {
                ...
                if (arrvResearchTopicObjLst.length == 0) {
                    const strid_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
                    const objCurrEduCls = await (0, clsCurrEduClsWApi_js_1.CurrEduCls_GetObjByid_CurrEduCls_Cache)(strid_CurrEduCls);
                    const strMsg = clsString2_js_1.clsString.Format("没有可申请的研究主题。当前教学班:[{0}].", objCurrEduCls === null || objCurrEduCls === void 0 ? void 0 : objCurrEduCls.eduClsName);
                    alert(strMsg);
                    return;
                }
                var arrTopicId = "";
                ...
                for (var i = 0; i < arrvResearchTopicObjLst.length; i++) {
                    ...
                    var streduClsName = clsPublocalStorage_js_1.clsPublocalStorage.GeteduClsName();
        ...
        async btnApplyTopic_Click(topicId, updUser) {
            ...
            objsys_RequestPushEN.tableKey = topicId;
            objsys_RequestPushEN.requesTypeId = "02";
            //objsys_RequestPushEN.parentId = $("#hidParentId").val();
            //objsys_RequestPushEN.pubParentId = $("#hidPubParentId").val();
            objsys_RequestPushEN.receiveUser = updUser; //接收用户
            objsys_RequestPushEN.requestUser = strUserId; //请求用户
            objsys_RequestPushEN.isReply = false; //请求用户
            objsys_RequestPushEN.requestStata = "请求中"; //请求用户
            objsys_RequestPushEN.requestDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); //请求日期
            objsys_RequestPushEN.id_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
            try {
        ...
        Combinesys_RequestPushCondition1() {
            ...
            try {
                ...
                strWhereCond += " and requesTypeId='02' and requestUser='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "' ";
            }
            catch (objException) {
        ...
        Combinesys_RequestPushCondition2() {
            ...
            try {
                //strWhereCond += " and id_CurrEduCls=" + clsPublocalStorage.Getid_CurrEduCls();
                strWhereCond += " and requesTypeId='02' and receiveUser='" + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() + "' ";
            }
            catch (objException) {
                var strMsg = `(errid:WiTsCs0002)在组合查询条件(Combineqa_PaperCondition)时出错!请联系管理员!${objException}`;
                throw strMsg;
        ...
        //请求列表
        async BindGv_sys_RequestPush(requestStata) {
            var strWhereCond = "";
            switch (requestStata) {
                case "1":
            ...
            try {
                ...
                //获取用户缓存数据
                arrUsers = await (0, clsvUsersSimWApi_js_1.vUsersSim_GetObjLst_Cache)();
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
     ...
     */
        async btn_OK_Click(requestId, strTopicId, strRequestUser) {
            var objsys_RequestPushEN = new clssys_RequestPushEN_js_1.clssys_RequestPushEN();
            objsys_RequestPushEN.requestId = requestId;
            objsys_RequestPushEN.isReply = true;
            objsys_RequestPushEN.replyDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate();
            objsys_RequestPushEN.requestStata = "同意";
        ...
        async AddNewTopicAndRecordSaveUserRela(strTopicId, strRequestUser) {
            ...
            objRTUserRelaEN.topicId = strTopicId;
            objRTUserRelaEN.userId = strRequestUser;
            objRTUserRelaEN.topicUserRoleId = "0003"; //主题成员
            objRTUserRelaEN.orderNum = 30;
            objRTUserRelaEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            objRTUserRelaEN.updUser = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改用户
            try {
                // 同一主题 同一用户 只能添加一次；
        ...
        //                        objUpdateRTUserRelaEN.mId = objRTUserRelaEN.mId;
        //                        objUpdateRTUserRelaEN.userBgColor = Objgs_Color.colorCode;
        //                        objUpdateRTUserRelaEN.sf_UpdFldSetStr = objUpdateRTUserRelaEN.updFldString;//设置哪些字段被修改(脏字段)
    ...
    */
        async btn_NO_Click(requestId) {
            ...
            objsys_RequestPushEN.isReply = true;
            objsys_RequestPushEN.replyDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate();
            objsys_RequestPushEN.requestStata = "拒绝";
            objsys_RequestPushEN.sf_UpdFldSetStr = objsys_RequestPushEN.updFldString; //设置哪些字段被修改(脏字段)
            if (objsys_RequestPushEN.requestId == 0 || objsys_RequestPushEN.requestId == undefined) {
                throw "关键字不能为空!";
            }
