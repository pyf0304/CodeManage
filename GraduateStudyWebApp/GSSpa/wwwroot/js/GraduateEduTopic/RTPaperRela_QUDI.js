(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTopic/clsRTPaperRelaEN.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperEN.js", "../TS/L0_Entity/GraduateEduTopic/clsResearchTopicEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvRTPaperRelaEN.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js", "../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RTPaperRela_QUDI = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
   ...
   */
    class RTPaperRela_QUDI extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        async btnExportExcel_Click() {
            ...
            try {
                const responseText = await (0, clsvRTPaperRelaWApi_js_1.vRTPaperRela_GetObjLstAsync)(strWhereCond).then((jsonData) => {
       ...
       */
        CombinevRTPaperRelaCondition() {
            ...
            try {
                if (this.TopicName_q != "") {
                    strWhereCond += ` And ${clsvRTPaperRelaEN_js_1.clsvRTPaperRelaEN.con_TopicName} like '% ${this.TopicName_q}%'`;
                }
                if (this.PaperTitle_q != "") {
                    strWhereCond += ` And ${clsvRTPaperRelaEN_js_1.clsvRTPaperRelaEN.con_PaperTitle} like '% ${this.PaperTitle_q}%'`;
                }
            }
            catch (objException) {
       ...
       */
        DelMultiRecord(arrmId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsRTPaperRelaWApi_js_1.RTPaperRela_DelRTPaperRelasAsync)(arrmId).then((jsonData) => {
       ...
       */
        DetailRecord(lngmId) {
            ...
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsRTPaperRelaWApi_js_1.RTPaperRela_GetObjBymIdAsync)(lngmId).then((jsonData) => {
       ...
       */
        QueryvRTPaperRelaLst(strListDiv) {
            var strWhereCond = this.CombinevRTPaperRelaCondition();
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
            return new Promise((resolve, reject) => {
                try {
                    ...
                    const responseText = (0, clsvRTPaperRelaWApi_js_1.vRTPaperRela_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                        var arrvRTPaperRelaObjLst = jsonData;
                        this.BindTab_vRTPaperRela(strListDiv, arrvRTPaperRelaObjLst);
       ...
       */
        async ShowData(lngmId) {
            ...
            var objRTPaperRelaEN = new clsRTPaperRelaEN_js_1.clsRTPaperRelaEN();
            try {
                const responseText = await (0, clsRTPaperRelaWApi_js_1.RTPaperRela_IsExistAsync)(lngmId);
       ...
       */
        UpdateRecordSave() {
            ...
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsRTPaperRelaWApi_js_1.RTPaperRela_UpdateRecordAsync)(objRTPaperRelaEN).then((jsonData) => {
                        var returnBool = jsonData;
                        if (returnBool == true) {
                            var strInfo = `修改记录成功!`;
    ...
    exports.RTPaperRela_QUDI = RTPaperRela_QUDI;
});
