(function (factory) {
    ...
    exports.MajorDirectionPaperRela_QUDI = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    ...
    */
    class MajorDirectionPaperRela_QUDI extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
            ...
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsXzMajorDirectionWApi_js_1.XzMajorDirection_GetObjLstAsync)(strWhereCond).then((jsonData) => {
                        ...
                        clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindDdl_ObjLst(ddlMajorDirectionId, arrXzMajorDirectionObjLst, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionId, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionName, "");
    ...
    exports.MajorDirectionPaperRela_QUDI = MajorDirectionPaperRela_QUDI;
});
