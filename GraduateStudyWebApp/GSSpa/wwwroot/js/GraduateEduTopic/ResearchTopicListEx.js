(function (factory) {
    ...
    */
    class ResearchTopicListEx extends ResearchTopic_QUDI_js_1.ResearchTopic_QUDI {
        constructor() {
            super(...arguments);
       ...
       */
        ...
        async BindGv_AllTopicRela() {
            ...
            //2论文关系
            var strWherePaperRela1 = this.CombinevRTPaperRelaCondition() + " and paperTypeId='01'";
            var strWherePaperRela2 = this.CombinevRTPaperRelaCondition() + " and paperTypeId='02'";
            //3个人观点
            var strWhereViewpointRela1 = this.CombinevRTViewpointRelaCondition1() + this.CombineIsTeaComment();
            //专家观点
            var strWhereViewpointRela2 = this.CombinevRTViewpointRelaCondition2() + this.CombineIsTeaComment();
            //附件
            ...
            //6相关概念
            var strWhereConcept = this.CombinevRTConceptRelaCondition() + this.CombineIsTeaComment();
            //7客观事实
            var strWhereFacts = this.CombinevRTTopicObjectiveRelaCondition1() + this.CombineIsTeaComment();
            //8客观数据
            var strWhereBasis = this.CombinevRTTopicObjectiveRelaCondition2() + this.CombineIsTeaComment();
            //技能
            var strWhereSysskill = this.CombinevRTSysSkillCondition() + this.CombineIsTeaComment();
            //9、社会关系
            ...
            //11研究计划
            var strWhereResearchPlan = "topicId='" + $("#hidTopicRelaId").val() + "'";
            //12研究计划之 教师任务布置
            var strWhereTeacherTask = "topicId='" + $("#hidTopicRelaId").val() + "'";
            //反思
            var strWheregs_ReflectLog = this.Combinegs_ReflectLogCondition();
            //二、数据源声明
            ...
            try {
                ...
                //            }
                //            strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('个人观点评论', '../GraduateEduTools/SysComment?Key=" + arrvRTViewpointRelaObjLst1[i].viewpointId + "&Type=03&User=" + arrvRTViewpointRelaObjLst1[i].updUser + "&pubParentId=" + $("#hidTopicRelaId").val() + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
                //            strhtml += '</li>';
                //        } else {
                //            strhtml += '&nbsp;&nbsp;<span class="rowtit colorRed">[未提交]</span></li>';
                //        }
                ...
                //            }
                //            strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('专家观点评论', '../GraduateEduTools/SysComment?Key=" + arrvRTViewpointRelaObjLst2[i].viewpointId + "&Type=04&User=" + arrvRTViewpointRelaObjLst2[i].updUser + "&pubParentId=" + $("#hidTopicRelaId").val() + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
                ...
                //            }
                //            strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('相关概念评论', '../GraduateEduTools/SysComment?Key=" + arrvRTConceptObjLst[i].conceptId + "&Type=05&User=" + arrvRTConceptObjLst[i].updUser + "&pubParentId=" + $("#hidTopicRelaId").val() + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
                ...
                //            }
                //            strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('客观事实评论', '../GraduateEduTools/SysComment?Key=" + arrvRTTopicObjectiveRelaObjLst1[i].topicObjectiveId + "&Type=06&User=" + arrvRTTopicObjectiveRelaObjLst1[i].updUser + "&pubParentId=" + $("#hidTopicRelaId").val() + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
                ...
                //            }
                //            strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('操作技能评论', '../GraduateEduTools/SysComment?Key=" + arrvRTSysSkillObjLst[i].skillId + "&Type=09&User=" + arrvRTSysSkillObjLst[i].updUser + "&pubParentId=" + $("#hidTopicRelaId").val() + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
                ...
                //            }
                //            strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('社会关系评论', '../GraduateEduTools/SysComment?Key=" + arrvRTSysSocialRelaObjLst[i].socialId + "&Type=10&User=" + arrvRTSysSocialRelaObjLst[i].updUser + "&pubParentId=" + $("#hidTopicRelaId").val() + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
        ...
        async btnAddVote_Click(strViewpointId, strUserId, strVoteTypeId) {
            ...
            objSysVoteEN.pubParentId = $("#hidTopicRelaId").val();
        ...
        //    objViewpointLikeLogEN.updUser = $("#hidUserId").val();// 修改用户Id
