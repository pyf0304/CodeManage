(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperEN.js", "../TS/L0_Entity/GraduateEduPaper/clsvPaperEN.js", "../TS/L0_Entity/ParameterTable/clsLiteratureTypeEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperReadWriteWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperWApi.js", "../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.QuoteAndGroupPaperEx = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    类名:Paper_QUDI_TS
    表名:Paper(01120535)
    生成代码版本:2019.12.06.1
    ...
    */
    class QuoteAndGroupPaperEx extends clsOperateList2_js_1.clsOperateList {
        constructor() {
            super(...arguments);
       ...
       */
        AddNewRecord() {
            ...
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsPaperWApi_js_1.Paper_GetMaxStrIdAsync)().then((jsonData) => {
        ...
        CombinevPaperCondition() {
            ...
            try {
                ...
                if (strQuoteAndGroupId == "01") {
                    strWhereCond += ` And ${clsvPaperEN_js_1.clsvPaperEN.con_IsQuotethesis} = '1'`; //引用论文
                }
                else {
                    strWhereCond += ` And ${clsvPaperEN_js_1.clsvPaperEN.con_IsQuotethesis} = '0'`; //本组论文
                }
    ...
    */
    ...
    exports.QuoteAndGroupPaperEx = QuoteAndGroupPaperEx;
});
