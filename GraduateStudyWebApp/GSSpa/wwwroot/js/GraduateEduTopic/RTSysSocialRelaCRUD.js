(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTopic/clsRTSysSocialRelaEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvRTSysSocialRelaEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsOperateList2.js"], factory);
    }
    ...
    class RTSysSocialRelaCRUD extends clsOperateList2_js_1.clsOperateList {
       ...
       */
        ...
        async AddDPV_Edit(divName4Edit) {
            var strUrl = "./RTSysSocialRela_Edit/";
       ...
       */
        async btnExportExcel_Click() {
            ...
            try {
                const responseText = await (0, clsvRTSysSocialRelaWApi_js_1.vRTSysSocialRela_GetObjLstAsync)(strWhereCond).then((jsonData) => {
                    var arrvRTSysSocialRelaObjLst = jsonData;
                    this.BindTab_vRTSysSocialRela(this.mstrListDiv, arrvRTSysSocialRelaObjLst);
                });
            }
       ...
       */
        CombinevRTSysSocialRelaCondition() {
            ...
            try {
                if (this.FullName_q != "") {
                    strWhereCond += ` And ${clsvRTSysSocialRelaEN_js_1.clsvRTSysSocialRelaEN.con_FullName} like '% ${this.FullName_q}%'`;
                }
                if (this.Nationality_q != "") {
                    strWhereCond += ` And ${clsvRTSysSocialRelaEN_js_1.clsvRTSysSocialRelaEN.con_Nationality} like '% ${this.Nationality_q}%'`;
                }
            }
            catch (objException) {
       ...
       */
        CombinevRTSysSocialRelaConditionObj() {
            ...
            try {
                ...
                var strMsg = `(errid:WiTsCs0005)在组合查询条件对象(CombineRTSysSocialRelaConditionObj)时出错!请联系管理员!${objException}`;
                throw strMsg;
            }
       ...
       */
        BindTab_vRTSysSocialRela(divContainer, arrvRTSysSocialRelaObjLst) {
            ...
            clsCommonFunc4Web2_js_1.clsCommonFunc4Web.BindTabV2(o, arrvRTSysSocialRelaObjLst, arrDataColumn, "mId");
       ...
       */
        async BindGv_vRTSysSocialRela_Cache() {
            ...
            if (arrvRTSysSocialRelaObjLst.length == 0) {
                var strMsg = `在BindGv_Cache过程中，根据条件对象获取的对象列表数为0！(Key=RTSysSocialRela)`;
                alert(strMsg);
                return;
            }
            try {
       ...
       */
        async ShowData(lngmId) {
            ...
            var objRTSysSocialRelaEN = new clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN();
            try {
                const responseText = await (0, clsRTSysSocialRelaWApi_js_1.RTSysSocialRela_IsExistAsync)(lngmId);
            ...
            try {
                const responseText = await (0, clsRTSysSocialRelaWApi_js_1.RTSysSocialRela_GetObjBymIdAsync)(lngmId);
                objRTSysSocialRelaEN = responseText;
            }
            catch (e) {
                var strMsg = `根据关键字获取相应的记录的对象不成功,${e}.`;
                alert(strMsg);
       ...
       */
        async UpdateRecordSave() {
            ...
            try {
                const responseText = await (0, clsRTSysSocialRelaWApi_js_1.RTSysSocialRela_UpdateRecordAsync)(objRTSysSocialRelaEN);
                var returnBool = !!responseText;
                if (returnBool == true) {
                }
                return returnBool;
