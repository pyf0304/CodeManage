(function (factory) {
    ...
    const clsvViewpointExWApi_js_1 = require("../TS/L3_ForWApiEx/GraduateEdu/clsvViewpointExWApi.js");
    ...
    */
    class Pdfiframe extends clsOperateList2_js_1.clsOperateList {
        constructor() {
       ...
       */
        ...
        async BindEdit() {
            ...
            try {
                ...
                var strWhereCond1 = this.CombinevViewpointCondition();
                var strWhereCond_1 = "1=1 and userTypeId='" + $("#hidUserTypeId").val() + "' and topicId='" + $('#hidTopicId').val() + "'";
                ...
                var strListDiv = this.mstrListDivViewpoint;
                var strWhereCond2 = this.CombinevViewpointCondition();
                var strWhereCond_2 = "1=1 and userTypeId='" + $("#hidUserTypeId").val() + "' and topicId='" + $('#hidTopicId').val() + "'";
                ...
                //相关概念
                var strWhereCond3 = this.CombineConceptCondition();
                var strWhereCond_3 = "1=1 and topicId='" + $('#hidTopicId').val() + "'";
                ...
                var strWhereCond4 = this.CombinevTopicObjectiveCondition();
                var strWhereCond_4 = "1=1 and objectiveType='" + $("#hidObjectiveTypeId").val() + "' and topicId='" + $('#hidTopicId').val() + "'";
                ...
                var strWhereCond5 = this.CombinevTopicObjectiveCondition();
                var strWhereCond_5 = "1=1 and objectiveType='" + $("#hidObjectiveTypeId").val() + "' and topicId='" + $('#hidTopicId').val() + "'";
                ...
                //技能
                var strWhereCond6 = this.CombinevSysSkillCondition();
                var strWhereCond_6 = "1=1 and topicId='" + $('#hidTopicId').val() + "'";
                ...
                //社会关系
                var strWhereCond7 = this.CombinevSysSocialRelationsCondition();
                var strWhereCond_7 = "1=1 and topicId='" + $('#hidTopicId').val() + "'";
                ...
                //var strTopicId = $('#hidTopicId').val();//存放主题Id
     ...
     */
        async BindGv_vViewpoint(strUserTypeId) {
            $("#hidUserTypeId").val(strUserTypeId);
            var strListDiv = this.mstrListDivViewpoint;
            var strWhereCond = this.CombinevViewpointCondition();
            var strWhereCond2 = "1=1 and userTypeId='" + strUserTypeId + "' and topicId='" + $('#hidTopicId').val() + "'";
            ...
            try {
                ...
                if (returnBool == true) {
                    ...
                    if ($("#ddlVTypeId").val() == "01") {
                        this.BindGv_vViewpoint("01");
                    }
                    else {
                        this.BindGv_vViewpoint("02");
                    }
                    CloseWindow_();
                    //CloseWindow();
                    //绑定专家关系列表； 
    ...
    */
        async BindGv_Concept() {
            ...
            var strWhereCond2 = "1=1 and topicId='" + $('#hidTopicId').val() + "'";
    ...
    */
        async BindGv_vTopicObjective(strObjectiveTypeId) {
            ...
            var strWhereCond2 = "1=1 and objectiveType='" + strObjectiveTypeId + "' and topicId='" + $('#hidTopicId').val() + "'";
            var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager); //获取当前页
    ...
    */
        PutDataToRTSysSkillRelaClass(pobjRTSysSkillRelaEN) {
            ...
            pobjRTSysSkillRelaEN.memo = "pdf添加模块"; // 备注
        }
        /* 添加新记录，保存函数
        (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_AddNewRecordSave)
       */
    ...
    */
        PutDataToRTSyssocialRelaClass(pobjRTSysSocialRelaEN) {
            ...
            pobjRTSysSocialRelaEN.memo = "pdf社会关系"; // 备注
        }
        /* 添加新记录，保存函数
        (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_AddNewRecordSave)
       */
