(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduPaper/clsvPaperEN.js", "../TS/L0_Entity/GraduateEduTopic/clsObjectiveAttachmentEN.js", "../TS/L0_Entity/GraduateEduTopic/clsRTTopicObjectiveRelaEN.js", "../TS/L0_Entity/GraduateEduTopic/clsTopicObjectiveEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvTopicObjectiveEN.js", "../TS/L0_Entity/ParameterTable/clsLiteratureTypeEN.js", "../TS/L0_Entity/UserManage/clsvUsersSimEN.js", "../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js", "../TS/PubFun/clsCommonFunc4Web2.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js", "./TopicObjective_QUDI_TS.js", "../GraduateEduPublicPage/Public_TopicObjective.js", "../TS/FunClass/clsDropDownList.js", "../TS/L0_Entity/GraduateEduTopic/clsTopicObjectiveVEN.js", "../TS/L0_Entity/ParameterTable/clsgs_ShareEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsObjectiveAttachmentWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveVWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js", "../TS/L3_ForWApi/ParameterTable/clsgs_ShareWApi.js", "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js", "../TS/L3_ForWApiEx/ExamManage/clsgs_UserConfigExWApi.js"], factory);
    }
    ...
    */
    ...
    const clsTopicObjectiveVEN_js_1 = require("../TS/L0_Entity/GraduateEduTopic/clsTopicObjectiveVEN.js");
    ...
    const clsTopicObjectiveVWApi_js_1 = require("../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveVWApi.js");
    ...
    */
    class TopicObjective_QUDI_TSEx extends TopicObjective_QUDI_TS_js_1.TopicObjective_QUDI_TS {
        constructor() {
            super(...arguments);
            //论文列表
    ...
    */
        ...
        //                clsCommonFunc4Web.BindDdl_ObjLst(ddlUserId, arrUserObjLst, clsvTopicObjectiveEN.con_UpdUser, clsvTopicObjectiveEN.con_UserName, "编辑用户");
        ...
        async CombinevTopicObjectiveCondition() {
            ...
            try {
                ...
                if (strRoleId == "00620001") {
                    ...
                    //strWhereCond += ` And ${clsvTopicObjectiveEN.con_id_CurrEduCls} = '${clsPublocalStorage.Getid_CurrEduCls()}'`;
                    //var strhidObjectiveTypeId = $("#hidObjectiveTypeId").val();
                    //if (strhidObjectiveTypeId != "") {
                ...
                if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() != "") {
                    switch (strCommandText) {
                        ...
                        case "确认添加":
                            ...
                            const responseText6 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strTopicObjectiveId, "07", "1", this.Id_CurrEduCls);
                        ...
                        case "确认修改":
                            ...
                            var strTopicObjectiveId = $('#hidObjectiveId').val();
                            const responseText7 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strTopicObjectiveId, "07", "2", this.Id_CurrEduCls);
    ...
    */
        async btnAddNewRecord_Click() {
            ...
            try {
                ...
                const ddl_gs_Share = await (0, clsgs_ShareWApi_js_1.gs_Share_BindDdl_ShareIdInDiv_Cache)(this.divName4List, "ddlShareId");
                //获取分享Id
                const responseText1 = await (0, clsgs_UserConfigExWApi_js_1.gs_UserConfigEx_GetNewReturnShareIdEx)("07", clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId());
    ...
    */
        async AddNewRecordSave() {
            ...
            if ($('#txtTopicObjectiveId').val() != "") {
                ...
                objTopicObjectiveEN.createDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate_ymd();
        ...
        PutDataToPaperAttachmentClass(pobjObjectiveAttachmentEN, filePath) {
            ...
            pobjObjectiveAttachmentEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
            pobjObjectiveAttachmentEN.id_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls(); //教学班
            pobjObjectiveAttachmentEN.updUserId = clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId(); // 修改用户Id
        }
        ///////////////////////////////////////////////////////////////////数据提交；
        //客观提交审核
    ...
    */
        async btnDelRecordInTab_Click(strKeyId) {
            try {
                ...
                if (RTVCount > 0) {
                    ...
                    const responseText1 = await (0, clsTopicObjectiveVWApi_js_1.TopicObjectiveV_GetObjLstAsync)(strTopicObjectiveVWhereCond).then((jsonData) => {
                    ...
                    const responseText6 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strTopicObjectiveId, "07", "3", this.Id_CurrEduCls);
                    var returnBool6 = !!responseText6;
                    if (returnBool6 == true) {
                        console.log("客观数据总表同步成功；");
                    }
        ...
        VDelMultiRecord(arrTopicObjectiveVId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsTopicObjectiveVWApi_js_1.TopicObjectiveV_DelTopicObjectiveVsAsync)(arrTopicObjectiveVId).then((jsonData) => {
    ...
    */
        ...
        async AddVersionRecordSave() {
            this.DivName = "divUpdateRecordSave";
            var objTopicObjectiveVEN = new clsTopicObjectiveVEN_js_1.clsTopicObjectiveVEN();
            objTopicObjectiveVEN.topicObjectiveId = this.topicObjectiveId;
            this.PutDataToTopicObjectiveVClass(objTopicObjectiveVEN);
            try {
                const responseText2 = await (0, clsTopicObjectiveVWApi_js_1.TopicObjectiveV_AddNewRecordAsync)(objTopicObjectiveVEN);
                var returnBool = !!responseText2;
                if (returnBool == true) {
                    var strWhereCond2 = " 1 =1 and topicObjectiveId=" + this.topicObjectiveId;
                    var intVersionCount = await (0, clsTopicObjectiveVWApi_js_1.TopicObjectiveV_GetRecCountByCondAsync)(strWhereCond2);
                    var objTopicObjectiveEN = new clsTopicObjectiveEN_js_1.clsTopicObjectiveEN();
    ...
    */
      ...
      */
        PutDataToTopicObjectiveVClass(pobjTopicObjectiveVEN) {
            var strUserId = $("#hidUserId").val();
            ...
            //pobjTopicObjectiveVEN.objectiveType = this.objectiveType;// 客观类型
            pobjTopicObjectiveVEN.sourceId = this.sourceId; // 来源Id
            pobjTopicObjectiveVEN.conclusion = this.conclusion; // 结论
            pobjTopicObjectiveVEN.id_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
            pobjTopicObjectiveVEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
       ...
       */
        PutDataToTopicObjectiveClass(pobjTopicObjectiveEN) {
            ...
            pobjTopicObjectiveEN.isSubmit = false; //是否提交；
            pobjTopicObjectiveEN.shareId = this.shareId;
            pobjTopicObjectiveEN.id_CurrEduCls = clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls();
            pobjTopicObjectiveEN.updDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate(); // 修改日期
    ...
    */
     ...
     */
        async CancelSubmitRecordSave(strKeyId) {
            //this.DivName = "divUpdateRecordSave";
            var objTopicObjectiveEN = new clsTopicObjectiveEN_js_1.clsTopicObjectiveEN();
            objTopicObjectiveEN.topicObjectiveId = strKeyId;
