(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsTeacherWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../TS/L3_ForWApiEx/DailyRunning/clsvCurrEduClsTeacherExWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsIndexExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsPubSessionStorage.js"], factory);
    }
    ...
    */
    class Index {
        async Page_Load() {
            ...
            try {
                if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() != "") {
                    ...
                    $('#tz_login').hide();
                    $('#tz_Register').hide();
                    $('#userName').html(clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserName() + '(' + clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_RoleName() + ')');
                    $('#box3').show();
                    $('#box4').show();
                    ...
                    else if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_RoleId() == "00620001") {
                        this.GetCurrEduClsMessage();
                    }
                    //$("#divLoading").hide();
                }
        ...
        async btnCancellation_Click() {
            //判断角色
            //管理员
            clsPubSessionStorage_js_1.clsPubSessionStorage.SetSession_UserId("");
            $('#userName').hide();
            $('#Cancellation').hide();
            $('#tz_login').show();
            $('#tz_Register').show();
        ...
        async btnCommentScore(strId_CurrEducls) {
            if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() != "") {
                //把传递参数存放缓存；
                clsPublocalStorage_js_1.clsPublocalStorage.Setid_CurrEduCls(strId_CurrEducls);
