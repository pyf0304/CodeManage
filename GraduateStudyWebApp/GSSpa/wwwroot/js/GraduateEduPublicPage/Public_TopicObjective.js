(function (factory) {
    ...
    const clsvTopicObjectiveExEN_js_1 = require("../TS/L0_EntityEx/GraduateEduTopic/clsvTopicObjectiveExEN.js");
    ...
    class Public_TopicObjective {
        ...
        static async BindList_vTopicObjectiveEx(strOperationType, strVType, arrvTopicObjectiveExObjLst) {
            ...
            const responseRecCount = await (0, clsObjectiveAttachmentWApi_js_1.ObjectiveAttachment_GetObjLstAsync)(strWhereCondAttachment).then((jsonData) => {
