...
(function (factory) {
    ...
    */
    class AddPaperEx extends Paper_QUDI_TS_js_1.Paper_QUDI_TS {
        constructor() {
    ...
    */
        async AddNewRecordWithMaxIdSaveRetrunId() {
            ...
            try {
                let strCondition = clsString2_js_1.clsString.Format(" 1 = 1 and paperTitle = '{0}' and paperId in (select paperId from PaperEduClsRela where id_CurrEduCls = '{1}')", this.paperTitle, $("#hidId_CurrEduCls").val());
                ...
                if (clsPubSessionStorage_js_1.clsPubSessionStorage.GetSession_UserId() != "") {
                    switch (strCommandText) {
                        ...
                        case "确认添加":
                            ...
                            const responseText8 = await (0, clsgs_TotalDataStatisticsExWApi_js_1.gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis)(strPaperId, "01", "1", this.Id_CurrEduCls);
