(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/stuUserLoginInfo.js", "../TS/L0_Entity/Other/clsvPaperSimEN.js", "../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js", "../GraduateEduPaper/Paper_QUDI_TS.js", "../TS/L3_ForWApi/Other/clsvPaperSimWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/L3_ForWApiEx/Other/clsvPaperSimExWApi.js"], factory);
    }
    ...
    */
    class PaperAllListEx extends Paper_QUDI_TS_js_1.Paper_QUDI_TS {
        constructor() {
    ...
    */
        async BindGv_vPaper() {
            ...
            try {
                this.RecCount = await (0, clsvPaperSimExWApi_js_1.vPaperSimEx_GetRecCountByCondById_CurrEduCls_Cache)(objvPaperSim_Cond, clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls());
                console.log("完成计数!");
                arrvPaperSimObjLst = await (0, clsvPaperSimExWApi_js_1.vPaperSimEx_GetObjLstByPagerById_CurrEduCls_Cache)(objPagerPara, clsPublocalStorage_js_1.clsPublocalStorage.Getid_CurrEduCls());
                ...
                //    arrvPaperSimObjLst = <Array<clsvPaperEN>>jsonData;
                //});
                //const responseText = await vPaper_GetObjLstByPager_WA_CacheAsync(objPagerPara);
                //arrvPaperSimObjLst = <Array<clsvPaperEN>>responseText;
            }
            catch (e) {
