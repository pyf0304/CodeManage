...
/***/ (function (module, exports, __webpack_require__) {
        ...
        function webViewerInitialized() {
            ...
            //var defaultUrl = _app_options.AppOptions.get('defaultUrl');
            //var PdfFile = document.getElementById("hidPdfFile");
            //console.log("hidPdfFile：" + PdfFile.value);
            //if (PdfFile.value != null && PdfFile.value != "") {
            //    //if (params.file == null) {
            ...
            //console.log("url的file内容：" + params.file);
            //console.log("默认的file内容：" + defaultUrl);
            //console.log("显示的file内容：" + file);
...
/***/ (function (module, exports, __webpack_require__) {
        ...
        var defaultOptions = {
            ...
            defaultUrl: {
                value: '../pdfjs2.3/web/SystemSpecification.pdf',
            ...
            workerSrc: {
                value: '../pdfjs2.3/build/pdf.worker.js',
                kind: OptionKind.WORKER
            }
        };
        {
...
/***/ (function (module, exports, __webpack_require__) {
        ...
        if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
            ...
            pdfjsLib = require('../pdfjs2.3/build/pdf.js');
        }
            ...
            function () {
                ...
                _createClass(BaseViewer, [{
                    ...
                    value: function _updateLocation(firstPage) {
                        ...
                        var pdf_zoom = document.getElementById("pdf_zoom");
                        pdf_zoom.value = this._location.scale;



                        var IsQA_Tags = document.getElementById("hidIsQA_Tags").value;
                        if (IsQA_Tags == "1") {
                            //绑定pdf悬浮问题
                            Showdiv_PdfQuestions_Click();
                            console.log("当前IsQA_Tags：" + IsQA_Tags)
                        } else if (IsQA_Tags == "2") {
                            //绑定pdf悬浮标记
                            Showdiv_PdfTags_Click();
                            console.log("当前IsQA_Tags：" + IsQA_Tags)
                        }
                        console.log("判断外的IsQA_Tags：" + IsQA_Tags)
