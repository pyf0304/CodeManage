...
export class clsqa_QuestionsTypeEN extends clsGeneralTab
{
public static CacheAddiCondition = "";//缓存附加条件，作为向后台调取数据的附加条件
public static CacheModeId = "03"; //localStorage
public static _CurrTabName= "qa_QuestionsType"; //当前表名,与该类相关的表名
public static _KeyFldName= "QuestionsTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 3;
public static AttributeName = ["questionsTypeId", "questionsTypeName", "memo"];
//以下是属性变量
...
private mstrQuestionsTypeName = "";    //问题类型名称
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetQuestionsTypeName (value: string)
{
if (value  != undefined)
{
