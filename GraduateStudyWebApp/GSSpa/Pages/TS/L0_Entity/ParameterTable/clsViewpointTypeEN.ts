...
export class clsViewpointTypeEN extends clsGeneralTab
{
public static CacheAddiCondition = "";//缓存附加条件，作为向后台调取数据的附加条件
public static CacheModeId = "03"; //localStorage
public static _CurrTabName= "ViewpointType"; //当前表名,与该类相关的表名
public static _KeyFldName= "ViewpointTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 3;
public static AttributeName = ["viewpointTypeId", "viewpointTypeName", "memo"];
//以下是属性变量
