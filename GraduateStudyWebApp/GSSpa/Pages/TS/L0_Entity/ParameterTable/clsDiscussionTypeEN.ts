...
export class clsDiscussionTypeEN extends clsGeneralTab
{
public static CacheAddiCondition = "";//缓存附加条件，作为向后台调取数据的附加条件
public static CacheModeId = "03"; //localStorage
public static _CurrTabName= "DiscussionType"; //当前表名,与该类相关的表名
public static _KeyFldName= "DiscussionTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 5;
public static AttributeName = ["discussionTypeId", "discussionTypeName", "updDate", "updUser", "memo"];
//以下是属性变量
...
private mstrDiscussionTypeName = "";    //讨论类型名称
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetDiscussionTypeName (value: string)
{
if (value  != undefined)
{
