...
public static AttributeName = ["paperSubViewpointLikeLogId", "updDate", "memo", "rwTitle", "subViewpointContent", "explainContent", "paperRWId", "subViewpointId", "updUser"];
//以下是属性变量
...
*/
public paperSubViewpointLikeLogId = 0;    //PaperSubViewpointLikeLogId
public updDate = "";    //修改日期
public memo = "";    //备注
public rwTitle = "";    //读写标题
 ...
 */
 public static get con_PaperSubViewpointLikeLogId(): string {return "paperSubViewpointLikeLogId";}    //PaperSubViewpointLikeLogId
