...
public static AttributeName = ["id_CurrEduCls", "currEduClsId", "eduClsName", "eduClsTypeId", "courseId", "teachingSolutionId", "id_XzCollege", "id_XzMajor", "id_EduWay", "id_ClassRoomType", "totalLessonQty", "maxStuQty", "weekQty", "scheUnitPW", "weekStatusID", "customerWeek", "lessonQtyPerWeek", "mark", "id_UniZone", "id_GradeBase", "isEffective", "isForPaperReading", "schoolYear", "schoolTerm", "id_CourseType", "isDegree", "id_ScoreType", "getScoreWayId", "isProportionalCtrl", "id_ExamType", "examTime", "beginWeek", "modifyDate", "modifyUserID", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public Setid_EduWay (value: string)
{
if (value  != undefined)
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public Setid_CourseType (value: string)
{
if (value  != undefined)
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public Setid_ScoreType (value: string)
{
if (value  != undefined)
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public Setid_ExamType (value: string)
{
if (value  != undefined)
{
