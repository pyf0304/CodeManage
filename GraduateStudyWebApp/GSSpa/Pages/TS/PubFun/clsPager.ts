...
export class clsPager {
    ...
    //    this.ShowPager();
    //}
    public PageNum(thisA) {
        var thisEvent = <HTMLAnchorElement>thisA;
    ...
    public JumpToPage(strDivName4Pager: string) {
        var objDiv: HTMLDivElement = <HTMLDivElement>document.getElementById(strDivName4Pager);
        if (objDiv == null) {
        ...
        var txtInputNumber: HTMLInputElement = <HTMLInputElement>arrElements.find(x => x.id == "txtInputNumber");
    ...
    public ShowPager(strDivName4Pager: string) {
        //var padingnum = 100;
 ...
 */
    ...
    public SetEvent(strDivName4Pager: string, thisPager: clsPager) {
        //var btnNextPage = doc
        var objDiv: HTMLDivElement = <HTMLDivElement>document.getElementById(strDivName4Pager);
        if (objDiv == null) {
            var strMsg = `层:[${strDivName4Pager}]在该界面不存在！`;
        ...
        var btnNextPage: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "btnNextPage");
        if (btnNextPage == null) {
        ...
        var btnPrevPage: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "btnPrevPage");
        if (btnPrevPage == null) {
        ...
        var btnFirstPage: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "btnFirstPage");
        ...
        var btnLastPage: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "btnLastPage");
        if (btnLastPage == null) {
        ...
        var btnJumpToPage: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "btnJumpToPage");
        ...
        var btnOne: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "One");
        if (btnOne == null) {
        ...
        var btnTwo: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "Two");
        if (btnTwo == null) {
        ...
        var btnThree: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "Three");
        if (btnThree == null) {
        ...
        var btnFour: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "Four");
        if (btnFour == null) {
        ...
        var btnFive: HTMLAnchorElement = <HTMLAnchorElement>arrElements.find(x => x.id == "Five");
        if (btnFive == null) {
    ...
    public ShowPagerV2(objListPage: clsOperateList, strDivName4Pager: string) {
    ...
    public ShowPagerV3(objListPage: clsOperateList, strDivName4Pager: string) {
        clsPager.ListPage = objListPage;
        var objDiv4Pager: HTMLDivElement = <HTMLDivElement>document.getElementById(strDivName4Pager);
        var objUl: HTMLUListElement = <HTMLUListElement>document.createElement("ul");
        objUl.className = "nav";
        objUl.id = "page";

        var objliFirstPage: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliFirstPage.className = "nav-item p-prev disabled";
        objliFirstPage.id = "liFirstPage";
        var btnFirstPage: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liPrevPage(): HTMLLIElement {
        var objliPrevPage: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliPrevPage.className = "nav-item p-prev disabled";
        objliPrevPage.id = "liPrevPage";
        var btnPrevPage: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liOne(): HTMLLIElement {
        var objliOne: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliOne.className = "nav-item";
        objliOne.id = "liOne";
        var btnOne: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liTwo(): HTMLLIElement {
        var objliTwo: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliTwo.className = "nav-item";
        objliTwo.id = "liTwo";
        var btnTwo: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liThree(): HTMLLIElement {
        var objliThree: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliThree.className = "nav-item";
        objliThree.id = "liThree";
        var btnThree: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liFour(): HTMLLIElement {
        var objliFour: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliFour.className = "nav-item";
        objliFour.id = "liFour";
        var btnFour: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liFive(): HTMLLIElement {
        var objliFive: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliFive.className = "nav-item";
        objliFive.id = "liFive";
        var btnFive: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liNextPage(): HTMLLIElement {
        var objliNextPage: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliNextPage.className = "nav-item p-prev disabled";
        objliNextPage.id = "liNextPage";
        var btnNextPage: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liLastPage(): HTMLLIElement {
        var objliLastPage: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliLastPage.className = "nav-item p-prev disabled";
        objliLastPage.id = "liLastPage";
        var btnLastPage: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_liCountPage(): HTMLLIElement {
        var objliCountPage: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        objliCountPage.className = "nav-item";
        objliCountPage.id = "liCountPage";
        var spnCountPage: HTMLSpanElement = <HTMLSpanElement>document.createElement("span");
    ...
    public get_liNumber(): HTMLLIElement {
        var objliNumber: HTMLLIElement = <HTMLLIElement>document.createElement("li");
        ...
        var spnNumber: HTMLSpanElement = <HTMLSpanElement>document.createElement("span");
        //spnNumber.className = "btn btn-outline-info btn-sm";
        spnNumber.id = "spnNumber";
        spnNumber.innerText = "共13855页 到第";
        objliNumber.appendChild(spnNumber);

        var txtInputNumber: HTMLInputElement = <HTMLInputElement>document.createElement("input");
        ...
        var spnYe: HTMLSpanElement = <HTMLSpanElement>document.createElement("span");
        //spnNumber.className = "btn btn-outline-info btn-sm";
        spnYe.id = "spnYe";
        spnYe.innerText = "页";
        objliNumber.appendChild(spnYe);

        var btnJumpToPage: HTMLAnchorElement = <HTMLAnchorElement>document.createElement("a");
    ...
    public get_hidCurrPageIndex(): HTMLInputElement {
        var objhidCurrPageIndex: HTMLInputElement = <HTMLInputElement>document.createElement("input");
    ...
    public InitShow(strDivName4Pager: string) {
        var objDiv4Pager: HTMLDivElement = <HTMLDivElement>document.getElementById(strDivName4Pager);
        ...
        var objliFirstPage: HTMLLIElement = this.get_liFirstPage();
        objUl.appendChild(objliFirstPage);

        var objliPrevPage: HTMLLIElement = this.get_liPrevPage();
        objUl.appendChild(objliPrevPage);

        var objliOne: HTMLLIElement = this.get_liOne();
        objUl.appendChild(objliOne);

        var objliTwo: HTMLLIElement = this.get_liTwo();
        objUl.appendChild(objliTwo);

        var objliThree: HTMLLIElement = this.get_liThree();
        objUl.appendChild(objliThree);

        var objliFour: HTMLLIElement = this.get_liFour();
        objUl.appendChild(objliFour);

        var objliFive: HTMLLIElement = this.get_liFive();
        objUl.appendChild(objliFive);

        var objliNextPage: HTMLLIElement = this.get_liNextPage();
        objUl.appendChild(objliNextPage);

        var objliLastPage: HTMLLIElement = this.get_liLastPage();
        objUl.appendChild(objliLastPage);

        //var objliCountPage: HTMLLIElement = this.get_liCountPage();
        //objUl.appendChild(objliCountPage);

        var objliNumber: HTMLLIElement = this.get_liNumber();
        objUl.appendChild(objliNumber);


        objDiv4Pager.appendChild(objUl);

        var hidCurrPageIndex: HTMLInputElement = this.get_hidCurrPageIndex();
   ...
   */
    ...
    public Hide(strDivName4Pager: string) {
        var objDiv = $(`#${strDivName4Pager}`);
        objDiv.css("display", "none");
    }
    public Show(strDivName4Pager: string) {
        var objDiv = $(`#${strDivName4Pager}`);
        objDiv.css("display", "block");
    }
    public HideLi(strAnchor: string, strDivName4Pager: string) {
        var objDiv = $(`#${strDivName4Pager}`);
    ...
    public ShowLi(strAnchor: string, strDivName4Pager: string) {
        var objDiv = $(`#${strDivName4Pager}`);
        var objAnchor = objDiv.find(`a[id ^= "${strAnchor}"]`);
        var thisLi = objAnchor.parent();
        thisLi.show();
