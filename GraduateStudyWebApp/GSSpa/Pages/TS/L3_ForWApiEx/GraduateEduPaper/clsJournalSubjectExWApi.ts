...
import { JournalSubject_CopyObjTo } from "../../L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js";
...
export class clsJournalSubjectExWApi {
    public static mstrController: string = "JournalSubjectExApi";
    public objJournalSubjectEN: clsJournalSubjectEN = new clsJournalSubjectEN();
    ...
    public static CopyToEx(objJournalSubjectENS: clsJournalSubjectEN): clsJournalSubjectENEx {
