...
import { AcademicJournals_CopyObjTo } from "../../L3_ForWApi/GraduateEduPaper/clsAcademicJournalsWApi.js";
...
export class clsAcademicJournalsExWApi {
    public static mstrController: string = "AcademicJournalsExApi";
    public objAcademicJournalsEN: clsAcademicJournalsEN = new clsAcademicJournalsEN();
    ...
    public static CopyToEx(objAcademicJournalsENS: clsAcademicJournalsEN): clsAcademicJournalsENEx {
