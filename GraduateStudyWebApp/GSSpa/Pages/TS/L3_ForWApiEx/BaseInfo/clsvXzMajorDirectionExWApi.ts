...
import { clsvXzMajorDirectionENEx } from "../../L0_Entity/BaseInfo/clsvXzMajorDirectionENEx.js";
...
import { vXzMajorDirection_CopyObjTo } from "../../L3_ForWApi/BaseInfo/clsvXzMajorDirectionWApi.js";

var ResponseData: tzResponseData;
export class clsvXzMajorDirectionExWApi 
{
 public static mstrController: string = "vXzMajorDirectionExApi";
public objvXzMajorDirectionEN: clsvXzMajorDirectionEN = new clsvXzMajorDirectionEN();
...
return strServiceUrl;
 ...
 public static CopyToEx(objvXzMajorDirectionENS:clsvXzMajorDirectionEN ): clsvXzMajorDirectionENEx
{
 var objvXzMajorDirectionENT = new clsvXzMajorDirectionENEx();
try
{
vXzMajorDirection_CopyObjTo(objvXzMajorDirectionENS, objvXzMajorDirectionENT);
