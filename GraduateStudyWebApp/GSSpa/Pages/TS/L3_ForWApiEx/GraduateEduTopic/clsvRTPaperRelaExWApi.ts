...
import { clsvRTPaperRelaENEx } from "../../L0_Entity/GraduateEduTopic/clsvRTPaperRelaENEx.js";
import { vRTPaperRela_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { vRTPaperRela_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { clsvRTPaperRelaEN } from "../../L0_Entity/GraduateEduTopic/clsvRTPaperRelaEN.js";
import { Format } from "../../PubFun/clsString.js";
import { vRTPaperRela_FilterFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
...
**/
export function vRTPaperRelaEx_CopyToEx(objvRTPaperRelaENS: clsvRTPaperRelaEN): clsvRTPaperRelaENEx {
    ...
    try {
        ...
        const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vRTPaperRelaEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vRTPaperRelaEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsvRTPaperRelaENEx>> {
    ...
    try {
        ...
        const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vRTPaperRelaEx_ConstructorName, strThisFuncName);
        console.error(strMsg);
...
*/
export function vRTPaperRelaEx_FuncMapByFldName(strFldName: string, objvRTPaperRelaEx: clsvRTPaperRelaENEx) {
