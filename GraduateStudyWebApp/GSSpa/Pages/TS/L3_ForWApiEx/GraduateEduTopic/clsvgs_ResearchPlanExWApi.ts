...
import { vgs_ResearchPlan_FilterFunByKey, vgs_ResearchPlan_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
...
import { clsvgs_ResearchPlanENEx } from "../../L0_Entity/GraduateEduTopic/clsvgs_ResearchPlanENEx.js";
import { vgs_ResearchPlan_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { vgs_ResearchPlan_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
 ...
 **/
export function vgs_ResearchPlanEx_CopyToEx(objvgs_ResearchPlanENS:clsvgs_ResearchPlanEN ): clsvgs_ResearchPlanENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vgs_ResearchPlanEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vgs_ResearchPlanEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara , strid_CurrEduCls:string):Promise<Array<clsvgs_ResearchPlanENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvgs_ResearchPlanObjLst = await vgs_ResearchPlan_GetObjLst_Cache(strid_CurrEduCls);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vgs_ResearchPlanEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function vgs_ResearchPlanEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvgs_ResearchPlanENEx>> {
...
*/
export function vgs_ResearchPlanEx_FuncMapByFldName(strFldName: string, objvgs_ResearchPlanEx: clsvgs_ResearchPlanENEx)
{
