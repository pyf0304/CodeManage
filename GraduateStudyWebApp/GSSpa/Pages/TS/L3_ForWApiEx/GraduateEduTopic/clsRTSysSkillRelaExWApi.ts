...
import { clsRTSysSkillRelaENEx } from "../../L0_Entity/GraduateEduTopic/clsRTSysSkillRelaENEx.js";
import { RTSysSkillRela_FilterFunByKey, RTSysSkillRela_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsRTSysSkillRelaWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { RTSysSkillRela_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsRTSysSkillRelaWApi.js";
 ...
 **/
export function RTSysSkillRelaEx_CopyToEx(objRTSysSkillRelaENS:clsRTSysSkillRelaEN ): clsRTSysSkillRelaENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, rTSysSkillRelaEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function RTSysSkillRelaEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsRTSysSkillRelaENEx>> {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, rTSysSkillRelaEx_ConstructorName, strThisFuncName);
console.error(strMsg);
...
*/
export function RTSysSkillRelaEx_FuncMapByFldName(strFldName: string, objRTSysSkillRelaEx: clsRTSysSkillRelaENEx)
{
