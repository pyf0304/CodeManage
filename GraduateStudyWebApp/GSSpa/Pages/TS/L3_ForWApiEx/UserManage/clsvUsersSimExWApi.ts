...
import { clsvUsersSimENEx } from "../../L0_Entity/UserManage/clsvUsersSimENEx.js";
import { vUsersSim_CopyObjTo } from "../../L3_ForWApi/UserManage/clsvUsersSimWApi.js";
...
export class clsvUsersSimExWApi 
{
 public static mstrController: string = "vUsersSimExApi";
public objvUsersSimEN: clsvUsersSimEN = new clsvUsersSimEN();
...
return strServiceUrl;
 ...
 public static CopyToEx(objvUsersSimENS:clsvUsersSimEN ): clsvUsersSimENEx
{
 var objvUsersSimENT = new clsvUsersSimENEx();
try
{
vUsersSim_CopyObjTo(objvUsersSimENS, objvUsersSimENT);
