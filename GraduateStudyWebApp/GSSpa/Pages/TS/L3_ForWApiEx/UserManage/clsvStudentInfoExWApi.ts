...
import { clsvStudentInfoENEx } from "../../L0_Entity/UserManage/clsvStudentInfoENEx.js";
...
import { vStudentInfo_CopyObjTo } from "../../L3_ForWApi/UserManage/clsvStudentInfoWApi.js";
var ResponseData: tzResponseData;
export class clsvStudentInfoExWApi 
{
 public static mstrController: string = "vStudentInfoExApi";
public objvStudentInfoEN: clsvStudentInfoEN = new clsvStudentInfoEN();
...
return strServiceUrl;
 ...
 public static CopyToEx(objvStudentInfoENS:clsvStudentInfoEN ): clsvStudentInfoENEx
{
 var objvStudentInfoENT = new clsvStudentInfoENEx();
try
{
vStudentInfo_CopyObjTo(objvStudentInfoENS, objvStudentInfoENT);
