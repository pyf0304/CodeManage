...
import { Users_GetSubObjLst_Cache } from "../../L3_ForWApi/UserManage/clsUsersWApi.js";
...
export class clsUsersWApiEx {
    ...
    public async BindDdl_UserId_Cache2(strDdlName: string, objUsers_Cond: clsUsersEN) {
        ...
        try {
            ...
            clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsUsersEN.con_UserId, clsUsersEN.con_UserName, "用户");
    ...
    public static ReFreshThisCache(): void {
        ...
        if (clsSysPara4WebApi2.spSetRefreshCacheOn == true) {
            ...
            strMsg = `刷新缓存已经关闭。(clsSysPara4WebApi2.spSetRefreshCacheOn == false)(${clsStackTrace.GetCurrClassFunctionByLevel(3)}->${clsStackTrace.GetCurrClassFunctionByLevel(2)}->${clsStackTrace.GetCurrClassFunction()})`;
            console.log(strMsg);
        }
    }
