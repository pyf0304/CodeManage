...
import { clsvUsersENEx } from "../../L0_Entity/UserManage/clsvUsersENEx.js";
...
import { vUsers_CopyObjTo } from "../../L3_ForWApi/UserManage/clsvUsersWApi.js";
var ResponseData: tzResponseData;
export class clsvUsersExWApi 
{
 public static mstrController: string = "vUsersExApi";
public objvUsersEN: clsvUsersEN = new clsvUsersEN();
...
return strServiceUrl;
 ...
 public static CopyToEx(objvUsersENS:clsvUsersEN ): clsvUsersENEx
{
 var objvUsersENT = new clsvUsersENEx();
try
{
vUsers_CopyObjTo(objvUsersENS, objvUsersENT);
 return objvUsersENT;
}
catch (e)
{
