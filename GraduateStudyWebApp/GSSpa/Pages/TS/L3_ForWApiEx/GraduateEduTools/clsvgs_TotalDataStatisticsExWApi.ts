...
import { vgs_TotalDataStatistics_FilterFunByKey, vgs_TotalDataStatistics_GetObjLst_ClientCache, vgs_TotalDataStatistics_GetObjLst_localStorage, vgs_TotalDataStatistics_GetObjLst_sessionStorage } from "../../L3_ForWApi/GraduateEduTools/clsvgs_TotalDataStatisticsWApi.js";
...
import { vgs_TotalDataStatistics_GetObjLstAsync, vgs_TotalDataStatistics_GetObjLst_Cache, vgs_TotalDataStatistics_SortFunByKey } from "../../L3_ForWApi/GraduateEduTools/clsvgs_TotalDataStatisticsWApi.js";
...
export async function vgs_TotalDataStatisticsEx_GetUserNumSubObjLst_Cache(objvgs_TotalDataStatistics_Cond: clsvgs_TotalDataStatisticsEN, strid_CurrEduCls: string) {
    ...
    //console.log(dicFldComparisonOp);
    try {
        var sstrKeys = clsCommonFunc4Web.GetObjKeys(objvgs_TotalDataStatistics_Cond);
        //console.log(sstrKeys);
