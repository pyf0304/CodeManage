...
import { gs_TotalDataStatistics_FilterFunByKey, gs_TotalDataStatistics_GetObjLstAsync, gs_TotalDataStatistics_GetObjLst_Cache, gs_TotalDataStatistics_GetObjLst_ClientCache, gs_TotalDataStatistics_GetObjLst_localStorage, gs_TotalDataStatistics_GetObjLst_sessionStorage, gs_TotalDataStatistics_SortFunByKey } from "../../L3_ForWApi/GraduateEduTools/clsgs_TotalDataStatisticsWApi.js";
...
export async function gs_TotalDataStatisticsEx_GetSubObjLst_CacheEx(objgs_TotalDataStatistics_Cond: clsgs_TotalDataStatisticsEN, strid_CurrEduCls: string) {
    ...
    //console.log(dicFldComparisonOp);
    try {
        var sstrKeys = clsCommonFunc4Web.GetObjKeys(objgs_TotalDataStatistics_Cond);
        //console.log(sstrKeys);
...
export function gs_TotalDataStatisticsEx_GetTotalStatisticsByTableAsync(strId_CurrEduCls: string, updUser: string): Promise<boolean> {
...
export function gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTablekey: string, strTotalDataTypeId: string, PageTypeId: string, Id_CurrEduCls: string): Promise<boolean> {
...
export function gs_TotalDataStatisticsEx_GetObjLstEx(strWhereCond: string): Promise<Array<clsgs_TotalDataStatisticsEN>> {
...
export function gs_TotalDataStatisticsEx_GetObjLstByPagerAsyncEx(objPagerPara: stuPagerPara): Promise<Array<clsgs_TotalDataStatisticsEN>> {
