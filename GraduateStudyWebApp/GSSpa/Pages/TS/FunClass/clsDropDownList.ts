...
import { vCurrEduClsStu_GetObjLstAsync, vCurrEduClsStu_GetObjLst_Cache } from "../L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js";
import { vCurrEduClsTeacher_GetObjLstAsync } from "../L3_ForWApi/DailyRunning/clsvCurrEduClsTeacherWApi.js";
...
import { vPaperEx_GetObjLstById_CurrEduCls, vPaperEx_GetObjLstById_CurrEduCls_Cache } from "../L3_ForWApiEx/GraduateEdu/clsvPaperExWApi.js";
...
export class clsDropDownList {
    ...
    /// </summary>
    /// <param name = "objDDL">需要绑定当前表的下拉框</param>
    public static async BindDdl_XzMajorInvPaper_Cache(strDdlName: string, objXzMajor_Cond: clsXzMajorEN) {
        var strid_Curreducls = clsPublocalStorage.Getid_CurrEduCls();
        var objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            var strMsg = `下拉框：${strDdlName} 不存在！`;
        ...
        var arrvPaper: Array<clsvPaperEN> = await vPaperEx_GetObjLstById_CurrEduCls(strid_Curreducls);
        //得到论文用户
        ...
        clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrUsersList_Sel, clsvUsersSimEN.con_id_XzMajor, clsvUsersSimEN.con_MajorName, "专业");
    ...
    public static async BindDdl_UsersInvPaperReadWrite_Cache(strDdlName: string, objUsers_Cond: clsvUsersSimEN) {
        ...
        console.log(arrUsersList_Sel);
        arrUsersList_Sel = arrUsersList_Sel.sort(x => x[clsvUsersSimEN.con_UserName]);
        clsCommonFunc4Web.BindDdl_ObjLst(strDdlName, arrUsersList_Sel, clsvUsersSimEN.con_UserId, clsvUsersSimEN.con_UserName, "用户");
    ...
    public static async BindDdl_UsersInvPaper_Cache(strDdlName: string, objUsers_Cond: clsvUsersSimEN) {
        ...
        //为数据源于表的下拉框设置内容
        console.log("开始：BindDdl_UserId_Cache");
        var arrUser: Array<clsvPaperEN> = await vPaperEx_GetObjLstById_CurrEduCls_Cache(strid_Curreducls);
    ...
    public static async BindDdl_UserIdInvExpertviewpoint_Cache(strDdlName: string, objUsers_Cond: clsvUsersSimEN) {
        ...
        var arrvViewpointList: Array<clsvViewpointEN> = await vViewpoint_GetObjLst_Cache(clsPublocalStorage.Getid_CurrEduCls());
    ...
    public static async BindDdl_UserIdInvConcept_Cache(strDdlName: string, objUsers_Cond: clsvUsersSimEN) {
        ...
        //为数据源于表的下拉框设置内容
        console.log("开始：BindDdl_UserIdInvConcept_Cache");
        var arrvConcept: Array<clsvConceptEN> = await vConcept_GetObjLst_Cache(clsPublocalStorage.Getid_CurrEduCls());
    ...
    public static async BindDdl_TopicId(ddlTopicId_q: string) {
        ...
        try {
            ...
            clsCommonFunc4Web.BindDdl_ObjLst(ddlTopicId_q, arrObjLst_Sel, clsResearchTopicEN.con_TopicId, clsResearchTopicEN.con_TopicName, "教学班主题");
    ...
    public static async BindDdl_TotalTypeId(ddlTotalType_q: string) {
        ...
        try {
            ...
            clsCommonFunc4Web.BindDdl_ObjLst(ddlTotalType_q, arrObjLst_Sel, clsgs_TotalDataTypeEN.con_TotalDataTypeId, clsgs_TotalDataTypeEN.con_TotalDataTypeName, "问题回答");
            console.log("完成BindDdl_ResearchTopicId!");
        }
        catch (e) {
            var strMsg: string = `根据条件获取相应的记录对象的列表不成功,${e}.`;
    ...
    public static async BindDdl_CurrEduClsStu(ddlCurrEduCls_q: string) {
        ...
        try {
            ...
            clsCommonFunc4Web.BindDdl_ObjLst(ddlCurrEduCls_q, arrObjLst_Sel, clsvCurrEduClsStuEN.con_id_CurrEduCls, clsvCurrEduClsStuEN.con_EduClsName, "其他教学班");
            console.log("完成BindDdl_vCurrEduClsStuId!");
        }
        catch (e) {
            var strMsg: string = `根据条件获取相应的记录对象的列表不成功,${e}.`;
    ...
    public static async BindDdl_CurrEduClsTea(ddlCurrEduCls_q: string) {
        ...
        try {
            ...
            clsCommonFunc4Web.BindDdl_ObjLst(ddlCurrEduCls_q, arrObjLst_Sel, clsvCurrEduClsTeacherEN.con_id_CurrEduCls, clsvCurrEduClsTeacherEN.con_EduClsName, "其他教学班");
