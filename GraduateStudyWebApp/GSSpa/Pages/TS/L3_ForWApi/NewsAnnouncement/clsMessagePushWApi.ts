 ...
 * @returns 对象
 **/
export async function MessagePush_GetObjByMessagePushIdAsync(strMessagePushId: string): Promise<clsMessagePushEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function MessagePush_GetFirstObjAsync(strWhereCond: string): Promise<clsMessagePushEN>  
{
