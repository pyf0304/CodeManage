 ...
 * @returns 对象
 **/
export async function vMessagePushUsersRelation_GetObjByMessagePushUsersRelationIdAsync(lngMessagePushUsersRelationId: number): Promise<clsvMessagePushUsersRelationEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vMessagePushUsersRelation_GetFirstObjAsync(strWhereCond: string): Promise<clsvMessagePushUsersRelationEN>  
{
