 ...
 * @returns 对象
 **/
export async function FeedBack_GetObjByFeedBackIdAsync(lngFeedBackId: number): Promise<clsFeedBackEN>  
{
const strThisFuncName = "GetObjByFeedBackIdAsync";

if (lngFeedBackId == 0)
{
  const strMsg = Format("参数:[lngFeedBackId]不能为空！(In GetObjByFeedBackIdAsync)");
 ...
 * @returns 第一条记录对象
 **/
export async function FeedBack_GetFirstObjAsync(strWhereCond: string): Promise<clsFeedBackEN>  
{
