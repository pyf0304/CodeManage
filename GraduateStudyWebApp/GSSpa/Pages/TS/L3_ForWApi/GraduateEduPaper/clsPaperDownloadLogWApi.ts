 ...
 * @returns 对象
 **/
export async function PaperDownloadLog_GetObjByPaperDownloadIdAsync(lngPaperDownloadId: number): Promise<clsPaperDownloadLogEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function PaperDownloadLog_GetFirstObjAsync(strWhereCond: string): Promise<clsPaperDownloadLogEN>  
{
