 ...
 * @returns 对象
 **/
export async function vPaperCount_GetObjByPaperIdAsync(strPaperId: string): Promise<clsvPaperCountEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vPaperCount_GetFirstObjAsync(strWhereCond: string): Promise<clsvPaperCountEN>  
{
...
objvPaperCountENT.collectionCount = objvPaperCountENS.collectionCount; //收藏数
