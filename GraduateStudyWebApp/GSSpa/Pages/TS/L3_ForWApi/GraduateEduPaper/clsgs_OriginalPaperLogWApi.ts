 ...
 * @returns 对象
 **/
export async function gs_OriginalPaperLog_GetObjByPaperLogIdAsync(lngPaperLogId: number): Promise<clsgs_OriginalPaperLogEN>  
{
const strThisFuncName = "GetObjByPaperLogIdAsync";

if (lngPaperLogId == 0)
{
  const strMsg = Format("参数:[lngPaperLogId]不能为空！(In GetObjByPaperLogIdAsync)");
 ...
 * @returns 第一条记录对象
 **/
export async function gs_OriginalPaperLog_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_OriginalPaperLogEN>  
{
