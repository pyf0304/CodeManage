 ...
 * @returns 对象
 **/
export async function PaperSubViewpoint_GetObjBySubViewpointIdAsync(strSubViewpointId: string): Promise<clsPaperSubViewpointEN>  
{
const strThisFuncName = "GetObjBySubViewpointIdAsync";

if (IsNullOrEmpty(strSubViewpointId) == true)
{
  const strMsg = Format("参数:[strSubViewpointId]不能为空！(In GetObjBySubViewpointIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointId.length != 8)
{
const strMsg = Format("缓存分类变量:[strSubViewpointId]的长度:[{0}]不正确！", strSubViewpointId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strSubViewpointId) == true)
{
  const strMsg = Format("参数:[strSubViewpointId]不能为空！(In GetObjBySubViewpointId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointId.length != 8)
...
if (IsNullOrEmpty(strSubViewpointId) == true)
{
  const strMsg = Format("参数:[strSubViewpointId]不能为空！(In GetObjBySubViewpointId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointId.length != 8)
 ...
 * @returns 返回一个输出字段值
*/
export async function PaperSubViewpoint_func(strInFldName:string , strOutFldName:string , strInValue:string , strid_CurrEduCls_C: string)
{
...
strInFldName, clsPaperSubViewpointEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function PaperSubViewpoint_GetFirstObjAsync(strWhereCond: string): Promise<clsPaperSubViewpointEN>  
{
...
clsPaperSubViewpointEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsPaperSubViewpointEN._CurrTabName);
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsPaperSubViewpointWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
...
if (IsNullOrEmpty(pobjPaperSubViewpointEN.userId) == false && GetStrLen(pobjPaperSubViewpointEN.userId) > 20)
{
