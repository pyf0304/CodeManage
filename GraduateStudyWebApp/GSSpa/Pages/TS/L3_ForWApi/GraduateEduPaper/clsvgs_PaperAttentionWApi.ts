 ...
 * @returns 对象
 **/
export async function vgs_PaperAttention_GetObjByPaperAttentionIdAsync(lngPaperAttentionId: number): Promise<clsvgs_PaperAttentionEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vgs_PaperAttention_func(strInFldName:string , strOutFldName:string , strInValue:number , strUserId_C: string)
{
...
strInFldName, clsvgs_PaperAttentionEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vgs_PaperAttention_GetFirstObjAsync(strWhereCond: string): Promise<clsvgs_PaperAttentionEN>  
{
...
clsvgs_PaperAttentionEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvgs_PaperAttentionEN._CurrTabName);
