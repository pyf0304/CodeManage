 ...
 * @returns 对象
 **/
export async function JournalSubjectCategory_GetObjByJournalSubjectCategoryIdAsync(strJournalSubjectCategoryId: string): Promise<clsJournalSubjectCategoryEN>  
{
const strThisFuncName = "GetObjByJournalSubjectCategoryIdAsync";

if (IsNullOrEmpty(strJournalSubjectCategoryId) == true)
{
  const strMsg = Format("参数:[strJournalSubjectCategoryId]不能为空！(In GetObjByJournalSubjectCategoryIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalSubjectCategoryId.length != 4)
{
const strMsg = Format("缓存分类变量:[strJournalSubjectCategoryId]的长度:[{0}]不正确！", strJournalSubjectCategoryId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strJournalSubjectCategoryId) == true)
{
  const strMsg = Format("参数:[strJournalSubjectCategoryId]不能为空！(In GetObjByJournalSubjectCategoryId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalSubjectCategoryId.length != 4)
...
if (IsNullOrEmpty(strJournalSubjectCategoryId) == true)
{
  const strMsg = Format("参数:[strJournalSubjectCategoryId]不能为空！(In GetObjByJournalSubjectCategoryId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalSubjectCategoryId.length != 4)
...
if (IsNullOrEmpty(strJournalSubjectCategoryId) == true)
{
  const strMsg = Format("参数:[strJournalSubjectCategoryId]不能为空！(In GetNameByJournalSubjectCategoryId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalSubjectCategoryId.length != 4)
...
strInFldName, clsJournalSubjectCategoryEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function JournalSubjectCategory_GetFirstObjAsync(strWhereCond: string): Promise<clsJournalSubjectCategoryEN>  
{
...
clsJournalSubjectCategoryEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsJournalSubjectCategoryEN._CurrTabName);
