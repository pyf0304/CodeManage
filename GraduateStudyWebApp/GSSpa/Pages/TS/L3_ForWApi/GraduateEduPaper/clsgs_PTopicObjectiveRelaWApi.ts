 ...
 * @returns 对象
 **/
export async function gs_PTopicObjectiveRela_GetObjBymIdAsync(lngmId: number): Promise<clsgs_PTopicObjectiveRelaEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PTopicObjectiveRela_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PTopicObjectiveRelaEN>  
{
