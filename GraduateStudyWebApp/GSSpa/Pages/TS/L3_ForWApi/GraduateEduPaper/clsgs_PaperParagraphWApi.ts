 ...
 * @returns 对象
 **/
export async function gs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId: string): Promise<clsgs_PaperParagraphEN>  
{
...
strInFldName, clsgs_PaperParagraphEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperParagraph_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperParagraphEN>  
{
...
clsgs_PaperParagraphEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_PaperParagraphEN._CurrTabName);
