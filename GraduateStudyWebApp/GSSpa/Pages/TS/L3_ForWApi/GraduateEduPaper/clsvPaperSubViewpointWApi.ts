 ...
 * @returns 对象
 **/
export async function vPaperSubViewpoint_GetObjBySubViewpointIdAsync(strSubViewpointId: string): Promise<clsvPaperSubViewpointEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vPaperSubViewpoint_func(strInFldName:string , strOutFldName:string , strInValue:string , strid_CurrEduCls_C: string)
{
...
strInFldName, clsvPaperSubViewpointEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vPaperSubViewpoint_GetFirstObjAsync(strWhereCond: string): Promise<clsvPaperSubViewpointEN>  
{
...
clsvPaperSubViewpointEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvPaperSubViewpointEN._CurrTabName);
