 ...
 * @returns 对象
 **/
export async function gs_PViewpointRela_GetObjBymIdAsync(lngmId: number): Promise<clsgs_PViewpointRelaEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PViewpointRela_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PViewpointRelaEN>  
{
