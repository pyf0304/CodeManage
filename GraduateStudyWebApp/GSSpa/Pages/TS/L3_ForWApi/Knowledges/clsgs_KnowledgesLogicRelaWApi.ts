 ...
 * @returns 对象
 **/
export async function gs_KnowledgesLogicRela_GetObjBymIdAsync(lngmId: number): Promise<clsgs_KnowledgesLogicRelaEN>  
{
 ...
 * @returns 对象
*/
export async function gs_KnowledgesLogicRela_GetObjBymId_Cache(lngmId:number,strKnowledgeGraphId:string, bolTryAsyncOnce: boolean = true) {
 ...
 * @returns 对象
*/
export async function gs_KnowledgesLogicRela_UpdateObjInLst_Cache(objgs_KnowledgesLogicRela: clsgs_KnowledgesLogicRelaEN,strKnowledgeGraphId: string) {
 ...
 * @returns 返回一个输出字段值
*/
export async function gs_KnowledgesLogicRela_func(strInFldName:string , strOutFldName:string , strInValue:number , strKnowledgeGraphId_C: string)
{
...
strInFldName, clsgs_KnowledgesLogicRelaEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_KnowledgesLogicRela_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_KnowledgesLogicRelaEN>  
{
 ...
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_ClientCache(strKnowledgeGraphId: string)
{
const strThisFuncName = "GetObjLst_ClientCache";
//初始化列表缓存
let strWhereCond = "1=1";
strWhereCond = Format("KnowledgeGraphId='{0}'", strKnowledgeGraphId);
const strKey = Format("{0}_{1}", clsgs_KnowledgesLogicRelaEN._CurrTabName, strKnowledgeGraphId);
clsgs_KnowledgesLogicRelaEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_KnowledgesLogicRelaEN._CurrTabName);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_localStorage(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_localStorage_PureCache(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_sessionStorage(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_sessionStorage_PureCache(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_Cache(strKnowledgeGraphId: string): Promise<Array<clsgs_KnowledgesLogicRelaEN>>
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogicRela_GetObjLst_PureCache(strKnowledgeGraphId: string)
{
 ...
 * @returns 对象列表子集
*/
export async function gs_KnowledgesLogicRela_GetSubObjLst_Cache(objgs_KnowledgesLogicRela_Cond: clsgs_KnowledgesLogicRelaEN,strKnowledgeGraphId: string) {
 ...
 * @returns 对象列表
*/
export async function gs_KnowledgesLogicRela_GetObjLstBymIdLst_Cache(arrmIdLst: Array<number>,strKnowledgeGraphId: string) {
 ...
 * @returns 对象列表
*/
export async function gs_KnowledgesLogicRela_GetObjLstByPager_Cache(objPagerPara: stuPagerPara,strKnowledgeGraphId: string) {
 ...
 * @returns 对象列表子集
*/
export async function gs_KnowledgesLogicRela_IsExistRecord_Cache(objgs_KnowledgesLogicRela_Cond: clsgs_KnowledgesLogicRelaEN,strKnowledgeGraphId: string) {
 ...
 * @returns 对象
*/
export async function gs_KnowledgesLogicRela_IsExist_Cache(lngmId:number,strKnowledgeGraphId:string) {
 ...
 * @returns 对象列表记录数
*/
export async function gs_KnowledgesLogicRela_GetRecCountByCond_Cache(objgs_KnowledgesLogicRela_Cond: clsgs_KnowledgesLogicRelaEN,strKnowledgeGraphId: string) {
 ...
 **/
export function gs_KnowledgesLogicRela_ReFreshCache(strKnowledgeGraphId: string):void
{
const strThisFuncName = "ReFreshCache";

if (IsNullOrEmpty(strKnowledgeGraphId) == true)
{
  const strMsg = Format("参数:[strKnowledgeGraphId]不能为空！(In clsgs_KnowledgesLogicRelaWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strKnowledgeGraphId.length != 10)
 ...
 **/
export function gs_KnowledgesLogicRela_ReFreshThisCache(strKnowledgeGraphId: string):void
{
