 ...
 * @returns 对象
 **/
export async function gs_KnowledgesLogic_User_GetObjBymIdAsync(lngmId: number): Promise<clsgs_KnowledgesLogic_UserEN>  
{
...
strInFldName, clsgs_KnowledgesLogic_UserEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_KnowledgesLogic_User_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_KnowledgesLogic_UserEN>  
{
...
clsgs_KnowledgesLogic_UserEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_KnowledgesLogic_UserEN._CurrTabName);
 ...
 * @returns 条件串(strWhereCond)
 **/
export function gs_KnowledgesLogic_User_GetUniCondStr_mId(objgs_KnowledgesLogic_UserEN: clsgs_KnowledgesLogic_UserEN ):string
{
let strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
export function gs_KnowledgesLogic_User_GetUniCondStr4Update_mId(objgs_KnowledgesLogic_UserEN: clsgs_KnowledgesLogic_UserEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and mId <> '{0}'", objgs_KnowledgesLogic_UserEN.mId);
 strWhereCond +=  Format(" and mId = '{0}'", objgs_KnowledgesLogic_UserEN.mId);
