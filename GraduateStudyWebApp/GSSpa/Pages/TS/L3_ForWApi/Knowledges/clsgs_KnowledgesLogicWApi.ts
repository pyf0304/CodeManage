 ...
 * @returns 对象
 **/
export async function gs_KnowledgesLogic_GetObjBymIdAsync(lngmId: number): Promise<clsgs_KnowledgesLogicEN>  
{
 ...
 * @returns 对象
*/
export async function gs_KnowledgesLogic_GetObjBymId_Cache(lngmId:number,strKnowledgeGraphId:string, bolTryAsyncOnce: boolean = true) {
...
try
{
const arrgs_KnowledgesLogic_Sel: Array <clsgs_KnowledgesLogicEN> = arrgs_KnowledgesLogicObjLst_Cache.filter(x => x.mId == lngmId);
 ...
 * @returns 对象
*/
export async function gs_KnowledgesLogic_UpdateObjInLst_Cache(objgs_KnowledgesLogic: clsgs_KnowledgesLogicEN,strKnowledgeGraphId: string) {
 ...
 * @returns 返回一个输出字段值
*/
export async function gs_KnowledgesLogic_func(strInFldName:string , strOutFldName:string , strInValue:number , strKnowledgeGraphId_C: string)
{
//const strThisFuncName = "func";

if (IsNullOrEmpty(strKnowledgeGraphId_C) == true)
{
  const strMsg = Format("参数:[strKnowledgeGraphId_C]不能为空！(In func)");
console.error(strMsg);
 throw (strMsg);
}
if (strKnowledgeGraphId_C.length != 10)
{
const strMsg = Format("缓存分类变量:[strKnowledgeGraphId_C]的长度:[{0}]不正确！", strKnowledgeGraphId_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strInFldName, clsgs_KnowledgesLogicEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_KnowledgesLogic_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_KnowledgesLogicEN>  
{
 ...
 **/
export async function gs_KnowledgesLogic_GetObjLst_ClientCache(strKnowledgeGraphId: string)
{
const strThisFuncName = "GetObjLst_ClientCache";
//初始化列表缓存
let strWhereCond = "1=1";
strWhereCond = Format("KnowledgeGraphId='{0}'", strKnowledgeGraphId);
const strKey = Format("{0}_{1}", clsgs_KnowledgesLogicEN._CurrTabName, strKnowledgeGraphId);
clsgs_KnowledgesLogicEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_KnowledgesLogicEN._CurrTabName);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogic_GetObjLst_localStorage(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogic_GetObjLst_localStorage_PureCache(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogic_GetObjLst_sessionStorage(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogic_GetObjLst_sessionStorage_PureCache(strKnowledgeGraphId: string)
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogic_GetObjLst_Cache(strKnowledgeGraphId: string): Promise<Array<clsgs_KnowledgesLogicEN>>
{
//const strThisFuncName = "GetObjLst_Cache";

if (IsNullOrEmpty(strKnowledgeGraphId) == true)
{
const strMsg = Format("缓存分类变量:[KnowledgeGraphId]不能为空！");
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function gs_KnowledgesLogic_GetObjLst_PureCache(strKnowledgeGraphId: string)
{
 ...
 * @returns 对象列表子集
*/
export async function gs_KnowledgesLogic_GetSubObjLst_Cache(objgs_KnowledgesLogic_Cond: clsgs_KnowledgesLogicEN,strKnowledgeGraphId: string) {
const strThisFuncName = "GetSubObjLst_Cache";
const arrgs_KnowledgesLogicObjLst_Cache = await gs_KnowledgesLogic_GetObjLst_Cache(strKnowledgeGraphId);
let arrgs_KnowledgesLogic_Sel: Array < clsgs_KnowledgesLogicEN > = arrgs_KnowledgesLogicObjLst_Cache;
 ...
 * @returns 对象列表
*/
export async function gs_KnowledgesLogic_GetObjLstBymIdLst_Cache(arrmIdLst: Array<number>,strKnowledgeGraphId: string) {
const strThisFuncName = "GetObjLstBymIdLst_Cache";
try
{
const arrgs_KnowledgesLogicObjLst_Cache = await gs_KnowledgesLogic_GetObjLst_Cache(strKnowledgeGraphId);
const arrgs_KnowledgesLogic_Sel: Array <clsgs_KnowledgesLogicEN> = arrgs_KnowledgesLogicObjLst_Cache.filter(x => arrmIdLst.indexOf(x.mId)>-1);
return arrgs_KnowledgesLogic_Sel;
}
catch (e)
{
 ...
 * @returns 对象列表
*/
export async function gs_KnowledgesLogic_GetObjLstByPager_Cache(objPagerPara: stuPagerPara,strKnowledgeGraphId: string) {
 ...
 * @returns 对象列表子集
*/
export async function gs_KnowledgesLogic_IsExistRecord_Cache(objgs_KnowledgesLogic_Cond: clsgs_KnowledgesLogicEN,strKnowledgeGraphId: string) {
 ...
 * @returns 对象
*/
export async function gs_KnowledgesLogic_IsExist_Cache(lngmId:number,strKnowledgeGraphId:string) {
 ...
 * @returns 对象列表记录数
*/
export async function gs_KnowledgesLogic_GetRecCountByCond_Cache(objgs_KnowledgesLogic_Cond: clsgs_KnowledgesLogicEN,strKnowledgeGraphId: string) {
 ...
 **/
export function gs_KnowledgesLogic_ReFreshCache(strKnowledgeGraphId: string):void
{
const strThisFuncName = "ReFreshCache";

if (IsNullOrEmpty(strKnowledgeGraphId) == true)
{
  const strMsg = Format("参数:[strKnowledgeGraphId]不能为空！(In clsgs_KnowledgesLogicWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strKnowledgeGraphId.length != 10)
 ...
 **/
export function gs_KnowledgesLogic_ReFreshThisCache(strKnowledgeGraphId: string):void
{
 ...
 * @returns 条件串(strWhereCond)
 **/
export function gs_KnowledgesLogic_GetUniCondStr_mId(objgs_KnowledgesLogicEN: clsgs_KnowledgesLogicEN ):string
{
let strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
export function gs_KnowledgesLogic_GetUniCondStr4Update_mId(objgs_KnowledgesLogicEN: clsgs_KnowledgesLogicEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and mId <> '{0}'", objgs_KnowledgesLogicEN.mId);
 strWhereCond +=  Format(" and mId = '{0}'", objgs_KnowledgesLogicEN.mId);
