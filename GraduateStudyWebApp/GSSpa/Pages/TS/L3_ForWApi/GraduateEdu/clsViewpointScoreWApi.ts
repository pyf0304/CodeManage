 ...
 * @returns 对象
 **/
export async function ViewpointScore_GetObjByViewpointScoreIdAsync(lngViewpointScoreId: number): Promise<clsViewpointScoreEN>  
{
const strThisFuncName = "GetObjByViewpointScoreIdAsync";

if (lngViewpointScoreId == 0)
{
  const strMsg = Format("参数:[lngViewpointScoreId]不能为空！(In GetObjByViewpointScoreIdAsync)");
...
if (lngViewpointScoreId == 0)
{
  const strMsg = Format("参数:[lngViewpointScoreId]不能为空！(In GetObjByViewpointScoreId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
if (lngViewpointScoreId == 0)
{
  const strMsg = Format("参数:[lngViewpointScoreId]不能为空！(In GetObjByViewpointScoreId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
strInFldName, clsViewpointScoreEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function ViewpointScore_GetFirstObjAsync(strWhereCond: string): Promise<clsViewpointScoreEN>  
{
...
clsViewpointScoreEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsViewpointScoreEN._CurrTabName);
