 ...
 * @returns 对象
 **/
export async function qa_Questions_GetObjByQuestionsIdAsync(strQuestionsId: string): Promise<clsqa_QuestionsEN>  
{
...
strInFldName, clsqa_QuestionsEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function qa_Questions_GetFirstObjAsync(strWhereCond: string): Promise<clsqa_QuestionsEN>  
{
...
clsqa_QuestionsEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsqa_QuestionsEN._CurrTabName);
...
if (IsNullOrEmpty(pobjqa_QuestionsEN.userId) == false && GetStrLen(pobjqa_QuestionsEN.userId) > 20)
{
