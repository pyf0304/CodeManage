 ...
 * @returns 对象
 **/
export async function vqa_Answer_GetObjByAnswerIdAsync(strAnswerId: string): Promise<clsvqa_AnswerEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vqa_Answer_func(strInFldName:string , strOutFldName:string , strInValue:string , strTopicId_C: string)
{
...
strInFldName, clsvqa_AnswerEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vqa_Answer_GetFirstObjAsync(strWhereCond: string): Promise<clsvqa_AnswerEN>  
{
...
clsvqa_AnswerEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvqa_AnswerEN._CurrTabName);
