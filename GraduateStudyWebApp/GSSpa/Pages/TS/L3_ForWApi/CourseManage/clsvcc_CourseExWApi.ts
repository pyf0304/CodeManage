 ...
 * @returns 对象
 **/
export async function vcc_CourseEx_GetObjByCourseIdAsync(strCourseId: string): Promise<clsvcc_CourseExEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vcc_CourseEx_GetFirstObjAsync(strWhereCond: string): Promise<clsvcc_CourseExEN>  
{
