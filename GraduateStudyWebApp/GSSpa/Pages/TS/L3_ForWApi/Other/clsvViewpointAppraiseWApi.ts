 ...
 * @returns 对象
 **/
export async function vViewpointAppraise_GetObjByViewpointAppraiseIdAsync(lngViewpointAppraiseId: number): Promise<clsvViewpointAppraiseEN>  
{
...
strInFldName, clsvViewpointAppraiseEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vViewpointAppraise_GetFirstObjAsync(strWhereCond: string): Promise<clsvViewpointAppraiseEN>  
{
...
clsvViewpointAppraiseEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvViewpointAppraiseEN._CurrTabName);
