 ...
 * @returns 对象
 **/
export async function PaperAppraise_GetObjByPaperAppraiseIdAsync(lngPaperAppraiseId: number): Promise<clsPaperAppraiseEN>  
{
const strThisFuncName = "GetObjByPaperAppraiseIdAsync";

if (lngPaperAppraiseId == 0)
{
  const strMsg = Format("参数:[lngPaperAppraiseId]不能为空！(In GetObjByPaperAppraiseIdAsync)");
...
if (lngPaperAppraiseId == 0)
{
  const strMsg = Format("参数:[lngPaperAppraiseId]不能为空！(In GetObjByPaperAppraiseId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
if (lngPaperAppraiseId == 0)
{
  const strMsg = Format("参数:[lngPaperAppraiseId]不能为空！(In GetObjByPaperAppraiseId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
strInFldName, clsPaperAppraiseEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function PaperAppraise_GetFirstObjAsync(strWhereCond: string): Promise<clsPaperAppraiseEN>  
{
...
clsPaperAppraiseEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsPaperAppraiseEN._CurrTabName);
