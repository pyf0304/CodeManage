 ...
 * @returns 对象
 **/
export async function gs_ResearchResultAttachment_GetObjBymIdAsync(lngmId: number): Promise<clsgs_ResearchResultAttachmentEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function gs_ResearchResultAttachment_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_ResearchResultAttachmentEN>  
{
