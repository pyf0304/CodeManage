 ...
 * @returns 对象
 **/
export async function gs_ViewsClassification_GetObjByClassificationIdAsync(strClassificationId: string): Promise<clsgs_ViewsClassificationEN>  
{
const strThisFuncName = "GetObjByClassificationIdAsync";

if (IsNullOrEmpty(strClassificationId) == true)
{
  const strMsg = Format("参数:[strClassificationId]不能为空！(In GetObjByClassificationIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strClassificationId.length != 10)
{
const strMsg = Format("缓存分类变量:[strClassificationId]的长度:[{0}]不正确！", strClassificationId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strClassificationId) == true)
{
  const strMsg = Format("参数:[strClassificationId]不能为空！(In GetObjByClassificationId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strClassificationId.length != 10)
...
if (IsNullOrEmpty(strClassificationId) == true)
{
  const strMsg = Format("参数:[strClassificationId]不能为空！(In GetObjByClassificationId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strClassificationId.length != 10)
...
strInFldName, clsgs_ViewsClassificationEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_ViewsClassification_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_ViewsClassificationEN>  
{
...
clsgs_ViewsClassificationEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_ViewsClassificationEN._CurrTabName);
 ...
 * @returns 条件串(strWhereCond)
 **/
export function gs_ViewsClassification_GetUniCondStr_ClassificationId(objgs_ViewsClassificationEN: clsgs_ViewsClassificationEN ):string
{
let strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
export function gs_ViewsClassification_GetUniCondStr4Update_ClassificationId(objgs_ViewsClassificationEN: clsgs_ViewsClassificationEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and ClassificationId <> '{0}'", objgs_ViewsClassificationEN.classificationId);
 strWhereCond +=  Format(" and ClassificationId = '{0}'", objgs_ViewsClassificationEN.classificationId);
