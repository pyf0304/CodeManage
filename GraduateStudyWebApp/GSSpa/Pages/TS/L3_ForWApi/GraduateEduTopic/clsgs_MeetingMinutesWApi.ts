 ...
 * @returns 对象
 **/
export async function gs_MeetingMinutes_GetObjByMeetingIdAsync(strMeetingId: string): Promise<clsgs_MeetingMinutesEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function gs_MeetingMinutes_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_MeetingMinutesEN>  
{
