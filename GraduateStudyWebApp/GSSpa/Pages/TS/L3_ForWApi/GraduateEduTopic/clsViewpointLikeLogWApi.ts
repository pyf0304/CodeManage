 ...
 * @returns 对象
 **/
export async function ViewpointLikeLog_GetObjByViewpointLikeLogIdAsync(lngViewpointLikeLogId: number): Promise<clsViewpointLikeLogEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function ViewpointLikeLog_GetFirstObjAsync(strWhereCond: string): Promise<clsViewpointLikeLogEN>  
{
