 ...
 * @returns 对象
 **/
export async function gs_ResearchResult_GetObjByResultIdAsync(strResultId: string): Promise<clsgs_ResearchResultEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function gs_ResearchResult_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_ResearchResultEN>  
{
