 ...
 * @returns 对象
 **/
export async function vRTSysSkill_GetObjBymIdAsync(lngmId: number): Promise<clsvRTSysSkillEN>  
{
...
strInFldName, clsvRTSysSkillEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vRTSysSkill_GetFirstObjAsync(strWhereCond: string): Promise<clsvRTSysSkillEN>  
{
...
clsvRTSysSkillEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvRTSysSkillEN._CurrTabName);
