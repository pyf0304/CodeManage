 ...
 * @returns 对象
 **/
export async function vObjectiveAttachment_GetObjByObjectiveAttachmentIdAsync(lngObjectiveAttachmentId: number): Promise<clsvObjectiveAttachmentEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vObjectiveAttachment_func(strInFldName:string , strOutFldName:string , strInValue:number , strid_CurrEduCls_C: string)
{
...
strInFldName, clsvObjectiveAttachmentEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vObjectiveAttachment_GetFirstObjAsync(strWhereCond: string): Promise<clsvObjectiveAttachmentEN>  
{
...
clsvObjectiveAttachmentEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvObjectiveAttachmentEN._CurrTabName);
