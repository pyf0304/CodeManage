 ...
 * @returns 对象
 **/
export async function RTTopicObjectiveRela_GetObjBymIdAsync(lngmId: number): Promise<clsRTTopicObjectiveRelaEN>  
{
...
strInFldName, clsRTTopicObjectiveRelaEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function RTTopicObjectiveRela_GetFirstObjAsync(strWhereCond: string): Promise<clsRTTopicObjectiveRelaEN>  
{
...
clsRTTopicObjectiveRelaEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsRTTopicObjectiveRelaEN._CurrTabName);
