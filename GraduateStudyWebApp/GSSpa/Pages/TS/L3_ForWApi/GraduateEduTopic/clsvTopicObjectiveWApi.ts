 ...
 * @returns 对象
 **/
export async function vTopicObjective_GetObjByTopicObjectiveIdAsync(strTopicObjectiveId: string): Promise<clsvTopicObjectiveEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vTopicObjective_func(strInFldName:string , strOutFldName:string , strInValue:string , strid_CurrEduCls_C: string)
{
...
strInFldName, clsvTopicObjectiveEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vTopicObjective_GetFirstObjAsync(strWhereCond: string): Promise<clsvTopicObjectiveEN>  
{
...
clsvTopicObjectiveEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvTopicObjectiveEN._CurrTabName);
