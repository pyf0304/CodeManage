 ...
 * @returns 对象
 **/
export async function ConceptCitation_GetObjBymIdAsync(lngmId: number): Promise<clsConceptCitationEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function ConceptCitation_GetFirstObjAsync(strWhereCond: string): Promise<clsConceptCitationEN>  
{
