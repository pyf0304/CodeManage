 ...
 * @returns 对象
 **/
export async function RTResearchResult_GetObjBymIdAsync(lngmId: number): Promise<clsRTResearchResultEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function RTResearchResult_GetFirstObjAsync(strWhereCond: string): Promise<clsRTResearchResultEN>  
{
