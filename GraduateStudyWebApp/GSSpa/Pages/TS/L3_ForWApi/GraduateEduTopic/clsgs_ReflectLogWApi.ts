 ...
 * @returns 对象
 **/
export async function gs_ReflectLog_GetObjBymIdAsync(lngmId: number): Promise<clsgs_ReflectLogEN>  
{
...
strInFldName, clsgs_ReflectLogEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_ReflectLog_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_ReflectLogEN>  
{
...
clsgs_ReflectLogEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_ReflectLogEN._CurrTabName);
