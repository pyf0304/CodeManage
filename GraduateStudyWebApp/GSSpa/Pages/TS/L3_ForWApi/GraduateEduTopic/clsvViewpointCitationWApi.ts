 ...
 * @returns 对象
 **/
export async function vViewpointCitation_GetObjBymIdAsync(lngmId: number): Promise<clsvViewpointCitationEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vViewpointCitation_GetFirstObjAsync(strWhereCond: string): Promise<clsvViewpointCitationEN>  
{
...
if (IsNullOrEmpty(pobjvViewpointCitationEN.userName) == false && GetStrLen(pobjvViewpointCitationEN.userName) > 50)
{
