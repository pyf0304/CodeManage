 ...
 * @returns 对象
 **/
export async function vViewpointLikeLog_GetObjByViewpointLikeLogIdAsync(lngViewpointLikeLogId: number): Promise<clsvViewpointLikeLogEN>  
{
const strThisFuncName = "GetObjByViewpointLikeLogIdAsync";

if (lngViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngViewpointLikeLogId]不能为空！(In GetObjByViewpointLikeLogIdAsync)");
...
if (lngViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngViewpointLikeLogId]不能为空！(In GetObjByViewpointLikeLogId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
if (lngViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngViewpointLikeLogId]不能为空！(In GetObjByViewpointLikeLogId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
strInFldName, clsvViewpointLikeLogEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vViewpointLikeLog_GetFirstObjAsync(strWhereCond: string): Promise<clsvViewpointLikeLogEN>  
{
...
clsvViewpointLikeLogEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvViewpointLikeLogEN._CurrTabName);
