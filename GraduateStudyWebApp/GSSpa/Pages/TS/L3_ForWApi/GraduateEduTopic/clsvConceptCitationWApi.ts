 ...
 * @returns 对象
 **/
export async function vConceptCitation_GetObjBymIdAsync(lngmId: number): Promise<clsvConceptCitationEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vConceptCitation_GetFirstObjAsync(strWhereCond: string): Promise<clsvConceptCitationEN>  
{
