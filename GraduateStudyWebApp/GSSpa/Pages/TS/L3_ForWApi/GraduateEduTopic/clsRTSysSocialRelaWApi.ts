 ...
 * @returns 对象
 **/
export async function RTSysSocialRela_GetObjBymIdAsync(lngmId: number): Promise<clsRTSysSocialRelaEN>  
{
...
strInFldName, clsRTSysSocialRelaEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function RTSysSocialRela_GetFirstObjAsync(strWhereCond: string): Promise<clsRTSysSocialRelaEN>  
{
...
clsRTSysSocialRelaEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsRTSysSocialRelaEN._CurrTabName);
