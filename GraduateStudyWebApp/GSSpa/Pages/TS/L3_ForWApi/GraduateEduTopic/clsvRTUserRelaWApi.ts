 ...
 * @returns 对象
 **/
export async function vRTUserRela_GetObjBymIdAsync(lngmId: number): Promise<clsvRTUserRelaEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vRTUserRela_func(strInFldName:string , strOutFldName:string , strInValue:number , strTopicId_C: string)
{
...
strInFldName, clsvRTUserRelaEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vRTUserRela_GetFirstObjAsync(strWhereCond: string): Promise<clsvRTUserRelaEN>  
{
...
clsvRTUserRelaEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvRTUserRelaEN._CurrTabName);
