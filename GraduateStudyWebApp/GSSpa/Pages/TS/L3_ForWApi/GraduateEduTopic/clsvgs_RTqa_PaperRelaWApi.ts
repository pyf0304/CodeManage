 ...
 * @returns 对象
 **/
export async function vgs_RTqa_PaperRela_GetObjBymIdAsync(lngmId: number): Promise<clsvgs_RTqa_PaperRelaEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vgs_RTqa_PaperRela_func(strInFldName:string , strOutFldName:string , strInValue:number , strTopicId_C: string)
{
...
strInFldName, clsvgs_RTqa_PaperRelaEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vgs_RTqa_PaperRela_GetFirstObjAsync(strWhereCond: string): Promise<clsvgs_RTqa_PaperRelaEN>  
{
...
clsvgs_RTqa_PaperRelaEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvgs_RTqa_PaperRelaEN._CurrTabName);
