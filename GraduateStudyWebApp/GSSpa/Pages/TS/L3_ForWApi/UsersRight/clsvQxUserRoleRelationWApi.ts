 ...
 * @returns 对象
 **/
export async function vQxUserRoleRelation_GetObjBymIdAsync(lngmId: number): Promise<clsvQxUserRoleRelationEN>  
{
...
strInFldName, clsvQxUserRoleRelationEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vQxUserRoleRelation_GetFirstObjAsync(strWhereCond: string): Promise<clsvQxUserRoleRelationEN>  
{
...
clsvQxUserRoleRelationEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvQxUserRoleRelationEN._CurrTabName);
