 ...
 * @returns 对象
 **/
export async function OperationType_GetObjByOperationTypeIdAsync(strOperationTypeId: string): Promise<clsOperationTypeEN>  
{
const strThisFuncName = "GetObjByOperationTypeIdAsync";

if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In GetObjByOperationTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！", strOperationTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In GetObjByOperationTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
...
if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In GetObjByOperationTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
...
if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In GetNameByOperationTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
...
strInFldName, clsOperationTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function OperationType_GetFirstObjAsync(strWhereCond: string): Promise<clsOperationTypeEN>  
{
...
clsOperationTypeEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsOperationTypeEN._CurrTabName);
...
*/
export async function OperationType__Cache(strDivName: string, strDdlName: string )
{
