 ...
 * @returns 对象
 **/
export async function SchoolTerm_GetObjBySchoolTermAsync(strSchoolTerm: string): Promise<clsSchoolTermEN>  
{
const strThisFuncName = "GetObjBySchoolTermAsync";

if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In GetObjBySchoolTermAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
{
const strMsg = Format("缓存分类变量:[strSchoolTerm]的长度:[{0}]不正确！", strSchoolTerm.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 对象
*/
export async function SchoolTerm_GetObjBySchoolTerm_Cache(strSchoolTerm: string, bolTryAsyncOnce: boolean = true) {
const strThisFuncName = "GetObjBySchoolTerm_Cache";

if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In GetObjBySchoolTerm_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
...
try
{
const arrSchoolTerm_Sel: Array <clsSchoolTermEN> = arrSchoolTermObjLst_Cache.filter(x => x.schoolTerm == strSchoolTerm);
...
{
objSchoolTerm = await SchoolTerm_GetObjBySchoolTermAsync(strSchoolTerm);
 ...
 * @returns 对象
*/
export async function SchoolTerm_GetObjBySchoolTerm_localStorage(strSchoolTerm: string) {
const strThisFuncName = "GetObjBySchoolTerm_localStorage";

if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In GetObjBySchoolTerm_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
...
const objSchoolTerm_Cache: clsSchoolTermEN = JSON.parse(strTempObj);
 ...
 * @returns 对象
*/
export async function SchoolTerm_UpdateObjInLst_Cache(objSchoolTerm: clsSchoolTermEN) {
const strThisFuncName = "UpdateObjInLst_Cache";
try
{
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
const obj = arrSchoolTermObjLst_Cache.find(x => 
 ...
 * @returns 对象
*/
export async function SchoolTerm_GetNameBySchoolTerm_Cache(strSchoolTerm: string) {
const strThisFuncName = "GetNameBySchoolTerm_Cache";

if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In GetNameBySchoolTerm_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
...
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
if (arrSchoolTermObjLst_Cache == null) return "";
try
{
const arrSchoolTerm_Sel: Array <clsSchoolTermEN> = arrSchoolTermObjLst_Cache.filter(x => x.schoolTerm == strSchoolTerm);
let objSchoolTerm: clsSchoolTermEN;
...
strInFldName, clsSchoolTermEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回两个对象比较的结果
*/
export function SchoolTerm_SortFun_Defa(a:clsSchoolTermEN , b:clsSchoolTermEN): number 
{
 ...
 * @returns 返回的第一条记录的关键字值
*/
export async function SchoolTerm_GetFirstID(strWhereCond: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 第一条记录对象
 **/
export async function SchoolTerm_GetFirstObjAsync(strWhereCond: string): Promise<clsSchoolTermEN>  
{
 ...
 **/
export async function SchoolTerm_GetObjLst_ClientCache() 
{
const strThisFuncName = "GetObjLst_ClientCache";
//初始化列表缓存
let strWhereCond = "1=1";
const strKey = clsSchoolTermEN._CurrTabName;
clsSchoolTermEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsSchoolTermEN._CurrTabName);
...
{
//缓存存在，直接返回
const arrSchoolTermExObjLst_Cache: Array<clsSchoolTermEN> = CacheHelper.Get(strKey);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function SchoolTerm_GetObjLst_localStorage() 
{
...
const arrSchoolTermExObjLst_Cache: Array<clsSchoolTermEN> = JSON.parse(strTempObjLst);
const arrSchoolTermObjLst_T = SchoolTerm_GetObjLstByJSONObjLst(arrSchoolTermExObjLst_Cache);
return arrSchoolTermObjLst_T;
}
try
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function SchoolTerm_GetObjLst_localStorage_PureCache() 
{
...
//缓存存在，直接返回
const strTempObjLst:string = localStorage.getItem(strKey) as string;
const arrSchoolTermObjLst_Cache: Array<clsSchoolTermEN> = JSON.parse(strTempObjLst);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function SchoolTerm_GetObjLst_sessionStorage() 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function SchoolTerm_GetObjLst_sessionStorage_PureCache() 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function SchoolTerm_GetObjLst_Cache(): Promise<Array<clsSchoolTermEN>> 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function SchoolTerm_GetObjLst_PureCache() 
{
 ...
 * @returns 对象列表子集
*/
export async function SchoolTerm_GetSubObjLst_Cache(objSchoolTerm_Cond: clsSchoolTermEN) {
const strThisFuncName = "GetSubObjLst_Cache";
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
let arrSchoolTerm_Sel: Array < clsSchoolTermEN > = arrSchoolTermObjLst_Cache;
if (objSchoolTerm_Cond.sf_FldComparisonOp == null || objSchoolTerm_Cond.sf_FldComparisonOp == "") return arrSchoolTerm_Sel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolTerm_Cond.sf_FldComparisonOp);
//console.log("clsSchoolTermWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
const sstrKeys = GetObjKeys(objSchoolTerm_Cond);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]缓存对象列表中获取子集对象不成功!(in {2}.{3})", e, JSON.stringify( objSchoolTerm_Cond), schoolTerm_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
...
try
{
const response = await axios.post(strUrl, arrSchoolTerm);
const data = response.data;
if (data.errorId == 0)
{
const returnObjLst = data.returnObjLst;
 ...
 * @returns 对象列表
*/
export async function SchoolTerm_GetObjLstBySchoolTermLst_Cache(arrSchoolTermLst: Array<string>) {
const strThisFuncName = "GetObjLstBySchoolTermLst_Cache";
try
{
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
const arrSchoolTerm_Sel: Array <clsSchoolTermEN> = arrSchoolTermObjLst_Cache.filter(x => arrSchoolTermLst.indexOf(x.schoolTerm)>-1);
return arrSchoolTerm_Sel;
}
catch (e)
{
 ...
 * @returns 获取的相应记录对象列表
*/
export async function SchoolTerm_GetObjLstByRange(intMinNum: number, intMaxNum: number, strWhereCond: string, strOrderBy:string="", cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 对象列表
*/
export async function SchoolTerm_GetObjLstByPager_Cache(objPagerPara: stuPagerPara) {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
if (arrSchoolTermObjLst_Cache.length == 0) return arrSchoolTermObjLst_Cache;
let arrSchoolTerm_Sel = arrSchoolTermObjLst_Cache;
const obj_Cond = JSON.parse(objPagerPara.whereCond);
const objSchoolTerm_Cond = new clsSchoolTermEN();
ObjectAssign(objSchoolTerm_Cond, obj_Cond);
...
if (arrSchoolTerm_Sel.length == 0) return arrSchoolTerm_Sel;
...
try
{
const response = await axios.post(strUrl, objSchoolTermEN);
const data = response.data;
if (data.errorId == 0)
{
 ...
 * @returns 返回新添加记录的关键字
*/
export async function SchoolTerm_AddNewRecordWithReturnKey(objSchoolTermEN: clsSchoolTermEN, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 对象列表子集
*/
export async function SchoolTerm_IsExistRecord_Cache(objSchoolTerm_Cond: clsSchoolTermEN) {
const strThisFuncName = "IsExistRecord_Cache";
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
if (arrSchoolTermObjLst_Cache == null) return false;
let arrSchoolTerm_Sel: Array < clsSchoolTermEN > = arrSchoolTermObjLst_Cache;
if (objSchoolTerm_Cond.sf_FldComparisonOp == null || objSchoolTerm_Cond.sf_FldComparisonOp == "") return arrSchoolTerm_Sel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolTerm_Cond.sf_FldComparisonOp);
//console.log("clsSchoolTermWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify( objSchoolTerm_Cond), schoolTerm_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return false;
...
*/
export async function SchoolTerm_IsExist(strSchoolTerm: string, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 对象
*/
export async function SchoolTerm_IsExist_Cache(strSchoolTerm:string) {
 ...
 * @returns 对象列表记录数
*/
export async function SchoolTerm_GetRecCountByCond_Cache(objSchoolTerm_Cond: clsSchoolTermEN) {
const strThisFuncName = "GetRecCountByCond_Cache";
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
if (arrSchoolTermObjLst_Cache == null) return 0;
let arrSchoolTerm_Sel: Array < clsSchoolTermEN > = arrSchoolTermObjLst_Cache;
if (objSchoolTerm_Cond.sf_FldComparisonOp == null || objSchoolTerm_Cond.sf_FldComparisonOp == "") return arrSchoolTerm_Sel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolTerm_Cond.sf_FldComparisonOp);
//console.log("clsSchoolTermWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]从缓存对象列表中获取记录数不成功!(in {2}.{3})", e, JSON.stringify( objSchoolTerm_Cond), schoolTerm_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return 0;
...
*/
export async function SchoolTerm_GetMaxStrIdByPrefix(strPrefix: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
...
*/
export async function SchoolTerm_BindDdl_SchoolTermInDiv_Cache(strDivName: string, strDdlName: string )
{
...
BindDdl_ObjLstInDiv(strDivName, strDdlName, arrObjLst_Sel, clsSchoolTermEN.con_SchoolTerm, clsSchoolTermEN.con_SchoolTermName, "学期");
}
...
*/
export function SchoolTerm_GetCombineCondition(objSchoolTerm_Cond: clsSchoolTermEN ):string
{
...
if (Object.prototype.hasOwnProperty.call(objSchoolTerm_Cond.dicFldComparisonOp, clsSchoolTermEN.con_SchoolTerm) == true)
{
const strComparisonOp_SchoolTerm:string = objSchoolTerm_Cond.dicFldComparisonOp[clsSchoolTermEN.con_SchoolTerm];
strWhereCond += Format(" And {0} {2} '{1}'", clsSchoolTermEN.con_SchoolTerm, objSchoolTerm_Cond.schoolTerm, strComparisonOp_SchoolTerm);
}
if (Object.prototype.hasOwnProperty.call(objSchoolTerm_Cond.dicFldComparisonOp, clsSchoolTermEN.con_SchoolTermName) == true)
{
const strComparisonOp_SchoolTermName:string = objSchoolTerm_Cond.dicFldComparisonOp[clsSchoolTermEN.con_SchoolTermName];
strWhereCond += Format(" And {0} {2} '{1}'", clsSchoolTermEN.con_SchoolTermName, objSchoolTerm_Cond.schoolTermName, strComparisonOp_SchoolTermName);
}
if (Object.prototype.hasOwnProperty.call(objSchoolTerm_Cond.dicFldComparisonOp, clsSchoolTermEN.con_IsCurrentSchoolTerm) == true)
{
