 ...
 * @returns 对象
 **/
export async function XzGradeBase_GetObjByid_GradeBaseAsync(strid_GradeBase: string): Promise<clsXzGradeBaseEN>  
{
const strThisFuncName = "GetObjByid_GradeBaseAsync";

if (IsNullOrEmpty(strid_GradeBase) == true)
{
  const strMsg = Format("参数:[strid_GradeBase]不能为空！(In GetObjByid_GradeBaseAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_GradeBase.length != 4)
{
const strMsg = Format("缓存分类变量:[strid_GradeBase]的长度:[{0}]不正确！", strid_GradeBase.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strid_GradeBase) == true)
{
  const strMsg = Format("参数:[strid_GradeBase]不能为空！(In GetObjByid_GradeBase_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_GradeBase.length != 4)
...
if (IsNullOrEmpty(strid_GradeBase) == true)
{
  const strMsg = Format("参数:[strid_GradeBase]不能为空！(In GetObjByid_GradeBase_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_GradeBase.length != 4)
...
if (IsNullOrEmpty(strid_GradeBase) == true)
{
  const strMsg = Format("参数:[strid_GradeBase]不能为空！(In GetNameByid_GradeBase_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_GradeBase.length != 4)
...
strInFldName, clsXzGradeBaseEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function XzGradeBase_GetFirstObjAsync(strWhereCond: string): Promise<clsXzGradeBaseEN>  
{
...
clsXzGradeBaseEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsXzGradeBaseEN._CurrTabName);
