 ...
 * @returns 对象
 **/
export async function vXzGradeBase_GetObjByid_GradeBaseAsync(strid_GradeBase: string): Promise<clsvXzGradeBaseEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vXzGradeBase_GetFirstObjAsync(strWhereCond: string): Promise<clsvXzGradeBaseEN>  
{
