 ...
 * @returns 对象
 **/
export async function DiscussionSubContent_GetObjBySubContentIdAsync(strSubContentId: string): Promise<clsDiscussionSubContentEN>  
{
const strThisFuncName = "GetObjBySubContentIdAsync";

if (IsNullOrEmpty(strSubContentId) == true)
{
  const strMsg = Format("参数:[strSubContentId]不能为空！(In GetObjBySubContentIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubContentId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSubContentId]的长度:[{0}]不正确！", strSubContentId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回两个对象比较的结果
*/
export function DiscussionSubContent_SortFun_Defa(a:clsDiscussionSubContentEN , b:clsDiscussionSubContentEN): number 
{
 ...
 * @returns 返回两个对象比较的结果
*/
export function DiscussionSubContent_SortFun_Defa_2Fld(a:clsDiscussionSubContentEN , b:clsDiscussionSubContentEN): number 
{
 ...
 * @returns 返回的第一条记录的关键字值
*/
export async function DiscussionSubContent_GetFirstID(strWhereCond: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 第一条记录对象
 **/
export async function DiscussionSubContent_GetFirstObjAsync(strWhereCond: string): Promise<clsDiscussionSubContentEN>  
{
 ...
 * @returns 获取的相应记录对象列表
*/
export async function DiscussionSubContent_GetObjLstByRange(intMinNum: number, intMaxNum: number, strWhereCond: string, strOrderBy:string="", cb: (json: any) => void, errorCb: (json: any) => void) 
{
...
try
{
const response = await axios.post(strUrl, objDiscussionSubContentEN);
const data = response.data;
if (data.errorId == 0)
{
 ...
 * @returns 返回新添加记录的关键字
*/
export async function DiscussionSubContent_AddNewRecordWithReturnKey(objDiscussionSubContentEN: clsDiscussionSubContentEN, cb: (json: any) => void, errorCb: (json: any) => void)
{
...
*/
export async function DiscussionSubContent_IsExist(strSubContentId: string, cb: (json: any) => void, errorCb: (json: any) => void)
{
...
*/
export async function DiscussionSubContent_GetMaxStrIdByPrefix(strPrefix: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
...
if (IsNullOrEmpty(pobjDiscussionSubContentEN.userId) == false && GetStrLen(pobjDiscussionSubContentEN.userId) > 20)
{
...
//检查主键是否为Null或者空！
if (IsNullOrEmpty(pobjDiscussionSubContentEN.subContentId) === true )
{
...
*/
export function DiscussionSubContent_GetCombineCondition(objDiscussionSubContent_Cond: clsDiscussionSubContentEN ):string
{
...
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_SubContentId) == true)
{
const strComparisonOp_SubContentId:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_SubContentId];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_SubContentId, objDiscussionSubContent_Cond.subContentId, strComparisonOp_SubContentId);
}
//数据类型string(text)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_TopicsId) == true)
{
const strComparisonOp_TopicsId:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_TopicsId];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_TopicsId, objDiscussionSubContent_Cond.topicsId, strComparisonOp_TopicsId);
}
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_IsTop) == true)
{
...
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_UpdDate) == true)
{
const strComparisonOp_UpdDate:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_UpdDate, objDiscussionSubContent_Cond.updDate, strComparisonOp_UpdDate);
}
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_UpdUser) == true)
{
const strComparisonOp_UpdUser:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_UpdUser];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_UpdUser, objDiscussionSubContent_Cond.updUser, strComparisonOp_UpdUser);
}
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_Memo) == true)
{
const strComparisonOp_Memo:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_Memo, objDiscussionSubContent_Cond.memo, strComparisonOp_Memo);
}
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_ParentId) == true)
{
const strComparisonOp_ParentId:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_ParentId];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_ParentId, objDiscussionSubContent_Cond.parentId, strComparisonOp_ParentId);
}
if (Object.prototype.hasOwnProperty.call(objDiscussionSubContent_Cond.dicFldComparisonOp, clsDiscussionSubContentEN.con_UserId) == true)
{
const strComparisonOp_UserId:string = objDiscussionSubContent_Cond.dicFldComparisonOp[clsDiscussionSubContentEN.con_UserId];
strWhereCond += Format(" And {0} {2} '{1}'", clsDiscussionSubContentEN.con_UserId, objDiscussionSubContent_Cond.userId, strComparisonOp_UserId);
}
 return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
export function DiscussionSubContent_GetUniCondStr_SubContentId(objDiscussionSubContentEN: clsDiscussionSubContentEN ):string
{
let strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
export function DiscussionSubContent_GetUniCondStr4Update_SubContentId(objDiscussionSubContentEN: clsDiscussionSubContentEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and subContentId <> '{0}'", objDiscussionSubContentEN.subContentId);
 strWhereCond +=  Format(" and subContentId = '{0}'", objDiscussionSubContentEN.subContentId);
