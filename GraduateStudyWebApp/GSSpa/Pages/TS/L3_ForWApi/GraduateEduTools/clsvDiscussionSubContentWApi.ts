 ...
 * @returns 对象
 **/
export async function vDiscussionSubContent_GetObjBySubContentIdAsync(strSubContentId: string): Promise<clsvDiscussionSubContentEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vDiscussionSubContent_GetFirstObjAsync(strWhereCond: string): Promise<clsvDiscussionSubContentEN>  
{
