 ...
 * @returns 对象
 **/
export async function vDiscussionTopics_GetObjByTopicsIdAsync(strTopicsId: string): Promise<clsvDiscussionTopicsEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vDiscussionTopics_func(strInFldName:string , strOutFldName:string , strInValue:string , strid_CurrEduCls_C: string)
{
...
strInFldName, clsvDiscussionTopicsEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vDiscussionTopics_GetFirstObjAsync(strWhereCond: string): Promise<clsvDiscussionTopicsEN>  
{
...
clsvDiscussionTopicsEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvDiscussionTopicsEN._CurrTabName);
