 ...
 * @returns 对象
 **/
export async function vSysCount_GetObjByCountIdAsync(strCountId: string): Promise<clsvSysCountEN>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function vSysCount_GetFirstObjAsync(strWhereCond: string): Promise<clsvSysCountEN>  
{
