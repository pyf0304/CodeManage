 ...
 * @returns 对象
 **/
export async function gs_TotalDataType_GetObjByTotalDataTypeIdAsync(strTotalDataTypeId: string): Promise<clsgs_TotalDataTypeEN>  
{
const strThisFuncName = "GetObjByTotalDataTypeIdAsync";

if (IsNullOrEmpty(strTotalDataTypeId) == true)
{
  const strMsg = Format("参数:[strTotalDataTypeId]不能为空！(In GetObjByTotalDataTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strTotalDataTypeId]的长度:[{0}]不正确！", strTotalDataTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strTotalDataTypeId) == true)
{
  const strMsg = Format("参数:[strTotalDataTypeId]不能为空！(In GetObjByTotalDataTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataTypeId.length != 2)
...
if (IsNullOrEmpty(strTotalDataTypeId) == true)
{
  const strMsg = Format("参数:[strTotalDataTypeId]不能为空！(In GetObjByTotalDataTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataTypeId.length != 2)
...
if (IsNullOrEmpty(strTotalDataTypeId) == true)
{
  const strMsg = Format("参数:[strTotalDataTypeId]不能为空！(In GetNameByTotalDataTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataTypeId.length != 2)
...
strInFldName, clsgs_TotalDataTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_TotalDataType_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_TotalDataTypeEN>  
{
...
clsgs_TotalDataTypeEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_TotalDataTypeEN._CurrTabName);
