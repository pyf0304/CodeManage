 ...
 * @returns 对象
 **/
export async function sys_RequestPush_GetObjByRequestIdAsync(lngRequestId: number): Promise<clssys_RequestPushEN>  
{
const strThisFuncName = "GetObjByRequestIdAsync";

if (lngRequestId == 0)
{
  const strMsg = Format("参数:[lngRequestId]不能为空！(In GetObjByRequestIdAsync)");
...
if (lngRequestId == 0)
{
  const strMsg = Format("参数:[lngRequestId]不能为空！(In GetObjByRequestId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
if (lngRequestId == 0)
{
  const strMsg = Format("参数:[lngRequestId]不能为空！(In GetObjByRequestId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
strInFldName, clssys_RequestPushEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function sys_RequestPush_GetFirstObjAsync(strWhereCond: string): Promise<clssys_RequestPushEN>  
{
...
clssys_RequestPushEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clssys_RequestPushEN._CurrTabName);
