 ...
 * @returns 对象
 **/
export async function gs_AnswerCount_GetObjByAnswerCountIdAsync(strAnswerCountId: string): Promise<clsgs_AnswerCountEN>  
{
const strThisFuncName = "GetObjByAnswerCountIdAsync";

if (IsNullOrEmpty(strAnswerCountId) == true)
{
  const strMsg = Format("参数:[strAnswerCountId]不能为空！(In GetObjByAnswerCountIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strAnswerCountId.length != 10)
{
const strMsg = Format("缓存分类变量:[strAnswerCountId]的长度:[{0}]不正确！", strAnswerCountId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strAnswerCountId) == true)
{
  const strMsg = Format("参数:[strAnswerCountId]不能为空！(In GetObjByAnswerCountId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strAnswerCountId.length != 10)
...
if (IsNullOrEmpty(strAnswerCountId) == true)
{
  const strMsg = Format("参数:[strAnswerCountId]不能为空！(In GetObjByAnswerCountId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strAnswerCountId.length != 10)
 ...
 * @returns 返回一个输出字段值
*/
export async function gs_AnswerCount_func(strInFldName:string , strOutFldName:string , strInValue:string , strid_CurrEduCls_C: string)
{
...
strInFldName, clsgs_AnswerCountEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_AnswerCount_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_AnswerCountEN>  
{
...
clsgs_AnswerCountEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_AnswerCountEN._CurrTabName);
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsgs_AnswerCountWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
...
if (IsNullOrEmpty(pobjgs_AnswerCountEN.userName) == false && GetStrLen(pobjgs_AnswerCountEN.userName) > 50)
{
