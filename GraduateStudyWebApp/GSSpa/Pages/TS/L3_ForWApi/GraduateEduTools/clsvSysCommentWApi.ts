 ...
 * @returns 对象
 **/
export async function vSysComment_GetObjByCommentIdAsync(strCommentId: string): Promise<clsvSysCommentEN>  
{
 ...
 * @returns 返回一个输出字段值
*/
export async function vSysComment_func(strInFldName:string , strOutFldName:string , strInValue:string , strid_CurrEduCls_C: string)
{
...
strInFldName, clsvSysCommentEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function vSysComment_GetFirstObjAsync(strWhereCond: string): Promise<clsvSysCommentEN>  
{
...
clsvSysCommentEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsvSysCommentEN._CurrTabName);
