 ...
 * @returns 对象
 **/
export async function SubViewpointType_GetObjBySubViewpointTypeIdAsync(strSubViewpointTypeId: string): Promise<clsSubViewpointTypeEN>  
{
const strThisFuncName = "GetObjBySubViewpointTypeIdAsync";

if (IsNullOrEmpty(strSubViewpointTypeId) == true)
{
  const strMsg = Format("参数:[strSubViewpointTypeId]不能为空！(In GetObjBySubViewpointTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointTypeId.length != 8)
{
const strMsg = Format("缓存分类变量:[strSubViewpointTypeId]的长度:[{0}]不正确！", strSubViewpointTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strSubViewpointTypeId) == true)
{
  const strMsg = Format("参数:[strSubViewpointTypeId]不能为空！(In GetObjBySubViewpointTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointTypeId.length != 8)
...
if (IsNullOrEmpty(strSubViewpointTypeId) == true)
{
  const strMsg = Format("参数:[strSubViewpointTypeId]不能为空！(In GetObjBySubViewpointTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointTypeId.length != 8)
...
if (IsNullOrEmpty(strSubViewpointTypeId) == true)
{
  const strMsg = Format("参数:[strSubViewpointTypeId]不能为空！(In GetNameBySubViewpointTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSubViewpointTypeId.length != 8)
...
strInFldName, clsSubViewpointTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
if (a.subViewpointTypeName == b.subViewpointTypeName) return a.defaTitle.localeCompare(b.defaTitle);
 ...
 * @returns 第一条记录对象
 **/
export async function SubViewpointType_GetFirstObjAsync(strWhereCond: string): Promise<clsSubViewpointTypeEN>  
{
...
clsSubViewpointTypeEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsSubViewpointTypeEN._CurrTabName);
