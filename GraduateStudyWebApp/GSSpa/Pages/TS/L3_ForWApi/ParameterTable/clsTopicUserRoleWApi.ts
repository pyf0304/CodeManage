 ...
 * @returns 对象
 **/
export async function TopicUserRole_GetObjByTopicUserRoleIdAsync(strTopicUserRoleId: string): Promise<clsTopicUserRoleEN>  
{
const strThisFuncName = "GetObjByTopicUserRoleIdAsync";

if (IsNullOrEmpty(strTopicUserRoleId) == true)
{
  const strMsg = Format("参数:[strTopicUserRoleId]不能为空！(In GetObjByTopicUserRoleIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicUserRoleId.length != 4)
{
const strMsg = Format("缓存分类变量:[strTopicUserRoleId]的长度:[{0}]不正确！", strTopicUserRoleId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strTopicUserRoleId) == true)
{
  const strMsg = Format("参数:[strTopicUserRoleId]不能为空！(In GetObjByTopicUserRoleId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicUserRoleId.length != 4)
...
if (IsNullOrEmpty(strTopicUserRoleId) == true)
{
  const strMsg = Format("参数:[strTopicUserRoleId]不能为空！(In GetObjByTopicUserRoleId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicUserRoleId.length != 4)
...
if (IsNullOrEmpty(strTopicUserRoleId) == true)
{
  const strMsg = Format("参数:[strTopicUserRoleId]不能为空！(In GetNameByTopicUserRoleId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicUserRoleId.length != 4)
...
strInFldName, clsTopicUserRoleEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
if (a.topicUserRoleName == b.topicUserRoleName) return a.updUserId.localeCompare(b.updUserId);
 ...
 * @returns 第一条记录对象
 **/
export async function TopicUserRole_GetFirstObjAsync(strWhereCond: string): Promise<clsTopicUserRoleEN>  
{
...
clsTopicUserRoleEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsTopicUserRoleEN._CurrTabName);
