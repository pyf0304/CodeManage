 ...
 * @returns 对象
 **/
export async function gs_PaperSubViewsAttitudes_GetObjByAttitudesIdAsync(strAttitudesId: string): Promise<clsgs_PaperSubViewsAttitudesEN>  
{
const strThisFuncName = "GetObjByAttitudesIdAsync";

if (IsNullOrEmpty(strAttitudesId) == true)
{
  const strMsg = Format("参数:[strAttitudesId]不能为空！(In GetObjByAttitudesIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strAttitudesId.length != 2)
{
const strMsg = Format("缓存分类变量:[strAttitudesId]的长度:[{0}]不正确！", strAttitudesId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strAttitudesId) == true)
{
  const strMsg = Format("参数:[strAttitudesId]不能为空！(In GetObjByAttitudesId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strAttitudesId.length != 2)
...
if (IsNullOrEmpty(strAttitudesId) == true)
{
  const strMsg = Format("参数:[strAttitudesId]不能为空！(In GetObjByAttitudesId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strAttitudesId.length != 2)
...
if (IsNullOrEmpty(strAttitudesId) == true)
{
  const strMsg = Format("参数:[strAttitudesId]不能为空！(In GetNameByAttitudesId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strAttitudesId.length != 2)
...
strInFldName, clsgs_PaperSubViewsAttitudesEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
if (a.attitudesName == b.attitudesName) return a.updUser.localeCompare(b.updUser);
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperSubViewsAttitudes_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperSubViewsAttitudesEN>  
{
...
clsgs_PaperSubViewsAttitudesEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_PaperSubViewsAttitudesEN._CurrTabName);
