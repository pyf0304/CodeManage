 ...
 * @returns 对象
 **/
export async function gs_ParagraphState_GetObjByParagraphStateIdAsync(strParagraphStateId: string): Promise<clsgs_ParagraphStateEN>  
{
const strThisFuncName = "GetObjByParagraphStateIdAsync";

if (IsNullOrEmpty(strParagraphStateId) == true)
{
  const strMsg = Format("参数:[strParagraphStateId]不能为空！(In GetObjByParagraphStateIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphStateId.length != 2)
{
const strMsg = Format("缓存分类变量:[strParagraphStateId]的长度:[{0}]不正确！", strParagraphStateId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strParagraphStateId) == true)
{
  const strMsg = Format("参数:[strParagraphStateId]不能为空！(In GetObjByParagraphStateId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphStateId.length != 2)
...
if (IsNullOrEmpty(strParagraphStateId) == true)
{
  const strMsg = Format("参数:[strParagraphStateId]不能为空！(In GetObjByParagraphStateId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphStateId.length != 2)
...
if (IsNullOrEmpty(strParagraphStateId) == true)
{
  const strMsg = Format("参数:[strParagraphStateId]不能为空！(In GetNameByParagraphStateId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphStateId.length != 2)
...
strInFldName, clsgs_ParagraphStateEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_ParagraphState_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_ParagraphStateEN>  
{
...
clsgs_ParagraphStateEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_ParagraphStateEN._CurrTabName);
