 ...
 * @returns 对象
 **/
export async function SysOperationType_GetObjByOperationTypeIdAsync(strOperationTypeId: string): Promise<clsSysOperationTypeEN>  
{
...
strInFldName, clsSysOperationTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function SysOperationType_GetFirstObjAsync(strWhereCond: string): Promise<clsSysOperationTypeEN>  
{
...
clsSysOperationTypeEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsSysOperationTypeEN._CurrTabName);
