 ...
 * @returns 对象
 **/
export async function gs_PaperType_GetObjByPaperTypeIdAsync(strPaperTypeId: string): Promise<clsgs_PaperTypeEN>  
{
const strThisFuncName = "GetObjByPaperTypeIdAsync";

if (IsNullOrEmpty(strPaperTypeId) == true)
{
  const strMsg = Format("参数:[strPaperTypeId]不能为空！(In GetObjByPaperTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPaperTypeId]的长度:[{0}]不正确！", strPaperTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperTypeId) == true)
{
  const strMsg = Format("参数:[strPaperTypeId]不能为空！(In GetObjByPaperTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperTypeId.length != 2)
...
if (IsNullOrEmpty(strPaperTypeId) == true)
{
  const strMsg = Format("参数:[strPaperTypeId]不能为空！(In GetObjByPaperTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperTypeId.length != 2)
...
strInFldName, clsgs_PaperTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperType_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperTypeEN>  
{
...
clsgs_PaperTypeEN.CacheAddiCondition = GetSession_CacheAdditionCondition(clsgs_PaperTypeEN._CurrTabName);
