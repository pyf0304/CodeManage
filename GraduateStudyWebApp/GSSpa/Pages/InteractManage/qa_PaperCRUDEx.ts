...
import { clsvqa_PushEN } from "../TS/L0_Entity/InteractManage/clsvqa_PushEN.js";
...
import { qa_Push_GetRecCountByCondAsync, qa_Push_UpdateRecordAsync } from "../TS/L3_ForWApi/InteractManage/clsqa_PushWApi.js";
import { vqa_Push_GetObjLstAsync } from "../TS/L3_ForWApi/InteractManage/clsvqa_PushWApi.js";
import { vqa_Questions_GetObjByQuestionsIdAsync, vqa_Questions_GetObjLstByPagerAsync, vqa_Questions_GetRecCountByCondAsync } from "../TS/L3_ForWApi/InteractManage/clsvqa_QuestionsWApi.js";
...
import { vPaperEx_GetObjLstByPagerById_CurrEduCls_Cache, vPaperEx_GetRecCountByCondById_CurrEduCls_Cache } from "../TS/L3_ForWApiEx/GraduateEdu/clsvPaperExWApi.js";
import { clsCommonFunc4Web } from "../TS/PubFun/clsCommonFunc4Web2.js";
import { clsDataColumn } from "../TS/PubFun/clsDataColumn.js";
import { clsPublocalStorage } from "../TS/PubFun/clsPublocalStorage.js";
import { clsPubSessionStorage } from "../TS/PubFun/clsPubSessionStorage.js";
import { stuPagerPara } from "../TS/PubFun/stuPagerPara.js";
import { qa_PaperCRUD } from "./qa_PaperCRUD.js";
...
*/
export class qa_PaperCRUDEx extends qa_PaperCRUD {
   ...
   */
    ...
    public async BindGv_vqa_Push() {
        ...
        var arrvqa_PushObjLst: Array<clsvqa_PushEN> = [];
        try {
            ...
            //});
            const responseObjLst = await vqa_Push_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrvqa_PushObjLst = <Array<clsvqa_PushEN>>jsonData;
            });
        }
        catch (e) {
    ...
    public async BindGv_History_vqa_Push() {
        ...
        strWhereCond += " and id_CurrEduCls=" + clsPublocalStorage.Getid_CurrEduCls();
        strWhereCond += " and receiveUser='" + clsPubSessionStorage.GetSession_UserId() + "' and isReceive=1";
   ...
   */
    ...
    public async btnAnswer_Click(strKeyId: string) {
        try {
            ...
            const responseText1 = vqa_Questions_GetObjByQuestionsIdAsync(strKeyId).then((jsonData) => {
                var objvqa_QuestionsEN: clsvqa_QuestionsEN = <clsvqa_QuestionsEN>jsonData;
  ...
  */
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        var objPage: qa_PaperCRUDEx = new qa_PaperCRUDEx();
    ...
    public async btnAddNewRecordWithMaxId_Click() {
        ...
        try {
            if (this.bolIsLoadEditRegion == false)  //
            {
                ...
                //获取分享Id
                const responseText = await gs_UserConfigEx_GetNewReturnShareIdEx("11", clsPubSessionStorage.GetSession_UserId());
...
*/
    public async BindGv_vPaper() {
        ...
        try {
            ...
            this.RecCount = await vPaperEx_GetRecCountByCondById_CurrEduCls_Cache(objvPaper_Cond, strid_CurrEduCls);
            console.log("完成计数!");
            arrvPaperObjLst = await vPaperEx_GetObjLstByPagerById_CurrEduCls_Cache(objPagerPara, strid_CurrEduCls);
