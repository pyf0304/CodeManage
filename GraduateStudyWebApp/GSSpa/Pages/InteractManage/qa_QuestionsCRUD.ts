...
import { qa_Questions_AddNewRecordAsync, qa_Questions_Delqa_QuestionssAsync, qa_Questions_DelRecordAsync, qa_Questions_DownMoveAsync, qa_Questions_GetMaxStrIdAsync, qa_Questions_GetObjByQuestionsIdAsync, qa_Questions_GetObjLstByQuestionsIdLstAsync, qa_Questions_GoBottomAsync, qa_Questions_GoTopAsync, qa_Questions_ReOrderAsync, qa_Questions_UpMoveAsync } from "../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js";
import { vqa_Questions_GetObjLstAsync, vqa_Questions_GetObjLstByPagerAsync, vqa_Questions_GetObjLstByPager_Cache, vqa_Questions_GetRecCountByCondAsync, vqa_Questions_GetRecCountByCond_Cache } from "../TS/L3_ForWApi/InteractManage/clsvqa_QuestionsWApi.js";
...
*/
declare function HideDialog_qa_Questions(): void;
/*
...
*/
export class qa_QuestionsCRUD implements clsOperateList{
   ...
   */
    public async SelectRecord(strQuestionsId: string) {
        try {
            ...
            clsCommonFunc4Web.Redirect("/Index/Main_vqa_Questions");
        }
        catch (e) {
            console.error(e);
   ...
   */
    public async btnExportExcel_Click() {
        ...
        try {
            const responseText = await vqa_Questions_GetObjLstAsync(strWhereCond).then((jsonData) => {
                var arrvqa_QuestionsObjLst: Array<clsvqa_QuestionsEN> = <Array<clsvqa_QuestionsEN>>jsonData;
   ...
   */
    public Combinevqa_QuestionsCondition(): string {
        ...
        try {
            ...
            var strMsg: string = `(errid:WiTsCs0009)在组合查询条件(Combineqa_QuestionsCondition)时出错!请联系管理员!${objException}`;
            throw strMsg;
        }
        return strWhereCond;
    }
    ...
    (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj)
     <returns>条件串(strWhereCond)</returns>
   */
    public Combinevqa_QuestionsConditionObj(): clsvqa_QuestionsEN {
        //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
        //例如 1 = 1 && userName = '张三'
        var strWhereCond: string = " 1 = 1 ";
        var objvqa_Questions_Cond: clsvqa_QuestionsEN = new clsvqa_QuestionsEN();
        //如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
        try {
        }
        catch (objException) {
            var strMsg: string = `(errid:WiTsCs0010)在组合查询条件对象(Combineqa_QuestionsConditionObj)时出错!请联系管理员!${objException}`;
            throw strMsg;
        }
   ...
   */
    public BindTab_vqa_Questions(divContainer: string, arrvqa_QuestionsObjLst: Array<clsvqa_QuestionsEN>) {
        ...
        clsCommonFunc4Web.BindTabV2(o, arrvqa_QuestionsObjLst, arrDataColumn, "questionsId");
   ...
   */
    public async BindGv_vqa_Questions() {
        ...
        try {
            const responseRecCount = await vqa_Questions_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
   ...
   */
    public async BindGv_vqa_Questions_Cache() {
        ...
        try {
            ...
            var arrvqa_QuestionsObjLst = await vqa_Questions_GetObjLstByPager_Cache(objPagerPara);
        }
        catch (e) {
            console.error('catch(e)=');
            console.error(e);
        ...
        if (arrvqa_QuestionsObjLst.length == 0) {
            var strKey: string = `${clsqa_QuestionsEN._CurrTabName}`;
   ...
   */
    public async CopyRecord(arrQuestionsId: Array<string>) {
        try {
            const responseText = await qa_Questions_GetObjLstByQuestionsIdLstAsync(arrQuestionsId);
            console.log('responseText=');
            console.log(responseText);
            var intCount: number = 0;
            var arrqa_QuestionsObjLst: Array<clsqa_QuestionsEN> = <Array<clsqa_QuestionsEN>>responseText;
            for (let objInFor of arrqa_QuestionsObjLst) {
                ...
                const responseText2 = await qa_Questions_AddNewRecordAsync(objInFor);
   ...
   */
    public async DelMultiRecord(arrQuestionsId: Array<string>) {
        try {
            const responseText = await qa_Questions_Delqa_QuestionssAsync(arrQuestionsId);
            var returnInt: number = responseText;
            if (returnInt > 0) {
                //qa_Questions_ReFreshCache();
                var strInfo: string = `删除记录成功,共删除${returnInt}条记录!`;
   ...
   */
    public Showqa_QuestionsObj(divContainer: string, objqa_Questions: clsqa_QuestionsEN) {
        ...
        var sstrKeys = clsCommonFunc4Web.GetObjKeys(objqa_Questions);
   ...
   */
    public set hidSortvqa_QuestionsBy(value: string) {
        $("#hidSortvqa_QuestionsBy").val(value);
    }
    /*
    * 设置排序字段
   */
    public get hidSortvqa_QuestionsBy(): string {
