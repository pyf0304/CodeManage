...
import { qa_AnswerV_AddNewRecordAsync, qa_AnswerV_GetFirstObjAsync } from "../TS/L3_ForWApi/InteractManage/clsqa_AnswerVWApi.js";
...
export class Tea_QA {
        ...
        try {
            ...
            if ($('#hidAnswerTypeId').val() == "01") {
                if ($('#hidParentId').val() == "root") {
                    ...
                    var strWhere = " answerTypeId='01' and questionsId='" + this.questionsId + "' and updUser='" + clsPubSessionStorage.GetSession_UserId() + "' and isRecommend=0 and parentId='root'";
  ...
  */
        ...
        try {
            switch (strCommandText) {
                ...
                case "确认添加":
                    ...
                    const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strAnswerId, "11", "1", this.Id_CurrEduCls);
                ...
                case "确认修改":
                    ...
                    var strAnswerId = $('#hidAnswerId').val();
                    const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strAnswerId, "11", "2", this.Id_CurrEduCls);
    ...
    public async AddVersionRecordSave() {
        ...
        var objqa_AnswerVEN: clsqa_AnswerVEN = new clsqa_AnswerVEN();
        objqa_AnswerVEN.answerId = this.answerId;
        this.PutDataToqa_AnswerVClass(objqa_AnswerVEN);

        try {
            const responseText2 = await qa_AnswerV_AddNewRecordAsync(objqa_AnswerVEN);
            var returnBool: boolean = !!responseText2;
            if (returnBool == true) {
  ...
  */
    public PutDataToqa_AnswerVClass(pobjqa_AnswerVEN: clsqa_AnswerVEN) {
        ...
        pobjqa_AnswerVEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
  ...
  */
   ...
   */
    ...
    public async DiscussSubmit_Click() {
        ...
        objqa_AnswerEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改人
        objqa_AnswerEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
        //是否提交
        objqa_AnswerEN.isSubmit = true;
        try {
 ...
 */
    public async UpdateRecordSave2() {
        ...
        if ($("#hidIsRecommend").val() != "") {
            ...
            const responseText = await qa_AnswerV_GetFirstObjAsync(strWhereCond2).then((jsonData) => {
                var objqa_AnswerVEN: clsqa_AnswerVEN = <clsqa_AnswerVEN>jsonData;
   ...
   */
    public async btnDelAnswer_Click(strAnswerId: string) {
        try {
            //先删除总表数据信息
           // var strAnswerId = $('#hidAnswerId').val();
            const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strAnswerId, "11", "3", this.Id_CurrEduCls);
            var returnBool6: boolean = !!responseText7;
            if (returnBool6 == true) {
                console.log("论文子观点数据总表同步成功；");
            }
  ...
  */
    ...
    public PutDataTogs_AnswerCountClass(pobjgs_AnswerCountEN: clsgs_AnswerCountEN) {
        ...
        pobjgs_AnswerCountEN.dataUser = clsPubSessionStorage.GetSession_UserId();// 修改人
        pobjgs_AnswerCountEN.userName = clsPubSessionStorage.GetSession_UserName();// 修改人

        pobjgs_AnswerCountEN.dataAddDate = clsPubFun4Web.getNowDate();// 修改日期

        pobjgs_AnswerCountEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改人
        pobjgs_AnswerCountEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
        //是否提交
