 ...
 界面名:CurrEduClsStuCRUD(01120075)
 生成代码版本:2020.05.09.1
 生成日期:2020/05/12 09:53:20
 生成者:
 工程名称:问卷调查
 工程ID:0112
...
namespace ExamLib.Pages
{
 ...
 /// </summary>
public class CurrEduClsStuCRUDModel : PageModel
{

public string Message { get; set; }
public void OnGet()
{
Message = "CurrEduClsStuCRUD(教学班与学生关系表CRUD)(01120075)页面.";
}
