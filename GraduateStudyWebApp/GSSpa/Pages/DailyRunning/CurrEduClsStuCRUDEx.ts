...
import { CurrEduClsStu_AddNewRecordAsync } from "../TS/L3_ForWApi/DailyRunning/clsCurrEduClsStuWApi.js";
import { vCurrEduClsStu_GetObjLstByPagerAsync, vCurrEduClsStu_GetRecCountByCondAsync, vCurrEduClsStu_IsExistRecordAsync } from "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js";
...
import { StudentInfo_GetFirstObjAsync } from "../TS/L3_ForWApi/UserManage/clsStudentInfoWApi.js";
import { clsCommonFunc4Web } from "../TS/PubFun/clsCommonFunc4Web2.js";
import { clsDataColumn } from "../TS/PubFun/clsDataColumn.js";
import { clsPublocalStorage } from "../TS/PubFun/clsPublocalStorage.js";
import { clsPubSessionStorage } from "../TS/PubFun/clsPubSessionStorage.js";
import { stuPagerPara } from "../TS/PubFun/stuPagerPara.js";
import { CurrEduClsStuCRUD } from "./CurrEduClsStuCRUD.js";
...
*/
export class CurrEduClsStuCRUDEx extends CurrEduClsStuCRUD {
...
*/
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        var objPage: CurrEduClsStuCRUDEx = new CurrEduClsStuCRUDEx();
...
*/
    public async PutDataToCurrEduClsStu(pobjCurrEduClsStuEN: clsCurrEduClsStuEN, strid_CurrEduCls: string) {
        ...
        pobjCurrEduClsStuEN.modifyDate = clsPubFun4Web.getNowDate();// 
    ...
    public CombinevCurrEduClsStuCondition(): string {
        ...
        try {
            ...
            if (strRoleId == "00620001") {
                ...
                strWhereCond += " and stuID in (select stuID from vCurrEduClsStu where id_CurrEduCls = '" + clsPublocalStorage.Getid_CurrEduCls() + "')";
            }
            else {
                ////学生； 
