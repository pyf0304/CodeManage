...
*/
export class OriginalPaperAddideas implements clsOperateList{
   ...
   */
    ...
    public async GetPaperData() {
        ...
        var arrvUsersObjLst: Array<clsvUsersSimEN> = await vUsersSim_GetObjLst_Cache();
 ...
 */
  ...
  */
    public async BindGv_vRTExpegs_PViewpointRela() {
        ...
        try {
            const responseRecCount = await vgs_PViewpointRela_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
 ...
 */
    public BindTab_vViewpoint(divContainer: string, arrvViewpointObjLst: Array<clsvViewpointEN>) {
        ...
        clsCommonFunc4Web.BindTabV2Where(o, arrvViewpointObjLst, arrDataColumn, "viewpointId", "TopicViewpoint");
 ...
 */
    public PutDataTogs_PViewpointRelaClass(pobjgs_PViewpointRelaEN: clsgs_PViewpointRelaEN) {
        ...
        pobjgs_PViewpointRelaEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
...
*/
    public async BindGv_vgs_PConceptRela() {
        ...
        try {
            const responseRecCount = await vgs_PConceptRela_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
                this.RecCount = jsonData;
            });
            var objPagerPara: stuPagerPara = {
                pageIndex: intCurrPageIndex,
...
*/
    public async BindGv_vgs_PTopicObjectiveRela() {
        ...
        try {
            const responseRecCount = await vgs_PTopicObjectiveRela_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
                this.RecCount = jsonData;
            });
            var objPagerPara: stuPagerPara = {
                pageIndex: intCurrPageIndex,
...
*/
    public async BindGv_vgs_PSkillRela() {
        ...
        try {
            const responseRecCount = await vgs_PSkillRela_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
                this.RecCount = jsonData;
            });
            var objPagerPara: stuPagerPara = {
                pageIndex: intCurrPageIndex,
...
*/
    public BindTab_vgs_PSkillRela(arrvgs_PSkillRelaObjLst: Array<clsvgs_PSkillRelaEN>, arrvUsersObjLst: Array<clsvUsersSimEN>) {
...
*/
    public async BindGv_vgs_PSocialRela() {
        ...
        //var arrvUsersObjLst: Array<clsvUsersSimEN> = [];
        try {
            const responseRecCount = await vgs_PSocialRela_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
                this.RecCount = jsonData;
            });
            var objPagerPara: stuPagerPara = {
                pageIndex: intCurrPageIndex,
