...
import { gs_PaperGroup_AddNewRecordAsync, gs_PaperGroup_Delgs_PaperGroupsAsync, gs_PaperGroup_DelRecordAsync, gs_PaperGroup_GetMaxStrIdAsync, gs_PaperGroup_GetObjByPaperGroupIdAsync, gs_PaperGroup_GetObjLstAsync, gs_PaperGroup_GetObjLstByPagerAsync, gs_PaperGroup_GetObjLstByPager_Cache, gs_PaperGroup_GetObjLstByPaperGroupIdLstAsync, gs_PaperGroup_GetRecCountByCondAsync, gs_PaperGroup_GetRecCountByCond_Cache, gs_PaperGroup_GetSubObjLst_Cache, gs_PaperGroup_SortFun_Defa } from "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
...
**/
export abstract class gs_PaperGroupCRUD1 implements clsOperateList {
    public static objPage_CRUD: gs_PaperGroupCRUD1;
    ...
    **/
    public async ExportExcel_gs_PaperGroup_Cache() {
        ...
        objgs_PaperGroup_Cond.SetCondFldValue(clsgs_PaperGroupEN.con_UpdUser, gs_PaperGroupCRUD1.strUpdUser_Cache, "=");
        const strWhereCond = JSON.stringify(objgs_PaperGroup_Cond);
        const intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager);//获取当前页
        let arrgs_PaperGroupObjLst: Array<clsgs_PaperGroupEN> = [];
        try {
            this.RecCount = await gs_PaperGroup_GetRecCountByCond_Cache(objgs_PaperGroup_Cond, gs_PaperGroupCRUD1.strUpdUser_Cache);
            if (this.RecCount == 0) {
                const lblMsg: HTMLSpanElement = <HTMLSpanElement>document.createElement("span");
            ...
            arrgs_PaperGroupObjLst = await gs_PaperGroup_GetSubObjLst_Cache(objgs_PaperGroup_Cond, gs_PaperGroupCRUD1.strUpdUser_Cache);
        }
        catch (e) {
            const strMsg = clsString.Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
            console.error(strMsg);
        ...
        if (arrgs_PaperGroupObjLst.length == 0) {
            const strKey = clsString.Format("{0}_{1}", clsgs_PaperGroupEN._CurrTabName, gs_PaperGroupCRUD1.strUpdUser_Cache);
    ...
    **/
    public async BindGv_gs_PaperGroup_Cache() {
        ...
        try {
            ...
            arrgs_PaperGroupObjLst = await gs_PaperGroup_GetObjLstByPager_Cache(objPagerPara, gs_PaperGroupCRUD1.strUpdUser_Cache);
        }
        catch (e) {
            const strMsg = clsString.Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
            console.error(strMsg);
