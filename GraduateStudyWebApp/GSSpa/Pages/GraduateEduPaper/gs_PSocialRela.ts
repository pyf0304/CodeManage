...
*/
export class gs_PSocialRela implements clsOperateList{
   ...
   */
    public async AddNewRecordWithMaxIdSave() {
        ...
        try {
            ...
            if (clsString.IsNullOrEmpty(responseText2) == false)
            {
...
*/
    public PutDataTogs_PSocialRelaClass(pobjgs_PSocialRelaEN: clsgs_PSocialRelaEN) {
        ...
        pobjgs_PSocialRelaEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
