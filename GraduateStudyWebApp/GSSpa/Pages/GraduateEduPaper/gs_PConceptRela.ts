...
*/
export class gs_PConceptRela implements clsOperateList{
    //论文列表
...
*/
   ...
   */
    public BindTab_Concept(divContainer: string, arrConceptObjLst: Array<clsvConceptEN>) {
        ...
        clsCommonFunc4Web.BindTabV2Where(o, arrConceptObjLst, arrDataColumn, "conceptId", "TopicConcept");
...
*/
   ...
   */
    public PutDataTogs_PConcepRelaClass(pobjgs_PConcepRelaEN: clsgs_PConcepRelaEN) {
        ...
        pobjgs_PConcepRelaEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
