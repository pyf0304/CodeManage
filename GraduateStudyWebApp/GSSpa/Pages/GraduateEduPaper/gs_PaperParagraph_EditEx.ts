...
import { gs_PaperParagraphV_AddNewRecordAsync, gs_PaperParagraphV_GetFirstObjAsync, gs_PaperParagraphV_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphVWApi.js";
...
import { gs_PaperParagraph_Edit } from "./gs_PaperParagraph_Edit.js";
declare function ShowDialog_gs_PaperParagraph(strOpType): void;
declare function HideDialog_vgs_PaperParagraph(): void;
...
*/
   ...
   */
    public async AddNewRecordWithMaxIdSave() {
        ...
        objgs_PaperParagraphEN.createDate = clsPubFun4Web.getNowDate_ymd();// 修改日期
        objgs_PaperParagraphEN.createUser = clsPubSessionStorage.GetSession_UserId();//用户
 ...
 */
    public PutDataTogs_PaperParagraphClass(pobjgs_PaperParagraphEN: clsgs_PaperParagraphEN) {
        ...
        pobjgs_PaperParagraphEN.updDate = clsPubFun4Web.getNowDate_ymd();// 修改日期
        pobjgs_PaperParagraphEN.updUser = clsPubSessionStorage.GetSession_UserId();//用户
...
*/
    public async UpdateRecordSave() {
       ...
       // var intVersionCount = await gs_PaperParagraphV_GetRecCountByCondAsync(strWhereCond2);
        const responseText = await gs_PaperParagraphV_GetFirstObjAsync(strWhereCond2).then((jsonData) => {
            var objgs_PaperParagraphVEN: clsgs_PaperParagraphVEN = <clsgs_PaperParagraphVEN>jsonData;
...
*/
    ...
    public async AddVersionRecordSave() {
        this.DivName = "divUpdateRecordSave";
        var objgs_PaperParagraphVEN: clsgs_PaperParagraphVEN = new clsgs_PaperParagraphVEN();
        ...
        try {
            const responseText2 = await gs_PaperParagraphV_AddNewRecordAsync(objgs_PaperParagraphVEN);
 ...
 <param name = "pobjgs_PaperParagraphEN">数据传输的目的类对象</param>
*/
    public PutDataTogs_PaperParagraphVClass(pobjgs_PaperParagraphEN: clsgs_PaperParagraphVEN) {
        //存放论文ID
        var strPaperId = $("#hidPaperId").val();
        //段落ID
        //var strParagraphId = $("#hidParagraphId").val();
