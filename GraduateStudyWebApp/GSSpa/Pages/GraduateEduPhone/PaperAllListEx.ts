...
*/
export class PaperAllListEx extends Paper_QUDI_TS {
...
*/
    public async BindGv_vPaper() {
        ...
        try {
            ...
            this.RecCount = await vPaperSimEx_GetRecCountByCondById_CurrEduCls_Cache(objvPaperSim_Cond, clsPublocalStorage.Getid_CurrEduCls());
            console.log("完成计数!");
            arrvPaperSimObjLst = await vPaperSimEx_GetObjLstByPagerById_CurrEduCls_Cache(objPagerPara, clsPublocalStorage.Getid_CurrEduCls());
