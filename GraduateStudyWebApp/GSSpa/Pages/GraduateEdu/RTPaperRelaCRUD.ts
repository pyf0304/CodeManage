...
import { RTPaperRela_AddNewRecordAsync, RTPaperRela_DelRecordAsync, RTPaperRela_DelRTPaperRelasAsync, RTPaperRela_GetObjBymIdAsync, RTPaperRela_GetObjLstBymIdLstAsync, RTPaperRela_ReFreshCache } from "../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { vRTPaperRela_GetObjLstAsync, vRTPaperRela_GetObjLstByPagerAsync, vRTPaperRela_GetRecCountByCondAsync, vRTPaperRela_GetRecCountByCond_Cache, vRTPaperRela_GetSubObjLst_Cache, vRTPaperRela_SortFun_Defa } from "../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
...
var objEN: object = arrvRTPaperRelaObjLst[i];
for (var j = 0; j < intColNum; j++)
{
...
var strFileName = clsString.Format("RTPaperRela({0})导出.xlsx",
...
lblMsg.innerHTML = clsString.Format("根据条件:[{0}]获取的对象列表数为0！", objvRTPaperRela_Cond.whereCond);
...
var strMsg: string = `在绑定Gv_Cache过程中，根据条件:[${objvRTPaperRela_Cond.whereCond}]获取的对象列表数为0！`;
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
var arrvRTPaperRelaObjLst = await vRTPaperRela_GetSubObjLst_Cache(objvRTPaperRela_Cond);
}
catch(e)
{
...
{
var strKey:string = `${clsRTPaperRelaEN._CurrTabName}`;
...
var arrvRTPaperRelaObjLst = await vRTPaperRela_GetObjLstAsync(strWhereCond);
}
catch(e)
{
var strMsg: string = `绑定GridView不成功,${e}.`;
...
try
{
const responseText = await RTPaperRela_DelRecordAsync(lngmId);
...
{
var strMsg:string = `(errid:WiTsCs0009)在组合查询条件(CombineRTPaperRelaCondition)时出错!请联系管理员!${objException}`;
throw strMsg;
}
return strWhereCond;
}
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj)
  <returns>条件串(strWhereCond)</returns>
*/
 public CombinevRTPaperRelaConditionObj():clsvRTPaperRelaEN 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && userName = '张三'
var strWhereCond: string = " 1 = 1 ";
var objvRTPaperRela_Cond: clsvRTPaperRelaEN = new clsvRTPaperRelaEN();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
}
...
{
var strMsg:string = `(errid:WiTsCs0010)在组合查询条件对象(CombineRTPaperRelaConditionObj)时出错!请联系管理员!${objException}`;
throw strMsg;
}
...
return objvRTPaperRela_Cond;
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj4ExportExcel)
  <returns>条件串(strWhereCond)</returns>
*/
 public CombinevRTPaperRelaConditionObj4ExportExcel():clsvRTPaperRelaEN 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && userName = '张三'
var strWhereCond: string = " 1 = 1 ";
...
{
var strMsg:string = `(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTPaperRelaConditionObj4ExportExcel)时出错!请联系管理员!${objException}`;
throw strMsg;
}
objvRTPaperRela_Cond.whereCond = strWhereCond;
return objvRTPaperRela_Cond;
...
clsCommonFunc4Web.BindTabV4(o, arrvRTPaperRelaObjLst, arrDataColumn, "mId", this); 
...
orderBy: this.hidSortvRTPaperRelaBy,//如果该字段为空，就使用下面的排序函数
...
var arrvRTPaperRelaObjLst = await vRTPaperRela_GetObjLstByPagerAsync(objPagerPara);
}
catch(e)
{
var strMsg: string = `绑定GridView不成功,${e}.`;
...
try
{
const responseText = await RTPaperRela_GetObjLstBymIdLstAsync(arrmId);
console.log('responseText=');
console.log(responseText);
var intCount:number = 0;
var arrRTPaperRelaObjLst: Array <clsRTPaperRelaEN> = <Array<clsRTPaperRelaEN>> responseText;
for (let objInFor of arrRTPaperRelaObjLst)
{
const responseText2 = await RTPaperRela_AddNewRecordAsync(objInFor);
...
try
{
const responseText = await RTPaperRela_DelRTPaperRelasAsync(arrmId);
var returnInt: number = responseText;
if (returnInt > 0)
{
RTPaperRela_ReFreshCache();
