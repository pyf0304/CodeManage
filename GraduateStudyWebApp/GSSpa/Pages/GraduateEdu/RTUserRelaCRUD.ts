...
import { RTUserRela_AddNewRecordAsync, RTUserRela_DelRecordAsync, RTUserRela_DelRTUserRelasAsync, RTUserRela_GetObjBymIdAsync, RTUserRela_GetObjLstBymIdLstAsync, RTUserRela_ReFreshCache } from "../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js";
import { vRTUserRela_GetObjLstAsync, vRTUserRela_GetObjLstByPagerAsync, vRTUserRela_GetObjLstByPager_Cache, vRTUserRela_GetRecCountByCondAsync, vRTUserRela_GetRecCountByCond_Cache, vRTUserRela_GetSubObjLst_Cache, vRTUserRela_SortFun_Defa } from "../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js";
...
public static strTopicId_Cache: string = "99999991";//缓存分类字段
...
var objEN: object = arrvRTUserRelaObjLst[i];
for (var j = 0; j < intColNum; j++)
{
...
var strFileName = clsString.Format("主题用户关系({0})导出.xlsx",
...
objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN.con_TopicId, RTUserRelaCRUD.strTopicId_Cache, "=");
    var strWhereCond = JSON.stringify(objvRTUserRela_Cond);
var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager);//获取当前页
 var arrvRTUserRelaObjLst: Array <clsvRTUserRelaEN> = [];
try
{
this.RecCount = await vRTUserRela_GetRecCountByCond_Cache(objvRTUserRela_Cond, RTUserRelaCRUD.strTopicId_Cache);
if (this.RecCount == 0)
{
var lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = clsString.Format("根据条件:[{0}]获取的对象列表数为0！", objvRTUserRela_Cond.whereCond);
...
var strMsg: string = `在绑定Gv_Cache过程中，根据条件:[${objvRTUserRela_Cond.whereCond}]获取的对象列表数为0！`;
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
var arrvRTUserRelaObjLst = await vRTUserRela_GetSubObjLst_Cache(objvRTUserRela_Cond, RTUserRelaCRUD.strTopicId_Cache);
}
catch(e)
{
...
{
var strKey:string = `${clsRTUserRelaEN._CurrTabName}_${ RTUserRelaCRUD.strTopicId_Cache }`;
...
var arrvRTUserRelaObjLst = await vRTUserRela_GetObjLstAsync(strWhereCond);
}
catch(e)
{
var strMsg: string = `绑定GridView不成功,${e}.`;
...
/// </summary>
public async SetDdl_id_XzCollege()
{
...
/// 设置绑定下拉框，针对字段:[id_XzMajor]
 /// (AGC.PureClassEx.clsASPDropDownListBLEx_Static:GC_SetBindDdl_TS4QryRegion)
/// </summary>
public async SetDdl_id_XzMajor()
{
 var objXzMajor_Cond: clsXzMajorEN = new clsXzMajorEN();//查询区域
    const ddlid_XzMajor_q = await XzMajor_BindDdl_id_XzMajor_Cache(this.divName4List, "ddlid_XzMajor_q");//查询区域
}
...
try
{
const responseText = await RTUserRela_DelRecordAsync(lngmId);
var returnInt: number = responseText;
if (returnInt > 0)
{
RTUserRela_ReFreshCache(RTUserRelaCRUD.strTopicId_Cache);
...
try
{
const responseText = await RTUserRela_GetObjBymIdAsync(lngmId);
var objRTUserRelaEN: clsRTUserRelaEN = <clsRTUserRelaEN>responseText;
console.log("完成SelectRecord!");
clsCommonFunc4Web.Redirect("/Index/Main_vRTUserRela");
}
catch(e)
{
...
{
var strMsg:string = `(errid:WiTsCs0009)在组合查询条件(CombineRTUserRelaCondition)时出错!请联系管理员!${objException}`;
throw strMsg;
}
return strWhereCond;
}
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj)
  <returns>条件串(strWhereCond)</returns>
*/
 public CombinevRTUserRelaConditionObj():clsvRTUserRelaEN 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && userName = '张三'
var strWhereCond: string = " 1 = 1 ";
...
{
var strMsg:string = `(errid:WiTsCs0010)在组合查询条件对象(CombineRTUserRelaConditionObj)时出错!请联系管理员!${objException}`;
throw strMsg;
}
...
return objvRTUserRela_Cond;
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj4ExportExcel)
  <returns>条件串(strWhereCond)</returns>
*/
 public CombinevRTUserRelaConditionObj4ExportExcel():clsvRTUserRelaEN 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && userName = '张三'
var strWhereCond: string = " 1 = 1 ";
...
{
var strMsg:string = `(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTUserRelaConditionObj4ExportExcel)时出错!请联系管理员!${objException}`;
throw strMsg;
}
objvRTUserRela_Cond.whereCond = strWhereCond;
return objvRTUserRela_Cond;
...
clsCommonFunc4Web.BindTabV4(o, arrvRTUserRelaObjLst, arrDataColumn, "mId", this); 
...
orderBy: this.hidSortvRTUserRelaBy,//如果该字段为空，就使用下面的排序函数
...
var arrvRTUserRelaObjLst = await vRTUserRela_GetObjLstByPager_Cache(objPagerPara, RTUserRelaCRUD.strTopicId_Cache);
}
catch(e)
{
var strMsg: string = `绑定GridView不成功,${e}.`;
...
try
{
const responseText = await RTUserRela_GetObjLstBymIdLstAsync(arrmId);
console.log('responseText=');
console.log(responseText);
var intCount:number = 0;
var arrRTUserRelaObjLst: Array <clsRTUserRelaEN> = <Array<clsRTUserRelaEN>> responseText;
for (let objInFor of arrRTUserRelaObjLst)
{
const responseText2 = await RTUserRela_AddNewRecordAsync(objInFor);
...
try
{
const responseText = await RTUserRela_DelRTUserRelasAsync(arrmId);
var returnInt: number = responseText;
if (returnInt > 0)
{
RTUserRela_ReFreshCache(RTUserRelaCRUD.strTopicId_Cache);
...
var sstrKeys = clsCommonFunc4Web.GetObjKeys(objRTUserRela);
