...
*/
export class AddOriginalPaperEx extends Paper_QUDI_TS {
            ...
            if (clsPubSessionStorage.GetSession_UserId() != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strPaperId, "01", "1", this.Id_CurrEduCls);
