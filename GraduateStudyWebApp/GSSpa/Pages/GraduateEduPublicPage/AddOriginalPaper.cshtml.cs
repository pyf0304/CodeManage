...
namespace GraduateStudyWebApp.Pages.GraduateEduPublicPage
{
    public class AddOriginalPaperModel : PageModel
    {
        public string Message { get; set; }
        public void OnGet()
        {
            Message = "TopicObjectiveCRUD(主题客观依据表CRUD)(01120110)页面.";
        }
