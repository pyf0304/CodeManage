...
export class CommentScore {
   ...
   */
    ...
    public async Bind_PaperTags() {
        ...
        var strWhereCond4 = " 1=1 and updUser='" + strUserId + "' and id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "' order by updDate desc";

        //var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager);//获取当前页

        //打分0045 表示标记打分（教师专属）
        var strWhereCond5 = " 1=1 and userId='" + strUserId + "' And scoreTypeId ='0045' And id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "'";
    ...
    public async CurrEduClsStuTree() {
        ...
        var strWhereCond1 = " id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "'";//得到评论表的条件；

        //得到讨论表的条件；010203代表属于讨论的类型；
        var strWhereCond3 = " id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "' And answerTypeId in ('01','02','03')";
        //打分00041 0042 表示讨论打分 和评价打分（教师专属）
        var strWhereCond4 = " scoreTypeId in('0041','0042','0045') And id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "'";
    ...
    public async Bind_Qa_Answer() {
        ...
        var strId_CurrEducls = clsPublocalStorage.Getid_CurrEduCls();
        //得到讨论表的条件；010203代表属于讨论的类型；
        var strWhereCond3 = " 1=1 and updUser='" + strUserId + "' and id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "' And answerTypeId in ('01','02','03') order by updDate desc";
        var strWhereCond4 = " 1=1 and updUser='" + strUserId + "' and id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "'";

        //var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager);//获取当前页

        //打分00041 0042 表示讨论打分 和评价打分（教师专属）
        var strWhereCond5 = " 1=1 and userId='" + strUserId + "' And scoreTypeId ='0041' And id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "'";
    ...
    public async Bind_SysComment() {
        ...
        //打分00041 0042 表示讨论打分 和评价打分（教师专属）
        var strWhereCond5 = " 1=1 and userId='" + strUserId + "' And scoreTypeId ='0042' And id_CurrEduCls='" + clsPublocalStorage.Getid_CurrEduCls() + "'";
    ...
    public async SubmitScore_Click() {
        try {
            ...
            objSysScoreSummaryEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
            if (strnum == "1") {
                //讨论
            ...
            objSysScoreSummaryEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
