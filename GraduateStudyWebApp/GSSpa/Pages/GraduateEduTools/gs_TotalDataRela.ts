...
*/
export class gs_TotalDataRela implements clsOperateList {
   ...
   */
    ...
    public async GetRelaId() {
        ...
        var objgs_TotalDataStatistics: clsgs_TotalDataStatisticsEN;

        try {
            objgs_TotalDataStatistics = await gs_TotalDataStatistics_GetFirstObjAsync(strWhereCond);
    ...
    public async btnDelgs_TotalDataRela(strKeyId: string) {
        try {
            ...
            objgs_TotalDataStatistics = await gs_TotalDataStatistics_GetFirstObjAsync(strWhereCond1);

            if (objgs_TotalDataStatistics != null) {
                var strWhereCond2 = " totalDataId1=" + strTotalDataId1 + " and totalDataId2 =" + objgs_TotalDataStatistics.totalDataId;

                var objgs_TotalDataRela: clsgs_TotalDataRelaEN = await gs_TotalDataRela_GetFirstObjAsync(strWhereCond2);
    ...
    public async btnAddgs_TotalDataRela(strKeyId: string) {
        ...
        var strWhereCond1 = " totalDataTypeId='" + strLiTypeId + "' and tableKey ='" + strKeyId + "'";
        var objgs_TotalDataStatistics: clsgs_TotalDataStatisticsEN = await gs_TotalDataStatistics_GetFirstObjAsync(strWhereCond1);
        ...
        try {
            if (objgs_TotalDataStatistics != null) {
                ...
                objgs_TotalDataRelaEN.updDate = clsPubFun4Web.getNowDate();
                objgs_TotalDataRelaEN.updUser = clsPubSessionStorage.GetSession_UserId();
                objgs_TotalDataRelaEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
