...
界面名:SysScoreSummaryCRUD(01120115)
生成代码版本:2020.04.17.1
生成日期:2020/04/22 17:34:07
生成者:
工程名称:问卷调查
工程ID:0112
...
namespace GraduateStudyWebApp.Pages.GraduateEduTools
{
    /// <summary>
    /// SysScoreSummary_QUDI_TS 的摘要说明。其中Q代表查询,U代表修改
    /// (AutoGCLib.WA_ViewScriptCSModel_TS4CSharp:GeneCode)
    /// </summary>
    public class SysScoreSummary_QUDI_TSModel : PageModel
    {

        public string Message { get; set; }
        public void OnGet()
        {
            Message = "SysScoreSummaryCRUD(系统分数汇总表CRUD)(01120115)页面.";
        }
