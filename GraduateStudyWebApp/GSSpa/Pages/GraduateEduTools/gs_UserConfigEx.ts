...
import { clsvgs_UserConfigEN } from "../TS/L0_Entity/GraduateEduTools/clsvgs_UserConfigEN.js";
...
import { vgs_UserConfig_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTools/clsvgs_UserConfigWApi.js";
...
*/
export class gs_UserConfigEx implements clsOperateList {
   ...
   */
    ...
    public async SelectConfigAddSave() {
        try {
            const responseText2 = await gs_UserConfigEx_GetAddConfig(clsPubSessionStorage.GetSession_UserId());
