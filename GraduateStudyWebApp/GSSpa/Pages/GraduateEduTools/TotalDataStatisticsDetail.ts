...
*/
export class TotalDataStatisticsDetail implements clsOperateList implements IShowList {
   ...
   */
    ...
    public async Page_Load() {
        ...
        try {
            ...
            if (clsPublocalStorage.Getid_CurrEduCls() != "" || strId_CurrEduCls != "") {
                var strId_CurrEduCls = $("#hidId_CurrEduClspara").val();
                if (strId_CurrEduCls != "") {
                    $("#topTitle").hide();
                }
  ...
  */
    public async BindGv_vSysScoreSummary() {
        ...
        if (hidId_CurrEduCls == "") {
            ...
            hidId_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
        }
...
*/
    public Combinegs_TotalConditionDetailObj(): clsgs_TotalDataStatisticsEN {
        ...
        try {
            ...
            if (strUserId == "") {
                //  strWhereCond += " and dataUser ='" + clsPubSessionStorage.GetSession_UserId() + "'";
                var strSessionUserId = clsPubSessionStorage.GetSession_UserId();
