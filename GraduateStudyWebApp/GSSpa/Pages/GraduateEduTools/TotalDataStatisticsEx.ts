...
import { vCurrEduClsStu_GetSubObjLst_Cache } from "../TS/L3_ForWApi/DailyRunning/clsvCurrEduClsStuWApi.js";
...
*/
export class TotalDataStatisticsEx implements IShowList {
    ...
    public async Page_Load() {
        ...
        try {
            if (clsPublocalStorage.Getid_CurrEduCls() != "") {
                ...
                await gs_TotalDataType_BindDdl_TotalDataTypeIdInDiv_Cache("", "ddlTotalDataTypeId_q");
