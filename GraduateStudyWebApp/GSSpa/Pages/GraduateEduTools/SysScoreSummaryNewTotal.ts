...
//import * as QQ from "q";
import { SysScoreSummary_QUDI_TS } from "../GraduateEduTools/SysScoreSummary_QUDI_TS.js";
...
*/
export class SysScoreSummaryNewTotal extends SysScoreSummary_QUDI_TS {
  ...
  */
    public CombinevSysScoreSummaryCondition(): string {
        ...
        try {
            ...
            if (clsPubSessionStorage.GetSession_RoleId() == "00620003") {
                ...
                strWhereCond += " and userId ='" + clsPubSessionStorage.GetSession_UserId() + "'";
            }
            else {
                //管理员 教师 
   ...
   */
    public async BindGv_vSysScoreSummary() {
        ...
        if (Id_CurrEduCls == "") {
            Id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
        }
