 ...
 界面名:CacheUseStateCRUD(00050292)
 生成代码版本:2020.06.17.1
...
namespace GraduateStudyWebApp.Pages.Web
{
 /// <summary>
 /// CacheUseStateCRUD 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewScriptCSModel_TS4CSharp:GeneCode)
 /// </summary>
public class CacheUseStateCRUDModel : PageModel
{

public string Message { get; set; }
public void OnGet()
{
Message = "CacheUseStateCRUD(缓存使用状态CRUD)(00050292)页面.";
}
