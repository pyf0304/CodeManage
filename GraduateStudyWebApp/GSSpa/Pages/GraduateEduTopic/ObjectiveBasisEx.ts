...
import { ObjectiveBasis } from "./ObjectiveBasis.js";
...
import { TopicObjectiveV_AddNewRecordAsync, TopicObjectiveV_DelTopicObjectiveVsAsync, TopicObjectiveV_GetObjLstAsync, TopicObjectiveV_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveVWApi.js";
    ...
    public async Page_Load() {
        ...
        try {
            ...
            if (clsPubSessionStorage.GetSession_UserId() != "") {
                ...
                const ddlObjectiveUserId_q = await clsDropDownList.BindDdl_UserIdInvTopicObjectiveBasis_Cache("ddlObjectiveUserId_q", objUsers_Cond);
            ...
            if (clsPubSessionStorage.GetSession_UserId() != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "08", "1", this.Id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        var strTopicObjectiveId = $('#hidObjectiveId').val();
                        const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "08", "2", this.Id_CurrEduCls);
...
*/
    public async btnAddNewRecord_Click() {
        ...
        try {
            ...
            //获取分享Id
            const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("08", clsPubSessionStorage.GetSession_UserId());
...
*/
    ...
    public PutDataToPaperAttachmentClass(pobjObjectiveAttachmentEN: clsObjectiveAttachmentEN, filePath: string) {
        ...
        pobjObjectiveAttachmentEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();//教学班
...
*/
  ...
  */
    public async btnDelRecordInTab_Click(strKeyId: string) {
        try {
            ...
            if (RTVCount > 0) {
                ...
                const responseText1 = await TopicObjectiveV_GetObjLstAsync(strTopicObjectiveVWhereCond).then((jsonData) => {
                ...
                const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strSubViewpointId, "08", "3", this.Id_CurrEduCls);
                var returnBool7: boolean = !!responseText7;
                if (returnBool7 == true) {
    ...
    public VDelMultiRecord(arrTopicObjectiveVId: Array<string>) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = TopicObjectiveV_DelTopicObjectiveVsAsync(arrTopicObjectiveVId).then((jsonData) => {
...
*/
  ...
  */
    public PutDataToTopicObjectiveVClass(pobjTopicObjectiveVEN: clsTopicObjectiveVEN) {
        ...
        pobjTopicObjectiveVEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
   ...
   */
    public PutDataToTopicObjectiveClass(pobjTopicObjectiveEN: clsTopicObjectiveEN) {
        ...
        pobjTopicObjectiveEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();;
