...
import { vRTUserRela_GetObjBymIdAsync, vRTUserRela_GetObjLstByPagerAsync, vRTUserRela_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js";
import { clsCommonFunc4Web } from "../TS/PubFun/clsCommonFunc4Web2.js";
import { clsDataColumn } from "../TS/PubFun/clsDataColumn.js";
import { clsPubSessionStorage } from "../TS/PubFun/clsPubSessionStorage.js";
import { stuPagerPara } from "../TS/PubFun/stuPagerPara.js";
import { RTUserRela_QUDI } from "./RTUserRela_QUDI.js";
...
*/
export class RTUserRela_QUDIEx extends RTUserRela_QUDI {
...
*/
    public RtUserRelaDetailRecord(lngmId: number) {

        this.KeyId = lngmId.toString();
        return new Promise((resolve, reject) => {
            try {
                const responseText = vRTUserRela_GetObjBymIdAsync(lngmId).then((jsonData) => {
                    var objRTUserRelaEN: clsvRTUserRelaEN = <clsvRTUserRelaEN>jsonData;
                    // //显示当前数据；
