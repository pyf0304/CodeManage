...
import { gs_ViewsClassificationCRUD } from "./gs_ViewsClassificationCRUD.js";
    ...
    */
    ...
    public async BindDdl_ClassificationId(ddlClassificationId: string) {
        ...
        try {
            ...
            clsCommonFunc4Web.BindDdl_ObjLst(ddlClassificationId, arrObjLst_Sel, clsgs_ViewsClassificationEN.con_ClassificationId, clsgs_ViewsClassificationEN.con_ClassificationName, "观点分类");
...
*/
    public Update_RTViewpointRela(): Promise<boolean> {
  ...
  (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_UpdateRecordSave)
*/
    public Update_RTConceptRela(): Promise<boolean> {
  ...
  (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_UpdateRecordSave)
*/
    public Update_RTTopicObjectiveRela(): Promise<boolean> {
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_UpdateRecordSave)
*/
    public Update_RTSysSkillRela(): Promise<boolean> {
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_UpdateRecordSave)
*/
    public Update_RTSysSocialRela(): Promise<boolean> {
