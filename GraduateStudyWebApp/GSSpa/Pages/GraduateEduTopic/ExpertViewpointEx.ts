...
import { ExpertViewpoint } from "./ExpertViewpoint.js";
...
*/
export class ExpertViewpointEx extends ExpertViewpoint {
    ...
    public async Page_Load() {
        ...
        try {
            ...
            if (strUserId != "") {
                ...
                const ddlViewPointUserId_q = await clsDropDownList.BindDdl_UserIdInvExpertviewpoint_Cache("ddlViewPointUserId_q", objUsers_Cond); // this.BindDdl_UserId("ddlUserId_q");
    ...
    public async btnDelRecordInTab_Click(strKeyId: string) {
        try {
            ...
            if (RTVCount > 0) {
                ...
                const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strSubViewpointId, "05", "3", this.Id_CurrEduCls);
  ...
  */
    public async btnAddNewRecord_Click() {
        ...
        try {
            ...
            //获取分享Id
            const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("05", clsPubSessionStorage.GetSession_UserId());
            ...
            if (clsPubSessionStorage.GetSession_UserId() != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "05", "1", this.Id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        //更新总表3个参数 主键、子表类型、页面操作类型；
                        var strTopicObjectiveId = $('#hidViewpointId').val();
                        const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "05", "2", this.Id_CurrEduCls);
                        var returnBool7: boolean = !!responseText7;
                        if (returnBool7 == true) {
