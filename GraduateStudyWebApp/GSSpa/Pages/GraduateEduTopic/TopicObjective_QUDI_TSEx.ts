...
*/
export class TopicObjective_QUDI_TSEx extends TopicObjective_QUDI_TS {
    //论文列表
            ...
            if (clsPubSessionStorage.GetSession_UserId() != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "07", "1", this.Id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        var strTopicObjectiveId = $('#hidObjectiveId').val();
                        const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "07", "2", this.Id_CurrEduCls);
...
*/
    public async btnAddNewRecord_Click() {
        ...
        try {
            ...
            const ddl_gs_Share = await gs_Share_BindDdl_ShareIdInDiv_Cache(this.divName4List, "ddlShareId");
            //获取分享Id
            const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("07", clsPubSessionStorage.GetSession_UserId());
    ...
    public async btnDelRecordInTab_Click(strKeyId: string) {
        try {
            ...
            if (RTVCount > 0) {
                ...
                const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "07", "3", this.Id_CurrEduCls);
                var returnBool6: boolean = !!responseText6;
                if (returnBool6 == true) {
                    console.log("客观数据总表同步成功；");
                }
