...
*/
export class QuoteAndGroupPaperEx implements clsOperateList{
    ...
    public CombinevPaperCondition(): string {
        ...
        try {
            ...
            if (strQuoteAndGroupId == "01") {
                strWhereCond += ` And ${clsvPaperEN.con_IsQuotethesis} = '1'`; //引用论文
            }
            else {
                strWhereCond += ` And ${clsvPaperEN.con_IsQuotethesis} = '0'`;//本组论文
            }
