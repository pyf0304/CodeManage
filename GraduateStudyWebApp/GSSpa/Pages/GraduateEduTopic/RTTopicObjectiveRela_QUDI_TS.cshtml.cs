 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:WApiRTTopicObjectiveRela_QUDI_TS
 界面名:RTTopicObjectiveRelaCRUD(01120111)
 生成代码版本:2020.03.20.1
 生成日期:2020/03/23 16:53:20
 生成者:
 工程名称:问卷调查
 工程ID:0112
...
{
 /// <summary>
 /// WApiRTTopicObjectiveRela_QUDI_TS 的摘要说明。其中Q代表查询,U代表修改
 /// (AutoGCLib.WA_ViewScriptCSModel_TS4CSharp:GeneCode)
 /// </summary>
public class RTTopicObjectiveRela_QUDI_TSModel : PageModel
{

public string Message { get; set; }
public void OnGet()
{
Message = "RTTopicObjectiveRelaCRUD(主题客观关系表CRUD)(01120111)页面.";
}
