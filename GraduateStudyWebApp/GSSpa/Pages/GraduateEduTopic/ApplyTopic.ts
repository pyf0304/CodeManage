...
import { CurrEduCls_GetObjByid_CurrEduCls_Cache } from "../TS/L3_ForWApi/DailyRunning/clsCurrEduClsWApi.js";
...
*/
export class ApplyTopic implements clsOperateList {
...
*/
    ...
    public CombineCondition1(): string {
        ...
        try {
            ...
            if (clsPublocalStorage.Getid_CurrEduCls() == "00000050") {
                ...
                strWhereCond += " and topicId not in(select topicId from RTUserRela where UserID='" + clsPubSessionStorage.GetSession_UserId() + "')";
            }
    ...
    public async BindGv_Topic() {
        ...
        try {
            ...
            if (arrvResearchTopicObjLst.length == 0) {
                ...
                const strid_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
                const objCurrEduCls = await CurrEduCls_GetObjByid_CurrEduCls_Cache(strid_CurrEduCls);
                const strMsg = clsString.Format("没有可申请的研究主题。当前教学班:[{0}].", objCurrEduCls?.eduClsName);
                alert(strMsg);
                return;
            }
            ...
            for (var i = 0; i < arrvResearchTopicObjLst.length; i++) {
                ...
                var streduClsName = clsPublocalStorage.GeteduClsName();
    ...
    public async btnApplyTopic_Click(topicId: string, updUser: string) {
        ...
        objsys_RequestPushEN.requestDate = clsPubFun4Web.getNowDate();//请求日期

        objsys_RequestPushEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
    ...
    public Combinesys_RequestPushCondition1(): string {
        ...
        try {
            //strWhereCond += " and id_CurrEduCls=" + clsPublocalStorage.Getid_CurrEduCls();
            strWhereCond += " and requesTypeId='02' and requestUser='" + clsPubSessionStorage.GetSession_UserId() + "' ";
        }
        catch (objException) {
    ...
    public Combinesys_RequestPushCondition2(): string {
        ...
        try {
            //strWhereCond += " and id_CurrEduCls=" + clsPublocalStorage.Getid_CurrEduCls();
            strWhereCond += " and requesTypeId='02' and receiveUser='" + clsPubSessionStorage.GetSession_UserId() + "' ";
        }
        catch (objException) {
            var strMsg: string = `(errid:WiTsCs0002)在组合查询条件(Combineqa_PaperCondition)时出错!请联系管理员!${objException}`;
            throw strMsg;
    ...
    public async BindGv_sys_RequestPush(requestStata: string) {
        ...
        try {
            ...
            //获取用户缓存数据
            arrUsers = await vUsersSim_GetObjLst_Cache();
 ...
 */
    public async btn_OK_Click(requestId: number, strTopicId: string, strRequestUser: string) {
        ...
        objsys_RequestPushEN.replyDate = clsPubFun4Web.getNowDate();
    ...
    public async AddNewTopicAndRecordSaveUserRela(strTopicId: string, strRequestUser: string) {
        ...
        objRTUserRelaEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
        objRTUserRelaEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改用户
