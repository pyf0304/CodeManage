...
import { vUsersSim_func, vUsersSim_GetObjLstByPagerAsync, vUsersSim_GetRecCountByCondAsync } from "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js";
import { CurrEduClsStuEx_BindDdl_id_CurrEduClsByStuIdInDiv_Cache, CurrEduClsStuEx_GetStuIDLstById_CurrEduCls } from "../TS/L3_ForWApiEx/DailyRunning/clsCurrEduClsStuExWApi.js";
import { CurrEduClsTeacherEx_BindDdl_id_CurrEduClsByTeacherIdInDiv_Cache, CurrEduClsTeacherEx_GetTeacherIdLstById_CurrEduCls } from "../TS/L3_ForWApiEx/DailyRunning/clsCurrEduClsTeacherExWApi.js";
...
*/
export class UsersLstSel extends QxUsers_QUDI_TS {
...
*/
    ...
    */
    public ShowDialog_Users(strOp) {
        //检查相关控件是否存在
        clsCommonFunc4Web.CheckControlExist(this.divName4Edit, "div", "divUserList");
   ...
   */
    public async BindDdl4EditRegion() {
        ...
        try {
            if (clsPubSessionStorage.GetSession_RoleName().indexOf('学生') > -1) {
                await CurrEduClsStuEx_BindDdl_id_CurrEduClsByStuIdInDiv_Cache("divQuery_UserSel", "ddlid_CurrEduCls", clsPubSessionStorage.GetSession_UserId());//编辑区域
            }
            else {
                await CurrEduClsTeacherEx_BindDdl_id_CurrEduClsByTeacherIdInDiv_Cache("divQuery_UserSel", "ddlid_CurrEduCls", clsPubSessionStorage.GetSession_UserId());//编辑区域
            }
        }
        catch (e) {
            console.error(e);
    ...
    public static CheckUserRole(): boolean {
        ...
        if (clsString.IsNullOrEmpty(UsersLstSel.objPage_Edit.TopicUserRole_q) == true) {
    ...
    public BindTab_vUsersQA(divContainer: string, arrvUsersObjLst: Array<clsvUsersEN>) {
        ...
        clsCommonFunc4Web.BindTabV2Where(o, arrvUsersObjLst, arrDataColumn, "userId", "TopicUsers");
...
*/
  ...
  */
    public async BindGv_QxUsers() {
        ...
        try {
            const responseRecCount = await vUsersSim_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
   ...
   */
    public BindTab_vUsersSim(divContainer: string, arrvUsersSimObjLst: Array<clsvUsersSimEN>) {
        var o: HTMLDivElement = document.getElementById(divContainer) as HTMLDivElement;
        if (o == null) {
            alert(`${divContainer}不存在！`);
            return;
        ...
        clsCommonFunc4Web.BindTabV2Where(o, arrvUsersSimObjLst, arrDataColumn, "userId", "TopicUser");
  ...
  */
    public async CombineUsersCondition(): Promise<string> {
        ...
        try {
            ...
            if (clsString.IsNullOrEmpty(this.id_CurrEduCls) == false) {
...
*/
        ...
        return new Promise((resolve, reject) => {
            try {
                const responseText = TopicUserRole_GetObjLst_Cache().then((jsonData) => {
                    ...
                    clsCommonFunc4Web.BindDdl_ObjLst(ddlTopicUserRole_q, arrTopicUserRoleObjLst, clsTopicUserRoleEN.con_TopicUserRoleId, clsTopicUserRoleEN.con_TopicUserRoleName, "角色");
    ...
    **/
    public get id_CurrEduCls(): string {
        ...
        clsCommonFunc4Web.CheckControlExist(this.divName4Query, "select", "ddlid_CurrEduCls");
        const strId = clsString.Format("select[id ^= 'ddlid_CurrEduCls']");
