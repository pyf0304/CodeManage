...
//import * as QQ from "q";
import { gs_ReflectLogCRUD } from "./gs_ReflectLogCRUD.js";
    ...
    public Combinegs_ReflectLogCondition(): string {
            ...
            try {
                ...
                if (clsPubSessionStorage.GetSession_RoleId() == "00620001") {
                    ...
                    //学生； 
                    strWhereCond += ` And ${clsgs_ReflectLogEN.con_UpdUser} = '${clsPubSessionStorage.GetSession_UserId()}'`;
                }
            }
            catch (objException) {
    ...
    public async Bindgs_ReflectLog(arrgs_ReflectLogObjLst: Array<clsgs_ReflectLogEN>, arrvUsersObjLst: Array<clsvUsersSimEN>) {
        ...
        for (var i = 0; i < arrgs_ReflectLogObjLst.length; i++) {
            ...
            if (clsPubSessionStorage.GetSession_RoleId() == "00620003") {
                //登录用户和upduser一致则显示；
                if (arrgs_ReflectLogObjLst[i].updUser == clsPubSessionStorage.GetSession_UserId()) {
