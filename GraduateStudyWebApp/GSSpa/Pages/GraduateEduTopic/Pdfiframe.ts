...
import { Users_GetObjLstAsync } from "../TS/L3_ForWApi/UserManage/clsUsersWApi.js";
import { vUsersSim_GetObjLst_Cache } from "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js";
import { vViewpointEx_GetAllVNumObjLstAsync } from "../TS/L3_ForWApiEx/GraduateEdu/clsvViewpointExWApi.js";
...
*/
export class Pdfiframe implements clsOperateList{
 ...
 */
    public async BindGv_vViewpoint(strUserTypeId: string) {
 ...
 */
   ...
   (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj)
    <returns>条件串(strWhereCond)</returns>
  */
    public CombineConceptCondition(): string {
        //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
        //例如 1 = 1 && userName = '张三'
        var strWhereCond: string = " 1 = 1 ";
        var strTopicId = $('#hidTopicId').val();
