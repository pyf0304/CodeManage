...
import { gs_TobeStudiedProblemV_AddNewRecordAsync, gs_TobeStudiedProblemV_GetFirstObjAsync, gs_TobeStudiedProblemV_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVWApi.js";
...
import { gs_TobeStudiedProblem_Edit } from "./gs_TobeStudiedProblem_Edit.js";
...
export class gs_TobeStudiedProblem_EditEx extends gs_TobeStudiedProblem_Edit {
   ...
   */
    ...
    public PutDataTogs_TobeStudiedProblemClass(pobjgs_TobeStudiedProblemEN: clsgs_TobeStudiedProblemEN) {
        ...
        pobjgs_TobeStudiedProblemEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
        pobjgs_TobeStudiedProblemEN.participant = $("#txtParticipant").val();// 参会者
        pobjgs_TobeStudiedProblemEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改人
  ...
  */
   ...
   */
    public async UpdateRecordSave() {
        ...
        const responseText = await gs_TobeStudiedProblemV_GetFirstObjAsync(strWhereCond2).then((jsonData) => {
            var objgs_TobeStudiedProblemVEN: clsgs_TobeStudiedProblemVEN = <clsgs_TobeStudiedProblemVEN>jsonData;
    ...
    public async AddVersionRecordSave() {
        this.DivName = "divUpdateRecordSave";
        var objgs_TobeStudiedProblemVEN: clsgs_TobeStudiedProblemVEN = new clsgs_TobeStudiedProblemVEN();

        this.PutDataTogs_TobeStudiedProblemVClass(objgs_TobeStudiedProblemVEN);

        try {
            const responseText2 = await gs_TobeStudiedProblemV_AddNewRecordAsync(objgs_TobeStudiedProblemVEN);
    ...
    public PutDataTogs_TobeStudiedProblemVClass(pobjgs_TobeStudiedProblemVEN: clsgs_TobeStudiedProblemVEN) {
        ...
        pobjgs_TobeStudiedProblemVEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
        pobjgs_TobeStudiedProblemVEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改人
        var strYmd = clsPubFun4Web.getNowDate_ymd();
        if (this.problemDate == "") {
