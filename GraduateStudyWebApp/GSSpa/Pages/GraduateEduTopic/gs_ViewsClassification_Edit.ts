...
import { gs_ViewsClassification_AddNewRecordAsync, gs_ViewsClassification_AddNewRecordWithMaxIdAsync, gs_ViewsClassification_CheckProperty4Update, gs_ViewsClassification_CheckPropertyNew, gs_ViewsClassification_GetObjByClassificationIdAsync, gs_ViewsClassification_IsExistAsync, gs_ViewsClassification_UpdateRecordAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
...
export abstract class gs_ViewsClassification_Edit {
   ...
   */
    ...
    public async AddDPV_Edit(divName4Edit) {
        var strUrl: string = "./gs_ViewsClassification_Edit/";
   ...
   */
    public async AddNewRecordSave() {
        ...
        var objgs_ViewsClassificationEN: clsgs_ViewsClassificationEN = new clsgs_ViewsClassificationEN();
        ...
        try {
            const responseText = await gs_ViewsClassification_IsExistAsync(objgs_ViewsClassificationEN.classificationId);
            var bolIsExist: boolean = responseText;
            if (bolIsExist == true) {
                var strMsg: string = `添加记录时，关键字：${objgs_ViewsClassificationEN.classificationId}已经存在！`;
                alert(strMsg);
                return responseText;//一定要有一个返回值，否则会出错！
            }
            const responseText2 = await gs_ViewsClassification_AddNewRecordAsync(objgs_ViewsClassificationEN);
   ...
   */
    public async ShowData(strClassificationId: string) {
        ...
        var objgs_ViewsClassificationEN: clsgs_ViewsClassificationEN = new clsgs_ViewsClassificationEN();
        try {
            const responseText = await gs_ViewsClassification_IsExistAsync(strClassificationId);
            var returnBool: boolean = responseText;
            if (returnBool == false) {
                var strInfo: string = `关键字:[${strClassificationId}] 的记录不存在!`;
        ...
        try {
            ...
            objgs_ViewsClassificationEN = <clsgs_ViewsClassificationEN>responseText;
        }
        catch (e) {
   ...
   */
    public async UpdateRecord(strClassificationId: string) {
   ...
   */
    public async UpdateRecordSave() {
        ...
        try {
            const responseText = await gs_ViewsClassification_UpdateRecordAsync(objgs_ViewsClassificationEN);
            var returnBool: boolean = !!responseText;
            if (returnBool == true) {
                //gs_ViewsClassification_ReFreshCache();
            }
   ...
   */
    public get orderNum(): number {
        ...
        if (clsString.IsNullOrEmpty(strOrderNum)) return 0;
