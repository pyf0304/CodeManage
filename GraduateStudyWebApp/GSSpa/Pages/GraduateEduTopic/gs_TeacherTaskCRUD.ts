...
import { gs_TeacherTask_AddNewRecordAsync, gs_TeacherTask_Delgs_TeacherTasksAsync, gs_TeacherTask_DelRecordAsync, gs_TeacherTask_GetObjBymIdAsync, gs_TeacherTask_GetObjLstAsync, gs_TeacherTask_GetObjLstBymIdLstAsync, gs_TeacherTask_GetObjLstByPagerAsync, gs_TeacherTask_GetObjLstByPager_Cache, gs_TeacherTask_GetRecCountByCondAsync, gs_TeacherTask_GetRecCountByCond_Cache, gs_TeacherTask_GetSubObjLst_Cache, gs_TeacherTask_ReFreshCache, gs_TeacherTask_SortFun_Defa } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js";
...
{
var intRowNum = arrgs_TeacherTaskObjLst.length;
...
var objEN: object = arrgs_TeacherTaskObjLst[i];
for (var j = 0; j < intColNum; j++)
{
...
var strFileName = clsString.Format("教师任务({0})导出.xlsx",
...
{
if (this.hidSortgs_TeacherTaskBy == null)
{
var strMsg = `在显示列表时，排序字段(hidSortgs_TeacherTaskBy)为空，请检查！(In BindGv_gs_TeacherTask_Cache)`;
console.error(strMsg);
alert(strMsg);
return;
}
var strListDiv: string = this.mstrListDiv;
var objgs_TeacherTask_Cond = this.Combinegs_TeacherTaskConditionObj4ExportExcel();
...
lblMsg.innerHTML = clsString.Format("根据条件:[{0}]获取的对象列表数为0！", objgs_TeacherTask_Cond.whereCond);
...
var strMsg: string = `在绑定Gv_Cache过程中，根据条件:[${objgs_TeacherTask_Cond.whereCond}]获取的对象列表数为0！`;
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
var arrgs_TeacherTaskObjLst = await gs_TeacherTask_GetSubObjLst_Cache(objgs_TeacherTask_Cond);
}
catch(e)
{
...
{
var strKey:string = `${clsgs_TeacherTaskEN._CurrTabName}`;
...
var arrgs_TeacherTaskObjLst = await gs_TeacherTask_GetObjLstAsync(strWhereCond);
}
catch(e)
{
var strMsg: string = `绑定GridView不成功,${e}.`;
...
{
var strMsg:string = `(errid:WiTsCs0009)在组合查询条件(Combinegs_TeacherTaskCondition)时出错!请联系管理员!${objException}`;
throw strMsg;
}
return strWhereCond;
}
...
{
var strMsg:string = `(errid:WiTsCs0010)在组合查询条件对象(Combinegs_TeacherTaskConditionObj)时出错!请联系管理员!${objException}`;
throw strMsg;
}
...
return objgs_TeacherTask_Cond;
 ...
 (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_CombineConditionObj4ExportExcel)
  <returns>条件串(strWhereCond)</returns>
*/
 public Combinegs_TeacherTaskConditionObj4ExportExcel():clsgs_TeacherTaskEN 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && userName = '张三'
var strWhereCond: string = " 1 = 1 ";
...
{
var strMsg:string = `(errid:WiTsCs0013)在组合导出Excel条件对象(Combinegs_TeacherTaskConditionObj4ExportExcel)时出错!请联系管理员!${objException}`;
throw strMsg;
}
objgs_TeacherTask_Cond.whereCond = strWhereCond;
return objgs_TeacherTask_Cond;
...
clsCommonFunc4Web.BindTabV4(o, arrgs_TeacherTaskObjLst, arrDataColumn, "mId", this); 
...
if (this.hidSortgs_TeacherTaskBy == null)
{
var strMsg = `在显示列表时，排序字段(hidSortgs_TeacherTaskBy)为空，请检查！(In BindGv_gs_TeacherTask)`;
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: this.hidSortgs_TeacherTaskBy,//如果该字段为空，就使用下面的排序函数
...
try
{
const responseText = await gs_TeacherTask_GetObjLstBymIdLstAsync(arrmId);
console.log('responseText=');
console.log(responseText);
var intCount:number = 0;
var arrgs_TeacherTaskObjLst: Array <clsgs_TeacherTaskEN> = <Array<clsgs_TeacherTaskEN>> responseText;
for (let objInFor of arrgs_TeacherTaskObjLst)
{
const responseText2 = await gs_TeacherTask_AddNewRecordAsync(objInFor);
...
var objDiv = $(`#${ this.divName4Query }`);
    clsCommonFunc4Web.CheckControlExist(this.divName4Query, "input", "txtMissionStatement_q");
var strId = `input[id ^= "txtMissionStatement_q"]`;
