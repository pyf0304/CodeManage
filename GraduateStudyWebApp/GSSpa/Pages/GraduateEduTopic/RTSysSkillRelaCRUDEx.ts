...
import { RTSysSkillRelaCRUD } from "./RTSysSkillRelaCRUD.js";
...
*/
export class RTSysSkillRelaCRUDEx extends RTSysSkillRelaCRUD {
   ...
   */
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        var objPage: RTSysSkillRelaCRUDEx = new RTSysSkillRelaCRUDEx();
