...
*/
export class SysSocialRelationsCRUD implements clsOperateList{
   ...
   */
    public async SelectRecord(strSocialId: string) {
        try {
            ...
            clsCommonFunc4Web.Redirect("/Index/Main_vSysSocialRelations");
        }
        catch (e) {
            console.error(e);
            var strMsg: string = `根据关键字获取相应的记录的对象不成功,${e}.`;
   ...
   */
    public ShowSysSocialRelationsObj(divContainer: string, objSysSocialRelations: clsSysSocialRelationsEN) {
        ...
        var sstrKeys = clsCommonFunc4Web.GetObjKeys(objSysSocialRelations);
