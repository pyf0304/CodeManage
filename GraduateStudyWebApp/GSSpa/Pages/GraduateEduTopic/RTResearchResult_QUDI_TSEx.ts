...
import { RTResearchResult_QUDI_TS } from "./RTResearchResult_QUDI_TS.js";
...
*/
export class RTResearchResult_QUDI_TSEx extends RTResearchResult_QUDI_TS {
 ...
 */
    public async Page_Load() {
        ...
        try {
            ...
            this.hidSortvRTResearchResultBy = "updDate Desc";
  ...
  */
    public CombinevRTResearchResultCondition(): string {
  ...
  */
    public async BindGv_vRTResearchResult() {
        ...
        try {
            const responseRecCount = await vRTResearchResult_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
                this.RecCount = jsonData;
            });
  ...
  */
    public BindTab_vRTResearchResult(divContainer: string, arrvRTResearchResultObjLst: Array<clsvRTResearchResultEN>) {
        ...
        clsCommonFunc4Web.BindTabV2(o, arrvRTResearchResultObjLst, arrDataColumn, "mId");
