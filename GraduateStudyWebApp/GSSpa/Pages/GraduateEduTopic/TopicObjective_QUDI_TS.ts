...
*/
export class TopicObjective_QUDI_TS implements clsOperateList
{
...
try
{
    this.RecCount = await vTopicObjective_GetRecCountByCond_Cache(objvTopicObjective_Cond, clsPublocalStorage.Getid_CurrEduCls());
var objPagerPara: stuPagerPara = {
pageIndex: intCurrPageIndex,
pageSize: this.pageSize,
whereCond: strWhereCond,
    ...
    var arrvTopicObjectiveObjLst = await vTopicObjective_GetObjLstByPager_Cache(objPagerPara, clsPublocalStorage.Getid_CurrEduCls());
}
catch(e)
{
console.error('catch(e)=');
