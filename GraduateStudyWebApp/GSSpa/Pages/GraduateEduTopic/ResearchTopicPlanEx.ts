...
*/
export class ResearchTopicPlanEx implements clsOperateList{
...
*/
  ...
  */
    ...
    //页面动态绑定
    public BindTab_vgs_ResearchPlan(arrvgs_ResearchPlanObjLst: Array<clsvgs_ResearchPlanEN>, arrvUsersObjLst: Array<clsvUsersSimEN>) {
        var strhtml = "";
...
*/
    public SubmitRecordSave(): Promise<boolean> {
        ...
        objgs_ResearchPlanEN.acceptanceUser = clsPubSessionStorage.GetSession_UserId();//验收用户
        objgs_ResearchPlanEN.sf_UpdFldSetStr = objgs_ResearchPlanEN.updFldString;//设置哪些字段被修改(脏字段)
        if (objgs_ResearchPlanEN.planId == "" || objgs_ResearchPlanEN.planId == undefined) {
            throw "关键字不能为空!";
        }
