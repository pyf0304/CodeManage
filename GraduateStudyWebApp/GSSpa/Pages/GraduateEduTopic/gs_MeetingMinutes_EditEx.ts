...
import { gs_MeetingMinutesV_AddNewRecordAsync, gs_MeetingMinutesV_GetFirstObjAsync, gs_MeetingMinutesV_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesVWApi.js";
...
import { gs_MeetingMinutes_Edit } from "./gs_MeetingMinutes_Edit.js";
...
*/
    ...
    public PutDataTogs_MeetingMinutesClass(pobjgs_MeetingMinutesEN: clsgs_MeetingMinutesEN) {
        ...
        pobjgs_MeetingMinutesEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
  ...
  */
   ...
   */
    public async UpdateRecordSave() {
        ...
        const responseText = await gs_MeetingMinutesV_GetFirstObjAsync(strWhereCond2).then((jsonData) => {
            var objgs_MeetingMinutesVEN: clsgs_MeetingMinutesVEN = <clsgs_MeetingMinutesVEN>jsonData;
    ...
    public async AddVersionRecordSave() {
        this.DivName = "divUpdateRecordSave";
        var objgs_MeetingMinutesVEN: clsgs_MeetingMinutesVEN = new clsgs_MeetingMinutesVEN();

        this.PutDataTogs_MeetingMinutesVClass(objgs_MeetingMinutesVEN);

        try {
            const responseText2 = await gs_MeetingMinutesV_AddNewRecordAsync(objgs_MeetingMinutesVEN);
    ...
    public PutDataTogs_MeetingMinutesVClass(pobjgs_MeetingMinutesVEN: clsgs_MeetingMinutesVEN) {
        ...
        pobjgs_MeetingMinutesVEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
        pobjgs_MeetingMinutesVEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改人
        var strYmd = clsPubFun4Web.getNowDate_ymd();
        if (this.meetingDate == "") {
