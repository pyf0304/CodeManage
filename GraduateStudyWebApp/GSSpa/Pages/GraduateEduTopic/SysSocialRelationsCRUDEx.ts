...
import { SysSocialRelationsV_DelSysSocialRelationsVsAsync, SysSocialRelationsV_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsVWApi.js";
...
*/
export class SysSocialRelationsCRUDEx extends SysSocialRelationsCRUD {
    ...
    public async btnAddNewRecord_Click() {
        ...
        try {
            if (this.bolIsLoadEditRegion == false)  //
            {
                ...
                //获取分享Id
                const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("10", clsPubSessionStorage.GetSession_UserId());
...
*/
    public async btnDelRecordInTab_Click(strKeyId: string) {
        try {
            ...
            if (RTVCount > 0) {
                ...
                var arrSysSocialRelationsVWObjLst: Array<clsSysSocialRelationsVEN> = [];
                const responseText1 = await SysSocialRelationsV_GetObjLstAsync(strSocialVWhereCond).then((jsonData) => {
                    arrSysSocialRelationsVWObjLst = <Array<clsSysSocialRelationsVEN>>jsonData;
                });
                ...
                const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strSocialId, "10", "3", this.Id_CurrEduCls);
    ...
    public VDelMultiRecord(arrSocialVId: Array<string>) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = SysSocialRelationsV_DelSysSocialRelationsVsAsync(arrSocialVId).then((jsonData) => {
...
*/
    public PutDataToSysSocialRelationsClass(pobjSysSocialRelationsEN: clsSysSocialRelationsEN) {
        ...
        pobjSysSocialRelationsEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
