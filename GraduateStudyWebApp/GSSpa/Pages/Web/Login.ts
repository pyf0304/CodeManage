...
import { vUsersSim_ReFreshThisCache } from "../TS/L3_ForWApi/UserManage/clsvUsersSimWApi.js";
    ...
    public async btnQuery_Click() {
        ...
        try {
            ...
            if (objvUserRoleRelation != null) {
                ...
                clsPubSessionStorage.SetSession_UserId(objvUserRoleRelation.userId);
                clsPubSessionStorage.SetSession_UserName(objvUserRoleRelation.userName);
                clsPubSessionStorage.SetSession_RoleId(objvUserRoleRelation.roleId);
                clsPubSessionStorage.SetSession_RoleName(objvUserRoleRelation.roleName);
                clsPubSessionStorage.SetSession_id_XzMajor(objvUserRoleRelation.id_XzMajor);
                clsPubSessionStorage.SetSession_majorName(objvUserRoleRelation.majorName);
                if (clsPublocalStorage.GetUserId() != "") {
                    if (clsPublocalStorage.GetUserId() != objvUserRoleRelation.userId) {
                        clsPublocalStorage.SetUserId(objvUserRoleRelation.userId);
                        clsPubSessionStorage.userId = objvUserRoleRelation.userId;
