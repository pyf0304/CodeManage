...
import { vXzMajorDirection_GetObjLstAsync, vXzMajorDirection_GetObjLstByPager_Cache, vXzMajorDirection_GetRecCountByCond_Cache } from "../TS/L3_ForWApi/BaseInfo/clsvXzMajorDirectionWApi.js";
import { XzMajorDirection_AddNewRecordAsync, XzMajorDirection_GetMaxStrIdAsync, XzMajorDirection_GetObjByMajorDirectionIdAsync, XzMajorDirection_ReFreshCache } from "../TS/L3_ForWApi/BaseInfo/clsXzMajorDirectionWApi.js";
import { XzMajor_GetObjLstAsync } from "../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js";
import { XzMajorEx_SortFun_majorName } from "../TS/L3_ForWApiEx/BaseInfo/clsXzMajorExWApi.js";
import { clsCommonFunc4Web } from "../TS/PubFun/clsCommonFunc4Web2.js";
import { clsDataColumn } from "../TS/PubFun/clsDataColumn.js";
import { clsPubSessionStorage } from "../TS/PubFun/clsPubSessionStorage.js";
import { Format, IsNullOrEmpty } from "../TS/PubFun/clsString.js";
import { stuPagerPara } from "../TS/PubFun/stuPagerPara.js";
import { XzMajorDirectionCRUD } from "./XzMajorDirectionCRUD.js";
...
*/
export class XzMajorDirectionCRUDEx extends XzMajorDirectionCRUD {
 ...
 */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        var objPage: XzMajorDirectionCRUDEx = new XzMajorDirectionCRUDEx();
    ...
    public async Page_Load() {
        ...
        try {
            ...
            if (strUserId != "") {
                ...
                const arrvPaper_Cache = await vXzMajorDirection_GetObjLstAsync("1=1");
                ...
                var objvXzMajorDirection_Cond: clsvXzMajorDirectionEN = this.CombinevXzMajorDirectionConditionobj();

                this.RecCount = await vXzMajorDirection_GetRecCountByCond_Cache(objvXzMajorDirection_Cond);//.then((jsonData) => {
   ...
   */
    public PutDataToXzMajorDirectionClass(pobjXzMajorDirectionEN: clsXzMajorDirectionEN) {
        ...
        pobjXzMajorDirectionEN.updDate = clsPubFun4Web.getNowDate();// 修改日期
  ...
  */
    public async BindGv_vXzMajorDirection() {
        ...
        try {
            ...
            arrvXzMajorDirectionObjLst = await vXzMajorDirection_GetObjLstByPager_Cache(objPagerPara);
 ...
 */
    public CombinevXzMajorDirectionConditionobj(): clsvXzMajorDirectionEN {
        ...
        var objvXzMajorDirectionCond: clsvXzMajorDirectionEN = new clsvXzMajorDirectionEN();
        ...
        try {
            if (this.id_XzMajor_q != "" && this.id_XzMajor_q != "0") {
                ...
                objvXzMajorDirectionCond.SetCondFldValue(clsvXzMajorDirectionEN.con_id_XzMajor, this.id_XzMajor_q, "=");
            }
            if (this.MajorDirectionName_q != "") {
                ...
                objvXzMajorDirectionCond.SetCondFldValue(clsvXzMajorDirectionEN.con_MajorDirectionName, this.MajorDirectionName_q, "=");
            }
            ...
            if (clsPubSessionStorage.GetSession_UserId() != "") {
                ...
                //}
                    ...
                    strWhereCond += ` And ${clsvXzMajorDirectionEN.con_UpdUser} = '${$("#hidUserId").val()}'`;

                    objvXzMajorDirectionCond.SetCondFldValue(clsvXzMajorDirectionEN.con_UpdUser, $("#hidUserId").val(), "=");
                }
            }
            else {
                window.top.location.href = "../Web/Login";
