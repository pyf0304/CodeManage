...
import { XzMajor_GetMaxStrIdAsync, XzMajor_GetObjByid_XzMajorAsync, XzMajor_GetObjLstAsync } from "../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js";
import { clsCommonFunc4Web } from "../TS/PubFun/clsCommonFunc4Web2.js";
import { clsDataColumn } from "../TS/PubFun/clsDataColumn.js";
import { clsPubSessionStorage } from "../TS/PubFun/clsPubSessionStorage.js";
import { Format, IsNullOrEmpty } from "../TS/PubFun/clsString.js";
import { XzMajorCRUD } from "./XzMajorCRUD.js";
...
*/
export class XzMajorCRUDEx extends XzMajorCRUD
{
...
var objPage:XzMajorCRUDEx = new XzMajorCRUDEx();
...
*/
    public PutDataToXzMajorClass(pobjXzMajorEN: clsXzMajorEN) {
     ...
     //只有选择了专业类型，才能选择学院；
    public async ddlid_XzMajorShoolTypeClick() {
        try {
            //只有选择了专业类型，才能选择学院；
...
*/
    public async btnUpdateRecord_Click(strKeyId:string) {
        ...
        if (strRoleId == "00620001") {
            ...
            const responseText = await XzMajor_GetObjByid_XzMajorAsync(strKeyId);
...
*/
    public async btnDelRecord_Click() {
        try {
            ...
            var arrXzmajorObjLst: Array<clsXzMajorEN> = [];
            const responseText1 = await XzMajor_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrXzmajorObjLst = <Array<clsXzMajorEN>>jsonData;
                //查询是否有提交的数据
