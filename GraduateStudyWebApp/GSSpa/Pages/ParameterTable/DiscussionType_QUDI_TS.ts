...
import { DiscussionType_AddNewRecordAsync, DiscussionType_AddNewRecordWithMaxIdAsync, DiscussionType_DelDiscussionTypesAsync, DiscussionType_DelRecordAsync, DiscussionType_GetObjByDiscussionTypeIdAsync, DiscussionType_GetObjLstAsync, DiscussionType_GetObjLstByPagerAsync, DiscussionType_GetRecCountByCondAsync, DiscussionType_IsExistAsync, DiscussionType_UpdateRecordAsync } from "../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js";
...
*/
export class DiscussionType_QUDI_TS implements clsOperateList{
   ...
   */
    public async AddNewRecordSave() {
        ...
        var objDiscussionTypeEN: clsDiscussionTypeEN = new clsDiscussionTypeEN();
        this.PutDataToDiscussionTypeClass(objDiscussionTypeEN);
        try {
            const responseText = await DiscussionType_IsExistAsync(objDiscussionTypeEN.discussionTypeId);
            var bolIsExist: boolean = responseText;
            if (bolIsExist == true) {
                var strMsg: string = `添加记录时，关键字：${objDiscussionTypeEN.discussionTypeId}已经存在！`;
                alert(strMsg);
                return responseText;//一定要有一个返回值，否则会出错！
            }
            const responseText2 = await DiscussionType_AddNewRecordAsync(objDiscussionTypeEN);
   ...
   */
    public async AddNewRecordWithMaxIdSave() {
        ...
        this.PutDataToDiscussionTypeClass(objDiscussionTypeEN);
        try {
            const responseText2 = await DiscussionType_AddNewRecordWithMaxIdAsync(objDiscussionTypeEN);
            var returnBool: boolean = !!responseText2;
            if (returnBool == true) {
                var strInfo: string = `添加记录成功!`;
   ...
   */
    public async BindGv_DiscussionType() {
        ...
        var arrDiscussionTypeObjLst: Array<clsDiscussionTypeEN> = [];
        try {
            const responseRecCount = await DiscussionType_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
   ...
   */
    public BindTab_DiscussionType(divContainer: string, arrDiscussionTypeObjLst: Array<clsDiscussionTypeEN>) {
        ...
        clsCommonFunc4Web.BindTabV2(o, arrDiscussionTypeObjLst, arrDataColumn, "discussionTypeId");
   ...
   */
    public async btnExportExcel_Click() {
        ...
        try {
            const responseText = await DiscussionType_GetObjLstAsync(strWhereCond).then((jsonData) => {
                var arrDiscussionTypeObjLst: Array<clsDiscussionTypeEN> = <Array<clsDiscussionTypeEN>>jsonData;
   ...
   */
    public CombineDiscussionTypeCondition(): string {
        ...
        try {
            ...
            var strMsg: string = `(errid:WiTsCs0002)在组合查询条件(CombineDiscussionTypeCondition)时出错!请联系管理员!${objException}`;
            throw strMsg;
        }
        return strWhereCond;
    }
   ...
   */
    public DelMultiRecord(arrDiscussionTypeId: Array<string>) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = DiscussionType_DelDiscussionTypesAsync(arrDiscussionTypeId).then((jsonData) => {
   ...
   */
    public DelRecord(strDiscussionTypeId: string) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = DiscussionType_DelRecordAsync(strDiscussionTypeId).then((jsonData) => {
                    var returnInt: number = jsonData;
                    if (returnInt > 0) {
                        var strInfo: string = `删除记录成功,共删除${returnInt}条记录!`;
                        //显示信息框
   ...
   */
    public DetailRecord(strDiscussionTypeId: string) {
        this.btnOKUpd = "";
        this.btnCancel = "关闭";
        return new Promise((resolve, reject) => {
            try {
                const responseText = DiscussionType_GetObjByDiscussionTypeIdAsync(strDiscussionTypeId).then((jsonData) => {
                    var objDiscussionTypeEN: clsDiscussionTypeEN = <clsDiscussionTypeEN>jsonData;
   ...
   */
    public QueryDiscussionTypeLst(strListDiv: string) {
        var strWhereCond = this.CombineDiscussionTypeCondition();
        var intCurrPageIndex = this.getCurrPageIndex(this.divName4Pager);//获取当前页
        return new Promise((resolve, reject) => {
            try {
                ...
                const responseText = DiscussionType_GetObjLstByPagerAsync(objPagerPara).then((jsonData) => {
                    var arrDiscussionTypeObjLst: Array<clsDiscussionTypeEN> = <Array<clsDiscussionTypeEN>>jsonData;
                    this.BindTab_DiscussionType(strListDiv, arrDiscussionTypeObjLst);
   ...
   */
    public async SelectRecord(strDiscussionTypeId: string) {
        try {
            const responseText = await DiscussionType_GetObjByDiscussionTypeIdAsync(strDiscussionTypeId);
            var objDiscussionTypeEN: clsDiscussionTypeEN = <clsDiscussionTypeEN>responseText;
            console.log("完成SelectRecord!");
            clsCommonFunc4Web.Redirect("/Index/Main_DiscussionType");
        }
        catch (e) {
            console.error(e);
            var strMsg: string = `根据关键字获取相应的记录的对象不成功,${e}.`;
   ...
   */
    public async ShowData(strDiscussionTypeId: string) {
        ...
        var objDiscussionTypeEN: clsDiscussionTypeEN = new clsDiscussionTypeEN();
        try {
            const responseText = await DiscussionType_IsExistAsync(strDiscussionTypeId);
            var returnBool: boolean = responseText;
            if (returnBool == false) {
                var strInfo: string = `关键字:[${strDiscussionTypeId}] 的记录不存在!`;
        ...
        try {
            const responseText = await DiscussionType_GetObjByDiscussionTypeIdAsync(strDiscussionTypeId);
            objDiscussionTypeEN = <clsDiscussionTypeEN>responseText;
        }
        catch (e) {
            var strMsg: string = `根据关键字获取相应的记录的对象不成功,${e}.`;
            alert(strMsg);
   ...
   */
    public ShowDiscussionTypeObj(divContainer: string, objDiscussionType: clsDiscussionTypeEN) {
        ...
        var sstrKeys = clsCommonFunc4Web.GetObjKeys(objDiscussionType);
   ...
   */
    ...
    /* 根据关键字获取相应的记录的对象
     ...
     <param name = "sender">参数列表</param>
   */
    public UpdateRecord(strDiscussionTypeId: string) {
        this.btnOKUpd = "确认修改";
        this.btnCancel = "取消修改";
   ...
   */
    public UpdateRecordSave(): Promise<boolean> {
        ...
        return new Promise((resolve, reject) => {
            try {
                const responseText = DiscussionType_UpdateRecordAsync(objDiscussionTypeEN).then((jsonData) => {
                    var returnBool: boolean = jsonData;
                    if (returnBool == true) {
   ...
   */
    public set hidSortDiscussionTypeBy(value: string) {
        $("#hidSortDiscussionTypeBy").val(value);
    }
    /*
    * 设置排序字段
   */
    public get hidSortDiscussionTypeBy(): string {
