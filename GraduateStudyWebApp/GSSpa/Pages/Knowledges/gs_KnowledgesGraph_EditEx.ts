...
export class gs_KnowledgesGraph_EditEx extends gs_KnowledgesGraph_Edit {
    ...
    */
    ...
    public PutDataTogs_KnowledgesGraphClass(pobjgs_KnowledgesGraphEN: clsgs_KnowledgesGraphEN) {
        ...
        pobjgs_KnowledgesGraphEN.updDate = clsPubFun4Web.getNowDate_ymd();// 修改日期
        pobjgs_KnowledgesGraphEN.updUser = clsPubSessionStorage.GetSession_UserId();// 修改用户Id
        pobjgs_KnowledgesGraphEN.createUser = clsPubSessionStorage.GetSession_UserId();// 修改用户Id
        pobjgs_KnowledgesGraphEN.id_CurrEduCls = clsPublocalStorage.Getid_CurrEduCls();
    }
