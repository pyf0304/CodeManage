...
{
    public class PaperReadWrite_QUDIModel : PageModel
    {
        public string Message { get; set; }
        public void OnGet()
        {
            Message = "spaPaperReadWriteCRUD(论文读写表CRUD)(01120088)页面.";
        }
        
        /// <summary>
        /// Session属性-用来判断是读、或写论文标志；
        /// (AutoGCLib.WA_ViewScriptCSModel_TS4CSharp:Gen_WApi_Model_SeUserId)
        /// </summary>
        public string seReadWriteTypeId
        {
            get
            {
                var strValue = HttpContext.Session.GetString("ReadWriteTypeId");
                return strValue;
            }
            set
            {
                HttpContext.Session.SetString("ReadWriteTypeId", value);
            }
        }
        /// <summary>
        /// Session属性-用户Id
        ...
        public string AddressAndPort
        {
            get
            {
                return clsPubVar.IPAddressAndPort + WebRoot + "/";
            }
        }
    }
}