...
import { SubViewpointType_GetFirstObjAsync, SubViewpointType_GetObjLstAsync, SubViewpointType_GetObjLst_Cache } from "../TS/L3_ForWApi/ParameterTable/clsSubViewpointTypeWApi.js";
import { PaperSubViewpointEx_AddNewRecordWithReturnKeyAsyncEx, PaperSubViewpointEx_DelRecordAsyncEx, PaperSubViewpointEx_UpdateRecordAsyncEx } from "../TS/L3_ForWApiEx/GraduateEdu/clsPaperSubViewpointExWApi.js";
...
*/
export class PaperSubViewpoint_QUDI extends PaperSubViewpoint_QUDI_TS {
  ...
  */
   ...
   */
    public DelRecord(strSubViewpointId: string) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = PaperSubViewpointEx_DelRecordAsyncEx(strSubViewpointId).then((jsonData) => {
