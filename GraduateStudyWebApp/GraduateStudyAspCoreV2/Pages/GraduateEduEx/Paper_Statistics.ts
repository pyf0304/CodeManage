...
import { PaperEx_GetUserNumObjLstAsync } from "../TS/L3_ForWApiEx/GraduateEduPaper/clsPaperExWApi.js";
import { vPaperSubViewpointEx_GetSubViewpointNumObjLstAsync } from "../TS/L3_ForWApiEx/GraduateEduPaper/clsvPaperSubViewpointExWApi.js";
...
*/
    ...
    public CombineCondition1(): string {
        ...
        if ($("#txtid_CurrEduCls").val() == "") {
            ...
            if (IsNullOrEmpty(strId_CurrEduCls)) {
                strId_CurrEduCls = clsPublocalStorage.id_CurrEduCls;
            }
        }
        ...
        try {
            ...
            //教师
                ...
                $("#td_UserId").hide();
                strWhereCond += Format(" and {0}='{1}'", clsvPaperReadWriteEN.con_id_CurrEduCls, strId_CurrEduCls);
    ...
    public CombineCondition_Paper(): string {
        ...
        try {
            ...
            //教师
                ...
                $("#td_UserId").hide();
                strWhereCond += Format(" and {0} in (Select {0} From {1} Where {2}='{3}')",
    ...
    public async  BindGv_vPaper_Statistics() {
        ...
        try {
            ...
            for (var i = 0; i < arrPaperExObjLst.length; i++) {
                ...
                var strUserName: string = "";
                var strUpdUser: string = arrPaperExObjLst[i].updUser;
