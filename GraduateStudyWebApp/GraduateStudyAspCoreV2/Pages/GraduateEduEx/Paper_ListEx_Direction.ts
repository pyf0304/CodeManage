...
*/
export class Paper_ListEx_Direction extends PaperCRUD {
  ...
  */
   ...
   */
    ...
    //绑定本方向
    public async BindGv_PaperDirection() {
        ...
        try {
            ...
            const gvResultPaper = await PaperEx_BindList_Paper("3", "divDataLstDirection", arrPaperExObjLst);
