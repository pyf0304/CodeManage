...
import { XzMajorDirection_BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache, XzMajorDirection_GetObjByMajorDirectionId_Cache } from "../TS/L3_ForWApi/BaseInfo_Share/clsXzMajorDirectionWApi.js";
import { PaperAttachment_DelPaperAttachmentsByCondAsync } from "../TS/L3_ForWApi/GraduateEduPaper/clsPaperAttachmentWApi.js";
...
import { GetCheckedKeyIdsInDiv, GetFirstCheckedKeyIdInDiv, GetSelectValueInDiv, SetSpanHtmlByIdInDiv } from "../TS/PubFun/clsCommFunc4Ctrl.js";
    ...
    public async Page_Load() {
        ...
        try {
            if (clsPublocalStorage.userId != "") {
                ...
                SetSpanHtmlByIdInDiv(this.divName4List, "spnMajorName", clsPublocalStorage.majorName);
    ...
    public async btnDelRecord_Click() {
        try {
            ...
            for (var i = 0; i < arrKeyIds.length; i++) {
                ...
                const responseText5 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strPaperId, "01", "3", clsPublocalStorage.id_CurrEduCls);
...
*/
    public async ddlMajorDirectionId_Tabs_SelectedIndexChanged(ddlMajorDirectionId_Tabs: HTMLSelectElement) {
        const strThisFuncName = this.ddlMajorDirectionId_Tabs_SelectedIndexChanged.name;
        const strMajorDirectionId = GetSelectValueInDiv(this.divName4List, "ddlMajorDirectionId_Tabs");
        ...
        const strMajorDirectionName = Format("<span class='text-secondary font-weight-bold'>[{0}]</span>方向论文", objXzMajorDirection.majorDirectionName);
