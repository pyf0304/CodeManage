...
import { BindDdl_ObjLst, BindTab, Redirect, SortFun } from "../TS/PubFun/clsCommFunc4Web.js";
    ...
    public async Page_Load() {
        ...
        try {
            if (clsPublocalStorage.userId != "") {
                ...
                this.AddNewRecord();
                //获取分享Id
                const responseText = await gs_UserConfigEx_GetNewReturnShareIdEx("02", clsPublocalStorage.userId);
        ...
        return new Promise((resolve, reject) => {
            try {
                const responseText = OperationType_GetObjLstAsync(strWhereCond).then((jsonData) => {
                    ...
                    BindDdl_ObjLst(ddlOperationTypeId, arrOperationTypeObjLst, clsOperationTypeEN.con_OperationTypeId, clsOperationTypeEN.con_OperationTypeName, "操作类型");
    ...
    public async AddNewRecordSave() {
        ...
        try {
            ...
            if (returnBool == true) {
                ...
                const responseText2 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strPaperRWId, "02", "1", clsPublocalStorage.id_CurrEduCls);
