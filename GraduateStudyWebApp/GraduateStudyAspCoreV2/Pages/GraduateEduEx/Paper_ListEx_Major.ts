...
*/
export class Paper_ListEx_Major extends PaperCRUD {
  ...
  */
    ...
    public async BindGv_PaperMajor() {
        ...
        try {
            ...
            const gvResultPaper = await PaperEx_BindList_Paper("2", "divDataLstMajor", arrPaperExObjLst);
