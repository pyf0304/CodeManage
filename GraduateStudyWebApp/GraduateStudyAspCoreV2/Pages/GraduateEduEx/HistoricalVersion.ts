...
import { clsvgs_PaperVerEN } from "../TS/L0_Entity/GraduateEduPaper/clsvgs_PaperVerEN.js";
...
import { clsgs_TobeStudiedProblemVerEN } from "../TS/L0_Entity/GraduateEduTopic/clsgs_TobeStudiedProblemVerEN.js";
...
import { gs_PaperParagraphVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphVerWApi.js";
...
import { vgs_PaperVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperVerWApi.js";
import { vPaperSubViewpoint_GetFirstObjAsync } from "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js";
import { ConceptVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsConceptVerWApi.js";
import { gs_MeetingMinutesVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesVerWApi.js";
import { gs_TobeStudiedProblemVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVerWApi.js";
import { SysSkillVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillVerWApi.js";
import { SysSocialRelationsVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsVerWApi.js";
import { TopicObjectiveVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveVerWApi.js";
...
import { ViewpointVer_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsViewpointVerWApi.js";
import { qa_AnswerVer_GetObjLstAsync } from "../TS/L3_ForWApi/InteractManage/clsqa_AnswerVerWApi.js";
...
import { PaperEx_CopyToEx, PaperEx_FuncMapByFldName, PaperEx_GetObjByPaperIdById_CurrEduCls_Cache } from "../TS/L3_ForWApiEx/GraduateEduPaper/clsPaperExWApi.js";
...
*/
        ...
        try {
            ...
            if (objvgs_PaperParagraph != null) {
                ...
                if (varPaperId != "" && varPaperId != null) {
                    var objPaper: clsPaperEN = await PaperEx_GetObjByPaperIdById_CurrEduCls_Cache(varPaperId, strid_CurrEducls);
    ...
    public async Bind_ViewpointVersion() {
        ...
        try {
            ...
            const responseText1 = await ViewpointVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
    ...
    public async Bind_ConceptVersion() {
        ...
        try {
            ...
            const responseText1 = await ConceptVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
    ...
    public async Bind_TopicObjectiveVersion() {
        ...
        try {
            ...
            const responseText1 = await TopicObjectiveVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
    ...
    public async Bind_SysSkillVersion() {
        ...
        var arrSysSkillVObjLst: Array<clsSysSkillVerEN> = [];
        ...
        try {
            ...
            const responseText1 = await SysSkillVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrSysSkillVObjLst = <Array<clsSysSkillVerEN>>jsonData;
            });
    ...
    public async Bind_SysSocialRelationsVersion() {
        ...
        var arrSysSocialRelationsVObjLst: Array<clsSysSocialRelationsVerEN> = [];
        ...
        try {
            ...
            const responseText1 = await SysSocialRelationsVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrSysSocialRelationsVObjLst = <Array<clsSysSocialRelationsVerEN>>jsonData;
            });
    ...
    public async BindList_vPaperVersion() {
        ...
        var arrvgs_PaperVObjLst: Array<clsvgs_PaperVerEN> = [];
        ...
        try {
            const responseText1 = await vgs_PaperVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrvgs_PaperVObjLst = <Array<clsvgs_PaperVerEN>>jsonData;
            });
    ...
    public async BindList_vqa_AnswerVersion() {
        ...
        var arrqa_AnswerVObjLst: Array<clsqa_AnswerVerEN> = [];
        var strWhereCond = "";
        var strUserId = clsPublocalStorage.userId;
        ...
        try {
            ...
            const responseText1 = await qa_AnswerVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrqa_AnswerVObjLst = <Array<clsqa_AnswerVerEN>>jsonData;
            });
    ...
    public async BindList_vgs_PaperParagraphVersion() {
        ...
        try {
            ...
            const responseText1 = await gs_PaperParagraphVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
    ...
    public async BindList_gs_MeetingMinutesVersion() {
        ...
        var arrgs_MeetingMinutesVObjLst: Array<clsgs_MeetingMinutesVerEN> = [];
        var strWhereCond = "";
        var strUserId = clsPublocalStorage.userId;
        ...
        try {
            ...
            const responseText1 = await gs_MeetingMinutesVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrgs_MeetingMinutesVObjLst = <Array<clsgs_MeetingMinutesVerEN>>jsonData;
            });
    ...
    public async BindList_gs_TobeStudiedProblemVersion() {
        ...
        var arrgs_TobeStudiedProblemVObjLst: Array<clsgs_TobeStudiedProblemVerEN> = [];
        var strWhereCond = "";
        var strUserId = clsPublocalStorage.userId;
        ...
        try {
            ...
            const responseText1 = await gs_TobeStudiedProblemVer_GetObjLstAsync(strWhereCond).then((jsonData) => {
                arrgs_TobeStudiedProblemVObjLst = <Array<clsgs_TobeStudiedProblemVerEN>>jsonData;
            });
