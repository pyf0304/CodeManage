...
*/
export class Paper_ListEx_AllPaper extends PaperCRUD {
 ...
 */
    public async BindGv_vPaperBak() {
        ...
        var arrvPaperObjLst0: Array<clsPaperEN> = [];
    ...
    public async BindGv_Paper() {
        ...
        try {
            if (strid_CurrEducls == "00000050")//私有空间
            {
                ...
                //const gvResultPaper = await this.BindList_vPaper("1", arrPaperExObjLst);
                const gvResultPaper = await PaperEx_BindList_Paper("1", "divDataLst", arrPaperObjLst0);
            }
            else {
                const gvResultPaper = await PaperEx_BindList_Paper("1", "divDataLst", arrPaperObjLst0);
            }
