...
declare var $;
declare var window;
/* Paper_ListEx_CurrEduCls 的摘要说明。其中Q代表查询,U代表修改
 (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
*/
export class Paper_ListEx_CurrEduCls extends PaperCRUD {
    ...
    public async Page_Load() {
        ...
        try {
            ...
            if (clsPublocalStorage.userId != "") {
                ...
                const gvResult = await this.BindGv_PaperEduCls();
  ...
  */
    ...
    //绑定本专业
    public async BindGv_PaperEduCls() {
        ...
        strWhereCond += ` and paperId in (select paperId from PaperEduClsRela where ${clsPaperEduClsRelaEN.con_id_CurrEduCls}= '${strid_CurrEduCls}')`;
        ...
        try {
            ...
            const gvResultPaper = await PaperEx_BindList_Paper("2", "divCurrEduClsDataLst", arrPaperExObjLst);
