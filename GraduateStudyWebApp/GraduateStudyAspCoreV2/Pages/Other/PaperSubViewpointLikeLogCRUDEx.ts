 ...
 * 编程语言:TypeScript
 **/
import { PaperSubViewpointLikeLogCRUD } from "../PagesBase/Other/PaperSubViewpointLikeLogCRUD.js";
 ...
 **/
export class PaperSubViewpointLikeLogCRUDEx extends PaperSubViewpointLikeLogCRUD implements IShowList
{
...
let objPage: PaperSubViewpointLikeLogCRUDEx;
if (PaperSubViewpointLikeLogCRUD.objPage_CRUD == null)
{
PaperSubViewpointLikeLogCRUD.objPage_CRUD = new PaperSubViewpointLikeLogCRUDEx();
objPage = <PaperSubViewpointLikeLogCRUDEx> PaperSubViewpointLikeLogCRUD.objPage_CRUD;
}
else
{
objPage = <PaperSubViewpointLikeLogCRUDEx> PaperSubViewpointLikeLogCRUD.objPage_CRUD;
