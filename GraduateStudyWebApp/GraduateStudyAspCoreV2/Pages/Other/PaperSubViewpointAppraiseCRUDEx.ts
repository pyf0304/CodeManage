 ...
 * 编程语言:TypeScript
 **/
import { PaperSubViewpointAppraiseCRUD } from "../PagesBase/Other/PaperSubViewpointAppraiseCRUD.js";
 ...
 **/
export class PaperSubViewpointAppraiseCRUDEx extends PaperSubViewpointAppraiseCRUD implements IShowList
{
...
if (PaperSubViewpointAppraiseCRUD.objPage_CRUD == null)
{
PaperSubViewpointAppraiseCRUD.objPage_CRUD = new PaperSubViewpointAppraiseCRUDEx();
objPage = <PaperSubViewpointAppraiseCRUDEx> PaperSubViewpointAppraiseCRUD.objPage_CRUD;
}
else
{
objPage = <PaperSubViewpointAppraiseCRUDEx> PaperSubViewpointAppraiseCRUD.objPage_CRUD;
