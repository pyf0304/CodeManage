...
import { StudentInfo_EditEx } from "./StudentInfo_EditEx.js";
...
if (StudentInfoCRUD.objPage_CRUD == null)
{
StudentInfoCRUD.objPage_CRUD = new StudentInfoCRUDEx();
objPage = <StudentInfoCRUDEx> StudentInfoCRUD.objPage_CRUD;
}
else
{
objPage = <StudentInfoCRUDEx> StudentInfoCRUD.objPage_CRUD;
}
const objPage_Edit:StudentInfo_EditEx = new StudentInfo_EditEx(objPage);
let strMsg = '';
