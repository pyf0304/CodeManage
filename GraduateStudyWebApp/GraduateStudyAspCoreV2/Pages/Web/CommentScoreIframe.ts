...
import { CurrEduCls_GetFirstObjAsync } from "../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js";
...
import { CurrEduClsEx_FilterFunByKey, CurrEduClsEx_GetCourseIdById_CurrEduCls } from "../TS/L3_ForWApiEx/DailyRunning_Share/clsCurrEduClsExWApi.js";
    ...
    public async Page_Load() {
        ...
        try {
            if (clsPublocalStorage.userId != "") {
                ...
                //把传递参数存放缓存；
                clsPublocalStorage.id_CurrEduCls = $('#hidId_CurrEduClspara').val();
