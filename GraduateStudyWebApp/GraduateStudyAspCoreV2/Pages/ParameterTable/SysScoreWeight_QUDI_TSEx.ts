...
import { CurrEduCls_GetSubObjLst_Cache } from "../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js";
...
export class SysScoreWeightCRUDEx extends SysScoreWeightCRUD {
  ...
  */
    ...
    public static async BindDdl_id_CurrEduCls_Cache(strDdlName: string, objCurrEduCls_Cond: clsCurrEduClsEN) {
        ...
        var arrObjLst_Sel: Array<clsCurrEduClsEN> = await CurrEduCls_GetSubObjLst_Cache(objCurrEduCls_Cond, clsPublocalStorage.courseId);
        BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsCurrEduClsEN.con_id_CurrEduCls, clsCurrEduClsEN.con_EduClsName, "教学班");
    }
