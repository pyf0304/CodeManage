...
*/
export class DiscussionType_QUDI_TSEx extends DiscussionTypeCRUD implements IShowList {
   ...
   */
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        let objPage: DiscussionType_QUDI_TSEx;
        if (DiscussionTypeCRUD.objPage_CRUD == null) {
            DiscussionTypeCRUD.objPage_CRUD = new DiscussionType_QUDI_TSEx();
            objPage = <DiscussionType_QUDI_TSEx>DiscussionTypeCRUD.objPage_CRUD;
        }
        else {
            objPage = <DiscussionType_QUDI_TSEx>DiscussionTypeCRUD.objPage_CRUD;
        }
