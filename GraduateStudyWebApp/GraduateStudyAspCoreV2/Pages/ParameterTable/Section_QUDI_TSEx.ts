...
import { Section_EditEx } from "../GraduateEduPaper/Section_EditEx.js";
...
*/
export class Section_QUDI_TSEx extends SectionCRUD implements IShowList {
   ...
   */
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        let objPage: Section_QUDI_TSEx;
        if (SectionCRUD.objPage_CRUD == null) {
            SectionCRUD.objPage_CRUD = new Section_QUDI_TSEx();
            objPage = <Section_QUDI_TSEx>SectionCRUD.objPage_CRUD;
        }
        else {
            objPage = <Section_QUDI_TSEx>SectionCRUD.objPage_CRUD;
        }
