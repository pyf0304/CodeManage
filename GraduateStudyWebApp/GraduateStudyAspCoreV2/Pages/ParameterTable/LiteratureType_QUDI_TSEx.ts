...
*/
export class LiteratureType_QUDI_TSEx extends LiteratureTypeCRUD implements IShowList {
   ...
   */
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        let objPage: LiteratureType_QUDI_TSEx;
        if (LiteratureTypeCRUD.objPage_CRUD == null) {
            LiteratureTypeCRUD.objPage_CRUD = new LiteratureType_QUDI_TSEx();
            objPage = <LiteratureType_QUDI_TSEx>LiteratureTypeCRUD.objPage_CRUD;
        }
        else {
            objPage = <LiteratureType_QUDI_TSEx>LiteratureTypeCRUD.objPage_CRUD;
        }
