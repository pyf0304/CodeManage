 ...
 * 编程语言:TypeScript
 **/
import { gs_ParagraphTypeCRUD } from "../PagesBase/ParameterTable/gs_ParagraphTypeCRUD.js";
import { gs_ParagraphType_EditEx } from "./gs_ParagraphType_EditEx.js";
...
if (gs_ParagraphTypeCRUD.objPage_CRUD == null)
{
gs_ParagraphTypeCRUD.objPage_CRUD = new gs_ParagraphTypeCRUDEx();
objPage = <gs_ParagraphTypeCRUDEx> gs_ParagraphTypeCRUD.objPage_CRUD;
}
else
{
objPage = <gs_ParagraphTypeCRUDEx> gs_ParagraphTypeCRUD.objPage_CRUD;
}
const objPage_Edit:gs_ParagraphType_EditEx = new gs_ParagraphType_EditEx(objPage);
