...
* 编程语言:TypeScript
**/
import { LiteratureTypeCRUD } from "../PagesBase/ParameterTable/LiteratureTypeCRUD.js";
import { LiteratureType_EditEx } from "./LiteratureType_EditEx.js";
...
export class LiteratureTypeCRUDEx extends LiteratureTypeCRUD implements IShowList {
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        ...
        if (LiteratureTypeCRUD.objPage_CRUD == null) {
            LiteratureTypeCRUD.objPage_CRUD = new LiteratureTypeCRUDEx();
            objPage = <LiteratureTypeCRUDEx>LiteratureTypeCRUD.objPage_CRUD;
        }
        else {
            objPage = <LiteratureTypeCRUDEx>LiteratureTypeCRUD.objPage_CRUD;
        }
        const objPage_Edit: LiteratureType_EditEx = new LiteratureType_EditEx(objPage);
        let strMsg = '';
