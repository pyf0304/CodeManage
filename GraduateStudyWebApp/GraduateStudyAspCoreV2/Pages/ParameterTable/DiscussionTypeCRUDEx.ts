...
* 编程语言:TypeScript
**/
import { DiscussionTypeCRUD } from "../PagesBase/ParameterTable/DiscussionTypeCRUD.js";
import { DiscussionType_EditEx } from "./DiscussionType_EditEx.js";
...
export class DiscussionTypeCRUDEx extends DiscussionTypeCRUD implements IShowList {
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        ...
        if (DiscussionTypeCRUD.objPage_CRUD == null) {
            DiscussionTypeCRUD.objPage_CRUD = new DiscussionTypeCRUDEx();
            objPage = <DiscussionTypeCRUDEx>DiscussionTypeCRUD.objPage_CRUD;
        }
        else {
            objPage = <DiscussionTypeCRUDEx>DiscussionTypeCRUD.objPage_CRUD;
        }
        const objPage_Edit: DiscussionType_EditEx = new DiscussionType_EditEx(objPage);
        let strMsg = '';
