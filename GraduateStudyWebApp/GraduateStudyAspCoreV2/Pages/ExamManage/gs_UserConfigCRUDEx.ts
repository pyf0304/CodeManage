...
import { gs_UserConfig_EditEx } from "./gs_UserConfig_EditEx.js";
...
if (gs_UserConfigCRUD.objPage_CRUD == null)
{
gs_UserConfigCRUD.objPage_CRUD = new gs_UserConfigCRUDEx();
objPage = <gs_UserConfigCRUDEx> gs_UserConfigCRUD.objPage_CRUD;
}
else
{
objPage = <gs_UserConfigCRUDEx> gs_UserConfigCRUD.objPage_CRUD;
}
const objPage_Edit:gs_UserConfig_EditEx = new gs_UserConfig_EditEx(objPage);
let strMsg = '';
