...
import { clscc_CourseEN } from "../TS/L0_Entity/CourseLearning_Share/clscc_CourseEN.js";
...
import { cc_CourseType_BindDdl_CourseTypeIDInDiv_Cache } from "../TS/L3_ForWApi/CourseLearning_Share/clscc_CourseTypeWApi.js";
...
*/
   ...
   */
    public PutDataToCurrEduClsClass(pobjCurrEduClsEN: clsCurrEduClsEN) {
        ...
        pobjCurrEduClsEN.SetModifyUserID( clsPublocalStorage.userId.toString());// 修改人
    }
   ...
   */
    public ShowCurrEduClsObj(divContainer: string, objCurrEduCls: clsCurrEduClsEN) {
        ...
        var sstrKeys = GetObjKeys(objCurrEduCls);
