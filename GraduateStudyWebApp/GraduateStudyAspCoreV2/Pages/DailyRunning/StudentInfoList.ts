...
import { clsvStudentInfoEN } from "../TS/L0_Entity/UserManage_Share/clsvStudentInfoEN.js";
import { CurrEduClsStu_AddNewRecordAsync, CurrEduClsStu_IsExistRecordAsync } from "../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js";
import { arrSelectedKeys, BindTab_V, GetCheckedKeyIds, GetObjKeys, Redirect, SortFun } from "../TS/PubFun/clsCommFunc4Web.js";
import { clsDataColumn } from "../TS/PubFun/clsDataColumn.js";
import { clsPubSessionStorage } from "../TS/PubFun/clsPubSessionStorage.js";
import { stuPagerPara } from "../TS/PubFun/stuPagerPara.js";
//import { clszx_TextExWApi } from "../TS/L3_ForWApiEx/ZXCourseware/clszx_TextExWApi.js";
import { StudentInfoCRUD } from "../PagesBase/UserManage_Share/StudentInfoCRUD.js";
import { StudentInfo_AddNewRecordAsync, StudentInfo_DelRecordAsync, StudentInfo_DelStudentInfosAsync, StudentInfo_GetObjByid_StudentInfoAsync, StudentInfo_GetObjLstByid_StudentInfoLstAsync } from "../TS/L3_ForWApi/UserManage_Share/clsStudentInfoWApi.js";
import { vStudentInfo_GetObjLstAsync, vStudentInfo_GetObjLstByPagerAsync, vStudentInfo_GetObjLstByPager_Cache, vStudentInfo_GetRecCountByCondAsync, vStudentInfo_GetRecCountByCond_Cache } from "../TS/L3_ForWApi/UserManage_Share/clsvStudentInfoWApi.js";
...
*/
export class StudentInfoList extends StudentInfoCRUD implements IShowList {
   ...
   */
    public async BindTab_vStudentInfo(divContainer: string, arrvStudentInfoObjLst: Array<clsvStudentInfoEN>) {
        ...
        var arrDataColumn: Array<clsDataColumn> =
            [
                ...
                {
                    fldName: "stuID",
                    sortBy: "stuID", sortFun: SortFun, getDataSource: "",
                    colHeader: "学号",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "stuName",
                    sortBy: "stuName", sortFun: SortFun, getDataSource: "",
                    colHeader: "姓名",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "SexDesc",
                    sortBy: "SexDesc", sortFun: SortFun, getDataSource: "",
                    colHeader: "性别名称",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "collegeName",
                    sortBy: "collegeName", sortFun: SortFun, getDataSource: "",
                    colHeader: "学院名称",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
        ...
        BindTab_V(o, arrvStudentInfoObjLst, arrDataColumn, "id_StudentInfo", this);
...
*/
   ...
   */
    public ShowStudentInfoObj(divContainer: string, objStudentInfo: clsStudentInfoEN) {
        ...
        var sstrKeys = GetObjKeys(objStudentInfo);
