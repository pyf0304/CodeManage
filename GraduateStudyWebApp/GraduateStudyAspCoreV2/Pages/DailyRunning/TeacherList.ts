...
export class TeacherList extends TeacherInfoCRUD implements IShowList {
  ...
  */
   ...
   */
    public async BindTab_TeacherInfo(divContainer: string, arrTeacherInfoObjLst: Array<clsTeacherInfoEN>) {
        ...
        var arrDataColumn: Array<clsDataColumn> =
            [
                ...
                {
                    fldName: "teacherID",
                    sortBy: "teacherID", sortFun: SortFun, getDataSource: "",
                    colHeader: "教师Id",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "teacherName",
                    sortBy: "teacherName", sortFun: SortFun, getDataSource: "",
                    colHeader: "教师姓名",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
        ...
        BindTab(o, arrTeacherInfoObjLst, arrDataColumn, "id_Teacher", this);
...
*/
   ...
   */
    public ShowTeacherInfoObj(divContainer: string, objTeacherInfo: clsTeacherInfoEN) {
        ...
        var sstrKeys = GetObjKeys(objTeacherInfo);
