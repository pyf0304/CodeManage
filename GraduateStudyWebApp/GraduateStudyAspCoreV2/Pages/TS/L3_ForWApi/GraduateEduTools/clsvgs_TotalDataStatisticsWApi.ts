 ...
 * @returns 对象
 **/
export async function vgs_TotalDataStatistics_GetObjByTotalDataIdAsync(strTotalDataId: string): Promise<clsvgs_TotalDataStatisticsEN|null>  
{
const strThisFuncName = "GetObjByTotalDataIdAsync";

if (IsNullOrEmpty(strTotalDataId) == true)
{
  const strMsg = Format("参数:[strTotalDataId]不能为空！(In clsvgs_TotalDataStatisticsWApi.GetObjByTotalDataIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataId.length != 12)
{
const strMsg = Format("缓存分类变量:[strTotalDataId]的长度:[{0}]不正确！(clsvgs_TotalDataStatisticsWApi.GetObjByTotalDataIdAsync)", strTotalDataId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strTotalDataId) == true)
{
  const strMsg = Format("参数:[strTotalDataId]不能为空！(In clsvgs_TotalDataStatisticsWApi.GetObjByTotalDataId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataId.length != 12)
{
const strMsg = Format("缓存分类变量:[strTotalDataId]的长度:[{0}]不正确！(clsvgs_TotalDataStatisticsWApi.GetObjByTotalDataId_Cache)", strTotalDataId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvgs_TotalDataStatistics_Sel: Array <clsvgs_TotalDataStatisticsEN> = arrvgs_TotalDataStatisticsObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strTotalDataId) == true)
{
  const strMsg = Format("参数:[strTotalDataId]不能为空！(In clsvgs_TotalDataStatisticsWApi.GetObjByTotalDataId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strTotalDataId.length != 12)
{
const strMsg = Format("缓存分类变量:[strTotalDataId]的长度:[{0}]不正确！(clsvgs_TotalDataStatisticsWApi.GetObjByTotalDataId_localStorage)", strTotalDataId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function vgs_TotalDataStatistics_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvgs_TotalDataStatisticsWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvgs_TotalDataStatisticsWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvgs_TotalDataStatisticsEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vgs_TotalDataStatistics_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvgs_TotalDataStatisticsWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvgs_TotalDataStatisticsWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvgs_TotalDataStatistics_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vgs_TotalDataStatistics_GetFirstObjAsync(strWhereCond: string): Promise<clsvgs_TotalDataStatisticsEN|null>  
{
...
{
strWhereCond = Format(clsvgs_TotalDataStatisticsEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvgs_TotalDataStatisticsWApi.vgs_TotalDataStatistics_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvgs_TotalDataStatisticsWApi.vgs_TotalDataStatistics_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
