 ...
 * @returns 对象
 **/
export async function vqa_Questions_GetObjByQuestionsIdAsync(strQuestionsId: string): Promise<clsvqa_QuestionsEN|null>  
{
const strThisFuncName = "GetObjByQuestionsIdAsync";

if (IsNullOrEmpty(strQuestionsId) == true)
{
  const strMsg = Format("参数:[strQuestionsId]不能为空！(In clsvqa_QuestionsWApi.GetObjByQuestionsIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strQuestionsId.length != 8)
{
const strMsg = Format("缓存分类变量:[strQuestionsId]的长度:[{0}]不正确！(clsvqa_QuestionsWApi.GetObjByQuestionsIdAsync)", strQuestionsId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strQuestionsId) == true)
{
  const strMsg = Format("参数:[strQuestionsId]不能为空！(In clsvqa_QuestionsWApi.GetObjByQuestionsId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strQuestionsId.length != 8)
{
const strMsg = Format("缓存分类变量:[strQuestionsId]的长度:[{0}]不正确！(clsvqa_QuestionsWApi.GetObjByQuestionsId_Cache)", strQuestionsId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvqa_Questions_Sel: Array <clsvqa_QuestionsEN> = arrvqa_QuestionsObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strQuestionsId) == true)
{
  const strMsg = Format("参数:[strQuestionsId]不能为空！(In clsvqa_QuestionsWApi.GetObjByQuestionsId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strQuestionsId.length != 8)
{
const strMsg = Format("缓存分类变量:[strQuestionsId]的长度:[{0}]不正确！(clsvqa_QuestionsWApi.GetObjByQuestionsId_localStorage)", strQuestionsId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvqa_QuestionsEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vqa_Questions_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrvqa_Questions_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vqa_Questions_GetFirstObjAsync(strWhereCond: string): Promise<clsvqa_QuestionsEN|null>  
{
