 ...
 * @returns 对象
 **/
export async function vqa_Paper_GetObjByqa_PaperIdAsync(strqa_PaperId: string): Promise<clsvqa_PaperEN|null>  
{
const strThisFuncName = "GetObjByqa_PaperIdAsync";

if (IsNullOrEmpty(strqa_PaperId) == true)
{
  const strMsg = Format("参数:[strqa_PaperId]不能为空！(In clsvqa_PaperWApi.GetObjByqa_PaperIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strqa_PaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strqa_PaperId]的长度:[{0}]不正确！(clsvqa_PaperWApi.GetObjByqa_PaperIdAsync)", strqa_PaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strqa_PaperId) == true)
{
  const strMsg = Format("参数:[strqa_PaperId]不能为空！(In clsvqa_PaperWApi.GetObjByqa_PaperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strqa_PaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strqa_PaperId]的长度:[{0}]不正确！(clsvqa_PaperWApi.GetObjByqa_PaperId_Cache)", strqa_PaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvqa_Paper_Sel: Array <clsvqa_PaperEN> = arrvqa_PaperObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strqa_PaperId) == true)
{
  const strMsg = Format("参数:[strqa_PaperId]不能为空！(In clsvqa_PaperWApi.GetObjByqa_PaperId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strqa_PaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strqa_PaperId]的长度:[{0}]不正确！(clsvqa_PaperWApi.GetObjByqa_PaperId_localStorage)", strqa_PaperId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function vqa_Paper_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvqa_PaperWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvqa_PaperWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvqa_PaperEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vqa_Paper_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvqa_PaperWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvqa_PaperWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvqa_Paper_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vqa_Paper_GetFirstObjAsync(strWhereCond: string): Promise<clsvqa_PaperEN|null>  
{
...
{
strWhereCond = Format(clsvqa_PaperEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvqa_PaperWApi.vqa_Paper_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvqa_PaperWApi.vqa_Paper_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
