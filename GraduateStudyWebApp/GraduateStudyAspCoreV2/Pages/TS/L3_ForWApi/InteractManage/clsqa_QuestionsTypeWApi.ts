 ...
 * @returns 对象
 **/
export async function qa_QuestionsType_GetObjByQuestionsTypeIdAsync(strQuestionsTypeId: string): Promise<clsqa_QuestionsTypeEN|null>  
{
const strThisFuncName = "GetObjByQuestionsTypeIdAsync";

if (IsNullOrEmpty(strQuestionsTypeId) == true)
{
  const strMsg = Format("参数:[strQuestionsTypeId]不能为空！(In clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strQuestionsTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strQuestionsTypeId]的长度:[{0}]不正确！(clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeIdAsync)", strQuestionsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strQuestionsTypeId) == true)
{
  const strMsg = Format("参数:[strQuestionsTypeId]不能为空！(In clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strQuestionsTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strQuestionsTypeId]的长度:[{0}]不正确！(clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_Cache)", strQuestionsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrqa_QuestionsType_Sel: Array <clsqa_QuestionsTypeEN> = arrqa_QuestionsTypeObjLst_Cache.filter(x => 
 x.questionsTypeId == strQuestionsTypeId );
...
if (IsNullOrEmpty(strQuestionsTypeId) == true)
{
  const strMsg = Format("参数:[strQuestionsTypeId]不能为空！(In clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strQuestionsTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strQuestionsTypeId]的长度:[{0}]不正确！(clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_localStorage)", strQuestionsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsqa_QuestionsTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function qa_QuestionsType_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrqa_QuestionsType_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function qa_QuestionsType_GetFirstObjAsync(strWhereCond: string): Promise<clsqa_QuestionsTypeEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objqa_QuestionsTypeEN.sfUpdFldSetStr === undefined || objqa_QuestionsTypeEN.sfUpdFldSetStr === null || objqa_QuestionsTypeEN.sfUpdFldSetStr === "")
{
