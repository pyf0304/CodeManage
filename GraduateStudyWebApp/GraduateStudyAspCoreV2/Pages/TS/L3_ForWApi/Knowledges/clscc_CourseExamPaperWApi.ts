...
if (IsNullOrEmpty(strCourseExamPaperId) == true)
{
  const strMsg = Format("参数:[strCourseExamPaperId]不能为空！(In clscc_CourseExamPaperWApi.GetObjByCourseExamPaperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseExamPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseExamPaperId]的长度:[{0}]不正确！(clscc_CourseExamPaperWApi.GetObjByCourseExamPaperId_Cache)", strCourseExamPaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrcc_CourseExamPaper_Sel = arrcc_CourseExamPaperObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strCourseExamPaperId) == true)
{
  const strMsg = Format("参数:[strCourseExamPaperId]不能为空！(In clscc_CourseExamPaperWApi.GetObjByCourseExamPaperId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseExamPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseExamPaperId]的长度:[{0}]不正确！(clscc_CourseExamPaperWApi.GetObjByCourseExamPaperId_localStorage)", strCourseExamPaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strCourseExamPaperId) == true)
{
  const strMsg = Format("参数:[strCourseExamPaperId]不能为空！(In clscc_CourseExamPaperWApi.GetNameByCourseExamPaperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseExamPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseExamPaperId]的长度:[{0}]不正确！(clscc_CourseExamPaperWApi.GetNameByCourseExamPaperId_Cache)", strCourseExamPaperId.length);
console.error(strMsg);
throw (strMsg);
}
const arrcc_CourseExamPaperObjLst_Cache = await cc_CourseExamPaper_GetObjLst_Cache(strCourseId);
...
{
  const strMsg = Format("参数:[strCourseId_C]不能为空！(In clscc_CourseExamPaperWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseId_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clscc_CourseExamPaperWApi.func)", strCourseId_C.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function cc_CourseExamPaper_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strCourseId_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strCourseId_C) == true)
{
  const strMsg = Format("参数:[strCourseId_C]不能为空！(In clscc_CourseExamPaperWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseId_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clscc_CourseExamPaperWApi.funcKey)", strCourseId_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrcc_CourseExamPaper_Sel.length == 0) return [];
...
{
const strMsg = Format("缓存分类变量:[CourseId]不能为空！(in clscc_CourseExamPaperWApi.cc_CourseExamPaper_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strCourseId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(in clscc_CourseExamPaperWApi.cc_CourseExamPaper_GetObjLst_Cache() )", strCourseId.length);
console.error(strMsg);
throw (strMsg);
}
...
*/
export async function cc_CourseExamPaper_BindDdl_CourseExamPaperIdInDiv_Cache(strDivName: string, strDdlName: string , strCourseId: string)
{
