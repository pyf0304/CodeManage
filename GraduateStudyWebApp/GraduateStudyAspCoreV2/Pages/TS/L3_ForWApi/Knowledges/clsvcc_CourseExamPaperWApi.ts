...
if (IsNullOrEmpty(strCourseExamPaperId) == true)
{
  const strMsg = Format("参数:[strCourseExamPaperId]不能为空！(In clsvcc_CourseExamPaperWApi.GetObjByCourseExamPaperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseExamPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseExamPaperId]的长度:[{0}]不正确！(clsvcc_CourseExamPaperWApi.GetObjByCourseExamPaperId_Cache)", strCourseExamPaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvcc_CourseExamPaper_Sel = arrvcc_CourseExamPaperObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strCourseExamPaperId) == true)
{
  const strMsg = Format("参数:[strCourseExamPaperId]不能为空！(In clsvcc_CourseExamPaperWApi.GetObjByCourseExamPaperId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseExamPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseExamPaperId]的长度:[{0}]不正确！(clsvcc_CourseExamPaperWApi.GetObjByCourseExamPaperId_localStorage)", strCourseExamPaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
{
  const strMsg = Format("参数:[strCourseId_C]不能为空！(In clsvcc_CourseExamPaperWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseId_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsvcc_CourseExamPaperWApi.func)", strCourseId_C.length);
console.error(strMsg);
throw (strMsg);
}
...
return (a: clsvcc_CourseExamPaperEN, b: clsvcc_CourseExamPaperEN) => {
if (a.chapterName_Sim == null) return -1;
if (b.chapterName_Sim == null) return 1;
return a.chapterName_Sim.localeCompare(b.chapterName_Sim);
}
case clsvcc_CourseExamPaperEN.con_SectionName_Sim:
return (a: clsvcc_CourseExamPaperEN, b: clsvcc_CourseExamPaperEN) => {
if (a.sectionName_Sim == null) return -1;
if (b.sectionName_Sim == null) return 1;
 ...
 * @returns 返回一个关键字值列表
*/
export async function vcc_CourseExamPaper_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strCourseId_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strCourseId_C) == true)
{
  const strMsg = Format("参数:[strCourseId_C]不能为空！(In clsvcc_CourseExamPaperWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strCourseId_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsvcc_CourseExamPaperWApi.funcKey)", strCourseId_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvcc_CourseExamPaper_Sel.length == 0) return [];
...
{
const strMsg = Format("缓存分类变量:[CourseId]不能为空！(in clsvcc_CourseExamPaperWApi.vcc_CourseExamPaper_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strCourseId.length != 8)
{
const strMsg = Format("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(in clsvcc_CourseExamPaperWApi.vcc_CourseExamPaper_GetObjLst_Cache() )", strCourseId.length);
console.error(strMsg);
throw (strMsg);
}
