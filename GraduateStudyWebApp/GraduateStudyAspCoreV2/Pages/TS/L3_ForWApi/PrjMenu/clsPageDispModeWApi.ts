...
if (IsNullOrEmpty(strPageDispModeId) == true)
{
  const strMsg = Format("参数:[strPageDispModeId]不能为空！(In clsPageDispModeWApi.GetObjByPageDispModeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPageDispModeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPageDispModeId]的长度:[{0}]不正确！(clsPageDispModeWApi.GetObjByPageDispModeId_Cache)", strPageDispModeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrPageDispMode_Sel: Array <clsPageDispModeEN> = arrPageDispModeObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strPageDispModeId) == true)
{
  const strMsg = Format("参数:[strPageDispModeId]不能为空！(In clsPageDispModeWApi.GetObjByPageDispModeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPageDispModeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPageDispModeId]的长度:[{0}]不正确！(clsPageDispModeWApi.GetObjByPageDispModeId_localStorage)", strPageDispModeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPageDispModeId) == true)
{
  const strMsg = Format("参数:[strPageDispModeId]不能为空！(In clsPageDispModeWApi.GetNameByPageDispModeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPageDispModeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPageDispModeId]的长度:[{0}]不正确！(clsPageDispModeWApi.GetNameByPageDispModeId_Cache)", strPageDispModeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrPageDispModeObjLst_Cache = await PageDispMode_GetObjLst_Cache();
...
if (arrPageDispMode_Sel.length == 0) return [];
