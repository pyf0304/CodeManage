...
if (IsNullOrEmpty(strExplainTypeId) == true)
{
  const strMsg = Format("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetObjByExplainTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strExplainTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetObjByExplainTypeId_Cache)", strExplainTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrExplainType_Sel: Array <clsExplainTypeEN> = arrExplainTypeObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strExplainTypeId) == true)
{
  const strMsg = Format("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetObjByExplainTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strExplainTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetObjByExplainTypeId_localStorage)", strExplainTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strExplainTypeId) == true)
{
  const strMsg = Format("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetNameByExplainTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strExplainTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetNameByExplainTypeId_Cache)", strExplainTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrExplainTypeObjLst_Cache = await ExplainType_GetObjLst_Cache();
...
if (arrExplainType_Sel.length == 0) return [];
