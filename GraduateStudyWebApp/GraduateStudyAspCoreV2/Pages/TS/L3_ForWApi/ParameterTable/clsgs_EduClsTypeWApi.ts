 ...
 * @returns 对象
 **/
export async function gs_EduClsType_GetObjByEduClsTypeIdAsync(strEduClsTypeId: string): Promise<clsgs_EduClsTypeEN|null>  
{
const strThisFuncName = "GetObjByEduClsTypeIdAsync";

if (IsNullOrEmpty(strEduClsTypeId) == true)
{
  const strMsg = Format("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetObjByEduClsTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strEduClsTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetObjByEduClsTypeIdAsync)", strEduClsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strEduClsTypeId) == true)
{
  const strMsg = Format("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strEduClsTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_Cache)", strEduClsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_EduClsType_Sel: Array <clsgs_EduClsTypeEN> = arrgs_EduClsTypeObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strEduClsTypeId) == true)
{
  const strMsg = Format("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strEduClsTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_localStorage)", strEduClsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strEduClsTypeId) == true)
{
  const strMsg = Format("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetNameByEduClsTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strEduClsTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetNameByEduClsTypeId_Cache)", strEduClsTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrgs_EduClsTypeObjLst_Cache = await gs_EduClsType_GetObjLst_Cache();
...
strOutFldName, clsgs_EduClsTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_EduClsType_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrgs_EduClsType_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_EduClsType_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_EduClsTypeEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objgs_EduClsTypeEN.sfUpdFldSetStr === undefined || objgs_EduClsTypeEN.sfUpdFldSetStr === null || objgs_EduClsTypeEN.sfUpdFldSetStr === "")
{
