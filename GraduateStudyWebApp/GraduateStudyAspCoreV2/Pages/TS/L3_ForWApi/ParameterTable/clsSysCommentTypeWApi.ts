...
if (IsNullOrEmpty(strCommentTypeId) == true)
{
  const strMsg = Format("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetObjByCommentTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strCommentTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetObjByCommentTypeId_Cache)", strCommentTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrSysCommentType_Sel: Array <clsSysCommentTypeEN> = arrSysCommentTypeObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strCommentTypeId) == true)
{
  const strMsg = Format("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetObjByCommentTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strCommentTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetObjByCommentTypeId_localStorage)", strCommentTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strCommentTypeId) == true)
{
  const strMsg = Format("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetNameByCommentTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strCommentTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetNameByCommentTypeId_Cache)", strCommentTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrSysCommentTypeObjLst_Cache = await SysCommentType_GetObjLst_Cache();
...
if (arrSysCommentType_Sel.length == 0) return [];
