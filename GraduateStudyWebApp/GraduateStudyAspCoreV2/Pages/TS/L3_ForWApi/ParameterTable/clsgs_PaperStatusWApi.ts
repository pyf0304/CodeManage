 ...
 * @returns 对象
 **/
export async function gs_PaperStatus_GetObjByPaperStatusIdAsync(strPaperStatusId: string): Promise<clsgs_PaperStatusEN|null>  
{
const strThisFuncName = "GetObjByPaperStatusIdAsync";

if (IsNullOrEmpty(strPaperStatusId) == true)
{
  const strMsg = Format("参数:[strPaperStatusId]不能为空！(In clsgs_PaperStatusWApi.GetObjByPaperStatusIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPaperStatusId]的长度:[{0}]不正确！(clsgs_PaperStatusWApi.GetObjByPaperStatusIdAsync)", strPaperStatusId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperStatusId) == true)
{
  const strMsg = Format("参数:[strPaperStatusId]不能为空！(In clsgs_PaperStatusWApi.GetObjByPaperStatusId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPaperStatusId]的长度:[{0}]不正确！(clsgs_PaperStatusWApi.GetObjByPaperStatusId_Cache)", strPaperStatusId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_PaperStatus_Sel: Array <clsgs_PaperStatusEN> = arrgs_PaperStatusObjLst_Cache.filter(x => 
 x.paperStatusId == strPaperStatusId );
...
if (IsNullOrEmpty(strPaperStatusId) == true)
{
  const strMsg = Format("参数:[strPaperStatusId]不能为空！(In clsgs_PaperStatusWApi.GetObjByPaperStatusId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strPaperStatusId]的长度:[{0}]不正确！(clsgs_PaperStatusWApi.GetObjByPaperStatusId_localStorage)", strPaperStatusId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsgs_PaperStatusEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_PaperStatus_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrgs_PaperStatus_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperStatus_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperStatusEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objgs_PaperStatusEN.sfUpdFldSetStr === undefined || objgs_PaperStatusEN.sfUpdFldSetStr === null || objgs_PaperStatusEN.sfUpdFldSetStr === "")
{
