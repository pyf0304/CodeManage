 ...
 * @returns 对象
 **/
export async function SysVoteType_GetObjByVoteTypeIdAsync(strVoteTypeId: string): Promise<clsSysVoteTypeEN|null>  
{
const strThisFuncName = "GetObjByVoteTypeIdAsync";

if (IsNullOrEmpty(strVoteTypeId) == true)
{
  const strMsg = Format("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetObjByVoteTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strVoteTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetObjByVoteTypeIdAsync)", strVoteTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strVoteTypeId) == true)
{
  const strMsg = Format("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetObjByVoteTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strVoteTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetObjByVoteTypeId_Cache)", strVoteTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrSysVoteType_Sel: Array <clsSysVoteTypeEN> = arrSysVoteTypeObjLst_Cache.filter(x => 
 x.voteTypeId == strVoteTypeId );
...
if (IsNullOrEmpty(strVoteTypeId) == true)
{
  const strMsg = Format("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetObjByVoteTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strVoteTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetObjByVoteTypeId_localStorage)", strVoteTypeId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 对象
*/
export async function SysVoteType_GetNameByVoteTypeId_Cache(strVoteTypeId: string) {
const strThisFuncName = "GetNameByVoteTypeId_Cache";

if (IsNullOrEmpty(strVoteTypeId) == true)
{
  const strMsg = Format("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetNameByVoteTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strVoteTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetNameByVoteTypeId_Cache)", strVoteTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrSysVoteTypeObjLst_Cache = await SysVoteType_GetObjLst_Cache();
if (arrSysVoteTypeObjLst_Cache == null) return "";
try
{
const arrSysVoteType_Sel: Array <clsSysVoteTypeEN> = arrSysVoteTypeObjLst_Cache.filter(x => 
 x.voteTypeId == strVoteTypeId );
...
strOutFldName, clsSysVoteTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function SysVoteType_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrSysVoteType_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function SysVoteType_GetFirstObjAsync(strWhereCond: string): Promise<clsSysVoteTypeEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objSysVoteTypeEN.sfUpdFldSetStr === undefined || objSysVoteTypeEN.sfUpdFldSetStr === null || objSysVoteTypeEN.sfUpdFldSetStr === "")
{
...
*/
export async function SysVoteType_BindDdl_VoteTypeIdByVoteTableInDiv_Cache(strDivName: string, strDdlName: string , strVoteTable: string)
{
const strThisFuncName = "BindDdl_VoteTypeIdByVoteTableInDiv_Cache";

if (IsNullOrEmpty(strVoteTable) == true)
{
  const strMsg = Format("参数:[strVoteTable]不能为空！(In clsSysVoteTypeWApi.BindDdl_VoteTypeIdByVoteTableInDiv)");
console.error(strMsg);
 throw (strMsg);
}
...
BindDdl_ObjLstInDiv(strDivName, strDdlName, arrObjLst_Sel, clsSysVoteTypeEN.con_VoteTypeId, clsSysVoteTypeEN.con_VoteTypeName, "系统点赞类型");
}
