 ...
 * @returns 对象
 **/
export async function DiscussionType_GetObjByDiscussionTypeIdAsync(strDiscussionTypeId: string): Promise<clsDiscussionTypeEN|null>  
{
const strThisFuncName = "GetObjByDiscussionTypeIdAsync";

if (IsNullOrEmpty(strDiscussionTypeId) == true)
{
  const strMsg = Format("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetObjByDiscussionTypeIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussionTypeId.length != 8)
{
const strMsg = Format("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetObjByDiscussionTypeIdAsync)", strDiscussionTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strDiscussionTypeId) == true)
{
  const strMsg = Format("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetObjByDiscussionTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussionTypeId.length != 8)
{
const strMsg = Format("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetObjByDiscussionTypeId_Cache)", strDiscussionTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrDiscussionType_Sel: Array <clsDiscussionTypeEN> = arrDiscussionTypeObjLst_Cache.filter(x => 
 x.discussionTypeId == strDiscussionTypeId );
...
if (IsNullOrEmpty(strDiscussionTypeId) == true)
{
  const strMsg = Format("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetObjByDiscussionTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussionTypeId.length != 8)
{
const strMsg = Format("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetObjByDiscussionTypeId_localStorage)", strDiscussionTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strDiscussionTypeId) == true)
{
  const strMsg = Format("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetNameByDiscussionTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussionTypeId.length != 8)
{
const strMsg = Format("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetNameByDiscussionTypeId_Cache)", strDiscussionTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrDiscussionTypeObjLst_Cache = await DiscussionType_GetObjLst_Cache();
...
strOutFldName, clsDiscussionTypeEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function DiscussionType_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrDiscussionType_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function DiscussionType_GetFirstObjAsync(strWhereCond: string): Promise<clsDiscussionTypeEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objDiscussionTypeEN.sfUpdFldSetStr === undefined || objDiscussionTypeEN.sfUpdFldSetStr === null || objDiscussionTypeEN.sfUpdFldSetStr === "")
{
...
*/
export async function DiscussionType_BindDdl_DiscussionTypeIdInDiv_Cache(strDivName: string, strDdlName: string )
{
