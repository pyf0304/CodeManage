 ...
 * @returns 对象
 **/
export async function gs_TopicTaskStatus_GetObjByStatusIdAsync(strStatusId: string): Promise<clsgs_TopicTaskStatusEN|null>  
{
const strThisFuncName = "GetObjByStatusIdAsync";

if (IsNullOrEmpty(strStatusId) == true)
{
  const strMsg = Format("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetObjByStatusIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetObjByStatusIdAsync)", strStatusId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strStatusId) == true)
{
  const strMsg = Format("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetObjByStatusId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetObjByStatusId_Cache)", strStatusId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_TopicTaskStatus_Sel: Array <clsgs_TopicTaskStatusEN> = arrgs_TopicTaskStatusObjLst_Cache.filter(x => 
 x.statusId == strStatusId );
...
if (IsNullOrEmpty(strStatusId) == true)
{
  const strMsg = Format("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetObjByStatusId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetObjByStatusId_localStorage)", strStatusId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strStatusId) == true)
{
  const strMsg = Format("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetNameByStatusId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strStatusId.length != 2)
{
const strMsg = Format("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetNameByStatusId_Cache)", strStatusId.length);
console.error(strMsg);
throw (strMsg);
}
const arrgs_TopicTaskStatusObjLst_Cache = await gs_TopicTaskStatus_GetObjLst_Cache();
...
strOutFldName, clsgs_TopicTaskStatusEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_TopicTaskStatus_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrgs_TopicTaskStatus_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_TopicTaskStatus_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_TopicTaskStatusEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objgs_TopicTaskStatusEN.sfUpdFldSetStr === undefined || objgs_TopicTaskStatusEN.sfUpdFldSetStr === null || objgs_TopicTaskStatusEN.sfUpdFldSetStr === "")
{
