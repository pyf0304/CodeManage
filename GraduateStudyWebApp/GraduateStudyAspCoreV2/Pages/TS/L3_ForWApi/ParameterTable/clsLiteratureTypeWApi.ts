...
if (IsNullOrEmpty(strLiteratureTypeId) == true)
{
  const strMsg = Format("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetObjByLiteratureTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strLiteratureTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetObjByLiteratureTypeId_Cache)", strLiteratureTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrLiteratureType_Sel: Array <clsLiteratureTypeEN> = arrLiteratureTypeObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strLiteratureTypeId) == true)
{
  const strMsg = Format("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetObjByLiteratureTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strLiteratureTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetObjByLiteratureTypeId_localStorage)", strLiteratureTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strLiteratureTypeId) == true)
{
  const strMsg = Format("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetNameByLiteratureTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strLiteratureTypeId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetNameByLiteratureTypeId_Cache)", strLiteratureTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrLiteratureTypeObjLst_Cache = await LiteratureType_GetObjLst_Cache();
...
if (arrLiteratureType_Sel.length == 0) return [];
...
*/
export async function LiteratureType_BindDdl_LiteratureTypeIdInDiv_Cache(strDivName: string, strDdlName: string )
{
