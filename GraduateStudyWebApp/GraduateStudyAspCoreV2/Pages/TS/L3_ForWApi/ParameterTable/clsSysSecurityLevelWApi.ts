 ...
 * @returns 对象
 **/
export async function SysSecurityLevel_GetObjByLevelIdAsync(strLevelId: string): Promise<clsSysSecurityLevelEN|null>  
{
const strThisFuncName = "GetObjByLevelIdAsync";

if (IsNullOrEmpty(strLevelId) == true)
{
  const strMsg = Format("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetObjByLevelIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strLevelId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetObjByLevelIdAsync)", strLevelId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strLevelId) == true)
{
  const strMsg = Format("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetObjByLevelId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strLevelId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetObjByLevelId_Cache)", strLevelId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrSysSecurityLevel_Sel: Array <clsSysSecurityLevelEN> = arrSysSecurityLevelObjLst_Cache.filter(x => 
 x.levelId == strLevelId );
...
if (IsNullOrEmpty(strLevelId) == true)
{
  const strMsg = Format("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetObjByLevelId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strLevelId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetObjByLevelId_localStorage)", strLevelId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strLevelId) == true)
{
  const strMsg = Format("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetNameByLevelId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strLevelId.length != 2)
{
const strMsg = Format("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetNameByLevelId_Cache)", strLevelId.length);
console.error(strMsg);
throw (strMsg);
}
const arrSysSecurityLevelObjLst_Cache = await SysSecurityLevel_GetObjLst_Cache();
...
strOutFldName, clsSysSecurityLevelEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function SysSecurityLevel_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrSysSecurityLevel_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function SysSecurityLevel_GetFirstObjAsync(strWhereCond: string): Promise<clsSysSecurityLevelEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objSysSecurityLevelEN.sfUpdFldSetStr === undefined || objSysSecurityLevelEN.sfUpdFldSetStr === null || objSysSecurityLevelEN.sfUpdFldSetStr === "")
{
