 ...
 * @returns 对象
 **/
export async function vMessagePush_GetObjByMessagePushIdAsync(strMessagePushId: string): Promise<clsvMessagePushEN|null>  
{
const strThisFuncName = "GetObjByMessagePushIdAsync";

if (IsNullOrEmpty(strMessagePushId) == true)
{
  const strMsg = Format("参数:[strMessagePushId]不能为空！(In clsvMessagePushWApi.GetObjByMessagePushIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strMessagePushId.length != 8)
{
const strMsg = Format("缓存分类变量:[strMessagePushId]的长度:[{0}]不正确！(clsvMessagePushWApi.GetObjByMessagePushIdAsync)", strMessagePushId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strMessagePushId) == true)
{
  const strMsg = Format("参数:[strMessagePushId]不能为空！(In clsvMessagePushWApi.GetObjByMessagePushId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strMessagePushId.length != 8)
{
const strMsg = Format("缓存分类变量:[strMessagePushId]的长度:[{0}]不正确！(clsvMessagePushWApi.GetObjByMessagePushId_Cache)", strMessagePushId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvMessagePush_Sel: Array <clsvMessagePushEN> = arrvMessagePushObjLst_Cache.filter(x => 
 x.messagePushId == strMessagePushId );
...
if (IsNullOrEmpty(strMessagePushId) == true)
{
  const strMsg = Format("参数:[strMessagePushId]不能为空！(In clsvMessagePushWApi.GetObjByMessagePushId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strMessagePushId.length != 8)
{
const strMsg = Format("缓存分类变量:[strMessagePushId]的长度:[{0}]不正确！(clsvMessagePushWApi.GetObjByMessagePushId_localStorage)", strMessagePushId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvMessagePushEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vMessagePush_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrvMessagePush_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vMessagePush_GetFirstObjAsync(strWhereCond: string): Promise<clsvMessagePushEN|null>  
{
