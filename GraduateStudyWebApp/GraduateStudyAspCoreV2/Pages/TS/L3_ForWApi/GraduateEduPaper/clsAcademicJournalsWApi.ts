...
if (IsNullOrEmpty(strJournalId) == true)
{
  const strMsg = Format("参数:[strJournalId]不能为空！(In clsAcademicJournalsWApi.GetObjByJournalId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalId.length != 4)
{
const strMsg = Format("缓存分类变量:[strJournalId]的长度:[{0}]不正确！(clsAcademicJournalsWApi.GetObjByJournalId_Cache)", strJournalId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrAcademicJournals_Sel: Array <clsAcademicJournalsEN> = arrAcademicJournalsObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strJournalId) == true)
{
  const strMsg = Format("参数:[strJournalId]不能为空！(In clsAcademicJournalsWApi.GetObjByJournalId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalId.length != 4)
{
const strMsg = Format("缓存分类变量:[strJournalId]的长度:[{0}]不正确！(clsAcademicJournalsWApi.GetObjByJournalId_localStorage)", strJournalId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strJournalId) == true)
{
  const strMsg = Format("参数:[strJournalId]不能为空！(In clsAcademicJournalsWApi.GetNameByJournalId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strJournalId.length != 4)
{
const strMsg = Format("缓存分类变量:[strJournalId]的长度:[{0}]不正确！(clsAcademicJournalsWApi.GetNameByJournalId_Cache)", strJournalId.length);
console.error(strMsg);
throw (strMsg);
}
const arrAcademicJournalsObjLst_Cache = await AcademicJournals_GetObjLst_Cache();
...
if (arrAcademicJournals_Sel.length == 0) return [];
