 ...
 * @returns 对象
 **/
export async function vgs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId: string): Promise<clsvgs_PaperParagraphEN|null>  
{
const strThisFuncName = "GetObjByParagraphIdAsync";

if (IsNullOrEmpty(strParagraphId) == true)
{
  const strMsg = Format("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetObjByParagraphIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphId.length != 10)
{
const strMsg = Format("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetObjByParagraphIdAsync)", strParagraphId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strParagraphId) == true)
{
  const strMsg = Format("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetObjByParagraphId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphId.length != 10)
{
const strMsg = Format("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetObjByParagraphId_Cache)", strParagraphId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvgs_PaperParagraph_Sel: Array <clsvgs_PaperParagraphEN> = arrvgs_PaperParagraphObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strParagraphId) == true)
{
  const strMsg = Format("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetObjByParagraphId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphId.length != 10)
{
const strMsg = Format("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetObjByParagraphId_localStorage)", strParagraphId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strParagraphId) == true)
{
  const strMsg = Format("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetNameByParagraphId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strParagraphId.length != 10)
{
const strMsg = Format("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetNameByParagraphId_Cache)", strParagraphId.length);
console.error(strMsg);
throw (strMsg);
}
const arrvgs_PaperParagraphObjLst_Cache = await vgs_PaperParagraph_GetObjLst_Cache();
...
strOutFldName, clsvgs_PaperParagraphEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vgs_PaperParagraph_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrvgs_PaperParagraph_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vgs_PaperParagraph_GetFirstObjAsync(strWhereCond: string): Promise<clsvgs_PaperParagraphEN|null>  
{
