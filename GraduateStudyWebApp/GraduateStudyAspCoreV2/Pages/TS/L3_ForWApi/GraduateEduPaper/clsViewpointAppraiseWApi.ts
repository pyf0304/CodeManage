...
import { clsViewpointAppraiseEN } from "../../L0_Entity/GraduateEduPaper/clsViewpointAppraiseEN.js";
import { vViewpointAppraise_ReFreshThisCache } from "../../L3_ForWApi/GraduateEduPaper/clsvViewpointAppraiseWApi.js";
 ...
 * @returns 对象
 **/
export async function ViewpointAppraise_GetObjByViewpointAppraiseIdAsync(lngViewpointAppraiseId: number): Promise<clsViewpointAppraiseEN|null>  
{
const strThisFuncName = "GetObjByViewpointAppraiseIdAsync";

if (lngViewpointAppraiseId == 0)
{
  const strMsg = Format("参数:[lngViewpointAppraiseId]不能为空！(In clsViewpointAppraiseWApi.GetObjByViewpointAppraiseIdAsync)");
...
{
const strInfo = Format("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else if (error.statusText == "Not Found")
{
const strInfo = Format("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else
 ...
 * @returns 对象
*/
export async function ViewpointAppraise_GetObjByViewpointAppraiseId_Cache(lngViewpointAppraiseId: number, bolTryAsyncOnce: boolean = true) {
const strThisFuncName = "GetObjByViewpointAppraiseId_Cache";

if (lngViewpointAppraiseId == 0)
{
  const strMsg = Format("参数:[lngViewpointAppraiseId]不能为空！(In clsViewpointAppraiseWApi.GetObjByViewpointAppraiseId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrViewpointAppraise_Sel: Array <clsViewpointAppraiseEN> = arrViewpointAppraiseObjLst_Cache.filter(x => 
...
{
const strMsg = Format("错误:[{0}]. \n根据关键字:[{1}]获取相应的对象不成功!(in {2}.{3})", e, lngViewpointAppraiseId, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
}
return null;
}
 ...
 * @returns 对象
*/
export async function ViewpointAppraise_GetObjByViewpointAppraiseId_localStorage(lngViewpointAppraiseId: number) {
const strThisFuncName = "GetObjByViewpointAppraiseId_localStorage";

if (lngViewpointAppraiseId == 0)
{
  const strMsg = Format("参数:[lngViewpointAppraiseId]不能为空！(In clsViewpointAppraiseWApi.GetObjByViewpointAppraiseId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
const objViewpointAppraise_Cache: clsViewpointAppraiseEN = JSON.parse(strTempObj);
 ...
 * @returns 对象
*/
export async function ViewpointAppraise_UpdateObjInLst_Cache(objViewpointAppraise: clsViewpointAppraiseEN) {
...
const strMsg = Format("错误:[{0}]. \n在列表中修改对象不成功!(in {1}.{2})", e, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @returns 返回一个输出字段值
*/
export async function ViewpointAppraise_func(strInFldName:string , strOutFldName:string , strInValue:string )
{
...
strOutFldName, clsViewpointAppraiseEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回两个对象比较的结果
*/
export function ViewpointAppraise_SortFun_Defa(a:clsViewpointAppraiseEN , b:clsViewpointAppraiseEN): number 
{
 ...
 * @returns 返回两个对象比较的结果
*/
export function ViewpointAppraise_SortFun_Defa_2Fld(a:clsViewpointAppraiseEN , b:clsViewpointAppraiseEN): number 
{
 ...
 * @returns 返回一个关键字值列表
*/
export async function ViewpointAppraise_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<number>> 
{
...
if (arrViewpointAppraise_Sel.length == 0) return [];
 ...
 * @returns 返回的第一条记录的关键字值
*/
export async function ViewpointAppraise_GetFirstID(strWhereCond: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 第一条记录对象
 **/
export async function ViewpointAppraise_GetFirstObjAsync(strWhereCond: string): Promise<clsViewpointAppraiseEN|null>  
{
 ...
 **/
export async function ViewpointAppraise_GetObjLst_ClientCache() 
{
...
{
//缓存存在，直接返回
const arrViewpointAppraiseExObjLst_Cache: Array<clsViewpointAppraiseEN> = CacheHelper.Get(strKey);
...
const strInfo = Format("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAppraiseExObjLst.length);
console.log(strInfo);
return arrViewpointAppraiseExObjLst;
}
catch (e)
{
const strMsg = Format("从本地缓存中获取所有对象列表出错. \n服务器错误：{0}.(in {1}.{2})", e, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
throw (strMsg);
}
}
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ViewpointAppraise_GetObjLst_localStorage() 
{
...
const arrViewpointAppraiseExObjLst_Cache: Array<clsViewpointAppraiseEN> = JSON.parse(strTempObjLst);
const arrViewpointAppraiseObjLst_T = ViewpointAppraise_GetObjLstByJSONObjLst(arrViewpointAppraiseExObjLst_Cache);
return arrViewpointAppraiseObjLst_T;
}
try
...
const strInfo = Format("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAppraiseExObjLst.length);
console.log(strInfo);
return arrViewpointAppraiseExObjLst;
}
catch (e)
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ViewpointAppraise_GetObjLst_localStorage_PureCache() 
{
...
//缓存存在，直接返回
const strTempObjLst:string = localStorage.getItem(strKey) as string;
const arrViewpointAppraiseObjLst_Cache: Array<clsViewpointAppraiseEN> = JSON.parse(strTempObjLst);
 ...
 * @returns 获取的相应对象列表
 **/
export async function ViewpointAppraise_GetObjLstAsync(strWhereCond: string): Promise<Array<clsViewpointAppraiseEN>>  
{
...
{
const strNullInfo = Format("获取数据为null, 请注意!(in {0}.{1})", viewpointAppraise_ConstructorName, strThisFuncName);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ViewpointAppraise_GetObjLst_sessionStorage() 
{
...
const strInfo = Format("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAppraiseExObjLst.length);
console.log(strInfo);
return arrViewpointAppraiseExObjLst;
}
catch (e)
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ViewpointAppraise_GetObjLst_sessionStorage_PureCache() 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ViewpointAppraise_GetObjLst_Cache(): Promise<Array<clsViewpointAppraiseEN>> 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ViewpointAppraise_GetObjLst_PureCache() 
{
 ...
 * @returns 对象列表子集
*/
export async function ViewpointAppraise_GetSubObjLst_Cache(objViewpointAppraise_Cond: clsViewpointAppraiseEN) {
const strThisFuncName = "GetSubObjLst_Cache";
const arrViewpointAppraiseObjLst_Cache = await ViewpointAppraise_GetObjLst_Cache();
let arrViewpointAppraise_Sel: Array < clsViewpointAppraiseEN > = arrViewpointAppraiseObjLst_Cache;
if (objViewpointAppraise_Cond.sf_FldComparisonOp == null || objViewpointAppraise_Cond.sf_FldComparisonOp == "") return arrViewpointAppraise_Sel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objViewpointAppraise_Cond.sf_FldComparisonOp);
//console.log("clsViewpointAppraiseWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
const sstrKeys = GetObjKeys(objViewpointAppraise_Cond);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]缓存对象列表中获取子集对象不成功!(in {2}.{3})", e, JSON.stringify( objViewpointAppraise_Cond), viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 对象列表
 **/
export async function ViewpointAppraise_GetObjLstByViewpointAppraiseIdLstAsync(arrViewpointAppraiseId: Array<string>): Promise<Array<clsViewpointAppraiseEN>>  
{
 ...
 * @returns 对象列表
*/
export async function ViewpointAppraise_GetObjLstByViewpointAppraiseIdLst_Cache(arrViewpointAppraiseIdLst: Array<number>) {
const strThisFuncName = "GetObjLstByViewpointAppraiseIdLst_Cache";
try
{
const arrViewpointAppraiseObjLst_Cache = await ViewpointAppraise_GetObjLst_Cache();
const arrViewpointAppraise_Sel: Array <clsViewpointAppraiseEN> = arrViewpointAppraiseObjLst_Cache.filter(x => arrViewpointAppraiseIdLst.indexOf(x.viewpointAppraiseId)>-1);
return arrViewpointAppraise_Sel;
}
catch (e)
{
const strMsg = Format("错误:[{0}]. \n根据关键字:[{1}]获取对象列表不成功!(in {2}.{3})", e, arrViewpointAppraiseIdLst.join(","), viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
}
 ...
 * @returns 获取的相应对象列表
 **/
export async function ViewpointAppraise_GetTopObjLstAsync(objTopPara: stuTopPara): Promise<Array<clsViewpointAppraiseEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function ViewpointAppraise_GetObjLstByRangeAsync(objRangePara: stuRangePara): Promise<Array<clsViewpointAppraiseEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
*/
export async function ViewpointAppraise_GetObjLstByRange(intMinNum: number, intMaxNum: number, strWhereCond: string, strOrderBy:string="", cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 对象列表
*/
export async function ViewpointAppraise_GetObjLstByPager_Cache(objPagerPara: stuPagerPara) {
const strThisFuncName = "GetObjLstByPager_Cache";
if (objPagerPara.pageIndex == 0) return new Array<clsViewpointAppraiseEN>();
const arrViewpointAppraiseObjLst_Cache = await ViewpointAppraise_GetObjLst_Cache();
if (arrViewpointAppraiseObjLst_Cache.length == 0) return arrViewpointAppraiseObjLst_Cache;
let arrViewpointAppraise_Sel = arrViewpointAppraiseObjLst_Cache;
const obj_Cond = JSON.parse(objPagerPara.whereCond);
const objViewpointAppraise_Cond = new clsViewpointAppraiseEN();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clsViewpointAppraiseEN>();
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function ViewpointAppraise_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsViewpointAppraiseEN>>  
{
 ...
 * @returns 获取删除的结果
 **/
export async function ViewpointAppraise_DelRecordAsync(lngViewpointAppraiseId: number): Promise<number>  
{
 ...
 * @returns 实际删除记录的个数
 **/
export async function ViewpointAppraise_DelViewpointAppraisesAsync(arrViewpointAppraiseId: Array<string>): Promise<number> 
{
 ...
 * @returns 实际删除记录的个数
 **/
export async function ViewpointAppraise_DelViewpointAppraisesByCondAsync(strWhereCond: string): Promise<number> 
{
 ...
 * @returns 获取相应的记录的对象
 **/
export async function ViewpointAppraise_AddNewRecordAsync(objViewpointAppraiseEN: clsViewpointAppraiseEN): Promise<boolean> 
{
...
try
{
const response = await axios.post(strUrl, objViewpointAppraiseEN);
const data = response.data;
if (data.errorId == 0)
{
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function ViewpointAppraise_AddNewRecordWithReturnKeyAsync(objViewpointAppraiseEN: clsViewpointAppraiseEN): Promise<string> 
{
 ...
 * @returns 返回新添加记录的关键字
*/
export async function ViewpointAppraise_AddNewRecordWithReturnKey(objViewpointAppraiseEN: clsViewpointAppraiseEN, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 获取修改是否成功？
 **/
export async function ViewpointAppraise_UpdateRecordAsync(objViewpointAppraiseEN: clsViewpointAppraiseEN): Promise<boolean>  
{
const strThisFuncName = "UpdateRecordAsync";
const strAction = "UpdateRecord";
 if (objViewpointAppraiseEN.sfUpdFldSetStr === undefined || objViewpointAppraiseEN.sfUpdFldSetStr === null || objViewpointAppraiseEN.sfUpdFldSetStr === "")
{
const strMsg = Format("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointAppraiseEN.viewpointAppraiseId);
 throw strMsg;
 }
const strUrl = GetWebApiUrl(viewpointAppraise_Controller, strAction);
try
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function ViewpointAppraise_UpdateWithConditionAsync(objViewpointAppraiseEN: clsViewpointAppraiseEN, strWhereCond: string ): Promise<boolean> 
{
 ...
 * @returns 对象列表子集
*/
export async function ViewpointAppraise_IsExistRecord_Cache(objViewpointAppraise_Cond: clsViewpointAppraiseEN) {
const strThisFuncName = "IsExistRecord_Cache";
const arrViewpointAppraiseObjLst_Cache = await ViewpointAppraise_GetObjLst_Cache();
if (arrViewpointAppraiseObjLst_Cache == null) return false;
let arrViewpointAppraise_Sel: Array < clsViewpointAppraiseEN > = arrViewpointAppraiseObjLst_Cache;
if (objViewpointAppraise_Cond.sf_FldComparisonOp == null || objViewpointAppraise_Cond.sf_FldComparisonOp == "") return arrViewpointAppraise_Sel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objViewpointAppraise_Cond.sf_FldComparisonOp);
//console.log("clsViewpointAppraiseWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify( objViewpointAppraise_Cond), viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return false;
...
*/
export async function ViewpointAppraise_IsExist(lngViewpointAppraiseId: number, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 对象
*/
export async function ViewpointAppraise_IsExist_Cache(lngViewpointAppraiseId:number) {
const strThisFuncName = "IsExist_Cache";
const arrViewpointAppraiseObjLst_Cache = await ViewpointAppraise_GetObjLst_Cache();
if (arrViewpointAppraiseObjLst_Cache == null) return false;
try
{
const arrViewpointAppraise_Sel: Array <clsViewpointAppraiseEN> = arrViewpointAppraiseObjLst_Cache.filter(x => x.viewpointAppraiseId == lngViewpointAppraiseId);
if (arrViewpointAppraise_Sel.length > 0)
{
return true;
}
...
{
const strMsg = Format("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngViewpointAppraiseId, viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
return false;
 ...
 * @returns 是否存在?存在返回True
 **/
export async function ViewpointAppraise_IsExistAsync(lngViewpointAppraiseId: number): Promise<boolean> 
{
 ...
 * @returns 获取某一条件的记录数
 **/
export async function ViewpointAppraise_GetRecCountByCondAsync(strWhereCond: string): Promise<number>  
{
 ...
 * @returns 对象列表记录数
*/
export async function ViewpointAppraise_GetRecCountByCond_Cache(objViewpointAppraise_Cond: clsViewpointAppraiseEN) {
const strThisFuncName = "GetRecCountByCond_Cache";
const arrViewpointAppraiseObjLst_Cache = await ViewpointAppraise_GetObjLst_Cache();
if (arrViewpointAppraiseObjLst_Cache == null) return 0;
let arrViewpointAppraise_Sel: Array < clsViewpointAppraiseEN > = arrViewpointAppraiseObjLst_Cache;
if (objViewpointAppraise_Cond.sf_FldComparisonOp == null || objViewpointAppraise_Cond.sf_FldComparisonOp == "") return arrViewpointAppraise_Sel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objViewpointAppraise_Cond.sf_FldComparisonOp);
//console.log("clsViewpointAppraiseWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]从缓存对象列表中获取记录数不成功!(in {2}.{3})", e, JSON.stringify( objViewpointAppraise_Cond), viewpointAppraise_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return 0;
...
*/
export async function ViewpointAppraise_GetMaxStrIdByPrefix(strPrefix: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
...
*/
export function ViewpointAppraise_CheckPropertyNew(pobjViewpointAppraiseEN: clsViewpointAppraiseEN)
{
//检查字段非空， 即数据表要求非常非空的字段，不能为空！
//检查字段长度， 若字符型字段长度超出规定的长度，即非法！
if (IsNullOrEmpty(pobjViewpointAppraiseEN.viewpointId) == false && GetStrLen(pobjViewpointAppraiseEN.viewpointId) > 8)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.appraiseContent) == false && GetStrLen(pobjViewpointAppraiseEN.appraiseContent) > 2000)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.updDate) == false && GetStrLen(pobjViewpointAppraiseEN.updDate) > 20)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.memo) == false && GetStrLen(pobjViewpointAppraiseEN.memo) > 1000)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.updUser) == false && GetStrLen(pobjViewpointAppraiseEN.updUser) > 20)
{
...
//检查字段的数据类型是否正确
if (null != pobjViewpointAppraiseEN.viewpointAppraiseId && undefined !== pobjViewpointAppraiseEN.viewpointAppraiseId && tzDataType.isNumber(pobjViewpointAppraiseEN.viewpointAppraiseId) === false)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.viewpointId) == false && undefined !== pobjViewpointAppraiseEN.viewpointId && tzDataType.isString(pobjViewpointAppraiseEN.viewpointId) === false)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.appraiseContent) == false && undefined !== pobjViewpointAppraiseEN.appraiseContent && tzDataType.isString(pobjViewpointAppraiseEN.appraiseContent) === false)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.updDate) == false && undefined !== pobjViewpointAppraiseEN.updDate && tzDataType.isString(pobjViewpointAppraiseEN.updDate) === false)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.memo) == false && undefined !== pobjViewpointAppraiseEN.memo && tzDataType.isString(pobjViewpointAppraiseEN.memo) === false)
{
...
if (IsNullOrEmpty(pobjViewpointAppraiseEN.updUser) == false && undefined !== pobjViewpointAppraiseEN.updUser && tzDataType.isString(pobjViewpointAppraiseEN.updUser) === false)
{
 ...
 * (AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CheckPropertyNew)
*/
export function ViewpointAppraise_CheckProperty4Update (pobjViewpointAppraiseEN: clsViewpointAppraiseEN)
{
//检查字段长度， 若字符型字段长度超出规定的长度，即非法！
if (IsNullOrEmpty(pobjViewpointAppraiseEN.viewpointId) == false && GetStrLen(pobjViewpointAppraiseEN.viewpointId) > 8)
{
 ...
 * @returns 返回一个生成的对象
*/
export function ViewpointAppraise_GetJSONStrByObj (pobjViewpointAppraiseEN: clsViewpointAppraiseEN): string
{
 ...
 * @returns 返回一个生成的对象列表
*/
export function ViewpointAppraise_GetObjLstByJSONStr (strJSON: string): Array<clsViewpointAppraiseEN>
{
 ...
 * @returns 返回一个生成的对象列表
*/
export function ViewpointAppraise_GetObjLstByJSONObjLst (arrViewpointAppraiseObjLstS: Array<clsViewpointAppraiseEN>): Array<clsViewpointAppraiseEN>
{
...
*/
export function ViewpointAppraise_GetCombineCondition(objViewpointAppraise_Cond: clsViewpointAppraiseEN ):string
{
...
if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN.con_ViewpointAppraiseId) == true)
{
const strComparisonOp_ViewpointAppraiseId:string = objViewpointAppraise_Cond.dicFldComparisonOp[clsViewpointAppraiseEN.con_ViewpointAppraiseId];
strWhereCond += Format(" And {0} {2} {1}", clsViewpointAppraiseEN.con_ViewpointAppraiseId, objViewpointAppraise_Cond.viewpointAppraiseId, strComparisonOp_ViewpointAppraiseId);
}
if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN.con_ViewpointId) == true)
{
const strComparisonOp_ViewpointId:string = objViewpointAppraise_Cond.dicFldComparisonOp[clsViewpointAppraiseEN.con_ViewpointId];
strWhereCond += Format(" And {0} {2} '{1}'", clsViewpointAppraiseEN.con_ViewpointId, objViewpointAppraise_Cond.viewpointId, strComparisonOp_ViewpointId);
}
if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN.con_AppraiseContent) == true)
{
const strComparisonOp_AppraiseContent:string = objViewpointAppraise_Cond.dicFldComparisonOp[clsViewpointAppraiseEN.con_AppraiseContent];
strWhereCond += Format(" And {0} {2} '{1}'", clsViewpointAppraiseEN.con_AppraiseContent, objViewpointAppraise_Cond.appraiseContent, strComparisonOp_AppraiseContent);
}
if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN.con_UpdDate) == true)
{
const strComparisonOp_UpdDate:string = objViewpointAppraise_Cond.dicFldComparisonOp[clsViewpointAppraiseEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clsViewpointAppraiseEN.con_UpdDate, objViewpointAppraise_Cond.updDate, strComparisonOp_UpdDate);
}
if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN.con_Memo) == true)
{
const strComparisonOp_Memo:string = objViewpointAppraise_Cond.dicFldComparisonOp[clsViewpointAppraiseEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clsViewpointAppraiseEN.con_Memo, objViewpointAppraise_Cond.memo, strComparisonOp_Memo);
}
if (Object.prototype.hasOwnProperty.call(objViewpointAppraise_Cond.dicFldComparisonOp, clsViewpointAppraiseEN.con_UpdUser) == true)
{
const strComparisonOp_UpdUser:string = objViewpointAppraise_Cond.dicFldComparisonOp[clsViewpointAppraiseEN.con_UpdUser];
strWhereCond += Format(" And {0} {2} '{1}'", clsViewpointAppraiseEN.con_UpdUser, objViewpointAppraise_Cond.updUser, strComparisonOp_UpdUser);
}
 return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
export function ViewpointAppraise_GetUniCondStr_ViewpointAppraiseId_ViewpointId(objViewpointAppraiseEN: clsViewpointAppraiseEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond +=  Format(" and ViewpointAppraiseId = '{0}'", objViewpointAppraiseEN.viewpointAppraiseId);
 ...
 * @returns 条件串(strWhereCond)
 **/
export function ViewpointAppraise_GetUniCondStr4Update_ViewpointAppraiseId_ViewpointId(objViewpointAppraiseEN: clsViewpointAppraiseEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and ViewpointAppraiseId <> '{0}'", objViewpointAppraiseEN.viewpointAppraiseId);
 strWhereCond +=  Format(" and ViewpointAppraiseId = '{0}'", objViewpointAppraiseEN.viewpointAppraiseId);
...
*/
export function ViewpointAppraise_CopyObjTo(objViewpointAppraiseENS: clsViewpointAppraiseEN , objViewpointAppraiseENT: clsViewpointAppraiseEN ): void 
{
 ...
 * @param objViewpointAppraiseENT:目标对象
*/
export function ViewpointAppraise_GetObjFromJsonObj(objViewpointAppraiseENS: clsViewpointAppraiseEN): clsViewpointAppraiseEN 
{
