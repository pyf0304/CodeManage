 ...
 * @returns 对象
 **/
export async function gs_PaperGroup_GetObjByPaperGroupIdAsync(strPaperGroupId: string): Promise<clsgs_PaperGroupEN|null>  
{
const strThisFuncName = "GetObjByPaperGroupIdAsync";

if (IsNullOrEmpty(strPaperGroupId) == true)
{
  const strMsg = Format("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetObjByPaperGroupIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperGroupId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetObjByPaperGroupIdAsync)", strPaperGroupId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperGroupId) == true)
{
  const strMsg = Format("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetObjByPaperGroupId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperGroupId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetObjByPaperGroupId_Cache)", strPaperGroupId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_PaperGroup_Sel: Array <clsgs_PaperGroupEN> = arrgs_PaperGroupObjLst_Cache.filter(x => 
 x.paperGroupId == strPaperGroupId );
...
if (IsNullOrEmpty(strPaperGroupId) == true)
{
  const strMsg = Format("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetObjByPaperGroupId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperGroupId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetObjByPaperGroupId_localStorage)", strPaperGroupId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperGroupId) == true)
{
  const strMsg = Format("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetNameByPaperGroupId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperGroupId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetNameByPaperGroupId_Cache)", strPaperGroupId.length);
console.error(strMsg);
throw (strMsg);
}
const arrgs_PaperGroupObjLst_Cache = await gs_PaperGroup_GetObjLst_Cache(strUpdUser);
 ...
 * @returns 返回一个输出字段值
*/
export async function gs_PaperGroup_func(strInFldName:string , strOutFldName:string , strInValue:string 
, strUpdUser_C: string)
{
...
{
  const strMsg = Format("参数:[strUpdUser_C]不能为空！(In clsgs_PaperGroupWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
...
strOutFldName, clsgs_PaperGroupEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
if (objgs_PaperGroup.GetFldValue(strOutFldName) == null) return "";
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_PaperGroup_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strUpdUser_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strUpdUser_C) == true)
{
  const strMsg = Format("参数:[strUpdUser_C]不能为空！(In clsgs_PaperGroupWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
...
if (arrgs_PaperGroup == null) return [];
...
if (arrgs_PaperGroup_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperGroup_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperGroupEN|null>  
{
...
if (IsNullOrEmpty(clsgs_PaperGroupEN.WhereFormat) == false)
{
strWhereCond = Format(clsgs_PaperGroupEN.WhereFormat, strUpdUser);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[UpdUser]不能为空！(in clsgs_PaperGroupWApi.gs_PaperGroup_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
...
if (objPagerPara.pageIndex == 0) return new Array<clsgs_PaperGroupEN>();
const arrgs_PaperGroupObjLst_Cache = await gs_PaperGroup_GetObjLst_Cache(strUpdUser);
...
const strAction = "UpdateRecord";
 if (objgs_PaperGroupEN.sfUpdFldSetStr === undefined || objgs_PaperGroupEN.sfUpdFldSetStr === null || objgs_PaperGroupEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(strUpdUser) == true)
{
  const strMsg = Format("参数:[strUpdUser]不能为空！(In clsgs_PaperGroupWApi.clsgs_PaperGroupWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
...
*/
export async function gs_PaperGroup_BindDdl_PaperGroupIdByUpdUserInDiv_Cache(strDivName: string, strDdlName: string , strUpdUser: string)
{
const strThisFuncName = "BindDdl_PaperGroupIdByUpdUserInDiv_Cache";

if (IsNullOrEmpty(strUpdUser) == true)
{
  const strMsg = Format("参数:[strUpdUser]不能为空！(In clsgs_PaperGroupWApi.BindDdl_PaperGroupIdByUpdUserInDiv)");
console.error(strMsg);
 throw (strMsg);
}
...
if (objDdl == null)
{
const strMsg = Format("下拉框：{0} 不存在！(In BindDdl_PaperGroupIdByUpdUserInDiv)", strDdlName);
alert(strMsg);
console.error(strMsg);
throw (strMsg);
}
...
pobjgs_PaperGroupEN.sfUpdFldSetStr = pobjgs_PaperGroupEN.updFldString;
let strJson = "";
try
{
...
objgs_PaperGroupENT.sfUpdFldSetStr = objgs_PaperGroupENS.updFldString; //sfUpdFldSetStr
}
