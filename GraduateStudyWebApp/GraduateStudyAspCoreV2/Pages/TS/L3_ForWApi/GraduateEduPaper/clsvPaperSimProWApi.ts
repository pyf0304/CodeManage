...
if (IsNullOrEmpty(strPaperId) == true)
{
  const strMsg = Format("参数:[strPaperId]不能为空！(In clsvPaperSimProWApi.GetObjByPaperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperId]的长度:[{0}]不正确！(clsvPaperSimProWApi.GetObjByPaperId_Cache)", strPaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperId) == true)
{
  const strMsg = Format("参数:[strPaperId]不能为空！(In clsvPaperSimProWApi.GetObjByPaperId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperId]的长度:[{0}]不正确！(clsvPaperSimProWApi.GetObjByPaperId_localStorage)", strPaperId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperId) == true)
{
  const strMsg = Format("参数:[strPaperId]不能为空！(In clsvPaperSimProWApi.GetNameByPaperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperId]的长度:[{0}]不正确！(clsvPaperSimProWApi.GetNameByPaperId_Cache)", strPaperId.length);
console.error(strMsg);
throw (strMsg);
}
const arrvPaperSimProObjLst_Cache = await vPaperSimPro_GetObjLst_Cache(strid_CurrEduCls);
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvPaperSimProWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvPaperSimProWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvPaperSimProWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvPaperSimProWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvPaperSimProWApi.vPaperSimPro_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvPaperSimProWApi.vPaperSimPro_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
