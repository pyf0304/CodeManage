 ...
 * @returns 对象
 **/
export async function PaperReadWrite_GetObjByPaperRWIdAsync(strPaperRWId: string): Promise<clsPaperReadWriteEN|null>  
{
const strThisFuncName = "GetObjByPaperRWIdAsync";

if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsPaperReadWriteWApi.GetObjByPaperRWIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsPaperReadWriteWApi.GetObjByPaperRWIdAsync)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsPaperReadWriteWApi.GetObjByPaperRWId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsPaperReadWriteWApi.GetObjByPaperRWId_Cache)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrPaperReadWrite_Sel: Array <clsPaperReadWriteEN> = arrPaperReadWriteObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsPaperReadWriteWApi.GetObjByPaperRWId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsPaperReadWriteWApi.GetObjByPaperRWId_localStorage)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function PaperReadWrite_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsPaperReadWriteWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsPaperReadWriteWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsPaperReadWriteEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function PaperReadWrite_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsPaperReadWriteWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsPaperReadWriteWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrPaperReadWrite_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function PaperReadWrite_GetFirstObjAsync(strWhereCond: string): Promise<clsPaperReadWriteEN|null>  
{
...
{
strWhereCond = Format(clsPaperReadWriteEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsPaperReadWriteWApi.PaperReadWrite_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsPaperReadWriteWApi.PaperReadWrite_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
const strAction = "UpdateRecord";
 if (objPaperReadWriteEN.sfUpdFldSetStr === undefined || objPaperReadWriteEN.sfUpdFldSetStr === null || objPaperReadWriteEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsPaperReadWriteWApi.clsPaperReadWriteWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsPaperReadWriteWApi.clsPaperReadWriteWApi.ReFreshCache)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
