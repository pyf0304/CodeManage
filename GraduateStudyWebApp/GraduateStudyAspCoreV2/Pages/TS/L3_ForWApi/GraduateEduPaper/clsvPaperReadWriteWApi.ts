 ...
 * @returns 对象
 **/
export async function vPaperReadWrite_GetObjByPaperRWIdAsync(strPaperRWId: string): Promise<clsvPaperReadWriteEN|null>  
{
const strThisFuncName = "GetObjByPaperRWIdAsync";

if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsvPaperReadWriteWApi.GetObjByPaperRWIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.GetObjByPaperRWIdAsync)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsvPaperReadWriteWApi.GetObjByPaperRWId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.GetObjByPaperRWId_Cache)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvPaperReadWrite_Sel: Array <clsvPaperReadWriteEN> = arrvPaperReadWriteObjLst_Cache.filter(x => 
 x.paperRWId == strPaperRWId );
...
if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsvPaperReadWriteWApi.GetObjByPaperRWId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.GetObjByPaperRWId_localStorage)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strPaperRWId) == true)
{
  const strMsg = Format("参数:[strPaperRWId]不能为空！(In clsvPaperReadWriteWApi.GetNameByPaperRWId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strPaperRWId.length != 8)
{
const strMsg = Format("缓存分类变量:[strPaperRWId]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.GetNameByPaperRWId_Cache)", strPaperRWId.length);
console.error(strMsg);
throw (strMsg);
}
const arrvPaperReadWriteObjLst_Cache = await vPaperReadWrite_GetObjLst_Cache(strid_CurrEduCls);
 ...
 * @returns 返回一个输出字段值
*/
export async function vPaperReadWrite_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvPaperReadWriteWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvPaperReadWriteEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vPaperReadWrite_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvPaperReadWriteWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvPaperReadWrite_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vPaperReadWrite_GetFirstObjAsync(strWhereCond: string): Promise<clsvPaperReadWriteEN|null>  
{
...
{
strWhereCond = Format(clsvPaperReadWriteEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvPaperReadWriteWApi.vPaperReadWrite_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvPaperReadWriteWApi.vPaperReadWrite_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsvPaperReadWriteWApi.)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsvPaperReadWriteWApi.)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
