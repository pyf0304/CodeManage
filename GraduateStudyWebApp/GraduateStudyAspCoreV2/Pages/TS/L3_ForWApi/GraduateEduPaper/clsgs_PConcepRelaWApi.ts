 ...
 * @returns 对象
 **/
export async function gs_PConcepRela_GetObjBymIdAsync(lngmId: number): Promise<clsgs_PConcepRelaEN|null>  
{
const strThisFuncName = "GetObjBymIdAsync";

if (lngmId == 0)
{
  const strMsg = Format("参数:[lngmId]不能为空！(In clsgs_PConcepRelaWApi.GetObjBymIdAsync)");
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PConcepRela_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PConcepRelaEN|null>  
{
...
if (objPagerPara.pageIndex == 0) return new Array<clsgs_PConcepRelaEN>();
...
const strAction = "UpdateRecord";
 if (objgs_PConcepRelaEN.sfUpdFldSetStr === undefined || objgs_PConcepRelaEN.sfUpdFldSetStr === null || objgs_PConcepRelaEN.sfUpdFldSetStr === "")
{
...
pobjgs_PConcepRelaEN.sfUpdFldSetStr = pobjgs_PConcepRelaEN.updFldString;
let strJson = "";
try
{
...
objgs_PConcepRelaENT.sfUpdFldSetStr = objgs_PConcepRelaENS.updFldString; //sfUpdFldSetStr
}
