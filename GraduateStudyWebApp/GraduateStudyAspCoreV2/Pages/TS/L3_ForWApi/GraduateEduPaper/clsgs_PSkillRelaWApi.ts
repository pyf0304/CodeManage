 ...
 * @returns 对象
 **/
export async function gs_PSkillRela_GetObjBymIdAsync(lngmId: number): Promise<clsgs_PSkillRelaEN|null>  
{
const strThisFuncName = "GetObjBymIdAsync";

if (lngmId == 0)
{
  const strMsg = Format("参数:[lngmId]不能为空！(In clsgs_PSkillRelaWApi.GetObjBymIdAsync)");
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PSkillRela_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PSkillRelaEN|null>  
{
...
if (objPagerPara.pageIndex == 0) return new Array<clsgs_PSkillRelaEN>();
...
const strAction = "UpdateRecord";
 if (objgs_PSkillRelaEN.sfUpdFldSetStr === undefined || objgs_PSkillRelaEN.sfUpdFldSetStr === null || objgs_PSkillRelaEN.sfUpdFldSetStr === "")
{
...
pobjgs_PSkillRelaEN.sfUpdFldSetStr = pobjgs_PSkillRelaEN.updFldString;
let strJson = "";
try
{
...
objgs_PSkillRelaENT.sfUpdFldSetStr = objgs_PSkillRelaENS.updFldString; //sfUpdFldSetStr
}
