 ...
 * @returns 对象
 **/
export async function vSection_GetObjBySectionIdAsync(strSectionId: string): Promise<clsvSectionEN|null>  
{
const strThisFuncName = "GetObjBySectionIdAsync";

if (IsNullOrEmpty(strSectionId) == true)
{
  const strMsg = Format("参数:[strSectionId]不能为空！(In clsvSectionWApi.GetObjBySectionIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strSectionId.length != 8)
{
const strMsg = Format("缓存分类变量:[strSectionId]的长度:[{0}]不正确！(clsvSectionWApi.GetObjBySectionIdAsync)", strSectionId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strSectionId) == true)
{
  const strMsg = Format("参数:[strSectionId]不能为空！(In clsvSectionWApi.GetObjBySectionId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSectionId.length != 8)
{
const strMsg = Format("缓存分类变量:[strSectionId]的长度:[{0}]不正确！(clsvSectionWApi.GetObjBySectionId_Cache)", strSectionId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvSection_Sel: Array <clsvSectionEN> = arrvSectionObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strSectionId) == true)
{
  const strMsg = Format("参数:[strSectionId]不能为空！(In clsvSectionWApi.GetObjBySectionId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSectionId.length != 8)
{
const strMsg = Format("缓存分类变量:[strSectionId]的长度:[{0}]不正确！(clsvSectionWApi.GetObjBySectionId_localStorage)", strSectionId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvSectionEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vSection_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrvSection_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vSection_GetFirstObjAsync(strWhereCond: string): Promise<clsvSectionEN|null>  
{
