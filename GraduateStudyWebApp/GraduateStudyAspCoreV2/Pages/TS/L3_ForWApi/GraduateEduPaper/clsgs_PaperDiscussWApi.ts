 ...
 * @returns 对象
 **/
export async function gs_PaperDiscuss_GetObjByDiscussIdAsync(strDiscussId: string): Promise<clsgs_PaperDiscussEN|null>  
{
const strThisFuncName = "GetObjByDiscussIdAsync";

if (IsNullOrEmpty(strDiscussId) == true)
{
  const strMsg = Format("参数:[strDiscussId]不能为空！(In clsgs_PaperDiscussWApi.GetObjByDiscussIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussId.length != 10)
{
const strMsg = Format("缓存分类变量:[strDiscussId]的长度:[{0}]不正确！(clsgs_PaperDiscussWApi.GetObjByDiscussIdAsync)", strDiscussId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strDiscussId) == true)
{
  const strMsg = Format("参数:[strDiscussId]不能为空！(In clsgs_PaperDiscussWApi.GetObjByDiscussId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussId.length != 10)
{
const strMsg = Format("缓存分类变量:[strDiscussId]的长度:[{0}]不正确！(clsgs_PaperDiscussWApi.GetObjByDiscussId_Cache)", strDiscussId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_PaperDiscuss_Sel: Array <clsgs_PaperDiscussEN> = arrgs_PaperDiscussObjLst_Cache.filter(x => 
 x.discussId == strDiscussId );
...
if (IsNullOrEmpty(strDiscussId) == true)
{
  const strMsg = Format("参数:[strDiscussId]不能为空！(In clsgs_PaperDiscussWApi.GetObjByDiscussId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strDiscussId.length != 10)
{
const strMsg = Format("缓存分类变量:[strDiscussId]的长度:[{0}]不正确！(clsgs_PaperDiscussWApi.GetObjByDiscussId_localStorage)", strDiscussId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsgs_PaperDiscussEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_PaperDiscuss_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrgs_PaperDiscuss_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperDiscuss_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperDiscussEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objgs_PaperDiscussEN.sfUpdFldSetStr === undefined || objgs_PaperDiscussEN.sfUpdFldSetStr === null || objgs_PaperDiscussEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(pobjgs_PaperDiscussEN.userId) == false && GetStrLen(pobjgs_PaperDiscussEN.userId) > 18)
{
