...
if (lngPaperSubViewpointAppraiseId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointAppraiseId]不能为空！(In clsPaperSubViewpointAppraiseWApi.GetObjByPaperSubViewpointAppraiseId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrPaperSubViewpointAppraise_Sel: Array <clsPaperSubViewpointAppraiseEN> = arrPaperSubViewpointAppraiseObjLst_Cache.filter(x => 
...
if (lngPaperSubViewpointAppraiseId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointAppraiseId]不能为空！(In clsPaperSubViewpointAppraiseWApi.GetObjByPaperSubViewpointAppraiseId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
if (arrPaperSubViewpointAppraise_Sel.length == 0) return [];
...
if (IsNullOrEmpty(pobjPaperSubViewpointAppraiseEN.subViewpointId) == false && GetStrLen(pobjPaperSubViewpointAppraiseEN.subViewpointId) > 8)
{
...
if (IsNullOrEmpty(pobjPaperSubViewpointAppraiseEN.subViewpointId) == false && undefined !== pobjPaperSubViewpointAppraiseEN.subViewpointId && tzDataType.isString(pobjPaperSubViewpointAppraiseEN.subViewpointId) === false)
{
