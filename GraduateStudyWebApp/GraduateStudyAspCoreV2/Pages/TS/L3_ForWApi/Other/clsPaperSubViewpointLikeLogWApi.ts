 ...
 * @returns 对象
 **/
export async function PaperSubViewpointLikeLog_GetObjByPaperSubViewpointLikeLogIdAsync(lngPaperSubViewpointLikeLogId: number): Promise<clsPaperSubViewpointLikeLogEN|null>  
{
const strThisFuncName = "GetObjByPaperSubViewpointLikeLogIdAsync";

if (lngPaperSubViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In clsPaperSubViewpointLikeLogWApi.GetObjByPaperSubViewpointLikeLogIdAsync)");
...
if (lngPaperSubViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In clsPaperSubViewpointLikeLogWApi.GetObjByPaperSubViewpointLikeLogId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrPaperSubViewpointLikeLog_Sel: Array <clsPaperSubViewpointLikeLogEN> = arrPaperSubViewpointLikeLogObjLst_Cache.filter(x => 
...
if (lngPaperSubViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In clsPaperSubViewpointLikeLogWApi.GetObjByPaperSubViewpointLikeLogId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
strOutFldName, clsPaperSubViewpointLikeLogEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
if (objPaperSubViewpointLikeLog.GetFldValue(strOutFldName) == null) return "";
 ...
 * @returns 返回一个关键字值列表
*/
export async function PaperSubViewpointLikeLog_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<number>> 
{
...
if (arrPaperSubViewpointLikeLog == null) return [];
...
if (arrPaperSubViewpointLikeLog_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function PaperSubViewpointLikeLog_GetFirstObjAsync(strWhereCond: string): Promise<clsPaperSubViewpointLikeLogEN|null>  
{
...
if (objPagerPara.pageIndex == 0) return new Array<clsPaperSubViewpointLikeLogEN>();
const arrPaperSubViewpointLikeLogObjLst_Cache = await PaperSubViewpointLikeLog_GetObjLst_Cache();
...
const strAction = "UpdateRecord";
 if (objPaperSubViewpointLikeLogEN.sfUpdFldSetStr === undefined || objPaperSubViewpointLikeLogEN.sfUpdFldSetStr === null || objPaperSubViewpointLikeLogEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(pobjPaperSubViewpointLikeLogEN.subViewpointId) == false && GetStrLen(pobjPaperSubViewpointLikeLogEN.subViewpointId) > 8)
{
...
if (IsNullOrEmpty(pobjPaperSubViewpointLikeLogEN.subViewpointId) == false && undefined !== pobjPaperSubViewpointLikeLogEN.subViewpointId && tzDataType.isString(pobjPaperSubViewpointLikeLogEN.subViewpointId) === false)
{
...
pobjPaperSubViewpointLikeLogEN.sfUpdFldSetStr = pobjPaperSubViewpointLikeLogEN.updFldString;
let strJson = "";
try
{
...
objPaperSubViewpointLikeLogENT.sfUpdFldSetStr = objPaperSubViewpointLikeLogENS.updFldString; //sfUpdFldSetStr
}
