...
if (lngPaperSubViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In clsvPaperSubViewpointLikeLogWApi.GetObjByPaperSubViewpointLikeLogId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrvPaperSubViewpointLikeLog_Sel: Array <clsvPaperSubViewpointLikeLogEN> = arrvPaperSubViewpointLikeLogObjLst_Cache.filter(x => 
...
if (lngPaperSubViewpointLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperSubViewpointLikeLogId]不能为空！(In clsvPaperSubViewpointLikeLogWApi.GetObjByPaperSubViewpointLikeLogId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
if (arrvPaperSubViewpointLikeLog_Sel.length == 0) return [];
