 ...
 * @returns 对象
 **/
export async function PaperLikeLog_GetObjByPaperLikeLogIdAsync(lngPaperLikeLogId: number): Promise<clsPaperLikeLogEN|null>  
{
const strThisFuncName = "GetObjByPaperLikeLogIdAsync";

if (lngPaperLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperLikeLogId]不能为空！(In clsPaperLikeLogWApi.GetObjByPaperLikeLogIdAsync)");
...
if (lngPaperLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperLikeLogId]不能为空！(In clsPaperLikeLogWApi.GetObjByPaperLikeLogId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrPaperLikeLog_Sel: Array <clsPaperLikeLogEN> = arrPaperLikeLogObjLst_Cache.filter(x => 
 x.paperLikeLogId == lngPaperLikeLogId );
...
if (lngPaperLikeLogId == 0)
{
  const strMsg = Format("参数:[lngPaperLikeLogId]不能为空！(In clsPaperLikeLogWApi.GetObjByPaperLikeLogId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
strOutFldName, clsPaperLikeLogEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function PaperLikeLog_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<number>> 
{
...
if (arrPaperLikeLog_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function PaperLikeLog_GetFirstObjAsync(strWhereCond: string): Promise<clsPaperLikeLogEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objPaperLikeLogEN.sfUpdFldSetStr === undefined || objPaperLikeLogEN.sfUpdFldSetStr === null || objPaperLikeLogEN.sfUpdFldSetStr === "")
{
