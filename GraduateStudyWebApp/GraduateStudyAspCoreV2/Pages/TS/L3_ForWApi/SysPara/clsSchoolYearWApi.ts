...
if (IsNullOrEmpty(strSchoolYear) == true)
{
  const strMsg = Format("参数:[strSchoolYear]不能为空！(In clsSchoolYearWApi.GetObjBySchoolYear_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrSchoolYear_Sel: Array <clsSchoolYearEN> = arrSchoolYearObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strSchoolYear) == true)
{
  const strMsg = Format("参数:[strSchoolYear]不能为空！(In clsSchoolYearWApi.GetObjBySchoolYear_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
...
if (IsNullOrEmpty(strSchoolYear) == true)
{
  const strMsg = Format("参数:[strSchoolYear]不能为空！(In clsSchoolYearWApi.GetNameBySchoolYear_Cache)");
console.error(strMsg);
 throw (strMsg);
}
const arrSchoolYearObjLst_Cache = await SchoolYear_GetObjLst_Cache();
...
if (arrSchoolYear_Sel.length == 0) return [];
