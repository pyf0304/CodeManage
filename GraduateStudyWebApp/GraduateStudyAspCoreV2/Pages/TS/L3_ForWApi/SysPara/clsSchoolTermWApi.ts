...
if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In clsSchoolTermWApi.GetObjBySchoolTerm_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
{
const strMsg = Format("缓存分类变量:[strSchoolTerm]的长度:[{0}]不正确！(clsSchoolTermWApi.GetObjBySchoolTerm_Cache)", strSchoolTerm.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrSchoolTerm_Sel: Array <clsSchoolTermEN> = arrSchoolTermObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In clsSchoolTermWApi.GetObjBySchoolTerm_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
{
const strMsg = Format("缓存分类变量:[strSchoolTerm]的长度:[{0}]不正确！(clsSchoolTermWApi.GetObjBySchoolTerm_localStorage)", strSchoolTerm.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strSchoolTerm) == true)
{
  const strMsg = Format("参数:[strSchoolTerm]不能为空！(In clsSchoolTermWApi.GetNameBySchoolTerm_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSchoolTerm.length != 1)
{
const strMsg = Format("缓存分类变量:[strSchoolTerm]的长度:[{0}]不正确！(clsSchoolTermWApi.GetNameBySchoolTerm_Cache)", strSchoolTerm.length);
console.error(strMsg);
throw (strMsg);
}
const arrSchoolTermObjLst_Cache = await SchoolTerm_GetObjLst_Cache();
...
if (arrSchoolTerm_Sel.length == 0) return [];
