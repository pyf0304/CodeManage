...
import { clsOperationTypeEN } from "../../L0_Entity/SysPara/clsOperationTypeEN.js";
 ...
 * @returns 对象
*/
export async function OperationType_GetObjByOperationTypeId_Cache(strOperationTypeId: string, bolTryAsyncOnce: boolean = true) {
const strThisFuncName = "GetObjByOperationTypeId_Cache";

if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetObjByOperationTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetObjByOperationTypeId_Cache)", strOperationTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrOperationType_Sel: Array <clsOperationTypeEN> = arrOperationTypeObjLst_Cache.filter(x => 
...
{
const objOperationType_Const = await OperationType_GetObjByOperationTypeIdAsync(strOperationTypeId);
if (objOperationType_Const != null)
{
OperationType_ReFreshThisCache();
return objOperationType_Const;
}
}
return null;
}
 ...
 * @returns 对象
*/
export async function OperationType_GetObjByOperationTypeId_localStorage(strOperationTypeId: string) {
const strThisFuncName = "GetObjByOperationTypeId_localStorage";

if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetObjByOperationTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetObjByOperationTypeId_localStorage)", strOperationTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
const objOperationType_Cache: clsOperationTypeEN = JSON.parse(strTempObj);
 ...
 * @returns 对象
*/
export async function OperationType_UpdateObjInLst_Cache(objOperationType: clsOperationTypeEN) {
 ...
 * @returns 对象
*/
export async function OperationType_GetNameByOperationTypeId_Cache(strOperationTypeId: string) {
const strThisFuncName = "GetNameByOperationTypeId_Cache";

if (IsNullOrEmpty(strOperationTypeId) == true)
{
  const strMsg = Format("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetNameByOperationTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strOperationTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetNameByOperationTypeId_Cache)", strOperationTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
if (arrOperationTypeObjLst_Cache == null) return "";
try
{
const arrOperationType_Sel: Array <clsOperationTypeEN> = arrOperationTypeObjLst_Cache.filter(x => 
 x.operationTypeId == strOperationTypeId );
 ...
 * @returns 返回两个对象比较的结果
*/
export function OperationType_SortFun_Defa(a:clsOperationTypeEN , b:clsOperationTypeEN): number 
{
 ...
 * @returns 返回两个对象比较的结果
*/
export function OperationType_SortFun_Defa_2Fld(a:clsOperationTypeEN , b:clsOperationTypeEN): number 
{
...
const arrOperationType = await OperationType_GetObjLst_Cache();
if (arrOperationType == null) return [];
let arrOperationType_Sel = arrOperationType;
...
arrOperationType_Sel = arrOperationType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
break;
case enumComparisonOp.Like_03:
arrOperationType_Sel = arrOperationType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
break;
case enumComparisonOp.In_04:
const arrValues = strInValue.split(',');
arrOperationType_Sel = arrOperationType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
break;
}
break;
case "boolean":
...
{
arrOperationType_Sel = arrOperationType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
}
break;
case "number":
...
if (arrOperationType_Sel.length == 0) return [];
return arrOperationType_Sel.map(x=>x.operationTypeId);
}
 ...
 * @returns 返回的第一条记录的关键字值
*/
export async function OperationType_GetFirstID(strWhereCond: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 **/
export async function OperationType_GetObjLst_ClientCache() 
{
...
{
//缓存存在，直接返回
const arrOperationTypeExObjLst_Cache: Array<clsOperationTypeEN> = CacheHelper.Get(strKey);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function OperationType_GetObjLst_localStorage() 
{
...
const arrOperationTypeExObjLst_Cache: Array<clsOperationTypeEN> = JSON.parse(strTempObjLst);
const arrOperationTypeObjLst_T = OperationType_GetObjLstByJSONObjLst(arrOperationTypeExObjLst_Cache);
return arrOperationTypeObjLst_T;
}
try
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function OperationType_GetObjLst_localStorage_PureCache() 
{
...
//缓存存在，直接返回
const strTempObjLst:string = localStorage.getItem(strKey) as string;
const arrOperationTypeObjLst_Cache: Array<clsOperationTypeEN> = JSON.parse(strTempObjLst);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function OperationType_GetObjLst_sessionStorage() 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function OperationType_GetObjLst_sessionStorage_PureCache() 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function OperationType_GetObjLst_Cache(): Promise<Array<clsOperationTypeEN>> 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function OperationType_GetObjLst_PureCache() 
{
 ...
 * @returns 对象列表子集
*/
export async function OperationType_GetSubObjLst_Cache(objOperationType_Cond: clsOperationTypeEN) {
const strThisFuncName = "GetSubObjLst_Cache";
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
let arrOperationType_Sel: Array < clsOperationTypeEN > = arrOperationTypeObjLst_Cache;
if (objOperationType_Cond.sf_FldComparisonOp == null || objOperationType_Cond.sf_FldComparisonOp == "") return arrOperationType_Sel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objOperationType_Cond.sf_FldComparisonOp);
//console.log("clsOperationTypeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
const sstrKeys = GetObjKeys(objOperationType_Cond);
...
arrOperationType_Sel = arrOperationType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
}
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]缓存对象列表中获取子集对象不成功!(in {2}.{3})", e, JSON.stringify( objOperationType_Cond), operationType_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 对象列表
*/
export async function OperationType_GetObjLstByOperationTypeIdLst_Cache(arrOperationTypeIdLst: Array<string>) {
const strThisFuncName = "GetObjLstByOperationTypeIdLst_Cache";
try
{
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
const arrOperationType_Sel: Array <clsOperationTypeEN> = arrOperationTypeObjLst_Cache.filter(x => arrOperationTypeIdLst.indexOf(x.operationTypeId)>-1);
return arrOperationType_Sel;
}
catch (e)
{
 ...
 * @returns 获取的相应记录对象列表
*/
export async function OperationType_GetObjLstByRange(intMinNum: number, intMaxNum: number, strWhereCond: string, strOrderBy:string="", cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 对象列表
*/
export async function OperationType_GetObjLstByPager_Cache(objPagerPara: stuPagerPara) {
const strThisFuncName = "GetObjLstByPager_Cache";
if (objPagerPara.pageIndex == 0) return new Array<clsOperationTypeEN>();
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
if (arrOperationTypeObjLst_Cache.length == 0) return arrOperationTypeObjLst_Cache;
let arrOperationType_Sel = arrOperationTypeObjLst_Cache;
const obj_Cond = JSON.parse(objPagerPara.whereCond);
const objOperationType_Cond = new clsOperationTypeEN();
...
try
{
const response = await axios.post(strUrl, objOperationTypeEN);
const data = response.data;
if (data.errorId == 0)
{
 ...
 * @returns 返回新添加记录的关键字
*/
export async function OperationType_AddNewRecordWithReturnKey(objOperationTypeEN: clsOperationTypeEN, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 对象列表子集
*/
export async function OperationType_IsExistRecord_Cache(objOperationType_Cond: clsOperationTypeEN) {
const strThisFuncName = "IsExistRecord_Cache";
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
if (arrOperationTypeObjLst_Cache == null) return false;
let arrOperationType_Sel: Array < clsOperationTypeEN > = arrOperationTypeObjLst_Cache;
if (objOperationType_Cond.sf_FldComparisonOp == null || objOperationType_Cond.sf_FldComparisonOp == "") return arrOperationType_Sel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objOperationType_Cond.sf_FldComparisonOp);
//console.log("clsOperationTypeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify( objOperationType_Cond), operationType_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return false;
...
*/
export async function OperationType_IsExist(strOperationTypeId: string, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 对象
*/
export async function OperationType_IsExist_Cache(strOperationTypeId:string) {
const strThisFuncName = "IsExist_Cache";
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
if (arrOperationTypeObjLst_Cache == null) return false;
try
{
const arrOperationType_Sel: Array <clsOperationTypeEN> = arrOperationTypeObjLst_Cache.filter(x => x.operationTypeId == strOperationTypeId);
if (arrOperationType_Sel.length > 0)
{
return true;
}
 ...
 * @returns 对象列表记录数
*/
export async function OperationType_GetRecCountByCond_Cache(objOperationType_Cond: clsOperationTypeEN) {
const strThisFuncName = "GetRecCountByCond_Cache";
const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
if (arrOperationTypeObjLst_Cache == null) return 0;
let arrOperationType_Sel: Array < clsOperationTypeEN > = arrOperationTypeObjLst_Cache;
if (objOperationType_Cond.sf_FldComparisonOp == null || objOperationType_Cond.sf_FldComparisonOp == "") return arrOperationType_Sel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objOperationType_Cond.sf_FldComparisonOp);
//console.log("clsOperationTypeWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]从缓存对象列表中获取记录数不成功!(in {2}.{3})", e, JSON.stringify( objOperationType_Cond), operationType_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return 0;
...
*/
export async function OperationType_GetMaxStrIdByPrefix(strPrefix: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
...
*/
export async function OperationType_BindDdl_OperationTypeIdInDiv_Cache(strDivName: string, strDdlName: string )
{
...
BindDdl_ObjLstInDiv(strDivName, strDdlName, arrObjLst_Sel, clsOperationTypeEN.con_OperationTypeId, clsOperationTypeEN.con_OperationTypeName, "操作类型");
}
...
//检查主键是否为Null或者空！
if (IsNullOrEmpty(pobjOperationTypeEN.operationTypeId) === true )
{
...
*/
export function OperationType_GetCombineCondition(objOperationType_Cond: clsOperationTypeEN ):string
{
...
if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN.con_OperationTypeId) == true)
{
const strComparisonOp_OperationTypeId:string = objOperationType_Cond.dicFldComparisonOp[clsOperationTypeEN.con_OperationTypeId];
strWhereCond += Format(" And {0} {2} '{1}'", clsOperationTypeEN.con_OperationTypeId, objOperationType_Cond.operationTypeId, strComparisonOp_OperationTypeId);
}
if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN.con_OperationTypeName) == true)
{
const strComparisonOp_OperationTypeName:string = objOperationType_Cond.dicFldComparisonOp[clsOperationTypeEN.con_OperationTypeName];
strWhereCond += Format(" And {0} {2} '{1}'", clsOperationTypeEN.con_OperationTypeName, objOperationType_Cond.operationTypeName, strComparisonOp_OperationTypeName);
}
if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN.con_UpdDate) == true)
{
const strComparisonOp_UpdDate:string = objOperationType_Cond.dicFldComparisonOp[clsOperationTypeEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clsOperationTypeEN.con_UpdDate, objOperationType_Cond.updDate, strComparisonOp_UpdDate);
}
if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN.con_UpdUserId) == true)
{
const strComparisonOp_UpdUserId:string = objOperationType_Cond.dicFldComparisonOp[clsOperationTypeEN.con_UpdUserId];
strWhereCond += Format(" And {0} {2} '{1}'", clsOperationTypeEN.con_UpdUserId, objOperationType_Cond.updUserId, strComparisonOp_UpdUserId);
}
if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN.con_Memo) == true)
{
const strComparisonOp_Memo:string = objOperationType_Cond.dicFldComparisonOp[clsOperationTypeEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clsOperationTypeEN.con_Memo, objOperationType_Cond.memo, strComparisonOp_Memo);
}
 return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
export function OperationType_GetUniCondStr_OperationTypeId(objOperationTypeEN: clsOperationTypeEN ):string
{
let strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
export function OperationType_GetUniCondStr4Update_OperationTypeId(objOperationTypeEN: clsOperationTypeEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and OperationTypeId <> '{0}'", objOperationTypeEN.operationTypeId);
 strWhereCond +=  Format(" and OperationTypeId = '{0}'", objOperationTypeEN.operationTypeId);
