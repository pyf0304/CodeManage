...
if (IsNullOrEmpty(strExcellentTypeId) == true)
{
  const strMsg = Format("参数:[strExcellentTypeId]不能为空！(In clscc_ExcellentTypeWApi.GetObjByExcellentTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strExcellentTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strExcellentTypeId]的长度:[{0}]不正确！(clscc_ExcellentTypeWApi.GetObjByExcellentTypeId_Cache)", strExcellentTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrcc_ExcellentType_Sel: Array <clscc_ExcellentTypeEN> = arrcc_ExcellentTypeObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strExcellentTypeId) == true)
{
  const strMsg = Format("参数:[strExcellentTypeId]不能为空！(In clscc_ExcellentTypeWApi.GetObjByExcellentTypeId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strExcellentTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strExcellentTypeId]的长度:[{0}]不正确！(clscc_ExcellentTypeWApi.GetObjByExcellentTypeId_localStorage)", strExcellentTypeId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strExcellentTypeId) == true)
{
  const strMsg = Format("参数:[strExcellentTypeId]不能为空！(In clscc_ExcellentTypeWApi.GetNameByExcellentTypeId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strExcellentTypeId.length != 4)
{
const strMsg = Format("缓存分类变量:[strExcellentTypeId]的长度:[{0}]不正确！(clscc_ExcellentTypeWApi.GetNameByExcellentTypeId_Cache)", strExcellentTypeId.length);
console.error(strMsg);
throw (strMsg);
}
const arrcc_ExcellentTypeObjLst_Cache = await cc_ExcellentType_GetObjLst_Cache();
...
if (arrcc_ExcellentType_Sel.length == 0) return [];
...
*/
export async function cc_ExcellentType_BindDdl_ExcellentTypeIdInDiv_Cache(strDivName: string, strDdlName: string )
{
