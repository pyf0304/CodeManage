 ...
 * @returns 对象
 **/
export async function TopicObjective_GetObjByTopicObjectiveIdAsync(strTopicObjectiveId: string): Promise<clsTopicObjectiveEN|null>  
{
const strThisFuncName = "GetObjByTopicObjectiveIdAsync";

if (IsNullOrEmpty(strTopicObjectiveId) == true)
{
  const strMsg = Format("参数:[strTopicObjectiveId]不能为空！(In clsTopicObjectiveWApi.GetObjByTopicObjectiveIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicObjectiveId.length != 8)
{
const strMsg = Format("缓存分类变量:[strTopicObjectiveId]的长度:[{0}]不正确！(clsTopicObjectiveWApi.GetObjByTopicObjectiveIdAsync)", strTopicObjectiveId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strTopicObjectiveId) == true)
{
  const strMsg = Format("参数:[strTopicObjectiveId]不能为空！(In clsTopicObjectiveWApi.GetObjByTopicObjectiveId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicObjectiveId.length != 8)
{
const strMsg = Format("缓存分类变量:[strTopicObjectiveId]的长度:[{0}]不正确！(clsTopicObjectiveWApi.GetObjByTopicObjectiveId_Cache)", strTopicObjectiveId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrTopicObjective_Sel: Array <clsTopicObjectiveEN> = arrTopicObjectiveObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strTopicObjectiveId) == true)
{
  const strMsg = Format("参数:[strTopicObjectiveId]不能为空！(In clsTopicObjectiveWApi.GetObjByTopicObjectiveId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicObjectiveId.length != 8)
{
const strMsg = Format("缓存分类变量:[strTopicObjectiveId]的长度:[{0}]不正确！(clsTopicObjectiveWApi.GetObjByTopicObjectiveId_localStorage)", strTopicObjectiveId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function TopicObjective_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsTopicObjectiveWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsTopicObjectiveWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsTopicObjectiveEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
if (objTopicObjective.GetFldValue(strOutFldName) == null) return "";
 ...
 * @returns 返回一个关键字值列表
*/
export async function TopicObjective_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsTopicObjectiveWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsTopicObjectiveWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrTopicObjective == null) return [];
...
if (arrTopicObjective_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function TopicObjective_GetFirstObjAsync(strWhereCond: string): Promise<clsTopicObjectiveEN|null>  
{
...
if (IsNullOrEmpty(clsTopicObjectiveEN.WhereFormat) == false)
{
strWhereCond = Format(clsTopicObjectiveEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsTopicObjectiveWApi.TopicObjective_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsTopicObjectiveWApi.TopicObjective_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
if (objPagerPara.pageIndex == 0) return new Array<clsTopicObjectiveEN>();
const arrTopicObjectiveObjLst_Cache = await TopicObjective_GetObjLst_Cache(strid_CurrEduCls);
...
const strAction = "UpdateRecord";
 if (objTopicObjectiveEN.sfUpdFldSetStr === undefined || objTopicObjectiveEN.sfUpdFldSetStr === null || objTopicObjectiveEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsTopicObjectiveWApi.clsTopicObjectiveWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsTopicObjectiveWApi.clsTopicObjectiveWApi.ReFreshCache)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
pobjTopicObjectiveEN.sfUpdFldSetStr = pobjTopicObjectiveEN.updFldString;
let strJson = "";
try
{
...
objTopicObjectiveENT.sfUpdFldSetStr = objTopicObjectiveENS.updFldString; //sfUpdFldSetStr
}
