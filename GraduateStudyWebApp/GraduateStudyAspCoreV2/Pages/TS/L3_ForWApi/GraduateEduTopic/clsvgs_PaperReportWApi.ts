 ...
 * @returns 对象
 **/
export async function vgs_PaperReport_GetObjByReportIdAsync(strReportId: string): Promise<clsvgs_PaperReportEN|null>  
{
const strThisFuncName = "GetObjByReportIdAsync";

if (IsNullOrEmpty(strReportId) == true)
{
  const strMsg = Format("参数:[strReportId]不能为空！(In clsvgs_PaperReportWApi.GetObjByReportIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strReportId.length != 10)
{
const strMsg = Format("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsvgs_PaperReportWApi.GetObjByReportIdAsync)", strReportId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strReportId) == true)
{
  const strMsg = Format("参数:[strReportId]不能为空！(In clsvgs_PaperReportWApi.GetObjByReportId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strReportId.length != 10)
{
const strMsg = Format("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsvgs_PaperReportWApi.GetObjByReportId_Cache)", strReportId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvgs_PaperReport_Sel: Array <clsvgs_PaperReportEN> = arrvgs_PaperReportObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strReportId) == true)
{
  const strMsg = Format("参数:[strReportId]不能为空！(In clsvgs_PaperReportWApi.GetObjByReportId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strReportId.length != 10)
{
const strMsg = Format("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsvgs_PaperReportWApi.GetObjByReportId_localStorage)", strReportId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvgs_PaperReportEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vgs_PaperReport_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrvgs_PaperReport_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vgs_PaperReport_GetFirstObjAsync(strWhereCond: string): Promise<clsvgs_PaperReportEN|null>  
{
