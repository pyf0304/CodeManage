 ...
 * @returns 对象
 **/
export async function RTConceptRela_GetObjBymIdAsync(lngmId: number): Promise<clsRTConceptRelaEN|null>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function RTConceptRela_GetFirstObjAsync(strWhereCond: string): Promise<clsRTConceptRelaEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objRTConceptRelaEN.sfUpdFldSetStr === undefined || objRTConceptRelaEN.sfUpdFldSetStr === null || objRTConceptRelaEN.sfUpdFldSetStr === "")
{
