 ...
 * @returns 对象
 **/
export async function gs_PaperReport_GetObjByReportIdAsync(strReportId: string): Promise<clsgs_PaperReportEN|null>  
{
const strThisFuncName = "GetObjByReportIdAsync";

if (IsNullOrEmpty(strReportId) == true)
{
  const strMsg = Format("参数:[strReportId]不能为空！(In clsgs_PaperReportWApi.GetObjByReportIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strReportId.length != 10)
{
const strMsg = Format("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsgs_PaperReportWApi.GetObjByReportIdAsync)", strReportId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strReportId) == true)
{
  const strMsg = Format("参数:[strReportId]不能为空！(In clsgs_PaperReportWApi.GetObjByReportId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strReportId.length != 10)
{
const strMsg = Format("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsgs_PaperReportWApi.GetObjByReportId_Cache)", strReportId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_PaperReport_Sel: Array <clsgs_PaperReportEN> = arrgs_PaperReportObjLst_Cache.filter(x => 
 x.reportId == strReportId );
...
if (IsNullOrEmpty(strReportId) == true)
{
  const strMsg = Format("参数:[strReportId]不能为空！(In clsgs_PaperReportWApi.GetObjByReportId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strReportId.length != 10)
{
const strMsg = Format("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsgs_PaperReportWApi.GetObjByReportId_localStorage)", strReportId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsgs_PaperReportEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_PaperReport_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrgs_PaperReport_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_PaperReport_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_PaperReportEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objgs_PaperReportEN.sfUpdFldSetStr === undefined || objgs_PaperReportEN.sfUpdFldSetStr === null || objgs_PaperReportEN.sfUpdFldSetStr === "")
{
