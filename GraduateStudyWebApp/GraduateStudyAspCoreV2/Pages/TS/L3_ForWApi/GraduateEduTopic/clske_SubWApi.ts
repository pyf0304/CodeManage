 ...
 * @returns 对象
 **/
export async function ke_Sub_GetObjByke_SubIdAsync(strke_SubId: string): Promise<clske_SubEN|null>  
{
const strThisFuncName = "GetObjByke_SubIdAsync";

if (IsNullOrEmpty(strke_SubId) == true)
{
  const strMsg = Format("参数:[strke_SubId]不能为空！(In clske_SubWApi.GetObjByke_SubIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SubId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SubId]的长度:[{0}]不正确！(clske_SubWApi.GetObjByke_SubIdAsync)", strke_SubId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strke_SubId) == true)
{
  const strMsg = Format("参数:[strke_SubId]不能为空！(In clske_SubWApi.GetObjByke_SubId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SubId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SubId]的长度:[{0}]不正确！(clske_SubWApi.GetObjByke_SubId_Cache)", strke_SubId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrke_Sub_Sel: Array <clske_SubEN> = arrke_SubObjLst_Cache.filter(x => 
 x.ke_SubId == strke_SubId );
...
if (IsNullOrEmpty(strke_SubId) == true)
{
  const strMsg = Format("参数:[strke_SubId]不能为空！(In clske_SubWApi.GetObjByke_SubId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SubId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SubId]的长度:[{0}]不正确！(clske_SubWApi.GetObjByke_SubId_localStorage)", strke_SubId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clske_SubEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
...
return (a: clske_SubEN, b: clske_SubEN) => {
if (a.ke_SubName_en == null) return -1;
if (b.ke_SubName_en == null) return 1;
return a.ke_SubName_en.localeCompare(b.ke_SubName_en);
}
case clske_SubEN.con_ke_SubDescribe_cn:
return (a: clske_SubEN, b: clske_SubEN) => {
if (a.ke_SubDescribe_cn == null) return -1;
if (b.ke_SubDescribe_cn == null) return 1;
return a.ke_SubDescribe_cn.localeCompare(b.ke_SubDescribe_cn);
}
case clske_SubEN.con_ke_SubDescribe_en:
return (a: clske_SubEN, b: clske_SubEN) => {
if (a.ke_SubDescribe_en == null) return -1;
if (b.ke_SubDescribe_en == null) return 1;
 ...
 * @returns 返回一个关键字值列表
*/
export async function ke_Sub_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrke_Sub_Sel.length == 0) return [];
...
const strAction = "UpdateRecord";
 if (objke_SubEN.sfUpdFldSetStr === undefined || objke_SubEN.sfUpdFldSetStr === null || objke_SubEN.sfUpdFldSetStr === "")
{
