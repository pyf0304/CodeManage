 ...
 * @returns 对象
 **/
export async function vSysSocialRelations_GetObjBySocialIdAsync(strSocialId: string): Promise<clsvSysSocialRelationsEN|null>  
{
const strThisFuncName = "GetObjBySocialIdAsync";

if (IsNullOrEmpty(strSocialId) == true)
{
  const strMsg = Format("参数:[strSocialId]不能为空！(In clsvSysSocialRelationsWApi.GetObjBySocialIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strSocialId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.GetObjBySocialIdAsync)", strSocialId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strSocialId) == true)
{
  const strMsg = Format("参数:[strSocialId]不能为空！(In clsvSysSocialRelationsWApi.GetObjBySocialId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSocialId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.GetObjBySocialId_Cache)", strSocialId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvSysSocialRelations_Sel: Array <clsvSysSocialRelationsEN> = arrvSysSocialRelationsObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strSocialId) == true)
{
  const strMsg = Format("参数:[strSocialId]不能为空！(In clsvSysSocialRelationsWApi.GetObjBySocialId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSocialId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.GetObjBySocialId_localStorage)", strSocialId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strSocialId) == true)
{
  const strMsg = Format("参数:[strSocialId]不能为空！(In clsvSysSocialRelationsWApi.GetNameBySocialId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSocialId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.GetNameBySocialId_Cache)", strSocialId.length);
console.error(strMsg);
throw (strMsg);
}
const arrvSysSocialRelationsObjLst_Cache = await vSysSocialRelations_GetObjLst_Cache(strid_CurrEduCls);
 ...
 * @returns 返回一个输出字段值
*/
export async function vSysSocialRelations_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvSysSocialRelationsWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvSysSocialRelationsEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vSysSocialRelations_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvSysSocialRelationsWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvSysSocialRelations_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vSysSocialRelations_GetFirstObjAsync(strWhereCond: string): Promise<clsvSysSocialRelationsEN|null>  
{
...
{
strWhereCond = Format(clsvSysSocialRelationsEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvSysSocialRelationsWApi.vSysSocialRelations_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvSysSocialRelationsWApi.vSysSocialRelations_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsvSysSocialRelationsWApi.)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsvSysSocialRelationsWApi.)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
