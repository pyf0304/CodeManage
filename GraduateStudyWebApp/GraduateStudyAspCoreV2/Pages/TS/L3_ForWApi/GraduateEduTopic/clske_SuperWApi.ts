 ...
 * @returns 对象
 **/
export async function ke_Super_GetObjByke_SuperIdAsync(strke_SuperId: string): Promise<clske_SuperEN|null>  
{
const strThisFuncName = "GetObjByke_SuperIdAsync";

if (IsNullOrEmpty(strke_SuperId) == true)
{
  const strMsg = Format("参数:[strke_SuperId]不能为空！(In clske_SuperWApi.GetObjByke_SuperIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SuperId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SuperId]的长度:[{0}]不正确！(clske_SuperWApi.GetObjByke_SuperIdAsync)", strke_SuperId.length);
console.error(strMsg);
throw (strMsg);
}
...
{
const strInfo = Format("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, ke_Super_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else if (error.statusText == "Not Found")
{
const strInfo = Format("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, ke_Super_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else
 ...
 * @returns 对象
*/
export async function ke_Super_GetObjByke_SuperId_Cache(strke_SuperId: string, bolTryAsyncOnce: boolean = true) {
const strThisFuncName = "GetObjByke_SuperId_Cache";

if (IsNullOrEmpty(strke_SuperId) == true)
{
  const strMsg = Format("参数:[strke_SuperId]不能为空！(In clske_SuperWApi.GetObjByke_SuperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SuperId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SuperId]的长度:[{0}]不正确！(clske_SuperWApi.GetObjByke_SuperId_Cache)", strke_SuperId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrke_Super_Sel: Array <clske_SuperEN> = arrke_SuperObjLst_Cache.filter(x => 
 x.ke_SuperId == strke_SuperId );
...
{
const strMsg = Format("错误:[{0}]. \n根据关键字:[{1}]获取相应的对象不成功!(in {2}.{3})", e, strke_SuperId, ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
}
return null;
}
 ...
 * @returns 对象
*/
export async function ke_Super_GetObjByke_SuperId_localStorage(strke_SuperId: string) {
const strThisFuncName = "GetObjByke_SuperId_localStorage";

if (IsNullOrEmpty(strke_SuperId) == true)
{
  const strMsg = Format("参数:[strke_SuperId]不能为空！(In clske_SuperWApi.GetObjByke_SuperId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SuperId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SuperId]的长度:[{0}]不正确！(clske_SuperWApi.GetObjByke_SuperId_localStorage)", strke_SuperId.length);
console.error(strMsg);
throw (strMsg);
}
const strKey = Format("{0}_{1}", clske_SuperEN._CurrTabName, strke_SuperId);
if (strKey == "")
{
...
const objke_Super_Cache: clske_SuperEN = JSON.parse(strTempObj);
 ...
 * @returns 对象
*/
export async function ke_Super_UpdateObjInLst_Cache(objke_Super: clske_SuperEN) {
const strThisFuncName = "UpdateObjInLst_Cache";
try
{
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
const obj = arrke_SuperObjLst_Cache.find(x => 
x.ke_SuperId == objke_Super.ke_SuperId);
if (obj != null)
{
...
const strMsg = Format("错误:[{0}]. \n在列表中修改对象不成功!(in {1}.{2})", e, ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @returns 对象
*/
export async function ke_Super_GetNameByke_SuperId_Cache(strke_SuperId: string) {
const strThisFuncName = "GetNameByke_SuperId_Cache";

if (IsNullOrEmpty(strke_SuperId) == true)
{
  const strMsg = Format("参数:[strke_SuperId]不能为空！(In clske_SuperWApi.GetNameByke_SuperId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strke_SuperId.length != 4)
{
const strMsg = Format("缓存分类变量:[strke_SuperId]的长度:[{0}]不正确！(clske_SuperWApi.GetNameByke_SuperId_Cache)", strke_SuperId.length);
console.error(strMsg);
throw (strMsg);
}
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
if (arrke_SuperObjLst_Cache == null) return "";
try
{
const arrke_Super_Sel: Array <clske_SuperEN> = arrke_SuperObjLst_Cache.filter(x => 
 x.ke_SuperId == strke_SuperId );
 ...
 * @returns 返回一个输出字段值
*/
export async function ke_Super_func(strInFldName:string , strOutFldName:string , strInValue:string )
{
//const strThisFuncName = "func";

if (strInFldName != clske_SuperEN.con_ke_SuperId)
{
...
strOutFldName, clske_SuperEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回两个对象比较的结果
*/
export function ke_Super_SortFun_Defa(a:clske_SuperEN , b:clske_SuperEN): number 
{
 ...
 * @returns 返回两个对象比较的结果
*/
export function ke_Super_SortFun_Defa_2Fld(a:clske_SuperEN , b:clske_SuperEN): number 
{
const strThisFuncName = "SortFun_Defa_2Fld";
if (a.ke_SuperName_cn == b.ke_SuperName_cn) return a.ke_SuperName_en.localeCompare(b.ke_SuperName_en);
else return a.ke_SuperName_cn.localeCompare(b.ke_SuperName_cn);
}
...
return (a: clske_SuperEN, b: clske_SuperEN) => {
if (a.ke_SuperName_en == null) return -1;
if (b.ke_SuperName_en == null) return 1;
return a.ke_SuperName_en.localeCompare(b.ke_SuperName_en);
}
case clske_SuperEN.con_ke_SuperDescribe_cn:
return (a: clske_SuperEN, b: clske_SuperEN) => {
if (a.ke_SuperDescribe_cn == null) return -1;
if (b.ke_SuperDescribe_cn == null) return 1;
return a.ke_SuperDescribe_cn.localeCompare(b.ke_SuperDescribe_cn);
}
case clske_SuperEN.con_ke_SuperDescribe_en:
return (a: clske_SuperEN, b: clske_SuperEN) => {
if (a.ke_SuperDescribe_en == null) return -1;
if (b.ke_SuperDescribe_en == null) return 1;
 ...
 * @returns 返回一个关键字值列表
*/
export async function ke_Super_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrke_Super_Sel.length == 0) return [];
 ...
 * @returns 返回的第一条记录的关键字值
*/
export async function ke_Super_GetFirstID(strWhereCond: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 第一条记录对象
 **/
export async function ke_Super_GetFirstObjAsync(strWhereCond: string): Promise<clske_SuperEN|null>  
{
 ...
 **/
export async function ke_Super_GetObjLst_ClientCache() 
{
...
{
//缓存存在，直接返回
const arrke_SuperExObjLst_Cache: Array<clske_SuperEN> = CacheHelper.Get(strKey);
...
const strInfo = Format("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SuperExObjLst.length);
console.log(strInfo);
return arrke_SuperExObjLst;
}
catch (e)
{
const strMsg = Format("从本地缓存中获取所有对象列表出错. \n服务器错误：{0}.(in {1}.{2})", e, ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
throw (strMsg);
}
}
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ke_Super_GetObjLst_localStorage() 
{
...
const arrke_SuperExObjLst_Cache: Array<clske_SuperEN> = JSON.parse(strTempObjLst);
const arrke_SuperObjLst_T = ke_Super_GetObjLstByJSONObjLst(arrke_SuperExObjLst_Cache);
return arrke_SuperObjLst_T;
}
try
...
const strInfo = Format("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SuperExObjLst.length);
console.log(strInfo);
return arrke_SuperExObjLst;
}
catch (e)
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ke_Super_GetObjLst_localStorage_PureCache() 
{
...
//缓存存在，直接返回
const strTempObjLst:string = localStorage.getItem(strKey) as string;
const arrke_SuperObjLst_Cache: Array<clske_SuperEN> = JSON.parse(strTempObjLst);
...
{
const strNullInfo = Format("获取数据为null, 请注意!(in {0}.{1})", ke_Super_ConstructorName, strThisFuncName);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ke_Super_GetObjLst_sessionStorage() 
{
...
const strInfo = Format("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SuperExObjLst.length);
console.log(strInfo);
return arrke_SuperExObjLst;
}
catch (e)
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ke_Super_GetObjLst_sessionStorage_PureCache() 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ke_Super_GetObjLst_Cache(): Promise<Array<clske_SuperEN>> 
{
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function ke_Super_GetObjLst_PureCache() 
{
 ...
 * @returns 对象列表子集
*/
export async function ke_Super_GetSubObjLst_Cache(objke_Super_Cond: clske_SuperEN) {
const strThisFuncName = "GetSubObjLst_Cache";
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
let arrke_Super_Sel: Array < clske_SuperEN > = arrke_SuperObjLst_Cache;
if (objke_Super_Cond.sf_FldComparisonOp == null || objke_Super_Cond.sf_FldComparisonOp == "") return arrke_Super_Sel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objke_Super_Cond.sf_FldComparisonOp);
//console.log("clske_SuperWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
const sstrKeys = GetObjKeys(objke_Super_Cond);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]缓存对象列表中获取子集对象不成功!(in {2}.{3})", e, JSON.stringify( objke_Super_Cond), ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 对象列表
 **/
export async function ke_Super_GetObjLstByke_SuperIdLstAsync(arrke_SuperId: Array<string>): Promise<Array<clske_SuperEN>>  
{
...
try
{
const response = await axios.post(strUrl, arrke_SuperId);
const data = response.data;
if (data.errorId == 0)
{
const returnObjLst = data.returnObjLst;
 ...
 * @returns 对象列表
*/
export async function ke_Super_GetObjLstByke_SuperIdLst_Cache(arrke_SuperIdLst: Array<string>) {
const strThisFuncName = "GetObjLstByke_SuperIdLst_Cache";
try
{
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
const arrke_Super_Sel: Array <clske_SuperEN> = arrke_SuperObjLst_Cache.filter(x => arrke_SuperIdLst.indexOf(x.ke_SuperId)>-1);
return arrke_Super_Sel;
}
catch (e)
{
const strMsg = Format("错误:[{0}]. \n根据关键字:[{1}]获取对象列表不成功!(in {2}.{3})", e, arrke_SuperIdLst.join(","), ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
}
 ...
 * @returns 获取的相应对象列表
 **/
export async function ke_Super_GetTopObjLstAsync(objTopPara: stuTopPara): Promise<Array<clske_SuperEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function ke_Super_GetObjLstByRangeAsync(objRangePara: stuRangePara): Promise<Array<clske_SuperEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
*/
export async function ke_Super_GetObjLstByRange(intMinNum: number, intMaxNum: number, strWhereCond: string, strOrderBy:string="", cb: (json: any) => void, errorCb: (json: any) => void) 
{
 ...
 * @returns 对象列表
*/
export async function ke_Super_GetObjLstByPager_Cache(objPagerPara: stuPagerPara) {
const strThisFuncName = "GetObjLstByPager_Cache";
if (objPagerPara.pageIndex == 0) return new Array<clske_SuperEN>();
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
if (arrke_SuperObjLst_Cache.length == 0) return arrke_SuperObjLst_Cache;
let arrke_Super_Sel = arrke_SuperObjLst_Cache;
const obj_Cond = JSON.parse(objPagerPara.whereCond);
const objke_Super_Cond = new clske_SuperEN();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clske_SuperEN>();
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function ke_Super_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clske_SuperEN>>  
{
 ...
 * @returns 获取删除的结果
 **/
export async function ke_Super_DelRecordAsync(strke_SuperId: string): Promise<number>  
{
const strThisFuncName = "DelRecordAsync";
const strAction = "DelRecord";
let strUrl = GetWebApiUrl(ke_Super_Controller, strAction);
strUrl = Format("{0}/?Id={1}", strUrl, strke_SuperId);
try
{
 ...
 * @returns 实际删除记录的个数
 **/
export async function ke_Super_Delke_SupersAsync(arrke_SuperId: Array<string>): Promise<number> 
{
...
try
{
const response = await axios.post(strUrl, objke_SuperEN);
const data = response.data;
if (data.errorId == 0)
{
 ...
 * @returns 获取相应的记录的对象
 **/
export async function ke_Super_AddNewRecordWithMaxIdAsync(objke_SuperEN: clske_SuperEN): Promise<string> 
{
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function ke_Super_AddNewRecordWithReturnKeyAsync(objke_SuperEN: clske_SuperEN): Promise<string> 
{
 ...
 * @returns 返回新添加记录的关键字
*/
export async function ke_Super_AddNewRecordWithReturnKey(objke_SuperEN: clske_SuperEN, cb: (json: any) => void, errorCb: (json: any) => void)
{
...
const strAction = "UpdateRecord";
 if (objke_SuperEN.sfUpdFldSetStr === undefined || objke_SuperEN.sfUpdFldSetStr === null || objke_SuperEN.sfUpdFldSetStr === "")
{
const strMsg = Format("对象(关键字: {0})的【修改字段集】为空，不能修改!", objke_SuperEN.ke_SuperId);
 throw strMsg;
 }
const strUrl = GetWebApiUrl(ke_Super_Controller, strAction);
try
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function ke_Super_UpdateWithConditionAsync(objke_SuperEN: clske_SuperEN, strWhereCond: string ): Promise<boolean> 
{
 ...
 * @returns 对象列表子集
*/
export async function ke_Super_IsExistRecord_Cache(objke_Super_Cond: clske_SuperEN) {
const strThisFuncName = "IsExistRecord_Cache";
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
if (arrke_SuperObjLst_Cache == null) return false;
let arrke_Super_Sel: Array < clske_SuperEN > = arrke_SuperObjLst_Cache;
if (objke_Super_Cond.sf_FldComparisonOp == null || objke_Super_Cond.sf_FldComparisonOp == "") return arrke_Super_Sel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objke_Super_Cond.sf_FldComparisonOp);
//console.log("clske_SuperWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify( objke_Super_Cond), ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return false;
...
*/
export async function ke_Super_IsExist(strke_SuperId: string, cb: (json: any) => void, errorCb: (json: any) => void)
{
 ...
 * @returns 对象
*/
export async function ke_Super_IsExist_Cache(strke_SuperId:string) {
const strThisFuncName = "IsExist_Cache";
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
if (arrke_SuperObjLst_Cache == null) return false;
try
{
const arrke_Super_Sel: Array <clske_SuperEN> = arrke_SuperObjLst_Cache.filter(x => x.ke_SuperId == strke_SuperId);
if (arrke_Super_Sel.length > 0)
{
return true;
}
...
{
const strMsg = Format("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strke_SuperId, ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
return false;
 ...
 * @returns 是否存在?存在返回True
 **/
export async function ke_Super_IsExistAsync(strke_SuperId: string): Promise<boolean> 
{
 ...
 * @returns 对象列表记录数
*/
export async function ke_Super_GetRecCountByCond_Cache(objke_Super_Cond: clske_SuperEN) {
const strThisFuncName = "GetRecCountByCond_Cache";
const arrke_SuperObjLst_Cache = await ke_Super_GetObjLst_Cache();
if (arrke_SuperObjLst_Cache == null) return 0;
let arrke_Super_Sel: Array < clske_SuperEN > = arrke_SuperObjLst_Cache;
if (objke_Super_Cond.sf_FldComparisonOp == null || objke_Super_Cond.sf_FldComparisonOp == "") return arrke_Super_Sel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objke_Super_Cond.sf_FldComparisonOp);
//console.log("clske_SuperWApi->GetSubObjLst_Cache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]从缓存对象列表中获取记录数不成功!(in {2}.{3})", e, JSON.stringify( objke_Super_Cond), ke_Super_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return 0;
...
*/
export async function ke_Super_GetMaxStrIdByPrefix(strPrefix: string, cb: (json: any) => void, errorCb: (json: any) => void) 
{
...
*/
export async function ke_Super_BindDdl_ke_SuperIdInDiv_Cache(strDivName: string, strDdlName: string )
{
...
BindDdl_ObjLstInDiv(strDivName, strDdlName, arrObjLst_Sel, clske_SuperEN.con_ke_SuperId, clske_SuperEN.con_ke_SuperName_cn, "知识经济父类");
}
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperName_cn) === true )
{
 throw new Error("(errid:Watl000058)字段[知识分类名]不能为空(In 知识经济父类)!(clske_SuperBL:CheckPropertyNew)");
}
//检查字段长度， 若字符型字段长度超出规定的长度，即非法！
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperId) == false && GetStrLen(pobjke_SuperEN.ke_SuperId) > 4)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperName_cn) == false && GetStrLen(pobjke_SuperEN.ke_SuperName_cn) > 200)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperName_en) == false && GetStrLen(pobjke_SuperEN.ke_SuperName_en) > 200)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperDescribe_cn) == false && GetStrLen(pobjke_SuperEN.ke_SuperDescribe_cn) > 500)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperDescribe_en) == false && GetStrLen(pobjke_SuperEN.ke_SuperDescribe_en) > 500)
{
...
//检查字段的数据类型是否正确
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperId) == false && undefined !== pobjke_SuperEN.ke_SuperId && tzDataType.isString(pobjke_SuperEN.ke_SuperId) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperName_cn) == false && undefined !== pobjke_SuperEN.ke_SuperName_cn && tzDataType.isString(pobjke_SuperEN.ke_SuperName_cn) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperName_en) == false && undefined !== pobjke_SuperEN.ke_SuperName_en && tzDataType.isString(pobjke_SuperEN.ke_SuperName_en) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperDescribe_cn) == false && undefined !== pobjke_SuperEN.ke_SuperDescribe_cn && tzDataType.isString(pobjke_SuperEN.ke_SuperDescribe_cn) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperDescribe_en) == false && undefined !== pobjke_SuperEN.ke_SuperDescribe_en && tzDataType.isString(pobjke_SuperEN.ke_SuperDescribe_en) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.updDate) == false && undefined !== pobjke_SuperEN.updDate && tzDataType.isString(pobjke_SuperEN.updDate) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.updUser) == false && undefined !== pobjke_SuperEN.updUser && tzDataType.isString(pobjke_SuperEN.updUser) === false)
{
...
if (IsNullOrEmpty(pobjke_SuperEN.memo) == false && undefined !== pobjke_SuperEN.memo && tzDataType.isString(pobjke_SuperEN.memo) === false)
{
...
//检查主键是否为Null或者空！
if (IsNullOrEmpty(pobjke_SuperEN.ke_SuperId) === true )
{
 ...
 * @returns 返回一个生成的对象列表
*/
export function ke_Super_GetObjLstByJSONObjLst (arrke_SuperObjLstS: Array<clske_SuperEN>): Array<clske_SuperEN>
{
...
*/
export function ke_Super_GetCombineCondition(objke_Super_Cond: clske_SuperEN ):string
{
...
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_ke_SuperId) == true)
{
const strComparisonOp_ke_SuperId:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_ke_SuperId];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_ke_SuperId, objke_Super_Cond.ke_SuperId, strComparisonOp_ke_SuperId);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_ke_SuperName_cn) == true)
{
const strComparisonOp_ke_SuperName_cn:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_ke_SuperName_cn];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_ke_SuperName_cn, objke_Super_Cond.ke_SuperName_cn, strComparisonOp_ke_SuperName_cn);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_ke_SuperName_en) == true)
{
const strComparisonOp_ke_SuperName_en:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_ke_SuperName_en];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_ke_SuperName_en, objke_Super_Cond.ke_SuperName_en, strComparisonOp_ke_SuperName_en);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_ke_SuperDescribe_cn) == true)
{
const strComparisonOp_ke_SuperDescribe_cn:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_ke_SuperDescribe_cn];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_ke_SuperDescribe_cn, objke_Super_Cond.ke_SuperDescribe_cn, strComparisonOp_ke_SuperDescribe_cn);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_ke_SuperDescribe_en) == true)
{
const strComparisonOp_ke_SuperDescribe_en:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_ke_SuperDescribe_en];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_ke_SuperDescribe_en, objke_Super_Cond.ke_SuperDescribe_en, strComparisonOp_ke_SuperDescribe_en);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_UpdDate) == true)
{
const strComparisonOp_UpdDate:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_UpdDate, objke_Super_Cond.updDate, strComparisonOp_UpdDate);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_UpdUser) == true)
{
const strComparisonOp_UpdUser:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_UpdUser];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_UpdUser, objke_Super_Cond.updUser, strComparisonOp_UpdUser);
}
if (Object.prototype.hasOwnProperty.call(objke_Super_Cond.dicFldComparisonOp, clske_SuperEN.con_Memo) == true)
{
const strComparisonOp_Memo:string = objke_Super_Cond.dicFldComparisonOp[clske_SuperEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clske_SuperEN.con_Memo, objke_Super_Cond.memo, strComparisonOp_Memo);
}
 return strWhereCond;
}
...
*/
export function ke_Super_CopyObjTo(objke_SuperENS: clske_SuperEN , objke_SuperENT: clske_SuperEN ): void 
{
