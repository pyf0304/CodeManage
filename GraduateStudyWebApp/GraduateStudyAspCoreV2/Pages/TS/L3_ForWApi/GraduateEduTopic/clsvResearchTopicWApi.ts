 ...
 * @returns 对象
 **/
export async function vResearchTopic_GetObjByTopicIdAsync(strTopicId: string): Promise<clsvResearchTopicEN|null>  
{
const strThisFuncName = "GetObjByTopicIdAsync";

if (IsNullOrEmpty(strTopicId) == true)
{
  const strMsg = Format("参数:[strTopicId]不能为空！(In clsvResearchTopicWApi.GetObjByTopicIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicId.length != 8)
{
const strMsg = Format("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(clsvResearchTopicWApi.GetObjByTopicIdAsync)", strTopicId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strTopicId) == true)
{
  const strMsg = Format("参数:[strTopicId]不能为空！(In clsvResearchTopicWApi.GetObjByTopicId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicId.length != 8)
{
const strMsg = Format("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(clsvResearchTopicWApi.GetObjByTopicId_Cache)", strTopicId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvResearchTopic_Sel: Array <clsvResearchTopicEN> = arrvResearchTopicObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strTopicId) == true)
{
  const strMsg = Format("参数:[strTopicId]不能为空！(In clsvResearchTopicWApi.GetObjByTopicId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicId.length != 8)
{
const strMsg = Format("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(clsvResearchTopicWApi.GetObjByTopicId_localStorage)", strTopicId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function vResearchTopic_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvResearchTopicWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvResearchTopicWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvResearchTopicEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vResearchTopic_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvResearchTopicWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvResearchTopicWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvResearchTopic_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vResearchTopic_GetFirstObjAsync(strWhereCond: string): Promise<clsvResearchTopicEN|null>  
{
...
{
strWhereCond = Format(clsvResearchTopicEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvResearchTopicWApi.vResearchTopic_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvResearchTopicWApi.vResearchTopic_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
