 ...
 * @returns 对象
 **/
export async function vConceptAttachment_GetObjByConceptAttachmentIdAsync(lngConceptAttachmentId: number): Promise<clsvConceptAttachmentEN|null>  
{
const strThisFuncName = "GetObjByConceptAttachmentIdAsync";

if (lngConceptAttachmentId == 0)
{
  const strMsg = Format("参数:[lngConceptAttachmentId]不能为空！(In clsvConceptAttachmentWApi.GetObjByConceptAttachmentIdAsync)");
...
if (lngConceptAttachmentId == 0)
{
  const strMsg = Format("参数:[lngConceptAttachmentId]不能为空！(In clsvConceptAttachmentWApi.GetObjByConceptAttachmentId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrvConceptAttachment_Sel: Array <clsvConceptAttachmentEN> = arrvConceptAttachmentObjLst_Cache.filter(x => 
 x.conceptAttachmentId == lngConceptAttachmentId );
...
if (lngConceptAttachmentId == 0)
{
  const strMsg = Format("参数:[lngConceptAttachmentId]不能为空！(In clsvConceptAttachmentWApi.GetObjByConceptAttachmentId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function vConceptAttachment_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvConceptAttachmentWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvConceptAttachmentWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvConceptAttachmentEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vConceptAttachment_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<number>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvConceptAttachmentWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvConceptAttachmentWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvConceptAttachment_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vConceptAttachment_GetFirstObjAsync(strWhereCond: string): Promise<clsvConceptAttachmentEN|null>  
{
...
{
strWhereCond = Format(clsvConceptAttachmentEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvConceptAttachmentWApi.vConceptAttachment_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvConceptAttachmentWApi.vConceptAttachment_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
