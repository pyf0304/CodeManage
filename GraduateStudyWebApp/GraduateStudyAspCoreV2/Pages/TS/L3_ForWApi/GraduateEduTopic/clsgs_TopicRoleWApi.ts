 ...
 * @returns 对象
 **/
export async function gs_TopicRole_GetObjByTopicRoleIdAsync(strTopicRoleId: string): Promise<clsgs_TopicRoleEN|null>  
{
const strThisFuncName = "GetObjByTopicRoleIdAsync";

if (IsNullOrEmpty(strTopicRoleId) == true)
{
  const strMsg = Format("参数:[strTopicRoleId]不能为空！(In clsgs_TopicRoleWApi.GetObjByTopicRoleIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicRoleId.length != 10)
{
const strMsg = Format("缓存分类变量:[strTopicRoleId]的长度:[{0}]不正确！(clsgs_TopicRoleWApi.GetObjByTopicRoleIdAsync)", strTopicRoleId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strTopicRoleId) == true)
{
  const strMsg = Format("参数:[strTopicRoleId]不能为空！(In clsgs_TopicRoleWApi.GetObjByTopicRoleId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicRoleId.length != 10)
{
const strMsg = Format("缓存分类变量:[strTopicRoleId]的长度:[{0}]不正确！(clsgs_TopicRoleWApi.GetObjByTopicRoleId_Cache)", strTopicRoleId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrgs_TopicRole_Sel: Array <clsgs_TopicRoleEN> = arrgs_TopicRoleObjLst_Cache.filter(x => 
 x.topicRoleId == strTopicRoleId );
...
if (IsNullOrEmpty(strTopicRoleId) == true)
{
  const strMsg = Format("参数:[strTopicRoleId]不能为空！(In clsgs_TopicRoleWApi.GetObjByTopicRoleId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strTopicRoleId.length != 10)
{
const strMsg = Format("缓存分类变量:[strTopicRoleId]的长度:[{0}]不正确！(clsgs_TopicRoleWApi.GetObjByTopicRoleId_localStorage)", strTopicRoleId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsgs_TopicRoleEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function gs_TopicRole_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrgs_TopicRole_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function gs_TopicRole_GetFirstObjAsync(strWhereCond: string): Promise<clsgs_TopicRoleEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objgs_TopicRoleEN.sfUpdFldSetStr === undefined || objgs_TopicRoleEN.sfUpdFldSetStr === null || objgs_TopicRoleEN.sfUpdFldSetStr === "")
{
