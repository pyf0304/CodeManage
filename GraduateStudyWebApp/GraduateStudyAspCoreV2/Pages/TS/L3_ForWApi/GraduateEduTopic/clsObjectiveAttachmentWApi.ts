 ...
 * @returns 对象
 **/
export async function ObjectiveAttachment_GetObjByObjectiveAttachmentIdAsync(lngObjectiveAttachmentId: number): Promise<clsObjectiveAttachmentEN|null>  
{
const strThisFuncName = "GetObjByObjectiveAttachmentIdAsync";

if (lngObjectiveAttachmentId == 0)
{
  const strMsg = Format("参数:[lngObjectiveAttachmentId]不能为空！(In clsObjectiveAttachmentWApi.GetObjByObjectiveAttachmentIdAsync)");
...
if (lngObjectiveAttachmentId == 0)
{
  const strMsg = Format("参数:[lngObjectiveAttachmentId]不能为空！(In clsObjectiveAttachmentWApi.GetObjByObjectiveAttachmentId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrObjectiveAttachment_Sel: Array <clsObjectiveAttachmentEN> = arrObjectiveAttachmentObjLst_Cache.filter(x => 
...
if (lngObjectiveAttachmentId == 0)
{
  const strMsg = Format("参数:[lngObjectiveAttachmentId]不能为空！(In clsObjectiveAttachmentWApi.GetObjByObjectiveAttachmentId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function ObjectiveAttachment_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsObjectiveAttachmentWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsObjectiveAttachmentWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsObjectiveAttachmentEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function ObjectiveAttachment_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<number>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsObjectiveAttachmentWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsObjectiveAttachmentWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrObjectiveAttachment_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function ObjectiveAttachment_GetFirstObjAsync(strWhereCond: string): Promise<clsObjectiveAttachmentEN|null>  
{
...
{
strWhereCond = Format(clsObjectiveAttachmentEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsObjectiveAttachmentWApi.ObjectiveAttachment_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsObjectiveAttachmentWApi.ObjectiveAttachment_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
const strAction = "UpdateRecord";
 if (objObjectiveAttachmentEN.sfUpdFldSetStr === undefined || objObjectiveAttachmentEN.sfUpdFldSetStr === null || objObjectiveAttachmentEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsObjectiveAttachmentWApi.clsObjectiveAttachmentWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsObjectiveAttachmentWApi.clsObjectiveAttachmentWApi.ReFreshCache)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
