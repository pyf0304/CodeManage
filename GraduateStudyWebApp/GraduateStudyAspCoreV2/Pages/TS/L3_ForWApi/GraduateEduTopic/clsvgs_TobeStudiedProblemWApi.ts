 ...
 * @returns 对象
 **/
export async function vgs_TobeStudiedProblem_GetObjByProblemIdAsync(strProblemId: string): Promise<clsvgs_TobeStudiedProblemEN|null>  
{
const strThisFuncName = "GetObjByProblemIdAsync";

if (IsNullOrEmpty(strProblemId) == true)
{
  const strMsg = Format("参数:[strProblemId]不能为空！(In clsvgs_TobeStudiedProblemWApi.GetObjByProblemIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strProblemId.length != 10)
{
const strMsg = Format("缓存分类变量:[strProblemId]的长度:[{0}]不正确！(clsvgs_TobeStudiedProblemWApi.GetObjByProblemIdAsync)", strProblemId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strProblemId) == true)
{
  const strMsg = Format("参数:[strProblemId]不能为空！(In clsvgs_TobeStudiedProblemWApi.GetObjByProblemId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strProblemId.length != 10)
{
const strMsg = Format("缓存分类变量:[strProblemId]的长度:[{0}]不正确！(clsvgs_TobeStudiedProblemWApi.GetObjByProblemId_Cache)", strProblemId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvgs_TobeStudiedProblem_Sel: Array <clsvgs_TobeStudiedProblemEN> = arrvgs_TobeStudiedProblemObjLst_Cache.filter(x => 
 x.problemId == strProblemId );
...
if (IsNullOrEmpty(strProblemId) == true)
{
  const strMsg = Format("参数:[strProblemId]不能为空！(In clsvgs_TobeStudiedProblemWApi.GetObjByProblemId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strProblemId.length != 10)
{
const strMsg = Format("缓存分类变量:[strProblemId]的长度:[{0}]不正确！(clsvgs_TobeStudiedProblemWApi.GetObjByProblemId_localStorage)", strProblemId.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvgs_TobeStudiedProblemEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vgs_TobeStudiedProblem_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
if (arrvgs_TobeStudiedProblem_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vgs_TobeStudiedProblem_GetFirstObjAsync(strWhereCond: string): Promise<clsvgs_TobeStudiedProblemEN|null>  
{
