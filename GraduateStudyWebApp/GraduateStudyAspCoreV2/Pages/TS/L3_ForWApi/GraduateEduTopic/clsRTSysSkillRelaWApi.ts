 ...
 * @returns 对象
 **/
export async function RTSysSkillRela_GetObjBymIdAsync(lngmId: number): Promise<clsRTSysSkillRelaEN|null>  
{
 ...
 * @returns 第一条记录对象
 **/
export async function RTSysSkillRela_GetFirstObjAsync(strWhereCond: string): Promise<clsRTSysSkillRelaEN|null>  
{
...
const strAction = "UpdateRecord";
 if (objRTSysSkillRelaEN.sfUpdFldSetStr === undefined || objRTSysSkillRelaEN.sfUpdFldSetStr === null || objRTSysSkillRelaEN.sfUpdFldSetStr === "")
{
