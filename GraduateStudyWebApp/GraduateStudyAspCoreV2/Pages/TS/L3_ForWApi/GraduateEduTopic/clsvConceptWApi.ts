 ...
 * @returns 对象
 **/
export async function vConcept_GetObjByConceptIdAsync(strConceptId: string): Promise<clsvConceptEN|null>  
{
const strThisFuncName = "GetObjByConceptIdAsync";

if (IsNullOrEmpty(strConceptId) == true)
{
  const strMsg = Format("参数:[strConceptId]不能为空！(In clsvConceptWApi.GetObjByConceptIdAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strConceptId.length != 8)
{
const strMsg = Format("缓存分类变量:[strConceptId]的长度:[{0}]不正确！(clsvConceptWApi.GetObjByConceptIdAsync)", strConceptId.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strConceptId) == true)
{
  const strMsg = Format("参数:[strConceptId]不能为空！(In clsvConceptWApi.GetObjByConceptId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strConceptId.length != 8)
{
const strMsg = Format("缓存分类变量:[strConceptId]的长度:[{0}]不正确！(clsvConceptWApi.GetObjByConceptId_Cache)", strConceptId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvConcept_Sel: Array <clsvConceptEN> = arrvConceptObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strConceptId) == true)
{
  const strMsg = Format("参数:[strConceptId]不能为空！(In clsvConceptWApi.GetObjByConceptId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strConceptId.length != 8)
{
const strMsg = Format("缓存分类变量:[strConceptId]的长度:[{0}]不正确！(clsvConceptWApi.GetObjByConceptId_localStorage)", strConceptId.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function vConcept_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvConceptWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvConceptWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsvConceptEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function vConcept_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsvConceptWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvConceptWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrvConcept_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function vConcept_GetFirstObjAsync(strWhereCond: string): Promise<clsvConceptEN|null>  
{
...
{
strWhereCond = Format(clsvConceptEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvConceptWApi.vConcept_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvConceptWApi.vConcept_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
