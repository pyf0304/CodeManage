 ...
 * @returns 对象
 **/
export async function ConceptAttachment_GetObjByConceptAttachmentIdAsync(lngConceptAttachmentId: number): Promise<clsConceptAttachmentEN|null>  
{
const strThisFuncName = "GetObjByConceptAttachmentIdAsync";

if (lngConceptAttachmentId == 0)
{
  const strMsg = Format("参数:[lngConceptAttachmentId]不能为空！(In clsConceptAttachmentWApi.GetObjByConceptAttachmentIdAsync)");
...
if (lngConceptAttachmentId == 0)
{
  const strMsg = Format("参数:[lngConceptAttachmentId]不能为空！(In clsConceptAttachmentWApi.GetObjByConceptAttachmentId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
...
try
{
const arrConceptAttachment_Sel: Array <clsConceptAttachmentEN> = arrConceptAttachmentObjLst_Cache.filter(x => 
...
if (lngConceptAttachmentId == 0)
{
  const strMsg = Format("参数:[lngConceptAttachmentId]不能为空！(In clsConceptAttachmentWApi.GetObjByConceptAttachmentId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
 ...
 * @returns 返回一个输出字段值
*/
export async function ConceptAttachment_func(strInFldName:string , strOutFldName:string , strInValue:string 
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsConceptAttachmentWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsConceptAttachmentWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
strOutFldName, clsConceptAttachmentEN.AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function ConceptAttachment_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<number>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsConceptAttachmentWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsConceptAttachmentWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrConceptAttachment_Sel.length == 0) return [];
 ...
 * @returns 第一条记录对象
 **/
export async function ConceptAttachment_GetFirstObjAsync(strWhereCond: string): Promise<clsConceptAttachmentEN|null>  
{
...
{
strWhereCond = Format(clsConceptAttachmentEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsConceptAttachmentWApi.ConceptAttachment_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsConceptAttachmentWApi.ConceptAttachment_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
const strAction = "UpdateRecord";
 if (objConceptAttachmentEN.sfUpdFldSetStr === undefined || objConceptAttachmentEN.sfUpdFldSetStr === null || objConceptAttachmentEN.sfUpdFldSetStr === "")
{
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsConceptAttachmentWApi.clsConceptAttachmentWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsConceptAttachmentWApi.clsConceptAttachmentWApi.ReFreshCache)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
