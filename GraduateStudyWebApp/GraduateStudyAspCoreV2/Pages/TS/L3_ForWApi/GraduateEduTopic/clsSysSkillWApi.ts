...
if (IsNullOrEmpty(strSkillId) == true)
{
  const strMsg = Format("参数:[strSkillId]不能为空！(In clsSysSkillWApi.GetObjBySkillId_Cache)");
console.error(strMsg);
 throw (strMsg);
}
if (strSkillId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSkillId]的长度:[{0}]不正确！(clsSysSkillWApi.GetObjBySkillId_Cache)", strSkillId.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrSysSkill_Sel: Array <clsSysSkillEN> = arrSysSkillObjLst_Cache.filter(x => 
...
if (IsNullOrEmpty(strSkillId) == true)
{
  const strMsg = Format("参数:[strSkillId]不能为空！(In clsSysSkillWApi.GetObjBySkillId_localStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strSkillId.length != 10)
{
const strMsg = Format("缓存分类变量:[strSkillId]的长度:[{0}]不正确！(clsSysSkillWApi.GetObjBySkillId_localStorage)", strSkillId.length);
console.error(strMsg);
throw (strMsg);
}
...
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsSysSkillWApi.func)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsSysSkillWApi.func)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export async function SysSkill_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string, strid_CurrEduCls_C: string): Promise<Array<string>>
{
//const strThisFuncName = "funcKey";

if (IsNullOrEmpty(strid_CurrEduCls_C) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls_C]不能为空！(In clsSysSkillWApi.funcKey)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls_C.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsSysSkillWApi.funcKey)", strid_CurrEduCls_C.length);
console.error(strMsg);
throw (strMsg);
}
...
if (arrSysSkill_Sel.length == 0) return [];
...
{
strWhereCond = Format(clsSysSkillEN.WhereFormat, strid_CurrEduCls);
}
else
{
...
{
const strMsg = Format("缓存分类变量:[id_CurrEduCls]不能为空！(in clsSysSkillWApi.SysSkill_GetObjLst_Cache() )");
console.error(strMsg);
throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsSysSkillWApi.SysSkill_GetObjLst_Cache() )", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
...
if (IsNullOrEmpty(strid_CurrEduCls) == true)
{
  const strMsg = Format("参数:[strid_CurrEduCls]不能为空！(In clsSysSkillWApi.clsSysSkillWApi.ReFreshCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strid_CurrEduCls.length != 8)
{
const strMsg = Format("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsSysSkillWApi.clsSysSkillWApi.ReFreshCache)", strid_CurrEduCls.length);
console.error(strMsg);
throw (strMsg);
}
