...
import { clsSysSkillVerENEx } from "../../L0_Entity/GraduateEduTopic/clsSysSkillVerENEx.js";
import { SysSkillVer_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsSysSkillVerWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { SysSkillVer_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsSysSkillVerWApi.js";
import { clsSysSkillVerEN } from "../../L0_Entity/GraduateEduTopic/clsSysSkillVerEN.js";
import { Format } from "../../PubFun/clsString.js";
import { SysSkillVer_FilterFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsSysSkillVerWApi.js";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, sysSkillVerEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function SysSkillVerEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsSysSkillVerENEx>> {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, sysSkillVerEx_ConstructorName, strThisFuncName);
console.error(strMsg);
...
*/
export function SysSkillVerEx_FuncMapByFldName(strFldName: string, objSysSkillVerEx: clsSysSkillVerENEx)
{
