...
import { vViewpointLikeLog_FilterFunByKey, vViewpointLikeLog_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTopic/clsvViewpointLikeLogWApi.js";
...
import { clsvViewpointLikeLogENEx } from "../../L0_Entity/GraduateEduTopic/clsvViewpointLikeLogENEx.js";
import { vViewpointLikeLog_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsvViewpointLikeLogWApi.js";
import { vViewpointLikeLog_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsvViewpointLikeLogWApi.js";
 ...
 **/
export function vViewpointLikeLogEx_CopyToEx(objvViewpointLikeLogENS:clsvViewpointLikeLogEN ): clsvViewpointLikeLogENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vViewpointLikeLogEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vViewpointLikeLogEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsvViewpointLikeLogENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvViewpointLikeLogObjLst = await vViewpointLikeLog_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vViewpointLikeLogEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function vViewpointLikeLogEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvViewpointLikeLogENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrvViewpointLikeLogExObjLst = await vViewpointLikeLog_GetObjLstAsync(objPagerPara.whereCond);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
 for (const objInFor of arrvViewpointLikeLogExObjLst) {
...
*/
export function vViewpointLikeLogEx_FuncMapByFldName(strFldName: string, objvViewpointLikeLogEx: clsvViewpointLikeLogENEx)
{
