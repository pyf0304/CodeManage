...
import { gs_ReflectLog_FilterFunByKey, gs_ReflectLog_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
...
import { clsgs_ReflectLogENEx } from "../../L0_Entity/GraduateEduTopic/clsgs_ReflectLogENEx.js";
import { gs_ReflectLog_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { clsSysPara4WebApi } from "../../PubConfig/clsSysPara4WebApi.js";
export const gs_ReflectLogEx_Controller = "gs_ReflectLogExApi";
 ...
 **/
export function gs_ReflectLogEx_CopyToEx(objgs_ReflectLogENS:clsgs_ReflectLogEN ): clsgs_ReflectLogENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, gs_ReflectLogEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function gs_ReflectLogEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsgs_ReflectLogENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrgs_ReflectLogObjLst = await gs_ReflectLog_GetObjLst_Cache();
...
let arrgs_ReflectLog_Sel: Array < clsgs_ReflectLogENEx > = arrgs_ReflectLogExObjLst;
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, gs_ReflectLogEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function gs_ReflectLogEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsgs_ReflectLogENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrgs_ReflectLogExObjLst = await gs_ReflectLog_GetObjLstAsync(objPagerPara.whereCond);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
 for (const objInFor of arrgs_ReflectLogExObjLst) {
...
*/
export function gs_ReflectLogEx_FuncMapByFldName(strFldName: string, objgs_ReflectLogEx: clsgs_ReflectLogENEx)
{
