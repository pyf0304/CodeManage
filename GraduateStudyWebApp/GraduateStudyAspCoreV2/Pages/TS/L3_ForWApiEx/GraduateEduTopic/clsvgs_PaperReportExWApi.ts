...
import { vgs_PaperReport_FilterFunByKey, vgs_PaperReport_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTopic/clsvgs_PaperReportWApi.js";
...
import { clsvgs_PaperReportENEx } from "../../L0_Entity/GraduateEduTopic/clsvgs_PaperReportENEx.js";
import { vgs_PaperReport_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsvgs_PaperReportWApi.js";
import { vgs_PaperReport_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsvgs_PaperReportWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { clsSysPara4WebApi } from "../../PubConfig/clsSysPara4WebApi.js";
export const vgs_PaperReportEx_Controller = "vgs_PaperReportExApi";
export const vgs_PaperReportEx_ConstructorName = "vgs_PaperReportEx";
 ...
 **/
export function vgs_PaperReportEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function vgs_PaperReportEx_CopyToEx(objvgs_PaperReportENS:clsvgs_PaperReportEN ): clsvgs_PaperReportENEx
{
const strThisFuncName  = vgs_PaperReportEx_CopyToEx.name;
 const objvgs_PaperReportENT = new clsvgs_PaperReportENEx();
try
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vgs_PaperReportEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vgs_PaperReportEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsvgs_PaperReportENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvgs_PaperReportObjLst = await vgs_PaperReport_GetObjLst_Cache();
...
if (arrvgs_PaperReportExObjLst.length == 0) return arrvgs_PaperReportExObjLst;
let arrvgs_PaperReport_Sel: Array < clsvgs_PaperReportENEx > = arrvgs_PaperReportExObjLst;
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vgs_PaperReportEx_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clsvgs_PaperReportENEx>();
}
 ...
 * @returns 对象列表
*/
export async function vgs_PaperReportEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvgs_PaperReportENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrvgs_PaperReportExObjLst = await vgs_PaperReport_GetObjLstAsync(objPagerPara.whereCond);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
 for (const objInFor of arrvgs_PaperReportExObjLst) {
 ...
 * @returns 返回两个对象比较的结果
*/
export function vgs_PaperReportEx_SortFunByKey(strKey:string, AscOrDesc: string)
{
...
{
        default:
return vgs_PaperReport_SortFunByKey(strKey, AscOrDesc);
 }
 }
  else
 {
...
*/
export function vgs_PaperReportEx_FuncMapByFldName(strFldName: string, objvgs_PaperReportEx: clsvgs_PaperReportENEx)
{
...
*/
export async function vgs_PaperReportEx_FilterFunByKey(strKey:string, value: any)
{
...
{
        default:
return vgs_PaperReport_FilterFunByKey(strKey, value);
 }
}
