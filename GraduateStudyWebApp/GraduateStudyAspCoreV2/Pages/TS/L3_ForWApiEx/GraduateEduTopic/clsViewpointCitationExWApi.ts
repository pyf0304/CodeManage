...
import { clsViewpointCitationENEx } from "../../L0_Entity/GraduateEduTopic/clsViewpointCitationENEx.js";
import { ViewpointCitation_FilterFunByKey, ViewpointCitation_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsViewpointCitationWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { ViewpointCitation_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsViewpointCitationWApi.js";
 ...
 **/
export function ViewpointCitationEx_CopyToEx(objViewpointCitationENS:clsViewpointCitationEN ): clsViewpointCitationENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, viewpointCitationEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function ViewpointCitationEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsViewpointCitationENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrViewpointCitationExObjLst = await ViewpointCitation_GetObjLstAsync(objPagerPara.whereCond);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, viewpointCitationEx_ConstructorName, strThisFuncName);
console.error(strMsg);
...
*/
export function ViewpointCitationEx_FuncMapByFldName(strFldName: string, objViewpointCitationEx: clsViewpointCitationENEx)
{
