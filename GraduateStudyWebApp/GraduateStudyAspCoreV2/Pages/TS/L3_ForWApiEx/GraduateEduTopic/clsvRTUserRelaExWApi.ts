...
import { vRTUserRela_FilterFunByKey, vRTUserRela_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js";
...
import { clsvRTUserRelaENEx } from "../../L0_Entity/GraduateEduTopic/clsvRTUserRelaENEx.js";
import { vRTUserRela_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js";
import { vRTUserRela_SortFunByKey } from "../../L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vRTUserRelaEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vRTUserRelaEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara , strTopicId:string):Promise<Array<clsvRTUserRelaENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvRTUserRelaObjLst = await vRTUserRela_GetObjLst_Cache(strTopicId);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vRTUserRelaEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function vRTUserRelaEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvRTUserRelaENEx>> {
...
*/
export function vRTUserRelaEx_FuncMapByFldName(strFldName: string, objvRTUserRelaEx: clsvRTUserRelaENEx)
{
