...
import { gs_KnowledgesGraph_GetObjLst_Cache } from "../../L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js";
import { stuPagerPara } from "../../PubFun/stuPagerPara.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { clsgs_KnowledgesGraphEN } from "../../L0_Entity/Knowledges_Share/clsgs_KnowledgesGraphEN.js";
import { GetObjKeys } from "../../PubFun/clsCommFunc4Web.js";
import { clsgs_KnowledgesGraphENEx } from "../../L0_Entity/Knowledges_Share/clsgs_KnowledgesGraphENEx.js";
import { gs_KnowledgesGraph_GetObjLstAsync } from "../../L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js";
import { gs_KnowledgesGraph_SortFunByKey } from "../../L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { gs_KnowledgesGraph_FilterFunByKey } from "../../L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js";
 ...
 **/
export function gs_KnowledgesGraphEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function gs_KnowledgesGraphEx_CopyToEx(objgs_KnowledgesGraphENS:clsgs_KnowledgesGraphEN ): clsgs_KnowledgesGraphENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, gs_KnowledgesGraphEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function gs_KnowledgesGraphEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara , strCourseId:string):Promise<Array<clsgs_KnowledgesGraphENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrgs_KnowledgesGraphObjLst = await gs_KnowledgesGraph_GetObjLst_Cache(strCourseId);
...
const objgs_KnowledgesGraph_Cond = new clsgs_KnowledgesGraphENEx();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, gs_KnowledgesGraphEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function gs_KnowledgesGraphEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsgs_KnowledgesGraphENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrgs_KnowledgesGraphObjLst = await gs_KnowledgesGraph_GetObjLstAsync(objPagerPara.whereCond);
const arrgs_KnowledgesGraphExObjLst = arrgs_KnowledgesGraphObjLst.map(gs_KnowledgesGraphEx_CopyToEx);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
...
*/
export function gs_KnowledgesGraphEx_FuncMapByFldName(strFldName: string, objgs_KnowledgesGraphEx: clsgs_KnowledgesGraphENEx)
{
