...
import { cc_CourseExamPaper_GetObjLst_Cache } from "../../L3_ForWApi/Knowledges/clscc_CourseExamPaperWApi.js";
...
import { clscc_CourseExamPaperENEx } from "../../L0_Entity/Knowledges/clscc_CourseExamPaperENEx.js";
import { cc_CourseExamPaper_GetObjLstAsync } from "../../L3_ForWApi/Knowledges/clscc_CourseExamPaperWApi.js";
import { cc_CourseExamPaper_SortFunByKey } from "../../L3_ForWApi/Knowledges/clscc_CourseExamPaperWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { cc_CourseExamPaper_FilterFunByKey } from "../../L3_ForWApi/Knowledges/clscc_CourseExamPaperWApi.js";
 ...
 **/
export function cc_CourseExamPaperEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function cc_CourseExamPaperEx_CopyToEx(objcc_CourseExamPaperENS:clscc_CourseExamPaperEN ): clscc_CourseExamPaperENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, cc_CourseExamPaperEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function cc_CourseExamPaperEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara , strCourseId:string):Promise<Array<clscc_CourseExamPaperENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrcc_CourseExamPaperObjLst = await cc_CourseExamPaper_GetObjLst_Cache(strCourseId);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, cc_CourseExamPaperEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function cc_CourseExamPaperEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clscc_CourseExamPaperENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrcc_CourseExamPaperObjLst = await cc_CourseExamPaper_GetObjLstAsync(objPagerPara.whereCond);
const arrcc_CourseExamPaperExObjLst = arrcc_CourseExamPaperObjLst.map(cc_CourseExamPaperEx_CopyToEx);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
...
*/
export function cc_CourseExamPaperEx_FuncMapByFldName(strFldName: string, objcc_CourseExamPaperEx: clscc_CourseExamPaperENEx)
{
