...
import { vcc_CourseExamPaper_GetObjLst_Cache } from "../../L3_ForWApi/Knowledges/clsvcc_CourseExamPaperWApi.js";
...
import { clsvcc_CourseExamPaperENEx } from "../../L0_Entity/Knowledges/clsvcc_CourseExamPaperENEx.js";
import { vcc_CourseExamPaper_GetObjLstAsync } from "../../L3_ForWApi/Knowledges/clsvcc_CourseExamPaperWApi.js";
import { vcc_CourseExamPaper_SortFunByKey } from "../../L3_ForWApi/Knowledges/clsvcc_CourseExamPaperWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { vcc_CourseExamPaper_FilterFunByKey } from "../../L3_ForWApi/Knowledges/clsvcc_CourseExamPaperWApi.js";
 ...
 * @returns 对象列表
*/
export async function vcc_CourseExamPaperEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara , strCourseId:string):Promise<Array<clsvcc_CourseExamPaperENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvcc_CourseExamPaperObjLst = await vcc_CourseExamPaper_GetObjLst_Cache(strCourseId);
...
let arrvcc_CourseExamPaper_Sel: Array < clsvcc_CourseExamPaperENEx > = arrvcc_CourseExamPaperExObjLst;
...
const arrvcc_CourseExamPaperObjLst = await vcc_CourseExamPaper_GetObjLstAsync(objPagerPara.whereCond);
const arrvcc_CourseExamPaperExObjLst = arrvcc_CourseExamPaperObjLst.map(vcc_CourseExamPaperEx_CopyToEx);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
