...
import { clsMessagePushENEx } from "../../L0_Entity/NewsAnnouncement/clsMessagePushENEx.js";
import { MessagePush_GetObjLstAsync } from "../../L3_ForWApi/NewsAnnouncement/clsMessagePushWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { MessagePush_SortFunByKey } from "../../L3_ForWApi/NewsAnnouncement/clsMessagePushWApi.js";
import { clsMessagePushEN } from "../../L0_Entity/NewsAnnouncement/clsMessagePushEN.js";
import { Format } from "../../PubFun/clsString.js";
import { MessagePush_FilterFunByKey } from "../../L3_ForWApi/NewsAnnouncement/clsMessagePushWApi.js";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, messagePushEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function MessagePushEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsMessagePushENEx>> {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, messagePushEx_ConstructorName, strThisFuncName);
console.error(strMsg);
...
*/
export function MessagePushEx_FuncMapByFldName(strFldName: string, objMessagePushEx: clsMessagePushENEx)
{
