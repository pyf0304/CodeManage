...
import { clsFeedBackENEx } from "../../L0_Entity/NewsAnnouncement/clsFeedBackENEx.js";
import { FeedBack_GetObjLstAsync } from "../../L3_ForWApi/NewsAnnouncement/clsFeedBackWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { FeedBack_SortFunByKey } from "../../L3_ForWApi/NewsAnnouncement/clsFeedBackWApi.js";
import { clsFeedBackEN } from "../../L0_Entity/NewsAnnouncement/clsFeedBackEN.js";
import { Format } from "../../PubFun/clsString.js";
import { FeedBack_FilterFunByKey } from "../../L3_ForWApi/NewsAnnouncement/clsFeedBackWApi.js";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, feedBackEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function FeedBackEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsFeedBackENEx>> {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, feedBackEx_ConstructorName, strThisFuncName);
console.error(strMsg);
