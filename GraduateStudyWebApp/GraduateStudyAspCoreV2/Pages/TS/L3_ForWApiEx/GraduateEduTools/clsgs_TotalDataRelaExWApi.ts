...
import { gs_TotalDataRela_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTools/clsgs_TotalDataRelaWApi.js";
...
import { clsgs_TotalDataRelaENEx } from "../../L0_Entity/GraduateEduTools/clsgs_TotalDataRelaENEx.js";
import { gs_TotalDataRela_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTools/clsgs_TotalDataRelaWApi.js";
import { gs_TotalDataRela_SortFunByKey } from "../../L3_ForWApi/GraduateEduTools/clsgs_TotalDataRelaWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { gs_TotalDataRela_FilterFunByKey } from "../../L3_ForWApi/GraduateEduTools/clsgs_TotalDataRelaWApi.js";
 ...
 **/
export function gs_TotalDataRelaEx_CopyToEx(objgs_TotalDataRelaENS:clsgs_TotalDataRelaEN ): clsgs_TotalDataRelaENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, gs_TotalDataRelaEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function gs_TotalDataRelaEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara , strid_CurrEduCls:string):Promise<Array<clsgs_TotalDataRelaENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrgs_TotalDataRelaObjLst = await gs_TotalDataRela_GetObjLst_Cache(strid_CurrEduCls);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, gs_TotalDataRelaEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function gs_TotalDataRelaEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsgs_TotalDataRelaENEx>> {
...
*/
export function gs_TotalDataRelaEx_FuncMapByFldName(strFldName: string, objgs_TotalDataRelaEx: clsgs_TotalDataRelaENEx)
{
