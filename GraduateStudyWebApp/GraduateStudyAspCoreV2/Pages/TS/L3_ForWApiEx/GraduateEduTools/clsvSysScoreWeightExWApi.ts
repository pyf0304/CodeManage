...
import { vSysScoreWeight_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
...
import { clsvSysScoreWeightENEx } from "../../L0_Entity/GraduateEduTools/clsvSysScoreWeightENEx.js";
import { vSysScoreWeight_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
import { vSysScoreWeight_SortFunByKey } from "../../L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { vSysScoreWeight_FilterFunByKey } from "../../L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
 ...
 **/
export function vSysScoreWeightEx_CopyToEx(objvSysScoreWeightENS:clsvSysScoreWeightEN ): clsvSysScoreWeightENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vSysScoreWeightEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vSysScoreWeightEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsvSysScoreWeightENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvSysScoreWeightObjLst = await vSysScoreWeight_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vSysScoreWeightEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function vSysScoreWeightEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvSysScoreWeightENEx>> {
...
*/
export function vSysScoreWeightEx_FuncMapByFldName(strFldName: string, objvSysScoreWeightEx: clsvSysScoreWeightENEx)
{
