...
import { gs_ParagraphState_GetObjLst_Cache } from "../../L3_ForWApi/ParameterTable/clsgs_ParagraphStateWApi.js";
...
import { clsgs_ParagraphStateENEx } from "../../L0_Entity/ParameterTable/clsgs_ParagraphStateENEx.js";
import { gs_ParagraphState_GetObjLstAsync } from "../../L3_ForWApi/ParameterTable/clsgs_ParagraphStateWApi.js";
import { gs_ParagraphState_SortFunByKey } from "../../L3_ForWApi/ParameterTable/clsgs_ParagraphStateWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { gs_ParagraphState_FilterFunByKey } from "../../L3_ForWApi/ParameterTable/clsgs_ParagraphStateWApi.js";
 ...
 **/
export function gs_ParagraphStateEx_CopyToEx(objgs_ParagraphStateENS:clsgs_ParagraphStateEN ): clsgs_ParagraphStateENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, gs_ParagraphStateEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function gs_ParagraphStateEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsgs_ParagraphStateENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrgs_ParagraphStateObjLst = await gs_ParagraphState_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, gs_ParagraphStateEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function gs_ParagraphStateEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsgs_ParagraphStateENEx>> {
...
*/
export function gs_ParagraphStateEx_FuncMapByFldName(strFldName: string, objgs_ParagraphStateEx: clsgs_ParagraphStateENEx)
{
