...
import { SysScoreType_GetObjLst_Cache } from "../../L3_ForWApi/ParameterTable/clsSysScoreTypeWApi.js";
...
import { clsSysScoreTypeENEx } from "../../L0_Entity/ParameterTable/clsSysScoreTypeENEx.js";
import { SysScoreType_GetObjLstAsync } from "../../L3_ForWApi/ParameterTable/clsSysScoreTypeWApi.js";
import { SysScoreType_SortFunByKey } from "../../L3_ForWApi/ParameterTable/clsSysScoreTypeWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { SysScoreType_FilterFunByKey } from "../../L3_ForWApi/ParameterTable/clsSysScoreTypeWApi.js";
 ...
 **/
export function SysScoreTypeEx_CopyToEx(objSysScoreTypeENS:clsSysScoreTypeEN ): clsSysScoreTypeENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, sysScoreTypeEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function SysScoreTypeEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsSysScoreTypeENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrSysScoreTypeObjLst = await SysScoreType_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, sysScoreTypeEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function SysScoreTypeEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsSysScoreTypeENEx>> {
...
*/
export function SysScoreTypeEx_FuncMapByFldName(strFldName: string, objSysScoreTypeEx: clsSysScoreTypeENEx)
{
