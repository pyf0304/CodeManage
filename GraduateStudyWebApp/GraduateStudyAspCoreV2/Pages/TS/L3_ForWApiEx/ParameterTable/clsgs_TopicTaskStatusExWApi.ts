...
import { gs_TopicTaskStatus_GetObjLst_Cache } from "../../L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
...
import { clsgs_TopicTaskStatusENEx } from "../../L0_Entity/ParameterTable/clsgs_TopicTaskStatusENEx.js";
import { gs_TopicTaskStatus_GetObjLstAsync } from "../../L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_SortFunByKey } from "../../L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { gs_TopicTaskStatus_FilterFunByKey } from "../../L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
 ...
 **/
export function gs_TopicTaskStatusEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function gs_TopicTaskStatusEx_CopyToEx(objgs_TopicTaskStatusENS:clsgs_TopicTaskStatusEN ): clsgs_TopicTaskStatusENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, gs_TopicTaskStatusEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function gs_TopicTaskStatusEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsgs_TopicTaskStatusENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrgs_TopicTaskStatusObjLst = await gs_TopicTaskStatus_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, gs_TopicTaskStatusEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function gs_TopicTaskStatusEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsgs_TopicTaskStatusENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrgs_TopicTaskStatusObjLst = await gs_TopicTaskStatus_GetObjLstAsync(objPagerPara.whereCond);
const arrgs_TopicTaskStatusExObjLst = arrgs_TopicTaskStatusObjLst.map(gs_TopicTaskStatusEx_CopyToEx);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
...
*/
export function gs_TopicTaskStatusEx_FuncMapByFldName(strFldName: string, objgs_TopicTaskStatusEx: clsgs_TopicTaskStatusENEx)
{
