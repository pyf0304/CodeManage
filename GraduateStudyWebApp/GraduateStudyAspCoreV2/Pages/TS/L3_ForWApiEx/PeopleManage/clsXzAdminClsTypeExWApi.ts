...
import { XzAdminClsType_GetObjLst_Cache } from "../../L3_ForWApi/PeopleManage/clsXzAdminClsTypeWApi.js";
...
import { clsXzAdminClsTypeENEx } from "../../L0_Entity/PeopleManage/clsXzAdminClsTypeENEx.js";
import { XzAdminClsType_GetObjLstAsync } from "../../L3_ForWApi/PeopleManage/clsXzAdminClsTypeWApi.js";
import { XzAdminClsType_SortFunByKey } from "../../L3_ForWApi/PeopleManage/clsXzAdminClsTypeWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { XzAdminClsType_FilterFunByKey } from "../../L3_ForWApi/PeopleManage/clsXzAdminClsTypeWApi.js";
 ...
 **/
export function XzAdminClsTypeEx_CopyToEx(objXzAdminClsTypeENS:clsXzAdminClsTypeEN ): clsXzAdminClsTypeENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, xzAdminClsTypeEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function XzAdminClsTypeEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsXzAdminClsTypeENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrXzAdminClsTypeObjLst = await XzAdminClsType_GetObjLst_Cache();
...
const objXzAdminClsType_Cond = new clsXzAdminClsTypeENEx();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, xzAdminClsTypeEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function XzAdminClsTypeEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsXzAdminClsTypeENEx>> {
...
*/
export function XzAdminClsTypeEx_FuncMapByFldName(strFldName: string, objXzAdminClsTypeEx: clsXzAdminClsTypeENEx)
{
