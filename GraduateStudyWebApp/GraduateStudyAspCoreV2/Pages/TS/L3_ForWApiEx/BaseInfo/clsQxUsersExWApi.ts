...
import { QxUsers_GetObjLst_Cache } from "../../L3_ForWApi/BaseInfo/clsQxUsersWApi.js";
...
import { clsQxUsersENEx } from "../../L0_Entity/BaseInfo/clsQxUsersENEx.js";
import { QxUsers_GetObjLstAsync } from "../../L3_ForWApi/BaseInfo/clsQxUsersWApi.js";
import { QxUsers_SortFunByKey } from "../../L3_ForWApi/BaseInfo/clsQxUsersWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { QxUsers_FilterFunByKey } from "../../L3_ForWApi/BaseInfo/clsQxUsersWApi.js";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, qxUsersEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function QxUsersEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsQxUsersENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrQxUsersObjLst = await QxUsers_GetObjLst_Cache();
...
const objQxUsers_Cond = new clsQxUsersENEx();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, qxUsersEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function QxUsersEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsQxUsersENEx>> {
