...
import { XzMajorShoolType_GetObjLst_Cache } from "../../L3_ForWApi/BaseInfo_Share/clsXzMajorShoolTypeWApi.js";
import { stuPagerPara } from "../../PubFun/stuPagerPara.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { clsXzMajorShoolTypeEN } from "../../L0_Entity/BaseInfo_Share/clsXzMajorShoolTypeEN.js";
import { GetObjKeys } from "../../PubFun/clsCommFunc4Web.js";
import { clsXzMajorShoolTypeENEx } from "../../L0_Entity/BaseInfo_Share/clsXzMajorShoolTypeENEx.js";
import { XzMajorShoolType_GetObjLstAsync } from "../../L3_ForWApi/BaseInfo_Share/clsXzMajorShoolTypeWApi.js";
import { XzMajorShoolType_SortFunByKey } from "../../L3_ForWApi/BaseInfo_Share/clsXzMajorShoolTypeWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { XzMajorShoolType_FilterFunByKey } from "../../L3_ForWApi/BaseInfo_Share/clsXzMajorShoolTypeWApi.js";
 ...
 **/
export function XzMajorShoolTypeEx_CopyToEx(objXzMajorShoolTypeENS:clsXzMajorShoolTypeEN ): clsXzMajorShoolTypeENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, xzMajorShoolTypeEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function XzMajorShoolTypeEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsXzMajorShoolTypeENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrXzMajorShoolTypeObjLst = await XzMajorShoolType_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, xzMajorShoolTypeEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function XzMajorShoolTypeEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsXzMajorShoolTypeENEx>> {
...
*/
export function XzMajorShoolTypeEx_FuncMapByFldName(strFldName: string, objXzMajorShoolTypeEx: clsXzMajorShoolTypeENEx)
{
