...
import { PaperSubAttachment_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js";
...
import { clsPaperSubAttachmentENEx } from "../../L0_Entity/GraduateEduPaper/clsPaperSubAttachmentENEx.js";
import { PaperSubAttachment_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js";
import { PaperSubAttachment_SortFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { PaperSubAttachment_FilterFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js";
 ...
 **/
export function PaperSubAttachmentEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function PaperSubAttachmentEx_CopyToEx(objPaperSubAttachmentENS:clsPaperSubAttachmentEN ): clsPaperSubAttachmentENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, paperSubAttachmentEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function PaperSubAttachmentEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsPaperSubAttachmentENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrPaperSubAttachmentObjLst = await PaperSubAttachment_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, paperSubAttachmentEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function PaperSubAttachmentEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsPaperSubAttachmentENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrPaperSubAttachmentObjLst = await PaperSubAttachment_GetObjLstAsync(objPagerPara.whereCond);
const arrPaperSubAttachmentExObjLst = arrPaperSubAttachmentObjLst.map(PaperSubAttachmentEx_CopyToEx);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
...
*/
export function PaperSubAttachmentEx_FuncMapByFldName(strFldName: string, objPaperSubAttachmentEx: clsPaperSubAttachmentENEx)
{
