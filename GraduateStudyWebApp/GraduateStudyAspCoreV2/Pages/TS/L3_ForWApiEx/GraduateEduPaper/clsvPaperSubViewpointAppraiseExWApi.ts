...
import { vPaperSubViewpointAppraise_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointAppraiseWApi.js";
...
import { clsvPaperSubViewpointAppraiseENEx } from "../../L0_Entity/GraduateEduPaper/clsvPaperSubViewpointAppraiseENEx.js";
import { vPaperSubViewpointAppraise_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointAppraiseWApi.js";
import { vPaperSubViewpointAppraise_SortFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointAppraiseWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { vPaperSubViewpointAppraise_FilterFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointAppraiseWApi.js";
import { clsSysPara4WebApi } from "../../PubConfig/clsSysPara4WebApi.js";
export const vPaperSubViewpointAppraiseEx_Controller = "vPaperSubViewpointAppraiseExApi";
export const vPaperSubViewpointAppraiseEx_ConstructorName = "vPaperSubViewpointAppraiseEx";
 ...
 **/
export function vPaperSubViewpointAppraiseEx_GetWebApiUrl(strController: string, strAction: string): string {
 ...
 **/
export function vPaperSubViewpointAppraiseEx_CopyToEx(objvPaperSubViewpointAppraiseENS:clsvPaperSubViewpointAppraiseEN ): clsvPaperSubViewpointAppraiseENEx
{
const strThisFuncName  = vPaperSubViewpointAppraiseEx_CopyToEx.name;
 const objvPaperSubViewpointAppraiseENT = new clsvPaperSubViewpointAppraiseENEx();
try
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vPaperSubViewpointAppraiseEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vPaperSubViewpointAppraiseEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clsvPaperSubViewpointAppraiseENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrvPaperSubViewpointAppraiseObjLst = await vPaperSubViewpointAppraise_GetObjLst_Cache();
...
if (arrvPaperSubViewpointAppraiseExObjLst.length == 0) return arrvPaperSubViewpointAppraiseExObjLst;
let arrvPaperSubViewpointAppraise_Sel: Array < clsvPaperSubViewpointAppraiseENEx > = arrvPaperSubViewpointAppraiseExObjLst;
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vPaperSubViewpointAppraiseEx_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clsvPaperSubViewpointAppraiseENEx>();
}
 ...
 * @returns 对象列表
*/
export async function vPaperSubViewpointAppraiseEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvPaperSubViewpointAppraiseENEx>> {
const strThisFuncName = "GetObjExLstByPagerAsync";
const arrvPaperSubViewpointAppraiseObjLst = await vPaperSubViewpointAppraise_GetObjLstAsync(objPagerPara.whereCond);
const arrvPaperSubViewpointAppraiseExObjLst = arrvPaperSubViewpointAppraiseObjLst.map(vPaperSubViewpointAppraiseEx_CopyToEx);
 const objSortInfo = GetSortExpressInfo(objPagerPara);
 if (IsNullOrEmpty(objSortInfo.SortFld) == false)
 {
 ...
 * @returns 返回两个对象比较的结果
*/
export function vPaperSubViewpointAppraiseEx_SortFunByKey(strKey:string, AscOrDesc: string)
{
...
{
        default:
return vPaperSubViewpointAppraise_SortFunByKey(strKey, AscOrDesc);
 }
 }
  else
 {
...
*/
export function vPaperSubViewpointAppraiseEx_FuncMapByFldName(strFldName: string, objvPaperSubViewpointAppraiseEx: clsvPaperSubViewpointAppraiseENEx)
{
...
*/
export async function vPaperSubViewpointAppraiseEx_FilterFunByKey(strKey:string, value: any)
{
...
{
        default:
return vPaperSubViewpointAppraise_FilterFunByKey(strKey, value);
 }
}
