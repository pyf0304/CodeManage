...
import { clsvgs_PSkillRelaENEx } from "../../L0_Entity/GraduateEduPaper/clsvgs_PSkillRelaENEx.js";
import { vgs_PSkillRela_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduPaper/clsvgs_PSkillRelaWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { vgs_PSkillRela_SortFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsvgs_PSkillRelaWApi.js";
import { clsvgs_PSkillRelaEN } from "../../L0_Entity/GraduateEduPaper/clsvgs_PSkillRelaEN.js";
import { Format } from "../../PubFun/clsString.js";
import { vgs_PSkillRela_FilterFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsvgs_PSkillRelaWApi.js";
 ...
 **/
export function vgs_PSkillRelaEx_CopyToEx(objvgs_PSkillRelaENS:clsvgs_PSkillRelaEN ): clsvgs_PSkillRelaENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vgs_PSkillRelaEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vgs_PSkillRelaEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvgs_PSkillRelaENEx>> {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vgs_PSkillRelaEx_ConstructorName, strThisFuncName);
console.error(strMsg);
...
*/
export function vgs_PSkillRelaEx_FuncMapByFldName(strFldName: string, objvgs_PSkillRelaEx: clsvgs_PSkillRelaENEx)
{
