...
import { QxUserRoleRelation_GetObjLst_Cache } from "../../L3_ForWApi/UsersRight/clsQxUserRoleRelationWApi.js";
...
import { clsQxUserRoleRelationENEx } from "../../L0_Entity/UsersRight/clsQxUserRoleRelationENEx.js";
import { QxUserRoleRelation_GetObjLstAsync } from "../../L3_ForWApi/UsersRight/clsQxUserRoleRelationWApi.js";
import { QxUserRoleRelation_SortFunByKey } from "../../L3_ForWApi/UsersRight/clsQxUserRoleRelationWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { QxUserRoleRelation_FilterFunByKey } from "../../L3_ForWApi/UsersRight/clsQxUserRoleRelationWApi.js";
...
**/
export function QxUserRoleRelationEx_GetWebApiUrl(strController: string, strAction: string): string {
...
**/
export function QxUserRoleRelationEx_CopyToEx(objQxUserRoleRelationENS: clsQxUserRoleRelationEN): clsQxUserRoleRelationENEx {
    ...
    try {
        ...
        const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelationEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function QxUserRoleRelationEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara): Promise<Array<clsQxUserRoleRelationENEx>> {
    const strThisFuncName = "GetObjLstByPager_Cache";
    const arrQxUserRoleRelationObjLst = await QxUserRoleRelation_GetObjLst_Cache();
    ...
    try {
        ...
        const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, qxUserRoleRelationEx_ConstructorName, strThisFuncName);
        console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function QxUserRoleRelationEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsQxUserRoleRelationENEx>> {
    const strThisFuncName = "GetObjExLstByPagerAsync";
    const arrQxUserRoleRelationObjLst = await QxUserRoleRelation_GetObjLstAsync(objPagerPara.whereCond);
    const arrQxUserRoleRelationExObjLst = arrQxUserRoleRelationObjLst.map(QxUserRoleRelationEx_CopyToEx);
    const objSortInfo = GetSortExpressInfo(objPagerPara);
    if (IsNullOrEmpty(objSortInfo.SortFld) == false) {
        for (const objInFor of arrQxUserRoleRelationExObjLst) {
...
*/
export function QxUserRoleRelationEx_FuncMapByFldName(strFldName: string, objQxUserRoleRelationEx: clsQxUserRoleRelationENEx) {
