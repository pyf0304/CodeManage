...
import { ViewpointAppraise_GetObjLst_Cache } from "../../L3_ForWApi/GraduateEduPaper/clsViewpointAppraiseWApi.js";
...
import { clsViewpointAppraiseENEx } from "../../L0_Entity/GraduateEduPaper/clsViewpointAppraiseENEx.js";
import { ViewpointAppraise_GetObjLstAsync } from "../../L3_ForWApi/GraduateEduPaper/clsViewpointAppraiseWApi.js";
import { ViewpointAppraise_SortFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsViewpointAppraiseWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { ViewpointAppraise_FilterFunByKey } from "../../L3_ForWApi/GraduateEduPaper/clsViewpointAppraiseWApi.js";
...
**/
export function ViewpointAppraiseEx_CopyToEx(objViewpointAppraiseENS: clsViewpointAppraiseEN): clsViewpointAppraiseENEx {
    ...
    try {
        ...
        const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, viewpointAppraiseEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function ViewpointAppraiseEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara): Promise<Array<clsViewpointAppraiseENEx>> {
    const strThisFuncName = "GetObjLstByPager_Cache";
    const arrViewpointAppraiseObjLst = await ViewpointAppraise_GetObjLst_Cache();
    ...
    try {
        ...
        const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, viewpointAppraiseEx_ConstructorName, strThisFuncName);
        console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function ViewpointAppraiseEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsViewpointAppraiseENEx>> {
...
*/
export function ViewpointAppraiseEx_FuncMapByFldName(strFldName: string, objViewpointAppraiseEx: clsViewpointAppraiseENEx) {
