...
import { clsXzGradeBaseENEx } from "../../L0_Entity/SysPara/clsXzGradeBaseENEx.js";
import { XzGradeBase_CopyObjTo } from "../../L3_ForWApi/SysPara/clsXzGradeBaseWApi.js";
...
{
 public static mstrController: string = "XzGradeBaseExApi";
...
{
 var objXzGradeBaseENT = new clsXzGradeBaseENEx();
try
{
