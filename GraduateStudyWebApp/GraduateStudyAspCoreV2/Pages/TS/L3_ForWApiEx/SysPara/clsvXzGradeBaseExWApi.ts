...
import { clsvXzGradeBaseENEx } from "../../L0_Entity/SysPara/clsvXzGradeBaseENEx.js";
import { vXzGradeBase_GetObjLstAsync } from "../../L3_ForWApi/SysPara/clsvXzGradeBaseWApi.js";
import { GetSortExpressInfo } from "../../PubFun/clsCommFunc4Web.js";
import { IsNullOrEmpty } from "../../PubFun/clsString.js";
import { vXzGradeBase_SortFunByKey } from "../../L3_ForWApi/SysPara/clsvXzGradeBaseWApi.js";
import { clsvXzGradeBaseEN } from "../../L0_Entity/SysPara/clsvXzGradeBaseEN.js";
import { Format } from "../../PubFun/clsString.js";
import { vXzGradeBase_FilterFunByKey } from "../../L3_ForWApi/SysPara/clsvXzGradeBaseWApi.js";
 ...
 **/
export function vXzGradeBaseEx_CopyToEx(objvXzGradeBaseENS:clsvXzGradeBaseEN ): clsvXzGradeBaseENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, vXzGradeBaseEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function vXzGradeBaseEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clsvXzGradeBaseENEx>> {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vXzGradeBaseEx_ConstructorName, strThisFuncName);
console.error(strMsg);
...
*/
export function vXzGradeBaseEx_FuncMapByFldName(strFldName: string, objvXzGradeBaseEx: clsvXzGradeBaseENEx)
{
