...
import { cc_ExcellentType_GetObjLst_Cache } from "../../L3_ForWApi/CourseLearning/clscc_ExcellentTypeWApi.js";
...
import { clscc_ExcellentTypeENEx } from "../../L0_Entity/CourseLearning/clscc_ExcellentTypeENEx.js";
import { cc_ExcellentType_GetObjLstAsync } from "../../L3_ForWApi/CourseLearning/clscc_ExcellentTypeWApi.js";
import { cc_ExcellentType_SortFunByKey } from "../../L3_ForWApi/CourseLearning/clscc_ExcellentTypeWApi.js";
import { Format } from "../../PubFun/clsString.js";
import { cc_ExcellentType_FilterFunByKey } from "../../L3_ForWApi/CourseLearning/clscc_ExcellentTypeWApi.js";
 ...
 **/
export function cc_ExcellentTypeEx_CopyToEx(objcc_ExcellentTypeENS:clscc_ExcellentTypeEN ): clscc_ExcellentTypeENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, cc_ExcellentTypeEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export async function cc_ExcellentTypeEx_GetObjExLstByPager_Cache(objPagerPara: stuPagerPara ):Promise<Array<clscc_ExcellentTypeENEx>> {
const strThisFuncName = "GetObjLstByPager_Cache";
const arrcc_ExcellentTypeObjLst = await cc_ExcellentType_GetObjLst_Cache();
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, cc_ExcellentTypeEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export async function cc_ExcellentTypeEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clscc_ExcellentTypeENEx>> {
...
*/
export function cc_ExcellentTypeEx_FuncMapByFldName(strFldName: string, objcc_ExcellentTypeEx: clscc_ExcellentTypeENEx)
{
