...
export class clsPaperAttachmentEN extends clsGeneralTab
{
public static CacheAddiCondition = "";//缓存附加条件，作为向后台调取数据的附加条件
public static CacheModeId = "04"; //sessionStorage
public static IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
public static WhereFormat = ""; //条件格式串
public static _CurrTabName= "PaperAttachment"; //当前表名,与该类相关的表名
public static _KeyFldName= "PaperAttachmentId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 8;
public static AttributeName = ["paperAttachmentId", "paperAttachmentName", "paperId", "filePath", "id_CurrEduCls", "updUserId", "updDate", "memo"];
//以下是属性变量
...
*/
private mlngPaperAttachmentId = 0;    //论文附件Id
private mstrPaperAttachmentName = "";    //附件名称
...
*/
 public SetPaperAttachmentId (value: number)
{
if (value  != undefined)
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetPaperAttachmentName (value: string)
{
if (value  != undefined)
{
...
*/
public paperAttachmentId = 0;    //论文附件Id
public paperAttachmentName = "";    //附件名称
public paperId = "";    //论文Id
 ...
 */
 public static get con_PaperAttachmentId(): string {return "paperAttachmentId";}    //论文附件Id

 /**
 * 常量:"PaperAttachmentName"
 * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 */
 public static get con_PaperAttachmentName(): string {return "paperAttachmentName";}    //附件名称
