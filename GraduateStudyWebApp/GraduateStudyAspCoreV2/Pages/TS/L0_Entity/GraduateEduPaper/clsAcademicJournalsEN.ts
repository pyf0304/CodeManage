...
export class clsAcademicJournalsEN extends clsGeneralTab
{
public static CacheAddiCondition = "";//缓存附加条件，作为向后台调取数据的附加条件
public static CacheModeId = "04"; //sessionStorage
public static IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
public static WhereFormat = ""; //条件格式串
public static _CurrTabName= "AcademicJournals"; //当前表名,与该类相关的表名
public static _KeyFldName= "JournalId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 7;
public static AttributeName = ["journalId", "journalName", "journalSubjectCategoryId", "journalSubjectId", "updDate", "updUser", "memo"];
//以下是属性变量
...
*/
private mstrJournalId = "";    //期刊Id
private mstrJournalName = "";    //期刊名称
...
*/
 public SetJournalId (value: string)
{
if (value  != undefined)
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetJournalName (value: string)
{
if (value  != undefined)
{
...
*/
public journalId = "";    //期刊Id
public journalName = "";    //期刊名称
 ...
 */
 public static get con_JournalId(): string {return "journalId";}    //期刊Id

 /**
 * 常量:"JournalName"
 * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 */
 public static get con_JournalName(): string {return "journalName";}    //期刊名称
