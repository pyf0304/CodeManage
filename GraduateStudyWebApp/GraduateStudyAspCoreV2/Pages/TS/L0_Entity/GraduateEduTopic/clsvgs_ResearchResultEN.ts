...
public static AttributeName = ["resultId", "topicId", "topicName", "paperId", "id_CurrEduCls", "resultTypeId", "resultName", "resultContent", "author", "division", "versionCount", "okCount", "appraiseCount", "score", "stuScore", "teaScore", "updDate", "updUser", "memo"];
//以下是属性变量
