...
public static AttributeName = ["commentId", "comment", "score", "commentTypeId", "scoreType", "parentId", "tableKey", "okCount", "pubParentId", "id_CurrEduCls", "userId", "month", "week", "weekTimeRange", "updUser", "updDate", "memo"];
//以下是属性变量
