...
public static AttributeName = ["qa_PaperId", "paperId", "questionsCount", "isDelete", "isPublic", "isSubmit", "updUser", "updDate", "memo", "id_CurrEduCls", "answerCount", "shareId", "tagsCount"];
//以下是属性变量
