...
public static AttributeName = ["tagsId", "tagsContent", "pdfContent", "pdfPageNum", "voteCount", "userId", "orderNum", "updUser", "updDate", "pdfLineNum", "pdfX", "pdfY", "memo", "id_CurrEduCls", "paperId", "shareId", "pdfPageNumIn", "pdfPageTop", "pdfDivLet", "pdfDivTop", "pdfZoom", "tagsTypeId"];
//以下是属性变量
