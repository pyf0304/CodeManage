...
export class clsgs_EduClsTypeEN extends clsGeneralTab
{
public static CacheAddiCondition = "";//缓存附加条件，作为向后台调取数据的附加条件
public static CacheModeId = "03"; //localStorage
public static IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
public static WhereFormat = ""; //条件格式串
public static _CurrTabName= "gs_EduClsType"; //当前表名,与该类相关的表名
public static _KeyFldName= "EduClsTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 3;
public static AttributeName = ["eduClsTypeId", "eduClsTypeName", "memo"];
//以下是属性变量
...
private mstrEduClsTypeName = "";    //教学班类型名称
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetEduClsTypeName (value: string)
{
if (value  != undefined)
{
