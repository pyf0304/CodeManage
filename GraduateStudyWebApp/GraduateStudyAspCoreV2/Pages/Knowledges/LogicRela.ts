...
import { clscc_CourseKnowledgesEN } from "../TS/L0_Entity/Knowledges_Share/clscc_CourseKnowledgesEN.js";
...
import { cc_CourseKnowledges_GetObjLst_Cache } from "../TS/L3_ForWApi/Knowledges_Share/clscc_CourseKnowledgesWApi.js";
   ...
   */
    ...
    public async btnSaveLogicRela_Click(ojson: any) {
        ...
        for (var i = 0; i < ojson.server.length; i++) {
            ...
            var strUpdUser: string = clsPublocalStorage.userId;// 修改人
            //var strid_CurrEduCls = clsPublocalStorage.id_CurrEduCls;
    ...
    public DelRecord1() {
        return new Promise((resolve, reject) => {
            try {
                var strKnowledgeGraphId = $("#hidKnowledgeGraphId").val();
                var strWhere = " knowledgeGraphId='" + strKnowledgeGraphId + "' and updUser='" + clsPublocalStorage.userId + "'";
