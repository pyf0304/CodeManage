...
namespace GraduateStudyWebApp.Pages.Knowledges
{
    public class WApicc_CourseKnowledges_QUDI_TSModel : PageModel
    {
        public string Message { get; set; }
        public void OnGet()
        {
            Message = "spacc_CourseKnowledgesCRUD(课程知识点CRUD)(01120085)页面.";
        }
