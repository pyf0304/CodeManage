...
* 编程语言:TypeScript
**/
import { TopicObjective_EditEx } from "../GraduateEduTopic/TopicObjective_EditEx.js";
...
**/
export class TopicObjectiveCRUDEx extends TopicObjectiveCRUD implements IShowList {
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        let objPage: TopicObjectiveCRUDEx;
        if (TopicObjectiveCRUD.objPage_CRUD == null) {
            TopicObjectiveCRUD.objPage_CRUD = new TopicObjectiveCRUDEx();
            objPage = <TopicObjectiveCRUDEx>TopicObjectiveCRUD.objPage_CRUD;
        }
        else {
            objPage = <TopicObjectiveCRUDEx>TopicObjectiveCRUD.objPage_CRUD;
        }
