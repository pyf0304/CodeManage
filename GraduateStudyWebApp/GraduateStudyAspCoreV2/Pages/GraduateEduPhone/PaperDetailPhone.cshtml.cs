...
namespace GraduateStudyWebApp.Pages.GraduateEduPhone
{
    public class PaperDetailPhoneModel : PageModel
    {
        public string Message { get; set; }
        public void OnGet()
        {
            Message = "spaPaper详细页面.";
        }
        ...
        /// (AutoGCLib.WA_ViewScriptCSModel_TS4CSharp:Gen_WApi_Model_SeUserId)
        /// </summary>
        public string sePaperRWId
        {
            get
            {
                var strValue = HttpContext.Session.GetString("PaperRWId");
                return strValue;
            }
            set
            {
                HttpContext.Session.SetString("PaperRWId", value);
            }
        }
