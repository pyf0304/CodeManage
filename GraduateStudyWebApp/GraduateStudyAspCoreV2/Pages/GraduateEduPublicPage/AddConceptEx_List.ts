...
import { Concept_GetObjByConceptIdAsync, Concept_GetObjLstAsync, Concept_GetObjLstByPagerAsync, Concept_GetRecCountByCondAsync, Concept_UpdateRecordAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js";
...
import { BindDdl_ObjLst, BindTab, BindTabV2Where, BindTabV2Where_V, BindTab_V, GetCheckedKeyIds, SortFun } from "../TS/PubFun/clsCommFunc4Web.js";
...
import { AddConceptEx_PaperList } from "./AddConceptEx_PaperList.js";
 ...
 */
    ...
    public async selectPaper_Click() {
        const objPage = new AddConceptEx_PaperList();
