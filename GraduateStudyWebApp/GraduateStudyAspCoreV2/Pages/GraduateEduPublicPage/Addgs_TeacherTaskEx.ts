...
import { ResearchTopicCRUDEx } from "../GraduateEduTopic/ResearchTopicCRUDEx.js";
import { ResearchTopic_QUDIEx } from "../GraduateEduTopic/ResearchTopic_QUDIEx.js";
...
export class Addgs_TeacherTaskEx extends gs_TeacherTaskCRUD {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if (returnBool == true) {
                                //HideDialog_gs_TeacherTask();
                                //this.BindGv_gs_TeacherTask();
                                const objPage_Parent = new ResearchTopic_QUDIEx();
                                objPage_Parent.BindGv(clsgs_TeacherTaskEN._CurrTabName, "");
                                CloseWindow();
                            }
                        }
                        break;
   ...
   */
    public async BindTab_gs_TeacherTask(divContainer: string, arrgs_TeacherTaskObjLst: Array<clsgs_TeacherTaskEN>) {
        ...
        BindTab(o, arrgs_TeacherTaskObjLst, arrDataColumn, "mId", this);
   ...
   */
    public PutDataTogs_TeacherTaskClass(pobjgs_TeacherTaskEN: clsgs_TeacherTaskEN) {
        ...
        pobjgs_TeacherTaskEN.Setid_CurrEduCls(clsPublocalStorage.id_CurrEduCls);// 当前教学班流水号
        ...
        pobjgs_TeacherTaskEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
