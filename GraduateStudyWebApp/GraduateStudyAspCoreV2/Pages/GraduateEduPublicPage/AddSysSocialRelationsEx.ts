...
import { SysSocialRelationsVer_AddNewRecordAsync, SysSocialRelationsVer_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsVerWApi.js";
...
*/
export class AddSysSocialRelationsEx extends SysSocialRelations_Edit {
        ...
        try {
            if (clsPublocalStorage.userId != "") {
                ...
                if (strSocialId != "") {
                    ...
                    $("#divLoading").hide();
                    //获取分享Id
                    const responseText = await gs_UserConfigEx_GetNewReturnShareIdEx("10", clsPublocalStorage.userId);
...
*/
    public PutDataToSysSocialRelationsVClass(pobjSysSocialRelationsVerEN: clsSysSocialRelationsVerEN) {
        var strSocialId = $("#hidSocialId").val();
        ...
        pobjSysSocialRelationsVerEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
        pobjSysSocialRelationsVerEN.SetUpdDate(clsPubFun4Web.getNowDate());// 修改日期
        pobjSysSocialRelationsVerEN.Setid_CurrEduCls(clsPublocalStorage.id_CurrEduCls);
...
*/
    ...
    public async AddVersionRecordSave() {
        ...
        //
        var strSocialId = $("#hidSocialId").val();
        var objSysSocialRelationsVerEN: clsSysSocialRelationsVerEN = new clsSysSocialRelationsVerEN();

        objSysSocialRelationsVerEN.SetSocialId(strSocialId);
        this.PutDataToSysSocialRelationsVClass(objSysSocialRelationsVerEN);

        try {
            const responseText2 = await SysSocialRelationsVer_AddNewRecordAsync(objSysSocialRelationsVerEN);
            var returnBool: boolean = !!responseText2;
            if (returnBool == true) {


                var strWhereCond2 = " 1 =1 and socialId=" + strSocialId;
                var intVersionCount = await SysSocialRelationsVer_GetRecCountByCondAsync(strWhereCond2);
