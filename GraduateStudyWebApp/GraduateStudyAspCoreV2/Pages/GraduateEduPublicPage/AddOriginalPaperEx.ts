...
import { gs_OriginalPaperLog_AddNewRecordAsync } from "../TS/L3_ForWApi/GraduateEduPaper/clsgs_OriginalPaperLogWApi.js";
...
*/
export class AddOriginalPaperEx extends Paper_Edit {
            ...
            if (clsPublocalStorage.userId != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strPaperId, "01", "1", clsPublocalStorage.id_CurrEduCls);
