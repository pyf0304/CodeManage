...
import { BindDdl_ObjLst, BindDdl_ObjLst_V, BindTab, BindTabV2Where, BindTabV2Where_V, SortFun } from "../TS/PubFun/clsCommFunc4Web.js";
...
export class Public_PaperSubViewpoint extends PaperCRUD {
   ...
   */
    ...
    public CombinevPaperSubViewpointCondition2(strTopicId: string): string {
    ...
    public CombinevPaperSubViewpointCondition3(strTopicId: string): string {
        //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
        //例如 1 = 1 && userName = '张三'
        var strWhereCond: string = " 1=1 ";
    ...
    public CombinevPaperSubViewpointCondition4(strTopicId: string): string {
        //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
        //例如 1 = 1 && userName = '张三'
        var strWhereCond: string = " 1 = 1 ";
        //var strPaperRWId = $("#hidPaperRWId").val();
    ...
    //绑定论文子观点内容
    public async Bind_PaperSubViewpoint(strUserId: string, strTopicId: string) {
...
*/
   ...
   */
    public async BindGv_vRTPaperRela_pyf() {
...
*/
    public async BindTab_vRTPaperRela(divContainer: string, arrvRTPaperRelaObjLst: Array<clsvRTPaperRelaEN>) {
        ...
        var arrDataColumn: Array<clsDataColumn> =
            [
                ...
                },
                {
                    fldName: "",
                    colHeader: "进入子观点",
                    text: "进入子观点", tdClass: "text-left", sortBy: "", sortFun: SortFun, getDataSource: "",
                    columnType: "Button",
                    orderNum: 1,
        ...
        BindTabV2Where_V(o, arrvRTPaperRelaObjLst, arrDataColumn, "mId", "TopicRTPaper");
