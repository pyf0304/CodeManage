...
import { clsvSysSkillExEN } from "../TS/L0_Entity/GraduateEduTopic/clsvSysSkillExEN.js";
        ...
        for (var i = 0; i < arrvSysSkillExObjLst.length; i++) {
            ...
            if (strOperationType == "06" || strOperationType == "07") {
                ...
                if (strOperationType == "06") {
                    ...
                    strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('相关技能评论', '../GraduateEduTools/SysComment?Key=" + strSkillId + "&Type=09&User=" + arrvSysSkillExObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论<span class=\"layui-badge\">" + arrvSysSkillExObjLst[i].appraiseCount + "</span></button >";
                    //建立观点关系
