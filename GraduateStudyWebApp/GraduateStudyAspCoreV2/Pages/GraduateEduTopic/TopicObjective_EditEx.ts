...
import { TopicObjective_AddNewRecordAsync, TopicObjective_GetMaxStrIdAsync, TopicObjective_GetObjByTopicObjectiveIdAsync, TopicObjective_IsExistAsync, TopicObjective_UpdateRecordAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js";
            ...
            if (clsPublocalStorage.userId != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "07", "1", clsPublocalStorage.id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        var strTopicObjectiveId = $('#hidObjectiveId').val();
                        const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "07", "2", clsPublocalStorage.id_CurrEduCls);
...
*/
    public async btnAddNewRecord_Click() {
        ...
        try {
            ...
            const ddl_gs_Share = await gs_Share_BindDdl_ShareIdInDiv_Cache(this.divName4Edit, "ddlShareId");
            //获取分享Id
            const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("07", clsPublocalStorage.userId);
