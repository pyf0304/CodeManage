...
import { RTViewpointRela_AddNewRecordAsync, RTViewpointRela_IsExistRecordAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsRTViewpointRelaWApi.js";
...
import { ViewpointVer_AddNewRecordAsync, ViewpointVer_DelViewpointVersAsync, ViewpointVer_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsViewpointVerWApi.js";
  ...
  */
    public async btnAddNewRecord_Click() {
        ...
        try {
            ...
            //获取分享Id
            const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("05", clsPublocalStorage.userId);
            ...
            if (clsPublocalStorage.userId != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "05", "1", clsPublocalStorage.id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        //更新总表3个参数 主键、子表类型、页面操作类型；
                        var strTopicObjectiveId = $('#hidViewpointId').val();
                        const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "05", "2", clsPublocalStorage.id_CurrEduCls);
