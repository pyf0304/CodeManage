 ...
 界面名:RTSysSkillRelaCRUD(01120130)
 生成代码版本:2020.05.24.1
 生成日期:2020/05/25 15:32:15
 生成者:
 工程名称:问卷调查
 工程ID:0112
...
namespace ExamLib.Pages
{
 ...
 /// </summary>
public class RTSysSkillRelaCRUDModel : PageModel
{

public string Message { get; set; }
public void OnGet()
{
Message = "RTSysSkillRelaCRUD(RTSysSkillRelaCRUD)(01120130)页面.";
}
