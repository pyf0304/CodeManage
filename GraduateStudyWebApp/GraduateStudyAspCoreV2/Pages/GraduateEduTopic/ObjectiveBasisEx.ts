...
import { TopicObjectiveVer_AddNewRecordAsync, TopicObjectiveVer_DelTopicObjectiveVersAsync, TopicObjectiveVer_GetObjLstAsync, TopicObjectiveVer_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveVerWApi.js";
            ...
            if (clsPublocalStorage.userId != "") {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        const responseText6 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "08", "1", clsPublocalStorage.id_CurrEduCls);
                    ...
                    case "确认修改":
                        ...
                        var strTopicObjectiveId = $('#hidObjectiveId').val();
                        const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strTopicObjectiveId, "08", "2", clsPublocalStorage.id_CurrEduCls);
...
*/
    public async btnAddNewRecord_Click() {
        ...
        try {
            ...
            //获取分享Id
            const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx("08", clsPublocalStorage.userId);
    ...
    public async btnDelRecordInTab_Click(strKeyId: string) {
        try {
            ...
            if (RTVCount > 0) {
                ...
                const responseText7 = await gs_TotalDataStatisticsEx_AddAndUpdateAndDeleteTotalStatis(strSubViewpointId, "08", "3", clsPublocalStorage.id_CurrEduCls);
                var returnBool7: boolean = !!responseText7;
                if (returnBool7 == true) {
