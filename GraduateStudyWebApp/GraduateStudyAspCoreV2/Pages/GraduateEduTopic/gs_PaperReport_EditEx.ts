...
export class gs_PaperReport_EditEx extends gs_PaperReport_Edit {
  ...
  */
    ...
    public async PutDataTogs_PaperReportClass(pobjgs_PaperReportEN: clsgs_PaperReportEN){
        ...
        //getTextboxio();
        pobjgs_PaperReportEN.Setid_CurrEduCls(clsPublocalStorage.id_CurrEduCls);
        pobjgs_PaperReportEN.SetTopicId(clsPrivateSessionStorage.topicId);// 主题编号
        ...
        pobjgs_PaperReportEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
