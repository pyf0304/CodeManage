 ...
 界面名:TopicObjectiveCRUD(01120110)
 生成代码版本:2020.03.20.1
 生成日期:2020/03/23 16:53:19
 生成者:
 工程名称:问卷调查
 工程ID:0112
...
namespace ExamLib.Pages
{
 ...
 /// </summary>
public class TopicObjective_QUDI_TSModel : PageModel
{

public string Message { get; set; }
public void OnGet()
{
Message = "TopicObjectiveCRUD(主题客观表CRUD)(01120110)页面.";
}
