...
//
//import * as QQ from "q";
import { ke_SuperCRUD } from "../PagesBase/GraduateEduTopic/ke_SuperCRUD.js";
...
import { BindTab, GetFirstCheckedKeyId, SortFun } from "../TS/PubFun/clsCommFunc4Web.js";
...
import { ke_Super_EditEx } from "./ke_Super_EditEx.js";
   ...
   */
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        ...
        if (ke_SuperCRUD.objPage_CRUD == null) {
            ke_SuperCRUD.objPage_CRUD = new ke_SuperCRUDEx();
            objPage = <ke_SuperCRUDEx>ke_SuperCRUD.objPage_CRUD;
        }
        else {
            objPage = <ke_SuperCRUDEx>ke_SuperCRUD.objPage_CRUD;
        }
        const objPage_Edit: ke_Super_EditEx = new ke_Super_EditEx(objPage);
...
*/
    public async BindTab_ke_Super(divContainer: string, arrke_SuperObjLst: Array<clske_SuperEN>) {
        ...
        BindTab(o, arrke_SuperObjLst, arrDataColumn, "ke_SuperId", this);
