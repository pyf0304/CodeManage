...
//
//import * as QQ from "q";
import { gs_TobeStudiedProblemCRUD } from "../PagesBase/GraduateEduTopic/gs_TobeStudiedProblemCRUD.js";
...
import { gs_TobeStudiedProblemVer_Delgs_TobeStudiedProblemVersByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVerWApi.js";
  ...
  */
    ...
    public VDelRecord(arrProblemId: string) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = gs_TobeStudiedProblemVer_Delgs_TobeStudiedProblemVersByCondAsync("problemId='" + arrProblemId + "'").then((jsonData) => {
