...
界面名:spaDiscussionSubContentCRUD(01120106)
生成代码版本:2020.02.19.1
生成日期:2020/02/20 16:39:44
生成者:
工程名称:问卷调查
工程ID:0112
...
namespace GraduateStudyWebApp.Pages.GraduateEduTopic
{
    ...
    /// </summary>
    public class DiscussionSubContent_QUDI_TSModel : PageModel
    {

        public string Message { get; set; }
        public void OnGet()
        {
            Message = "spaDiscussionSubContentCRUD(讨论子内容CRUD)(01120106)页面.";
        }
