/*-- -- -- -- -- -- -- -- -- -- --
类名:SubViewpoint_QUDI_TS
表名:SubViewpoint(01120534)
生成代码版本:2019.11.22.1
生成日期:2019/12/01 21:15:00
生成者:
工程名称:问卷调查
工程ID:0112
...
== == == == == == == == == == == == 
*/
//import { SubViewpoint_QUDI_TS } from "./SubViewpoint_QUDI_TS.js";
//import { clsvSubViewpointWApiEx } from "../TS/L3_ForWApiEx/GraduateEdu/clsvSubViewpointWApiEx.js";
/*
...
//        var strListDiv: string = this.mstrListDiv;
//        var strWhereCond = await this.CombinevSubViewpointCondition();
//        var intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
...
//        
//        var objSubViewpointEN: clsSubViewpointEN = new clsSubViewpointEN();
//        objSubViewpointEN.SetSubViewpointId(Number(this.keyId);
//        this.PutDataToSubViewpointClass(objSubViewpointEN);
//        objSubViewpointEN.sfUpdFldSetStr = objSubViewpointEN.updFldString;//设置哪些字段被修改(脏字段)
...
//            pobjSubViewpointEN.SetUpdUser(clsPublocalStorage.userId;// 修改用户Id
//        }
//        else {
//            pobjSubViewpointEN.SetUpdUser(this.updUser;// 修改用户Id
//            // pobjSubViewpointEN.subViewpointTypeId = this.subViewpointTypeId;// 类型Id
//        }

//        pobjSubViewpointEN.SetSubViewpointContent(this.subViewpointContent;// 详情内容

//        pobjSubViewpointEN.SetUpdDate(clsPubFun4Web.getNowDate();// 修改日期
//        pobjSubViewpointEN.SetMemo(this.memo;// 备注
//    }
