...
//
//import * as QQ from "q";
import { gs_MeetingMinutesCRUD } from "../PagesBase/GraduateEduTopic/gs_MeetingMinutesCRUD.js";
...
import { gs_MeetingMinutesVer_Delgs_MeetingMinutesVersByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesVerWApi.js";
   ...
   */
    ...
    */
    ...
    public async Bind_MeetingMinutesTree() {
        var strWhereCond = " topicId='" + clsPrivateSessionStorage.topicId + "'";
  ...
  */
    ...
    public VDelRecord(arrMeetingId: string) {
        return new Promise((resolve, reject) => {
            try {
                const responseText = gs_MeetingMinutesVer_Delgs_MeetingMinutesVersByCondAsync("meetingId='" + arrMeetingId + "'").then((jsonData) => {
