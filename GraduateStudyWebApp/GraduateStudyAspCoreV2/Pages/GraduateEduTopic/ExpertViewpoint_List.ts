...
import { arrSelectedKeys, BindDdl_ObjLst, BindTab, BindTab_V, GetCheckedKeyIds, GetObjKeys, Redirect, SortFun } from "../TS/PubFun/clsCommFunc4Web.js";
...
export class ExpertViewpoint_List extends ViewpointCRUD {
   ...
   */
    public async QueryvViewpointLst(strListDiv: string) {
        var strWhereCond = await this.CombinevViewpointCondition();
        var intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
        return new Promise((resolve, reject) => {
            try {
