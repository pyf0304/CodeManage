...
**/
export class RTTopicObjectiveRelaCRUDEx extends RTTopicObjectiveRelaCRUD implements IShowList {
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        let objPage: RTTopicObjectiveRelaCRUDEx;
        if (RTTopicObjectiveRelaCRUD.objPage_CRUD == null) {
            RTTopicObjectiveRelaCRUD.objPage_CRUD = new RTTopicObjectiveRelaCRUDEx();
            objPage = <RTTopicObjectiveRelaCRUDEx>RTTopicObjectiveRelaCRUD.objPage_CRUD;
        }
        else {
            objPage = <RTTopicObjectiveRelaCRUDEx>RTTopicObjectiveRelaCRUD.objPage_CRUD;
        }
