...
//
//import * as QQ from "q";
import { gs_ResearchResultCRUD } from "../PagesBase/GraduateEduTopic/gs_ResearchResultCRUD.js";
...
import { gs_ResearchResultAttachment_GetObjLstAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchResultAttachmentWApi.js";
...
import { BindTab, GetCheckedKeyIds, GetFirstCheckedKeyId } from "../TS/PubFun/clsCommFunc4Web.js";
...
export class gs_ResearchResultCRUDEx extends gs_ResearchResultCRUD implements IShowList {
   ...
   */
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        var objPage: gs_ResearchResultCRUDEx = new gs_ResearchResultCRUDEx();
        var objPage_Edit: gs_ResearchResult_EditEx = new gs_ResearchResult_EditEx(objPage);
  ...
  */
    ...
    //研究成果列表绑定
    public async Bind_ResearchResultList() {
        ...
        var arrgs_ResearchResultObjLst1: Array<clsvgs_ResearchResultEN> = [];
        var arrgs_ResearchResultObjLst2: Array<clsvgs_ResearchResultEN> = [];
        ...
        const responseObjLst1 = await vgs_ResearchResult_GetObjLstAsync(strWhereCond).then((jsonData) => {
        ...
        const responseObjLst2 = await gs_ResearchResultAttachment_GetObjLstAsync(strWhereCond).then((jsonData) => {
