 ...
 **/
export class RTViewpointRelaCRUDEx extends RTViewpointRelaCRUD implements IShowList
{
...
let objPage: RTViewpointRelaCRUDEx;
if (RTViewpointRelaCRUD.objPage_CRUD == null)
{
RTViewpointRelaCRUD.objPage_CRUD = new RTViewpointRelaCRUDEx();
objPage = <RTViewpointRelaCRUDEx> RTViewpointRelaCRUD.objPage_CRUD;
}
else
{
objPage = <RTViewpointRelaCRUDEx> RTViewpointRelaCRUD.objPage_CRUD;
