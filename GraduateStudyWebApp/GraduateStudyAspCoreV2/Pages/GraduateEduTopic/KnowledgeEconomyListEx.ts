...
*/
export class KnowledgeEconomyListEx extends ResearchTopic_Edit {
...
*/
    ...
    public async BindGv_AllTopicRela() {
        ...
        //7客观事实
        var strWhereFacts = "topicId='" + clsPrivateSessionStorage.topicId + "' and objectiveType='01'";

        //8客观数据
        var strWhereBasis = "topicId='" + clsPrivateSessionStorage.topicId + "' and objectiveType='02'";

        //技能
        var strWhereSysskill = "topicId='" + clsPrivateSessionStorage.topicId + "'";


        //9、社会关系
        var strWhereSysSocialRelations = "topicId='" + clsPrivateSessionStorage.topicId + "'";
            ...
            for (var i = 0; i < arrvRTViewpointRelaObjLst1.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTViewpointRelaObjLst1[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('个人观点评论', '../GraduateEduTools/SysComment?Key=" + arrvRTViewpointRelaObjLst1[i].viewpointId + "&Type=03&User=" + arrvRTViewpointRelaObjLst1[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
            ...
            for (var i = 0; i < arrvRTViewpointRelaObjLst2.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTViewpointRelaObjLst2[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('专家观点评论', '../GraduateEduTools/SysComment?Key=" + arrvRTViewpointRelaObjLst2[i].viewpointId + "&Type=04&User=" + arrvRTViewpointRelaObjLst2[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
            ...
            for (var i = 0; i < arrvRTConceptObjLst.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTConceptObjLst[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('相关概念评论', '../GraduateEduTools/SysComment?Key=" + arrvRTConceptObjLst[i].conceptId + "&Type=05&User=" + arrvRTConceptObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
            ...
            for (var i = 0; i < arrvRTTopicObjectiveRelaObjLst1.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTTopicObjectiveRelaObjLst1[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('客观事实评论', '../GraduateEduTools/SysComment?Key=" + arrvRTTopicObjectiveRelaObjLst1[i].topicObjectiveId + "&Type=06&User=" + arrvRTTopicObjectiveRelaObjLst1[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
            ...
            for (var i = 0; i < arrvRTTopicObjectiveRelaObjLst2.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTTopicObjectiveRelaObjLst2[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('客观事实评论', '../GraduateEduTools/SysComment?Key=" + arrvRTTopicObjectiveRelaObjLst2[i].topicObjectiveId + "&Type=07&User=" + arrvRTTopicObjectiveRelaObjLst2[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
            ...
            for (var i = 0; i < arrvRTSysSkillObjLst.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTSysSkillObjLst[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('操作技能评论', '../GraduateEduTools/SysComment?Key=" + arrvRTSysSkillObjLst[i].skillId + "&Type=09&User=" + arrvRTSysSkillObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
            ...
            for (var i = 0; i < arrvRTSysSocialRelaObjLst.length; i++) {
                ...
                if (objUserRoleRel == null) {
                    ...
                    if (arrvRTSysSocialRelaObjLst[i].isSubmit == true) {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('社会关系评论', '../GraduateEduTools/SysComment?Key=" + arrvRTSysSocialRelaObjLst[i].socialId + "&Type=10&User=" + arrvRTSysSocialRelaObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage.topicId + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论</button >";
...
*/
   ...
   */
    ...
    /// </summary>
    /// <returns>获取主键字段、名称字段两列的所有记录记录的dataTable</returns>
    public async BindDdl_LiteratureTypeId(ddlLiteratureTypeId: string, strWhereCond: string = "1 =1") {
        //var strWhereCond = " 1 =1 ";
