 ...
 **/
export class ViewpointCRUDEx extends ViewpointCRUD implements IShowList
{
...
let objPage: ViewpointCRUDEx;
if (ViewpointCRUD.objPage_CRUD == null)
{
ViewpointCRUD.objPage_CRUD = new ViewpointCRUDEx();
objPage = <ViewpointCRUDEx> ViewpointCRUD.objPage_CRUD;
}
else
{
objPage = <ViewpointCRUDEx> ViewpointCRUD.objPage_CRUD;
