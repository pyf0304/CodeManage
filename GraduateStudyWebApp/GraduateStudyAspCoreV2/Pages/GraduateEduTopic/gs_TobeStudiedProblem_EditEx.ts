...
import { gs_TobeStudiedProblemVer_AddNewRecordAsync, gs_TobeStudiedProblemVer_GetFirstObjAsync, gs_TobeStudiedProblemVer_GetRecCountByCondAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVerWApi.js";
import { gs_TobeStudiedProblem_AddNewRecordWithMaxIdAsync, gs_TobeStudiedProblem_GetMaxStrIdAsync, gs_TobeStudiedProblem_GetObjByProblemIdAsync, gs_TobeStudiedProblem_UpdateRecordAsync } from "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemWApi.js";
   ...
   */
    public async AddNewRecord() {
        ...
        try {
            ...
            if (returnString == "") {
                var strInfo: string = `获取表gs_TobeStudiedProblem的最大关键字为空，不成功，请检查!`;
                //显示信息框
                alert(strInfo);
            }
            else {
    ...
    public async PutDataTogs_TobeStudiedProblemClass(pobjgs_TobeStudiedProblemEN: clsgs_TobeStudiedProblemEN) {
        ...
        //getTextboxio();
        pobjgs_TobeStudiedProblemEN.Setid_CurrEduCls(clsPublocalStorage.id_CurrEduCls);
        pobjgs_TobeStudiedProblemEN.SetTopicId(clsPrivateSessionStorage.topicId);// 主题编号
        ...
        pobjgs_TobeStudiedProblemEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
  ...
  */
   ...
   */
    public async UpdateRecordSave() {
        ...
        const responseText = await gs_TobeStudiedProblemVer_GetFirstObjAsync(strWhereCond2).then((jsonData) => {
            var objgs_TobeStudiedProblemVerEN: clsgs_TobeStudiedProblemVerEN = <clsgs_TobeStudiedProblemVerEN>jsonData;
    ...
    public async AddVersionRecordSave() {
        ...
        var objgs_TobeStudiedProblemVerEN: clsgs_TobeStudiedProblemVerEN = new clsgs_TobeStudiedProblemVerEN();

        this.PutDataTogs_TobeStudiedProblemVClass(objgs_TobeStudiedProblemVerEN);

        try {
            const responseText2 = await gs_TobeStudiedProblemVer_AddNewRecordAsync(objgs_TobeStudiedProblemVerEN);
            ...
            if (returnBool == true) {
                ...
                const responseText = gs_TobeStudiedProblem_UpdateRecordAsync(objgs_TobeStudiedProblemEN).then((jsonData) => {
                    var returnBool: boolean = jsonData;
                    if (returnBool == true) {
                        return true;
                    }
    ...
    public PutDataTogs_TobeStudiedProblemVClass(pobjgs_TobeStudiedProblemVerEN: clsgs_TobeStudiedProblemVerEN) {
        pobjgs_TobeStudiedProblemVerEN.problemId = $("#hidProblemId").val();
        pobjgs_TobeStudiedProblemVerEN.SetTopicId(clsPrivateSessionStorage.topicId);// 主题编号
        ...
        pobjgs_TobeStudiedProblemVerEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
        var strYmd = clsPubFun4Web.getNowDate_ymd();
        if (this.problemDate == "") {
   ...
   */
    public async UpdateRecord(strProblemId: string): Promise<boolean>  {
        ...
        try {
            ...
            var objgs_TobeStudiedProblemEN: clsgs_TobeStudiedProblemEN = <clsgs_TobeStudiedProblemEN>responseText2;
