...
import { sys_RequestPushEx_GetObjExLstByPager_Cache } from "../TS/L3_ForWApiEx/GraduateEduTools/clssys_RequestPushExWApi.js";
 ...
 */
    public async BindGv_sys_RequestPush4Func() {
        ...
        try {
            ...
            arrsys_RequestPushExObjLst = await sys_RequestPushEx_GetObjExLstByPager_Cache(objPagerPara);
        }
        catch (e) {
    ...
    public async BindTab_sys_RequestPush4Func(divContainer: string, arrsys_RequestPushExObjLst: Array<clssys_RequestPushENEx>) {
        ...
        var arrDataColumn: Array<clsDataColumn> =
            [
                ...
                {
                    fldName: "eduClsName",
                    sortBy: "eduClsName", sortFun: SortFun, getDataSource: "",
                    colHeader: "教学班",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "requestUser",
                    sortBy: "requestUser", sortFun: SortFun, getDataSource: "",
                    colHeader: "推送人",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "requestDate",
                    sortBy: "requestDate", sortFun: SortFun, getDataSource: "",
                    colHeader: "推送日期",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
        ...
        BindTab(o, arrsys_RequestPushExObjLst, arrDataColumn, "requestId", this);
