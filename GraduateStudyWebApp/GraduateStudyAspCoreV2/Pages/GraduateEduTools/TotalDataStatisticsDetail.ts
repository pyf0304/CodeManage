...
import { gs_TotalDataStatistics_GetRecCountByCondAsync, gs_TotalDataStatistics_ReFreshCache } from "../TS/L3_ForWApi/GraduateEduTools/clsgs_TotalDataStatisticsWApi.js";
...
import { gs_TotalDataStatisticsEx_GetObjLstByPagerAsyncEx, gs_TotalDataStatisticsEx_GetSubObjLst_CacheEx } from "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js";
...
*/
export class TotalDataStatisticsDetail extends SysScoreSummaryCRUD implements IShowList {
   ...
   */
    ...
    public async Page_Load() {
        ...
        try {
            ...
            if (clsPublocalStorage.id_CurrEduCls != "" || strId_CurrEduCls != "") {
                var strId_CurrEduCls = $("#hidId_CurrEduClspara").val();
                if (strId_CurrEduCls != "") {
                    $("#topTitle").hide();
                }
              ...
              //  const ddl_TotalDataTypeId_q = await clsDropDownList.BindDdl_TotalTypeId("ddlTotalDataTypeId_q");
                ...
                clsPublocalStorage.id_CurrEduCls = clsPublocalStorage.id_CurrEduCls;
  ...
  */
    public async BindGv_vSysScoreSummary() {
        ...
        if (hidId_CurrEduCls == "") {
            ...
            hidId_CurrEduCls = clsPublocalStorage.id_CurrEduCls;
        }
        ...
        try {
            ...
            // 获取教学班学生数据；
            const responseObjLst3 = await vCurrEduClsStu_GetObjLst_Cache(hidId_CurrEduCls).then((jsonData) => {
                arrvCurrEduClsObjLst = <Array<clsvCurrEduClsStuEN>>jsonData;

            });

            //获取各类型观点数量数据；
            const responseObjLst4 = await gs_TotalDataStatisticsEx_GetSubObjLst_CacheEx(objgs_TotalDataStatistics_Cond, hidId_CurrEduCls).then((jsonData) => {
        ...
        try {
            ...
            for (var i = 0; i < arrvSysScoreSummaryObjLst1.length; i++) {
                ...
                var strId_CurrEduCls: string = arrvSysScoreSummaryObjLst1[i].id_CurrEduCls;
...
*/
    public Combinegs_TotalConditionDetailObj(): clsgs_TotalDataStatisticsEN {
        ...
        try {
            ...
            if (strUserId == "") {
                //  strWhereCond += " and dataUser ='" + clsPublocalStorage.userId + "'";
                var strSessionUserId = clsPublocalStorage.userId;
                objgs_TotalDataStatistics_Cond.SetCondFldValue(clsgs_TotalDataStatisticsEN.con_DataUser, strSessionUserId, "=");
            }
            else {
                //获取当前用户自己数据
             //   strWhereCond += " And dataUser='" + strUserId + "'";
       ...
       // var strUserId = clsPublocalStorage.userId;
        ...
        try {
            ...
            if (strTotalDataTypeId != "") {
                ...
                strWhereCond += ` And ${clsgs_TotalDataTypeEN.con_TotalDataTypeId} = '01'`;//如果tab值为空 默认显示论文；
            }
...
*/
    ...
    public async Bind_AllData(){
        ...
        try {
            ...
            this.recCount = await gs_TotalDataStatistics_GetRecCountByCondAsync(objgs_TotalDataStatistics_Cond);
            console.log("完成计数!");
            const responseObjLst = await gs_TotalDataStatisticsEx_GetObjLstByPagerAsyncEx(objPagerPara).then((jsonData) => {
                arrgs_TotalDataStatisticsObjLst = <Array<clsgs_TotalDataStatisticsEN>>jsonData;
            });
            console.log("完成对象列表获取!");
...
*/
    ...
    public async li_Paper_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计论文列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //论文子观点
    public async li_PaperViewpoint_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计论文子观点列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //个人观点
    public async li_Viewpoint_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计个人观点列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //专家观点
    public async li_ExpertViewpoint_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计专家列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //概念
    public async li_Concept_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计概念列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //客观事实
    public async li_TopicObjective_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计客观事实列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //客观数据
    public async li_ObjectiveBasis_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计客观数据列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    ...
    public async li_Skill_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计技能列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //社会关系
    public async li_SysSocialRelations_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计社会关系列表不成功,${e}.`;
            alert(strMsg);
        }
    }
    //问题回答
    public async li_QaAnswer_Click() {
        try {
            ...
            console.error('catch(e)=');
            console.error(e);
            var strMsg: string = `获取统计问题回答列表不成功,${e}.`;
            alert(strMsg);
        }
    }
