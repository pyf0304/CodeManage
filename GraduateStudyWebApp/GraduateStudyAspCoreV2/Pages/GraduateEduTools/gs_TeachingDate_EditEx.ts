                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            const responseText2 = await this.AddNewRecordSave().then((jsonData) => {
                                ...
                                if (returnBool == true) {
                                    ...
                                    //数据同步；
                                    const responseText4 = gs_TotalDataStatisticsEx_GetTotalStatisticsByTableAsync(strId_CurrEduCls, clsPublocalStorage.userId);
                                    var returnBool3: boolean = !!responseText4;
                                    if (returnBool3 == true) {
                                        const responseText5 = SysCommentEx_UpdateCommentWeekAsync(strId_CurrEduCls, clsPublocalStorage.userId);
...
*/
  ...
  */
    public async PutDataTogs_TeachingDateClass(pobjgs_TeachingDateEN: clsgs_TeachingDateEN) {
        ...
        pobjgs_TeachingDateEN.SetUpdDate(clsPubFun4Web.getNowDate_ymd());// 修改日期
        pobjgs_TeachingDateEN.SetUpdUser(clsPublocalStorage.userId);
