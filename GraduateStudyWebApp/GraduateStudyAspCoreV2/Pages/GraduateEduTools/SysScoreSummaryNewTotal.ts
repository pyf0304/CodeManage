...
import { vCurrEduClsStu_GetObjLst_Cache } from "../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js";
import { vCurrEduClsTeacher_GetObjLst_Cache } from "../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsTeacherWApi.js";
import { gs_TeachingDate_GetObjLst_Cache } from "../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TotalDataStatistics_ReFreshCache } from "../TS/L3_ForWApi/GraduateEduTools/clsgs_TotalDataStatisticsWApi.js";
import { gs_TotalDataType_GetObjLst_Cache } from "../TS/L3_ForWApi/GraduateEduTools/clsgs_TotalDataTypeWApi.js";
import { gs_UserRela_GetObjLst_Cache } from "../TS/L3_ForWApi/GraduateEduTools/clsgs_UserRelaWApi.js";
import { vSysScoreSummary_GetObjLst_Cache } from "../TS/L3_ForWApi/GraduateEduTools/clsvSysScoreSummaryWApi.js";
import { SchoolYear_GetObjLst_Cache } from "../TS/L3_ForWApi/SysPara/clsSchoolYearWApi.js";
...
import { gs_TotalDataStatisticsEx_GetSubObjLst_CacheEx } from "../TS/L3_ForWApiEx/GraduateEduTools/clsgs_TotalDataStatisticsExWApi.js";
import { vgs_TotalDataStatisticsEx_GetUserNumObjLstAsync, vgs_TotalDataStatisticsEx_GetUser_WeekNumObjLstAsync } from "../TS/L3_ForWApiEx/GraduateEduTools/clsvgs_TotalDataStatisticsExWApi.js";
...
import { gs_UserRela } from "./gs_UserRela.js";
import { TotalDataStatisticsEx } from "./TotalDataStatisticsEx.js";
declare function ShowDialog(strOpType): void;

declare function GetExportCurrEduclsID(strId_CurrEduCls): void;

declare function btnExportWord_Click(): void;//图标方法
...
declare function UserRelaCanvas(str1, str2, str3, str4): void;//人员关系图展示

declare function UserRelaCanvasUpload(str1, str2, str3, str4): void;//人员关系图上传
...
*/
export class SysScoreSummaryNewTotal extends SysScoreSummaryCRUD {
  ...
  */
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                const responseText = SchoolYear_GetObjLst_Cache().then((jsonData) => {
                    ...
                    BindDdl_ObjLst(strDdlName, arrSchoolYearObjLst, clsSchoolYearEN.con_SchoolYear, clsSchoolYearEN.con_SchoolYearName, "学年");
                ...
                //BindDdl_ObjLst(strDdlName, arrObjLst_Sel, clsSchoolYearEN.con_SchoolYear, clsSchoolYearEN.con_SchoolYearName, "学年");
    ...
    public async GetUserRela() {
        try {
            ...
            var objgs_UserRela: gs_UserRela = new gs_UserRela();
            objgs_UserRela.Bind_UserRela(strId_CurrEduCls);

        }
        catch (e) {
            var strMsg: string = `用户关系获取不成功,${e}.`;
            alert(strMsg);
        }
    }
    ...
    public async GetBind_AllData() {
        ...
        var objTotalDataStatisticsEx: TotalDataStatisticsEx = new TotalDataStatisticsEx();
    ...
    public async GetCurrEduClsUserRela() {
        try {
            ...
            //本地展示；
          //  var strAddressAndPort = `${clsSysPara4WebApi.CurrIPAddressAndPort_LocalPic}/${clsSysPara4WebApi.CurrPrx_Local}/`;
    ...
    public async Bind_UserRelaOne() {
        var strSeUserId = clsPublocalStorage.userId;
    ...
    public async GetExportCurrEduclsID(strId_CurrEducls: string) {
  ...
  */
        ...
        try {
            ...
            if (clsPublocalStorage.roleId == "00620003") {
                ...
                if (strId_CurrEduCls == "") {
                    ...
                    $("#hidId_CurrEduClspara").val(clsPublocalStorage.id_CurrEduCls);
                }
                else {

                    strWhereCond += ` And ${clsvSysScoreSummaryEN.con_id_CurrEduCls} = '${strId_CurrEduCls}'`;
                }
   ...
   */
    public async BindGv_vSysScoreSummary() {
        ...
        if (Id_CurrEduCls == "") {
            Id_CurrEduCls = clsPublocalStorage.id_CurrEduCls;
        }

        var objgs_TotalDataStatistics_Cond = await this.Combinegs_TotalConditionObj();
        //var strid_CurrEducls = $("#hidId_CurrEduClspara").val();;
        ...
        //观点数量统计
        var arrgs_TotalDataStatisticsObjLst0: Array<clsgs_TotalDataStatisticsEN> = [];
        var arrgs_TotalDataStatisticsObjLst: Array<clsgs_TotalDataStatisticsEN> = [];
        //观点类型
        var arrObjLst_Sel: Array<clsgs_TotalDataTypeEN> = [];
        try {
            ...
            const responseObjLst = await vSysScoreSummary_GetObjLst_Cache(Id_CurrEduCls).then((jsonData) => {
            ...
            // 获取教学班学生数据；
            const responseObjLst3 = await vCurrEduClsStu_GetObjLst_Cache(Id_CurrEduCls).then((jsonData) => {
            ...
            const responseObjLst4 = await gs_TotalDataStatisticsEx_GetSubObjLst_CacheEx(objgs_TotalDataStatistics_Cond, Id_CurrEduCls).then((jsonData) => {
                arrgs_TotalDataStatisticsObjLst0 = <Array<clsgs_TotalDataStatisticsEN>>jsonData;
            });
            ...
            arrObjLst_Sel = await gs_TotalDataType_GetObjLst_Cache();
...
*/
    public async Combinegs_TotalConditionObj(): Promise< clsgs_TotalDataStatisticsEN> {
        ...
        try {
            ...
            //    strWhereCond += " And dataUser='" + strUserId + "'";
            //}
            objgs_TotalDataStatistics_Cond.SetCondFldValue(clsgs_TotalDataStatisticsEN.con_id_CurrEduCls, strId_CurrEduCls, "=");
    ...
    public async ExportDetail() {
        ...
        var objWhere_Cond = await this.Combinegs_TotalCondition();
        ...
        var arrvUserStuNameObjLst: Array<clsvUsersSimEN> = [];
        var arrgs_TotalDataStatisticsObjLst0: Array<clsgs_TotalDataStatisticsEN> = [];
        var arrgs_TotalDataStatisticsObjLst: Array<clsgs_TotalDataStatisticsEN> = [];
        var arrObjLst_Sel: Array<clsgs_TotalDataTypeEN> = [];
        //var objPagerPara: stuPagerPara = {
        ...
        try {
            ...
            // console.log("完成计数!");
            const responseObjLst = await gs_TotalDataStatisticsEx_GetSubObjLst_CacheEx(objgs_TotalDataStatistics_Cond, strid_CurrEducls).then((jsonData) => {
                arrgs_TotalDataStatisticsObjLst0 = <Array<clsgs_TotalDataStatisticsEN>>jsonData;
            });
            console.log("完成对象列表获取!");
            ...
            var arrvgs_TotalDataStatisticsObjLst: Array<clsvgs_TotalDataStatisticsEN> = await vgs_TotalDataStatisticsEx_GetUserNumObjLstAsync(objWhere_Cond);
        ...
        try {
            ...
            gs_TotalDataStatistics_ReFreshCache(strid_CurrEducls);
        }
        catch (e) {
            console.error('catch(e)=');
            console.error(e);
