...
//
//import * as QQ from "q";
import { SysCommentCRUD } from "../PagesBase/GraduateEduTools/SysCommentCRUD.js";
...
import { GetCurrPageIndex, ShowEmptyRecNumInfo } from "../TS/PubFun/clsOperateList.js";
...
*/
export class SysComment_QUDI_TSEx extends SysCommentCRUD {
            ...
            if (ParentarrvSysCommentObjLst.length > 0) {
                ...
                for (var i = 0; i < ParentarrvSysCommentObjLst.length; i++) {
                    ...
                    switch (strQueryStata) {
                        ...
                        case "1":
                            var pubarrPaperObjLst: Array<clsPaperEN> = [];//论文
                ...
                if (RemainDatavSysCommentObjLst.length > 0) {
                    ...
                    console.error("Error: ", strMsg);
                    //console.trace();
                    ShowEmptyRecNumInfo(SysComment_QUDI_TSEx.arrDivDataLst[intQueryStata], strMsg);
                    this.objPager.Hide(SysComment_QUDI_TSEx.arrDivName4Pager[intQueryStata]);
                    //return;
                }
            }
