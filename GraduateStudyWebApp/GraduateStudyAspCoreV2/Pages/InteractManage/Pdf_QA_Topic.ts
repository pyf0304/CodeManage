   ...
   */
    ...
    public async BindPdf() {
        try {
            ...
            if (strPaperId == "") {
                var strWhereCond1 = "1=1 and topicId='" + clsPrivateSessionStorage.topicId + "'";
    ...
    public async BindDdl_gs_TagsType_Cache(ddlTagsTypeId: string) {
        ...
        try {
            ...
            BindDdl_ObjLst(ddlTagsTypeId, arrObjLst_Sel, clsgs_TagsTypeEN.con_TagsTypeId, clsgs_TagsTypeEN.con_TagsTypeName, "标注类型");
 ...
 */
  ...
  */
    public async UpdateRecordSave3() {
        ...
        objgs_TagsEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
 ...
 */
    public PutDataTogs_TagsClass(pobjgs_TagsEN: clsgs_TagsEN) {
        ...
        pobjgs_TagsEN.Setid_CurrEduCls(clsPublocalStorage.id_CurrEduCls);//教学班Id// 教学班Id
        pobjgs_TagsEN.SetShareId("02");// 分享
        pobjgs_TagsEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
