...
import { qa_Paper_EditEx } from "./qa_Paper_EditEx.js";
...
export class qa_PaperCRUDEx extends qa_PaperCRUD implements IShowList {
   ...
   */
    ...
    public async BindGv_History_vqa_Push() {
        ...
        strWhereCond += " and id_CurrEduCls=" + clsPublocalStorage.id_CurrEduCls;
        strWhereCond += " and receiveUser='" + clsPublocalStorage.userId + "' and isReceive=1";
 ...
 */
   ...
   */
    public async BindTab_vqa_Questions(divContainer: string, arrvqa_QuestionsObjLst: Array<clsvqa_QuestionsEN>) {
        ...
        var arrDataColumn: Array<clsDataColumn> =
            [
                ...
                },
                {
                    fldName: "",
                    colHeader: "解答",
                    text: "解答", tdClass: "text-left", sortBy: "", sortFun: SortFun, getDataSource: "",
                    columnType: "Button",
                    orderNum: 1,
        ...
        BindTab_V(o, arrvqa_QuestionsObjLst, arrDataColumn, "questionsId", this);
 ...
 **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        ...
        if (qa_PaperCRUD.objPage_CRUD == null) {
            qa_PaperCRUD.objPage_CRUD = new qa_PaperCRUDEx();
            objPage = <qa_PaperCRUDEx>qa_PaperCRUD.objPage_CRUD;
        }
        else {
            objPage = <qa_PaperCRUDEx>qa_PaperCRUD.objPage_CRUD;
        }
