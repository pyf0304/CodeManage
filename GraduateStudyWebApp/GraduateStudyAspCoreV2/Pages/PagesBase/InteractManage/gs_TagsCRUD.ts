...
import { gs_Tags_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_Tags_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
...
import { gs_Tags_DelRecordAsync } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
...
import { gs_TagsEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/InteractManage/clsgs_TagsExWApi.js";
import { gs_Tags_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_Tags_SortFun_Defa } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_Tags_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_TagsEx_GetObjExLstByPagerAsync } from "../../TS/L3_ForWApiEx/InteractManage/clsgs_TagsExWApi.js";
import { gs_Tags_GetObjLstByTagsIdLstAsync } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_Tags_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_Tags_AddNewRecordAsync } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
import { gs_Tags_Delgs_TagssAsync } from "../../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js";
...
const strFileName = Format("标注({0})导出.xlsx",
...
{
const strMsg = Format("在显示列表时，排序字段(sortgs_TagsBy)为空，请检查！(In BindGv_gs_Tags_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objgs_Tags_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objgs_Tags_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
...
{
await PaperEduClsRelaEx_BindDdl_PaperIdByid_CurrEduClsInDiv_Cache(this.divName4Query, "ddlPaperId_q" , Id_CurrEduCls);//
}
...
{
await gs_TagsType_BindDdl_TagsTypeIdInDiv_Cache(this.divName4Query, "ddlTagsTypeId_q" );//
}
 ...
 **/
public async btnSelectRecordInTab_Click(strTagsId: string) {
...
try
{
const returnInt = await gs_Tags_DelRecordAsync(strTagsId);
if (returnInt > 0)
{
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsgs_TagsEN.con_TagsContent, this.tagsContent_q);
}
if ( this.paperId_q != "" && this.paperId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsgs_TagsEN.con_PaperId, this.paperId_q);
}
if ( this.tagsTypeId_q != "" && this.tagsTypeId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsgs_TagsEN.con_TagsTypeId, this.tagsTypeId_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(Combinegs_TagsCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async Combinegs_TagsConditionObj(): Promise<clsgs_TagsEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(Combinegs_TagsConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async Combinegs_TagsConditionObj4ExportExcel():Promise<clsgs_TagsEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(Combinegs_TagsConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objgs_Tags_Cond.whereCond = strWhereCond;
return objgs_Tags_Cond;
 ...
 **/
public async BindTab_gs_Tags(divContainer: string, arrgs_TagsObjLst: Array<clsgs_TagsEN>) 
{
...
await BindTab(o, arrgs_TagsObjLst, arrDataColumn,  clsgs_TagsEN.con_TagsId, this); 
 ...
 **/
public async BindTab_gs_Tags4Func(divContainer: string, arrgs_TagsExObjLst: Array<clsgs_TagsENEx>) 
{
...
await BindTab(o, arrgs_TagsExObjLst, arrDataColumn, clsgs_TagsEN.con_TagsId, this); 
this.objPager.recCount = this.recCount;
this.objPager.pageSize = this.pageSize;
this.objPager.ShowPagerV2(this, this.divName4Pager);
}
 ...
 **/
public async ExtendFldFuncMap(arrgs_TagsExObjLst: Array<clsgs_TagsENEx>, arrDataColumn: Array<clsDataColumn>) {
const arrFldName = clsgs_TagsEN.AttributeName;
for (const objDataColumn of arrDataColumn) {
if (IsNullOrEmpty(objDataColumn.fldName) == true) continue;
if (arrFldName.indexOf(objDataColumn.fldName) > -1) continue;
for (const objInFor of arrgs_TagsExObjLst) {
await gs_TagsEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (gs_TagsCRUD.sortgs_TagsBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortgs_TagsBy)为空，请检查！(In BindGv_gs_Tags)");
console.error(strMsg);
alert(strMsg);
return;
}
 ...
 **/
public async BindGv_gs_Tags_Cache() 
{
...
whereCond: strWhereCond,
orderBy: gs_TagsCRUD.sortgs_TagsBy,//如果该字段为空，就使用下面的排序函数
sortFun: gs_Tags_SortFun_Defa
}
arrgs_TagsObjLst = await gs_Tags_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, gs_TagsCRUD.ascOrDesc4SortFun, gs_TagsCRUD.sortgs_TagsBy, strSortExpress);
...
try
{
const arrgs_TagsObjLst = await gs_Tags_GetObjLstByTagsIdLstAsync(arrTagsId);
...
const returnBool = await gs_Tags_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await gs_Tags_Delgs_TagssAsync(arrTagsId);
if (returnInt > 0)
{
//gs_Tags_ReFreshCache();
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const sstrKeys = GetObjKeys(objgs_Tags);
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtTagsContent_q");
if (strValue == undefined) return "";
...
public  set tagsContent_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtTagsContent_q", value);
}
 /**
 * 标注类型ID (Used In CombineCondition())
 **/
public  get tagsTypeId_q():string {
const strValue = GetSelectValueInDiv(this.divName4Query, "ddlTagsTypeId_q");
if (strValue == undefined) return "";
else if (strValue == "0") return "";
else return strValue;
}
...
SetSelectValueByIdInDiv(this.divName4Query, "ddlTagsTypeId_q", value);
}
 /**
