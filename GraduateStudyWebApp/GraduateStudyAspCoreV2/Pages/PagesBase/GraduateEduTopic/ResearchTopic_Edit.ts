...
import { ResearchTopic_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetUniCondStr_TopicId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetUniCondStr4Update_TopicId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { clsResearchTopicEN } from "../../TS/L0_Entity/GraduateEduTopic/clsResearchTopicEN.js";
import { ResearchTopic_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetObjByTopicIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
...
**/
export abstract class ResearchTopic_Edit {
    public opType = "";
    public keyId = "";

    public static id_CurrEduCls_Cache = "";
    public static strPageDispModeId = "01";//PopupBox(弹出框)
    public static objPage_Edit: ResearchTopic_Edit;
    public objResearchTopic: clsResearchTopicEN;
    ...
    constructor(objShowList: IShowList) {
        ...
        this.objResearchTopic = new clsResearchTopicEN();
    }
    ...
    **/
    public ShowDialog_ResearchTopic(strOp: string) {
        const strThisFuncName = this.ShowDialog_ResearchTopic.name;
        //检查相关控件是否存在
        CheckControlExist(this.divName4Edit, "div", "divEditDialog_ResearchTopic");
        CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_ResearchTopic");
    ...
    **/
    public HideDialog_ResearchTopic() {
    ...
    **/
    public async btnSubmit_Click() {
        ...
        const strCommandText: string = this.btnSubmit_ResearchTopic;
        try {
                ...
                case "确认添加":
                    ...
                    if (this.opType == "AddWithMaxId") {
                        ...
                        if (IsNullOrEmpty(returnKeyId) == false) {
                            ...
                            this.iShowList.BindGv(clsResearchTopicEN._CurrTabName, returnKeyId);
                        }
                    }
                    else {
    ...
    **/
    public async AddNewRecord() {
        ...
        try {
            const returnString = await ResearchTopic_GetMaxStrIdAsync();
            if (returnString == "") {
                const strInfo = Format("获取表ResearchTopic的最大关键字为空，不成功，请检查!");
                //显示信息框
                alert(strInfo);
            }
            else {
    ...
    **/
    public async PutDataToResearchTopicClass(pobjResearchTopicEN: clsResearchTopicEN) {
        ...
        pobjResearchTopicEN.Setid_CurrEduCls(clsPublocalStorage.id_CurrEduCls);// 教学班流水号
        pobjResearchTopicEN.SetShareId(this.shareId);// 分享Id
        pobjResearchTopicEN.SetMemo(this.memo);// 备注
        pobjResearchTopicEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1));// 修改日期
    ...
    **/
    public async AddNewRecordSave(): Promise<boolean> {
        ...
        const objResearchTopicEN = new clsResearchTopicEN();
        try {
        ...
        try {
            ResearchTopic_CheckPropertyNew(objResearchTopicEN);
        }
        catch (e) {
        ...
        try {
            ...
            let returnBool = false;
            const returnKeyId = await ResearchTopic_AddNewRecordWithMaxIdAsync(objResearchTopicEN);
            if (IsNullOrEmpty(returnKeyId) == false) {
                returnBool = true;
            }
            if (returnBool == true) {
                ResearchTopic_ReFreshCache(ResearchTopic_Edit.id_CurrEduCls_Cache);
    ...
    **/
    public async CheckUniCond4Add_TopicId(objResearchTopicEN: clsResearchTopicEN): Promise<boolean> {
        const strThisFuncName = this.CheckUniCond4Add_TopicId.name;
        const strUniquenessCondition = ResearchTopic_GetUniCondStr_TopicId(objResearchTopicEN);
        const bolIsExistCondition = await ResearchTopic_IsExistRecordAsync(strUniquenessCondition);
    ...
    **/
    public async CheckUniCond4Update_TopicId(objResearchTopicEN: clsResearchTopicEN): Promise<boolean> {
        const strThisFuncName = this.CheckUniCond4Update_TopicId.name;
        const strUniquenessCondition = ResearchTopic_GetUniCondStr4Update_TopicId(objResearchTopicEN);
        const bolIsExistCondition = await ResearchTopic_IsExistRecordAsync(strUniquenessCondition);
        if (bolIsExistCondition == true) {
            const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
            console.error(strMsg);
    ...
    **/
    public async AddNewRecordWithMaxIdSave(): Promise<string> {
        ...
        try {
            ...
            const responseKeyId = await ResearchTopic_AddNewRecordWithMaxIdAsync(objResearchTopicEN);
   ...
   * 在这里是把值传到表控件中
    ...
    **/
    public async ShowData(strTopicId: string) {
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objResearchTopicEN = new clsResearchTopicEN();
        try {
            const returnBool = await ResearchTopic_IsExistAsync(strTopicId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", strTopicId);
        ...
        try {
            const objResearchTopicEN_Const = await ResearchTopic_GetObjByTopicIdAsync(strTopicId);
    ...
    **/
    public async UpdateRecordSave(): Promise<boolean> {
        ...
        try {
            ResearchTopic_CheckProperty4Update(objResearchTopicEN);
        }
        catch (e) {
            const strMsg = Format("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
            console.error(strMsg);
        ...
        try {
            ...
            const returnBool = await ResearchTopic_UpdateRecordAsync(objResearchTopicEN);
            if (returnBool == true) {
                ResearchTopic_ReFreshCache(ResearchTopic_Edit.id_CurrEduCls_Cache);
            }
            return returnBool;
    ...
    **/
    public set btnCancel_ResearchTopic(value: string) {
        SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_ResearchTopic", value);
    }
    /**
    * 获取按钮的标题
    **/
    public get btnSubmit_ResearchTopic(): string {
        const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_ResearchTopic");
        return strValue;
    }
    /**
    * 设置确定按钮的标题(Used In AddNewRecord())
    **/
    public set btnSubmit_ResearchTopic(value: string) {
        SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_ResearchTopic", value);
    }
    /**
    * 是否提交 (Used In Clear())
    **/
    ...
    **/
    public set topicContent(value: string) {
        SetInputValueByIdInDiv(this.divName4Edit, "txtTopicContent", value);
    }
    /**
    * 主题内容 (Used In PutDataToClass())
    **/
    public get topicContent(): string {
        const strValue = GetInputValueInDiv(this.divName4Edit, "txtTopicContent");
        if (strValue == undefined) return "";
        else return strValue.toString();
    }
    /**
    ...
    **/
    public set topicName(value: string) {
        SetInputValueByIdInDiv(this.divName4Edit, "txtTopicName", value);
    }
    /**
    * 栏目主题 (Used In PutDataToClass())
    **/
    public get topicName(): string {
        const strValue = GetInputValueInDiv(this.divName4Edit, "txtTopicName");
        if (strValue == undefined) return "";
        else return strValue.toString();
    }
    /**
    ...
    **/
    public set topicProposePeople(value: string) {
        SetInputValueByIdInDiv(this.divName4Edit, "txtTopicProposePeople", value);
    }
    /**
    * 主题提出人 (Used In PutDataToClass())
    **/
    public get topicProposePeople(): string {
        const strValue = GetInputValueInDiv(this.divName4Edit, "txtTopicProposePeople");
        if (strValue == undefined) return "";
        else return strValue.toString();
    }
    /**
