 ...
 /**
 * 类名:WA_RTSysSocialRela_Edit(界面:RTSysSocialRelaCRUD)
 * 表名:RTSysSocialRela(01120657)
 * 生成代码版本:2022.11.02.1
 * 生成日期:2022/11/05 03:46:23
 * 生成者:
 工程名称:问卷调查(0112)
...
import { RTSysSocialRela_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_GetUniCondStr_mId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_GetUniCondStr4Update_mId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_GetObjBymIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
...
declare function HideDialog(strDialogName:string): void;
 /** WA_RTSysSocialRela_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.WA_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class WA_RTSysSocialRela_Edit 
{
public opType = "";
public keyId = "";

public static strPageDispModeId = "01";//PopupBox(弹出框)
public static objPage_Edit: WA_RTSysSocialRela_Edit;
public objRTSysSocialRela: clsRTSysSocialRelaEN;
protected iShowList: IShowList;
public bolIsLoadEditRegion = false;  //记录是否导入编辑区的变量
public divName4Edit = "divEdit";  //编辑区的Id
constructor(objShowList: IShowList) {
this.iShowList = objShowList;
WA_RTSysSocialRela_Edit.objPage_Edit = this;
this.objRTSysSocialRela = new clsRTSysSocialRelaEN();
}
...
const strUrl = "../GraduateEduTopic/WA_RTSysSocialRela_Edit";
 ...
 **/
public ShowDialog_RTSysSocialRela(strOp:string) {
const strThisFuncName = this.ShowDialog_RTSysSocialRela.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_RTSysSocialRela");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_RTSysSocialRela");
       if (strOp === "Add" || strOp === "AddWithMaxId") {
           $('#lblDialogTitle_RTSysSocialRela').html('添加记录');
//WA_RTSysSocialRela_EditEx.GetMaxStrId('#txtmId');
        }
...
if (WA_RTSysSocialRela_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
...
const strCommandText: string = this.btnSubmit_RTSysSocialRela;
try {
...
//this.iShowList.BindGv_Cache(clsvRTSysSocialRelaEN._CurrTabName, "");
//}
}
else
{
...
this.iShowList.BindGv(clsvRTSysSocialRelaEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
strInfo += "(In WA_RTSysSocialRela_Edit.btnSubmit_Click)";
//显示信息框
//console.log(strInfo);
alert(strInfo);
if (returnBool == true)
 ...
 **/
public async CheckUniCond4Add_mId(objRTSysSocialRelaEN: clsRTSysSocialRelaEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_mId.name;
const strUniquenessCondition = RTSysSocialRela_GetUniCondStr_mId(objRTSysSocialRelaEN);
 ...
 **/
public async CheckUniCond4Update_mId(objRTSysSocialRelaEN: clsRTSysSocialRelaEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_mId.name;
const strUniquenessCondition = RTSysSocialRela_GetUniCondStr4Update_mId(objRTSysSocialRelaEN);
const bolIsExistCondition = await RTSysSocialRela_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
console.error(strMsg);
        ...
        try {
objRTSysSocialRelaEN = await RTSysSocialRela_GetObjBymIdAsync(lngmId);
        }
        catch (e) {
...
this.objRTSysSocialRela = objRTSysSocialRelaEN;
const conGetDataFromClass = await   this.GetDataFromRTSysSocialRelaClass(objRTSysSocialRelaEN);
 ...
 **/
public  set btnCancel_RTSysSocialRela(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_RTSysSocialRela", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_RTSysSocialRela():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_RTSysSocialRela");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_RTSysSocialRela(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_RTSysSocialRela", value);
}
 /**
 * 备注 (Used In Clear())
 **/
