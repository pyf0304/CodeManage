                ...
                case "确认添加":
                    ...
                    if (this.opType == "AddWithMaxId") {
                        ...
                        if (IsNullOrEmpty(returnKeyId) == false) {
                            ...
                            this.iShowList.BindGv(clsgs_MeetingMinutesEN._CurrTabName, returnKeyId);
                        }
                    }
                    else {
                        ...
                        if (returnBool == true) {
                            ...
                            this.iShowList.BindGv(clsgs_MeetingMinutesEN._CurrTabName, returnBool.toString());
                        }
                    }
                    break;
                case "确认修改":
   ...
   * 在这里是把值传到表控件中
    ...
    **/
    public async ShowData(strMeetingId: string) {
        ...
        try {
            const objgs_MeetingMinutesEN_Const = await gs_MeetingMinutes_GetObjByMeetingIdAsync(strMeetingId);
    ...
    **/
    public set meetingContent(value: string) {
        SetTextAreaValueByIdInDiv(this.divName4Edit, "txtMeetingContent", value);
    }
    /**
    * 会议内容 (Used In PutDataToClass())
    **/
    public get meetingContent(): string {
        const strValue = GetTextAreaValueInDiv(this.divName4Edit, "txtMeetingContent");
