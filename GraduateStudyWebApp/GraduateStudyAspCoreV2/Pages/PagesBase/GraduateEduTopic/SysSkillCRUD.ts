 ...
 **/
//import $ from "jquery";
import { vSysSkill_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { vSysSkill_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { vSysSkill_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { vSysSkill_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { SysOperationType_BindDdl_OperationTypeIdInDiv_Cache } from "../../TS/L3_ForWApi/ParameterTable/clsSysOperationTypeWApi.js";
import { SysSkill_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillWApi.js";
...
import { clsvSysSkillENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsvSysSkillENEx.js";
import { vSysSkillEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvSysSkillExWApi.js";
import { vSysSkill_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { vSysSkill_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { vSysSkill_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSkillWApi.js";
import { SysSkill_GetObjLstBySkillIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillWApi.js";
import { SysSkill_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillWApi.js";
import { SysSkill_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillWApi.js";
import { SysSkill_DelSysSkillsAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSkillWApi.js";
 ...
 **/
export abstract class SysSkillCRUD implements clsOperateList
{
public static objPage_CRUD: SysSkillCRUD;
public static sortFun_Static: (ascOrDesc: string) => (x: any, y: any) => number;
public static ascOrDesc4SortFun = "Asc";
public static sortvSysSkillBy = "";
 ...
 **/
public CombineData(arrvSysSkillObjLst: Array<clsvSysSkillEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const objEN: clsvSysSkillEN = arrvSysSkillObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("技能表({0})导出.xlsx",
 clsvSysSkillEN._CurrTabName);
 ...
 **/
public async ExportExcel_vSysSkill() 
{
const strThisFuncName = this.ExportExcel_vSysSkill.name;
if (SysSkillCRUD.sortvSysSkillBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvSysSkillBy)为空，请检查！(In BindGv_vSysSkill_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrvSysSkillObjLst = await vSysSkill_GetObjLstAsync(strWhereCond);
}
catch(e)
{
 ...
 **/
public async ExportExcel_vSysSkill_Cache() 
{
...
objvSysSkill_Cond.SetCondFldValue(clsvSysSkillEN.con_id_CurrEduCls, SysSkillCRUD.id_CurrEduCls_Cache, "=");
const strWhereCond = JSON.stringify(objvSysSkill_Cond);
const intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
 let arrvSysSkillObjLst: Array <clsvSysSkillEN> = [];
try
{
this.recCount = await vSysSkill_GetRecCountByCond_Cache(objvSysSkill_Cond, SysSkillCRUD.id_CurrEduCls_Cache);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvSysSkill_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvSysSkill_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvSysSkillObjLst = await vSysSkill_GetSubObjLst_Cache(objvSysSkill_Cond, SysSkillCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrvSysSkillObjLst.length == 0)
{
const strKey = Format("{0}_{1}", clsSysSkillEN._CurrTabName, SysSkillCRUD.id_CurrEduCls_Cache);
 ...
 **/
public async btnSelectRecordInTab_Click(strSkillId: string) {
...
try
{
const returnInt = await SysSkill_DelRecordAsync(strSkillId);
if (returnInt > 0)
{
...
if ( this.skillName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvSysSkillEN.con_SkillName, this.skillName_q);
}
if ( this.operationTypeId_q != "" && this.operationTypeId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsvSysSkillEN.con_OperationTypeId, this.operationTypeId_q);
}
if ( this.updUser_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvSysSkillEN.con_UpdUser, this.updUser_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineSysSkillCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineSysSkillConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async CombinevSysSkillConditionObj4ExportExcel():Promise<clsvSysSkillEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineSysSkillConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvSysSkill_Cond.whereCond = strWhereCond;
return objvSysSkill_Cond;
...
{
fldName: clsvSysSkillEN.con_SkillName,
sortBy: clsvSysSkillEN.con_SkillName,
sortFun: SortFun,
getDataSource: "",
colHeader: "技能名称",
text: "",
...
{
fldName: clsvSysSkillEN.con_Process,
sortBy: clsvSysSkillEN.con_Process,
sortFun: SortFun,
getDataSource: "",
colHeader: "实施过程",
text: "",
...
{
fldName: clsvSysSkillEN.con_LevelName,
sortBy: clsvSysSkillEN.con_LevelName,
sortFun: SortFun,
getDataSource: "",
colHeader: "级别名称",
text: "",
...
{
fldName: clsvSysSkillEN.con_IsSubmit,
sortBy: clsvSysSkillEN.con_IsSubmit,
sortFun: SortFun,
getDataSource: "",
colHeader: "是否提交",
text: "",
...
{
fldName: clsvSysSkillEN.con_OkCount,
sortBy: clsvSysSkillEN.con_OkCount,
sortFun: SortFun,
getDataSource: "",
colHeader: "点赞统计",
text: "",
...
{
fldName: clsvSysSkillEN.con_AppraiseCount,
sortBy: clsvSysSkillEN.con_AppraiseCount,
sortFun: SortFun,
getDataSource: "",
colHeader: "评论数",
text: "",
...
{
fldName: clsvSysSkillEN.con_Score,
sortBy: clsvSysSkillEN.con_Score,
sortFun: SortFun,
getDataSource: "",
colHeader: "评分",
text: "",
...
{
fldName: clsvSysSkillEN.con_StuScore,
sortBy: clsvSysSkillEN.con_StuScore,
sortFun: SortFun,
getDataSource: "",
colHeader: "学生平均分",
text: "",
...
{
fldName: clsvSysSkillEN.con_TeaScore,
sortBy: clsvSysSkillEN.con_TeaScore,
sortFun: SortFun,
getDataSource: "",
colHeader: "教师评分",
text: "",
...
{
fldName: clsvSysSkillEN.con_PdfContent,
sortBy: clsvSysSkillEN.con_PdfContent,
sortFun: SortFun,
getDataSource: "",
colHeader: "Pdf内容",
text: "",
...
{
fldName: clsvSysSkillEN.con_PdfPageNum,
sortBy: clsvSysSkillEN.con_PdfPageNum,
sortFun: SortFun,
getDataSource: "",
colHeader: "Pdf页码",
text: "",
...
{
fldName: clsvSysSkillEN.con_CitationCount,
sortBy: clsvSysSkillEN.con_CitationCount,
sortFun: SortFun,
getDataSource: "",
colHeader: "引用统计",
text: "",
...
{
fldName: clsvSysSkillEN.con_VersionCount,
sortBy: clsvSysSkillEN.con_VersionCount,
sortFun: SortFun,
getDataSource: "",
colHeader: "版本统计",
text: "",
...
{
fldName: clsvSysSkillEN.con_UpdDate,
sortBy: clsvSysSkillEN.con_UpdDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改日期",
text: "",
...
{
fldName: clsvSysSkillEN.con_UpdUser,
sortBy: clsvSysSkillEN.con_UpdUser,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改人",
text: "",
...
await BindTab_V(o, arrvSysSkillObjLst, arrDataColumn,  clsvSysSkillEN.con_SkillId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvSysSkillExObjLst: Array<clsvSysSkillENEx>, arrDataColumn: Array<clsDataColumn>) {
const arrFldName = clsvSysSkillEN.AttributeName;
for (const objDataColumn of arrDataColumn) {
if (IsNullOrEmpty(objDataColumn.fldName) == true) continue;
if (arrFldName.indexOf(objDataColumn.fldName) > -1) continue;
for (const objInFor of arrvSysSkillExObjLst) {
await vSysSkillEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (SysSkillCRUD.sortvSysSkillBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvSysSkillBy)为空，请检查！(In BindGv_vSysSkill)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: SysSkillCRUD.sortvSysSkillBy,//如果该字段为空，就使用下面的排序函数
...
whereCond: strWhereCond,
orderBy: SysSkillCRUD.sortvSysSkillBy,//如果该字段为空，就使用下面的排序函数
sortFun: vSysSkill_SortFun_Defa
}
arrvSysSkillObjLst = await vSysSkill_GetObjLstByPager_Cache(objPagerPara, SysSkillCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvSysSkillEN , b:clsvSysSkillEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, SysSkillCRUD.ascOrDesc4SortFun, SysSkillCRUD.sortvSysSkillBy, strSortExpress);
 ...
 **/
public async CopyRecord(arrSkillId: Array<string>) {
const strThisFuncName = this.CopyRecord.name;
try
{
const arrSysSkillObjLst = await SysSkill_GetObjLstBySkillIdLstAsync(arrSkillId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrSysSkillObjLst)
{
const strMaxStrId = await SysSkill_GetMaxStrIdAsync();
//console.log('strMaxStrId=' + strMaxStrId);
objInFor.skillId = strMaxStrId;
const returnBool = await SysSkill_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await SysSkill_DelSysSkillsAsync(arrSkillId);
if (returnInt > 0)
{
//SysSkill_ReFreshCache(SysSkillCRUD.id_CurrEduCls_Cache);
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const sstrKeys = GetObjKeys(objSysSkill);
