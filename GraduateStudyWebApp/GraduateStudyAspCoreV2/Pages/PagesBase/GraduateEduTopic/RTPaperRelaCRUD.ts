 ...
 **/
//import $ from "jquery";
import { vRTPaperRela_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { vRTPaperRela_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { vRTPaperRela_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { vRTPaperRela_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { RTPaperRela_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
...
import { vRTPaperRelaEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvRTPaperRelaExWApi.js";
import { vRTPaperRela_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { vRTPaperRela_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { vRTPaperRela_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTPaperRelaWApi.js";
import { RTPaperRela_GetObjLstBymIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_DelRTPaperRelasAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
 ...
 **/
export abstract class RTPaperRelaCRUD implements clsOperateList
{
public static objPage_CRUD: RTPaperRelaCRUD;
public static sortFun_Static: (ascOrDesc: string) => (x: any, y: any) => number;
public static ascOrDesc4SortFun = "Asc";
public static sortvRTPaperRelaBy = "";
 ...
 **/
public CombineData(arrvRTPaperRelaObjLst: Array<clsvRTPaperRelaEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const objEN: clsvRTPaperRelaEN = arrvRTPaperRelaObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("RTPaperRela({0})导出.xlsx",
 clsvRTPaperRelaEN._CurrTabName);
 ...
 **/
public async ExportExcel_vRTPaperRela() 
{
const strThisFuncName = this.ExportExcel_vRTPaperRela.name;
if (RTPaperRelaCRUD.sortvRTPaperRelaBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvRTPaperRelaBy)为空，请检查！(In BindGv_vRTPaperRela_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
 ...
 **/
public async ExportExcel_vRTPaperRela_Cache() 
{
...
try
{
this.recCount = await vRTPaperRela_GetRecCountByCond_Cache(objvRTPaperRela_Cond);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvRTPaperRela_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvRTPaperRela_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvRTPaperRelaObjLst = await vRTPaperRela_GetSubObjLst_Cache(objvRTPaperRela_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrvRTPaperRelaObjLst.length == 0)
{
const strKey = Format("{0}", clsRTPaperRelaEN._CurrTabName);
...
try
{
const returnInt = await RTPaperRela_DelRecordAsync(lngmId);
if (returnInt > 0)
{
...
try
{
const objRTPaperRelaEN = await RTPaperRela_GetObjBymIdAsync(lngmId);
//console.log("完成SelectRecord!", objRTPaperRelaEN);
Redirect("/Index/Main_vRTPaperRela");
}
catch(e)
{
...
if ( this.topicName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTPaperRelaEN.con_TopicName, this.topicName_q);
}
if ( this.paperTitle_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTPaperRelaEN.con_PaperTitle, this.paperTitle_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineRTPaperRelaCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async CombinevRTPaperRelaConditionObj(): Promise<clsvRTPaperRelaEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTPaperRelaEN.con_TopicName, this.topicName_q);
objvRTPaperRela_Cond.SetCondFldValue(clsvRTPaperRelaEN.con_TopicName, this.topicName_q, "like");
}
if ( this.paperTitle_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTPaperRelaEN.con_PaperTitle, this.paperTitle_q);
objvRTPaperRela_Cond.SetCondFldValue(clsvRTPaperRelaEN.con_PaperTitle, this.paperTitle_q, "like");
}

}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineRTPaperRelaConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async CombinevRTPaperRelaConditionObj4ExportExcel():Promise<clsvRTPaperRelaEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
const objvRTPaperRela_Cond = new clsvRTPaperRelaENEx();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
if ( this.topicName_q != "")
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTPaperRelaConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvRTPaperRela_Cond.whereCond = strWhereCond;
return objvRTPaperRela_Cond;
...
{
fldName: clsvRTPaperRelaEN.con_TopicName,
sortBy: clsvRTPaperRelaEN.con_TopicName,
sortFun: SortFun,
getDataSource: "",
colHeader: "栏目主题",
text: "",
...
{
fldName: clsvRTPaperRelaEN.con_PaperTitle,
sortBy: clsvRTPaperRelaEN.con_PaperTitle,
sortFun: SortFun,
getDataSource: "",
colHeader: "论文标题",
text: "",
...
{
fldName: clsvRTPaperRelaEN.con_Author,
sortBy: clsvRTPaperRelaEN.con_Author,
sortFun: SortFun,
getDataSource: "",
colHeader: "作者",
text: "",
...
{
fldName: clsvRTPaperRelaEN.con_Periodical,
sortBy: clsvRTPaperRelaEN.con_Periodical,
sortFun: SortFun,
getDataSource: "",
colHeader: "期刊",
text: "",
...
{
fldName: clsvRTPaperRelaEN.con_TopicProposePeople,
sortBy: clsvRTPaperRelaEN.con_TopicProposePeople,
sortFun: SortFun,
getDataSource: "",
colHeader: "主题提出人",
text: "",
...
{
fldName: clsvRTPaperRelaEN.con_UpdDate,
sortBy: clsvRTPaperRelaEN.con_UpdDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改日期",
text: "",
...
{
fldName: clsvRTPaperRelaEN.con_UpdUser,
sortBy: clsvRTPaperRelaEN.con_UpdUser,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改人",
text: "",
...
await BindTab_V(o, arrvRTPaperRelaObjLst, arrDataColumn,  clsvRTPaperRelaEN.con_mId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvRTPaperRelaExObjLst: Array<clsvRTPaperRelaENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await vRTPaperRelaEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (RTPaperRelaCRUD.sortvRTPaperRelaBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvRTPaperRelaBy)为空，请检查！(In BindGv_vRTPaperRela)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: RTPaperRelaCRUD.sortvRTPaperRelaBy,//如果该字段为空，就使用下面的排序函数
 ...
 **/
public async BindGv_vRTPaperRela_Cache() 
{
...
whereCond: strWhereCond,
orderBy: RTPaperRelaCRUD.sortvRTPaperRelaBy,//如果该字段为空，就使用下面的排序函数
sortFun: vRTPaperRela_SortFun_Defa
}
arrvRTPaperRelaObjLst = await vRTPaperRela_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvRTPaperRelaEN , b:clsvRTPaperRelaEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, RTPaperRelaCRUD.ascOrDesc4SortFun, RTPaperRelaCRUD.sortvRTPaperRelaBy, strSortExpress);
...
try
{
const arrRTPaperRelaObjLst = await RTPaperRela_GetObjLstBymIdLstAsync(arrmId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrRTPaperRelaObjLst)
{
const returnBool = await RTPaperRela_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await RTPaperRela_DelRTPaperRelasAsync(arrmId);
if (returnInt > 0)
{
//RTPaperRela_ReFreshCache();
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const sstrKeys = GetObjKeys(objRTPaperRela);
