 ...
 **/
//import $ from "jquery";
import { vTopicObjective_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { vTopicObjective_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { vTopicObjective_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { vTopicObjective_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { TopicObjective_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js";
...
import { clsvTopicObjectiveENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsvTopicObjectiveENEx.js";
import { vTopicObjectiveEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvTopicObjectiveExWApi.js";
import { vTopicObjective_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { vTopicObjective_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { vTopicObjective_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js";
import { TopicObjective_GetObjLstByTopicObjectiveIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js";
import { TopicObjective_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js";
import { TopicObjective_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js";
import { TopicObjective_DelTopicObjectivesAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js";
...
public static sortvTopicObjectiveBy = "";
...
const objEN: clsvTopicObjectiveEN = arrvTopicObjectiveObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("主题客观表({0})导出.xlsx",
...
{
const strMsg = Format("在显示列表时，排序字段(sortvTopicObjectiveBy)为空，请检查！(In BindGv_vTopicObjective_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrvTopicObjectiveObjLst = await vTopicObjective_GetObjLstAsync(strWhereCond);
}
catch(e)
{
...
objvTopicObjective_Cond.SetCondFldValue(clsvTopicObjectiveEN.con_id_CurrEduCls, TopicObjectiveCRUD.id_CurrEduCls_Cache, "=");
const strWhereCond = JSON.stringify(objvTopicObjective_Cond);
const intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
 let arrvTopicObjectiveObjLst: Array <clsvTopicObjectiveEN> = [];
try
{
this.recCount = await vTopicObjective_GetRecCountByCond_Cache(objvTopicObjective_Cond, TopicObjectiveCRUD.id_CurrEduCls_Cache);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvTopicObjective_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvTopicObjective_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvTopicObjectiveObjLst = await vTopicObjective_GetSubObjLst_Cache(objvTopicObjective_Cond, TopicObjectiveCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrvTopicObjectiveObjLst.length == 0)
{
const strKey = Format("{0}_{1}", clsTopicObjectiveEN._CurrTabName, TopicObjectiveCRUD.id_CurrEduCls_Cache);
 ...
 **/
public async btnSelectRecordInTab_Click(strTopicObjectiveId: string) {
...
try
{
const returnInt = await TopicObjective_DelRecordAsync(strTopicObjectiveId);
if (returnInt > 0)
{
...
try
{
const objTopicObjectiveEN = await TopicObjective_GetObjByTopicObjectiveIdAsync(strTopicObjectiveId);
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvTopicObjectiveEN.con_ObjectiveName, this.objectiveName_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineTopicObjectiveCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineTopicObjectiveConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async CombinevTopicObjectiveConditionObj4ExportExcel():Promise<clsvTopicObjectiveEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineTopicObjectiveConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvTopicObjective_Cond.whereCond = strWhereCond;
return objvTopicObjective_Cond;
...
{
fldName: clsvTopicObjectiveEN.con_PaperTitle,
sortBy: clsvTopicObjectiveEN.con_PaperTitle,
sortFun: SortFun,
getDataSource: "",
colHeader: "论文标题",
text: "",
...
{
fldName: clsvTopicObjectiveEN.con_ObjectiveName,
sortBy: clsvTopicObjectiveEN.con_ObjectiveName,
sortFun: SortFun,
getDataSource: "",
colHeader: "客观名称",
text: "",
...
{
fldName: clsvTopicObjectiveEN.con_ObjectiveType,
sortBy: clsvTopicObjectiveEN.con_ObjectiveType,
sortFun: SortFun,
getDataSource: "",
colHeader: "客观类型",
text: "",
...
{
fldName: clsvTopicObjectiveEN.con_ObjectiveTypeName,
sortBy: clsvTopicObjectiveEN.con_ObjectiveTypeName,
sortFun: SortFun,
getDataSource: "",
colHeader: "ObjectiveTypeName",
text: "",
...
{
fldName: clsvTopicObjectiveEN.con_IsSubmit,
sortBy: clsvTopicObjectiveEN.con_IsSubmit,
sortFun: SortFun,
getDataSource: "",
colHeader: "是否提交",
text: "",
...
{
fldName: clsvTopicObjectiveEN.con_UpdDate,
sortBy: clsvTopicObjectiveEN.con_UpdDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改日期",
text: "",
...
await BindTab_V(o, arrvTopicObjectiveObjLst, arrDataColumn,  clsvTopicObjectiveEN.con_TopicObjectiveId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvTopicObjectiveExObjLst: Array<clsvTopicObjectiveENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await vTopicObjectiveEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (TopicObjectiveCRUD.sortvTopicObjectiveBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvTopicObjectiveBy)为空，请检查！(In BindGv_vTopicObjective)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: TopicObjectiveCRUD.sortvTopicObjectiveBy,//如果该字段为空，就使用下面的排序函数
...
arrvTopicObjectiveObjLst = await vTopicObjective_GetObjLstByPager_Cache(objPagerPara, TopicObjectiveCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, TopicObjectiveCRUD.ascOrDesc4SortFun, TopicObjectiveCRUD.sortvTopicObjectiveBy, strSortExpress);
...
try
{
const arrTopicObjectiveObjLst = await TopicObjective_GetObjLstByTopicObjectiveIdLstAsync(arrTopicObjectiveId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrTopicObjectiveObjLst)
{
const strMaxStrId = await TopicObjective_GetMaxStrIdAsync();
//console.log('strMaxStrId=' + strMaxStrId);
objInFor.topicObjectiveId = strMaxStrId;
const returnBool = await TopicObjective_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await TopicObjective_DelTopicObjectivesAsync(arrTopicObjectiveId);
if (returnInt > 0)
{
//TopicObjective_ReFreshCache(TopicObjectiveCRUD.id_CurrEduCls_Cache);
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
