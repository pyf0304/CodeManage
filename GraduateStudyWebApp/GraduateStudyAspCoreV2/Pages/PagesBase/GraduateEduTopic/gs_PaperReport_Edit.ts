...
import { gs_PaperReport_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_GetUniCondStr_TopicId_ReportUser_ReportDate } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_GetUniCondStr4Update_TopicId_ReportUser_ReportDate } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { clsgs_PaperReportEN } from "../../TS/L0_Entity/GraduateEduTopic/clsgs_PaperReportEN.js";
import { gs_PaperReport_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_GetObjByReportIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
import { gs_PaperReport_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_PaperReportWApi.js";
...
public objgs_PaperReport: clsgs_PaperReportEN;
...
this.objgs_PaperReport = new clsgs_PaperReportEN();
}
 ...
 **/
public ShowDialog_gs_PaperReport(strOp:string) {
const strThisFuncName = this.ShowDialog_gs_PaperReport.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_gs_PaperReport");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_gs_PaperReport");
 ...
 **/
public HideDialog_gs_PaperReport() {
...
if (gs_PaperReport_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
...
const strCommandText: string = this.btnSubmit_gs_PaperReport;
try {
...
this.iShowList.BindGv(clsgs_PaperReportEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsgs_PaperReportEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
try
{
const returnString = await gs_PaperReport_GetMaxStrIdAsync();
if (returnString == "")
{
const strInfo = Format("获取表gs_PaperReport的最大关键字为空，不成功，请检查!");
//显示信息框
alert(strInfo);
}
else
...
const objgs_PaperReportEN = new clsgs_PaperReportEN();
try
{
...
try
{
gs_PaperReport_CheckPropertyNew(objgs_PaperReportEN);
}
catch(e)
{
...
let returnBool = false;
const returnKeyId = await gs_PaperReport_AddNewRecordWithMaxIdAsync(objgs_PaperReportEN);
if (IsNullOrEmpty(returnKeyId) == false)
{
returnBool = true;
}
 ...
 **/
public async CheckUniCond4Add_TopicId_ReportUser_ReportDate(objgs_PaperReportEN: clsgs_PaperReportEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_TopicId_ReportUser_ReportDate.name;
const strUniquenessCondition = gs_PaperReport_GetUniCondStr_TopicId_ReportUser_ReportDate(objgs_PaperReportEN);
const bolIsExistCondition = await gs_PaperReport_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_TopicId_ReportUser_ReportDate(objgs_PaperReportEN: clsgs_PaperReportEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_TopicId_ReportUser_ReportDate.name;
const strUniquenessCondition = gs_PaperReport_GetUniCondStr4Update_TopicId_ReportUser_ReportDate(objgs_PaperReportEN);
const bolIsExistCondition = await gs_PaperReport_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
const strThisFuncName = this.ShowData.name;
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objgs_PaperReportEN = new clsgs_PaperReportEN();
        try {
            const returnBool = await gs_PaperReport_IsExistAsync(strReportId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", strReportId);
...
console.error(strMsg);
        ...
        try {
const objgs_PaperReportEN_Const = await gs_PaperReport_GetObjByReportIdAsync(strReportId);
 ...
 **/
public async UpdateRecord(strReportId: string):Promise<boolean> 
{
...
try
{
gs_PaperReport_CheckProperty4Update(objgs_PaperReportEN);
}
catch(e)
{
const strMsg = Format("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const returnBool = await gs_PaperReport_UpdateRecordAsync(objgs_PaperReportEN);
if (returnBool == true)
{
gs_PaperReport_ReFreshCache();
}
...
public  set btnCancel_gs_PaperReport(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_gs_PaperReport", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_gs_PaperReport():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_gs_PaperReport");
return strValue;
}
 /**
...
public  set btnSubmit_gs_PaperReport(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_gs_PaperReport", value);
}
 /**
 * 备注 (Used In Clear())
 **/
...
public  set pdFUrl(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtPDFUrl", value);
}
 /**
 * PDFUrl (Used In PutDataToClass())
 **/
public  get pdFUrl():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtPDFUrl");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set ppTUrl(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtPPTUrl", value);
}
 /**
 * PPTUrl (Used In PutDataToClass())
 **/
public  get ppTUrl():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtPPTUrl");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set reportContent(value: string) {
 SetTextAreaValueByIdInDiv(this.divName4Edit, "txtReportContent", value);
}
 /**
 * 汇报内容 (Used In PutDataToClass())
 **/
public  get reportContent():string {
const strValue = GetTextAreaValueInDiv(this.divName4Edit, "txtReportContent");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set reportDate(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtReportDate", value);
}
 /**
 * 汇报日期 (Used In PutDataToClass())
 **/
public  get reportDate():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtReportDate");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set reportId(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtReportId", value);
}
 /**
 * 汇报Id (Used In PutDataToClass())
 **/
public  get reportId():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtReportId");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set reportUser(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtReportUser", value);
}
 /**
 * 汇报用户 (Used In PutDataToClass())
 **/
public  get reportUser():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtReportUser");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
