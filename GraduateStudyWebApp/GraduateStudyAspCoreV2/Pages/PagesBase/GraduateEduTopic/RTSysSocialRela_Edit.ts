...
public static objPage_Edit: RTSysSocialRela_Edit;
...
this.iShowList.BindGv(clsRTSysSocialRelaEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
console.error(strMsg);
        ...
        try {
const objRTSysSocialRelaEN_Const = await RTSysSocialRela_GetObjBymIdAsync(lngmId);
