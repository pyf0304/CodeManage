 ...
 **/
//import $ from "jquery";
import { gs_TopicRole_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetObjByTopicRoleIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { clsgs_TopicRoleENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsgs_TopicRoleENEx.js";
import { gs_TopicRoleEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsgs_TopicRoleExWApi.js";
import { gs_TopicRole_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetObjLstByTopicRoleIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
import { gs_TopicRole_Delgs_TopicRolesAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TopicRoleWApi.js";
 ...
 **/
export abstract class gs_TopicRoleCRUD implements clsOperateList
{
public static objPage_CRUD: gs_TopicRoleCRUD;
public static sortFun_Static: (ascOrDesc: string) => (x: any, y: any) => number;
public static ascOrDesc4SortFun = "Asc";
public static sortgs_TopicRoleBy = "";
 ...
 **/
public CombineData(arrgs_TopicRoleObjLst: Array<clsgs_TopicRoleEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const objEN: clsgs_TopicRoleEN = arrgs_TopicRoleObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("主题权限表({0})导出.xlsx",
 clsgs_TopicRoleEN._CurrTabName);
 ...
 **/
public async ExportExcel_gs_TopicRole() 
{
const strThisFuncName = this.ExportExcel_gs_TopicRole.name;
if (gs_TopicRoleCRUD.sortgs_TopicRoleBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortgs_TopicRoleBy)为空，请检查！(In BindGv_gs_TopicRole_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
try
{
this.recCount = await gs_TopicRole_GetRecCountByCondAsync(strWhereCond);
if (this.recCount == 0)
{
...
arrgs_TopicRoleObjLst = await gs_TopicRole_GetObjLstAsync(strWhereCond);
}
catch(e)
{
 ...
 **/
public async ExportExcel_gs_TopicRole_Cache() 
{
...
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objgs_TopicRole_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objgs_TopicRole_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrgs_TopicRoleObjLst = await gs_TopicRole_GetSubObjLst_Cache(objgs_TopicRole_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrgs_TopicRoleObjLst.length == 0)
{
const strKey = Format("{0}", clsgs_TopicRoleEN._CurrTabName);
 ...
 **/
public async btnSelectRecordInTab_Click(strTopicRoleId: string) {
...
try
{
const returnInt = await gs_TopicRole_DelRecordAsync(strTopicRoleId);
if (returnInt > 0)
{
...
Redirect("/Index/Main_gs_TopicRole");
}
catch(e)
{
 ...
 **/
 public async Combinegs_TopicRoleCondition():Promise<string> 
{
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async Combinegs_TopicRoleConditionObj(): Promise<clsgs_TopicRoleEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
const strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async Combinegs_TopicRoleConditionObj4ExportExcel():Promise<clsgs_TopicRoleEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
const strWhereCond = " 1 = 1 ";
 ...
 **/
public async BindTab_gs_TopicRole(divContainer: string, arrgs_TopicRoleObjLst: Array<clsgs_TopicRoleEN>) 
{
...
{
fldName: clsgs_TopicRoleEN.con_TopicRoleId,
sortBy: clsgs_TopicRoleEN.con_TopicRoleId,
sortFun: SortFun,
getDataSource: "",
colHeader: "主题权限Id",
text: "",
...
{
fldName: clsgs_TopicRoleEN.con_MenuNum,
sortBy: clsgs_TopicRoleEN.con_MenuNum,
sortFun: SortFun,
getDataSource: "",
colHeader: "菜单编号",
text: "",
...
{
fldName: clsgs_TopicRoleEN.con_MenuName,
sortBy: clsgs_TopicRoleEN.con_MenuName,
sortFun: SortFun,
getDataSource: "",
colHeader: "菜单名称",
text: "",
...
{
fldName: clsgs_TopicRoleEN.con_MenuIsHide,
sortBy: clsgs_TopicRoleEN.con_MenuIsHide,
sortFun: SortFun,
getDataSource: "",
colHeader: "菜单是否隐藏",
text: "",
...
await BindTab(o, arrgs_TopicRoleObjLst, arrDataColumn,  clsgs_TopicRoleEN.con_TopicRoleId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrgs_TopicRoleExObjLst: Array<clsgs_TopicRoleENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await gs_TopicRoleEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (gs_TopicRoleCRUD.sortgs_TopicRoleBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortgs_TopicRoleBy)为空，请检查！(In BindGv_gs_TopicRole)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: gs_TopicRoleCRUD.sortgs_TopicRoleBy,//如果该字段为空，就使用下面的排序函数
...
arrgs_TopicRoleObjLst = await gs_TopicRole_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsgs_TopicRoleEN , b:clsgs_TopicRoleEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, gs_TopicRoleCRUD.ascOrDesc4SortFun, gs_TopicRoleCRUD.sortgs_TopicRoleBy, strSortExpress);
...
try
{
const arrgs_TopicRoleObjLst = await gs_TopicRole_GetObjLstByTopicRoleIdLstAsync(arrTopicRoleId);
...
const returnBool = await gs_TopicRole_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await gs_TopicRole_Delgs_TopicRolesAsync(arrTopicRoleId);
if (returnInt > 0)
{
//gs_TopicRole_ReFreshCache();
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const sstrKeys = GetObjKeys(objgs_TopicRole);
