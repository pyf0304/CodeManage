 ...
 **/
//import $ from "jquery";
import { gs_ReflectLog_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
...
import { clsgs_ReflectLogENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsgs_ReflectLogENEx.js";
import { gs_ReflectLogEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsgs_ReflectLogExWApi.js";
import { gs_ReflectLog_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_GetObjLstBymIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
import { gs_ReflectLog_Delgs_ReflectLogsAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js";
...
const strFileName = Format("反思日志({0})导出.xlsx",
...
{
const strMsg = Format("在显示列表时，排序字段(sortgs_ReflectLogBy)为空，请检查！(In BindGv_gs_ReflectLog_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrgs_ReflectLogObjLst = await gs_ReflectLog_GetObjLstAsync(strWhereCond);
}
catch(e)
{
...
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objgs_ReflectLog_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objgs_ReflectLog_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrgs_ReflectLogObjLst = await gs_ReflectLog_GetSubObjLst_Cache(objgs_ReflectLog_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsgs_ReflectLogEN.con_ReflectLogName, this.reflectLogName_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(Combinegs_ReflectLogCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(Combinegs_ReflectLogConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
const objgs_ReflectLog_Cond = new clsgs_ReflectLogENEx();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
if ( this.reflectLogName_q != "")
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(Combinegs_ReflectLogConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objgs_ReflectLog_Cond.whereCond = strWhereCond;
return objgs_ReflectLog_Cond;
 ...
 **/
public async BindTab_gs_ReflectLog(divContainer: string, arrgs_ReflectLogObjLst: Array<clsgs_ReflectLogEN>) 
{
...
{
fldName: clsgs_ReflectLogEN.con_UpdDate,
sortBy: clsgs_ReflectLogEN.con_UpdDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改日期",
text: "",
...
await BindTab(o, arrgs_ReflectLogObjLst, arrDataColumn,  clsgs_ReflectLogEN.con_mId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrgs_ReflectLogExObjLst: Array<clsgs_ReflectLogENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (gs_ReflectLogCRUD.sortgs_ReflectLogBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortgs_ReflectLogBy)为空，请检查！(In BindGv_gs_ReflectLog)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: gs_ReflectLogCRUD.sortgs_ReflectLogBy,//如果该字段为空，就使用下面的排序函数
...
arrgs_ReflectLogObjLst = await gs_ReflectLog_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, gs_ReflectLogCRUD.ascOrDesc4SortFun, gs_ReflectLogCRUD.sortgs_ReflectLogBy, strSortExpress);
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtReflectLogName_q");
...
public  set reflectLogName_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtReflectLogName_q", value);
}
 /**
