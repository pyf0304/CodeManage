 ...
 **/
//import $ from "jquery";
import { vRTConceptRela_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTConceptRelaWApi.js";
import { vRTConceptRela_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTConceptRelaWApi.js";
import { RTConceptRela_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js";
...
import { clsvRTConceptRelaENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsvRTConceptRelaENEx.js";
import { vRTConceptRelaEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvRTConceptRelaExWApi.js";
import { vRTConceptRela_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTConceptRelaWApi.js";
import { RTConceptRela_GetObjLstBymIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js";
import { RTConceptRela_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js";
import { RTConceptRela_DelRTConceptRelasAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js";
 ...
 **/
export abstract class RTConceptRelaCRUD implements clsOperateList
{
public static objPage_CRUD: RTConceptRelaCRUD;
public static sortFun_Static: (ascOrDesc: string) => (x: any, y: any) => number;
public static ascOrDesc4SortFun = "Asc";
public static sortvRTConceptRelaBy = "";
 ...
 **/
public CombineData(arrvRTConceptRelaObjLst: Array<clsvRTConceptRelaEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const objEN: clsvRTConceptRelaEN = arrvRTConceptRelaObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("主题概念关系表({0})导出.xlsx",
 clsvRTConceptRelaEN._CurrTabName);
 ...
 **/
public async ExportExcel_vRTConceptRela() 
{
const strThisFuncName = this.ExportExcel_vRTConceptRela.name;
if (RTConceptRelaCRUD.sortvRTConceptRelaBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvRTConceptRelaBy)为空，请检查！(In BindGv_vRTConceptRela_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrvRTConceptRelaObjLst = await vRTConceptRela_GetObjLstAsync(strWhereCond);
}
catch(e)
{
...
try
{
const returnInt = await RTConceptRela_DelRecordAsync(lngmId);
if (returnInt > 0)
{
...
Redirect("/Index/Main_vRTConceptRela");
}
catch(e)
{
...
if ( this.topicName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTConceptRelaEN.con_TopicName, this.topicName_q);
}
if ( this.conceptName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTConceptRelaEN.con_ConceptName, this.conceptName_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineRTConceptRelaCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async CombinevRTConceptRelaConditionObj(): Promise<clsvRTConceptRelaEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineRTConceptRelaConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async CombinevRTConceptRelaConditionObj4ExportExcel():Promise<clsvRTConceptRelaEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTConceptRelaConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvRTConceptRela_Cond.whereCond = strWhereCond;
return objvRTConceptRela_Cond;
...
{
fldName: clsvRTConceptRelaEN.con_TopicName,
sortBy: clsvRTConceptRelaEN.con_TopicName,
sortFun: SortFun,
getDataSource: "",
colHeader: "栏目主题",
text: "",
...
{
fldName: clsvRTConceptRelaEN.con_TopicContent,
sortBy: clsvRTConceptRelaEN.con_TopicContent,
sortFun: SortFun,
getDataSource: "",
colHeader: "主题内容",
text: "",
...
{
fldName: clsvRTConceptRelaEN.con_ConceptName,
sortBy: clsvRTConceptRelaEN.con_ConceptName,
sortFun: SortFun,
getDataSource: "",
colHeader: "概念名称",
text: "",
...
{
fldName: clsvRTConceptRelaEN.con_ConceptContent,
sortBy: clsvRTConceptRelaEN.con_ConceptContent,
sortFun: SortFun,
getDataSource: "",
colHeader: "概念内容",
text: "",
...
{
fldName: clsvRTConceptRelaEN.con_UpdDate,
sortBy: clsvRTConceptRelaEN.con_UpdDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改日期",
text: "",
...
await BindTab_V(o, arrvRTConceptRelaObjLst, arrDataColumn,  clsvRTConceptRelaEN.con_mId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvRTConceptRelaExObjLst: Array<clsvRTConceptRelaENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await vRTConceptRelaEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (RTConceptRelaCRUD.sortvRTConceptRelaBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvRTConceptRelaBy)为空，请检查！(In BindGv_vRTConceptRela)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: RTConceptRelaCRUD.sortvRTConceptRelaBy,//如果该字段为空，就使用下面的排序函数
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvRTConceptRelaEN , b:clsvRTConceptRelaEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, RTConceptRelaCRUD.ascOrDesc4SortFun, RTConceptRelaCRUD.sortvRTConceptRelaBy, strSortExpress);
...
try
{
const arrRTConceptRelaObjLst = await RTConceptRela_GetObjLstBymIdLstAsync(arrmId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrRTConceptRelaObjLst)
{
const returnBool = await RTConceptRela_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await RTConceptRela_DelRTConceptRelasAsync(arrmId);
if (returnInt > 0)
{
//RTConceptRela_ReFreshCache();
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const sstrKeys = GetObjKeys(objRTConceptRela);
