 ...
 **/
//import $ from "jquery";
import { vgs_ResearchPlan_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { vgs_ResearchPlan_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { vgs_ResearchPlan_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { vgs_ResearchPlan_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { gs_TopicTaskStatus_BindDdl_StatusIdInDiv_Cache } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_ResearchPlan_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchPlanWApi.js";
import { gs_ResearchPlan_GetObjByPlanIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchPlanWApi.js";
import { clsvgs_ResearchPlanEN } from "../../TS/L0_Entity/GraduateEduTopic/clsvgs_ResearchPlanEN.js";
import { clsvgs_ResearchPlanENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsvgs_ResearchPlanENEx.js";
import { vgs_ResearchPlanEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvgs_ResearchPlanExWApi.js";
import { vgs_ResearchPlan_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { vgs_ResearchPlan_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { vgs_ResearchPlan_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvgs_ResearchPlanWApi.js";
import { gs_ResearchPlan_GetObjLstByPlanIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchPlanWApi.js";
import { gs_ResearchPlan_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchPlanWApi.js";
import { gs_ResearchPlan_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchPlanWApi.js";
import { gs_ResearchPlan_Delgs_ResearchPlansAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ResearchPlanWApi.js";
 ...
 **/
export abstract class gs_ResearchPlanCRUD implements clsOperateList
{
public static objPage_CRUD: gs_ResearchPlanCRUD;
public static sortFun_Static: (ascOrDesc: string) => (x: any, y: any) => number;
public static ascOrDesc4SortFun = "Asc";
public static sortvgs_ResearchPlanBy = "";
 ...
 **/
public CombineData(arrvgs_ResearchPlanObjLst: Array<clsvgs_ResearchPlanEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const objEN: clsvgs_ResearchPlanEN = arrvgs_ResearchPlanObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("主题研究计划({0})导出.xlsx",
 clsvgs_ResearchPlanEN._CurrTabName);
 ...
 **/
public async ExportExcel_vgs_ResearchPlan() 
{
const strThisFuncName = this.ExportExcel_vgs_ResearchPlan.name;
if (gs_ResearchPlanCRUD.sortvgs_ResearchPlanBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvgs_ResearchPlanBy)为空，请检查！(In BindGv_vgs_ResearchPlan_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrvgs_ResearchPlanObjLst = await vgs_ResearchPlan_GetObjLstAsync(strWhereCond);
}
catch(e)
{
 ...
 **/
public async ExportExcel_vgs_ResearchPlan_Cache() 
{
...
objvgs_ResearchPlan_Cond.SetCondFldValue(clsvgs_ResearchPlanEN.con_id_CurrEduCls, gs_ResearchPlanCRUD.id_CurrEduCls_Cache, "=");
const strWhereCond = JSON.stringify(objvgs_ResearchPlan_Cond);
const intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
 let arrvgs_ResearchPlanObjLst: Array <clsvgs_ResearchPlanEN> = [];
try
{
this.recCount = await vgs_ResearchPlan_GetRecCountByCond_Cache(objvgs_ResearchPlan_Cond, gs_ResearchPlanCRUD.id_CurrEduCls_Cache);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvgs_ResearchPlan_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvgs_ResearchPlan_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvgs_ResearchPlanObjLst = await vgs_ResearchPlan_GetSubObjLst_Cache(objvgs_ResearchPlan_Cond, gs_ResearchPlanCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrvgs_ResearchPlanObjLst.length == 0)
{
const strKey = Format("{0}_{1}", clsgs_ResearchPlanEN._CurrTabName, gs_ResearchPlanCRUD.id_CurrEduCls_Cache);
...
{
await gs_TopicTaskStatus_BindDdl_StatusIdInDiv_Cache(this.divName4Query, "ddlStatusId_q" );//
}
 ...
 **/
public async btnSelectRecordInTab_Click(strPlanId: string) {
...
try
{
const returnInt = await gs_ResearchPlan_DelRecordAsync(strPlanId);
if (returnInt > 0)
{
...
if ( this.topicName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvgs_ResearchPlanEN.con_TopicName, this.topicName_q);
}
if ( this.statusId_q != "" && this.statusId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsvgs_ResearchPlanEN.con_StatusId, this.statusId_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(Combinegs_ResearchPlanCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(Combinegs_ResearchPlanConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async Combinevgs_ResearchPlanConditionObj4ExportExcel():Promise<clsvgs_ResearchPlanEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(Combinegs_ResearchPlanConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvgs_ResearchPlan_Cond.whereCond = strWhereCond;
return objvgs_ResearchPlan_Cond;
...
{
fldName: clsvgs_ResearchPlanEN.con_TopicName,
sortBy: clsvgs_ResearchPlanEN.con_TopicName,
sortFun: SortFun,
getDataSource: "",
colHeader: "栏目主题",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_StatusName,
sortBy: clsvgs_ResearchPlanEN.con_StatusName,
sortFun: SortFun,
getDataSource: "",
colHeader: "状态名称",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_PlanContent,
sortBy: clsvgs_ResearchPlanEN.con_PlanContent,
sortFun: SortFun,
getDataSource: "",
colHeader: "计划内容",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_ResponsibleUser,
sortBy: clsvgs_ResearchPlanEN.con_ResponsibleUser,
sortFun: SortFun,
getDataSource: "",
colHeader: "负责人/小组",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_StartDate,
sortBy: clsvgs_ResearchPlanEN.con_StartDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "开始日期",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_EndDate,
sortBy: clsvgs_ResearchPlanEN.con_EndDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "截止日期",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_ActualFinishingDate,
sortBy: clsvgs_ResearchPlanEN.con_ActualFinishingDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "实际完成日期",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_AcceptanceUser,
sortBy: clsvgs_ResearchPlanEN.con_AcceptanceUser,
sortFun: SortFun,
getDataSource: "",
colHeader: "验收用户",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_IsSubmit,
sortBy: clsvgs_ResearchPlanEN.con_IsSubmit,
sortFun: SortFun,
getDataSource: "",
colHeader: "是否提交",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_UpdUser,
sortBy: clsvgs_ResearchPlanEN.con_UpdUser,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改人",
text: "",
...
{
fldName: clsvgs_ResearchPlanEN.con_UpdDate,
sortBy: clsvgs_ResearchPlanEN.con_UpdDate,
sortFun: SortFun,
getDataSource: "",
colHeader: "修改日期",
text: "",
...
await BindTab_V(o, arrvgs_ResearchPlanObjLst, arrDataColumn,  clsvgs_ResearchPlanEN.con_PlanId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvgs_ResearchPlanExObjLst: Array<clsvgs_ResearchPlanENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await vgs_ResearchPlanEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (gs_ResearchPlanCRUD.sortvgs_ResearchPlanBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvgs_ResearchPlanBy)为空，请检查！(In BindGv_vgs_ResearchPlan)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: gs_ResearchPlanCRUD.sortvgs_ResearchPlanBy,//如果该字段为空，就使用下面的排序函数
...
whereCond: strWhereCond,
orderBy: gs_ResearchPlanCRUD.sortvgs_ResearchPlanBy,//如果该字段为空，就使用下面的排序函数
sortFun: vgs_ResearchPlan_SortFun_Defa
}
arrvgs_ResearchPlanObjLst = await vgs_ResearchPlan_GetObjLstByPager_Cache(objPagerPara, gs_ResearchPlanCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvgs_ResearchPlanEN , b:clsvgs_ResearchPlanEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, gs_ResearchPlanCRUD.ascOrDesc4SortFun, gs_ResearchPlanCRUD.sortvgs_ResearchPlanBy, strSortExpress);
 ...
 **/
public async CopyRecord(arrPlanId: Array<string>) {
const strThisFuncName = this.CopyRecord.name;
try
{
const arrgs_ResearchPlanObjLst = await gs_ResearchPlan_GetObjLstByPlanIdLstAsync(arrPlanId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrgs_ResearchPlanObjLst)
{
const strMaxStrId = await gs_ResearchPlan_GetMaxStrIdAsync();
//console.log('strMaxStrId=' + strMaxStrId);
objInFor.planId = strMaxStrId;
const returnBool = await gs_ResearchPlan_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await gs_ResearchPlan_Delgs_ResearchPlansAsync(arrPlanId);
if (returnInt > 0)
{
//gs_ResearchPlan_ReFreshCache(gs_ResearchPlanCRUD.id_CurrEduCls_Cache);
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const strValue = GetSelectValueInDiv(this.divName4Query, "ddlStatusId_q");
 ...
 * 状态Id (Used In CombineCondition())
 **/
public  set statusId_q(value: string) {
SetSelectValueByIdInDiv(this.divName4Query, "ddlStatusId_q", value);
}
 /**
