 ...
 **/
//import $ from "jquery";
import { vRTSysSocialRela_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { vRTSysSocialRela_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { vRTSysSocialRela_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { vRTSysSocialRela_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { RTSysSocialRela_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_GetObjBymIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { clsvRTSysSocialRelaEN } from "../../TS/L0_Entity/GraduateEduTopic/clsvRTSysSocialRelaEN.js";
import { clsvRTSysSocialRelaENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsvRTSysSocialRelaENEx.js";
import { vRTSysSocialRelaEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvRTSysSocialRelaExWApi.js";
import { vRTSysSocialRela_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { vRTSysSocialRela_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { vRTSysSocialRela_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTSysSocialRelaWApi.js";
import { RTSysSocialRela_GetObjLstBymIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
import { RTSysSocialRela_DelRTSysSocialRelasAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTSysSocialRelaWApi.js";
...
const strFileName = Format("RTSysSocialRela({0})导出.xlsx",
...
{
const strMsg = Format("在显示列表时，排序字段(sortvRTSysSocialRelaBy)为空，请检查！(In BindGv_vRTSysSocialRela_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrvRTSysSocialRelaObjLst = await vRTSysSocialRela_GetObjLstAsync(strWhereCond);
}
catch(e)
{
...
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvRTSysSocialRela_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvRTSysSocialRela_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvRTSysSocialRelaObjLst = await vRTSysSocialRela_GetSubObjLst_Cache(objvRTSysSocialRela_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
try
{
const returnInt = await RTSysSocialRela_DelRecordAsync(lngmId);
if (returnInt > 0)
{
...
if ( this.fullName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTSysSocialRelaEN.con_FullName, this.fullName_q);
}
if ( this.nationality_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvRTSysSocialRelaEN.con_Nationality, this.nationality_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineRTSysSocialRelaCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineRTSysSocialRelaConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
const objvRTSysSocialRela_Cond = new clsvRTSysSocialRelaENEx();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
if ( this.fullName_q != "")
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTSysSocialRelaConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvRTSysSocialRela_Cond.whereCond = strWhereCond;
return objvRTSysSocialRela_Cond;
 ...
 **/
public async BindTab_vRTSysSocialRela(divContainer: string, arrvRTSysSocialRelaObjLst: Array<clsvRTSysSocialRelaEN>) 
{
...
await BindTab_V(o, arrvRTSysSocialRelaObjLst, arrDataColumn,  clsvRTSysSocialRelaEN.con_mId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvRTSysSocialRelaExObjLst: Array<clsvRTSysSocialRelaENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (RTSysSocialRelaCRUD.sortvRTSysSocialRelaBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvRTSysSocialRelaBy)为空，请检查！(In BindGv_vRTSysSocialRela)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: RTSysSocialRelaCRUD.sortvRTSysSocialRelaBy,//如果该字段为空，就使用下面的排序函数
...
arrvRTSysSocialRelaObjLst = await vRTSysSocialRela_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, RTSysSocialRelaCRUD.ascOrDesc4SortFun, RTSysSocialRelaCRUD.sortvRTSysSocialRelaBy, strSortExpress);
...
try
{
const arrRTSysSocialRelaObjLst = await RTSysSocialRela_GetObjLstBymIdLstAsync(arrmId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrRTSysSocialRelaObjLst)
{
const returnBool = await RTSysSocialRela_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await RTSysSocialRela_DelRTSysSocialRelasAsync(arrmId);
if (returnInt > 0)
{
//RTSysSocialRela_ReFreshCache();
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtNationality_q");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set nationality_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtNationality_q", value);
}
 /**
