 ...
 **/
//import $ from "jquery";
import { ResearchTopic_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetObjByTopicIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { clsResearchTopicEN } from "../../TS/L0_Entity/GraduateEduTopic/clsResearchTopicEN.js";
import { clsResearchTopicENEx } from "../../TS/L0_Entity/GraduateEduTopic/clsResearchTopicENEx.js";
import { ResearchTopicEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTopic/clsResearchTopicExWApi.js";
import { ResearchTopic_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetObjLstByTopicIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
import { ResearchTopic_DelResearchTopicsAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js";
...
{
public static objPage_CRUD: ResearchTopicCRUD;
 ...
 **/
public CombineData(arrResearchTopicObjLst: Array<clsResearchTopicEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const strFileName = Format("研究主题({0})导出.xlsx",
 ...
 **/
public async ExportExcel_ResearchTopic() 
{
const strThisFuncName = this.ExportExcel_ResearchTopic.name;
if (ResearchTopicCRUD.sortResearchTopicBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortResearchTopicBy)为空，请检查！(In BindGv_ResearchTopic_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
 ...
 **/
public async ExportExcel_ResearchTopic_Cache() 
{
...
objResearchTopic_Cond.SetCondFldValue(clsResearchTopicEN.con_id_CurrEduCls, ResearchTopicCRUD.id_CurrEduCls_Cache, "=");
const strWhereCond = JSON.stringify(objResearchTopic_Cond);
const intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
 let arrResearchTopicObjLst: Array <clsResearchTopicEN> = [];
try
{
this.recCount = await ResearchTopic_GetRecCountByCond_Cache(objResearchTopic_Cond, ResearchTopicCRUD.id_CurrEduCls_Cache);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objResearchTopic_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objResearchTopic_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrResearchTopicObjLst = await ResearchTopic_GetSubObjLst_Cache(objResearchTopic_Cond, ResearchTopicCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrResearchTopicObjLst.length == 0)
{
const strKey = Format("{0}_{1}", clsResearchTopicEN._CurrTabName, ResearchTopicCRUD.id_CurrEduCls_Cache);
...
if ( this.topicName_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsResearchTopicEN.con_TopicName, this.topicName_q);
}
if ( this.topicContent_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsResearchTopicEN.con_TopicContent, this.topicContent_q);
}
if ( this.topicProposePeople_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsResearchTopicEN.con_TopicProposePeople, this.topicProposePeople_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineResearchTopicCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsResearchTopicEN.con_TopicName, this.topicName_q);
objResearchTopic_Cond.SetCondFldValue(clsResearchTopicEN.con_TopicName, this.topicName_q, "like");
}
if ( this.topicContent_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsResearchTopicEN.con_TopicContent, this.topicContent_q);
objResearchTopic_Cond.SetCondFldValue(clsResearchTopicEN.con_TopicContent, this.topicContent_q, "like");
}
if ( this.topicProposePeople_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsResearchTopicEN.con_TopicProposePeople, this.topicProposePeople_q);
objResearchTopic_Cond.SetCondFldValue(clsResearchTopicEN.con_TopicProposePeople, this.topicProposePeople_q, "like");
}

}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineResearchTopicConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineResearchTopicConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objResearchTopic_Cond.whereCond = strWhereCond;
return objResearchTopic_Cond;
...
await BindTab(o, arrResearchTopicObjLst, arrDataColumn,  clsResearchTopicEN.con_TopicId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrResearchTopicExObjLst: Array<clsResearchTopicENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (ResearchTopicCRUD.sortResearchTopicBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortResearchTopicBy)为空，请检查！(In BindGv_ResearchTopic)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: ResearchTopicCRUD.sortResearchTopicBy,//如果该字段为空，就使用下面的排序函数
 ...
 **/
public async BindGv_ResearchTopic_Cache() 
{
...
whereCond: strWhereCond,
orderBy: ResearchTopicCRUD.sortResearchTopicBy,//如果该字段为空，就使用下面的排序函数
sortFun: ResearchTopic_SortFun_Defa
}
arrResearchTopicObjLst = await ResearchTopic_GetObjLstByPager_Cache(objPagerPara, ResearchTopicCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsResearchTopicEN , b:clsResearchTopicEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, ResearchTopicCRUD.ascOrDesc4SortFun, ResearchTopicCRUD.sortResearchTopicBy, strSortExpress);
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtTopicContent_q");
...
public  set topicContent_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtTopicContent_q", value);
}
 /**
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtTopicProposePeople_q");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set topicProposePeople_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtTopicProposePeople_q", value);
}
 /**
