...
import { RTPaperRela_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_GetUniCondStr_mId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_GetUniCondStr4Update_mId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_GetObjBymIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
import { RTPaperRela_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsRTPaperRelaWApi.js";
 ...
 **/
export abstract class RTPaperRela_Edit 
{
public opType = "";
public keyId = "";
...
public static objPage_Edit: RTPaperRela_Edit;
public objRTPaperRela: clsRTPaperRelaEN;
...
this.objRTPaperRela = new clsRTPaperRelaEN();
}
 ...
 **/
public ShowDialog_RTPaperRela(strOp:string) {
const strThisFuncName = this.ShowDialog_RTPaperRela.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_RTPaperRela");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_RTPaperRela");
...
if (RTPaperRela_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
...
const strCommandText: string = this.btnSubmit_RTPaperRela;
try {
...
pobjRTPaperRelaEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1));// 修改日期
...
const objRTPaperRelaEN = new clsRTPaperRelaEN();
try
{
...
try
{
RTPaperRela_CheckPropertyNew(objRTPaperRelaEN);
}
catch(e)
{
...
let returnBool = false;
returnBool = await RTPaperRela_AddNewRecordAsync(objRTPaperRelaEN);
if (returnBool == true)
{
 ...
 **/
public async CheckUniCond4Add_mId(objRTPaperRelaEN: clsRTPaperRelaEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_mId.name;
const strUniquenessCondition = RTPaperRela_GetUniCondStr_mId(objRTPaperRelaEN);
const bolIsExistCondition = await RTPaperRela_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_mId(objRTPaperRelaEN: clsRTPaperRelaEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_mId.name;
const strUniquenessCondition = RTPaperRela_GetUniCondStr4Update_mId(objRTPaperRelaEN);
const bolIsExistCondition = await RTPaperRela_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
const strThisFuncName = this.ShowData.name;
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objRTPaperRelaEN = new clsRTPaperRelaEN();
        try {
            const returnBool = await RTPaperRela_IsExistAsync(lngmId);
            if (returnBool == false) {
...
console.error(strMsg);
        ...
        try {
const objRTPaperRelaEN_Const = await RTPaperRela_GetObjBymIdAsync(lngmId);
...
await this.PutDataToRTPaperRelaClass(objRTPaperRelaEN);
objRTPaperRelaEN.sfUpdFldSetStr = objRTPaperRelaEN.updFldString;//设置哪些字段被修改(脏字段)
...
try
{
RTPaperRela_CheckProperty4Update(objRTPaperRelaEN);
}
catch(e)
{
const strMsg = Format("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const returnBool = await RTPaperRela_UpdateRecordAsync(objRTPaperRelaEN);
if (returnBool == true)
{
RTPaperRela_ReFreshCache();
}
 ...
 **/
public  set btnCancel_RTPaperRela(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_RTPaperRela", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_RTPaperRela():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_RTPaperRela");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_RTPaperRela(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_RTPaperRela", value);
}
 /**
 * 备注 (Used In Clear())
 **/
