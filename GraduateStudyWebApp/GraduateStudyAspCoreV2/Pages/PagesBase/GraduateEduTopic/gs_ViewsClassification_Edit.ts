...
import { gs_ViewsClassification_CheckPropertyNew, gs_ViewsClassification_GetUniCondStr4Update_ClassificationName_TopicId, gs_ViewsClassification_GetUniCondStr_ClassificationName_TopicId } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
import { gs_ViewsClassification_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
import { gs_ViewsClassification_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
import { gs_ViewsClassification_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
import { gs_ViewsClassification_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
import { clsgs_ViewsClassificationEN } from "../../TS/L0_Entity/GraduateEduTopic/clsgs_ViewsClassificationEN.js";
import { gs_ViewsClassification_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
...
import { gs_ViewsClassification_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
import { gs_ViewsClassification_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ViewsClassificationWApi.js";
 ...
 **/
export abstract class gs_ViewsClassification_Edit 
{
public opType = "";
public keyId = "";
...
public static objPage_Edit: gs_ViewsClassification_Edit;
public objgs_ViewsClassification: clsgs_ViewsClassificationEN;
...
this.objgs_ViewsClassification = new clsgs_ViewsClassificationEN();
}
 ...
 **/
public ShowDialog_gs_ViewsClassification(strOp:string) {
const strThisFuncName = this.ShowDialog_gs_ViewsClassification.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_gs_ViewsClassification");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_gs_ViewsClassification");
 ...
 **/
public HideDialog_gs_ViewsClassification() {
...
if (gs_ViewsClassification_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
...
const strCommandText: string = this.btnSubmit_gs_ViewsClassification;
try {
...
this.iShowList.BindGv(clsgs_ViewsClassificationEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsgs_ViewsClassificationEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
const objgs_ViewsClassificationEN = new clsgs_ViewsClassificationEN();
try
{
...
try
{
gs_ViewsClassification_CheckPropertyNew(objgs_ViewsClassificationEN);
}
catch(e)
{
...
let returnBool = false;
const bolIsExist = await gs_ViewsClassification_IsExistAsync(objgs_ViewsClassificationEN.classificationId);
if (bolIsExist == true)
{
const strMsg = Format("添加记录时，关键字：{0}已经存在！", objgs_ViewsClassificationEN.classificationId);
console.error(strMsg);
alert(strMsg);
return false;//一定要有一个返回值，否则会出错！
}
returnBool = await gs_ViewsClassification_AddNewRecordAsync(objgs_ViewsClassificationEN);
if (returnBool == true)
{
 ...
 **/
public async CheckUniCond4Add_ClassificationId(objgs_ViewsClassificationEN: clsgs_ViewsClassificationEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_ClassificationId.name;
const strUniquenessCondition = gs_ViewsClassification_GetUniCondStr_ClassificationName_TopicId(objgs_ViewsClassificationEN);
const bolIsExistCondition = await gs_ViewsClassification_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_ClassificationId(objgs_ViewsClassificationEN: clsgs_ViewsClassificationEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_ClassificationId.name;
const strUniquenessCondition = gs_ViewsClassification_GetUniCondStr4Update_ClassificationName_TopicId(objgs_ViewsClassificationEN);
const bolIsExistCondition = await gs_ViewsClassification_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
const responseKeyId = await gs_ViewsClassification_AddNewRecordWithMaxIdAsync(objgs_ViewsClassificationEN);
 ...
 **/
  public async ShowData(strClassificationId: string) {
const strThisFuncName = this.ShowData.name;
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objgs_ViewsClassificationEN = new clsgs_ViewsClassificationEN();
        try {
            const returnBool = await gs_ViewsClassification_IsExistAsync(strClassificationId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", strClassificationId);
...
console.error(strMsg);
        ...
        try {
const objgs_ViewsClassificationEN_Const = await gs_ViewsClassification_GetObjByClassificationIdAsync(strClassificationId);
 ...
 **/
public async UpdateRecord(strClassificationId: string):Promise<boolean> 
{
...
await this.PutDataTogs_ViewsClassificationClass(objgs_ViewsClassificationEN);
objgs_ViewsClassificationEN.sfUpdFldSetStr = objgs_ViewsClassificationEN.updFldString;//设置哪些字段被修改(脏字段)
...
try
{
gs_ViewsClassification_CheckProperty4Update(objgs_ViewsClassificationEN);
}
catch(e)
{
const strMsg = Format("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const returnBool = await gs_ViewsClassification_UpdateRecordAsync(objgs_ViewsClassificationEN);
if (returnBool == true)
{
gs_ViewsClassification_ReFreshCache();
}
 ...
 **/
public  set btnCancel_gs_ViewsClassification(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_gs_ViewsClassification", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_gs_ViewsClassification():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_gs_ViewsClassification");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_gs_ViewsClassification(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_gs_ViewsClassification", value);
}
 /**
 * 分类Id (Used In Clear())
 **/
public  set classificationId(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtClassificationId", value);
}
 /**
 * 分类Id (Used In PutDataToClass())
 **/
public  get classificationId():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtClassificationId");
...
public  set classificationName(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtClassificationName", value);
}
 /**
 * 分类名称 (Used In PutDataToClass())
 **/
public  get classificationName():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtClassificationName");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
