 ...
 **/
//import $ from "jquery";
import { PaperSubViewpointLikeLog_CheckPropertyNew } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_AddNewRecordAsync } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_ReFreshCache } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_GetUniCondStr_PaperSubViewpointLikeLogId_SubViewpointId } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_IsExistRecordAsync } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_GetUniCondStr4Update_PaperSubViewpointLikeLogId_SubViewpointId } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_IsExistAsync } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_GetObjByPaperSubViewpointLikeLogIdAsync } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_CheckProperty4Update } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
import { PaperSubViewpointLikeLog_UpdateRecordAsync } from "../../TS/L3_ForWApi/Other/clsPaperSubViewpointLikeLogWApi.js";
 ...
 **/
export abstract class PaperSubViewpointLikeLog_Edit 
{
public opType = "";
public keyId = "";

public static strPageDispModeId = "01";//PopupBox(弹出框)
public static objPage_Edit: PaperSubViewpointLikeLog_Edit;
public objPaperSubViewpointLikeLog: clsPaperSubViewpointLikeLogEN;
...
this.objPaperSubViewpointLikeLog = new clsPaperSubViewpointLikeLogEN();
}
 ...
 **/
public ShowDialog_PaperSubViewpointLikeLog(strOp:string) {
const strThisFuncName = this.ShowDialog_PaperSubViewpointLikeLog.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_PaperSubViewpointLikeLog");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_PaperSubViewpointLikeLog");
 ...
 **/
public HideDialog_PaperSubViewpointLikeLog() {
...
if (PaperSubViewpointLikeLog_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
...
const strCommandText: string = this.btnSubmit_PaperSubViewpointLikeLog;
try {
...
this.iShowList.BindGv(clsPaperSubViewpointLikeLogEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
 ...
 **/
public async PutDataToPaperSubViewpointLikeLogClass(pobjPaperSubViewpointLikeLogEN: clsPaperSubViewpointLikeLogEN)
{
const strThisFuncName = this.PutDataToPaperSubViewpointLikeLogClass.name;
pobjPaperSubViewpointLikeLogEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1));// 修改日期
...
const objPaperSubViewpointLikeLogEN = new clsPaperSubViewpointLikeLogEN();
try
{
...
try
{
PaperSubViewpointLikeLog_CheckPropertyNew(objPaperSubViewpointLikeLogEN);
}
catch(e)
{
...
let returnBool = false;
returnBool = await PaperSubViewpointLikeLog_AddNewRecordAsync(objPaperSubViewpointLikeLogEN);
if (returnBool == true)
{
 ...
 **/
public async CheckUniCond4Add_PaperSubViewpointLikeLogId_SubViewpointId(objPaperSubViewpointLikeLogEN: clsPaperSubViewpointLikeLogEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_PaperSubViewpointLikeLogId_SubViewpointId.name;
const strUniquenessCondition = PaperSubViewpointLikeLog_GetUniCondStr_PaperSubViewpointLikeLogId_SubViewpointId(objPaperSubViewpointLikeLogEN);
const bolIsExistCondition = await PaperSubViewpointLikeLog_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_PaperSubViewpointLikeLogId_SubViewpointId(objPaperSubViewpointLikeLogEN: clsPaperSubViewpointLikeLogEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_PaperSubViewpointLikeLogId_SubViewpointId.name;
const strUniquenessCondition = PaperSubViewpointLikeLog_GetUniCondStr4Update_PaperSubViewpointLikeLogId_SubViewpointId(objPaperSubViewpointLikeLogEN);
const bolIsExistCondition = await PaperSubViewpointLikeLog_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
 ...
 **/
  public async ShowData(lngPaperSubViewpointLikeLogId: number) {
const strThisFuncName = this.ShowData.name;
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objPaperSubViewpointLikeLogEN = new clsPaperSubViewpointLikeLogEN();
        try {
            const returnBool = await PaperSubViewpointLikeLog_IsExistAsync(lngPaperSubViewpointLikeLogId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", lngPaperSubViewpointLikeLogId);
...
console.error(strMsg);
        ...
        try {
const objPaperSubViewpointLikeLogEN_Const = await PaperSubViewpointLikeLog_GetObjByPaperSubViewpointLikeLogIdAsync(lngPaperSubViewpointLikeLogId);
 ...
 **/
public GetDataFromPaperSubViewpointLikeLogClass(pobjPaperSubViewpointLikeLogEN: clsPaperSubViewpointLikeLogEN )
{
 ...
 **/
public async UpdateRecord(lngPaperSubViewpointLikeLogId: number):Promise<boolean> 
{
...
await this.PutDataToPaperSubViewpointLikeLogClass(objPaperSubViewpointLikeLogEN);
objPaperSubViewpointLikeLogEN.sfUpdFldSetStr = objPaperSubViewpointLikeLogEN.updFldString;//设置哪些字段被修改(脏字段)
...
try
{
PaperSubViewpointLikeLog_CheckProperty4Update(objPaperSubViewpointLikeLogEN);
}
catch(e)
{
const strMsg = Format("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
const returnBool = await PaperSubViewpointLikeLog_UpdateRecordAsync(objPaperSubViewpointLikeLogEN);
if (returnBool == true)
{
PaperSubViewpointLikeLog_ReFreshCache();
}
 ...
 **/
public  set btnCancel_PaperSubViewpointLikeLog(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_PaperSubViewpointLikeLog", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_PaperSubViewpointLikeLog():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_PaperSubViewpointLikeLog");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_PaperSubViewpointLikeLog(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_PaperSubViewpointLikeLog", value);
}
 /**
 * 备注 (Used In Clear())
 **/
