...
**/
export abstract class WA_gs_UserConfig_Edit {
    public opType = "";
    public keyId = "";

    public static strPageDispModeId = "01";//PopupBox(弹出框)
    public static objPage_Edit: WA_gs_UserConfig_Edit;
    ...
    public async btnAddNewRecord_Click() {
        ...
        try {
            if (this.bolIsLoadEditRegion == false)  //
            {
                ...
                if (WA_gs_UserConfig_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
                ...
                case "确认添加":
                    ...
                    if (this.opType == "AddWithMaxId") {
                        ...
                        if (returnBool == true) {
                            ...
                            this.iShowList.BindGv(clsvgs_UserConfigEN._CurrTabName, returnBool.toString());
                        }
                    }
                    break;
                case "确认修改":
   ...
   * 在这里是把值传到表控件中
    ...
    **/
    public async ShowData(lngConfigId: number) {
        ...
        try {
            objgs_UserConfigEN = await gs_UserConfig_GetObjByConfigIdAsync(lngConfigId);
        }
        catch (e) {
