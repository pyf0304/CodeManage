...
import { sys_RequestPush_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPush_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPush_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { CurrEduCls_BindDdl_id_CurrEduClsInDiv_Cache } from "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js";
import { sys_RequestPush_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
...
import { sys_RequestPushEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTools/clssys_RequestPushExWApi.js";
import { sys_RequestPush_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPush_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPush_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPushEx_GetObjExLstByPagerAsync } from "../../TS/L3_ForWApiEx/GraduateEduTools/clssys_RequestPushExWApi.js";
import { sys_RequestPush_GetObjLstByRequestIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPush_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
import { sys_RequestPush_Delsys_RequestPushsAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clssys_RequestPushWApi.js";
 ...
 **/
export abstract class sys_RequestPushCRUD implements clsOperateList
{
public static objPage_CRUD: sys_RequestPushCRUD;
public static sortFun_Static: (ascOrDesc: string) => (x: any, y: any) => number;
public static ascOrDesc4SortFun = "Asc";
public static sortsys_RequestPushBy = "";
 ...
 **/
public CombineData(arrsys_RequestPushObjLst: Array<clssys_RequestPushEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const objEN: clssys_RequestPushEN = arrsys_RequestPushObjLst[i];
for (let j = 0; j < intColNum; j++)
{
...
const strFileName = Format("请求推送表({0})导出.xlsx",
 clssys_RequestPushEN._CurrTabName);
 ...
 **/
public async ExportExcel_sys_RequestPush() 
{
const strThisFuncName = this.ExportExcel_sys_RequestPush.name;
if (sys_RequestPushCRUD.sortsys_RequestPushBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortsys_RequestPushBy)为空，请检查！(In BindGv_sys_RequestPush_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
try
{
this.recCount = await sys_RequestPush_GetRecCountByCondAsync(strWhereCond);
if (this.recCount == 0)
{
 ...
 **/
public async ExportExcel_sys_RequestPush_Cache() 
{
...
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objsys_RequestPush_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objsys_RequestPush_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrsys_RequestPushObjLst = await sys_RequestPush_GetSubObjLst_Cache(objsys_RequestPush_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrsys_RequestPushObjLst.length == 0)
{
const strKey = Format("{0}", clssys_RequestPushEN._CurrTabName);
 ...
 **/
public async btnSelectRecordInTab_Click(lngRequestId: number) {
...
try
{
const returnInt = await sys_RequestPush_DelRecordAsync(lngRequestId);
if (returnInt > 0)
{
...
try
{
const objsys_RequestPushEN = await sys_RequestPush_GetObjByRequestIdAsync(lngRequestId);
//console.log("完成SelectRecord!", objsys_RequestPushEN);
Redirect("/Index/Main_sys_RequestPush");
}
catch(e)
{
 ...
 **/
 public async Combinesys_RequestPushCondition():Promise<string> 
{
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clssys_RequestPushEN.con_ReceiveUser, this.receiveUser_q);
}
if ( this.id_CurrEduCls_q != "" && this.id_CurrEduCls_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clssys_RequestPushEN.con_id_CurrEduCls, this.id_CurrEduCls_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(Combinesys_RequestPushCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(Combinesys_RequestPushConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
 public async Combinesys_RequestPushConditionObj4ExportExcel():Promise<clssys_RequestPushEN> 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
const objsys_RequestPush_Cond = new clssys_RequestPushENEx();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
if ( this.receiveUser_q != "")
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(Combinesys_RequestPushConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objsys_RequestPush_Cond.whereCond = strWhereCond;
return objsys_RequestPush_Cond;
 ...
 **/
public async BindTab_sys_RequestPush(divContainer: string, arrsys_RequestPushObjLst: Array<clssys_RequestPushEN>) 
{
...
{
fldName: clssys_RequestPushENEx.con_UserName,
sortBy: "userName",
sortFun: SortFun,
getDataSource: "",
colHeader: "接收用户",
...
{
fldName: clssys_RequestPushENEx.con_EduClsName,
sortBy: "eduClsName",
sortFun: SortFun,
getDataSource: "",
colHeader: "教学班名",
...
{
fldName: clssys_RequestPushEN.con_RequestUser,
sortBy: "requestUser",
sortFun: SortFun,
getDataSource: "",
colHeader: "推送人",
...
{
fldName: clssys_RequestPushEN.con_RequestDate,
sortBy: "requestDate",
sortFun: SortFun,
getDataSource: "",
colHeader: "推送日期",
...
await BindTab(o, arrsys_RequestPushObjLst, arrDataColumn,  clssys_RequestPushEN.con_RequestId, this); 
 ...
 **/
public async BindTab_sys_RequestPush4Func(divContainer: string, arrsys_RequestPushExObjLst: Array<clssys_RequestPushENEx>) 
{
...
await BindTab(o, arrsys_RequestPushExObjLst, arrDataColumn, clssys_RequestPushEN.con_RequestId, this); 
this.objPager.recCount = this.recCount;
this.objPager.pageSize = this.pageSize;
this.objPager.ShowPagerV2(this, this.divName4Pager);
}
 ...
 **/
public async ExtendFldFuncMap(arrsys_RequestPushExObjLst: Array<clssys_RequestPushENEx>, arrDataColumn: Array<clsDataColumn>) {
const arrFldName = clssys_RequestPushEN.AttributeName;
for (const objDataColumn of arrDataColumn) {
if (IsNullOrEmpty(objDataColumn.fldName) == true) continue;
if (arrFldName.indexOf(objDataColumn.fldName) > -1) continue;
for (const objInFor of arrsys_RequestPushExObjLst) {
await sys_RequestPushEx_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
if (sys_RequestPushCRUD.sortsys_RequestPushBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortsys_RequestPushBy)为空，请检查！(In BindGv_sys_RequestPush)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: sys_RequestPushCRUD.sortsys_RequestPushBy,//如果该字段为空，就使用下面的排序函数
...
whereCond: strWhereCond,
orderBy: sys_RequestPushCRUD.sortsys_RequestPushBy,//如果该字段为空，就使用下面的排序函数
sortFun: sys_RequestPush_SortFun_Defa
}
...
arrsys_RequestPushExObjLst = await sys_RequestPushEx_GetObjExLstByPagerAsync(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clssys_RequestPushEN , b:clssys_RequestPushEN): number 
{
const strThisFuncName = this.SortFun_ExportExcel.name;
if (a.id_CurrEduCls == b.id_CurrEduCls) return a.id_CurrEduCls.localeCompare(b.id_CurrEduCls) ;
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, sys_RequestPushCRUD.ascOrDesc4SortFun, sys_RequestPushCRUD.sortsys_RequestPushBy, strSortExpress);
...
try
{
const arrsys_RequestPushObjLst = await sys_RequestPush_GetObjLstByRequestIdLstAsync(arrRequestId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrsys_RequestPushObjLst)
{
const returnBool = await sys_RequestPush_AddNewRecordAsync(objInFor);
...
try
{
const returnInt = await sys_RequestPush_Delsys_RequestPushsAsync(arrRequestId);
if (returnInt > 0)
{
//sys_RequestPush_ReFreshCache();
const strInfo = Format("删除记录成功,共删除{0}条记录!", returnInt);
...
const sstrKeys = GetObjKeys(objsys_RequestPush);
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtReceiveUser_q");
if (strValue == undefined) return "";
...
public  set receiveUser_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtReceiveUser_q", value);
}
 /**
