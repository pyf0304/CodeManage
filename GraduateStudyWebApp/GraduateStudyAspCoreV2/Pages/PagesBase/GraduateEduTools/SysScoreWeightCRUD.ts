 ...
 **/
//import $ from "jquery";
import { vSysScoreWeight_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
import { vSysScoreWeight_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
import { CurrEduCls_BindDdl_id_CurrEduClsInDiv_Cache } from "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js";
import { SysScoreWeight_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreWeightWApi.js";
...
import { clsvSysScoreWeightENEx } from "../../TS/L0_Entity/GraduateEduTools/clsvSysScoreWeightENEx.js";
import { vSysScoreWeightEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduTools/clsvSysScoreWeightExWApi.js";
import { vSysScoreWeight_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsvSysScoreWeightWApi.js";
import { SysScoreWeight_GetObjLstByScoreWeightIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreWeightWApi.js";
import { SysScoreWeight_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreWeightWApi.js";
import { SysScoreWeight_DelSysScoreWeightsAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreWeightWApi.js";
...
{
public static objPage_CRUD: SysScoreWeightCRUD;
...
public static CourseId_Cache = "";//查询区下拉框条件变量1
 ...
 **/
public CombineData(arrvSysScoreWeightObjLst: Array<clsvSysScoreWeightEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const strFileName = Format("系统分数权重表({0})导出.xlsx",
 clsvSysScoreWeightEN._CurrTabName);
 ...
 **/
public async ExportExcel_vSysScoreWeight() 
{
const strThisFuncName = this.ExportExcel_vSysScoreWeight.name;
if (SysScoreWeightCRUD.sortvSysScoreWeightBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvSysScoreWeightBy)为空，请检查！(In BindGv_vSysScoreWeight_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
try
{
this.recCount = await vSysScoreWeight_GetRecCountByCondAsync(strWhereCond);
if (this.recCount == 0)
{
...
arrvSysScoreWeightObjLst = await vSysScoreWeight_GetObjLstAsync(strWhereCond);
}
catch(e)
{
...
try
{
const objSysScoreWeightEN = await SysScoreWeight_GetObjByScoreWeightIdAsync(strScoreWeightId);
...
{
strWhereCond += Format(" And {0} = '{1}'", clsvSysScoreWeightEN.con_id_CurrEduCls, this.id_CurrEduCls_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineSysScoreWeightCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineSysScoreWeightConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineSysScoreWeightConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvSysScoreWeight_Cond.whereCond = strWhereCond;
return objvSysScoreWeight_Cond;
 ...
 **/
public async BindTab_vSysScoreWeight(divContainer: string, arrvSysScoreWeightObjLst: Array<clsvSysScoreWeightEN>) 
{
...
await BindTab_V(o, arrvSysScoreWeightObjLst, arrDataColumn,  clsvSysScoreWeightEN.con_ScoreWeightId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvSysScoreWeightExObjLst: Array<clsvSysScoreWeightENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (SysScoreWeightCRUD.sortvSysScoreWeightBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvSysScoreWeightBy)为空，请检查！(In BindGv_vSysScoreWeight)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: SysScoreWeightCRUD.sortvSysScoreWeightBy,//如果该字段为空，就使用下面的排序函数
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvSysScoreWeightEN , b:clsvSysScoreWeightEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, SysScoreWeightCRUD.ascOrDesc4SortFun, SysScoreWeightCRUD.sortvSysScoreWeightBy, strSortExpress);
...
try
{
const arrSysScoreWeightObjLst = await SysScoreWeight_GetObjLstByScoreWeightIdLstAsync(arrScoreWeightId);
...
const bolValue = GetCheckBoxValueInDiv(this.divName4Query, "chkIsPublic_q");
return bolValue;
}
 /**
 * 是否公开 (Used In CombineCondition())
...
public  set isPublic_q(value: boolean) {
 SetCheckBoxValueByIdInDiv(this.divName4Query, "chkIsPublic_q", value);
}
 /**
