...
import { SysScoreSummary_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_GetUniCondStr_mId_UserId } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_GetUniCondStr4Update_mId_UserId } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_GetObjBymIdAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
import { SysScoreSummary_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js";
...
public static objPage_Edit: SysScoreSummary_Edit;
public objSysScoreSummary: clsSysScoreSummaryEN;
...
this.objSysScoreSummary = new clsSysScoreSummaryEN();
}
 ...
 **/
public ShowDialog_SysScoreSummary(strOp:string) {
const strThisFuncName = this.ShowDialog_SysScoreSummary.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_SysScoreSummary");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_SysScoreSummary");
...
{
await SchoolYear_BindDdl_SchoolYearInDiv_Cache(this.divName4Edit, "ddlSchoolYear" );//
}
...
const strCommandText: string = this.btnSubmit_SysScoreSummary;
try {
...
this.iShowList.BindGv(clsSysScoreSummaryEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
if (returnBool == true)
{
SysScoreSummary_ReFreshCache(SysScoreSummary_Edit.id_CurrEduCls_Cache);
 ...
 **/
public async CheckUniCond4Add_mId_UserId(objSysScoreSummaryEN: clsSysScoreSummaryEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_mId_UserId.name;
const strUniquenessCondition = SysScoreSummary_GetUniCondStr_mId_UserId(objSysScoreSummaryEN);
 ...
 **/
public async CheckUniCond4Update_mId_UserId(objSysScoreSummaryEN: clsSysScoreSummaryEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_mId_UserId.name;
const strUniquenessCondition = SysScoreSummary_GetUniCondStr4Update_mId_UserId(objSysScoreSummaryEN);
const bolIsExistCondition = await SysScoreSummary_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
console.error(strMsg);
        ...
        try {
const objSysScoreSummaryEN_Const = await SysScoreSummary_GetObjBymIdAsync(lngmId);
 ...
 **/
public  set btnCancel_SysScoreSummary(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_SysScoreSummary", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_SysScoreSummary():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_SysScoreSummary");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_SysScoreSummary(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_SysScoreSummary", value);
}
 /**
 * 备注 (Used In Clear())
 **/
...
SetSelectValueByIdInDiv(this.divName4Edit, "ddlSchoolYear", value);
}
 /**
 * 学年 (Used In PutDataToClass())
 **/
public  get schoolYear():string {
const strValue = GetSelectValueInDiv(this.divName4Edit, "ddlSchoolYear");
if (strValue == undefined) return "";
