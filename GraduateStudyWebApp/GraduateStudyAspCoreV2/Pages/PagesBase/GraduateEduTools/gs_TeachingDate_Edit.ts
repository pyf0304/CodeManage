 ...
 **/
//import $ from "jquery";
import { gs_TeachingDate_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_GetUniCondStr_mId } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_GetUniCondStr4Update_mId } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_GetObjBymIdAsync } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
import { gs_TeachingDate_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduTools/clsgs_TeachingDateWApi.js";
...
public objgs_TeachingDate: clsgs_TeachingDateEN;
...
this.objgs_TeachingDate = new clsgs_TeachingDateEN();
}
 ...
 **/
public ShowDialog_gs_TeachingDate(strOp:string) {
const strThisFuncName = this.ShowDialog_gs_TeachingDate.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_gs_TeachingDate");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_gs_TeachingDate");
...
const strCommandText: string = this.btnSubmit_gs_TeachingDate;
try {
...
this.iShowList.BindGv(clsgs_TeachingDateEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
const objgs_TeachingDateEN = new clsgs_TeachingDateEN();
try
{
...
if (returnBool == true)
{
gs_TeachingDate_ReFreshCache(gs_TeachingDate_Edit.id_CurrEduCls_Cache);
 ...
 **/
public async CheckUniCond4Add_mId(objgs_TeachingDateEN: clsgs_TeachingDateEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_mId.name;
const strUniquenessCondition = gs_TeachingDate_GetUniCondStr_mId(objgs_TeachingDateEN);
 ...
 **/
public async CheckUniCond4Update_mId(objgs_TeachingDateEN: clsgs_TeachingDateEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_mId.name;
const strUniquenessCondition = gs_TeachingDate_GetUniCondStr4Update_mId(objgs_TeachingDateEN);
const bolIsExistCondition = await gs_TeachingDate_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
console.error(strMsg);
        ...
        try {
const objgs_TeachingDateEN_Const = await gs_TeachingDate_GetObjBymIdAsync(lngmId);
...
public  set btnCancel_gs_TeachingDate(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_gs_TeachingDate", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_gs_TeachingDate():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_gs_TeachingDate");
return strValue;
}
 /**
...
public  set btnSubmit_gs_TeachingDate(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_gs_TeachingDate", value);
}
 /**
 * 截止日期 (Used In Clear())
 **/
public  set endDate(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtEndDate", value);
}
 /**
 * 截止日期 (Used In PutDataToClass())
 **/
public  get endDate():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtEndDate");
...
public  set startDate(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtStartDate", value);
}
 /**
 * 开始日期 (Used In PutDataToClass())
 **/
public  get startDate():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtStartDate");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
