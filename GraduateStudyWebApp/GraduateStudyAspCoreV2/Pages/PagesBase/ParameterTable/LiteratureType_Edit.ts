 ...
 **/
//import $ from "jquery";
import { LiteratureType_CheckPropertyNew } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_IsExistAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_AddNewRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_ReFreshCache } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { clsLiteratureTypeEN } from "../../TS/L0_Entity/ParameterTable/clsLiteratureTypeEN.js";
import { LiteratureType_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetObjByLiteratureTypeIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_CheckProperty4Update } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_UpdateRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
 ...
 **/
export abstract class LiteratureType_Edit 
{
public opType = "";
public keyId = "";

public static strPageDispModeId = "01";//PopupBox(弹出框)
public static objPage_Edit: LiteratureType_Edit;
public objLiteratureType: clsLiteratureTypeEN;
...
this.objLiteratureType = new clsLiteratureTypeEN();
}
 ...
 **/
public ShowDialog_LiteratureType(strOp:string) {
const strThisFuncName = this.ShowDialog_LiteratureType.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_LiteratureType");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_LiteratureType");
 ...
 **/
public HideDialog_LiteratureType() {
...
if (LiteratureType_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
{
...
const strCommandText: string = this.btnSubmit_LiteratureType;
try {
...
this.iShowList.BindGv(clsLiteratureTypeEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsLiteratureTypeEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
pobjLiteratureTypeEN.SetUpdUserId(clsPublocalStorage.userId);// 修改用户Id
pobjLiteratureTypeEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1));// 修改日期
}
...
const objLiteratureTypeEN = new clsLiteratureTypeEN();
try
{
...
try
{
LiteratureType_CheckPropertyNew(objLiteratureTypeEN);
}
catch(e)
{
...
//检查唯一性条件
let returnBool = false;
const bolIsExist = await LiteratureType_IsExistAsync(objLiteratureTypeEN.literatureTypeId);
if (bolIsExist == true)
{
const strMsg = Format("添加记录时，关键字：{0}已经存在！", objLiteratureTypeEN.literatureTypeId);
console.error(strMsg);
alert(strMsg);
return false;//一定要有一个返回值，否则会出错！
}
returnBool = await LiteratureType_AddNewRecordAsync(objLiteratureTypeEN);
if (returnBool == true)
{
...
{
//检查唯一性条件
const responseKeyId = await LiteratureType_AddNewRecordWithMaxIdAsync(objLiteratureTypeEN);
 ...
 **/
  public async ShowData(strLiteratureTypeId: string) {
const strThisFuncName = this.ShowData.name;
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objLiteratureTypeEN = new clsLiteratureTypeEN();
        try {
            const returnBool = await LiteratureType_IsExistAsync(strLiteratureTypeId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", strLiteratureTypeId);
...
console.error(strMsg);
        ...
        try {
const objLiteratureTypeEN_Const = await LiteratureType_GetObjByLiteratureTypeIdAsync(strLiteratureTypeId);
 ...
 **/
public GetDataFromLiteratureTypeClass(pobjLiteratureTypeEN: clsLiteratureTypeEN )
{
 ...
 **/
public async UpdateRecord(strLiteratureTypeId: string):Promise<boolean> 
{
...
await this.PutDataToLiteratureTypeClass(objLiteratureTypeEN);
objLiteratureTypeEN.sfUpdFldSetStr = objLiteratureTypeEN.updFldString;//设置哪些字段被修改(脏字段)
...
try
{
LiteratureType_CheckProperty4Update(objLiteratureTypeEN);
}
catch(e)
{
const strMsg = Format("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
{
//检查唯一性条件
const returnBool = await LiteratureType_UpdateRecordAsync(objLiteratureTypeEN);
if (returnBool == true)
{
LiteratureType_ReFreshCache();
}
 ...
 **/
public  set btnCancel_LiteratureType(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_LiteratureType", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_LiteratureType():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_LiteratureType");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_LiteratureType(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_LiteratureType", value);
}
 /**
 ...
 * 作文类型名 (Used In Clear())
 **/
public  set literatureTypeName(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtLiteratureTypeName", value);
}
 /**
 * 作文类型名 (Used In PutDataToClass())
 **/
public  get literatureTypeName():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtLiteratureTypeName");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
