 ...
 **/
//import $ from "jquery";
import { LiteratureType_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetObjLstAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_DelRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetObjByLiteratureTypeIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { clsLiteratureTypeEN } from "../../TS/L0_Entity/ParameterTable/clsLiteratureTypeEN.js";
import { clsLiteratureTypeENEx } from "../../TS/L0_Entity/ParameterTable/clsLiteratureTypeENEx.js";
import { LiteratureTypeEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/ParameterTable/clsLiteratureTypeExWApi.js";
import { LiteratureType_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_SortFun_Defa } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_GetObjLstByLiteratureTypeIdLstAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_AddNewRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
import { LiteratureType_DelLiteratureTypesAsync } from "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js";
...
{
public static objPage_CRUD: LiteratureTypeCRUD;
 ...
 **/
public CombineData(arrLiteratureTypeObjLst: Array<clsLiteratureTypeEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const strFileName = Format("文献类型({0})导出.xlsx",
 clsLiteratureTypeEN._CurrTabName);
 ...
 **/
public async ExportExcel_LiteratureType() 
{
const strThisFuncName = this.ExportExcel_LiteratureType.name;
if (LiteratureTypeCRUD.sortLiteratureTypeBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortLiteratureTypeBy)为空，请检查！(In BindGv_LiteratureType_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrLiteratureTypeObjLst = await LiteratureType_GetObjLstAsync(strWhereCond);
}
catch(e)
{
 ...
 **/
public async ExportExcel_LiteratureType_Cache() 
{
...
try
{
this.recCount = await LiteratureType_GetRecCountByCond_Cache(objLiteratureType_Cond);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objLiteratureType_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objLiteratureType_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrLiteratureTypeObjLst = await LiteratureType_GetSubObjLst_Cache(objLiteratureType_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
try
{
const objLiteratureTypeEN = await LiteratureType_GetObjByLiteratureTypeIdAsync(strLiteratureTypeId);
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsLiteratureTypeEN.con_LiteratureTypeName, this.literatureTypeName_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombineLiteratureTypeCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsLiteratureTypeEN.con_LiteratureTypeName, this.literatureTypeName_q);
objLiteratureType_Cond.SetCondFldValue(clsLiteratureTypeEN.con_LiteratureTypeName, this.literatureTypeName_q, "like");
}

}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombineLiteratureTypeConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
const objLiteratureType_Cond = new clsLiteratureTypeENEx();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
if ( this.literatureTypeName_q != "")
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineLiteratureTypeConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objLiteratureType_Cond.whereCond = strWhereCond;
return objLiteratureType_Cond;
 ...
 **/
public async BindTab_LiteratureType(divContainer: string, arrLiteratureTypeObjLst: Array<clsLiteratureTypeEN>) 
{
...
await BindTab(o, arrLiteratureTypeObjLst, arrDataColumn,  clsLiteratureTypeEN.con_LiteratureTypeId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrLiteratureTypeExObjLst: Array<clsLiteratureTypeENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (LiteratureTypeCRUD.sortLiteratureTypeBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortLiteratureTypeBy)为空，请检查！(In BindGv_LiteratureType)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: LiteratureTypeCRUD.sortLiteratureTypeBy,//如果该字段为空，就使用下面的排序函数
 ...
 **/
public async BindGv_LiteratureType_Cache() 
{
...
whereCond: strWhereCond,
orderBy: LiteratureTypeCRUD.sortLiteratureTypeBy,//如果该字段为空，就使用下面的排序函数
sortFun: LiteratureType_SortFun_Defa
}
arrLiteratureTypeObjLst = await LiteratureType_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsLiteratureTypeEN , b:clsLiteratureTypeEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, LiteratureTypeCRUD.ascOrDesc4SortFun, LiteratureTypeCRUD.sortLiteratureTypeBy, strSortExpress);
...
try
{
const arrLiteratureTypeObjLst = await LiteratureType_GetObjLstByLiteratureTypeIdLstAsync(arrLiteratureTypeId);
 ...
 **/
public ShowLiteratureTypeObj(divContainer: string, objLiteratureType: clsLiteratureTypeEN) 
{
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtLiteratureTypeName_q");
...
public  set literatureTypeName_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtLiteratureTypeName_q", value);
}
 /**
