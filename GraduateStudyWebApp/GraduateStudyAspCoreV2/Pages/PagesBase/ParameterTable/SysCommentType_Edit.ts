 ...
 **/
//import $ from "jquery";
import { SysCommentType_CheckPropertyNew } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { SysCommentType_IsExistAsync } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { SysCommentType_AddNewRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { SysCommentType_ReFreshCache } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { clsSysCommentTypeEN } from "../../TS/L0_Entity/ParameterTable/clsSysCommentTypeEN.js";
import { SysCommentType_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { SysCommentType_GetObjByCommentTypeIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { SysCommentType_CheckProperty4Update } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
import { SysCommentType_UpdateRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsSysCommentTypeWApi.js";
...
public static objPage_Edit: SysCommentType_Edit;
public objSysCommentType: clsSysCommentTypeEN;
...
this.objSysCommentType = new clsSysCommentTypeEN();
}
 ...
 **/
public ShowDialog_SysCommentType(strOp:string) {
const strThisFuncName = this.ShowDialog_SysCommentType.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_SysCommentType");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_SysCommentType");
...
const strCommandText: string = this.btnSubmit_SysCommentType;
try {
...
this.iShowList.BindGv(clsSysCommentTypeEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsSysCommentTypeEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
console.error(strMsg);
        ...
        try {
const objSysCommentTypeEN_Const = await SysCommentType_GetObjByCommentTypeIdAsync(strCommentTypeId);
 ...
 **/
public GetDataFromSysCommentTypeClass(pobjSysCommentTypeEN: clsSysCommentTypeEN )
{
 ...
 **/
public  set btnCancel_SysCommentType(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_SysCommentType", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_SysCommentType():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_SysCommentType");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_SysCommentType(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_SysCommentType", value);
}
 /**
 * 评论表 (Used In Clear())
 **/
public  set commentTable(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtCommentTable", value);
}
 /**
 * 评论表 (Used In PutDataToClass())
 **/
public  get commentTable():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtCommentTable");
...
public  set commentTableId(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtCommentTableId", value);
}
 /**
 * 评论表Id (Used In PutDataToClass())
 **/
public  get commentTableId():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtCommentTableId");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set commentTypeName(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtCommentTypeName", value);
}
 /**
 * 评论类型名 (Used In PutDataToClass())
 **/
public  get commentTypeName():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtCommentTypeName");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
