 ...
 **/
//import $ from "jquery";
import { gs_TopicTaskStatus_CheckPropertyNew } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_IsExistAsync } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_AddNewRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_ReFreshCache } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { clsgs_TopicTaskStatusEN } from "../../TS/L0_Entity/ParameterTable/clsgs_TopicTaskStatusEN.js";
import { gs_TopicTaskStatus_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_GetObjByStatusIdAsync } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_CheckProperty4Update } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
import { gs_TopicTaskStatus_UpdateRecordAsync } from "../../TS/L3_ForWApi/ParameterTable/clsgs_TopicTaskStatusWApi.js";
...
public static objPage_Edit: gs_TopicTaskStatus_Edit;
public objgs_TopicTaskStatus: clsgs_TopicTaskStatusEN;
...
this.objgs_TopicTaskStatus = new clsgs_TopicTaskStatusEN();
}
 ...
 **/
public ShowDialog_gs_TopicTaskStatus(strOp:string) {
const strThisFuncName = this.ShowDialog_gs_TopicTaskStatus.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_gs_TopicTaskStatus");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_gs_TopicTaskStatus");
...
const strCommandText: string = this.btnSubmit_gs_TopicTaskStatus;
try {
...
this.iShowList.BindGv(clsgs_TopicTaskStatusEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsgs_TopicTaskStatusEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
{
//检查唯一性条件
const responseKeyId = await gs_TopicTaskStatus_AddNewRecordWithMaxIdAsync(objgs_TopicTaskStatusEN);
...
console.error(strMsg);
        ...
        try {
const objgs_TopicTaskStatusEN_Const = await gs_TopicTaskStatus_GetObjByStatusIdAsync(strStatusId);
 ...
 **/
public  set btnCancel_gs_TopicTaskStatus(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_gs_TopicTaskStatus", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_gs_TopicTaskStatus():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_gs_TopicTaskStatus");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_gs_TopicTaskStatus(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_gs_TopicTaskStatus", value);
}
 /**
 * 状态Id (Used In Clear())
 **/
public  set statusId(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtStatusId", value);
}
 /**
 * 状态Id (Used In PutDataToClass())
 **/
public  get statusId():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtStatusId");
...
public  set statusName(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtStatusName", value);
}
 /**
 * 状态名称 (Used In PutDataToClass())
 **/
public  get statusName():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtStatusName");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
