...
import { gs_PaperParagraph_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GetUniCondStr_ParagraphId } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GetUniCondStr4Update_ParagraphId } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { clsgs_PaperParagraphEN } from "../../TS/L0_Entity/GraduateEduPaper/clsgs_PaperParagraphEN.js";
import { gs_PaperParagraph_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GetObjByParagraphIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
 ...
 **/
public ShowDialog_gs_PaperParagraph(strOp:string) {
const strThisFuncName = this.ShowDialog_gs_PaperParagraph.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_gs_PaperParagraph");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_gs_PaperParagraph");
...
{
await gs_ParagraphType_BindDdl_ParagraphTypeIdInDiv_Cache(this.divName4Edit, "ddlParagraphTypeId" );//
}
...
const strCommandText: string = this.btnSubmit_gs_PaperParagraph;
try {
...
this.iShowList.BindGv(clsgs_PaperParagraphEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsgs_PaperParagraphEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
try
{
const returnString = await gs_PaperParagraph_GetMaxStrIdAsync();
if (returnString == "")
{
const strInfo = Format("获取表gs_PaperParagraph的最大关键字为空，不成功，请检查!");
//显示信息框
alert(strInfo);
}
else
...
const objgs_PaperParagraphEN = new clsgs_PaperParagraphEN();
try
{
...
let returnBool = false;
const returnKeyId = await gs_PaperParagraph_AddNewRecordWithMaxIdAsync(objgs_PaperParagraphEN);
if (IsNullOrEmpty(returnKeyId) == false)
{
returnBool = true;
}
 ...
 **/
public async CheckUniCond4Add_ParagraphId(objgs_PaperParagraphEN: clsgs_PaperParagraphEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_ParagraphId.name;
const strUniquenessCondition = gs_PaperParagraph_GetUniCondStr_ParagraphId(objgs_PaperParagraphEN);
const bolIsExistCondition = await gs_PaperParagraph_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_ParagraphId(objgs_PaperParagraphEN: clsgs_PaperParagraphEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_ParagraphId.name;
const strUniquenessCondition = gs_PaperParagraph_GetUniCondStr4Update_ParagraphId(objgs_PaperParagraphEN);
const bolIsExistCondition = await gs_PaperParagraph_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
const strThisFuncName = this.ShowData.name;
        ...
        //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
        let objgs_PaperParagraphEN = new clsgs_PaperParagraphEN();
        try {
            const returnBool = await gs_PaperParagraph_IsExistAsync(strParagraphId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", strParagraphId);
...
console.error(strMsg);
        ...
        try {
const objgs_PaperParagraphEN_Const = await gs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId);
...
const returnBool = await gs_PaperParagraph_UpdateRecordAsync(objgs_PaperParagraphEN);
if (returnBool == true)
{
gs_PaperParagraph_ReFreshCache();
}
...
public  set btnCancel_gs_PaperParagraph(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_gs_PaperParagraph", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_gs_PaperParagraph():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_gs_PaperParagraph");
return strValue;
}
 /**
...
public  set btnSubmit_gs_PaperParagraph(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_gs_PaperParagraph", value);
}
 /**
 * 备注 (Used In Clear())
 **/
...
public  set paragraphContent(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtParagraphContent", value);
}
 /**
 * 段落内容 (Used In PutDataToClass())
 **/
public  get paragraphContent():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtParagraphContent");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
SetSelectValueByIdInDiv(this.divName4Edit, "ddlParagraphTypeId", value);
}
 /**
 * 段落类型Id (Used In PutDataToClass())
 **/
public  get paragraphTypeId():string {
const strValue = GetSelectValueInDiv(this.divName4Edit, "ddlParagraphTypeId");
if (strValue == undefined) return "";
