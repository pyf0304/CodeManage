...
import { vPaperSubViewpoint_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js";
import { vPaperSubViewpoint_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js";
...
import { PaperSubViewpoint_ReOrderAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_GoBottomAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_DownMoveAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_UpMoveAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_GoTopAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
...
import { clsvPaperSubViewpointENEx } from "../../TS/L0_Entity/GraduateEduPaper/clsvPaperSubViewpointENEx.js";
import { vPaperSubViewpointEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduPaper/clsvPaperSubViewpointExWApi.js";
import { vPaperSubViewpoint_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js";
import { vPaperSubViewpoint_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js";
import { vPaperSubViewpoint_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js";
import { PaperSubViewpoint_GetObjLstBySubViewpointIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
import { PaperSubViewpoint_DelPaperSubViewpointsAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js";
...
{
public static objPage_CRUD: PaperSubViewpointCRUD;
...
public static PaperId_Static = "";//查询区下拉框条件变量1
 ...
 **/
public CombineData(arrvPaperSubViewpointObjLst: Array<clsvPaperSubViewpointEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const strFileName = Format("子观点表({0})导出.xlsx",
 clsvPaperSubViewpointEN._CurrTabName);
 ...
 **/
public async ExportExcel_vPaperSubViewpoint() 
{
const strThisFuncName = this.ExportExcel_vPaperSubViewpoint.name;
if (PaperSubViewpointCRUD.sortvPaperSubViewpointBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvPaperSubViewpointBy)为空，请检查！(In BindGv_vPaperSubViewpoint_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
arrvPaperSubViewpointObjLst = await vPaperSubViewpoint_GetObjLstAsync(strWhereCond);
}
catch(e)
{
 ...
 **/
public async ExportExcel_vPaperSubViewpoint_Cache() 
{
...
objvPaperSubViewpoint_Cond.SetCondFldValue(clsvPaperSubViewpointEN.con_id_CurrEduCls, PaperSubViewpointCRUD.id_CurrEduCls_Cache, "=");
const strWhereCond = JSON.stringify(objvPaperSubViewpoint_Cond);
const intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
 let arrvPaperSubViewpointObjLst: Array <clsvPaperSubViewpointEN> = [];
try
{
this.recCount = await vPaperSubViewpoint_GetRecCountByCond_Cache(objvPaperSubViewpoint_Cond, PaperSubViewpointCRUD.id_CurrEduCls_Cache);
if (this.recCount == 0)
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvPaperSubViewpoint_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvPaperSubViewpoint_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvPaperSubViewpointObjLst = await vPaperSubViewpoint_GetSubObjLst_Cache(objvPaperSubViewpoint_Cond, PaperSubViewpointCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
if (arrvPaperSubViewpointObjLst.length == 0)
{
const strKey = Format("{0}_{1}", clsPaperSubViewpointEN._CurrTabName, PaperSubViewpointCRUD.id_CurrEduCls_Cache);
...
{
await Section_BindDdl_SectionIdByPaperIdInDiv_Cache(this.divName4Query, "ddlSectionId_q" , PaperId);//
}
...
{
await SubViewpointType_BindDdl_SubViewpointTypeIdInDiv_Cache(this.divName4Query, "ddlSubViewpointTypeId_q" );//
}
...
{
await ExplainType_BindDdl_ExplainTypeIdInDiv_Cache(this.divName4Query, "ddlExplainTypeId_q" );//
}
...
if (strPaperRWId == "")
{
const strMsg = Format("请输入PaperRWId!");
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return false;
 ...
 **/
public async btnSelectRecordInTab_Click(strSubViewpointId: string) {
 ...
 * @param sender:参数列表
 **/
public async SelectRecord(strSubViewpointId: string) 
{
const strThisFuncName = this.SelectRecord.name;
try
{
const objPaperSubViewpointEN = await PaperSubViewpoint_GetObjBySubViewpointIdAsync(strSubViewpointId);
...
if ( this.paperRWId_q != "")
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvPaperSubViewpointEN.con_PaperRWId, this.paperRWId_q);
}
if ( this.sectionId_q != "" && this.sectionId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsvPaperSubViewpointEN.con_SectionId, this.sectionId_q);
}
if ( this.subViewpointTypeId_q != "" && this.subViewpointTypeId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsvPaperSubViewpointEN.con_SubViewpointTypeId, this.subViewpointTypeId_q);
}
if ( this.explainTypeId_q != "" && this.explainTypeId_q != "0")
{
strWhereCond += Format(" And {0} = '{1}'", clsvPaperSubViewpointEN.con_ExplainTypeId, this.explainTypeId_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(CombinePaperSubViewpointCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(CombinePaperSubViewpointConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(CombinePaperSubViewpointConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvPaperSubViewpoint_Cond.whereCond = strWhereCond;
return objvPaperSubViewpoint_Cond;
 ...
 **/
public async BindTab_vPaperSubViewpoint(divContainer: string, arrvPaperSubViewpointObjLst: Array<clsvPaperSubViewpointEN>) 
{
...
await BindTab_V(o, arrvPaperSubViewpointObjLst, arrDataColumn,  clsvPaperSubViewpointEN.con_SubViewpointId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvPaperSubViewpointExObjLst: Array<clsvPaperSubViewpointENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (PaperSubViewpointCRUD.sortvPaperSubViewpointBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvPaperSubViewpointBy)为空，请检查！(In BindGv_vPaperSubViewpoint)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: PaperSubViewpointCRUD.sortvPaperSubViewpointBy,//如果该字段为空，就使用下面的排序函数
...
whereCond: strWhereCond,
orderBy: PaperSubViewpointCRUD.sortvPaperSubViewpointBy,//如果该字段为空，就使用下面的排序函数
sortFun: vPaperSubViewpoint_SortFun_Defa
}
arrvPaperSubViewpointObjLst = await vPaperSubViewpoint_GetObjLstByPager_Cache(objPagerPara, PaperSubViewpointCRUD.id_CurrEduCls_Cache);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvPaperSubViewpointEN , b:clsvPaperSubViewpointEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, PaperSubViewpointCRUD.ascOrDesc4SortFun, PaperSubViewpointCRUD.sortvPaperSubViewpointBy, strSortExpress);
...
try
{
const arrPaperSubViewpointObjLst = await PaperSubViewpoint_GetObjLstBySubViewpointIdLstAsync(arrSubViewpointId);
//console.log('responseText=');
//console.log(responseText);
let intCount = 0;
for (const objInFor of arrPaperSubViewpointObjLst)
{
const strMaxStrId = await PaperSubViewpoint_GetMaxStrIdAsync();
...
const strValue = GetSelectValueInDiv(this.divName4Query, "ddlExplainTypeId_q");
...
SetSelectValueByIdInDiv(this.divName4Query, "ddlExplainTypeId_q", value);
}
 /**
 * PaperRWId (Used In btnReOrder_Click())
 **/
public static get PaperRWId_OrderNum():string {
return $("#txtPaperRWId_OrderNum").val();
}
 /**
 * PaperRWId (Used In btnReOrder_Click())
 **/
public static set PaperRWId_OrderNum(value: string) {
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtPaperRWId_q");
if (strValue == undefined) return "";
...
public  set paperRWId_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtPaperRWId_q", value);
}
 /**
 * 节Id (Used In CombineCondition())
 **/
public  get sectionId_q():string {
const strValue = GetSelectValueInDiv(this.divName4Query, "ddlSectionId_q");
if (strValue == undefined) return "";
else if (strValue == "0") return "";
else return strValue;
}
...
SetSelectValueByIdInDiv(this.divName4Query, "ddlSectionId_q", value);
}
 /**
 * SubViewpointTypeId (Used In btnReOrder_Click())
 **/
public static get SubViewpointTypeId_OrderNum():string {
if ($("#ddlSubViewpointTypeId_OrderNum").val() == "0") return "";
return $("#ddlSubViewpointTypeId_OrderNum").val();
}
 /**
 * SubViewpointTypeId (Used In btnReOrder_Click())
 **/
public static set SubViewpointTypeId_OrderNum(value: string) {
...
const strValue = GetSelectValueInDiv(this.divName4Query, "ddlSubViewpointTypeId_q");
if (strValue == undefined) return "";
else if (strValue == "0") return "";
else return strValue;
}
...
SetSelectValueByIdInDiv(this.divName4Query, "ddlSubViewpointTypeId_q", value);
}
 /**
