...
CheckControlExist(this.divName4Detail, "div", "divDetailDialog_gs_PaperVer");
CheckControlExist(this.divName4Detail, "h4", "lblDialogTitle_gs_PaperVer");
 ...
 **/
public  set btnCancel_d_gs_PaperVer(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Detail, "btnCancel_d_gs_PaperVer", value);
}
 /**
 * 设置确定按钮的标题(Used In DetailRecord())
 **/
public  set btnSubmit_d_gs_PaperVer(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Detail, "btnSubmit_d_gs_PaperVer", value);
}
 /**
 * 审核人 (Used In ShowDetailDataFromClass())
 **/
public  set checker_d(value: string) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblChecker_d", value);
}
 /**
...
public  set isChecked_d(value: boolean) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblIsChecked_d", value.toString());
}
 /**
 * 是否引用论文 (Used In ShowDetailDataFromClass())
 **/
public  set isQuotethesis_d(value: boolean) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblIsQuotethesis_d", value.toString());
}
 /**
...
public  set literatureLink_d(value: string) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblLiteratureLink_d", value);
}
 /**
...
public  set literatureTypeId_d(value: string) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblLiteratureTypeId_d", value);
}
 /**
...
public  set paperStatusId_d(value: string) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblPaperStatusId_d", value);
}
 /**
...
public  set paperTypeId_d(value: string) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblPaperTypeId_d", value);
}
 /**
...
public  set quoteId_d(value: string) {
 SetLabelHtmlByIdInDiv(this.divName4Detail, "lblQuoteId_d", value);
}
 /**
