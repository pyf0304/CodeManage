 ...
 **/
//import $ from "jquery";
import { vgs_PaperParagraph_GetRecCountByCondAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { vgs_PaperParagraph_GetObjLstAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { vgs_PaperParagraph_GetRecCountByCond_Cache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { vgs_PaperParagraph_GetSubObjLst_Cache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_ReOrderAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GoBottomAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_DownMoveAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_UpMoveAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GoTopAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_DelRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GetObjByParagraphIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { clsvgs_PaperParagraphEN } from "../../TS/L0_Entity/GraduateEduPaper/clsvgs_PaperParagraphEN.js";
import { clsvgs_PaperParagraphENEx } from "../../TS/L0_Entity/GraduateEduPaper/clsvgs_PaperParagraphENEx.js";
import { vgs_PaperParagraphEx_FuncMapByFldName } from "../../TS/L3_ForWApiEx/GraduateEduPaper/clsvgs_PaperParagraphExWApi.js";
import { vgs_PaperParagraph_GetObjLstByPagerAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { vgs_PaperParagraph_SortFun_Defa } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { vgs_PaperParagraph_GetObjLstByPager_Cache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GetObjLstByParagraphIdLstAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_GetMaxStrIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
import { gs_PaperParagraph_Delgs_PaperParagraphsAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperParagraphWApi.js";
...
{
public static objPage_CRUD: gs_PaperParagraphCRUD;
 ...
 **/
public CombineData(arrvgs_PaperParagraphObjLst: Array<clsvgs_PaperParagraphEN>, arrDataColumn: Array<clsDataColumn>) 
{
...
const strFileName = Format("论文段落表({0})导出.xlsx",
 clsvgs_PaperParagraphEN._CurrTabName);
 ...
 **/
public async ExportExcel_vgs_PaperParagraph() 
{
const strThisFuncName = this.ExportExcel_vgs_PaperParagraph.name;
if (gs_PaperParagraphCRUD.sortvgs_PaperParagraphBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvgs_PaperParagraphBy)为空，请检查！(In BindGv_vgs_PaperParagraph_Cache)");
console.error(strMsg);
alert(strMsg);
return;
}
...
try
{
this.recCount = await vgs_PaperParagraph_GetRecCountByCondAsync(strWhereCond);
if (this.recCount == 0)
{
 ...
 **/
public async ExportExcel_vgs_PaperParagraph_Cache() 
{
...
{
const lblMsg: HTMLSpanElement = < HTMLSpanElement > document.createElement("span");
lblMsg.innerHTML = Format("根据条件:[{0}]获取的对象列表数为0！", objvgs_PaperParagraph_Cond.whereCond);
const divDataLst: HTMLDivElement = <HTMLDivElement> document.getElementById("divDataLst");
if (divDataLst != null)
{
divDataLst.innerText = "";
...
const strMsg = Format("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvgs_PaperParagraph_Cond.whereCond);
console.error("Error: ", strMsg);
//console.trace();
alert(strMsg);
return;
}
arrvgs_PaperParagraphObjLst = await vgs_PaperParagraph_GetSubObjLst_Cache(objvgs_PaperParagraph_Cond);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
...
try
{
const objgs_PaperParagraphEN = await gs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId);
...
{
strWhereCond += Format(" And {0} like '% {1}%'", clsvgs_PaperParagraphEN.con_ParagraphContent, this.paragraphContent_q);
}
}
catch(objException)
{
const strMsg:string = Format("(errid:WiTsCs0009)在组合查询条件(Combinegs_PaperParagraphCondition)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
return strWhereCond;
}
...
{
const strMsg:string = Format("(errid:WiTsCs0010)在组合查询条件对象(Combinegs_PaperParagraphConditionObj)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
...
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
const objvgs_PaperParagraph_Cond = new clsvgs_PaperParagraphENEx();
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
try
{
if ( this.paragraphContent_q != "")
...
{
const strMsg:string = Format("(errid:WiTsCs0013)在组合导出Excel条件对象(Combinegs_PaperParagraphConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
throw strMsg;
}
objvgs_PaperParagraph_Cond.whereCond = strWhereCond;
return objvgs_PaperParagraph_Cond;
 ...
 **/
public async BindTab_vgs_PaperParagraph(divContainer: string, arrvgs_PaperParagraphObjLst: Array<clsvgs_PaperParagraphEN>) 
{
...
await BindTab_V(o, arrvgs_PaperParagraphObjLst, arrDataColumn,  clsvgs_PaperParagraphEN.con_ParagraphId, this); 
 ...
 **/
public async ExtendFldFuncMap(arrvgs_PaperParagraphExObjLst: Array<clsvgs_PaperParagraphENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (gs_PaperParagraphCRUD.sortvgs_PaperParagraphBy == null)
{
const strMsg = Format("在显示列表时，排序字段(sortvgs_PaperParagraphBy)为空，请检查！(In BindGv_vgs_PaperParagraph)");
console.error(strMsg);
alert(strMsg);
return;
}
...
orderBy: gs_PaperParagraphCRUD.sortvgs_PaperParagraphBy,//如果该字段为空，就使用下面的排序函数
...
whereCond: strWhereCond,
orderBy: gs_PaperParagraphCRUD.sortvgs_PaperParagraphBy,//如果该字段为空，就使用下面的排序函数
sortFun: vgs_PaperParagraph_SortFun_Defa
}
arrvgs_PaperParagraphObjLst = await vgs_PaperParagraph_GetObjLstByPager_Cache(objPagerPara);
}
catch(e)
{
const strMsg = Format("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
 ...
 * @returns 返回两个对象比较的结果
 **/
public SortFun_ExportExcel(a:clsvgs_PaperParagraphEN , b:clsvgs_PaperParagraphEN): number 
{
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, gs_PaperParagraphCRUD.ascOrDesc4SortFun, gs_PaperParagraphCRUD.sortvgs_PaperParagraphBy, strSortExpress);
...
try
{
const arrgs_PaperParagraphObjLst = await gs_PaperParagraph_GetObjLstByParagraphIdLstAsync(arrParagraphId);
...
const strValue = GetInputValueInDiv(this.divName4Query, "txtParagraphContent_q");
...
public  set paragraphContent_q(value: string) {
 SetInputValueByIdInDiv(this.divName4Query, "txtParagraphContent_q", value);
}
 /**
