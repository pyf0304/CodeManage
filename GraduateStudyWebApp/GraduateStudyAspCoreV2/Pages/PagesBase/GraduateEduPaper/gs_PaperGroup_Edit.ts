...
import { gs_PaperGroup_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_AddNewRecordWithMaxIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_ReFreshCache } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_GetUniCondStr_PaperGroupName_UpdUser } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_GetUniCondStr4Update_PaperGroupName_UpdUser } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { clsgs_PaperGroupEN } from "../../TS/L0_Entity/GraduateEduPaper/clsgs_PaperGroupEN.js";
import { gs_PaperGroup_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_GetObjByPaperGroupIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
import { gs_PaperGroup_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js";
...
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_gs_PaperGroup");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_gs_PaperGroup");
...
this.iShowList.BindGv(clsgs_PaperGroupEN._CurrTabName, returnKeyId);
}
}
else
{
...
this.iShowList.BindGv(clsgs_PaperGroupEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
...
try
{
const returnString = await gs_PaperGroup_GetMaxStrIdAsync();
if (returnString == "")
{
const strInfo = Format("获取表gs_PaperGroup的最大关键字为空，不成功，请检查!");
//显示信息框
alert(strInfo);
}
else
...
pobjgs_PaperGroupEN.SetUpdUser(clsPublocalStorage.userId);// 修改人
pobjgs_PaperGroupEN.SetOrderNum(this.orderNum);// 序号
pobjgs_PaperGroupEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1));// 修改日期
...
const objgs_PaperGroupEN = new clsgs_PaperGroupEN();
try
{
...
let returnBool = false;
const returnKeyId = await gs_PaperGroup_AddNewRecordWithMaxIdAsync(objgs_PaperGroupEN);
if (IsNullOrEmpty(returnKeyId) == false)
{
returnBool = true;
}
if (returnBool == true)
{
gs_PaperGroup_ReFreshCache(gs_PaperGroup_Edit.UpdUser_Cache);
 ...
 **/
public async CheckUniCond4Add_PaperGroupName_UpdUser(objgs_PaperGroupEN: clsgs_PaperGroupEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_PaperGroupName_UpdUser.name;
const strUniquenessCondition = gs_PaperGroup_GetUniCondStr_PaperGroupName_UpdUser(objgs_PaperGroupEN);
const bolIsExistCondition = await gs_PaperGroup_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_PaperGroupName_UpdUser(objgs_PaperGroupEN: clsgs_PaperGroupEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_PaperGroupName_UpdUser.name;
const strUniquenessCondition = gs_PaperGroup_GetUniCondStr4Update_PaperGroupName_UpdUser(objgs_PaperGroupEN);
const bolIsExistCondition = await gs_PaperGroup_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
const strThisFuncName = this.ShowData.name;
        ...
        try {
            const returnBool = await gs_PaperGroup_IsExistAsync(strPaperGroupId);
            if (returnBool == false) {
                const strInfo = Format("关键字:[{0}] 的记录不存在!", strPaperGroupId);
...
console.error(strMsg);
        ...
        try {
const objgs_PaperGroupEN_Const = await gs_PaperGroup_GetObjByPaperGroupIdAsync(strPaperGroupId);
...
const returnBool = await gs_PaperGroup_UpdateRecordAsync(objgs_PaperGroupEN);
if (returnBool == true)
{
gs_PaperGroup_ReFreshCache(gs_PaperGroup_Edit.UpdUser_Cache);
}
...
public  set btnCancel_gs_PaperGroup(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_gs_PaperGroup", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_gs_PaperGroup():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_gs_PaperGroup");
return strValue;
}
 /**
...
public  set btnSubmit_gs_PaperGroup(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_gs_PaperGroup", value);
}
 /**
 * 备注 (Used In Clear())
 **/
...
public  set paperGroupId(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtPaperGroupId", value);
}
 /**
 * 组Id (Used In PutDataToClass())
 **/
public  get paperGroupId():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtPaperGroupId");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
...
public  set paperGroupName(value: string) {
 SetInputValueByIdInDiv(this.divName4Edit, "txtPaperGroupName", value);
}
 /**
 * 组名 (Used In PutDataToClass())
 **/
public  get paperGroupName():string {
const strValue = GetInputValueInDiv(this.divName4Edit, "txtPaperGroupName");
if (strValue == undefined) return "";
else return strValue.toString();
}
 /**
