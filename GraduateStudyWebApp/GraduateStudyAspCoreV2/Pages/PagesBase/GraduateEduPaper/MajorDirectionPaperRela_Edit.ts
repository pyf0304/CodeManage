 ...
 **/
//import $ from "jquery";
import { XzMajorDirection_BindDdl_MajorDirectionIdInDiv_Cache } from "../../TS/L3_ForWApi/BaseInfo_Share/clsXzMajorDirectionWApi.js";
...
import { MajorDirectionPaperRela_CheckPropertyNew } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_AddNewRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_GetUniCondStr_MajorDirectionId_PaperId } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_IsExistRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_GetUniCondStr4Update_MajorDirectionId_PaperId } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_IsExistAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_GetObjBymIdAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_CheckProperty4Update } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
import { MajorDirectionPaperRela_UpdateRecordAsync } from "../../TS/L3_ForWApi/GraduateEduPaper/clsMajorDirectionPaperRelaWApi.js";
...
public static objPage_Edit: MajorDirectionPaperRela_Edit;
public objMajorDirectionPaperRela: clsMajorDirectionPaperRelaEN;
...
this.objMajorDirectionPaperRela = new clsMajorDirectionPaperRelaEN();
}
 ...
 **/
public ShowDialog_MajorDirectionPaperRela(strOp:string) {
const strThisFuncName = this.ShowDialog_MajorDirectionPaperRela.name;
//检查相关控件是否存在
CheckControlExist(this.divName4Edit, "div", "divEditDialog_MajorDirectionPaperRela");
CheckControlExist(this.divName4Edit, "h4", "lblDialogTitle_MajorDirectionPaperRela");
...
public async SetDdl_MajorDirectionIdInDiv()
{
await XzMajorDirection_BindDdl_MajorDirectionIdInDiv_Cache(this.divName4Edit, "ddlMajorDirectionId", clsPublocalStorage.id_XzMajor );//
}
...
const strCommandText: string = this.btnSubmit_MajorDirectionPaperRela;
try {
...
this.iShowList.BindGv(clsMajorDirectionPaperRelaEN._CurrTabName, returnBool.toString());
}
}
break;
case "确认修改":
 ...
 **/
public async CheckUniCond4Add_MajorDirectionId_PaperId(objMajorDirectionPaperRelaEN: clsMajorDirectionPaperRelaEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Add_MajorDirectionId_PaperId.name;
const strUniquenessCondition = MajorDirectionPaperRela_GetUniCondStr_MajorDirectionId_PaperId(objMajorDirectionPaperRelaEN);
const bolIsExistCondition = await MajorDirectionPaperRela_IsExistRecordAsync(strUniquenessCondition);
 ...
 **/
public async CheckUniCond4Update_MajorDirectionId_PaperId(objMajorDirectionPaperRelaEN: clsMajorDirectionPaperRelaEN): Promise<boolean>{
const strThisFuncName = this.CheckUniCond4Update_MajorDirectionId_PaperId.name;
const strUniquenessCondition = MajorDirectionPaperRela_GetUniCondStr4Update_MajorDirectionId_PaperId(objMajorDirectionPaperRelaEN);
const bolIsExistCondition = await MajorDirectionPaperRela_IsExistRecordAsync(strUniquenessCondition);
if (bolIsExistCondition == true)
{
const strMsg = Format("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
...
console.error(strMsg);
        ...
        try {
const objMajorDirectionPaperRelaEN_Const = await MajorDirectionPaperRela_GetObjBymIdAsync(lngmId);
...
const returnBool = await MajorDirectionPaperRela_UpdateRecordAsync(objMajorDirectionPaperRelaEN);
if (returnBool == true)
{
//MajorDirectionPaperRela_ReFreshCache();
}
 ...
 **/
public  set btnCancel_MajorDirectionPaperRela(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnCancel_MajorDirectionPaperRela", value);
}
 /**
 * 获取按钮的标题
 **/
public  get btnSubmit_MajorDirectionPaperRela():string {
const strValue = GetButtonHtmlInDiv(this.divName4Edit, "btnSubmit_MajorDirectionPaperRela");
return strValue;
}
 /**
 * 设置确定按钮的标题(Used In AddNewRecord())
 **/
public  set btnSubmit_MajorDirectionPaperRela(value: string) {
 SetButtonHtmlByIdInDiv(this.divName4Edit, "btnSubmit_MajorDirectionPaperRela", value);
}
 /**
 * 研究方向Id (Used In Clear())
 **/
public  set majorDirectionId(value: string) {
SetSelectValueByIdInDiv(this.divName4Edit, "ddlMajorDirectionId", value);
}
 /**
 * 研究方向Id (Used In PutDataToClass())
 **/
public  get majorDirectionId():string {
const strValue = GetSelectValueInDiv(this.divName4Edit, "ddlMajorDirectionId");
