...
import { PaperEx_CopyToEx, PaperEx_GetSubObjLstById_CurrEduCls_Cache } from "../TS/L3_ForWApiEx/GraduateEduPaper/clsPaperExWApi.js";
...
export class gs_PaperDiscussEx {
        ...
        try {
            if (clsPublocalStorage.userId != "") {
                ...
                if (clsPublocalStorage.id_CurrEduCls == "") {
                    const objResearchTopic = await ResearchTopic_GetFirstObjAsync(" topicId=" + $("#hidPubParentId").val());
    ...
    public async GetPaperData() {
     ...
     const   arrPaperObjLst = await PaperEx_GetSubObjLstById_CurrEduCls_Cache(objvPaper_Cond, strid_CurrEducls);
