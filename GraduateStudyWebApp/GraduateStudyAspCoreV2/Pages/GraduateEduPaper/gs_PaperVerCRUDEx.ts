 ...
 * 编程语言:TypeScript
 **/
import { gs_PaperVerCRUD } from "../PagesBase/GraduateEduPaper/gs_PaperVerCRUD.js";
import { gs_PaperVer_EditEx } from "./gs_PaperVer_EditEx.js";
 ...
 **/
export class gs_PaperVerCRUDEx extends gs_PaperVerCRUD implements IShowList
{
...
let objPage: gs_PaperVerCRUDEx;
if (gs_PaperVerCRUD.objPage_CRUD == null)
{
gs_PaperVerCRUD.objPage_CRUD = new gs_PaperVerCRUDEx();
objPage = <gs_PaperVerCRUDEx> gs_PaperVerCRUD.objPage_CRUD;
}
else
{
objPage = <gs_PaperVerCRUDEx> gs_PaperVerCRUD.objPage_CRUD;
}
const objPage_Edit:gs_PaperVer_EditEx = new gs_PaperVer_EditEx(objPage);
let strMsg = '';
