...
import { PaperCollectionLog_EditEx } from "./PaperCollectionLog_EditEx.js";
//import $ from "jquery";
...
if (PaperCollectionLogCRUD.objPage_CRUD == null)
{
PaperCollectionLogCRUD.objPage_CRUD = new PaperCollectionLogCRUDEx();
objPage = <PaperCollectionLogCRUDEx> PaperCollectionLogCRUD.objPage_CRUD;
}
else
{
objPage = <PaperCollectionLogCRUDEx> PaperCollectionLogCRUD.objPage_CRUD;
}
const objPage_Edit:PaperCollectionLog_EditEx = new PaperCollectionLog_EditEx(objPage);
let strMsg = '';
