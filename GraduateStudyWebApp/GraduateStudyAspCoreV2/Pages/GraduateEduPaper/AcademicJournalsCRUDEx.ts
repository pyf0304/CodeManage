...
//
//import * as QQ from "q";
import { AcademicJournalsCRUD } from "../PagesBase/GraduateEduPaper/AcademicJournalsCRUD.js";
import { AcademicJournals_ReFreshCache } from "../TS/L3_ForWApi/GraduateEduPaper/clsAcademicJournalsWApi.js";
import { AcademicJournalsEx_ImportDataFromCsv } from "../TS/L3_ForWApiEx/GraduateEduPaper/clsAcademicJournalsExWApi.js";
import { GetCheckedKeyIdsInDiv, GetFirstCheckedKeyIdInDiv } from "../TS/PubFun/clsCommFunc4Ctrl.js";
import { confirm_del, GetFirstCheckedKeyId } from "../TS/PubFun/clsCommFunc4Web.js";
...
import { AcademicJournals_EditEx } from "./AcademicJournals_EditEx.js";
   ...
   */
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        ...
        if (AcademicJournalsCRUD.objPage_CRUD == null) {
            AcademicJournalsCRUD.objPage_CRUD = new AcademicJournalsCRUDEx();
            objPage = <AcademicJournalsCRUDEx>AcademicJournalsCRUD.objPage_CRUD;
        }
        else {
            objPage = <AcademicJournalsCRUDEx>AcademicJournalsCRUD.objPage_CRUD;
        }
        const objPage_Edit: AcademicJournals_EditEx = new AcademicJournals_EditEx(objPage);
