...
* 编程语言:TypeScript
**/
import { SectionCRUD } from "../PagesBase/GraduateEduPaper/SectionCRUD.js";
...
export class SectionCRUDEx extends SectionCRUD implements IShowList {
    ...
    **/
    public static btn_Click(strCommandName: string, strKeyId: string) {
        let objPage: SectionCRUDEx;
        if (SectionCRUD.objPage_CRUD == null) {
            SectionCRUD.objPage_CRUD = new SectionCRUDEx();
            objPage = <SectionCRUDEx>SectionCRUD.objPage_CRUD;
        }
        else {
            objPage = <SectionCRUDEx>SectionCRUD.objPage_CRUD;
        }
        const objPage_Edit: Section_EditEx = new Section_EditEx(objPage);
        let strMsg = '';
