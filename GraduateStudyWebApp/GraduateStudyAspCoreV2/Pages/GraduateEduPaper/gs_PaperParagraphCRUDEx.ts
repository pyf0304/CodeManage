...
/*-- -- -- -- -- -- -- -- -- -- --
类名:gs_PaperParagraphCRUDEx(界面:gs_PaperParagraphCRUD)
表名:gs_PaperParagraph(01120744)
生成代码版本:2021.06.06.1
生成日期:2021/06/11 10:56:35
生成者:
工程名称:问卷调查
工程ID:0112
...
declare var $;
/* gs_PaperParagraphCRUDEx 的摘要说明。其中Q代表查询,U代表修改
 (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
*/
export class gs_PaperParagraphCRUDEx extends gs_PaperParagraphCRUD implements IShowList {
    //public static mstrListDiv: string = "divDataLst";
    //public static mstrSortvgs_PaperParagraphBy: string = "paragraphId";
    /*
    * 每页记录数，在扩展类可以修改
   */
    ...
    BindGv_Cache(strType: string, strPara: string) {
        switch (strType) {
            case "vgs_PaperParagraph":
                alert('该类没有绑定该函数：[this.BindGv_vgs_PaperParagraph_Cache]！');
                //this.BindGv_vgs_PaperParagraph_Cache();
                break;
            default:
    ...
    */
    public static btn_Click(strCommandName: string, strKeyId: string) {
        var objPage: gs_PaperParagraphCRUDEx = new gs_PaperParagraphCRUDEx();
        ...
        switch (strCommandName) {
            ...
            case "ReOrder":            //重序记录
                ...
                break;
            default:
                var strMsg = '命令:' + strCommandName + "在函数(gs_PaperParagraphCRUDExEx.btn_Click)中没有被处理！";
                alert(strMsg);
                break;
        }
    }
