...
import { MajorDirectionPaperRela_EditEx } from "./MajorDirectionPaperRela_EditEx.js";
//import $ from "jquery";
 /** MajorDirectionPaperRelaCRUDEx 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
 **/
export class MajorDirectionPaperRelaCRUDEx extends MajorDirectionPaperRelaCRUD implements IShowList
{
...
{
MajorDirectionPaperRelaCRUD.objPage_CRUD = new MajorDirectionPaperRelaCRUDEx();
objPage = <MajorDirectionPaperRelaCRUDEx> MajorDirectionPaperRelaCRUD.objPage_CRUD;
}
else
{
objPage = <MajorDirectionPaperRelaCRUDEx> MajorDirectionPaperRelaCRUD.objPage_CRUD;
