(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/DailyRunning_Share/CurrEduClsStuCRUD.js", "../TS/L0_Entity/DailyRunning_Share/clsvCurrEduClsEN.js", "../TS/L0_Entity/DailyRunning_Share/clsvCurrEduClsStuEN.js", "../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js", "./CurrEduClsStu_EditEx.js"], factory);
    }
       ...
       */
        async BindGv_vCurrEduCls() {
            ...
            try {
                ...
                arrvCurrEduClsObjLst = await (0, clsvCurrEduClsWApi_js_1.vCurrEduCls_GetObjLstByPagerAsync)(objPagerPara);
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
    ...
    */
        async BindTab_vCurrEduClsStu(divContainer, arrvCurrEduClsStuObjLst) {
            ...
            (0, clsCommFunc4Web_js_1.BindTab_V)(o, arrvCurrEduClsStuObjLst, arrDataColumn, "id_EduClsStu", this);
            this.objPager.recCount = this.recCount;
            this.objPager.pageSize = this.pageSize;
            this.objPager.ShowPagerV2(this, this.divName4Pager);
        }
