(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/BaseInfo_Share/clsTeacherInfoEN.js", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/L0_Entity/DailyRunning_Share/clsCurrEduClsTeacherEN.js", "../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsTeacherWApi.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsOperateList.js", "../PagesBase/BaseInfo_Share/TeacherInfoCRUD.js", "../TS/PubFun/clsPublocalStorage.js"], factory);
    }
       ...
       */
        async BindTab_TeacherInfo(divContainer, arrTeacherInfoObjLst) {
            ...
            var arrDataColumn = [
                ...
                {
                    fldName: "teacherID",
                    sortBy: "teacherID", sortFun: clsCommFunc4Web_js_1.SortFun, getDataSource: "",
                    colHeader: "教师Id",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "teacherName",
                    sortBy: "teacherName", sortFun: clsCommFunc4Web_js_1.SortFun, getDataSource: "",
                    colHeader: "教师姓名",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
            ...
            (0, clsCommFunc4Web_js_1.BindTab)(o, arrTeacherInfoObjLst, arrDataColumn, "id_Teacher", this);
    ...
    */
        async PutDataToCurrEduClsTeacher(pobjCurrEduClsTeacherEN, strid_Teacher) {
            var strCurrEduClsId = $('#hidCurrEduClsId').val();
            pobjCurrEduClsTeacherEN.Setid_CurrEduCls(strCurrEduClsId); // 教学班
            ...
            //    }
            //})
            pobjCurrEduClsTeacherEN.Setid_Teacher(strid_Teacher); // 老
            //pobjCurrEduClsTeacherEN.schoolTerm = this.schoolTerm;// 学期
            //pobjCurrEduClsTeacherEN.schoolYear = this.schoolYear;// 学年
            pobjCurrEduClsTeacherEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate_ymd()); // 
       ...
       */
        async BindGv_TeacherInfo() {
            ...
            try {
                this.recCount = await (0, clsTeacherInfoWApi_js_1.TeacherInfo_GetRecCountByCondAsync)(strWhereCond);
                var objPagerPara = {
