(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduPaper/PaperReadWriteCRUD.js", "./PaperReadWrite_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PaperReadWriteCRUDEx = void 0;
    /**
    * 类名:PaperReadWriteCRUDEx(界面:PaperReadWriteCRUD)
    * 表名:PaperReadWrite(01120547)
    * 版本:2023.01.04.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/06 01:16:29
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    const PaperReadWrite_EditEx_js_1 = require("./PaperReadWrite_EditEx.js");
    const clsCommFunc4Ctrl_js_1 = require("../TS/PubFun/clsCommFunc4Ctrl.js");
    const clsString_js_1 = require("../TS/PubFun/clsString.js");
    //import $ from "jquery";
    /** PaperReadWriteCRUDEx 的摘要说明。其中Q代表查询,U代表修改
    * (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    **/
    class PaperReadWriteCRUDEx extends PaperReadWriteCRUD_js_1.PaperReadWriteCRUD {
        //public static mstrListDiv = "divDataLst";
        //public static mstrSortvPaperReadWriteBy = "PaperRWId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (PaperReadWriteCRUD_js_1.PaperReadWriteCRUD.objPage_CRUD == null) {
                PaperReadWriteCRUD_js_1.PaperReadWriteCRUD.objPage_CRUD = new PaperReadWriteCRUDEx();
    ...
    exports.PaperReadWriteCRUDEx = PaperReadWriteCRUDEx;
});
