(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../GraduateEduEx/PaperSubViewpoint_pdf.js", "../PagesBase/GraduateEduPaper/PaperSubViewpoint_Edit.js", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperSubAttachmentEN.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperSubViewpointEN.js", "../TS/L0_Entity/ParameterTable/clsSubViewpointTypeEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js", "../TS/L3_ForWApi/ParameterTable/clsSubViewpointTypeWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsPaperSubViewpointExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PaperSubViewpoint_EditEx = void 0;
    /**
    * 类名:PaperSubViewpoint_EditEx(界面:PaperSubViewpointCRUD)
    * 表名:PaperSubViewpoint(01120534)
    * 版本:2023.01.04.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/06 15:02:09
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    * 编程语言:TypeScript
    **/
    const PaperSubViewpoint_pdf_js_1 = require("../GraduateEduEx/PaperSubViewpoint_pdf.js");
    const PaperSubViewpoint_Edit_js_1 = require("../PagesBase/GraduateEduPaper/PaperSubViewpoint_Edit.js");
    ...
    */
    class PaperSubViewpoint_EditEx extends PaperSubViewpoint_Edit_js_1.PaperSubViewpoint_Edit {
        /**
     ...
     */
        async PutDataToPaperSubViewpointClass(pobjPaperSubViewpointEN) {
            ...
            pobjPaperSubViewpointEN.Setid_CurrEduCls(clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls); //论文Id
            pobjPaperSubViewpointEN.SetUserId(clsPublocalStorage_js_1.clsPublocalStorage.userId); //论文Id
            ...
            pobjPaperSubViewpointEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改用户Id
            //pobjPaperSubViewpointEN.SetUpdUser(clsPublocalStorage.userId;// 修改用户Id
            pobjPaperSubViewpointEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate()); // 修改日期
    ...
    **/
        ...
        async btnAddNewRecord_Click() {
            this.opType = "Add";
            try {
                if ((0, clsString_js_1.IsNullOrEmpty)(this.subViewpointTypeId) == true)
                    this.subViewpointTypeId = clsSubViewpointTypeEN_js_1.enumSubViewpointType.QuestioningProcess_00000001;
        ...
        async selectTitle_Click() {
            ...
            try {
                ...
                const objSubViewpointType = await (0, clsSubViewpointTypeWApi_js_1.SubViewpointType_GetFirstObjAsync)(strWhereCond);
      ...
      */
        async btnSubmit_Click() {
            ...
            var strCommandText = this.btnSubmit_PaperSubViewpoint;
            let returnBool;
            try {
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        if (returnBool == true) {
                            ...
                            this.iShowList.BindGv(clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN._CurrTabName, "");
                        }
                        //var returnBool: boolean = jsonData;
                        //if (returnBool == true) {
                        //    HideDialog();
     ...
     */
        async AddNewRecordSaves() {
            ...
            try {
                if ((0, clsString_js_1.IsNullOrEmpty)(objPaperSubViewpointEN.paperRWId) == true)
                ...
                const strUniCondition = (0, clsPaperSubViewpointWApi_js_1.PaperSubViewpoint_GetUniCondStr_PaperRWId_SubViewpointTypeId_SubViewpointContent)(objPaperSubViewpointEN);
                const bolIsExist = await (0, clsPaperSubViewpointWApi_js_1.PaperSubViewpoint_IsExistRecordAsync)(strUniCondition);
                if (bolIsExist == true) {
                    var strMsg = `详情内容:[${objPaperSubViewpointEN.subViewpointContent}]已经存在，不能再添加！`;
                    alert(strMsg);
    ...
    */
       ...
       */
        async ddlSubViewpointTypeId_SelectedIndexChanged() {
            ...
            if ((0, clsString_js_1.IsNullOrEmpty)(strSubViewpointTypeId) == false)
                this.selectTitle_Click();
        }
        /*
     提交编辑
    ...
    */
        mySubmit(pstrOp) {
            ...
            if ($("#hidUserInfo").val() != "") {
                if ((0, clsString_js_1.IsNullOrEmpty)(this.shareId) == true || this.shareId == "0") {
                    alert('分享不能为空!');
                    return;
                }
                else {
                    ...
                    //if (bolIsExist == false) {
                    let objPage = new PaperSubViewpoint_pdf_js_1.PaperSubViewpoint_pdf();
                    const objPage_Edit = new PaperSubViewpoint_EditEx(objPage);
    ...
    exports.PaperSubViewpoint_EditEx = PaperSubViewpoint_EditEx;
});
