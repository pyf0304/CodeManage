(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduPaper/MajorDirectionPaperRelaCRUD.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js", "./MajorDirectionPaperRela_EditEx.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MajorDirectionPaperRelaCRUDEx = void 0;
    /**
    * 类名:MajorDirectionPaperRelaCRUDEx(界面:MajorDirectionPaperRelaCRUD)
    * 表名:MajorDirectionPaperRela(01120554)
    * 版本:2023.01.04.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/06 01:10:15
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    const MajorDirectionPaperRela_EditEx_js_1 = require("./MajorDirectionPaperRela_EditEx.js");
    //import $ from "jquery";
    /** MajorDirectionPaperRelaCRUDEx 的摘要说明。其中Q代表查询,U代表修改
    * (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    **/
    class MajorDirectionPaperRelaCRUDEx extends MajorDirectionPaperRelaCRUD_js_1.MajorDirectionPaperRelaCRUD {
        //public static mstrListDiv = "divDataLst";
        //public static mstrSortvMajorDirectionPaperRelaBy = "mId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (MajorDirectionPaperRelaCRUD_js_1.MajorDirectionPaperRelaCRUD.objPage_CRUD == null) {
                MajorDirectionPaperRelaCRUD_js_1.MajorDirectionPaperRelaCRUD.objPage_CRUD = new MajorDirectionPaperRelaCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(MajorDirectionPaperRelaCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.MajorDirectionPaperRelaCRUDEx = MajorDirectionPaperRelaCRUDEx;
});
