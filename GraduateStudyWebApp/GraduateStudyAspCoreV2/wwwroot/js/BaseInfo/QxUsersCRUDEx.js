(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/BaseInfo_Share/QxUsersCRUD.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
    ...
    class QxUsersCRUDEx extends QxUsersCRUD_js_1.QxUsersCRUD {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            let objPage;
            if (QxUsersCRUD_js_1.QxUsersCRUD.objPage_CRUD == null) {
                QxUsersCRUD_js_1.QxUsersCRUD.objPage_CRUD = new QxUsersCRUDEx();
                objPage = QxUsersCRUD_js_1.QxUsersCRUD.objPage_CRUD;
            }
            else {
                objPage = QxUsersCRUD_js_1.QxUsersCRUD.objPage_CRUD;
            }
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(QxUsersCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
