(function (factory) {
    ...
    exports.Paper_ListEx_CurrEduCls = void 0;
    ...
    */
    class Paper_ListEx_CurrEduCls extends PaperCRUD_js_1.PaperCRUD {
        constructor() {
      ...
      */
        ...
        async BindGv_PaperEduCls() {
            ...
            try {
                ...
                const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindList_Paper)("2", "divCurrEduClsDataLst", arrPaperExObjLst);
                this.objPager.recCount = this.recCount;
                this.objPager.pageSize = this.pageSize;
                this.objPager.ShowPagerV2(this, this.divName4Pager);
    ...
    */
    ...
    exports.Paper_ListEx_CurrEduCls = Paper_ListEx_CurrEduCls;
});
