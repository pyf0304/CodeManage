(function (factory) {
    ...
    exports.Paper_ListEx_AllPaper = void 0;
    ...
    /* Paper_ListEx_AllPaper 的摘要说明。其中Q代表查询,U代表修改
     (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    */
    class Paper_ListEx_AllPaper extends PaperCRUD_js_1.PaperCRUD {
        constructor() {
                ...
                if (strid_CurrEducls == "00000050") //私有空间
                 {
                    //arrPaperExObjLst = arrvPaperObjLst0.filter(x => x.id_CurrEduCls != "00000050");
                    //const gvResultPaper = await this.BindList_vPaper("1", arrPaperExObjLst);
                    const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindList_Paper)("1", "divDataLst", arrPaperObjLst0);
                }
                else {
                    const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindList_Paper)("1", "divDataLst", arrPaperObjLst0);
                }
    ...
    */
    ...
    exports.Paper_ListEx_AllPaper = Paper_ListEx_AllPaper;
});
