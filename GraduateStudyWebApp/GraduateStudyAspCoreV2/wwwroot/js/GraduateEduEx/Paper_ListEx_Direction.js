(function (factory) {
    ...
    exports.Paper_ListEx_Direction = void 0;
    ...
    /* Paper_ListEx_Direction 的摘要说明。其中Q代表查询,U代表修改
     (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    */
    class Paper_ListEx_Direction extends PaperCRUD_js_1.PaperCRUD {
        constructor() {
      ...
      */
        async Page_Load() {
            ...
            try {
                ...
                if (clsPublocalStorage_js_1.clsPublocalStorage.userId != "") {
                    ...
                    const gvResult = await this.BindGv_PaperDirection();
       ...
       */
        ...
        //  }
        //绑定本方向
        async BindGv_PaperDirection() {
            //var strListDiv: string = this.mstrListDivDirection;
            var strWhereCond = await this.CombinevPaperCondition();
            //通过登录的用户得到用户专业
            var strMajorDirectionId = clsPublocalStorage_js_1.clsPublocalStorage.majorDirectionId;
            ...
            try {
                ...
                const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindList_Paper)("3", "divDataLstDirection", arrPaperExObjLst);
                this.objPager.recCount = this.recCount;
                this.objPager.pageSize = this.pageSize;
                this.objPager.ShowPagerV2(this, this.divName4Pager);
    ...
    */
    ...
    exports.Paper_ListEx_Direction = Paper_ListEx_Direction;
});
