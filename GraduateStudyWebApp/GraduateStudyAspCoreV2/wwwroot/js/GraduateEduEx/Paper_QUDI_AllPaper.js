(function (factory) {
    ...
    exports.Paper_QUDI_AllPaper = void 0;
    ...
    */
    class Paper_QUDI_AllPaper extends PaperCRUD_js_1.PaperCRUD {
        constructor() {
     ...
     */
        async BindGv_vPaperBak() {
            ...
            //var objvPaper_Cond: clsPaperEN = this.CombinePaperConditionobj();
            ////objvPaper_Cond.SetCondFldValue(clsPaperEN.con_id_XzMajor, this.id_XzMajor_q, "=");
                ...
                if (strid_CurrEducls == "00000050") //私有空间
                 {
                    //arrPaperExObjLst = arrvPaperObjLst0.filter(x => x.id_CurrEduCls != "00000050");
                    //const gvResultPaper = await this.BindList_vPaper("1", arrPaperExObjLst);
                    const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindTab_Paper)(this.divName4DataList, arrPaperObjLst0, this);
                }
                else {
                    const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindTab_Paper)(this.divName4DataList, arrPaperObjLst0, this);
                }
    ...
    */
    ...
    exports.Paper_QUDI_AllPaper = Paper_QUDI_AllPaper;
});
