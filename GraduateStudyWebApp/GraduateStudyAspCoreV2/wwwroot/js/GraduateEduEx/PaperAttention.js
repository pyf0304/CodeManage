(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduPaper/clsgs_PaperAttentionEN.js", "../TS/L0_Entity/GraduateEduPaper/clsgs_PaperGroupEN.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperSubViewpointEN.js", "../TS/L0_Entity/GraduateEduPaper/clsSectionEN.js", "../TS/L0_Entity/GraduateEduPaper/clsvPaperSubViewpointEN.js", "../TS/L0_Entity/InteractManage/clsSysVoteEN.js", "../TS/L0_Entity/ParameterTable/clsSubViewpointTypeEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperAttentionWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubAttachmentWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperSubViewpointWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsSectionWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvgs_PaperAttentionWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsgs_TagsTypeWApi.js", "../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js", "../TS/L3_ForWApi/InteractManage/clsSysVoteWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_AnswerWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_QuestionsWApi.js", "../TS/L3_ForWApi/ParameterTable/clsSubViewpointTypeWApi.js", "../TS/L3_ForWApi/UserManage_Share/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEduPaper/clsvPaperSubViewpointExWApi.js", "../TS/L3_ForWApiEx/GraduateEduPaper/clsvgs_PaperAttentionExWApi.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubConfig/clsSysPara4WebApi.js", "../TS/PubFun/clsString.js", "../TS/L3_ForWApiEx/GraduateEduPaper/clsPaperExWApi.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PaperAttention = void 0;
    ...
    const clsvgs_PaperAttentionExWApi_js_1 = require("../TS/L3_ForWApiEx/GraduateEduPaper/clsvgs_PaperAttentionExWApi.js");
    ...
    */
    class PaperAttention {
       ...
       */
        ...
        async li_PaperAttentionTab_Click() {
        ...
        //论文组
        async BindDdl_PaperGroupId(ddlPaperGroupId) {
            //var strWhereCond = " updUser='" + clsPublocalStorage.userId + "' order by updDate Asc";
            ...
            try {
                ...
                var arrObjLst_Sel = await (0, clsgs_PaperGroupWApi_js_1.gs_PaperGroup_GetObjLst_Cache)(strUserId);
                arrObjLst_Sel = arrObjLst_Sel.sort(x => x[clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId]);
                (0, clsCommFunc4Web_js_1.BindDdl_ObjLst)(ddlPaperGroupId, arrObjLst_Sel, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupName, "论文组");
        ...
        //关注论文树
        async PaperAttentionTree() {
            var strUserId = clsPublocalStorage_js_1.clsPublocalStorage.userId;
            var strWhereCond1 = " updUser='" + strUserId + "'";
            var strWhereCond2 = " userId='" + strUserId + "'";
            //声明主题变量
            var arrgs_PaperGroupObjLst = [];
            var arrvgs_PaperAttentionObjLst0 = [];
            var arrvgs_PaperIdNumObjLst = [];
            var arrvgs_PaperAttentionObjLst = [];
            ...
            //});
            arrgs_PaperGroupObjLst = await (0, clsgs_PaperGroupWApi_js_1.gs_PaperGroup_GetObjLst_Cache)(strUserId);
            if ($("#hidMyResearch").val() == 1) {
                arrvgs_PaperIdNumObjLst = await (0, clsvgs_PaperAttentionExWApi_js_1.vgs_PaperAttentionEx_GetPaperIdNumObjLstAsync)(strWhereCond1);
                var arrPaperId = "";
                if (arrvgs_PaperIdNumObjLst.length > 0) {
                    ...
                    var strWhereCond3 = " paperId in(" + arrPaperId + ") and userId='" + clsPublocalStorage_js_1.clsPublocalStorage.userId + "'";
                    arrvgs_PaperAttentionObjLst0 = await (0, clsvgs_PaperAttentionWApi_js_1.vgs_PaperAttention_GetObjLstAsync)(strWhereCond3);
                }
            }
            else {
                ...
                //});
                arrvgs_PaperAttentionObjLst0 = await (0, clsvgs_PaperAttentionWApi_js_1.vgs_PaperAttention_GetObjLst_Cache)(strUserId);
            }
            var strhtml = "";
            if (arrgs_PaperGroupObjLst.length > 0) {
                for (var i = 0; i < arrgs_PaperGroupObjLst.length; i++) {
                    ...
                    for (var j = 0; j < arrvgs_PaperAttentionObjLst.length; j++) {
                        ...
                        strhtml += '<li id="' + strPaperId + '" onclick=btnSelectPaper("' + strPaperId + '",' + arrvgs_PaperAttentionObjLst[j].paperAttentionId + ',"' + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + '")>';
                        //默认存放第一条数据显示；
                        //判断存放的id控件是否为空；
                        if ($("#hidPaperId").val() == "") {
                            //存放Id
                        ...
                        //strhtml += '<a href="#" onclick=UpdatePaperSubVer_Click("' + arrvgs_PaperAttentionObjLst[j].paperId + '","' + arrvgs_PaperAttentionObjLst[j].id_CurrEduCls + '","02")><i class="layui-icon layui-icon-list" style="font-size:16px; color: #219167;" title="pdf查看论文子观点" ></i></a>';
                        strhtml += '</div>';
                        strhtml += '</li>';
                    }
                    strhtml += '</ul>';
     ...
     */
      ...
      */
        DelRecord(lngPaperAttentionId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsgs_PaperAttentionWApi_js_1.gs_PaperAttention_DelRecordAsync)(lngPaperAttentionId).then((jsonData) => {
        ...
        async SubmitUpdateGroup_Click() {
            var strCommandText = $('#btnEditGroup').html();
            try {
        ...
        //添加组名
        async AddGroup_Click() {
            try {
                var strUserId = clsPublocalStorage_js_1.clsPublocalStorage.userId;
                var objgs_PaperGroupEN = new clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN();
                objgs_PaperGroupEN.SetPaperGroupName($("#txtPaperGroupName").val());
                ...
                console.error('catch(e)=');
                console.error(e);
                var strMsg = `组名添加不成功. ${e}.`;
                alert(strMsg);
            }
        }
        //修改组名
        async UpdateGroup_Click() {
            ...
            try {
                ...
                console.error('catch(e)=');
                console.error(e);
                var strMsg = `组名修改不成功. ${e}.`;
                alert(strMsg);
            }
        }
        //提交调整关注的论文组
        async SubmitPaperGroup_Click() {
            ...
            try {
                ...
                objgs_PaperAttentionEN.SetPaperGroupId($('#ddlPaperGroupId').val());
                ...
                const responseText = await (0, clsgs_PaperAttentionWApi_js_1.gs_PaperAttention_UpdateRecordAsync)(objgs_PaperAttentionEN);
                var returnBool = !!responseText;
                if (returnBool == true) {
                    //刷新缓存
                    var strUserId = clsPublocalStorage_js_1.clsPublocalStorage.userId;
        ...
        async Bind_PaperSubViewpoint() {
            ...
            try {
                ...
                //this.recCount= await vPaperSubViewpoint_GetRecCountByCondAsync(strWhereCond3).then((jsonData) => {
                //});
                ...
                //    //}
                //}
                strhtml += '<a style="float:left;" href="#" onclick=UpdatePaperSubVer_Click("01")><i class="layui-icon layui-icon-edit" style="font-size:16px; color: #0080ff;" title="维护论文子观点" ></i>维护论文子观点</a>';
                strhtml += '<a href="#" onclick=UpdatePaperSubVer_Click("02")><i class="layui-icon layui-icon-list" style="font-size:16px; color: #219167;" title="查看论文子观点" ></i>查看论文子观点</a>';
                strhtml += '</div></td></tr>';
        ...
        async Bind_PaperQA() {
            ...
            try {
                const responseText0 = await (0, clsvqa_QuestionsWApi_js_1.vqa_Questions_GetObjLstAsync)(strWhereCond).then((jsonData) => {
    ...
    exports.PaperAttention = PaperAttention;
});
