(function (factory) {
    ...
    exports.Paper_ListEx_Major = void 0;
    ...
    /* Paper_ListEx_Major 的摘要说明。其中Q代表查询,U代表修改
     (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    */
    class Paper_ListEx_Major extends PaperCRUD_js_1.PaperCRUD {
        constructor() {
      ...
      */
        async Page_Load() {
            // 在此处放置用户代码以初始化页面
            try {
                this.divName4Pager = "divPager_Major";
                ...
                if (clsPublocalStorage_js_1.clsPublocalStorage.userId != "") {
                    ...
                    const gvResult = await this.BindGv_PaperMajor();
      ...
      */
        ...
        async BindGv_PaperMajor() {
            ...
            try {
                ...
                const gvResultPaper = await (0, clsPaperExWApi_js_1.PaperEx_BindList_Paper)("2", "divDataLstMajor", arrPaperExObjLst);
                this.objPager.recCount = this.recCount;
                this.objPager.pageSize = this.pageSize;
                this.objPager.ShowPagerV2(this, this.divName4Pager);
    ...
    */
    ...
    exports.Paper_ListEx_Major = Paper_ListEx_Major;
});
