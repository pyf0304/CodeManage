(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/UserManage_Share/StudentInfoCRUD.js", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/FunClass_Share/clsPubVar4Web.js", "../TS/L0_Entity/DailyRunning_Share/clsCurrEduClsStuEN.js", "../TS/L0_Entity/UserManage_Share/clsStudentInfoEN.js", "../TS/L0_Entity/UserManage_Share/clsvStudentInfoEN.js", "../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../TS/L3_ForWApi/UserManage_Share/clsStudentInfoWApi.js", "../TS/L3_ForWApi/UserManage_Share/clsvStudentInfoWApi.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js"], factory);
    }
        ...
        static btn_Click(strCommandName, strKeyId) {
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    var strMsg = '命令:' + strCommandName + "在函数(StudentInfoCRUDEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
        ...
        async btnExportExcel_Click() {
            ...
            try {
                const responseText = await (0, clsvStudentInfoWApi_js_1.vStudentInfo_GetObjLstAsync)(strWhereCond).then((jsonData) => {
                    ...
                    this.BindTab_vStudentInfo(this.divName4List, arrvStudentInfoObjLst);
                });
            }
            catch (e) {
                console.log('catch(e)=');
       ...
       */
        async BindTab_vStudentInfo(divContainer, arrvStudentInfoObjLst) {
            ...
            var arrDataColumn = [
                ...
                {
                    fldName: "stuID",
                    sortBy: "stuID", getDataSource: "", sortFun: clsPubVar4Web_js_1.clsPubVar4Web.sortFun,
                    colHeader: "学号",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "stuName",
                    sortBy: "stuName", getDataSource: "", sortFun: clsPubVar4Web_js_1.clsPubVar4Web.sortFun,
                    colHeader: "姓名",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "SexDesc",
                    sortBy: "SexDesc", getDataSource: "", sortFun: clsPubVar4Web_js_1.clsPubVar4Web.sortFun,
                    colHeader: "性别名称",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
                ...
                {
                    fldName: "collegeName",
                    sortBy: "collegeName", getDataSource: "", sortFun: clsPubVar4Web_js_1.clsPubVar4Web.sortFun,
                    colHeader: "学院名称",
                    text: "",
                    tdClass: "text-left",
                    columnType: "Label",
            ...
            await (0, clsCommFunc4Web_js_1.BindTab_V)(o, arrvStudentInfoObjLst, arrDataColumn, "id_StudentInfo", this);
    ...
    */
        async PutDataToCurrEduClsStu(pobjCurrEduClsStuEN, strid_Stu) {
            ...
            pobjCurrEduClsStuEN.modifyDate = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate_ymd(); // 
       ...
       */
        async BindGv_vStudentInfo() {
            ...
            try {
                const responseRecCount = await (0, clsvStudentInfoWApi_js_1.vStudentInfo_GetRecCountByCondAsync)(strWhereCond).then((jsonData) => {
