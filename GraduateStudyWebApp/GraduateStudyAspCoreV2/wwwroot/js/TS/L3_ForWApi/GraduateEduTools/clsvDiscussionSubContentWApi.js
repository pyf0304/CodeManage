...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTools/clsvDiscussionSubContentEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vDiscussionSubContent_GetObjBySubContentIdAsync(strSubContentId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strSubContentId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strSubContentId]不能为空！(In clsvDiscussionSubContentWApi.GetObjBySubContentIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubContentId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strSubContentId]的长度:[{0}]不正确！(clsvDiscussionSubContentWApi.GetObjBySubContentIdAsync)", strSubContentId.length);
            console.error(strMsg);
            throw (strMsg);
        }
