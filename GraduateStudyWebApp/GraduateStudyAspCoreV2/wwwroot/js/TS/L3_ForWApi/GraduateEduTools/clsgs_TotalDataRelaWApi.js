...
(function (factory) {
    ...
    **/
    async function gs_TotalDataRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_TotalDataRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TotalDataRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TotalDataRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TotalDataRela_GetObjBymId_Cache(lngmId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_TotalDataRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_TotalDataRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_TotalDataRela_Const = await gs_TotalDataRela_GetObjBymIdAsync(lngmId);
                    if (objgs_TotalDataRela_Const != null) {
                        gs_TotalDataRela_ReFreshThisCache(strid_CurrEduCls);
                        return objgs_TotalDataRela_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_TotalDataRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_TotalDataRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_TotalDataRela_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsgs_TotalDataRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsgs_TotalDataRelaWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_TotalDataRela == null)
            return "";
        if (objgs_TotalDataRela.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TdRelaTypeId:
                    return (a, b) => {
                        if (a.tdRelaTypeId == null)
                            return -1;
                        if (b.tdRelaTypeId == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_TotalDataRela_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsgs_TotalDataRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsgs_TotalDataRelaWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_mId) {
        ...
        const arrgs_TotalDataRela = await gs_TotalDataRela_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrgs_TotalDataRela == null)
            return [];
        let arrgs_TotalDataRela_Sel = arrgs_TotalDataRela;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_TotalDataRela_Sel = arrgs_TotalDataRela_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_TotalDataRela_Sel = arrgs_TotalDataRela_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_TotalDataRela_Sel = arrgs_TotalDataRela_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_TotalDataRela_Sel = arrgs_TotalDataRela_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrgs_TotalDataRela_Sel.length == 0)
            return [];
        return arrgs_TotalDataRela_Sel.map(x => x.mId);
    }
    exports.gs_TotalDataRela_funcKey = gs_TotalDataRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_TotalDataRela_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TotalDataRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_TotalDataRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TotalDataRela_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_TotalDataRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TotalDataRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_TotalDataRela_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TotalDataRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_TotalDataRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TotalDataRela_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsgs_TotalDataRelaWApi.gs_TotalDataRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsgs_TotalDataRelaWApi.gs_TotalDataRela_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_TotalDataRela_Sel = arrgs_TotalDataRela_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_TotalDataRela_UpdateRecordAsync(objgs_TotalDataRelaEN) {
        ...
        if (objgs_TotalDataRelaEN.sf_UpdFldSetStr === undefined || objgs_TotalDataRelaEN.sf_UpdFldSetStr === null || objgs_TotalDataRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TotalDataRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TotalDataRela_Controller, strAction);
        try {
    ...
    */
    async function gs_TotalDataRela_IsExistRecord_Cache(objgs_TotalDataRela_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TotalDataRela_Cond), exports.gs_TotalDataRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TotalDataRela_IsExist_Cache(lngmId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_TotalDataRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_TotalDataRela_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_TotalDataRelaWApi.clsgs_TotalDataRelaWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsgs_TotalDataRelaWApi.clsgs_TotalDataRelaWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_TotalDataRela_CheckPropertyNew(pobjgs_TotalDataRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.id_CurrEduCls) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.totalDataId1) === true) {
            throw new Error("(errid:Watl000058)字段[TotalDataId1]不能为空(In 各观点总数据关系表)!(clsgs_TotalDataRelaBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.totalDataId2) === true) {
            throw new Error("(errid:Watl000058)字段[TotalDataId2]不能为空(In 各观点总数据关系表)!(clsgs_TotalDataRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.tdRelaTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.tdRelaTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.totalDataId1) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.totalDataId1) > 12) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.totalDataId2) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TotalDataRelaEN.totalDataId2) > 12) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_TotalDataRelaEN.mId && undefined !== pobjgs_TotalDataRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_TotalDataRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.id_CurrEduCls) == false && undefined !== pobjgs_TotalDataRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.updDate) == false && undefined !== pobjgs_TotalDataRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.updUser) == false && undefined !== pobjgs_TotalDataRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.memo) == false && undefined !== pobjgs_TotalDataRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.tdRelaTypeId) == false && undefined !== pobjgs_TotalDataRelaEN.tdRelaTypeId && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.tdRelaTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.totalDataId1) == false && undefined !== pobjgs_TotalDataRelaEN.totalDataId1 && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.totalDataId1) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TotalDataRelaEN.totalDataId2) == false && undefined !== pobjgs_TotalDataRelaEN.totalDataId2 && clsString_js_1.tzDataType.isString(pobjgs_TotalDataRelaEN.totalDataId2) === false) {
    ...
    */
    function gs_TotalDataRela_GetCombineCondition(objgs_TotalDataRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_mId, objgs_TotalDataRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_id_CurrEduCls, objgs_TotalDataRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_UpdDate, objgs_TotalDataRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_UpdUser, objgs_TotalDataRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_Memo, objgs_TotalDataRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TdRelaTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TdRelaTypeId, objgs_TotalDataRela_Cond.tdRelaTypeId, strComparisonOp_TdRelaTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TotalDataId1) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TotalDataId1, objgs_TotalDataRela_Cond.totalDataId1, strComparisonOp_TotalDataId1);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TotalDataRela_Cond.dicFldComparisonOp, clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TotalDataId2) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TotalDataRelaEN_js_1.clsgs_TotalDataRelaEN.con_TotalDataId2, objgs_TotalDataRela_Cond.totalDataId2, strComparisonOp_TotalDataId2);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_TotalDataRela_GetUniCondStr_mId(objgs_TotalDataRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_TotalDataRelaEN.mId);
        return strWhereCond;
    }
