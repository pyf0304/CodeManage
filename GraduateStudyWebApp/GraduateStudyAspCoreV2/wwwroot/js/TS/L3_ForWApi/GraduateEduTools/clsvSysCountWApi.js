...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTools/clsvSysCountEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vSysCount_GetObjByCountIdAsync(strCountId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCountId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCountId]不能为空！(In clsvSysCountWApi.GetObjByCountIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCountId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCountId]的长度:[{0}]不正确！(clsvSysCountWApi.GetObjByCountIdAsync)", strCountId.length);
            console.error(strMsg);
            throw (strMsg);
        }
