...
(function (factory) {
    ...
    **/
    async function sys_RequestPush_GetObjByRequestIdAsync(lngRequestId) {
        ...
        if (lngRequestId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngRequestId]不能为空！(In clssys_RequestPushWApi.GetObjByRequestIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sys_RequestPush_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sys_RequestPush_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function sys_RequestPush_GetObjByRequestId_Cache(lngRequestId, bolTryAsyncOnce = true) {
        ...
        if (lngRequestId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngRequestId]不能为空！(In clssys_RequestPushWApi.GetObjByRequestId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function sys_RequestPush_GetObjByRequestId_localStorage(lngRequestId) {
        ...
        if (lngRequestId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngRequestId]不能为空！(In clssys_RequestPushWApi.GetObjByRequestId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clssys_RequestPushEN_js_1.clssys_RequestPushEN._CurrTabName, lngRequestId);
        if (strKey == "") {
    ...
    */
    async function sys_RequestPush_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clssys_RequestPushEN_js_1.clssys_RequestPushEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clssys_RequestPushEN_js_1.clssys_RequestPushEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objsys_RequestPush == null)
            return "";
        if (objsys_RequestPush.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequesTypeId:
                    return (a, b) => {
                        if (a.requesTypeId == null)
                            return -1;
                        if (b.requesTypeId == null)
                            return 1;
                        return a.requesTypeId.localeCompare(b.requesTypeId);
                    };
                ...
                case clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestStata:
                    return (a, b) => {
                        if (a.requestStata == null)
                            return -1;
                        if (b.requestStata == null)
                            return 1;
                ...
                case clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_PushTypeId:
                    return (a, b) => {
                        if (a.pushTypeId == null)
                            return -1;
                        if (b.pushTypeId == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function sys_RequestPush_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.sys_RequestPush_funcKey = sys_RequestPush_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function sys_RequestPush_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clssys_RequestPushEN_js_1.clssys_RequestPushEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clssys_RequestPushEN_js_1.clssys_RequestPushEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrsys_RequestPushExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrsys_RequestPushExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrsys_RequestPushExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function sys_RequestPush_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrsys_RequestPushExObjLst.length);
            console.log(strInfo);
            return arrsys_RequestPushExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sys_RequestPush_ConstructorName, strThisFuncName);
    ...
    **/
    async function sys_RequestPush_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrsys_RequestPushExObjLst.length);
            console.log(strInfo);
            return arrsys_RequestPushExObjLst;
        }
        catch (e) {
    ...
    **/
    async function sys_RequestPush_DelRecordAsync(lngRequestId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngRequestId);
        try {
    ...
    **/
    async function sys_RequestPush_UpdateRecordAsync(objsys_RequestPushEN) {
        ...
        if (objsys_RequestPushEN.sf_UpdFldSetStr === undefined || objsys_RequestPushEN.sf_UpdFldSetStr === null || objsys_RequestPushEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objsys_RequestPushEN.requestId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sys_RequestPush_Controller, strAction);
        try {
    ...
    */
    async function sys_RequestPush_IsExistRecord_Cache(objsys_RequestPush_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objsys_RequestPush_Cond), exports.sys_RequestPush_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function sys_RequestPush_IsExist_Cache(lngRequestId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngRequestId, exports.sys_RequestPush_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function sys_RequestPush_CheckPropertyNew(pobjsys_RequestPushEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requesTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.requesTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.tableKey) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.tableKey) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.receiveUser) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.receiveUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.replyDate) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.replyDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requestUser) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.requestUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requestDate) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.requestDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requestStata) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.requestStata) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.pushTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjsys_RequestPushEN.pushTypeId) > 2) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjsys_RequestPushEN.requestId && undefined !== pobjsys_RequestPushEN.requestId && clsString_js_1.tzDataType.isNumber(pobjsys_RequestPushEN.requestId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requesTypeId) == false && undefined !== pobjsys_RequestPushEN.requesTypeId && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.requesTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.tableKey) == false && undefined !== pobjsys_RequestPushEN.tableKey && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.tableKey) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.receiveUser) == false && undefined !== pobjsys_RequestPushEN.receiveUser && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.receiveUser) === false) {
        ...
        if (null != pobjsys_RequestPushEN.isReply && undefined !== pobjsys_RequestPushEN.isReply && clsString_js_1.tzDataType.isBoolean(pobjsys_RequestPushEN.isReply) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.replyDate) == false && undefined !== pobjsys_RequestPushEN.replyDate && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.replyDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requestUser) == false && undefined !== pobjsys_RequestPushEN.requestUser && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.requestUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requestDate) == false && undefined !== pobjsys_RequestPushEN.requestDate && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.requestDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.requestStata) == false && undefined !== pobjsys_RequestPushEN.requestStata && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.requestStata) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.memo) == false && undefined !== pobjsys_RequestPushEN.memo && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.id_CurrEduCls) == false && undefined !== pobjsys_RequestPushEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjsys_RequestPushEN.pushTypeId) == false && undefined !== pobjsys_RequestPushEN.pushTypeId && clsString_js_1.tzDataType.isString(pobjsys_RequestPushEN.pushTypeId) === false) {
    ...
    */
    function sys_RequestPush_GetCombineCondition(objsys_RequestPush_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestId, objsys_RequestPush_Cond.requestId, strComparisonOp_RequestId);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequesTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequesTypeId, objsys_RequestPush_Cond.requesTypeId, strComparisonOp_RequesTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_TableKey) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_TableKey, objsys_RequestPush_Cond.tableKey, strComparisonOp_TableKey);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_ReceiveUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_ReceiveUser, objsys_RequestPush_Cond.receiveUser, strComparisonOp_ReceiveUser);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_IsReply) == true) {
            if (objsys_RequestPush_Cond.isReply == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_IsReply);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_IsReply);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_ReplyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_ReplyDate, objsys_RequestPush_Cond.replyDate, strComparisonOp_ReplyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestUser, objsys_RequestPush_Cond.requestUser, strComparisonOp_RequestUser);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestDate, objsys_RequestPush_Cond.requestDate, strComparisonOp_RequestDate);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestStata) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_RequestStata, objsys_RequestPush_Cond.requestStata, strComparisonOp_RequestStata);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_Memo, objsys_RequestPush_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_id_CurrEduCls, objsys_RequestPush_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objsys_RequestPush_Cond.dicFldComparisonOp, clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_PushTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clssys_RequestPushEN_js_1.clssys_RequestPushEN.con_PushTypeId, objsys_RequestPush_Cond.pushTypeId, strComparisonOp_PushTypeId);
        }
        return strWhereCond;
    }
    ...
    **/
    function sys_RequestPush_GetUniCondStr_RequesTypeId_TableKey(objsys_RequestPushEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and RequesTypeId = '{0}'", objsys_RequestPushEN.requesTypeId);
        strWhereCond += (0, clsString_js_2.Format)(" and TableKey = '{0}'", objsys_RequestPushEN.tableKey);
        return strWhereCond;
    }
    ...
    **/
    function sys_RequestPush_GetUniCondStr4Update_RequesTypeId_TableKey(objsys_RequestPushEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and RequestId <> '{0}'", objsys_RequestPushEN.requestId);
        strWhereCond += (0, clsString_js_2.Format)(" and RequesTypeId = '{0}'", objsys_RequestPushEN.requesTypeId);
        strWhereCond += (0, clsString_js_2.Format)(" and TableKey = '{0}'", objsys_RequestPushEN.tableKey);
        return strWhereCond;
    }
