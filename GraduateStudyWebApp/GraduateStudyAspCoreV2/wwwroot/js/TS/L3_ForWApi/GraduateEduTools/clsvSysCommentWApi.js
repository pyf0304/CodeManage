...
(function (factory) {
    ...
    **/
    async function vSysComment_GetObjByCommentIdAsync(strCommentId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCommentId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCommentId]不能为空！(In clsvSysCommentWApi.GetObjByCommentIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCommentId]的长度:[{0}]不正确！(clsvSysCommentWApi.GetObjByCommentIdAsync)", strCommentId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vSysComment_GetObjByCommentId_Cache(strCommentId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCommentId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCommentId]不能为空！(In clsvSysCommentWApi.GetObjByCommentId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCommentId]的长度:[{0}]不正确！(clsvSysCommentWApi.GetObjByCommentId_Cache)", strCommentId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vSysComment_GetObjByCommentId_localStorage(strCommentId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCommentId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCommentId]不能为空！(In clsvSysCommentWApi.GetObjByCommentId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCommentId]的长度:[{0}]不正确！(clsvSysCommentWApi.GetObjByCommentId_localStorage)", strCommentId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vSysComment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvSysCommentWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvSysCommentWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvSysCommentEN_js_1.clsvSysCommentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvSysCommentEN_js_1.clsvSysCommentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvSysComment == null)
            return "";
        if (objvSysComment.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vSysComment_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvSysCommentWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvSysCommentWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvSysCommentEN_js_1.clsvSysCommentEN.con_CommentId) {
    ...
    exports.vSysComment_funcKey = vSysComment_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vSysComment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvSysCommentEN_js_1.clsvSysCommentEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvSysCommentEN_js_1.clsvSysCommentEN.WhereFormat, strid_CurrEduCls);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvSysCommentExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvSysCommentExObjLst);
    ...
    **/
    async function vSysComment_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvSysCommentWApi.vSysComment_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvSysCommentWApi.vSysComment_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
