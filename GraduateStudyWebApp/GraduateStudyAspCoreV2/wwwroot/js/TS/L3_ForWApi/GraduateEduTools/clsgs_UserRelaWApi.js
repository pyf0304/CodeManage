...
(function (factory) {
    ...
    **/
    async function gs_UserRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_UserRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_UserRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_UserRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_UserRela_GetObjBymId_Cache(lngmId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_UserRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_UserRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_UserRela_Const = await gs_UserRela_GetObjBymIdAsync(lngmId);
                    if (objgs_UserRela_Const != null) {
                        gs_UserRela_ReFreshThisCache(strid_CurrEduCls);
                        return objgs_UserRela_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_UserRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_UserRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_UserRela_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsgs_UserRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsgs_UserRelaWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_UserRela == null)
            return "";
        if (objgs_UserRela.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserRelaId:
                    return (a, b) => {
                        if (a.userRelaId == null)
                            return -1;
                        if (b.userRelaId == null)
                            return 1;
                        return a.userRelaId.localeCompare(b.userRelaId);
                    };
                ...
                case clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserRelaName:
                    return (a, b) => {
                        if (a.userRelaName == null)
                            return -1;
                        if (b.userRelaName == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_UserRela_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsgs_UserRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsgs_UserRelaWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_mId) {
        ...
        const arrgs_UserRela = await gs_UserRela_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrgs_UserRela == null)
            return [];
        let arrgs_UserRela_Sel = arrgs_UserRela;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_UserRela_Sel = arrgs_UserRela_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_UserRela_Sel = arrgs_UserRela_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_UserRela_Sel = arrgs_UserRela_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_UserRela_Sel = arrgs_UserRela_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrgs_UserRela_Sel.length == 0)
            return [];
        return arrgs_UserRela_Sel.map(x => x.mId);
    }
    exports.gs_UserRela_funcKey = gs_UserRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_UserRela_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_UserRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_UserRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_UserRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_UserRela_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_UserRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_UserRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_UserRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_UserRela_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_UserRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_UserRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_UserRela_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsgs_UserRelaWApi.gs_UserRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsgs_UserRelaWApi.gs_UserRela_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_UserRela_Sel = arrgs_UserRela_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_UserRela_UpdateRecordAsync(objgs_UserRelaEN) {
        ...
        if (objgs_UserRelaEN.sf_UpdFldSetStr === undefined || objgs_UserRelaEN.sf_UpdFldSetStr === null || objgs_UserRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_UserRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_UserRela_Controller, strAction);
        try {
    ...
    */
    async function gs_UserRela_IsExistRecord_Cache(objgs_UserRela_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_UserRela_Cond), exports.gs_UserRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_UserRela_IsExist_Cache(lngmId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_UserRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_UserRela_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_UserRelaWApi.clsgs_UserRelaWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsgs_UserRelaWApi.clsgs_UserRelaWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_UserRela_CheckPropertyNew(pobjgs_UserRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.userId) > 18) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过18(In 用户关系(gs_UserRela))!值:$(pobjgs_UserRelaEN.userId)(clsgs_UserRelaBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userRelaId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.userRelaId) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.updUserName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.updUserName) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userRelaName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.userRelaName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_UserRelaEN.mId && undefined !== pobjgs_UserRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_UserRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userId) == false && undefined !== pobjgs_UserRelaEN.userId && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.userId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userRelaId) == false && undefined !== pobjgs_UserRelaEN.userRelaId && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.userRelaId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.updUser) == false && undefined !== pobjgs_UserRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.updDate) == false && undefined !== pobjgs_UserRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.memo) == false && undefined !== pobjgs_UserRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.updUserName) == false && undefined !== pobjgs_UserRelaEN.updUserName && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.updUserName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userRelaName) == false && undefined !== pobjgs_UserRelaEN.userRelaName && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.userRelaName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.id_CurrEduCls) == false && undefined !== pobjgs_UserRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_UserRelaEN.id_CurrEduCls) === false) {
        ...
        if (null != pobjgs_UserRelaEN.orderNum && undefined !== pobjgs_UserRelaEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjgs_UserRelaEN.orderNum) === false) {
        ...
        if (null != pobjgs_UserRelaEN.x_Position && undefined !== pobjgs_UserRelaEN.x_Position && clsString_js_1.tzDataType.isNumber(pobjgs_UserRelaEN.x_Position) === false) {
        ...
        if (null != pobjgs_UserRelaEN.y_Position && undefined !== pobjgs_UserRelaEN.y_Position && clsString_js_1.tzDataType.isNumber(pobjgs_UserRelaEN.y_Position) === false) {
    ...
    */
    function gs_UserRela_CheckProperty4Update(pobjgs_UserRelaEN) {
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.userId) > 18) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过18(In 用户关系(gs_UserRela))!值:$(pobjgs_UserRelaEN.userId)(clsgs_UserRelaBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_UserRelaEN.userRelaId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_UserRelaEN.userRelaId) > 50) {
    ...
    */
    function gs_UserRela_GetCombineCondition(objgs_UserRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_mId, objgs_UserRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserId, objgs_UserRela_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserRelaId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserRelaId, objgs_UserRela_Cond.userRelaId, strComparisonOp_UserRelaId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UpdUser, objgs_UserRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UpdDate, objgs_UserRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_Memo, objgs_UserRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UpdUserName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UpdUserName, objgs_UserRela_Cond.updUserName, strComparisonOp_UpdUserName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserRelaName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_UserRelaName, objgs_UserRela_Cond.userRelaName, strComparisonOp_UserRelaName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_id_CurrEduCls, objgs_UserRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_OrderNum, objgs_UserRela_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_X_Position) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_X_Position, objgs_UserRela_Cond.x_Position, strComparisonOp_X_Position);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_UserRela_Cond.dicFldComparisonOp, clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_Y_Position) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_UserRelaEN_js_1.clsgs_UserRelaEN.con_Y_Position, objgs_UserRela_Cond.y_Position, strComparisonOp_Y_Position);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_UserRela_GetUniCondStr_mId(objgs_UserRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_UserRelaEN.mId);
        return strWhereCond;
    }
