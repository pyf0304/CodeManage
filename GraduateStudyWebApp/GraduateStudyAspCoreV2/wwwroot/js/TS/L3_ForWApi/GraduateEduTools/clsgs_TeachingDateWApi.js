...
(function (factory) {
    ...
    **/
    async function gs_TeachingDate_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_TeachingDateWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TeachingDate_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TeachingDate_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TeachingDate_GetObjBymId_Cache(lngmId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_TeachingDateWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_TeachingDate_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_TeachingDate_Const = await gs_TeachingDate_GetObjBymIdAsync(lngmId);
                    if (objgs_TeachingDate_Const != null) {
                        gs_TeachingDate_ReFreshThisCache(strid_CurrEduCls);
                        return objgs_TeachingDate_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_TeachingDate_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_TeachingDateWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_TeachingDate_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsgs_TeachingDateWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsgs_TeachingDateWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_TeachingDate == null)
            return "";
        if (objgs_TeachingDate.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_TeachingDate_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsgs_TeachingDateWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsgs_TeachingDateWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_mId) {
        ...
        const arrgs_TeachingDate = await gs_TeachingDate_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrgs_TeachingDate == null)
            return [];
        let arrgs_TeachingDate_Sel = arrgs_TeachingDate;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_TeachingDate_Sel = arrgs_TeachingDate_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_TeachingDate_Sel = arrgs_TeachingDate_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_TeachingDate_Sel = arrgs_TeachingDate_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_TeachingDate_Sel = arrgs_TeachingDate_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrgs_TeachingDate_Sel.length == 0)
            return [];
        return arrgs_TeachingDate_Sel.map(x => x.mId);
    }
    exports.gs_TeachingDate_funcKey = gs_TeachingDate_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_TeachingDate_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TeachingDateExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_TeachingDateExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TeachingDateExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TeachingDate_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TeachingDateExObjLst.length);
            console.log(strInfo);
            return arrgs_TeachingDateExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TeachingDate_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_TeachingDate_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TeachingDateExObjLst.length);
            console.log(strInfo);
            return arrgs_TeachingDateExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_TeachingDate_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsgs_TeachingDateWApi.gs_TeachingDate_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsgs_TeachingDateWApi.gs_TeachingDate_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_TeachingDate_Sel = arrgs_TeachingDate_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_TeachingDate_UpdateRecordAsync(objgs_TeachingDateEN) {
        ...
        if (objgs_TeachingDateEN.sf_UpdFldSetStr === undefined || objgs_TeachingDateEN.sf_UpdFldSetStr === null || objgs_TeachingDateEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TeachingDateEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TeachingDate_Controller, strAction);
        try {
    ...
    */
    async function gs_TeachingDate_IsExistRecord_Cache(objgs_TeachingDate_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TeachingDate_Cond), exports.gs_TeachingDate_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TeachingDate_IsExist_Cache(lngmId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_TeachingDate_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_TeachingDate_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsgs_TeachingDateWApi.clsgs_TeachingDateWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsgs_TeachingDateWApi.clsgs_TeachingDateWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_TeachingDate_CheckPropertyNew(pobjgs_TeachingDateEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TeachingDateEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.startDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TeachingDateEN.startDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.endDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TeachingDateEN.endDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TeachingDateEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TeachingDateEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TeachingDateEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_TeachingDateEN.mId && undefined !== pobjgs_TeachingDateEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_TeachingDateEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.id_CurrEduCls) == false && undefined !== pobjgs_TeachingDateEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_TeachingDateEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.startDate) == false && undefined !== pobjgs_TeachingDateEN.startDate && clsString_js_1.tzDataType.isString(pobjgs_TeachingDateEN.startDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.endDate) == false && undefined !== pobjgs_TeachingDateEN.endDate && clsString_js_1.tzDataType.isString(pobjgs_TeachingDateEN.endDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.updDate) == false && undefined !== pobjgs_TeachingDateEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_TeachingDateEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.updUser) == false && undefined !== pobjgs_TeachingDateEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_TeachingDateEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TeachingDateEN.memo) == false && undefined !== pobjgs_TeachingDateEN.memo && clsString_js_1.tzDataType.isString(pobjgs_TeachingDateEN.memo) === false) {
    ...
    */
    function gs_TeachingDate_GetCombineCondition(objgs_TeachingDate_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_mId, objgs_TeachingDate_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_id_CurrEduCls, objgs_TeachingDate_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_StartDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_StartDate, objgs_TeachingDate_Cond.startDate, strComparisonOp_StartDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_EndDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_EndDate, objgs_TeachingDate_Cond.endDate, strComparisonOp_EndDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_UpdDate, objgs_TeachingDate_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_UpdUser, objgs_TeachingDate_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TeachingDate_Cond.dicFldComparisonOp, clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TeachingDateEN_js_1.clsgs_TeachingDateEN.con_Memo, objgs_TeachingDate_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_TeachingDate_GetUniCondStr_mId(objgs_TeachingDateEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_TeachingDateEN.mId);
        return strWhereCond;
    }
