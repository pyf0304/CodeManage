...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/NewsAnnouncement/clsFeedBackEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function FeedBack_GetObjByFeedBackIdAsync(lngFeedBackId) {
        ...
        if (lngFeedBackId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngFeedBackId]不能为空！(In clsFeedBackWApi.GetObjByFeedBackIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.feedBack_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.feedBack_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackNumber:
                    return (a, b) => {
                        if (a.feedBackNumber == null)
                            return -1;
                        if (b.feedBackNumber == null)
                            return 1;
                        return a.feedBackNumber.localeCompare(b.feedBackNumber);
                    };
                case clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackContent:
                    return (a, b) => {
                        if (a.feedBackContent == null)
                            return -1;
                        if (b.feedBackContent == null)
                            return 1;
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.feedBack_ConstructorName, strThisFuncName);
    ...
    **/
    async function FeedBack_DelRecordAsync(lngFeedBackId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngFeedBackId);
        try {
    ...
    **/
    async function FeedBack_UpdateRecordAsync(objFeedBackEN) {
        ...
        if (objFeedBackEN.sf_UpdFldSetStr === undefined || objFeedBackEN.sf_UpdFldSetStr === null || objFeedBackEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objFeedBackEN.feedBackId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.feedBack_Controller, strAction);
        try {
    ...
    */
    function FeedBack_CheckPropertyNew(pobjFeedBackEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.nickName) === true) {
            throw new Error("(errid:Watl000058)字段[昵称]不能为空(In 反馈意见)!(clsFeedBackBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 反馈意见)!(clsFeedBackBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.nickName) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.nickName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.feedBackNumber) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.feedBackNumber) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.feedBackContent) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.feedBackContent) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.email) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.email) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.telephone) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.telephone) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjFeedBackEN.updUser) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjFeedBackEN.feedBackId && undefined !== pobjFeedBackEN.feedBackId && clsString_js_1.tzDataType.isNumber(pobjFeedBackEN.feedBackId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.nickName) == false && undefined !== pobjFeedBackEN.nickName && clsString_js_1.tzDataType.isString(pobjFeedBackEN.nickName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.feedBackNumber) == false && undefined !== pobjFeedBackEN.feedBackNumber && clsString_js_1.tzDataType.isString(pobjFeedBackEN.feedBackNumber) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.feedBackContent) == false && undefined !== pobjFeedBackEN.feedBackContent && clsString_js_1.tzDataType.isString(pobjFeedBackEN.feedBackContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.email) == false && undefined !== pobjFeedBackEN.email && clsString_js_1.tzDataType.isString(pobjFeedBackEN.email) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.telephone) == false && undefined !== pobjFeedBackEN.telephone && clsString_js_1.tzDataType.isString(pobjFeedBackEN.telephone) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.updDate) == false && undefined !== pobjFeedBackEN.updDate && clsString_js_1.tzDataType.isString(pobjFeedBackEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.memo) == false && undefined !== pobjFeedBackEN.memo && clsString_js_1.tzDataType.isString(pobjFeedBackEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjFeedBackEN.updUser) == false && undefined !== pobjFeedBackEN.updUser && clsString_js_1.tzDataType.isString(pobjFeedBackEN.updUser) === false) {
    ...
    */
    function FeedBack_GetCombineCondition(objFeedBack_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackId, objFeedBack_Cond.feedBackId, strComparisonOp_FeedBackId);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_NickName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_NickName, objFeedBack_Cond.nickName, strComparisonOp_NickName);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackNumber, objFeedBack_Cond.feedBackNumber, strComparisonOp_FeedBackNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_FeedBackContent, objFeedBack_Cond.feedBackContent, strComparisonOp_FeedBackContent);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_Email) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_Email, objFeedBack_Cond.email, strComparisonOp_Email);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_Telephone) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_Telephone, objFeedBack_Cond.telephone, strComparisonOp_Telephone);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_UpdDate, objFeedBack_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_Memo, objFeedBack_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objFeedBack_Cond.dicFldComparisonOp, clsFeedBackEN_js_1.clsFeedBackEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsFeedBackEN_js_1.clsFeedBackEN.con_UpdUser, objFeedBack_Cond.updUser, strComparisonOp_UpdUser);
        }
        return strWhereCond;
    }
    ...
    **/
    function FeedBack_GetUniCondStr_NickName_FeedBackNumber(objFeedBackEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and NickName = '{0}'", objFeedBackEN.nickName);
        strWhereCond += (0, clsString_js_2.Format)(" and FeedBackNumber = '{0}'", objFeedBackEN.feedBackNumber);
        return strWhereCond;
    }
    ...
    **/
    function FeedBack_GetUniCondStr4Update_NickName_FeedBackNumber(objFeedBackEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and FeedBackId <> '{0}'", objFeedBackEN.feedBackId);
        strWhereCond += (0, clsString_js_2.Format)(" and NickName = '{0}'", objFeedBackEN.nickName);
        strWhereCond += (0, clsString_js_2.Format)(" and FeedBackNumber = '{0}'", objFeedBackEN.feedBackNumber);
        return strWhereCond;
    }
