...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/NewsAnnouncement/clsvMessagePushUsersRelationEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vMessagePushUsersRelation_GetObjByMessagePushUsersRelationIdAsync(lngMessagePushUsersRelationId) {
        ...
        if (lngMessagePushUsersRelationId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngMessagePushUsersRelationId]不能为空！(In clsvMessagePushUsersRelationWApi.GetObjByMessagePushUsersRelationIdAsync)");
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvMessagePushUsersRelationEN_js_1.clsvMessagePushUsersRelationEN.con_MessageTypeId:
                    return (a, b) => {
                        if (a.messageTypeId == null)
                            return -1;
                        if (b.messageTypeId == null)
                            return 1;
