...
(function (factory) {
    ...
    **/
    async function CurrEduClsStu_GetObjByid_EduClsStuAsync(lngid_EduClsStu) {
        ...
        if (lngid_EduClsStu == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngid_EduClsStu]不能为空！(In clsCurrEduClsStuWApi.GetObjByid_EduClsStuAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.currEduClsStu_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.currEduClsStu_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function CurrEduClsStu_GetObjByid_EduClsStu_Cache(lngid_EduClsStu, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngid_EduClsStu == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngid_EduClsStu]不能为空！(In clsCurrEduClsStuWApi.GetObjByid_EduClsStu_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrCurrEduClsStu_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objCurrEduClsStu_Const = await CurrEduClsStu_GetObjByid_EduClsStuAsync(lngid_EduClsStu);
                    if (objCurrEduClsStu_Const != null) {
                        CurrEduClsStu_ReFreshThisCache(strid_CurrEduCls);
                        return objCurrEduClsStu_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function CurrEduClsStu_GetObjByid_EduClsStu_localStorage(lngid_EduClsStu) {
        ...
        if (lngid_EduClsStu == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngid_EduClsStu]不能为空！(In clsCurrEduClsStuWApi.GetObjByid_EduClsStu_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN._CurrTabName, lngid_EduClsStu);
        if (strKey == "") {
    ...
    */
    async function CurrEduClsStu_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsCurrEduClsStuWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsCurrEduClsStuWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objCurrEduClsStu == null)
            return "";
        if (objCurrEduClsStu.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_EduClsStuStateID:
                    return (a, b) => {
                        if (a.eduClsStuStateID == null)
                            return -1;
                        if (b.eduClsStuStateID == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function CurrEduClsStu_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsCurrEduClsStuWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsCurrEduClsStuWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_EduClsStu) {
        ...
        const arrCurrEduClsStu = await CurrEduClsStu_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrCurrEduClsStu == null)
            return [];
        let arrCurrEduClsStu_Sel = arrCurrEduClsStu;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrCurrEduClsStu_Sel = arrCurrEduClsStu_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrCurrEduClsStu_Sel = arrCurrEduClsStu_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrCurrEduClsStu_Sel = arrCurrEduClsStu_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrCurrEduClsStu_Sel = arrCurrEduClsStu_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrCurrEduClsStu_Sel.length == 0)
            return [];
        return arrCurrEduClsStu_Sel.map(x => x.id_EduClsStu);
    }
    exports.CurrEduClsStu_funcKey = CurrEduClsStu_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function CurrEduClsStu_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrCurrEduClsStuExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrCurrEduClsStuExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsStuExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function CurrEduClsStu_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsStuExObjLst.length);
            console.log(strInfo);
            return arrCurrEduClsStuExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.currEduClsStu_ConstructorName, strThisFuncName);
    ...
    **/
    async function CurrEduClsStu_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsStuExObjLst.length);
            console.log(strInfo);
            return arrCurrEduClsStuExObjLst;
        }
        catch (e) {
    ...
    **/
    async function CurrEduClsStu_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsCurrEduClsStuWApi.CurrEduClsStu_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsCurrEduClsStuWApi.CurrEduClsStu_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrCurrEduClsStu_Sel = arrCurrEduClsStu_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function CurrEduClsStu_DelRecordAsync(lngid_EduClsStu) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngid_EduClsStu);
        try {
    ...
    **/
    async function CurrEduClsStu_UpdateRecordAsync(objCurrEduClsStuEN) {
        ...
        if (objCurrEduClsStuEN.sf_UpdFldSetStr === undefined || objCurrEduClsStuEN.sf_UpdFldSetStr === null || objCurrEduClsStuEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objCurrEduClsStuEN.id_EduClsStu);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.currEduClsStu_Controller, strAction);
        try {
    ...
    */
    async function CurrEduClsStu_IsExistRecord_Cache(objCurrEduClsStu_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objCurrEduClsStu_Cond), exports.currEduClsStu_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function CurrEduClsStu_IsExist_Cache(lngid_EduClsStu, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngid_EduClsStu, exports.currEduClsStu_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function CurrEduClsStu_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsCurrEduClsStuWApi.clsCurrEduClsStuWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsCurrEduClsStuWApi.clsCurrEduClsStuWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function CurrEduClsStu_BindDdl_id_StuByid_CurrEduClsInDiv_Cache(strDivName, strDdlName, strid_CurrEduCls) {
        const strThisFuncName = "BindDdl_id_StuByid_CurrEduClsInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsCurrEduClsStuWApi.BindDdl_id_StuByid_CurrEduClsInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsCurrEduClsStuWApi.BindDdl_id_StuByid_CurrEduClsInDiv)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_StuByid_CurrEduClsInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        let arrObjLst_Sel = await CurrEduClsStu_GetObjLst_Cache(strid_CurrEduCls);
        if (arrObjLst_Sel == null)
            return;
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_Stu, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_StuName, "教学班与学生关系");
    }
    exports.CurrEduClsStu_BindDdl_id_StuByid_CurrEduClsInDiv_Cache = CurrEduClsStu_BindDdl_id_StuByid_CurrEduClsInDiv_Cache;
    ...
    */
    function CurrEduClsStu_CheckPropertyNew(pobjCurrEduClsStuEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.id_Stu) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.id_Stu) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.eduClsStuStateID) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.eduClsStuStateID) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.schoolTerm) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.schoolTerm) > 1) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.schoolYear) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.schoolYear) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.exportDate) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.exportDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.signInDate) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.signInDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.signInStateID) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.signInStateID) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.signInUser) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.signInUser) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.modifyDate) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.modifyDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.modifyUserID) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.modifyUserID) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsStuEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjCurrEduClsStuEN.id_EduClsStu && undefined !== pobjCurrEduClsStuEN.id_EduClsStu && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.id_EduClsStu) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.id_CurrEduCls) == false && undefined !== pobjCurrEduClsStuEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.id_Stu) == false && undefined !== pobjCurrEduClsStuEN.id_Stu && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.id_Stu) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.eduClsStuStateID) == false && undefined !== pobjCurrEduClsStuEN.eduClsStuStateID && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.eduClsStuStateID) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.getScoreTimes && undefined !== pobjCurrEduClsStuEN.getScoreTimes && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.getScoreTimes) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.score && undefined !== pobjCurrEduClsStuEN.score && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.score) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.totalScores && undefined !== pobjCurrEduClsStuEN.totalScores && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.totalScores) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.ranking && undefined !== pobjCurrEduClsStuEN.ranking && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.ranking) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.percentile && undefined !== pobjCurrEduClsStuEN.percentile && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.percentile) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.ranking2 && undefined !== pobjCurrEduClsStuEN.ranking2 && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.ranking2) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.percentile2 && undefined !== pobjCurrEduClsStuEN.percentile2 && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.percentile2) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.ranking3 && undefined !== pobjCurrEduClsStuEN.ranking3 && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.ranking3) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.percentile3 && undefined !== pobjCurrEduClsStuEN.percentile3 && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsStuEN.percentile3) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.confirmed && undefined !== pobjCurrEduClsStuEN.confirmed && clsString_js_1.tzDataType.isBoolean(pobjCurrEduClsStuEN.confirmed) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.schoolTerm) == false && undefined !== pobjCurrEduClsStuEN.schoolTerm && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.schoolTerm) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.schoolYear) == false && undefined !== pobjCurrEduClsStuEN.schoolYear && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.schoolYear) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.exportDate) == false && undefined !== pobjCurrEduClsStuEN.exportDate && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.exportDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.signInDate) == false && undefined !== pobjCurrEduClsStuEN.signInDate && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.signInDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.signInStateID) == false && undefined !== pobjCurrEduClsStuEN.signInStateID && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.signInStateID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.signInUser) == false && undefined !== pobjCurrEduClsStuEN.signInUser && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.signInUser) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.isOpByTeacher && undefined !== pobjCurrEduClsStuEN.isOpByTeacher && clsString_js_1.tzDataType.isBoolean(pobjCurrEduClsStuEN.isOpByTeacher) === false) {
        ...
        if (null != pobjCurrEduClsStuEN.isSynScore && undefined !== pobjCurrEduClsStuEN.isSynScore && clsString_js_1.tzDataType.isBoolean(pobjCurrEduClsStuEN.isSynScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.modifyDate) == false && undefined !== pobjCurrEduClsStuEN.modifyDate && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.modifyDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.modifyUserID) == false && undefined !== pobjCurrEduClsStuEN.modifyUserID && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.modifyUserID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsStuEN.memo) == false && undefined !== pobjCurrEduClsStuEN.memo && clsString_js_1.tzDataType.isString(pobjCurrEduClsStuEN.memo) === false) {
    ...
    */
    function CurrEduClsStu_GetCombineCondition(objCurrEduClsStu_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_EduClsStu) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_EduClsStu, objCurrEduClsStu_Cond.id_EduClsStu, strComparisonOp_id_EduClsStu);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_CurrEduCls, objCurrEduClsStu_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_Stu) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_id_Stu, objCurrEduClsStu_Cond.id_Stu, strComparisonOp_id_Stu);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_EduClsStuStateID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_EduClsStuStateID, objCurrEduClsStu_Cond.eduClsStuStateID, strComparisonOp_EduClsStuStateID);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Score, objCurrEduClsStu_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_TotalScores) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_TotalScores, objCurrEduClsStu_Cond.totalScores, strComparisonOp_TotalScores);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Ranking) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Ranking, objCurrEduClsStu_Cond.ranking, strComparisonOp_Ranking);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Percentile) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Percentile, objCurrEduClsStu_Cond.percentile, strComparisonOp_Percentile);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Ranking2) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Ranking2, objCurrEduClsStu_Cond.ranking2, strComparisonOp_Ranking2);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Percentile2) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Percentile2, objCurrEduClsStu_Cond.percentile2, strComparisonOp_Percentile2);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Ranking3) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Ranking3, objCurrEduClsStu_Cond.ranking3, strComparisonOp_Ranking3);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Percentile3) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Percentile3, objCurrEduClsStu_Cond.percentile3, strComparisonOp_Percentile3);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Confirmed) == true) {
            if (objCurrEduClsStu_Cond.confirmed == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Confirmed);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Confirmed);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SchoolTerm) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SchoolTerm, objCurrEduClsStu_Cond.schoolTerm, strComparisonOp_SchoolTerm);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SchoolYear) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SchoolYear, objCurrEduClsStu_Cond.schoolYear, strComparisonOp_SchoolYear);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_ExportDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_ExportDate, objCurrEduClsStu_Cond.exportDate, strComparisonOp_ExportDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SignInDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SignInDate, objCurrEduClsStu_Cond.signInDate, strComparisonOp_SignInDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SignInStateID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SignInStateID, objCurrEduClsStu_Cond.signInStateID, strComparisonOp_SignInStateID);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SignInUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_SignInUser, objCurrEduClsStu_Cond.signInUser, strComparisonOp_SignInUser);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_IsOpByTeacher) == true) {
            if (objCurrEduClsStu_Cond.isOpByTeacher == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_IsOpByTeacher);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_IsOpByTeacher);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_IsSynScore) == true) {
            if (objCurrEduClsStu_Cond.isSynScore == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_IsSynScore);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_IsSynScore);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_ModifyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_ModifyDate, objCurrEduClsStu_Cond.modifyDate, strComparisonOp_ModifyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_ModifyUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_ModifyUserID, objCurrEduClsStu_Cond.modifyUserID, strComparisonOp_ModifyUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsStu_Cond.dicFldComparisonOp, clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN.con_Memo, objCurrEduClsStu_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function CurrEduClsStu_GetUniCondStr_id_CurrEduCls_id_Stu(objCurrEduClsStuEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_CurrEduCls = '{0}'", objCurrEduClsStuEN.id_CurrEduCls);
        strWhereCond += (0, clsString_js_2.Format)(" and id_Stu = '{0}'", objCurrEduClsStuEN.id_Stu);
        return strWhereCond;
    }
    ...
    **/
    function CurrEduClsStu_GetUniCondStr4Update_id_CurrEduCls_id_Stu(objCurrEduClsStuEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_EduClsStu <> '{0}'", objCurrEduClsStuEN.id_EduClsStu);
        strWhereCond += (0, clsString_js_2.Format)(" and id_CurrEduCls = '{0}'", objCurrEduClsStuEN.id_CurrEduCls);
        strWhereCond += (0, clsString_js_2.Format)(" and id_Stu = '{0}'", objCurrEduClsStuEN.id_Stu);
        return strWhereCond;
    }
