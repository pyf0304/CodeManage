...
(function (factory) {
    ...
    **/
    async function cc_CourseType_GetObjByCourseTypeIDAsync(strCourseTypeID) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseTypeID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseTypeID]不能为空！(In clscc_CourseTypeWApi.GetObjByCourseTypeIDAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseTypeID.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseTypeID]的长度:[{0}]不正确！(clscc_CourseTypeWApi.GetObjByCourseTypeIDAsync)", strCourseTypeID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cc_CourseType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cc_CourseType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function cc_CourseType_GetObjByCourseTypeID_Cache(strCourseTypeID, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseTypeID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseTypeID]不能为空！(In clscc_CourseTypeWApi.GetObjByCourseTypeID_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseTypeID.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseTypeID]的长度:[{0}]不正确！(clscc_CourseTypeWApi.GetObjByCourseTypeID_Cache)", strCourseTypeID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrcc_CourseType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objcc_CourseType_Const = await cc_CourseType_GetObjByCourseTypeIDAsync(strCourseTypeID);
                    if (objcc_CourseType_Const != null) {
                        cc_CourseType_ReFreshThisCache();
                        return objcc_CourseType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function cc_CourseType_GetObjByCourseTypeID_localStorage(strCourseTypeID) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseTypeID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseTypeID]不能为空！(In clscc_CourseTypeWApi.GetObjByCourseTypeID_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseTypeID.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseTypeID]的长度:[{0}]不正确！(clscc_CourseTypeWApi.GetObjByCourseTypeID_localStorage)", strCourseTypeID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN._CurrTabName, strCourseTypeID);
        if (strKey == "") {
    ...
    */
    async function cc_CourseType_GetNameByCourseTypeID_Cache(strCourseTypeID) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseTypeID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseTypeID]不能为空！(In clscc_CourseTypeWApi.GetNameByCourseTypeID_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseTypeID.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseTypeID]的长度:[{0}]不正确！(clscc_CourseTypeWApi.GetNameByCourseTypeID_Cache)", strCourseTypeID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrcc_CourseTypeObjLst_Cache = await cc_CourseType_GetObjLst_Cache();
    ...
    */
    async function cc_CourseType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objcc_CourseType == null)
            return "";
        if (objcc_CourseType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function cc_CourseType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrcc_CourseType = await cc_CourseType_GetObjLst_Cache();
        if (arrcc_CourseType == null)
            return [];
        let arrcc_CourseType_Sel = arrcc_CourseType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrcc_CourseType_Sel = arrcc_CourseType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrcc_CourseType_Sel = arrcc_CourseType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrcc_CourseType_Sel = arrcc_CourseType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrcc_CourseType_Sel = arrcc_CourseType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrcc_CourseType_Sel.length == 0)
            return [];
        return arrcc_CourseType_Sel.map(x => x.courseTypeID);
    }
    exports.cc_CourseType_funcKey = cc_CourseType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function cc_CourseType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrcc_CourseTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrcc_CourseTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function cc_CourseType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseTypeExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cc_CourseType_ConstructorName, strThisFuncName);
    ...
    **/
    async function cc_CourseType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseTypeExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrcc_CourseType_Sel = arrcc_CourseType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function cc_CourseType_DelRecordAsync(strCourseTypeID) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strCourseTypeID);
        try {
    ...
    **/
    async function cc_CourseType_UpdateRecordAsync(objcc_CourseTypeEN) {
        ...
        if (objcc_CourseTypeEN.sf_UpdFldSetStr === undefined || objcc_CourseTypeEN.sf_UpdFldSetStr === null || objcc_CourseTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objcc_CourseTypeEN.courseTypeID);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cc_CourseType_Controller, strAction);
        try {
    ...
    */
    async function cc_CourseType_IsExistRecord_Cache(objcc_CourseType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objcc_CourseType_Cond), exports.cc_CourseType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function cc_CourseType_IsExist_Cache(strCourseTypeID) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCourseTypeID, exports.cc_CourseType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function cc_CourseType_BindDdl_CourseTypeIDInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_CourseTypeIDInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function cc_CourseType_CheckPropertyNew(pobjcc_CourseTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.courseTypeName) === true) {
            throw new Error("(errid:Watl000058)字段[课程类型名称]不能为空(In 课程类型)!(clscc_CourseTypeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.courseTypeID) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseTypeEN.courseTypeID) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.courseTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseTypeEN.courseTypeName) > 30) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.id_School) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseTypeEN.id_School) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.courseTypeID) == false && undefined !== pobjcc_CourseTypeEN.courseTypeID && clsString_js_1.tzDataType.isString(pobjcc_CourseTypeEN.courseTypeID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.courseTypeName) == false && undefined !== pobjcc_CourseTypeEN.courseTypeName && clsString_js_1.tzDataType.isString(pobjcc_CourseTypeEN.courseTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.id_School) == false && undefined !== pobjcc_CourseTypeEN.id_School && clsString_js_1.tzDataType.isString(pobjcc_CourseTypeEN.id_School) === false) {
        ...
        if (null != pobjcc_CourseTypeEN.isUse && undefined !== pobjcc_CourseTypeEN.isUse && clsString_js_1.tzDataType.isBoolean(pobjcc_CourseTypeEN.isUse) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.updDate) == false && undefined !== pobjcc_CourseTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjcc_CourseTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.updUserId) == false && undefined !== pobjcc_CourseTypeEN.updUserId && clsString_js_1.tzDataType.isString(pobjcc_CourseTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.memo) == false && undefined !== pobjcc_CourseTypeEN.memo && clsString_js_1.tzDataType.isString(pobjcc_CourseTypeEN.memo) === false) {
    ...
    */
    function cc_CourseType_CheckProperty4Update(pobjcc_CourseTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseTypeEN.courseTypeID) === true
    ...
    */
    function cc_CourseType_GetCombineCondition(objcc_CourseType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_CourseTypeID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_CourseTypeID, objcc_CourseType_Cond.courseTypeID, strComparisonOp_CourseTypeID);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_CourseTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_CourseTypeName, objcc_CourseType_Cond.courseTypeName, strComparisonOp_CourseTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_id_School) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_id_School, objcc_CourseType_Cond.id_School, strComparisonOp_id_School);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_IsUse) == true) {
            if (objcc_CourseType_Cond.isUse == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_IsUse);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_IsUse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_UpdDate, objcc_CourseType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_UpdUserId, objcc_CourseType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseType_Cond.dicFldComparisonOp, clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseTypeEN_js_1.clscc_CourseTypeEN.con_Memo, objcc_CourseType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
