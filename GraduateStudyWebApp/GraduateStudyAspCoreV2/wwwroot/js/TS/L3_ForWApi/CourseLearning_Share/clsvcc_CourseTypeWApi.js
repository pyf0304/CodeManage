...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/CourseLearning_Share/clsvcc_CourseTypeEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vcc_CourseType_GetObjByCourseTypeIDAsync(strCourseTypeID) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseTypeID) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseTypeID]不能为空！(In clsvcc_CourseTypeWApi.GetObjByCourseTypeIDAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseTypeID.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseTypeID]的长度:[{0}]不正确！(clsvcc_CourseTypeWApi.GetObjByCourseTypeIDAsync)", strCourseTypeID.length);
            console.error(strMsg);
            throw (strMsg);
        }
