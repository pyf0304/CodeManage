...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/UserManage/clsUserIdentityEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function UserIdentity_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsUserIdentityEN_js_1.clsUserIdentityEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsUserIdentityEN_js_1.clsUserIdentityEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
