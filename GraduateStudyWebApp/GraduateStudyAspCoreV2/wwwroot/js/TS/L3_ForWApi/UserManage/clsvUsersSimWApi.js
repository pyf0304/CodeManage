...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/UserManage/clsvUsersSimEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function vUsersSim_func(strInFldName, strOutFldName, strInValue, strCmPrjId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCmPrjId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCmPrjId_C]不能为空！(In func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCmPrjId_C.length != 6) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCmPrjId_C]的长度:[{0}]不正确！", strCmPrjId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vUsersSim_funcKey(strInFldName, strInValue, strComparisonOp, strCmPrjId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCmPrjId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCmPrjId_C]不能为空！(In funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCmPrjId_C.length != 6) {
    ...
    **/
    async function vUsersSim_GetObjLst_Cache(strCmPrjId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCmPrjId) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[CmPrjId]不能为空！");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCmPrjId.length != 6) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCmPrjId]的长度:[{0}]不正确！", strCmPrjId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vUsersSim_BindDdl_UserIdInDiv_Cache(strDivName, strDdlName, strCmPrjId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCmPrjId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCmPrjId]不能为空！(In BindDdl_UserIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCmPrjId.length != 6) {
