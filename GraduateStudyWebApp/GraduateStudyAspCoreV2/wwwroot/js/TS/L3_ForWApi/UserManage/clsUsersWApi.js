...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/UserManage/clsUsersEN.js", "../../L3_ForWApi/UserManage/clsvUsersWApi.js", "../../L3_ForWApi/UserManage/clsvUsersSimWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function Users_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsUsersEN_js_1.clsUsersEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsUsersEN_js_1.clsUsersEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
