...
(function (factory) {
    ...
    **/
    async function CacheMode_GetObjByCacheModeIdAsync(strCacheModeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCacheModeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCacheModeId]不能为空！(In clsCacheModeWApi.GetObjByCacheModeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCacheModeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCacheModeId]的长度:[{0}]不正确！(clsCacheModeWApi.GetObjByCacheModeIdAsync)", strCacheModeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cacheMode_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cacheMode_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function CacheMode_GetObjByCacheModeId_Cache(strCacheModeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCacheModeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCacheModeId]不能为空！(In clsCacheModeWApi.GetObjByCacheModeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCacheModeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCacheModeId]的长度:[{0}]不正确！(clsCacheModeWApi.GetObjByCacheModeId_Cache)", strCacheModeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrCacheMode_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objCacheMode_Const = await CacheMode_GetObjByCacheModeIdAsync(strCacheModeId);
                    if (objCacheMode_Const != null) {
                        CacheMode_ReFreshThisCache();
                        return objCacheMode_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function CacheMode_GetObjByCacheModeId_localStorage(strCacheModeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCacheModeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCacheModeId]不能为空！(In clsCacheModeWApi.GetObjByCacheModeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCacheModeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCacheModeId]的长度:[{0}]不正确！(clsCacheModeWApi.GetObjByCacheModeId_localStorage)", strCacheModeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsCacheModeEN_js_1.clsCacheModeEN._CurrTabName, strCacheModeId);
        if (strKey == "") {
    ...
    */
    async function CacheMode_GetNameByCacheModeId_Cache(strCacheModeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCacheModeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCacheModeId]不能为空！(In clsCacheModeWApi.GetNameByCacheModeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCacheModeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCacheModeId]的长度:[{0}]不正确！(clsCacheModeWApi.GetNameByCacheModeId_Cache)", strCacheModeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrCacheModeObjLst_Cache = await CacheMode_GetObjLst_Cache();
    ...
    */
    async function CacheMode_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsCacheModeEN_js_1.clsCacheModeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsCacheModeEN_js_1.clsCacheModeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objCacheMode == null)
            return "";
        if (objCacheMode.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeENName:
                    return (a, b) => {
                        if (a.cacheModeENName == null)
                            return -1;
                        if (b.cacheModeENName == null)
                            return 1;
                        return a.cacheModeENName.localeCompare(b.cacheModeENName);
                    };
                case clsCacheModeEN_js_1.clsCacheModeEN.con_InUse:
                    return (a, b) => {
                        if (a.inUse == true)
                            return 1;
                        else
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function CacheMode_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrCacheMode = await CacheMode_GetObjLst_Cache();
        if (arrCacheMode == null)
            return [];
        let arrCacheMode_Sel = arrCacheMode;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrCacheMode_Sel = arrCacheMode_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrCacheMode_Sel.length == 0)
            return [];
        return arrCacheMode_Sel.map(x => x.cacheModeId);
    }
    exports.CacheMode_funcKey = CacheMode_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function CacheMode_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsCacheModeEN_js_1.clsCacheModeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsCacheModeEN_js_1.clsCacheModeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrCacheModeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrCacheModeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCacheModeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function CacheMode_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCacheModeExObjLst.length);
            console.log(strInfo);
            return arrCacheModeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cacheMode_ConstructorName, strThisFuncName);
    ...
    **/
    async function CacheMode_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCacheModeExObjLst.length);
            console.log(strInfo);
            return arrCacheModeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrCacheMode_Sel = arrCacheMode_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function CacheMode_DelRecordAsync(strCacheModeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strCacheModeId);
        try {
    ...
    **/
    async function CacheMode_UpdateRecordAsync(objCacheModeEN) {
        ...
        if (objCacheModeEN.sf_UpdFldSetStr === undefined || objCacheModeEN.sf_UpdFldSetStr === null || objCacheModeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objCacheModeEN.cacheModeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cacheMode_Controller, strAction);
        try {
    ...
    */
    async function CacheMode_IsExistRecord_Cache(objCacheMode_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objCacheMode_Cond), exports.cacheMode_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function CacheMode_IsExist_Cache(strCacheModeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCacheModeId, exports.cacheMode_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
     ...
     * @param bolInUse:是否在用
    */
    async function CacheMode_BindDdl_CacheModeIdByInUseInDiv_Cache(strDivName, strDdlName, bolInUse) {
        const strThisFuncName = "BindDdl_CacheModeIdByInUseInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_CacheModeIdByInUseInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_CacheModeIdByInUseInDiv_Cache");
        let arrObjLst_Sel = await CacheMode_GetObjLst_Cache();
        if (arrObjLst_Sel == null)
            return;
        arrObjLst_Sel = arrObjLst_Sel.filter(x => x.inUse == bolInUse);
    ...
    exports.CacheMode_BindDdl_CacheModeIdByInUseInDiv_Cache = CacheMode_BindDdl_CacheModeIdByInUseInDiv_Cache;
    /**
    ...
    */
    function CacheMode_CheckPropertyNew(pobjCacheModeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeName) === true) {
            throw new Error("(errid:Watl000058)字段[缓存方式名]不能为空(In 缓存方式)!(clsCacheModeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeId) == false && (0, clsString_js_2.GetStrLen)(pobjCacheModeEN.cacheModeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeName) == false && (0, clsString_js_2.GetStrLen)(pobjCacheModeEN.cacheModeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeENName) == false && (0, clsString_js_2.GetStrLen)(pobjCacheModeEN.cacheModeENName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjCacheModeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeId) == false && undefined !== pobjCacheModeEN.cacheModeId && clsString_js_1.tzDataType.isString(pobjCacheModeEN.cacheModeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeName) == false && undefined !== pobjCacheModeEN.cacheModeName && clsString_js_1.tzDataType.isString(pobjCacheModeEN.cacheModeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeENName) == false && undefined !== pobjCacheModeEN.cacheModeENName && clsString_js_1.tzDataType.isString(pobjCacheModeEN.cacheModeENName) === false) {
        ...
        if (null != pobjCacheModeEN.inUse && undefined !== pobjCacheModeEN.inUse && clsString_js_1.tzDataType.isBoolean(pobjCacheModeEN.inUse) === false) {
            throw new Error("(errid:Watl000060)字段[是否在用(inUse)]的值:[$(pobjCacheModeEN.inUse)], 非法，应该为布尔型(In 缓存方式(CacheMode))!(clsCacheModeBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.memo) == false && undefined !== pobjCacheModeEN.memo && clsString_js_1.tzDataType.isString(pobjCacheModeEN.memo) === false) {
    ...
    */
    function CacheMode_CheckProperty4Update(pobjCacheModeEN) {
        ...
        if (null != pobjCacheModeEN.inUse && undefined !== pobjCacheModeEN.inUse && clsString_js_1.tzDataType.isBoolean(pobjCacheModeEN.inUse) === false) {
            throw new Error("(errid:Watl000063)字段[是否在用(inUse)]的值:[$(pobjCacheModeEN.inUse)], 非法，应该为布尔型(In 缓存方式(CacheMode))!(clsCacheModeBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.memo) == false && undefined !== pobjCacheModeEN.memo && clsString_js_1.tzDataType.isString(pobjCacheModeEN.memo) === false) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCacheModeEN.cacheModeId) === true) {
    ...
    */
    function CacheMode_GetCombineCondition(objCacheMode_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objCacheMode_Cond.dicFldComparisonOp, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeId, objCacheMode_Cond.cacheModeId, strComparisonOp_CacheModeId);
        }
        if (Object.prototype.hasOwnProperty.call(objCacheMode_Cond.dicFldComparisonOp, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeName, objCacheMode_Cond.cacheModeName, strComparisonOp_CacheModeName);
        }
        if (Object.prototype.hasOwnProperty.call(objCacheMode_Cond.dicFldComparisonOp, clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeENName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCacheModeEN_js_1.clsCacheModeEN.con_CacheModeENName, objCacheMode_Cond.cacheModeENName, strComparisonOp_CacheModeENName);
        }
        if (Object.prototype.hasOwnProperty.call(objCacheMode_Cond.dicFldComparisonOp, clsCacheModeEN_js_1.clsCacheModeEN.con_InUse) == true) {
            if (objCacheMode_Cond.inUse == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsCacheModeEN_js_1.clsCacheModeEN.con_InUse);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsCacheModeEN_js_1.clsCacheModeEN.con_InUse);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objCacheMode_Cond.dicFldComparisonOp, clsCacheModeEN_js_1.clsCacheModeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCacheModeEN_js_1.clsCacheModeEN.con_Memo, objCacheMode_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function CacheMode_GetUniCondStr_CacheModeId(objCacheModeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and CacheModeId = '{0}'", objCacheModeEN.cacheModeId);
        return strWhereCond;
    }
