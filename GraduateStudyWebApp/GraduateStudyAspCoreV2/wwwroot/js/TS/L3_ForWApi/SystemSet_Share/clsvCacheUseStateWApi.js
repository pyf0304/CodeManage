...
(function (factory) {
    ...
    **/
    async function vCacheUseState_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvCacheUseStateWApi.GetObjBymIdAsync)");
    ...
    */
    async function vCacheUseState_GetObjBymId_Cache(lngmId, strUserId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvCacheUseStateWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vCacheUseState_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvCacheUseStateWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vCacheUseState_func(strInFldName, strOutFldName, strInValue, strUserId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId_C]不能为空！(In clsvCacheUseStateWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvCacheUseState == null)
            return "";
        if (objvCacheUseState.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.con_CacheModeId:
                    return (a, b) => {
                        if (a.cacheModeId == null)
                            return -1;
                        if (b.cacheModeId == null)
                            return 1;
                        return a.cacheModeId.localeCompare(b.cacheModeId);
                    };
                case clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.con_CacheModeName:
                    return (a, b) => {
                        if (a.cacheModeName == null)
                            return -1;
                        if (b.cacheModeName == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vCacheUseState_funcKey(strInFldName, strInValue, strComparisonOp, strUserId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId_C]不能为空！(In clsvCacheUseStateWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.con_mId) {
            ...
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrvCacheUseState_Sel = arrvCacheUseState_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrvCacheUseState_Sel = arrvCacheUseState_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrvCacheUseState_Sel = arrvCacheUseState_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrvCacheUseState_Sel = arrvCacheUseState_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
    ...
    exports.vCacheUseState_funcKey = vCacheUseState_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vCacheUseState_GetObjLst_ClientCache(strUserId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvCacheUseStateEN_js_1.clsvCacheUseStateEN.WhereFormat, strUserId);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvCacheUseStateExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvCacheUseStateExObjLst);
    ...
    **/
    async function vCacheUseState_GetObjLst_Cache(strUserId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[UserId]不能为空！(in clsvCacheUseStateWApi.vCacheUseState_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
