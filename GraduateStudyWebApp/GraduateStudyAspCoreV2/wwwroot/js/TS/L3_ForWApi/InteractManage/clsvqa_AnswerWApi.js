...
(function (factory) {
    ...
    **/
    async function vqa_Answer_GetObjByAnswerIdAsync(strAnswerId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAnswerId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAnswerId]不能为空！(In clsvqa_AnswerWApi.GetObjByAnswerIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAnswerId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strAnswerId]的长度:[{0}]不正确！(clsvqa_AnswerWApi.GetObjByAnswerIdAsync)", strAnswerId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vqa_Answer_GetObjByAnswerId_Cache(strAnswerId, strTopicId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAnswerId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAnswerId]不能为空！(In clsvqa_AnswerWApi.GetObjByAnswerId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAnswerId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strAnswerId]的长度:[{0}]不正确！(clsvqa_AnswerWApi.GetObjByAnswerId_Cache)", strAnswerId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vqa_Answer_GetObjByAnswerId_localStorage(strAnswerId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strAnswerId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strAnswerId]不能为空！(In clsvqa_AnswerWApi.GetObjByAnswerId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strAnswerId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strAnswerId]的长度:[{0}]不正确！(clsvqa_AnswerWApi.GetObjByAnswerId_localStorage)", strAnswerId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vqa_Answer_func(strInFldName, strOutFldName, strInValue, strTopicId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId_C]不能为空！(In clsvqa_AnswerWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsvqa_AnswerWApi.func)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvqa_AnswerEN_js_1.clsvqa_AnswerEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvqa_AnswerEN_js_1.clsvqa_AnswerEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvqa_Answer == null)
            return "";
        if (objvqa_Answer.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvqa_AnswerEN_js_1.clsvqa_AnswerEN.con_QuestUserName:
                    return (a, b) => {
                        if (a.questUserName == null)
                            return -1;
                        if (b.questUserName == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vqa_Answer_funcKey(strInFldName, strInValue, strComparisonOp, strTopicId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId_C]不能为空！(In clsvqa_AnswerWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsvqa_AnswerWApi.funcKey)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvqa_AnswerEN_js_1.clsvqa_AnswerEN.con_AnswerId) {
    ...
    exports.vqa_Answer_funcKey = vqa_Answer_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vqa_Answer_GetObjLst_ClientCache(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvqa_AnswerEN_js_1.clsvqa_AnswerEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvqa_AnswerEN_js_1.clsvqa_AnswerEN.WhereFormat, strTopicId);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvqa_AnswerExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvqa_AnswerExObjLst);
    ...
    **/
    async function vqa_Answer_GetObjLst_Cache(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[TopicId]不能为空！(in clsvqa_AnswerWApi.vqa_Answer_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(in clsvqa_AnswerWApi.vqa_Answer_GetObjLst_Cache() )", strTopicId.length);
            console.error(strMsg);
            throw (strMsg);
        }
