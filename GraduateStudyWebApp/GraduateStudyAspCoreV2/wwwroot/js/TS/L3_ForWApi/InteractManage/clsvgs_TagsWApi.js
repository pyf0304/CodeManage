...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/InteractManage/clsvgs_TagsEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vgs_Tags_GetObjByTagsIdAsync(strTagsId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTagsId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTagsId]不能为空！(In clsvgs_TagsWApi.GetObjByTagsIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTagsId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTagsId]的长度:[{0}]不正确！(clsvgs_TagsWApi.GetObjByTagsIdAsync)", strTagsId.length);
            console.error(strMsg);
            throw (strMsg);
        }
