...
(function (factory) {
    ...
    **/
    async function qa_QuestionsType_GetObjByQuestionsTypeIdAsync(strQuestionsTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strQuestionsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strQuestionsTypeId]不能为空！(In clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strQuestionsTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strQuestionsTypeId]的长度:[{0}]不正确！(clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeIdAsync)", strQuestionsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.qa_QuestionsType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.qa_QuestionsType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function qa_QuestionsType_GetObjByQuestionsTypeId_Cache(strQuestionsTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strQuestionsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strQuestionsTypeId]不能为空！(In clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strQuestionsTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strQuestionsTypeId]的长度:[{0}]不正确！(clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_Cache)", strQuestionsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrqa_QuestionsType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objqa_QuestionsType_Const = await qa_QuestionsType_GetObjByQuestionsTypeIdAsync(strQuestionsTypeId);
                    if (objqa_QuestionsType_Const != null) {
                        qa_QuestionsType_ReFreshThisCache();
                        return objqa_QuestionsType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function qa_QuestionsType_GetObjByQuestionsTypeId_localStorage(strQuestionsTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strQuestionsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strQuestionsTypeId]不能为空！(In clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strQuestionsTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strQuestionsTypeId]的长度:[{0}]不正确！(clsqa_QuestionsTypeWApi.GetObjByQuestionsTypeId_localStorage)", strQuestionsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN._CurrTabName, strQuestionsTypeId);
        if (strKey == "") {
    ...
    */
    async function qa_QuestionsType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objqa_QuestionsType == null)
            return "";
        if (objqa_QuestionsType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function qa_QuestionsType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrqa_QuestionsType = await qa_QuestionsType_GetObjLst_Cache();
        if (arrqa_QuestionsType == null)
            return [];
        let arrqa_QuestionsType_Sel = arrqa_QuestionsType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrqa_QuestionsType_Sel = arrqa_QuestionsType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrqa_QuestionsType_Sel = arrqa_QuestionsType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrqa_QuestionsType_Sel = arrqa_QuestionsType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrqa_QuestionsType_Sel = arrqa_QuestionsType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrqa_QuestionsType_Sel.length == 0)
            return [];
        return arrqa_QuestionsType_Sel.map(x => x.questionsTypeId);
    }
    exports.qa_QuestionsType_funcKey = qa_QuestionsType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function qa_QuestionsType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrqa_QuestionsTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrqa_QuestionsTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_QuestionsTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function qa_QuestionsType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_QuestionsTypeExObjLst.length);
            console.log(strInfo);
            return arrqa_QuestionsTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.qa_QuestionsType_ConstructorName, strThisFuncName);
    ...
    **/
    async function qa_QuestionsType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrqa_QuestionsTypeExObjLst.length);
            console.log(strInfo);
            return arrqa_QuestionsTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrqa_QuestionsType_Sel = arrqa_QuestionsType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function qa_QuestionsType_DelRecordAsync(strQuestionsTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strQuestionsTypeId);
        try {
    ...
    **/
    async function qa_QuestionsType_UpdateRecordAsync(objqa_QuestionsTypeEN) {
        ...
        if (objqa_QuestionsTypeEN.sf_UpdFldSetStr === undefined || objqa_QuestionsTypeEN.sf_UpdFldSetStr === null || objqa_QuestionsTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objqa_QuestionsTypeEN.questionsTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.qa_QuestionsType_Controller, strAction);
        try {
    ...
    */
    async function qa_QuestionsType_IsExistRecord_Cache(objqa_QuestionsType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objqa_QuestionsType_Cond), exports.qa_QuestionsType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function qa_QuestionsType_IsExist_Cache(strQuestionsTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strQuestionsTypeId, exports.qa_QuestionsType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function qa_QuestionsType_CheckPropertyNew(pobjqa_QuestionsTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.questionsTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjqa_QuestionsTypeEN.questionsTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.questionsTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjqa_QuestionsTypeEN.questionsTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjqa_QuestionsTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.questionsTypeId) == false && undefined !== pobjqa_QuestionsTypeEN.questionsTypeId && clsString_js_1.tzDataType.isString(pobjqa_QuestionsTypeEN.questionsTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.questionsTypeName) == false && undefined !== pobjqa_QuestionsTypeEN.questionsTypeName && clsString_js_1.tzDataType.isString(pobjqa_QuestionsTypeEN.questionsTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.memo) == false && undefined !== pobjqa_QuestionsTypeEN.memo && clsString_js_1.tzDataType.isString(pobjqa_QuestionsTypeEN.memo) === false) {
    ...
    */
    function qa_QuestionsType_CheckProperty4Update(pobjqa_QuestionsTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjqa_QuestionsTypeEN.questionsTypeId) === true) {
    ...
    */
    function qa_QuestionsType_GetCombineCondition(objqa_QuestionsType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objqa_QuestionsType_Cond.dicFldComparisonOp, clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.con_QuestionsTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.con_QuestionsTypeId, objqa_QuestionsType_Cond.questionsTypeId, strComparisonOp_QuestionsTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_QuestionsType_Cond.dicFldComparisonOp, clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.con_QuestionsTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.con_QuestionsTypeName, objqa_QuestionsType_Cond.questionsTypeName, strComparisonOp_QuestionsTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objqa_QuestionsType_Cond.dicFldComparisonOp, clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsqa_QuestionsTypeEN_js_1.clsqa_QuestionsTypeEN.con_Memo, objqa_QuestionsType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function qa_QuestionsType_GetUniCondStr_QuestionsTypeId(objqa_QuestionsTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and QuestionsTypeId = '{0}'", objqa_QuestionsTypeEN.questionsTypeId);
        return strWhereCond;
    }
