...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/Knowledges/clsgs_KnowledgesGraphEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function gs_KnowledgesGraph_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if (clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function gs_KnowledgesGraph_GetObjLst_ClientCache(strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.WhereFormat, strCourseId);
        }
        else {
    ...
    */
    async function gs_KnowledgesGraph_BindDdl_KnowledgeGraphIdInDiv_Cache(strDivName, strDdlName, strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseId]不能为空！(In BindDdl_KnowledgeGraphIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_KnowledgeGraphIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_KnowledgesGraph_CheckPropertyNew(pobjgs_KnowledgesGraphEN) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.takeUpTime) == false && (0, clsString_js_1.GetStrLen)(pobjgs_KnowledgesGraphEN.takeUpTime) > 50) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.takeUpTime) == false && undefined !== pobjgs_KnowledgesGraphEN.takeUpTime && jsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.takeUpTime) === false) {
    ...
    */
    function gs_KnowledgesGraph_GetCombineCondition(objgs_KnowledgesGraph_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_TakeUpTime) == true) {
            ...
            strWhereCond += (0, clsString_js_1.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_TakeUpTime, objgs_KnowledgesGraph_Cond.takeUpTime, strComparisonOp_TakeUpTime);
        }
        return strWhereCond;
    }
