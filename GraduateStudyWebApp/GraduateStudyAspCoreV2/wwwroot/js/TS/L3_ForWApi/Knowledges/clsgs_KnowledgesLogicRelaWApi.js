...
(function (factory) {
    ...
    **/
    async function gs_KnowledgesLogicRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_KnowledgesLogicRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_KnowledgesLogicRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_KnowledgesLogicRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
     ...
     * @returns 对象
    */
    async function gs_KnowledgesLogicRela_GetObjBymId_Cache(lngmId, strCourseId, bolTryAsyncOnce = true) {
        const strThisFuncName = "GetObjBymId_Cache";
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_KnowledgesLogicRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_KnowledgesLogicRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_KnowledgesLogicRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
     ...
     * @returns 对象
    */
    async function gs_KnowledgesLogicRela_UpdateObjInLst_Cache(objgs_KnowledgesLogicRela, strCourseId) {
     ...
     * @returns 返回一个输出字段值
    */
    async function gs_KnowledgesLogicRela_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        //const strThisFuncName = "func";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId_C]不能为空！(In clsgs_KnowledgesLogicRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsgs_KnowledgesLogicRelaWApi.func)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_KnowledgesLogicRela == null)
            return "";
        if (objgs_KnowledgesLogicRela.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeTitleA:
                    return (a, b) => {
                        if (a.courseKnowledgeTitleA == null)
                            return -1;
                        if (b.courseKnowledgeTitleA == null)
                            return 1;
                        return a.courseKnowledgeTitleA.localeCompare(b.courseKnowledgeTitleA);
                    };
                ...
                case clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeTitleB:
                    return (a, b) => {
                        if (a.courseKnowledgeTitleB == null)
                            return -1;
                        if (b.courseKnowledgeTitleB == null)
                            return 1;
                ...
                case clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_SourceAnchor:
                    return (a, b) => {
                        if (a.sourceAnchor == null)
                            return -1;
                        if (b.sourceAnchor == null)
                            return 1;
                ...
                case clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_TargetAnchor:
                    return (a, b) => {
                        if (a.targetAnchor == null)
                            return -1;
                        if (b.targetAnchor == null)
                            return 1;
                ...
                case clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_RelaTypeId:
                    return (a, b) => {
                        if (a.relaTypeId == null)
                            return -1;
                        if (b.relaTypeId == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_KnowledgesLogicRela_funcKey(strInFldName, strInValue, strComparisonOp, strCourseId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId_C]不能为空！(In clsgs_KnowledgesLogicRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsgs_KnowledgesLogicRelaWApi.funcKey)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_mId) {
        ...
        if (arrgs_KnowledgesLogicRela == null)
            return [];
    ...
    exports.gs_KnowledgesLogicRela_funcKey = gs_KnowledgesLogicRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_ClientCache(strCourseId) {
        const strThisFuncName = "GetObjLst_ClientCache";
        //初始化列表缓存
        let strWhereCond = "1=1";
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.WhereFormat, strCourseId);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("CourseId='{0}'", strCourseId);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN._CurrTabName, strCourseId);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_KnowledgesLogicRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_KnowledgesLogicRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesLogicRelaExObjLst.length);
            console.log(strInfo);
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_localStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesLogicRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesLogicRelaExObjLst;
        }
        catch (e) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_localStorage_PureCache(strCourseId) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_KnowledgesLogicRela_ConstructorName, strThisFuncName);
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_sessionStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesLogicRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesLogicRelaExObjLst;
        }
        catch (e) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_sessionStorage_PureCache(strCourseId) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_Cache(strCourseId) {
        //const strThisFuncName = "GetObjLst_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[CourseId]不能为空！(in clsgs_KnowledgesLogicRelaWApi.gs_KnowledgesLogicRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(in clsgs_KnowledgesLogicRelaWApi.gs_KnowledgesLogicRela_GetObjLst_Cache() )", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function gs_KnowledgesLogicRela_GetObjLst_PureCache(strCourseId) {
     ...
     * @returns 对象列表子集
    */
    async function gs_KnowledgesLogicRela_GetSubObjLst_Cache(objgs_KnowledgesLogicRela_Cond, strCourseId) {
    ...
    **/
     ...
     * @returns 对象列表
    */
    async function gs_KnowledgesLogicRela_GetObjLstBymIdLst_Cache(arrmIdLst, strCourseId) {
    ...
    */
     ...
     * @returns 对象列表
    */
    async function gs_KnowledgesLogicRela_GetObjLstByPager_Cache(objPagerPara, strCourseId) {
    ...
    **/
    async function gs_KnowledgesLogicRela_UpdateRecordAsync(objgs_KnowledgesLogicRelaEN) {
        ...
        if (objgs_KnowledgesLogicRelaEN.sf_UpdFldSetStr === undefined || objgs_KnowledgesLogicRelaEN.sf_UpdFldSetStr === null || objgs_KnowledgesLogicRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_KnowledgesLogicRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_KnowledgesLogicRela_Controller, strAction);
        try {
    ...
    **/
     ...
     * @returns 对象列表子集
    */
    async function gs_KnowledgesLogicRela_IsExistRecord_Cache(objgs_KnowledgesLogicRela_Cond, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_KnowledgesLogicRela_Cond), exports.gs_KnowledgesLogicRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
     ...
     * @returns 对象
    */
    async function gs_KnowledgesLogicRela_IsExist_Cache(lngmId, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_KnowledgesLogicRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
     ...
     * @returns 对象列表记录数
    */
    async function gs_KnowledgesLogicRela_GetRecCountByCond_Cache(objgs_KnowledgesLogicRela_Cond, strCourseId) {
    ...
    **/
    function gs_KnowledgesLogicRela_ReFreshCache(strCourseId) {
        const strThisFuncName = "ReFreshCache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId]不能为空！(In clsgs_KnowledgesLogicRelaWApi.clsgs_KnowledgesLogicRelaWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(clsgs_KnowledgesLogicRelaWApi.clsgs_KnowledgesLogicRelaWApi.ReFreshCache)", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    function gs_KnowledgesLogicRela_ReFreshThisCache(strCourseId) {
    ...
    */
    function gs_KnowledgesLogicRela_CheckPropertyNew(pobjgs_KnowledgesLogicRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdA) === true) {
            throw new Error("(errid:Watl000058)字段[课程知识点AId]不能为空(In 知识点逻辑关系表)!(clsgs_KnowledgesLogicRelaBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdB) === true) {
            throw new Error("(errid:Watl000058)字段[课程知识点BId]不能为空(In 知识点逻辑关系表)!(clsgs_KnowledgesLogicRelaBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdA) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdA) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleA) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleA) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdB) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdB) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleB) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleB) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.knowledgeGraphId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.knowledgeGraphId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.sourceAnchor) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.sourceAnchor) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.targetAnchor) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.targetAnchor) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.relaTitle) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.relaTitle) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.relaTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.relaTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.courseId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesLogicRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_KnowledgesLogicRelaEN.mId && undefined !== pobjgs_KnowledgesLogicRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_KnowledgesLogicRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdA) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdA && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdA) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleA) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleA && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleA) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdB) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdB && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeIdB) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleB) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleB && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.courseKnowledgeTitleB) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.knowledgeGraphId) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.knowledgeGraphId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.knowledgeGraphId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.sourceAnchor) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.sourceAnchor && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.sourceAnchor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.targetAnchor) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.targetAnchor && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.targetAnchor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.relaTitle) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.relaTitle && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.relaTitle) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.relaTypeId) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.relaTypeId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.relaTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.courseId) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.courseId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.courseId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.updUser) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.updDate) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesLogicRelaEN.memo) == false && undefined !== pobjgs_KnowledgesLogicRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesLogicRelaEN.memo) === false) {
    ...
    */
    function gs_KnowledgesLogicRela_GetCombineCondition(objgs_KnowledgesLogicRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_mId, objgs_KnowledgesLogicRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeIdA) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeIdA, objgs_KnowledgesLogicRela_Cond.courseKnowledgeIdA, strComparisonOp_CourseKnowledgeIdA);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeTitleA) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeTitleA, objgs_KnowledgesLogicRela_Cond.courseKnowledgeTitleA, strComparisonOp_CourseKnowledgeTitleA);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeIdB) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeIdB, objgs_KnowledgesLogicRela_Cond.courseKnowledgeIdB, strComparisonOp_CourseKnowledgeIdB);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeTitleB) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseKnowledgeTitleB, objgs_KnowledgesLogicRela_Cond.courseKnowledgeTitleB, strComparisonOp_CourseKnowledgeTitleB);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_KnowledgeGraphId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_KnowledgeGraphId, objgs_KnowledgesLogicRela_Cond.knowledgeGraphId, strComparisonOp_KnowledgeGraphId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_SourceAnchor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_SourceAnchor, objgs_KnowledgesLogicRela_Cond.sourceAnchor, strComparisonOp_SourceAnchor);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_TargetAnchor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_TargetAnchor, objgs_KnowledgesLogicRela_Cond.targetAnchor, strComparisonOp_TargetAnchor);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_RelaTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_RelaTitle, objgs_KnowledgesLogicRela_Cond.relaTitle, strComparisonOp_RelaTitle);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_RelaTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_RelaTypeId, objgs_KnowledgesLogicRela_Cond.relaTypeId, strComparisonOp_RelaTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_CourseId, objgs_KnowledgesLogicRela_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_UpdUser, objgs_KnowledgesLogicRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_UpdDate, objgs_KnowledgesLogicRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesLogicRela_Cond.dicFldComparisonOp, clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesLogicRelaEN_js_1.clsgs_KnowledgesLogicRelaEN.con_Memo, objgs_KnowledgesLogicRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_KnowledgesLogicRela_GetUniCondStr_KnowledgeGraphId_CourseKnowledgeIdA_CourseKnowledgeIdB(objgs_KnowledgesLogicRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeGraphId = '{0}'", objgs_KnowledgesLogicRelaEN.knowledgeGraphId);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseKnowledgeIdA = '{0}'", objgs_KnowledgesLogicRelaEN.courseKnowledgeIdA);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseKnowledgeIdB = '{0}'", objgs_KnowledgesLogicRelaEN.courseKnowledgeIdB);
        return strWhereCond;
    }
    ...
    **/
    function gs_KnowledgesLogicRela_GetUniCondStr4Update_KnowledgeGraphId_CourseKnowledgeIdA_CourseKnowledgeIdB(objgs_KnowledgesLogicRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId <> '{0}'", objgs_KnowledgesLogicRelaEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeGraphId = '{0}'", objgs_KnowledgesLogicRelaEN.knowledgeGraphId);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseKnowledgeIdA = '{0}'", objgs_KnowledgesLogicRelaEN.courseKnowledgeIdA);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseKnowledgeIdB = '{0}'", objgs_KnowledgesLogicRelaEN.courseKnowledgeIdB);
        return strWhereCond;
