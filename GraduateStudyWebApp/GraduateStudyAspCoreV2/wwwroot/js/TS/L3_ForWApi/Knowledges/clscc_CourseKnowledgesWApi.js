...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/Knowledges/clscc_CourseKnowledgesEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function cc_CourseKnowledges_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if (clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function cc_CourseKnowledges_GetObjLst_ClientCache(strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.WhereFormat, strCourseId);
        }
        else {
    ...
    */
    async function cc_CourseKnowledges_BindDdl_CourseKnowledgeIdInDiv_Cache(strDivName, strDdlName, strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseId]不能为空！(In BindDdl_CourseKnowledgeIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_CourseKnowledgeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
