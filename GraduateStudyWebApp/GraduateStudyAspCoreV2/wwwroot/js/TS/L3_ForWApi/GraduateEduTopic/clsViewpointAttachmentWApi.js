...
(function (factory) {
    ...
    **/
    async function ViewpointAttachment_GetObjByViewpointAttachmentIdAsync(lngViewpointAttachmentId) {
        ...
        if (lngViewpointAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngViewpointAttachmentId]不能为空！(In clsViewpointAttachmentWApi.GetObjByViewpointAttachmentIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpointAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpointAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ViewpointAttachment_GetObjByViewpointAttachmentId_Cache(lngViewpointAttachmentId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngViewpointAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngViewpointAttachmentId]不能为空！(In clsViewpointAttachmentWApi.GetObjByViewpointAttachmentId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function ViewpointAttachment_GetObjByViewpointAttachmentId_localStorage(lngViewpointAttachmentId) {
        ...
        if (lngViewpointAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngViewpointAttachmentId]不能为空！(In clsViewpointAttachmentWApi.GetObjByViewpointAttachmentId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN._CurrTabName, lngViewpointAttachmentId);
        if (strKey == "") {
    ...
    */
    async function ViewpointAttachment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsViewpointAttachmentWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsViewpointAttachmentWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objViewpointAttachment == null)
            return "";
        if (objViewpointAttachment.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointAttachmentName:
                    return (a, b) => {
                        if (a.viewpointAttachmentName == null)
                            return -1;
                        if (b.viewpointAttachmentName == null)
                            return 1;
                        return a.viewpointAttachmentName.localeCompare(b.viewpointAttachmentName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function ViewpointAttachment_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsViewpointAttachmentWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsViewpointAttachmentWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointAttachmentId) {
        ...
        if (arrViewpointAttachment == null)
            return [];
    ...
    exports.ViewpointAttachment_funcKey = ViewpointAttachment_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function ViewpointAttachment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrViewpointAttachmentExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrViewpointAttachmentExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAttachmentExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ViewpointAttachment_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAttachmentExObjLst.length);
            console.log(strInfo);
            return arrViewpointAttachmentExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpointAttachment_ConstructorName, strThisFuncName);
    ...
    **/
    async function ViewpointAttachment_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointAttachmentExObjLst.length);
            console.log(strInfo);
            return arrViewpointAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ViewpointAttachment_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsViewpointAttachmentWApi.ViewpointAttachment_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsViewpointAttachmentWApi.ViewpointAttachment_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function ViewpointAttachment_DelRecordAsync(lngViewpointAttachmentId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngViewpointAttachmentId);
        try {
    ...
    **/
    async function ViewpointAttachment_UpdateRecordAsync(objViewpointAttachmentEN) {
        ...
        if (objViewpointAttachmentEN.sf_UpdFldSetStr === undefined || objViewpointAttachmentEN.sf_UpdFldSetStr === null || objViewpointAttachmentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointAttachmentEN.viewpointAttachmentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpointAttachment_Controller, strAction);
        try {
    ...
    */
    async function ViewpointAttachment_IsExistRecord_Cache(objViewpointAttachment_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objViewpointAttachment_Cond), exports.viewpointAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ViewpointAttachment_IsExist_Cache(lngViewpointAttachmentId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngViewpointAttachmentId, exports.viewpointAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function ViewpointAttachment_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsViewpointAttachmentWApi.clsViewpointAttachmentWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsViewpointAttachmentWApi.clsViewpointAttachmentWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function ViewpointAttachment_CheckPropertyNew(pobjViewpointAttachmentEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.filePath) === true) {
            throw new Error("(errid:Watl000058)字段[文件路径]不能为空(In 观点附件表)!(clsViewpointAttachmentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.viewpointAttachmentName) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.viewpointAttachmentName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.viewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.filePath) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.filePath) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointAttachmentEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjViewpointAttachmentEN.viewpointAttachmentId && undefined !== pobjViewpointAttachmentEN.viewpointAttachmentId && clsString_js_1.tzDataType.isNumber(pobjViewpointAttachmentEN.viewpointAttachmentId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.viewpointAttachmentName) == false && undefined !== pobjViewpointAttachmentEN.viewpointAttachmentName && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.viewpointAttachmentName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.viewpointId) == false && undefined !== pobjViewpointAttachmentEN.viewpointId && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.filePath) == false && undefined !== pobjViewpointAttachmentEN.filePath && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.filePath) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.updUserId) == false && undefined !== pobjViewpointAttachmentEN.updUserId && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.updDate) == false && undefined !== pobjViewpointAttachmentEN.updDate && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.memo) == false && undefined !== pobjViewpointAttachmentEN.memo && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointAttachmentEN.id_CurrEduCls) == false && undefined !== pobjViewpointAttachmentEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjViewpointAttachmentEN.id_CurrEduCls) === false) {
    ...
    */
    function ViewpointAttachment_GetCombineCondition(objViewpointAttachment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointAttachmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointAttachmentId, objViewpointAttachment_Cond.viewpointAttachmentId, strComparisonOp_ViewpointAttachmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointAttachmentName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointAttachmentName, objViewpointAttachment_Cond.viewpointAttachmentName, strComparisonOp_ViewpointAttachmentName);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_ViewpointId, objViewpointAttachment_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_FilePath) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_FilePath, objViewpointAttachment_Cond.filePath, strComparisonOp_FilePath);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_UpdUserId, objViewpointAttachment_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_UpdDate, objViewpointAttachment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_Memo, objViewpointAttachment_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointAttachment_Cond.dicFldComparisonOp, clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointAttachmentEN_js_1.clsViewpointAttachmentEN.con_id_CurrEduCls, objViewpointAttachment_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function ViewpointAttachment_GetUniCondStr_ViewpointAttachmentId_ViewpointAttachmentName(objViewpointAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointAttachmentId = '{0}'", objViewpointAttachmentEN.viewpointAttachmentId);
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointAttachmentName = '{0}'", objViewpointAttachmentEN.viewpointAttachmentName);
        return strWhereCond;
    }
