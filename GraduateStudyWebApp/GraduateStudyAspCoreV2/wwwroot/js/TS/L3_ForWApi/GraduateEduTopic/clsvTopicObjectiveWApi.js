...
(function (factory) {
    ...
    **/
    async function vTopicObjective_GetObjByTopicObjectiveIdAsync(strTopicObjectiveId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicObjectiveId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicObjectiveId]不能为空！(In clsvTopicObjectiveWApi.GetObjByTopicObjectiveIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicObjectiveId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicObjectiveId]的长度:[{0}]不正确！(clsvTopicObjectiveWApi.GetObjByTopicObjectiveIdAsync)", strTopicObjectiveId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vTopicObjective_GetObjByTopicObjectiveId_Cache(strTopicObjectiveId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicObjectiveId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicObjectiveId]不能为空！(In clsvTopicObjectiveWApi.GetObjByTopicObjectiveId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicObjectiveId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicObjectiveId]的长度:[{0}]不正确！(clsvTopicObjectiveWApi.GetObjByTopicObjectiveId_Cache)", strTopicObjectiveId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vTopicObjective_GetObjByTopicObjectiveId_localStorage(strTopicObjectiveId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicObjectiveId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicObjectiveId]不能为空！(In clsvTopicObjectiveWApi.GetObjByTopicObjectiveId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicObjectiveId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicObjectiveId]的长度:[{0}]不正确！(clsvTopicObjectiveWApi.GetObjByTopicObjectiveId_localStorage)", strTopicObjectiveId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vTopicObjective_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvTopicObjectiveWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvTopicObjectiveWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvTopicObjectiveEN_js_1.clsvTopicObjectiveEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvTopicObjectiveEN_js_1.clsvTopicObjectiveEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvTopicObjective == null)
            return "";
        if (objvTopicObjective.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vTopicObjective_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvTopicObjectiveWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvTopicObjectiveWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvTopicObjectiveEN_js_1.clsvTopicObjectiveEN.con_TopicObjectiveId) {
    ...
    exports.vTopicObjective_funcKey = vTopicObjective_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vTopicObjective_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvTopicObjectiveEN_js_1.clsvTopicObjectiveEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvTopicObjectiveEN_js_1.clsvTopicObjectiveEN.WhereFormat, strid_CurrEduCls);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvTopicObjectiveExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvTopicObjectiveExObjLst);
    ...
    **/
    async function vTopicObjective_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvTopicObjectiveWApi.vTopicObjective_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvTopicObjectiveWApi.vTopicObjective_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
