...
(function (factory) {
    ...
    **/
    async function ObjectiveAttachment_GetObjByObjectiveAttachmentIdAsync(lngObjectiveAttachmentId) {
        ...
        if (lngObjectiveAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngObjectiveAttachmentId]不能为空！(In clsObjectiveAttachmentWApi.GetObjByObjectiveAttachmentIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.objectiveAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.objectiveAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ObjectiveAttachment_GetObjByObjectiveAttachmentId_Cache(lngObjectiveAttachmentId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngObjectiveAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngObjectiveAttachmentId]不能为空！(In clsObjectiveAttachmentWApi.GetObjByObjectiveAttachmentId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrObjectiveAttachment_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objObjectiveAttachment_Const = await ObjectiveAttachment_GetObjByObjectiveAttachmentIdAsync(lngObjectiveAttachmentId);
                    if (objObjectiveAttachment_Const != null) {
                        ObjectiveAttachment_ReFreshThisCache(strid_CurrEduCls);
                        return objObjectiveAttachment_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function ObjectiveAttachment_GetObjByObjectiveAttachmentId_localStorage(lngObjectiveAttachmentId) {
        ...
        if (lngObjectiveAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngObjectiveAttachmentId]不能为空！(In clsObjectiveAttachmentWApi.GetObjByObjectiveAttachmentId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN._CurrTabName, lngObjectiveAttachmentId);
        if (strKey == "") {
    ...
    */
    async function ObjectiveAttachment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsObjectiveAttachmentWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsObjectiveAttachmentWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objObjectiveAttachment == null)
            return "";
        if (objObjectiveAttachment.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_ObjectiveAttachmentName:
                    return (a, b) => {
                        if (a.objectiveAttachmentName == null)
                            return -1;
                        if (b.objectiveAttachmentName == null)
                            return 1;
                        return a.objectiveAttachmentName.localeCompare(b.objectiveAttachmentName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function ObjectiveAttachment_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsObjectiveAttachmentWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsObjectiveAttachmentWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_ObjectiveAttachmentId) {
        ...
        const arrObjectiveAttachment = await ObjectiveAttachment_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrObjectiveAttachment == null)
            return [];
        let arrObjectiveAttachment_Sel = arrObjectiveAttachment;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrObjectiveAttachment_Sel = arrObjectiveAttachment_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrObjectiveAttachment_Sel = arrObjectiveAttachment_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrObjectiveAttachment_Sel = arrObjectiveAttachment_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrObjectiveAttachment_Sel = arrObjectiveAttachment_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrObjectiveAttachment_Sel.length == 0)
            return [];
        return arrObjectiveAttachment_Sel.map(x => x.objectiveAttachmentId);
    }
    exports.ObjectiveAttachment_funcKey = ObjectiveAttachment_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function ObjectiveAttachment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrObjectiveAttachmentExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrObjectiveAttachmentExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrObjectiveAttachmentExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ObjectiveAttachment_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrObjectiveAttachmentExObjLst.length);
            console.log(strInfo);
            return arrObjectiveAttachmentExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.objectiveAttachment_ConstructorName, strThisFuncName);
    ...
    **/
    async function ObjectiveAttachment_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrObjectiveAttachmentExObjLst.length);
            console.log(strInfo);
            return arrObjectiveAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ObjectiveAttachment_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsObjectiveAttachmentWApi.ObjectiveAttachment_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsObjectiveAttachmentWApi.ObjectiveAttachment_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrObjectiveAttachment_Sel = arrObjectiveAttachment_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function ObjectiveAttachment_DelRecordAsync(lngObjectiveAttachmentId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngObjectiveAttachmentId);
        try {
    ...
    **/
    async function ObjectiveAttachment_UpdateRecordAsync(objObjectiveAttachmentEN) {
        ...
        if (objObjectiveAttachmentEN.sf_UpdFldSetStr === undefined || objObjectiveAttachmentEN.sf_UpdFldSetStr === null || objObjectiveAttachmentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objObjectiveAttachmentEN.objectiveAttachmentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.objectiveAttachment_Controller, strAction);
        try {
    ...
    */
    async function ObjectiveAttachment_IsExistRecord_Cache(objObjectiveAttachment_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objObjectiveAttachment_Cond), exports.objectiveAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ObjectiveAttachment_IsExist_Cache(lngObjectiveAttachmentId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngObjectiveAttachmentId, exports.objectiveAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function ObjectiveAttachment_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsObjectiveAttachmentWApi.clsObjectiveAttachmentWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsObjectiveAttachmentWApi.clsObjectiveAttachmentWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function ObjectiveAttachment_CheckPropertyNew(pobjObjectiveAttachmentEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.topicObjectiveId) === true) {
            throw new Error("(errid:Watl000058)字段[客观Id]不能为空(In 客观附件表)!(clsObjectiveAttachmentBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.filePath) === true) {
            throw new Error("(errid:Watl000058)字段[文件路径]不能为空(In 客观附件表)!(clsObjectiveAttachmentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.topicObjectiveId) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.topicObjectiveId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.objectiveAttachmentName) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.objectiveAttachmentName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.filePath) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.filePath) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjObjectiveAttachmentEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.topicObjectiveId) == false && undefined !== pobjObjectiveAttachmentEN.topicObjectiveId && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.topicObjectiveId) === false) {
        ...
        if (null != pobjObjectiveAttachmentEN.objectiveAttachmentId && undefined !== pobjObjectiveAttachmentEN.objectiveAttachmentId && clsString_js_1.tzDataType.isNumber(pobjObjectiveAttachmentEN.objectiveAttachmentId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.objectiveAttachmentName) == false && undefined !== pobjObjectiveAttachmentEN.objectiveAttachmentName && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.objectiveAttachmentName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.filePath) == false && undefined !== pobjObjectiveAttachmentEN.filePath && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.filePath) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.updDate) == false && undefined !== pobjObjectiveAttachmentEN.updDate && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.updUserId) == false && undefined !== pobjObjectiveAttachmentEN.updUserId && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.memo) == false && undefined !== pobjObjectiveAttachmentEN.memo && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjObjectiveAttachmentEN.id_CurrEduCls) == false && undefined !== pobjObjectiveAttachmentEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjObjectiveAttachmentEN.id_CurrEduCls) === false) {
    ...
    */
    function ObjectiveAttachment_GetCombineCondition(objObjectiveAttachment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_TopicObjectiveId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_TopicObjectiveId, objObjectiveAttachment_Cond.topicObjectiveId, strComparisonOp_TopicObjectiveId);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_ObjectiveAttachmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_ObjectiveAttachmentId, objObjectiveAttachment_Cond.objectiveAttachmentId, strComparisonOp_ObjectiveAttachmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_ObjectiveAttachmentName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_ObjectiveAttachmentName, objObjectiveAttachment_Cond.objectiveAttachmentName, strComparisonOp_ObjectiveAttachmentName);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_FilePath) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_FilePath, objObjectiveAttachment_Cond.filePath, strComparisonOp_FilePath);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_UpdDate, objObjectiveAttachment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_UpdUserId, objObjectiveAttachment_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_Memo, objObjectiveAttachment_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objObjectiveAttachment_Cond.dicFldComparisonOp, clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsObjectiveAttachmentEN_js_1.clsObjectiveAttachmentEN.con_id_CurrEduCls, objObjectiveAttachment_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function ObjectiveAttachment_GetUniCondStr_TopicObjectiveId_ObjectiveAttachmentId(objObjectiveAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TopicObjectiveId = '{0}'", objObjectiveAttachmentEN.topicObjectiveId);
        strWhereCond += (0, clsString_js_2.Format)(" and ObjectiveAttachmentId = '{0}'", objObjectiveAttachmentEN.objectiveAttachmentId);
        return strWhereCond;
    }
