...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsgs_ResearchResultEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_ResearchResult_GetObjByResultIdAsync(strResultId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strResultId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strResultId]不能为空！(In clsgs_ResearchResultWApi.GetObjByResultIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strResultId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strResultId]的长度:[{0}]不正确！(clsgs_ResearchResultWApi.GetObjByResultIdAsync)", strResultId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ResearchResult_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ResearchResult_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ResearchResult_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_ResearchResult_DelRecordAsync(strResultId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strResultId);
        try {
    ...
    **/
    async function gs_ResearchResult_UpdateRecordAsync(objgs_ResearchResultEN) {
        ...
        if (objgs_ResearchResultEN.sf_UpdFldSetStr === undefined || objgs_ResearchResultEN.sf_UpdFldSetStr === null || objgs_ResearchResultEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ResearchResultEN.resultId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ResearchResult_Controller, strAction);
        try {
    ...
    */
    function gs_ResearchResult_CheckPropertyNew(pobjgs_ResearchResultEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.resultId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.resultTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.resultName) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.author) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.author) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.division) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.division) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultId) == false && undefined !== pobjgs_ResearchResultEN.resultId && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.resultId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.topicId) == false && undefined !== pobjgs_ResearchResultEN.topicId && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.paperId) == false && undefined !== pobjgs_ResearchResultEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultTypeId) == false && undefined !== pobjgs_ResearchResultEN.resultTypeId && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.resultTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultName) == false && undefined !== pobjgs_ResearchResultEN.resultName && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.resultName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultContent) == false && undefined !== pobjgs_ResearchResultEN.resultContent && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.resultContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.author) == false && undefined !== pobjgs_ResearchResultEN.author && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.author) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.division) == false && undefined !== pobjgs_ResearchResultEN.division && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.division) === false) {
        ...
        if (null != pobjgs_ResearchResultEN.versionCount && undefined !== pobjgs_ResearchResultEN.versionCount && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultEN.versionCount) === false) {
        ...
        if (null != pobjgs_ResearchResultEN.okCount && undefined !== pobjgs_ResearchResultEN.okCount && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultEN.okCount) === false) {
        ...
        if (null != pobjgs_ResearchResultEN.appraiseCount && undefined !== pobjgs_ResearchResultEN.appraiseCount && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultEN.appraiseCount) === false) {
        ...
        if (null != pobjgs_ResearchResultEN.score && undefined !== pobjgs_ResearchResultEN.score && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultEN.score) === false) {
        ...
        if (null != pobjgs_ResearchResultEN.stuScore && undefined !== pobjgs_ResearchResultEN.stuScore && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultEN.stuScore) === false) {
        ...
        if (null != pobjgs_ResearchResultEN.teaScore && undefined !== pobjgs_ResearchResultEN.teaScore && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultEN.teaScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.id_CurrEduCls) == false && undefined !== pobjgs_ResearchResultEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.updDate) == false && undefined !== pobjgs_ResearchResultEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.updUser) == false && undefined !== pobjgs_ResearchResultEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.memo) == false && undefined !== pobjgs_ResearchResultEN.memo && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultEN.memo) === false) {
    ...
    */
    function gs_ResearchResult_CheckProperty4Update(pobjgs_ResearchResultEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultEN.resultId) === true) {
    ...
    */
    function gs_ResearchResult_GetCombineCondition(objgs_ResearchResult_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_ResultId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_ResultId, objgs_ResearchResult_Cond.resultId, strComparisonOp_ResultId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_TopicId, objgs_ResearchResult_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_PaperId, objgs_ResearchResult_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_ResultTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_ResultTypeId, objgs_ResearchResult_Cond.resultTypeId, strComparisonOp_ResultTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_ResultName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_ResultName, objgs_ResearchResult_Cond.resultName, strComparisonOp_ResultName);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Author) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Author, objgs_ResearchResult_Cond.author, strComparisonOp_Author);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Division) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Division, objgs_ResearchResult_Cond.division, strComparisonOp_Division);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_VersionCount, objgs_ResearchResult_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_OkCount, objgs_ResearchResult_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_AppraiseCount, objgs_ResearchResult_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Score, objgs_ResearchResult_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_StuScore, objgs_ResearchResult_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_TeaScore, objgs_ResearchResult_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_id_CurrEduCls, objgs_ResearchResult_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_UpdDate, objgs_ResearchResult_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_UpdUser, objgs_ResearchResult_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResult_Cond.dicFldComparisonOp, clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultEN_js_1.clsgs_ResearchResultEN.con_Memo, objgs_ResearchResult_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ResearchResult_GetUniCondStr_TopicId_ResultTypeId_ResultName(objgs_ResearchResultEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objgs_ResearchResultEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and ResultTypeId = '{0}'", objgs_ResearchResultEN.resultTypeId);
        strWhereCond += (0, clsString_js_2.Format)(" and ResultName = '{0}'", objgs_ResearchResultEN.resultName);
        return strWhereCond;
    }
    ...
    **/
    function gs_ResearchResult_GetUniCondStr4Update_TopicId_ResultTypeId_ResultName(objgs_ResearchResultEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ResultId <> '{0}'", objgs_ResearchResultEN.resultId);
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objgs_ResearchResultEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and ResultTypeId = '{0}'", objgs_ResearchResultEN.resultTypeId);
        strWhereCond += (0, clsString_js_2.Format)(" and ResultName = '{0}'", objgs_ResearchResultEN.resultName);
        return strWhereCond;
