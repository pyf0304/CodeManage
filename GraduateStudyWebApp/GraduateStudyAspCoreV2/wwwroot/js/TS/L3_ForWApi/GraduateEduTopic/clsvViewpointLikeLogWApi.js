...
(function (factory) {
    ...
    **/
    async function vViewpointLikeLog_GetObjByViewpointLikeLogIdAsync(lngViewpointLikeLogId) {
        ...
        if (lngViewpointLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngViewpointLikeLogId]不能为空！(In clsvViewpointLikeLogWApi.GetObjByViewpointLikeLogIdAsync)");
    ...
    */
    async function vViewpointLikeLog_GetObjByViewpointLikeLogId_Cache(lngViewpointLikeLogId, bolTryAsyncOnce = true) {
        ...
        if (lngViewpointLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngViewpointLikeLogId]不能为空！(In clsvViewpointLikeLogWApi.GetObjByViewpointLikeLogId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vViewpointLikeLog_GetObjByViewpointLikeLogId_localStorage(lngViewpointLikeLogId) {
        ...
        if (lngViewpointLikeLogId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngViewpointLikeLogId]不能为空！(In clsvViewpointLikeLogWApi.GetObjByViewpointLikeLogId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vViewpointLikeLog_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvViewpointLikeLogEN_js_1.clsvViewpointLikeLogEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvViewpointLikeLogEN_js_1.clsvViewpointLikeLogEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvViewpointLikeLog == null)
            return "";
        if (objvViewpointLikeLog.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vViewpointLikeLog_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.vViewpointLikeLog_funcKey = vViewpointLikeLog_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vViewpointLikeLog_GetObjLst_ClientCache() {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvViewpointLikeLogExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvViewpointLikeLogExObjLst);
