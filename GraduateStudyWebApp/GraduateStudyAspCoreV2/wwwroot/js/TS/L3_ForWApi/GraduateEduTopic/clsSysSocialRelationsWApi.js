...
(function (factory) {
    ...
    **/
    async function SysSocialRelations_GetObjBySocialIdAsync(strSocialId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strSocialId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strSocialId]不能为空！(In clsSysSocialRelationsWApi.GetObjBySocialIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSocialId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsSysSocialRelationsWApi.GetObjBySocialIdAsync)", strSocialId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysSocialRelations_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysSocialRelations_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysSocialRelations_GetObjBySocialId_Cache(strSocialId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strSocialId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strSocialId]不能为空！(In clsSysSocialRelationsWApi.GetObjBySocialId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSocialId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsSysSocialRelationsWApi.GetObjBySocialId_Cache)", strSocialId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function SysSocialRelations_GetObjBySocialId_localStorage(strSocialId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strSocialId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strSocialId]不能为空！(In clsSysSocialRelationsWApi.GetObjBySocialId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSocialId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strSocialId]的长度:[{0}]不正确！(clsSysSocialRelationsWApi.GetObjBySocialId_localStorage)", strSocialId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN._CurrTabName, strSocialId);
        if (strKey == "") {
    ...
    */
    async function SysSocialRelations_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsSysSocialRelationsWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsSysSocialRelationsWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objSysSocialRelations == null)
            return "";
        if (objSysSocialRelations.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function SysSocialRelations_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsSysSocialRelationsWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsSysSocialRelationsWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_SocialId) {
    ...
    exports.SysSocialRelations_funcKey = SysSocialRelations_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function SysSocialRelations_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysSocialRelationsExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrSysSocialRelationsExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSocialRelationsExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysSocialRelations_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSocialRelationsExObjLst.length);
            console.log(strInfo);
            return arrSysSocialRelationsExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysSocialRelations_ConstructorName, strThisFuncName);
    ...
    **/
    async function SysSocialRelations_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSocialRelationsExObjLst.length);
            console.log(strInfo);
            return arrSysSocialRelationsExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysSocialRelations_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsSysSocialRelationsWApi.SysSocialRelations_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsSysSocialRelationsWApi.SysSocialRelations_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function SysSocialRelations_DelRecordAsync(strSocialId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strSocialId);
        try {
    ...
    **/
    async function SysSocialRelations_UpdateRecordAsync(objSysSocialRelationsEN) {
        ...
        if (objSysSocialRelationsEN.sf_UpdFldSetStr === undefined || objSysSocialRelationsEN.sf_UpdFldSetStr === null || objSysSocialRelationsEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysSocialRelationsEN.socialId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysSocialRelations_Controller, strAction);
        try {
    ...
    */
    async function SysSocialRelations_IsExistRecord_Cache(objSysSocialRelations_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysSocialRelations_Cond), exports.sysSocialRelations_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysSocialRelations_IsExist_Cache(strSocialId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strSocialId, exports.sysSocialRelations_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function SysSocialRelations_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsSysSocialRelationsWApi.clsSysSocialRelationsWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsSysSocialRelationsWApi.clsSysSocialRelationsWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function SysSocialRelations_CheckPropertyNew(pobjSysSocialRelationsEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.socialId) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.socialId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.fullName) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.fullName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.nationality) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.nationality) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.workUnit) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.workUnit) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.major) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.major) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.achievement) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.achievement) > 5000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.levelId) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.levelId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.citationId) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.citationId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.createDate) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.createDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.shareId) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.shareId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.pdfContent) == false && (0, clsString_js_2.GetStrLen)(pobjSysSocialRelationsEN.pdfContent) > 2000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.socialId) == false && undefined !== pobjSysSocialRelationsEN.socialId && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.socialId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.fullName) == false && undefined !== pobjSysSocialRelationsEN.fullName && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.fullName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.nationality) == false && undefined !== pobjSysSocialRelationsEN.nationality && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.nationality) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.workUnit) == false && undefined !== pobjSysSocialRelationsEN.workUnit && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.workUnit) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.major) == false && undefined !== pobjSysSocialRelationsEN.major && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.major) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.achievement) == false && undefined !== pobjSysSocialRelationsEN.achievement && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.achievement) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.detailedDescription) == false && undefined !== pobjSysSocialRelationsEN.detailedDescription && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.detailedDescription) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.levelId) == false && undefined !== pobjSysSocialRelationsEN.levelId && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.levelId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.updUser) == false && undefined !== pobjSysSocialRelationsEN.updUser && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.updDate) == false && undefined !== pobjSysSocialRelationsEN.updDate && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.updDate) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.isSubmit && undefined !== pobjSysSocialRelationsEN.isSubmit && clsString_js_1.tzDataType.isBoolean(pobjSysSocialRelationsEN.isSubmit) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.okCount && undefined !== pobjSysSocialRelationsEN.okCount && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.okCount) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.citationCount && undefined !== pobjSysSocialRelationsEN.citationCount && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.citationCount) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.versionCount && undefined !== pobjSysSocialRelationsEN.versionCount && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.versionCount) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.id_CurrEduCls) == false && undefined !== pobjSysSocialRelationsEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.memo) == false && undefined !== pobjSysSocialRelationsEN.memo && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.memo) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.appraiseCount && undefined !== pobjSysSocialRelationsEN.appraiseCount && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.appraiseCount) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.score && undefined !== pobjSysSocialRelationsEN.score && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.score) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.stuScore && undefined !== pobjSysSocialRelationsEN.stuScore && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.stuScore) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.teaScore && undefined !== pobjSysSocialRelationsEN.teaScore && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.teaScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.citationId) == false && undefined !== pobjSysSocialRelationsEN.citationId && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.citationId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.createDate) == false && undefined !== pobjSysSocialRelationsEN.createDate && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.createDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.shareId) == false && undefined !== pobjSysSocialRelationsEN.shareId && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.shareId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.pdfContent) == false && undefined !== pobjSysSocialRelationsEN.pdfContent && clsString_js_1.tzDataType.isString(pobjSysSocialRelationsEN.pdfContent) === false) {
        ...
        if (null != pobjSysSocialRelationsEN.pdfPageNum && undefined !== pobjSysSocialRelationsEN.pdfPageNum && clsString_js_1.tzDataType.isNumber(pobjSysSocialRelationsEN.pdfPageNum) === false) {
    ...
    */
    function SysSocialRelations_CheckProperty4Update(pobjSysSocialRelationsEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSocialRelationsEN.socialId) === true) {
    ...
    */
    function SysSocialRelations_GetCombineCondition(objSysSocialRelations_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_SocialId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_SocialId, objSysSocialRelations_Cond.socialId, strComparisonOp_SocialId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_FullName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_FullName, objSysSocialRelations_Cond.fullName, strComparisonOp_FullName);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Nationality) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Nationality, objSysSocialRelations_Cond.nationality, strComparisonOp_Nationality);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_WorkUnit) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_WorkUnit, objSysSocialRelations_Cond.workUnit, strComparisonOp_WorkUnit);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Major) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Major, objSysSocialRelations_Cond.major, strComparisonOp_Major);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Achievement) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Achievement, objSysSocialRelations_Cond.achievement, strComparisonOp_Achievement);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_LevelId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_LevelId, objSysSocialRelations_Cond.levelId, strComparisonOp_LevelId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_UpdUser, objSysSocialRelations_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_UpdDate, objSysSocialRelations_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_IsSubmit) == true) {
            if (objSysSocialRelations_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_OkCount, objSysSocialRelations_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_CitationCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_CitationCount, objSysSocialRelations_Cond.citationCount, strComparisonOp_CitationCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_VersionCount, objSysSocialRelations_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_id_CurrEduCls, objSysSocialRelations_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Memo, objSysSocialRelations_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_AppraiseCount, objSysSocialRelations_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_Score, objSysSocialRelations_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_StuScore, objSysSocialRelations_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_TeaScore, objSysSocialRelations_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_CitationId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_CitationId, objSysSocialRelations_Cond.citationId, strComparisonOp_CitationId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_CreateDate, objSysSocialRelations_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_ShareId, objSysSocialRelations_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_PdfContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_PdfContent, objSysSocialRelations_Cond.pdfContent, strComparisonOp_PdfContent);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSocialRelations_Cond.dicFldComparisonOp, clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_PdfPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN.con_PdfPageNum, objSysSocialRelations_Cond.pdfPageNum, strComparisonOp_PdfPageNum);
        }
        return strWhereCond;
    }
    ...
    **/
    function SysSocialRelations_GetUniCondStr_SocialId(objSysSocialRelationsEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and SocialId = '{0}'", objSysSocialRelationsEN.socialId);
        return strWhereCond;
    }
