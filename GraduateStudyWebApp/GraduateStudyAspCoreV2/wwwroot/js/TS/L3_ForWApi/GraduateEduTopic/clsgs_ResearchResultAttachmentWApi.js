...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsgs_ResearchResultAttachmentEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_ResearchResultAttachment_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_ResearchResultAttachmentWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ResearchResultAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ResearchResultAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ResearchResultAttachment_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_ResearchResultAttachment_UpdateRecordAsync(objgs_ResearchResultAttachmentEN) {
        ...
        if (objgs_ResearchResultAttachmentEN.sf_UpdFldSetStr === undefined || objgs_ResearchResultAttachmentEN.sf_UpdFldSetStr === null || objgs_ResearchResultAttachmentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ResearchResultAttachmentEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ResearchResultAttachment_Controller, strAction);
        try {
    ...
    */
    function gs_ResearchResultAttachment_CheckPropertyNew(pobjgs_ResearchResultAttachmentEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.resultId) === true) {
            throw new Error("(errid:Watl000058)字段[成果Id]不能为空(In 研究成果附件表)!(clsgs_ResearchResultAttachmentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.resultId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.resultId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.fileName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.fileName) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.filePath) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.filePath) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ResearchResultAttachmentEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_ResearchResultAttachmentEN.mId && undefined !== pobjgs_ResearchResultAttachmentEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_ResearchResultAttachmentEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.resultId) == false && undefined !== pobjgs_ResearchResultAttachmentEN.resultId && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.resultId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.topicId) == false && undefined !== pobjgs_ResearchResultAttachmentEN.topicId && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.fileName) == false && undefined !== pobjgs_ResearchResultAttachmentEN.fileName && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.fileName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.filePath) == false && undefined !== pobjgs_ResearchResultAttachmentEN.filePath && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.filePath) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.updDate) == false && undefined !== pobjgs_ResearchResultAttachmentEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.updUser) == false && undefined !== pobjgs_ResearchResultAttachmentEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ResearchResultAttachmentEN.memo) == false && undefined !== pobjgs_ResearchResultAttachmentEN.memo && clsString_js_1.tzDataType.isString(pobjgs_ResearchResultAttachmentEN.memo) === false) {
    ...
    */
    function gs_ResearchResultAttachment_GetCombineCondition(objgs_ResearchResultAttachment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_mId, objgs_ResearchResultAttachment_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_ResultId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_ResultId, objgs_ResearchResultAttachment_Cond.resultId, strComparisonOp_ResultId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_TopicId, objgs_ResearchResultAttachment_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_FileName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_FileName, objgs_ResearchResultAttachment_Cond.fileName, strComparisonOp_FileName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_FilePath) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_FilePath, objgs_ResearchResultAttachment_Cond.filePath, strComparisonOp_FilePath);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_UpdDate, objgs_ResearchResultAttachment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_UpdUser, objgs_ResearchResultAttachment_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ResearchResultAttachment_Cond.dicFldComparisonOp, clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ResearchResultAttachmentEN_js_1.clsgs_ResearchResultAttachmentEN.con_Memo, objgs_ResearchResultAttachment_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ResearchResultAttachment_GetUniCondStr_mId(objgs_ResearchResultAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_ResearchResultAttachmentEN.mId);
        return strWhereCond;
    }
