...
(function (factory) {
    ...
    **/
    async function vConceptAttachment_GetObjByConceptAttachmentIdAsync(lngConceptAttachmentId) {
        ...
        if (lngConceptAttachmentId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngConceptAttachmentId]不能为空！(In clsvConceptAttachmentWApi.GetObjByConceptAttachmentIdAsync)");
    ...
    */
    async function vConceptAttachment_GetObjByConceptAttachmentId_Cache(lngConceptAttachmentId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngConceptAttachmentId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngConceptAttachmentId]不能为空！(In clsvConceptAttachmentWApi.GetObjByConceptAttachmentId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrvConceptAttachment_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objvConceptAttachment_Const = await vConceptAttachment_GetObjByConceptAttachmentIdAsync(lngConceptAttachmentId);
                    if (objvConceptAttachment_Const != null) {
                        vConceptAttachment_ReFreshThisCache(strid_CurrEduCls);
                        return objvConceptAttachment_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function vConceptAttachment_GetObjByConceptAttachmentId_localStorage(lngConceptAttachmentId) {
        ...
        if (lngConceptAttachmentId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngConceptAttachmentId]不能为空！(In clsvConceptAttachmentWApi.GetObjByConceptAttachmentId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vConceptAttachment_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvConceptAttachmentWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvConceptAttachmentWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvConceptAttachmentEN_js_1.clsvConceptAttachmentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvConceptAttachmentEN_js_1.clsvConceptAttachmentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvConceptAttachment == null)
            return "";
        if (objvConceptAttachment.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vConceptAttachment_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvConceptAttachmentWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvConceptAttachmentWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvConceptAttachmentEN_js_1.clsvConceptAttachmentEN.con_ConceptAttachmentId) {
        ...
        const arrvConceptAttachment = await vConceptAttachment_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrvConceptAttachment == null)
            return [];
        let arrvConceptAttachment_Sel = arrvConceptAttachment;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrvConceptAttachment_Sel = arrvConceptAttachment_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrvConceptAttachment_Sel = arrvConceptAttachment_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrvConceptAttachment_Sel = arrvConceptAttachment_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrvConceptAttachment_Sel = arrvConceptAttachment_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrvConceptAttachment_Sel.length == 0)
            return [];
        return arrvConceptAttachment_Sel.map(x => x.conceptAttachmentId);
    }
    exports.vConceptAttachment_funcKey = vConceptAttachment_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vConceptAttachment_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvConceptAttachmentEN_js_1.clsvConceptAttachmentEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvConceptAttachmentEN_js_1.clsvConceptAttachmentEN.WhereFormat, strid_CurrEduCls);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvConceptAttachmentExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvConceptAttachmentExObjLst);
    ...
    **/
    async function vConceptAttachment_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvConceptAttachmentWApi.vConceptAttachment_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvConceptAttachmentWApi.vConceptAttachment_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrvConceptAttachment_Sel = arrvConceptAttachment_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
