...
(function (factory) {
    ...
    **/
    async function gs_RTqa_PaperRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_RTqa_PaperRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_RTqa_PaperRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_RTqa_PaperRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_RTqa_PaperRela_GetObjBymId_Cache(lngmId, strTopicId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_RTqa_PaperRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_RTqa_PaperRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_RTqa_PaperRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_RTqa_PaperRela_func(strInFldName, strOutFldName, strInValue, strTopicId_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicId_C]不能为空！(In clsgs_RTqa_PaperRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsgs_RTqa_PaperRelaWApi.func)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_RTqa_PaperRela == null)
            return "";
        if (objgs_RTqa_PaperRela.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_RTqa_PaperRela_funcKey(strInFldName, strInValue, strComparisonOp, strTopicId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicId_C]不能为空！(In clsgs_RTqa_PaperRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsgs_RTqa_PaperRelaWApi.funcKey)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_mId) {
    ...
    exports.gs_RTqa_PaperRela_funcKey = gs_RTqa_PaperRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_RTqa_PaperRela_GetObjLst_ClientCache(strTopicId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.WhereFormat, strTopicId);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("TopicId='{0}'", strTopicId);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN._CurrTabName, strTopicId);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_RTqa_PaperRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_RTqa_PaperRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_RTqa_PaperRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_RTqa_PaperRela_GetObjLst_localStorage(strTopicId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_RTqa_PaperRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_RTqa_PaperRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_RTqa_PaperRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_RTqa_PaperRela_GetObjLst_sessionStorage(strTopicId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_RTqa_PaperRelaExObjLst.length);
            console.log(strInfo);
            return arrgs_RTqa_PaperRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_RTqa_PaperRela_GetObjLst_Cache(strTopicId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[TopicId]不能为空！(in clsgs_RTqa_PaperRelaWApi.gs_RTqa_PaperRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(in clsgs_RTqa_PaperRelaWApi.gs_RTqa_PaperRela_GetObjLst_Cache() )", strTopicId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function gs_RTqa_PaperRela_UpdateRecordAsync(objgs_RTqa_PaperRelaEN) {
        ...
        if (objgs_RTqa_PaperRelaEN.sf_UpdFldSetStr === undefined || objgs_RTqa_PaperRelaEN.sf_UpdFldSetStr === null || objgs_RTqa_PaperRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_RTqa_PaperRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_RTqa_PaperRela_Controller, strAction);
        try {
    ...
    */
    async function gs_RTqa_PaperRela_IsExistRecord_Cache(objgs_RTqa_PaperRela_Cond, strTopicId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_RTqa_PaperRela_Cond), exports.gs_RTqa_PaperRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_RTqa_PaperRela_IsExist_Cache(lngmId, strTopicId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_RTqa_PaperRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_RTqa_PaperRela_ReFreshCache(strTopicId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicId]不能为空！(In clsgs_RTqa_PaperRelaWApi.clsgs_RTqa_PaperRelaWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(clsgs_RTqa_PaperRelaWApi.clsgs_RTqa_PaperRelaWApi.ReFreshCache)", strTopicId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_RTqa_PaperRela_CheckPropertyNew(pobjgs_RTqa_PaperRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.topicId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.qa_PaperId) === true) {
            throw new Error("(errid:Watl000058)字段[论文答疑Id]不能为空(In 答疑关系表)!(clsgs_RTqa_PaperRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_RTqa_PaperRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.qa_PaperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_RTqa_PaperRelaEN.qa_PaperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_RTqa_PaperRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_RTqa_PaperRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_RTqa_PaperRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_RTqa_PaperRelaEN.mId && undefined !== pobjgs_RTqa_PaperRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_RTqa_PaperRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.topicId) == false && undefined !== pobjgs_RTqa_PaperRelaEN.topicId && clsString_js_1.tzDataType.isString(pobjgs_RTqa_PaperRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.qa_PaperId) == false && undefined !== pobjgs_RTqa_PaperRelaEN.qa_PaperId && clsString_js_1.tzDataType.isString(pobjgs_RTqa_PaperRelaEN.qa_PaperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.updDate) == false && undefined !== pobjgs_RTqa_PaperRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_RTqa_PaperRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.updUser) == false && undefined !== pobjgs_RTqa_PaperRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_RTqa_PaperRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_RTqa_PaperRelaEN.memo) == false && undefined !== pobjgs_RTqa_PaperRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_RTqa_PaperRelaEN.memo) === false) {
    ...
    */
    function gs_RTqa_PaperRela_GetCombineCondition(objgs_RTqa_PaperRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_RTqa_PaperRela_Cond.dicFldComparisonOp, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_mId, objgs_RTqa_PaperRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_RTqa_PaperRela_Cond.dicFldComparisonOp, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_TopicId, objgs_RTqa_PaperRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_RTqa_PaperRela_Cond.dicFldComparisonOp, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_qa_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_qa_PaperId, objgs_RTqa_PaperRela_Cond.qa_PaperId, strComparisonOp_qa_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_RTqa_PaperRela_Cond.dicFldComparisonOp, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_UpdDate, objgs_RTqa_PaperRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_RTqa_PaperRela_Cond.dicFldComparisonOp, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_UpdUser, objgs_RTqa_PaperRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_RTqa_PaperRela_Cond.dicFldComparisonOp, clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_RTqa_PaperRelaEN_js_1.clsgs_RTqa_PaperRelaEN.con_Memo, objgs_RTqa_PaperRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_RTqa_PaperRela_GetUniCondStr_mId(objgs_RTqa_PaperRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_RTqa_PaperRelaEN.mId);
        return strWhereCond;
    }
