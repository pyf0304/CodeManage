...
(function (factory) {
    ...
    **/
    async function RTPaperRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTPaperRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTPaperRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTPaperRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function RTPaperRela_GetObjBymId_Cache(lngmId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTPaperRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrRTPaperRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objRTPaperRela_Const = await RTPaperRela_GetObjBymIdAsync(lngmId);
                    if (objRTPaperRela_Const != null) {
                        RTPaperRela_ReFreshThisCache();
                        return objRTPaperRela_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function RTPaperRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTPaperRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function RTPaperRela_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objRTPaperRela == null)
            return "";
        if (objRTPaperRela.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function RTPaperRela_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrRTPaperRela = await RTPaperRela_GetObjLst_Cache();
        if (arrRTPaperRela == null)
            return [];
        let arrRTPaperRela_Sel = arrRTPaperRela;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrRTPaperRela_Sel = arrRTPaperRela_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrRTPaperRela_Sel = arrRTPaperRela_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrRTPaperRela_Sel = arrRTPaperRela_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrRTPaperRela_Sel = arrRTPaperRela_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrRTPaperRela_Sel.length == 0)
            return [];
        return arrRTPaperRela_Sel.map(x => x.mId);
    }
    exports.RTPaperRela_funcKey = RTPaperRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function RTPaperRela_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrRTPaperRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrRTPaperRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTPaperRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function RTPaperRela_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTPaperRelaExObjLst.length);
            console.log(strInfo);
            return arrRTPaperRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTPaperRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function RTPaperRela_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTPaperRelaExObjLst.length);
            console.log(strInfo);
            return arrRTPaperRelaExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrRTPaperRela_Sel = arrRTPaperRela_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function RTPaperRela_UpdateRecordAsync(objRTPaperRelaEN) {
        ...
        if (objRTPaperRelaEN.sf_UpdFldSetStr === undefined || objRTPaperRelaEN.sf_UpdFldSetStr === null || objRTPaperRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTPaperRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTPaperRela_Controller, strAction);
        try {
    ...
    */
    async function RTPaperRela_IsExistRecord_Cache(objRTPaperRela_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objRTPaperRela_Cond), exports.rTPaperRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function RTPaperRela_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.rTPaperRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function RTPaperRela_ReFreshCache() {
        ...
        (0, clsvRTPaperRelaWApi_js_1.vRTPaperRela_ReFreshThisCache)();
    }
    ...
    */
    function RTPaperRela_CheckPropertyNew(pobjRTPaperRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjRTPaperRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjRTPaperRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjRTPaperRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjRTPaperRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjRTPaperRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjRTPaperRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTPaperRelaEN.mId && undefined !== pobjRTPaperRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjRTPaperRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.topicId) == false && undefined !== pobjRTPaperRelaEN.topicId && clsString_js_1.tzDataType.isString(pobjRTPaperRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.paperId) == false && undefined !== pobjRTPaperRelaEN.paperId && clsString_js_1.tzDataType.isString(pobjRTPaperRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.updDate) == false && undefined !== pobjRTPaperRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjRTPaperRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.updUser) == false && undefined !== pobjRTPaperRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjRTPaperRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.memo) == false && undefined !== pobjRTPaperRelaEN.memo && clsString_js_1.tzDataType.isString(pobjRTPaperRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTPaperRelaEN.id_CurrEduCls) == false && undefined !== pobjRTPaperRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjRTPaperRelaEN.id_CurrEduCls) === false) {
    ...
    */
    function RTPaperRela_GetCombineCondition(objRTPaperRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_mId, objRTPaperRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_TopicId, objRTPaperRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_PaperId, objRTPaperRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_UpdDate, objRTPaperRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_UpdUser, objRTPaperRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_Memo, objRTPaperRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTPaperRela_Cond.dicFldComparisonOp, clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTPaperRelaEN_js_1.clsRTPaperRelaEN.con_id_CurrEduCls, objRTPaperRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTPaperRela_GetUniCondStr_mId(objRTPaperRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objRTPaperRelaEN.mId);
        return strWhereCond;
    }
