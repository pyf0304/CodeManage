...
(function (factory) {
    ...
    **/
    async function gs_ReflectLog_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_ReflectLogWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ReflectLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ReflectLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_ReflectLog_GetObjBymId_Cache(lngmId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_ReflectLogWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_ReflectLog_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_ReflectLogWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function gs_ReflectLog_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_ReflectLog == null)
            return "";
        if (objgs_ReflectLog.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_ReflectLogName:
                    return (a, b) => {
                        if (a.reflectLogName == null)
                            return -1;
                        if (b.reflectLogName == null)
                            return 1;
                        return a.reflectLogName.localeCompare(b.reflectLogName);
                    };
                case clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_ReflectLogContent:
                    return (a, b) => {
                        if (a.reflectLogContent == null)
                            return -1;
                        if (b.reflectLogContent == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_ReflectLog_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_ReflectLog_funcKey = gs_ReflectLog_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_ReflectLog_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_ReflectLogExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_ReflectLogExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ReflectLogExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_ReflectLog_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ReflectLogExObjLst.length);
            console.log(strInfo);
            return arrgs_ReflectLogExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ReflectLog_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_ReflectLog_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ReflectLogExObjLst.length);
            console.log(strInfo);
            return arrgs_ReflectLogExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_ReflectLog_UpdateRecordAsync(objgs_ReflectLogEN) {
        ...
        if (objgs_ReflectLogEN.sf_UpdFldSetStr === undefined || objgs_ReflectLogEN.sf_UpdFldSetStr === null || objgs_ReflectLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ReflectLogEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ReflectLog_Controller, strAction);
        try {
    ...
    */
    async function gs_ReflectLog_IsExistRecord_Cache(objgs_ReflectLog_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_ReflectLog_Cond), exports.gs_ReflectLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_ReflectLog_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.gs_ReflectLog_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_ReflectLog_CheckPropertyNew(pobjgs_ReflectLogEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.reflectLogName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.reflectLogName) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.reflectLogContent) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.reflectLogContent) > 5000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ReflectLogEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_ReflectLogEN.mId && undefined !== pobjgs_ReflectLogEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_ReflectLogEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.topicId) == false && undefined !== pobjgs_ReflectLogEN.topicId && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.reflectLogName) == false && undefined !== pobjgs_ReflectLogEN.reflectLogName && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.reflectLogName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.reflectLogContent) == false && undefined !== pobjgs_ReflectLogEN.reflectLogContent && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.reflectLogContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.updUser) == false && undefined !== pobjgs_ReflectLogEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.updDate) == false && undefined !== pobjgs_ReflectLogEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.memo) == false && undefined !== pobjgs_ReflectLogEN.memo && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ReflectLogEN.id_CurrEduCls) == false && undefined !== pobjgs_ReflectLogEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_ReflectLogEN.id_CurrEduCls) === false) {
    ...
    */
    function gs_ReflectLog_GetCombineCondition(objgs_ReflectLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_mId, objgs_ReflectLog_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_TopicId, objgs_ReflectLog_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_ReflectLogName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_ReflectLogName, objgs_ReflectLog_Cond.reflectLogName, strComparisonOp_ReflectLogName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_ReflectLogContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_ReflectLogContent, objgs_ReflectLog_Cond.reflectLogContent, strComparisonOp_ReflectLogContent);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_UpdUser, objgs_ReflectLog_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_UpdDate, objgs_ReflectLog_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_Memo, objgs_ReflectLog_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ReflectLog_Cond.dicFldComparisonOp, clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN.con_id_CurrEduCls, objgs_ReflectLog_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ReflectLog_GetUniCondStr_mId(objgs_ReflectLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_ReflectLogEN.mId);
        return strWhereCond;
    }
