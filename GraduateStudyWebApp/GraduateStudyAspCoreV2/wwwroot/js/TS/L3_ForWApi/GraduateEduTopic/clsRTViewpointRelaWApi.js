...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsRTViewpointRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function RTViewpointRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTViewpointRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTViewpointRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTViewpointRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTViewpointRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function RTViewpointRela_UpdateRecordAsync(objRTViewpointRelaEN) {
        ...
        if (objRTViewpointRelaEN.sf_UpdFldSetStr === undefined || objRTViewpointRelaEN.sf_UpdFldSetStr === null || objRTViewpointRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTViewpointRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTViewpointRela_Controller, strAction);
        try {
    ...
    */
    function RTViewpointRela_CheckPropertyNew(pobjRTViewpointRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.viewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.proposePeople) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.proposePeople) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.classificationId) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.classificationId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjRTViewpointRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTViewpointRelaEN.mId && undefined !== pobjRTViewpointRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjRTViewpointRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.topicId) == false && undefined !== pobjRTViewpointRelaEN.topicId && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.viewpointId) == false && undefined !== pobjRTViewpointRelaEN.viewpointId && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.proposePeople) == false && undefined !== pobjRTViewpointRelaEN.proposePeople && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.proposePeople) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.updDate) == false && undefined !== pobjRTViewpointRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.updUser) == false && undefined !== pobjRTViewpointRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.memo) == false && undefined !== pobjRTViewpointRelaEN.memo && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.classificationId) == false && undefined !== pobjRTViewpointRelaEN.classificationId && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.classificationId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTViewpointRelaEN.id_CurrEduCls) == false && undefined !== pobjRTViewpointRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjRTViewpointRelaEN.id_CurrEduCls) === false) {
    ...
    */
    function RTViewpointRela_GetCombineCondition(objRTViewpointRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_mId, objRTViewpointRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_TopicId, objRTViewpointRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_ViewpointId, objRTViewpointRela_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_ProposePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_ProposePeople, objRTViewpointRela_Cond.proposePeople, strComparisonOp_ProposePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_UpdDate, objRTViewpointRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_UpdUser, objRTViewpointRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_Memo, objRTViewpointRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_ClassificationId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_ClassificationId, objRTViewpointRela_Cond.classificationId, strComparisonOp_ClassificationId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTViewpointRela_Cond.dicFldComparisonOp, clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTViewpointRelaEN_js_1.clsRTViewpointRelaEN.con_id_CurrEduCls, objRTViewpointRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTViewpointRela_GetUniCondStr_TopicId_ViewpointId(objRTViewpointRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objRTViewpointRelaEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointId = '{0}'", objRTViewpointRelaEN.viewpointId);
        return strWhereCond;
    }
    ...
    **/
    function RTViewpointRela_GetUniCondStr4Update_TopicId_ViewpointId(objRTViewpointRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId <> '{0}'", objRTViewpointRelaEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objRTViewpointRelaEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointId = '{0}'", objRTViewpointRelaEN.viewpointId);
        return strWhereCond;
    }
