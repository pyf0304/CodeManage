...
(function (factory) {
    ...
    **/
    async function gs_PaperReport_GetObjByReportIdAsync(strReportId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strReportId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strReportId]不能为空！(In clsgs_PaperReportWApi.GetObjByReportIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strReportId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsgs_PaperReportWApi.GetObjByReportIdAsync)", strReportId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperReport_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperReport_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperReport_GetObjByReportId_Cache(strReportId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strReportId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strReportId]不能为空！(In clsgs_PaperReportWApi.GetObjByReportId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strReportId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsgs_PaperReportWApi.GetObjByReportId_Cache)", strReportId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_PaperReport_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_PaperReport_Const = await gs_PaperReport_GetObjByReportIdAsync(strReportId);
                    if (objgs_PaperReport_Const != null) {
                        gs_PaperReport_ReFreshThisCache();
                        return objgs_PaperReport_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_PaperReport_GetObjByReportId_localStorage(strReportId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strReportId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strReportId]不能为空！(In clsgs_PaperReportWApi.GetObjByReportId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strReportId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strReportId]的长度:[{0}]不正确！(clsgs_PaperReportWApi.GetObjByReportId_localStorage)", strReportId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN._CurrTabName, strReportId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperReport_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_PaperReport == null)
            return "";
        if (objgs_PaperReport.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_PaperReport_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrgs_PaperReport = await gs_PaperReport_GetObjLst_Cache();
        if (arrgs_PaperReport == null)
            return [];
        let arrgs_PaperReport_Sel = arrgs_PaperReport;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_PaperReport_Sel = arrgs_PaperReport_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_PaperReport_Sel = arrgs_PaperReport_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_PaperReport_Sel = arrgs_PaperReport_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_PaperReport_Sel = arrgs_PaperReport_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_PaperReport_Sel.length == 0)
            return [];
        return arrgs_PaperReport_Sel.map(x => x.reportId);
    }
    exports.gs_PaperReport_funcKey = gs_PaperReport_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_PaperReport_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperReportExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_PaperReportExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperReportExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperReport_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperReportExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperReportExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperReport_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PaperReport_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperReportExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperReportExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_PaperReport_Sel = arrgs_PaperReport_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_PaperReport_DelRecordAsync(strReportId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strReportId);
        try {
    ...
    **/
    async function gs_PaperReport_UpdateRecordAsync(objgs_PaperReportEN) {
        ...
        if (objgs_PaperReportEN.sf_UpdFldSetStr === undefined || objgs_PaperReportEN.sf_UpdFldSetStr === null || objgs_PaperReportEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperReportEN.reportId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperReport_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperReport_IsExistRecord_Cache(objgs_PaperReport_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperReport_Cond), exports.gs_PaperReport_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperReport_IsExist_Cache(strReportId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strReportId, exports.gs_PaperReport_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_PaperReport_CheckPropertyNew(pobjgs_PaperReportEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.reportId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportContent) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.reportContent) > 5000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.reportUser) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.reportDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.pdFUrl) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.pdFUrl) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.ppTUrl) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.ppTUrl) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.month) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.month) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.year) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.year) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperReportEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportId) == false && undefined !== pobjgs_PaperReportEN.reportId && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.reportId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.topicId) == false && undefined !== pobjgs_PaperReportEN.topicId && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.paperId) == false && undefined !== pobjgs_PaperReportEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportContent) == false && undefined !== pobjgs_PaperReportEN.reportContent && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.reportContent) === false) {
        ...
        if (null != pobjgs_PaperReportEN.isSubmit && undefined !== pobjgs_PaperReportEN.isSubmit && clsString_js_1.tzDataType.isBoolean(pobjgs_PaperReportEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportUser) == false && undefined !== pobjgs_PaperReportEN.reportUser && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.reportUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportDate) == false && undefined !== pobjgs_PaperReportEN.reportDate && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.reportDate) === false) {
        ...
        if (null != pobjgs_PaperReportEN.versionCount && undefined !== pobjgs_PaperReportEN.versionCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.versionCount) === false) {
        ...
        if (null != pobjgs_PaperReportEN.okCount && undefined !== pobjgs_PaperReportEN.okCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.okCount) === false) {
        ...
        if (null != pobjgs_PaperReportEN.appraiseCount && undefined !== pobjgs_PaperReportEN.appraiseCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.appraiseCount) === false) {
        ...
        if (null != pobjgs_PaperReportEN.score && undefined !== pobjgs_PaperReportEN.score && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.score) === false) {
        ...
        if (null != pobjgs_PaperReportEN.stuScore && undefined !== pobjgs_PaperReportEN.stuScore && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.stuScore) === false) {
        ...
        if (null != pobjgs_PaperReportEN.teaScore && undefined !== pobjgs_PaperReportEN.teaScore && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.teaScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.pdFUrl) == false && undefined !== pobjgs_PaperReportEN.pdFUrl && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.pdFUrl) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.ppTUrl) == false && undefined !== pobjgs_PaperReportEN.ppTUrl && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.ppTUrl) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.month) == false && undefined !== pobjgs_PaperReportEN.month && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.month) === false) {
        ...
        if (null != pobjgs_PaperReportEN.week && undefined !== pobjgs_PaperReportEN.week && clsString_js_1.tzDataType.isNumber(pobjgs_PaperReportEN.week) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.year) == false && undefined !== pobjgs_PaperReportEN.year && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.year) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.id_CurrEduCls) == false && undefined !== pobjgs_PaperReportEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.updUser) == false && undefined !== pobjgs_PaperReportEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.updDate) == false && undefined !== pobjgs_PaperReportEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.memo) == false && undefined !== pobjgs_PaperReportEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PaperReportEN.memo) === false) {
    ...
    */
    function gs_PaperReport_CheckProperty4Update(pobjgs_PaperReportEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperReportEN.reportId) === true) {
    ...
    */
    function gs_PaperReport_GetCombineCondition(objgs_PaperReport_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportId, objgs_PaperReport_Cond.reportId, strComparisonOp_ReportId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_TopicId, objgs_PaperReport_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_PaperId, objgs_PaperReport_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportContent, objgs_PaperReport_Cond.reportContent, strComparisonOp_ReportContent);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_IsSubmit) == true) {
            if (objgs_PaperReport_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportUser, objgs_PaperReport_Cond.reportUser, strComparisonOp_ReportUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_ReportDate, objgs_PaperReport_Cond.reportDate, strComparisonOp_ReportDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_VersionCount, objgs_PaperReport_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_OkCount, objgs_PaperReport_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_AppraiseCount, objgs_PaperReport_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Score, objgs_PaperReport_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_StuScore, objgs_PaperReport_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_TeaScore, objgs_PaperReport_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_PDFUrl) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_PDFUrl, objgs_PaperReport_Cond.pdFUrl, strComparisonOp_PDFUrl);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_PPTUrl) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_PPTUrl, objgs_PaperReport_Cond.ppTUrl, strComparisonOp_PPTUrl);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Month) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Month, objgs_PaperReport_Cond.month, strComparisonOp_Month);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Week) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Week, objgs_PaperReport_Cond.week, strComparisonOp_Week);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Year) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Year, objgs_PaperReport_Cond.year, strComparisonOp_Year);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_id_CurrEduCls, objgs_PaperReport_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_UpdUser, objgs_PaperReport_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_UpdDate, objgs_PaperReport_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperReport_Cond.dicFldComparisonOp, clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperReportEN_js_1.clsgs_PaperReportEN.con_Memo, objgs_PaperReport_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperReport_GetUniCondStr_TopicId_ReportUser_ReportDate(objgs_PaperReportEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objgs_PaperReportEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and ReportUser = '{0}'", objgs_PaperReportEN.reportUser);
        strWhereCond += (0, clsString_js_2.Format)(" and ReportDate = '{0}'", objgs_PaperReportEN.reportDate);
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperReport_GetUniCondStr4Update_TopicId_ReportUser_ReportDate(objgs_PaperReportEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ReportId <> '{0}'", objgs_PaperReportEN.reportId);
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objgs_PaperReportEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and ReportUser = '{0}'", objgs_PaperReportEN.reportUser);
        strWhereCond += (0, clsString_js_2.Format)(" and ReportDate = '{0}'", objgs_PaperReportEN.reportDate);
        return strWhereCond;
