...
(function (factory) {
    ...
    **/
    async function Viewpoint_GetObjByViewpointIdAsync(strViewpointId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strViewpointId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strViewpointId]不能为空！(In clsViewpointWApi.GetObjByViewpointIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strViewpointId]的长度:[{0}]不正确！(clsViewpointWApi.GetObjByViewpointIdAsync)", strViewpointId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpoint_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpoint_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function Viewpoint_GetObjByViewpointId_Cache(strViewpointId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strViewpointId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strViewpointId]不能为空！(In clsViewpointWApi.GetObjByViewpointId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strViewpointId]的长度:[{0}]不正确！(clsViewpointWApi.GetObjByViewpointId_Cache)", strViewpointId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function Viewpoint_GetObjByViewpointId_localStorage(strViewpointId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strViewpointId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strViewpointId]不能为空！(In clsViewpointWApi.GetObjByViewpointId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strViewpointId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strViewpointId]的长度:[{0}]不正确！(clsViewpointWApi.GetObjByViewpointId_localStorage)", strViewpointId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsViewpointEN_js_1.clsViewpointEN._CurrTabName, strViewpointId);
        if (strKey == "") {
    ...
    */
    async function Viewpoint_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsViewpointWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsViewpointWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsViewpointEN_js_1.clsViewpointEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsViewpointEN_js_1.clsViewpointEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objViewpoint == null)
            return "";
        if (objViewpoint.GetFldValue(strOutFldName) == null)
            return "";
    ...
    function Viewpoint_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsViewpointEN_js_1.clsViewpointEN.con_CourseId:
                    return (a, b) => {
                        if (a.courseId == null)
                            return -1;
                        if (b.courseId == null)
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function Viewpoint_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsViewpointWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsViewpointWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsViewpointEN_js_1.clsViewpointEN.con_ViewpointId) {
    ...
    exports.Viewpoint_funcKey = Viewpoint_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function Viewpoint_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsViewpointEN_js_1.clsViewpointEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsViewpointEN_js_1.clsViewpointEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsViewpointEN_js_1.clsViewpointEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsViewpointEN_js_1.clsViewpointEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsViewpointEN_js_1.clsViewpointEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrViewpointExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrViewpointExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function Viewpoint_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointExObjLst.length);
            console.log(strInfo);
            return arrViewpointExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpoint_ConstructorName, strThisFuncName);
    ...
    **/
    async function Viewpoint_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointExObjLst.length);
            console.log(strInfo);
            return arrViewpointExObjLst;
        }
        catch (e) {
    ...
    **/
    async function Viewpoint_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsViewpointWApi.Viewpoint_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsViewpointWApi.Viewpoint_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function Viewpoint_DelRecordAsync(strViewpointId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strViewpointId);
        try {
    ...
    **/
    async function Viewpoint_UpdateRecordAsync(objViewpointEN) {
        ...
        if (objViewpointEN.sf_UpdFldSetStr === undefined || objViewpointEN.sf_UpdFldSetStr === null || objViewpointEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointEN.viewpointId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpoint_Controller, strAction);
        try {
    ...
    */
    async function Viewpoint_IsExistRecord_Cache(objViewpoint_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objViewpoint_Cond), exports.viewpoint_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function Viewpoint_IsExist_Cache(strViewpointId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strViewpointId, exports.viewpoint_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function Viewpoint_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsViewpointWApi.clsViewpointWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsViewpointWApi.clsViewpointWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function Viewpoint_BindDdl_ViewpointIdByCourseIdInDiv_Cache(strDivName, strDdlName, strCourseId, strid_CurrEduCls) {
        const strThisFuncName = "BindDdl_ViewpointIdByCourseIdInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId]不能为空！(In clsViewpointWApi.BindDdl_ViewpointIdByCourseIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(clsViewpointWApi.BindDdl_ViewpointIdByCourseIdInDiv)", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsViewpointWApi.BindDdl_ViewpointIdByCourseIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsViewpointWApi.BindDdl_ViewpointIdByCourseIdInDiv)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_ViewpointIdByCourseIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsViewpointEN_js_1.clsViewpointEN.con_ViewpointId, clsViewpointEN_js_1.clsViewpointEN.con_ViewpointName, "观点表");
    }
    exports.Viewpoint_BindDdl_ViewpointIdByCourseIdInDiv_Cache = Viewpoint_BindDdl_ViewpointIdByCourseIdInDiv_Cache;
    /**
    ...
    */
    function Viewpoint_CheckPropertyNew(pobjViewpointEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointName) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.viewpointName) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.viewpointTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.source) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.source) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.vpProposePeople) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.vpProposePeople) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.userTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.userTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.citationId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.citationId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.pdfContent) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.pdfContent) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.createDate) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.createDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.shareId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.shareId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.courseId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.courseId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointId) == false && undefined !== pobjViewpointEN.viewpointId && clsString_js_1.tzDataType.isString(pobjViewpointEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointName) == false && undefined !== pobjViewpointEN.viewpointName && clsString_js_1.tzDataType.isString(pobjViewpointEN.viewpointName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointContent) == false && undefined !== pobjViewpointEN.viewpointContent && clsString_js_1.tzDataType.isString(pobjViewpointEN.viewpointContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointTypeId) == false && undefined !== pobjViewpointEN.viewpointTypeId && clsString_js_1.tzDataType.isString(pobjViewpointEN.viewpointTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.reason) == false && undefined !== pobjViewpointEN.reason && clsString_js_1.tzDataType.isString(pobjViewpointEN.reason) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.source) == false && undefined !== pobjViewpointEN.source && clsString_js_1.tzDataType.isString(pobjViewpointEN.source) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.vpProposePeople) == false && undefined !== pobjViewpointEN.vpProposePeople && clsString_js_1.tzDataType.isString(pobjViewpointEN.vpProposePeople) === false) {
        ...
        if (null != pobjViewpointEN.isSubmit && undefined !== pobjViewpointEN.isSubmit && clsString_js_1.tzDataType.isBoolean(pobjViewpointEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.userTypeId) == false && undefined !== pobjViewpointEN.userTypeId && clsString_js_1.tzDataType.isString(pobjViewpointEN.userTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.citationId) == false && undefined !== pobjViewpointEN.citationId && clsString_js_1.tzDataType.isString(pobjViewpointEN.citationId) === false) {
        ...
        if (null != pobjViewpointEN.appraiseCount && undefined !== pobjViewpointEN.appraiseCount && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.appraiseCount) === false) {
        ...
        if (null != pobjViewpointEN.okCount && undefined !== pobjViewpointEN.okCount && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.okCount) === false) {
        ...
        if (null != pobjViewpointEN.score && undefined !== pobjViewpointEN.score && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.score) === false) {
        ...
        if (null != pobjViewpointEN.stuScore && undefined !== pobjViewpointEN.stuScore && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.stuScore) === false) {
        ...
        if (null != pobjViewpointEN.teaScore && undefined !== pobjViewpointEN.teaScore && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.teaScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.pdfContent) == false && undefined !== pobjViewpointEN.pdfContent && clsString_js_1.tzDataType.isString(pobjViewpointEN.pdfContent) === false) {
        ...
        if (null != pobjViewpointEN.pdfPageNum && undefined !== pobjViewpointEN.pdfPageNum && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.pdfPageNum) === false) {
        ...
        if (null != pobjViewpointEN.citationCount && undefined !== pobjViewpointEN.citationCount && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.citationCount) === false) {
        ...
        if (null != pobjViewpointEN.versionCount && undefined !== pobjViewpointEN.versionCount && clsString_js_1.tzDataType.isNumber(pobjViewpointEN.versionCount) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.createDate) == false && undefined !== pobjViewpointEN.createDate && clsString_js_1.tzDataType.isString(pobjViewpointEN.createDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.shareId) == false && undefined !== pobjViewpointEN.shareId && clsString_js_1.tzDataType.isString(pobjViewpointEN.shareId) === false) {
        ...
        if (null != pobjViewpointEN.isRecommend && undefined !== pobjViewpointEN.isRecommend && clsString_js_1.tzDataType.isBoolean(pobjViewpointEN.isRecommend) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.id_CurrEduCls) == false && undefined !== pobjViewpointEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjViewpointEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.courseId) == false && undefined !== pobjViewpointEN.courseId && clsString_js_1.tzDataType.isString(pobjViewpointEN.courseId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.updUser) == false && undefined !== pobjViewpointEN.updUser && clsString_js_1.tzDataType.isString(pobjViewpointEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.updDate) == false && undefined !== pobjViewpointEN.updDate && clsString_js_1.tzDataType.isString(pobjViewpointEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.memo) == false && undefined !== pobjViewpointEN.memo && clsString_js_1.tzDataType.isString(pobjViewpointEN.memo) === false) {
    ...
    */
    function Viewpoint_CheckProperty4Update(pobjViewpointEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointEN.viewpointId) === true) {
    ...
    */
    function Viewpoint_GetCombineCondition(objViewpoint_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_ViewpointId, objViewpoint_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_ViewpointName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_ViewpointName, objViewpoint_Cond.viewpointName, strComparisonOp_ViewpointName);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_ViewpointTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_ViewpointTypeId, objViewpoint_Cond.viewpointTypeId, strComparisonOp_ViewpointTypeId);
        }
        //数据类型string(text)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_Source) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_Source, objViewpoint_Cond.source, strComparisonOp_Source);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_VPProposePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_VPProposePeople, objViewpoint_Cond.vpProposePeople, strComparisonOp_VPProposePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_IsSubmit) == true) {
            if (objViewpoint_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsViewpointEN_js_1.clsViewpointEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsViewpointEN_js_1.clsViewpointEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_UserTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_UserTypeId, objViewpoint_Cond.userTypeId, strComparisonOp_UserTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_CitationId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_CitationId, objViewpoint_Cond.citationId, strComparisonOp_CitationId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_AppraiseCount, objViewpoint_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_OkCount, objViewpoint_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_Score, objViewpoint_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_StuScore, objViewpoint_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_TeaScore, objViewpoint_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_PdfContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_PdfContent, objViewpoint_Cond.pdfContent, strComparisonOp_PdfContent);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_PdfPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_PdfPageNum, objViewpoint_Cond.pdfPageNum, strComparisonOp_PdfPageNum);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_CitationCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_CitationCount, objViewpoint_Cond.citationCount, strComparisonOp_CitationCount);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointEN_js_1.clsViewpointEN.con_VersionCount, objViewpoint_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_CreateDate, objViewpoint_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_ShareId, objViewpoint_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_IsRecommend) == true) {
            if (objViewpoint_Cond.isRecommend == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsViewpointEN_js_1.clsViewpointEN.con_IsRecommend);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsViewpointEN_js_1.clsViewpointEN.con_IsRecommend);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_id_CurrEduCls, objViewpoint_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_CourseId) == true) {
            const strComparisonOp_CourseId = objViewpoint_Cond.dicFldComparisonOp[clsViewpointEN_js_1.clsViewpointEN.con_CourseId];
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_CourseId, objViewpoint_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_UpdUser, objViewpoint_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_UpdDate, objViewpoint_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpoint_Cond.dicFldComparisonOp, clsViewpointEN_js_1.clsViewpointEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointEN_js_1.clsViewpointEN.con_Memo, objViewpoint_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function Viewpoint_GetUniCondStr_ViewpointId(objViewpointEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointId = '{0}'", objViewpointEN.viewpointId);
        return strWhereCond;
    }
