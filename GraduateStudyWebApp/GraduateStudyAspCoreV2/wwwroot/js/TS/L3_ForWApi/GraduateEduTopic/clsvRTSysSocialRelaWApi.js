...
(function (factory) {
    ...
    **/
    async function vRTSysSocialRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvRTSysSocialRelaWApi.GetObjBymIdAsync)");
    ...
    */
    async function vRTSysSocialRela_GetObjBymId_Cache(lngmId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvRTSysSocialRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrvRTSysSocialRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objvRTSysSocialRela_Const = await vRTSysSocialRela_GetObjBymIdAsync(lngmId);
                    if (objvRTSysSocialRela_Const != null) {
                        vRTSysSocialRela_ReFreshThisCache();
                        return objvRTSysSocialRela_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function vRTSysSocialRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvRTSysSocialRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vRTSysSocialRela_GetNameBymId_Cache(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvRTSysSocialRelaWApi.GetNameBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        const arrvRTSysSocialRelaObjLst_Cache = await vRTSysSocialRela_GetObjLst_Cache();
    ...
    */
    async function vRTSysSocialRela_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvRTSysSocialRelaEN_js_1.clsvRTSysSocialRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvRTSysSocialRelaEN_js_1.clsvRTSysSocialRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvRTSysSocialRela == null)
            return "";
        if (objvRTSysSocialRela.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvRTSysSocialRelaEN_js_1.clsvRTSysSocialRelaEN.con_SocialUpdUser:
                    return (a, b) => {
                        if (a.socialUpdUser == null)
                            return -1;
                        if (b.socialUpdUser == null)
                            return 1;
                ...
                case clsvRTSysSocialRelaEN_js_1.clsvRTSysSocialRelaEN.con_SocialUpdDate:
                    return (a, b) => {
                        if (a.socialUpdDate == null)
                            return -1;
                        if (b.socialUpdDate == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vRTSysSocialRela_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrvRTSysSocialRela = await vRTSysSocialRela_GetObjLst_Cache();
        if (arrvRTSysSocialRela == null)
            return [];
        let arrvRTSysSocialRela_Sel = arrvRTSysSocialRela;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrvRTSysSocialRela_Sel = arrvRTSysSocialRela_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrvRTSysSocialRela_Sel = arrvRTSysSocialRela_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrvRTSysSocialRela_Sel = arrvRTSysSocialRela_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrvRTSysSocialRela_Sel = arrvRTSysSocialRela_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrvRTSysSocialRela_Sel.length == 0)
            return [];
        return arrvRTSysSocialRela_Sel.map(x => x.mId);
    }
    exports.vRTSysSocialRela_funcKey = vRTSysSocialRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vRTSysSocialRela_GetObjLst_ClientCache() {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvRTSysSocialRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvRTSysSocialRelaExObjLst);
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrvRTSysSocialRela_Sel = arrvRTSysSocialRela_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
