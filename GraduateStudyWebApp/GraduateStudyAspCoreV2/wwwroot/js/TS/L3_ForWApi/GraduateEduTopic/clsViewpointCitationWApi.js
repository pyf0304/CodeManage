...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsViewpointCitationEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function ViewpointCitation_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsViewpointCitationWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpointCitation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpointCitation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpointCitation_ConstructorName, strThisFuncName);
    ...
    **/
    async function ViewpointCitation_UpdateRecordAsync(objViewpointCitationEN) {
        ...
        if (objViewpointCitationEN.sf_UpdFldSetStr === undefined || objViewpointCitationEN.sf_UpdFldSetStr === null || objViewpointCitationEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointCitationEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpointCitation_Controller, strAction);
        try {
    ...
    */
    function ViewpointCitation_CheckPropertyNew(pobjViewpointCitationEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.viewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointCitationEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointCitationEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointCitationEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointCitationEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointCitationEN.updDate) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjViewpointCitationEN.mId && undefined !== pobjViewpointCitationEN.mId && clsString_js_1.tzDataType.isNumber(pobjViewpointCitationEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.viewpointId) == false && undefined !== pobjViewpointCitationEN.viewpointId && clsString_js_1.tzDataType.isString(pobjViewpointCitationEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.paperId) == false && undefined !== pobjViewpointCitationEN.paperId && clsString_js_1.tzDataType.isString(pobjViewpointCitationEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.updUserId) == false && undefined !== pobjViewpointCitationEN.updUserId && clsString_js_1.tzDataType.isString(pobjViewpointCitationEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.memo) == false && undefined !== pobjViewpointCitationEN.memo && clsString_js_1.tzDataType.isString(pobjViewpointCitationEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointCitationEN.updDate) == false && undefined !== pobjViewpointCitationEN.updDate && clsString_js_1.tzDataType.isString(pobjViewpointCitationEN.updDate) === false) {
    ...
    */
    function ViewpointCitation_GetCombineCondition(objViewpointCitation_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpointCitation_Cond.dicFldComparisonOp, clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_mId, objViewpointCitation_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointCitation_Cond.dicFldComparisonOp, clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_ViewpointId, objViewpointCitation_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointCitation_Cond.dicFldComparisonOp, clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_PaperId, objViewpointCitation_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointCitation_Cond.dicFldComparisonOp, clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_UpdUserId, objViewpointCitation_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointCitation_Cond.dicFldComparisonOp, clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_Memo, objViewpointCitation_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointCitation_Cond.dicFldComparisonOp, clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointCitationEN_js_1.clsViewpointCitationEN.con_UpdDate, objViewpointCitation_Cond.updDate, strComparisonOp_UpdDate);
        }
        return strWhereCond;
    }
    ...
    **/
    function ViewpointCitation_GetUniCondStr_mId_ViewpointId_PaperId(objViewpointCitationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objViewpointCitationEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointId = '{0}'", objViewpointCitationEN.viewpointId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objViewpointCitationEN.paperId);
        return strWhereCond;
    }
