...
(function (factory) {
    ...
    **/
    async function RTUserRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTUserRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTUserRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTUserRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function RTUserRela_GetObjBymId_Cache(lngmId, strTopicId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTUserRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrRTUserRela_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objRTUserRela_Const = await RTUserRela_GetObjBymIdAsync(lngmId);
                    if (objRTUserRela_Const != null) {
                        RTUserRela_ReFreshThisCache(strTopicId);
                        return objRTUserRela_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function RTUserRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTUserRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsRTUserRelaEN_js_1.clsRTUserRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function RTUserRela_func(strInFldName, strOutFldName, strInValue, strTopicId_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicId_C]不能为空！(In clsRTUserRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsRTUserRelaWApi.func)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsRTUserRelaEN_js_1.clsRTUserRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsRTUserRelaEN_js_1.clsRTUserRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objRTUserRela == null)
            return "";
        if (objRTUserRela.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function RTUserRela_funcKey(strInFldName, strInValue, strComparisonOp, strTopicId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicId_C]不能为空！(In clsRTUserRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsRTUserRelaWApi.funcKey)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_mId) {
        ...
        const arrRTUserRela = await RTUserRela_GetObjLst_Cache(strTopicId_C);
        if (arrRTUserRela == null)
            return [];
        let arrRTUserRela_Sel = arrRTUserRela;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrRTUserRela_Sel = arrRTUserRela_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrRTUserRela_Sel = arrRTUserRela_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrRTUserRela_Sel = arrRTUserRela_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrRTUserRela_Sel = arrRTUserRela_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrRTUserRela_Sel.length == 0)
            return [];
        return arrRTUserRela_Sel.map(x => x.mId);
    }
    exports.RTUserRela_funcKey = RTUserRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function RTUserRela_GetObjLst_ClientCache(strTopicId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsRTUserRelaEN_js_1.clsRTUserRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsRTUserRelaEN_js_1.clsRTUserRelaEN.WhereFormat, strTopicId);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("TopicId='{0}'", strTopicId);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsRTUserRelaEN_js_1.clsRTUserRelaEN._CurrTabName, strTopicId);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsRTUserRelaEN_js_1.clsRTUserRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsRTUserRelaEN_js_1.clsRTUserRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrRTUserRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrRTUserRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTUserRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function RTUserRela_GetObjLst_localStorage(strTopicId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTUserRelaExObjLst.length);
            console.log(strInfo);
            return arrRTUserRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTUserRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function RTUserRela_GetObjLst_sessionStorage(strTopicId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTUserRelaExObjLst.length);
            console.log(strInfo);
            return arrRTUserRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function RTUserRela_GetObjLst_Cache(strTopicId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[TopicId]不能为空！(in clsRTUserRelaWApi.RTUserRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(in clsRTUserRelaWApi.RTUserRela_GetObjLst_Cache() )", strTopicId.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrRTUserRela_Sel = arrRTUserRela_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function RTUserRela_UpdateRecordAsync(objRTUserRelaEN) {
        ...
        if (objRTUserRelaEN.sf_UpdFldSetStr === undefined || objRTUserRelaEN.sf_UpdFldSetStr === null || objRTUserRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTUserRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTUserRela_Controller, strAction);
        try {
    ...
    */
    async function RTUserRela_IsExistRecord_Cache(objRTUserRela_Cond, strTopicId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objRTUserRela_Cond), exports.rTUserRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function RTUserRela_IsExist_Cache(lngmId, strTopicId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.rTUserRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function RTUserRela_ReFreshCache(strTopicId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicId]不能为空！(In clsRTUserRelaWApi.clsRTUserRelaWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(clsRTUserRelaWApi.clsRTUserRelaWApi.ReFreshCache)", strTopicId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function RTUserRela_CheckPropertyNew(pobjRTUserRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicUserRoleId) === true) {
            throw new Error("(errid:Watl000058)字段[主键Id]不能为空(In 主题用户关系)!(clsRTUserRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.userId) > 18) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过18(In 主题用户关系(RTUserRela))!值:$(pobjRTUserRelaEN.userId)(clsRTUserRelaBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicUserRoleId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.topicUserRoleId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.colorId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.colorId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.userBgColor) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.userBgColor) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTUserRelaEN.mId && undefined !== pobjRTUserRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjRTUserRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicId) == false && undefined !== pobjRTUserRelaEN.topicId && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.userId) == false && undefined !== pobjRTUserRelaEN.userId && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.userId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicUserRoleId) == false && undefined !== pobjRTUserRelaEN.topicUserRoleId && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.topicUserRoleId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.colorId) == false && undefined !== pobjRTUserRelaEN.colorId && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.colorId) === false) {
        ...
        if (null != pobjRTUserRelaEN.orderNum && undefined !== pobjRTUserRelaEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjRTUserRelaEN.orderNum) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.userBgColor) == false && undefined !== pobjRTUserRelaEN.userBgColor && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.userBgColor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.id_CurrEduCls) == false && undefined !== pobjRTUserRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.updDate) == false && undefined !== pobjRTUserRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.updUser) == false && undefined !== pobjRTUserRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.memo) == false && undefined !== pobjRTUserRelaEN.memo && clsString_js_1.tzDataType.isString(pobjRTUserRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicUserRoleId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.topicUserRoleId) != 4) {
            throw ("(errid:Watl000061)字段[主键Id]作为外键字段,长度应该为4(In 主题用户关系)!(clsRTUserRelaBL:CheckPropertyNew)");
        }
    ...
    */
    function RTUserRela_CheckProperty4Update(pobjRTUserRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.userId) > 18) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过18(In 主题用户关系(RTUserRela))!值:$(pobjRTUserRelaEN.userId)(clsRTUserRelaBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicUserRoleId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.topicUserRoleId) > 4) {
        ...
        //检查外键， 作为外键应该和主键的字段长度是一样的， 若不一样，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTUserRelaEN.topicUserRoleId) == false && (0, clsString_js_2.GetStrLen)(pobjRTUserRelaEN.topicUserRoleId) != 4) {
            throw ("(errid:Watl000065)字段[主键Id]作为外键字段,长度应该为4(In 主题用户关系)!(clsRTUserRelaBL:CheckPropertyNew)");
        }
        pobjRTUserRelaEN.SetIsCheckProperty(true);
    }
    ...
    */
    function RTUserRela_GetCombineCondition(objRTUserRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_mId, objRTUserRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_TopicId, objRTUserRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UserId, objRTUserRela_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_TopicUserRoleId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_TopicUserRoleId, objRTUserRela_Cond.topicUserRoleId, strComparisonOp_TopicUserRoleId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_ColorId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_ColorId, objRTUserRela_Cond.colorId, strComparisonOp_ColorId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_OrderNum, objRTUserRela_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UserBgColor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UserBgColor, objRTUserRela_Cond.userBgColor, strComparisonOp_UserBgColor);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_id_CurrEduCls, objRTUserRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UpdDate, objRTUserRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_UpdUser, objRTUserRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTUserRela_Cond.dicFldComparisonOp, clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTUserRelaEN_js_1.clsRTUserRelaEN.con_Memo, objRTUserRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTUserRela_GetUniCondStr_TopicId_UserId(objRTUserRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objRTUserRelaEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and UserId = '{0}'", objRTUserRelaEN.userId);
        return strWhereCond;
    }
    ...
    **/
    function RTUserRela_GetUniCondStr4Update_TopicId_UserId(objRTUserRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId <> '{0}'", objRTUserRelaEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and TopicId = '{0}'", objRTUserRelaEN.topicId);
        strWhereCond += (0, clsString_js_2.Format)(" and UserId = '{0}'", objRTUserRelaEN.userId);
        return strWhereCond;
    }
