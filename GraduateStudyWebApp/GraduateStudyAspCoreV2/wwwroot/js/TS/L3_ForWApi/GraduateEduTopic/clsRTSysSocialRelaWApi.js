...
(function (factory) {
    ...
    **/
    async function RTSysSocialRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTSysSocialRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.rTSysSocialRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.rTSysSocialRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function RTSysSocialRela_GetObjBymId_Cache(lngmId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTSysSocialRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function RTSysSocialRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsRTSysSocialRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function RTSysSocialRela_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objRTSysSocialRela == null)
            return "";
        if (objRTSysSocialRela.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function RTSysSocialRela_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.RTSysSocialRela_funcKey = RTSysSocialRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function RTSysSocialRela_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrRTSysSocialRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrRTSysSocialRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTSysSocialRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function RTSysSocialRela_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTSysSocialRelaExObjLst.length);
            console.log(strInfo);
            return arrRTSysSocialRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.rTSysSocialRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function RTSysSocialRela_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrRTSysSocialRelaExObjLst.length);
            console.log(strInfo);
            return arrRTSysSocialRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function RTSysSocialRela_UpdateRecordAsync(objRTSysSocialRelaEN) {
        ...
        if (objRTSysSocialRelaEN.sf_UpdFldSetStr === undefined || objRTSysSocialRelaEN.sf_UpdFldSetStr === null || objRTSysSocialRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objRTSysSocialRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.rTSysSocialRela_Controller, strAction);
        try {
    ...
    */
    async function RTSysSocialRela_IsExistRecord_Cache(objRTSysSocialRela_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objRTSysSocialRela_Cond), exports.rTSysSocialRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function RTSysSocialRela_IsExist_Cache(lngmId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.rTSysSocialRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function RTSysSocialRela_CheckPropertyNew(pobjRTSysSocialRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.topicId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.socialId) === true) {
            throw new Error("(errid:Watl000058)字段[社会Id]不能为空(In RTSysSocialRela)!(clsRTSysSocialRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.socialId) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.socialId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.classificationId) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.classificationId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjRTSysSocialRelaEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjRTSysSocialRelaEN.mId && undefined !== pobjRTSysSocialRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjRTSysSocialRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.topicId) == false && undefined !== pobjRTSysSocialRelaEN.topicId && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.socialId) == false && undefined !== pobjRTSysSocialRelaEN.socialId && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.socialId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.updDate) == false && undefined !== pobjRTSysSocialRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.updUser) == false && undefined !== pobjRTSysSocialRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.memo) == false && undefined !== pobjRTSysSocialRelaEN.memo && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.classificationId) == false && undefined !== pobjRTSysSocialRelaEN.classificationId && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.classificationId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjRTSysSocialRelaEN.id_CurrEduCls) == false && undefined !== pobjRTSysSocialRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjRTSysSocialRelaEN.id_CurrEduCls) === false) {
    ...
    */
    function RTSysSocialRela_GetCombineCondition(objRTSysSocialRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_mId, objRTSysSocialRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_TopicId, objRTSysSocialRela_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_SocialId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_SocialId, objRTSysSocialRela_Cond.socialId, strComparisonOp_SocialId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_UpdDate, objRTSysSocialRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_UpdUser, objRTSysSocialRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_Memo, objRTSysSocialRela_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_ClassificationId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_ClassificationId, objRTSysSocialRela_Cond.classificationId, strComparisonOp_ClassificationId);
        }
        if (Object.prototype.hasOwnProperty.call(objRTSysSocialRela_Cond.dicFldComparisonOp, clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsRTSysSocialRelaEN_js_1.clsRTSysSocialRelaEN.con_id_CurrEduCls, objRTSysSocialRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function RTSysSocialRela_GetUniCondStr_mId(objRTSysSocialRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objRTSysSocialRelaEN.mId);
        return strWhereCond;
    }
