...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsConceptCitationEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function ConceptCitation_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsConceptCitationWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.conceptCitation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.conceptCitation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.conceptCitation_ConstructorName, strThisFuncName);
    ...
    **/
    async function ConceptCitation_UpdateRecordAsync(objConceptCitationEN) {
        ...
        if (objConceptCitationEN.sf_UpdFldSetStr === undefined || objConceptCitationEN.sf_UpdFldSetStr === null || objConceptCitationEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objConceptCitationEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.conceptCitation_Controller, strAction);
        try {
    ...
    */
    function ConceptCitation_CheckPropertyNew(pobjConceptCitationEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.conceptId) === true) {
            throw new Error("(errid:Watl000058)字段[概念Id]不能为空(In 概念引用)!(clsConceptCitationBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.conceptId) == false && (0, clsString_js_2.GetStrLen)(pobjConceptCitationEN.conceptId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjConceptCitationEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjConceptCitationEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjConceptCitationEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjConceptCitationEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjConceptCitationEN.mId && undefined !== pobjConceptCitationEN.mId && clsString_js_1.tzDataType.isNumber(pobjConceptCitationEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.conceptId) == false && undefined !== pobjConceptCitationEN.conceptId && clsString_js_1.tzDataType.isString(pobjConceptCitationEN.conceptId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.paperId) == false && undefined !== pobjConceptCitationEN.paperId && clsString_js_1.tzDataType.isString(pobjConceptCitationEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.updDate) == false && undefined !== pobjConceptCitationEN.updDate && clsString_js_1.tzDataType.isString(pobjConceptCitationEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.updUserId) == false && undefined !== pobjConceptCitationEN.updUserId && clsString_js_1.tzDataType.isString(pobjConceptCitationEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjConceptCitationEN.memo) == false && undefined !== pobjConceptCitationEN.memo && clsString_js_1.tzDataType.isString(pobjConceptCitationEN.memo) === false) {
    ...
    */
    function ConceptCitation_GetCombineCondition(objConceptCitation_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objConceptCitation_Cond.dicFldComparisonOp, clsConceptCitationEN_js_1.clsConceptCitationEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsConceptCitationEN_js_1.clsConceptCitationEN.con_mId, objConceptCitation_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptCitation_Cond.dicFldComparisonOp, clsConceptCitationEN_js_1.clsConceptCitationEN.con_ConceptId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsConceptCitationEN_js_1.clsConceptCitationEN.con_ConceptId, objConceptCitation_Cond.conceptId, strComparisonOp_ConceptId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptCitation_Cond.dicFldComparisonOp, clsConceptCitationEN_js_1.clsConceptCitationEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsConceptCitationEN_js_1.clsConceptCitationEN.con_PaperId, objConceptCitation_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptCitation_Cond.dicFldComparisonOp, clsConceptCitationEN_js_1.clsConceptCitationEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsConceptCitationEN_js_1.clsConceptCitationEN.con_UpdDate, objConceptCitation_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptCitation_Cond.dicFldComparisonOp, clsConceptCitationEN_js_1.clsConceptCitationEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsConceptCitationEN_js_1.clsConceptCitationEN.con_UpdUserId, objConceptCitation_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objConceptCitation_Cond.dicFldComparisonOp, clsConceptCitationEN_js_1.clsConceptCitationEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsConceptCitationEN_js_1.clsConceptCitationEN.con_Memo, objConceptCitation_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function ConceptCitation_GetUniCondStr_mId_ConceptId_PaperId(objConceptCitationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objConceptCitationEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and ConceptId = '{0}'", objConceptCitationEN.conceptId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objConceptCitationEN.paperId);
        return strWhereCond;
    }
