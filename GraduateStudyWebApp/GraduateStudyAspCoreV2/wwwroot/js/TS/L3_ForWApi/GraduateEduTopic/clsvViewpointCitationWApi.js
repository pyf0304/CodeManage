...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsvViewpointCitationEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vViewpointCitation_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsvViewpointCitationWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.vViewpointCitation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.vViewpointCitation_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.vViewpointCitation_ConstructorName, strThisFuncName);
    ...
    **/
    async function vViewpointCitation_UpdateRecordAsync(objvViewpointCitationEN) {
        ...
        if (objvViewpointCitationEN.sf_UpdFldSetStr === undefined || objvViewpointCitationEN.sf_UpdFldSetStr === null || objvViewpointCitationEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objvViewpointCitationEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.vViewpointCitation_Controller, strAction);
        try {
    ...
    */
    function vViewpointCitation_CheckPropertyNew(pobjvViewpointCitationEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.paperTitle) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.paperTitle) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.userName) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.userName) > 30) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointName) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.viewpointName) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.viewpointTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.viewpointTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.proposePeople) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.proposePeople) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.source) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.source) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.topicName) == false && (0, clsString_js_2.GetStrLen)(pobjvViewpointCitationEN.topicName) > 200) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.memo) == false && undefined !== pobjvViewpointCitationEN.memo && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.memo) === false) {
        ...
        if (null != pobjvViewpointCitationEN.mId && undefined !== pobjvViewpointCitationEN.mId && clsString_js_1.tzDataType.isNumber(pobjvViewpointCitationEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.paperContent) == false && undefined !== pobjvViewpointCitationEN.paperContent && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.paperContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.paperId) == false && undefined !== pobjvViewpointCitationEN.paperId && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.paperTitle) == false && undefined !== pobjvViewpointCitationEN.paperTitle && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.paperTitle) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.reason) == false && undefined !== pobjvViewpointCitationEN.reason && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.reason) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.updUserId) == false && undefined !== pobjvViewpointCitationEN.updUserId && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.userName) == false && undefined !== pobjvViewpointCitationEN.userName && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.userName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointId) == false && undefined !== pobjvViewpointCitationEN.viewpointId && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointName) == false && undefined !== pobjvViewpointCitationEN.viewpointName && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.viewpointName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointTypeId) == false && undefined !== pobjvViewpointCitationEN.viewpointTypeId && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.viewpointTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.viewpointTypeName) == false && undefined !== pobjvViewpointCitationEN.viewpointTypeName && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.viewpointTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.updDate) == false && undefined !== pobjvViewpointCitationEN.updDate && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.proposePeople) == false && undefined !== pobjvViewpointCitationEN.proposePeople && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.proposePeople) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.source) == false && undefined !== pobjvViewpointCitationEN.source && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.source) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.topicId) == false && undefined !== pobjvViewpointCitationEN.topicId && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjvViewpointCitationEN.topicName) == false && undefined !== pobjvViewpointCitationEN.topicName && clsString_js_1.tzDataType.isString(pobjvViewpointCitationEN.topicName) === false) {
    ...
    */
    function vViewpointCitation_GetCombineCondition(objvViewpointCitation_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_Memo, objvViewpointCitation_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_mId, objvViewpointCitation_Cond.mId, strComparisonOp_mId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_PaperId, objvViewpointCitation_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_PaperTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_PaperTitle, objvViewpointCitation_Cond.paperTitle, strComparisonOp_PaperTitle);
        }
        //数据类型string(text)在函数:[AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CombineConditionByCondObj]中没有处理！
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_UpdUserId, objvViewpointCitation_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_UserName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_UserName, objvViewpointCitation_Cond.userName, strComparisonOp_UserName);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointId, objvViewpointCitation_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointName, objvViewpointCitation_Cond.viewpointName, strComparisonOp_ViewpointName);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointTypeId, objvViewpointCitation_Cond.viewpointTypeId, strComparisonOp_ViewpointTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ViewpointTypeName, objvViewpointCitation_Cond.viewpointTypeName, strComparisonOp_ViewpointTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_UpdDate, objvViewpointCitation_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ProposePeople) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_ProposePeople, objvViewpointCitation_Cond.proposePeople, strComparisonOp_ProposePeople);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_Source) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_Source, objvViewpointCitation_Cond.source, strComparisonOp_Source);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_TopicId, objvViewpointCitation_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objvViewpointCitation_Cond.dicFldComparisonOp, clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_TopicName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsvViewpointCitationEN_js_1.clsvViewpointCitationEN.con_TopicName, objvViewpointCitation_Cond.topicName, strComparisonOp_TopicName);
        }
        return strWhereCond;
    }
    ...
    **/
    function vViewpointCitation_GetUniCondStr_mId_PaperId_ViewpointId(objvViewpointCitationEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objvViewpointCitationEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objvViewpointCitationEN.paperId);
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointId = '{0}'", objvViewpointCitationEN.viewpointId);
        return strWhereCond;
    }
