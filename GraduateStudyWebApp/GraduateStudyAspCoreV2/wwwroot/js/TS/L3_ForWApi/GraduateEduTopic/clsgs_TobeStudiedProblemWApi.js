...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTopic/clsgs_TobeStudiedProblemEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_TobeStudiedProblem_GetObjByProblemIdAsync(strProblemId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strProblemId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strProblemId]不能为空！(In clsgs_TobeStudiedProblemWApi.GetObjByProblemIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strProblemId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strProblemId]的长度:[{0}]不正确！(clsgs_TobeStudiedProblemWApi.GetObjByProblemIdAsync)", strProblemId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TobeStudiedProblem_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TobeStudiedProblem_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TobeStudiedProblem_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_TobeStudiedProblem_DelRecordAsync(strProblemId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strProblemId);
        try {
    ...
    **/
    async function gs_TobeStudiedProblem_UpdateRecordAsync(objgs_TobeStudiedProblemEN) {
        ...
        if (objgs_TobeStudiedProblemEN.sf_UpdFldSetStr === undefined || objgs_TobeStudiedProblemEN.sf_UpdFldSetStr === null || objgs_TobeStudiedProblemEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TobeStudiedProblemEN.problemId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TobeStudiedProblem_Controller, strAction);
        try {
    ...
    */
    function gs_TobeStudiedProblem_CheckPropertyNew(pobjgs_TobeStudiedProblemEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.problemId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemTitle) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.problemTitle) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.problemDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.year) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.year) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.month) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.month) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.participant) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.participant) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TobeStudiedProblemEN.id_CurrEduCls) > 8) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemId) == false && undefined !== pobjgs_TobeStudiedProblemEN.problemId && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.problemId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemTitle) == false && undefined !== pobjgs_TobeStudiedProblemEN.problemTitle && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.problemTitle) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemContent) == false && undefined !== pobjgs_TobeStudiedProblemEN.problemContent && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.problemContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.topicId) == false && undefined !== pobjgs_TobeStudiedProblemEN.topicId && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.topicId) === false) {
        ...
        if (null != pobjgs_TobeStudiedProblemEN.isSubmit && undefined !== pobjgs_TobeStudiedProblemEN.isSubmit && clsString_js_1.tzDataType.isBoolean(pobjgs_TobeStudiedProblemEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemDate) == false && undefined !== pobjgs_TobeStudiedProblemEN.problemDate && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.problemDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.updDate) == false && undefined !== pobjgs_TobeStudiedProblemEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.updUser) == false && undefined !== pobjgs_TobeStudiedProblemEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.year) == false && undefined !== pobjgs_TobeStudiedProblemEN.year && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.year) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.month) == false && undefined !== pobjgs_TobeStudiedProblemEN.month && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.month) === false) {
        ...
        if (null != pobjgs_TobeStudiedProblemEN.versionCount && undefined !== pobjgs_TobeStudiedProblemEN.versionCount && clsString_js_1.tzDataType.isNumber(pobjgs_TobeStudiedProblemEN.versionCount) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.participant) == false && undefined !== pobjgs_TobeStudiedProblemEN.participant && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.participant) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.memo) == false && undefined !== pobjgs_TobeStudiedProblemEN.memo && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.id_CurrEduCls) == false && undefined !== pobjgs_TobeStudiedProblemEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_TobeStudiedProblemEN.id_CurrEduCls) === false) {
    ...
    */
    function gs_TobeStudiedProblem_CheckProperty4Update(pobjgs_TobeStudiedProblemEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TobeStudiedProblemEN.problemId) === true) {
    ...
    */
    function gs_TobeStudiedProblem_GetCombineCondition(objgs_TobeStudiedProblem_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_ProblemId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_ProblemId, objgs_TobeStudiedProblem_Cond.problemId, strComparisonOp_ProblemId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_ProblemTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_ProblemTitle, objgs_TobeStudiedProblem_Cond.problemTitle, strComparisonOp_ProblemTitle);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_TopicId, objgs_TobeStudiedProblem_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_IsSubmit) == true) {
            if (objgs_TobeStudiedProblem_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_ProblemDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_ProblemDate, objgs_TobeStudiedProblem_Cond.problemDate, strComparisonOp_ProblemDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_UpdDate, objgs_TobeStudiedProblem_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_UpdUser, objgs_TobeStudiedProblem_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Year) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Year, objgs_TobeStudiedProblem_Cond.year, strComparisonOp_Year);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Month) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Month, objgs_TobeStudiedProblem_Cond.month, strComparisonOp_Month);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_VersionCount, objgs_TobeStudiedProblem_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Participant) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Participant, objgs_TobeStudiedProblem_Cond.participant, strComparisonOp_Participant);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_Memo, objgs_TobeStudiedProblem_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TobeStudiedProblem_Cond.dicFldComparisonOp, clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN.con_id_CurrEduCls, objgs_TobeStudiedProblem_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_TobeStudiedProblem_GetUniCondStr_ProblemId(objgs_TobeStudiedProblemEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ProblemId = '{0}'", objgs_TobeStudiedProblemEN.problemId);
        return strWhereCond;
    }
