...
(function (factory) {
    ...
    **/
    async function ke_Sub_GetObjByke_SubIdAsync(strke_SubId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strke_SubId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strke_SubId]不能为空！(In clske_SubWApi.GetObjByke_SubIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SubId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strke_SubId]的长度:[{0}]不正确！(clske_SubWApi.GetObjByke_SubIdAsync)", strke_SubId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.ke_Sub_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.ke_Sub_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ke_Sub_GetObjByke_SubId_Cache(strke_SubId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strke_SubId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strke_SubId]不能为空！(In clske_SubWApi.GetObjByke_SubId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SubId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strke_SubId]的长度:[{0}]不正确！(clske_SubWApi.GetObjByke_SubId_Cache)", strke_SubId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrke_Sub_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objke_Sub_Const = await ke_Sub_GetObjByke_SubIdAsync(strke_SubId);
                    if (objke_Sub_Const != null) {
                        ke_Sub_ReFreshThisCache();
                        return objke_Sub_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function ke_Sub_GetObjByke_SubId_localStorage(strke_SubId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strke_SubId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strke_SubId]不能为空！(In clske_SubWApi.GetObjByke_SubId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strke_SubId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strke_SubId]的长度:[{0}]不正确！(clske_SubWApi.GetObjByke_SubId_localStorage)", strke_SubId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clske_SubEN_js_1.clske_SubEN._CurrTabName, strke_SubId);
        if (strKey == "") {
    ...
    */
    async function ke_Sub_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clske_SubEN_js_1.clske_SubEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clske_SubEN_js_1.clske_SubEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objke_Sub == null)
            return "";
        if (objke_Sub.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function ke_Sub_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrke_Sub = await ke_Sub_GetObjLst_Cache();
        if (arrke_Sub == null)
            return [];
        let arrke_Sub_Sel = arrke_Sub;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrke_Sub_Sel = arrke_Sub_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrke_Sub_Sel = arrke_Sub_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrke_Sub_Sel = arrke_Sub_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrke_Sub_Sel = arrke_Sub_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrke_Sub_Sel.length == 0)
            return [];
        return arrke_Sub_Sel.map(x => x.ke_SubId);
    }
    exports.ke_Sub_funcKey = ke_Sub_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function ke_Sub_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clske_SubEN_js_1.clske_SubEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clske_SubEN_js_1.clske_SubEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrke_SubExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrke_SubExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SubExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ke_Sub_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SubExObjLst.length);
            console.log(strInfo);
            return arrke_SubExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.ke_Sub_ConstructorName, strThisFuncName);
    ...
    **/
    async function ke_Sub_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrke_SubExObjLst.length);
            console.log(strInfo);
            return arrke_SubExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrke_Sub_Sel = arrke_Sub_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function ke_Sub_DelRecordAsync(strke_SubId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strke_SubId);
        try {
    ...
    **/
    async function ke_Sub_UpdateRecordAsync(objke_SubEN) {
        ...
        if (objke_SubEN.sf_UpdFldSetStr === undefined || objke_SubEN.sf_UpdFldSetStr === null || objke_SubEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objke_SubEN.ke_SubId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.ke_Sub_Controller, strAction);
        try {
    ...
    */
    async function ke_Sub_IsExistRecord_Cache(objke_Sub_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objke_Sub_Cond), exports.ke_Sub_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ke_Sub_IsExist_Cache(strke_SubId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strke_SubId, exports.ke_Sub_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function ke_Sub_CheckPropertyNew(pobjke_SubEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SuperId) === true) {
            throw new Error("(errid:Watl000058)字段[知识分类Id]不能为空(In 知识经济子类)!(clske_SubBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubName_cn) === true) {
            throw new Error("(errid:Watl000058)字段[知识子类名]不能为空(In 知识经济子类)!(clske_SubBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubId) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.ke_SubId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SuperId) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.ke_SuperId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubName_cn) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.ke_SubName_cn) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubName_en) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.ke_SubName_en) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubDescribe_cn) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.ke_SubDescribe_cn) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubDescribe_en) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.ke_SubDescribe_en) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.link) == false && (0, clsString_js_2.GetStrLen)(pobjke_SubEN.link) > 200) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubId) == false && undefined !== pobjke_SubEN.ke_SubId && clsString_js_1.tzDataType.isString(pobjke_SubEN.ke_SubId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SuperId) == false && undefined !== pobjke_SubEN.ke_SuperId && clsString_js_1.tzDataType.isString(pobjke_SubEN.ke_SuperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubName_cn) == false && undefined !== pobjke_SubEN.ke_SubName_cn && clsString_js_1.tzDataType.isString(pobjke_SubEN.ke_SubName_cn) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubName_en) == false && undefined !== pobjke_SubEN.ke_SubName_en && clsString_js_1.tzDataType.isString(pobjke_SubEN.ke_SubName_en) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubDescribe_cn) == false && undefined !== pobjke_SubEN.ke_SubDescribe_cn && clsString_js_1.tzDataType.isString(pobjke_SubEN.ke_SubDescribe_cn) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubDescribe_en) == false && undefined !== pobjke_SubEN.ke_SubDescribe_en && clsString_js_1.tzDataType.isString(pobjke_SubEN.ke_SubDescribe_en) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.updDate) == false && undefined !== pobjke_SubEN.updDate && clsString_js_1.tzDataType.isString(pobjke_SubEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.updUser) == false && undefined !== pobjke_SubEN.updUser && clsString_js_1.tzDataType.isString(pobjke_SubEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.memo) == false && undefined !== pobjke_SubEN.memo && clsString_js_1.tzDataType.isString(pobjke_SubEN.memo) === false) {
            throw new Error("(errid:Watl000060)字段[备注(memo)]的值:[$(pobjke_SubEN.memo)], 非法，应该为字符型(In 知识经济子类(ke_Sub))!(clske_SubBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.link) == false && undefined !== pobjke_SubEN.link && clsString_js_1.tzDataType.isString(pobjke_SubEN.link) === false) {
    ...
    */
    function ke_Sub_CheckProperty4Update(pobjke_SubEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjke_SubEN.ke_SubId) === true) {
    ...
    */
    function ke_Sub_GetCombineCondition(objke_Sub_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_ke_SubId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_ke_SubId, objke_Sub_Cond.ke_SubId, strComparisonOp_ke_SubId);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_ke_SuperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_ke_SuperId, objke_Sub_Cond.ke_SuperId, strComparisonOp_ke_SuperId);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_ke_SubName_cn) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_ke_SubName_cn, objke_Sub_Cond.ke_SubName_cn, strComparisonOp_ke_SubName_cn);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_ke_SubName_en) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_ke_SubName_en, objke_Sub_Cond.ke_SubName_en, strComparisonOp_ke_SubName_en);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_ke_SubDescribe_cn) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_ke_SubDescribe_cn, objke_Sub_Cond.ke_SubDescribe_cn, strComparisonOp_ke_SubDescribe_cn);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_ke_SubDescribe_en) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_ke_SubDescribe_en, objke_Sub_Cond.ke_SubDescribe_en, strComparisonOp_ke_SubDescribe_en);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_UpdDate, objke_Sub_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_UpdUser, objke_Sub_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_Memo, objke_Sub_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objke_Sub_Cond.dicFldComparisonOp, clske_SubEN_js_1.clske_SubEN.con_Link) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clske_SubEN_js_1.clske_SubEN.con_Link, objke_Sub_Cond.link, strComparisonOp_Link);
        }
        return strWhereCond;
    }
