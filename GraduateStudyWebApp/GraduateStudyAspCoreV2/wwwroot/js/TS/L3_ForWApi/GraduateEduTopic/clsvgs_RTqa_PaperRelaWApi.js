...
(function (factory) {
    ...
    **/
    async function vgs_RTqa_PaperRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvgs_RTqa_PaperRelaWApi.GetObjBymIdAsync)");
    ...
    */
    async function vgs_RTqa_PaperRela_GetObjBymId_Cache(lngmId, strTopicId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvgs_RTqa_PaperRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vgs_RTqa_PaperRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvgs_RTqa_PaperRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vgs_RTqa_PaperRela_func(strInFldName, strOutFldName, strInValue, strTopicId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId_C]不能为空！(In clsvgs_RTqa_PaperRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsvgs_RTqa_PaperRelaWApi.func)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvgs_RTqa_PaperRelaEN_js_1.clsvgs_RTqa_PaperRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvgs_RTqa_PaperRelaEN_js_1.clsvgs_RTqa_PaperRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvgs_RTqa_PaperRela == null)
            return "";
        if (objvgs_RTqa_PaperRela.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvgs_RTqa_PaperRelaEN_js_1.clsvgs_RTqa_PaperRelaEN.con_qaUserName:
                    return (a, b) => {
                        if (a.qaUserName == null)
                            return -1;
                        if (b.qaUserName == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vgs_RTqa_PaperRela_funcKey(strInFldName, strInValue, strComparisonOp, strTopicId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strTopicId_C]不能为空！(In clsvgs_RTqa_PaperRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicId_C]的长度:[{0}]不正确！(clsvgs_RTqa_PaperRelaWApi.funcKey)", strTopicId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvgs_RTqa_PaperRelaEN_js_1.clsvgs_RTqa_PaperRelaEN.con_mId) {
    ...
    exports.vgs_RTqa_PaperRela_funcKey = vgs_RTqa_PaperRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vgs_RTqa_PaperRela_GetObjLst_ClientCache(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvgs_RTqa_PaperRelaEN_js_1.clsvgs_RTqa_PaperRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvgs_RTqa_PaperRelaEN_js_1.clsvgs_RTqa_PaperRelaEN.WhereFormat, strTopicId);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_RTqa_PaperRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvgs_RTqa_PaperRelaExObjLst);
    ...
    **/
    async function vgs_RTqa_PaperRela_GetObjLst_Cache(strTopicId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strTopicId) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[TopicId]不能为空！(in clsvgs_RTqa_PaperRelaWApi.vgs_RTqa_PaperRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strTopicId]的长度:[{0}]不正确！(in clsvgs_RTqa_PaperRelaWApi.vgs_RTqa_PaperRela_GetObjLst_Cache() )", strTopicId.length);
            console.error(strMsg);
            throw (strMsg);
        }
