...
(function (factory) {
    ...
    **/
    async function SysVoteType_GetObjByVoteTypeIdAsync(strVoteTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strVoteTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetObjByVoteTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strVoteTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetObjByVoteTypeIdAsync)", strVoteTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysVoteType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysVoteType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysVoteType_GetObjByVoteTypeId_Cache(strVoteTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strVoteTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetObjByVoteTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strVoteTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetObjByVoteTypeId_Cache)", strVoteTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrSysVoteType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objSysVoteType_Const = await SysVoteType_GetObjByVoteTypeIdAsync(strVoteTypeId);
                    if (objSysVoteType_Const != null) {
                        SysVoteType_ReFreshThisCache();
                        return objSysVoteType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function SysVoteType_GetObjByVoteTypeId_localStorage(strVoteTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strVoteTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetObjByVoteTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strVoteTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetObjByVoteTypeId_localStorage)", strVoteTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN._CurrTabName, strVoteTypeId);
        if (strKey == "") {
    ...
    */
     ...
     * @returns 对象
    */
    async function SysVoteType_GetNameByVoteTypeId_Cache(strVoteTypeId) {
        const strThisFuncName = "GetNameByVoteTypeId_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strVoteTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strVoteTypeId]不能为空！(In clsSysVoteTypeWApi.GetNameByVoteTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strVoteTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strVoteTypeId]的长度:[{0}]不正确！(clsSysVoteTypeWApi.GetNameByVoteTypeId_Cache)", strVoteTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrSysVoteTypeObjLst_Cache = await SysVoteType_GetObjLst_Cache();
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("错误:[{0}]. \n根据关键字:[{1}]获取相应的对象名称属性不成功!", e, strVoteTypeId);
            console.error(strMsg);
            alert(strMsg);
        }
        return "";
    }
    exports.SysVoteType_GetNameByVoteTypeId_Cache = SysVoteType_GetNameByVoteTypeId_Cache;
    /**
    ...
    */
    async function SysVoteType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objSysVoteType == null)
            return "";
        if (objSysVoteType.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeName:
                    return (a, b) => {
                        if (a.voteTypeName == null)
                            return -1;
                        if (b.voteTypeName == null)
                            return 1;
                        return a.voteTypeName.localeCompare(b.voteTypeName);
                    };
                ...
                case clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTableId:
                    return (a, b) => {
                        if (a.voteTableId == null)
                            return -1;
                        if (b.voteTableId == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function SysVoteType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrSysVoteType = await SysVoteType_GetObjLst_Cache();
        if (arrSysVoteType == null)
            return [];
        let arrSysVoteType_Sel = arrSysVoteType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrSysVoteType_Sel = arrSysVoteType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrSysVoteType_Sel = arrSysVoteType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrSysVoteType_Sel = arrSysVoteType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrSysVoteType_Sel = arrSysVoteType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrSysVoteType_Sel.length == 0)
            return [];
        return arrSysVoteType_Sel.map(x => x.voteTypeId);
    }
    exports.SysVoteType_funcKey = SysVoteType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function SysVoteType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysVoteTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrSysVoteTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysVoteTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysVoteType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysVoteTypeExObjLst.length);
            console.log(strInfo);
            return arrSysVoteTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysVoteType_ConstructorName, strThisFuncName);
    ...
    **/
    async function SysVoteType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysVoteTypeExObjLst.length);
            console.log(strInfo);
            return arrSysVoteTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrSysVoteType_Sel = arrSysVoteType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function SysVoteType_DelRecordAsync(strVoteTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strVoteTypeId);
        try {
    ...
    **/
    async function SysVoteType_UpdateRecordAsync(objSysVoteTypeEN) {
        ...
        if (objSysVoteTypeEN.sf_UpdFldSetStr === undefined || objSysVoteTypeEN.sf_UpdFldSetStr === null || objSysVoteTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysVoteTypeEN.voteTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysVoteType_Controller, strAction);
        try {
    ...
    */
    async function SysVoteType_IsExistRecord_Cache(objSysVoteType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysVoteType_Cond), exports.sysVoteType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysVoteType_IsExist_Cache(strVoteTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strVoteTypeId, exports.sysVoteType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
     ...
     * @param strVoteTable:点赞表
    */
    async function SysVoteType_BindDdl_VoteTypeIdByVoteTableInDiv_Cache(strDivName, strDdlName, strVoteTable) {
        const strThisFuncName = "BindDdl_VoteTypeIdByVoteTableInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strVoteTable) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strVoteTable]不能为空！(In clsSysVoteTypeWApi.BindDdl_VoteTypeIdByVoteTableInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_VoteTypeIdByVoteTableInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_VoteTypeIdByVoteTableInDiv_Cache");
        let arrObjLst_Sel = await SysVoteType_GetObjLst_Cache();
        if (arrObjLst_Sel == null)
            return;
        arrObjLst_Sel = arrObjLst_Sel.filter(x => x.voteTable == strVoteTable);
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeId, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeName, "系统点赞类型");
    }
    exports.SysVoteType_BindDdl_VoteTypeIdByVoteTableInDiv_Cache = SysVoteType_BindDdl_VoteTypeIdByVoteTableInDiv_Cache;
    /**
    ...
    */
    function SysVoteType_CheckPropertyNew(pobjSysVoteTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjSysVoteTypeEN.voteTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjSysVoteTypeEN.voteTypeName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTable) == false && (0, clsString_js_2.GetStrLen)(pobjSysVoteTypeEN.voteTable) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTableId) == false && (0, clsString_js_2.GetStrLen)(pobjSysVoteTypeEN.voteTableId) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjSysVoteTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTypeId) == false && undefined !== pobjSysVoteTypeEN.voteTypeId && clsString_js_1.tzDataType.isString(pobjSysVoteTypeEN.voteTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTypeName) == false && undefined !== pobjSysVoteTypeEN.voteTypeName && clsString_js_1.tzDataType.isString(pobjSysVoteTypeEN.voteTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTable) == false && undefined !== pobjSysVoteTypeEN.voteTable && clsString_js_1.tzDataType.isString(pobjSysVoteTypeEN.voteTable) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTableId) == false && undefined !== pobjSysVoteTypeEN.voteTableId && clsString_js_1.tzDataType.isString(pobjSysVoteTypeEN.voteTableId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.memo) == false && undefined !== pobjSysVoteTypeEN.memo && clsString_js_1.tzDataType.isString(pobjSysVoteTypeEN.memo) === false) {
    ...
    */
    function SysVoteType_CheckProperty4Update(pobjSysVoteTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysVoteTypeEN.voteTypeId) === true
    ...
    */
    function SysVoteType_GetCombineCondition(objSysVoteType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysVoteType_Cond.dicFldComparisonOp, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeId, objSysVoteType_Cond.voteTypeId, strComparisonOp_VoteTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysVoteType_Cond.dicFldComparisonOp, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTypeName, objSysVoteType_Cond.voteTypeName, strComparisonOp_VoteTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objSysVoteType_Cond.dicFldComparisonOp, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTable) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTable, objSysVoteType_Cond.voteTable, strComparisonOp_VoteTable);
        }
        if (Object.prototype.hasOwnProperty.call(objSysVoteType_Cond.dicFldComparisonOp, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTableId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_VoteTableId, objSysVoteType_Cond.voteTableId, strComparisonOp_VoteTableId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysVoteType_Cond.dicFldComparisonOp, clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysVoteTypeEN_js_1.clsSysVoteTypeEN.con_Memo, objSysVoteType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
