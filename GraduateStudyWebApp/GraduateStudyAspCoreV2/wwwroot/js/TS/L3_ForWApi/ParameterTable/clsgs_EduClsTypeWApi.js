...
(function (factory) {
    ...
    **/
    async function gs_EduClsType_GetObjByEduClsTypeIdAsync(strEduClsTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strEduClsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetObjByEduClsTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strEduClsTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetObjByEduClsTypeIdAsync)", strEduClsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_EduClsType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_EduClsType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_EduClsType_GetObjByEduClsTypeId_Cache(strEduClsTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strEduClsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strEduClsTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_Cache)", strEduClsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_EduClsType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_EduClsType_Const = await gs_EduClsType_GetObjByEduClsTypeIdAsync(strEduClsTypeId);
                    if (objgs_EduClsType_Const != null) {
                        gs_EduClsType_ReFreshThisCache();
                        return objgs_EduClsType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_EduClsType_GetObjByEduClsTypeId_localStorage(strEduClsTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strEduClsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strEduClsTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetObjByEduClsTypeId_localStorage)", strEduClsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN._CurrTabName, strEduClsTypeId);
        if (strKey == "") {
    ...
    */
    async function gs_EduClsType_GetNameByEduClsTypeId_Cache(strEduClsTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strEduClsTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strEduClsTypeId]不能为空！(In clsgs_EduClsTypeWApi.GetNameByEduClsTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strEduClsTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strEduClsTypeId]的长度:[{0}]不正确！(clsgs_EduClsTypeWApi.GetNameByEduClsTypeId_Cache)", strEduClsTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_EduClsTypeObjLst_Cache = await gs_EduClsType_GetObjLst_Cache();
    ...
    */
    async function gs_EduClsType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_EduClsType == null)
            return "";
        if (objgs_EduClsType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_EduClsType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrgs_EduClsType = await gs_EduClsType_GetObjLst_Cache();
        if (arrgs_EduClsType == null)
            return [];
        let arrgs_EduClsType_Sel = arrgs_EduClsType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_EduClsType_Sel = arrgs_EduClsType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_EduClsType_Sel = arrgs_EduClsType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_EduClsType_Sel = arrgs_EduClsType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_EduClsType_Sel = arrgs_EduClsType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_EduClsType_Sel.length == 0)
            return [];
        return arrgs_EduClsType_Sel.map(x => x.eduClsTypeId);
    }
    exports.gs_EduClsType_funcKey = gs_EduClsType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_EduClsType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_EduClsTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_EduClsTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_EduClsTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_EduClsType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_EduClsTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_EduClsTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_EduClsType_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_EduClsType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_EduClsTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_EduClsTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_EduClsType_Sel = arrgs_EduClsType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_EduClsType_DelRecordAsync(strEduClsTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strEduClsTypeId);
        try {
    ...
    **/
    async function gs_EduClsType_UpdateRecordAsync(objgs_EduClsTypeEN) {
        ...
        if (objgs_EduClsTypeEN.sf_UpdFldSetStr === undefined || objgs_EduClsTypeEN.sf_UpdFldSetStr === null || objgs_EduClsTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_EduClsTypeEN.eduClsTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_EduClsType_Controller, strAction);
        try {
    ...
    */
    async function gs_EduClsType_IsExistRecord_Cache(objgs_EduClsType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_EduClsType_Cond), exports.gs_EduClsType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_EduClsType_IsExist_Cache(strEduClsTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strEduClsTypeId, exports.gs_EduClsType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_EduClsType_CheckPropertyNew(pobjgs_EduClsTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.eduClsTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_EduClsTypeEN.eduClsTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.eduClsTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_EduClsTypeEN.eduClsTypeName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_EduClsTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.eduClsTypeId) == false && undefined !== pobjgs_EduClsTypeEN.eduClsTypeId && clsString_js_1.tzDataType.isString(pobjgs_EduClsTypeEN.eduClsTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.eduClsTypeName) == false && undefined !== pobjgs_EduClsTypeEN.eduClsTypeName && clsString_js_1.tzDataType.isString(pobjgs_EduClsTypeEN.eduClsTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.memo) == false && undefined !== pobjgs_EduClsTypeEN.memo && clsString_js_1.tzDataType.isString(pobjgs_EduClsTypeEN.memo) === false) {
    ...
    */
    function gs_EduClsType_CheckProperty4Update(pobjgs_EduClsTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_EduClsTypeEN.eduClsTypeId) === true) {
    ...
    */
    function gs_EduClsType_GetCombineCondition(objgs_EduClsType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_EduClsType_Cond.dicFldComparisonOp, clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.con_EduClsTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.con_EduClsTypeId, objgs_EduClsType_Cond.eduClsTypeId, strComparisonOp_EduClsTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_EduClsType_Cond.dicFldComparisonOp, clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.con_EduClsTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.con_EduClsTypeName, objgs_EduClsType_Cond.eduClsTypeName, strComparisonOp_EduClsTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_EduClsType_Cond.dicFldComparisonOp, clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_EduClsTypeEN_js_1.clsgs_EduClsTypeEN.con_Memo, objgs_EduClsType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_EduClsType_GetUniCondStr_EduClsTypeName(objgs_EduClsTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and EduClsTypeName = '{0}'", objgs_EduClsTypeEN.eduClsTypeName);
        return strWhereCond;
    }
    ...
    **/
    function gs_EduClsType_GetUniCondStr4Update_EduClsTypeName(objgs_EduClsTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and EduClsTypeId <> '{0}'", objgs_EduClsTypeEN.eduClsTypeId);
        strWhereCond += (0, clsString_js_2.Format)(" and EduClsTypeName = '{0}'", objgs_EduClsTypeEN.eduClsTypeName);
        return strWhereCond;
    }
