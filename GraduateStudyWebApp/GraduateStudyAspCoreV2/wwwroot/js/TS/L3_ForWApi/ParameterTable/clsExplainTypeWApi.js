...
(function (factory) {
    ...
    **/
    async function ExplainType_GetObjByExplainTypeIdAsync(strExplainTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strExplainTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetObjByExplainTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExplainTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetObjByExplainTypeIdAsync)", strExplainTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.explainType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.explainType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ExplainType_GetObjByExplainTypeId_Cache(strExplainTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strExplainTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetObjByExplainTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExplainTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetObjByExplainTypeId_Cache)", strExplainTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrExplainType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objExplainType_Const = await ExplainType_GetObjByExplainTypeIdAsync(strExplainTypeId);
                    if (objExplainType_Const != null) {
                        ExplainType_ReFreshThisCache();
                        return objExplainType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function ExplainType_GetObjByExplainTypeId_localStorage(strExplainTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strExplainTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetObjByExplainTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExplainTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetObjByExplainTypeId_localStorage)", strExplainTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsExplainTypeEN_js_1.clsExplainTypeEN._CurrTabName, strExplainTypeId);
        if (strKey == "") {
    ...
    */
    async function ExplainType_GetNameByExplainTypeId_Cache(strExplainTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strExplainTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strExplainTypeId]不能为空！(In clsExplainTypeWApi.GetNameByExplainTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strExplainTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strExplainTypeId]的长度:[{0}]不正确！(clsExplainTypeWApi.GetNameByExplainTypeId_Cache)", strExplainTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrExplainTypeObjLst_Cache = await ExplainType_GetObjLst_Cache();
    ...
    */
    async function ExplainType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsExplainTypeEN_js_1.clsExplainTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsExplainTypeEN_js_1.clsExplainTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objExplainType == null)
            return "";
        if (objExplainType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function ExplainType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrExplainType = await ExplainType_GetObjLst_Cache();
        if (arrExplainType == null)
            return [];
        let arrExplainType_Sel = arrExplainType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrExplainType_Sel = arrExplainType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrExplainType_Sel = arrExplainType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrExplainType_Sel = arrExplainType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrExplainType_Sel = arrExplainType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrExplainType_Sel.length == 0)
            return [];
        return arrExplainType_Sel.map(x => x.explainTypeId);
    }
    exports.ExplainType_funcKey = ExplainType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function ExplainType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsExplainTypeEN_js_1.clsExplainTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsExplainTypeEN_js_1.clsExplainTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrExplainTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrExplainTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrExplainTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ExplainType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrExplainTypeExObjLst.length);
            console.log(strInfo);
            return arrExplainTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.explainType_ConstructorName, strThisFuncName);
    ...
    **/
    async function ExplainType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrExplainTypeExObjLst.length);
            console.log(strInfo);
            return arrExplainTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrExplainType_Sel = arrExplainType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function ExplainType_DelRecordAsync(strExplainTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strExplainTypeId);
        try {
    ...
    **/
    async function ExplainType_UpdateRecordAsync(objExplainTypeEN) {
        ...
        if (objExplainTypeEN.sf_UpdFldSetStr === undefined || objExplainTypeEN.sf_UpdFldSetStr === null || objExplainTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objExplainTypeEN.explainTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.explainType_Controller, strAction);
        try {
    ...
    */
    async function ExplainType_IsExistRecord_Cache(objExplainType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objExplainType_Cond), exports.explainType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ExplainType_IsExist_Cache(strExplainTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strExplainTypeId, exports.explainType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function ExplainType_BindDdl_ExplainTypeIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_ExplainTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function ExplainType_CheckPropertyNew(pobjExplainTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.explainTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjExplainTypeEN.explainTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.explainTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjExplainTypeEN.explainTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjExplainTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjExplainTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjExplainTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.explainTypeId) == false && undefined !== pobjExplainTypeEN.explainTypeId && clsString_js_1.tzDataType.isString(pobjExplainTypeEN.explainTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.explainTypeName) == false && undefined !== pobjExplainTypeEN.explainTypeName && clsString_js_1.tzDataType.isString(pobjExplainTypeEN.explainTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.updDate) == false && undefined !== pobjExplainTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjExplainTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.updUserId) == false && undefined !== pobjExplainTypeEN.updUserId && clsString_js_1.tzDataType.isString(pobjExplainTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.memo) == false && undefined !== pobjExplainTypeEN.memo && clsString_js_1.tzDataType.isString(pobjExplainTypeEN.memo) === false) {
    ...
    */
    function ExplainType_CheckProperty4Update(pobjExplainTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjExplainTypeEN.explainTypeId) === true
    ...
    */
    function ExplainType_GetCombineCondition(objExplainType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objExplainType_Cond.dicFldComparisonOp, clsExplainTypeEN_js_1.clsExplainTypeEN.con_ExplainTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsExplainTypeEN_js_1.clsExplainTypeEN.con_ExplainTypeId, objExplainType_Cond.explainTypeId, strComparisonOp_ExplainTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objExplainType_Cond.dicFldComparisonOp, clsExplainTypeEN_js_1.clsExplainTypeEN.con_ExplainTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsExplainTypeEN_js_1.clsExplainTypeEN.con_ExplainTypeName, objExplainType_Cond.explainTypeName, strComparisonOp_ExplainTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objExplainType_Cond.dicFldComparisonOp, clsExplainTypeEN_js_1.clsExplainTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsExplainTypeEN_js_1.clsExplainTypeEN.con_UpdDate, objExplainType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objExplainType_Cond.dicFldComparisonOp, clsExplainTypeEN_js_1.clsExplainTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsExplainTypeEN_js_1.clsExplainTypeEN.con_UpdUserId, objExplainType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objExplainType_Cond.dicFldComparisonOp, clsExplainTypeEN_js_1.clsExplainTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsExplainTypeEN_js_1.clsExplainTypeEN.con_Memo, objExplainType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
