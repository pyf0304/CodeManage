...
(function (factory) {
    ...
    **/
    async function DiscussionType_GetObjByDiscussionTypeIdAsync(strDiscussionTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussionTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetObjByDiscussionTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussionTypeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetObjByDiscussionTypeIdAsync)", strDiscussionTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.discussionType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.discussionType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function DiscussionType_GetObjByDiscussionTypeId_Cache(strDiscussionTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussionTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetObjByDiscussionTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussionTypeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetObjByDiscussionTypeId_Cache)", strDiscussionTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrDiscussionType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objDiscussionType_Const = await DiscussionType_GetObjByDiscussionTypeIdAsync(strDiscussionTypeId);
                    if (objDiscussionType_Const != null) {
                        DiscussionType_ReFreshThisCache();
                        return objDiscussionType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function DiscussionType_GetObjByDiscussionTypeId_localStorage(strDiscussionTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussionTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetObjByDiscussionTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussionTypeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetObjByDiscussionTypeId_localStorage)", strDiscussionTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN._CurrTabName, strDiscussionTypeId);
        if (strKey == "") {
    ...
    */
    async function DiscussionType_GetNameByDiscussionTypeId_Cache(strDiscussionTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussionTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussionTypeId]不能为空！(In clsDiscussionTypeWApi.GetNameByDiscussionTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussionTypeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussionTypeId]的长度:[{0}]不正确！(clsDiscussionTypeWApi.GetNameByDiscussionTypeId_Cache)", strDiscussionTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrDiscussionTypeObjLst_Cache = await DiscussionType_GetObjLst_Cache();
    ...
    */
    async function DiscussionType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objDiscussionType == null)
            return "";
        if (objDiscussionType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function DiscussionType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrDiscussionType = await DiscussionType_GetObjLst_Cache();
        if (arrDiscussionType == null)
            return [];
        let arrDiscussionType_Sel = arrDiscussionType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrDiscussionType_Sel = arrDiscussionType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrDiscussionType_Sel = arrDiscussionType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrDiscussionType_Sel = arrDiscussionType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrDiscussionType_Sel = arrDiscussionType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrDiscussionType_Sel.length == 0)
            return [];
        return arrDiscussionType_Sel.map(x => x.discussionTypeId);
    }
    exports.DiscussionType_funcKey = DiscussionType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function DiscussionType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrDiscussionTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrDiscussionTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrDiscussionTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function DiscussionType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrDiscussionTypeExObjLst.length);
            console.log(strInfo);
            return arrDiscussionTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.discussionType_ConstructorName, strThisFuncName);
    ...
    **/
    async function DiscussionType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrDiscussionTypeExObjLst.length);
            console.log(strInfo);
            return arrDiscussionTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrDiscussionType_Sel = arrDiscussionType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function DiscussionType_DelRecordAsync(strDiscussionTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strDiscussionTypeId);
        try {
    ...
    **/
    async function DiscussionType_UpdateRecordAsync(objDiscussionTypeEN) {
        ...
        if (objDiscussionTypeEN.sf_UpdFldSetStr === undefined || objDiscussionTypeEN.sf_UpdFldSetStr === null || objDiscussionTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objDiscussionTypeEN.discussionTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.discussionType_Controller, strAction);
        try {
    ...
    */
    async function DiscussionType_IsExistRecord_Cache(objDiscussionType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objDiscussionType_Cond), exports.discussionType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function DiscussionType_IsExist_Cache(strDiscussionTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strDiscussionTypeId, exports.discussionType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function DiscussionType_BindDdl_DiscussionTypeIdInDiv_Cache(strDivName, strDdlName) {
        const strThisFuncName = "BindDdl_DiscussionTypeIdInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_DiscussionTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_DiscussionTypeIdInDiv_Cache");
    ...
    exports.DiscussionType_BindDdl_DiscussionTypeIdInDiv_Cache = DiscussionType_BindDdl_DiscussionTypeIdInDiv_Cache;
    /**
    ...
    */
    function DiscussionType_CheckPropertyNew(pobjDiscussionTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.discussionTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjDiscussionTypeEN.discussionTypeId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.discussionTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjDiscussionTypeEN.discussionTypeName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjDiscussionTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjDiscussionTypeEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjDiscussionTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.discussionTypeId) == false && undefined !== pobjDiscussionTypeEN.discussionTypeId && clsString_js_1.tzDataType.isString(pobjDiscussionTypeEN.discussionTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.discussionTypeName) == false && undefined !== pobjDiscussionTypeEN.discussionTypeName && clsString_js_1.tzDataType.isString(pobjDiscussionTypeEN.discussionTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.updDate) == false && undefined !== pobjDiscussionTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjDiscussionTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.updUser) == false && undefined !== pobjDiscussionTypeEN.updUser && clsString_js_1.tzDataType.isString(pobjDiscussionTypeEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.memo) == false && undefined !== pobjDiscussionTypeEN.memo && clsString_js_1.tzDataType.isString(pobjDiscussionTypeEN.memo) === false) {
    ...
    */
    function DiscussionType_CheckProperty4Update(pobjDiscussionTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjDiscussionTypeEN.discussionTypeId) === true
    ...
    */
    function DiscussionType_GetCombineCondition(objDiscussionType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objDiscussionType_Cond.dicFldComparisonOp, clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_DiscussionTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_DiscussionTypeId, objDiscussionType_Cond.discussionTypeId, strComparisonOp_DiscussionTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionType_Cond.dicFldComparisonOp, clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_DiscussionTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_DiscussionTypeName, objDiscussionType_Cond.discussionTypeName, strComparisonOp_DiscussionTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionType_Cond.dicFldComparisonOp, clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_UpdDate, objDiscussionType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionType_Cond.dicFldComparisonOp, clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_UpdUser, objDiscussionType_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objDiscussionType_Cond.dicFldComparisonOp, clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsDiscussionTypeEN_js_1.clsDiscussionTypeEN.con_Memo, objDiscussionType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
