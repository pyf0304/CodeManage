...
(function (factory) {
    ...
    **/
    async function gs_ParagraphType_GetObjByParagraphTypeIdAsync(strParagraphTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphTypeId]不能为空！(In clsgs_ParagraphTypeWApi.GetObjByParagraphTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphTypeId]的长度:[{0}]不正确！(clsgs_ParagraphTypeWApi.GetObjByParagraphTypeIdAsync)", strParagraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ParagraphType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ParagraphType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_ParagraphType_GetObjByParagraphTypeId_Cache(strParagraphTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphTypeId]不能为空！(In clsgs_ParagraphTypeWApi.GetObjByParagraphTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphTypeId]的长度:[{0}]不正确！(clsgs_ParagraphTypeWApi.GetObjByParagraphTypeId_Cache)", strParagraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_ParagraphType_GetObjByParagraphTypeId_localStorage(strParagraphTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphTypeId]不能为空！(In clsgs_ParagraphTypeWApi.GetObjByParagraphTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphTypeId]的长度:[{0}]不正确！(clsgs_ParagraphTypeWApi.GetObjByParagraphTypeId_localStorage)", strParagraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN._CurrTabName, strParagraphTypeId);
        if (strKey == "") {
    ...
    */
    async function gs_ParagraphType_GetNameByParagraphTypeId_Cache(strParagraphTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphTypeId]不能为空！(In clsgs_ParagraphTypeWApi.GetNameByParagraphTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphTypeId]的长度:[{0}]不正确！(clsgs_ParagraphTypeWApi.GetNameByParagraphTypeId_Cache)", strParagraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_ParagraphTypeObjLst_Cache = await gs_ParagraphType_GetObjLst_Cache();
    ...
    */
    async function gs_ParagraphType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_ParagraphType == null)
            return "";
        if (objgs_ParagraphType.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_ParagraphTypeName:
                    return (a, b) => {
                        if (a.paragraphTypeName == null)
                            return -1;
                        if (b.paragraphTypeName == null)
                            return 1;
                        return a.paragraphTypeName.localeCompare(b.paragraphTypeName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_ParagraphType_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_ParagraphType_funcKey = gs_ParagraphType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_ParagraphType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_ParagraphTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_ParagraphTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ParagraphTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_ParagraphType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ParagraphTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_ParagraphTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ParagraphType_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_ParagraphType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ParagraphTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_ParagraphTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_ParagraphType_DelRecordAsync(strParagraphTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strParagraphTypeId);
        try {
    ...
    **/
    async function gs_ParagraphType_UpdateRecordAsync(objgs_ParagraphTypeEN) {
        ...
        if (objgs_ParagraphTypeEN.sf_UpdFldSetStr === undefined || objgs_ParagraphTypeEN.sf_UpdFldSetStr === null || objgs_ParagraphTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ParagraphTypeEN.paragraphTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ParagraphType_Controller, strAction);
        try {
    ...
    */
    async function gs_ParagraphType_IsExistRecord_Cache(objgs_ParagraphType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_ParagraphType_Cond), exports.gs_ParagraphType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_ParagraphType_IsExist_Cache(strParagraphTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strParagraphTypeId, exports.gs_ParagraphType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function gs_ParagraphType_BindDdl_ParagraphTypeIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_ParagraphTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_ParagraphType_CheckPropertyNew(pobjgs_ParagraphTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.paragraphTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ParagraphTypeEN.paragraphTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.paragraphTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ParagraphTypeEN.paragraphTypeName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ParagraphTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.paragraphTypeId) == false && undefined !== pobjgs_ParagraphTypeEN.paragraphTypeId && clsString_js_1.tzDataType.isString(pobjgs_ParagraphTypeEN.paragraphTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.paragraphTypeName) == false && undefined !== pobjgs_ParagraphTypeEN.paragraphTypeName && clsString_js_1.tzDataType.isString(pobjgs_ParagraphTypeEN.paragraphTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.memo) == false && undefined !== pobjgs_ParagraphTypeEN.memo && clsString_js_1.tzDataType.isString(pobjgs_ParagraphTypeEN.memo) === false) {
    ...
    */
    function gs_ParagraphType_CheckProperty4Update(pobjgs_ParagraphTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphTypeEN.paragraphTypeId) === true) {
    ...
    */
    function gs_ParagraphType_GetCombineCondition(objgs_ParagraphType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ParagraphType_Cond.dicFldComparisonOp, clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_ParagraphTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_ParagraphTypeId, objgs_ParagraphType_Cond.paragraphTypeId, strComparisonOp_ParagraphTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ParagraphType_Cond.dicFldComparisonOp, clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_ParagraphTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_ParagraphTypeName, objgs_ParagraphType_Cond.paragraphTypeName, strComparisonOp_ParagraphTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ParagraphType_Cond.dicFldComparisonOp, clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN.con_Memo, objgs_ParagraphType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ParagraphType_GetUniCondStr_ParagraphTypeId(objgs_ParagraphTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ParagraphTypeId = '{0}'", objgs_ParagraphTypeEN.paragraphTypeId);
        return strWhereCond;
    }
