...
(function (factory) {
    ...
    **/
    async function LiteratureType_GetObjByLiteratureTypeIdAsync(strLiteratureTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLiteratureTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetObjByLiteratureTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLiteratureTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetObjByLiteratureTypeIdAsync)", strLiteratureTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.literatureType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.literatureType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function LiteratureType_GetObjByLiteratureTypeId_Cache(strLiteratureTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLiteratureTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetObjByLiteratureTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLiteratureTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetObjByLiteratureTypeId_Cache)", strLiteratureTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrLiteratureType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objLiteratureType_Const = await LiteratureType_GetObjByLiteratureTypeIdAsync(strLiteratureTypeId);
                    if (objLiteratureType_Const != null) {
                        LiteratureType_ReFreshThisCache();
                        return objLiteratureType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function LiteratureType_GetObjByLiteratureTypeId_localStorage(strLiteratureTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLiteratureTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetObjByLiteratureTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLiteratureTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetObjByLiteratureTypeId_localStorage)", strLiteratureTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsLiteratureTypeEN_js_1.clsLiteratureTypeEN._CurrTabName, strLiteratureTypeId);
        if (strKey == "") {
    ...
    */
    async function LiteratureType_GetNameByLiteratureTypeId_Cache(strLiteratureTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLiteratureTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLiteratureTypeId]不能为空！(In clsLiteratureTypeWApi.GetNameByLiteratureTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLiteratureTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLiteratureTypeId]的长度:[{0}]不正确！(clsLiteratureTypeWApi.GetNameByLiteratureTypeId_Cache)", strLiteratureTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrLiteratureTypeObjLst_Cache = await LiteratureType_GetObjLst_Cache();
    ...
    */
    async function LiteratureType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objLiteratureType == null)
            return "";
        if (objLiteratureType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function LiteratureType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrLiteratureType = await LiteratureType_GetObjLst_Cache();
        if (arrLiteratureType == null)
            return [];
        let arrLiteratureType_Sel = arrLiteratureType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrLiteratureType_Sel = arrLiteratureType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrLiteratureType_Sel = arrLiteratureType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrLiteratureType_Sel = arrLiteratureType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrLiteratureType_Sel = arrLiteratureType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrLiteratureType_Sel.length == 0)
            return [];
        return arrLiteratureType_Sel.map(x => x.literatureTypeId);
    }
    exports.LiteratureType_funcKey = LiteratureType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function LiteratureType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrLiteratureTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrLiteratureTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrLiteratureTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function LiteratureType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrLiteratureTypeExObjLst.length);
            console.log(strInfo);
            return arrLiteratureTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.literatureType_ConstructorName, strThisFuncName);
    ...
    **/
    async function LiteratureType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrLiteratureTypeExObjLst.length);
            console.log(strInfo);
            return arrLiteratureTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrLiteratureType_Sel = arrLiteratureType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function LiteratureType_DelRecordAsync(strLiteratureTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strLiteratureTypeId);
        try {
    ...
    **/
    async function LiteratureType_UpdateRecordAsync(objLiteratureTypeEN) {
        ...
        if (objLiteratureTypeEN.sf_UpdFldSetStr === undefined || objLiteratureTypeEN.sf_UpdFldSetStr === null || objLiteratureTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objLiteratureTypeEN.literatureTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.literatureType_Controller, strAction);
        try {
    ...
    */
    async function LiteratureType_IsExistRecord_Cache(objLiteratureType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objLiteratureType_Cond), exports.literatureType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function LiteratureType_IsExist_Cache(strLiteratureTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strLiteratureTypeId, exports.literatureType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function LiteratureType_BindDdl_LiteratureTypeIdInDiv_Cache(strDivName, strDdlName) {
        const strThisFuncName = "BindDdl_LiteratureTypeIdInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_LiteratureTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_LiteratureTypeIdInDiv_Cache");
    ...
    exports.LiteratureType_BindDdl_LiteratureTypeIdInDiv_Cache = LiteratureType_BindDdl_LiteratureTypeIdInDiv_Cache;
    /**
    ...
    */
    function LiteratureType_CheckPropertyNew(pobjLiteratureTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.literatureTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjLiteratureTypeEN.literatureTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.literatureTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjLiteratureTypeEN.literatureTypeName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjLiteratureTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjLiteratureTypeEN.updDate) > 20) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.literatureTypeId) == false && undefined !== pobjLiteratureTypeEN.literatureTypeId && clsString_js_1.tzDataType.isString(pobjLiteratureTypeEN.literatureTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.literatureTypeName) == false && undefined !== pobjLiteratureTypeEN.literatureTypeName && clsString_js_1.tzDataType.isString(pobjLiteratureTypeEN.literatureTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.updUserId) == false && undefined !== pobjLiteratureTypeEN.updUserId && clsString_js_1.tzDataType.isString(pobjLiteratureTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.updDate) == false && undefined !== pobjLiteratureTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjLiteratureTypeEN.updDate) === false) {
    ...
    */
    function LiteratureType_CheckProperty4Update(pobjLiteratureTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjLiteratureTypeEN.literatureTypeId) === true) {
    ...
    */
    function LiteratureType_GetCombineCondition(objLiteratureType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objLiteratureType_Cond.dicFldComparisonOp, clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_LiteratureTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_LiteratureTypeId, objLiteratureType_Cond.literatureTypeId, strComparisonOp_LiteratureTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objLiteratureType_Cond.dicFldComparisonOp, clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_LiteratureTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_LiteratureTypeName, objLiteratureType_Cond.literatureTypeName, strComparisonOp_LiteratureTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objLiteratureType_Cond.dicFldComparisonOp, clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_UpdUserId, objLiteratureType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objLiteratureType_Cond.dicFldComparisonOp, clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsLiteratureTypeEN_js_1.clsLiteratureTypeEN.con_UpdDate, objLiteratureType_Cond.updDate, strComparisonOp_UpdDate);
        }
        return strWhereCond;
    }
