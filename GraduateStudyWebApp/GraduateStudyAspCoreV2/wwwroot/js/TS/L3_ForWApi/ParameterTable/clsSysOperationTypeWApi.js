...
(function (factory) {
    ...
    **/
    async function SysOperationType_GetObjByOperationTypeIdAsync(strOperationTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsSysOperationTypeWApi.GetObjByOperationTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsSysOperationTypeWApi.GetObjByOperationTypeIdAsync)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysOperationType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysOperationType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysOperationType_GetObjByOperationTypeId_Cache(strOperationTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsSysOperationTypeWApi.GetObjByOperationTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsSysOperationTypeWApi.GetObjByOperationTypeId_Cache)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function SysOperationType_GetObjByOperationTypeId_localStorage(strOperationTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsSysOperationTypeWApi.GetObjByOperationTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsSysOperationTypeWApi.GetObjByOperationTypeId_localStorage)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysOperationTypeEN_js_1.clsSysOperationTypeEN._CurrTabName, strOperationTypeId);
        if (strKey == "") {
    ...
    */
    async function SysOperationType_GetNameByOperationTypeId_Cache(strOperationTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsSysOperationTypeWApi.GetNameByOperationTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsSysOperationTypeWApi.GetNameByOperationTypeId_Cache)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrSysOperationTypeObjLst_Cache = await SysOperationType_GetObjLst_Cache();
    ...
    */
    async function SysOperationType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objSysOperationType == null)
            return "";
        if (objSysOperationType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function SysOperationType_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.SysOperationType_funcKey = SysOperationType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function SysOperationType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysOperationTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrSysOperationTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysOperationTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysOperationType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysOperationTypeExObjLst.length);
            console.log(strInfo);
            return arrSysOperationTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysOperationType_ConstructorName, strThisFuncName);
    ...
    **/
    async function SysOperationType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysOperationTypeExObjLst.length);
            console.log(strInfo);
            return arrSysOperationTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysOperationType_UpdateRecordAsync(objSysOperationTypeEN) {
        ...
        if (objSysOperationTypeEN.sf_UpdFldSetStr === undefined || objSysOperationTypeEN.sf_UpdFldSetStr === null || objSysOperationTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysOperationTypeEN.operationTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysOperationType_Controller, strAction);
        try {
    ...
    */
    async function SysOperationType_IsExistRecord_Cache(objSysOperationType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysOperationType_Cond), exports.sysOperationType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysOperationType_IsExist_Cache(strOperationTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strOperationTypeId, exports.sysOperationType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function SysOperationType_CheckPropertyNew(pobjSysOperationTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.operationTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjSysOperationTypeEN.operationTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjSysOperationTypeEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.operationTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjSysOperationTypeEN.operationTypeName) > 50) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.operationTypeId) == false && undefined !== pobjSysOperationTypeEN.operationTypeId && clsString_js_1.tzDataType.isString(pobjSysOperationTypeEN.operationTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.memo) == false && undefined !== pobjSysOperationTypeEN.memo && clsString_js_1.tzDataType.isString(pobjSysOperationTypeEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.operationTypeName) == false && undefined !== pobjSysOperationTypeEN.operationTypeName && clsString_js_1.tzDataType.isString(pobjSysOperationTypeEN.operationTypeName) === false) {
    ...
    */
    function SysOperationType_CheckProperty4Update(pobjSysOperationTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysOperationTypeEN.operationTypeId) === true) {
    ...
    */
    function SysOperationType_GetCombineCondition(objSysOperationType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysOperationType_Cond.dicFldComparisonOp, clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.con_OperationTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.con_OperationTypeId, objSysOperationType_Cond.operationTypeId, strComparisonOp_OperationTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysOperationType_Cond.dicFldComparisonOp, clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.con_Memo, objSysOperationType_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objSysOperationType_Cond.dicFldComparisonOp, clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.con_OperationTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysOperationTypeEN_js_1.clsSysOperationTypeEN.con_OperationTypeName, objSysOperationType_Cond.operationTypeName, strComparisonOp_OperationTypeName);
        }
        return strWhereCond;
    }
