...
(function (factory) {
    ...
    **/
    async function gs_PaperType_GetObjByPaperTypeIdAsync(strPaperTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperTypeId]不能为空！(In clsgs_PaperTypeWApi.GetObjByPaperTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperTypeId]的长度:[{0}]不正确！(clsgs_PaperTypeWApi.GetObjByPaperTypeIdAsync)", strPaperTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperType_GetObjByPaperTypeId_Cache(strPaperTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperTypeId]不能为空！(In clsgs_PaperTypeWApi.GetObjByPaperTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperTypeId]的长度:[{0}]不正确！(clsgs_PaperTypeWApi.GetObjByPaperTypeId_Cache)", strPaperTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_PaperType_GetObjByPaperTypeId_localStorage(strPaperTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperTypeId]不能为空！(In clsgs_PaperTypeWApi.GetObjByPaperTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperTypeId]的长度:[{0}]不正确！(clsgs_PaperTypeWApi.GetObjByPaperTypeId_localStorage)", strPaperTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN._CurrTabName, strPaperTypeId);
        if (strKey == "") {
    ...
    */
     ...
     * @returns 对象
    */
    async function gs_PaperType_GetNameByPaperTypeId_Cache(strPaperTypeId) {
        const strThisFuncName = "GetNameByPaperTypeId_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperTypeId]不能为空！(In clsgs_PaperTypeWApi.GetNameByPaperTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperTypeId]的长度:[{0}]不正确！(clsgs_PaperTypeWApi.GetNameByPaperTypeId_Cache)", strPaperTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_PaperTypeObjLst_Cache = await gs_PaperType_GetObjLst_Cache();
    ...
    exports.gs_PaperType_GetNameByPaperTypeId_Cache = gs_PaperType_GetNameByPaperTypeId_Cache;
    /**
    ...
    */
    async function gs_PaperType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_PaperType == null)
            return "";
        if (objgs_PaperType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    function gs_PaperType_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeENName:
                    return (a, b) => {
                        if (a.paperTypeENName == null)
                            return -1;
                        if (b.paperTypeENName == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_PaperType_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_PaperType_funcKey = gs_PaperType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_PaperType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_PaperTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperType_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PaperType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperType_DelRecordAsync(strPaperTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strPaperTypeId);
        try {
    ...
    **/
    async function gs_PaperType_UpdateRecordAsync(objgs_PaperTypeEN) {
        ...
        if (objgs_PaperTypeEN.sf_UpdFldSetStr === undefined || objgs_PaperTypeEN.sf_UpdFldSetStr === null || objgs_PaperTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperTypeEN.paperTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperType_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperType_IsExistRecord_Cache(objgs_PaperType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperType_Cond), exports.gs_PaperType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperType_IsExist_Cache(strPaperTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strPaperTypeId, exports.gs_PaperType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_PaperType_CheckPropertyNew(pobjgs_PaperTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeName) === true) {
            throw new Error("(errid:Watl000058)字段[论文类型名]不能为空(In 论文类型表)!(clsgs_PaperTypeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperTypeEN.paperTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperTypeEN.paperTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperTypeEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeENName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperTypeEN.paperTypeENName) > 50) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeId) == false && undefined !== pobjgs_PaperTypeEN.paperTypeId && clsString_js_1.tzDataType.isString(pobjgs_PaperTypeEN.paperTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeName) == false && undefined !== pobjgs_PaperTypeEN.paperTypeName && clsString_js_1.tzDataType.isString(pobjgs_PaperTypeEN.paperTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.memo) == false && undefined !== pobjgs_PaperTypeEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PaperTypeEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeENName) == false && undefined !== pobjgs_PaperTypeEN.paperTypeENName && clsString_js_1.tzDataType.isString(pobjgs_PaperTypeEN.paperTypeENName) === false) {
    ...
    */
    function gs_PaperType_CheckProperty4Update(pobjgs_PaperTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperTypeEN.paperTypeId) === true) {
    ...
    */
    function gs_PaperType_GetCombineCondition(objgs_PaperType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperType_Cond.dicFldComparisonOp, clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeId, objgs_PaperType_Cond.paperTypeId, strComparisonOp_PaperTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperType_Cond.dicFldComparisonOp, clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeName, objgs_PaperType_Cond.paperTypeName, strComparisonOp_PaperTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperType_Cond.dicFldComparisonOp, clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_Memo, objgs_PaperType_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperType_Cond.dicFldComparisonOp, clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeENName) == true) {
            const strComparisonOp_PaperTypeENName = objgs_PaperType_Cond.dicFldComparisonOp[clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeENName];
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperTypeEN_js_1.clsgs_PaperTypeEN.con_PaperTypeENName, objgs_PaperType_Cond.paperTypeENName, strComparisonOp_PaperTypeENName);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperType_GetUniCondStr_PaperTypeId(objgs_PaperTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperTypeId = '{0}'", objgs_PaperTypeEN.paperTypeId);
        return strWhereCond;
    }
