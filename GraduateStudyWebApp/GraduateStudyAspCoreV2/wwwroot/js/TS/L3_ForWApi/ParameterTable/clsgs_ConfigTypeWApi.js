...
(function (factory) {
    ...
    **/
    async function gs_ConfigType_GetObjByConfigTypeIdAsync(strConfigTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strConfigTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strConfigTypeId]不能为空！(In clsgs_ConfigTypeWApi.GetObjByConfigTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strConfigTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strConfigTypeId]的长度:[{0}]不正确！(clsgs_ConfigTypeWApi.GetObjByConfigTypeIdAsync)", strConfigTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ConfigType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ConfigType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_ConfigType_GetObjByConfigTypeId_Cache(strConfigTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strConfigTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strConfigTypeId]不能为空！(In clsgs_ConfigTypeWApi.GetObjByConfigTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strConfigTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strConfigTypeId]的长度:[{0}]不正确！(clsgs_ConfigTypeWApi.GetObjByConfigTypeId_Cache)", strConfigTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_ConfigType_GetObjByConfigTypeId_localStorage(strConfigTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strConfigTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strConfigTypeId]不能为空！(In clsgs_ConfigTypeWApi.GetObjByConfigTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strConfigTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strConfigTypeId]的长度:[{0}]不正确！(clsgs_ConfigTypeWApi.GetObjByConfigTypeId_localStorage)", strConfigTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN._CurrTabName, strConfigTypeId);
        if (strKey == "") {
    ...
    */
    async function gs_ConfigType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_ConfigType == null)
            return "";
        if (objgs_ConfigType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_ConfigType_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_ConfigType_funcKey = gs_ConfigType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_ConfigType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_ConfigTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_ConfigTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ConfigTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_ConfigType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ConfigTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_ConfigTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ConfigType_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_ConfigType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ConfigTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_ConfigTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_ConfigType_DelRecordAsync(strConfigTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strConfigTypeId);
        try {
    ...
    **/
    async function gs_ConfigType_UpdateRecordAsync(objgs_ConfigTypeEN) {
        ...
        if (objgs_ConfigTypeEN.sf_UpdFldSetStr === undefined || objgs_ConfigTypeEN.sf_UpdFldSetStr === null || objgs_ConfigTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ConfigTypeEN.configTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ConfigType_Controller, strAction);
        try {
    ...
    */
    async function gs_ConfigType_IsExistRecord_Cache(objgs_ConfigType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_ConfigType_Cond), exports.gs_ConfigType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_ConfigType_IsExist_Cache(strConfigTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strConfigTypeId, exports.gs_ConfigType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_ConfigType_CheckPropertyNew(pobjgs_ConfigTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.configTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ConfigTypeEN.configTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.configTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ConfigTypeEN.configTypeName) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.dataTable) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ConfigTypeEN.dataTable) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.dataTableId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ConfigTypeEN.dataTableId) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ConfigTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.configTypeId) == false && undefined !== pobjgs_ConfigTypeEN.configTypeId && clsString_js_1.tzDataType.isString(pobjgs_ConfigTypeEN.configTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.configTypeName) == false && undefined !== pobjgs_ConfigTypeEN.configTypeName && clsString_js_1.tzDataType.isString(pobjgs_ConfigTypeEN.configTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.dataTable) == false && undefined !== pobjgs_ConfigTypeEN.dataTable && clsString_js_1.tzDataType.isString(pobjgs_ConfigTypeEN.dataTable) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.dataTableId) == false && undefined !== pobjgs_ConfigTypeEN.dataTableId && clsString_js_1.tzDataType.isString(pobjgs_ConfigTypeEN.dataTableId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.memo) == false && undefined !== pobjgs_ConfigTypeEN.memo && clsString_js_1.tzDataType.isString(pobjgs_ConfigTypeEN.memo) === false) {
    ...
    */
    function gs_ConfigType_CheckProperty4Update(pobjgs_ConfigTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ConfigTypeEN.configTypeId) === true) {
    ...
    */
    function gs_ConfigType_GetCombineCondition(objgs_ConfigType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ConfigType_Cond.dicFldComparisonOp, clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_ConfigTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_ConfigTypeId, objgs_ConfigType_Cond.configTypeId, strComparisonOp_ConfigTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ConfigType_Cond.dicFldComparisonOp, clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_ConfigTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_ConfigTypeName, objgs_ConfigType_Cond.configTypeName, strComparisonOp_ConfigTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ConfigType_Cond.dicFldComparisonOp, clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_DataTable) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_DataTable, objgs_ConfigType_Cond.dataTable, strComparisonOp_DataTable);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ConfigType_Cond.dicFldComparisonOp, clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_DataTableId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_DataTableId, objgs_ConfigType_Cond.dataTableId, strComparisonOp_DataTableId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ConfigType_Cond.dicFldComparisonOp, clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ConfigTypeEN_js_1.clsgs_ConfigTypeEN.con_Memo, objgs_ConfigType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ConfigType_GetUniCondStr_ConfigTypeId(objgs_ConfigTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ConfigTypeId = '{0}'", objgs_ConfigTypeEN.configTypeId);
        return strWhereCond;
    }
