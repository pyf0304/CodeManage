...
(function (factory) {
    ...
    **/
    async function TopicUserRole_GetObjByTopicUserRoleIdAsync(strTopicUserRoleId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicUserRoleId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicUserRoleId]不能为空！(In clsTopicUserRoleWApi.GetObjByTopicUserRoleIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicUserRoleId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicUserRoleId]的长度:[{0}]不正确！(clsTopicUserRoleWApi.GetObjByTopicUserRoleIdAsync)", strTopicUserRoleId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.topicUserRole_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.topicUserRole_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function TopicUserRole_GetObjByTopicUserRoleId_Cache(strTopicUserRoleId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicUserRoleId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicUserRoleId]不能为空！(In clsTopicUserRoleWApi.GetObjByTopicUserRoleId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicUserRoleId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicUserRoleId]的长度:[{0}]不正确！(clsTopicUserRoleWApi.GetObjByTopicUserRoleId_Cache)", strTopicUserRoleId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function TopicUserRole_GetObjByTopicUserRoleId_localStorage(strTopicUserRoleId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicUserRoleId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicUserRoleId]不能为空！(In clsTopicUserRoleWApi.GetObjByTopicUserRoleId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicUserRoleId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicUserRoleId]的长度:[{0}]不正确！(clsTopicUserRoleWApi.GetObjByTopicUserRoleId_localStorage)", strTopicUserRoleId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN._CurrTabName, strTopicUserRoleId);
        if (strKey == "") {
    ...
    */
    async function TopicUserRole_GetNameByTopicUserRoleId_Cache(strTopicUserRoleId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strTopicUserRoleId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strTopicUserRoleId]不能为空！(In clsTopicUserRoleWApi.GetNameByTopicUserRoleId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strTopicUserRoleId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strTopicUserRoleId]的长度:[{0}]不正确！(clsTopicUserRoleWApi.GetNameByTopicUserRoleId_Cache)", strTopicUserRoleId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrTopicUserRoleObjLst_Cache = await TopicUserRole_GetObjLst_Cache();
    ...
    */
    async function TopicUserRole_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objTopicUserRole == null)
            return "";
        if (objTopicUserRole.GetFldValue(strOutFldName) == null)
            return "";
    ...
    function TopicUserRole_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleENName:
                    return (a, b) => {
                        if (a.topicUserRoleENName == null)
                            return -1;
                        if (b.topicUserRoleENName == null)
                            return 1;
                        return a.topicUserRoleENName.localeCompare(b.topicUserRoleENName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function TopicUserRole_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.TopicUserRole_funcKey = TopicUserRole_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function TopicUserRole_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrTopicUserRoleExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrTopicUserRoleExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTopicUserRoleExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function TopicUserRole_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTopicUserRoleExObjLst.length);
            console.log(strInfo);
            return arrTopicUserRoleExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.topicUserRole_ConstructorName, strThisFuncName);
    ...
    **/
    async function TopicUserRole_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTopicUserRoleExObjLst.length);
            console.log(strInfo);
            return arrTopicUserRoleExObjLst;
        }
        catch (e) {
    ...
    **/
    async function TopicUserRole_DelRecordAsync(strTopicUserRoleId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strTopicUserRoleId);
        try {
    ...
    **/
    async function TopicUserRole_UpdateRecordAsync(objTopicUserRoleEN) {
        ...
        if (objTopicUserRoleEN.sf_UpdFldSetStr === undefined || objTopicUserRoleEN.sf_UpdFldSetStr === null || objTopicUserRoleEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objTopicUserRoleEN.topicUserRoleId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.topicUserRole_Controller, strAction);
        try {
    ...
    */
    async function TopicUserRole_IsExistRecord_Cache(objTopicUserRole_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objTopicUserRole_Cond), exports.topicUserRole_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function TopicUserRole_IsExist_Cache(strTopicUserRoleId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strTopicUserRoleId, exports.topicUserRole_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function TopicUserRole_CheckPropertyNew(pobjTopicUserRoleEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleName) === true) {
            throw new Error("(errid:Watl000058)字段[主题用户角色]不能为空(In 主题用户角色)!(clsTopicUserRoleBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.updUserId) === true) {
            throw new Error("(errid:Watl000058)字段[修改用户Id]不能为空(In 主题用户角色)!(clsTopicUserRoleBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleId) == false && (0, clsString_js_2.GetStrLen)(pobjTopicUserRoleEN.topicUserRoleId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleName) == false && (0, clsString_js_2.GetStrLen)(pobjTopicUserRoleEN.topicUserRoleName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleENName) == false && (0, clsString_js_2.GetStrLen)(pobjTopicUserRoleEN.topicUserRoleENName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjTopicUserRoleEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjTopicUserRoleEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjTopicUserRoleEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleId) == false && undefined !== pobjTopicUserRoleEN.topicUserRoleId && clsString_js_1.tzDataType.isString(pobjTopicUserRoleEN.topicUserRoleId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleName) == false && undefined !== pobjTopicUserRoleEN.topicUserRoleName && clsString_js_1.tzDataType.isString(pobjTopicUserRoleEN.topicUserRoleName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleENName) == false && undefined !== pobjTopicUserRoleEN.topicUserRoleENName && clsString_js_1.tzDataType.isString(pobjTopicUserRoleEN.topicUserRoleENName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.updUserId) == false && undefined !== pobjTopicUserRoleEN.updUserId && clsString_js_1.tzDataType.isString(pobjTopicUserRoleEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.updDate) == false && undefined !== pobjTopicUserRoleEN.updDate && clsString_js_1.tzDataType.isString(pobjTopicUserRoleEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.memo) == false && undefined !== pobjTopicUserRoleEN.memo && clsString_js_1.tzDataType.isString(pobjTopicUserRoleEN.memo) === false) {
    ...
    */
    function TopicUserRole_CheckProperty4Update(pobjTopicUserRoleEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTopicUserRoleEN.topicUserRoleId) === true) {
    ...
    */
    function TopicUserRole_GetCombineCondition(objTopicUserRole_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objTopicUserRole_Cond.dicFldComparisonOp, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleId, objTopicUserRole_Cond.topicUserRoleId, strComparisonOp_TopicUserRoleId);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicUserRole_Cond.dicFldComparisonOp, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleName, objTopicUserRole_Cond.topicUserRoleName, strComparisonOp_TopicUserRoleName);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicUserRole_Cond.dicFldComparisonOp, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleENName) == true) {
            const strComparisonOp_TopicUserRoleENName = objTopicUserRole_Cond.dicFldComparisonOp[clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleENName];
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_TopicUserRoleENName, objTopicUserRole_Cond.topicUserRoleENName, strComparisonOp_TopicUserRoleENName);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicUserRole_Cond.dicFldComparisonOp, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_UpdUserId, objTopicUserRole_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicUserRole_Cond.dicFldComparisonOp, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_UpdDate, objTopicUserRole_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objTopicUserRole_Cond.dicFldComparisonOp, clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTopicUserRoleEN_js_1.clsTopicUserRoleEN.con_Memo, objTopicUserRole_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function TopicUserRole_GetUniCondStr_TopicUserRoleId(objTopicUserRoleEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TopicUserRoleId = '{0}'", objTopicUserRoleEN.topicUserRoleId);
        return strWhereCond;
    }
