...
(function (factory) {
    ...
    **/
    async function gs_ParagraphState_GetObjByParagraphStateIdAsync(strParagraphStateId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphStateId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphStateId]不能为空！(In clsgs_ParagraphStateWApi.GetObjByParagraphStateIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphStateId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphStateId]的长度:[{0}]不正确！(clsgs_ParagraphStateWApi.GetObjByParagraphStateIdAsync)", strParagraphStateId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_ParagraphState_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_ParagraphState_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_ParagraphState_GetObjByParagraphStateId_Cache(strParagraphStateId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphStateId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphStateId]不能为空！(In clsgs_ParagraphStateWApi.GetObjByParagraphStateId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphStateId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphStateId]的长度:[{0}]不正确！(clsgs_ParagraphStateWApi.GetObjByParagraphStateId_Cache)", strParagraphStateId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_ParagraphState_GetObjByParagraphStateId_localStorage(strParagraphStateId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphStateId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphStateId]不能为空！(In clsgs_ParagraphStateWApi.GetObjByParagraphStateId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphStateId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphStateId]的长度:[{0}]不正确！(clsgs_ParagraphStateWApi.GetObjByParagraphStateId_localStorage)", strParagraphStateId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN._CurrTabName, strParagraphStateId);
        if (strKey == "") {
    ...
    */
    async function gs_ParagraphState_GetNameByParagraphStateId_Cache(strParagraphStateId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphStateId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphStateId]不能为空！(In clsgs_ParagraphStateWApi.GetNameByParagraphStateId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphStateId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphStateId]的长度:[{0}]不正确！(clsgs_ParagraphStateWApi.GetNameByParagraphStateId_Cache)", strParagraphStateId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_ParagraphStateObjLst_Cache = await gs_ParagraphState_GetObjLst_Cache();
    ...
    */
    async function gs_ParagraphState_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_ParagraphState == null)
            return "";
        if (objgs_ParagraphState.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                case clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_ParagraphStateId:
                    return (a, b) => {
                        if (a.paragraphStateId == null)
                            return -1;
                        if (b.paragraphStateId == null)
                            return 1;
                        return a.paragraphStateId.localeCompare(b.paragraphStateId);
                    };
                case clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_ParagraphStateName:
                    return (a, b) => {
                        if (a.paragraphStateName == null)
                            return -1;
                        if (b.paragraphStateName == null)
                            return 1;
                        return a.paragraphStateName.localeCompare(b.paragraphStateName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_ParagraphState_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_ParagraphState_funcKey = gs_ParagraphState_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_ParagraphState_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_ParagraphStateExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_ParagraphStateExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ParagraphStateExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_ParagraphState_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ParagraphStateExObjLst.length);
            console.log(strInfo);
            return arrgs_ParagraphStateExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_ParagraphState_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_ParagraphState_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ParagraphStateExObjLst.length);
            console.log(strInfo);
            return arrgs_ParagraphStateExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_ParagraphState_DelRecordAsync(strParagraphStateId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strParagraphStateId);
        try {
    ...
    **/
    async function gs_ParagraphState_UpdateRecordAsync(objgs_ParagraphStateEN) {
        ...
        if (objgs_ParagraphStateEN.sf_UpdFldSetStr === undefined || objgs_ParagraphStateEN.sf_UpdFldSetStr === null || objgs_ParagraphStateEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ParagraphStateEN.paragraphStateId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_ParagraphState_Controller, strAction);
        try {
    ...
    */
    async function gs_ParagraphState_IsExistRecord_Cache(objgs_ParagraphState_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_ParagraphState_Cond), exports.gs_ParagraphState_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_ParagraphState_IsExist_Cache(strParagraphStateId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strParagraphStateId, exports.gs_ParagraphState_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_ParagraphState_CheckPropertyNew(pobjgs_ParagraphStateEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.paragraphStateId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ParagraphStateEN.paragraphStateId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.paragraphStateName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ParagraphStateEN.paragraphStateName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ParagraphStateEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.paragraphStateId) == false && undefined !== pobjgs_ParagraphStateEN.paragraphStateId && clsString_js_1.tzDataType.isString(pobjgs_ParagraphStateEN.paragraphStateId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.paragraphStateName) == false && undefined !== pobjgs_ParagraphStateEN.paragraphStateName && clsString_js_1.tzDataType.isString(pobjgs_ParagraphStateEN.paragraphStateName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.memo) == false && undefined !== pobjgs_ParagraphStateEN.memo && clsString_js_1.tzDataType.isString(pobjgs_ParagraphStateEN.memo) === false) {
    ...
    */
    function gs_ParagraphState_CheckProperty4Update(pobjgs_ParagraphStateEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ParagraphStateEN.paragraphStateId) === true) {
    ...
    */
    function gs_ParagraphState_GetCombineCondition(objgs_ParagraphState_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_ParagraphState_Cond.dicFldComparisonOp, clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_ParagraphStateId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_ParagraphStateId, objgs_ParagraphState_Cond.paragraphStateId, strComparisonOp_ParagraphStateId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ParagraphState_Cond.dicFldComparisonOp, clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_ParagraphStateName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_ParagraphStateName, objgs_ParagraphState_Cond.paragraphStateName, strComparisonOp_ParagraphStateName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_ParagraphState_Cond.dicFldComparisonOp, clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ParagraphStateEN_js_1.clsgs_ParagraphStateEN.con_Memo, objgs_ParagraphState_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_ParagraphState_GetUniCondStr_ParagraphStateId(objgs_ParagraphStateEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ParagraphStateId = '{0}'", objgs_ParagraphStateEN.paragraphStateId);
        return strWhereCond;
    }
