...
(function (factory) {
    ...
    **/
    async function gs_Color_GetObjByColorIdAsync(strColorId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strColorId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strColorId]不能为空！(In clsgs_ColorWApi.GetObjByColorIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strColorId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strColorId]的长度:[{0}]不正确！(clsgs_ColorWApi.GetObjByColorIdAsync)", strColorId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_Color_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_Color_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_Color_GetObjByColorId_Cache(strColorId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strColorId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strColorId]不能为空！(In clsgs_ColorWApi.GetObjByColorId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strColorId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strColorId]的长度:[{0}]不正确！(clsgs_ColorWApi.GetObjByColorId_Cache)", strColorId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_Color_GetObjByColorId_localStorage(strColorId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strColorId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strColorId]不能为空！(In clsgs_ColorWApi.GetObjByColorId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strColorId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strColorId]的长度:[{0}]不正确！(clsgs_ColorWApi.GetObjByColorId_localStorage)", strColorId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_ColorEN_js_1.clsgs_ColorEN._CurrTabName, strColorId);
        if (strKey == "") {
    ...
    */
    async function gs_Color_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_ColorEN_js_1.clsgs_ColorEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_ColorEN_js_1.clsgs_ColorEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_Color == null)
            return "";
        if (objgs_Color.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_Color_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_Color_funcKey = gs_Color_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_Color_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_ColorEN_js_1.clsgs_ColorEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_ColorEN_js_1.clsgs_ColorEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_ColorExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_ColorExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ColorExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_Color_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ColorExObjLst.length);
            console.log(strInfo);
            return arrgs_ColorExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_Color_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_Color_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_ColorExObjLst.length);
            console.log(strInfo);
            return arrgs_ColorExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_Color_DelRecordAsync(strColorId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strColorId);
        try {
    ...
    **/
    async function gs_Color_UpdateRecordAsync(objgs_ColorEN) {
        ...
        if (objgs_ColorEN.sf_UpdFldSetStr === undefined || objgs_ColorEN.sf_UpdFldSetStr === null || objgs_ColorEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_ColorEN.colorId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_Color_Controller, strAction);
        try {
    ...
    */
    async function gs_Color_IsExistRecord_Cache(objgs_Color_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_Color_Cond), exports.gs_Color_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_Color_IsExist_Cache(strColorId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strColorId, exports.gs_Color_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_Color_CheckPropertyNew(pobjgs_ColorEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ColorEN.colorId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ColorEN.colorId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ColorEN.colorCode) == false && (0, clsString_js_2.GetStrLen)(pobjgs_ColorEN.colorCode) > 200) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ColorEN.colorId) == false && undefined !== pobjgs_ColorEN.colorId && clsString_js_1.tzDataType.isString(pobjgs_ColorEN.colorId) === false) {
        ...
        if (null != pobjgs_ColorEN.userNo && undefined !== pobjgs_ColorEN.userNo && clsString_js_1.tzDataType.isNumber(pobjgs_ColorEN.userNo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ColorEN.colorCode) == false && undefined !== pobjgs_ColorEN.colorCode && clsString_js_1.tzDataType.isString(pobjgs_ColorEN.colorCode) === false) {
    ...
    */
    function gs_Color_CheckProperty4Update(pobjgs_ColorEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_ColorEN.colorId) === true) {
    ...
    */
    function gs_Color_GetCombineCondition(objgs_Color_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_Color_Cond.dicFldComparisonOp, clsgs_ColorEN_js_1.clsgs_ColorEN.con_ColorId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ColorEN_js_1.clsgs_ColorEN.con_ColorId, objgs_Color_Cond.colorId, strComparisonOp_ColorId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Color_Cond.dicFldComparisonOp, clsgs_ColorEN_js_1.clsgs_ColorEN.con_UserNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_ColorEN_js_1.clsgs_ColorEN.con_UserNo, objgs_Color_Cond.userNo, strComparisonOp_UserNo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_Color_Cond.dicFldComparisonOp, clsgs_ColorEN_js_1.clsgs_ColorEN.con_ColorCode) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_ColorEN_js_1.clsgs_ColorEN.con_ColorCode, objgs_Color_Cond.colorCode, strComparisonOp_ColorCode);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_Color_GetUniCondStr_ColorId(objgs_ColorEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ColorId = '{0}'", objgs_ColorEN.colorId);
        return strWhereCond;
    }
