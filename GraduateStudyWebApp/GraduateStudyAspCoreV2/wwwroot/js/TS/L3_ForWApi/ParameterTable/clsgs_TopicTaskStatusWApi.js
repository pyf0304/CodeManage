...
(function (factory) {
    ...
    **/
    async function gs_TopicTaskStatus_GetObjByStatusIdAsync(strStatusId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strStatusId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetObjByStatusIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strStatusId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetObjByStatusIdAsync)", strStatusId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_TopicTaskStatus_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_TopicTaskStatus_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_TopicTaskStatus_GetObjByStatusId_Cache(strStatusId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strStatusId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetObjByStatusId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strStatusId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetObjByStatusId_Cache)", strStatusId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_TopicTaskStatus_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_TopicTaskStatus_Const = await gs_TopicTaskStatus_GetObjByStatusIdAsync(strStatusId);
                    if (objgs_TopicTaskStatus_Const != null) {
                        gs_TopicTaskStatus_ReFreshThisCache();
                        return objgs_TopicTaskStatus_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_TopicTaskStatus_GetObjByStatusId_localStorage(strStatusId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strStatusId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetObjByStatusId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strStatusId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetObjByStatusId_localStorage)", strStatusId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN._CurrTabName, strStatusId);
        if (strKey == "") {
    ...
    */
    async function gs_TopicTaskStatus_GetNameByStatusId_Cache(strStatusId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strStatusId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strStatusId]不能为空！(In clsgs_TopicTaskStatusWApi.GetNameByStatusId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strStatusId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strStatusId]的长度:[{0}]不正确！(clsgs_TopicTaskStatusWApi.GetNameByStatusId_Cache)", strStatusId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_TopicTaskStatusObjLst_Cache = await gs_TopicTaskStatus_GetObjLst_Cache();
    ...
    */
    async function gs_TopicTaskStatus_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_TopicTaskStatus == null)
            return "";
        if (objgs_TopicTaskStatus.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_TopicTaskStatus_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrgs_TopicTaskStatus = await gs_TopicTaskStatus_GetObjLst_Cache();
        if (arrgs_TopicTaskStatus == null)
            return [];
        let arrgs_TopicTaskStatus_Sel = arrgs_TopicTaskStatus;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_TopicTaskStatus_Sel = arrgs_TopicTaskStatus_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_TopicTaskStatus_Sel = arrgs_TopicTaskStatus_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_TopicTaskStatus_Sel = arrgs_TopicTaskStatus_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_TopicTaskStatus_Sel = arrgs_TopicTaskStatus_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_TopicTaskStatus_Sel.length == 0)
            return [];
        return arrgs_TopicTaskStatus_Sel.map(x => x.statusId);
    }
    exports.gs_TopicTaskStatus_funcKey = gs_TopicTaskStatus_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_TopicTaskStatus_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_TopicTaskStatusExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_TopicTaskStatusExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TopicTaskStatusExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_TopicTaskStatus_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TopicTaskStatusExObjLst.length);
            console.log(strInfo);
            return arrgs_TopicTaskStatusExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_TopicTaskStatus_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_TopicTaskStatus_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_TopicTaskStatusExObjLst.length);
            console.log(strInfo);
            return arrgs_TopicTaskStatusExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_TopicTaskStatus_Sel = arrgs_TopicTaskStatus_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_TopicTaskStatus_DelRecordAsync(strStatusId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strStatusId);
        try {
    ...
    **/
    async function gs_TopicTaskStatus_UpdateRecordAsync(objgs_TopicTaskStatusEN) {
        ...
        if (objgs_TopicTaskStatusEN.sf_UpdFldSetStr === undefined || objgs_TopicTaskStatusEN.sf_UpdFldSetStr === null || objgs_TopicTaskStatusEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_TopicTaskStatusEN.statusId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_TopicTaskStatus_Controller, strAction);
        try {
    ...
    */
    async function gs_TopicTaskStatus_IsExistRecord_Cache(objgs_TopicTaskStatus_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_TopicTaskStatus_Cond), exports.gs_TopicTaskStatus_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_TopicTaskStatus_IsExist_Cache(strStatusId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strStatusId, exports.gs_TopicTaskStatus_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function gs_TopicTaskStatus_BindDdl_StatusIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_StatusIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_TopicTaskStatus_CheckPropertyNew(pobjgs_TopicTaskStatusEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.statusId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TopicTaskStatusEN.statusId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.statusName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TopicTaskStatusEN.statusName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TopicTaskStatusEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TopicTaskStatusEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_TopicTaskStatusEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.statusId) == false && undefined !== pobjgs_TopicTaskStatusEN.statusId && clsString_js_1.tzDataType.isString(pobjgs_TopicTaskStatusEN.statusId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.statusName) == false && undefined !== pobjgs_TopicTaskStatusEN.statusName && clsString_js_1.tzDataType.isString(pobjgs_TopicTaskStatusEN.statusName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.updUser) == false && undefined !== pobjgs_TopicTaskStatusEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_TopicTaskStatusEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.updDate) == false && undefined !== pobjgs_TopicTaskStatusEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_TopicTaskStatusEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.memo) == false && undefined !== pobjgs_TopicTaskStatusEN.memo && clsString_js_1.tzDataType.isString(pobjgs_TopicTaskStatusEN.memo) === false) {
    ...
    */
    function gs_TopicTaskStatus_CheckProperty4Update(pobjgs_TopicTaskStatusEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_TopicTaskStatusEN.statusId) === true) {
    ...
    */
    function gs_TopicTaskStatus_GetCombineCondition(objgs_TopicTaskStatus_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_TopicTaskStatus_Cond.dicFldComparisonOp, clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_StatusId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_StatusId, objgs_TopicTaskStatus_Cond.statusId, strComparisonOp_StatusId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicTaskStatus_Cond.dicFldComparisonOp, clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_StatusName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_StatusName, objgs_TopicTaskStatus_Cond.statusName, strComparisonOp_StatusName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicTaskStatus_Cond.dicFldComparisonOp, clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_UpdUser, objgs_TopicTaskStatus_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicTaskStatus_Cond.dicFldComparisonOp, clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_UpdDate, objgs_TopicTaskStatus_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_TopicTaskStatus_Cond.dicFldComparisonOp, clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_TopicTaskStatusEN_js_1.clsgs_TopicTaskStatusEN.con_Memo, objgs_TopicTaskStatus_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
