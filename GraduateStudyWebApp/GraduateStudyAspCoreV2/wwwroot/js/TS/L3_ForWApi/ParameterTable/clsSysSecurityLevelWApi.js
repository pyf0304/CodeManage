...
(function (factory) {
    ...
    **/
    async function SysSecurityLevel_GetObjByLevelIdAsync(strLevelId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLevelId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetObjByLevelIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLevelId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetObjByLevelIdAsync)", strLevelId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysSecurityLevel_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysSecurityLevel_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysSecurityLevel_GetObjByLevelId_Cache(strLevelId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLevelId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetObjByLevelId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLevelId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetObjByLevelId_Cache)", strLevelId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrSysSecurityLevel_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objSysSecurityLevel_Const = await SysSecurityLevel_GetObjByLevelIdAsync(strLevelId);
                    if (objSysSecurityLevel_Const != null) {
                        SysSecurityLevel_ReFreshThisCache();
                        return objSysSecurityLevel_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function SysSecurityLevel_GetObjByLevelId_localStorage(strLevelId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLevelId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetObjByLevelId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLevelId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetObjByLevelId_localStorage)", strLevelId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN._CurrTabName, strLevelId);
        if (strKey == "") {
    ...
    */
    async function SysSecurityLevel_GetNameByLevelId_Cache(strLevelId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strLevelId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strLevelId]不能为空！(In clsSysSecurityLevelWApi.GetNameByLevelId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strLevelId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strLevelId]的长度:[{0}]不正确！(clsSysSecurityLevelWApi.GetNameByLevelId_Cache)", strLevelId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrSysSecurityLevelObjLst_Cache = await SysSecurityLevel_GetObjLst_Cache();
    ...
    */
    async function SysSecurityLevel_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objSysSecurityLevel == null)
            return "";
        if (objSysSecurityLevel.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function SysSecurityLevel_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrSysSecurityLevel = await SysSecurityLevel_GetObjLst_Cache();
        if (arrSysSecurityLevel == null)
            return [];
        let arrSysSecurityLevel_Sel = arrSysSecurityLevel;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrSysSecurityLevel_Sel = arrSysSecurityLevel_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrSysSecurityLevel_Sel = arrSysSecurityLevel_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrSysSecurityLevel_Sel = arrSysSecurityLevel_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrSysSecurityLevel_Sel = arrSysSecurityLevel_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrSysSecurityLevel_Sel.length == 0)
            return [];
        return arrSysSecurityLevel_Sel.map(x => x.levelId);
    }
    exports.SysSecurityLevel_funcKey = SysSecurityLevel_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function SysSecurityLevel_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysSecurityLevelExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrSysSecurityLevelExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSecurityLevelExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysSecurityLevel_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSecurityLevelExObjLst.length);
            console.log(strInfo);
            return arrSysSecurityLevelExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysSecurityLevel_ConstructorName, strThisFuncName);
    ...
    **/
    async function SysSecurityLevel_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysSecurityLevelExObjLst.length);
            console.log(strInfo);
            return arrSysSecurityLevelExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrSysSecurityLevel_Sel = arrSysSecurityLevel_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function SysSecurityLevel_DelRecordAsync(strLevelId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strLevelId);
        try {
    ...
    **/
    async function SysSecurityLevel_UpdateRecordAsync(objSysSecurityLevelEN) {
        ...
        if (objSysSecurityLevelEN.sf_UpdFldSetStr === undefined || objSysSecurityLevelEN.sf_UpdFldSetStr === null || objSysSecurityLevelEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysSecurityLevelEN.levelId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysSecurityLevel_Controller, strAction);
        try {
    ...
    */
    async function SysSecurityLevel_IsExistRecord_Cache(objSysSecurityLevel_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysSecurityLevel_Cond), exports.sysSecurityLevel_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysSecurityLevel_IsExist_Cache(strLevelId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strLevelId, exports.sysSecurityLevel_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function SysSecurityLevel_BindDdl_LevelIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_LevelIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function SysSecurityLevel_CheckPropertyNew(pobjSysSecurityLevelEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.levelId) == false && (0, clsString_js_2.GetStrLen)(pobjSysSecurityLevelEN.levelId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.levelName) == false && (0, clsString_js_2.GetStrLen)(pobjSysSecurityLevelEN.levelName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjSysSecurityLevelEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.levelId) == false && undefined !== pobjSysSecurityLevelEN.levelId && clsString_js_1.tzDataType.isString(pobjSysSecurityLevelEN.levelId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.levelName) == false && undefined !== pobjSysSecurityLevelEN.levelName && clsString_js_1.tzDataType.isString(pobjSysSecurityLevelEN.levelName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.memo) == false && undefined !== pobjSysSecurityLevelEN.memo && clsString_js_1.tzDataType.isString(pobjSysSecurityLevelEN.memo) === false) {
    ...
    */
    function SysSecurityLevel_CheckProperty4Update(pobjSysSecurityLevelEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysSecurityLevelEN.levelId) === true
    ...
    */
    function SysSecurityLevel_GetCombineCondition(objSysSecurityLevel_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysSecurityLevel_Cond.dicFldComparisonOp, clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.con_LevelId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.con_LevelId, objSysSecurityLevel_Cond.levelId, strComparisonOp_LevelId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSecurityLevel_Cond.dicFldComparisonOp, clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.con_LevelName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.con_LevelName, objSysSecurityLevel_Cond.levelName, strComparisonOp_LevelName);
        }
        if (Object.prototype.hasOwnProperty.call(objSysSecurityLevel_Cond.dicFldComparisonOp, clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysSecurityLevelEN_js_1.clsSysSecurityLevelEN.con_Memo, objSysSecurityLevel_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function SysSecurityLevel_GetUniCondStr_LevelId(objSysSecurityLevelEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and LevelId = '{0}'", objSysSecurityLevelEN.levelId);
        return strWhereCond;
    }
