...
(function (factory) {
    ...
    **/
    async function SysScoreType_GetObjByScoreTypeIdAsync(strScoreTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strScoreTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strScoreTypeId]不能为空！(In clsSysScoreTypeWApi.GetObjByScoreTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strScoreTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strScoreTypeId]的长度:[{0}]不正确！(clsSysScoreTypeWApi.GetObjByScoreTypeIdAsync)", strScoreTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysScoreType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysScoreType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysScoreType_GetObjByScoreTypeId_Cache(strScoreTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strScoreTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strScoreTypeId]不能为空！(In clsSysScoreTypeWApi.GetObjByScoreTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strScoreTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strScoreTypeId]的长度:[{0}]不正确！(clsSysScoreTypeWApi.GetObjByScoreTypeId_Cache)", strScoreTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function SysScoreType_GetObjByScoreTypeId_localStorage(strScoreTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strScoreTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strScoreTypeId]不能为空！(In clsSysScoreTypeWApi.GetObjByScoreTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strScoreTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strScoreTypeId]的长度:[{0}]不正确！(clsSysScoreTypeWApi.GetObjByScoreTypeId_localStorage)", strScoreTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN._CurrTabName, strScoreTypeId);
        if (strKey == "") {
    ...
    */
    async function SysScoreType_GetNameByScoreTypeId_Cache(strScoreTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strScoreTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strScoreTypeId]不能为空！(In clsSysScoreTypeWApi.GetNameByScoreTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strScoreTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strScoreTypeId]的长度:[{0}]不正确！(clsSysScoreTypeWApi.GetNameByScoreTypeId_Cache)", strScoreTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrSysScoreTypeObjLst_Cache = await SysScoreType_GetObjLst_Cache();
    ...
    */
    async function SysScoreType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objSysScoreType == null)
            return "";
        if (objSysScoreType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function SysScoreType_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.SysScoreType_funcKey = SysScoreType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function SysScoreType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysScoreTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrSysScoreTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysScoreTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysScoreType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysScoreTypeExObjLst.length);
            console.log(strInfo);
            return arrSysScoreTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysScoreType_ConstructorName, strThisFuncName);
    ...
    **/
    async function SysScoreType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysScoreTypeExObjLst.length);
            console.log(strInfo);
            return arrSysScoreTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function SysScoreType_DelRecordAsync(strScoreTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strScoreTypeId);
        try {
    ...
    **/
    async function SysScoreType_UpdateRecordAsync(objSysScoreTypeEN) {
        ...
        if (objSysScoreTypeEN.sf_UpdFldSetStr === undefined || objSysScoreTypeEN.sf_UpdFldSetStr === null || objSysScoreTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysScoreTypeEN.scoreTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysScoreType_Controller, strAction);
        try {
    ...
    */
    async function SysScoreType_IsExistRecord_Cache(objSysScoreType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysScoreType_Cond), exports.sysScoreType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysScoreType_IsExist_Cache(strScoreTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strScoreTypeId, exports.sysScoreType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function SysScoreType_BindDdl_ScoreTypeIdInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_ScoreTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function SysScoreType_CheckPropertyNew(pobjSysScoreTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.scoreTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjSysScoreTypeEN.scoreTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.scoreTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjSysScoreTypeEN.scoreTypeName) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.onlyId) == false && (0, clsString_js_2.GetStrLen)(pobjSysScoreTypeEN.onlyId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjSysScoreTypeEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjSysScoreTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjSysScoreTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.scoreTypeId) == false && undefined !== pobjSysScoreTypeEN.scoreTypeId && clsString_js_1.tzDataType.isString(pobjSysScoreTypeEN.scoreTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.scoreTypeName) == false && undefined !== pobjSysScoreTypeEN.scoreTypeName && clsString_js_1.tzDataType.isString(pobjSysScoreTypeEN.scoreTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.onlyId) == false && undefined !== pobjSysScoreTypeEN.onlyId && clsString_js_1.tzDataType.isString(pobjSysScoreTypeEN.onlyId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.updUser) == false && undefined !== pobjSysScoreTypeEN.updUser && clsString_js_1.tzDataType.isString(pobjSysScoreTypeEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.updDate) == false && undefined !== pobjSysScoreTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjSysScoreTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.memo) == false && undefined !== pobjSysScoreTypeEN.memo && clsString_js_1.tzDataType.isString(pobjSysScoreTypeEN.memo) === false) {
    ...
    */
    function SysScoreType_CheckProperty4Update(pobjSysScoreTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysScoreTypeEN.scoreTypeId) === true
    ...
    */
    function SysScoreType_GetCombineCondition(objSysScoreType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysScoreType_Cond.dicFldComparisonOp, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_ScoreTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_ScoreTypeId, objSysScoreType_Cond.scoreTypeId, strComparisonOp_ScoreTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreType_Cond.dicFldComparisonOp, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_ScoreTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_ScoreTypeName, objSysScoreType_Cond.scoreTypeName, strComparisonOp_ScoreTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreType_Cond.dicFldComparisonOp, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_OnlyId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_OnlyId, objSysScoreType_Cond.onlyId, strComparisonOp_OnlyId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreType_Cond.dicFldComparisonOp, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_UpdUser, objSysScoreType_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreType_Cond.dicFldComparisonOp, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_UpdDate, objSysScoreType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objSysScoreType_Cond.dicFldComparisonOp, clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysScoreTypeEN_js_1.clsSysScoreTypeEN.con_Memo, objSysScoreType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
