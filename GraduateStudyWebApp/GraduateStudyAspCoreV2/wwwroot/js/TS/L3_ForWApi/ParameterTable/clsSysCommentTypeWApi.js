...
(function (factory) {
    ...
    **/
    async function SysCommentType_GetObjByCommentTypeIdAsync(strCommentTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCommentTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetObjByCommentTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetObjByCommentTypeIdAsync)", strCommentTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.sysCommentType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.sysCommentType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function SysCommentType_GetObjByCommentTypeId_Cache(strCommentTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCommentTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetObjByCommentTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetObjByCommentTypeId_Cache)", strCommentTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrSysCommentType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objSysCommentType_Const = await SysCommentType_GetObjByCommentTypeIdAsync(strCommentTypeId);
                    if (objSysCommentType_Const != null) {
                        SysCommentType_ReFreshThisCache();
                        return objSysCommentType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function SysCommentType_GetObjByCommentTypeId_localStorage(strCommentTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCommentTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetObjByCommentTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetObjByCommentTypeId_localStorage)", strCommentTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN._CurrTabName, strCommentTypeId);
        if (strKey == "") {
    ...
    */
    async function SysCommentType_GetNameByCommentTypeId_Cache(strCommentTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCommentTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCommentTypeId]不能为空！(In clsSysCommentTypeWApi.GetNameByCommentTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCommentTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCommentTypeId]的长度:[{0}]不正确！(clsSysCommentTypeWApi.GetNameByCommentTypeId_Cache)", strCommentTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrSysCommentTypeObjLst_Cache = await SysCommentType_GetObjLst_Cache();
    ...
    */
    async function SysCommentType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objSysCommentType == null)
            return "";
        if (objSysCommentType.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTypeName:
                    return (a, b) => {
                        if (a.commentTypeName == null)
                            return -1;
                        if (b.commentTypeName == null)
                            return 1;
                        return a.commentTypeName.localeCompare(b.commentTypeName);
                    };
                case clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTable:
                    return (a, b) => {
                        if (a.commentTable == null)
                            return -1;
                        if (b.commentTable == null)
                            return 1;
                        return a.commentTable.localeCompare(b.commentTable);
                    };
                case clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTableId:
                    return (a, b) => {
                        if (a.commentTableId == null)
                            return -1;
                        if (b.commentTableId == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function SysCommentType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrSysCommentType = await SysCommentType_GetObjLst_Cache();
        if (arrSysCommentType == null)
            return [];
        let arrSysCommentType_Sel = arrSysCommentType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrSysCommentType_Sel = arrSysCommentType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrSysCommentType_Sel = arrSysCommentType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrSysCommentType_Sel = arrSysCommentType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrSysCommentType_Sel = arrSysCommentType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrSysCommentType_Sel.length == 0)
            return [];
        return arrSysCommentType_Sel.map(x => x.commentTypeId);
    }
    exports.SysCommentType_funcKey = SysCommentType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function SysCommentType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrSysCommentTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrSysCommentTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysCommentTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function SysCommentType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysCommentTypeExObjLst.length);
            console.log(strInfo);
            return arrSysCommentTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.sysCommentType_ConstructorName, strThisFuncName);
    ...
    **/
    async function SysCommentType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrSysCommentTypeExObjLst.length);
            console.log(strInfo);
            return arrSysCommentTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrSysCommentType_Sel = arrSysCommentType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function SysCommentType_DelRecordAsync(strCommentTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strCommentTypeId);
        try {
    ...
    **/
    async function SysCommentType_UpdateRecordAsync(objSysCommentTypeEN) {
        ...
        if (objSysCommentTypeEN.sf_UpdFldSetStr === undefined || objSysCommentTypeEN.sf_UpdFldSetStr === null || objSysCommentTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objSysCommentTypeEN.commentTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.sysCommentType_Controller, strAction);
        try {
    ...
    */
    async function SysCommentType_IsExistRecord_Cache(objSysCommentType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objSysCommentType_Cond), exports.sysCommentType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function SysCommentType_IsExist_Cache(strCommentTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCommentTypeId, exports.sysCommentType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function SysCommentType_CheckPropertyNew(pobjSysCommentTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjSysCommentTypeEN.commentTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjSysCommentTypeEN.commentTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTable) == false && (0, clsString_js_2.GetStrLen)(pobjSysCommentTypeEN.commentTable) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTableId) == false && (0, clsString_js_2.GetStrLen)(pobjSysCommentTypeEN.commentTableId) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjSysCommentTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTypeId) == false && undefined !== pobjSysCommentTypeEN.commentTypeId && clsString_js_1.tzDataType.isString(pobjSysCommentTypeEN.commentTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTypeName) == false && undefined !== pobjSysCommentTypeEN.commentTypeName && clsString_js_1.tzDataType.isString(pobjSysCommentTypeEN.commentTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTable) == false && undefined !== pobjSysCommentTypeEN.commentTable && clsString_js_1.tzDataType.isString(pobjSysCommentTypeEN.commentTable) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTableId) == false && undefined !== pobjSysCommentTypeEN.commentTableId && clsString_js_1.tzDataType.isString(pobjSysCommentTypeEN.commentTableId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.memo) == false && undefined !== pobjSysCommentTypeEN.memo && clsString_js_1.tzDataType.isString(pobjSysCommentTypeEN.memo) === false) {
    ...
    */
    function SysCommentType_CheckProperty4Update(pobjSysCommentTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjSysCommentTypeEN.commentTypeId) === true) {
    ...
    */
    function SysCommentType_GetCombineCondition(objSysCommentType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objSysCommentType_Cond.dicFldComparisonOp, clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTypeId, objSysCommentType_Cond.commentTypeId, strComparisonOp_CommentTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCommentType_Cond.dicFldComparisonOp, clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTypeName, objSysCommentType_Cond.commentTypeName, strComparisonOp_CommentTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCommentType_Cond.dicFldComparisonOp, clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTable) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTable, objSysCommentType_Cond.commentTable, strComparisonOp_CommentTable);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCommentType_Cond.dicFldComparisonOp, clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTableId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_CommentTableId, objSysCommentType_Cond.commentTableId, strComparisonOp_CommentTableId);
        }
        if (Object.prototype.hasOwnProperty.call(objSysCommentType_Cond.dicFldComparisonOp, clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsSysCommentTypeEN_js_1.clsSysCommentTypeEN.con_Memo, objSysCommentType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
