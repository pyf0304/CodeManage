...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/BaseInfo/clsXzMajorDirectionEN.js", "../../L3_ForWApi/BaseInfo/clsvXzMajorDirectionWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function XzMajorDirection_func(strInFldName, strOutFldName, strInValue, strid_XzMajor_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzMajor_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzMajor_C]不能为空！(In func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_XzMajor_C]的长度:[{0}]不正确！", strid_XzMajor_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    */
    async function XzMajorDirection_funcKey(strInFldName, strInValue, strComparisonOp, strid_XzMajor_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzMajor_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzMajor_C]不能为空！(In funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor_C.length != 8) {
    ...
    **/
    async function XzMajorDirection_GetObjLst_ClientCache(strid_XzMajor) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.WhereFormat, strid_XzMajor);
        }
        else {
            strWhereCond = (0, clsString_js_1.Format)("id_XzMajor='{0}'", strid_XzMajor);
        }
        const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN._CurrTabName, strid_XzMajor);
    ...
    **/
    async function XzMajorDirection_GetObjLst_Cache(strid_XzMajor) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[id_XzMajor]不能为空！");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    function XzMajorDirection_ReFreshCache(strid_XzMajor) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorDirectionWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
    ...
    */
    async function XzMajorDirection_BindDdl_MajorDirectionIdInDiv_Cache(strDivName, strDdlName, strid_XzMajor) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzMajor]不能为空！(In BindDdl_MajorDirectionIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_MajorDirectionIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function XzMajorDirection_BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache(strDivName, strDdlName, strid_XzMajor) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzMajor]不能为空！(In BindDdl_MajorDirectionIdByid_XzMajorInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
        ...
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_MajorDirectionIdByid_XzMajorInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
