...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/BaseInfo/clsXzMajorEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/jsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function XzMajor_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsXzMajorEN_js_1.clsXzMajorEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzMajorEN_js_1.clsXzMajorEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    */
    async function XzMajor_BindDdl_id_XzMajorInDiv_Cache(strDivName, strDdlName) {
        ...
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzMajorInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function XzMajor_BindDdl_id_XzMajorByid_XzCollegeInDiv_Cache(strDivName, strDdlName, strid_XzCollege) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzCollege]不能为空！(In BindDdl_id_XzMajorByid_XzCollegeInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_1.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzMajorByid_XzCollegeInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
