...
(function (factory) {
    ...
    **/
    async function cc_CourseKnowledges_GetObjByCourseKnowledgeIdAsync(strCourseKnowledgeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseKnowledgeId]不能为空！(In clscc_CourseKnowledgesWApi.GetObjByCourseKnowledgeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.GetObjByCourseKnowledgeIdAsync)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.cc_CourseKnowledges_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.cc_CourseKnowledges_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function cc_CourseKnowledges_GetObjByCourseKnowledgeId_Cache(strCourseKnowledgeId, strCourseId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseKnowledgeId]不能为空！(In clscc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_Cache)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrcc_CourseKnowledges_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objcc_CourseKnowledges_Const = await cc_CourseKnowledges_GetObjByCourseKnowledgeIdAsync(strCourseKnowledgeId);
                    if (objcc_CourseKnowledges_Const != null) {
                        cc_CourseKnowledges_ReFreshThisCache(strCourseId);
                        return objcc_CourseKnowledges_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function cc_CourseKnowledges_GetObjByCourseKnowledgeId_localStorage(strCourseKnowledgeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseKnowledgeId]不能为空！(In clscc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_localStorage)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN._CurrTabName, strCourseKnowledgeId);
        if (strKey == "") {
    ...
    */
    async function cc_CourseKnowledges_GetNameByCourseKnowledgeId_Cache(strCourseKnowledgeId, strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseKnowledgeId]不能为空！(In clscc_CourseKnowledgesWApi.GetNameByCourseKnowledgeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.GetNameByCourseKnowledgeId_Cache)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrcc_CourseKnowledgesObjLst_Cache = await cc_CourseKnowledges_GetObjLst_Cache(strCourseId);
    ...
    */
    async function cc_CourseKnowledges_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId_C]不能为空！(In clscc_CourseKnowledgesWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.func)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objcc_CourseKnowledges == null)
            return "";
        if (objcc_CourseKnowledges.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function cc_CourseKnowledges_funcKey(strInFldName, strInValue, strComparisonOp, strCourseId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId_C]不能为空！(In clscc_CourseKnowledgesWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.funcKey)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseKnowledgeId) {
        ...
        const arrcc_CourseKnowledges = await cc_CourseKnowledges_GetObjLst_Cache(strCourseId_C);
        if (arrcc_CourseKnowledges == null)
            return [];
        let arrcc_CourseKnowledges_Sel = arrcc_CourseKnowledges;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrcc_CourseKnowledges_Sel = arrcc_CourseKnowledges_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrcc_CourseKnowledges_Sel = arrcc_CourseKnowledges_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrcc_CourseKnowledges_Sel = arrcc_CourseKnowledges_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrcc_CourseKnowledges_Sel = arrcc_CourseKnowledges_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrcc_CourseKnowledges_Sel.length == 0)
            return [];
        return arrcc_CourseKnowledges_Sel.map(x => x.courseKnowledgeId);
    }
    exports.cc_CourseKnowledges_funcKey = cc_CourseKnowledges_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function cc_CourseKnowledges_GetObjLst_ClientCache(strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.WhereFormat, strCourseId);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("CourseId='{0}'", strCourseId);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN._CurrTabName, strCourseId);
        if ((0, clsString_js_2.IsNullOrEmpty)(clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrcc_CourseKnowledgesExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrcc_CourseKnowledgesExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseKnowledgesExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function cc_CourseKnowledges_GetObjLst_localStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseKnowledgesExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseKnowledgesExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.cc_CourseKnowledges_ConstructorName, strThisFuncName);
    ...
    **/
    async function cc_CourseKnowledges_GetObjLst_sessionStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrcc_CourseKnowledgesExObjLst.length);
            console.log(strInfo);
            return arrcc_CourseKnowledgesExObjLst;
        }
        catch (e) {
    ...
    **/
    async function cc_CourseKnowledges_GetObjLst_Cache(strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[CourseId]不能为空！(in clscc_CourseKnowledgesWApi.cc_CourseKnowledges_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(in clscc_CourseKnowledgesWApi.cc_CourseKnowledges_GetObjLst_Cache() )", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrcc_CourseKnowledges_Sel = arrcc_CourseKnowledges_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function cc_CourseKnowledges_DelRecordAsync(strCourseKnowledgeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strCourseKnowledgeId);
        try {
    ...
    **/
    async function cc_CourseKnowledges_UpdateRecordAsync(objcc_CourseKnowledgesEN) {
        ...
        if (objcc_CourseKnowledgesEN.sf_UpdFldSetStr === undefined || objcc_CourseKnowledgesEN.sf_UpdFldSetStr === null || objcc_CourseKnowledgesEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objcc_CourseKnowledgesEN.courseKnowledgeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.cc_CourseKnowledges_Controller, strAction);
        try {
    ...
    */
    async function cc_CourseKnowledges_IsExistRecord_Cache(objcc_CourseKnowledges_Cond, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objcc_CourseKnowledges_Cond), exports.cc_CourseKnowledges_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function cc_CourseKnowledges_IsExist_Cache(strCourseKnowledgeId, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strCourseKnowledgeId, exports.cc_CourseKnowledges_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function cc_CourseKnowledges_ReFreshCache(strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId]不能为空！(In clscc_CourseKnowledgesWApi.clscc_CourseKnowledgesWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.clscc_CourseKnowledgesWApi.ReFreshCache)", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function cc_CourseKnowledges_BindDdl_CourseKnowledgeIdInDiv_Cache(strDivName, strDdlName, strCourseId) {
        const strThisFuncName = "BindDdl_CourseKnowledgeIdInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId]不能为空！(In clscc_CourseKnowledgesWApi.BindDdl_CourseKnowledgeIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(clscc_CourseKnowledgesWApi.BindDdl_CourseKnowledgeIdInDiv)", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_CourseKnowledgeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_CourseKnowledgeIdInDiv_Cache");
        let arrObjLst_Sel = await cc_CourseKnowledges_GetObjLst_Cache(strCourseId);
    ...
    exports.cc_CourseKnowledges_BindDdl_CourseKnowledgeIdInDiv_Cache = cc_CourseKnowledges_BindDdl_CourseKnowledgeIdInDiv_Cache;
    /**
    ...
    */
    function cc_CourseKnowledges_CheckPropertyNew(pobjcc_CourseKnowledgesEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeName) === true) {
            throw new Error("(errid:Watl000058)字段[知识点名称]不能为空(In 知识点)!(clscc_CourseKnowledgesBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseChapterId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.userId) === true) {
            throw new Error("(errid:Watl000058)字段[用户ID]不能为空(In 知识点)!(clscc_CourseKnowledgesBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseKnowledgeId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.courseKnowledgeId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeName) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.knowledgeName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeTitle) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.knowledgeTitle) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.courseId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.knowledgeTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseChapterId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.courseChapterId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.userId) > 18) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过18(In 知识点(cc_CourseKnowledges))!值:$(pobjcc_CourseKnowledgesEN.userId)(clscc_CourseKnowledgesBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.uploadDate) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.uploadDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseKnowledgeId) == false && undefined !== pobjcc_CourseKnowledgesEN.courseKnowledgeId && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.courseKnowledgeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeName) == false && undefined !== pobjcc_CourseKnowledgesEN.knowledgeName && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.knowledgeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeTitle) == false && undefined !== pobjcc_CourseKnowledgesEN.knowledgeTitle && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.knowledgeTitle) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeContent) == false && undefined !== pobjcc_CourseKnowledgesEN.knowledgeContent && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.knowledgeContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseId) == false && undefined !== pobjcc_CourseKnowledgesEN.courseId && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.courseId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.knowledgeTypeId) == false && undefined !== pobjcc_CourseKnowledgesEN.knowledgeTypeId && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.knowledgeTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseChapterId) == false && undefined !== pobjcc_CourseKnowledgesEN.courseChapterId && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.courseChapterId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.userId) == false && undefined !== pobjcc_CourseKnowledgesEN.userId && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.userId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.uploadDate) == false && undefined !== pobjcc_CourseKnowledgesEN.uploadDate && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.uploadDate) === false) {
        ...
        if (null != pobjcc_CourseKnowledgesEN.isShow && undefined !== pobjcc_CourseKnowledgesEN.isShow && clsString_js_1.tzDataType.isBoolean(pobjcc_CourseKnowledgesEN.isShow) === false) {
        ...
        if (null != pobjcc_CourseKnowledgesEN.isCast && undefined !== pobjcc_CourseKnowledgesEN.isCast && clsString_js_1.tzDataType.isBoolean(pobjcc_CourseKnowledgesEN.isCast) === false) {
        ...
        if (null != pobjcc_CourseKnowledgesEN.likeCount && undefined !== pobjcc_CourseKnowledgesEN.likeCount && clsString_js_1.tzDataType.isNumber(pobjcc_CourseKnowledgesEN.likeCount) === false) {
        ...
        if (null != pobjcc_CourseKnowledgesEN.orderNum && undefined !== pobjcc_CourseKnowledgesEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjcc_CourseKnowledgesEN.orderNum) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.updDate) == false && undefined !== pobjcc_CourseKnowledgesEN.updDate && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.updUser) == false && undefined !== pobjcc_CourseKnowledgesEN.updUser && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.memo) == false && undefined !== pobjcc_CourseKnowledgesEN.memo && clsString_js_1.tzDataType.isString(pobjcc_CourseKnowledgesEN.memo) === false) {
    ...
    */
    function cc_CourseKnowledges_CheckProperty4Update(pobjcc_CourseKnowledgesEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.userId) > 18) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过18(In 知识点(cc_CourseKnowledges))!值:$(pobjcc_CourseKnowledgesEN.userId)(clscc_CourseKnowledgesBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.uploadDate) == false && (0, clsString_js_2.GetStrLen)(pobjcc_CourseKnowledgesEN.uploadDate) > 20) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjcc_CourseKnowledgesEN.courseKnowledgeId) === true
    ...
    */
    function cc_CourseKnowledges_GetCombineCondition(objcc_CourseKnowledges_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseKnowledgeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseKnowledgeId, objcc_CourseKnowledges_Cond.courseKnowledgeId, strComparisonOp_CourseKnowledgeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_KnowledgeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_KnowledgeName, objcc_CourseKnowledges_Cond.knowledgeName, strComparisonOp_KnowledgeName);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_KnowledgeTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_KnowledgeTitle, objcc_CourseKnowledges_Cond.knowledgeTitle, strComparisonOp_KnowledgeTitle);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseId, objcc_CourseKnowledges_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_KnowledgeTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_KnowledgeTypeId, objcc_CourseKnowledges_Cond.knowledgeTypeId, strComparisonOp_KnowledgeTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseChapterId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_CourseChapterId, objcc_CourseKnowledges_Cond.courseChapterId, strComparisonOp_CourseChapterId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UserId, objcc_CourseKnowledges_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UploadDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UploadDate, objcc_CourseKnowledges_Cond.uploadDate, strComparisonOp_UploadDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_IsShow) == true) {
            if (objcc_CourseKnowledges_Cond.isShow == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_IsShow);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_IsShow);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_IsCast) == true) {
            if (objcc_CourseKnowledges_Cond.isCast == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_IsCast);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_IsCast);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_LikeCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_LikeCount, objcc_CourseKnowledges_Cond.likeCount, strComparisonOp_LikeCount);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_OrderNum, objcc_CourseKnowledges_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UpdDate, objcc_CourseKnowledges_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_UpdUser, objcc_CourseKnowledges_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objcc_CourseKnowledges_Cond.dicFldComparisonOp, clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clscc_CourseKnowledgesEN_js_1.clscc_CourseKnowledgesEN.con_Memo, objcc_CourseKnowledges_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function cc_CourseKnowledges_GetUniCondStr_CourseId_KnowledgeName(objcc_CourseKnowledgesEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and CourseId = '{0}'", objcc_CourseKnowledgesEN.courseId);
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeName = '{0}'", objcc_CourseKnowledgesEN.knowledgeName);
        return strWhereCond;
    }
    ...
    **/
    function cc_CourseKnowledges_GetUniCondStr4Update_CourseId_KnowledgeName(objcc_CourseKnowledgesEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and CourseKnowledgeId <> '{0}'", objcc_CourseKnowledgesEN.courseKnowledgeId);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseId = '{0}'", objcc_CourseKnowledgesEN.courseId);
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeName = '{0}'", objcc_CourseKnowledgesEN.knowledgeName);
        return strWhereCond;
    }
