...
(function (factory) {
    ...
    **/
    async function gs_KnowledgesGraphType_GetObjByGraphTypeIdAsync(strGraphTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strGraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strGraphTypeId]不能为空！(In clsgs_KnowledgesGraphTypeWApi.GetObjByGraphTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strGraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strGraphTypeId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphTypeWApi.GetObjByGraphTypeIdAsync)", strGraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_KnowledgesGraphType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_KnowledgesGraphType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_KnowledgesGraphType_GetObjByGraphTypeId_Cache(strGraphTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strGraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strGraphTypeId]不能为空！(In clsgs_KnowledgesGraphTypeWApi.GetObjByGraphTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strGraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strGraphTypeId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphTypeWApi.GetObjByGraphTypeId_Cache)", strGraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_KnowledgesGraphType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_KnowledgesGraphType_Const = await gs_KnowledgesGraphType_GetObjByGraphTypeIdAsync(strGraphTypeId);
                    if (objgs_KnowledgesGraphType_Const != null) {
                        gs_KnowledgesGraphType_ReFreshThisCache();
                        return objgs_KnowledgesGraphType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_KnowledgesGraphType_GetObjByGraphTypeId_localStorage(strGraphTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strGraphTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strGraphTypeId]不能为空！(In clsgs_KnowledgesGraphTypeWApi.GetObjByGraphTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strGraphTypeId.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strGraphTypeId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphTypeWApi.GetObjByGraphTypeId_localStorage)", strGraphTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN._CurrTabName, strGraphTypeId);
        if (strKey == "") {
    ...
    */
    async function gs_KnowledgesGraphType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_KnowledgesGraphType == null)
            return "";
        if (objgs_KnowledgesGraphType.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeName:
                    return (a, b) => {
                        if (a.graphTypeName == null)
                            return -1;
                        if (b.graphTypeName == null)
                            return 1;
                        return a.graphTypeName.localeCompare(b.graphTypeName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_KnowledgesGraphType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrgs_KnowledgesGraphType = await gs_KnowledgesGraphType_GetObjLst_Cache();
        if (arrgs_KnowledgesGraphType == null)
            return [];
        let arrgs_KnowledgesGraphType_Sel = arrgs_KnowledgesGraphType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_KnowledgesGraphType_Sel = arrgs_KnowledgesGraphType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_KnowledgesGraphType_Sel = arrgs_KnowledgesGraphType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_KnowledgesGraphType_Sel = arrgs_KnowledgesGraphType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_KnowledgesGraphType_Sel = arrgs_KnowledgesGraphType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_KnowledgesGraphType_Sel.length == 0)
            return [];
        return arrgs_KnowledgesGraphType_Sel.map(x => x.graphTypeId);
    }
    exports.gs_KnowledgesGraphType_funcKey = gs_KnowledgesGraphType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_KnowledgesGraphType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_KnowledgesGraphTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_KnowledgesGraphTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesGraphTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_KnowledgesGraphType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesGraphTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesGraphTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_KnowledgesGraphType_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_KnowledgesGraphType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesGraphTypeExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesGraphTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_KnowledgesGraphType_Sel = arrgs_KnowledgesGraphType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_KnowledgesGraphType_DelRecordAsync(strGraphTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strGraphTypeId);
        try {
    ...
    **/
    async function gs_KnowledgesGraphType_UpdateRecordAsync(objgs_KnowledgesGraphTypeEN) {
        ...
        if (objgs_KnowledgesGraphTypeEN.sf_UpdFldSetStr === undefined || objgs_KnowledgesGraphTypeEN.sf_UpdFldSetStr === null || objgs_KnowledgesGraphTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_KnowledgesGraphTypeEN.graphTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_KnowledgesGraphType_Controller, strAction);
        try {
    ...
    */
    async function gs_KnowledgesGraphType_IsExistRecord_Cache(objgs_KnowledgesGraphType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_KnowledgesGraphType_Cond), exports.gs_KnowledgesGraphType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_KnowledgesGraphType_IsExist_Cache(strGraphTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strGraphTypeId, exports.gs_KnowledgesGraphType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function gs_KnowledgesGraphType_BindDdl_GraphTypeIdInDiv_Cache(strDivName, strDdlName) {
        const strThisFuncName = "BindDdl_GraphTypeIdInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_GraphTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_GraphTypeIdInDiv_Cache");
        const arrObjLst_Sel = await gs_KnowledgesGraphType_GetObjLst_Cache();
        if (arrObjLst_Sel == null)
            return;
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeId, clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeName, "知识点图谱类型");
    }
    exports.gs_KnowledgesGraphType_BindDdl_GraphTypeIdInDiv_Cache = gs_KnowledgesGraphType_BindDdl_GraphTypeIdInDiv_Cache;
    /**
    ...
    */
    function gs_KnowledgesGraphType_CheckPropertyNew(pobjgs_KnowledgesGraphTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.graphTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphTypeEN.graphTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.graphTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphTypeEN.graphTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.graphTypeId) == false && undefined !== pobjgs_KnowledgesGraphTypeEN.graphTypeId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphTypeEN.graphTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.graphTypeName) == false && undefined !== pobjgs_KnowledgesGraphTypeEN.graphTypeName && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphTypeEN.graphTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.memo) == false && undefined !== pobjgs_KnowledgesGraphTypeEN.memo && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphTypeEN.memo) === false) {
    ...
    */
    function gs_KnowledgesGraphType_CheckProperty4Update(pobjgs_KnowledgesGraphTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphTypeEN.graphTypeId) === true) {
    ...
    */
    function gs_KnowledgesGraphType_GetCombineCondition(objgs_KnowledgesGraphType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraphType_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeId, objgs_KnowledgesGraphType_Cond.graphTypeId, strComparisonOp_GraphTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraphType_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_GraphTypeName, objgs_KnowledgesGraphType_Cond.graphTypeName, strComparisonOp_GraphTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraphType_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphTypeEN_js_1.clsgs_KnowledgesGraphTypeEN.con_Memo, objgs_KnowledgesGraphType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_KnowledgesGraphType_GetUniCondStr_GraphTypeId(objgs_KnowledgesGraphTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and GraphTypeId = '{0}'", objgs_KnowledgesGraphTypeEN.graphTypeId);
        return strWhereCond;
    }
