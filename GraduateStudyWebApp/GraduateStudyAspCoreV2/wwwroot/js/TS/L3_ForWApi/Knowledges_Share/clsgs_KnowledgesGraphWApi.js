...
(function (factory) {
    ...
    **/
    async function gs_KnowledgesGraph_GetObjByKnowledgeGraphIdAsync(strKnowledgeGraphId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strKnowledgeGraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strKnowledgeGraphId]不能为空！(In clsgs_KnowledgesGraphWApi.GetObjByKnowledgeGraphIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strKnowledgeGraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strKnowledgeGraphId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.GetObjByKnowledgeGraphIdAsync)", strKnowledgeGraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_KnowledgesGraph_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_KnowledgesGraph_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_KnowledgesGraph_GetObjByKnowledgeGraphId_Cache(strKnowledgeGraphId, strCourseId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strKnowledgeGraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strKnowledgeGraphId]不能为空！(In clsgs_KnowledgesGraphWApi.GetObjByKnowledgeGraphId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strKnowledgeGraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strKnowledgeGraphId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.GetObjByKnowledgeGraphId_Cache)", strKnowledgeGraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_KnowledgesGraph_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_KnowledgesGraph_Const = await gs_KnowledgesGraph_GetObjByKnowledgeGraphIdAsync(strKnowledgeGraphId);
                    if (objgs_KnowledgesGraph_Const != null) {
                        gs_KnowledgesGraph_ReFreshThisCache(strCourseId);
                        return objgs_KnowledgesGraph_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_KnowledgesGraph_GetObjByKnowledgeGraphId_localStorage(strKnowledgeGraphId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strKnowledgeGraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strKnowledgeGraphId]不能为空！(In clsgs_KnowledgesGraphWApi.GetObjByKnowledgeGraphId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strKnowledgeGraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strKnowledgeGraphId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.GetObjByKnowledgeGraphId_localStorage)", strKnowledgeGraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN._CurrTabName, strKnowledgeGraphId);
        if (strKey == "") {
    ...
    */
    async function gs_KnowledgesGraph_GetNameByKnowledgeGraphId_Cache(strKnowledgeGraphId, strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strKnowledgeGraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strKnowledgeGraphId]不能为空！(In clsgs_KnowledgesGraphWApi.GetNameByKnowledgeGraphId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strKnowledgeGraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strKnowledgeGraphId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.GetNameByKnowledgeGraphId_Cache)", strKnowledgeGraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_KnowledgesGraphObjLst_Cache = await gs_KnowledgesGraph_GetObjLst_Cache(strCourseId);
    ...
    */
    async function gs_KnowledgesGraph_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId_C]不能为空！(In clsgs_KnowledgesGraphWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.func)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_KnowledgesGraph == null)
            return "";
        if (objgs_KnowledgesGraph.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_KnowledgeGraphName:
                    return (a, b) => {
                        if (a.knowledgeGraphName == null)
                            return -1;
                        if (b.knowledgeGraphName == null)
                            return 1;
                        return a.knowledgeGraphName.localeCompare(b.knowledgeGraphName);
                    };
                ...
                case clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_GraphTypeId:
                    return (a, b) => {
                        if (a.graphTypeId == null)
                            return -1;
                        if (b.graphTypeId == null)
                            return 1;
                ...
                case clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_SubmitTime:
                    return (a, b) => {
                        if (a.submitTime == null)
                            return -1;
                        if (b.submitTime == null)
                            return 1;
                        return a.submitTime.localeCompare(b.submitTime);
                    };
                case clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_TakeUpTime:
                    return (a, b) => {
                        if (a.takeUpTime == null)
                            return -1;
                        if (b.takeUpTime == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_KnowledgesGraph_funcKey(strInFldName, strInValue, strComparisonOp, strCourseId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId_C]不能为空！(In clsgs_KnowledgesGraphWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.funcKey)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_KnowledgeGraphId) {
        ...
        const arrgs_KnowledgesGraph = await gs_KnowledgesGraph_GetObjLst_Cache(strCourseId_C);
        if (arrgs_KnowledgesGraph == null)
            return [];
        let arrgs_KnowledgesGraph_Sel = arrgs_KnowledgesGraph;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_KnowledgesGraph_Sel = arrgs_KnowledgesGraph_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_KnowledgesGraph_Sel = arrgs_KnowledgesGraph_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_KnowledgesGraph_Sel = arrgs_KnowledgesGraph_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_KnowledgesGraph_Sel = arrgs_KnowledgesGraph_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_KnowledgesGraph_Sel.length == 0)
            return [];
        return arrgs_KnowledgesGraph_Sel.map(x => x.knowledgeGraphId);
    }
    exports.gs_KnowledgesGraph_funcKey = gs_KnowledgesGraph_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_KnowledgesGraph_GetObjLst_ClientCache(strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.WhereFormat, strCourseId);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("CourseId='{0}'", strCourseId);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN._CurrTabName, strCourseId);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_KnowledgesGraphExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_KnowledgesGraphExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesGraphExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_KnowledgesGraph_GetObjLst_localStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesGraphExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesGraphExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_KnowledgesGraph_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_KnowledgesGraph_GetObjLst_sessionStorage(strCourseId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_KnowledgesGraphExObjLst.length);
            console.log(strInfo);
            return arrgs_KnowledgesGraphExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_KnowledgesGraph_GetObjLst_Cache(strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[CourseId]不能为空！(in clsgs_KnowledgesGraphWApi.gs_KnowledgesGraph_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(in clsgs_KnowledgesGraphWApi.gs_KnowledgesGraph_GetObjLst_Cache() )", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_KnowledgesGraph_Sel = arrgs_KnowledgesGraph_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_KnowledgesGraph_DelRecordAsync(strKnowledgeGraphId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strKnowledgeGraphId);
        try {
    ...
    **/
    async function gs_KnowledgesGraph_UpdateRecordAsync(objgs_KnowledgesGraphEN) {
        ...
        if (objgs_KnowledgesGraphEN.sf_UpdFldSetStr === undefined || objgs_KnowledgesGraphEN.sf_UpdFldSetStr === null || objgs_KnowledgesGraphEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_KnowledgesGraphEN.knowledgeGraphId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_KnowledgesGraph_Controller, strAction);
        try {
    ...
    */
    async function gs_KnowledgesGraph_IsExistRecord_Cache(objgs_KnowledgesGraph_Cond, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_KnowledgesGraph_Cond), exports.gs_KnowledgesGraph_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_KnowledgesGraph_IsExist_Cache(strKnowledgeGraphId, strCourseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strKnowledgeGraphId, exports.gs_KnowledgesGraph_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_KnowledgesGraph_ReFreshCache(strCourseId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId]不能为空！(In clsgs_KnowledgesGraphWApi.clsgs_KnowledgesGraphWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.clsgs_KnowledgesGraphWApi.ReFreshCache)", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_KnowledgesGraph_BindDdl_KnowledgeGraphIdInDiv_Cache(strDivName, strDdlName, strCourseId) {
        const strThisFuncName = "BindDdl_KnowledgeGraphIdInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strCourseId]不能为空！(In clsgs_KnowledgesGraphWApi.BindDdl_KnowledgeGraphIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(clsgs_KnowledgesGraphWApi.BindDdl_KnowledgeGraphIdInDiv)", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_KnowledgeGraphIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_KnowledgeGraphIdInDiv_Cache");
        let arrObjLst_Sel = await gs_KnowledgesGraph_GetObjLst_Cache(strCourseId);
    ...
    exports.gs_KnowledgesGraph_BindDdl_KnowledgeGraphIdInDiv_Cache = gs_KnowledgesGraph_BindDdl_KnowledgeGraphIdInDiv_Cache;
    /**
    ...
    */
    function gs_KnowledgesGraph_CheckPropertyNew(pobjgs_KnowledgesGraphEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.knowledgeGraphId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.knowledgeGraphId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.knowledgeGraphName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.knowledgeGraphName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.courseId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.courseId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.createUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.createUser) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.graphTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.graphTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.startTime) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.startTime) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.submitTime) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.submitTime) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.takeUpTime) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.takeUpTime) > 50) {
            throw new Error("(errid:Watl000059)字段[耗时(takeUpTime)]的长度不能超过50(In 知识点逻辑图(gs_KnowledgesGraph))!值:$(pobjgs_KnowledgesGraphEN.takeUpTime)(clsgs_KnowledgesGraphBL:CheckPropertyNew)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.knowledgeGraphId) == false && undefined !== pobjgs_KnowledgesGraphEN.knowledgeGraphId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.knowledgeGraphId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.knowledgeGraphName) == false && undefined !== pobjgs_KnowledgesGraphEN.knowledgeGraphName && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.knowledgeGraphName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.id_CurrEduCls) == false && undefined !== pobjgs_KnowledgesGraphEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.courseId) == false && undefined !== pobjgs_KnowledgesGraphEN.courseId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.courseId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.createUser) == false && undefined !== pobjgs_KnowledgesGraphEN.createUser && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.createUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.updDate) == false && undefined !== pobjgs_KnowledgesGraphEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.updUser) == false && undefined !== pobjgs_KnowledgesGraphEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.memo) == false && undefined !== pobjgs_KnowledgesGraphEN.memo && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.graphTypeId) == false && undefined !== pobjgs_KnowledgesGraphEN.graphTypeId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.graphTypeId) === false) {
        ...
        if (null != pobjgs_KnowledgesGraphEN.isDisplay && undefined !== pobjgs_KnowledgesGraphEN.isDisplay && clsString_js_1.tzDataType.isBoolean(pobjgs_KnowledgesGraphEN.isDisplay) === false) {
        ...
        if (null != pobjgs_KnowledgesGraphEN.isExtend && undefined !== pobjgs_KnowledgesGraphEN.isExtend && clsString_js_1.tzDataType.isBoolean(pobjgs_KnowledgesGraphEN.isExtend) === false) {
        ...
        if (null != pobjgs_KnowledgesGraphEN.isRecommend && undefined !== pobjgs_KnowledgesGraphEN.isRecommend && clsString_js_1.tzDataType.isBoolean(pobjgs_KnowledgesGraphEN.isRecommend) === false) {
        ...
        if (null != pobjgs_KnowledgesGraphEN.isAnswer && undefined !== pobjgs_KnowledgesGraphEN.isAnswer && clsString_js_1.tzDataType.isBoolean(pobjgs_KnowledgesGraphEN.isAnswer) === false) {
        ...
        if (null != pobjgs_KnowledgesGraphEN.isSubmit && undefined !== pobjgs_KnowledgesGraphEN.isSubmit && clsString_js_1.tzDataType.isBoolean(pobjgs_KnowledgesGraphEN.isSubmit) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.startTime) == false && undefined !== pobjgs_KnowledgesGraphEN.startTime && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.startTime) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.submitTime) == false && undefined !== pobjgs_KnowledgesGraphEN.submitTime && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.submitTime) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.takeUpTime) == false && undefined !== pobjgs_KnowledgesGraphEN.takeUpTime && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.takeUpTime) === false) {
            throw new Error("(errid:Watl000060)字段[耗时(takeUpTime)]的值:[$(pobjgs_KnowledgesGraphEN.takeUpTime)], 非法，应该为字符型(In 知识点逻辑图(gs_KnowledgesGraph))!(clsgs_KnowledgesGraphBL:CheckPropertyNew)");
        }
    ...
    */
    function gs_KnowledgesGraph_CheckProperty4Update(pobjgs_KnowledgesGraphEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.takeUpTime) == false && (0, clsString_js_2.GetStrLen)(pobjgs_KnowledgesGraphEN.takeUpTime) > 50) {
            throw new Error("(errid:Watl000062)字段[耗时(takeUpTime)]的长度不能超过50(In 知识点逻辑图(gs_KnowledgesGraph))!值:$(pobjgs_KnowledgesGraphEN.takeUpTime)(clsgs_KnowledgesGraphBL:CheckProperty4Update)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.knowledgeGraphId) == false && undefined !== pobjgs_KnowledgesGraphEN.knowledgeGraphId && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.knowledgeGraphId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.takeUpTime) == false && undefined !== pobjgs_KnowledgesGraphEN.takeUpTime && clsString_js_1.tzDataType.isString(pobjgs_KnowledgesGraphEN.takeUpTime) === false) {
            throw new Error("(errid:Watl000063)字段[耗时(takeUpTime)]的值:[$(pobjgs_KnowledgesGraphEN.takeUpTime)], 非法，应该为字符型(In 知识点逻辑图(gs_KnowledgesGraph))!(clsgs_KnowledgesGraphBL:CheckProperty4Update)");
        }
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_KnowledgesGraphEN.knowledgeGraphId) === true
    ...
    */
    function gs_KnowledgesGraph_GetCombineCondition(objgs_KnowledgesGraph_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_KnowledgeGraphId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_KnowledgeGraphId, objgs_KnowledgesGraph_Cond.knowledgeGraphId, strComparisonOp_KnowledgeGraphId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_KnowledgeGraphName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_KnowledgeGraphName, objgs_KnowledgesGraph_Cond.knowledgeGraphName, strComparisonOp_KnowledgeGraphName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_id_CurrEduCls, objgs_KnowledgesGraph_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_CourseId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_CourseId, objgs_KnowledgesGraph_Cond.courseId, strComparisonOp_CourseId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_CreateUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_CreateUser, objgs_KnowledgesGraph_Cond.createUser, strComparisonOp_CreateUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_UpdDate, objgs_KnowledgesGraph_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_UpdUser, objgs_KnowledgesGraph_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_Memo, objgs_KnowledgesGraph_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_GraphTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_GraphTypeId, objgs_KnowledgesGraph_Cond.graphTypeId, strComparisonOp_GraphTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsDisplay) == true) {
            if (objgs_KnowledgesGraph_Cond.isDisplay == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsDisplay);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsDisplay);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsExtend) == true) {
            if (objgs_KnowledgesGraph_Cond.isExtend == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsExtend);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsExtend);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsRecommend) == true) {
            if (objgs_KnowledgesGraph_Cond.isRecommend == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsRecommend);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsRecommend);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsAnswer) == true) {
            if (objgs_KnowledgesGraph_Cond.isAnswer == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsAnswer);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsAnswer);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsSubmit) == true) {
            if (objgs_KnowledgesGraph_Cond.isSubmit == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsSubmit);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_IsSubmit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_StartTime) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_StartTime, objgs_KnowledgesGraph_Cond.startTime, strComparisonOp_StartTime);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_SubmitTime) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_SubmitTime, objgs_KnowledgesGraph_Cond.submitTime, strComparisonOp_SubmitTime);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_KnowledgesGraph_Cond.dicFldComparisonOp, clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_TakeUpTime) == true) {
            const strComparisonOp_TakeUpTime = objgs_KnowledgesGraph_Cond.dicFldComparisonOp[clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_TakeUpTime];
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_KnowledgesGraphEN_js_1.clsgs_KnowledgesGraphEN.con_TakeUpTime, objgs_KnowledgesGraph_Cond.takeUpTime, strComparisonOp_TakeUpTime);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_KnowledgesGraph_GetUniCondStr_KnowledgeGraphName_CourseId_CreateUser(objgs_KnowledgesGraphEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeGraphName = '{0}'", objgs_KnowledgesGraphEN.knowledgeGraphName);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseId = '{0}'", objgs_KnowledgesGraphEN.courseId);
        strWhereCond += (0, clsString_js_2.Format)(" and CreateUser = '{0}'", objgs_KnowledgesGraphEN.createUser);
        return strWhereCond;
    }
    ...
    **/
    function gs_KnowledgesGraph_GetUniCondStr4Update_KnowledgeGraphName_CourseId_CreateUser(objgs_KnowledgesGraphEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeGraphId <> '{0}'", objgs_KnowledgesGraphEN.knowledgeGraphId);
        strWhereCond += (0, clsString_js_2.Format)(" and KnowledgeGraphName = '{0}'", objgs_KnowledgesGraphEN.knowledgeGraphName);
        strWhereCond += (0, clsString_js_2.Format)(" and CourseId = '{0}'", objgs_KnowledgesGraphEN.courseId);
        strWhereCond += (0, clsString_js_2.Format)(" and CreateUser = '{0}'", objgs_KnowledgesGraphEN.createUser);
        return strWhereCond;
