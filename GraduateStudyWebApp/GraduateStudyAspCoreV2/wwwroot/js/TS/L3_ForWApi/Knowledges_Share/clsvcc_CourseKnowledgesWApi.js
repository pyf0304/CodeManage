...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/Knowledges_Share/clsvcc_CourseKnowledgesEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vcc_CourseKnowledges_GetObjByCourseKnowledgeIdAsync(strCourseKnowledgeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseKnowledgeId]不能为空！(In clsvcc_CourseKnowledgesWApi.GetObjByCourseKnowledgeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clsvcc_CourseKnowledgesWApi.GetObjByCourseKnowledgeIdAsync)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vcc_CourseKnowledges_GetObjByCourseKnowledgeId_Cache(strCourseKnowledgeId, strCourseId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseKnowledgeId]不能为空！(In clsvcc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clsvcc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_Cache)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vcc_CourseKnowledges_GetObjByCourseKnowledgeId_localStorage(strCourseKnowledgeId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseKnowledgeId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseKnowledgeId]不能为空！(In clsvcc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseKnowledgeId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseKnowledgeId]的长度:[{0}]不正确！(clsvcc_CourseKnowledgesWApi.GetObjByCourseKnowledgeId_localStorage)", strCourseKnowledgeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vcc_CourseKnowledges_func(strInFldName, strOutFldName, strInValue, strCourseId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseId_C]不能为空！(In clsvcc_CourseKnowledgesWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsvcc_CourseKnowledgesWApi.func)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vcc_CourseKnowledges_funcKey(strInFldName, strInValue, strComparisonOp, strCourseId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strCourseId_C]不能为空！(In clsvcc_CourseKnowledgesWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseId_C]的长度:[{0}]不正确！(clsvcc_CourseKnowledgesWApi.funcKey)", strCourseId_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvcc_CourseKnowledgesEN_js_1.clsvcc_CourseKnowledgesEN.con_CourseKnowledgeId) {
    ...
    **/
    async function vcc_CourseKnowledges_GetObjLst_ClientCache(strCourseId) {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvcc_CourseKnowledgesExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvcc_CourseKnowledgesExObjLst);
    ...
    **/
    async function vcc_CourseKnowledges_GetObjLst_Cache(strCourseId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strCourseId) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[CourseId]不能为空！(in clsvcc_CourseKnowledgesWApi.vcc_CourseKnowledges_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strCourseId.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strCourseId]的长度:[{0}]不正确！(in clsvcc_CourseKnowledgesWApi.vcc_CourseKnowledges_GetObjLst_Cache() )", strCourseId.length);
            console.error(strMsg);
            throw (strMsg);
        }
