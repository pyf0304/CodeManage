...
(function (factory) {
    ...
    **/
    async function ViewpointScore_GetObjByViewpointScoreIdAsync(lngViewpointScoreId) {
        ...
        if (lngViewpointScoreId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngViewpointScoreId]不能为空！(In clsViewpointScoreWApi.GetObjByViewpointScoreIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.viewpointScore_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.viewpointScore_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function ViewpointScore_GetObjByViewpointScoreId_Cache(lngViewpointScoreId, bolTryAsyncOnce = true) {
        ...
        if (lngViewpointScoreId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngViewpointScoreId]不能为空！(In clsViewpointScoreWApi.GetObjByViewpointScoreId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function ViewpointScore_GetObjByViewpointScoreId_localStorage(lngViewpointScoreId) {
        ...
        if (lngViewpointScoreId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngViewpointScoreId]不能为空！(In clsViewpointScoreWApi.GetObjByViewpointScoreId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsViewpointScoreEN_js_1.clsViewpointScoreEN._CurrTabName, lngViewpointScoreId);
        if (strKey == "") {
    ...
    */
    async function ViewpointScore_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsViewpointScoreEN_js_1.clsViewpointScoreEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsViewpointScoreEN_js_1.clsViewpointScoreEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objViewpointScore == null)
            return "";
        if (objViewpointScore.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function ViewpointScore_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.ViewpointScore_funcKey = ViewpointScore_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function ViewpointScore_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsViewpointScoreEN_js_1.clsViewpointScoreEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsViewpointScoreEN_js_1.clsViewpointScoreEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrViewpointScoreExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrViewpointScoreExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointScoreExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function ViewpointScore_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointScoreExObjLst.length);
            console.log(strInfo);
            return arrViewpointScoreExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.viewpointScore_ConstructorName, strThisFuncName);
    ...
    **/
    async function ViewpointScore_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrViewpointScoreExObjLst.length);
            console.log(strInfo);
            return arrViewpointScoreExObjLst;
        }
        catch (e) {
    ...
    **/
    async function ViewpointScore_DelRecordAsync(lngViewpointScoreId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngViewpointScoreId);
        try {
    ...
    **/
    async function ViewpointScore_UpdateRecordAsync(objViewpointScoreEN) {
        ...
        if (objViewpointScoreEN.sf_UpdFldSetStr === undefined || objViewpointScoreEN.sf_UpdFldSetStr === null || objViewpointScoreEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objViewpointScoreEN.viewpointScoreId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.viewpointScore_Controller, strAction);
        try {
    ...
    */
    async function ViewpointScore_IsExistRecord_Cache(objViewpointScore_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objViewpointScore_Cond), exports.viewpointScore_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function ViewpointScore_IsExist_Cache(lngViewpointScoreId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngViewpointScoreId, exports.viewpointScore_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function ViewpointScore_CheckPropertyNew(pobjViewpointScoreEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.viewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointScoreEN.viewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointScoreEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointScoreEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjViewpointScoreEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjViewpointScoreEN.viewpointScoreId && undefined !== pobjViewpointScoreEN.viewpointScoreId && clsString_js_1.tzDataType.isNumber(pobjViewpointScoreEN.viewpointScoreId) === false) {
        ...
        if (null != pobjViewpointScoreEN.viewpointScore && undefined !== pobjViewpointScoreEN.viewpointScore && clsString_js_1.tzDataType.isNumber(pobjViewpointScoreEN.viewpointScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.viewpointId) == false && undefined !== pobjViewpointScoreEN.viewpointId && clsString_js_1.tzDataType.isString(pobjViewpointScoreEN.viewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.updDate) == false && undefined !== pobjViewpointScoreEN.updDate && clsString_js_1.tzDataType.isString(pobjViewpointScoreEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.updUserId) == false && undefined !== pobjViewpointScoreEN.updUserId && clsString_js_1.tzDataType.isString(pobjViewpointScoreEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjViewpointScoreEN.memo) == false && undefined !== pobjViewpointScoreEN.memo && clsString_js_1.tzDataType.isString(pobjViewpointScoreEN.memo) === false) {
    ...
    */
    function ViewpointScore_GetCombineCondition(objViewpointScore_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objViewpointScore_Cond.dicFldComparisonOp, clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_ViewpointScoreId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_ViewpointScoreId, objViewpointScore_Cond.viewpointScoreId, strComparisonOp_ViewpointScoreId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointScore_Cond.dicFldComparisonOp, clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_ViewpointScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_ViewpointScore, objViewpointScore_Cond.viewpointScore, strComparisonOp_ViewpointScore);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointScore_Cond.dicFldComparisonOp, clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_ViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_ViewpointId, objViewpointScore_Cond.viewpointId, strComparisonOp_ViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointScore_Cond.dicFldComparisonOp, clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_UpdDate, objViewpointScore_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointScore_Cond.dicFldComparisonOp, clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_UpdUserId, objViewpointScore_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objViewpointScore_Cond.dicFldComparisonOp, clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsViewpointScoreEN_js_1.clsViewpointScoreEN.con_Memo, objViewpointScore_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function ViewpointScore_GetUniCondStr_ViewpointScoreId_ViewpointId(objViewpointScoreEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointScoreId = '{0}'", objViewpointScoreEN.viewpointScoreId);
        strWhereCond += (0, clsString_js_2.Format)(" and ViewpointId = '{0}'", objViewpointScoreEN.viewpointId);
        return strWhereCond;
    }
