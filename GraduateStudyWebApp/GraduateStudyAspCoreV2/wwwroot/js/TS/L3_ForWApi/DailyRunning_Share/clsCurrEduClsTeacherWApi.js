...
(function (factory) {
    ...
    **/
    async function CurrEduClsTeacher_GetObjByid_EduClsTeacherAsync(lngid_EduClsTeacher) {
        ...
        if (lngid_EduClsTeacher == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngid_EduClsTeacher]不能为空！(In clsCurrEduClsTeacherWApi.GetObjByid_EduClsTeacherAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.currEduClsTeacher_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.currEduClsTeacher_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function CurrEduClsTeacher_GetObjByid_EduClsTeacher_Cache(lngid_EduClsTeacher, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngid_EduClsTeacher == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngid_EduClsTeacher]不能为空！(In clsCurrEduClsTeacherWApi.GetObjByid_EduClsTeacher_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrCurrEduClsTeacher_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objCurrEduClsTeacher_Const = await CurrEduClsTeacher_GetObjByid_EduClsTeacherAsync(lngid_EduClsTeacher);
                    if (objCurrEduClsTeacher_Const != null) {
                        CurrEduClsTeacher_ReFreshThisCache(strid_CurrEduCls);
                        return objCurrEduClsTeacher_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function CurrEduClsTeacher_GetObjByid_EduClsTeacher_localStorage(lngid_EduClsTeacher) {
        ...
        if (lngid_EduClsTeacher == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngid_EduClsTeacher]不能为空！(In clsCurrEduClsTeacherWApi.GetObjByid_EduClsTeacher_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN._CurrTabName, lngid_EduClsTeacher);
        if (strKey == "") {
    ...
    */
    async function CurrEduClsTeacher_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsCurrEduClsTeacherWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsCurrEduClsTeacherWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objCurrEduClsTeacher == null)
            return "";
        if (objCurrEduClsTeacher.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_Pk2EduClsTeacherType:
                    return (a, b) => {
                        if (a.id_Pk2EduClsTeacherType == null)
                            return -1;
                        if (b.id_Pk2EduClsTeacherType == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function CurrEduClsTeacher_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsCurrEduClsTeacherWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsCurrEduClsTeacherWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_EduClsTeacher) {
        ...
        const arrCurrEduClsTeacher = await CurrEduClsTeacher_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrCurrEduClsTeacher == null)
            return [];
        let arrCurrEduClsTeacher_Sel = arrCurrEduClsTeacher;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrCurrEduClsTeacher_Sel = arrCurrEduClsTeacher_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrCurrEduClsTeacher_Sel = arrCurrEduClsTeacher_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrCurrEduClsTeacher_Sel = arrCurrEduClsTeacher_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrCurrEduClsTeacher_Sel = arrCurrEduClsTeacher_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrCurrEduClsTeacher_Sel.length == 0)
            return [];
        return arrCurrEduClsTeacher_Sel.map(x => x.id_EduClsTeacher);
    }
    exports.CurrEduClsTeacher_funcKey = CurrEduClsTeacher_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function CurrEduClsTeacher_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrCurrEduClsTeacherExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrCurrEduClsTeacherExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsTeacherExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function CurrEduClsTeacher_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsTeacherExObjLst.length);
            console.log(strInfo);
            return arrCurrEduClsTeacherExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.currEduClsTeacher_ConstructorName, strThisFuncName);
    ...
    **/
    async function CurrEduClsTeacher_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrCurrEduClsTeacherExObjLst.length);
            console.log(strInfo);
            return arrCurrEduClsTeacherExObjLst;
        }
        catch (e) {
    ...
    **/
    async function CurrEduClsTeacher_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsCurrEduClsTeacherWApi.CurrEduClsTeacher_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsCurrEduClsTeacherWApi.CurrEduClsTeacher_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrCurrEduClsTeacher_Sel = arrCurrEduClsTeacher_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function CurrEduClsTeacher_DelRecordAsync(lngid_EduClsTeacher) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngid_EduClsTeacher);
        try {
    ...
    **/
    async function CurrEduClsTeacher_UpdateRecordAsync(objCurrEduClsTeacherEN) {
        ...
        if (objCurrEduClsTeacherEN.sf_UpdFldSetStr === undefined || objCurrEduClsTeacherEN.sf_UpdFldSetStr === null || objCurrEduClsTeacherEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objCurrEduClsTeacherEN.id_EduClsTeacher);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.currEduClsTeacher_Controller, strAction);
        try {
    ...
    */
    async function CurrEduClsTeacher_IsExistRecord_Cache(objCurrEduClsTeacher_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objCurrEduClsTeacher_Cond), exports.currEduClsTeacher_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function CurrEduClsTeacher_IsExist_Cache(lngid_EduClsTeacher, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngid_EduClsTeacher, exports.currEduClsTeacher_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function CurrEduClsTeacher_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsCurrEduClsTeacherWApi.clsCurrEduClsTeacherWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsCurrEduClsTeacherWApi.clsCurrEduClsTeacherWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function CurrEduClsTeacher_CheckPropertyNew(pobjCurrEduClsTeacherEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.id_Teacher) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.id_Teacher) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.id_Pk2EduClsTeacherType) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.id_Pk2EduClsTeacherType) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.schoolTerm) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.schoolTerm) > 1) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.schoolYear) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.schoolYear) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.openBeginDate) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.openBeginDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.openEndDate) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.openEndDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjCurrEduClsTeacherEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjCurrEduClsTeacherEN.id_EduClsTeacher && undefined !== pobjCurrEduClsTeacherEN.id_EduClsTeacher && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsTeacherEN.id_EduClsTeacher) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.id_CurrEduCls) == false && undefined !== pobjCurrEduClsTeacherEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.id_Teacher) == false && undefined !== pobjCurrEduClsTeacherEN.id_Teacher && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.id_Teacher) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.id_Pk2EduClsTeacherType) == false && undefined !== pobjCurrEduClsTeacherEN.id_Pk2EduClsTeacherType && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.id_Pk2EduClsTeacherType) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.schoolTerm) == false && undefined !== pobjCurrEduClsTeacherEN.schoolTerm && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.schoolTerm) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.schoolYear) == false && undefined !== pobjCurrEduClsTeacherEN.schoolYear && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.schoolYear) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.openBeginDate) == false && undefined !== pobjCurrEduClsTeacherEN.openBeginDate && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.openBeginDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.openEndDate) == false && undefined !== pobjCurrEduClsTeacherEN.openEndDate && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.openEndDate) === false) {
        ...
        if (null != pobjCurrEduClsTeacherEN.orderNum && undefined !== pobjCurrEduClsTeacherEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjCurrEduClsTeacherEN.orderNum) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.updDate) == false && undefined !== pobjCurrEduClsTeacherEN.updDate && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.updUser) == false && undefined !== pobjCurrEduClsTeacherEN.updUser && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjCurrEduClsTeacherEN.memo) == false && undefined !== pobjCurrEduClsTeacherEN.memo && clsString_js_1.tzDataType.isString(pobjCurrEduClsTeacherEN.memo) === false) {
    ...
    */
    function CurrEduClsTeacher_GetCombineCondition(objCurrEduClsTeacher_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_EduClsTeacher) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_EduClsTeacher, objCurrEduClsTeacher_Cond.id_EduClsTeacher, strComparisonOp_id_EduClsTeacher);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_CurrEduCls, objCurrEduClsTeacher_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_Teacher) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_Teacher, objCurrEduClsTeacher_Cond.id_Teacher, strComparisonOp_id_Teacher);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_Pk2EduClsTeacherType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_id_Pk2EduClsTeacherType, objCurrEduClsTeacher_Cond.id_Pk2EduClsTeacherType, strComparisonOp_id_Pk2EduClsTeacherType);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_SchoolTerm) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_SchoolTerm, objCurrEduClsTeacher_Cond.schoolTerm, strComparisonOp_SchoolTerm);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_SchoolYear) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_SchoolYear, objCurrEduClsTeacher_Cond.schoolYear, strComparisonOp_SchoolYear);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_OpenBeginDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_OpenBeginDate, objCurrEduClsTeacher_Cond.openBeginDate, strComparisonOp_OpenBeginDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_OpenEndDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_OpenEndDate, objCurrEduClsTeacher_Cond.openEndDate, strComparisonOp_OpenEndDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_OrderNum, objCurrEduClsTeacher_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_UpdDate, objCurrEduClsTeacher_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_UpdUser, objCurrEduClsTeacher_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objCurrEduClsTeacher_Cond.dicFldComparisonOp, clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsCurrEduClsTeacherEN_js_1.clsCurrEduClsTeacherEN.con_Memo, objCurrEduClsTeacher_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function CurrEduClsTeacher_GetUniCondStr_id_CurrEduCls_id_Teacher(objCurrEduClsTeacherEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_CurrEduCls = '{0}'", objCurrEduClsTeacherEN.id_CurrEduCls);
        strWhereCond += (0, clsString_js_2.Format)(" and id_Teacher = '{0}'", objCurrEduClsTeacherEN.id_Teacher);
        return strWhereCond;
    }
    ...
    **/
    function CurrEduClsTeacher_GetUniCondStr4Update_id_CurrEduCls_id_Teacher(objCurrEduClsTeacherEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_EduClsTeacher <> '{0}'", objCurrEduClsTeacherEN.id_EduClsTeacher);
        strWhereCond += (0, clsString_js_2.Format)(" and id_CurrEduCls = '{0}'", objCurrEduClsTeacherEN.id_CurrEduCls);
        strWhereCond += (0, clsString_js_2.Format)(" and id_Teacher = '{0}'", objCurrEduClsTeacherEN.id_Teacher);
        return strWhereCond;
    }
