...
(function (factory) {
    ...
    **/
    async function vCurrEduClsStu_GetObjByid_EduClsStuAsync(lngid_EduClsStu) {
        ...
        if (lngid_EduClsStu == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngid_EduClsStu]不能为空！(In clsvCurrEduClsStuWApi.GetObjByid_EduClsStuAsync)");
    ...
    */
    async function vCurrEduClsStu_GetObjByid_EduClsStu_Cache(lngid_EduClsStu, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngid_EduClsStu == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngid_EduClsStu]不能为空！(In clsvCurrEduClsStuWApi.GetObjByid_EduClsStu_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrvCurrEduClsStu_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objvCurrEduClsStu_Const = await vCurrEduClsStu_GetObjByid_EduClsStuAsync(lngid_EduClsStu);
                    if (objvCurrEduClsStu_Const != null) {
                        vCurrEduClsStu_ReFreshThisCache(strid_CurrEduCls);
                        return objvCurrEduClsStu_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function vCurrEduClsStu_GetObjByid_EduClsStu_localStorage(lngid_EduClsStu) {
        ...
        if (lngid_EduClsStu == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngid_EduClsStu]不能为空！(In clsvCurrEduClsStuWApi.GetObjByid_EduClsStu_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vCurrEduClsStu_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvCurrEduClsStuWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvCurrEduClsStuWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvCurrEduClsStuEN_js_1.clsvCurrEduClsStuEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvCurrEduClsStuEN_js_1.clsvCurrEduClsStuEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvCurrEduClsStu == null)
            return "";
        if (objvCurrEduClsStu.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvCurrEduClsStuEN_js_1.clsvCurrEduClsStuEN.con_CollegeName4Stu:
                    return (a, b) => {
                        if (a.collegeName4Stu == null)
                            return -1;
                        if (b.collegeName4Stu == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vCurrEduClsStu_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsvCurrEduClsStuWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsvCurrEduClsStuWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvCurrEduClsStuEN_js_1.clsvCurrEduClsStuEN.con_id_EduClsStu) {
        ...
        const arrvCurrEduClsStu = await vCurrEduClsStu_GetObjLst_Cache(strid_CurrEduCls_C);
        if (arrvCurrEduClsStu == null)
            return [];
        let arrvCurrEduClsStu_Sel = arrvCurrEduClsStu;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrvCurrEduClsStu_Sel = arrvCurrEduClsStu_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrvCurrEduClsStu_Sel = arrvCurrEduClsStu_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrvCurrEduClsStu_Sel = arrvCurrEduClsStu_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrvCurrEduClsStu_Sel = arrvCurrEduClsStu_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrvCurrEduClsStu_Sel.length == 0)
            return [];
        return arrvCurrEduClsStu_Sel.map(x => x.id_EduClsStu);
    }
    exports.vCurrEduClsStu_funcKey = vCurrEduClsStu_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vCurrEduClsStu_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvCurrEduClsStuEN_js_1.clsvCurrEduClsStuEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvCurrEduClsStuEN_js_1.clsvCurrEduClsStuEN.WhereFormat, strid_CurrEduCls);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvCurrEduClsStuExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvCurrEduClsStuExObjLst);
    ...
    **/
    async function vCurrEduClsStu_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsvCurrEduClsStuWApi.vCurrEduClsStu_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsvCurrEduClsStuWApi.vCurrEduClsStu_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrvCurrEduClsStu_Sel = arrvCurrEduClsStu_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
