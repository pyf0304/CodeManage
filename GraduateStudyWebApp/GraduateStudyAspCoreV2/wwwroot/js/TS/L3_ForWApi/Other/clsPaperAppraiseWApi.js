...
(function (factory) {
    ...
    **/
    async function PaperAppraise_GetObjByPaperAppraiseIdAsync(lngPaperAppraiseId) {
        ...
        if (lngPaperAppraiseId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperAppraiseId]不能为空！(In clsPaperAppraiseWApi.GetObjByPaperAppraiseIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperAppraise_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperAppraise_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperAppraise_GetObjByPaperAppraiseId_Cache(lngPaperAppraiseId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperAppraiseId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperAppraiseId]不能为空！(In clsPaperAppraiseWApi.GetObjByPaperAppraiseId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function PaperAppraise_GetObjByPaperAppraiseId_localStorage(lngPaperAppraiseId) {
        ...
        if (lngPaperAppraiseId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperAppraiseId]不能为空！(In clsPaperAppraiseWApi.GetObjByPaperAppraiseId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN._CurrTabName, lngPaperAppraiseId);
        if (strKey == "") {
    ...
    */
    async function PaperAppraise_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objPaperAppraise == null)
            return "";
        if (objPaperAppraise.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperAppraiseContent:
                    return (a, b) => {
                        if (a.paperAppraiseContent == null)
                            return -1;
                        if (b.paperAppraiseContent == null)
                            return 1;
                        return a.paperAppraiseContent.localeCompare(b.paperAppraiseContent);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function PaperAppraise_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.PaperAppraise_funcKey = PaperAppraise_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function PaperAppraise_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperAppraiseExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrPaperAppraiseExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperAppraiseExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperAppraise_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperAppraiseExObjLst.length);
            console.log(strInfo);
            return arrPaperAppraiseExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperAppraise_ConstructorName, strThisFuncName);
    ...
    **/
    async function PaperAppraise_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperAppraiseExObjLst.length);
            console.log(strInfo);
            return arrPaperAppraiseExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperAppraise_DelRecordAsync(lngPaperAppraiseId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngPaperAppraiseId);
        try {
    ...
    **/
    async function PaperAppraise_UpdateRecordAsync(objPaperAppraiseEN) {
        ...
        if (objPaperAppraiseEN.sf_UpdFldSetStr === undefined || objPaperAppraiseEN.sf_UpdFldSetStr === null || objPaperAppraiseEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperAppraiseEN.paperAppraiseId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperAppraise_Controller, strAction);
        try {
    ...
    */
    async function PaperAppraise_IsExistRecord_Cache(objPaperAppraise_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperAppraise_Cond), exports.paperAppraise_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperAppraise_IsExist_Cache(lngPaperAppraiseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperAppraiseId, exports.paperAppraise_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function PaperAppraise_CheckPropertyNew(pobjPaperAppraiseEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.paperAppraiseContent) == false && (0, clsString_js_2.GetStrLen)(pobjPaperAppraiseEN.paperAppraiseContent) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperAppraiseEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjPaperAppraiseEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperAppraiseEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjPaperAppraiseEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperAppraiseEN.paperAppraiseId && undefined !== pobjPaperAppraiseEN.paperAppraiseId && clsString_js_1.tzDataType.isNumber(pobjPaperAppraiseEN.paperAppraiseId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.paperAppraiseContent) == false && undefined !== pobjPaperAppraiseEN.paperAppraiseContent && clsString_js_1.tzDataType.isString(pobjPaperAppraiseEN.paperAppraiseContent) === false) {
        ...
        if (null != pobjPaperAppraiseEN.appraiseScore && undefined !== pobjPaperAppraiseEN.appraiseScore && clsString_js_1.tzDataType.isNumber(pobjPaperAppraiseEN.appraiseScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.paperId) == false && undefined !== pobjPaperAppraiseEN.paperId && clsString_js_1.tzDataType.isString(pobjPaperAppraiseEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.updUser) == false && undefined !== pobjPaperAppraiseEN.updUser && clsString_js_1.tzDataType.isString(pobjPaperAppraiseEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.updDate) == false && undefined !== pobjPaperAppraiseEN.updDate && clsString_js_1.tzDataType.isString(pobjPaperAppraiseEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperAppraiseEN.memo) == false && undefined !== pobjPaperAppraiseEN.memo && clsString_js_1.tzDataType.isString(pobjPaperAppraiseEN.memo) === false) {
    ...
    */
    function PaperAppraise_GetCombineCondition(objPaperAppraise_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperAppraiseId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperAppraiseId, objPaperAppraise_Cond.paperAppraiseId, strComparisonOp_PaperAppraiseId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperAppraiseContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperAppraiseContent, objPaperAppraise_Cond.paperAppraiseContent, strComparisonOp_PaperAppraiseContent);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_AppraiseScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_AppraiseScore, objPaperAppraise_Cond.appraiseScore, strComparisonOp_AppraiseScore);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_PaperId, objPaperAppraise_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_UpdUser, objPaperAppraise_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_UpdDate, objPaperAppraise_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperAppraise_Cond.dicFldComparisonOp, clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperAppraiseEN_js_1.clsPaperAppraiseEN.con_Memo, objPaperAppraise_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperAppraise_GetUniCondStr_PaperId(objPaperAppraiseEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objPaperAppraiseEN.paperId);
        return strWhereCond;
    }
    ...
    **/
    function PaperAppraise_GetUniCondStr4Update_PaperId(objPaperAppraiseEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperAppraiseId <> '{0}'", objPaperAppraiseEN.paperAppraiseId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objPaperAppraiseEN.paperId);
        return strWhereCond;
    }
