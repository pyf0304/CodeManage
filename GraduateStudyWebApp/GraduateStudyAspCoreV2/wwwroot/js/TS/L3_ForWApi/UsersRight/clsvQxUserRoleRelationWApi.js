...
(function (factory) {
    ...
    **/
    async function vQxUserRoleRelation_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvQxUserRoleRelationWApi.GetObjBymIdAsync)");
    ...
    */
    async function vQxUserRoleRelation_GetObjBymId_Cache(lngmId, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvQxUserRoleRelationWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vQxUserRoleRelation_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngmId]不能为空！(In clsvQxUserRoleRelationWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vQxUserRoleRelation_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvQxUserRoleRelationEN_js_1.clsvQxUserRoleRelationEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvQxUserRoleRelationEN_js_1.clsvQxUserRoleRelationEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvQxUserRoleRelation == null)
            return "";
        if (objvQxUserRoleRelation.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvQxUserRoleRelationEN_js_1.clsvQxUserRoleRelationEN.con_UserStateId:
                    return (a, b) => {
                        if (a.userStateId == null)
                            return -1;
                        if (b.userStateId == null)
                            return 1;
                ...
                case clsvQxUserRoleRelationEN_js_1.clsvQxUserRoleRelationEN.con_StuTeacherID:
                    return (a, b) => {
                        if (a.stuTeacherID == null)
                            return -1;
                        if (b.stuTeacherID == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vQxUserRoleRelation_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        if (arrvQxUserRoleRelation == null)
            return [];
    ...
    exports.vQxUserRoleRelation_funcKey = vQxUserRoleRelation_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vQxUserRoleRelation_GetObjLst_ClientCache() {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvQxUserRoleRelationExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvQxUserRoleRelationExObjLst);
