...
* 版本:2023.03.10.1(服务器:LAPTOP-RAFT5SD9)
* 日期:2023/03/14 23:06:15
* 生成者:pyf
* 生成服务器IP:192.168.1.18
工程名称:问卷调查(0112)
...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/BaseInfo_Share/clsTeacherInfoEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function TeacherInfo_GetObjByid_TeacherAsync(strid_Teacher) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_Teacher]不能为空！(In clsTeacherInfoWApi.GetObjByid_TeacherAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsTeacherInfoWApi.GetObjByid_TeacherAsync)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.teacherInfo_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.teacherInfo_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function TeacherInfo_GetObjByid_Teacher_Cache(strid_Teacher, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_Teacher]不能为空！(In clsTeacherInfoWApi.GetObjByid_Teacher_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsTeacherInfoWApi.GetObjByid_Teacher_Cache)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function TeacherInfo_GetObjByid_Teacher_localStorage(strid_Teacher) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_Teacher]不能为空！(In clsTeacherInfoWApi.GetObjByid_Teacher_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsTeacherInfoWApi.GetObjByid_Teacher_localStorage)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsTeacherInfoEN_js_1.clsTeacherInfoEN._CurrTabName, strid_Teacher);
        if (strKey == "") {
    ...
    */
    async function TeacherInfo_GetNameByid_Teacher_Cache(strid_Teacher) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_Teacher]不能为空！(In clsTeacherInfoWApi.GetNameByid_Teacher_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsTeacherInfoWApi.GetNameByid_Teacher_Cache)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrTeacherInfoObjLst_Cache = await TeacherInfo_GetObjLst_Cache();
    ...
    */
    async function TeacherInfo_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsTeacherInfoEN_js_1.clsTeacherInfoEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsTeacherInfoEN_js_1.clsTeacherInfoEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function TeacherInfo_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsTeacherInfoEN_js_1.clsTeacherInfoEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsTeacherInfoEN_js_1.clsTeacherInfoEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrTeacherInfoExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrTeacherInfoExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTeacherInfoExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function TeacherInfo_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTeacherInfoExObjLst.length);
            console.log(strInfo);
            return arrTeacherInfoExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.teacherInfo_ConstructorName, strThisFuncName);
    ...
    **/
    async function TeacherInfo_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrTeacherInfoExObjLst.length);
            console.log(strInfo);
            return arrTeacherInfoExObjLst;
        }
        catch (e) {
    ...
    **/
    async function TeacherInfo_DelRecordAsync(strid_Teacher) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strid_Teacher);
        try {
    ...
    **/
    async function TeacherInfo_UpdateRecordAsync(objTeacherInfoEN) {
        ...
        if (objTeacherInfoEN.sf_UpdFldSetStr === undefined || objTeacherInfoEN.sf_UpdFldSetStr === null || objTeacherInfoEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objTeacherInfoEN.id_Teacher);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.teacherInfo_Controller, strAction);
        try {
    ...
    */
    async function TeacherInfo_IsExistRecord_Cache(objTeacherInfo_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objTeacherInfo_Cond), exports.teacherInfo_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function TeacherInfo_IsExist_Cache(strid_Teacher) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_Teacher, exports.teacherInfo_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function TeacherInfo_BindDdl_id_TeacherInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_TeacherInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function TeacherInfo_CheckPropertyNew(pobjTeacherInfoEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherID) === true) {
            throw new Error("(errid:Watl000058)字段[教师工号]不能为空(In 教师)!(clsTeacherInfoBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherName) === true) {
            throw new Error("(errid:Watl000058)字段[教师姓名]不能为空(In 教师)!(clsTeacherInfoBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Sex) === true) {
            throw new Error("(errid:Watl000058)字段[性别流水号]不能为空(In 教师)!(clsTeacherInfoBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Teacher) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Teacher) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherID) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.teacherID) > 12) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherName) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.teacherName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Sex) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Sex) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_School_Ps) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_School_Ps) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Discipline_Ps) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Discipline_Ps) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_UniZone) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_UniZone) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Ethnic) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Ethnic) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Politics) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Politics) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_AdminGrade) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_AdminGrade) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_ProfGrade) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_ProfGrade) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Qualif) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Qualif) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Degree) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Degree) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_StaffType) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_StaffType) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Province) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Province) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.citizenID) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.citizenID) > 25) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.cardNo) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.cardNo) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.birthday) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.birthday) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.graduationMajor) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.graduationMajor) > 40) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.telNo) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.telNo) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.email) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.email) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.webSite) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.webSite) > 60) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.personBlog) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.personBlog) > 60) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.entryDate) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.entryDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_CardNo) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_CardNo) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.fromUnit) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.fromUnit) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_XzCollege) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_XzMajor) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.entryDay) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.entryDay) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Photo) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Photo) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Religion) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.id_Religion) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.microblog) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.microblog) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.modifyUserID) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.modifyUserID) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.phoneNumber) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.phoneNumber) > 15) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.qQ) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.qQ) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teach_id_College) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.teach_id_College) > 6) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teach_id_Major) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.teach_id_Major) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.tel) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.tel) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.headphoto) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.headphoto) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.modifyDate) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.modifyDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.registerPassword) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.registerPassword) > 30) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherPhoto) == false && (0, clsString_js_2.GetStrLen)(pobjTeacherInfoEN.teacherPhoto) > 500) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Teacher) == false && undefined !== pobjTeacherInfoEN.id_Teacher && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Teacher) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherID) == false && undefined !== pobjTeacherInfoEN.teacherID && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.teacherID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherName) == false && undefined !== pobjTeacherInfoEN.teacherName && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.teacherName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Sex) == false && undefined !== pobjTeacherInfoEN.id_Sex && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Sex) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_School_Ps) == false && undefined !== pobjTeacherInfoEN.id_School_Ps && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_School_Ps) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Discipline_Ps) == false && undefined !== pobjTeacherInfoEN.id_Discipline_Ps && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Discipline_Ps) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_UniZone) == false && undefined !== pobjTeacherInfoEN.id_UniZone && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_UniZone) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Ethnic) == false && undefined !== pobjTeacherInfoEN.id_Ethnic && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Ethnic) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Politics) == false && undefined !== pobjTeacherInfoEN.id_Politics && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Politics) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_AdminGrade) == false && undefined !== pobjTeacherInfoEN.id_AdminGrade && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_AdminGrade) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_ProfGrade) == false && undefined !== pobjTeacherInfoEN.id_ProfGrade && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_ProfGrade) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Qualif) == false && undefined !== pobjTeacherInfoEN.id_Qualif && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Qualif) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Degree) == false && undefined !== pobjTeacherInfoEN.id_Degree && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Degree) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_StaffType) == false && undefined !== pobjTeacherInfoEN.id_StaffType && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_StaffType) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Province) == false && undefined !== pobjTeacherInfoEN.id_Province && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Province) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.citizenID) == false && undefined !== pobjTeacherInfoEN.citizenID && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.citizenID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.cardNo) == false && undefined !== pobjTeacherInfoEN.cardNo && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.cardNo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.birthday) == false && undefined !== pobjTeacherInfoEN.birthday && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.birthday) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.graduationMajor) == false && undefined !== pobjTeacherInfoEN.graduationMajor && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.graduationMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.telNo) == false && undefined !== pobjTeacherInfoEN.telNo && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.telNo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.email) == false && undefined !== pobjTeacherInfoEN.email && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.email) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.webSite) == false && undefined !== pobjTeacherInfoEN.webSite && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.webSite) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.personBlog) == false && undefined !== pobjTeacherInfoEN.personBlog && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.personBlog) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.entryDate) == false && undefined !== pobjTeacherInfoEN.entryDate && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.entryDate) === false) {
        ...
        if (null != pobjTeacherInfoEN.offed && undefined !== pobjTeacherInfoEN.offed && clsString_js_1.tzDataType.isBoolean(pobjTeacherInfoEN.offed) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_CardNo) == false && undefined !== pobjTeacherInfoEN.id_CardNo && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_CardNo) === false) {
        ...
        if (null != pobjTeacherInfoEN.isAvconUser && undefined !== pobjTeacherInfoEN.isAvconUser && clsString_js_1.tzDataType.isBoolean(pobjTeacherInfoEN.isAvconUser) === false) {
        ...
        if (null != pobjTeacherInfoEN.isGpUser && undefined !== pobjTeacherInfoEN.isGpUser && clsString_js_1.tzDataType.isBoolean(pobjTeacherInfoEN.isGpUser) === false) {
        ...
        if (null != pobjTeacherInfoEN.isLocalUser && undefined !== pobjTeacherInfoEN.isLocalUser && clsString_js_1.tzDataType.isBoolean(pobjTeacherInfoEN.isLocalUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.fromUnit) == false && undefined !== pobjTeacherInfoEN.fromUnit && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.fromUnit) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.memo) == false && undefined !== pobjTeacherInfoEN.memo && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_XzCollege) == false && undefined !== pobjTeacherInfoEN.id_XzCollege && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_XzMajor) == false && undefined !== pobjTeacherInfoEN.id_XzMajor && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.entryDay) == false && undefined !== pobjTeacherInfoEN.entryDay && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.entryDay) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Photo) == false && undefined !== pobjTeacherInfoEN.id_Photo && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Photo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Religion) == false && undefined !== pobjTeacherInfoEN.id_Religion && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.id_Religion) === false) {
        ...
        if (null != pobjTeacherInfoEN.isMessage && undefined !== pobjTeacherInfoEN.isMessage && clsString_js_1.tzDataType.isBoolean(pobjTeacherInfoEN.isMessage) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.microblog) == false && undefined !== pobjTeacherInfoEN.microblog && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.microblog) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.modifyUserID) == false && undefined !== pobjTeacherInfoEN.modifyUserID && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.modifyUserID) === false) {
        ...
        if (null != pobjTeacherInfoEN.offedBak && undefined !== pobjTeacherInfoEN.offedBak && clsString_js_1.tzDataType.isBoolean(pobjTeacherInfoEN.offedBak) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.phoneNumber) == false && undefined !== pobjTeacherInfoEN.phoneNumber && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.phoneNumber) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.qQ) == false && undefined !== pobjTeacherInfoEN.qQ && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.qQ) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teach_id_College) == false && undefined !== pobjTeacherInfoEN.teach_id_College && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.teach_id_College) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teach_id_Major) == false && undefined !== pobjTeacherInfoEN.teach_id_Major && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.teach_id_Major) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.tel) == false && undefined !== pobjTeacherInfoEN.tel && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.tel) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.headphoto) == false && undefined !== pobjTeacherInfoEN.headphoto && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.headphoto) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.modifyDate) == false && undefined !== pobjTeacherInfoEN.modifyDate && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.modifyDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.registerPassword) == false && undefined !== pobjTeacherInfoEN.registerPassword && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.registerPassword) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.teacherPhoto) == false && undefined !== pobjTeacherInfoEN.teacherPhoto && clsString_js_1.tzDataType.isString(pobjTeacherInfoEN.teacherPhoto) === false) {
    ...
    */
    function TeacherInfo_CheckProperty4Update(pobjTeacherInfoEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjTeacherInfoEN.id_Teacher) === true
    ...
    */
    function TeacherInfo_GetCombineCondition(objTeacherInfo_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Teacher) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Teacher, objTeacherInfo_Cond.id_Teacher, strComparisonOp_id_Teacher);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherID, objTeacherInfo_Cond.teacherID, strComparisonOp_TeacherID);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherName, objTeacherInfo_Cond.teacherName, strComparisonOp_TeacherName);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Sex) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Sex, objTeacherInfo_Cond.id_Sex, strComparisonOp_id_Sex);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_School_Ps) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_School_Ps, objTeacherInfo_Cond.id_School_Ps, strComparisonOp_id_School_Ps);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Discipline_Ps) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Discipline_Ps, objTeacherInfo_Cond.id_Discipline_Ps, strComparisonOp_id_Discipline_Ps);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_UniZone) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_UniZone, objTeacherInfo_Cond.id_UniZone, strComparisonOp_id_UniZone);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Ethnic) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Ethnic, objTeacherInfo_Cond.id_Ethnic, strComparisonOp_id_Ethnic);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Politics) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Politics, objTeacherInfo_Cond.id_Politics, strComparisonOp_id_Politics);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_AdminGrade) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_AdminGrade, objTeacherInfo_Cond.id_AdminGrade, strComparisonOp_id_AdminGrade);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_ProfGrade) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_ProfGrade, objTeacherInfo_Cond.id_ProfGrade, strComparisonOp_id_ProfGrade);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Qualif) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Qualif, objTeacherInfo_Cond.id_Qualif, strComparisonOp_id_Qualif);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Degree) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Degree, objTeacherInfo_Cond.id_Degree, strComparisonOp_id_Degree);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_StaffType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_StaffType, objTeacherInfo_Cond.id_StaffType, strComparisonOp_id_StaffType);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Province) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Province, objTeacherInfo_Cond.id_Province, strComparisonOp_id_Province);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_CitizenID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_CitizenID, objTeacherInfo_Cond.citizenID, strComparisonOp_CitizenID);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_CardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_CardNo, objTeacherInfo_Cond.cardNo, strComparisonOp_CardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Birthday) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Birthday, objTeacherInfo_Cond.birthday, strComparisonOp_Birthday);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_GraduationMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_GraduationMajor, objTeacherInfo_Cond.graduationMajor, strComparisonOp_GraduationMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TelNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TelNo, objTeacherInfo_Cond.telNo, strComparisonOp_TelNo);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Email) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Email, objTeacherInfo_Cond.email, strComparisonOp_Email);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_WebSite) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_WebSite, objTeacherInfo_Cond.webSite, strComparisonOp_WebSite);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_PersonBlog) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_PersonBlog, objTeacherInfo_Cond.personBlog, strComparisonOp_PersonBlog);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_EntryDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_EntryDate, objTeacherInfo_Cond.entryDate, strComparisonOp_EntryDate);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Offed) == true) {
            if (objTeacherInfo_Cond.offed == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Offed);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Offed);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Id_CardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Id_CardNo, objTeacherInfo_Cond.id_CardNo, strComparisonOp_Id_CardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsAvconUser) == true) {
            if (objTeacherInfo_Cond.isAvconUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsAvconUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsAvconUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsGpUser) == true) {
            if (objTeacherInfo_Cond.isGpUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsGpUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsGpUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsLocalUser) == true) {
            if (objTeacherInfo_Cond.isLocalUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsLocalUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsLocalUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_FromUnit) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_FromUnit, objTeacherInfo_Cond.fromUnit, strComparisonOp_FromUnit);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Memo, objTeacherInfo_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_XzCollege, objTeacherInfo_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_XzMajor, objTeacherInfo_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_EntryDay) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_EntryDay, objTeacherInfo_Cond.entryDay, strComparisonOp_EntryDay);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Photo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Photo, objTeacherInfo_Cond.id_Photo, strComparisonOp_id_Photo);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Religion) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Religion, objTeacherInfo_Cond.id_Religion, strComparisonOp_id_Religion);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsMessage) == true) {
            if (objTeacherInfo_Cond.isMessage == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsMessage);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_IsMessage);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Microblog) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Microblog, objTeacherInfo_Cond.microblog, strComparisonOp_Microblog);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_ModifyUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_ModifyUserID, objTeacherInfo_Cond.modifyUserID, strComparisonOp_ModifyUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_OffedBak) == true) {
            if (objTeacherInfo_Cond.offedBak == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_OffedBak);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_OffedBak);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_PhoneNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_PhoneNumber, objTeacherInfo_Cond.phoneNumber, strComparisonOp_PhoneNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_QQ) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_QQ, objTeacherInfo_Cond.qQ, strComparisonOp_QQ);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Teach_id_College) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Teach_id_College, objTeacherInfo_Cond.teach_id_College, strComparisonOp_Teach_id_College);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Teach_id_Major) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Teach_id_Major, objTeacherInfo_Cond.teach_id_Major, strComparisonOp_Teach_id_Major);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Tel) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Tel, objTeacherInfo_Cond.tel, strComparisonOp_Tel);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Headphoto) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_Headphoto, objTeacherInfo_Cond.headphoto, strComparisonOp_Headphoto);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_ModifyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_ModifyDate, objTeacherInfo_Cond.modifyDate, strComparisonOp_ModifyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_RegisterPassword) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_RegisterPassword, objTeacherInfo_Cond.registerPassword, strComparisonOp_RegisterPassword);
        }
        if (Object.prototype.hasOwnProperty.call(objTeacherInfo_Cond.dicFldComparisonOp, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherPhoto) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherPhoto, objTeacherInfo_Cond.teacherPhoto, strComparisonOp_TeacherPhoto);
        }
        return strWhereCond;
    }
    ...
    **/
    function TeacherInfo_GetUniCondStr_TeacherID(objTeacherInfoEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and TeacherID = '{0}'", objTeacherInfoEN.teacherID);
        return strWhereCond;
    }
    ...
    **/
    function TeacherInfo_GetUniCondStr4Update_TeacherID(objTeacherInfoEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_Teacher <> '{0}'", objTeacherInfoEN.id_Teacher);
        strWhereCond += (0, clsString_js_2.Format)(" and TeacherID = '{0}'", objTeacherInfoEN.teacherID);
        return strWhereCond;
    }
