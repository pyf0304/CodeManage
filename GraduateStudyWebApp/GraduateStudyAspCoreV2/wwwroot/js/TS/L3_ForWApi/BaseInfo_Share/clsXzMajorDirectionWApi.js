...
(function (factory) {
    ...
    * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    ...
    const clsvXzMajorDirectionWApi_js_1 = require("../../L3_ForWApi/BaseInfo_Share/clsvXzMajorDirectionWApi.js");
    ...
    **/
    async function XzMajorDirection_GetObjByMajorDirectionIdAsync(strMajorDirectionId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strMajorDirectionId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strMajorDirectionId]不能为空！(In clsXzMajorDirectionWApi.GetObjByMajorDirectionIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strMajorDirectionId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strMajorDirectionId]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.GetObjByMajorDirectionIdAsync)", strMajorDirectionId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.xzMajorDirection_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.xzMajorDirection_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
     ...
     * @returns 对象
    */
    async function XzMajorDirection_GetObjByMajorDirectionId_Cache(strMajorDirectionId, strid_XzMajor, bolTryAsyncOnce = true) {
        const strThisFuncName = "GetObjByMajorDirectionId_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strMajorDirectionId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strMajorDirectionId]不能为空！(In clsXzMajorDirectionWApi.GetObjByMajorDirectionId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strMajorDirectionId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strMajorDirectionId]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.GetObjByMajorDirectionId_Cache)", strMajorDirectionId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_Cache(strid_XzMajor);
        try {
            ...
            if (arrXzMajorDirection_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objXzMajorDirection_Const = await XzMajorDirection_GetObjByMajorDirectionIdAsync(strMajorDirectionId);
                    if (objXzMajorDirection_Const != null) {
                        XzMajorDirection_ReFreshThisCache(strid_XzMajor);
                        return objXzMajorDirection_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function XzMajorDirection_GetObjByMajorDirectionId_localStorage(strMajorDirectionId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strMajorDirectionId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strMajorDirectionId]不能为空！(In clsXzMajorDirectionWApi.GetObjByMajorDirectionId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strMajorDirectionId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strMajorDirectionId]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.GetObjByMajorDirectionId_localStorage)", strMajorDirectionId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN._CurrTabName, strMajorDirectionId);
        if (strKey == "") {
     ...
     * @returns 对象
    */
    async function XzMajorDirection_UpdateObjInLst_Cache(objXzMajorDirection, strid_XzMajor) {
     ...
     * @returns 对象
    */
    async function XzMajorDirection_GetNameByMajorDirectionId_Cache(strMajorDirectionId, strid_XzMajor) {
        const strThisFuncName = "GetNameByMajorDirectionId_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strMajorDirectionId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strMajorDirectionId]不能为空！(In clsXzMajorDirectionWApi.GetNameByMajorDirectionId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strMajorDirectionId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strMajorDirectionId]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.GetNameByMajorDirectionId_Cache)", strMajorDirectionId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_Cache(strid_XzMajor);
     ...
     * @returns 返回一个输出字段值
    */
    async function XzMajorDirection_func(strInFldName, strOutFldName, strInValue, strid_XzMajor_C) {
        //const strThisFuncName = "func";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor_C]不能为空！(In clsXzMajorDirectionWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor_C]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.func)", strid_XzMajor_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        const objXzMajorDirection = await XzMajorDirection_GetObjByMajorDirectionId_Cache(strMajorDirectionId, strid_XzMajor_C);
        if (objXzMajorDirection == null)
            return "";
        if (objXzMajorDirection.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                case clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionId:
                    return (a, b) => {
                        if (a.majorDirectionId == null)
                            return -1;
                        if (b.majorDirectionId == null)
                            return 1;
                        return a.majorDirectionId.localeCompare(b.majorDirectionId);
                    };
                ...
                case clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionENName:
                    return (a, b) => {
                        if (a.majorDirectionENName == null)
                            return -1;
                        if (b.majorDirectionENName == null)
                            return 1;
                ...
                case clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionExplain:
                    return (a, b) => {
                        if (a.majorDirectionExplain == null)
                            return -1;
                        if (b.majorDirectionExplain == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function XzMajorDirection_funcKey(strInFldName, strInValue, strComparisonOp, strid_XzMajor_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor_C]不能为空！(In clsXzMajorDirectionWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor_C]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.funcKey)", strid_XzMajor_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionId) {
        ...
        const arrXzMajorDirection = await XzMajorDirection_GetObjLst_Cache(strid_XzMajor_C);
        if (arrXzMajorDirection == null)
            return [];
        let arrXzMajorDirection_Sel = arrXzMajorDirection;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrXzMajorDirection_Sel = arrXzMajorDirection_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrXzMajorDirection_Sel = arrXzMajorDirection_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrXzMajorDirection_Sel = arrXzMajorDirection_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrXzMajorDirection_Sel = arrXzMajorDirection_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrXzMajorDirection_Sel.length == 0)
            return [];
        return arrXzMajorDirection_Sel.map(x => x.majorDirectionId);
    }
    exports.XzMajorDirection_funcKey = XzMajorDirection_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function XzMajorDirection_GetObjLst_ClientCache(strid_XzMajor) {
        const strThisFuncName = "GetObjLst_ClientCache";
        //初始化列表缓存
        let strWhereCond = "1=1";
        if ((0, clsString_js_2.IsNullOrEmpty)(clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.WhereFormat, strid_XzMajor);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_XzMajor='{0}'", strid_XzMajor);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN._CurrTabName, strid_XzMajor);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrXzMajorDirectionExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrXzMajorDirectionExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorDirectionExObjLst.length);
            console.log(strInfo);
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function XzMajorDirection_GetObjLst_localStorage(strid_XzMajor) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorDirectionExObjLst.length);
            console.log(strInfo);
            return arrXzMajorDirectionExObjLst;
        }
        catch (e) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function XzMajorDirection_GetObjLst_localStorage_PureCache(strid_XzMajor) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.xzMajorDirection_ConstructorName, strThisFuncName);
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function XzMajorDirection_GetObjLst_sessionStorage(strid_XzMajor) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorDirectionExObjLst.length);
            console.log(strInfo);
            return arrXzMajorDirectionExObjLst;
        }
        catch (e) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function XzMajorDirection_GetObjLst_sessionStorage_PureCache(strid_XzMajor) {
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function XzMajorDirection_GetObjLst_Cache(strid_XzMajor) {
        //const strThisFuncName = "GetObjLst_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_XzMajor]不能为空！(in clsXzMajorDirectionWApi.XzMajorDirection_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(in clsXzMajorDirectionWApi.XzMajorDirection_GetObjLst_Cache() )", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        switch (clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.CacheModeId) {
            case "04": //sessionStorage
                arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_sessionStorage(strid_XzMajor);
                break;
            case "03": //localStorage
                arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_localStorage(strid_XzMajor);
                break;
            case "02": //ClientCache
                arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_ClientCache(strid_XzMajor);
                break;
            default:
                arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_ClientCache(strid_XzMajor);
                break;
    ...
    * @returns 从本地缓存中获取的对象列表
    **/
    async function XzMajorDirection_GetObjLst_PureCache(strid_XzMajor) {
        //const strThisFuncName = "GetObjLst_PureCache";
        let arrXzMajorDirectionObjLst_Cache;
        switch (clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.CacheModeId) {
            case "04": //sessionStorage
                arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_sessionStorage_PureCache(strid_XzMajor);
                break;
            case "03": //localStorage
                arrXzMajorDirectionObjLst_Cache = await XzMajorDirection_GetObjLst_localStorage_PureCache(strid_XzMajor);
                break;
            case "02": //ClientCache
     ...
     * @returns 对象列表子集
    */
    async function XzMajorDirection_GetSubObjLst_Cache(objXzMajorDirection_Cond, strid_XzMajor) {
    ...
    **/
     ...
     * @returns 对象列表
    */
    async function XzMajorDirection_GetObjLstByMajorDirectionIdLst_Cache(arrMajorDirectionIdLst, strid_XzMajor) {
    ...
    */
     ...
     * @returns 对象列表
    */
    async function XzMajorDirection_GetObjLstByPager_Cache(objPagerPara, strid_XzMajor) {
    ...
    **/
    async function XzMajorDirection_DelRecordAsync(strMajorDirectionId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strMajorDirectionId);
        try {
    ...
    **/
    async function XzMajorDirection_UpdateRecordAsync(objXzMajorDirectionEN) {
        ...
        if (objXzMajorDirectionEN.sf_UpdFldSetStr === undefined || objXzMajorDirectionEN.sf_UpdFldSetStr === null || objXzMajorDirectionEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objXzMajorDirectionEN.majorDirectionId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.xzMajorDirection_Controller, strAction);
        try {
    ...
    **/
     ...
     * @returns 对象列表子集
    */
    async function XzMajorDirection_IsExistRecord_Cache(objXzMajorDirection_Cond, strid_XzMajor) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objXzMajorDirection_Cond), exports.xzMajorDirection_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
     ...
     * @returns 对象
    */
    async function XzMajorDirection_IsExist_Cache(strMajorDirectionId, strid_XzMajor) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strMajorDirectionId, exports.xzMajorDirection_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
     ...
     * @returns 对象列表记录数
    */
    async function XzMajorDirection_GetRecCountByCond_Cache(objXzMajorDirection_Cond, strid_XzMajor) {
    ...
    **/
    function XzMajorDirection_ReFreshCache(strid_XzMajor) {
        const strThisFuncName = "ReFreshCache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorDirectionWApi.clsXzMajorDirectionWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.clsXzMajorDirectionWApi.ReFreshCache)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    function XzMajorDirection_ReFreshThisCache(strid_XzMajor) {
    ...
    */
    async function XzMajorDirection_BindDdl_MajorDirectionIdInDiv_Cache(strDivName, strDdlName, strid_XzMajor) {
        const strThisFuncName = "BindDdl_MajorDirectionIdInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorDirectionWApi.BindDdl_MajorDirectionIdInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.BindDdl_MajorDirectionIdInDiv)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_MajorDirectionIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_MajorDirectionIdInDiv_Cache");
        const arrObjLst_Sel = await XzMajorDirection_GetObjLst_Cache(strid_XzMajor);
    ...
    exports.XzMajorDirection_BindDdl_MajorDirectionIdInDiv_Cache = XzMajorDirection_BindDdl_MajorDirectionIdInDiv_Cache;
    /**
     * 绑定基于Web的下拉框,在某一层下的下拉框
     * (AutoGCLib.WA_Access4TypeScript:Gen_4WA_TabFeature_DdlBindFunctionInDiv)
     * @param objDDL:需要绑定当前表的下拉框
     * @param strid_XzMajor:专业流水号
    */
    async function XzMajorDirection_BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache(strDivName, strDdlName, strid_XzMajor) {
        const strThisFuncName = "BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorDirectionWApi.BindDdl_MajorDirectionIdByid_XzMajorInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorDirectionWApi.BindDdl_MajorDirectionIdByid_XzMajorInDiv)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_MajorDirectionIdByid_XzMajorInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache");
        let arrObjLst_Sel = await XzMajorDirection_GetObjLst_Cache(strid_XzMajor);
        if (arrObjLst_Sel == null)
            return;
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionId, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionName, "专业方向");
    }
    exports.XzMajorDirection_BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache = XzMajorDirection_BindDdl_MajorDirectionIdByid_XzMajorInDiv_Cache;
    /**
    ...
    */
    function XzMajorDirection_CheckPropertyNew(pobjXzMajorDirectionEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.id_XzMajor) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionName) === true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 专业方向)!(clsXzMajorDirectionBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionId) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.majorDirectionId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.id_XzMajor) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionName) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.majorDirectionName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionENName) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.majorDirectionENName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionExplain) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.majorDirectionExplain) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorDirectionEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionId) == false && undefined !== pobjXzMajorDirectionEN.majorDirectionId && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.majorDirectionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.id_XzMajor) == false && undefined !== pobjXzMajorDirectionEN.id_XzMajor && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionName) == false && undefined !== pobjXzMajorDirectionEN.majorDirectionName && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.majorDirectionName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionENName) == false && undefined !== pobjXzMajorDirectionEN.majorDirectionENName && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.majorDirectionENName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionExplain) == false && undefined !== pobjXzMajorDirectionEN.majorDirectionExplain && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.majorDirectionExplain) === false) {
        ...
        if (null != pobjXzMajorDirectionEN.isVisible && undefined !== pobjXzMajorDirectionEN.isVisible && clsString_js_1.tzDataType.isBoolean(pobjXzMajorDirectionEN.isVisible) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.updDate) == false && undefined !== pobjXzMajorDirectionEN.updDate && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.updUser) == false && undefined !== pobjXzMajorDirectionEN.updUser && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.memo) == false && undefined !== pobjXzMajorDirectionEN.memo && clsString_js_1.tzDataType.isString(pobjXzMajorDirectionEN.memo) === false) {
    ...
    */
    function XzMajorDirection_CheckProperty4Update(pobjXzMajorDirectionEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorDirectionEN.majorDirectionId) === true
    ...
    */
    function XzMajorDirection_GetCombineCondition(objXzMajorDirection_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionId, objXzMajorDirection_Cond.majorDirectionId, strComparisonOp_MajorDirectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_id_XzMajor, objXzMajorDirection_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionName, objXzMajorDirection_Cond.majorDirectionName, strComparisonOp_MajorDirectionName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionENName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionENName, objXzMajorDirection_Cond.majorDirectionENName, strComparisonOp_MajorDirectionENName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionExplain) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_MajorDirectionExplain, objXzMajorDirection_Cond.majorDirectionExplain, strComparisonOp_MajorDirectionExplain);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_IsVisible) == true) {
            if (objXzMajorDirection_Cond.isVisible == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_IsVisible);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_IsVisible);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_UpdDate, objXzMajorDirection_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_UpdUser, objXzMajorDirection_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorDirection_Cond.dicFldComparisonOp, clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorDirectionEN_js_1.clsXzMajorDirectionEN.con_Memo, objXzMajorDirection_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function XzMajorDirection_GetUniCondStr_id_XzMajor_MajorDirectionName(objXzMajorDirectionEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_XzMajor = '{0}'", objXzMajorDirectionEN.id_XzMajor);
        strWhereCond += (0, clsString_js_2.Format)(" and MajorDirectionName = '{0}'", objXzMajorDirectionEN.majorDirectionName);
        return strWhereCond;
    }
    ...
    **/
    function XzMajorDirection_GetUniCondStr4Update_id_XzMajor_MajorDirectionName(objXzMajorDirectionEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and MajorDirectionId <> '{0}'", objXzMajorDirectionEN.majorDirectionId);
        strWhereCond += (0, clsString_js_2.Format)(" and id_XzMajor = '{0}'", objXzMajorDirectionEN.id_XzMajor);
        strWhereCond += (0, clsString_js_2.Format)(" and MajorDirectionName = '{0}'", objXzMajorDirectionEN.majorDirectionName);
        return strWhereCond;
    }
