...
(function (factory) {
    ...
    **/
    async function XzMajor_GetObjByid_XzMajorAsync(strid_XzMajor) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorWApi.GetObjByid_XzMajorAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorWApi.GetObjByid_XzMajorAsync)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.xzMajor_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.xzMajor_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function XzMajor_GetObjByid_XzMajor_Cache(strid_XzMajor, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorWApi.GetObjByid_XzMajor_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorWApi.GetObjByid_XzMajor_Cache)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrXzMajor_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objXzMajor_Const = await XzMajor_GetObjByid_XzMajorAsync(strid_XzMajor);
                    if (objXzMajor_Const != null) {
                        XzMajor_ReFreshThisCache();
                        return objXzMajor_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function XzMajor_GetObjByid_XzMajor_localStorage(strid_XzMajor) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorWApi.GetObjByid_XzMajor_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorWApi.GetObjByid_XzMajor_localStorage)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsXzMajorEN_js_1.clsXzMajorEN._CurrTabName, strid_XzMajor);
        if (strKey == "") {
    ...
    */
    async function XzMajor_GetNameByid_XzMajor_Cache(strid_XzMajor) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajor) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajor]不能为空！(In clsXzMajorWApi.GetNameByid_XzMajor_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajor.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajor]的长度:[{0}]不正确！(clsXzMajorWApi.GetNameByid_XzMajor_Cache)", strid_XzMajor.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrXzMajorObjLst_Cache = await XzMajor_GetObjLst_Cache();
    ...
    */
    async function XzMajor_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsXzMajorEN_js_1.clsXzMajorEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzMajorEN_js_1.clsXzMajorEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objXzMajor == null)
            return "";
        if (objXzMajor.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function XzMajor_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrXzMajor = await XzMajor_GetObjLst_Cache();
        if (arrXzMajor == null)
            return [];
        let arrXzMajor_Sel = arrXzMajor;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrXzMajor_Sel = arrXzMajor_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrXzMajor_Sel = arrXzMajor_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrXzMajor_Sel = arrXzMajor_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrXzMajor_Sel = arrXzMajor_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrXzMajor_Sel.length == 0)
            return [];
        return arrXzMajor_Sel.map(x => x.id_XzMajor);
    }
    exports.XzMajor_funcKey = XzMajor_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function XzMajor_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsXzMajorEN_js_1.clsXzMajorEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsXzMajorEN_js_1.clsXzMajorEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrXzMajorExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrXzMajorExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function XzMajor_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorExObjLst.length);
            console.log(strInfo);
            return arrXzMajorExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.xzMajor_ConstructorName, strThisFuncName);
    ...
    **/
    async function XzMajor_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorExObjLst.length);
            console.log(strInfo);
            return arrXzMajorExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrXzMajor_Sel = arrXzMajor_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function XzMajor_DelRecordAsync(strid_XzMajor) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strid_XzMajor);
        try {
    ...
    **/
    async function XzMajor_UpdateRecordAsync(objXzMajorEN) {
        ...
        if (objXzMajorEN.sf_UpdFldSetStr === undefined || objXzMajorEN.sf_UpdFldSetStr === null || objXzMajorEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objXzMajorEN.id_XzMajor);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.xzMajor_Controller, strAction);
        try {
    ...
    */
    async function XzMajor_IsExistRecord_Cache(objXzMajor_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objXzMajor_Cond), exports.xzMajor_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function XzMajor_IsExist_Cache(strid_XzMajor) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_XzMajor, exports.xzMajor_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function XzMajor_BindDdl_id_XzMajorByid_XzMajorShoolTypeInDiv_Cache(strDivName, strDdlName, strid_XzMajorShoolType) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajorShoolType) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajorShoolType]不能为空！(In clsXzMajorWApi.BindDdl_id_XzMajorByid_XzMajorShoolTypeInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajorShoolType.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajorShoolType]的长度:[{0}]不正确！(clsXzMajorWApi.BindDdl_id_XzMajorByid_XzMajorShoolTypeInDiv)", strid_XzMajorShoolType.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzMajorByid_XzMajorShoolTypeInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
     ...
     * @param objDDL:需要绑定当前表的下拉框
    */
    async function XzMajor_BindDdl_id_XzMajorInDiv_Cache(strDivName, strDdlName) {
        const strThisFuncName = "BindDdl_id_XzMajorInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzMajorInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_id_XzMajorInDiv_Cache");
        const arrObjLst_Sel = await XzMajor_GetObjLst_Cache();
        if (arrObjLst_Sel == null)
            return;
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzMajor, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorName, "专业");
    }
    exports.XzMajor_BindDdl_id_XzMajorInDiv_Cache = XzMajor_BindDdl_id_XzMajorInDiv_Cache;
    /**
     * 绑定基于Web的下拉框,在某一层下的下拉框
     * (AutoGCLib.WA_Access4TypeScript:Gen_4WA_TabFeature_DdlBindFunctionInDiv)
     * @param objDDL:需要绑定当前表的下拉框
     * @param strid_XzCollege:学院流水号
    */
    async function XzMajor_BindDdl_id_XzMajorByid_XzCollegeInDiv_Cache(strDivName, strDdlName, strid_XzCollege) {
        const strThisFuncName = "BindDdl_id_XzMajorByid_XzCollegeInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzCollege]不能为空！(In clsXzMajorWApi.BindDdl_id_XzMajorByid_XzCollegeInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzCollege.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzCollege]的长度:[{0}]不正确！(clsXzMajorWApi.BindDdl_id_XzMajorByid_XzCollegeInDiv)", strid_XzCollege.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzMajorByid_XzCollegeInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_id_XzMajorByid_XzCollegeInDiv_Cache");
        let arrObjLst_Sel = await XzMajor_GetObjLst_Cache();
        if (arrObjLst_Sel == null)
            return;
        arrObjLst_Sel = arrObjLst_Sel.filter(x => x.id_XzCollege == strid_XzCollege);
        (0, clsCommFunc4Web_js_1.BindDdl_ObjLstInDiv)(strDivName, strDdlName, arrObjLst_Sel, clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzMajor, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorName, "专业");
    }
    exports.XzMajor_BindDdl_id_XzMajorByid_XzCollegeInDiv_Cache = XzMajor_BindDdl_id_XzMajorByid_XzCollegeInDiv_Cache;
    /**
    ...
    */
    function XzMajor_CheckPropertyNew(pobjXzMajorEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorID) === true) {
            throw new Error("(errid:Watl000058)字段[专业ID]不能为空(In 专业)!(clsXzMajorBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorName) === true) {
            throw new Error("(errid:Watl000058)字段[专业名称]不能为空(In 专业)!(clsXzMajorBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzCollege) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzMajor) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorID) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.majorID) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorName) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.majorName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorEnglishName) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.majorEnglishName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorExplain) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.majorExplain) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorNationalID) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.majorNationalID) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzCollege) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_MajorType) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.id_MajorType) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_DegreeType) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.id_DegreeType) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorDirection) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.majorDirection) > 30) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.modifyDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.modifyDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.modifyUserID) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.modifyUserID) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.memo) > 1000) {
            throw new Error("(errid:Watl000059)字段[备注(memo)]的长度不能超过1000(In 专业(XzMajor))!值:$(pobjXzMajorEN.memo)(clsXzMajorBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzMajorShoolType) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorEN.id_XzMajorShoolType) > 4) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzMajor) == false && undefined !== pobjXzMajorEN.id_XzMajor && clsString_js_1.tzDataType.isString(pobjXzMajorEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorID) == false && undefined !== pobjXzMajorEN.majorID && clsString_js_1.tzDataType.isString(pobjXzMajorEN.majorID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorName) == false && undefined !== pobjXzMajorEN.majorName && clsString_js_1.tzDataType.isString(pobjXzMajorEN.majorName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorEnglishName) == false && undefined !== pobjXzMajorEN.majorEnglishName && clsString_js_1.tzDataType.isString(pobjXzMajorEN.majorEnglishName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorExplain) == false && undefined !== pobjXzMajorEN.majorExplain && clsString_js_1.tzDataType.isString(pobjXzMajorEN.majorExplain) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorNationalID) == false && undefined !== pobjXzMajorEN.majorNationalID && clsString_js_1.tzDataType.isString(pobjXzMajorEN.majorNationalID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzCollege) == false && undefined !== pobjXzMajorEN.id_XzCollege && clsString_js_1.tzDataType.isString(pobjXzMajorEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_MajorType) == false && undefined !== pobjXzMajorEN.id_MajorType && clsString_js_1.tzDataType.isString(pobjXzMajorEN.id_MajorType) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_DegreeType) == false && undefined !== pobjXzMajorEN.id_DegreeType && clsString_js_1.tzDataType.isString(pobjXzMajorEN.id_DegreeType) === false) {
        ...
        if (null != pobjXzMajorEN.isMainMajor && undefined !== pobjXzMajorEN.isMainMajor && clsString_js_1.tzDataType.isBoolean(pobjXzMajorEN.isMainMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.majorDirection) == false && undefined !== pobjXzMajorEN.majorDirection && clsString_js_1.tzDataType.isString(pobjXzMajorEN.majorDirection) === false) {
        ...
        if (null != pobjXzMajorEN.isVisible && undefined !== pobjXzMajorEN.isVisible && clsString_js_1.tzDataType.isBoolean(pobjXzMajorEN.isVisible) === false) {
        ...
        if (null != pobjXzMajorEN.isNormal && undefined !== pobjXzMajorEN.isNormal && clsString_js_1.tzDataType.isBoolean(pobjXzMajorEN.isNormal) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.modifyDate) == false && undefined !== pobjXzMajorEN.modifyDate && clsString_js_1.tzDataType.isString(pobjXzMajorEN.modifyDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.modifyUserID) == false && undefined !== pobjXzMajorEN.modifyUserID && clsString_js_1.tzDataType.isString(pobjXzMajorEN.modifyUserID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.memo) == false && undefined !== pobjXzMajorEN.memo && clsString_js_1.tzDataType.isString(pobjXzMajorEN.memo) === false) {
            throw new Error("(errid:Watl000060)字段[备注(memo)]的值:[$(pobjXzMajorEN.memo)], 非法，应该为字符型(In 专业(XzMajor))!(clsXzMajorBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzMajorShoolType) == false && undefined !== pobjXzMajorEN.id_XzMajorShoolType && clsString_js_1.tzDataType.isString(pobjXzMajorEN.id_XzMajorShoolType) === false) {
    ...
    */
    function XzMajor_CheckProperty4Update(pobjXzMajorEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorEN.id_XzMajor) === true
    ...
    */
    function XzMajor_GetCombineCondition(objXzMajor_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzMajor, objXzMajor_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_MajorID, objXzMajor_Cond.majorID, strComparisonOp_MajorID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_MajorName, objXzMajor_Cond.majorName, strComparisonOp_MajorName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorEnglishName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_MajorEnglishName, objXzMajor_Cond.majorEnglishName, strComparisonOp_MajorEnglishName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorExplain) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_MajorExplain, objXzMajor_Cond.majorExplain, strComparisonOp_MajorExplain);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorNationalID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_MajorNationalID, objXzMajor_Cond.majorNationalID, strComparisonOp_MajorNationalID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzCollege, objXzMajor_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_id_MajorType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_id_MajorType, objXzMajor_Cond.id_MajorType, strComparisonOp_id_MajorType);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_id_DegreeType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_id_DegreeType, objXzMajor_Cond.id_DegreeType, strComparisonOp_id_DegreeType);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_IsMainMajor) == true) {
            if (objXzMajor_Cond.isMainMajor == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzMajorEN_js_1.clsXzMajorEN.con_IsMainMajor);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzMajorEN_js_1.clsXzMajorEN.con_IsMainMajor);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_MajorDirection) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_MajorDirection, objXzMajor_Cond.majorDirection, strComparisonOp_MajorDirection);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_IsVisible) == true) {
            if (objXzMajor_Cond.isVisible == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzMajorEN_js_1.clsXzMajorEN.con_IsVisible);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzMajorEN_js_1.clsXzMajorEN.con_IsVisible);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_IsNormal) == true) {
            if (objXzMajor_Cond.isNormal == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzMajorEN_js_1.clsXzMajorEN.con_IsNormal);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzMajorEN_js_1.clsXzMajorEN.con_IsNormal);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_ModifyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_ModifyDate, objXzMajor_Cond.modifyDate, strComparisonOp_ModifyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_ModifyUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_ModifyUserID, objXzMajor_Cond.modifyUserID, strComparisonOp_ModifyUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_Memo, objXzMajor_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajor_Cond.dicFldComparisonOp, clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzMajorShoolType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorEN_js_1.clsXzMajorEN.con_id_XzMajorShoolType, objXzMajor_Cond.id_XzMajorShoolType, strComparisonOp_id_XzMajorShoolType);
        }
        return strWhereCond;
    }
    ...
    **/
    function XzMajor_GetUniCondStr_id_XzMajor(objXzMajorEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_XzMajor = '{0}'", objXzMajorEN.id_XzMajor);
        return strWhereCond;
    }
