...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/BaseInfo_Share/clsXzClgEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function XzClg_GetObjByid_XzCollegeAsync(strid_XzCollege) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzCollege]不能为空！(In clsXzClgWApi.GetObjByid_XzCollegeAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzCollege.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzCollege]的长度:[{0}]不正确！(clsXzClgWApi.GetObjByid_XzCollegeAsync)", strid_XzCollege.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.xzClg_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.xzClg_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function XzClg_GetObjByid_XzCollege_Cache(strid_XzCollege, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzCollege]不能为空！(In clsXzClgWApi.GetObjByid_XzCollege_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzCollege.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzCollege]的长度:[{0}]不正确！(clsXzClgWApi.GetObjByid_XzCollege_Cache)", strid_XzCollege.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function XzClg_GetObjByid_XzCollege_localStorage(strid_XzCollege) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzCollege]不能为空！(In clsXzClgWApi.GetObjByid_XzCollege_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzCollege.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzCollege]的长度:[{0}]不正确！(clsXzClgWApi.GetObjByid_XzCollege_localStorage)", strid_XzCollege.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsXzClgEN_js_1.clsXzClgEN._CurrTabName, strid_XzCollege);
        if (strKey == "") {
    ...
    */
    async function XzClg_GetNameByid_XzCollege_Cache(strid_XzCollege) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzCollege]不能为空！(In clsXzClgWApi.GetNameByid_XzCollege_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzCollege.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzCollege]的长度:[{0}]不正确！(clsXzClgWApi.GetNameByid_XzCollege_Cache)", strid_XzCollege.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrXzClgObjLst_Cache = await XzClg_GetObjLst_Cache();
    ...
    */
    async function XzClg_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsXzClgEN_js_1.clsXzClgEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzClgEN_js_1.clsXzClgEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function XzClg_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsXzClgEN_js_1.clsXzClgEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsXzClgEN_js_1.clsXzClgEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrXzClgExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrXzClgExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzClgExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function XzClg_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzClgExObjLst.length);
            console.log(strInfo);
            return arrXzClgExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.xzClg_ConstructorName, strThisFuncName);
    ...
    **/
    async function XzClg_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzClgExObjLst.length);
            console.log(strInfo);
            return arrXzClgExObjLst;
        }
        catch (e) {
    ...
    **/
    async function XzClg_DelRecordAsync(strid_XzCollege) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strid_XzCollege);
        try {
    ...
    **/
    async function XzClg_UpdateRecordAsync(objXzClgEN) {
        ...
        if (objXzClgEN.sf_UpdFldSetStr === undefined || objXzClgEN.sf_UpdFldSetStr === null || objXzClgEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objXzClgEN.id_XzCollege);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.xzClg_Controller, strAction);
        try {
    ...
    */
    async function XzClg_IsExistRecord_Cache(objXzClg_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objXzClg_Cond), exports.xzClg_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function XzClg_IsExist_Cache(strid_XzCollege) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_XzCollege, exports.xzClg_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function XzClg_BindDdl_id_XzCollegeInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzCollegeInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function XzClg_CheckPropertyNew(pobjXzClgEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeID) === true) {
            throw new Error("(errid:Watl000058)字段[学院ID]不能为空(In 学院)!(clsXzClgBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeName) === true) {
            throw new Error("(errid:Watl000058)字段[学院名称]不能为空(In 学院)!(clsXzClgBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeNameA) === true) {
            throw new Error("(errid:Watl000058)字段[学院名称简写]不能为空(In 学院)!(clsXzClgBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_XzCollege) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeID) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.collegeID) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeName) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.collegeName) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeIdInGP) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.collegeIdInGP) > 6) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.clgEnglishName) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.clgEnglishName) > 60) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeNameA) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.collegeNameA) > 12) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.phoneNumber) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.phoneNumber) > 15) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.webSite) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.webSite) > 60) {
            throw new Error("(errid:Watl000059)字段[个人主页(webSite)]的长度不能超过60(In 学院(XzClg))!值:$(pobjXzClgEN.webSite)(clsXzClgBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_School) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.id_School) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_Uni) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.id_Uni) > 4) {
            throw new Error("(errid:Watl000059)字段[id_Uni(id_Uni)]的长度不能超过4(In 学院(XzClg))!值:$(pobjXzClgEN.id_Uni)(clsXzClgBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.modifyDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.modifyDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.modifyUserID) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.modifyUserID) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjXzClgEN.memo) > 1000) {
            throw new Error("(errid:Watl000059)字段[备注(memo)]的长度不能超过1000(In 学院(XzClg))!值:$(pobjXzClgEN.memo)(clsXzClgBL:CheckPropertyNew)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_XzCollege) == false && undefined !== pobjXzClgEN.id_XzCollege && clsString_js_1.tzDataType.isString(pobjXzClgEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeID) == false && undefined !== pobjXzClgEN.collegeID && clsString_js_1.tzDataType.isString(pobjXzClgEN.collegeID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeName) == false && undefined !== pobjXzClgEN.collegeName && clsString_js_1.tzDataType.isString(pobjXzClgEN.collegeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeIdInGP) == false && undefined !== pobjXzClgEN.collegeIdInGP && clsString_js_1.tzDataType.isString(pobjXzClgEN.collegeIdInGP) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.clgEnglishName) == false && undefined !== pobjXzClgEN.clgEnglishName && clsString_js_1.tzDataType.isString(pobjXzClgEN.clgEnglishName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.collegeNameA) == false && undefined !== pobjXzClgEN.collegeNameA && clsString_js_1.tzDataType.isString(pobjXzClgEN.collegeNameA) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.phoneNumber) == false && undefined !== pobjXzClgEN.phoneNumber && clsString_js_1.tzDataType.isString(pobjXzClgEN.phoneNumber) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.webSite) == false && undefined !== pobjXzClgEN.webSite && clsString_js_1.tzDataType.isString(pobjXzClgEN.webSite) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_School) == false && undefined !== pobjXzClgEN.id_School && clsString_js_1.tzDataType.isString(pobjXzClgEN.id_School) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_Uni) == false && undefined !== pobjXzClgEN.id_Uni && clsString_js_1.tzDataType.isString(pobjXzClgEN.id_Uni) === false) {
        ...
        if (null != pobjXzClgEN.isVisible4Tea && undefined !== pobjXzClgEN.isVisible4Tea && clsString_js_1.tzDataType.isBoolean(pobjXzClgEN.isVisible4Tea) === false) {
        ...
        if (null != pobjXzClgEN.isVisible && undefined !== pobjXzClgEN.isVisible && clsString_js_1.tzDataType.isBoolean(pobjXzClgEN.isVisible) === false) {
        ...
        if (null != pobjXzClgEN.orderNum && undefined !== pobjXzClgEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjXzClgEN.orderNum) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.modifyDate) == false && undefined !== pobjXzClgEN.modifyDate && clsString_js_1.tzDataType.isString(pobjXzClgEN.modifyDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.modifyUserID) == false && undefined !== pobjXzClgEN.modifyUserID && clsString_js_1.tzDataType.isString(pobjXzClgEN.modifyUserID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.memo) == false && undefined !== pobjXzClgEN.memo && clsString_js_1.tzDataType.isString(pobjXzClgEN.memo) === false) {
    ...
    */
    function XzClg_CheckProperty4Update(pobjXzClgEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzClgEN.id_XzCollege) === true
    ...
    */
    function XzClg_GetCombineCondition(objXzClg_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_id_XzCollege, objXzClg_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_CollegeID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_CollegeID, objXzClg_Cond.collegeID, strComparisonOp_CollegeID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_CollegeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_CollegeName, objXzClg_Cond.collegeName, strComparisonOp_CollegeName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_CollegeIdInGP) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_CollegeIdInGP, objXzClg_Cond.collegeIdInGP, strComparisonOp_CollegeIdInGP);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_ClgEnglishName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_ClgEnglishName, objXzClg_Cond.clgEnglishName, strComparisonOp_ClgEnglishName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_CollegeNameA) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_CollegeNameA, objXzClg_Cond.collegeNameA, strComparisonOp_CollegeNameA);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_PhoneNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_PhoneNumber, objXzClg_Cond.phoneNumber, strComparisonOp_PhoneNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_WebSite) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_WebSite, objXzClg_Cond.webSite, strComparisonOp_WebSite);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_id_School) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_id_School, objXzClg_Cond.id_School, strComparisonOp_id_School);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_id_Uni) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_id_Uni, objXzClg_Cond.id_Uni, strComparisonOp_id_Uni);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_IsVisible4Tea) == true) {
            if (objXzClg_Cond.isVisible4Tea == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzClgEN_js_1.clsXzClgEN.con_IsVisible4Tea);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzClgEN_js_1.clsXzClgEN.con_IsVisible4Tea);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_IsVisible) == true) {
            if (objXzClg_Cond.isVisible == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzClgEN_js_1.clsXzClgEN.con_IsVisible);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzClgEN_js_1.clsXzClgEN.con_IsVisible);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsXzClgEN_js_1.clsXzClgEN.con_OrderNum, objXzClg_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_ModifyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_ModifyDate, objXzClg_Cond.modifyDate, strComparisonOp_ModifyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_ModifyUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_ModifyUserID, objXzClg_Cond.modifyUserID, strComparisonOp_ModifyUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzClg_Cond.dicFldComparisonOp, clsXzClgEN_js_1.clsXzClgEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzClgEN_js_1.clsXzClgEN.con_Memo, objXzClg_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
