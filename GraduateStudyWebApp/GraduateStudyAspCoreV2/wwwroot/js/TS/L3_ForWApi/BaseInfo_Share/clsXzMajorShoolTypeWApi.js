...
(function (factory) {
    ...
    **/
    async function XzMajorShoolType_GetObjByid_XzMajorShoolTypeAsync(strid_XzMajorShoolType) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajorShoolType) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajorShoolType]不能为空！(In clsXzMajorShoolTypeWApi.GetObjByid_XzMajorShoolTypeAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajorShoolType.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajorShoolType]的长度:[{0}]不正确！(clsXzMajorShoolTypeWApi.GetObjByid_XzMajorShoolTypeAsync)", strid_XzMajorShoolType.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.xzMajorShoolType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.xzMajorShoolType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function XzMajorShoolType_GetObjByid_XzMajorShoolType_Cache(strid_XzMajorShoolType, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajorShoolType) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajorShoolType]不能为空！(In clsXzMajorShoolTypeWApi.GetObjByid_XzMajorShoolType_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajorShoolType.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajorShoolType]的长度:[{0}]不正确！(clsXzMajorShoolTypeWApi.GetObjByid_XzMajorShoolType_Cache)", strid_XzMajorShoolType.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrXzMajorShoolType_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objXzMajorShoolType_Const = await XzMajorShoolType_GetObjByid_XzMajorShoolTypeAsync(strid_XzMajorShoolType);
                    if (objXzMajorShoolType_Const != null) {
                        XzMajorShoolType_ReFreshThisCache();
                        return objXzMajorShoolType_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function XzMajorShoolType_GetObjByid_XzMajorShoolType_localStorage(strid_XzMajorShoolType) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajorShoolType) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajorShoolType]不能为空！(In clsXzMajorShoolTypeWApi.GetObjByid_XzMajorShoolType_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajorShoolType.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajorShoolType]的长度:[{0}]不正确！(clsXzMajorShoolTypeWApi.GetObjByid_XzMajorShoolType_localStorage)", strid_XzMajorShoolType.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN._CurrTabName, strid_XzMajorShoolType);
        if (strKey == "") {
    ...
    */
    async function XzMajorShoolType_GetNameByid_XzMajorShoolType_Cache(strid_XzMajorShoolType) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_XzMajorShoolType) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_XzMajorShoolType]不能为空！(In clsXzMajorShoolTypeWApi.GetNameByid_XzMajorShoolType_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzMajorShoolType.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_XzMajorShoolType]的长度:[{0}]不正确！(clsXzMajorShoolTypeWApi.GetNameByid_XzMajorShoolType_Cache)", strid_XzMajorShoolType.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrXzMajorShoolTypeObjLst_Cache = await XzMajorShoolType_GetObjLst_Cache();
    ...
    */
    async function XzMajorShoolType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objXzMajorShoolType == null)
            return "";
        if (objXzMajorShoolType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function XzMajorShoolType_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrXzMajorShoolType = await XzMajorShoolType_GetObjLst_Cache();
        if (arrXzMajorShoolType == null)
            return [];
        let arrXzMajorShoolType_Sel = arrXzMajorShoolType;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrXzMajorShoolType_Sel = arrXzMajorShoolType_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrXzMajorShoolType_Sel = arrXzMajorShoolType_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrXzMajorShoolType_Sel = arrXzMajorShoolType_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrXzMajorShoolType_Sel = arrXzMajorShoolType_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrXzMajorShoolType_Sel.length == 0)
            return [];
        return arrXzMajorShoolType_Sel.map(x => x.id_XzMajorShoolType);
    }
    exports.XzMajorShoolType_funcKey = XzMajorShoolType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function XzMajorShoolType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrXzMajorShoolTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrXzMajorShoolTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorShoolTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function XzMajorShoolType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorShoolTypeExObjLst.length);
            console.log(strInfo);
            return arrXzMajorShoolTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.xzMajorShoolType_ConstructorName, strThisFuncName);
    ...
    **/
    async function XzMajorShoolType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzMajorShoolTypeExObjLst.length);
            console.log(strInfo);
            return arrXzMajorShoolTypeExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrXzMajorShoolType_Sel = arrXzMajorShoolType_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function XzMajorShoolType_DelRecordAsync(strid_XzMajorShoolType) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strid_XzMajorShoolType);
        try {
    ...
    **/
    async function XzMajorShoolType_UpdateRecordAsync(objXzMajorShoolTypeEN) {
        ...
        if (objXzMajorShoolTypeEN.sf_UpdFldSetStr === undefined || objXzMajorShoolTypeEN.sf_UpdFldSetStr === null || objXzMajorShoolTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objXzMajorShoolTypeEN.id_XzMajorShoolType);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.xzMajorShoolType_Controller, strAction);
        try {
    ...
    */
    async function XzMajorShoolType_IsExistRecord_Cache(objXzMajorShoolType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objXzMajorShoolType_Cond), exports.xzMajorShoolType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function XzMajorShoolType_IsExist_Cache(strid_XzMajorShoolType) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_XzMajorShoolType, exports.xzMajorShoolType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function XzMajorShoolType_BindDdl_id_XzMajorShoolTypeInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_XzMajorShoolTypeInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function XzMajorShoolType_CheckPropertyNew(pobjXzMajorShoolTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.typeName) === true) {
            throw new Error("(errid:Watl000058)字段[类型名称]不能为空(In 专业学校类型)!(clsXzMajorShoolTypeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.id_XzMajorShoolType) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorShoolTypeEN.id_XzMajorShoolType) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.typeName) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorShoolTypeEN.typeName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorShoolTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorShoolTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjXzMajorShoolTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.id_XzMajorShoolType) == false && undefined !== pobjXzMajorShoolTypeEN.id_XzMajorShoolType && clsString_js_1.tzDataType.isString(pobjXzMajorShoolTypeEN.id_XzMajorShoolType) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.typeName) == false && undefined !== pobjXzMajorShoolTypeEN.typeName && clsString_js_1.tzDataType.isString(pobjXzMajorShoolTypeEN.typeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.updUserId) == false && undefined !== pobjXzMajorShoolTypeEN.updUserId && clsString_js_1.tzDataType.isString(pobjXzMajorShoolTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.updDate) == false && undefined !== pobjXzMajorShoolTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjXzMajorShoolTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.memo) == false && undefined !== pobjXzMajorShoolTypeEN.memo && clsString_js_1.tzDataType.isString(pobjXzMajorShoolTypeEN.memo) === false) {
    ...
    */
    function XzMajorShoolType_CheckProperty4Update(pobjXzMajorShoolTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzMajorShoolTypeEN.id_XzMajorShoolType) === true) {
    ...
    */
    function XzMajorShoolType_GetCombineCondition(objXzMajorShoolType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objXzMajorShoolType_Cond.dicFldComparisonOp, clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_id_XzMajorShoolType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_id_XzMajorShoolType, objXzMajorShoolType_Cond.id_XzMajorShoolType, strComparisonOp_id_XzMajorShoolType);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorShoolType_Cond.dicFldComparisonOp, clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_TypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_TypeName, objXzMajorShoolType_Cond.typeName, strComparisonOp_TypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorShoolType_Cond.dicFldComparisonOp, clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_UpdUserId, objXzMajorShoolType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorShoolType_Cond.dicFldComparisonOp, clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_UpdDate, objXzMajorShoolType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzMajorShoolType_Cond.dicFldComparisonOp, clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzMajorShoolTypeEN_js_1.clsXzMajorShoolTypeEN.con_Memo, objXzMajorShoolType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function XzMajorShoolType_GetUniCondStr_id_XzMajorShoolType(objXzMajorShoolTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_XzMajorShoolType = '{0}'", objXzMajorShoolTypeEN.id_XzMajorShoolType);
        return strWhereCond;
    }
