...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/BaseInfo_Share/clsvXzClgEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vXzClg_GetObjByid_XzCollegeAsync(strid_XzCollege) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_XzCollege) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_XzCollege]不能为空！(In clsvXzClgWApi.GetObjByid_XzCollegeAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_XzCollege.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_XzCollege]的长度:[{0}]不正确！(clsvXzClgWApi.GetObjByid_XzCollegeAsync)", strid_XzCollege.length);
            console.error(strMsg);
            throw (strMsg);
        }
