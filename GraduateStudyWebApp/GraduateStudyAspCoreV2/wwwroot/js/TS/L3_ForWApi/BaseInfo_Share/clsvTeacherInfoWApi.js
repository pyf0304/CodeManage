...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/BaseInfo_Share/clsvTeacherInfoEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vTeacherInfo_GetObjByid_TeacherAsync(strid_Teacher) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_Teacher]不能为空！(In clsvTeacherInfoWApi.GetObjByid_TeacherAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsvTeacherInfoWApi.GetObjByid_TeacherAsync)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vTeacherInfo_GetObjByid_Teacher_Cache(strid_Teacher, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_Teacher]不能为空！(In clsvTeacherInfoWApi.GetObjByid_Teacher_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsvTeacherInfoWApi.GetObjByid_Teacher_Cache)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vTeacherInfo_GetObjByid_Teacher_localStorage(strid_Teacher) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_Teacher]不能为空！(In clsvTeacherInfoWApi.GetObjByid_Teacher_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsvTeacherInfoWApi.GetObjByid_Teacher_localStorage)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vTeacherInfo_GetNameByid_Teacher_Cache(strid_Teacher) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_Teacher) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_Teacher]不能为空！(In clsvTeacherInfoWApi.GetNameByid_Teacher_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_Teacher.length != 8) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_Teacher]的长度:[{0}]不正确！(clsvTeacherInfoWApi.GetNameByid_Teacher_Cache)", strid_Teacher.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrvTeacherInfoObjLst_Cache = await vTeacherInfo_GetObjLst_Cache();
    ...
    **/
    async function vTeacherInfo_GetObjLst_ClientCache() {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvTeacherInfoExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvTeacherInfoExObjLst);
