...
(function (factory) {
    ...
    **/
    async function Users_GetObjByUserIdAsync(strUserId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId]不能为空！(In clsUsersWApi.GetObjByUserIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.users_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.users_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function Users_GetObjByUserId_Cache(strUserId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId]不能为空！(In clsUsersWApi.GetObjByUserId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrUsers_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objUsers_Const = await Users_GetObjByUserIdAsync(strUserId);
                    if (objUsers_Const != null) {
                        Users_ReFreshThisCache();
                        return objUsers_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function Users_GetObjByUserId_localStorage(strUserId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId]不能为空！(In clsUsersWApi.GetObjByUserId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsUsersEN_js_1.clsUsersEN._CurrTabName, strUserId);
        if (strKey == "") {
    ...
    */
    async function Users_GetNameByUserId_Cache(strUserId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId]不能为空！(In clsUsersWApi.GetNameByUserId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        const arrUsersObjLst_Cache = await Users_GetObjLst_Cache();
    ...
    */
    async function Users_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsUsersEN_js_1.clsUsersEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsUsersEN_js_1.clsUsersEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objUsers == null)
            return "";
        if (objUsers.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function Users_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrUsers = await Users_GetObjLst_Cache();
        if (arrUsers == null)
            return [];
        let arrUsers_Sel = arrUsers;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrUsers_Sel = arrUsers_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrUsers_Sel = arrUsers_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrUsers_Sel = arrUsers_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrUsers_Sel = arrUsers_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrUsers_Sel.length == 0)
            return [];
        return arrUsers_Sel.map(x => x.userId);
    }
    exports.Users_funcKey = Users_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function Users_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsUsersEN_js_1.clsUsersEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsUsersEN_js_1.clsUsersEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrUsersExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrUsersExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrUsersExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function Users_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrUsersExObjLst.length);
            console.log(strInfo);
            return arrUsersExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.users_ConstructorName, strThisFuncName);
    ...
    **/
    async function Users_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrUsersExObjLst.length);
            console.log(strInfo);
            return arrUsersExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrUsers_Sel = arrUsers_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function Users_UpdateRecordAsync(objUsersEN) {
        ...
        if (objUsersEN.sf_UpdFldSetStr === undefined || objUsersEN.sf_UpdFldSetStr === null || objUsersEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objUsersEN.userId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.users_Controller, strAction);
        try {
    ...
    */
    async function Users_IsExistRecord_Cache(objUsers_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objUsers_Cond), exports.users_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function Users_IsExist_Cache(strUserId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strUserId, exports.users_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function Users_CheckPropertyNew(pobjUsersEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userName) === true) {
            throw new Error("(errid:Watl000058)字段[用户名]不能为空(In 用户)!(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userStateId) === true) {
            throw new Error("(errid:Watl000058)字段[用户状态Id]不能为空(In 用户)!(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.identityID) === true
            || pobjUsersEN.identityID.toString() === "0") {
            throw new Error("(errid:Watl000058)字段[身份编号]不能为空(In 用户)!(clsUsersBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.userId) > 18) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过18(In 用户(Users))!值:$(pobjUsersEN.userId)(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userName) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.userName) > 30) {
            throw new Error("(errid:Watl000059)字段[用户名(userName)]的长度不能超过30(In 用户(Users))!值:$(pobjUsersEN.userName)(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.departmentId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.departmentId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userStateId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.userStateId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.password) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.password) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.schoolID1) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.schoolID1) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.beginYearMonth) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.beginYearMonth) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.endYearMonth) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.endYearMonth) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.id_GradeBase) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.id_GradeBase) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.id_XzCollege) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.id_XzMajor) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.stuIdTeacherId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.stuIdTeacherId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.email) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.email) > 100) {
            throw new Error("(errid:Watl000059)字段[电子邮箱(email)]的长度不能超过100(In 用户(Users))!值:$(pobjUsersEN.email)(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.phoneNumber) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.phoneNumber) > 15) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.avatarsPicture) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.avatarsPicture) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.identityID) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.identityID) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.auditDate) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.auditDate) > 14) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.auditUser) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.auditUser) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.registerDate) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.registerDate) > 14) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.mobilePhone) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.mobilePhone) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.openId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.openId) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.updDate) > 20) {
            throw new Error("(errid:Watl000059)字段[修改日期(updDate)]的长度不能超过20(In 用户(Users))!值:$(pobjUsersEN.updDate)(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.updUser) > 20) {
            throw new Error("(errid:Watl000059)字段[修改人(updUser)]的长度不能超过20(In 用户(Users))!值:$(pobjUsersEN.updUser)(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.memo) > 1000) {
            throw new Error("(errid:Watl000059)字段[备注(memo)]的长度不能超过1000(In 用户(Users))!值:$(pobjUsersEN.memo)(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.headPic) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.headPic) > 500) {
            throw new Error("(errid:Watl000059)字段[头像(headPic)]的长度不能超过500(In 用户(Users))!值:$(pobjUsersEN.headPic)(clsUsersBL:CheckPropertyNew)");
        }
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userId) == false && undefined !== pobjUsersEN.userId && clsString_js_1.tzDataType.isString(pobjUsersEN.userId) === false) {
            throw new Error("(errid:Watl000060)字段[用户ID(userId)]的值:[$(pobjUsersEN.userId)], 非法，应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userName) == false && undefined !== pobjUsersEN.userName && clsString_js_1.tzDataType.isString(pobjUsersEN.userName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.departmentId) == false && undefined !== pobjUsersEN.departmentId && clsString_js_1.tzDataType.isString(pobjUsersEN.departmentId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userStateId) == false && undefined !== pobjUsersEN.userStateId && clsString_js_1.tzDataType.isString(pobjUsersEN.userStateId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.password) == false && undefined !== pobjUsersEN.password && clsString_js_1.tzDataType.isString(pobjUsersEN.password) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.schoolID1) == false && undefined !== pobjUsersEN.schoolID1 && clsString_js_1.tzDataType.isString(pobjUsersEN.schoolID1) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.beginYearMonth) == false && undefined !== pobjUsersEN.beginYearMonth && clsString_js_1.tzDataType.isString(pobjUsersEN.beginYearMonth) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.endYearMonth) == false && undefined !== pobjUsersEN.endYearMonth && clsString_js_1.tzDataType.isString(pobjUsersEN.endYearMonth) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.id_GradeBase) == false && undefined !== pobjUsersEN.id_GradeBase && clsString_js_1.tzDataType.isString(pobjUsersEN.id_GradeBase) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.id_XzCollege) == false && undefined !== pobjUsersEN.id_XzCollege && clsString_js_1.tzDataType.isString(pobjUsersEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.id_XzMajor) == false && undefined !== pobjUsersEN.id_XzMajor && clsString_js_1.tzDataType.isString(pobjUsersEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.stuIdTeacherId) == false && undefined !== pobjUsersEN.stuIdTeacherId && clsString_js_1.tzDataType.isString(pobjUsersEN.stuIdTeacherId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.email) == false && undefined !== pobjUsersEN.email && clsString_js_1.tzDataType.isString(pobjUsersEN.email) === false) {
            throw new Error("(errid:Watl000060)字段[电子邮箱(email)]的值:[$(pobjUsersEN.email)], 非法，应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.phoneNumber) == false && undefined !== pobjUsersEN.phoneNumber && clsString_js_1.tzDataType.isString(pobjUsersEN.phoneNumber) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.avatarsPicture) == false && undefined !== pobjUsersEN.avatarsPicture && clsString_js_1.tzDataType.isString(pobjUsersEN.avatarsPicture) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.identityID) == false && undefined !== pobjUsersEN.identityID && clsString_js_1.tzDataType.isString(pobjUsersEN.identityID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.auditDate) == false && undefined !== pobjUsersEN.auditDate && clsString_js_1.tzDataType.isString(pobjUsersEN.auditDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.auditUser) == false && undefined !== pobjUsersEN.auditUser && clsString_js_1.tzDataType.isString(pobjUsersEN.auditUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.registerDate) == false && undefined !== pobjUsersEN.registerDate && clsString_js_1.tzDataType.isString(pobjUsersEN.registerDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.mobilePhone) == false && undefined !== pobjUsersEN.mobilePhone && clsString_js_1.tzDataType.isString(pobjUsersEN.mobilePhone) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.openId) == false && undefined !== pobjUsersEN.openId && clsString_js_1.tzDataType.isString(pobjUsersEN.openId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.updDate) == false && undefined !== pobjUsersEN.updDate && clsString_js_1.tzDataType.isString(pobjUsersEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.updUser) == false && undefined !== pobjUsersEN.updUser && clsString_js_1.tzDataType.isString(pobjUsersEN.updUser) === false) {
            throw new Error("(errid:Watl000060)字段[修改人(updUser)]的值:[$(pobjUsersEN.updUser)], 非法，应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.memo) == false && undefined !== pobjUsersEN.memo && clsString_js_1.tzDataType.isString(pobjUsersEN.memo) === false) {
            throw new Error("(errid:Watl000060)字段[备注(memo)]的值:[$(pobjUsersEN.memo)], 非法，应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.headPic) == false && undefined !== pobjUsersEN.headPic && clsString_js_1.tzDataType.isString(pobjUsersEN.headPic) === false) {
    ...
    */
    function Users_CheckProperty4Update(pobjUsersEN) {
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.userId) > 18) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过18(In 用户(Users))!值:$(pobjUsersEN.userId)(clsUsersBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userName) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.userName) > 30) {
            throw new Error("(errid:Watl000062)字段[用户名(userName)]的长度不能超过30(In 用户(Users))!值:$(pobjUsersEN.userName)(clsUsersBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.departmentId) == false && (0, clsString_js_2.GetStrLen)(pobjUsersEN.departmentId) > 8) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUsersEN.userId) === true) {
    ...
    */
    function Users_GetCombineCondition(objUsers_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_UserId, objUsers_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_UserName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_UserName, objUsers_Cond.userName, strComparisonOp_UserName);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_DepartmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_DepartmentId, objUsers_Cond.departmentId, strComparisonOp_DepartmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_UserStateId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_UserStateId, objUsers_Cond.userStateId, strComparisonOp_UserStateId);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_Password) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_Password, objUsers_Cond.password, strComparisonOp_Password);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_IsGpUser) == true) {
            if (objUsers_Cond.isGpUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsUsersEN_js_1.clsUsersEN.con_IsGpUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsUsersEN_js_1.clsUsersEN.con_IsGpUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_SchoolID1) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_SchoolID1, objUsers_Cond.schoolID1, strComparisonOp_SchoolID1);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_BeginYearMonth) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_BeginYearMonth, objUsers_Cond.beginYearMonth, strComparisonOp_BeginYearMonth);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_EndYearMonth) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_EndYearMonth, objUsers_Cond.endYearMonth, strComparisonOp_EndYearMonth);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_id_GradeBase) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_id_GradeBase, objUsers_Cond.id_GradeBase, strComparisonOp_id_GradeBase);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_id_XzCollege, objUsers_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_id_XzMajor, objUsers_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_IsLeaved) == true) {
            if (objUsers_Cond.isLeaved == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsUsersEN_js_1.clsUsersEN.con_IsLeaved);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsUsersEN_js_1.clsUsersEN.con_IsLeaved);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_StuIdTeacherId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_StuIdTeacherId, objUsers_Cond.stuIdTeacherId, strComparisonOp_StuIdTeacherId);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_Email) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_Email, objUsers_Cond.email, strComparisonOp_Email);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_PhoneNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_PhoneNumber, objUsers_Cond.phoneNumber, strComparisonOp_PhoneNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_AvatarsPicture) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_AvatarsPicture, objUsers_Cond.avatarsPicture, strComparisonOp_AvatarsPicture);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_IdentityID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_IdentityID, objUsers_Cond.identityID, strComparisonOp_IdentityID);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_AuditDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_AuditDate, objUsers_Cond.auditDate, strComparisonOp_AuditDate);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_AuditUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_AuditUser, objUsers_Cond.auditUser, strComparisonOp_AuditUser);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_IsAudit) == true) {
            if (objUsers_Cond.isAudit == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsUsersEN_js_1.clsUsersEN.con_IsAudit);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsUsersEN_js_1.clsUsersEN.con_IsAudit);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_IsRegister) == true) {
            if (objUsers_Cond.isRegister == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsUsersEN_js_1.clsUsersEN.con_IsRegister);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsUsersEN_js_1.clsUsersEN.con_IsRegister);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_RegisterDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_RegisterDate, objUsers_Cond.registerDate, strComparisonOp_RegisterDate);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_MobilePhone) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_MobilePhone, objUsers_Cond.mobilePhone, strComparisonOp_MobilePhone);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_OpenId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_OpenId, objUsers_Cond.openId, strComparisonOp_OpenId);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_UpdDate, objUsers_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_UpdUser, objUsers_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_Memo, objUsers_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_HeadPic) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUsersEN_js_1.clsUsersEN.con_HeadPic, objUsers_Cond.headPic, strComparisonOp_HeadPic);
        }
        if (Object.prototype.hasOwnProperty.call(objUsers_Cond.dicFldComparisonOp, clsUsersEN_js_1.clsUsersEN.con_IsGSuser) == true) {
            if (objUsers_Cond.isGSuser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsUsersEN_js_1.clsUsersEN.con_IsGSuser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsUsersEN_js_1.clsUsersEN.con_IsGSuser);
            }
        }
        return strWhereCond;
    }
