...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/UserManage_Share/clsvUsersEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vUsers_GetObjByUserIdAsync(strUserId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId]不能为空！(In clsvUsersWApi.GetObjByUserIdAsync)");
    ...
    */
    async function vUsers_GetObjByUserId_Cache(strUserId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId]不能为空！(In clsvUsersWApi.GetObjByUserId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vUsers_GetObjByUserId_localStorage(strUserId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId]不能为空！(In clsvUsersWApi.GetObjByUserId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function vUsers_GetObjLst_ClientCache() {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvUsersExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvUsersExObjLst);
