...
(function (factory) {
    ...
    **/
    async function UserIdentity_GetObjByIdentityIDAsync(strIdentityID) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strIdentityID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strIdentityID]不能为空！(In clsUserIdentityWApi.GetObjByIdentityIDAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strIdentityID.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strIdentityID]的长度:[{0}]不正确！(clsUserIdentityWApi.GetObjByIdentityIDAsync)", strIdentityID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.userIdentity_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.userIdentity_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function UserIdentity_GetObjByIdentityID_Cache(strIdentityID, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strIdentityID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strIdentityID]不能为空！(In clsUserIdentityWApi.GetObjByIdentityID_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strIdentityID.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strIdentityID]的长度:[{0}]不正确！(clsUserIdentityWApi.GetObjByIdentityID_Cache)", strIdentityID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrUserIdentity_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objUserIdentity_Const = await UserIdentity_GetObjByIdentityIDAsync(strIdentityID);
                    if (objUserIdentity_Const != null) {
                        UserIdentity_ReFreshThisCache();
                        return objUserIdentity_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function UserIdentity_GetObjByIdentityID_localStorage(strIdentityID) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strIdentityID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strIdentityID]不能为空！(In clsUserIdentityWApi.GetObjByIdentityID_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strIdentityID.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strIdentityID]的长度:[{0}]不正确！(clsUserIdentityWApi.GetObjByIdentityID_localStorage)", strIdentityID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsUserIdentityEN_js_1.clsUserIdentityEN._CurrTabName, strIdentityID);
        if (strKey == "") {
    ...
    */
    async function UserIdentity_GetNameByIdentityID_Cache(strIdentityID) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strIdentityID) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strIdentityID]不能为空！(In clsUserIdentityWApi.GetNameByIdentityID_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strIdentityID.length != 2) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strIdentityID]的长度:[{0}]不正确！(clsUserIdentityWApi.GetNameByIdentityID_Cache)", strIdentityID.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrUserIdentityObjLst_Cache = await UserIdentity_GetObjLst_Cache();
    ...
    */
    async function UserIdentity_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsUserIdentityEN_js_1.clsUserIdentityEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsUserIdentityEN_js_1.clsUserIdentityEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objUserIdentity == null)
            return "";
        if (objUserIdentity.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function UserIdentity_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrUserIdentity = await UserIdentity_GetObjLst_Cache();
        if (arrUserIdentity == null)
            return [];
        let arrUserIdentity_Sel = arrUserIdentity;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrUserIdentity_Sel = arrUserIdentity_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrUserIdentity_Sel = arrUserIdentity_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrUserIdentity_Sel = arrUserIdentity_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrUserIdentity_Sel = arrUserIdentity_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrUserIdentity_Sel.length == 0)
            return [];
        return arrUserIdentity_Sel.map(x => x.identityID);
    }
    exports.UserIdentity_funcKey = UserIdentity_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function UserIdentity_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsUserIdentityEN_js_1.clsUserIdentityEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsUserIdentityEN_js_1.clsUserIdentityEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrUserIdentityExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrUserIdentityExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrUserIdentityExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function UserIdentity_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrUserIdentityExObjLst.length);
            console.log(strInfo);
            return arrUserIdentityExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.userIdentity_ConstructorName, strThisFuncName);
    ...
    **/
    async function UserIdentity_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrUserIdentityExObjLst.length);
            console.log(strInfo);
            return arrUserIdentityExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrUserIdentity_Sel = arrUserIdentity_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function UserIdentity_DelRecordAsync(strIdentityID) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strIdentityID);
        try {
    ...
    **/
    async function UserIdentity_UpdateRecordAsync(objUserIdentityEN) {
        ...
        if (objUserIdentityEN.sf_UpdFldSetStr === undefined || objUserIdentityEN.sf_UpdFldSetStr === null || objUserIdentityEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objUserIdentityEN.identityID);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.userIdentity_Controller, strAction);
        try {
    ...
    */
    async function UserIdentity_IsExistRecord_Cache(objUserIdentity_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objUserIdentity_Cond), exports.userIdentity_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function UserIdentity_IsExist_Cache(strIdentityID) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strIdentityID, exports.userIdentity_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function UserIdentity_BindDdl_IdentityIDInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_IdentityIDInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function UserIdentity_CheckPropertyNew(pobjUserIdentityEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.identityDesc) === true) {
            throw new Error("(errid:Watl000058)字段[身份描述]不能为空(In 用户身份)!(clsUserIdentityBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.identityID) == false && (0, clsString_js_2.GetStrLen)(pobjUserIdentityEN.identityID) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.identityDesc) == false && (0, clsString_js_2.GetStrLen)(pobjUserIdentityEN.identityDesc) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjUserIdentityEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.identityID) == false && undefined !== pobjUserIdentityEN.identityID && clsString_js_1.tzDataType.isString(pobjUserIdentityEN.identityID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.identityDesc) == false && undefined !== pobjUserIdentityEN.identityDesc && clsString_js_1.tzDataType.isString(pobjUserIdentityEN.identityDesc) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.memo) == false && undefined !== pobjUserIdentityEN.memo && clsString_js_1.tzDataType.isString(pobjUserIdentityEN.memo) === false) {
    ...
    */
    function UserIdentity_CheckProperty4Update(pobjUserIdentityEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjUserIdentityEN.identityID) === true
    ...
    */
    function UserIdentity_GetCombineCondition(objUserIdentity_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objUserIdentity_Cond.dicFldComparisonOp, clsUserIdentityEN_js_1.clsUserIdentityEN.con_IdentityID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUserIdentityEN_js_1.clsUserIdentityEN.con_IdentityID, objUserIdentity_Cond.identityID, strComparisonOp_IdentityID);
        }
        if (Object.prototype.hasOwnProperty.call(objUserIdentity_Cond.dicFldComparisonOp, clsUserIdentityEN_js_1.clsUserIdentityEN.con_IdentityDesc) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUserIdentityEN_js_1.clsUserIdentityEN.con_IdentityDesc, objUserIdentity_Cond.identityDesc, strComparisonOp_IdentityDesc);
        }
        if (Object.prototype.hasOwnProperty.call(objUserIdentity_Cond.dicFldComparisonOp, clsUserIdentityEN_js_1.clsUserIdentityEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsUserIdentityEN_js_1.clsUserIdentityEN.con_Memo, objUserIdentity_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
