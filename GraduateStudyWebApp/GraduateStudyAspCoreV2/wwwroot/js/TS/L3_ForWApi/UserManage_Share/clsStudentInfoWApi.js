...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/UserManage_Share/clsStudentInfoEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function StudentInfo_GetObjByid_StudentInfoAsync(strid_StudentInfo) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_StudentInfo) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_StudentInfo]不能为空！(In clsStudentInfoWApi.GetObjByid_StudentInfoAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_StudentInfo.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_StudentInfo]的长度:[{0}]不正确！(clsStudentInfoWApi.GetObjByid_StudentInfoAsync)", strid_StudentInfo.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.studentInfo_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.studentInfo_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function StudentInfo_GetObjByid_StudentInfo_Cache(strid_StudentInfo, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_StudentInfo) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_StudentInfo]不能为空！(In clsStudentInfoWApi.GetObjByid_StudentInfo_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_StudentInfo.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_StudentInfo]的长度:[{0}]不正确！(clsStudentInfoWApi.GetObjByid_StudentInfo_Cache)", strid_StudentInfo.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function StudentInfo_GetObjByid_StudentInfo_localStorage(strid_StudentInfo) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_StudentInfo) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_StudentInfo]不能为空！(In clsStudentInfoWApi.GetObjByid_StudentInfo_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_StudentInfo.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_StudentInfo]的长度:[{0}]不正确！(clsStudentInfoWApi.GetObjByid_StudentInfo_localStorage)", strid_StudentInfo.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsStudentInfoEN_js_1.clsStudentInfoEN._CurrTabName, strid_StudentInfo);
        if (strKey == "") {
    ...
    */
    async function StudentInfo_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsStudentInfoEN_js_1.clsStudentInfoEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsStudentInfoEN_js_1.clsStudentInfoEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
    ...
    **/
    async function StudentInfo_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsStudentInfoEN_js_1.clsStudentInfoEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsStudentInfoEN_js_1.clsStudentInfoEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrStudentInfoExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrStudentInfoExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrStudentInfoExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function StudentInfo_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrStudentInfoExObjLst.length);
            console.log(strInfo);
            return arrStudentInfoExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.studentInfo_ConstructorName, strThisFuncName);
    ...
    **/
    async function StudentInfo_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrStudentInfoExObjLst.length);
            console.log(strInfo);
            return arrStudentInfoExObjLst;
        }
        catch (e) {
    ...
    **/
    async function StudentInfo_DelRecordAsync(strid_StudentInfo) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strid_StudentInfo);
        try {
    ...
    **/
    async function StudentInfo_UpdateRecordAsync(objStudentInfoEN) {
        ...
        if (objStudentInfoEN.sf_UpdFldSetStr === undefined || objStudentInfoEN.sf_UpdFldSetStr === null || objStudentInfoEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objStudentInfoEN.id_StudentInfo);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.studentInfo_Controller, strAction);
        try {
    ...
    */
    async function StudentInfo_IsExistRecord_Cache(objStudentInfo_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objStudentInfo_Cond), exports.studentInfo_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function StudentInfo_IsExist_Cache(strid_StudentInfo) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_StudentInfo, exports.studentInfo_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function StudentInfo_CheckPropertyNew(pobjStudentInfoEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuID) === true) {
            throw new Error("(errid:Watl000058)字段[学号]不能为空(In 学生)!(clsStudentInfoBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuName) === true) {
            throw new Error("(errid:Watl000058)字段[姓名]不能为空(In 学生)!(clsStudentInfoBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_StudentInfo) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_StudentInfo) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuID) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.stuID) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuName) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.stuName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_Politics) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_Politics) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_Sex) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_Sex) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_Ethnic) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_Ethnic) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_UniZone) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_UniZone) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_StuType) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_StuType) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_XzCollege) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_XzCollege) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_XzMajor) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_XzMajor) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_GradeBase) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_GradeBase) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_AdminCls) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_AdminCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.birthday) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.birthday) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.nativePlace) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.nativePlace) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.duty) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.duty) > 30) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.idCardNo) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.idCardNo) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuCardNo) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.stuCardNo) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.liveAddress) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.liveAddress) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.homePhone) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.homePhone) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_CardNo) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.id_CardNo) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.cardNo) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.cardNo) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.userId) > 18) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过18(In 学生(StudentInfo))!值:$(pobjStudentInfoEN.userId)(clsStudentInfoBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.userID4Avcon) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.userID4Avcon) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.enrollmentDate) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.enrollmentDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.postCode) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.postCode) > 6) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.email) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.email) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.microblog) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.microblog) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.phoneNumber) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.phoneNumber) > 15) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.headphoto) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.headphoto) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.qQ) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.qQ) > 100) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.registerPassword) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.registerPassword) > 30) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_StudentInfo) == false && undefined !== pobjStudentInfoEN.id_StudentInfo && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_StudentInfo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuID) == false && undefined !== pobjStudentInfoEN.stuID && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.stuID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuName) == false && undefined !== pobjStudentInfoEN.stuName && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.stuName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_Politics) == false && undefined !== pobjStudentInfoEN.id_Politics && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_Politics) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_Sex) == false && undefined !== pobjStudentInfoEN.id_Sex && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_Sex) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_Ethnic) == false && undefined !== pobjStudentInfoEN.id_Ethnic && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_Ethnic) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_UniZone) == false && undefined !== pobjStudentInfoEN.id_UniZone && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_UniZone) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_StuType) == false && undefined !== pobjStudentInfoEN.id_StuType && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_StuType) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_XzCollege) == false && undefined !== pobjStudentInfoEN.id_XzCollege && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_XzCollege) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_XzMajor) == false && undefined !== pobjStudentInfoEN.id_XzMajor && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_XzMajor) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_GradeBase) == false && undefined !== pobjStudentInfoEN.id_GradeBase && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_GradeBase) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_AdminCls) == false && undefined !== pobjStudentInfoEN.id_AdminCls && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_AdminCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.birthday) == false && undefined !== pobjStudentInfoEN.birthday && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.birthday) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.nativePlace) == false && undefined !== pobjStudentInfoEN.nativePlace && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.nativePlace) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.duty) == false && undefined !== pobjStudentInfoEN.duty && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.duty) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.idCardNo) == false && undefined !== pobjStudentInfoEN.idCardNo && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.idCardNo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.stuCardNo) == false && undefined !== pobjStudentInfoEN.stuCardNo && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.stuCardNo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.liveAddress) == false && undefined !== pobjStudentInfoEN.liveAddress && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.liveAddress) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.homePhone) == false && undefined !== pobjStudentInfoEN.homePhone && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.homePhone) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_CardNo) == false && undefined !== pobjStudentInfoEN.id_CardNo && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.id_CardNo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.cardNo) == false && undefined !== pobjStudentInfoEN.cardNo && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.cardNo) === false) {
        ...
        if (null != pobjStudentInfoEN.isAvconClassUser && undefined !== pobjStudentInfoEN.isAvconClassUser && clsString_js_1.tzDataType.isBoolean(pobjStudentInfoEN.isAvconClassUser) === false) {
        ...
        if (null != pobjStudentInfoEN.isAvconUser && undefined !== pobjStudentInfoEN.isAvconUser && clsString_js_1.tzDataType.isBoolean(pobjStudentInfoEN.isAvconUser) === false) {
        ...
        if (null != pobjStudentInfoEN.isGpUser && undefined !== pobjStudentInfoEN.isGpUser && clsString_js_1.tzDataType.isBoolean(pobjStudentInfoEN.isGpUser) === false) {
        ...
        if (null != pobjStudentInfoEN.isLocalUser && undefined !== pobjStudentInfoEN.isLocalUser && clsString_js_1.tzDataType.isBoolean(pobjStudentInfoEN.isLocalUser) === false) {
        ...
        if (null != pobjStudentInfoEN.isLeaved && undefined !== pobjStudentInfoEN.isLeaved && clsString_js_1.tzDataType.isBoolean(pobjStudentInfoEN.isLeaved) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.userId) == false && undefined !== pobjStudentInfoEN.userId && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.userId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.userID4Avcon) == false && undefined !== pobjStudentInfoEN.userID4Avcon && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.userID4Avcon) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.enrollmentDate) == false && undefined !== pobjStudentInfoEN.enrollmentDate && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.enrollmentDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.postCode) == false && undefined !== pobjStudentInfoEN.postCode && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.postCode) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.email) == false && undefined !== pobjStudentInfoEN.email && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.email) === false) {
        ...
        if (null != pobjStudentInfoEN.isMessage && undefined !== pobjStudentInfoEN.isMessage && clsString_js_1.tzDataType.isBoolean(pobjStudentInfoEN.isMessage) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.microblog) == false && undefined !== pobjStudentInfoEN.microblog && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.microblog) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.phoneNumber) == false && undefined !== pobjStudentInfoEN.phoneNumber && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.phoneNumber) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.headphoto) == false && undefined !== pobjStudentInfoEN.headphoto && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.headphoto) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.qQ) == false && undefined !== pobjStudentInfoEN.qQ && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.qQ) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.registerPassword) == false && undefined !== pobjStudentInfoEN.registerPassword && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.registerPassword) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.updDate) == false && undefined !== pobjStudentInfoEN.updDate && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.updUser) == false && undefined !== pobjStudentInfoEN.updUser && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.memo) == false && undefined !== pobjStudentInfoEN.memo && clsString_js_1.tzDataType.isString(pobjStudentInfoEN.memo) === false) {
    ...
    */
    function StudentInfo_CheckProperty4Update(pobjStudentInfoEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.userId) > 18) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过18(In 学生(StudentInfo))!值:$(pobjStudentInfoEN.userId)(clsStudentInfoBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.userID4Avcon) == false && (0, clsString_js_2.GetStrLen)(pobjStudentInfoEN.userID4Avcon) > 20) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjStudentInfoEN.id_StudentInfo) === true) {
    ...
    */
    function StudentInfo_GetCombineCondition(objStudentInfo_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_StudentInfo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_StudentInfo, objStudentInfo_Cond.id_StudentInfo, strComparisonOp_id_StudentInfo);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_StuID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_StuID, objStudentInfo_Cond.stuID, strComparisonOp_StuID);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_StuName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_StuName, objStudentInfo_Cond.stuName, strComparisonOp_StuName);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_Politics) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_Politics, objStudentInfo_Cond.id_Politics, strComparisonOp_id_Politics);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_Sex) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_Sex, objStudentInfo_Cond.id_Sex, strComparisonOp_id_Sex);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_Ethnic) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_Ethnic, objStudentInfo_Cond.id_Ethnic, strComparisonOp_id_Ethnic);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_UniZone) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_UniZone, objStudentInfo_Cond.id_UniZone, strComparisonOp_id_UniZone);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_StuType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_StuType, objStudentInfo_Cond.id_StuType, strComparisonOp_id_StuType);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_XzCollege) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_XzCollege, objStudentInfo_Cond.id_XzCollege, strComparisonOp_id_XzCollege);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_XzMajor) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_XzMajor, objStudentInfo_Cond.id_XzMajor, strComparisonOp_id_XzMajor);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_GradeBase) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_GradeBase, objStudentInfo_Cond.id_GradeBase, strComparisonOp_id_GradeBase);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_AdminCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_id_AdminCls, objStudentInfo_Cond.id_AdminCls, strComparisonOp_id_AdminCls);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Birthday) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Birthday, objStudentInfo_Cond.birthday, strComparisonOp_Birthday);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_NativePlace) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_NativePlace, objStudentInfo_Cond.nativePlace, strComparisonOp_NativePlace);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Duty) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Duty, objStudentInfo_Cond.duty, strComparisonOp_Duty);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IDCardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IDCardNo, objStudentInfo_Cond.idCardNo, strComparisonOp_IDCardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_StuCardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_StuCardNo, objStudentInfo_Cond.stuCardNo, strComparisonOp_StuCardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_LiveAddress) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_LiveAddress, objStudentInfo_Cond.liveAddress, strComparisonOp_LiveAddress);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_HomePhone) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_HomePhone, objStudentInfo_Cond.homePhone, strComparisonOp_HomePhone);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Id_CardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Id_CardNo, objStudentInfo_Cond.id_CardNo, strComparisonOp_Id_CardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_CardNo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_CardNo, objStudentInfo_Cond.cardNo, strComparisonOp_CardNo);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsAvconClassUser) == true) {
            if (objStudentInfo_Cond.isAvconClassUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsAvconClassUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsAvconClassUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsAvconUser) == true) {
            if (objStudentInfo_Cond.isAvconUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsAvconUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsAvconUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsGpUser) == true) {
            if (objStudentInfo_Cond.isGpUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsGpUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsGpUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsLocalUser) == true) {
            if (objStudentInfo_Cond.isLocalUser == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsLocalUser);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsLocalUser);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsLeaved) == true) {
            if (objStudentInfo_Cond.isLeaved == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsLeaved);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsLeaved);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_UserId, objStudentInfo_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_UserID4Avcon) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_UserID4Avcon, objStudentInfo_Cond.userID4Avcon, strComparisonOp_UserID4Avcon);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_EnrollmentDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_EnrollmentDate, objStudentInfo_Cond.enrollmentDate, strComparisonOp_EnrollmentDate);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_PostCode) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_PostCode, objStudentInfo_Cond.postCode, strComparisonOp_PostCode);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Email) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Email, objStudentInfo_Cond.email, strComparisonOp_Email);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsMessage) == true) {
            if (objStudentInfo_Cond.isMessage == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsMessage);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_IsMessage);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Microblog) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Microblog, objStudentInfo_Cond.microblog, strComparisonOp_Microblog);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_PhoneNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_PhoneNumber, objStudentInfo_Cond.phoneNumber, strComparisonOp_PhoneNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Headphoto) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Headphoto, objStudentInfo_Cond.headphoto, strComparisonOp_Headphoto);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_QQ) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_QQ, objStudentInfo_Cond.qQ, strComparisonOp_QQ);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_RegisterPassword) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_RegisterPassword, objStudentInfo_Cond.registerPassword, strComparisonOp_RegisterPassword);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_UpdDate, objStudentInfo_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_UpdUser, objStudentInfo_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objStudentInfo_Cond.dicFldComparisonOp, clsStudentInfoEN_js_1.clsStudentInfoEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsStudentInfoEN_js_1.clsStudentInfoEN.con_Memo, objStudentInfo_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function StudentInfo_GetUniCondStr_StuID(objStudentInfoEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and StuID = '{0}'", objStudentInfoEN.stuID);
        return strWhereCond;
    }
    ...
    **/
    function StudentInfo_GetUniCondStr4Update_StuID(objStudentInfoEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and id_StudentInfo <> '{0}'", objStudentInfoEN.id_StudentInfo);
        strWhereCond += (0, clsString_js_2.Format)(" and StuID = '{0}'", objStudentInfoEN.stuID);
        return strWhereCond;
    }
