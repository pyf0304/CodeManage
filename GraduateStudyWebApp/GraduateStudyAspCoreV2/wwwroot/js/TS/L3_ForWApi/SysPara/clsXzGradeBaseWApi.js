...
(function (factory) {
    ...
    **/
    async function XzGradeBase_GetObjByid_GradeBaseAsync(strid_GradeBase) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_GradeBase) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_GradeBase]不能为空！(In clsXzGradeBaseWApi.GetObjByid_GradeBaseAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_GradeBase.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_GradeBase]的长度:[{0}]不正确！(clsXzGradeBaseWApi.GetObjByid_GradeBaseAsync)", strid_GradeBase.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.xzGradeBase_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.xzGradeBase_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function XzGradeBase_GetObjByid_GradeBase_Cache(strid_GradeBase, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_GradeBase) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_GradeBase]不能为空！(In clsXzGradeBaseWApi.GetObjByid_GradeBase_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_GradeBase.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_GradeBase]的长度:[{0}]不正确！(clsXzGradeBaseWApi.GetObjByid_GradeBase_Cache)", strid_GradeBase.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function XzGradeBase_GetObjByid_GradeBase_localStorage(strid_GradeBase) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_GradeBase) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_GradeBase]不能为空！(In clsXzGradeBaseWApi.GetObjByid_GradeBase_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_GradeBase.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_GradeBase]的长度:[{0}]不正确！(clsXzGradeBaseWApi.GetObjByid_GradeBase_localStorage)", strid_GradeBase.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN._CurrTabName, strid_GradeBase);
        if (strKey == "") {
    ...
    */
    async function XzGradeBase_GetNameByid_GradeBase_Cache(strid_GradeBase) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_GradeBase) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_GradeBase]不能为空！(In clsXzGradeBaseWApi.GetNameByid_GradeBase_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_GradeBase.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_GradeBase]的长度:[{0}]不正确！(clsXzGradeBaseWApi.GetNameByid_GradeBase_Cache)", strid_GradeBase.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrXzGradeBaseObjLst_Cache = await XzGradeBase_GetObjLst_Cache();
    ...
    */
    async function XzGradeBase_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objXzGradeBase == null)
            return "";
        if (objXzGradeBase.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_EnterSchoolDate:
                    return (a, b) => {
                        if (a.enterSchoolDate == null)
                            return -1;
                        if (b.enterSchoolDate == null)
                            return 1;
                ...
                case clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SetEPTermIndexDate:
                    return (a, b) => {
                        if (a.setEPTermIndexDate == null)
                            return -1;
                        if (b.setEPTermIndexDate == null)
                            return 1;
                ...
                case clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_PointCalcVersionId:
                    return (a, b) => {
                        if (a.pointCalcVersionId == null)
                            return -1;
                        if (b.pointCalcVersionId == null)
                            return 1;
                ...
                case clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_id_StudyLevel:
                    return (a, b) => {
                        if (a.id_StudyLevel == null)
                            return -1;
                        if (b.id_StudyLevel == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function XzGradeBase_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.XzGradeBase_funcKey = XzGradeBase_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function XzGradeBase_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrXzGradeBaseExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrXzGradeBaseExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzGradeBaseExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function XzGradeBase_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzGradeBaseExObjLst.length);
            console.log(strInfo);
            return arrXzGradeBaseExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.xzGradeBase_ConstructorName, strThisFuncName);
    ...
    **/
    async function XzGradeBase_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrXzGradeBaseExObjLst.length);
            console.log(strInfo);
            return arrXzGradeBaseExObjLst;
        }
        catch (e) {
    ...
    **/
    async function XzGradeBase_DelRecordAsync(strid_GradeBase) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strid_GradeBase);
        try {
    ...
    **/
    async function XzGradeBase_UpdateRecordAsync(objXzGradeBaseEN) {
        ...
        if (objXzGradeBaseEN.sf_UpdFldSetStr === undefined || objXzGradeBaseEN.sf_UpdFldSetStr === null || objXzGradeBaseEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objXzGradeBaseEN.id_GradeBase);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.xzGradeBase_Controller, strAction);
        try {
    ...
    */
    async function XzGradeBase_IsExistRecord_Cache(objXzGradeBase_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objXzGradeBase_Cond), exports.xzGradeBase_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function XzGradeBase_IsExist_Cache(strid_GradeBase) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strid_GradeBase, exports.xzGradeBase_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function XzGradeBase_BindDdl_id_GradeBaseInDiv_Cache(strDivName, strDdlName) {
        ...
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_id_GradeBaseInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function XzGradeBase_CheckPropertyNew(pobjXzGradeBaseEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseID) === true) {
            throw new Error("(errid:Watl000058)字段[年级代号]不能为空(In 年级)!(clsXzGradeBaseBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseName) === true) {
            throw new Error("(errid:Watl000058)字段[年级名称]不能为空(In 年级)!(clsXzGradeBaseBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.schoolYear) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.schoolTerm) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.id_GradeBase) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.id_GradeBase) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseID) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.gradeBaseID) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseName) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.gradeBaseName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseNameA) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.gradeBaseNameA) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.schoolYear) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.schoolYear) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.schoolTerm) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.schoolTerm) > 1) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.enterSchoolDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.enterSchoolDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.setEPTermIndexDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.setEPTermIndexDate) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.beginYearMonth) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.beginYearMonth) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.endYearMonth) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.endYearMonth) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.prefix) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.prefix) > 3) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.pointCalcVersionId) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.pointCalcVersionId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.modifyUserID) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.modifyUserID) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.modifyDate) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.modifyDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.id_StudyLevel) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.id_StudyLevel) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjXzGradeBaseEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.id_GradeBase) == false && undefined !== pobjXzGradeBaseEN.id_GradeBase && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.id_GradeBase) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseID) == false && undefined !== pobjXzGradeBaseEN.gradeBaseID && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.gradeBaseID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseName) == false && undefined !== pobjXzGradeBaseEN.gradeBaseName && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.gradeBaseName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.gradeBaseNameA) == false && undefined !== pobjXzGradeBaseEN.gradeBaseNameA && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.gradeBaseNameA) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.schoolYear) == false && undefined !== pobjXzGradeBaseEN.schoolYear && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.schoolYear) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.schoolTerm) == false && undefined !== pobjXzGradeBaseEN.schoolTerm && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.schoolTerm) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.enterSchoolDate) == false && undefined !== pobjXzGradeBaseEN.enterSchoolDate && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.enterSchoolDate) === false) {
        ...
        if (null != pobjXzGradeBaseEN.currentTermSeq && undefined !== pobjXzGradeBaseEN.currentTermSeq && clsString_js_1.tzDataType.isNumber(pobjXzGradeBaseEN.currentTermSeq) === false) {
        ...
        if (null != pobjXzGradeBaseEN.execPlanTermIndex && undefined !== pobjXzGradeBaseEN.execPlanTermIndex && clsString_js_1.tzDataType.isNumber(pobjXzGradeBaseEN.execPlanTermIndex) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.setEPTermIndexDate) == false && undefined !== pobjXzGradeBaseEN.setEPTermIndexDate && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.setEPTermIndexDate) === false) {
        ...
        if (null != pobjXzGradeBaseEN.isOffed && undefined !== pobjXzGradeBaseEN.isOffed && clsString_js_1.tzDataType.isBoolean(pobjXzGradeBaseEN.isOffed) === false) {
        ...
        if (null != pobjXzGradeBaseEN.gradeIndex && undefined !== pobjXzGradeBaseEN.gradeIndex && clsString_js_1.tzDataType.isNumber(pobjXzGradeBaseEN.gradeIndex) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.beginYearMonth) == false && undefined !== pobjXzGradeBaseEN.beginYearMonth && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.beginYearMonth) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.endYearMonth) == false && undefined !== pobjXzGradeBaseEN.endYearMonth && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.endYearMonth) === false) {
        ...
        if (null != pobjXzGradeBaseEN.allowUpBaseInfo && undefined !== pobjXzGradeBaseEN.allowUpBaseInfo && clsString_js_1.tzDataType.isBoolean(pobjXzGradeBaseEN.allowUpBaseInfo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.prefix) == false && undefined !== pobjXzGradeBaseEN.prefix && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.prefix) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.pointCalcVersionId) == false && undefined !== pobjXzGradeBaseEN.pointCalcVersionId && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.pointCalcVersionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.modifyUserID) == false && undefined !== pobjXzGradeBaseEN.modifyUserID && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.modifyUserID) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.modifyDate) == false && undefined !== pobjXzGradeBaseEN.modifyDate && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.modifyDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.id_StudyLevel) == false && undefined !== pobjXzGradeBaseEN.id_StudyLevel && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.id_StudyLevel) === false) {
        ...
        if (null != pobjXzGradeBaseEN.isVisible && undefined !== pobjXzGradeBaseEN.isVisible && clsString_js_1.tzDataType.isBoolean(pobjXzGradeBaseEN.isVisible) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.memo) == false && undefined !== pobjXzGradeBaseEN.memo && clsString_js_1.tzDataType.isString(pobjXzGradeBaseEN.memo) === false) {
    ...
    */
    function XzGradeBase_CheckProperty4Update(pobjXzGradeBaseEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjXzGradeBaseEN.id_GradeBase) === true
    ...
    */
    function XzGradeBase_GetCombineCondition(objXzGradeBase_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_id_GradeBase) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_id_GradeBase, objXzGradeBase_Cond.id_GradeBase, strComparisonOp_id_GradeBase);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseID, objXzGradeBase_Cond.gradeBaseID, strComparisonOp_GradeBaseID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseName, objXzGradeBase_Cond.gradeBaseName, strComparisonOp_GradeBaseName);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseNameA) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseNameA, objXzGradeBase_Cond.gradeBaseNameA, strComparisonOp_GradeBaseNameA);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SchoolYear) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SchoolYear, objXzGradeBase_Cond.schoolYear, strComparisonOp_SchoolYear);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SchoolTerm) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SchoolTerm, objXzGradeBase_Cond.schoolTerm, strComparisonOp_SchoolTerm);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_EnterSchoolDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_EnterSchoolDate, objXzGradeBase_Cond.enterSchoolDate, strComparisonOp_EnterSchoolDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_CurrentTermSeq) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_CurrentTermSeq, objXzGradeBase_Cond.currentTermSeq, strComparisonOp_CurrentTermSeq);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SetEPTermIndexDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_SetEPTermIndexDate, objXzGradeBase_Cond.setEPTermIndexDate, strComparisonOp_SetEPTermIndexDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_IsOffed) == true) {
            if (objXzGradeBase_Cond.isOffed == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_IsOffed);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_IsOffed);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeIndex) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeIndex, objXzGradeBase_Cond.gradeIndex, strComparisonOp_GradeIndex);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_BeginYearMonth) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_BeginYearMonth, objXzGradeBase_Cond.beginYearMonth, strComparisonOp_BeginYearMonth);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_EndYearMonth) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_EndYearMonth, objXzGradeBase_Cond.endYearMonth, strComparisonOp_EndYearMonth);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_AllowUpBaseInfo) == true) {
            if (objXzGradeBase_Cond.allowUpBaseInfo == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_AllowUpBaseInfo);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_AllowUpBaseInfo);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_Prefix) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_Prefix, objXzGradeBase_Cond.prefix, strComparisonOp_Prefix);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_PointCalcVersionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_PointCalcVersionId, objXzGradeBase_Cond.pointCalcVersionId, strComparisonOp_PointCalcVersionId);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_ModifyUserID) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_ModifyUserID, objXzGradeBase_Cond.modifyUserID, strComparisonOp_ModifyUserID);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_ModifyDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_ModifyDate, objXzGradeBase_Cond.modifyDate, strComparisonOp_ModifyDate);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_id_StudyLevel) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_id_StudyLevel, objXzGradeBase_Cond.id_StudyLevel, strComparisonOp_id_StudyLevel);
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_IsVisible) == true) {
            if (objXzGradeBase_Cond.isVisible == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_IsVisible);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_IsVisible);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objXzGradeBase_Cond.dicFldComparisonOp, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_Memo, objXzGradeBase_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
