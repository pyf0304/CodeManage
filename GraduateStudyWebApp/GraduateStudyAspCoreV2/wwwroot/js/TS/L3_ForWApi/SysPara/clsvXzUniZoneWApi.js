...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/SysPara/clsvXzUniZoneEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vXzUniZone_GetObjByid_UniZoneAsync(strid_UniZone) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_UniZone) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_UniZone]不能为空！(In clsvXzUniZoneWApi.GetObjByid_UniZoneAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_UniZone.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_UniZone]的长度:[{0}]不正确！(clsvXzUniZoneWApi.GetObjByid_UniZoneAsync)", strid_UniZone.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvXzUniZoneEN_js_1.clsvXzUniZoneEN.con_UniZoneDescA:
                    return (a, b) => {
                        if (a.uniZoneDescA == null)
                            return -1;
                        if (b.uniZoneDescA == null)
                            return 1;
