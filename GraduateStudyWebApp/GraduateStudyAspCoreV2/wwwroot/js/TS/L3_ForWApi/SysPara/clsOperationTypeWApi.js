...
(function (factory) {
    ...
    **/
    async function OperationType_GetObjByOperationTypeIdAsync(strOperationTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetObjByOperationTypeIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetObjByOperationTypeIdAsync)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.operationType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.operationType_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function OperationType_GetObjByOperationTypeId_Cache(strOperationTypeId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetObjByOperationTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetObjByOperationTypeId_Cache)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function OperationType_GetObjByOperationTypeId_localStorage(strOperationTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetObjByOperationTypeId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetObjByOperationTypeId_localStorage)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsOperationTypeEN_js_1.clsOperationTypeEN._CurrTabName, strOperationTypeId);
        if (strKey == "") {
    ...
    */
    async function OperationType_GetNameByOperationTypeId_Cache(strOperationTypeId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strOperationTypeId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strOperationTypeId]不能为空！(In clsOperationTypeWApi.GetNameByOperationTypeId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strOperationTypeId.length != 4) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strOperationTypeId]的长度:[{0}]不正确！(clsOperationTypeWApi.GetNameByOperationTypeId_Cache)", strOperationTypeId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrOperationTypeObjLst_Cache = await OperationType_GetObjLst_Cache();
    ...
    */
    async function OperationType_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsOperationTypeEN_js_1.clsOperationTypeEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsOperationTypeEN_js_1.clsOperationTypeEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objOperationType == null)
            return "";
        if (objOperationType.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function OperationType_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.OperationType_funcKey = OperationType_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function OperationType_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsOperationTypeEN_js_1.clsOperationTypeEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsOperationTypeEN_js_1.clsOperationTypeEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrOperationTypeExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrOperationTypeExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrOperationTypeExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function OperationType_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrOperationTypeExObjLst.length);
            console.log(strInfo);
            return arrOperationTypeExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.operationType_ConstructorName, strThisFuncName);
    ...
    **/
    async function OperationType_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrOperationTypeExObjLst.length);
            console.log(strInfo);
            return arrOperationTypeExObjLst;
        }
        catch (e) {
    ...
    **/
    async function OperationType_DelRecordAsync(strOperationTypeId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strOperationTypeId);
        try {
    ...
    **/
    async function OperationType_UpdateRecordAsync(objOperationTypeEN) {
        ...
        if (objOperationTypeEN.sf_UpdFldSetStr === undefined || objOperationTypeEN.sf_UpdFldSetStr === null || objOperationTypeEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objOperationTypeEN.operationTypeId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.operationType_Controller, strAction);
        try {
    ...
    */
    async function OperationType_IsExistRecord_Cache(objOperationType_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objOperationType_Cond), exports.operationType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function OperationType_IsExist_Cache(strOperationTypeId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strOperationTypeId, exports.operationType_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    async function OperationType_BindDdl_OperationTypeIdInDiv_Cache(strDivName, strDdlName) {
        const strThisFuncName = "BindDdl_OperationTypeIdInDiv_Cache";
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_OperationTypeIdInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    exports.OperationType_BindDdl_OperationTypeIdInDiv_Cache = OperationType_BindDdl_OperationTypeIdInDiv_Cache;
    /**
    ...
    */
    function OperationType_CheckPropertyNew(pobjOperationTypeEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.operationTypeName) === true) {
            throw new Error("(errid:Watl000058)字段[操作类型名]不能为空(In 操作类型)!(clsOperationTypeBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.operationTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjOperationTypeEN.operationTypeId) > 4) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.operationTypeName) == false && (0, clsString_js_2.GetStrLen)(pobjOperationTypeEN.operationTypeName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjOperationTypeEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjOperationTypeEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjOperationTypeEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.operationTypeId) == false && undefined !== pobjOperationTypeEN.operationTypeId && clsString_js_1.tzDataType.isString(pobjOperationTypeEN.operationTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.operationTypeName) == false && undefined !== pobjOperationTypeEN.operationTypeName && clsString_js_1.tzDataType.isString(pobjOperationTypeEN.operationTypeName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.updDate) == false && undefined !== pobjOperationTypeEN.updDate && clsString_js_1.tzDataType.isString(pobjOperationTypeEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.updUserId) == false && undefined !== pobjOperationTypeEN.updUserId && clsString_js_1.tzDataType.isString(pobjOperationTypeEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.memo) == false && undefined !== pobjOperationTypeEN.memo && clsString_js_1.tzDataType.isString(pobjOperationTypeEN.memo) === false) {
    ...
    */
    function OperationType_CheckProperty4Update(pobjOperationTypeEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjOperationTypeEN.operationTypeId) === true) {
    ...
    */
    function OperationType_GetCombineCondition(objOperationType_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN_js_1.clsOperationTypeEN.con_OperationTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsOperationTypeEN_js_1.clsOperationTypeEN.con_OperationTypeId, objOperationType_Cond.operationTypeId, strComparisonOp_OperationTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN_js_1.clsOperationTypeEN.con_OperationTypeName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsOperationTypeEN_js_1.clsOperationTypeEN.con_OperationTypeName, objOperationType_Cond.operationTypeName, strComparisonOp_OperationTypeName);
        }
        if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN_js_1.clsOperationTypeEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsOperationTypeEN_js_1.clsOperationTypeEN.con_UpdDate, objOperationType_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN_js_1.clsOperationTypeEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsOperationTypeEN_js_1.clsOperationTypeEN.con_UpdUserId, objOperationType_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objOperationType_Cond.dicFldComparisonOp, clsOperationTypeEN_js_1.clsOperationTypeEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsOperationTypeEN_js_1.clsOperationTypeEN.con_Memo, objOperationType_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function OperationType_GetUniCondStr_OperationTypeId(objOperationTypeEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and OperationTypeId = '{0}'", objOperationTypeEN.operationTypeId);
        return strWhereCond;
    }
