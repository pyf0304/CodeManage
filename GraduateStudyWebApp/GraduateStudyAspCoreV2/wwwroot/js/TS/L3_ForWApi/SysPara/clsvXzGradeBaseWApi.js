...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/SysPara/clsvXzGradeBaseEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function vXzGradeBase_GetObjByid_GradeBaseAsync(strid_GradeBase) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_GradeBase) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_GradeBase]不能为空！(In clsvXzGradeBaseWApi.GetObjByid_GradeBaseAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_GradeBase.length != 4) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strid_GradeBase]的长度:[{0}]不正确！(clsvXzGradeBaseWApi.GetObjByid_GradeBaseAsync)", strid_GradeBase.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsvXzGradeBaseEN_js_1.clsvXzGradeBaseEN.con_StudyLevelName:
                    return (a, b) => {
                        if (a.studyLevelName == null)
                            return -1;
                        if (b.studyLevelName == null)
                            return 1;
