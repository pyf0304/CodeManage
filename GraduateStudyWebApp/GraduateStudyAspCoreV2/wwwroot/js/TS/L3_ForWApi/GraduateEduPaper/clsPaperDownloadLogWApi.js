...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsPaperDownloadLogEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function PaperDownloadLog_GetObjByPaperDownloadIdAsync(lngPaperDownloadId) {
        ...
        if (lngPaperDownloadId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperDownloadId]不能为空！(In clsPaperDownloadLogWApi.GetObjByPaperDownloadIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperDownloadLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperDownloadLog_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_DownloadFile:
                    return (a, b) => {
                        if (a.downloadFile == null)
                            return -1;
                        if (b.downloadFile == null)
                            return 1;
                        return a.downloadFile.localeCompare(b.downloadFile);
                    };
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperDownloadLog_ConstructorName, strThisFuncName);
    ...
    **/
    async function PaperDownloadLog_DelRecordAsync(lngPaperDownloadId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngPaperDownloadId);
        try {
    ...
    **/
    async function PaperDownloadLog_UpdateRecordAsync(objPaperDownloadLogEN) {
        ...
        if (objPaperDownloadLogEN.sf_UpdFldSetStr === undefined || objPaperDownloadLogEN.sf_UpdFldSetStr === null || objPaperDownloadLogEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperDownloadLogEN.paperDownloadId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperDownloadLog_Controller, strAction);
        try {
    ...
    */
    function PaperDownloadLog_CheckPropertyNew(pobjPaperDownloadLogEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.downloadFile) == false && (0, clsString_js_2.GetStrLen)(pobjPaperDownloadLogEN.downloadFile) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.downloadLink) == false && (0, clsString_js_2.GetStrLen)(pobjPaperDownloadLogEN.downloadLink) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperDownloadLogEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjPaperDownloadLogEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperDownloadLogEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjPaperDownloadLogEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperDownloadLogEN.paperDownloadId && undefined !== pobjPaperDownloadLogEN.paperDownloadId && clsString_js_1.tzDataType.isNumber(pobjPaperDownloadLogEN.paperDownloadId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.downloadFile) == false && undefined !== pobjPaperDownloadLogEN.downloadFile && clsString_js_1.tzDataType.isString(pobjPaperDownloadLogEN.downloadFile) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.downloadLink) == false && undefined !== pobjPaperDownloadLogEN.downloadLink && clsString_js_1.tzDataType.isString(pobjPaperDownloadLogEN.downloadLink) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.paperId) == false && undefined !== pobjPaperDownloadLogEN.paperId && clsString_js_1.tzDataType.isString(pobjPaperDownloadLogEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.updUser) == false && undefined !== pobjPaperDownloadLogEN.updUser && clsString_js_1.tzDataType.isString(pobjPaperDownloadLogEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.updDate) == false && undefined !== pobjPaperDownloadLogEN.updDate && clsString_js_1.tzDataType.isString(pobjPaperDownloadLogEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperDownloadLogEN.memo) == false && undefined !== pobjPaperDownloadLogEN.memo && clsString_js_1.tzDataType.isString(pobjPaperDownloadLogEN.memo) === false) {
    ...
    */
    function PaperDownloadLog_GetCombineCondition(objPaperDownloadLog_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_PaperDownloadId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_PaperDownloadId, objPaperDownloadLog_Cond.paperDownloadId, strComparisonOp_PaperDownloadId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_DownloadFile) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_DownloadFile, objPaperDownloadLog_Cond.downloadFile, strComparisonOp_DownloadFile);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_DownloadLink) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_DownloadLink, objPaperDownloadLog_Cond.downloadLink, strComparisonOp_DownloadLink);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_PaperId, objPaperDownloadLog_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_UpdUser, objPaperDownloadLog_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_UpdDate, objPaperDownloadLog_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperDownloadLog_Cond.dicFldComparisonOp, clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperDownloadLogEN_js_1.clsPaperDownloadLogEN.con_Memo, objPaperDownloadLog_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperDownloadLog_GetUniCondStr_PaperDownloadId(objPaperDownloadLogEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperDownloadId = '{0}'", objPaperDownloadLogEN.paperDownloadId);
        return strWhereCond;
    }
