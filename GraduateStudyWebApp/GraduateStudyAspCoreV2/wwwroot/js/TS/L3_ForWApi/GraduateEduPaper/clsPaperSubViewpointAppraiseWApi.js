...
(function (factory) {
    ...
    * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    ...
    const clsPaperSubViewpointAppraiseEN_js_1 = require("../../L0_Entity/GraduateEduPaper/clsPaperSubViewpointAppraiseEN.js");
    ...
    **/
    async function PaperSubViewpointAppraise_GetObjByPaperSubViewpointAppraiseIdAsync(lngPaperSubViewpointAppraiseId) {
        ...
        if (lngPaperSubViewpointAppraiseId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperSubViewpointAppraiseId]不能为空！(In clsPaperSubViewpointAppraiseWApi.GetObjByPaperSubViewpointAppraiseIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperSubViewpointAppraise_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperSubViewpointAppraise_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperSubViewpointAppraise_GetObjByPaperSubViewpointAppraiseId_Cache(lngPaperSubViewpointAppraiseId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperSubViewpointAppraiseId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperSubViewpointAppraiseId]不能为空！(In clsPaperSubViewpointAppraiseWApi.GetObjByPaperSubViewpointAppraiseId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrPaperSubViewpointAppraise_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objPaperSubViewpointAppraise_Const = await PaperSubViewpointAppraise_GetObjByPaperSubViewpointAppraiseIdAsync(lngPaperSubViewpointAppraiseId);
                    if (objPaperSubViewpointAppraise_Const != null) {
                        PaperSubViewpointAppraise_ReFreshThisCache();
                        return objPaperSubViewpointAppraise_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function PaperSubViewpointAppraise_GetObjByPaperSubViewpointAppraiseId_localStorage(lngPaperSubViewpointAppraiseId) {
        ...
        if (lngPaperSubViewpointAppraiseId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperSubViewpointAppraiseId]不能为空！(In clsPaperSubViewpointAppraiseWApi.GetObjByPaperSubViewpointAppraiseId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN._CurrTabName, lngPaperSubViewpointAppraiseId);
        if (strKey == "") {
    ...
    */
    async function PaperSubViewpointAppraise_UpdateObjInLst_Cache(objPaperSubViewpointAppraise) {
        ...
        try {
            const arrPaperSubViewpointAppraiseObjLst_Cache = await PaperSubViewpointAppraise_GetObjLst_Cache();
            const obj = arrPaperSubViewpointAppraiseObjLst_Cache.find(x => x.paperSubViewpointAppraiseId == objPaperSubViewpointAppraise.paperSubViewpointAppraiseId);
            if (obj != null) {
    ...
    */
    async function PaperSubViewpointAppraise_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objPaperSubViewpointAppraise == null)
            return "";
        if (objPaperSubViewpointAppraise.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function PaperSubViewpointAppraise_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrPaperSubViewpointAppraise = await PaperSubViewpointAppraise_GetObjLst_Cache();
        if (arrPaperSubViewpointAppraise == null)
            return [];
        let arrPaperSubViewpointAppraise_Sel = arrPaperSubViewpointAppraise;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrPaperSubViewpointAppraise_Sel = arrPaperSubViewpointAppraise_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrPaperSubViewpointAppraise_Sel = arrPaperSubViewpointAppraise_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrPaperSubViewpointAppraise_Sel = arrPaperSubViewpointAppraise_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrPaperSubViewpointAppraise_Sel = arrPaperSubViewpointAppraise_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
                if (Number(strInValue) == 0)
        ...
        if (arrPaperSubViewpointAppraise_Sel.length == 0)
            return [];
        return arrPaperSubViewpointAppraise_Sel.map(x => x.paperSubViewpointAppraiseId);
    }
    exports.PaperSubViewpointAppraise_funcKey = PaperSubViewpointAppraise_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function PaperSubViewpointAppraise_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperSubViewpointAppraiseExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrPaperSubViewpointAppraiseExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointAppraiseExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperSubViewpointAppraise_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointAppraiseExObjLst.length);
            console.log(strInfo);
            return arrPaperSubViewpointAppraiseExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperSubViewpointAppraise_ConstructorName, strThisFuncName);
    ...
    **/
    async function PaperSubViewpointAppraise_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointAppraiseExObjLst.length);
            console.log(strInfo);
            return arrPaperSubViewpointAppraiseExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrPaperSubViewpointAppraise_Sel = arrPaperSubViewpointAppraise_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function PaperSubViewpointAppraise_DelRecordAsync(lngPaperSubViewpointAppraiseId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngPaperSubViewpointAppraiseId);
        try {
    ...
    **/
    async function PaperSubViewpointAppraise_UpdateRecordAsync(objPaperSubViewpointAppraiseEN) {
        ...
        if (objPaperSubViewpointAppraiseEN.sf_UpdFldSetStr === undefined || objPaperSubViewpointAppraiseEN.sf_UpdFldSetStr === null || objPaperSubViewpointAppraiseEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperSubViewpointAppraiseEN.paperSubViewpointAppraiseId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperSubViewpointAppraise_Controller, strAction);
        try {
    ...
    */
    async function PaperSubViewpointAppraise_IsExistRecord_Cache(objPaperSubViewpointAppraise_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperSubViewpointAppraise_Cond), exports.paperSubViewpointAppraise_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperSubViewpointAppraise_IsExist_Cache(lngPaperSubViewpointAppraiseId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperSubViewpointAppraiseId, exports.paperSubViewpointAppraise_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function PaperSubViewpointAppraise_CheckPropertyNew(pobjPaperSubViewpointAppraiseEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.subViewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.subViewpointId) > 8) {
            throw new Error("(errid:Watl000059)字段[子观点Id(subViewpointId)]的长度不能超过8(In 子观点评论表(PaperSubViewpointAppraise))!值:$(pobjPaperSubViewpointAppraiseEN.subViewpointId)(clsPaperSubViewpointAppraiseBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.appraiseContent) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.appraiseContent) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.meno) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.meno) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.updUser) > 20) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperSubViewpointAppraiseEN.paperSubViewpointAppraiseId && undefined !== pobjPaperSubViewpointAppraiseEN.paperSubViewpointAppraiseId && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointAppraiseEN.paperSubViewpointAppraiseId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.subViewpointId) == false && undefined !== pobjPaperSubViewpointAppraiseEN.subViewpointId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointAppraiseEN.subViewpointId) === false) {
            throw new Error("(errid:Watl000060)字段[子观点Id(subViewpointId)]的值:[$(pobjPaperSubViewpointAppraiseEN.subViewpointId)], 非法，应该为字符型(In 子观点评论表(PaperSubViewpointAppraise))!(clsPaperSubViewpointAppraiseBL:CheckPropertyNew)");
        }
        if (null != pobjPaperSubViewpointAppraiseEN.appraiseScore && undefined !== pobjPaperSubViewpointAppraiseEN.appraiseScore && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointAppraiseEN.appraiseScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.appraiseContent) == false && undefined !== pobjPaperSubViewpointAppraiseEN.appraiseContent && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointAppraiseEN.appraiseContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.updDate) == false && undefined !== pobjPaperSubViewpointAppraiseEN.updDate && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointAppraiseEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.meno) == false && undefined !== pobjPaperSubViewpointAppraiseEN.meno && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointAppraiseEN.meno) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.updUser) == false && undefined !== pobjPaperSubViewpointAppraiseEN.updUser && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointAppraiseEN.updUser) === false) {
    ...
    */
    function PaperSubViewpointAppraise_CheckProperty4Update(pobjPaperSubViewpointAppraiseEN) {
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.subViewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.subViewpointId) > 8) {
            throw new Error("(errid:Watl000062)字段[子观点Id(subViewpointId)]的长度不能超过8(In 子观点评论表(PaperSubViewpointAppraise))!值:$(pobjPaperSubViewpointAppraiseEN.subViewpointId)(clsPaperSubViewpointAppraiseBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.appraiseContent) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointAppraiseEN.appraiseContent) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointAppraiseEN.subViewpointId) == false && undefined !== pobjPaperSubViewpointAppraiseEN.subViewpointId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointAppraiseEN.subViewpointId) === false) {
            throw new Error("(errid:Watl000063)字段[子观点Id(subViewpointId)]的值:[$(pobjPaperSubViewpointAppraiseEN.subViewpointId)], 非法，应该为字符型(In 子观点评论表(PaperSubViewpointAppraise))!(clsPaperSubViewpointAppraiseBL:CheckProperty4Update)");
        }
        if (null != pobjPaperSubViewpointAppraiseEN.appraiseScore && undefined !== pobjPaperSubViewpointAppraiseEN.appraiseScore && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointAppraiseEN.appraiseScore) === false) {
    ...
    */
    function PaperSubViewpointAppraise_GetCombineCondition(objPaperSubViewpointAppraise_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_PaperSubViewpointAppraiseId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_PaperSubViewpointAppraiseId, objPaperSubViewpointAppraise_Cond.paperSubViewpointAppraiseId, strComparisonOp_PaperSubViewpointAppraiseId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_SubViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_SubViewpointId, objPaperSubViewpointAppraise_Cond.subViewpointId, strComparisonOp_SubViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_AppraiseScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_AppraiseScore, objPaperSubViewpointAppraise_Cond.appraiseScore, strComparisonOp_AppraiseScore);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_AppraiseContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_AppraiseContent, objPaperSubViewpointAppraise_Cond.appraiseContent, strComparisonOp_AppraiseContent);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_UpdDate, objPaperSubViewpointAppraise_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_Meno) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_Meno, objPaperSubViewpointAppraise_Cond.meno, strComparisonOp_Meno);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpointAppraise_Cond.dicFldComparisonOp, clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointAppraiseEN_js_1.clsPaperSubViewpointAppraiseEN.con_UpdUser, objPaperSubViewpointAppraise_Cond.updUser, strComparisonOp_UpdUser);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperSubViewpointAppraise_GetUniCondStr_PaperSubViewpointAppraiseId_SuvViewpointId(objPaperSubViewpointAppraiseEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperSubViewpointAppraiseId = '{0}'", objPaperSubViewpointAppraiseEN.paperSubViewpointAppraiseId);
        return strWhereCond;
    }
