...
(function (factory) {
    ...
    **/
    async function PaperSubAttachment_GetObjByPaperSubAttachmentIdAsync(lngPaperSubAttachmentId) {
        ...
        if (lngPaperSubAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperSubAttachmentId]不能为空！(In clsPaperSubAttachmentWApi.GetObjByPaperSubAttachmentIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperSubAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperSubAttachment_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperSubAttachment_GetObjByPaperSubAttachmentId_Cache(lngPaperSubAttachmentId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperSubAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperSubAttachmentId]不能为空！(In clsPaperSubAttachmentWApi.GetObjByPaperSubAttachmentId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function PaperSubAttachment_GetObjByPaperSubAttachmentId_localStorage(lngPaperSubAttachmentId) {
        ...
        if (lngPaperSubAttachmentId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperSubAttachmentId]不能为空！(In clsPaperSubAttachmentWApi.GetObjByPaperSubAttachmentId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN._CurrTabName, lngPaperSubAttachmentId);
        if (strKey == "") {
    ...
    */
    async function PaperSubAttachment_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objPaperSubAttachment == null)
            return "";
        if (objPaperSubAttachment.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperSubAttachmentName:
                    return (a, b) => {
                        if (a.paperSubAttachmentName == null)
                            return -1;
                        if (b.paperSubAttachmentName == null)
                            return 1;
                        return a.paperSubAttachmentName.localeCompare(b.paperSubAttachmentName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function PaperSubAttachment_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.PaperSubAttachment_funcKey = PaperSubAttachment_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function PaperSubAttachment_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperSubAttachmentExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrPaperSubAttachmentExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubAttachmentExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperSubAttachment_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubAttachmentExObjLst.length);
            console.log(strInfo);
            return arrPaperSubAttachmentExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperSubAttachment_ConstructorName, strThisFuncName);
    ...
    **/
    async function PaperSubAttachment_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubAttachmentExObjLst.length);
            console.log(strInfo);
            return arrPaperSubAttachmentExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperSubAttachment_DelRecordAsync(lngPaperSubAttachmentId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngPaperSubAttachmentId);
        try {
    ...
    **/
    async function PaperSubAttachment_UpdateRecordAsync(objPaperSubAttachmentEN) {
        ...
        if (objPaperSubAttachmentEN.sf_UpdFldSetStr === undefined || objPaperSubAttachmentEN.sf_UpdFldSetStr === null || objPaperSubAttachmentEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperSubAttachmentEN.paperSubAttachmentId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperSubAttachment_Controller, strAction);
        try {
    ...
    */
    async function PaperSubAttachment_IsExistRecord_Cache(objPaperSubAttachment_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperSubAttachment_Cond), exports.paperSubAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperSubAttachment_IsExist_Cache(lngPaperSubAttachmentId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperSubAttachmentId, exports.paperSubAttachment_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function PaperSubAttachment_CheckPropertyNew(pobjPaperSubAttachmentEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.filePath) === true) {
            throw new Error("(errid:Watl000058)字段[文件路径]不能为空(In 子观点附件)!(clsPaperSubAttachmentBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.paperSubAttachmentName) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.paperSubAttachmentName) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.filePath) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.filePath) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.updUserId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.updUserId) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.memo) > 1000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.paperRWId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.paperRWId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.subViewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubAttachmentEN.subViewpointId) > 8) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperSubAttachmentEN.paperSubAttachmentId && undefined !== pobjPaperSubAttachmentEN.paperSubAttachmentId && clsString_js_1.tzDataType.isNumber(pobjPaperSubAttachmentEN.paperSubAttachmentId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.paperSubAttachmentName) == false && undefined !== pobjPaperSubAttachmentEN.paperSubAttachmentName && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.paperSubAttachmentName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.filePath) == false && undefined !== pobjPaperSubAttachmentEN.filePath && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.filePath) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.updUserId) == false && undefined !== pobjPaperSubAttachmentEN.updUserId && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.updUserId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.updDate) == false && undefined !== pobjPaperSubAttachmentEN.updDate && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.memo) == false && undefined !== pobjPaperSubAttachmentEN.memo && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.memo) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.id_CurrEduCls) == false && undefined !== pobjPaperSubAttachmentEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.paperRWId) == false && undefined !== pobjPaperSubAttachmentEN.paperRWId && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.paperRWId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubAttachmentEN.subViewpointId) == false && undefined !== pobjPaperSubAttachmentEN.subViewpointId && clsString_js_1.tzDataType.isString(pobjPaperSubAttachmentEN.subViewpointId) === false) {
    ...
    */
    function PaperSubAttachment_GetCombineCondition(objPaperSubAttachment_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperSubAttachmentId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperSubAttachmentId, objPaperSubAttachment_Cond.paperSubAttachmentId, strComparisonOp_PaperSubAttachmentId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperSubAttachmentName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperSubAttachmentName, objPaperSubAttachment_Cond.paperSubAttachmentName, strComparisonOp_PaperSubAttachmentName);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_FilePath) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_FilePath, objPaperSubAttachment_Cond.filePath, strComparisonOp_FilePath);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_UpdUserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_UpdUserId, objPaperSubAttachment_Cond.updUserId, strComparisonOp_UpdUserId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_UpdDate, objPaperSubAttachment_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_Memo, objPaperSubAttachment_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_id_CurrEduCls, objPaperSubAttachment_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperRWId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_PaperRWId, objPaperSubAttachment_Cond.paperRWId, strComparisonOp_PaperRWId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubAttachment_Cond.dicFldComparisonOp, clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_SubViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubAttachmentEN_js_1.clsPaperSubAttachmentEN.con_SubViewpointId, objPaperSubAttachment_Cond.subViewpointId, strComparisonOp_SubViewpointId);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperSubAttachment_GetUniCondStr_SubViewpointId_PaperSubAttachmentName(objPaperSubAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperSubAttachmentName = '{0}'", objPaperSubAttachmentEN.paperSubAttachmentName);
        return strWhereCond;
    }
    ...
    **/
    function PaperSubAttachment_GetUniCondStr4Update_SubViewpointId_PaperSubAttachmentName(objPaperSubAttachmentEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperSubAttachmentId <> '{0}'", objPaperSubAttachmentEN.paperSubAttachmentId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperSubAttachmentName = '{0}'", objPaperSubAttachmentEN.paperSubAttachmentName);
        return strWhereCond;
    }
