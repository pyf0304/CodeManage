...
(function (factory) {
    ...
    **/
    async function gs_PaperDiscuss_GetObjByDiscussIdAsync(strDiscussId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussId]不能为空！(In clsgs_PaperDiscussWApi.GetObjByDiscussIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussId]的长度:[{0}]不正确！(clsgs_PaperDiscussWApi.GetObjByDiscussIdAsync)", strDiscussId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperDiscuss_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperDiscuss_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperDiscuss_GetObjByDiscussId_Cache(strDiscussId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussId]不能为空！(In clsgs_PaperDiscussWApi.GetObjByDiscussId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussId]的长度:[{0}]不正确！(clsgs_PaperDiscussWApi.GetObjByDiscussId_Cache)", strDiscussId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_PaperDiscuss_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_PaperDiscuss_Const = await gs_PaperDiscuss_GetObjByDiscussIdAsync(strDiscussId);
                    if (objgs_PaperDiscuss_Const != null) {
                        gs_PaperDiscuss_ReFreshThisCache();
                        return objgs_PaperDiscuss_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_PaperDiscuss_GetObjByDiscussId_localStorage(strDiscussId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strDiscussId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strDiscussId]不能为空！(In clsgs_PaperDiscussWApi.GetObjByDiscussId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strDiscussId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strDiscussId]的长度:[{0}]不正确！(clsgs_PaperDiscussWApi.GetObjByDiscussId_localStorage)", strDiscussId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN._CurrTabName, strDiscussId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperDiscuss_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_PaperDiscuss == null)
            return "";
        if (objgs_PaperDiscuss.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_PaperDiscuss_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrgs_PaperDiscuss = await gs_PaperDiscuss_GetObjLst_Cache();
        if (arrgs_PaperDiscuss == null)
            return [];
        let arrgs_PaperDiscuss_Sel = arrgs_PaperDiscuss;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_PaperDiscuss_Sel = arrgs_PaperDiscuss_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_PaperDiscuss_Sel = arrgs_PaperDiscuss_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_PaperDiscuss_Sel = arrgs_PaperDiscuss_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_PaperDiscuss_Sel = arrgs_PaperDiscuss_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_PaperDiscuss_Sel.length == 0)
            return [];
        return arrgs_PaperDiscuss_Sel.map(x => x.discussId);
    }
    exports.gs_PaperDiscuss_funcKey = gs_PaperDiscuss_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_PaperDiscuss_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperDiscussExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_PaperDiscussExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperDiscussExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperDiscuss_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperDiscussExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperDiscussExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperDiscuss_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PaperDiscuss_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperDiscussExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperDiscussExObjLst;
        }
        catch (e) {
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_PaperDiscuss_Sel = arrgs_PaperDiscuss_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_PaperDiscuss_DelRecordAsync(strDiscussId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strDiscussId);
        try {
    ...
    **/
    async function gs_PaperDiscuss_UpdateRecordAsync(objgs_PaperDiscussEN) {
        ...
        if (objgs_PaperDiscussEN.sf_UpdFldSetStr === undefined || objgs_PaperDiscussEN.sf_UpdFldSetStr === null || objgs_PaperDiscussEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperDiscussEN.discussId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperDiscuss_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperDiscuss_IsExistRecord_Cache(objgs_PaperDiscuss_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperDiscuss_Cond), exports.gs_PaperDiscuss_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperDiscuss_IsExist_Cache(strDiscussId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strDiscussId, exports.gs_PaperDiscuss_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_PaperDiscuss_CheckPropertyNew(pobjgs_PaperDiscussEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussContent) === true) {
            throw new Error("(errid:Watl000058)字段[讨论内容]不能为空(In 论文讨论表)!(clsgs_PaperDiscussBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.parentId) === true) {
            throw new Error("(errid:Watl000058)字段[父节点Id]不能为空(In 论文讨论表)!(clsgs_PaperDiscussBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[讨论类型Id]不能为空(In 论文讨论表)!(clsgs_PaperDiscussBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.id_CurrEduCls) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.discussId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussContent) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.discussContent) > 2000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.parentId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.parentId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.scoreType) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.scoreType) > 1) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.discussTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.userId) > 18) {
            throw new Error("(errid:Watl000059)字段[用户ID(userId)]的长度不能超过18(In 论文讨论表(gs_PaperDiscuss))!值:$(pobjgs_PaperDiscussEN.userId)(clsgs_PaperDiscussBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussId) == false && undefined !== pobjgs_PaperDiscussEN.discussId && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.discussId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussContent) == false && undefined !== pobjgs_PaperDiscussEN.discussContent && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.discussContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.paperId) == false && undefined !== pobjgs_PaperDiscussEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.parentId) == false && undefined !== pobjgs_PaperDiscussEN.parentId && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.parentId) === false) {
        ...
        if (null != pobjgs_PaperDiscussEN.score && undefined !== pobjgs_PaperDiscussEN.score && clsString_js_1.tzDataType.isNumber(pobjgs_PaperDiscussEN.score) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.scoreType) == false && undefined !== pobjgs_PaperDiscussEN.scoreType && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.scoreType) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussTypeId) == false && undefined !== pobjgs_PaperDiscussEN.discussTypeId && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.discussTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.userId) == false && undefined !== pobjgs_PaperDiscussEN.userId && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.userId) === false) {
        ...
        if (null != pobjgs_PaperDiscussEN.voteCount && undefined !== pobjgs_PaperDiscussEN.voteCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperDiscussEN.voteCount) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.updUser) == false && undefined !== pobjgs_PaperDiscussEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.updDate) == false && undefined !== pobjgs_PaperDiscussEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.id_CurrEduCls) == false && undefined !== pobjgs_PaperDiscussEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.memo) == false && undefined !== pobjgs_PaperDiscussEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PaperDiscussEN.memo) === false) {
    ...
    */
    function gs_PaperDiscuss_CheckProperty4Update(pobjgs_PaperDiscussEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.userId) > 18) {
            throw new Error("(errid:Watl000062)字段[用户ID(userId)]的长度不能超过18(In 论文讨论表(gs_PaperDiscuss))!值:$(pobjgs_PaperDiscussEN.userId)(clsgs_PaperDiscussBL:CheckProperty4Update)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperDiscussEN.updUser) > 20) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperDiscussEN.discussId) === true) {
    ...
    */
    function gs_PaperDiscuss_GetCombineCondition(objgs_PaperDiscuss_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_DiscussId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_DiscussId, objgs_PaperDiscuss_Cond.discussId, strComparisonOp_DiscussId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_DiscussContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_DiscussContent, objgs_PaperDiscuss_Cond.discussContent, strComparisonOp_DiscussContent);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_PaperId, objgs_PaperDiscuss_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_ParentId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_ParentId, objgs_PaperDiscuss_Cond.parentId, strComparisonOp_ParentId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_Score, objgs_PaperDiscuss_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_ScoreType) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_ScoreType, objgs_PaperDiscuss_Cond.scoreType, strComparisonOp_ScoreType);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_DiscussTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_DiscussTypeId, objgs_PaperDiscuss_Cond.discussTypeId, strComparisonOp_DiscussTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_UserId, objgs_PaperDiscuss_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_VoteCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_VoteCount, objgs_PaperDiscuss_Cond.voteCount, strComparisonOp_VoteCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_UpdUser, objgs_PaperDiscuss_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_UpdDate, objgs_PaperDiscuss_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_id_CurrEduCls, objgs_PaperDiscuss_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperDiscuss_Cond.dicFldComparisonOp, clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperDiscussEN_js_1.clsgs_PaperDiscussEN.con_Memo, objgs_PaperDiscuss_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperDiscuss_GetUniCondStr_DiscussId(objgs_PaperDiscussEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and DiscussId = '{0}'", objgs_PaperDiscussEN.discussId);
        return strWhereCond;
    }
