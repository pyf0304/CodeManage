...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsgs_PConcepRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_PConcepRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_PConcepRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PConcepRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PConcepRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PConcepRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PConcepRela_UpdateRecordAsync(objgs_PConcepRelaEN) {
        ...
        if (objgs_PConcepRelaEN.sf_UpdFldSetStr === undefined || objgs_PConcepRelaEN.sf_UpdFldSetStr === null || objgs_PConcepRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PConcepRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PConcepRela_Controller, strAction);
        try {
    ...
    */
    function gs_PConcepRela_CheckPropertyNew(pobjgs_PConcepRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.conceptId) === true) {
            throw new Error("(errid:Watl000058)字段[概念Id]不能为空(In 论文概念关系)!(clsgs_PConcepRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PConcepRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.sectionId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PConcepRelaEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.conceptId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PConcepRelaEN.conceptId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PConcepRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PConcepRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PConcepRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_PConcepRelaEN.mId && undefined !== pobjgs_PConcepRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_PConcepRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.paperId) == false && undefined !== pobjgs_PConcepRelaEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PConcepRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.sectionId) == false && undefined !== pobjgs_PConcepRelaEN.sectionId && clsString_js_1.tzDataType.isString(pobjgs_PConcepRelaEN.sectionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.conceptId) == false && undefined !== pobjgs_PConcepRelaEN.conceptId && clsString_js_1.tzDataType.isString(pobjgs_PConcepRelaEN.conceptId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.updDate) == false && undefined !== pobjgs_PConcepRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PConcepRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.updUser) == false && undefined !== pobjgs_PConcepRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PConcepRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PConcepRelaEN.memo) == false && undefined !== pobjgs_PConcepRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PConcepRelaEN.memo) === false) {
    ...
    */
    function gs_PConcepRela_GetCombineCondition(objgs_PConcepRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_mId, objgs_PConcepRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_PaperId, objgs_PConcepRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_SectionId, objgs_PConcepRela_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_ConceptId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_ConceptId, objgs_PConcepRela_Cond.conceptId, strComparisonOp_ConceptId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_UpdDate, objgs_PConcepRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_UpdUser, objgs_PConcepRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PConcepRela_Cond.dicFldComparisonOp, clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PConcepRelaEN_js_1.clsgs_PConcepRelaEN.con_Memo, objgs_PConcepRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PConcepRela_GetUniCondStr_mId(objgs_PConcepRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_PConcepRelaEN.mId);
        return strWhereCond;
    }
