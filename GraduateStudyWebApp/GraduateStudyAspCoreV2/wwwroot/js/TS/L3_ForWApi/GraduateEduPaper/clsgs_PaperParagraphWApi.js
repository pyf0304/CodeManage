...
(function (factory) {
    ...
    **/
    async function gs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphId]不能为空！(In clsgs_PaperParagraphWApi.GetObjByParagraphIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsgs_PaperParagraphWApi.GetObjByParagraphIdAsync)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperParagraph_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperParagraph_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperParagraph_GetObjByParagraphId_Cache(strParagraphId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphId]不能为空！(In clsgs_PaperParagraphWApi.GetObjByParagraphId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsgs_PaperParagraphWApi.GetObjByParagraphId_Cache)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_PaperParagraph_GetObjByParagraphId_localStorage(strParagraphId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strParagraphId]不能为空！(In clsgs_PaperParagraphWApi.GetObjByParagraphId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsgs_PaperParagraphWApi.GetObjByParagraphId_localStorage)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN._CurrTabName, strParagraphId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperParagraph_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_PaperParagraph == null)
            return "";
        if (objgs_PaperParagraph.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_PaperParagraph_funcKey(strInFldName, strInValue, strComparisonOp) {
    ...
    exports.gs_PaperParagraph_funcKey = gs_PaperParagraph_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_PaperParagraph_GetObjLst_ClientCache() {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperParagraphExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_PaperParagraphExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperParagraphExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperParagraph_GetObjLst_localStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperParagraphExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperParagraphExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperParagraph_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PaperParagraph_GetObjLst_sessionStorage() {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperParagraphExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperParagraphExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperParagraph_DelRecordAsync(strParagraphId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strParagraphId);
        try {
    ...
    **/
    async function gs_PaperParagraph_UpdateRecordAsync(objgs_PaperParagraphEN) {
        ...
        if (objgs_PaperParagraphEN.sf_UpdFldSetStr === undefined || objgs_PaperParagraphEN.sf_UpdFldSetStr === null || objgs_PaperParagraphEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperParagraphEN.paragraphId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperParagraph_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperParagraph_IsExistRecord_Cache(objgs_PaperParagraph_Cond) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperParagraph_Cond), exports.gs_PaperParagraph_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperParagraph_IsExist_Cache(strParagraphId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strParagraphId, exports.gs_PaperParagraph_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    */
    function gs_PaperParagraph_CheckPropertyNew(pobjgs_PaperParagraphEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.sectionId) === true) {
            throw new Error("(errid:Watl000058)字段[节Id]不能为空(In 论文段落表)!(clsgs_PaperParagraphBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphStateId) === true) {
            throw new Error("(errid:Watl000058)字段[段落状态Id]不能为空(In 论文段落表)!(clsgs_PaperParagraphBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphTypeId) === true) {
            throw new Error("(errid:Watl000058)字段[段落类型Id]不能为空(In 论文段落表)!(clsgs_PaperParagraphBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.paragraphId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.sectionId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphStateId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.paragraphStateId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.paragraphTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.createDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.createDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.createUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.createUser) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperParagraphEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphId) == false && undefined !== pobjgs_PaperParagraphEN.paragraphId && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.paragraphId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paperId) == false && undefined !== pobjgs_PaperParagraphEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.sectionId) == false && undefined !== pobjgs_PaperParagraphEN.sectionId && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.sectionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphStateId) == false && undefined !== pobjgs_PaperParagraphEN.paragraphStateId && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.paragraphStateId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphTypeId) == false && undefined !== pobjgs_PaperParagraphEN.paragraphTypeId && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.paragraphTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphContent) == false && undefined !== pobjgs_PaperParagraphEN.paragraphContent && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.paragraphContent) === false) {
        ...
        if (null != pobjgs_PaperParagraphEN.voteCount && undefined !== pobjgs_PaperParagraphEN.voteCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperParagraphEN.voteCount) === false) {
        ...
        if (null != pobjgs_PaperParagraphEN.commentCount && undefined !== pobjgs_PaperParagraphEN.commentCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperParagraphEN.commentCount) === false) {
        ...
        if (null != pobjgs_PaperParagraphEN.versionCount && undefined !== pobjgs_PaperParagraphEN.versionCount && clsString_js_1.tzDataType.isNumber(pobjgs_PaperParagraphEN.versionCount) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.createDate) == false && undefined !== pobjgs_PaperParagraphEN.createDate && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.createDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.createUser) == false && undefined !== pobjgs_PaperParagraphEN.createUser && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.createUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.updDate) == false && undefined !== pobjgs_PaperParagraphEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.updUser) == false && undefined !== pobjgs_PaperParagraphEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.memo) == false && undefined !== pobjgs_PaperParagraphEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PaperParagraphEN.memo) === false) {
        ...
        if (null != pobjgs_PaperParagraphEN.orderNum && undefined !== pobjgs_PaperParagraphEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjgs_PaperParagraphEN.orderNum) === false) {
    ...
    */
    function gs_PaperParagraph_CheckProperty4Update(pobjgs_PaperParagraphEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperParagraphEN.paragraphId) === true) {
    ...
    */
    function gs_PaperParagraph_GetCombineCondition(objgs_PaperParagraph_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_ParagraphId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_ParagraphId, objgs_PaperParagraph_Cond.paragraphId, strComparisonOp_ParagraphId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_PaperId, objgs_PaperParagraph_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_SectionId, objgs_PaperParagraph_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_ParagraphStateId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_ParagraphStateId, objgs_PaperParagraph_Cond.paragraphStateId, strComparisonOp_ParagraphStateId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_ParagraphTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_ParagraphTypeId, objgs_PaperParagraph_Cond.paragraphTypeId, strComparisonOp_ParagraphTypeId);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_VoteCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_VoteCount, objgs_PaperParagraph_Cond.voteCount, strComparisonOp_VoteCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_CommentCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_CommentCount, objgs_PaperParagraph_Cond.commentCount, strComparisonOp_CommentCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_VersionCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_VersionCount, objgs_PaperParagraph_Cond.versionCount, strComparisonOp_VersionCount);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_CreateDate, objgs_PaperParagraph_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_CreateUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_CreateUser, objgs_PaperParagraph_Cond.createUser, strComparisonOp_CreateUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_UpdDate, objgs_PaperParagraph_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_UpdUser, objgs_PaperParagraph_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_Memo, objgs_PaperParagraph_Cond.memo, strComparisonOp_Memo);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperParagraph_Cond.dicFldComparisonOp, clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperParagraphEN_js_1.clsgs_PaperParagraphEN.con_OrderNum, objgs_PaperParagraph_Cond.orderNum, strComparisonOp_OrderNum);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperParagraph_GetUniCondStr_ParagraphId(objgs_PaperParagraphEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and ParagraphId = '{0}'", objgs_PaperParagraphEN.paragraphId);
        return strWhereCond;
    }
