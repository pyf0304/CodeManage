...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsgs_PTopicObjectiveRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_PTopicObjectiveRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_PTopicObjectiveRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PTopicObjectiveRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PTopicObjectiveRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PTopicObjectiveRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PTopicObjectiveRela_UpdateRecordAsync(objgs_PTopicObjectiveRelaEN) {
        ...
        if (objgs_PTopicObjectiveRelaEN.sf_UpdFldSetStr === undefined || objgs_PTopicObjectiveRelaEN.sf_UpdFldSetStr === null || objgs_PTopicObjectiveRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PTopicObjectiveRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PTopicObjectiveRela_Controller, strAction);
        try {
    ...
    */
    function gs_PTopicObjectiveRela_CheckPropertyNew(pobjgs_PTopicObjectiveRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) === true) {
            throw new Error("(errid:Watl000058)字段[客观Id]不能为空(In 论文客观关系表)!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PTopicObjectiveRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.sectionId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PTopicObjectiveRelaEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PTopicObjectiveRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PTopicObjectiveRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PTopicObjectiveRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_PTopicObjectiveRelaEN.mId && undefined !== pobjgs_PTopicObjectiveRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_PTopicObjectiveRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.paperId) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.sectionId) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.sectionId && clsString_js_1.tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.sectionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.topicObjectiveId && clsString_js_1.tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.updDate) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.updUser) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PTopicObjectiveRelaEN.memo) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.memo) === false) {
    ...
    */
    function gs_PTopicObjectiveRela_GetCombineCondition(objgs_PTopicObjectiveRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_mId, objgs_PTopicObjectiveRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_PaperId, objgs_PTopicObjectiveRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_SectionId, objgs_PTopicObjectiveRela_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_TopicObjectiveId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_TopicObjectiveId, objgs_PTopicObjectiveRela_Cond.topicObjectiveId, strComparisonOp_TopicObjectiveId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_UpdDate, objgs_PTopicObjectiveRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_UpdUser, objgs_PTopicObjectiveRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRela_Cond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN_js_1.clsgs_PTopicObjectiveRelaEN.con_Memo, objgs_PTopicObjectiveRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PTopicObjectiveRela_GetUniCondStr_mId(objgs_PTopicObjectiveRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_PTopicObjectiveRelaEN.mId);
        return strWhereCond;
    }
