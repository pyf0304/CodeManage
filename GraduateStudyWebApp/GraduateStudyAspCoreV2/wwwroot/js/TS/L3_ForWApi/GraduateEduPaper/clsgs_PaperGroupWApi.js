...
(function (factory) {
    ...
    **/
    async function gs_PaperGroup_GetObjByPaperGroupIdAsync(strPaperGroupId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperGroupId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetObjByPaperGroupIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperGroupId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetObjByPaperGroupIdAsync)", strPaperGroupId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperGroup_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperGroup_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperGroup_GetObjByPaperGroupId_Cache(strPaperGroupId, strUpdUser, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperGroupId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetObjByPaperGroupId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperGroupId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetObjByPaperGroupId_Cache)", strPaperGroupId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrgs_PaperGroup_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objgs_PaperGroup_Const = await gs_PaperGroup_GetObjByPaperGroupIdAsync(strPaperGroupId);
                    if (objgs_PaperGroup_Const != null) {
                        gs_PaperGroup_ReFreshThisCache(strUpdUser);
                        return objgs_PaperGroup_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function gs_PaperGroup_GetObjByPaperGroupId_localStorage(strPaperGroupId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperGroupId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetObjByPaperGroupId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperGroupId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetObjByPaperGroupId_localStorage)", strPaperGroupId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN._CurrTabName, strPaperGroupId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperGroup_GetNameByPaperGroupId_Cache(strPaperGroupId, strUpdUser) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strPaperGroupId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strPaperGroupId]不能为空！(In clsgs_PaperGroupWApi.GetNameByPaperGroupId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperGroupId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strPaperGroupId]的长度:[{0}]不正确！(clsgs_PaperGroupWApi.GetNameByPaperGroupId_Cache)", strPaperGroupId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrgs_PaperGroupObjLst_Cache = await gs_PaperGroup_GetObjLst_Cache(strUpdUser);
    ...
    */
    async function gs_PaperGroup_func(strInFldName, strOutFldName, strInValue, strUpdUser_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUpdUser_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUpdUser_C]不能为空！(In clsgs_PaperGroupWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_PaperGroup == null)
            return "";
        if (objgs_PaperGroup.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                case clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId:
                    return (a, b) => {
                        if (a.paperGroupId == null)
                            return -1;
                        if (b.paperGroupId == null)
                            return 1;
                        return a.paperGroupId.localeCompare(b.paperGroupId);
                    };
                case clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupName:
                    return (a, b) => {
                        if (a.paperGroupName == null)
                            return -1;
                        if (b.paperGroupName == null)
                            return 1;
                        return a.paperGroupName.localeCompare(b.paperGroupName);
                    };
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_PaperGroup_funcKey(strInFldName, strInValue, strComparisonOp, strUpdUser_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strUpdUser_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUpdUser_C]不能为空！(In clsgs_PaperGroupWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId) {
        ...
        const arrgs_PaperGroup = await gs_PaperGroup_GetObjLst_Cache(strUpdUser_C);
        if (arrgs_PaperGroup == null)
            return [];
        let arrgs_PaperGroup_Sel = arrgs_PaperGroup;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrgs_PaperGroup_Sel = arrgs_PaperGroup_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrgs_PaperGroup_Sel = arrgs_PaperGroup_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrgs_PaperGroup_Sel = arrgs_PaperGroup_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrgs_PaperGroup_Sel = arrgs_PaperGroup_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrgs_PaperGroup_Sel.length == 0)
            return [];
        return arrgs_PaperGroup_Sel.map(x => x.paperGroupId);
    }
    exports.gs_PaperGroup_funcKey = gs_PaperGroup_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_PaperGroup_GetObjLst_ClientCache(strUpdUser) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.WhereFormat, strUpdUser);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("UpdUser='{0}'", strUpdUser);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN._CurrTabName, strUpdUser);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperGroupExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_PaperGroupExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperGroupExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperGroup_GetObjLst_localStorage(strUpdUser) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperGroupExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperGroupExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperGroup_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PaperGroup_GetObjLst_sessionStorage(strUpdUser) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperGroupExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperGroupExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperGroup_GetObjLst_Cache(strUpdUser) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUpdUser) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[UpdUser]不能为空！(in clsgs_PaperGroupWApi.gs_PaperGroup_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrgs_PaperGroup_Sel = arrgs_PaperGroup_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
    ...
    **/
    async function gs_PaperGroup_DelRecordAsync(strPaperGroupId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strPaperGroupId);
        try {
    ...
    **/
    async function gs_PaperGroup_UpdateRecordAsync(objgs_PaperGroupEN) {
        ...
        if (objgs_PaperGroupEN.sf_UpdFldSetStr === undefined || objgs_PaperGroupEN.sf_UpdFldSetStr === null || objgs_PaperGroupEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperGroupEN.paperGroupId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperGroup_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperGroup_IsExistRecord_Cache(objgs_PaperGroup_Cond, strUpdUser) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperGroup_Cond), exports.gs_PaperGroup_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperGroup_IsExist_Cache(strPaperGroupId, strUpdUser) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strPaperGroupId, exports.gs_PaperGroup_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_PaperGroup_ReFreshCache(strUpdUser) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUpdUser) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUpdUser]不能为空！(In clsgs_PaperGroupWApi.clsgs_PaperGroupWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
     ...
     * @param strUpdUser:修改人
    */
    async function gs_PaperGroup_BindDdl_PaperGroupIdByUpdUserInDiv_Cache(strDivName, strDdlName, strUpdUser) {
        const strThisFuncName = "BindDdl_PaperGroupIdByUpdUserInDiv_Cache";
        if ((0, clsString_js_2.IsNullOrEmpty)(strUpdUser) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUpdUser]不能为空！(In clsgs_PaperGroupWApi.BindDdl_PaperGroupIdByUpdUserInDiv)");
            console.error(strMsg);
            throw (strMsg);
        }
        const objDdl = document.getElementById(strDdlName);
        if (objDdl == null) {
            const strMsg = (0, clsString_js_2.Format)("下拉框：{0} 不存在！(In BindDdl_PaperGroupIdByUpdUserInDiv)", strDdlName);
            alert(strMsg);
            console.error(strMsg);
            throw (strMsg);
        }
        //为数据源于表的下拉框设置内容
        //console.log("开始：BindDdl_PaperGroupIdByUpdUserInDiv_Cache");
        let arrObjLst_Sel = await gs_PaperGroup_GetObjLst_Cache(strUpdUser);
    ...
    exports.gs_PaperGroup_BindDdl_PaperGroupIdByUpdUserInDiv_Cache = gs_PaperGroup_BindDdl_PaperGroupIdByUpdUserInDiv_Cache;
    /**
    ...
    */
    function gs_PaperGroup_CheckPropertyNew(pobjgs_PaperGroupEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 论文分组)!(clsgs_PaperGroupBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.paperGroupId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperGroupEN.paperGroupId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.paperGroupName) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperGroupEN.paperGroupName) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperGroupEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperGroupEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.meno) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperGroupEN.meno) > 2000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.paperGroupId) == false && undefined !== pobjgs_PaperGroupEN.paperGroupId && clsString_js_1.tzDataType.isString(pobjgs_PaperGroupEN.paperGroupId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.paperGroupName) == false && undefined !== pobjgs_PaperGroupEN.paperGroupName && clsString_js_1.tzDataType.isString(pobjgs_PaperGroupEN.paperGroupName) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.updUser) == false && undefined !== pobjgs_PaperGroupEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PaperGroupEN.updUser) === false) {
        ...
        if (null != pobjgs_PaperGroupEN.orderNum && undefined !== pobjgs_PaperGroupEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjgs_PaperGroupEN.orderNum) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.updDate) == false && undefined !== pobjgs_PaperGroupEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PaperGroupEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.meno) == false && undefined !== pobjgs_PaperGroupEN.meno && clsString_js_1.tzDataType.isString(pobjgs_PaperGroupEN.meno) === false) {
    ...
    */
    function gs_PaperGroup_CheckProperty4Update(pobjgs_PaperGroupEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperGroupEN.paperGroupId) === true
    ...
    */
    function gs_PaperGroup_GetCombineCondition(objgs_PaperGroup_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperGroup_Cond.dicFldComparisonOp, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupId, objgs_PaperGroup_Cond.paperGroupId, strComparisonOp_PaperGroupId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperGroup_Cond.dicFldComparisonOp, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupName) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_PaperGroupName, objgs_PaperGroup_Cond.paperGroupName, strComparisonOp_PaperGroupName);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperGroup_Cond.dicFldComparisonOp, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_UpdUser, objgs_PaperGroup_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperGroup_Cond.dicFldComparisonOp, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_OrderNum, objgs_PaperGroup_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperGroup_Cond.dicFldComparisonOp, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_UpdDate, objgs_PaperGroup_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperGroup_Cond.dicFldComparisonOp, clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_Meno) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN.con_Meno, objgs_PaperGroup_Cond.meno, strComparisonOp_Meno);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperGroup_GetUniCondStr_PaperGroupName_UpdUser(objgs_PaperGroupEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperGroupName = '{0}'", objgs_PaperGroupEN.paperGroupName);
        strWhereCond += (0, clsString_js_2.Format)(" and UpdUser = '{0}'", objgs_PaperGroupEN.updUser);
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperGroup_GetUniCondStr4Update_PaperGroupName_UpdUser(objgs_PaperGroupEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperGroupId <> '{0}'", objgs_PaperGroupEN.paperGroupId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperGroupName = '{0}'", objgs_PaperGroupEN.paperGroupName);
        strWhereCond += (0, clsString_js_2.Format)(" and UpdUser = '{0}'", objgs_PaperGroupEN.updUser);
        return strWhereCond;
    }
