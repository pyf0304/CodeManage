...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../PubFun/enumComparisonOp.js", "../../PubFun/CacheHelper.js", "../../PubFun/CacheHelper.js", "../../L0_Entity/GraduateEduPaper/clsvPaperSimProEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    */
    async function vPaperSimPro_GetNameByPaperId_Cache(strPaperId, strid_CurrEduCls) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strPaperId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strPaperId]不能为空！(In GetNameByPaperId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strPaperId.length != 8) {
    ...
    */
    async function vPaperSimPro_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strid_CurrEduCls_C]不能为空！(In funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
    ...
    **/
    async function vPaperSimPro_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if (CacheHelper_js_3.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvPaperSimProExObjLst_Cache = CacheHelper_js_3.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_3.CacheHelper.Add(strKey, arrvPaperSimProExObjLst);
    ...
    **/
    async function vPaperSimPro_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const arrCacheKeyLst = (0, CacheHelper_js_1.LocalStorage_GetKeyByPrefix)(strPrefix);
    ...
    **/
    async function vPaperSimPro_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            const arrvPaperSimProExObjLst = await vPaperSimPro_GetObjLstAsync(strWhereCond);
            const strPrefix = (0, clsString_js_1.Format)("{0}_", clsvPaperSimProEN_js_1.clsvPaperSimProEN._CurrTabName);
            const arrCacheKeyLst = (0, CacheHelper_js_2.SessionStorage_GetKeyByPrefix)(strPrefix);
        ...
        if (clsSysPara4WebApi_js_1.clsSysPara4WebApi.spSetRefreshCacheOn == true) {
            ...
            switch (clsvPaperSimProEN_js_1.clsvPaperSimProEN.CacheModeId) {
                ...
                case "03": //localStorage
                    ...
                    break;
                case "02": //ClientCache
                    CacheHelper_js_3.CacheHelper.Remove(strKey);
                    break;
                default:
                    CacheHelper_js_3.CacheHelper.Remove(strKey);
                    break;
