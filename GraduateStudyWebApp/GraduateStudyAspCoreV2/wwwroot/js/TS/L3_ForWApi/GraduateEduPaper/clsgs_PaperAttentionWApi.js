...
(function (factory) {
    ...
    **/
    async function gs_PaperAttention_GetObjByPaperAttentionIdAsync(lngPaperAttentionId) {
        ...
        if (lngPaperAttentionId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperAttentionId]不能为空！(In clsgs_PaperAttentionWApi.GetObjByPaperAttentionIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PaperAttention_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PaperAttention_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function gs_PaperAttention_GetObjByPaperAttentionId_Cache(lngPaperAttentionId, strUserId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperAttentionId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperAttentionId]不能为空！(In clsgs_PaperAttentionWApi.GetObjByPaperAttentionId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function gs_PaperAttention_GetObjByPaperAttentionId_localStorage(lngPaperAttentionId) {
        ...
        if (lngPaperAttentionId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngPaperAttentionId]不能为空！(In clsgs_PaperAttentionWApi.GetObjByPaperAttentionId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN._CurrTabName, lngPaperAttentionId);
        if (strKey == "") {
    ...
    */
    async function gs_PaperAttention_func(strInFldName, strOutFldName, strInValue, strUserId_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId_C]不能为空！(In clsgs_PaperAttentionWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objgs_PaperAttention == null)
            return "";
        if (objgs_PaperAttention.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function gs_PaperAttention_funcKey(strInFldName, strInValue, strComparisonOp, strUserId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId_C]不能为空！(In clsgs_PaperAttentionWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperAttentionId) {
    ...
    exports.gs_PaperAttention_funcKey = gs_PaperAttention_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function gs_PaperAttention_GetObjLst_ClientCache(strUserId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.WhereFormat, strUserId);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("UserId='{0}'", strUserId);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN._CurrTabName, strUserId);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrgs_PaperAttentionExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrgs_PaperAttentionExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperAttentionExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function gs_PaperAttention_GetObjLst_localStorage(strUserId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperAttentionExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperAttentionExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PaperAttention_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PaperAttention_GetObjLst_sessionStorage(strUserId) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrgs_PaperAttentionExObjLst.length);
            console.log(strInfo);
            return arrgs_PaperAttentionExObjLst;
        }
        catch (e) {
    ...
    **/
    async function gs_PaperAttention_GetObjLst_Cache(strUserId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[UserId]不能为空！(in clsgs_PaperAttentionWApi.gs_PaperAttention_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function gs_PaperAttention_DelRecordAsync(lngPaperAttentionId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, lngPaperAttentionId);
        try {
    ...
    **/
    async function gs_PaperAttention_UpdateRecordAsync(objgs_PaperAttentionEN) {
        ...
        if (objgs_PaperAttentionEN.sf_UpdFldSetStr === undefined || objgs_PaperAttentionEN.sf_UpdFldSetStr === null || objgs_PaperAttentionEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PaperAttentionEN.paperAttentionId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PaperAttention_Controller, strAction);
        try {
    ...
    */
    async function gs_PaperAttention_IsExistRecord_Cache(objgs_PaperAttention_Cond, strUserId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objgs_PaperAttention_Cond), exports.gs_PaperAttention_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function gs_PaperAttention_IsExist_Cache(lngPaperAttentionId, strUserId) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngPaperAttentionId, exports.gs_PaperAttention_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function gs_PaperAttention_ReFreshCache(strUserId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strUserId]不能为空！(In clsgs_PaperAttentionWApi.clsgs_PaperAttentionWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function gs_PaperAttention_CheckPropertyNew(pobjgs_PaperAttentionEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.updUser) === true) {
            throw new Error("(errid:Watl000058)字段[修改人]不能为空(In 论文关注)!(clsgs_PaperAttentionBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperAttentionEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperAttentionEN.userId) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.paperGroupId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperAttentionEN.paperGroupId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperAttentionEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperAttentionEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.meno) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PaperAttentionEN.meno) > 2000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_PaperAttentionEN.paperAttentionId && undefined !== pobjgs_PaperAttentionEN.paperAttentionId && clsString_js_1.tzDataType.isNumber(pobjgs_PaperAttentionEN.paperAttentionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.paperId) == false && undefined !== pobjgs_PaperAttentionEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PaperAttentionEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.userId) == false && undefined !== pobjgs_PaperAttentionEN.userId && clsString_js_1.tzDataType.isString(pobjgs_PaperAttentionEN.userId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.paperGroupId) == false && undefined !== pobjgs_PaperAttentionEN.paperGroupId && clsString_js_1.tzDataType.isString(pobjgs_PaperAttentionEN.paperGroupId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.updUser) == false && undefined !== pobjgs_PaperAttentionEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PaperAttentionEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.updDate) == false && undefined !== pobjgs_PaperAttentionEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PaperAttentionEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PaperAttentionEN.meno) == false && undefined !== pobjgs_PaperAttentionEN.meno && clsString_js_1.tzDataType.isString(pobjgs_PaperAttentionEN.meno) === false) {
    ...
    */
    function gs_PaperAttention_GetCombineCondition(objgs_PaperAttention_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperAttentionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperAttentionId, objgs_PaperAttention_Cond.paperAttentionId, strComparisonOp_PaperAttentionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperId, objgs_PaperAttention_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_UserId, objgs_PaperAttention_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperGroupId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_PaperGroupId, objgs_PaperAttention_Cond.paperGroupId, strComparisonOp_PaperGroupId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_UpdUser, objgs_PaperAttention_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_UpdDate, objgs_PaperAttention_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PaperAttention_Cond.dicFldComparisonOp, clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_Meno) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PaperAttentionEN_js_1.clsgs_PaperAttentionEN.con_Meno, objgs_PaperAttention_Cond.meno, strComparisonOp_Meno);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperAttention_GetUniCondStr_PaperId_UserId(objgs_PaperAttentionEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objgs_PaperAttentionEN.paperId);
        strWhereCond += (0, clsString_js_2.Format)(" and UserId = '{0}'", objgs_PaperAttentionEN.userId);
        return strWhereCond;
    }
    ...
    **/
    function gs_PaperAttention_GetUniCondStr4Update_PaperId_UserId(objgs_PaperAttentionEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperAttentionId <> '{0}'", objgs_PaperAttentionEN.paperAttentionId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objgs_PaperAttentionEN.paperId);
        strWhereCond += (0, clsString_js_2.Format)(" and UserId = '{0}'", objgs_PaperAttentionEN.userId);
        return strWhereCond;
    }
