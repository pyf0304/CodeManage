...
(function (factory) {
    ...
    **/
    async function PaperEduClsRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsPaperEduClsRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperEduClsRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperEduClsRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperEduClsRela_GetObjBymId_Cache(lngmId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsPaperEduClsRelaWApi.GetObjBymId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function PaperEduClsRela_GetObjBymId_localStorage(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsPaperEduClsRelaWApi.GetObjBymId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN._CurrTabName, lngmId);
        if (strKey == "") {
    ...
    */
    async function PaperEduClsRela_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsPaperEduClsRelaWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsPaperEduClsRelaWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objPaperEduClsRela == null)
            return "";
        if (objPaperEduClsRela.GetFldValue(strOutFldName) == null)
            return "";
    ...
    function PaperEduClsRela_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_PaperTitle:
                    return (a, b) => {
                ...
                case clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_Author:
                    return (a, b) => {
                        if (a.author == null)
                            return -1;
                        if (b.author == null)
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function PaperEduClsRela_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsPaperEduClsRelaWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsPaperEduClsRelaWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_mId) {
    ...
    exports.PaperEduClsRela_funcKey = PaperEduClsRela_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function PaperEduClsRela_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperEduClsRelaExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrPaperEduClsRelaExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperEduClsRelaExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperEduClsRela_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperEduClsRelaExObjLst.length);
            console.log(strInfo);
            return arrPaperEduClsRelaExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperEduClsRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function PaperEduClsRela_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperEduClsRelaExObjLst.length);
            console.log(strInfo);
            return arrPaperEduClsRelaExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperEduClsRela_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsPaperEduClsRelaWApi.PaperEduClsRela_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsPaperEduClsRelaWApi.PaperEduClsRela_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function PaperEduClsRela_UpdateRecordAsync(objPaperEduClsRelaEN) {
        ...
        if (objPaperEduClsRelaEN.sf_UpdFldSetStr === undefined || objPaperEduClsRelaEN.sf_UpdFldSetStr === null || objPaperEduClsRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperEduClsRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperEduClsRela_Controller, strAction);
        try {
    ...
    */
    async function PaperEduClsRela_IsExistRecord_Cache(objPaperEduClsRela_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperEduClsRela_Cond), exports.paperEduClsRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperEduClsRela_IsExist_Cache(lngmId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", lngmId, exports.paperEduClsRela_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function PaperEduClsRela_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsPaperEduClsRelaWApi.clsPaperEduClsRelaWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsPaperEduClsRelaWApi.clsPaperEduClsRelaWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function PaperEduClsRela_CheckPropertyNew(pobjPaperEduClsRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.paperTitle) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.paperTitle) > 500) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.author) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.author) > 200) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjPaperEduClsRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjPaperEduClsRelaEN.mId && undefined !== pobjPaperEduClsRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjPaperEduClsRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.paperId) == false && undefined !== pobjPaperEduClsRelaEN.paperId && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.paperTitle) == false && undefined !== pobjPaperEduClsRelaEN.paperTitle && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.paperTitle) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.id_CurrEduCls) == false && undefined !== pobjPaperEduClsRelaEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.author) == false && undefined !== pobjPaperEduClsRelaEN.author && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.author) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.updUser) == false && undefined !== pobjPaperEduClsRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.updDate) == false && undefined !== pobjPaperEduClsRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperEduClsRelaEN.memo) == false && undefined !== pobjPaperEduClsRelaEN.memo && clsString_js_1.tzDataType.isString(pobjPaperEduClsRelaEN.memo) === false) {
    ...
    */
    function PaperEduClsRela_GetCombineCondition(objPaperEduClsRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_mId, objPaperEduClsRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_PaperId, objPaperEduClsRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_PaperTitle) == true) {
            const strComparisonOp_PaperTitle = objPaperEduClsRela_Cond.dicFldComparisonOp[clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_PaperTitle];
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_PaperTitle, objPaperEduClsRela_Cond.paperTitle, strComparisonOp_PaperTitle);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_id_CurrEduCls, objPaperEduClsRela_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_Author) == true) {
            const strComparisonOp_Author = objPaperEduClsRela_Cond.dicFldComparisonOp[clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_Author];
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_Author, objPaperEduClsRela_Cond.author, strComparisonOp_Author);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_UpdUser, objPaperEduClsRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_UpdDate, objPaperEduClsRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperEduClsRela_Cond.dicFldComparisonOp, clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperEduClsRelaEN_js_1.clsPaperEduClsRelaEN.con_Memo, objPaperEduClsRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperEduClsRela_GetUniCondStr_PaperId_id_CurrEduCls(objPaperEduClsRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objPaperEduClsRelaEN.paperId);
        strWhereCond += (0, clsString_js_2.Format)(" and id_CurrEduCls = '{0}'", objPaperEduClsRelaEN.id_CurrEduCls);
        return strWhereCond;
    }
    ...
    **/
    function PaperEduClsRela_GetUniCondStr4Update_PaperId_id_CurrEduCls(objPaperEduClsRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId <> '{0}'", objPaperEduClsRelaEN.mId);
        strWhereCond += (0, clsString_js_2.Format)(" and PaperId = '{0}'", objPaperEduClsRelaEN.paperId);
        strWhereCond += (0, clsString_js_2.Format)(" and id_CurrEduCls = '{0}'", objPaperEduClsRelaEN.id_CurrEduCls);
        return strWhereCond;
    }
