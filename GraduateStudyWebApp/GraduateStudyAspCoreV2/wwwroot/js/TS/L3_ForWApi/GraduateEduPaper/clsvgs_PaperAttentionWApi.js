...
(function (factory) {
    ...
    **/
    async function vgs_PaperAttention_GetObjByPaperAttentionIdAsync(lngPaperAttentionId) {
        ...
        if (lngPaperAttentionId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperAttentionId]不能为空！(In clsvgs_PaperAttentionWApi.GetObjByPaperAttentionIdAsync)");
    ...
    */
    async function vgs_PaperAttention_GetObjByPaperAttentionId_Cache(lngPaperAttentionId, strUserId, bolTryAsyncOnce = true) {
        ...
        if (lngPaperAttentionId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperAttentionId]不能为空！(In clsvgs_PaperAttentionWApi.GetObjByPaperAttentionId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vgs_PaperAttention_GetObjByPaperAttentionId_localStorage(lngPaperAttentionId) {
        ...
        if (lngPaperAttentionId == 0) {
            const strMsg = (0, clsString_js_1.Format)("参数:[lngPaperAttentionId]不能为空！(In clsvgs_PaperAttentionWApi.GetObjByPaperAttentionId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vgs_PaperAttention_func(strInFldName, strOutFldName, strInValue, strUserId_C) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId_C]不能为空！(In clsvgs_PaperAttentionWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsvgs_PaperAttentionEN_js_1.clsvgs_PaperAttentionEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvgs_PaperAttentionEN_js_1.clsvgs_PaperAttentionEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvgs_PaperAttention == null)
            return "";
        if (objvgs_PaperAttention.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vgs_PaperAttention_funcKey(strInFldName, strInValue, strComparisonOp, strUserId_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId_C) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strUserId_C]不能为空！(In clsvgs_PaperAttentionWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsvgs_PaperAttentionEN_js_1.clsvgs_PaperAttentionEN.con_PaperAttentionId) {
    ...
    exports.vgs_PaperAttention_funcKey = vgs_PaperAttention_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vgs_PaperAttention_GetObjLst_ClientCache(strUserId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(clsvgs_PaperAttentionEN_js_1.clsvgs_PaperAttentionEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_1.Format)(clsvgs_PaperAttentionEN_js_1.clsvgs_PaperAttentionEN.WhereFormat, strUserId);
        }
        else {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_PaperAttentionExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvgs_PaperAttentionExObjLst);
    ...
    **/
    async function vgs_PaperAttention_GetObjLst_Cache(strUserId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strUserId) == true) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[UserId]不能为空！(in clsvgs_PaperAttentionWApi.vgs_PaperAttention_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
