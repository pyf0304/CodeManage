...
(function (factory) {
    ...
    **/
    async function PaperSubViewpoint_GetObjBySubViewpointIdAsync(strSubViewpointId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strSubViewpointId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strSubViewpointId]不能为空！(In clsPaperSubViewpointWApi.GetObjBySubViewpointIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strSubViewpointId]的长度:[{0}]不正确！(clsPaperSubViewpointWApi.GetObjBySubViewpointIdAsync)", strSubViewpointId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.paperSubViewpoint_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.paperSubViewpoint_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    */
    async function PaperSubViewpoint_GetObjBySubViewpointId_Cache(strSubViewpointId, strid_CurrEduCls, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strSubViewpointId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strSubViewpointId]不能为空！(In clsPaperSubViewpointWApi.GetObjBySubViewpointId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strSubViewpointId]的长度:[{0}]不正确！(clsPaperSubViewpointWApi.GetObjBySubViewpointId_Cache)", strSubViewpointId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function PaperSubViewpoint_GetObjBySubViewpointId_localStorage(strSubViewpointId) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strSubViewpointId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strSubViewpointId]不能为空！(In clsPaperSubViewpointWApi.GetObjBySubViewpointId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strSubViewpointId.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strSubViewpointId]的长度:[{0}]不正确！(clsPaperSubViewpointWApi.GetObjBySubViewpointId_localStorage)", strSubViewpointId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN._CurrTabName, strSubViewpointId);
        if (strKey == "") {
    ...
    */
    async function PaperSubViewpoint_func(strInFldName, strOutFldName, strInValue, strid_CurrEduCls_C) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsPaperSubViewpointWApi.func)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsPaperSubViewpointWApi.func)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        if (clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_2.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objPaperSubViewpoint == null)
            return "";
        if (objPaperSubViewpoint.GetFldValue(strOutFldName) == null)
            return "";
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                ...
                case clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_AttitudesId:
                    return (a, b) => {
                        if (a.attitudesId == null)
                            return -1;
                        if (b.attitudesId == null)
                            return 1;
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function PaperSubViewpoint_funcKey(strInFldName, strInValue, strComparisonOp, strid_CurrEduCls_C) {
        //const strThisFuncName = "funcKey";
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls_C) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls_C]不能为空！(In clsPaperSubViewpointWApi.funcKey)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls_C.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls_C]的长度:[{0}]不正确！(clsPaperSubViewpointWApi.funcKey)", strid_CurrEduCls_C.length);
            console.error(strMsg);
            throw (strMsg);
        }
        if (strInFldName == clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SubViewpointId) {
    ...
    exports.PaperSubViewpoint_funcKey = PaperSubViewpoint_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function PaperSubViewpoint_GetObjLst_ClientCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.WhereFormat) == false) {
            strWhereCond = (0, clsString_js_2.Format)(clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.WhereFormat, strid_CurrEduCls);
        }
        else {
            strWhereCond = (0, clsString_js_2.Format)("id_CurrEduCls='{0}'", strid_CurrEduCls);
        }
        const strKey = (0, clsString_js_2.Format)("{0}_{1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN._CurrTabName, strid_CurrEduCls);
        if ((0, clsString_js_2.IsNullOrEmpty)(clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.CacheAddiCondition) == false) {
            strWhereCond += (0, clsString_js_2.Format)(" and {0}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.CacheAddiCondition);
        }
        if (strKey == "") {
            console.error("关键字为空！不正确");
            throw new Error("关键字为空！不正确");
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrPaperSubViewpointExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrPaperSubViewpointExObjLst);
            const strInfo = (0, clsString_js_2.Format)("[ClientCache]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointExObjLst.length);
            console.log(strInfo);
    ...
    **/
    async function PaperSubViewpoint_GetObjLst_localStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[localStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointExObjLst.length);
            console.log(strInfo);
            return arrPaperSubViewpointExObjLst;
        }
        catch (e) {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.paperSubViewpoint_ConstructorName, strThisFuncName);
    ...
    **/
    async function PaperSubViewpoint_GetObjLst_sessionStorage(strid_CurrEduCls) {
        ...
        try {
            ...
            const strInfo = (0, clsString_js_2.Format)("[sessionStorage]Key:[{0}]的缓存已经建立，对象列表数：{1}!", strKey, arrPaperSubViewpointExObjLst.length);
            console.log(strInfo);
            return arrPaperSubViewpointExObjLst;
        }
        catch (e) {
    ...
    **/
    async function PaperSubViewpoint_GetObjLst_Cache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[id_CurrEduCls]不能为空！(in clsPaperSubViewpointWApi.PaperSubViewpoint_GetObjLst_Cache() )");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(in clsPaperSubViewpointWApi.PaperSubViewpoint_GetObjLst_Cache() )", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    **/
    async function PaperSubViewpoint_DelRecordAsync(strSubViewpointId) {
        ...
        strUrl = (0, clsString_js_2.Format)("{0}/?Id={1}", strUrl, strSubViewpointId);
        try {
    ...
    **/
    async function PaperSubViewpoint_UpdateRecordAsync(objPaperSubViewpointEN) {
        ...
        if (objPaperSubViewpointEN.sf_UpdFldSetStr === undefined || objPaperSubViewpointEN.sf_UpdFldSetStr === null || objPaperSubViewpointEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objPaperSubViewpointEN.subViewpointId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.paperSubViewpoint_Controller, strAction);
        try {
    ...
    */
    async function PaperSubViewpoint_IsExistRecord_Cache(objPaperSubViewpoint_Cond, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify(objPaperSubViewpoint_Cond), exports.paperSubViewpoint_ConstructorName, strThisFuncName);
            console.error(strMsg);
            throw new Error(strMsg);
        }
        return false;
    ...
    */
    async function PaperSubViewpoint_IsExist_Cache(strSubViewpointId, strid_CurrEduCls) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strSubViewpointId, exports.paperSubViewpoint_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
        return false;
    ...
    **/
    function PaperSubViewpoint_ReFreshCache(strid_CurrEduCls) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(strid_CurrEduCls) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strid_CurrEduCls]不能为空！(In clsPaperSubViewpointWApi.clsPaperSubViewpointWApi.ReFreshCache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strid_CurrEduCls.length != 8) {
            const strMsg = (0, clsString_js_2.Format)("缓存分类变量:[strid_CurrEduCls]的长度:[{0}]不正确！(clsPaperSubViewpointWApi.clsPaperSubViewpointWApi.ReFreshCache)", strid_CurrEduCls.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    function PaperSubViewpoint_CheckPropertyNew(pobjPaperSubViewpointEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.paperRWId) === true) {
            throw new Error("(errid:Watl000058)字段[课文阅读]不能为空(In 子观点表)!(clsPaperSubViewpointBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.id_CurrEduCls) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.userId) === true) {
            throw new Error("(errid:Watl000058)字段[用户ID]不能为空(In 子观点表)!(clsPaperSubViewpointBL:CheckPropertyNew)");
        }
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointTypeId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.shareId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.subViewpointId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.paperRWId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.paperRWId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.id_CurrEduCls) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.id_CurrEduCls) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.userId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.userId) > 18) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.sectionId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.subViewpointTypeId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.rwTitle) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.rwTitle) > 50) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.explainTypeId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.explainTypeId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.explainContent) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.explainContent) > 5000) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.literatureSourcesId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.literatureSourcesId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.createDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.createDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.shareId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.shareId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.topicId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.topicId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.attitudesId) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.attitudesId) > 2) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjPaperSubViewpointEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointId) == false && undefined !== pobjPaperSubViewpointEN.subViewpointId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.subViewpointId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.paperRWId) == false && undefined !== pobjPaperSubViewpointEN.paperRWId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.paperRWId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.paperId) == false && undefined !== pobjPaperSubViewpointEN.paperId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.id_CurrEduCls) == false && undefined !== pobjPaperSubViewpointEN.id_CurrEduCls && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.id_CurrEduCls) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.userId) == false && undefined !== pobjPaperSubViewpointEN.userId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.userId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.sectionId) == false && undefined !== pobjPaperSubViewpointEN.sectionId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.sectionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointTypeId) == false && undefined !== pobjPaperSubViewpointEN.subViewpointTypeId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.subViewpointTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.rwTitle) == false && undefined !== pobjPaperSubViewpointEN.rwTitle && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.rwTitle) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointContent) == false && undefined !== pobjPaperSubViewpointEN.subViewpointContent && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.subViewpointContent) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.explainTypeId) == false && undefined !== pobjPaperSubViewpointEN.explainTypeId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.explainTypeId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.explainContent) == false && undefined !== pobjPaperSubViewpointEN.explainContent && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.explainContent) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.isPublic && undefined !== pobjPaperSubViewpointEN.isPublic && clsString_js_1.tzDataType.isBoolean(pobjPaperSubViewpointEN.isPublic) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.literatureSourcesId) == false && undefined !== pobjPaperSubViewpointEN.literatureSourcesId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.literatureSourcesId) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.pageNumber && undefined !== pobjPaperSubViewpointEN.pageNumber && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.pageNumber) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.orderNum && undefined !== pobjPaperSubViewpointEN.orderNum && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.orderNum) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.paperLineNum && undefined !== pobjPaperSubViewpointEN.paperLineNum && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.paperLineNum) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.paperPageNum && undefined !== pobjPaperSubViewpointEN.paperPageNum && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.paperPageNum) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.appraiseCount && undefined !== pobjPaperSubViewpointEN.appraiseCount && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.appraiseCount) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.okCount && undefined !== pobjPaperSubViewpointEN.okCount && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.okCount) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.score && undefined !== pobjPaperSubViewpointEN.score && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.score) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.stuScore && undefined !== pobjPaperSubViewpointEN.stuScore && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.stuScore) === false) {
        ...
        if (null != pobjPaperSubViewpointEN.teaScore && undefined !== pobjPaperSubViewpointEN.teaScore && clsString_js_1.tzDataType.isNumber(pobjPaperSubViewpointEN.teaScore) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.createDate) == false && undefined !== pobjPaperSubViewpointEN.createDate && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.createDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.shareId) == false && undefined !== pobjPaperSubViewpointEN.shareId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.shareId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.topicId) == false && undefined !== pobjPaperSubViewpointEN.topicId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.topicId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.attitudesId) == false && undefined !== pobjPaperSubViewpointEN.attitudesId && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.attitudesId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.updDate) == false && undefined !== pobjPaperSubViewpointEN.updDate && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.updUser) == false && undefined !== pobjPaperSubViewpointEN.updUser && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.memo) == false && undefined !== pobjPaperSubViewpointEN.memo && clsString_js_1.tzDataType.isString(pobjPaperSubViewpointEN.memo) === false) {
    ...
    */
    function PaperSubViewpoint_CheckProperty4Update(pobjPaperSubViewpointEN) {
        ...
        //检查主键是否为Null或者空！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjPaperSubViewpointEN.subViewpointId) === true
    ...
    */
    function PaperSubViewpoint_GetCombineCondition(objPaperSubViewpoint_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SubViewpointId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SubViewpointId, objPaperSubViewpoint_Cond.subViewpointId, strComparisonOp_SubViewpointId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperRWId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperRWId, objPaperSubViewpoint_Cond.paperRWId, strComparisonOp_PaperRWId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperId, objPaperSubViewpoint_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_id_CurrEduCls) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_id_CurrEduCls, objPaperSubViewpoint_Cond.id_CurrEduCls, strComparisonOp_id_CurrEduCls);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_UserId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_UserId, objPaperSubViewpoint_Cond.userId, strComparisonOp_UserId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SectionId, objPaperSubViewpoint_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SubViewpointTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_SubViewpointTypeId, objPaperSubViewpoint_Cond.subViewpointTypeId, strComparisonOp_SubViewpointTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_RWTitle) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_RWTitle, objPaperSubViewpoint_Cond.rwTitle, strComparisonOp_RWTitle);
        }
        ...
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_ExplainTypeId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_ExplainTypeId, objPaperSubViewpoint_Cond.explainTypeId, strComparisonOp_ExplainTypeId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_ExplainContent) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_ExplainContent, objPaperSubViewpoint_Cond.explainContent, strComparisonOp_ExplainContent);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_IsPublic) == true) {
            if (objPaperSubViewpoint_Cond.isPublic == true) {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '1'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_IsPublic);
            }
            else {
                strWhereCond += (0, clsString_js_2.Format)(" And {0} = '0'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_IsPublic);
            }
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_LiteratureSourcesId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_LiteratureSourcesId, objPaperSubViewpoint_Cond.literatureSourcesId, strComparisonOp_LiteratureSourcesId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PageNumber) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PageNumber, objPaperSubViewpoint_Cond.pageNumber, strComparisonOp_PageNumber);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_OrderNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_OrderNum, objPaperSubViewpoint_Cond.orderNum, strComparisonOp_OrderNum);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperLineNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperLineNum, objPaperSubViewpoint_Cond.paperLineNum, strComparisonOp_PaperLineNum);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperPageNum) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_PaperPageNum, objPaperSubViewpoint_Cond.paperPageNum, strComparisonOp_PaperPageNum);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_AppraiseCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_AppraiseCount, objPaperSubViewpoint_Cond.appraiseCount, strComparisonOp_AppraiseCount);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_OkCount) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_OkCount, objPaperSubViewpoint_Cond.okCount, strComparisonOp_OkCount);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_Score) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_Score, objPaperSubViewpoint_Cond.score, strComparisonOp_Score);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_StuScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_StuScore, objPaperSubViewpoint_Cond.stuScore, strComparisonOp_StuScore);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_TeaScore) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_TeaScore, objPaperSubViewpoint_Cond.teaScore, strComparisonOp_TeaScore);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_CreateDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_CreateDate, objPaperSubViewpoint_Cond.createDate, strComparisonOp_CreateDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_ShareId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_ShareId, objPaperSubViewpoint_Cond.shareId, strComparisonOp_ShareId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_TopicId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_TopicId, objPaperSubViewpoint_Cond.topicId, strComparisonOp_TopicId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_AttitudesId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_AttitudesId, objPaperSubViewpoint_Cond.attitudesId, strComparisonOp_AttitudesId);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_UpdDate, objPaperSubViewpoint_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_UpdUser, objPaperSubViewpoint_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objPaperSubViewpoint_Cond.dicFldComparisonOp, clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsPaperSubViewpointEN_js_1.clsPaperSubViewpointEN.con_Memo, objPaperSubViewpoint_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function PaperSubViewpoint_GetUniCondStr_PaperRWId_SubViewpointTypeId_SubViewpointContent(objPaperSubViewpointEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and PaperRWId = '{0}'", objPaperSubViewpointEN.paperRWId);
        strWhereCond += (0, clsString_js_2.Format)(" and SubViewpointTypeId = '{0}'", objPaperSubViewpointEN.subViewpointTypeId);
        strWhereCond += (0, clsString_js_2.Format)(" and SubViewpointContent = '{0}'", objPaperSubViewpointEN.subViewpointContent);
        return strWhereCond;
    }
    ...
    **/
    function PaperSubViewpoint_GetUniCondStr_SubViewpointId(objPaperSubViewpointEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and SubViewpointId = '{0}'", objPaperSubViewpointEN.subViewpointId);
        return strWhereCond;
    }
