...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduPaper/clsgs_PSocialRelaEN.js", "../../PubFun/clsCommFunc4Web.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsString.js", "../../PubFun/clsString.js"], factory);
    }
    ...
    **/
    async function gs_PSocialRela_GetObjBymIdAsync(lngmId) {
        ...
        if (lngmId == 0) {
            const strMsg = (0, clsString_js_2.Format)("参数:[lngmId]不能为空！(In clsgs_PSocialRelaWApi.GetObjBymIdAsync)");
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_PSocialRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_2.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_PSocialRela_ConstructorName, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_2.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_PSocialRela_ConstructorName, strThisFuncName);
    ...
    **/
    async function gs_PSocialRela_UpdateRecordAsync(objgs_PSocialRelaEN) {
        ...
        if (objgs_PSocialRelaEN.sf_UpdFldSetStr === undefined || objgs_PSocialRelaEN.sf_UpdFldSetStr === null || objgs_PSocialRelaEN.sf_UpdFldSetStr === "") {
            const strMsg = (0, clsString_js_2.Format)("对象(关键字: {0})的【修改字段集】为空，不能修改!", objgs_PSocialRelaEN.mId);
            throw strMsg;
        }
        const strUrl = (0, clsSysPara4WebApi_js_1.GetWebApiUrl)(exports.gs_PSocialRela_Controller, strAction);
        try {
    ...
    */
    function gs_PSocialRela_CheckPropertyNew(pobjgs_PSocialRelaEN) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.paperId) === true
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.socialId) === true) {
            throw new Error("(errid:Watl000058)字段[社会Id]不能为空(In 论文社会关系)!(clsgs_PSocialRelaBL:CheckPropertyNew)");
        }
        //检查字段长度， 若字符型字段长度超出规定的长度，即非法！
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.paperId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PSocialRelaEN.paperId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.sectionId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PSocialRelaEN.sectionId) > 8) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.socialId) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PSocialRelaEN.socialId) > 10) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.updDate) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PSocialRelaEN.updDate) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.updUser) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PSocialRelaEN.updUser) > 20) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.memo) == false && (0, clsString_js_2.GetStrLen)(pobjgs_PSocialRelaEN.memo) > 1000) {
        ...
        //检查字段的数据类型是否正确
        if (null != pobjgs_PSocialRelaEN.mId && undefined !== pobjgs_PSocialRelaEN.mId && clsString_js_1.tzDataType.isNumber(pobjgs_PSocialRelaEN.mId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.paperId) == false && undefined !== pobjgs_PSocialRelaEN.paperId && clsString_js_1.tzDataType.isString(pobjgs_PSocialRelaEN.paperId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.sectionId) == false && undefined !== pobjgs_PSocialRelaEN.sectionId && clsString_js_1.tzDataType.isString(pobjgs_PSocialRelaEN.sectionId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.socialId) == false && undefined !== pobjgs_PSocialRelaEN.socialId && clsString_js_1.tzDataType.isString(pobjgs_PSocialRelaEN.socialId) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.updDate) == false && undefined !== pobjgs_PSocialRelaEN.updDate && clsString_js_1.tzDataType.isString(pobjgs_PSocialRelaEN.updDate) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.updUser) == false && undefined !== pobjgs_PSocialRelaEN.updUser && clsString_js_1.tzDataType.isString(pobjgs_PSocialRelaEN.updUser) === false) {
        ...
        if ((0, clsString_js_2.IsNullOrEmpty)(pobjgs_PSocialRelaEN.memo) == false && undefined !== pobjgs_PSocialRelaEN.memo && clsString_js_1.tzDataType.isString(pobjgs_PSocialRelaEN.memo) === false) {
    ...
    */
    function gs_PSocialRela_GetCombineCondition(objgs_PSocialRela_Cond) {
        ...
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_mId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} {1}", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_mId, objgs_PSocialRela_Cond.mId, strComparisonOp_mId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_PaperId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_PaperId, objgs_PSocialRela_Cond.paperId, strComparisonOp_PaperId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_SectionId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_SectionId, objgs_PSocialRela_Cond.sectionId, strComparisonOp_SectionId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_SocialId) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_SocialId, objgs_PSocialRela_Cond.socialId, strComparisonOp_SocialId);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_UpdDate) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_UpdDate, objgs_PSocialRela_Cond.updDate, strComparisonOp_UpdDate);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_UpdUser) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_UpdUser, objgs_PSocialRela_Cond.updUser, strComparisonOp_UpdUser);
        }
        if (Object.prototype.hasOwnProperty.call(objgs_PSocialRela_Cond.dicFldComparisonOp, clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_Memo) == true) {
            ...
            strWhereCond += (0, clsString_js_2.Format)(" And {0} {2} '{1}'", clsgs_PSocialRelaEN_js_1.clsgs_PSocialRelaEN.con_Memo, objgs_PSocialRela_Cond.memo, strComparisonOp_Memo);
        }
        return strWhereCond;
    }
    ...
    **/
    function gs_PSocialRela_GetUniCondStr_mId(objgs_PSocialRelaEN) {
        let strWhereCond = " 1 = 1 ";
        strWhereCond += (0, clsString_js_2.Format)(" and mId = '{0}'", objgs_PSocialRelaEN.mId);
        return strWhereCond;
    }
