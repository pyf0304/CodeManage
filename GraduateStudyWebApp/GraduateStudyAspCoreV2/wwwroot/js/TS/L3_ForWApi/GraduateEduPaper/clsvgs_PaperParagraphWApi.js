...
(function (factory) {
    ...
    **/
    async function vgs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetObjByParagraphIdAsync)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetObjByParagraphIdAsync)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vgs_PaperParagraph_GetObjByParagraphId_Cache(strParagraphId, bolTryAsyncOnce = true) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetObjByParagraphId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetObjByParagraphId_Cache)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        ...
        try {
            ...
            if (arrvgs_PaperParagraph_Sel.length > 0) {
                ...
                if (bolTryAsyncOnce == true) {
                    const objvgs_PaperParagraph_Const = await vgs_PaperParagraph_GetObjByParagraphIdAsync(strParagraphId);
                    if (objvgs_PaperParagraph_Const != null) {
                        vgs_PaperParagraph_ReFreshThisCache();
                        return objvgs_PaperParagraph_Const;
                    }
                }
                return null;
            }
    ...
    */
    async function vgs_PaperParagraph_GetObjByParagraphId_localStorage(strParagraphId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetObjByParagraphId_localStorage)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetObjByParagraphId_localStorage)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
    ...
    */
    async function vgs_PaperParagraph_GetNameByParagraphId_Cache(strParagraphId) {
        ...
        if ((0, clsString_js_1.IsNullOrEmpty)(strParagraphId) == true) {
            const strMsg = (0, clsString_js_1.Format)("参数:[strParagraphId]不能为空！(In clsvgs_PaperParagraphWApi.GetNameByParagraphId_Cache)");
            console.error(strMsg);
            throw (strMsg);
        }
        if (strParagraphId.length != 10) {
            const strMsg = (0, clsString_js_1.Format)("缓存分类变量:[strParagraphId]的长度:[{0}]不正确！(clsvgs_PaperParagraphWApi.GetNameByParagraphId_Cache)", strParagraphId.length);
            console.error(strMsg);
            throw (strMsg);
        }
        const arrvgs_PaperParagraphObjLst_Cache = await vgs_PaperParagraph_GetObjLst_Cache();
    ...
    */
    async function vgs_PaperParagraph_func(strInFldName, strOutFldName, strInValue) {
        ...
        if (clsvgs_PaperParagraphEN_js_1.clsvgs_PaperParagraphEN.AttributeName.indexOf(strOutFldName) == -1) {
            const strMsg = (0, clsString_js_1.Format)("输出字段名:[{0}]不正确，不在输出字段范围之内!({1})", strOutFldName, clsvgs_PaperParagraphEN_js_1.clsvgs_PaperParagraphEN.AttributeName.join(','));
            console.error(strMsg);
            throw new Error(strMsg);
        }
        ...
        if (objvgs_PaperParagraph == null)
            return "";
        if (objvgs_PaperParagraph.GetFldValue(strOutFldName) == null)
            return "";
    ...
    */
     ...
     * @returns 返回一个关键字值列表
    */
    async function vgs_PaperParagraph_funcKey(strInFldName, strInValue, strComparisonOp) {
        ...
        const arrvgs_PaperParagraph = await vgs_PaperParagraph_GetObjLst_Cache();
        if (arrvgs_PaperParagraph == null)
            return [];
        let arrvgs_PaperParagraph_Sel = arrvgs_PaperParagraph;
        const strType = typeof (strInValue);
        switch (strType) {
            case "string":
                switch (strComparisonOp) {
                    case enumComparisonOp_js_1.enumComparisonOp.Equal_01: // " = "
                        arrvgs_PaperParagraph_Sel = arrvgs_PaperParagraph_Sel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.Like_03:
                        arrvgs_PaperParagraph_Sel = arrvgs_PaperParagraph_Sel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
                        break;
                    case enumComparisonOp_js_1.enumComparisonOp.In_04:
                        const arrValues = strInValue.split(',');
                        arrvgs_PaperParagraph_Sel = arrvgs_PaperParagraph_Sel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
                        break;
                }
                break;
            case "boolean":
                ...
                if (strComparisonOp == enumComparisonOp_js_1.enumComparisonOp.Equal_01) {
                    arrvgs_PaperParagraph_Sel = arrvgs_PaperParagraph_Sel.filter(x => x.GetFldValue(strInFldName) == strInValue);
                }
                break;
            case "number":
        ...
        if (arrvgs_PaperParagraph_Sel.length == 0)
            return [];
        return arrvgs_PaperParagraph_Sel.map(x => x.paragraphId);
    }
    exports.vgs_PaperParagraph_funcKey = vgs_PaperParagraph_funcKey;
    /**
    * 根据条件获取满足条件的第一条记录
    ...
    **/
    async function vgs_PaperParagraph_GetObjLst_ClientCache() {
        ...
        if (CacheHelper_js_1.CacheHelper.Exsits(strKey)) {
            //缓存存在，直接返回
            const arrvgs_PaperParagraphExObjLst_Cache = CacheHelper_js_1.CacheHelper.Get(strKey);
        ...
        try {
            ...
            CacheHelper_js_1.CacheHelper.Add(strKey, arrvgs_PaperParagraphExObjLst);
                ...
                switch (strType) {
                    case "string":
                        ...
                        if (strComparisonOp == "=") {
                            ...
                            arrvgs_PaperParagraph_Sel = arrvgs_PaperParagraph_Sel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
                        }
