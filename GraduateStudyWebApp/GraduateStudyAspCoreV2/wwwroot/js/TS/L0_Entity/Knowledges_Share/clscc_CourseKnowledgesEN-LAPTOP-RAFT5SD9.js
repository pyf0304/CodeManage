(function (factory) {
    ...
    **/
    ...
    clscc_CourseKnowledgesEN.CacheModeId = "04"; //sessionStorage
    clscc_CourseKnowledgesEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clscc_CourseKnowledgesEN.WhereFormat = ""; //条件格式串
