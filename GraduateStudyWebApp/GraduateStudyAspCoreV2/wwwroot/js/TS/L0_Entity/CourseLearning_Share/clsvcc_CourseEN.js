(function (factory) {
    ...
    exports.clsvcc_CourseEN = void 0;
    /**
    * 类名:clsvcc_CourseEN
    * 表名:vcc_Course(01120058)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:14:28
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsvcc_CourseEN extends clsGeneralTabV_js_1.clsGeneralTabV {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsvcc_CourseEN = clsvcc_CourseEN;
    clsvcc_CourseEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsvcc_CourseEN.CacheModeId = "02"; //客户端缓存
    clsvcc_CourseEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsvcc_CourseEN.WhereFormat = ""; //条件格式串
    clsvcc_CourseEN._CurrTabName = "vcc_Course"; //当前表名,与该类相关的表名
    clsvcc_CourseEN._KeyFldName = "CourseId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsvcc_CourseEN.mintAttributeCount = 31;
    clsvcc_CourseEN.AttributeName = ["courseId", "likeCount", "courseCode", "courseDescription", "courseName", "courseTypeID", "courseTypeName", "createDate", "excellentTypeId", "excellentTypeName", "excellentYear", "isBuildingCourse", "isDoubleLanguageCourse", "isOpen", "isRecommendedCourse", "isSelfPropelledCourse", "operationDate", "orderNum", "outerLink", "viewCount", "themeId", "themeName", "exampleImgPath", "id_XzMajor", "majorID", "majorName", "id_XzCollege", "collegeID", "collegeName", "collegeNameA", "memo"];
});
