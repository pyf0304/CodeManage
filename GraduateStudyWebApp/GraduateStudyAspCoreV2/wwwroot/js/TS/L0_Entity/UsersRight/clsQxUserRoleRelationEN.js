(function (factory) {
    ...
    exports.clsQxUserRoleRelationEN = void 0;
    /**
    ...
    **/
    ...
    class clsQxUserRoleRelationEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsQxUserRoleRelationEN = clsQxUserRoleRelationEN;
    clsQxUserRoleRelationEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsQxUserRoleRelationEN.CacheModeId = "02"; //客户端缓存
    clsQxUserRoleRelationEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsQxUserRoleRelationEN.WhereFormat = ""; //条件格式串
    clsQxUserRoleRelationEN._CurrTabName = "QxUserRoleRelation"; //当前表名,与该类相关的表名
    clsQxUserRoleRelationEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsQxUserRoleRelationEN.mintAttributeCount = 9;
    clsQxUserRoleRelationEN.AttributeName = ["mId", "userId", "roleId", "qxPrjId", "memo", "questionnaireSetId", "updDate", "updUser", "updUserId"];
});
