(function (factory) {
    ...
    exports.clsgs_KnowledgesLogicEN = void 0;
    /**
    ...
    **/
    ...
    class clsgs_KnowledgesLogicEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_CourseKnowledgeTitle() { return "courseKnowledgeTitle"; } //知识点标题
        /**
        * 常量:"X_Position"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_NodeColor() { return "nodeColor"; } //结点颜色
        /**
        * 常量:"LogicNodeId"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_LogicNodeId() { return "logicNodeId"; } //逻辑节点Id
        /**
        * 常量:"ClassName"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    exports.clsgs_KnowledgesLogicEN = clsgs_KnowledgesLogicEN;
    clsgs_KnowledgesLogicEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_KnowledgesLogicEN.CacheModeId = "02"; //客户端缓存
    clsgs_KnowledgesLogicEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_KnowledgesLogicEN.WhereFormat = ""; //条件格式串
    clsgs_KnowledgesLogicEN._CurrTabName = "gs_KnowledgesLogic"; //当前表名,与该类相关的表名
    clsgs_KnowledgesLogicEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_KnowledgesLogicEN.mintAttributeCount = 13;
    clsgs_KnowledgesLogicEN.AttributeName = ["mId", "courseKnowledgeId", "courseKnowledgeTitle", "x_Position", "y_Position", "knowledgeGraphId", "nodeColor", "logicNodeId", "className", "courseId", "updDate", "updUser", "memo"];
});
