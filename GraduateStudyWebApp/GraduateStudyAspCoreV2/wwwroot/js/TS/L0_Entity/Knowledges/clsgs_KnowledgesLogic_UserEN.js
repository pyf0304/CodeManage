(function (factory) {
    ...
    **/
    ...
    clsgs_KnowledgesLogic_UserEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_KnowledgesLogic_UserEN.WhereFormat = ""; //条件格式串
    ...
    clsgs_KnowledgesLogic_UserEN.mintAttributeCount = 9;
    clsgs_KnowledgesLogic_UserEN.AttributeName = ["mId", "userId", "knowledgeGraphId", "courseKnowledgeId", "className", "courseId", "updDate", "updUser", "memo"];
});
