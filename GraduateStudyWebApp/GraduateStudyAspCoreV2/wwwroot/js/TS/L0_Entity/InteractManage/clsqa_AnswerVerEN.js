(function (factory) {
    ...
    exports.clsqa_AnswerVerEN = void 0;
    /**
    ...
    **/
    ...
    class clsqa_AnswerVerEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsqa_AnswerVerEN = clsqa_AnswerVerEN;
    clsqa_AnswerVerEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsqa_AnswerVerEN.CacheModeId = "04"; //sessionStorage
    clsqa_AnswerVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsqa_AnswerVerEN.WhereFormat = ""; //条件格式串
    clsqa_AnswerVerEN._CurrTabName = "qa_AnswerVer"; //当前表名,与该类相关的表名
    clsqa_AnswerVerEN._KeyFldName = "AnswerVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsqa_AnswerVerEN.mintAttributeCount = 16;
    clsqa_AnswerVerEN.AttributeName = ["answerVId", "answerId", "questionsId", "answerContent", "score", "scoreType", "isRight", "parentId", "voteCount", "isRecommend", "topicId", "answerTypeId", "isSubmit", "updUser", "updDate", "memo"];
});
