(function (factory) {
    ...
    **/
    ...
    class clsSysVoteEN extends clsGeneralTab_js_1.clsGeneralTab {
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_LikedUserId() { return "likedUserId"; } //被点赞用户Id
        /**
        * 常量:"UpdUser"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    clsSysVoteEN.CacheModeId = "04"; //sessionStorage
    clsSysVoteEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsSysVoteEN.WhereFormat = ""; //条件格式串
    ...
    clsSysVoteEN.AttributeName = ["voteId", "tableKey", "pubParentId", "voteTypeId", "likedUserId", "updUser", "updDate", "memo", "id_CurrEduCls"];
});
