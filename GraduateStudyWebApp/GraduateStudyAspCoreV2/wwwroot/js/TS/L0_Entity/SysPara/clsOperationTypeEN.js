(function (factory) {
    ...
    exports.clsOperationTypeEN = void 0;
    /**
    * 类名:clsOperationTypeEN
    * 表名:OperationType(01120538)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:52:29
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsOperationTypeEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsOperationTypeEN = clsOperationTypeEN;
    clsOperationTypeEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsOperationTypeEN.CacheModeId = "03"; //localStorage
    clsOperationTypeEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsOperationTypeEN.WhereFormat = ""; //条件格式串
    clsOperationTypeEN._CurrTabName = "OperationType"; //当前表名,与该类相关的表名
    clsOperationTypeEN._KeyFldName = "OperationTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsOperationTypeEN.mintAttributeCount = 5;
    clsOperationTypeEN.AttributeName = ["operationTypeId", "operationTypeName", "updDate", "updUserId", "memo"];
});
