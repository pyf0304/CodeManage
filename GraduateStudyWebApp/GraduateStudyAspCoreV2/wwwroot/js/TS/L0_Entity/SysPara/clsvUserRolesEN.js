(function (factory) {
    ...
    exports.clsvUserRolesEN_Sim = exports.clsvUserRolesEN = void 0;
    /**
    * 类名:clsvUserRolesEN
    ...
    **/
    ...
    class clsvUserRolesEN extends clsGeneralTab2_js_1.clsGeneralTab2 {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        constructor() {
            ...
            this.mstrQuestionnaireSetName = ""; //问卷集名
        ...
        */
         ...
         * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
        */
        set QuestionnaireSetName(value) {
            if (value != undefined) {
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_QuestionnaireSetName() { return "QuestionnaireSetName"; } //问卷集名
        /**
        * 常量:"PrjId"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    exports.clsvUserRolesEN = clsvUserRolesEN;
    clsvUserRolesEN._CurrTabName = "vUserRoles"; //当前表名,与该类相关的表名
    clsvUserRolesEN._KeyFldName = "roleId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsvUserRolesEN.mintAttributeCount = 9;
    clsvUserRolesEN.AttributeName = ["roleId", "roleName", "QuestionnaireSetId", "QuestionnaireSetName", "PrjId", "memo", "IsInUse", "updDate", "updUserId"];
    /**
    * v角色(vUserRoles)
    * (AutoGCLib.EntityLayer4TypeScript:GeneCode)
    **/
    class clsvUserRolesEN_Sim {
        constructor() {
            //以下是属性变量
            /**
             * 角色Id(说明:;字段类型:char;字段长度:8;是否可空:True)
    ...
    exports.clsvUserRolesEN_Sim = clsvUserRolesEN_Sim;
});
