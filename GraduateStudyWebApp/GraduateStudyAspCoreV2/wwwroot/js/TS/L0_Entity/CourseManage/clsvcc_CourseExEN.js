(function (factory) {
    ...
    exports.clsvcc_CourseExEN = void 0;
    /**
    * 类名:clsvcc_CourseExEN
    ...
    **/
    ...
    class clsvcc_CourseExEN extends clsGeneralTabV_js_1.clsGeneralTabV {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        GetFldValue(strFldName) {
            ...
            switch (strFldName) {
                ...
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[vcc_CourseEx]中不存在！`;
        ...
        SetFldValue(strFldName, strValue) {
            ...
            switch (strFldName) {
                ...
                case "sf_FldComparisonOp":
                    ...
                    break;
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[vcc_CourseEx]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
                    console.error(strMsg);
                    break;
            }
        }
    ...
    exports.clsvcc_CourseExEN = clsvcc_CourseExEN;
    clsvcc_CourseExEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsvcc_CourseExEN.CacheModeId = "05"; //未知
    clsvcc_CourseExEN._CurrTabName = "vcc_CourseEx"; //当前表名,与该类相关的表名
    clsvcc_CourseExEN._KeyFldName = "courseId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsvcc_CourseExEN.mintAttributeCount = 35;
    clsvcc_CourseExEN.AttributeName = ["courseId", "likeCount", "courseCode", "courseDescription", "courseName", "courseTypeID", "courseTypeName", "createDate", "excellentTypeId", "excellentTypeName", "excellentYear", "isBuildingCourse", "isDoubleLanguageCourse", "isOpen", "isRecommendedCourse", "isSelfPropelledCourse", "operationDate", "orderNum", "outerLink", "viewCount", "themeId", "themeName", "exampleImgPath", "id_XzMajor", "majorID", "majorName", "id_XzCollege", "collegeID", "collegeName", "collegeNameA", "memo", "questionNum", "knowledgesNum", "teacherNum", "chapterNum"];
});
