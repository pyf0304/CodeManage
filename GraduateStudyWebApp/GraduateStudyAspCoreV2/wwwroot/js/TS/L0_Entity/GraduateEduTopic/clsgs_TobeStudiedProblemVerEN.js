(function (factory) {
    ...
    exports.clsgs_TobeStudiedProblemVerEN = void 0;
    /**
    ...
    **/
    ...
    class clsgs_TobeStudiedProblemVerEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsgs_TobeStudiedProblemVerEN = clsgs_TobeStudiedProblemVerEN;
    clsgs_TobeStudiedProblemVerEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_TobeStudiedProblemVerEN.CacheModeId = ""; //
    clsgs_TobeStudiedProblemVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_TobeStudiedProblemVerEN.WhereFormat = ""; //条件格式串
    clsgs_TobeStudiedProblemVerEN._CurrTabName = "gs_TobeStudiedProblemVer"; //当前表名,与该类相关的表名
    clsgs_TobeStudiedProblemVerEN._KeyFldName = "ProblemVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_TobeStudiedProblemVerEN.mintAttributeCount = 13;
    clsgs_TobeStudiedProblemVerEN.AttributeName = ["problemVId", "problemId", "topicId", "isSubmit", "problemContent", "problemDate", "participant", "updDate", "updUser", "year", "month", "memo", "problemTitle"];
});
