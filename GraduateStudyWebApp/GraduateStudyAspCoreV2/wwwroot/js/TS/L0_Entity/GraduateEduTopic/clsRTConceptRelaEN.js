(function (factory) {
    ...
    exports.clsRTConceptRelaEN = void 0;
    /**
    * 类名:clsRTConceptRelaEN
    * 表名:RTConceptRela(01120605)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:50:21
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsRTConceptRelaEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        GetFldValue(strFldName) {
            ...
            switch (strFldName) {
                ...
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[RTConceptRela]中不存在！`;
        ...
        SetFldValue(strFldName, strValue) {
            ...
            switch (strFldName) {
                ...
                case "sf_FldComparisonOp":
                    ...
                    break;
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[RTConceptRela]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
                    console.error(strMsg);
                    break;
            }
        }
    ...
    exports.clsRTConceptRelaEN = clsRTConceptRelaEN;
    clsRTConceptRelaEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsRTConceptRelaEN.CacheModeId = "05"; //未知
    clsRTConceptRelaEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsRTConceptRelaEN.WhereFormat = ""; //条件格式串
    clsRTConceptRelaEN._CurrTabName = "RTConceptRela"; //当前表名,与该类相关的表名
    clsRTConceptRelaEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsRTConceptRelaEN.mintAttributeCount = 8;
    clsRTConceptRelaEN.AttributeName = ["mId", "topicId", "conceptId", "updDate", "memo", "updUser", "classificationId", "id_CurrEduCls"];
});
