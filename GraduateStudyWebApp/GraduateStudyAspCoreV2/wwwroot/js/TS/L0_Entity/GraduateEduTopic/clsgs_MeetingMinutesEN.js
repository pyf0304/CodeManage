(function (factory) {
    ...
    **/
    ...
    class clsgs_MeetingMinutesEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsgs_MeetingMinutesEN = clsgs_MeetingMinutesEN;
    clsgs_MeetingMinutesEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_MeetingMinutesEN.CacheModeId = ""; //
    clsgs_MeetingMinutesEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_MeetingMinutesEN.WhereFormat = ""; //条件格式串
    clsgs_MeetingMinutesEN._CurrTabName = "gs_MeetingMinutes"; //当前表名,与该类相关的表名
    clsgs_MeetingMinutesEN._KeyFldName = "MeetingId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_MeetingMinutesEN.mintAttributeCount = 13;
    clsgs_MeetingMinutesEN.AttributeName = ["meetingId", "topicId", "isSubmit", "meetingContent", "meetingDate", "updDate", "updUser", "year", "month", "memo", "versionCount", "participants", "id_CurrEduCls"];
});
