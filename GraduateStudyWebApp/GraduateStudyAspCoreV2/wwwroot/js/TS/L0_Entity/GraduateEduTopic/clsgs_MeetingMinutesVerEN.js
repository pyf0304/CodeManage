(function (factory) {
    ...
    **/
    ...
    class clsgs_MeetingMinutesVerEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsgs_MeetingMinutesVerEN = clsgs_MeetingMinutesVerEN;
    clsgs_MeetingMinutesVerEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_MeetingMinutesVerEN.CacheModeId = ""; //
    clsgs_MeetingMinutesVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_MeetingMinutesVerEN.WhereFormat = ""; //条件格式串
    clsgs_MeetingMinutesVerEN._CurrTabName = "gs_MeetingMinutesVer"; //当前表名,与该类相关的表名
    clsgs_MeetingMinutesVerEN._KeyFldName = "MeetingVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_MeetingMinutesVerEN.mintAttributeCount = 12;
    clsgs_MeetingMinutesVerEN.AttributeName = ["meetingVId", "meetingId", "topicId", "isSubmit", "meetingContent", "meetingDate", "updDate", "updUser", "year", "month", "memo", "participants"];
});
