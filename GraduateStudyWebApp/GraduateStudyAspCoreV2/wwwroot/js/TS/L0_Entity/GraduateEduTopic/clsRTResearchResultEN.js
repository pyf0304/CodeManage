(function (factory) {
    ...
    exports.clsRTResearchResultEN = void 0;
    /**
    ...
    **/
    ...
    class clsRTResearchResultEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsRTResearchResultEN = clsRTResearchResultEN;
    clsRTResearchResultEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsRTResearchResultEN.CacheModeId = "05"; //未知
    clsRTResearchResultEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsRTResearchResultEN.WhereFormat = ""; //条件格式串
    clsRTResearchResultEN._CurrTabName = "RTResearchResult"; //当前表名,与该类相关的表名
    clsRTResearchResultEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsRTResearchResultEN.mintAttributeCount = 7;
    clsRTResearchResultEN.AttributeName = ["mId", "topicId", "paperId", "updDate", "updUser", "memo", "id_CurrEduCls"];
});
