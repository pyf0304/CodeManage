(function (factory) {
    ...
    **/
    ...
    clsgs_ViewsClassificationEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_ViewsClassificationEN.WhereFormat = ""; //条件格式串
    ...
    clsgs_ViewsClassificationEN.AttributeName = ["classificationId", "classificationName", "topicId", "orderNum", "updDate", "updUser", "memo"];
});
