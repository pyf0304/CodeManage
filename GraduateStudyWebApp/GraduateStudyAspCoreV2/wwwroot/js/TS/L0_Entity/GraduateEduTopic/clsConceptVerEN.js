(function (factory) {
    ...
    exports.clsConceptVerEN = void 0;
    /**
    * 类名:clsConceptVerEN
    * 表名:ConceptVer(01120649)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:48:18
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsConceptVerEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsConceptVerEN = clsConceptVerEN;
    clsConceptVerEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsConceptVerEN.CacheModeId = ""; //
    clsConceptVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsConceptVerEN.WhereFormat = ""; //条件格式串
    clsConceptVerEN._CurrTabName = "ConceptVer"; //当前表名,与该类相关的表名
    clsConceptVerEN._KeyFldName = "ConceptVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsConceptVerEN.mintAttributeCount = 11;
    clsConceptVerEN.AttributeName = ["conceptVId", "conceptId", "conceptContent", "conceptName", "citationId", "updDate", "updUser", "id_CurrEduCls", "pdfContent", "pdfPageNum", "memo"];
});
