(function (factory) {
    ...
    exports.clsRTTopicObjectiveRelaEN = void 0;
    /**
    ...
    **/
    ...
    class clsRTTopicObjectiveRelaEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsRTTopicObjectiveRelaEN = clsRTTopicObjectiveRelaEN;
    clsRTTopicObjectiveRelaEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsRTTopicObjectiveRelaEN.CacheModeId = "02"; //客户端缓存
    clsRTTopicObjectiveRelaEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsRTTopicObjectiveRelaEN.WhereFormat = ""; //条件格式串
    clsRTTopicObjectiveRelaEN._CurrTabName = "RTTopicObjectiveRela"; //当前表名,与该类相关的表名
    clsRTTopicObjectiveRelaEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsRTTopicObjectiveRelaEN.mintAttributeCount = 8;
    clsRTTopicObjectiveRelaEN.AttributeName = ["mId", "topicId", "topicObjectiveId", "updDate", "updUser", "memo", "classificationId", "id_CurrEduCls"];
});
