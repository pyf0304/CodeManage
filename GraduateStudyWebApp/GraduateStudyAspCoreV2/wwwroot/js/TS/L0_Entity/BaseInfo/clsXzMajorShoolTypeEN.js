(function (factory) {
    ...
    **/
    ...
    class clsXzMajorShoolTypeEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsXzMajorShoolTypeEN = clsXzMajorShoolTypeEN;
    clsXzMajorShoolTypeEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsXzMajorShoolTypeEN.CacheModeId = "03"; //localStorage
    clsXzMajorShoolTypeEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsXzMajorShoolTypeEN.WhereFormat = ""; //条件格式串
    clsXzMajorShoolTypeEN._CurrTabName = "XzMajorShoolType"; //当前表名,与该类相关的表名
    clsXzMajorShoolTypeEN._KeyFldName = "id_XzMajorShoolType"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsXzMajorShoolTypeEN.mintAttributeCount = 5;
    clsXzMajorShoolTypeEN.AttributeName = ["id_XzMajorShoolType", "typeName", "updUserId", "updDate", "memo"];
});
