(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/GraduateEduPaper/clsPaperAttachmentEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.clsPaperAttachmentENEx = void 0;
    /**
    * 类名:clsPaperAttachmentENEx
    * 表名:PaperAttachment(01120578)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:53:55
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsPaperAttachmentENEx extends clsPaperAttachmentEN_js_1.clsPaperAttachmentEN {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        GetFldValue(strFldName) {
            ...
            switch (strFldName) {
                case "CtrlId":
                    return "";
                case clsPaperAttachmentENEx.con_PaperTitle_Author:
    ...
    exports.clsPaperAttachmentENEx = clsPaperAttachmentENEx;
});
