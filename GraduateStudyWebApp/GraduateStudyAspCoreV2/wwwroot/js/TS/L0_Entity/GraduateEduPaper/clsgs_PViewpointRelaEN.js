(function (factory) {
    ...
    **/
    ...
    class clsgs_PViewpointRelaEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        GetFldValue(strFldName) {
            ...
            switch (strFldName) {
                ...
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[gs_PViewpointRela]中不存在！`;
        ...
        SetFldValue(strFldName, strValue) {
            ...
            switch (strFldName) {
                ...
                case "sf_FldComparisonOp":
                    ...
                    break;
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[gs_PViewpointRela]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
                    console.error(strMsg);
                    break;
            }
        }
    ...
    exports.clsgs_PViewpointRelaEN = clsgs_PViewpointRelaEN;
    clsgs_PViewpointRelaEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_PViewpointRelaEN.CacheModeId = "05"; //未知
    clsgs_PViewpointRelaEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_PViewpointRelaEN.WhereFormat = ""; //条件格式串
    clsgs_PViewpointRelaEN._CurrTabName = "gs_PViewpointRela"; //当前表名,与该类相关的表名
    clsgs_PViewpointRelaEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_PViewpointRelaEN.mintAttributeCount = 8;
    clsgs_PViewpointRelaEN.AttributeName = ["mId", "paperId", "sectionId", "viewpointId", "proposePeople", "updDate", "updUser", "memo"];
});
