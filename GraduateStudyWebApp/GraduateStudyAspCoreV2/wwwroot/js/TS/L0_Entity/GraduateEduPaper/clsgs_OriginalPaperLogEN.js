(function (factory) {
    ...
    exports.clsgs_OriginalPaperLogEN = void 0;
    /**
    ...
    **/
    ...
    class clsgs_OriginalPaperLogEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        constructor() {
            ...
            */
            this.mlngPaperLogId = 0; //论文日志Id
            this.mstrPaperId = ""; //论文Id
            this.mstrLogTypeId = ""; //日志类型Id
            this.mstrLogDescription = ""; //日志描述
            ...
            */
            this.paperLogId = 0; //论文日志Id
            this.paperId = ""; //论文Id
            this.logTypeId = ""; //日志类型Id
            this.logDescription = ""; //日志描述
            this.updUser = ""; //修改人
            this.updDate = ""; //修改日期
            this.memo = ""; //备注
        }
        ...
        */
        static get con_PaperLogId() { return "paperLogId"; } //论文日志Id
        /**
        * 常量:"PaperId"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_LogTypeId() { return "logTypeId"; } //日志类型Id
        /**
        * 常量:"LogDescription"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_LogDescription() { return "logDescription"; } //日志描述
        /**
        * 常量:"UpdUser"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    exports.clsgs_OriginalPaperLogEN = clsgs_OriginalPaperLogEN;
    clsgs_OriginalPaperLogEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_OriginalPaperLogEN.CacheModeId = "05"; //未知
    clsgs_OriginalPaperLogEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_OriginalPaperLogEN.WhereFormat = ""; //条件格式串
    clsgs_OriginalPaperLogEN._CurrTabName = "gs_OriginalPaperLog"; //当前表名,与该类相关的表名
    clsgs_OriginalPaperLogEN._KeyFldName = "PaperLogId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_OriginalPaperLogEN.mintAttributeCount = 7;
    clsgs_OriginalPaperLogEN.AttributeName = ["paperLogId", "paperId", "logTypeId", "logDescription", "updUser", "updDate", "memo"];
});
