(function (factory) {
    ...
    exports.clsPaperDownloadLogEN = void 0;
    /**
    * 类名:clsPaperDownloadLogEN
    * 表名:PaperDownloadLog(01120571)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:53:46
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsPaperDownloadLogEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        constructor() {
            ...
            */
            this.mlngPaperDownloadId = 0; //PaperDownloadId
            this.mstrDownloadFile = ""; //DownloadFile
            this.mstrDownloadLink = ""; //DownloadLink
    ...
    exports.clsPaperDownloadLogEN = clsPaperDownloadLogEN;
    clsPaperDownloadLogEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsPaperDownloadLogEN.CacheModeId = "05"; //未知
    clsPaperDownloadLogEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsPaperDownloadLogEN.WhereFormat = ""; //条件格式串
    clsPaperDownloadLogEN._CurrTabName = "PaperDownloadLog"; //当前表名,与该类相关的表名
    clsPaperDownloadLogEN._KeyFldName = "PaperDownloadId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsPaperDownloadLogEN.mintAttributeCount = 7;
    clsPaperDownloadLogEN.AttributeName = ["paperDownloadId", "downloadFile", "downloadLink", "paperId", "updUser", "updDate", "memo"];
});
