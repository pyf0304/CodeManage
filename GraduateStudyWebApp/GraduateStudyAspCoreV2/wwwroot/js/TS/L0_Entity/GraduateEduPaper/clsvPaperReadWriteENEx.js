(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/GraduateEduPaper/clsvPaperReadWriteEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.clsvPaperReadWriteENEx = void 0;
    /**
    * 类名:clsvPaperReadWriteENEx
    * 表名:vPaperReadWrite(01120550)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:55:18
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsvPaperReadWriteENEx extends clsvPaperReadWriteEN_js_1.clsvPaperReadWriteEN {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsvPaperReadWriteENEx = clsvPaperReadWriteENEx;
});
