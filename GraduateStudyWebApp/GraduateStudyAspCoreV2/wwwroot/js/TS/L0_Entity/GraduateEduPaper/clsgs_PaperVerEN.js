(function (factory) {
    ...
    **/
    ...
    clsgs_PaperVerEN.CacheModeId = ""; //
    clsgs_PaperVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_PaperVerEN.WhereFormat = ""; //条件格式串
    clsgs_PaperVerEN._CurrTabName = "gs_PaperVer"; //当前表名,与该类相关的表名
