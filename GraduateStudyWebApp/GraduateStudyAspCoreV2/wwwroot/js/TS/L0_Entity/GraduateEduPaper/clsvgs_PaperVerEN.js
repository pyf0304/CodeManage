(function (factory) {
    ...
    **/
    ...
    clsvgs_PaperVerEN.CacheModeId = ""; //
    clsvgs_PaperVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsvgs_PaperVerEN.WhereFormat = ""; //条件格式串
    clsvgs_PaperVerEN._CurrTabName = "vgs_PaperVer"; //当前表名,与该类相关的表名
