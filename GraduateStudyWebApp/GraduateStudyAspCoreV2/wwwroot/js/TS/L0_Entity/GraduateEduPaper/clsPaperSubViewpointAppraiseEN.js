(function (factory) {
    ...
    **/
    ...
    clsPaperSubViewpointAppraiseEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsPaperSubViewpointAppraiseEN.WhereFormat = ""; //条件格式串
    ...
    clsPaperSubViewpointAppraiseEN.AttributeName = ["paperSubViewpointAppraiseId", "subViewpointId", "appraiseScore", "appraiseContent", "updDate", "meno", "updUser"];
});
