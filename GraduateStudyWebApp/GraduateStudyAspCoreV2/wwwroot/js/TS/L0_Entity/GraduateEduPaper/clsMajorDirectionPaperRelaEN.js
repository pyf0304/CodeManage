(function (factory) {
    ...
    **/
    ...
    class clsMajorDirectionPaperRelaEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsMajorDirectionPaperRelaEN = clsMajorDirectionPaperRelaEN;
    clsMajorDirectionPaperRelaEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsMajorDirectionPaperRelaEN.CacheModeId = "04"; //sessionStorage
    clsMajorDirectionPaperRelaEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsMajorDirectionPaperRelaEN.WhereFormat = "MajorDirectionId in (select MajorDirectionId From XzMajorDirection where id_Major='{0}')"; //条件格式串
    clsMajorDirectionPaperRelaEN._CurrTabName = "MajorDirectionPaperRela"; //当前表名,与该类相关的表名
    clsMajorDirectionPaperRelaEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsMajorDirectionPaperRelaEN.mintAttributeCount = 6;
    clsMajorDirectionPaperRelaEN.AttributeName = ["mId", "majorDirectionId", "paperId", "updDate", "updUser", "memo"];
});
