(function (factory) {
    ...
    **/
    ...
    clsPaperCollectionLogEN.CacheModeId = "04"; //sessionStorage
    clsPaperCollectionLogEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsPaperCollectionLogEN.WhereFormat = ""; //条件格式串
