(function (factory) {
    ...
    exports.clsPaperEduClsRelaEN = void 0;
    /**
    ...
    **/
    ...
    class clsPaperEduClsRelaEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsPaperEduClsRelaEN = clsPaperEduClsRelaEN;
    clsPaperEduClsRelaEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsPaperEduClsRelaEN.CacheModeId = "04"; //sessionStorage
    clsPaperEduClsRelaEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsPaperEduClsRelaEN.WhereFormat = ""; //条件格式串
    clsPaperEduClsRelaEN._CurrTabName = "PaperEduClsRela"; //当前表名,与该类相关的表名
    clsPaperEduClsRelaEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsPaperEduClsRelaEN.mintAttributeCount = 8;
    clsPaperEduClsRelaEN.AttributeName = ["mId", "paperId", "paperTitle", "id_CurrEduCls", "author", "updUser", "updDate", "memo"];
});
