(function (factory) {
    ...
    exports.clsAcademicJournalsEN = void 0;
    /**
    * 类名:clsAcademicJournalsEN
    * 表名:AcademicJournals(01120929)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:49:49
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsAcademicJournalsEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        */
        constructor() {
            ...
            */
            this.mstrJournalId = ""; //期刊Id
            this.mstrJournalName = ""; //期刊名称
        ...
        */
        SetJournalId(value) {
            if (value != undefined) {
                ...
                this.hmProperty["journalId"] = true;
        ...
        */
        SetJournalName(value) {
            if (value != undefined) {
                ...
                this.hmProperty["journalName"] = true;
                this.sf_UpdFldSetStr = this.updFldString;
            }
        }
        /**
        ...
        */
        GetFldValue(strFldName) {
            ...
            switch (strFldName) {
                ...
                default:
                    strMsg = `字段名:[${strFldName}]在表对象:[AcademicJournals]中不存在！`;
        ...
        */
        SetFldValue(strFldName, strValue) {
            ...
            switch (strFldName) {
                case clsAcademicJournalsEN.con_JournalId:
                    this.journalId = strValue;
                    this.hmProperty["journalId"] = true;
                    break;
                case clsAcademicJournalsEN.con_JournalName:
                    this.journalName = strValue;
                    this.hmProperty["journalName"] = true;
                    break;
                case clsAcademicJournalsEN.con_JournalSubjectCategoryId:
        ...
        */
        static get con_JournalId() { return "journalId"; } //期刊Id
        /**
        * 常量:"JournalName"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_JournalName() { return "journalName"; } //期刊名称
        /**
    ...
    exports.clsAcademicJournalsEN = clsAcademicJournalsEN;
    clsAcademicJournalsEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsAcademicJournalsEN.CacheModeId = "04"; //sessionStorage
    clsAcademicJournalsEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsAcademicJournalsEN.WhereFormat = ""; //条件格式串
    clsAcademicJournalsEN._CurrTabName = "AcademicJournals"; //当前表名,与该类相关的表名
    clsAcademicJournalsEN._KeyFldName = "JournalId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsAcademicJournalsEN.mintAttributeCount = 7;
    clsAcademicJournalsEN.AttributeName = ["journalId", "journalName", "journalSubjectCategoryId", "journalSubjectId", "updDate", "updUser", "memo"];
});
