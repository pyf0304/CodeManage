(function (factory) {
    ...
    exports.clsgs_PaperParagraphVerEN = void 0;
    /**
    ...
    **/
    ...
    class clsgs_PaperParagraphVerEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
    ...
    exports.clsgs_PaperParagraphVerEN = clsgs_PaperParagraphVerEN;
    clsgs_PaperParagraphVerEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsgs_PaperParagraphVerEN.CacheModeId = ""; //
    clsgs_PaperParagraphVerEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsgs_PaperParagraphVerEN.WhereFormat = ""; //条件格式串
    clsgs_PaperParagraphVerEN._CurrTabName = "gs_PaperParagraphVer"; //当前表名,与该类相关的表名
    clsgs_PaperParagraphVerEN._KeyFldName = "ParagraphVId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsgs_PaperParagraphVerEN.mintAttributeCount = 9;
    clsgs_PaperParagraphVerEN.AttributeName = ["paragraphVId", "paragraphId", "sectionId", "paragraphTypeId", "paragraphContent", "updDate", "updUser", "memo", "paperId"];
});
