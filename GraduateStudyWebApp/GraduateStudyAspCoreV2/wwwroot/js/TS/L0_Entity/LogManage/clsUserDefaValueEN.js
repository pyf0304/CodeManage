(function (factory) {
    ...
    exports.clsUserDefaValueEN = void 0;
    /**
    * 类名:clsUserDefaValueEN
    * 表名:UserDefaValue(01120203)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:52:26
    * 生成者:pyf
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    class clsUserDefaValueEN extends clsGeneralTab_js_1.clsGeneralTab {
        //以下是属性变量
        /**
         * 构造函数
        ...
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
        static get con_UserDefaValue() { return "userDefaValue"; } //用户缺省值
        /**
        * 常量:"UpdDate"
        * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
        */
    ...
    exports.clsUserDefaValueEN = clsUserDefaValueEN;
    clsUserDefaValueEN.CacheAddiCondition = ""; //缓存附加条件，作为向后台调取数据的附加条件
    clsUserDefaValueEN.CacheModeId = "05"; //未知
    clsUserDefaValueEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsUserDefaValueEN.WhereFormat = ""; //条件格式串
    clsUserDefaValueEN._CurrTabName = "UserDefaValue"; //当前表名,与该类相关的表名
    clsUserDefaValueEN._KeyFldName = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
    clsUserDefaValueEN.mintAttributeCount = 7;
    clsUserDefaValueEN.AttributeName = ["mId", "defaValNameId", "userId", "userDefaValue", "updDate", "updUser", "memo"];
});
