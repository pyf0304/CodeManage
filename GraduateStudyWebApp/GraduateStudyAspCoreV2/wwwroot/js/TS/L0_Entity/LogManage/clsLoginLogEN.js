(function (factory) {
    ...
    **/
    ...
    clsLoginLogEN.IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
    clsLoginLogEN.WhereFormat = ""; //条件格式串
    ...
    clsLoginLogEN.AttributeName = ["loginLogId", "loginLogNumber", "loginIP", "failReason", "loginResult", "loginTime", "loginUserId", "onlineTime", "outTime", "memo"];
});
