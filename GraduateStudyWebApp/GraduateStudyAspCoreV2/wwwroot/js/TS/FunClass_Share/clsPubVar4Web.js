...
(function (factory) {
    ...
    exports.GetLst_TabCacheAdditionConditionBak = exports.clsPubVar4Web = void 0;
    class clsPubVar4Web {
        static sortFun() { }
        /*
        * 重新转向本项目新的Url地址
    ...
    function GetLst_TabCacheAdditionConditionBak() {
    ...
    exports.GetLst_TabCacheAdditionConditionBak = GetLst_TabCacheAdditionConditionBak;
});
