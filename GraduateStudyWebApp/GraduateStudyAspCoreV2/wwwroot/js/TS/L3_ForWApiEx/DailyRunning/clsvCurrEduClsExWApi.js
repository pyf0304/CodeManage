...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../PubFun/clsCommFunc4Web.js", "../../L0_Entity/DailyRunning_Share/clsvCurrEduClsENEx.js", "../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js", "../../L0_Entity/DailyRunning_Share/clsvCurrEduClsEN.js", "../../PubFun/clsString.js", "../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js", "../../PubConfig/clsSysPara4WebApi.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.vCurrEduClsEx_FilterFunByKey = exports.vCurrEduClsEx_FuncMapByFldName = exports.vCurrEduClsEx_SortFunByKey = exports.vCurrEduClsEx_GetObjExLstByPagerAsync = exports.vCurrEduClsEx_CopyToEx = exports.vCurrEduClsEx_GetWebApiUrl = exports.vCurrEduClsEx_ConstructorName = exports.vCurrEduClsEx_Controller = void 0;
    /**
    * v当前教学班(vCurrEduCls)
   ...
   * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    **/
    ...
    const clsvCurrEduClsENEx_js_1 = require("../../L0_Entity/DailyRunning_Share/clsvCurrEduClsENEx.js");
    const clsvCurrEduClsWApi_js_1 = require("../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js");
    const clsCommFunc4Web_js_2 = require("../../PubFun/clsCommFunc4Web.js");
    const clsString_js_1 = require("../../PubFun/clsString.js");
    const clsvCurrEduClsWApi_js_2 = require("../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js");
    const clsvCurrEduClsEN_js_1 = require("../../L0_Entity/DailyRunning_Share/clsvCurrEduClsEN.js");
    const clsString_js_2 = require("../../PubFun/clsString.js");
    const clsvCurrEduClsWApi_js_3 = require("../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsWApi.js");
    ...
    **/
    function vCurrEduClsEx_CopyToEx(objvCurrEduClsENS) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, exports.vCurrEduClsEx_ConstructorName, strThisFuncName);
    ...
    */
    async function vCurrEduClsEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrvCurrEduClsObjLst = await (0, clsvCurrEduClsWApi_js_1.vCurrEduCls_GetObjLstAsync)(objPagerPara.whereCond);
    ...
    */
    async function vCurrEduClsEx_FilterFunByKey(strKey, value) {
        ...
        switch (strKey) {
            ...
            default:
                return (0, clsvCurrEduClsWApi_js_3.vCurrEduCls_FilterFunByKey)(strKey, value);
        }
    }
