...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../PubFun/CacheHelper.js", "../../PubFun/tzDictionary.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js", "../../L0_Entity/GraduateEduTools/clsvgs_TotalDataStatisticsEN.js", "../../L0_Entity/GraduateEduTools/clsvgs_TotalDataStatisticsENEx.js", "../../L3_ForWApi/GraduateEduTools/clsvgs_TotalDataStatisticsWApi.js", "axios"], factory);
    }
    ...
    */
    async function vgs_TotalDataStatisticsEx_GetObjExLstByPager_Cache(objPagerPara, strid_CurrEduCls) {
        ...
        const arrvgs_TotalDataStatisticsObjLst = await (0, clsvgs_TotalDataStatisticsWApi_js_1.vgs_TotalDataStatistics_GetObjLst_Cache)(strid_CurrEduCls);
    ...
    */
    async function vgs_TotalDataStatisticsEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrvgs_TotalDataStatisticsExObjLst = await (0, clsvgs_TotalDataStatisticsWApi_js_1.vgs_TotalDataStatistics_GetObjLstAsync)(objPagerPara.whereCond);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrvgs_TotalDataStatisticsExObjLst) {
                const conFuncMap = await vgs_TotalDataStatisticsEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
    ...
    */
    function vgs_TotalDataStatisticsEx_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                default:
                    return (0, clsvgs_TotalDataStatisticsWApi_js_1.vgs_TotalDataStatistics_SortFunByKey)(strKey, AscOrDesc);
            }
        }
        else {
            switch (strKey) {
    ...
    */
    ...
    async function vgs_TotalDataStatisticsEx_GetUserNumSubObjLst_Cache(objvgs_TotalDataStatistics_Cond, strid_CurrEduCls) {
        ...
        //console.log(dicFldComparisonOp);
        try {
            var sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objvgs_TotalDataStatistics_Cond);
            //console.log(sstrKeys);
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.vgs_TotalDataStatisticsEx_Controller, strThisFuncName);
                    console.error(strNullInfo);
                    throw (strNullInfo);
                }
                //console.log(returnObjLst);
                const arrObjLst = (0, clsvgs_TotalDataStatisticsWApi_js_1.vgs_TotalDataStatistics_GetObjLstByJSONObjLst)(returnObjLst);
                return (arrObjLst);
            }
            else {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.vgs_TotalDataStatisticsEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.vgs_TotalDataStatisticsEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
