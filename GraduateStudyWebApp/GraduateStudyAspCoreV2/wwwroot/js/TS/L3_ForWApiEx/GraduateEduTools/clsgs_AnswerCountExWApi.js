...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/GraduateEduTools/clsgs_AnswerCountEN.js", "../../L3_ForWApi/GraduateEduTools/clsgs_AnswerCountWApi.js", "../../PubFun/CacheHelper.js", "../../PubFun/tzDictionary.js", "../../L0_Entity/GraduateEduTools/clsgs_AnswerCountENEx.js", "../../L3_ForWApi/GraduateEduTools/clsgs_AnswerCountWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js", "axios"], factory);
    }
    ...
    */
    ...
    async function gs_AnswerCountEx_AddNewRecordWithMaxIdAsync(objgs_AnswerCountEN) {
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_AnswerCountEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_AnswerCountEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
    ...
    async function gs_AnswerCountEx_GetSubObjLst_Cache(objgs_AnswerCount_Cond, strid_CurrEduCls) {
        ...
        //console.log(dicFldComparisonOp);
        try {
            var sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objgs_AnswerCount_Cond);
            //console.log(sstrKeys);
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.gs_AnswerCountEx_Controller, strThisFuncName);
                    console.error(strNullInfo);
                    throw (strNullInfo);
                }
                //console.log(returnObjLst);
                const arrObjLst = (0, clsgs_AnswerCountWApi_js_1.gs_AnswerCount_GetObjLstByJSONObjLst)(returnObjLst);
                return (arrObjLst);
            }
            else {
                console.error(data.errorMsg);
