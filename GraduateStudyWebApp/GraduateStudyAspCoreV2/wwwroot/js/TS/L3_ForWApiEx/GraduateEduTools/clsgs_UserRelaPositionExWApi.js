...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/GraduateEduTools/clsgs_UserRelaPositionEN.js", "../../L0_Entity/GraduateEduTools/clsgs_UserRelaPositionENEx.js", "../../L3_ForWApi/GraduateEduTools/clsgs_UserRelaPositionWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js"], factory);
    }
    ...
    **/
    function gs_UserRelaPositionEx_CopyToEx(objgs_UserRelaPositionENS) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_1.Format)("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, exports.gs_UserRelaPositionEx_ConstructorName, strThisFuncName);
    ...
    */
    async function gs_UserRelaPositionEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrgs_UserRelaPositionExObjLst = await (0, clsgs_UserRelaPositionWApi_js_1.gs_UserRelaPosition_GetObjLstAsync)(objPagerPara.whereCond);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrgs_UserRelaPositionExObjLst) {
                const conFuncMap = await gs_UserRelaPositionEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
    ...
    */
    function gs_UserRelaPositionEx_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                default:
                    return (0, clsgs_UserRelaPositionWApi_js_1.gs_UserRelaPosition_SortFunByKey)(strKey, AscOrDesc);
            }
        }
        else {
            switch (strKey) {
    ...
    async function gs_UserRelaPositionEx_AddNewRecordAsync(strJSON) {
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_UserRelaPositionEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_UserRelaPositionEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
