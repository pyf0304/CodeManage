...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../PubFun/clsCommFunc4Web.js", "../../L0_Entity/GraduateEduTopic/clsSysSocialRelationsVerENEx.js", "../../L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsVerWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsVerWApi.js", "../../L0_Entity/GraduateEduTopic/clsSysSocialRelationsVerEN.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js"], factory);
    }
   ...
   * 注意:该类必须与调用界面处于同一个包，否则调用不成功!
    ...
    **/
    function SysSocialRelationsVEx_CopyToEx(objSysSocialRelationsVerENS) {
    ...
    */
    async function SysSocialRelationsVEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrSysSocialRelationsVExObjLst = await (0, clsSysSocialRelationsVerWApi_js_1.SysSocialRelationsVer_GetObjLstAsync)(objPagerPara.whereCond);
        ...
        let arrSysSocialRelationsVer_Sel = arrSysSocialRelationsVExObjLst;
        try {
    ...
    */
    async function SysSocialRelationsVEx_FilterFunByKey(strKey, value) {
        ...
        switch (strKey) {
            default:
                return (0, clsSysSocialRelationsVerWApi_js_1.SysSocialRelationsVer_FilterFunByKey)(strKey, value);
        }
    }
