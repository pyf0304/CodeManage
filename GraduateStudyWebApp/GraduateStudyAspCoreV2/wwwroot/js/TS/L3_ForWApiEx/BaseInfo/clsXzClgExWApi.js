(function (factory) {
    ...
    **/
    ...
    const clsXzClgWApi_js_3 = require("../../L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js");
    const clsString_js_2 = require("../../PubFun/clsString.js");
    const clsXzClgWApi_js_4 = require("../../L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js");
    ...
    **/
    function XzClgEx_CopyToEx(objXzClgENS) {
        ...
        try {
            ...
            const strMsg = (0, clsString_js_2.Format)("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, exports.xzClgEx_ConstructorName, strThisFuncName);
    ...
    */
    async function XzClgEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrXzClgObjLst = await (0, clsXzClgWApi_js_2.XzClg_GetObjLstAsync)(objPagerPara.whereCond);
        const arrXzClgExObjLst = arrXzClgObjLst.map(XzClgEx_CopyToEx);
        const objSortInfo = (0, clsCommFunc4Web_js_2.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrXzClgExObjLst) {
    ...
    */
    function XzClgEx_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                default:
                    return (0, clsXzClgWApi_js_3.XzClg_SortFunByKey)(strKey, AscOrDesc);
            }
        }
        else {
            switch (strKey) {
    ...
    */
    async function XzClgEx_FilterFunByKey(strKey, value) {
        ...
        switch (strKey) {
            default:
                return (0, clsXzClgWApi_js_4.XzClg_FilterFunByKey)(strKey, value);
        }
    }
    ...
    /// <returns>获取的相应对象列表</returns>
    async function XzClgEx_DelRecordExAsync(id) {
    ...
    exports.XzClgEx_DelRecordExAsync = XzClgEx_DelRecordExAsync;
    ;
    async function XzClgEx_BindDdl_id_XzCollegeForvUsersSimInDiv_CacheEx(strDivName, strDdlName, strCmPrjId) {
        if ((0, clsString_js_1.IsNullOrEmpty)(strCmPrjId) == true) {
            const strMsg = (0, clsString_js_2.Format)("参数:[strstrCmPrjIdPrjId]不能为空！(In BindDdl_id_XzCollege_CacheEx)");
            console.error(strMsg);
            throw (strMsg);
        }
