...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/UserManage_Share/clsUsersEN.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/stuPagerPara.js", "../../PubFun/stuRangePara.js", "../../PubFun/stuTopPara.js", "../../PubFun/tzDictionary.js", "../../L0_Entity/UserManage_Share/clsUsersENEx.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../L3_ForWApi/UserManage_Share/clsUsersWApi.js"], factory);
    }
    ...
    */
    async function UsersEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrUsersObjLst = await (0, clsUsersWApi_js_1.Users_GetObjLstAsync)(objPagerPara.whereCond);
        const arrUsersExObjLst = arrUsersObjLst.map(UsersEx_CopyToEx);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrUsersExObjLst) {
