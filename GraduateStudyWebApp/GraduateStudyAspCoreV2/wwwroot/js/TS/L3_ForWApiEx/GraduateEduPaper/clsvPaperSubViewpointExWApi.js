...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/GraduateEduPaper/clsvPaperSubViewpointEN.js", "../../PubFun/tzDictionary.js", "../../L0_Entity/GraduateEduPaper/clsvPaperSubViewpointENEx.js", "../../L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js", "axios"], factory);
    }
        ...
        try {
            ...
            if (data.errorId == 0) {
                ...
                if (returnObjLst == null) {
                    const strNullInfo = (0, clsString_js_1.Format)("获取数据为null, 请注意!(in {0}.{1})", exports.vPaperSubViewpointEx_Controller, strThisFuncName);
                    console.error(strNullInfo);
                    throw (strNullInfo);
                }
                //console.log(returnObjLst);
                const arrObjLst = (0, clsvPaperSubViewpointWApi_js_1.vPaperSubViewpoint_GetObjLstByJSONObjLst)(returnObjLst);
                return (arrObjLst);
            }
            else {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.vPaperSubViewpointEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.vPaperSubViewpointEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
