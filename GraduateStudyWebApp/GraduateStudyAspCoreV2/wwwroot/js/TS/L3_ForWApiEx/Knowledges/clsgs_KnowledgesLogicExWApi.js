...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "axios", "../../L0_Entity/Knowledges/clsgs_KnowledgesLogicEN.js", "../../L0_Entity/Knowledges/clsgs_KnowledgesLogicENEx.js", "../../L3_ForWApi/Knowledges/clsgs_KnowledgesLogicWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js"], factory);
    }
    ...
    */
    async function gs_KnowledgesLogicEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrgs_KnowledgesLogicObjLst = await (0, clsgs_KnowledgesLogicWApi_js_1.gs_KnowledgesLogic_GetObjLstAsync)(objPagerPara.whereCond);
        const arrgs_KnowledgesLogicExObjLst = arrgs_KnowledgesLogicObjLst.map(gs_KnowledgesLogicEx_CopyToEx);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrgs_KnowledgesLogicExObjLst) {
    ...
    async function gs_KnowledgesLogicEx_AddNewRecordAsync(strJSON) {
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.gs_KnowledgesLogicEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.gs_KnowledgesLogicEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
