(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/BaseInfo_Share/clsXzClgEN.js", "../../L0_Entity/DailyRunning_Share/clsCurrEduClsEN.js", "../../L0_Entity/DailyRunning_Share/clsCurrEduClsENEx.js", "../../L0_Entity/SysPara/clsXzGradeBaseEN.js", "../../L0_Entity/SystemSet_Share/clsClsRmTypeEN.js", "../../L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js", "../../L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../L3_ForWApi/SysPara/clsXzGradeBaseWApi.js", "../../L3_ForWApi/SystemSet_Share/clsClsRmTypeWApi.js", "../../PubConfig/clsSysPara4WebApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsPublocalStorage.js", "../../PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.CurrEduClsEx_GetCourseIdById_CurrEduCls = exports.CurrEduClsEx_SortFun_IntTag = exports.CurrEduClsEx_FuncMap_GradeBaseName = exports.CurrEduClsEx_FuncMap_ClassRoomTypeDesc = exports.CurrEduClsEx_FuncMap_CollegeName = exports.CurrEduClsEx_SetObjLst_localStorage = exports.CurrEduClsEx_GetObjLst_localStorage = exports.CurrEduClsEx_FilterFunByKey = exports.CurrEduClsEx_FuncMapByFldName = exports.CurrEduClsEx_SortFunByKey = exports.CurrEduClsEx_GetObjExLstByPagerAsync = exports.CurrEduClsEx_GetObjExLstByPager_Cache = exports.CurrEduClsEx_CopyToEx = exports.CurrEduClsEx_GetWebApiUrl = exports.currEduClsEx_ConstructorName = exports.currEduClsEx_Controller = void 0;
    //import * as QQ from "q";
    ...
    **/
     ...
     * @returns 对象列表
    */
    async function CurrEduClsEx_GetObjExLstByPager_Cache(objPagerPara, strCourseId) {
        const strThisFuncName = "GetObjLstByPager_Cache";
        const arrCurrEduClsObjLst = await (0, clsCurrEduClsWApi_js_1.CurrEduCls_GetObjLst_Cache)(strCourseId);
    ...
    */
    function CurrEduClsEx_SortFunByKey(strKey, AscOrDesc) {
        ...
        if (AscOrDesc == "Asc" || AscOrDesc == "") {
            switch (strKey) {
                default:
                    return (0, clsCurrEduClsWApi_js_1.CurrEduCls_SortFunByKey)(strKey, AscOrDesc);
            }
        }
        else {
            switch (strKey) {
    ...
    */
    function CurrEduClsEx_FuncMapByFldName(strFldName, objCurrEduClsEx) {
        ...
        //针对扩展字段进行映射
        switch (strFldName) {
            case clsCurrEduClsENEx_js_1.clsCurrEduClsENEx.con_CollegeName:
                return CurrEduClsEx_FuncMap_CollegeName(objCurrEduClsEx);
            case clsCurrEduClsENEx_js_1.clsCurrEduClsENEx.con_ClassRoomTypeDesc:
                return CurrEduClsEx_FuncMap_ClassRoomTypeDesc(objCurrEduClsEx);
            case clsCurrEduClsENEx_js_1.clsCurrEduClsENEx.con_GradeBaseName:
                return CurrEduClsEx_FuncMap_GradeBaseName(objCurrEduClsEx);
            default:
    ...
    */
    async function CurrEduClsEx_FilterFunByKey(strKey, value) {
        ...
        switch (strKey) {
            default:
                return (0, clsCurrEduClsWApi_js_1.CurrEduCls_FilterFunByKey)(strKey, value);
        }
    }
    ...
    /// </summary>
    /// <returns>从本地缓存中获取的对象列表</returns>
    async function CurrEduClsEx_SetObjLst_localStorage(strid_CurrEduCls) {
        //清空本类缓存
        const responseText0 = await (0, clsCurrEduClsWApi_js_1.CurrEduCls_ReFreshThisCache)(clsPublocalStorage_js_1.clsPublocalStorage.courseId);
        //初始化列表缓存
    ...
    **/
    async function CurrEduClsEx_FuncMap_CollegeName(objCurrEduCls) {
        const strThisFuncName = CurrEduClsEx_FuncMap_CollegeName.name;
        try {
            if ((0, clsString_js_1.IsNullOrEmpty)(objCurrEduCls.collegeName) == true) {
                const XzClg_id_XzCollege = objCurrEduCls.id_XzCollege;
                ...
                objCurrEduCls.collegeName = XzClg_CollegeName;
            }
        }
        catch (e) {
            const strMsg = (0, clsString_js_1.Format)("(errid:Watl000214)函数映射表对象数据出错,{0}.(in {1}.{2})", e, exports.currEduClsEx_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
    }
    exports.CurrEduClsEx_FuncMap_CollegeName = CurrEduClsEx_FuncMap_CollegeName;
    /**
    * 把一个扩展类的部分属性进行函数转换
    * (AutoGCLib.WA_AccessEx4TypeScript:Gen_4WAEx_Ts_FuncMap)
    * @param objCurrEduClsS:源对象
    **/
    async function CurrEduClsEx_FuncMap_ClassRoomTypeDesc(objCurrEduCls) {
        const strThisFuncName = CurrEduClsEx_FuncMap_ClassRoomTypeDesc.name;
        try {
            if ((0, clsString_js_1.IsNullOrEmpty)(objCurrEduCls.classRoomTypeDesc) == true) {
                const ClsRmType_id_ClassRoomType = objCurrEduCls.id_ClassRoomType;
                const ClsRmType_ClassRoomTypeDesc = await (0, clsClsRmTypeWApi_js_1.ClsRmType_func)(clsClsRmTypeEN_js_1.clsClsRmTypeEN.con_id_ClassRoomType, clsClsRmTypeEN_js_1.clsClsRmTypeEN.con_ClassRoomTypeDesc, ClsRmType_id_ClassRoomType);
                objCurrEduCls.classRoomTypeDesc = ClsRmType_ClassRoomTypeDesc;
            }
        }
        catch (e) {
            const strMsg = (0, clsString_js_1.Format)("(errid:Watl000215)函数映射表对象数据出错,{0}.(in {1}.{2})", e, exports.currEduClsEx_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
    }
    exports.CurrEduClsEx_FuncMap_ClassRoomTypeDesc = CurrEduClsEx_FuncMap_ClassRoomTypeDesc;
    /**
    * 把一个扩展类的部分属性进行函数转换
    * (AutoGCLib.WA_AccessEx4TypeScript:Gen_4WAEx_Ts_FuncMap)
    * @param objCurrEduClsS:源对象
    **/
    async function CurrEduClsEx_FuncMap_GradeBaseName(objCurrEduCls) {
        const strThisFuncName = CurrEduClsEx_FuncMap_GradeBaseName.name;
        try {
            if ((0, clsString_js_1.IsNullOrEmpty)(objCurrEduCls.gradeBaseName) == true) {
                const XzGradeBase_id_GradeBase = objCurrEduCls.id_GradeBase;
                const XzGradeBase_GradeBaseName = await (0, clsXzGradeBaseWApi_js_1.XzGradeBase_func)(clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_id_GradeBase, clsXzGradeBaseEN_js_1.clsXzGradeBaseEN.con_GradeBaseName, XzGradeBase_id_GradeBase);
                objCurrEduCls.gradeBaseName = XzGradeBase_GradeBaseName;
            }
        }
        catch (e) {
            const strMsg = (0, clsString_js_1.Format)("(errid:Watl000216)函数映射表对象数据出错,{0}.(in {1}.{2})", e, exports.currEduClsEx_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
    }
    exports.CurrEduClsEx_FuncMap_GradeBaseName = CurrEduClsEx_FuncMap_GradeBaseName;
    /**
    * 排序函数。根据关键字字段的值进行比较
    * 作者:pyf
    * 日期:20211017113202
