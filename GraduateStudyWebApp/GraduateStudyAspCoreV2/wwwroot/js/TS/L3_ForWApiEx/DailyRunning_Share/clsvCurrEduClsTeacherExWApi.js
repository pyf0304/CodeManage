(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/DailyRunning_Share/clsCurrEduClsTeacherEN.js", "../../L0_Entity/DailyRunning_Share/clsCurrEduClsTeacherENEx.js", "../../L0_Entity/DailyRunning_Share/clsvCurrEduClsTeacherEN.js", "../../L0_Entity/DailyRunning_Share/clsvCurrEduClsTeacherENEx.js", "../../L3_ForWApi/DailyRunning_Share/clsvCurrEduClsTeacherWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js", "../../L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../L0_Entity/BaseInfo_Share/clsTeacherInfoEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.vCurrEduClsTeacherEx_SortFun_OrderNum = exports.vCurrEduClsTeacherEx_FuncMapByFldName = exports.CurrEduClsTeacherEx_FuncMap_TeacherName = exports.CurrEduClsTeacherEx_FuncMap_TeacherID = exports.vCurrEduClsTeacherEx_FilterFunByKey = exports.CurrEduClsTeacherEx_FuncMapByFldName = exports.vCurrEduClsTeacherEx_SortFunByKey = exports.vCurrEduClsTeacherEx_GetObjExLstByPagerAsync = exports.vCurrEduClsTeacherEx_GetObjExLstByPager_Cache = exports.vCurrEduClsTeacherEx_CopyToEx = exports.vCurrEduClsTeacherEx_GetWebApiUrl = exports.vCurrEduClsTeacherEx_ConstructorName = exports.vCurrEduClsTeacherEx_Controller = void 0;
    //import $ from "jquery";
    ...
    const clsvCurrEduClsTeacherENEx_js_1 = require("../../L0_Entity/DailyRunning_Share/clsvCurrEduClsTeacherENEx.js");
    ...
    */
    async function vCurrEduClsTeacherEx_GetObjExLstByPagerAsync(objPagerPara) {
        ...
        const arrvCurrEduClsTeacherObjLst = await (0, clsvCurrEduClsTeacherWApi_js_1.vCurrEduClsTeacher_GetObjLstAsync)(objPagerPara.whereCond);
        const arrvCurrEduClsTeacherExObjLst = arrvCurrEduClsTeacherObjLst.map(vCurrEduClsTeacherEx_CopyToEx);
        const objSortInfo = (0, clsCommFunc4Web_js_1.GetSortExpressInfo)(objPagerPara);
        if ((0, clsString_js_1.IsNullOrEmpty)(objSortInfo.SortFld) == false) {
            for (const objInFor of arrvCurrEduClsTeacherExObjLst) {
    ...
    */
    function CurrEduClsTeacherEx_FuncMapByFldName(strFldName, objCurrEduClsTeacherEx) {
        ...
        //针对扩展字段进行映射
        switch (strFldName) {
            case clsCurrEduClsTeacherENEx_js_1.clsCurrEduClsTeacherENEx.con_TeacherID:
                return CurrEduClsTeacherEx_FuncMap_TeacherID(objCurrEduClsTeacherEx);
            case clsCurrEduClsTeacherENEx_js_1.clsCurrEduClsTeacherENEx.con_TeacherName:
                return CurrEduClsTeacherEx_FuncMap_TeacherName(objCurrEduClsTeacherEx);
            default:
    ...
    **/
    async function CurrEduClsTeacherEx_FuncMap_TeacherID(objCurrEduClsTeacher) {
        const strThisFuncName = CurrEduClsTeacherEx_FuncMap_TeacherID.name;
        try {
            if ((0, clsString_js_1.IsNullOrEmpty)(objCurrEduClsTeacher.teacherID) == true) {
                const TeacherInfo_id_Teacher = objCurrEduClsTeacher.id_Teacher;
                const TeacherInfo_TeacherID = await (0, clsTeacherInfoWApi_js_1.TeacherInfo_func)(clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Teacher, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherID, TeacherInfo_id_Teacher);
                objCurrEduClsTeacher.teacherID = TeacherInfo_TeacherID;
            }
        }
        catch (e) {
            const strMsg = (0, clsString_js_1.Format)("(errid:Watl000217)函数映射表对象数据出错,{0}.(in {1}.{2})", e, exports.vCurrEduClsTeacherEx_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
    }
    exports.CurrEduClsTeacherEx_FuncMap_TeacherID = CurrEduClsTeacherEx_FuncMap_TeacherID;
    /**
    * 把一个扩展类的部分属性进行函数转换
    * (AutoGCLib.WA_AccessEx4TypeScript:Gen_4WAEx_Ts_FuncMap)
    * @param objCurrEduClsTeacherS:源对象
    **/
    async function CurrEduClsTeacherEx_FuncMap_TeacherName(objCurrEduClsTeacher) {
        const strThisFuncName = CurrEduClsTeacherEx_FuncMap_TeacherName.name;
        try {
            if ((0, clsString_js_1.IsNullOrEmpty)(objCurrEduClsTeacher.teacherName) == true) {
                const TeacherInfo_id_Teacher = objCurrEduClsTeacher.id_Teacher;
                const TeacherInfo_TeacherName = await (0, clsTeacherInfoWApi_js_1.TeacherInfo_func)(clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_id_Teacher, clsTeacherInfoEN_js_1.clsTeacherInfoEN.con_TeacherName, TeacherInfo_id_Teacher);
                objCurrEduClsTeacher.teacherName = TeacherInfo_TeacherName;
            }
        }
        catch (e) {
            const strMsg = (0, clsString_js_1.Format)("(errid:Watl000208)函数映射表对象数据出错,{0}.(in {1}.{2})", e, exports.vCurrEduClsTeacherEx_ConstructorName, strThisFuncName);
            console.error(strMsg);
            alert(strMsg);
        }
    }
    exports.CurrEduClsTeacherEx_FuncMap_TeacherName = CurrEduClsTeacherEx_FuncMap_TeacherName;
    /**
     * 根据扩展字段名去调用相应的映射函数
     * 作者:潘以锋
     * 日期:00-00-00
