...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../L0_Entity/UserManage_Share/clsUsersEN.js", "../../PubFun/stuPagerPara.js", "../../PubFun/stuRangePara.js", "../../PubFun/stuTopPara.js", "../../PubFun/tzDictionary.js", "../../L0_Entity/UserManage_Share/clsUsersENEx.js", "../../L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../PubFun/clsCommFunc4Web.js", "../../PubFun/clsString.js", "../../PubConfig/clsSysPara4WebApi.js", "axios"], factory);
    }
    ...
    */
    ...
    const clsUsersENEx_js_1 = require("../../L0_Entity/UserManage_Share/clsUsersENEx.js");
    ...
    async function UsersEx_DelRecordAsync(strUserId) {
        ...
        try {
            ...
            if (error.statusText == "error") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}不成功！(in {1}.{2})", strUrl, exports.usersEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else if (error.statusText == "Not Found") {
                const strInfo = (0, clsString_js_1.Format)("网络错误！访问地址:{0}可能不存在！(in {1}.{2})", strUrl, exports.usersEx_Controller, strThisFuncName);
                console.error(strInfo);
                throw (strInfo);
            }
            else {
