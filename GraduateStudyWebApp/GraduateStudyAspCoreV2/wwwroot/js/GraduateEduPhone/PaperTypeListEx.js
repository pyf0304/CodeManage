(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/stuUserLoginInfo.js", "../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSimWApi.js", "../TS/L0_Entity/GraduateEduPaper/clsvPaperSimEN.js", "../PagesBase/GraduateEduPaper/PaperCRUD.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PaperTypeListEx = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    类名:Paper_QUDI_TSEx
    表名:Paper(01120535)
    生成代码版本:2019.12.06.1
    ...
    */
    ...
    /* PaperTypeListEx 的摘要说明。其中Q代表查询,U代表修改
     (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    */
    class PaperTypeListEx extends PaperCRUD_js_1.PaperCRUD {
        constructor() {
    ...
    */
        ...
        //    try {
        //        //this.BindTab_vPaper(strListDiv, arrvPaperSimObjLst);
        //        const gvResultPaper = await this.BindList_vPaperSim("3", arrvPaperSimObjLst);
    ...
    */
        async liAllPaper_Click(strListDiv) {
            try {
                const gvResultPaper = await this.BindGv_Paper();
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
    ...
    */
    ...
    exports.PaperTypeListEx = PaperTypeListEx;
});
