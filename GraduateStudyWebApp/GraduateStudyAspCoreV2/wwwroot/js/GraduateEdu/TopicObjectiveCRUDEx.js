(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../GraduateEduTopic/TopicObjective_EditEx.js", "../PagesBase/GraduateEduTopic/TopicObjectiveCRUD.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TopicObjectiveCRUDEx = void 0;
    /**
    * 类名:TopicObjectiveCRUDEx(界面:TopicObjectiveCRUD)
    * 表名:TopicObjective(01120613)
    * 版本:2023.01.09.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/11 17:58:57
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    * 编程语言:TypeScript
    **/
    const TopicObjective_EditEx_js_1 = require("../GraduateEduTopic/TopicObjective_EditEx.js");
    const TopicObjectiveCRUD_js_1 = require("../PagesBase/GraduateEduTopic/TopicObjectiveCRUD.js");
    const clsCommFunc4Ctrl_js_1 = require("../TS/PubFun/clsCommFunc4Ctrl.js");
    const clsString_js_1 = require("../TS/PubFun/clsString.js");
    //import $ from "jquery";
    /** TopicObjectiveCRUDEx 的摘要说明。其中Q代表查询,U代表修改
    * (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    **/
    class TopicObjectiveCRUDEx extends TopicObjectiveCRUD_js_1.TopicObjectiveCRUD {
        //public static mstrListDiv = "divDataLst";
        //public static mstrSortvTopicObjectiveBy = "TopicObjectiveId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (TopicObjectiveCRUD_js_1.TopicObjectiveCRUD.objPage_CRUD == null) {
                TopicObjectiveCRUD_js_1.TopicObjectiveCRUD.objPage_CRUD = new TopicObjectiveCRUDEx();
    ...
    exports.TopicObjectiveCRUDEx = TopicObjectiveCRUDEx;
});
