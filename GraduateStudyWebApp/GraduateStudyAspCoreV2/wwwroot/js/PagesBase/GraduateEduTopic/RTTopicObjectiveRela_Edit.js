(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsRTTopicObjectiveRelaEN.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RTTopicObjectiveRela_Edit = void 0;
    /**
    ...
    **/
    ...
    const clsRTTopicObjectiveRelaWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js");
    const clsRTTopicObjectiveRelaWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js");
    const clsRTTopicObjectiveRelaWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js");
    const clsRTTopicObjectiveRelaWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js");
    const clsRTTopicObjectiveRelaWApi_js_10 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTTopicObjectiveRelaWApi.js");
    ...
    **/
    class RTTopicObjectiveRela_Edit {
        constructor(objShowList) {
            ...
            this.objRTTopicObjectiveRela = new clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_RTTopicObjectiveRela(strOp) {
            const strThisFuncName = this.ShowDialog_RTTopicObjectiveRela.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_RTTopicObjectiveRela");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_RTTopicObjectiveRela");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (RTTopicObjectiveRela_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_RTTopicObjectiveRela;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async PutDataToRTTopicObjectiveRelaClass(pobjRTTopicObjectiveRelaEN) {
            ...
            pobjRTTopicObjectiveRelaEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objRTTopicObjectiveRelaEN = new clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN();
            try {
            ...
            try {
                (0, clsRTTopicObjectiveRelaWApi_js_1.RTTopicObjectiveRela_CheckPropertyNew)(objRTTopicObjectiveRelaEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                returnBool = await (0, clsRTTopicObjectiveRelaWApi_js_2.RTTopicObjectiveRela_AddNewRecordAsync)(objRTTopicObjectiveRelaEN);
                if (returnBool == true) {
                    (0, clsRTTopicObjectiveRelaWApi_js_3.RTTopicObjectiveRela_ReFreshCache)();
        ...
        **/
        async CheckUniCond4Add_mId_TopicId_TopicObjectiveId(objRTTopicObjectiveRelaEN) {
            const strThisFuncName = this.CheckUniCond4Add_mId_TopicId_TopicObjectiveId.name;
            const strUniquenessCondition = (0, clsRTTopicObjectiveRelaWApi_js_4.RTTopicObjectiveRela_GetUniCondStr_mId_TopicId_TopicObjectiveId)(objRTTopicObjectiveRelaEN);
            const bolIsExistCondition = await (0, clsRTTopicObjectiveRelaWApi_js_5.RTTopicObjectiveRela_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_mId_TopicId_TopicObjectiveId(objRTTopicObjectiveRelaEN) {
            const strThisFuncName = this.CheckUniCond4Update_mId_TopicId_TopicObjectiveId.name;
            const strUniquenessCondition = (0, clsRTTopicObjectiveRelaWApi_js_6.RTTopicObjectiveRela_GetUniCondStr4Update_mId_TopicId_TopicObjectiveId)(objRTTopicObjectiveRelaEN);
            const bolIsExistCondition = await (0, clsRTTopicObjectiveRelaWApi_js_5.RTTopicObjectiveRela_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(lngmId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objRTTopicObjectiveRelaEN = new clsRTTopicObjectiveRelaEN_js_1.clsRTTopicObjectiveRelaEN();
            try {
                const returnBool = await (0, clsRTTopicObjectiveRelaWApi_js_7.RTTopicObjectiveRela_IsExistAsync)(lngmId);
                if (returnBool == false) {
            ...
            try {
                const objRTTopicObjectiveRelaEN_Const = await (0, clsRTTopicObjectiveRelaWApi_js_8.RTTopicObjectiveRela_GetObjBymIdAsync)(lngmId);
        ...
        **/
        GetDataFromRTTopicObjectiveRelaClass(pobjRTTopicObjectiveRelaEN) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsRTTopicObjectiveRelaWApi_js_9.RTTopicObjectiveRela_CheckProperty4Update)(objRTTopicObjectiveRelaEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsRTTopicObjectiveRelaWApi_js_10.RTTopicObjectiveRela_UpdateRecordAsync)(objRTTopicObjectiveRelaEN);
                if (returnBool == true) {
                    (0, clsRTTopicObjectiveRelaWApi_js_3.RTTopicObjectiveRela_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_RTTopicObjectiveRela(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_RTTopicObjectiveRela", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_RTTopicObjectiveRela() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_RTTopicObjectiveRela");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_RTTopicObjectiveRela(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_RTTopicObjectiveRela", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
    ...
    exports.RTTopicObjectiveRela_Edit = RTTopicObjectiveRela_Edit;
    RTTopicObjectiveRela_Edit.id_CurrEduCls_Cache = ""; //定义下拉框条件变量1
    RTTopicObjectiveRela_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
