(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsSysSecurityLevelWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsvSysSocialRelationsEN.js", "../../TS/L0_Entity/GraduateEduTopic/clsvSysSocialRelationsENEx.js", "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvSysSocialRelationsExWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsSysSocialRelationsWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsSysSocialRelationsEN.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
    ...
    **/
    ...
    const clsvSysSocialRelationsWApi_js_2 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js");
    const clsvSysSocialRelationsWApi_js_3 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js");
    const clsvSysSocialRelationsWApi_js_4 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js");
    ...
    const clsvSysSocialRelationsENEx_js_1 = require("../../TS/L0_Entity/GraduateEduTopic/clsvSysSocialRelationsENEx.js");
    const clsvSysSocialRelationsExWApi_js_1 = require("../../TS/L3_ForWApiEx/GraduateEduTopic/clsvSysSocialRelationsExWApi.js");
    const clsvSysSocialRelationsWApi_js_5 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js");
    const clsvSysSocialRelationsWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js");
    const clsvSysSocialRelationsWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvSysSocialRelationsWApi.js");
    ...
    **/
    class SysSocialRelationsCRUD {
        ...
        **/
        CombineData(arrvSysSocialRelationsObjLst, arrDataColumn) {
            ...
            for (let i = 0; i < intRowNum; i++) {
                ...
                const objEN = arrvSysSocialRelationsObjLst[i];
                for (let j = 0; j < intColNum; j++) {
            ...
            const strFileName = (0, clsString_js_1.Format)("社会关系表({0})导出.xlsx", clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN._CurrTabName);
            exportSpecialExcel_pyf(arrData, strFileName);
        }
        /** 根据条件获取相应的对象列表
        * (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_ExportExcel)
        **/
        async ExportExcel_vSysSocialRelations() {
            const strThisFuncName = this.ExportExcel_vSysSocialRelations.name;
            if (SysSocialRelationsCRUD.sortvSysSocialRelationsBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvSysSocialRelationsBy)为空，请检查！(In BindGv_vSysSocialRelations_Cache)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            let arrvSysSocialRelationsObjLst = [];
            try {
                ...
                arrvSysSocialRelationsObjLst = await (0, clsvSysSocialRelationsWApi_js_2.vSysSocialRelations_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async ExportExcel_vSysSocialRelations_Cache() {
            ...
            objvSysSocialRelations_Cond.SetCondFldValue(clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_id_CurrEduCls, SysSocialRelationsCRUD.id_CurrEduCls_Cache, "=");
            const strWhereCond = JSON.stringify(objvSysSocialRelations_Cond);
            const intCurrPageIndex = (0, clsOperateList_js_1.GetCurrPageIndex)(this.objPager.currPageIndex); //获取当前页
            let arrvSysSocialRelationsObjLst = [];
            try {
                this.recCount = await (0, clsvSysSocialRelationsWApi_js_3.vSysSocialRelations_GetRecCountByCond_Cache)(objvSysSocialRelations_Cond, SysSocialRelationsCRUD.id_CurrEduCls_Cache);
                if (this.recCount == 0) {
                    const lblMsg = document.createElement("span");
                    lblMsg.innerHTML = (0, clsString_js_1.Format)("根据条件:[{0}]获取的对象列表数为0！", objvSysSocialRelations_Cond.whereCond);
                    const divDataLst = document.getElementById("divDataLst");
                    if (divDataLst != null) {
                        divDataLst.innerText = "";
                        divDataLst.appendChild(lblMsg);
                    }
                    const strMsg = (0, clsString_js_1.Format)("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvSysSocialRelations_Cond.whereCond);
                    console.error("Error: ", strMsg);
                    //console.trace();
                    alert(strMsg);
                    return;
                }
                arrvSysSocialRelationsObjLst = await (0, clsvSysSocialRelationsWApi_js_4.vSysSocialRelations_GetSubObjLst_Cache)(objvSysSocialRelations_Cond, SysSocialRelationsCRUD.id_CurrEduCls_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            if (arrvSysSocialRelationsObjLst.length == 0) {
                const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsSysSocialRelationsEN_js_1.clsSysSocialRelationsEN._CurrTabName, SysSocialRelationsCRUD.id_CurrEduCls_Cache);
        ...
        **/
        async SetDdl_LevelIdInDiv() {
            await (0, clsSysSecurityLevelWApi_js_1.SysSecurityLevel_BindDdl_LevelIdInDiv_Cache)(this.divName4Query, "ddlLevelId_q"); //
        }
        /** 函数功能:为查询区绑定下拉框
        ...
        **/
        async btnSelectRecordInTab_Click(strSocialId) {
        ...
        **/
        async DelRecord(strSocialId) {
            ...
            try {
                const returnInt = await (0, clsSysSocialRelationsWApi_js_1.SysSocialRelations_DelRecordAsync)(strSocialId);
                if (returnInt > 0) {
        ...
        **/
        async SelectRecord(strSocialId) {
            ...
            try {
                const objSysSocialRelationsEN = await (0, clsSysSocialRelationsWApi_js_2.SysSocialRelations_GetObjBySocialIdAsync)(strSocialId);
                //console.log("完成SelectRecord!", objSysSocialRelationsEN);
                (0, clsCommFunc4Web_js_1.Redirect)("/Index/Main_vSysSocialRelations");
            }
            catch (e) {
        ...
        **/
        async CombinevSysSocialRelationsCondition() {
            ...
            try {
                if (this.fullName_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_FullName, this.fullName_q);
                }
                if (this.achievement_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Achievement, this.achievement_q);
                }
                if (this.levelId_q != "" && this.levelId_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_LevelId, this.levelId_q);
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0009)在组合查询条件(CombineSysSocialRelationsCondition)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            return strWhereCond;
        }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombinevSysSocialRelationsConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0010)在组合查询条件对象(CombineSysSocialRelationsConditionObj)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombinevSysSocialRelationsConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineSysSocialRelationsConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            objvSysSocialRelations_Cond.whereCond = strWhereCond;
            return objvSysSocialRelations_Cond;
        ...
        **/
        async BindTab_vSysSocialRelations(divContainer, arrvSysSocialRelationsObjLst) {
            ...
            const arrDataColumn = [
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_FullName,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_FullName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "姓名",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Nationality,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Nationality,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "国籍",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_WorkUnit,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_WorkUnit,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "工作单位",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Major,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Major,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "专业",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Achievement,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_Achievement,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "成就",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_DetailedDescription,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_DetailedDescription,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "详细说明",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_LevelName,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_LevelName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "级别名称",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_UpdUser,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_UpdUser,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改人",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_UpdDate,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_UpdDate,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改日期",
                    text: "",
                ...
                {
                    fldName: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_IsSubmit,
                    sortBy: clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_IsSubmit,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "是否提交",
                    text: "",
            ...
            await (0, clsCommFunc4Web_js_1.BindTab_V)(o, arrvSysSocialRelationsObjLst, arrDataColumn, clsvSysSocialRelationsEN_js_1.clsvSysSocialRelationsEN.con_SocialId, this);
        ...
        **/
        async ExtendFldFuncMap(arrvSysSocialRelationsExObjLst, arrDataColumn) {
            ...
            for (const objDataColumn of arrDataColumn) {
                ...
                for (const objInFor of arrvSysSocialRelationsExObjLst) {
                    await (0, clsvSysSocialRelationsExWApi_js_1.vSysSocialRelationsEx_FuncMapByFldName)(objDataColumn.fldName, objInFor);
                }
            }
        }
        /** 函数功能:在数据列表中跳转到前一页
        ...
        **/
        async BindGv_vSysSocialRelations() {
            ...
            if (SysSocialRelationsCRUD.sortvSysSocialRelationsBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvSysSocialRelationsBy)为空，请检查！(In BindGv_vSysSocialRelations)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                const responseObjLst = await (0, clsvSysSocialRelationsWApi_js_5.vSysSocialRelations_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
        ...
        async BindGv_vSysSocialRelations_Cache() {
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: SysSocialRelationsCRUD.sortvSysSocialRelationsBy,
                    sortFun: clsvSysSocialRelationsWApi_js_6.vSysSocialRelations_SortFun_Defa
                };
                arrvSysSocialRelationsObjLst = await (0, clsvSysSocialRelationsWApi_js_7.vSysSocialRelations_GetObjLstByPager_Cache)(objPagerPara, SysSocialRelationsCRUD.id_CurrEduCls_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SortBy(objAnchorElement) {
            ...
            const { sortFun, ascOrDesc4SortFun, sortBy } = (0, clsOperateList_js_1.GetSortBy)(objAnchorElement, SysSocialRelationsCRUD.ascOrDesc4SortFun, SysSocialRelationsCRUD.sortvSysSocialRelationsBy, strSortExpress);
        ...
        **/
        async CopyRecord(arrSocialId) {
            const strThisFuncName = this.CopyRecord.name;
            try {
                const arrSysSocialRelationsObjLst = await (0, clsSysSocialRelationsWApi_js_3.SysSocialRelations_GetObjLstBySocialIdLstAsync)(arrSocialId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrSysSocialRelationsObjLst) {
                    const strMaxStrId = await (0, clsSysSocialRelationsWApi_js_4.SysSocialRelations_GetMaxStrIdAsync)();
                    //console.log('strMaxStrId=' + strMaxStrId);
                    objInFor.socialId = strMaxStrId;
                    const returnBool = await (0, clsSysSocialRelationsWApi_js_5.SysSocialRelations_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrSocialId) {
            ...
            try {
                const returnInt = await (0, clsSysSocialRelationsWApi_js_6.SysSocialRelations_DelSysSocialRelationssAsync)(arrSocialId);
                if (returnInt > 0) {
                    //SysSocialRelations_ReFreshCache(SysSocialRelationsCRUD.id_CurrEduCls_Cache);
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        ShowSysSocialRelationsObj(divContainer, objSysSocialRelations) {
            ...
            const sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objSysSocialRelations);
        ...
        **/
        get achievement_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Query, "txtAchievement_q");
        ...
        * 成就 (Used In CombineCondition())
        **/
        set achievement_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Query, "txtAchievement_q", value);
        }
        /**
        ...
        **/
        get levelId_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Query, "ddlLevelId_q");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set levelId_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Query, "ddlLevelId_q", value);
        }
        /**
    ...
    SysSocialRelationsCRUD.ascOrDesc4SortFun = "Asc";
    SysSocialRelationsCRUD.sortvSysSocialRelationsBy = "";
    SysSocialRelationsCRUD.id_CurrEduCls_Cache = ""; //缓存分类字段
});
