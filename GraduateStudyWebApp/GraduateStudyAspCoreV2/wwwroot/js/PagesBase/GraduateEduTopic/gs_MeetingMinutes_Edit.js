(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsgs_MeetingMinutesEN.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    **/
    ...
    const clsgs_MeetingMinutesWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js");
    const clsgs_MeetingMinutesWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js");
    const clsgs_MeetingMinutesWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js");
    const clsgs_MeetingMinutesWApi_js_10 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsgs_MeetingMinutesWApi.js");
    ...
    **/
    class gs_MeetingMinutes_Edit {
        constructor(objShowList) {
            ...
            this.objgs_MeetingMinutes = new clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../GraduateEduTopic/gs_MeetingMinutes_Edit";
        ...
        **/
        ShowDialog_gs_MeetingMinutes(strOp) {
            const strThisFuncName = this.ShowDialog_gs_MeetingMinutes.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_gs_MeetingMinutes");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_gs_MeetingMinutes");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                $('#lblDialogTitle_gs_MeetingMinutes').html('添加记录');
                //gs_MeetingMinutes_EditEx.GetMaxStrId('#txtMeetingId');
            }
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (gs_MeetingMinutes_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async BindDdl4EditRegionInDiv() {
            ...
            // 在此处放置用户代码以初始化页面
            const strid_CurrEduCls = gs_MeetingMinutes_Edit.id_CurrEduCls_Static;
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_gs_MeetingMinutes;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsgs_MeetingMinutesWApi_js_1.gs_MeetingMinutes_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表gs_MeetingMinutes的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objgs_MeetingMinutesEN = new clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN();
            try {
            ...
            try {
                (0, clsgs_MeetingMinutesWApi_js_2.gs_MeetingMinutes_CheckPropertyNew)(objgs_MeetingMinutesEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsgs_MeetingMinutesWApi_js_3.gs_MeetingMinutes_AddNewRecordWithMaxIdAsync)(objgs_MeetingMinutesEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
        ...
        **/
        async CheckUniCond4Add_MeetingId(objgs_MeetingMinutesEN) {
            const strThisFuncName = this.CheckUniCond4Add_MeetingId.name;
            const strUniquenessCondition = (0, clsgs_MeetingMinutesWApi_js_4.gs_MeetingMinutes_GetUniCondStr_MeetingId)(objgs_MeetingMinutesEN);
            const bolIsExistCondition = await (0, clsgs_MeetingMinutesWApi_js_5.gs_MeetingMinutes_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_MeetingId(objgs_MeetingMinutesEN) {
            const strThisFuncName = this.CheckUniCond4Update_MeetingId.name;
            const strUniquenessCondition = (0, clsgs_MeetingMinutesWApi_js_6.gs_MeetingMinutes_GetUniCondStr4Update_MeetingId)(objgs_MeetingMinutesEN);
            const bolIsExistCondition = await (0, clsgs_MeetingMinutesWApi_js_5.gs_MeetingMinutes_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsgs_MeetingMinutesWApi_js_3.gs_MeetingMinutes_AddNewRecordWithMaxIdAsync)(objgs_MeetingMinutesEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strMeetingId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objgs_MeetingMinutesEN = new clsgs_MeetingMinutesEN_js_1.clsgs_MeetingMinutesEN();
            try {
                const returnBool = await (0, clsgs_MeetingMinutesWApi_js_7.gs_MeetingMinutes_IsExistAsync)(strMeetingId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strMeetingId);
            ...
            try {
                const objgs_MeetingMinutesEN_Const = await (0, clsgs_MeetingMinutesWApi_js_8.gs_MeetingMinutes_GetObjByMeetingIdAsync)(strMeetingId);
                if (objgs_MeetingMinutesEN_Const == null) {
                    const strMsg = (0, clsString_js_1.Format)("根据关键字获取相应的记录的对象为空.(in {0}.{1})", this.constructor.name, strThisFuncName);
                    console.error(strMsg);
                    alert(strMsg);
                    return;
                }
                objgs_MeetingMinutesEN = objgs_MeetingMinutesEN_Const;
            }
            catch (e) {
        ...
        **/
        async UpdateRecord(strMeetingId) {
            ...
            try {
                ...
                this.objgs_MeetingMinutes = objgs_MeetingMinutesEN_Const;
                const conGetDataFromClass = await this.GetDataFromgs_MeetingMinutesClass(objgs_MeetingMinutesEN_Const);
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsgs_MeetingMinutesWApi_js_9.gs_MeetingMinutes_CheckProperty4Update)(objgs_MeetingMinutesEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsgs_MeetingMinutesWApi_js_10.gs_MeetingMinutes_UpdateRecordAsync)(objgs_MeetingMinutesEN);
                if (returnBool == true) {
                    //gs_MeetingMinutes_ReFreshCache();
                }
                return returnBool;
        ...
        **/
        set btnCancel_gs_MeetingMinutes(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_gs_MeetingMinutes", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_gs_MeetingMinutes() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_gs_MeetingMinutes");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_gs_MeetingMinutes(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_gs_MeetingMinutes", value);
        }
        /**
        * 是否提交 (Used In Clear())
        **/
        ...
        **/
        set meetingContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetTextAreaValueByIdInDiv)(this.divName4Edit, "txtMeetingContent", value);
        }
        /**
        * 会议内容 (Used In PutDataToClass())
        **/
        get meetingContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetTextAreaValueInDiv)(this.divName4Edit, "txtMeetingContent");
        ...
        **/
        set meetingDate(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMeetingDate", value);
        }
        /**
        * 会议日期 (Used In PutDataToClass())
        **/
        get meetingDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMeetingDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set meetingId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMeetingId", value);
        }
        /**
        * 会议Id (Used In PutDataToClass())
        **/
        get meetingId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMeetingId");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    gs_MeetingMinutes_Edit.id_CurrEduCls_Static = ""; //定义下拉框条件变量1
    gs_MeetingMinutes_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
