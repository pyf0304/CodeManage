(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/PubFun/clsPublocalStorage.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsgs_ReflectLogEN.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    **/
    class gs_ReflectLog_Edit {
        constructor(objShowList) {
            ...
            this.objgs_ReflectLog = new clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_gs_ReflectLog(strOp) {
            const strThisFuncName = this.ShowDialog_gs_ReflectLog.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_gs_ReflectLog");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_gs_ReflectLog");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (gs_ReflectLog_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_gs_ReflectLog;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async PutDataTogs_ReflectLogClass(pobjgs_ReflectLogEN) {
            ...
            pobjgs_ReflectLogEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
        }
        /** 添加新记录，保存函数
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objgs_ReflectLogEN = new clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN();
            try {
            ...
            try {
                (0, clsgs_ReflectLogWApi_js_1.gs_ReflectLog_CheckPropertyNew)(objgs_ReflectLogEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                returnBool = await (0, clsgs_ReflectLogWApi_js_2.gs_ReflectLog_AddNewRecordAsync)(objgs_ReflectLogEN);
                if (returnBool == true) {
                    (0, clsgs_ReflectLogWApi_js_3.gs_ReflectLog_ReFreshCache)();
        ...
        **/
        async CheckUniCond4Add_mId(objgs_ReflectLogEN) {
            const strThisFuncName = this.CheckUniCond4Add_mId.name;
            const strUniquenessCondition = (0, clsgs_ReflectLogWApi_js_4.gs_ReflectLog_GetUniCondStr_mId)(objgs_ReflectLogEN);
            const bolIsExistCondition = await (0, clsgs_ReflectLogWApi_js_5.gs_ReflectLog_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_mId(objgs_ReflectLogEN) {
            const strThisFuncName = this.CheckUniCond4Update_mId.name;
            const strUniquenessCondition = (0, clsgs_ReflectLogWApi_js_6.gs_ReflectLog_GetUniCondStr4Update_mId)(objgs_ReflectLogEN);
            const bolIsExistCondition = await (0, clsgs_ReflectLogWApi_js_5.gs_ReflectLog_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(lngmId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objgs_ReflectLogEN = new clsgs_ReflectLogEN_js_1.clsgs_ReflectLogEN();
            try {
                const returnBool = await (0, clsgs_ReflectLogWApi_js_7.gs_ReflectLog_IsExistAsync)(lngmId);
                if (returnBool == false) {
            ...
            try {
                const objgs_ReflectLogEN_Const = await (0, clsgs_ReflectLogWApi_js_8.gs_ReflectLog_GetObjBymIdAsync)(lngmId);
        ...
        **/
        async GetDataFromgs_ReflectLogClass(pobjgs_ReflectLogEN) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsgs_ReflectLogWApi_js_9.gs_ReflectLog_CheckProperty4Update)(objgs_ReflectLogEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsgs_ReflectLogWApi_js_10.gs_ReflectLog_UpdateRecordAsync)(objgs_ReflectLogEN);
                if (returnBool == true) {
                    (0, clsgs_ReflectLogWApi_js_3.gs_ReflectLog_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_gs_ReflectLog(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_gs_ReflectLog", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_gs_ReflectLog() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_gs_ReflectLog");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_gs_ReflectLog(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_gs_ReflectLog", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
        ...
        **/
        set reflectLogContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetTextAreaValueByIdInDiv)(this.divName4Edit, "txtReflectLogContent", value);
        }
        /**
        * 内容 (Used In PutDataToClass())
        **/
        get reflectLogContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetTextAreaValueInDiv)(this.divName4Edit, "txtReflectLogContent");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set reflectLogName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtReflectLogName", value);
        }
        /**
        * 标题 (Used In PutDataToClass())
        **/
        get reflectLogName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtReflectLogName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    gs_ReflectLog_Edit.id_CurrEduCls_Static = "";
    gs_ReflectLog_Edit.TopicId_Static = "";
    gs_ReflectLog_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
