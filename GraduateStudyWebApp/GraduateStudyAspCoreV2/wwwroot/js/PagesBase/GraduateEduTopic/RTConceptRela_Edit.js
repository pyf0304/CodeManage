(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsRTConceptRelaEN.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RTConceptRela_Edit = void 0;
    /**
    ...
    **/
    ...
    const clsRTConceptRelaWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js");
    const clsRTConceptRelaWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js");
    const clsRTConceptRelaWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js");
    const clsRTConceptRelaWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsRTConceptRelaWApi.js");
    ...
    **/
    class RTConceptRela_Edit {
        constructor(objShowList) {
            ...
            this.objRTConceptRela = new clsRTConceptRelaEN_js_1.clsRTConceptRelaEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_RTConceptRela(strOp) {
            const strThisFuncName = this.ShowDialog_RTConceptRela.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_RTConceptRela");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_RTConceptRela");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (RTConceptRela_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_RTConceptRela;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsRTConceptRelaEN_js_1.clsRTConceptRelaEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async PutDataToRTConceptRelaClass(pobjRTConceptRelaEN) {
            ...
            pobjRTConceptRelaEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objRTConceptRelaEN = new clsRTConceptRelaEN_js_1.clsRTConceptRelaEN();
            try {
            ...
            try {
                (0, clsRTConceptRelaWApi_js_1.RTConceptRela_CheckPropertyNew)(objRTConceptRelaEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                returnBool = await (0, clsRTConceptRelaWApi_js_2.RTConceptRela_AddNewRecordAsync)(objRTConceptRelaEN);
                if (returnBool == true) {
        ...
        **/
        async CheckUniCond4Add_mId_TopicId_ConceptId(objRTConceptRelaEN) {
            const strThisFuncName = this.CheckUniCond4Add_mId_TopicId_ConceptId.name;
            const strUniquenessCondition = (0, clsRTConceptRelaWApi_js_3.RTConceptRela_GetUniCondStr_mId_TopicId_ConceptId)(objRTConceptRelaEN);
            const bolIsExistCondition = await (0, clsRTConceptRelaWApi_js_4.RTConceptRela_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_mId_TopicId_ConceptId(objRTConceptRelaEN) {
            const strThisFuncName = this.CheckUniCond4Update_mId_TopicId_ConceptId.name;
            const strUniquenessCondition = (0, clsRTConceptRelaWApi_js_5.RTConceptRela_GetUniCondStr4Update_mId_TopicId_ConceptId)(objRTConceptRelaEN);
            const bolIsExistCondition = await (0, clsRTConceptRelaWApi_js_4.RTConceptRela_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(lngmId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objRTConceptRelaEN = new clsRTConceptRelaEN_js_1.clsRTConceptRelaEN();
            try {
                const returnBool = await (0, clsRTConceptRelaWApi_js_6.RTConceptRela_IsExistAsync)(lngmId);
                if (returnBool == false) {
            ...
            try {
                const objRTConceptRelaEN_Const = await (0, clsRTConceptRelaWApi_js_7.RTConceptRela_GetObjBymIdAsync)(lngmId);
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsRTConceptRelaWApi_js_8.RTConceptRela_CheckProperty4Update)(objRTConceptRelaEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsRTConceptRelaWApi_js_9.RTConceptRela_UpdateRecordAsync)(objRTConceptRelaEN);
                if (returnBool == true) {
                    //RTConceptRela_ReFreshCache();
                }
                return returnBool;
        ...
        **/
        set btnCancel_RTConceptRela(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_RTConceptRela", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_RTConceptRela() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_RTConceptRela");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_RTConceptRela(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_RTConceptRela", value);
        }
        /**
        * 概念Id (Used In Clear())
        **/
        set conceptId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtConceptId", value);
        }
        /**
        * 概念Id (Used In PutDataToClass())
        **/
        get conceptId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtConceptId");
    ...
    exports.RTConceptRela_Edit = RTConceptRela_Edit;
    RTConceptRela_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
