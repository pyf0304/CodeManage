(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsgs_TeacherTaskEN.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gs_TeacherTask_Edit = void 0;
    /**
    ...
    **/
    class gs_TeacherTask_Edit {
        constructor(objShowList) {
            ...
            this.objgs_TeacherTask = new clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_gs_TeacherTask(strOp) {
            const strThisFuncName = this.ShowDialog_gs_TeacherTask.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_gs_TeacherTask");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_gs_TeacherTask");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (gs_TeacherTask_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_gs_TeacherTask;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async PutDataTogs_TeacherTaskClass(pobjgs_TeacherTaskEN) {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objgs_TeacherTaskEN = new clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN();
            try {
            ...
            try {
                (0, clsgs_TeacherTaskWApi_js_1.gs_TeacherTask_CheckPropertyNew)(objgs_TeacherTaskEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                returnBool = await (0, clsgs_TeacherTaskWApi_js_2.gs_TeacherTask_AddNewRecordAsync)(objgs_TeacherTaskEN);
                if (returnBool == true) {
                    (0, clsgs_TeacherTaskWApi_js_3.gs_TeacherTask_ReFreshCache)();
        ...
        **/
        async CheckUniCond4Add_mId(objgs_TeacherTaskEN) {
            const strThisFuncName = this.CheckUniCond4Add_mId.name;
            const strUniquenessCondition = (0, clsgs_TeacherTaskWApi_js_4.gs_TeacherTask_GetUniCondStr_mId)(objgs_TeacherTaskEN);
            const bolIsExistCondition = await (0, clsgs_TeacherTaskWApi_js_5.gs_TeacherTask_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_mId(objgs_TeacherTaskEN) {
            const strThisFuncName = this.CheckUniCond4Update_mId.name;
            const strUniquenessCondition = (0, clsgs_TeacherTaskWApi_js_6.gs_TeacherTask_GetUniCondStr4Update_mId)(objgs_TeacherTaskEN);
            const bolIsExistCondition = await (0, clsgs_TeacherTaskWApi_js_5.gs_TeacherTask_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(lngmId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objgs_TeacherTaskEN = new clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN();
            try {
                const returnBool = await (0, clsgs_TeacherTaskWApi_js_7.gs_TeacherTask_IsExistAsync)(lngmId);
                if (returnBool == false) {
            ...
            try {
                const objgs_TeacherTaskEN_Const = await (0, clsgs_TeacherTaskWApi_js_8.gs_TeacherTask_GetObjBymIdAsync)(lngmId);
        ...
        **/
        async GetDataFromgs_TeacherTaskClass(pobjgs_TeacherTaskEN) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsgs_TeacherTaskWApi_js_9.gs_TeacherTask_CheckProperty4Update)(objgs_TeacherTaskEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsgs_TeacherTaskWApi_js_10.gs_TeacherTask_UpdateRecordAsync)(objgs_TeacherTaskEN);
                if (returnBool == true) {
                    (0, clsgs_TeacherTaskWApi_js_3.gs_TeacherTask_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_gs_TeacherTask(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_gs_TeacherTask", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_gs_TeacherTask() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_gs_TeacherTask");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_gs_TeacherTask(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_gs_TeacherTask", value);
        }
        /**
        ...
        **/
        set missionRequirement(value) {
            (0, clsCommFunc4Ctrl_js_1.SetTextAreaValueByIdInDiv)(this.divName4Edit, "txtMissionRequirement", value);
        }
        /**
        * 任务要求 (Used In PutDataToClass())
        **/
        get missionRequirement() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetTextAreaValueInDiv)(this.divName4Edit, "txtMissionRequirement");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set missionStatement(value) {
            (0, clsCommFunc4Ctrl_js_1.SetTextAreaValueByIdInDiv)(this.divName4Edit, "txtMissionStatement", value);
        }
        /**
        * 任务说明 (Used In PutDataToClass())
        **/
        get missionStatement() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetTextAreaValueInDiv)(this.divName4Edit, "txtMissionStatement");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    exports.gs_TeacherTask_Edit = gs_TeacherTask_Edit;
    gs_TeacherTask_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
