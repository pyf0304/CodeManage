(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzMajorWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsvRTUserRelaEN.js", "../../TS/L0_Entity/GraduateEduTopic/clsvRTUserRelaENEx.js", "../../TS/L3_ForWApiEx/GraduateEduTopic/clsvRTUserRelaExWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsRTUserRelaWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsRTUserRelaEN.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
    ...
    **/
    ...
    const clsvRTUserRelaWApi_js_2 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js");
    const clsvRTUserRelaWApi_js_3 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js");
    const clsvRTUserRelaWApi_js_4 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js");
    ...
    const clsvRTUserRelaWApi_js_5 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js");
    const clsvRTUserRelaWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js");
    const clsvRTUserRelaWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js");
    ...
    **/
    class RTUserRelaCRUD {
        ...
        **/
        async Page_Load() {
            ...
            try {
                ...
                RTUserRelaCRUD.sortvRTUserRelaBy = "updDate Asc";
        ...
        **/
        CombineData(arrvRTUserRelaObjLst, arrDataColumn) {
            ...
            for (let i = 0; i < intRowNum; i++) {
                ...
                const objEN = arrvRTUserRelaObjLst[i];
                for (let j = 0; j < intColNum; j++) {
            ...
            const strFileName = (0, clsString_js_1.Format)("主题用户关系({0})导出.xlsx", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN._CurrTabName);
        ...
        **/
        async ExportExcel_vRTUserRela() {
            const strThisFuncName = this.ExportExcel_vRTUserRela.name;
            if (RTUserRelaCRUD.sortvRTUserRelaBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvRTUserRelaBy)为空，请检查！(In BindGv_vRTUserRela_Cache)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                arrvRTUserRelaObjLst = await (0, clsvRTUserRelaWApi_js_2.vRTUserRela_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async ExportExcel_vRTUserRela_Cache() {
            const strThisFuncName = this.ExportExcel_vRTUserRela_Cache.name;
            if (RTUserRelaCRUD.sortvRTUserRelaBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvRTUserRelaBy)为空，请检查！(In BindGv_vRTUserRela_Cache)");
                console.error(strMsg);
                alert(strMsg);
            ...
            const strListDiv = this.divName4DataList;
            const objvRTUserRela_Cond = await this.CombinevRTUserRelaConditionObj4ExportExcel();
            objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicId, RTUserRelaCRUD.TopicId_Cache, "=");
            const strWhereCond = JSON.stringify(objvRTUserRela_Cond);
            const intCurrPageIndex = (0, clsOperateList_js_1.GetCurrPageIndex)(this.objPager.currPageIndex); //获取当前页
            let arrvRTUserRelaObjLst = [];
            try {
                this.recCount = await (0, clsvRTUserRelaWApi_js_3.vRTUserRela_GetRecCountByCond_Cache)(objvRTUserRela_Cond, RTUserRelaCRUD.TopicId_Cache);
                if (this.recCount == 0) {
                    const lblMsg = document.createElement("span");
                    lblMsg.innerHTML = (0, clsString_js_1.Format)("根据条件:[{0}]获取的对象列表数为0！", objvRTUserRela_Cond.whereCond);
                    const divDataLst = document.getElementById("divDataLst");
                    if (divDataLst != null) {
                        divDataLst.innerText = "";
                        divDataLst.appendChild(lblMsg);
                    }
                    const strMsg = (0, clsString_js_1.Format)("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvRTUserRela_Cond.whereCond);
                    console.error("Error: ", strMsg);
                    //console.trace();
                    alert(strMsg);
                    return;
                }
                arrvRTUserRelaObjLst = await (0, clsvRTUserRelaWApi_js_4.vRTUserRela_GetSubObjLst_Cache)(objvRTUserRela_Cond, RTUserRelaCRUD.TopicId_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            if (arrvRTUserRelaObjLst.length == 0) {
                const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsRTUserRelaEN_js_1.clsRTUserRelaEN._CurrTabName, RTUserRelaCRUD.TopicId_Cache);
        ...
        **/
        async DelRecord(lngmId) {
            ...
            try {
                const returnInt = await (0, clsRTUserRelaWApi_js_1.RTUserRela_DelRecordAsync)(lngmId);
                if (returnInt > 0) {
                    //RTUserRela_ReFreshCache(RTUserRelaCRUD.TopicId_Cache);
        ...
        **/
        async SelectRecord(lngmId) {
            ...
            try {
                const objRTUserRelaEN = await (0, clsRTUserRelaWApi_js_2.RTUserRela_GetObjBymIdAsync)(lngmId);
                //console.log("完成SelectRecord!", objRTUserRelaEN);
                (0, clsCommFunc4Web_js_1.Redirect)("/Index/Main_vRTUserRela");
            }
            catch (e) {
        ...
        **/
        async CombinevRTUserRelaCondition() {
            ...
            try {
                if (this.userId_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UserId, this.userId_q);
                }
                if (this.topicName_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicName, this.topicName_q);
                }
                if (this.id_XzCollege_q != "" && this.id_XzCollege_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_id_XzCollege, this.id_XzCollege_q);
                }
                if (this.id_XzMajor_q != "" && this.id_XzMajor_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_id_XzMajor, this.id_XzMajor_q);
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0009)在组合查询条件(CombineRTUserRelaCondition)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            return strWhereCond;
        }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombinevRTUserRelaConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                if (this.userId_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UserId, this.userId_q);
                    objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UserId, this.userId_q, "like");
                }
                if (this.topicName_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicName, this.topicName_q);
                    objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicName, this.topicName_q, "like");
                }
                if (this.id_XzCollege_q != "" && this.id_XzCollege_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_id_XzCollege, this.id_XzCollege_q);
                    objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_id_XzCollege, this.id_XzCollege_q, "=");
                }
                if (this.id_XzMajor_q != "" && this.id_XzMajor_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_id_XzMajor, this.id_XzMajor_q);
                    objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_id_XzMajor, this.id_XzMajor_q, "=");
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0010)在组合查询条件对象(CombineRTUserRelaConditionObj)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombinevRTUserRelaConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineRTUserRelaConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            objvRTUserRela_Cond.whereCond = strWhereCond;
            return objvRTUserRela_Cond;
        ...
        **/
        async BindTab_vRTUserRela(divContainer, arrvRTUserRelaObjLst) {
            ...
            const arrDataColumn = [
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicName,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "栏目主题",
                    text: "",
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UserName,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UserName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "用户名",
                    text: "",
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_CollegeName,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_CollegeName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "学院名称",
                    text: "",
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_MajorName,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_MajorName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "专业名称",
                    text: "",
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicProposePeople,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicProposePeople,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "主题提出人",
                    text: "",
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UpdUser,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UpdUser,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改人",
                    text: "",
                ...
                {
                    fldName: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UpdDate,
                    sortBy: clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_UpdDate,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改日期",
                    text: "",
            ...
            await (0, clsCommFunc4Web_js_1.BindTab_V)(o, arrvRTUserRelaObjLst, arrDataColumn, clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_mId, this);
        ...
        **/
        async ExtendFldFuncMap(arrvRTUserRelaExObjLst, arrDataColumn) {
            ...
            for (const objDataColumn of arrDataColumn) {
                ...
                for (const objInFor of arrvRTUserRelaExObjLst) {
                    await (0, clsvRTUserRelaExWApi_js_1.vRTUserRelaEx_FuncMapByFldName)(objDataColumn.fldName, objInFor);
                }
            }
        }
        /** 函数功能:在数据列表中跳转到前一页
        ...
        **/
        async BindGv_vRTUserRela() {
            const strThisFuncName = this.BindGv_vRTUserRela.name;
            if (RTUserRelaCRUD.sortvRTUserRelaBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvRTUserRelaBy)为空，请检查！(In BindGv_vRTUserRela)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                const responseObjLst = await (0, clsvRTUserRelaWApi_js_5.vRTUserRela_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
            ...
            try {
                await this.BindTab_vRTUserRela(strListDiv, arrvRTUserRelaObjLst);
                //console.log("完成BindGv_vRTUserRela!");
            }
            catch (e) {
                //console.trace();
        ...
        **/
        async BindGv_vRTUserRela_Cache() {
            const strThisFuncName = this.BindGv_vRTUserRela_Cache.name;
            if (RTUserRelaCRUD.sortvRTUserRelaBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvRTUserRelaBy)为空，请检查！(In BindGv_vRTUserRela_Cache)");
                console.error(strMsg);
                alert(strMsg);
            ...
            const strListDiv = this.divName4DataList;
            const objvRTUserRela_Cond = await this.CombinevRTUserRelaConditionObj();
            objvRTUserRela_Cond.SetCondFldValue(clsvRTUserRelaEN_js_1.clsvRTUserRelaEN.con_TopicId, RTUserRelaCRUD.TopicId_Cache, "=");
            const strWhereCond = JSON.stringify(objvRTUserRela_Cond);
            let intCurrPageIndex = (0, clsOperateList_js_1.GetCurrPageIndex)(this.objPager.currPageIndex); //获取当前页
            let arrvRTUserRelaObjLst = [];
            try {
                ...
                const objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: RTUserRelaCRUD.sortvRTUserRelaBy,
                    sortFun: clsvRTUserRelaWApi_js_6.vRTUserRela_SortFun_Defa
                };
                arrvRTUserRelaObjLst = await (0, clsvRTUserRelaWApi_js_7.vRTUserRela_GetObjLstByPager_Cache)(objPagerPara, RTUserRelaCRUD.TopicId_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SortBy(objAnchorElement) {
            ...
            const { sortFun, ascOrDesc4SortFun, sortBy } = (0, clsOperateList_js_1.GetSortBy)(objAnchorElement, RTUserRelaCRUD.ascOrDesc4SortFun, RTUserRelaCRUD.sortvRTUserRelaBy, strSortExpress);
            RTUserRelaCRUD.sortvRTUserRelaBy = sortBy;
            RTUserRelaCRUD.ascOrDesc4SortFun = ascOrDesc4SortFun;
            RTUserRelaCRUD.sortFun_Static = sortFun;
            await this.BindGv_vRTUserRela();
        }
        /** 复制记录
        ...
        **/
        async CopyRecord(arrmId) {
            ...
            try {
                const arrRTUserRelaObjLst = await (0, clsRTUserRelaWApi_js_3.RTUserRela_GetObjLstBymIdLstAsync)(arrmId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrRTUserRelaObjLst) {
                    const returnBool = await (0, clsRTUserRelaWApi_js_4.RTUserRela_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrmId) {
            ...
            try {
                const returnInt = await (0, clsRTUserRelaWApi_js_5.RTUserRela_DelRTUserRelasAsync)(arrmId);
                if (returnInt > 0) {
                    //RTUserRela_ReFreshCache(RTUserRelaCRUD.TopicId_Cache);
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        ShowRTUserRelaObj(divContainer, objRTUserRela) {
            const strThisFuncName = this.ShowRTUserRelaObj.name;
            const o = document.getElementById(divContainer);
            if (o == null) {
                alert((0, clsString_js_1.Format)("{}不存在！", divContainer));
                return;
            }
            const sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objRTUserRela);
    ...
    RTUserRelaCRUD.ascOrDesc4SortFun = "Asc";
    RTUserRelaCRUD.sortvRTUserRelaBy = "";
    RTUserRelaCRUD.TopicId_Cache = ""; //缓存分类字段
});
