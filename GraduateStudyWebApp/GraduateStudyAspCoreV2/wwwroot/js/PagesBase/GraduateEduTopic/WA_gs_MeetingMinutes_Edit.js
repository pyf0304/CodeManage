(function (factory) {
    ...
    exports.WA_gs_MeetingMinutes_Edit = void 0;
    /**
    ...
    **/
    class WA_gs_MeetingMinutes_Edit {
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (WA_gs_MeetingMinutes_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async SetDdl_TopicIdInDiv(strid_CurrEduCls) {
            //定义条件字段
            await (0, clsResearchTopicWApi_js_1.ResearchTopic_BindDdl_TopicIdInDiv_Cache)(this.divName4Edit, "ddlTopicId", strid_CurrEduCls); //编辑区域
        }
        /** 函数功能:为编辑区绑定下拉框
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsvgs_MeetingMinutesEN_js_1.clsvgs_MeetingMinutesEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsvgs_MeetingMinutesEN_js_1.clsvgs_MeetingMinutesEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strMeetingId) {
            ...
            try {
                objgs_MeetingMinutesEN = await (0, clsgs_MeetingMinutesWApi_js_8.gs_MeetingMinutes_GetObjByMeetingIdAsync)(strMeetingId);
            }
            catch (e) {
        ...
        **/
        async UpdateRecord(strMeetingId) {
            ...
            try {
                const objgs_MeetingMinutesEN = await (0, clsgs_MeetingMinutesWApi_js_8.gs_MeetingMinutes_GetObjByMeetingIdAsync)(strMeetingId);
        ...
        **/
        set meetingContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMeetingContent", value);
        }
        /**
        * 会议内容 (Used In PutDataToClass())
        **/
        get meetingContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMeetingContent");
    ...
    exports.WA_gs_MeetingMinutes_Edit = WA_gs_MeetingMinutes_Edit;
    WA_gs_MeetingMinutes_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
