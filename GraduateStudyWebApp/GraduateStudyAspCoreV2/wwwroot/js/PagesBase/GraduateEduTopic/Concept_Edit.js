(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L0_Entity/GraduateEduTopic/clsConceptEN.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/L3_ForWApi/GraduateEduTopic/clsConceptWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Concept_Edit = void 0;
    /**
    ...
    **/
    class Concept_Edit {
        constructor(objShowList) {
            ...
            this.objConcept = new clsConceptEN_js_1.clsConceptEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_Concept(strOp) {
            const strThisFuncName = this.ShowDialog_Concept.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_Concept");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_Concept");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (Concept_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_Concept;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv_Cache(clsConceptEN_js_1.clsConceptEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsConceptWApi_js_1.Concept_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表Concept的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objConceptEN = new clsConceptEN_js_1.clsConceptEN();
            try {
            ...
            try {
                (0, clsConceptWApi_js_2.Concept_CheckPropertyNew)(objConceptEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsConceptWApi_js_3.Concept_AddNewRecordWithMaxIdAsync)(objConceptEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
                    (0, clsConceptWApi_js_4.Concept_ReFreshCache)(Concept_Edit.id_CurrEduCls_Cache);
        ...
        **/
        async CheckUniCond4Add_id_CurrEduCls_ConceptName(objConceptEN) {
            const strThisFuncName = this.CheckUniCond4Add_id_CurrEduCls_ConceptName.name;
            const strUniquenessCondition = (0, clsConceptWApi_js_5.Concept_GetUniCondStr_id_CurrEduCls_ConceptName)(objConceptEN);
            const bolIsExistCondition = await (0, clsConceptWApi_js_6.Concept_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_id_CurrEduCls_ConceptName(objConceptEN) {
            const strThisFuncName = this.CheckUniCond4Update_id_CurrEduCls_ConceptName.name;
            const strUniquenessCondition = (0, clsConceptWApi_js_7.Concept_GetUniCondStr4Update_id_CurrEduCls_ConceptName)(objConceptEN);
            const bolIsExistCondition = await (0, clsConceptWApi_js_6.Concept_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsConceptWApi_js_3.Concept_AddNewRecordWithMaxIdAsync)(objConceptEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strConceptId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objConceptEN = new clsConceptEN_js_1.clsConceptEN();
            try {
                const returnBool = await (0, clsConceptWApi_js_8.Concept_IsExistAsync)(strConceptId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strConceptId);
            ...
            try {
                const objConceptEN_Const = await (0, clsConceptWApi_js_9.Concept_GetObjByConceptIdAsync)(strConceptId);
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsConceptWApi_js_10.Concept_CheckProperty4Update)(objConceptEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsConceptWApi_js_11.Concept_UpdateRecordAsync)(objConceptEN);
                if (returnBool == true) {
                    (0, clsConceptWApi_js_4.Concept_ReFreshCache)(Concept_Edit.id_CurrEduCls_Cache);
                }
                return returnBool;
        ...
        **/
        set btnCancel_Concept(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_Concept", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_Concept() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_Concept");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_Concept(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_Concept", value);
        }
        /**
        * 概念内容 (Used In Clear())
        **/
        set conceptContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtConceptContent", value);
        }
        /**
        * 概念内容 (Used In PutDataToClass())
        **/
        get conceptContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtConceptContent");
        ...
        **/
        set conceptName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtConceptName", value);
        }
        /**
        * 概念名称 (Used In PutDataToClass())
        **/
        get conceptName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtConceptName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    exports.Concept_Edit = Concept_Edit;
    Concept_Edit.id_CurrEduCls_Cache = "";
    Concept_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
