(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/SysPara/clsXzGradeBaseWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzMajorWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUserIdentityWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L0_Entity/UserManage_Share/clsUsersEN.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../TS/PubFun/clsPublocalStorage.js"], factory);
    }
    ...
    class Users_Edit3 {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../UserManage/Users_Edit3";
        ...
        **/
        ShowDialog_Users(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_Users");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_Users");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                $('#lblDialogTitle_Users').html('添加记录');
                //Users_Edit3Ex.GetMaxStrId('#txtUserId');
            }
            else if (strOp === "Update") {
                $('#lblDialogTitle_Users').html('修改记录');
            }
            else if (strOp === "Detail") {
                $('#btnSubmit_Users').hide();
                $('#lblDialogTitle_Users').html('详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        set btnCancel_Users(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_Users", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_Users() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_Users");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_Users(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_Users", value);
        }
        /**
        * 电子邮箱 (Used In Clear())
        **/
        ...
        **/
        set isRegister(value) {
            (0, clsCommFunc4Ctrl_js_1.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsRegister", value);
        }
        /**
        * IsRegister (Used In PutDataToClass())
        **/
        get isRegister() {
            const bolValue = (0, clsCommFunc4Ctrl_js_1.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsRegister");
            return bolValue;
        }
        /**
        * 备注 (Used In Clear())
        ...
        **/
        set mobilePhone(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMobilePhone", value);
        }
        /**
        * 手机 (Used In PutDataToClass())
        **/
        get mobilePhone() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMobilePhone");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set openId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtOpenId", value);
        }
        /**
        * 微信OpenId (Used In PutDataToClass())
        **/
        get openId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtOpenId");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set registerDate(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtRegisterDate", value);
        }
        /**
        * RegisterDate (Used In PutDataToClass())
        **/
        get registerDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtRegisterDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set stuIdTeacherId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtStuIdTeacherId", value);
        }
        /**
        * 学工号 (Used In PutDataToClass())
        **/
        get stuIdTeacherId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtStuIdTeacherId");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
