    ...
    class StudentInfo_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../UserManage/StudentInfo_Edit";
        ...
        **/
        ShowDialog_StudentInfo(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_StudentInfo");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_StudentInfo");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                $('#lblDialogTitle_StudentInfo').html('添加记录');
                //StudentInfo_EditEx.GetMaxStrId('#txtid_StudentInfo');
            }
            else if (strOp === "Update") {
                $('#lblDialogTitle_StudentInfo').html('修改记录');
            }
            else if (strOp === "Detail") {
                $('#btnSubmit_StudentInfo').hide();
                $('#lblDialogTitle_StudentInfo').html('详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        GetDataFromStudentInfoClass(pobjStudentInfoEN) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            const objStudentInfoEN = new clsStudentInfoEN_js_1.clsStudentInfoEN();
            objStudentInfoEN.id_StudentInfo = this.keyId;
            await this.PutDataToStudentInfoClass(objStudentInfoEN);
        ...
        **/
        set birthday(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtBirthday", value);
        }
        /**
        * 出生日期 (Used In PutDataToClass())
        **/
        get birthday() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtBirthday");
        ...
        **/
        set btnCancel_StudentInfo(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_StudentInfo", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_StudentInfo() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_StudentInfo");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_StudentInfo(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_StudentInfo", value);
        }
        /**
        * 卡号 (Used In Clear())
        **/
        ...
        **/
        set duty(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtDuty", value);
        }
        /**
        * 职位 (Used In PutDataToClass())
        **/
        get duty() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtDuty");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set enrollmentDate(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtEnrollmentDate", value);
        }
        /**
        * 入校日期 (Used In PutDataToClass())
        **/
        get enrollmentDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtEnrollmentDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set headphoto(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtHeadphoto", value);
        }
        /**
        * Headphoto (Used In PutDataToClass())
        **/
        get headphoto() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtHeadphoto");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set homePhone(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtHomePhone", value);
        }
        /**
        * 住宅电话 (Used In PutDataToClass())
        **/
        get homePhone() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtHomePhone");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_AdminCls(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlid_AdminCls", value);
        }
        /**
        * 行政班流水号 (Used In PutDataToClass())
        **/
        get id_AdminCls() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Edit, "ddlid_AdminCls");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set id_CardNo(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtId_CardNo", value);
        }
        /**
        * 内卡号 (Used In PutDataToClass())
        **/
        get id_CardNo() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtId_CardNo");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_Ethnic(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_Ethnic", value);
        }
        /**
        * 民族流水号 (Used In PutDataToClass())
        **/
        get id_Ethnic() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtid_Ethnic");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_Politics(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_Politics", value);
        }
        /**
        * 政治面貌流水号 (Used In PutDataToClass())
        **/
        get id_Politics() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtid_Politics");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_Sex(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_Sex", value);
        }
        /**
        * 性别流水号 (Used In PutDataToClass())
        **/
        get id_Sex() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtid_Sex");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_StudentInfo(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_StudentInfo", value);
        }
        /**
        * 学生流水号 (Used In PutDataToClass())
        **/
        get id_StudentInfo() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtid_StudentInfo");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_StuType(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlid_StuType", value);
        }
        /**
        * 学生类别流水号 (Used In PutDataToClass())
        **/
        get id_StuType() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Edit, "ddlid_StuType");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set id_UniZone(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_UniZone", value);
        }
        /**
        * 校区流水号 (Used In PutDataToClass())
        **/
        get id_UniZone() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtid_UniZone");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set idCardNo(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtIDCardNo", value);
        }
        /**
        * 身份证号 (Used In PutDataToClass())
        **/
        get idCardNo() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtIDCardNo");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set isAvconClassUser(value) {
            (0, clsCommFunc4Ctrl_js_1.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsAvconClassUser", value);
        }
        /**
        * IsAvconClassUser (Used In PutDataToClass())
        **/
        get isAvconClassUser() {
            const bolValue = (0, clsCommFunc4Ctrl_js_1.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsAvconClassUser");
            return bolValue;
        }
        /**
        ...
        **/
        set isAvconUser(value) {
            (0, clsCommFunc4Ctrl_js_1.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsAvconUser", value);
        }
        /**
        * IsAvconUser (Used In PutDataToClass())
        **/
        get isAvconUser() {
            const bolValue = (0, clsCommFunc4Ctrl_js_1.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsAvconUser");
            return bolValue;
        }
        /**
        ...
        **/
        set isMessage(value) {
            (0, clsCommFunc4Ctrl_js_1.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsMessage", value);
        }
        /**
        * IsMessage (Used In PutDataToClass())
        **/
        get isMessage() {
            const bolValue = (0, clsCommFunc4Ctrl_js_1.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsMessage");
            return bolValue;
        }
        /**
        * 居住地址 (Used In Clear())
        **/
        set liveAddress(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtLiveAddress", value);
        }
        /**
        * 居住地址 (Used In PutDataToClass())
        **/
        get liveAddress() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtLiveAddress");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set microblog(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMicroblog", value);
        }
        /**
        * Microblog (Used In PutDataToClass())
        **/
        get microblog() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMicroblog");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set nativePlace(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtNativePlace", value);
        }
        /**
        * 籍贯 (Used In PutDataToClass())
        **/
        get nativePlace() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtNativePlace");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set postCode(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtPostCode", value);
        }
        /**
        * 邮编 (Used In PutDataToClass())
        **/
        get postCode() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtPostCode");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set qQ(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtQQ", value);
        }
        /**
        * QQ (Used In PutDataToClass())
        **/
        get qQ() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtQQ");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set registerPassword(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtRegisterPassword", value);
        }
        /**
        * RegisterPassword (Used In PutDataToClass())
        **/
        get registerPassword() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtRegisterPassword");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set stuCardNo(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtStuCardNo", value);
        }
        /**
        * 学生证号 (Used In PutDataToClass())
        **/
        get stuCardNo() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtStuCardNo");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set stuID(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtStuID", value);
        }
        /**
        * 学号 (Used In PutDataToClass())
        **/
        get stuID() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtStuID");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set stuName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtStuName", value);
        }
        /**
        * 姓名 (Used In PutDataToClass())
        **/
        get stuName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtStuName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set userID4Avcon(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtUserID4Avcon", value);
        }
        /**
        * UserID4Avcon (Used In PutDataToClass())
        **/
        get userID4Avcon() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtUserID4Avcon");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
