(function (factory) {
    ...
    **/
    class StudentInfoCRUD {
        ...
        **/
        async BindGv_vStudentInfo() {
            ...
            try {
                ...
                const responseObjLst = await (0, clsvStudentInfoWApi_js_5.vStudentInfo_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
        ...
        **/
        get stuID_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Query, "txtStuID_q");
        ...
        **/
        set stuID_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Query, "txtStuID_q", value);
        }
        /**
        * 姓名 (Used In CombineCondition())
        **/
        get stuName_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Query, "txtStuName_q");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set stuName_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Query, "txtStuName_q", value);
        }
        /**
