(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzMajorWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L0_Entity/UserManage_Share/clsvUsersEN.js", "../../TS/L0_Entity/UserManage_Share/clsvUsersENEx.js", "../../TS/L3_ForWApiEx/UserManage_Share/clsvUsersExWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUsersWApi.js", "../../TS/L0_Entity/UserManage_Share/clsUsersEN.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
    ...
    **/
    ...
    const clsvUsersWApi_js_2 = require("../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js");
    const clsvUsersWApi_js_3 = require("../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js");
    const clsvUsersWApi_js_4 = require("../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js");
    ...
    const clsvUsersWApi_js_5 = require("../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js");
    const clsvUsersWApi_js_6 = require("../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js");
    const clsvUsersWApi_js_7 = require("../../TS/L3_ForWApi/UserManage_Share/clsvUsersWApi.js");
    ...
    class UsersCRUD {
        ...
        **/
        async ExportExcel_vUsers() {
            ...
            try {
                ...
                arrvUsersObjLst = await (0, clsvUsersWApi_js_2.vUsers_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async ExportExcel_vUsers_Cache() {
            ...
            let arrvUsersObjLst = [];
            try {
                this.recCount = await (0, clsvUsersWApi_js_3.vUsers_GetRecCountByCond_Cache)(objvUsers_Cond);
                if (this.recCount == 0) {
                    const lblMsg = document.createElement("span");
                ...
                arrvUsersObjLst = await (0, clsvUsersWApi_js_4.vUsers_GetSubObjLst_Cache)(objvUsers_Cond);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SelectRecord(strUserId) {
            ...
            try {
                const objUsersEN = await (0, clsUsersWApi_js_2.Users_GetObjByUserIdAsync)(strUserId);
        ...
        **/
        async BindGv_vUsers() {
            ...
            try {
                ...
                const responseObjLst = await (0, clsvUsersWApi_js_5.vUsers_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
        ...
        async BindGv_vUsers_Cache() {
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: UsersCRUD.sortvUsersBy,
                    sortFun: clsvUsersWApi_js_6.vUsers_SortFun_Defa
                };
                arrvUsersObjLst = await (0, clsvUsersWApi_js_7.vUsers_GetObjLstByPager_Cache)(objPagerPara);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async CopyRecord(arrUserId) {
            ...
            try {
                const arrUsersObjLst = await (0, clsUsersWApi_js_3.Users_GetObjLstByUserIdLstAsync)(arrUserId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrUsersObjLst) {
                    const returnBool = await (0, clsUsersWApi_js_4.Users_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrUserId) {
            ...
            try {
                const returnInt = await (0, clsUsersWApi_js_5.Users_DelUserssAsync)(arrUserId);
                if (returnInt > 0) {
                    //Users_ReFreshCache();
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
