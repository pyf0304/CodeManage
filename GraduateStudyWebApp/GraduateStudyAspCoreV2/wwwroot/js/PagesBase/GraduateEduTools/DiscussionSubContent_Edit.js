(function (factory) {
    ...
    **/
    ...
    const clsDiscussionSubContentWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTools/clsDiscussionSubContentWApi.js");
    const clsDiscussionSubContentWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduTools/clsDiscussionSubContentWApi.js");
    const clsDiscussionSubContentWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduTools/clsDiscussionSubContentWApi.js");
    const clsDiscussionSubContentWApi_js_10 = require("../../TS/L3_ForWApi/GraduateEduTools/clsDiscussionSubContentWApi.js");
    ...
    **/
    class DiscussionSubContent_Edit {
        constructor(objShowList) {
            ...
            this.objDiscussionSubContent = new clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_DiscussionSubContent(strOp) {
            const strThisFuncName = this.ShowDialog_DiscussionSubContent.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_DiscussionSubContent");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_DiscussionSubContent");
        ...
        **/
        HideDialog_DiscussionSubContent() {
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (DiscussionSubContent_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_DiscussionSubContent;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsDiscussionSubContentWApi_js_1.DiscussionSubContent_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表DiscussionSubContent的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async PutDataToDiscussionSubContentClass(pobjDiscussionSubContentEN) {
            ...
            pobjDiscussionSubContentEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
            pobjDiscussionSubContentEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objDiscussionSubContentEN = new clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN();
            try {
            ...
            try {
                (0, clsDiscussionSubContentWApi_js_2.DiscussionSubContent_CheckPropertyNew)(objDiscussionSubContentEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsDiscussionSubContentWApi_js_3.DiscussionSubContent_AddNewRecordWithMaxIdAsync)(objDiscussionSubContentEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
        ...
        **/
        async CheckUniCond4Add_SubContentId(objDiscussionSubContentEN) {
            const strThisFuncName = this.CheckUniCond4Add_SubContentId.name;
            const strUniquenessCondition = (0, clsDiscussionSubContentWApi_js_4.DiscussionSubContent_GetUniCondStr_SubContentId)(objDiscussionSubContentEN);
            const bolIsExistCondition = await (0, clsDiscussionSubContentWApi_js_5.DiscussionSubContent_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_SubContentId(objDiscussionSubContentEN) {
            const strThisFuncName = this.CheckUniCond4Update_SubContentId.name;
            const strUniquenessCondition = (0, clsDiscussionSubContentWApi_js_6.DiscussionSubContent_GetUniCondStr4Update_SubContentId)(objDiscussionSubContentEN);
            const bolIsExistCondition = await (0, clsDiscussionSubContentWApi_js_5.DiscussionSubContent_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsDiscussionSubContentWApi_js_3.DiscussionSubContent_AddNewRecordWithMaxIdAsync)(objDiscussionSubContentEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strSubContentId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objDiscussionSubContentEN = new clsDiscussionSubContentEN_js_1.clsDiscussionSubContentEN();
            try {
                const returnBool = await (0, clsDiscussionSubContentWApi_js_7.DiscussionSubContent_IsExistAsync)(strSubContentId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strSubContentId);
            ...
            try {
                const objDiscussionSubContentEN_Const = await (0, clsDiscussionSubContentWApi_js_8.DiscussionSubContent_GetObjBySubContentIdAsync)(strSubContentId);
        ...
        **/
        async UpdateRecord(strSubContentId) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsDiscussionSubContentWApi_js_9.DiscussionSubContent_CheckProperty4Update)(objDiscussionSubContentEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsDiscussionSubContentWApi_js_10.DiscussionSubContent_UpdateRecordAsync)(objDiscussionSubContentEN);
                if (returnBool == true) {
                    //DiscussionSubContent_ReFreshCache();
                }
                return returnBool;
        ...
        **/
        set btnCancel_DiscussionSubContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_DiscussionSubContent", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_DiscussionSubContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_DiscussionSubContent");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_DiscussionSubContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_DiscussionSubContent", value);
        }
        /**
        * 是否置顶 (Used In Clear())
        **/
        ...
        **/
        set subContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtSubContent", value);
        }
        /**
        * 子内容 (Used In PutDataToClass())
        **/
        get subContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtSubContent");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set topicsId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtTopicsId", value);
        }
        /**
        * 主题Id (Used In PutDataToClass())
        **/
        get topicsId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtTopicsId");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    exports.DiscussionSubContent_Edit = DiscussionSubContent_Edit;
    DiscussionSubContent_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
