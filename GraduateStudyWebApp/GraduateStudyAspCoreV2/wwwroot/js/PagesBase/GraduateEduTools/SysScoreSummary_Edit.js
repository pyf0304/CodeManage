(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/SysPara/clsSchoolYearWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsSysScoreTypeWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../../TS/L0_Entity/GraduateEduTools/clsSysScoreSummaryEN.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SysScoreSummary_Edit = void 0;
    /**
    * 类名:SysScoreSummary_Edit(界面:SysScoreSummaryCRUD)
    * 表名:SysScoreSummary(01120628)
    * 版本:2023.01.12.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/12 16:38:03
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    const clsSysScoreSummaryWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js");
    const clsSysScoreSummaryWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js");
    const clsSysScoreSummaryWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js");
    const clsSysScoreSummaryWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js");
    const clsSysScoreSummaryWApi_js_10 = require("../../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js");
    ...
    **/
    class SysScoreSummary_Edit {
        constructor(objShowList) {
            ...
            SysScoreSummary_Edit.objPage_Edit = this;
            this.objSysScoreSummary = new clsSysScoreSummaryEN_js_1.clsSysScoreSummaryEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../GraduateEduTools/SysScoreSummary_Edit";
        ...
        **/
        ShowDialog_SysScoreSummary(strOp) {
            const strThisFuncName = this.ShowDialog_SysScoreSummary.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_SysScoreSummary");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_SysScoreSummary");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                $('#lblDialogTitle_SysScoreSummary').html('添加记录');
                //SysScoreSummary_EditEx.GetMaxStrId('#txtmId');
            }
            else if (strOp === "Update") {
                $('#lblDialogTitle_SysScoreSummary').html('修改记录');
            }
            else if (strOp === "Detail") {
                $('#btnSubmit_SysScoreSummary').hide();
                $('#lblDialogTitle_SysScoreSummary').html('详细信息');
            }
            ShowDialog('#divEditDialog_SysScoreSummary');
        }
        /**
        * 隐藏对话框
        * (AutoGCLib.WA_ViewScript_EditCS_TS4TypeScript:Gen_WApi_TS_HideDialog)
        **/
        HideDialog_SysScoreSummary() {
            const strThisFuncName = this.HideDialog_SysScoreSummary.name;
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_SysScoreSummary");
            HideDialog('#divEditDialog_SysScoreSummary');
        }
        /** 添加新记录
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    this.btnSubmit_SysScoreSummary = "确认添加";
                    this.btnCancel_SysScoreSummary = "取消添加";
                    const responseText = this.AddNewRecord();
                    if (SysScoreSummary_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
                        this.ShowDialog_SysScoreSummary('Add');
                    }
                }
                else {
                    this.opType = "Add";
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    this.SetEventFunc();
                    this.bolIsLoadEditRegion = true; //
                    this.btnSubmit_SysScoreSummary = "确认修改";
                    this.btnCancel_SysScoreSummary = "取消修改";
                    const lngKeyId = Number(strKeyId);
                    this.UpdateRecord(lngKeyId);
                    if (SysScoreSummary_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
                        this.ShowDialog_SysScoreSummary('Update');
                    }
                }
                else {
                    this.opType = "Update";
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_SysScoreSummary;
            try {
                ...
                switch (strCommandText) {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            //{
                            //HideDialog_SysScoreSummary();
                            //this.iShowList.BindGv_Cache(clsSysScoreSummaryEN._CurrTabName, "");
                            //}
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                if (SysScoreSummary_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
                                    this.HideDialog_SysScoreSummary();
                                }
                                this.iShowList.BindGv(clsSysScoreSummaryEN_js_1.clsSysScoreSummaryEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async AddNewRecord() {
            ...
            this.Clear();
            //wucSysScoreSummaryB1.mId = SysScoreSummary_GetMaxStrId_S();
        }
        /** 为插入记录做准备工作
        ...
        **/
        async PutDataToSysScoreSummaryClass(pobjSysScoreSummaryEN) {
            const strThisFuncName = this.PutDataToSysScoreSummaryClass.name;
            ...
            pobjSysScoreSummaryEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objSysScoreSummaryEN = new clsSysScoreSummaryEN_js_1.clsSysScoreSummaryEN();
            try {
            ...
            try {
                (0, clsSysScoreSummaryWApi_js_1.SysScoreSummary_CheckPropertyNew)(objSysScoreSummaryEN);
            }
            catch (e) {
            ...
            try {
                //检查唯一性条件
                const bolIsExistCond_mId_UserId = await this.CheckUniCond4Add_mId_UserId(objSysScoreSummaryEN);
                if (bolIsExistCond_mId_UserId == false) {
                    return false;
                }
                let returnBool = false;
                returnBool = await (0, clsSysScoreSummaryWApi_js_2.SysScoreSummary_AddNewRecordAsync)(objSysScoreSummaryEN);
                if (returnBool == true) {
                    (0, clsSysScoreSummaryWApi_js_3.SysScoreSummary_ReFreshCache)(SysScoreSummary_Edit.id_CurrEduCls_Cache);
        ...
        **/
        async CheckUniCond4Add_mId_UserId(objSysScoreSummaryEN) {
            const strThisFuncName = this.CheckUniCond4Add_mId_UserId.name;
            const strUniquenessCondition = (0, clsSysScoreSummaryWApi_js_4.SysScoreSummary_GetUniCondStr_mId_UserId)(objSysScoreSummaryEN);
            const bolIsExistCondition = await (0, clsSysScoreSummaryWApi_js_5.SysScoreSummary_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_mId_UserId(objSysScoreSummaryEN) {
            const strThisFuncName = this.CheckUniCond4Update_mId_UserId.name;
            const strUniquenessCondition = (0, clsSysScoreSummaryWApi_js_6.SysScoreSummary_GetUniCondStr4Update_mId_UserId)(objSysScoreSummaryEN);
            const bolIsExistCondition = await (0, clsSysScoreSummaryWApi_js_5.SysScoreSummary_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(lngmId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objSysScoreSummaryEN = new clsSysScoreSummaryEN_js_1.clsSysScoreSummaryEN();
            try {
                const returnBool = await (0, clsSysScoreSummaryWApi_js_7.SysScoreSummary_IsExistAsync)(lngmId);
                if (returnBool == false) {
            ...
            try {
                const objSysScoreSummaryEN_Const = await (0, clsSysScoreSummaryWApi_js_8.SysScoreSummary_GetObjBymIdAsync)(lngmId);
                if (objSysScoreSummaryEN_Const == null) {
                    const strMsg = (0, clsString_js_1.Format)("根据关键字获取相应的记录的对象为空.(in {0}.{1})", this.constructor.name, strThisFuncName);
                    console.error(strMsg);
                    alert(strMsg);
                    return;
                }
                objSysScoreSummaryEN = objSysScoreSummaryEN_Const;
            }
            catch (e) {
        ...
        **/
        GetDataFromSysScoreSummaryClass(pobjSysScoreSummaryEN) {
            const strThisFuncName = this.GetDataFromSysScoreSummaryClass.name;
        ...
        **/
        async UpdateRecord(lngmId) {
            ...
            try {
                ...
                this.objSysScoreSummary = objSysScoreSummaryEN_Const;
                const conGetDataFromClass = await this.GetDataFromSysScoreSummaryClass(objSysScoreSummaryEN_Const);
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsSysScoreSummaryWApi_js_9.SysScoreSummary_CheckProperty4Update)(objSysScoreSummaryEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                //检查唯一性条件
                const bolIsExistCond_mId_UserId = await this.CheckUniCond4Update_mId_UserId(objSysScoreSummaryEN);
                if (bolIsExistCond_mId_UserId == false) {
                    return false;
                }
                const returnBool = await (0, clsSysScoreSummaryWApi_js_10.SysScoreSummary_UpdateRecordAsync)(objSysScoreSummaryEN);
                if (returnBool == true) {
                    (0, clsSysScoreSummaryWApi_js_3.SysScoreSummary_ReFreshCache)(SysScoreSummary_Edit.id_CurrEduCls_Cache);
                }
                return returnBool;
        ...
        **/
        set btnCancel_SysScoreSummary(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_SysScoreSummary", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_SysScoreSummary() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_SysScoreSummary");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_SysScoreSummary(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_SysScoreSummary", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
    ...
    exports.SysScoreSummary_Edit = SysScoreSummary_Edit;
    SysScoreSummary_Edit.id_CurrEduCls_Cache = "";
    SysScoreSummary_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
