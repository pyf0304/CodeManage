(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/L3_ForWApi/CourseLearning_Share/clscc_CourseWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L0_Entity/Knowledges_Share/clsgs_KnowledgesGraphEN.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/L3_ForWApi/Knowledges_Share/clsgs_KnowledgesGraphWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    class gs_KnowledgesGraph_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../Knowledges_Share/gs_KnowledgesGraph_Edit";
        ...
        **/
        ShowDialog_gs_KnowledgesGraph(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_gs_KnowledgesGraph");
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_gs_KnowledgesGraph");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_gs_KnowledgesGraph', '添加记录');
                //gs_KnowledgesGraph_EditEx.GetMaxStrId('#txtKnowledgeGraphId');
            }
            else if (strOp === "Update") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_gs_KnowledgesGraph', '修改记录');
            }
            else if (strOp === "Detail") {
                const btnSubmit_gs_KnowledgesGraph = (0, clsCommFunc4Ctrl_js_2.getButtonObjByIdInDiv)(this.divName4Edit, 'btnSubmit_gs_KnowledgesGraph');
                btnSubmit_gs_KnowledgesGraph.hidden = true;
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_gs_KnowledgesGraph', '详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async GetDataFromgs_KnowledgesGraphClass(pobjgs_KnowledgesGraphEN) {
        ...
        **/
        set btnCancel_gs_KnowledgesGraph(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_gs_KnowledgesGraph", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_gs_KnowledgesGraph() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_gs_KnowledgesGraph");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_gs_KnowledgesGraph(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_gs_KnowledgesGraph", value);
        }
        /**
        * 课程Id (Used In Clear())
        **/
        ...
        **/
        set knowledgeGraphName(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtKnowledgeGraphName", value);
        }
        /**
        * 连连看图名 (Used In PutDataToClass())
        **/
        get knowledgeGraphName() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtKnowledgeGraphName");
            if (strValue == undefined)
                return "";
            else
