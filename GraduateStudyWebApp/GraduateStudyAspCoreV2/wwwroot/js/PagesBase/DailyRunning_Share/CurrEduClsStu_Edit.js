(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/SysPara/clsSchoolTermWApi.js", "../../TS/L3_ForWApi/SysPara/clsSchoolYearWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L0_Entity/DailyRunning_Share/clsCurrEduClsStuEN.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    **/
    ...
    const clsCurrEduClsStuWApi_js_6 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_7 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_8 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_9 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_10 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    ...
    class CurrEduClsStu_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../DailyRunning_Share/CurrEduClsStu_Edit";
        ...
        **/
        ShowDialog_CurrEduClsStu(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_CurrEduClsStu");
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_CurrEduClsStu");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_CurrEduClsStu', '添加记录');
                //CurrEduClsStu_EditEx.GetMaxStrId('#txtid_EduClsStu');
            }
            else if (strOp === "Update") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_CurrEduClsStu', '修改记录');
            }
            else if (strOp === "Detail") {
                const btnSubmit_CurrEduClsStu = (0, clsCommFunc4Ctrl_js_2.getButtonObjByIdInDiv)(this.divName4Edit, 'btnSubmit_CurrEduClsStu');
                btnSubmit_CurrEduClsStu.hidden = true;
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_CurrEduClsStu', '详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async GetDataFromCurrEduClsStuClass(pobjCurrEduClsStuEN) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            const objCurrEduClsStuEN = new clsCurrEduClsStuEN_js_1.clsCurrEduClsStuEN();
            objCurrEduClsStuEN.Setid_EduClsStu(Number(this.keyId));
            await this.PutDataToCurrEduClsStuClass(objCurrEduClsStuEN);
        ...
        **/
        set btnCancel_CurrEduClsStu(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_CurrEduClsStu", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_CurrEduClsStu() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_CurrEduClsStu");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_CurrEduClsStu(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_CurrEduClsStu", value);
        }
        /**
        ...
        **/
        set id_Stu(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_Stu", value);
        }
        /**
        * 学生流水号 (Used In PutDataToClass())
        **/
        get id_Stu() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtid_Stu");
            if (strValue == undefined)
                return "";
            else
