(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/L3_ForWApi/CourseManage_Share/clsvcc_Course_SimWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js", "../../TS/L3_ForWApi/SysPara/clsXzGradeBaseWApi.js", "../../TS/L3_ForWApi/SysPara/clsSchoolYearWApi.js", "../../TS/L3_ForWApi/SysPara/clsSchoolTermWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/PubFun/clsPublocalStorage.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L0_Entity/DailyRunning_Share/clsCurrEduClsEN.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    **/
    ...
    const clsvcc_Course_SimWApi_js_1 = require("../../TS/L3_ForWApi/CourseManage_Share/clsvcc_Course_SimWApi.js");
    ...
    class CurrEduCls_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../DailyRunning_Share/CurrEduCls_Edit";
        ...
        **/
        ShowDialog_CurrEduCls(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_CurrEduCls");
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_CurrEduCls");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_CurrEduCls', '添加记录');
                //CurrEduCls_EditEx.GetMaxStrId('#txtid_CurrEduCls');
            }
            else if (strOp === "Update") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_CurrEduCls', '修改记录');
            }
            else if (strOp === "Detail") {
                const btnSubmit_CurrEduCls = (0, clsCommFunc4Ctrl_js_2.getButtonObjByIdInDiv)(this.divName4Edit, 'btnSubmit_CurrEduCls');
                btnSubmit_CurrEduCls.hidden = true;
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_CurrEduCls', '详细信息');
            }
        ...
        **/
        async SetDdl_CourseIdInDiv() {
            await (0, clsvcc_Course_SimWApi_js_1.vcc_Course_Sim_BindDdl_CourseIdInDiv_Cache)(this.divName4Edit, "ddlCourseId"); //
        }
        /**
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async GetDataFromCurrEduClsClass(pobjCurrEduClsEN) {
        ...
        **/
        set btnCancel_CurrEduCls(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_CurrEduCls", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_CurrEduCls() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_CurrEduCls");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_CurrEduCls(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_CurrEduCls", value);
        }
        /**
        * 课程Id (Used In Clear())
        **/
        set courseId(value) {
            (0, clsCommFunc4Ctrl_js_3.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlCourseId", value);
        }
        /**
        * 课程Id (Used In PutDataToClass())
        **/
        get courseId() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetSelectValueInDiv)(this.divName4Edit, "ddlCourseId");
        ...
        **/
        set currEduClsId(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtCurrEduClsId", value);
        }
        /**
        * 教学班Id (Used In PutDataToClass())
        **/
        get currEduClsId() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtCurrEduClsId");
            if (strValue == undefined)
                return "";
            else
        ...
        **/
        set eduClsName(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtEduClsName", value);
        }
        /**
        * 教学班名 (Used In PutDataToClass())
        **/
        get eduClsName() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtEduClsName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set isEffective(value) {
            (0, clsCommFunc4Ctrl_js_3.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsEffective", value);
        }
        /**
        * 是否有效 (Used In PutDataToClass())
        **/
        get isEffective() {
            const bolValue = (0, clsCommFunc4Ctrl_js_3.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsEffective");
            return bolValue;
        }
        /**
        * 备注 (Used In Clear())
