(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L0_Entity/DailyRunning_Share/clsvCurrEduClsStuEN.js", "../../TS/L0_Entity/DailyRunning_Share/clsvCurrEduClsStuENEx.js", "../../TS/L3_ForWApiEx/DailyRunning_Share/clsvCurrEduClsStuExWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js", "../../TS/L0_Entity/DailyRunning_Share/clsCurrEduClsStuEN.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
    ...
    **/
    ...
    const clsvCurrEduClsStuWApi_js_2 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js");
    const clsvCurrEduClsStuWApi_js_3 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js");
    const clsvCurrEduClsStuWApi_js_4 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js");
    ...
    const clsCurrEduClsStuWApi_js_2 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsvCurrEduClsStuEN_js_1 = require("../../TS/L0_Entity/DailyRunning_Share/clsvCurrEduClsStuEN.js");
    const clsvCurrEduClsStuENEx_js_1 = require("../../TS/L0_Entity/DailyRunning_Share/clsvCurrEduClsStuENEx.js");
    const clsvCurrEduClsStuExWApi_js_1 = require("../../TS/L3_ForWApiEx/DailyRunning_Share/clsvCurrEduClsStuExWApi.js");
    const clsvCurrEduClsStuWApi_js_5 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js");
    const clsvCurrEduClsStuWApi_js_6 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js");
    const clsvCurrEduClsStuWApi_js_7 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_3 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_4 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    const clsCurrEduClsStuWApi_js_5 = require("../../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsStuWApi.js");
    ...
    **/
    class CurrEduClsStuCRUD {
        ...
        **/
        async ExportExcel_vCurrEduClsStu() {
            ...
            try {
                ...
                arrvCurrEduClsStuObjLst = await (0, clsvCurrEduClsStuWApi_js_2.vCurrEduClsStu_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async ExportExcel_vCurrEduClsStu_Cache() {
            ...
            let arrvCurrEduClsStuObjLst = [];
            try {
                this.recCount = await (0, clsvCurrEduClsStuWApi_js_3.vCurrEduClsStu_GetRecCountByCond_Cache)(objvCurrEduClsStu_Cond, CurrEduClsStuCRUD.id_CurrEduCls_Cache);
                if (this.recCount == 0) {
                    const lblMsg = document.createElement("span");
                ...
                arrvCurrEduClsStuObjLst = await (0, clsvCurrEduClsStuWApi_js_4.vCurrEduClsStu_GetSubObjLst_Cache)(objvCurrEduClsStu_Cond, CurrEduClsStuCRUD.id_CurrEduCls_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SelectRecord(lngid_EduClsStu) {
            ...
            try {
                const objCurrEduClsStuEN = await (0, clsCurrEduClsStuWApi_js_2.CurrEduClsStu_GetObjByid_EduClsStuAsync)(lngid_EduClsStu);
        ...
        **/
        async BindGv_vCurrEduClsStu() {
            ...
            try {
                ...
                arrvCurrEduClsStuObjLst = await (0, clsvCurrEduClsStuWApi_js_5.vCurrEduClsStu_GetObjLstByPagerAsync)(objPagerPara);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error("Error: ", strMsg);
        ...
        async BindGv_vCurrEduClsStu_Cache() {
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: CurrEduClsStuCRUD.sortvCurrEduClsStuBy,
                    sortFun: clsvCurrEduClsStuWApi_js_6.vCurrEduClsStu_SortFun_Defa
                };
                arrvCurrEduClsStuObjLst = await (0, clsvCurrEduClsStuWApi_js_7.vCurrEduClsStu_GetObjLstByPager_Cache)(objPagerPara, CurrEduClsStuCRUD.id_CurrEduCls_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async CopyRecord(arrid_EduClsStu) {
            ...
            try {
                const arrCurrEduClsStuObjLst = await (0, clsCurrEduClsStuWApi_js_3.CurrEduClsStu_GetObjLstByid_EduClsStuLstAsync)(arrid_EduClsStu);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrCurrEduClsStuObjLst) {
                    const returnBool = await (0, clsCurrEduClsStuWApi_js_4.CurrEduClsStu_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrid_EduClsStu) {
            ...
            try {
                const returnInt = await (0, clsCurrEduClsStuWApi_js_5.CurrEduClsStu_DelCurrEduClsStusAsync)(arrid_EduClsStu);
                if (returnInt > 0) {
                    //CurrEduClsStu_ReFreshCache(CurrEduClsStuCRUD.id_CurrEduCls_Cache);
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        get id_CurrEduCls_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_2.GetSelectValueInDiv)(this.divName4Query, "ddlid_CurrEduCls_q");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set id_CurrEduCls_q(value) {
            (0, clsCommFunc4Ctrl_js_2.SetSelectValueByIdInDiv)(this.divName4Query, "ddlid_CurrEduCls_q", value);
        }
        /**
    ...
    CurrEduClsStuCRUD.CourseId_Static = "99999999"; //查询区下拉框条件变量1
});
