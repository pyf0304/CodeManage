(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L0_Entity/ParameterTable/clsDiscussionTypeEN.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../TS/PubFun/clsPublocalStorage.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DiscussionType_Edit = void 0;
    /**
    ...
    **/
    ...
    const clsDiscussionTypeWApi_js_2 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    const clsDiscussionTypeWApi_js_3 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    const clsDiscussionTypeWApi_js_4 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    const clsDiscussionTypeEN_js_1 = require("../../TS/L0_Entity/ParameterTable/clsDiscussionTypeEN.js");
    const clsDiscussionTypeWApi_js_5 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    const clsDiscussionTypeWApi_js_6 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    const clsDiscussionTypeWApi_js_7 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    const clsDiscussionTypeWApi_js_8 = require("../../TS/L3_ForWApi/ParameterTable/clsDiscussionTypeWApi.js");
    ...
    **/
    class DiscussionType_Edit {
        constructor(objShowList) {
            ...
            this.objDiscussionType = new clsDiscussionTypeEN_js_1.clsDiscussionTypeEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_DiscussionType(strOp) {
            const strThisFuncName = this.ShowDialog_DiscussionType.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_DiscussionType");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_DiscussionType");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (DiscussionType_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_DiscussionType;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsDiscussionTypeEN_js_1.clsDiscussionTypeEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsDiscussionTypeEN_js_1.clsDiscussionTypeEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async PutDataToDiscussionTypeClass(pobjDiscussionTypeEN) {
            ...
            pobjDiscussionTypeEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
            pobjDiscussionTypeEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objDiscussionTypeEN = new clsDiscussionTypeEN_js_1.clsDiscussionTypeEN();
            try {
            ...
            try {
                (0, clsDiscussionTypeWApi_js_1.DiscussionType_CheckPropertyNew)(objDiscussionTypeEN);
            }
            catch (e) {
            ...
            try {
                //检查唯一性条件
                let returnBool = false;
                const bolIsExist = await (0, clsDiscussionTypeWApi_js_2.DiscussionType_IsExistAsync)(objDiscussionTypeEN.discussionTypeId);
                if (bolIsExist == true) {
                    const strMsg = (0, clsString_js_1.Format)("添加记录时，关键字：{0}已经存在！", objDiscussionTypeEN.discussionTypeId);
                    console.error(strMsg);
                    alert(strMsg);
                    return false; //一定要有一个返回值，否则会出错！
                }
                returnBool = await (0, clsDiscussionTypeWApi_js_3.DiscussionType_AddNewRecordAsync)(objDiscussionTypeEN);
                if (returnBool == true) {
                    (0, clsDiscussionTypeWApi_js_4.DiscussionType_ReFreshCache)();
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                //检查唯一性条件
                const responseKeyId = await (0, clsDiscussionTypeWApi_js_5.DiscussionType_AddNewRecordWithMaxIdAsync)(objDiscussionTypeEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strDiscussionTypeId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objDiscussionTypeEN = new clsDiscussionTypeEN_js_1.clsDiscussionTypeEN();
            try {
                const returnBool = await (0, clsDiscussionTypeWApi_js_2.DiscussionType_IsExistAsync)(strDiscussionTypeId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strDiscussionTypeId);
            ...
            try {
                const objDiscussionTypeEN_Const = await (0, clsDiscussionTypeWApi_js_6.DiscussionType_GetObjByDiscussionTypeIdAsync)(strDiscussionTypeId);
        ...
        **/
        async UpdateRecord(strDiscussionTypeId) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsDiscussionTypeWApi_js_7.DiscussionType_CheckProperty4Update)(objDiscussionTypeEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                //检查唯一性条件
                const returnBool = await (0, clsDiscussionTypeWApi_js_8.DiscussionType_UpdateRecordAsync)(objDiscussionTypeEN);
                if (returnBool == true) {
                    (0, clsDiscussionTypeWApi_js_4.DiscussionType_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_DiscussionType(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_DiscussionType", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_DiscussionType() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_DiscussionType");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_DiscussionType(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_DiscussionType", value);
        }
        /**
        * 讨论类型名称 (Used In Clear())
        **/
        set discussionTypeName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtDiscussionTypeName", value);
        }
        /**
        * 讨论类型名称 (Used In PutDataToClass())
        **/
        get discussionTypeName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtDiscussionTypeName");
    ...
    exports.DiscussionType_Edit = DiscussionType_Edit;
    DiscussionType_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
