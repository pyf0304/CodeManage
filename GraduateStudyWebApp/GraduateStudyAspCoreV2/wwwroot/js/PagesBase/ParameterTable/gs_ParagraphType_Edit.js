(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L0_Entity/ParameterTable/clsgs_ParagraphTypeEN.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsgs_ParagraphTypeWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gs_ParagraphType_Edit = void 0;
    /**
    ...
    **/
    class gs_ParagraphType_Edit {
        constructor(objShowList) {
            ...
            this.objgs_ParagraphType = new clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_gs_ParagraphType(strOp) {
            const strThisFuncName = this.ShowDialog_gs_ParagraphType.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_gs_ParagraphType");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_gs_ParagraphType");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (gs_ParagraphType_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_gs_ParagraphType;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsgs_ParagraphTypeWApi_js_1.gs_ParagraphType_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表gs_ParagraphType的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async PutDataTogs_ParagraphTypeClass(pobjgs_ParagraphTypeEN) {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objgs_ParagraphTypeEN = new clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN();
            try {
            ...
            try {
                (0, clsgs_ParagraphTypeWApi_js_2.gs_ParagraphType_CheckPropertyNew)(objgs_ParagraphTypeEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsgs_ParagraphTypeWApi_js_3.gs_ParagraphType_AddNewRecordWithMaxIdAsync)(objgs_ParagraphTypeEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
                    (0, clsgs_ParagraphTypeWApi_js_4.gs_ParagraphType_ReFreshCache)();
        ...
        **/
        async CheckUniCond4Add_ParagraphTypeId(objgs_ParagraphTypeEN) {
            const strThisFuncName = this.CheckUniCond4Add_ParagraphTypeId.name;
            const strUniquenessCondition = (0, clsgs_ParagraphTypeWApi_js_5.gs_ParagraphType_GetUniCondStr_ParagraphTypeId)(objgs_ParagraphTypeEN);
            const bolIsExistCondition = await (0, clsgs_ParagraphTypeWApi_js_6.gs_ParagraphType_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_ParagraphTypeId(objgs_ParagraphTypeEN) {
            const strThisFuncName = this.CheckUniCond4Update_ParagraphTypeId.name;
            const strUniquenessCondition = (0, clsgs_ParagraphTypeWApi_js_7.gs_ParagraphType_GetUniCondStr4Update_ParagraphTypeId)(objgs_ParagraphTypeEN);
            const bolIsExistCondition = await (0, clsgs_ParagraphTypeWApi_js_6.gs_ParagraphType_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsgs_ParagraphTypeWApi_js_3.gs_ParagraphType_AddNewRecordWithMaxIdAsync)(objgs_ParagraphTypeEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strParagraphTypeId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objgs_ParagraphTypeEN = new clsgs_ParagraphTypeEN_js_1.clsgs_ParagraphTypeEN();
            try {
                const returnBool = await (0, clsgs_ParagraphTypeWApi_js_8.gs_ParagraphType_IsExistAsync)(strParagraphTypeId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strParagraphTypeId);
            ...
            try {
                const objgs_ParagraphTypeEN_Const = await (0, clsgs_ParagraphTypeWApi_js_9.gs_ParagraphType_GetObjByParagraphTypeIdAsync)(strParagraphTypeId);
        ...
        **/
        GetDataFromgs_ParagraphTypeClass(pobjgs_ParagraphTypeEN) {
        ...
        **/
        async UpdateRecord(strParagraphTypeId) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            await this.PutDataTogs_ParagraphTypeClass(objgs_ParagraphTypeEN);
            objgs_ParagraphTypeEN.sf_UpdFldSetStr = objgs_ParagraphTypeEN.updFldString; //设置哪些字段被修改(脏字段)
            if (objgs_ParagraphTypeEN.paragraphTypeId == "" || objgs_ParagraphTypeEN.paragraphTypeId == undefined) {
                console.error("关键字不能为空!");
                throw (0, clsString_js_1.Format)("关键字不能为空!(in {0}.{1})", this.constructor.name, strThisFuncName);
            }
            try {
                (0, clsgs_ParagraphTypeWApi_js_10.gs_ParagraphType_CheckProperty4Update)(objgs_ParagraphTypeEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsgs_ParagraphTypeWApi_js_11.gs_ParagraphType_UpdateRecordAsync)(objgs_ParagraphTypeEN);
                if (returnBool == true) {
                    (0, clsgs_ParagraphTypeWApi_js_4.gs_ParagraphType_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_gs_ParagraphType(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_gs_ParagraphType", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_gs_ParagraphType() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_gs_ParagraphType");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_gs_ParagraphType(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_gs_ParagraphType", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
        ...
        * 段落类型 (Used In Clear())
        **/
        set paragraphTypeName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtParagraphTypeName", value);
        }
        /**
        * 段落类型 (Used In PutDataToClass())
        **/
        get paragraphTypeName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtParagraphTypeName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    exports.gs_ParagraphType_Edit = gs_ParagraphType_Edit;
    gs_ParagraphType_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
