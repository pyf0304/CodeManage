(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsgs_UserConfigWApi.js", "../../TS/L0_Entity/ExamManage/clsvgs_UserConfigENEx.js", "../../TS/L3_ForWApiEx/ExamManage/clsvgs_UserConfigExWApi.js", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsgs_UserConfigWApi.js", "../../TS/L3_ForWApi/ExamManage/clsgs_UserConfigWApi.js", "../../TS/L0_Entity/ExamManage/clsgs_UserConfigEN.js", "../../TS/L0_Entity/ExamManage/clsvgs_UserConfigEN.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gs_UserConfigCRUD = void 0;
    /**
    ...
    **/
    ...
    const clsvgs_UserConfigWApi_js_2 = require("../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js");
    const clsvgs_UserConfigWApi_js_3 = require("../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js");
    const clsvgs_UserConfigWApi_js_4 = require("../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js");
    ...
    const clsvgs_UserConfigENEx_js_1 = require("../../TS/L0_Entity/ExamManage/clsvgs_UserConfigENEx.js");
    const clsvgs_UserConfigExWApi_js_1 = require("../../TS/L3_ForWApiEx/ExamManage/clsvgs_UserConfigExWApi.js");
    const clsvgs_UserConfigWApi_js_5 = require("../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js");
    const clsvgs_UserConfigWApi_js_6 = require("../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js");
    const clsvgs_UserConfigWApi_js_7 = require("../../TS/L3_ForWApi/ExamManage/clsvgs_UserConfigWApi.js");
    ...
    **/
    class gs_UserConfigCRUD {
        ...
        **/
        CombineData(arrvgs_UserConfigObjLst, arrDataColumn) {
            ...
            for (let i = 0; i < intRowNum; i++) {
                ...
                const objEN = arrvgs_UserConfigObjLst[i];
                for (let j = 0; j < intColNum; j++) {
            ...
            const strFileName = (0, clsString_js_1.Format)("用户配置({0})导出.xlsx", clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN._CurrTabName);
            exportSpecialExcel_pyf(arrData, strFileName);
        }
        /** 根据条件获取相应的对象列表
        * (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_ExportExcel)
        **/
        async ExportExcel_vgs_UserConfig() {
            const strThisFuncName = this.ExportExcel_vgs_UserConfig.name;
            if (gs_UserConfigCRUD.sortvgs_UserConfigBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvgs_UserConfigBy)为空，请检查！(In BindGv_vgs_UserConfig_Cache)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            let arrvgs_UserConfigObjLst = [];
            try {
                this.recCount = await (0, clsvgs_UserConfigWApi_js_1.vgs_UserConfig_GetRecCountByCondAsync)(strWhereCond);
                if (this.recCount == 0) {
                ...
                arrvgs_UserConfigObjLst = await (0, clsvgs_UserConfigWApi_js_2.vgs_UserConfig_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async ExportExcel_vgs_UserConfig_Cache() {
            ...
            let arrvgs_UserConfigObjLst = [];
            try {
                this.recCount = await (0, clsvgs_UserConfigWApi_js_3.vgs_UserConfig_GetRecCountByCond_Cache)(objvgs_UserConfig_Cond);
                if (this.recCount == 0) {
                    const lblMsg = document.createElement("span");
                    lblMsg.innerHTML = (0, clsString_js_1.Format)("根据条件:[{0}]获取的对象列表数为0！", objvgs_UserConfig_Cond.whereCond);
                    const divDataLst = document.getElementById("divDataLst");
                    if (divDataLst != null) {
                        divDataLst.innerText = "";
                        divDataLst.appendChild(lblMsg);
                    }
                    const strMsg = (0, clsString_js_1.Format)("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvgs_UserConfig_Cond.whereCond);
                    console.error("Error: ", strMsg);
                    //console.trace();
                    alert(strMsg);
                    return;
                }
                arrvgs_UserConfigObjLst = await (0, clsvgs_UserConfigWApi_js_4.vgs_UserConfig_GetSubObjLst_Cache)(objvgs_UserConfig_Cond);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            if (arrvgs_UserConfigObjLst.length == 0) {
                const strKey = (0, clsString_js_1.Format)("{0}", clsgs_UserConfigEN_js_1.clsgs_UserConfigEN._CurrTabName);
        ...
        **/
        async btnSelectRecordInTab_Click(lngConfigId) {
        ...
        **/
        async DelRecord(lngConfigId) {
            const strThisFuncName = this.DelRecord.name;
            try {
                const returnInt = await (0, clsgs_UserConfigWApi_js_1.gs_UserConfig_DelRecordAsync)(lngConfigId);
                if (returnInt > 0) {
        ...
        * @param sender:参数列表
        **/
        async SelectRecord(lngConfigId) {
            const strThisFuncName = this.SelectRecord.name;
            try {
                const objgs_UserConfigEN = await (0, clsgs_UserConfigWApi_js_2.gs_UserConfig_GetObjByConfigIdAsync)(lngConfigId);
                //console.log("完成SelectRecord!", objgs_UserConfigEN);
                (0, clsCommFunc4Web_js_1.Redirect)("/Index/Main_vgs_UserConfig");
            }
            catch (e) {
        ...
        **/
        async Combinevgs_UserConfigCondition() {
        ...
        * @returns 条件串(strWhereCond)
        **/
        async Combinevgs_UserConfigConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            const strWhereCond = " 1 = 1 ";
        ...
        * @returns 条件串(strWhereCond)
        **/
        async Combinevgs_UserConfigConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            const strWhereCond = " 1 = 1 ";
            const objvgs_UserConfig_Cond = new clsvgs_UserConfigENEx_js_1.clsvgs_UserConfigENEx();
            //如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
            objvgs_UserConfig_Cond.whereCond = strWhereCond;
            return objvgs_UserConfig_Cond;
        }
        ...
        **/
        async BindTab_vgs_UserConfig(divContainer, arrvgs_UserConfigObjLst) {
            ...
            const arrDataColumn = [
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ConfigTypeName,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ConfigTypeName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "配置类型名称",
                    text: "",
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ShareId,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ShareId,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "分享Id",
                    text: "",
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_UpdUser,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_UpdUser,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改人",
                    text: "",
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_DataTable,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_DataTable,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "数据表",
                    text: "",
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_DataTableId,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_DataTableId,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "数据表Id",
                    text: "",
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_UpdDate,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_UpdDate,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改日期",
                    text: "",
                ...
                {
                    fldName: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ShareName,
                    sortBy: clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ShareName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "分享名称",
                    text: "",
            ...
            await (0, clsCommFunc4Web_js_1.BindTab_V)(o, arrvgs_UserConfigObjLst, arrDataColumn, clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.con_ConfigId, this);
        ...
        **/
        async ExtendFldFuncMap(arrvgs_UserConfigExObjLst, arrDataColumn) {
            const arrFldName = clsvgs_UserConfigEN_js_1.clsvgs_UserConfigEN.AttributeName;
            for (const objDataColumn of arrDataColumn) {
                ...
                for (const objInFor of arrvgs_UserConfigExObjLst) {
                    await (0, clsvgs_UserConfigExWApi_js_1.vgs_UserConfigEx_FuncMapByFldName)(objDataColumn.fldName, objInFor);
                }
            }
        }
        /** 函数功能:在数据列表中跳转到前一页
        ...
        **/
        async BindGv_vgs_UserConfig() {
            const strThisFuncName = this.BindGv_vgs_UserConfig.name;
            if (gs_UserConfigCRUD.sortvgs_UserConfigBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvgs_UserConfigBy)为空，请检查！(In BindGv_vgs_UserConfig)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    orderBy: gs_UserConfigCRUD.sortvgs_UserConfigBy,
                    sortFun: (x, y) => { console.log(x, y); return 0; }
                };
                const responseObjLst = await (0, clsvgs_UserConfigWApi_js_5.vgs_UserConfig_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                    arrvgs_UserConfigObjLst = jsonData;
                });
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
        ...
        **/
        async BindGv_vgs_UserConfig_Cache() {
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: gs_UserConfigCRUD.sortvgs_UserConfigBy,
                    sortFun: clsvgs_UserConfigWApi_js_6.vgs_UserConfig_SortFun_Defa
                };
                arrvgs_UserConfigObjLst = await (0, clsvgs_UserConfigWApi_js_7.vgs_UserConfig_GetObjLstByPager_Cache)(objPagerPara);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SortBy(objAnchorElement) {
            ...
            const { sortFun, ascOrDesc4SortFun, sortBy } = (0, clsOperateList_js_1.GetSortBy)(objAnchorElement, gs_UserConfigCRUD.ascOrDesc4SortFun, gs_UserConfigCRUD.sortvgs_UserConfigBy, strSortExpress);
        ...
        **/
        async CopyRecord(arrConfigId) {
            const strThisFuncName = this.CopyRecord.name;
            try {
                const arrgs_UserConfigObjLst = await (0, clsgs_UserConfigWApi_js_3.gs_UserConfig_GetObjLstByConfigIdLstAsync)(arrConfigId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrgs_UserConfigObjLst) {
                    const returnBool = await (0, clsgs_UserConfigWApi_js_4.gs_UserConfig_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrConfigId) {
            const strThisFuncName = this.DelMultiRecord.name;
            try {
                const returnInt = await (0, clsgs_UserConfigWApi_js_5.gs_UserConfig_Delgs_UserConfigsAsync)(arrConfigId);
                if (returnInt > 0) {
                    //gs_UserConfig_ReFreshCache();
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        Showgs_UserConfigObj(divContainer, objgs_UserConfig) {
            ...
            const sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objgs_UserConfig);
    ...
    exports.gs_UserConfigCRUD = gs_UserConfigCRUD;
    gs_UserConfigCRUD.ascOrDesc4SortFun = "Asc";
    gs_UserConfigCRUD.sortvgs_UserConfigBy = "";
});
