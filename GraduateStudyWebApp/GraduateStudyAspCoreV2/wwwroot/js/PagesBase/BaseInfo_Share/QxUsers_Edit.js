(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/L3_ForWApi/UserManage/clsQxDepartmentInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsXzClgWApi.js", "../../TS/L3_ForWApi/SysPara/clsXzGradeBaseWApi.js", "../../TS/L3_ForWApi/UserManage_Share/clsUserIdentityWApi.js", "../../TS/PubFun/clsPublocalStorage.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L0_Entity/BaseInfo/clsQxUsersEN.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsQxUsersWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    class QxUsers_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../BaseInfo_Share/QxUsers_Edit";
        ...
        **/
        ShowDialog_QxUsers(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_QxUsers");
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_QxUsers");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_QxUsers', '添加记录');
                //QxUsers_EditEx.GetMaxStrId('#txtUserId');
            }
            else if (strOp === "Update") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_QxUsers', '修改记录');
            }
            else if (strOp === "Detail") {
                const btnSubmit_QxUsers = (0, clsCommFunc4Ctrl_js_2.getButtonObjByIdInDiv)(this.divName4Edit, 'btnSubmit_QxUsers');
                btnSubmit_QxUsers.hidden = true;
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_QxUsers', '详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async GetDataFromQxUsersClass(pobjQxUsersEN) {
        ...
        **/
        set avatarsPicture(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtAvatarsPicture", value);
        }
        /**
        * AvatarsPicture (Used In PutDataToClass())
        **/
        get avatarsPicture() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtAvatarsPicture");
        ...
        **/
        set beginYearMonth(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtBeginYearMonth", value);
        }
        /**
        * 开始年月 (Used In PutDataToClass())
        **/
        get beginYearMonth() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtBeginYearMonth");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set btnCancel_QxUsers(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_QxUsers", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_QxUsers() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_QxUsers");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_QxUsers(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_QxUsers", value);
        }
        /**
        * Card_State (Used In Clear())
        **/
        set card_State(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtCard_State", value);
        }
        /**
        * Card_State (Used In PutDataToClass())
        **/
        get card_State() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtCard_State");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set departmentId(value) {
            (0, clsCommFunc4Ctrl_js_3.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlDepartmentId", value);
        }
        /**
        * 部门Id (Used In PutDataToClass())
        **/
        get departmentId() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetSelectValueInDiv)(this.divName4Edit, "ddlDepartmentId");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set effectiveDate(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtEffectiveDate", value);
        }
        /**
        * EffectiveDate (Used In PutDataToClass())
        **/
        get effectiveDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtEffectiveDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set effitiveBeginDate(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtEffitiveBeginDate", value);
        }
        /**
        * EffitiveBeginDate (Used In PutDataToClass())
        **/
        get effitiveBeginDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtEffitiveBeginDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set effitiveEndDate(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtEffitiveEndDate", value);
        }
        /**
        * EffitiveEndDate (Used In PutDataToClass())
        **/
        get effitiveEndDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtEffitiveEndDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set endYearMonth(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtEndYearMonth", value);
        }
        /**
        * 结束年月 (Used In PutDataToClass())
        **/
        get endYearMonth() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtEndYearMonth");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set id_College(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_College", value);
        }
        /**
        * 学院流水号 (Used In PutDataToClass())
        **/
        get id_College() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtid_College");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set isArchive(value) {
            (0, clsCommFunc4Ctrl_js_3.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsArchive", value);
        }
        /**
        * IsArchive (Used In PutDataToClass())
        **/
        get isArchive() {
            const bolValue = (0, clsCommFunc4Ctrl_js_3.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsArchive");
            return bolValue;
        }
        /**
        ...
        **/
        set optDate(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtOptDate", value);
        }
        /**
        * OptDate (Used In PutDataToClass())
        **/
        get optDate() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtOptDate");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set optUser(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtOptUser", value);
        }
        /**
        * OptUser (Used In PutDataToClass())
        **/
        get optUser() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtOptUser");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set schoolID1(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtSchoolID1", value);
        }
        /**
        * 学校编号 (Used In PutDataToClass())
        **/
        get schoolID1() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtSchoolID1");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set stuTeacherID(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtStuTeacherID", value);
        }
        /**
        * 学工号 (Used In PutDataToClass())
        **/
        get stuTeacherID() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtStuTeacherID");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
