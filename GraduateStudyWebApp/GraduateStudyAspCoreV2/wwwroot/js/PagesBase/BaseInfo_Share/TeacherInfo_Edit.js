(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/L3_ForWApi/SysPara/clsSexWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L0_Entity/BaseInfo_Share/clsTeacherInfoEN.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
    ...
    **/
    ...
    const clsTeacherInfoWApi_js_7 = require("../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js");
    const clsTeacherInfoEN_js_1 = require("../../TS/L0_Entity/BaseInfo_Share/clsTeacherInfoEN.js");
    const clsTeacherInfoWApi_js_8 = require("../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js");
    const clsTeacherInfoWApi_js_9 = require("../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js");
    const clsTeacherInfoWApi_js_10 = require("../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js");
    const clsTeacherInfoWApi_js_11 = require("../../TS/L3_ForWApi/BaseInfo_Share/clsTeacherInfoWApi.js");
    ...
    class TeacherInfo_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../BaseInfo_Share/TeacherInfo_Edit";
        ...
        **/
        ShowDialog_TeacherInfo(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_TeacherInfo");
            (0, clsCommFunc4Ctrl_js_3.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_TeacherInfo");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_TeacherInfo', '添加记录');
                //TeacherInfo_EditEx.GetMaxStrId('#txtid_Teacher');
            }
            else if (strOp === "Update") {
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_TeacherInfo', '修改记录');
            }
            else if (strOp === "Detail") {
                const btnSubmit_TeacherInfo = (0, clsCommFunc4Ctrl_js_2.getButtonObjByIdInDiv)(this.divName4Edit, 'btnSubmit_TeacherInfo');
                btnSubmit_TeacherInfo.hidden = true;
                (0, clsCommFunc4Ctrl_js_1.SetH4HtmlByIdInDiv)(this.divName4Edit, 'lblDialogTitle_TeacherInfo', '详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async GetDataFromTeacherInfoClass(pobjTeacherInfoEN) {
        ...
        **/
        set btnCancel_TeacherInfo(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_TeacherInfo", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_TeacherInfo() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_TeacherInfo");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_TeacherInfo(value) {
            (0, clsCommFunc4Ctrl_js_3.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_TeacherInfo", value);
        }
        /**
        * 性别流水号 (Used In Clear())
        **/
        set id_Sex(value) {
            (0, clsCommFunc4Ctrl_js_3.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlid_Sex", value);
        }
        /**
        * 性别流水号 (Used In PutDataToClass())
        **/
        get id_Sex() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetSelectValueInDiv)(this.divName4Edit, "ddlid_Sex");
        ...
        **/
        set id_Teacher(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtid_Teacher", value);
        }
        /**
        * 教师流水号 (Used In PutDataToClass())
        **/
        get id_Teacher() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtid_Teacher");
            if (strValue == undefined)
                return "";
            else
        ...
        **/
        set teacherID(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtTeacherID", value);
        }
        /**
        * 教师工号 (Used In PutDataToClass())
        **/
        get teacherID() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtTeacherID");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set teacherName(value) {
            (0, clsCommFunc4Ctrl_js_3.SetInputValueByIdInDiv)(this.divName4Edit, "txtTeacherName", value);
        }
        /**
        * 教师姓名 (Used In PutDataToClass())
        **/
        get teacherName() {
            const strValue = (0, clsCommFunc4Ctrl_js_3.GetInputValueInDiv)(this.divName4Edit, "txtTeacherName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
