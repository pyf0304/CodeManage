(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseTypeWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L0_Entity/CourseLearning/clscc_CourseEN.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../TS/PubFun/clsPublocalStorage.js"], factory);
    }
    ...
    **/
    ...
    const clscc_CourseWApi_js_7 = require("../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js");
    const clscc_CourseEN_js_1 = require("../../TS/L0_Entity/CourseLearning/clscc_CourseEN.js");
    const clscc_CourseWApi_js_8 = require("../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js");
    const clscc_CourseWApi_js_9 = require("../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js");
    const clscc_CourseWApi_js_10 = require("../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js");
    const clscc_CourseWApi_js_11 = require("../../TS/L3_ForWApi/CourseLearning/clscc_CourseWApi.js");
    ...
    class cc_Course_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../CourseLearning/cc_Course_Edit";
        ...
        **/
        ShowDialog_cc_Course(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_cc_Course");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_cc_Course");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                $('#lblDialogTitle_cc_Course').html('添加记录');
                //cc_Course_EditEx.GetMaxStrId('#txtCourseId');
            }
            else if (strOp === "Update") {
                $('#lblDialogTitle_cc_Course').html('修改记录');
            }
            else if (strOp === "Detail") {
                $('#btnSubmit_cc_Course').hide();
                $('#lblDialogTitle_cc_Course').html('详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        set btnCancel_cc_Course(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_cc_Course", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_cc_Course() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_cc_Course");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_cc_Course(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_cc_Course", value);
        }
        /**
        * 课程代码 (Used In Clear())
        **/
        set courseCode(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtCourseCode", value);
        }
        /**
        * 课程代码 (Used In PutDataToClass())
        **/
        get courseCode() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtCourseCode");
        ...
        **/
        set courseDescription(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtCourseDescription", value);
        }
        /**
        * 课程描述 (Used In PutDataToClass())
        **/
        get courseDescription() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtCourseDescription");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set courseName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtCourseName", value);
        }
        /**
        * 课程名称 (Used In PutDataToClass())
        **/
        get courseName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtCourseName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set courseTypeID(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlCourseTypeID", value);
        }
        /**
        * 课程类型ID (Used In PutDataToClass())
        **/
        get courseTypeID() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Edit, "ddlCourseTypeID");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set isOpen(value) {
            (0, clsCommFunc4Ctrl_js_1.SetCheckBoxValueByIdInDiv)(this.divName4Edit, "chkIsOpen", value);
        }
        /**
        * 是否公开 (Used In PutDataToClass())
        **/
        get isOpen() {
            const bolValue = (0, clsCommFunc4Ctrl_js_1.GetCheckBoxValueInDiv)(this.divName4Edit, "chkIsOpen");
            return bolValue;
        }
        /**
        * 备注 (Used In Clear())
