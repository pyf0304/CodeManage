(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L0_Entity/InteractManage/clsqa_QuestionsEN.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_QuestionsWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../TS/PubFun/clsPublocalStorage.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.qa_Questions_Edit = void 0;
    /**
    ...
    **/
    class qa_Questions_Edit {
        constructor(objShowList) {
            ...
            this.objqa_Questions = new clsqa_QuestionsEN_js_1.clsqa_QuestionsEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_qa_Questions(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_qa_Questions");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_qa_Questions");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (qa_Questions_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_qa_Questions;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsqa_QuestionsEN_js_1.clsqa_QuestionsEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsqa_QuestionsEN_js_1.clsqa_QuestionsEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsqa_QuestionsWApi_js_1.qa_Questions_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表qa_Questions的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async PutDataToqa_QuestionsClass(pobjqa_QuestionsEN) {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objqa_QuestionsEN = new clsqa_QuestionsEN_js_1.clsqa_QuestionsEN();
            try {
            ...
            try {
                (0, clsqa_QuestionsWApi_js_2.qa_Questions_CheckPropertyNew)(objqa_QuestionsEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsqa_QuestionsWApi_js_3.qa_Questions_AddNewRecordWithMaxIdAsync)(objqa_QuestionsEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
                    (0, clsqa_QuestionsWApi_js_4.qa_Questions_ReFreshCache)();
        ...
        **/
        async CheckUniCond4Add_QuestionsId(objqa_QuestionsEN) {
            const strThisFuncName = this.CheckUniCond4Add_QuestionsId.name;
            const strUniquenessCondition = (0, clsqa_QuestionsWApi_js_5.qa_Questions_GetUniCondStr_QuestionsId)(objqa_QuestionsEN);
            const bolIsExistCondition = await (0, clsqa_QuestionsWApi_js_6.qa_Questions_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_QuestionsId(objqa_QuestionsEN) {
            const strThisFuncName = this.CheckUniCond4Update_QuestionsId.name;
            const strUniquenessCondition = (0, clsqa_QuestionsWApi_js_7.qa_Questions_GetUniCondStr4Update_QuestionsId)(objqa_QuestionsEN);
            const bolIsExistCondition = await (0, clsqa_QuestionsWApi_js_6.qa_Questions_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsqa_QuestionsWApi_js_3.qa_Questions_AddNewRecordWithMaxIdAsync)(objqa_QuestionsEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strQuestionsId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objqa_QuestionsEN = new clsqa_QuestionsEN_js_1.clsqa_QuestionsEN();
            try {
                const returnBool = await (0, clsqa_QuestionsWApi_js_8.qa_Questions_IsExistAsync)(strQuestionsId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strQuestionsId);
            ...
            try {
                const objqa_QuestionsEN_Const = await (0, clsqa_QuestionsWApi_js_9.qa_Questions_GetObjByQuestionsIdAsync)(strQuestionsId);
        ...
        **/
        async UpdateRecord(strQuestionsId) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsqa_QuestionsWApi_js_10.qa_Questions_CheckProperty4Update)(objqa_QuestionsEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsqa_QuestionsWApi_js_11.qa_Questions_UpdateRecordAsync)(objqa_QuestionsEN);
                if (returnBool == true) {
                    (0, clsqa_QuestionsWApi_js_4.qa_Questions_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_qa_Questions(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_qa_Questions", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_qa_Questions() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_qa_Questions");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_qa_Questions(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_qa_Questions", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
        ...
        **/
        set questionsContent(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtQuestionsContent", value);
        }
        /**
        * 提问内容 (Used In PutDataToClass())
        **/
        get questionsContent() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtQuestionsContent");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    exports.qa_Questions_Edit = qa_Questions_Edit;
    qa_Questions_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
