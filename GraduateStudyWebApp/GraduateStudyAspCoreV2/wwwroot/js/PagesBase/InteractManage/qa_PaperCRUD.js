(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../../TS/L0_Entity/InteractManage/clsvqa_PaperEN.js", "../../TS/L0_Entity/InteractManage/clsvqa_PaperENEx.js", "../../TS/L3_ForWApiEx/InteractManage/clsvqa_PaperExWApi.js", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../../TS/L3_ForWApi/InteractManage/clsqa_PaperWApi.js", "../../TS/L0_Entity/InteractManage/clsqa_PaperEN.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
    ...
    **/
    ...
    const clsvqa_PaperWApi_js_2 = require("../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js");
    const clsvqa_PaperWApi_js_3 = require("../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js");
    const clsvqa_PaperWApi_js_4 = require("../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js");
    ...
    const clsvqa_PaperENEx_js_1 = require("../../TS/L0_Entity/InteractManage/clsvqa_PaperENEx.js");
    const clsvqa_PaperExWApi_js_1 = require("../../TS/L3_ForWApiEx/InteractManage/clsvqa_PaperExWApi.js");
    const clsvqa_PaperWApi_js_5 = require("../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js");
    const clsvqa_PaperWApi_js_6 = require("../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js");
    const clsvqa_PaperWApi_js_7 = require("../../TS/L3_ForWApi/InteractManage/clsvqa_PaperWApi.js");
    ...
    **/
    class qa_PaperCRUD {
        ...
        **/
        CombineData(arrvqa_PaperObjLst, arrDataColumn) {
            ...
            for (let i = 0; i < intRowNum; i++) {
                ...
                const objEN = arrvqa_PaperObjLst[i];
                for (let j = 0; j < intColNum; j++) {
            ...
            const strFileName = (0, clsString_js_1.Format)("论文答疑表({0})导出.xlsx", clsvqa_PaperEN_js_1.clsvqa_PaperEN._CurrTabName);
            exportSpecialExcel_pyf(arrData, strFileName);
        }
        /** 根据条件获取相应的对象列表
        * (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_ExportExcel)
        **/
        async ExportExcel_vqa_Paper() {
            const strThisFuncName = this.ExportExcel_vqa_Paper.name;
            if (qa_PaperCRUD.sortvqa_PaperBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvqa_PaperBy)为空，请检查！(In BindGv_vqa_Paper_Cache)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            let arrvqa_PaperObjLst = [];
            try {
                this.recCount = await (0, clsvqa_PaperWApi_js_1.vqa_Paper_GetRecCountByCondAsync)(strWhereCond);
                if (this.recCount == 0) {
                ...
                arrvqa_PaperObjLst = await (0, clsvqa_PaperWApi_js_2.vqa_Paper_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async ExportExcel_vqa_Paper_Cache() {
            ...
            objvqa_Paper_Cond.SetCondFldValue(clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_id_CurrEduCls, qa_PaperCRUD.id_CurrEduCls_Cache, "=");
            const strWhereCond = JSON.stringify(objvqa_Paper_Cond);
            const intCurrPageIndex = (0, clsOperateList_js_1.GetCurrPageIndex)(this.objPager.currPageIndex); //获取当前页
            let arrvqa_PaperObjLst = [];
            try {
                this.recCount = await (0, clsvqa_PaperWApi_js_3.vqa_Paper_GetRecCountByCond_Cache)(objvqa_Paper_Cond, qa_PaperCRUD.id_CurrEduCls_Cache);
                if (this.recCount == 0) {
                    const lblMsg = document.createElement("span");
                    lblMsg.innerHTML = (0, clsString_js_1.Format)("根据条件:[{0}]获取的对象列表数为0！", objvqa_Paper_Cond.whereCond);
                    const divDataLst = document.getElementById("divDataLst");
                    if (divDataLst != null) {
                        divDataLst.innerText = "";
                        divDataLst.appendChild(lblMsg);
                    }
                    const strMsg = (0, clsString_js_1.Format)("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objvqa_Paper_Cond.whereCond);
                    console.error("Error: ", strMsg);
                    //console.trace();
                    alert(strMsg);
                    return;
                }
                arrvqa_PaperObjLst = await (0, clsvqa_PaperWApi_js_4.vqa_Paper_GetSubObjLst_Cache)(objvqa_Paper_Cond, qa_PaperCRUD.id_CurrEduCls_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            if (arrvqa_PaperObjLst.length == 0) {
                const strKey = (0, clsString_js_1.Format)("{0}_{1}", clsqa_PaperEN_js_1.clsqa_PaperEN._CurrTabName, qa_PaperCRUD.id_CurrEduCls_Cache);
        ...
        **/
        async btnSelectRecordInTab_Click(strqa_PaperId) {
        ...
        **/
        async DelRecord(strqa_PaperId) {
            ...
            try {
                const returnInt = await (0, clsqa_PaperWApi_js_1.qa_Paper_DelRecordAsync)(strqa_PaperId);
                if (returnInt > 0) {
        ...
        **/
        async SelectRecord(strqa_PaperId) {
            ...
            try {
                const objqa_PaperEN = await (0, clsqa_PaperWApi_js_2.qa_Paper_GetObjByqa_PaperIdAsync)(strqa_PaperId);
                //console.log("完成SelectRecord!", objqa_PaperEN);
                (0, clsCommFunc4Web_js_1.Redirect)("/Index/Main_vqa_Paper");
            }
            catch (e) {
        ...
        async Combinevqa_PaperCondition() {
            ...
            try {
                if (this.paperTitle_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_PaperTitle, this.paperTitle_q);
                }
                if (this.userName_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_UserName, this.userName_q);
                }
                if (this.updDate_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_UpdDate, this.updDate_q);
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0009)在组合查询条件(Combineqa_PaperCondition)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            return strWhereCond;
        }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async Combinevqa_PaperConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0010)在组合查询条件对象(Combineqa_PaperConditionObj)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async Combinevqa_PaperConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0013)在组合导出Excel条件对象(Combineqa_PaperConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            objvqa_Paper_Cond.whereCond = strWhereCond;
            return objvqa_Paper_Cond;
        ...
        **/
        async BindTab_vqa_Paper(divContainer, arrvqa_PaperObjLst) {
            ...
            const arrDataColumn = [
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_PaperTitle,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_PaperTitle,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "论文标题",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_IsPublic,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_IsPublic,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "是否公开",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_IsSubmit,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_IsSubmit,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "是否提交",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_UserName,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_UserName,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "用户名",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_UpdDate,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_UpdDate,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改日期",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_AttachmentCount,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_AttachmentCount,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "附件计数",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_QuestionsCount,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_QuestionsCount,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "提问计数",
                    text: "",
                ...
                {
                    fldName: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_AnswerCount,
                    sortBy: clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_AnswerCount,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "回答计数",
                    text: "",
            ...
            await (0, clsCommFunc4Web_js_1.BindTab_V)(o, arrvqa_PaperObjLst, arrDataColumn, clsvqa_PaperEN_js_1.clsvqa_PaperEN.con_qa_PaperId, this);
        ...
        **/
        async ExtendFldFuncMap(arrvqa_PaperExObjLst, arrDataColumn) {
            ...
            for (const objDataColumn of arrDataColumn) {
                ...
                for (const objInFor of arrvqa_PaperExObjLst) {
                    await (0, clsvqa_PaperExWApi_js_1.vqa_PaperEx_FuncMapByFldName)(objDataColumn.fldName, objInFor);
                }
            }
        }
        /** 函数功能:在数据列表中跳转到前一页
        ...
        **/
        async BindGv_vqa_Paper() {
            ...
            if (qa_PaperCRUD.sortvqa_PaperBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortvqa_PaperBy)为空，请检查！(In BindGv_vqa_Paper)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                const responseObjLst = await (0, clsvqa_PaperWApi_js_5.vqa_Paper_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
        ...
        async BindGv_vqa_Paper_Cache() {
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    whereCond: strWhereCond,
                    orderBy: qa_PaperCRUD.sortvqa_PaperBy,
                    sortFun: clsvqa_PaperWApi_js_6.vqa_Paper_SortFun_Defa
                };
                arrvqa_PaperObjLst = await (0, clsvqa_PaperWApi_js_7.vqa_Paper_GetObjLstByPager_Cache)(objPagerPara, qa_PaperCRUD.id_CurrEduCls_Cache);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SortBy(objAnchorElement) {
            ...
            const { sortFun, ascOrDesc4SortFun, sortBy } = (0, clsOperateList_js_1.GetSortBy)(objAnchorElement, qa_PaperCRUD.ascOrDesc4SortFun, qa_PaperCRUD.sortvqa_PaperBy, strSortExpress);
        ...
        **/
        async CopyRecord(arrqa_PaperId) {
            const strThisFuncName = this.CopyRecord.name;
            try {
                const arrqa_PaperObjLst = await (0, clsqa_PaperWApi_js_3.qa_Paper_GetObjLstByqa_PaperIdLstAsync)(arrqa_PaperId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrqa_PaperObjLst) {
                    const strMaxStrId = await (0, clsqa_PaperWApi_js_4.qa_Paper_GetMaxStrIdAsync)();
                    //console.log('strMaxStrId=' + strMaxStrId);
                    objInFor.qa_PaperId = strMaxStrId;
                    const returnBool = await (0, clsqa_PaperWApi_js_5.qa_Paper_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrqa_PaperId) {
            ...
            try {
                const returnInt = await (0, clsqa_PaperWApi_js_6.qa_Paper_Delqa_PapersAsync)(arrqa_PaperId);
                if (returnInt > 0) {
                    //qa_Paper_ReFreshCache(qa_PaperCRUD.id_CurrEduCls_Cache);
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        Showqa_PaperObj(divContainer, objqa_Paper) {
            ...
            const sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objqa_Paper);
    ...
    qa_PaperCRUD.ascOrDesc4SortFun = "Asc";
    qa_PaperCRUD.sortvqa_PaperBy = "";
    qa_PaperCRUD.id_CurrEduCls_Cache = ""; //缓存分类字段
});
