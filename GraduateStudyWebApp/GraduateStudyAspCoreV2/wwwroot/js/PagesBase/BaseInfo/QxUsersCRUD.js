(function (factory) {
    ...
    **/
    class QxUsersCRUD {
        ...
        **/
        async BindGv_QxUsers() {
            ...
            try {
                ...
                const responseObjLst = await (0, clsQxUsersWApi_js_7.QxUsers_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
        ...
        **/
        get departmentId_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Query, "ddlDepartmentId_q");
        ...
        **/
        set departmentId_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Query, "ddlDepartmentId_q", value);
        }
        /**
        * 年级流水号 (Used In CombineCondition())
        **/
        get id_GradeBase_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Query, "ddlid_GradeBase_q");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set id_GradeBase_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Query, "ddlid_GradeBase_q", value);
        }
        /**
        ...
        **/
        get identityID_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Query, "ddlIdentityID_q");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set identityID_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Query, "ddlIdentityID_q", value);
        }
        /**
