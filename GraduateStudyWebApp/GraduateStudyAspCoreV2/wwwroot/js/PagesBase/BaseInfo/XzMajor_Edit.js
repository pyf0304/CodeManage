(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorShoolTypeWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzClgWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L0_Entity/BaseInfo/clsXzMajorEN.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../TS/PubFun/clsPublocalStorage.js"], factory);
    }
    ...
    **/
    ...
    const clsXzMajorWApi_js_2 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_3 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_4 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_5 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_6 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_7 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorEN_js_1 = require("../../TS/L0_Entity/BaseInfo/clsXzMajorEN.js");
    const clsXzMajorWApi_js_8 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_9 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_10 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    const clsXzMajorWApi_js_11 = require("../../TS/L3_ForWApi/BaseInfo/clsXzMajorWApi.js");
    ...
    class XzMajor_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../BaseInfo/XzMajor_Edit";
        ...
        **/
        ShowDialog_XzMajor(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_XzMajor");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_XzMajor");
            if (strOp === "Add" || strOp === "AddWithMaxId") {
                $('#lblDialogTitle_XzMajor').html('添加记录');
                //XzMajor_EditEx.GetMaxStrId('#txtid_XzMajor');
            }
            else if (strOp === "Update") {
                $('#lblDialogTitle_XzMajor').html('修改记录');
            }
            else if (strOp === "Detail") {
                $('#btnSubmit_XzMajor').hide();
                $('#lblDialogTitle_XzMajor').html('详细信息');
            }
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        set btnCancel_XzMajor(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_XzMajor", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_XzMajor() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_XzMajor");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_XzMajor(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_XzMajor", value);
        }
        /**
        * 学院流水号 (Used In Clear())
        **/
        ...
        **/
        set id_XzMajorShoolType(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlid_XzMajorShoolType", value);
        }
        /**
        * 专业学校类型流水号 (Used In PutDataToClass())
        **/
        get id_XzMajorShoolType() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Edit, "ddlid_XzMajorShoolType");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
        ...
        **/
        set majorDirection(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMajorDirection", value);
        }
        /**
        * 专业方向 (Used In PutDataToClass())
        **/
        get majorDirection() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMajorDirection");
            if (strValue == undefined)
                return "";
            else
        ...
        **/
        set majorEnglishName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMajorEnglishName", value);
        }
        /**
        * 专业英文名称 (Used In PutDataToClass())
        **/
        get majorEnglishName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMajorEnglishName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set majorExplain(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMajorExplain", value);
        }
        /**
        * 专业说明 (Used In PutDataToClass())
        **/
        get majorExplain() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMajorExplain");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set majorID(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMajorID", value);
        }
        /**
        * 专业ID (Used In PutDataToClass())
        **/
        get majorID() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMajorID");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set majorName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtMajorName", value);
        }
        /**
        * 专业名称 (Used In PutDataToClass())
        **/
        get majorName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtMajorName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
