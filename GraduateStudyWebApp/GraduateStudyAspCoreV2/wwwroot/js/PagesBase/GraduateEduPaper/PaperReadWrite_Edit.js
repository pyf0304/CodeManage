(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApiEx/GraduateEduPaper/clsvPaperSimProExWApi.js", "../../TS/L3_ForWApi/SysPara/clsOperationTypeWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L0_Entity/GraduateEduPaper/clsPaperReadWriteEN.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PaperReadWrite_Edit = void 0;
    /**
    ...
    **/
    ...
    const clsPaperReadWriteWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js");
    const clsPaperReadWriteEN_js_1 = require("../../TS/L0_Entity/GraduateEduPaper/clsPaperReadWriteEN.js");
    const clsPaperReadWriteWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js");
    const clsPaperReadWriteWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js");
    const clsPaperReadWriteWApi_js_10 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js");
    const clsPaperReadWriteWApi_js_11 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperReadWriteWApi.js");
    ...
    **/
    class PaperReadWrite_Edit {
        constructor(objShowList) {
            ...
            this.objPaperReadWrite = new clsPaperReadWriteEN_js_1.clsPaperReadWriteEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_PaperReadWrite(strOp) {
            const strThisFuncName = this.ShowDialog_PaperReadWrite.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_PaperReadWrite");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_PaperReadWrite");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (PaperReadWrite_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async SetDdl_OperationTypeIdInDiv() {
            await (0, clsOperationTypeWApi_js_1.OperationType_BindDdl_OperationTypeIdInDiv_Cache)(this.divName4Edit, "ddlOperationTypeId"); //
        }
        /** 函数功能:为编辑区绑定下拉框
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_PaperReadWrite;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsPaperReadWriteEN_js_1.clsPaperReadWriteEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsPaperReadWriteWApi_js_1.PaperReadWrite_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表PaperReadWrite的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objPaperReadWriteEN = new clsPaperReadWriteEN_js_1.clsPaperReadWriteEN();
            try {
            ...
            try {
                (0, clsPaperReadWriteWApi_js_2.PaperReadWrite_CheckPropertyNew)(objPaperReadWriteEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsPaperReadWriteWApi_js_3.PaperReadWrite_AddNewRecordWithMaxIdAsync)(objPaperReadWriteEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
                    (0, clsPaperReadWriteWApi_js_4.PaperReadWrite_ReFreshCache)(PaperReadWrite_Edit.id_CurrEduCls_Cache);
        ...
        **/
        async CheckUniCond4Add_ReaderId_PaperId(objPaperReadWriteEN) {
            const strThisFuncName = this.CheckUniCond4Add_ReaderId_PaperId.name;
            const strUniquenessCondition = (0, clsPaperReadWriteWApi_js_5.PaperReadWrite_GetUniCondStr_ReaderId_PaperId)(objPaperReadWriteEN);
            const bolIsExistCondition = await (0, clsPaperReadWriteWApi_js_6.PaperReadWrite_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_ReaderId_PaperId(objPaperReadWriteEN) {
            const strThisFuncName = this.CheckUniCond4Update_ReaderId_PaperId.name;
            const strUniquenessCondition = (0, clsPaperReadWriteWApi_js_7.PaperReadWrite_GetUniCondStr4Update_ReaderId_PaperId)(objPaperReadWriteEN);
            const bolIsExistCondition = await (0, clsPaperReadWriteWApi_js_6.PaperReadWrite_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsPaperReadWriteWApi_js_3.PaperReadWrite_AddNewRecordWithMaxIdAsync)(objPaperReadWriteEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strPaperRWId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objPaperReadWriteEN = new clsPaperReadWriteEN_js_1.clsPaperReadWriteEN();
            try {
                const returnBool = await (0, clsPaperReadWriteWApi_js_8.PaperReadWrite_IsExistAsync)(strPaperRWId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strPaperRWId);
            ...
            try {
                const objPaperReadWriteEN_Const = await (0, clsPaperReadWriteWApi_js_9.PaperReadWrite_GetObjByPaperRWIdAsync)(strPaperRWId);
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsPaperReadWriteWApi_js_10.PaperReadWrite_CheckProperty4Update)(objPaperReadWriteEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsPaperReadWriteWApi_js_11.PaperReadWrite_UpdateRecordAsync)(objPaperReadWriteEN);
                if (returnBool == true) {
                    (0, clsPaperReadWriteWApi_js_4.PaperReadWrite_ReFreshCache)(PaperReadWrite_Edit.id_CurrEduCls_Cache);
                }
                return returnBool;
        ...
        **/
        set btnCancel_PaperReadWrite(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_PaperReadWrite", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_PaperReadWrite() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_PaperReadWrite");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_PaperReadWrite(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_PaperReadWrite", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
        ...
        **/
        set readerId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtReaderId", value);
        }
        /**
        * 阅读者Id (Used In PutDataToClass())
        **/
        get readerId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtReaderId");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    exports.PaperReadWrite_Edit = PaperReadWrite_Edit;
    PaperReadWrite_Edit.id_CurrEduCls_Cache = "";
    PaperReadWrite_Edit.id_CurrEduCls_Static = ""; //定义下拉框条件变量1
    PaperReadWrite_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
