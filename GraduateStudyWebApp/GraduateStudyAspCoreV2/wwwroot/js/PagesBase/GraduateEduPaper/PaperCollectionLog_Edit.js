(function (factory) {
    ...
    **/
    ...
    const clsPaperCollectionLogWApi_js_5 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperCollectionLogWApi.js");
    const clsPaperCollectionLogWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperCollectionLogWApi.js");
    const clsPaperCollectionLogWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperCollectionLogWApi.js");
    const clsPaperCollectionLogWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperCollectionLogWApi.js");
    const clsPaperCollectionLogWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsPaperCollectionLogWApi.js");
    ...
    **/
    class PaperCollectionLog_Edit {
        constructor(objShowList) {
            ...
            this.objPaperCollectionLog = new clsPaperCollectionLogEN_js_1.clsPaperCollectionLogEN();
        }
        /**
        * 在当前界面中，导入编辑区域
        ...
        **/
        ShowDialog_PaperCollectionLog(strOp) {
            const strThisFuncName = this.ShowDialog_PaperCollectionLog.name;
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_PaperCollectionLog");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_PaperCollectionLog");
                ...
                if (this.bolIsLoadEditRegion == false) //
                 {
                    ...
                    if (PaperCollectionLog_Edit.strPageDispModeId == clsPageDispModeEN_js_1.enumPageDispMode.PopupBox_01) {
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_PaperCollectionLog;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsPaperCollectionLogEN_js_1.clsPaperCollectionLogEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async PutDataToPaperCollectionLogClass(pobjPaperCollectionLogEN) {
            const strThisFuncName = this.PutDataToPaperCollectionLogClass.name;
            pobjPaperCollectionLogEN.SetPaperId(this.paperId); // 论文Id
            pobjPaperCollectionLogEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
            pobjPaperCollectionLogEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objPaperCollectionLogEN = new clsPaperCollectionLogEN_js_1.clsPaperCollectionLogEN();
            try {
            ...
            try {
                (0, clsPaperCollectionLogWApi_js_1.PaperCollectionLog_CheckPropertyNew)(objPaperCollectionLogEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                returnBool = await (0, clsPaperCollectionLogWApi_js_2.PaperCollectionLog_AddNewRecordAsync)(objPaperCollectionLogEN);
                if (returnBool == true) {
        ...
        **/
        async CheckUniCond4Add_PaperCollectionLogId(objPaperCollectionLogEN) {
            const strThisFuncName = this.CheckUniCond4Add_PaperCollectionLogId.name;
            const strUniquenessCondition = (0, clsPaperCollectionLogWApi_js_3.PaperCollectionLog_GetUniCondStr_PaperCollectionLogId)(objPaperCollectionLogEN);
            const bolIsExistCondition = await (0, clsPaperCollectionLogWApi_js_4.PaperCollectionLog_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_PaperCollectionLogId(objPaperCollectionLogEN) {
            const strThisFuncName = this.CheckUniCond4Update_PaperCollectionLogId.name;
            const strUniquenessCondition = (0, clsPaperCollectionLogWApi_js_5.PaperCollectionLog_GetUniCondStr4Update_PaperCollectionLogId)(objPaperCollectionLogEN);
            const bolIsExistCondition = await (0, clsPaperCollectionLogWApi_js_4.PaperCollectionLog_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(lngPaperCollectionLogId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objPaperCollectionLogEN = new clsPaperCollectionLogEN_js_1.clsPaperCollectionLogEN();
            try {
                const returnBool = await (0, clsPaperCollectionLogWApi_js_6.PaperCollectionLog_IsExistAsync)(lngPaperCollectionLogId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", lngPaperCollectionLogId);
            ...
            try {
                const objPaperCollectionLogEN_Const = await (0, clsPaperCollectionLogWApi_js_7.PaperCollectionLog_GetObjByPaperCollectionLogIdAsync)(lngPaperCollectionLogId);
        ...
        **/
        async UpdateRecord(lngPaperCollectionLogId) {
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsPaperCollectionLogWApi_js_8.PaperCollectionLog_CheckProperty4Update)(objPaperCollectionLogEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsPaperCollectionLogWApi_js_9.PaperCollectionLog_UpdateRecordAsync)(objPaperCollectionLogEN);
                if (returnBool == true) {
                    //PaperCollectionLog_ReFreshCache();
                }
                return returnBool;
        ...
        **/
        set btnCancel_PaperCollectionLog(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_PaperCollectionLog", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_PaperCollectionLog() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_PaperCollectionLog");
            return strValue;
        }
        /**
        * 设置确定按钮的标题(Used In AddNewRecord())
        **/
        set btnSubmit_PaperCollectionLog(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_PaperCollectionLog", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
    ...
    exports.PaperCollectionLog_Edit = PaperCollectionLog_Edit;
    PaperCollectionLog_Edit.id_CurrEduCls_Static = ""; //定义下拉框条件变量1
    PaperCollectionLog_Edit.strPageDispModeId = "01"; //PopupBox(弹出框)
});
