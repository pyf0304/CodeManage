(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L0_Entity/GraduateEduPaper/clsgs_PaperGroupEN.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsgs_PaperGroupWApi.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsDateTime.js", "../../TS/L0_Entity/PrjMenu/clsPageDispModeEN.js", "../../TS/PubFun/clsPublocalStorage.js"], factory);
    }
    ...
    **/
    class gs_PaperGroup_Edit {
        ...
        **/
        async AddDPV_Edit(divName4Edit) {
            ...
            const strUrl = "../GraduateEduPaper/gs_PaperGroup_Edit";
        ...
        **/
        ShowDialog_gs_PaperGroup(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_gs_PaperGroup");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_gs_PaperGroup");
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv(clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv(clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        *  在用户自定义控件中，设置关键字的值，是否只读
        ...
        SetKeyReadOnly(bolReadonly) {
            ...
            $('#txtPaperGroupId').attr('ReadOnly', bolReadonly.toString());
        }
        /**
         * 清除用户自定义控件中，所有控件的值
        ...
        **/
        async AddNewRecord() {
            ...
            this.Clear();
            //wucgs_PaperGroupB1.paperGroupId = gs_PaperGroup_GetMaxStrId_S();
            try {
                const returnString = await (0, clsgs_PaperGroupWApi_js_1.gs_PaperGroup_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表gs_PaperGroup的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async PutDataTogs_PaperGroupClass(pobjgs_PaperGroupEN) {
            ...
            pobjgs_PaperGroupEN.SetPaperGroupId(this.paperGroupId); // 组Id
            pobjgs_PaperGroupEN.SetPaperGroupName(this.paperGroupName); // 组名
            pobjgs_PaperGroupEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
            pobjgs_PaperGroupEN.SetOrderNum(this.orderNum); // 序号
            pobjgs_PaperGroupEN.SetUpdDate(clsDateTime_js_1.clsDateTime.getTodayDateTimeStr(1)); // 修改日期
            pobjgs_PaperGroupEN.SetMeno(this.meno); // 备注
        }
        /** 添加新记录，保存函数
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objgs_PaperGroupEN = new clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN();
            try {
            ...
            try {
                (0, clsgs_PaperGroupWApi_js_2.gs_PaperGroup_CheckPropertyNew)(objgs_PaperGroupEN);
            }
            catch (e) {
            ...
            try {
                //检查唯一性条件
                const bolIsExistCond_PaperGroupName_UpdUser = await this.CheckUniCond4Add_PaperGroupName_UpdUser(objgs_PaperGroupEN);
                if (bolIsExistCond_PaperGroupName_UpdUser == false) {
                    return false;
                }
                let returnBool = false;
                const returnKeyId = await (0, clsgs_PaperGroupWApi_js_3.gs_PaperGroup_AddNewRecordWithMaxIdAsync)(objgs_PaperGroupEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
                    (0, clsgs_PaperGroupWApi_js_4.gs_PaperGroup_ReFreshCache)(gs_PaperGroup_Edit.UpdUser_Cache);
        ...
        **/
        async CheckUniCond4Add_PaperGroupName_UpdUser(objgs_PaperGroupEN) {
            const strThisFuncName = this.CheckUniCond4Add_PaperGroupName_UpdUser.name;
            const strUniquenessCondition = (0, clsgs_PaperGroupWApi_js_5.gs_PaperGroup_GetUniCondStr_PaperGroupName_UpdUser)(objgs_PaperGroupEN);
            const bolIsExistCondition = await (0, clsgs_PaperGroupWApi_js_6.gs_PaperGroup_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_PaperGroupName_UpdUser(objgs_PaperGroupEN) {
            const strThisFuncName = this.CheckUniCond4Update_PaperGroupName_UpdUser.name;
            const strUniquenessCondition = (0, clsgs_PaperGroupWApi_js_7.gs_PaperGroup_GetUniCondStr4Update_PaperGroupName_UpdUser)(objgs_PaperGroupEN);
            const bolIsExistCondition = await (0, clsgs_PaperGroupWApi_js_6.gs_PaperGroup_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsgs_PaperGroupWApi_js_3.gs_PaperGroup_AddNewRecordWithMaxIdAsync)(objgs_PaperGroupEN);
       ...
       * 在这里是把值传到表控件中
        ...
        * @param strPaperGroupId: 表记录的关键字,显示该表关键字的内容
        **/
        async ShowData(strPaperGroupId) {
            ...
            try {
                const returnBool = await (0, clsgs_PaperGroupWApi_js_8.gs_PaperGroup_IsExistAsync)(strPaperGroupId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strPaperGroupId);
            ...
            try {
                const objgs_PaperGroupEN_Const = await (0, clsgs_PaperGroupWApi_js_9.gs_PaperGroup_GetObjByPaperGroupIdAsync)(strPaperGroupId);
                if (objgs_PaperGroupEN_Const == null) {
                    const strMsg = (0, clsString_js_1.Format)("根据关键字获取相应的记录的对象为空.(in {0}.{1})", this.constructor.name, strThisFuncName);
                    console.error(strMsg);
                    alert(strMsg);
                    return;
                }
                objgs_PaperGroupEN = objgs_PaperGroupEN_Const;
            }
            catch (e) {
        ...
        **/
        async UpdateRecord(strPaperGroupId) {
            ...
            try {
                ...
                this.objgs_PaperGroup = objgs_PaperGroupEN_Const;
                const conGetDataFromClass = await this.GetDataFromgs_PaperGroupClass(objgs_PaperGroupEN_Const);
        ...
        **/
        async UpdateRecordSave() {
            ...
            const objgs_PaperGroupEN = new clsgs_PaperGroupEN_js_1.clsgs_PaperGroupEN();
            objgs_PaperGroupEN.SetPaperGroupId(this.keyId);
            await this.PutDataTogs_PaperGroupClass(objgs_PaperGroupEN);
            ...
            try {
                (0, clsgs_PaperGroupWApi_js_10.gs_PaperGroup_CheckProperty4Update)(objgs_PaperGroupEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                //检查唯一性条件
                const bolIsExistCond_PaperGroupName_UpdUser = await this.CheckUniCond4Update_PaperGroupName_UpdUser(objgs_PaperGroupEN);
                if (bolIsExistCond_PaperGroupName_UpdUser == false) {
                    return false;
                }
                const returnBool = await (0, clsgs_PaperGroupWApi_js_11.gs_PaperGroup_UpdateRecordAsync)(objgs_PaperGroupEN);
                if (returnBool == true) {
                    (0, clsgs_PaperGroupWApi_js_4.gs_PaperGroup_ReFreshCache)(gs_PaperGroup_Edit.UpdUser_Cache);
                }
                return returnBool;
        ...
        **/
        set btnCancel_gs_PaperGroup(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_gs_PaperGroup", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_gs_PaperGroup() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_gs_PaperGroup");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_gs_PaperGroup(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_gs_PaperGroup", value);
        }
        /**
        * 备注 (Used In Clear())
        **/
        ...
        **/
        set paperGroupId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtPaperGroupId", value);
        }
        /**
        * 组Id (Used In PutDataToClass())
        **/
        get paperGroupId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtPaperGroupId");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set paperGroupName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtPaperGroupName", value);
        }
        /**
        * 组名 (Used In PutDataToClass())
        **/
        get paperGroupName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtPaperGroupName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
    ...
    gs_PaperGroup_Edit.UpdUser_Cache = "";
