(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L0_Entity/GraduateEduPaper/clsJournalSubjectENEx.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApiEx/GraduateEduPaper/clsJournalSubjectExWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectCategoryWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L0_Entity/GraduateEduPaper/clsJournalSubjectEN.js", "../../TS/L3_ForWApiEx/GraduateEduPaper/clsJournalSubjectExWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApiEx/GraduateEduPaper/clsJournalSubjectExWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
    ...
    **/
    ...
    const clsJournalSubjectWApi_js_2 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    ...
    const clsJournalSubjectWApi_js_3 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectWApi_js_4 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectWApi_js_5 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectEN_js_1 = require("../../TS/L0_Entity/GraduateEduPaper/clsJournalSubjectEN.js");
    const clsJournalSubjectExWApi_js_2 = require("../../TS/L3_ForWApiEx/GraduateEduPaper/clsJournalSubjectExWApi.js");
    const clsJournalSubjectWApi_js_6 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectWApi_js_7 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectExWApi_js_3 = require("../../TS/L3_ForWApiEx/GraduateEduPaper/clsJournalSubjectExWApi.js");
    const clsJournalSubjectWApi_js_8 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectWApi_js_9 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectWApi_js_10 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    const clsJournalSubjectWApi_js_11 = require("../../TS/L3_ForWApi/GraduateEduPaper/clsJournalSubjectWApi.js");
    ...
    **/
    class JournalSubjectCRUD {
        ...
        **/
        CombineData(arrJournalSubjectObjLst, arrDataColumn) {
            ...
            for (let i = 0; i < intRowNum; i++) {
                ...
                const objEN = arrJournalSubjectObjLst[i];
                for (let j = 0; j < intColNum; j++) {
            ...
            const strFileName = (0, clsString_js_1.Format)("期刊学科({0})导出.xlsx", clsJournalSubjectEN_js_1.clsJournalSubjectEN._CurrTabName);
        ...
        **/
        CombineData4Func(arrJournalSubjectExObjLst, arrDataColumn) {
            ...
            for (let i = 0; i < intRowNum; i++) {
                const arrRow = new Array();
                const objEN = arrJournalSubjectExObjLst[i];
                for (let j = 0; j < intColNum; j++) {
                    arrRow.push(objEN.GetFldValue(arrDataColumn[j].fldName)); //i + "" + j;
                }
                arrData.push(arrRow);
        ...
        **/
        async ExportExcel_JournalSubject4Func() {
            ...
            if (JournalSubjectCRUD.sortJournalSubjectBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortJournalSubjectBy)为空，请检查！(In BindGv_JournalSubject_Cache)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            let arrJournalSubjectObjLst = [];
            let arrJournalSubjectExObjLst = [];
            try {
                ...
                if (this.recCount == 0) {
                    ...
                    lblMsg.innerHTML = (0, clsString_js_1.Format)("根据条件:[{0}]获取的对象列表数为0！", objJournalSubject_Cond.whereCond);
                    const divDataLst = document.getElementById("divDataLst");
                    if (divDataLst != null) {
                        divDataLst.innerText = "";
                        divDataLst.appendChild(lblMsg);
                    }
                    const strMsg = (0, clsString_js_1.Format)("在绑定Gv_Cache过程中，根据条件:[{0}]获取的对象列表数为0！", objJournalSubject_Cond.whereCond);
                    console.error("Error: ", strMsg);
                    //console.trace();
                    alert(strMsg);
                    return;
                }
                arrJournalSubjectObjLst = await (0, clsJournalSubjectWApi_js_2.JournalSubject_GetSubObjLst_Cache)(objJournalSubject_Cond);
                arrJournalSubjectExObjLst = arrJournalSubjectObjLst.map(clsJournalSubjectExWApi_js_1.JournalSubjectEx_CopyToEx);
            }
            catch (e) {
            ...
            if (arrJournalSubjectObjLst.length == 0) {
                const strKey = (0, clsString_js_1.Format)("{0}", clsJournalSubjectEN_js_1.clsJournalSubjectEN._CurrTabName);
        ...
        **/
        async btnSelectRecordInTab_Click(strJournalSubjectId) {
            const strThisFuncName = this.btnSelectRecordInTab_Click.name;
            try {
                if ((0, clsString_js_1.IsNullOrEmpty)(strJournalSubjectId) == true) {
        ...
        **/
        async DelRecord(strJournalSubjectId) {
            ...
            try {
                const returnInt = await (0, clsJournalSubjectWApi_js_3.JournalSubject_DelRecordAsync)(strJournalSubjectId);
                if (returnInt > 0) {
                    (0, clsJournalSubjectWApi_js_4.JournalSubject_ReFreshCache)();
        ...
        **/
        async SelectRecord(strJournalSubjectId) {
            ...
            try {
                const objJournalSubjectEN = await (0, clsJournalSubjectWApi_js_5.JournalSubject_GetObjByJournalSubjectIdAsync)(strJournalSubjectId);
                //console.log("完成SelectRecord!", objJournalSubjectEN);
                (0, clsCommFunc4Web_js_1.Redirect)("/Index/Main_JournalSubject");
            }
            catch (e) {
        ...
        **/
        async CombineJournalSubjectCondition() {
            ...
            try {
                if (this.journalSubjectId_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectId, this.journalSubjectId_q);
                }
                if (this.journalSubjectCode_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCode, this.journalSubjectCode_q);
                }
                if (this.journalSubjectName_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectName, this.journalSubjectName_q);
                }
                if (this.journalSubjectCategoryId_q != "" && this.journalSubjectCategoryId_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCategoryId, this.journalSubjectCategoryId_q);
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0009)在组合查询条件(CombineJournalSubjectCondition)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            return strWhereCond;
        }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombineJournalSubjectConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0010)在组合查询条件对象(CombineJournalSubjectConditionObj)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombineJournalSubjectConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0013)在组合导出Excel条件对象(CombineJournalSubjectConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            objJournalSubject_Cond.whereCond = strWhereCond;
            return objJournalSubject_Cond;
        ...
        **/
        async BindTab_JournalSubject(divContainer, arrJournalSubjectObjLst) {
            ...
            const arrDataColumn = [
                ...
                {
                    fldName: clsJournalSubjectENEx_js_1.clsJournalSubjectENEx.con_JournalSubjectCategoryName,
                ...
                {
                    fldName: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectId,
                ...
                {
                    fldName: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectCode,
                ...
                {
                    fldName: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectName,
                ...
                {
                    fldName: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdDate,
                    sortBy: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdDate,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改日期",
                    text: "",
                ...
                {
                    fldName: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdUser,
                    sortBy: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_UpdUser,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改人",
                    text: "",
                ...
                {
                    fldName: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_Memo,
                    sortBy: clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_Memo,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "备注",
                    text: "",
            ...
            await (0, clsCommFunc4Web_js_1.BindTab)(o, arrJournalSubjectObjLst, arrDataColumn, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectId, this);
        ...
        **/
        async BindTab_JournalSubject4Func(divContainer, arrJournalSubjectExObjLst) {
            ...
            await (0, clsCommFunc4Web_js_1.BindTab)(o, arrJournalSubjectExObjLst, arrDataColumn, clsJournalSubjectEN_js_1.clsJournalSubjectEN.con_JournalSubjectId, this);
            this.objPager.recCount = this.recCount;
            this.objPager.pageSize = this.pageSize;
            this.objPager.ShowPagerV2(this, this.divName4Pager);
        }
        ...
        **/
        async ExtendFldFuncMap(arrJournalSubjectExObjLst, arrDataColumn) {
            ...
            for (const objDataColumn of arrDataColumn) {
                ...
                for (const objInFor of arrJournalSubjectExObjLst) {
                    await (0, clsJournalSubjectExWApi_js_2.JournalSubjectEx_FuncMapByFldName)(objDataColumn.fldName, objInFor);
                }
            }
        }
        /** 函数功能:在数据列表中跳转到前一页
        ...
        **/
        async BindGv_JournalSubject_Cache() {
            ...
            try {
                ...
                const objPagerPara = {
                    ...
                    sortFun: clsJournalSubjectWApi_js_6.JournalSubject_SortFun_Defa
                };
                arrJournalSubjectObjLst = await (0, clsJournalSubjectWApi_js_7.JournalSubject_GetObjLstByPager_Cache)(objPagerPara);
            }
            catch (e) {
        ...
        **/
        async BindGv_JournalSubject4Func() {
            ...
            try {
                ...
                arrJournalSubjectExObjLst = await (0, clsJournalSubjectExWApi_js_3.JournalSubjectEx_GetObjExLstByPager_Cache)(objPagerPara);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
        ...
        **/
        async SortBy(objAnchorElement) {
            ...
            const { sortFun, ascOrDesc4SortFun, sortBy } = (0, clsOperateList_js_1.GetSortBy)(objAnchorElement, JournalSubjectCRUD.ascOrDesc4SortFun, JournalSubjectCRUD.sortJournalSubjectBy, strSortExpress);
        ...
        **/
        async CopyRecord(arrJournalSubjectId) {
            ...
            try {
                const arrJournalSubjectObjLst = await (0, clsJournalSubjectWApi_js_8.JournalSubject_GetObjLstByJournalSubjectIdLstAsync)(arrJournalSubjectId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrJournalSubjectObjLst) {
                    const strMaxStrId = await (0, clsJournalSubjectWApi_js_9.JournalSubject_GetMaxStrIdAsync)();
                    //console.log('strMaxStrId=' + strMaxStrId);
                    objInFor.journalSubjectId = strMaxStrId;
                    const returnBool = await (0, clsJournalSubjectWApi_js_10.JournalSubject_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrJournalSubjectId) {
            ...
            try {
                const returnInt = await (0, clsJournalSubjectWApi_js_11.JournalSubject_DelJournalSubjectsAsync)(arrJournalSubjectId);
                if (returnInt > 0) {
                    (0, clsJournalSubjectWApi_js_4.JournalSubject_ReFreshCache)();
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        ShowJournalSubjectObj(divContainer, objJournalSubject) {
            ...
            const sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objJournalSubject);
        ...
        **/
        get journalSubjectCode_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Query, "txtJournalSubjectCode_q");
            if (strValue == undefined)
                return "";
            else
        ...
        **/
        set journalSubjectCode_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Query, "txtJournalSubjectCode_q", value);
        }
        /**
        * 期刊学科Id (Used In CombineCondition())
        **/
        get journalSubjectId_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Query, "txtJournalSubjectId_q");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set journalSubjectId_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Query, "txtJournalSubjectId_q", value);
        }
        /**
        * 期刊学科名称 (Used In CombineCondition())
        **/
        get journalSubjectName_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Query, "txtJournalSubjectName_q");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set journalSubjectName_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Query, "txtJournalSubjectName_q", value);
        }
        /**
    ...
    JournalSubjectCRUD.ascOrDesc4SortFun = "Asc";
    JournalSubjectCRUD.sortJournalSubjectBy = "";
});
