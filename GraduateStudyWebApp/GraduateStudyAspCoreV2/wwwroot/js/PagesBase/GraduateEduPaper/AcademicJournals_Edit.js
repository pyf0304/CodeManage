    ...
    class AcademicJournals_Edit {
        ...
        **/
        ShowDialog_AcademicJournals(strOp) {
            ...
            //检查相关控件是否存在
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "div", "divEditDialog_AcademicJournals");
            (0, clsCommFunc4Ctrl_js_1.CheckControlExist)(this.divName4Edit, "h4", "lblDialogTitle_AcademicJournals");
        ...
        **/
        async SetDdl_JournalSubjectIdInDiv() {
            await (0, clsJournalSubjectWApi_js_1.JournalSubject_BindDdl_JournalSubjectIdInDiv_Cache)(this.divName4Edit, "ddlJournalSubjectId"); //
        }
        /** 函数功能:为编辑区绑定下拉框
        ...
        **/
        async btnSubmit_Click() {
            ...
            const strCommandText = this.btnSubmit_AcademicJournals;
            try {
                    ...
                    case "确认添加":
                        ...
                        if (this.opType == "AddWithMaxId") {
                            ...
                            if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                                ...
                                this.iShowList.BindGv_Cache(clsAcademicJournalsEN_js_1.clsAcademicJournalsEN._CurrTabName, returnKeyId);
                            }
                        }
                        else {
                            ...
                            if (returnBool == true) {
                                ...
                                this.iShowList.BindGv_Cache(clsAcademicJournalsEN_js_1.clsAcademicJournalsEN._CurrTabName, returnBool.toString());
                            }
                        }
                        break;
                    case "确认修改":
        ...
        **/
        async AddNewRecord() {
            ...
            try {
                const returnString = await (0, clsAcademicJournalsWApi_js_1.AcademicJournals_GetMaxStrIdAsync)();
                if (returnString == "") {
                    const strInfo = (0, clsString_js_1.Format)("获取表AcademicJournals的最大关键字为空，不成功，请检查!");
                    //显示信息框
                    alert(strInfo);
                }
                else {
        ...
        **/
        async PutDataToAcademicJournalsClass(pobjAcademicJournalsEN) {
        ...
        **/
        async AddNewRecordSave() {
            ...
            const objAcademicJournalsEN = new clsAcademicJournalsEN_js_1.clsAcademicJournalsEN();
            try {
            ...
            try {
                (0, clsAcademicJournalsWApi_js_2.AcademicJournals_CheckPropertyNew)(objAcademicJournalsEN);
            }
            catch (e) {
            ...
            try {
                ...
                let returnBool = false;
                const returnKeyId = await (0, clsAcademicJournalsWApi_js_3.AcademicJournals_AddNewRecordWithMaxIdAsync)(objAcademicJournalsEN);
                if ((0, clsString_js_1.IsNullOrEmpty)(returnKeyId) == false) {
                    returnBool = true;
                }
                if (returnBool == true) {
        ...
        **/
        async CheckUniCond4Add_JournalName(objAcademicJournalsEN) {
            const strThisFuncName = this.CheckUniCond4Add_JournalName.name;
            const strUniquenessCondition = (0, clsAcademicJournalsWApi_js_5.AcademicJournals_GetUniCondStr_JournalName)(objAcademicJournalsEN);
            const bolIsExistCondition = await (0, clsAcademicJournalsWApi_js_6.AcademicJournals_IsExistRecordAsync)(strUniquenessCondition);
        ...
        **/
        async CheckUniCond4Update_JournalName(objAcademicJournalsEN) {
            const strThisFuncName = this.CheckUniCond4Update_JournalName.name;
            const strUniquenessCondition = (0, clsAcademicJournalsWApi_js_7.AcademicJournals_GetUniCondStr4Update_JournalName)(objAcademicJournalsEN);
            const bolIsExistCondition = await (0, clsAcademicJournalsWApi_js_6.AcademicJournals_IsExistRecordAsync)(strUniquenessCondition);
            if (bolIsExistCondition == true) {
                const strMsg = (0, clsString_js_1.Format)("不能满足唯一性条件。满足条件：{0}的记录已经存在！", strUniquenessCondition);
                console.error(strMsg);
        ...
        **/
        async AddNewRecordWithMaxIdSave() {
            ...
            try {
                ...
                const responseKeyId = await (0, clsAcademicJournalsWApi_js_3.AcademicJournals_AddNewRecordWithMaxIdAsync)(objAcademicJournalsEN);
       ...
       * 在这里是把值传到表控件中
        ...
        **/
        async ShowData(strJournalId) {
            ...
            //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
            let objAcademicJournalsEN = new clsAcademicJournalsEN_js_1.clsAcademicJournalsEN();
            try {
                const returnBool = await (0, clsAcademicJournalsWApi_js_8.AcademicJournals_IsExistAsync)(strJournalId);
                if (returnBool == false) {
                    const strInfo = (0, clsString_js_1.Format)("关键字:[{0}] 的记录不存在!", strJournalId);
            ...
            try {
                const objAcademicJournalsEN_Const = await (0, clsAcademicJournalsWApi_js_9.AcademicJournals_GetObjByJournalIdAsync)(strJournalId);
        ...
        **/
        async UpdateRecordSave() {
            ...
            try {
                (0, clsAcademicJournalsWApi_js_10.AcademicJournals_CheckProperty4Update)(objAcademicJournalsEN);
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("检查数据不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
                console.error(strMsg);
            ...
            try {
                ...
                const returnBool = await (0, clsAcademicJournalsWApi_js_11.AcademicJournals_UpdateRecordAsync)(objAcademicJournalsEN);
                if (returnBool == true) {
                    (0, clsAcademicJournalsWApi_js_4.AcademicJournals_ReFreshCache)();
                }
                return returnBool;
        ...
        **/
        set btnCancel_AcademicJournals(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnCancel_AcademicJournals", value);
        }
        /**
        * 获取按钮的标题
        **/
        get btnSubmit_AcademicJournals() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetButtonHtmlInDiv)(this.divName4Edit, "btnSubmit_AcademicJournals");
            return strValue;
        }
        /**
        ...
        **/
        set btnSubmit_AcademicJournals(value) {
            (0, clsCommFunc4Ctrl_js_1.SetButtonHtmlByIdInDiv)(this.divName4Edit, "btnSubmit_AcademicJournals", value);
        }
        /**
        * 期刊Id (Used In Clear())
        **/
        set journalId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtJournalId", value);
        }
        /**
        * 期刊Id (Used In PutDataToClass())
        **/
        get journalId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtJournalId");
        ...
        **/
        set journalName(value) {
            (0, clsCommFunc4Ctrl_js_1.SetInputValueByIdInDiv)(this.divName4Edit, "txtJournalName", value);
        }
        /**
        * 期刊名称 (Used In PutDataToClass())
        **/
        get journalName() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetInputValueInDiv)(this.divName4Edit, "txtJournalName");
            if (strValue == undefined)
                return "";
            else
                return strValue.toString();
        ...
        **/
        set journalSubjectId(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Edit, "ddlJournalSubjectId", value);
        }
        /**
        * 期刊学科Id (Used In PutDataToClass())
        **/
        get journalSubjectId() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Edit, "ddlJournalSubjectId");
            if (strValue == undefined)
                return "";
            else if (strValue == "0")
                return "";
