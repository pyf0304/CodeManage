(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/ParameterTable/clsLiteratureTypeWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L0_Entity/GraduateEduPaper/clsPaperEN.js", "../../TS/L0_Entity/GraduateEduPaper/clsPaperENEx.js", "../../TS/L3_ForWApiEx/GraduateEduPaper/clsPaperExWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../../TS/PubFun/clsCommFunc4Web.js", "../../TS/PubFun/clsCommFunc4Ctrl.js", "../../TS/PubFun/clsPager.js", "../../TS/PubFun/clsString.js", "../../TS/PubFun/clsOperateList.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PaperCRUD = void 0;
    /**
    ...
    **/
    class PaperCRUD {
        ...
        **/
        CombineData(arrPaperObjLst, arrDataColumn) {
            ...
            const strFileName = (0, clsString_js_1.Format)("论文表({0})导出.xlsx", clsPaperEN_js_1.clsPaperEN._CurrTabName);
            exportSpecialExcel_pyf(arrData, strFileName);
        }
        /** 根据条件获取相应的对象列表
        * (AutoGCLib.WA_ViewScriptCS_TS4TypeScript:Gen_WApi_Ts_ExportExcel)
        **/
        async ExportExcel_Paper() {
            const strThisFuncName = this.ExportExcel_Paper.name;
            if (PaperCRUD.sortPaperBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortPaperBy)为空，请检查！(In BindGv_Paper_Cache)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                arrPaperObjLst = await (0, clsPaperWApi_js_2.Paper_GetObjLstAsync)(strWhereCond);
            }
            catch (e) {
        ...
        **/
        async SetDdl_LiteratureTypeIdInDiv() {
            await (0, clsLiteratureTypeWApi_js_1.LiteratureType_BindDdl_LiteratureTypeIdInDiv_Cache)(this.divName4Query, "ddlLiteratureTypeId_q"); //
        }
        /** 函数功能:为查询区绑定下拉框
        ...
        **/
        async btnSelectRecordInTab_Click(strPaperId) {
        ...
        **/
        async DelRecord(strPaperId) {
            const strThisFuncName = this.DelRecord.name;
            try {
                const returnInt = await (0, clsPaperWApi_js_3.Paper_DelRecordAsync)(strPaperId);
                if (returnInt > 0) {
                    //Paper_ReFreshCache();
        ...
        **/
        async SelectRecord(strPaperId) {
            ...
            try {
                const objPaperEN = await (0, clsPaperWApi_js_4.Paper_GetObjByPaperIdAsync)(strPaperId);
                //console.log("完成SelectRecord!", objPaperEN);
                (0, clsCommFunc4Web_js_1.Redirect)("/Index/Main_Paper");
            }
            catch (e) {
        ...
        async CombinePaperCondition() {
            ...
            try {
                if (this.paperTitle_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsPaperEN_js_1.clsPaperEN.con_PaperTitle, this.paperTitle_q);
                }
                if (this.updDate_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsPaperEN_js_1.clsPaperEN.con_UpdDate, this.updDate_q);
                }
                ...
                if (this.literatureTypeId_q != "" && this.literatureTypeId_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsPaperEN_js_1.clsPaperEN.con_LiteratureTypeId, this.literatureTypeId_q);
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0009)在组合查询条件(CombinePaperCondition)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            return strWhereCond;
        }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombinePaperConditionObj() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                if (this.paperTitle_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsPaperEN_js_1.clsPaperEN.con_PaperTitle, this.paperTitle_q);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_PaperTitle, this.paperTitle_q, "like");
                }
                if (this.updDate_q != "") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} like '% {1}%'", clsPaperEN_js_1.clsPaperEN.con_UpdDate, this.updDate_q);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_UpdDate, this.updDate_q, "like");
                }
                if (this.isChecked_q == true) {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsPaperEN_js_1.clsPaperEN.con_IsChecked);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_IsChecked, true, "=");
                }
                else {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsPaperEN_js_1.clsPaperEN.con_IsChecked);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_IsChecked, false, "=");
                }
                if (this.isQuotethesis_q == true) {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '1'", clsPaperEN_js_1.clsPaperEN.con_IsQuotethesis);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_IsQuotethesis, true, "=");
                }
                else {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '0'", clsPaperEN_js_1.clsPaperEN.con_IsQuotethesis);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_IsQuotethesis, false, "=");
                }
                if (this.literatureTypeId_q != "" && this.literatureTypeId_q != "0") {
                    strWhereCond += (0, clsString_js_1.Format)(" And {0} = '{1}'", clsPaperEN_js_1.clsPaperEN.con_LiteratureTypeId, this.literatureTypeId_q);
                    objPaper_Cond.SetCondFldValue(clsPaperEN_js_1.clsPaperEN.con_LiteratureTypeId, this.literatureTypeId_q, "=");
                }
            }
            catch (objException) {
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0010)在组合查询条件对象(CombinePaperConditionObj)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
        ...
        * @returns 条件串(strWhereCond)
        **/
        async CombinePaperConditionObj4ExportExcel() {
            //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
            //例如 1 = 1 && UserName = '张三'
            let strWhereCond = " 1 = 1 ";
            ...
            try {
                ...
                const strMsg = (0, clsString_js_1.Format)("(errid:WiTsCs0013)在组合导出Excel条件对象(CombinePaperConditionObj4ExportExcel)时出错!请联系管理员!{0}", objException);
                throw strMsg;
            }
            objPaper_Cond.whereCond = strWhereCond;
            return objPaper_Cond;
        ...
        **/
        async BindTab_Paper(divContainer, arrPaperObjLst) {
            ...
            const arrDataColumn = [
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_PaperTitle,
                    sortBy: "paperTitle",
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "论文标题",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_Periodical,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_Periodical,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "期刊",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_Author,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_Author,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "作者",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_ResearchQuestion,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_ResearchQuestion,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "研究问题",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_UpdDate,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_UpdDate,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "修改日期",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_Keyword,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_Keyword,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "关键字",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_LiteratureSources,
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_LiteratureLink,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_LiteratureLink,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "文献链接",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_UploadfileUrl,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_UploadfileUrl,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "文件地址",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_Checker,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_Checker,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "审核人",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_IsChecked,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_IsChecked,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "是否检查",
                    text: "",
                ...
                {
                    fldName: clsPaperEN_js_1.clsPaperEN.con_IsQuotethesis,
                    sortBy: clsPaperEN_js_1.clsPaperEN.con_IsQuotethesis,
                    sortFun: clsCommFunc4Web_js_1.SortFun,
                    getDataSource: "",
                    colHeader: "是否引用论文",
                    text: "",
                ...
                {
                    fldName: clsPaperENEx_js_1.clsPaperENEx.con_LiteratureTypeName,
            ...
            await (0, clsCommFunc4Web_js_1.BindTab)(o, arrPaperObjLst, arrDataColumn, clsPaperEN_js_1.clsPaperEN.con_PaperId, this);
        ...
        **/
        async ExtendFldFuncMap(arrPaperExObjLst, arrDataColumn) {
            ...
            for (const objDataColumn of arrDataColumn) {
                ...
                for (const objInFor of arrPaperExObjLst) {
                    await (0, clsPaperExWApi_js_1.PaperEx_FuncMapByFldName)(objDataColumn.fldName, objInFor);
                }
            }
        }
        /** 函数功能:在数据列表中跳转到前一页
        ...
        **/
        async BindGv_Paper() {
            ...
            if (PaperCRUD.sortPaperBy == null) {
                const strMsg = (0, clsString_js_1.Format)("在显示列表时，排序字段(sortPaperBy)为空，请检查！(In BindGv_Paper)");
                console.error(strMsg);
                alert(strMsg);
                return;
            }
            ...
            try {
                ...
                const responseObjLst = await (0, clsPaperWApi_js_5.Paper_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                    arrPaperObjLst = jsonData;
                });
            }
            catch (e) {
                const strMsg = (0, clsString_js_1.Format)("绑定GridView不成功,{0}.(in {1}.{2})", e, this.constructor.name, strThisFuncName);
        ...
        **/
        async SortBy(objAnchorElement) {
            ...
            const { sortFun, ascOrDesc4SortFun, sortBy } = (0, clsOperateList_js_1.GetSortBy)(objAnchorElement, PaperCRUD.ascOrDesc4SortFun, PaperCRUD.sortPaperBy, strSortExpress);
        ...
        **/
        async CopyRecord(arrPaperId) {
            const strThisFuncName = this.CopyRecord.name;
            try {
                const arrPaperObjLst = await (0, clsPaperWApi_js_6.Paper_GetObjLstByPaperIdLstAsync)(arrPaperId);
                //console.log('responseText=');
                //console.log(responseText);
                let intCount = 0;
                for (const objInFor of arrPaperObjLst) {
                    const strMaxStrId = await (0, clsPaperWApi_js_7.Paper_GetMaxStrIdAsync)();
                    //console.log('strMaxStrId=' + strMaxStrId);
                    objInFor.paperId = strMaxStrId;
                    const returnBool = await (0, clsPaperWApi_js_8.Paper_AddNewRecordAsync)(objInFor);
        ...
        **/
        async DelMultiRecord(arrPaperId) {
            ...
            try {
                const returnInt = await (0, clsPaperWApi_js_9.Paper_DelPapersAsync)(arrPaperId);
                if (returnInt > 0) {
                    //Paper_ReFreshCache();
                    const strInfo = (0, clsString_js_1.Format)("删除记录成功,共删除{0}条记录!", returnInt);
                    //显示信息框
        ...
        **/
        ShowPaperObj(divContainer, objPaper) {
            ...
            const sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objPaper);
        ...
        **/
        get literatureTypeId_q() {
            const strValue = (0, clsCommFunc4Ctrl_js_1.GetSelectValueInDiv)(this.divName4Query, "ddlLiteratureTypeId_q");
        ...
        **/
        set literatureTypeId_q(value) {
            (0, clsCommFunc4Ctrl_js_1.SetSelectValueByIdInDiv)(this.divName4Query, "ddlLiteratureTypeId_q", value);
        }
        /**
    ...
    exports.PaperCRUD = PaperCRUD;
    PaperCRUD.ascOrDesc4SortFun = "Asc";
