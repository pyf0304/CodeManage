...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/gs_ReflectLogCRUD.js", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduTopic/clsgs_ReflectLogEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_ReflectLogWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../TS/PubConfig/clsPrivateSessionStorage.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Addgs_ReflectLogEx = void 0;
    ...
    */
    class Addgs_ReflectLogEx extends gs_ReflectLogCRUD_js_1.gs_ReflectLogCRUD {
        constructor() {
            super(...arguments);
      ...
      */
        ...
        async btnQuery_Click() {
            ...
            try {
                ...
                const responseObjLst = await (0, clsgs_ReflectLogWApi_js_1.gs_ReflectLog_GetObjLstByPagerAsync)(objPagerPara).then((jsonData) => {
                    var arrgs_ReflectLogObjLst = jsonData;
       ...
       */
        async btnExportExcel_Click() {
            var strWhereCond = " 1=1 ";
            try {
                const responseText = await (0, clsgs_ReflectLogWApi_js_1.gs_ReflectLog_GetObjLstAsync)(strWhereCond).then((jsonData) => {
       ...
       */
        async BindGv_gs_TeacherTask() {
            ...
            try {
                ...
                arrgs_ReflectLogObjLst = await (0, clsgs_ReflectLogWApi_js_1.gs_ReflectLog_GetObjLstByPagerAsync)(objPagerPara);
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
       ...
       */
        PutDataTogs_TeacherTaskClass(pobjgs_ReflectLogEN) {
       ...
       */
        GetDataFromgs_TeacherTaskClass(pobjgs_ReflectLogEN) {
    ...
    exports.Addgs_ReflectLogEx = Addgs_ReflectLogEx;
});
