...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../GraduateEduTopic/ResearchTopic_QUDIEx.js", "../PagesBase/GraduateEduTopic/gs_TeacherTaskCRUD.js", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduTopic/clsgs_TeacherTaskEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TeacherTaskWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsResearchTopicWApi.js", "../TS/PubConfig/clsPrivateSessionStorage.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Addgs_TeacherTaskEx = void 0;
    const ResearchTopic_QUDIEx_js_1 = require("../GraduateEduTopic/ResearchTopic_QUDIEx.js");
    ...
    class Addgs_TeacherTaskEx extends gs_TeacherTaskCRUD_js_1.gs_TeacherTaskCRUD {
                        ...
                        case "确认添加":
                            ...
                            if (this.opType == "AddWithMaxId") {
                                ...
                                if (returnBool == true) {
                                    //HideDialog_gs_TeacherTask();
                                    //this.BindGv_gs_TeacherTask();
                                    const objPage_Parent = new ResearchTopic_QUDIEx_js_1.ResearchTopic_QUDIEx();
                                    objPage_Parent.BindGv(clsgs_TeacherTaskEN_js_1.clsgs_TeacherTaskEN._CurrTabName, "");
                                    CloseWindow();
                                }
                            }
                            break;
       ...
       */
        async BindTab_gs_TeacherTask(divContainer, arrgs_TeacherTaskObjLst) {
            ...
            (0, clsCommFunc4Web_js_1.BindTab)(o, arrgs_TeacherTaskObjLst, arrDataColumn, "mId", this);
       ...
       */
        PutDataTogs_TeacherTaskClass(pobjgs_TeacherTaskEN) {
            ...
            pobjgs_TeacherTaskEN.Setid_CurrEduCls(clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls); // 当前教学班流水号
            ...
            pobjgs_TeacherTaskEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate_ymd()); // 修改日期
            pobjgs_TeacherTaskEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
       ...
       */
        Showgs_TeacherTaskObj(divContainer, objgs_TeacherTask) {
            ...
            var sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objgs_TeacherTask);
