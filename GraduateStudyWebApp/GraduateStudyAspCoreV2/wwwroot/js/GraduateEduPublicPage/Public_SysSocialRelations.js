(function (factory) {
    ...
    const clsvSysSocialRelationsExEN_js_1 = require("../TS/L0_Entity/GraduateEduTopic/clsvSysSocialRelationsExEN.js");
    ...
    class Public_SysSocialRelations {
        ...
        static async BindList_vSysSocialRelationsEx(strOperationType, arrvSysSocialRelationsExObjLst) {
            ...
            if (strOperationType == "01" || strOperationType == "07") {
                ...
                //var strWhereCondRela = "1=1 and id_CurrEduCls='" + clsPublocalStorage.id_CurrEduCls + "'";
            ...
            for (var i = 0; i < arrvSysSocialRelationsExObjLst.length; i++) {
                ...
                if (strOperationType == "06" || strOperationType == "07") {
                    ...
                    if (strOperationType == "06") {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('社会关系评论', '../GraduateEduTools/SysComment?Key=" + strSocialId + "&Type=10&User=" + arrvSysSocialRelationsExObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage_js_1.clsPrivateSessionStorage.topicId + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论<span class=\"layui-badge\">" + arrvSysSocialRelationsExObjLst[i].appraiseCount + "</span></button >";
                        //建立观点关系
                    }
