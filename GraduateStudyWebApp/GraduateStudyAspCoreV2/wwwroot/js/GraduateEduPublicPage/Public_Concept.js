(function (factory) {
    ...
    const clsvConceptExEN_js_1 = require("../TS/L0_Entity/GraduateEduTopic/clsvConceptExEN.js");
    ...
    class Public_Concept {
        ...
        static async BindList_vConceptEx(strOperationType, arrvConceptExObjLst) {
            ...
            arrConceptAttachmentObjLst2 = await (0, clsConceptAttachmentWApi_js_1.ConceptAttachment_GetObjLstAsync)(strWhereCondAttachment);
            var arrUsers = await (0, clsvUsersSimWApi_js_1.vUsersSim_GetObjLst_Cache)(clsSysPara4WebApi_js_1.clsSysPara4WebApi.cmPrjId);
            ...
            for (var i = 0; i < arrvConceptExObjLst.length; i++) {
                ...
                if (strOperationType == "06" || strOperationType == "07") {
                    ...
                    if (strOperationType == "06") {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('相关概念评论', '../GraduateEduTools/SysComment?Key=" + strConceptId + "&Type=05&User=" + arrvConceptExObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage_js_1.clsPrivateSessionStorage.topicId + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论<span class=\"layui-badge\">" + arrvConceptExObjLst[i].appraiseCount + "</span></button >";
                        //查看观点关系
                    }
