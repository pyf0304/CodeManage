(function (factory) {
    ...
    const clsvViewpointExEN_js_1 = require("../TS/L0_Entity/GraduateEduTopic/clsvViewpointExEN.js");
    ...
    class Public_Viewpoint {
        ...
        static async BindList_vViewpointEx(strOperationType, strVType, arrvViewpointExObjLst) {
            ...
            arrViewpointAttachmentObjLst2 = await (0, clsViewpointAttachmentWApi_js_1.ViewpointAttachment_GetObjLstAsync)(strWhereCondAttachment);
            //获取用户缓存数据
            var arrUsers = await (0, clsvUsersSimWApi_js_1.vUsersSim_GetObjLst_Cache)(clsSysPara4WebApi_js_1.clsSysPara4WebApi.cmPrjId);
            //点赞
            ...
            for (var i = 0; i < arrvViewpointExObjLst.length; i++) {
                ...
                if (strOperationType == "06" || strOperationType == "07") {
                    ...
                    if (strOperationType == "06") {
                        ...
                        strhtml += "&nbsp;&nbsp;<button class=\"layui-btn layui-btn layui-btn-xs\" onclick=\"xadmin.open('" + strTitle + "评论', '../GraduateEduTools/SysComment?Key=" + strViewpointId + "&Type=" + strType + "&User=" + arrvViewpointExObjLst[i].updUser + "&pubParentId=" + clsPrivateSessionStorage_js_1.clsPrivateSessionStorage.topicId + "&FontSize=" + $("#hidFontSize").val() + "')\"> <i class=\"layui-icon\" >&#xe642;</i>添加评论<span class=\"layui-badge\">" + arrvViewpointExObjLst[i].appraiseCount + "</span></button >";
                    }
