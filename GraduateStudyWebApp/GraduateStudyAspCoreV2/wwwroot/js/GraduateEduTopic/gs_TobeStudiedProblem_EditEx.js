(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/gs_TobeStudiedProblem_Edit.js", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/FunClass/clsPublicParagraph.js", "../TS/L0_Entity/GraduateEduTopic/clsgs_TobeStudiedProblemEN.js", "../TS/L0_Entity/GraduateEduTopic/clsgs_TobeStudiedProblemVerEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvRTUserRelaEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVerWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../TS/PubConfig/clsPrivateSessionStorage.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
    ...
    */
    ...
    const clsgs_TobeStudiedProblemVerEN_js_1 = require("../TS/L0_Entity/GraduateEduTopic/clsgs_TobeStudiedProblemVerEN.js");
    ...
    class gs_TobeStudiedProblem_EditEx extends gs_TobeStudiedProblem_Edit_js_1.gs_TobeStudiedProblem_Edit {
        ...
        static btnEdit_Click(strCommandName, strKeyId) {
            ...
            switch (strCommandName) {
                ...
                case "Submit": //提交
                    ...
                    break;
                default:
                    var strMsg = '命令:' + strCommandName + "在函数(gs_TobeStudiedProblem_EditEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
       ...
       */
        ...
        async PutDataTogs_TobeStudiedProblemClass(pobjgs_TobeStudiedProblemEN) {
            ...
            //getTextboxio();
            pobjgs_TobeStudiedProblemEN.Setid_CurrEduCls(clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls);
            pobjgs_TobeStudiedProblemEN.SetTopicId(clsPrivateSessionStorage_js_1.clsPrivateSessionStorage.topicId); // 主题编号
            ...
            pobjgs_TobeStudiedProblemEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate()); // 修改日期
            pobjgs_TobeStudiedProblemEN.SetParticipant($("#txtParticipant").val()); // 参会者
            pobjgs_TobeStudiedProblemEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
            ...
            pobjgs_TobeStudiedProblemEN.SetYear(this.problemDate.substr(0, 4));
            pobjgs_TobeStudiedProblemEN.SetMonth(this.problemDate.substr(5, 2));
      ...
      */
       ...
       */
        async UpdateRecordSave() {
            ...
            // var intVersionCount = await gs_TobeStudiedProblemVer_GetRecCountByCondAsync(strWhereCond2);
            const responseText = await (0, clsgs_TobeStudiedProblemVerWApi_js_1.gs_TobeStudiedProblemVer_GetFirstObjAsync)(strWhereCond2).then((jsonData) => {
                var objgs_TobeStudiedProblemVerEN = jsonData;
        ...
        async AddVersionRecordSave() {
            ...
            var objgs_TobeStudiedProblemVerEN = new clsgs_TobeStudiedProblemVerEN_js_1.clsgs_TobeStudiedProblemVerEN();
            this.PutDataTogs_TobeStudiedProblemVClass(objgs_TobeStudiedProblemVerEN);
            try {
                const responseText2 = await (0, clsgs_TobeStudiedProblemVerWApi_js_1.gs_TobeStudiedProblemVer_AddNewRecordAsync)(objgs_TobeStudiedProblemVerEN);
                var returnBool = !!responseText2;
                if (returnBool == true) {
                    var strWhereCond2 = " 1 =1 and problemId=" + $("#hidProblemId").val();
                    var intVersionCount = await (0, clsgs_TobeStudiedProblemVerWApi_js_1.gs_TobeStudiedProblemVer_GetRecCountByCondAsync)(strWhereCond2);
                    var objgs_TobeStudiedProblemEN = new clsgs_TobeStudiedProblemEN_js_1.clsgs_TobeStudiedProblemEN();
        ...
        PutDataTogs_TobeStudiedProblemVClass(pobjgs_TobeStudiedProblemVerEN) {
            pobjgs_TobeStudiedProblemVerEN.problemId = $("#hidProblemId").val();
            pobjgs_TobeStudiedProblemVerEN.SetTopicId(clsPrivateSessionStorage_js_1.clsPrivateSessionStorage.topicId); // 主题编号
            ...
            pobjgs_TobeStudiedProblemVerEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate()); // 修改日期
            pobjgs_TobeStudiedProblemVerEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId); // 修改人
            var strYmd = clsPubFun4Web_js_1.clsPubFun4Web.getNowDate_ymd();
            if (this.problemDate == "") {
