(function (factory) {
    ...
    */
    class ExpertViewpoint_List extends ViewpointCRUD_js_1.ViewpointCRUD {
        constructor() {
            super(...arguments);
       ...
       */
        async QueryvViewpointLst(strListDiv) {
            var strWhereCond = await this.CombinevViewpointCondition();
            var intCurrPageIndex = (0, clsOperateList_js_1.GetCurrPageIndex)(this.objPager.currPageIndex); //获取当前页
            return new Promise((resolve, reject) => {
                try {
    ...
    */
    ...
    exports.ExpertViewpoint_List = ExpertViewpoint_List;
});
