(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/RTTopicObjectiveRelaCRUD.js", "./RTTopicObjectiveRela_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RTTopicObjectiveRelaCRUDEx = void 0;
    /**
    * 类名:RTTopicObjectiveRelaCRUDEx(界面:RTTopicObjectiveRelaCRUD)
    * 表名:RTTopicObjectiveRela(01120615)
    * 版本:2023.01.09.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/12 02:11:41
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    //import $ from "jquery";
    /** RTTopicObjectiveRelaCRUDEx 的摘要说明。其中Q代表查询,U代表修改
    * (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    **/
    class RTTopicObjectiveRelaCRUDEx extends RTTopicObjectiveRelaCRUD_js_1.RTTopicObjectiveRelaCRUD {
        //public static mstrListDiv = "divDataLst";
        //public static mstrSortvRTTopicObjectiveRelaBy = "mId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (RTTopicObjectiveRelaCRUD_js_1.RTTopicObjectiveRelaCRUD.objPage_CRUD == null) {
                RTTopicObjectiveRelaCRUD_js_1.RTTopicObjectiveRelaCRUD.objPage_CRUD = new RTTopicObjectiveRelaCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(RTTopicObjectiveRelaCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.RTTopicObjectiveRelaCRUDEx = RTTopicObjectiveRelaCRUDEx;
});
