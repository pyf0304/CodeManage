(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/TopicObjectiveCRUD.js", "../TS/L0_Entity/GraduateEduTopic/clsTopicObjectiveEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvTopicObjectiveEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsTopicObjectiveWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
    ...
    */
    class ObjectiveBasis extends TopicObjectiveCRUD_js_1.TopicObjectiveCRUD {
        constructor() {
            super(...arguments);
       ...
       */
        async BindGv_vTopicObjective_Cache() {
            ...
            var arrvTopicObjectiveObjLst = [];
            try {
                this.recCount = await (0, clsvTopicObjectiveWApi_js_1.vTopicObjective_GetRecCountByCond_Cache)(objvTopicObjective_Cond, clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls);
                var objPagerPara = {
                    pageIndex: intCurrPageIndex,
                    pageSize: this.pageSize,
                    whereCond: strWhereCond,
                ...
                var arrvTopicObjectiveObjLst = await (0, clsvTopicObjectiveWApi_js_1.vTopicObjective_GetObjLstByPager_Cache)(objPagerPara, clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls);
            }
            catch (e) {
                console.error('catch(e)=');
                console.error(e);
       ...
       */
        async Page_Load() {
            ...
            try {
                ...
                TopicObjectiveCRUD_js_1.TopicObjectiveCRUD.sortvTopicObjectiveBy = "paperTitle Asc";
                var strWhereCond = await this.CombinevTopicObjectiveCondition();
       ...
       */
        ShowTopicObjectiveObj(divContainer, objTopicObjective) {
            ...
            var sstrKeys = (0, clsCommFunc4Web_js_1.GetObjKeys)(objTopicObjective);
