(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/ViewpointCRUD.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js", "./Viewpoint_EditEx.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ViewpointCRUDEx = void 0;
    /**
    * 类名:ViewpointCRUDEx(界面:ViewpointCRUD)
    * 表名:Viewpoint(01120542)
    * 版本:2023.01.04.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/06 01:28:08
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    ...
    //import $ from "jquery";
    /** ViewpointCRUDEx 的摘要说明。其中Q代表查询,U代表修改
    * (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    **/
    class ViewpointCRUDEx extends ViewpointCRUD_js_1.ViewpointCRUD {
        //public static mstrListDiv = "divDataLst";
        //public static mstrSortvViewpointBy = "ViewpointId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (ViewpointCRUD_js_1.ViewpointCRUD.objPage_CRUD == null) {
                ViewpointCRUD_js_1.ViewpointCRUD.objPage_CRUD = new ViewpointCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(ViewpointCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.ViewpointCRUDEx = ViewpointCRUDEx;
});
