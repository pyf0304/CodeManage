(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/RTSysSocialRelaCRUD.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js", "./WA_RTSysSocialRela_EditEx.js"], factory);
    }
    ...
    */
    ...
    //
    //import * as QQ from "q";
    const RTSysSocialRelaCRUD_js_1 = require("../PagesBase/GraduateEduTopic/RTSysSocialRelaCRUD.js");
    const clsCommFunc4Ctrl_js_1 = require("../TS/PubFun/clsCommFunc4Ctrl.js");
    const clsString_js_1 = require("../TS/PubFun/clsString.js");
    const WA_RTSysSocialRela_EditEx_js_1 = require("./WA_RTSysSocialRela_EditEx.js");
    ...
    class RTSysSocialRelaCRUDEx extends RTSysSocialRelaCRUD_js_1.RTSysSocialRelaCRUD {
       ...
       */
        ...
        BindGv_Cache(strType, strPara) {
            ...
            let strMsg = "";
            switch (strType) {
                case "vRTSysSocialRela":
                    alert('该类没有绑定该函数：[this.BindGv_vRTSysSocialRela_Cache]！');
                    //this.BindGv_vRTSysSocialRela_Cache();
                    break;
                default:
        ...
        */
        static btn_Click(strCommandName, strKeyId) {
            ...
            let objPage;
            if (RTSysSocialRelaCRUD_js_1.RTSysSocialRelaCRUD.objPage_CRUD == null) {
                RTSysSocialRelaCRUD_js_1.RTSysSocialRelaCRUD.objPage_CRUD = new RTSysSocialRelaCRUDEx();
                objPage = RTSysSocialRelaCRUD_js_1.RTSysSocialRelaCRUD.objPage_CRUD;
            }
            else {
                objPage = RTSysSocialRelaCRUD_js_1.RTSysSocialRelaCRUD.objPage_CRUD;
            }
            const objPage_Edit = new WA_RTSysSocialRela_EditEx_js_1.WA_RTSysSocialRela_EditEx(objPage);
