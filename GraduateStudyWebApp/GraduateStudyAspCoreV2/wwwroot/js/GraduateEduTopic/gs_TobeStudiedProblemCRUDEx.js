(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTopic/gs_TobeStudiedProblemCRUD.js", "../PagesBase/GraduateEduTopic/gs_TobeStudiedProblem_Edit.js", "../TS/L0_Entity/GraduateEduTopic/clsgs_TobeStudiedProblemEN.js", "../TS/L0_Entity/GraduateEduTopic/clsvgs_TobeStudiedProblemEN.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemVerWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsgs_TobeStudiedProblemWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvRTUserRelaWApi.js", "../TS/L3_ForWApi/UserManage_Share/clsvUsersSimWApi.js", "../TS/L3_ForWApiEx/GraduateEduTopic/clsgs_TobeStudiedProblemExWApi.js", "../TS/PubConfig/clsPrivateSessionStorage.js", "../TS/PubConfig/clsSysPara4WebApi.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js", "./gs_TobeStudiedProblem_EditEx.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gs_TobeStudiedProblemCRUDEx = void 0;
    /*-- -- -- -- -- -- -- -- -- -- --
    ...
    */
    ...
    //
    //import * as QQ from "q";
    const gs_TobeStudiedProblemCRUD_js_1 = require("../PagesBase/GraduateEduTopic/gs_TobeStudiedProblemCRUD.js");
    ...
    const clsgs_TobeStudiedProblemExWApi_js_1 = require("../TS/L3_ForWApiEx/GraduateEduTopic/clsgs_TobeStudiedProblemExWApi.js");
    ...
    */
    class gs_TobeStudiedProblemCRUDEx extends gs_TobeStudiedProblemCRUD_js_1.gs_TobeStudiedProblemCRUD {
       ...
       */
        ...
        */
        static btn_Click(strCommandName, strKeyId) {
            var objPage = new gs_TobeStudiedProblemCRUDEx();
            var objPage_Edit = new gs_TobeStudiedProblem_EditEx_js_1.gs_TobeStudiedProblem_EditEx(objPage);
        ...
        async Page_Load() {
            ...
            try {
                ...
                this.divName4Query = "divTobeStudiedProblem";
      ...
      */
        ...
        //待研究问题列表绑定
        async Bind_TobeStudiedProblemList() {
            var strUserId = clsPublocalStorage_js_1.clsPublocalStorage.userId;
            var strRoleId = clsPublocalStorage_js_1.clsPublocalStorage.roleId;
            var strTopicId = clsPrivateSessionStorage_js_1.clsPrivateSessionStorage.topicId;
            var strWhereCond = await this.Combinevgs_TobeStudiedProblemCondition();
            //var strWhereCond = " topicId='" + strTopicId + "' and year='" + $("#hidYear").val() + "' and month='" + $("#hidMonth").val() + "'";
            //声明主题变量
            var arrgs_ProblemDateNumObjLst = [];
            var arrgs_TobeStudiedProblemObjLst1 = [];
            var arrgs_TobeStudiedProblemObjLst2 = [];
            var arrRTUserRelaObjLst = [];
            const responseObjLst1 = await (0, clsgs_TobeStudiedProblemExWApi_js_1.gs_TobeStudiedProblemEx_GetProblemDateNumObjLstAsync)(strWhereCond).then((jsonData) => {
                arrgs_ProblemDateNumObjLst = jsonData;
            });
            const responseObjLst2 = await (0, clsgs_TobeStudiedProblemWApi_js_1.gs_TobeStudiedProblem_GetObjLstAsync)(strWhereCond).then((jsonData) => {
                arrgs_TobeStudiedProblemObjLst1 = jsonData;
            });
        ...
        //待研究问题提交
        async Update_ProblemIsSubmit_Click(strKeyId, stata) {
      ...
      */
        ...
        //历史版本删除
        VDelRecord(arrProblemId) {
            return new Promise((resolve, reject) => {
                try {
                    const responseText = (0, clsgs_TobeStudiedProblemVerWApi_js_1.gs_TobeStudiedProblemVer_Delgs_TobeStudiedProblemVersByCondAsync)("problemId='" + arrProblemId + "'").then((jsonData) => {
    ...
    exports.gs_TobeStudiedProblemCRUDEx = gs_TobeStudiedProblemCRUDEx;
});
