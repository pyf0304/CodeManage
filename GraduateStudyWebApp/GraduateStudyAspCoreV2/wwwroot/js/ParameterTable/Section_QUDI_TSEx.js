(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../GraduateEduPaper/Section_EditEx.js", "../PagesBase/GraduateEduPaper/SectionCRUD.js", "../TS/L0_Entity/GraduateEduPaper/clsvSectionEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvSectionWApi.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Section_QUDI_TSEx = void 0;
    const Section_EditEx_js_1 = require("../GraduateEduPaper/Section_EditEx.js");
    ...
    */
    class Section_QUDI_TSEx extends SectionCRUD_js_1.SectionCRUD {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (SectionCRUD_js_1.SectionCRUD.objPage_CRUD == null) {
                SectionCRUD_js_1.SectionCRUD.objPage_CRUD = new Section_QUDI_TSEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(Section_QUDI_TSExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    ...
    */
        async Page_Load() {
            ...
            try {
                ...
                if (strUserId != "") {
                    //1、为下拉框设置数据源,绑定列表数据
                    SectionCRUD_js_1.SectionCRUD.sortvSectionBy = "sectionId Asc";
        ...
        async BindGv_vSection() {
            ...
            try {
                ...
                var objPagerPara = {
                    ...
                    orderBy: SectionCRUD_js_1.SectionCRUD.sortvSectionBy,
