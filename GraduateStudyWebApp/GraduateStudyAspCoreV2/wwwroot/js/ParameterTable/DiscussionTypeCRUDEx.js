(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/ParameterTable/DiscussionTypeCRUD.js", "./DiscussionType_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DiscussionTypeCRUDEx = void 0;
    /**
    * 类名:DiscussionTypeCRUDEx(界面:DiscussionTypeCRUD)
    * 表名:DiscussionType(01120589)
    * 版本:2023.01.09.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/12 01:31:01
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    class DiscussionTypeCRUDEx extends DiscussionTypeCRUD_js_1.DiscussionTypeCRUD {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (DiscussionTypeCRUD_js_1.DiscussionTypeCRUD.objPage_CRUD == null) {
                DiscussionTypeCRUD_js_1.DiscussionTypeCRUD.objPage_CRUD = new DiscussionTypeCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(DiscussionTypeCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.DiscussionTypeCRUDEx = DiscussionTypeCRUDEx;
});
