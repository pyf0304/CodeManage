(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/ParameterTable/ViewpointTypeCRUD.js", "./ViewpointType_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ViewpointTypeCRUDEx = void 0;
    /**
    * 类名:ViewpointTypeCRUDEx(界面:ViewpointTypeCRUD)
    * 表名:ViewpointType(01120544)
    * 版本:2023.01.09.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/12 01:35:26
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    class ViewpointTypeCRUDEx extends ViewpointTypeCRUD_js_1.ViewpointTypeCRUD {
        //public static mstrListDiv = "divDataLst";
        //public static mstrSortViewpointTypeBy = "ViewpointTypeId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (ViewpointTypeCRUD_js_1.ViewpointTypeCRUD.objPage_CRUD == null) {
                ViewpointTypeCRUD_js_1.ViewpointTypeCRUD.objPage_CRUD = new ViewpointTypeCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(ViewpointTypeCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.ViewpointTypeCRUDEx = ViewpointTypeCRUDEx;
});
