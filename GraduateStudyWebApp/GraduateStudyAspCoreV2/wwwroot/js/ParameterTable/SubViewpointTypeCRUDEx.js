(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/ParameterTable/SubViewpointTypeCRUD.js", "./SubViewpointType_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SubViewpointTypeCRUDEx = void 0;
    /**
    * 类名:SubViewpointTypeCRUDEx(界面:SubViewpointTypeCRUD)
    * 表名:SubViewpointType(01120533)
    * 版本:2023.01.09.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/12 00:13:31
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    class SubViewpointTypeCRUDEx extends SubViewpointTypeCRUD_js_1.SubViewpointTypeCRUD {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (SubViewpointTypeCRUD_js_1.SubViewpointTypeCRUD.objPage_CRUD == null) {
                SubViewpointTypeCRUD_js_1.SubViewpointTypeCRUD.objPage_CRUD = new SubViewpointTypeCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(SubViewpointTypeCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.SubViewpointTypeCRUDEx = SubViewpointTypeCRUDEx;
});
