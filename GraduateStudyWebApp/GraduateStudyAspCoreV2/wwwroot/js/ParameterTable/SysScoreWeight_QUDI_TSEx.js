...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/L0_Entity/GraduateEduTools/clsvSysScoreWeightEN.js", "../TS/L0_Entity/DailyRunning_Share/clsCurrEduClsEN.js", "../TS/PubFun/clsCommFunc4Web.js", "../TS/L3_ForWApi/DailyRunning_Share/clsCurrEduClsWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../PagesBase/GraduateEduTools/SysScoreWeightCRUD.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SysScoreWeightCRUDEx = void 0;
    ...
    const SysScoreWeightCRUD_js_1 = require("../PagesBase/GraduateEduTools/SysScoreWeightCRUD.js");
    /* SysScoreWeightCRUDEx 的摘要说明。其中Q代表查询,U代表修改
     (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
    */
    class SysScoreWeightCRUDEx extends SysScoreWeightCRUD_js_1.SysScoreWeightCRUD {
      ...
      */
        ...
        static async BindDdl_id_CurrEduCls_Cache(strDdlName, objCurrEduCls_Cond) {
            ...
            var arrObjLst_Sel = await (0, clsCurrEduClsWApi_js_1.CurrEduCls_GetSubObjLst_Cache)(objCurrEduCls_Cond, clsPublocalStorage_js_1.clsPublocalStorage.courseId);
            (0, clsCommFunc4Web_js_1.BindDdl_ObjLst)(strDdlName, arrObjLst_Sel, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_id_CurrEduCls, clsCurrEduClsEN_js_1.clsCurrEduClsEN.con_EduClsName, "教学班");
        }
    }
    exports.SysScoreWeightCRUDEx = SysScoreWeightCRUDEx;
});
