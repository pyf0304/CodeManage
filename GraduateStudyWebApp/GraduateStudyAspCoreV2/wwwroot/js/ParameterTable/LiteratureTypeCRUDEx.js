(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/ParameterTable/LiteratureTypeCRUD.js", "./LiteratureType_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.LiteratureTypeCRUDEx = void 0;
    /**
    * 类名:LiteratureTypeCRUDEx(界面:LiteratureTypeCRUD)
    * 表名:LiteratureType(01120557)
    * 版本:2023.01.09.1(服务器:WIN-SRV103-116)
    * 日期:2023/01/12 01:48:17
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    class LiteratureTypeCRUDEx extends LiteratureTypeCRUD_js_1.LiteratureTypeCRUD {
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            ...
            if (LiteratureTypeCRUD_js_1.LiteratureTypeCRUD.objPage_CRUD == null) {
                LiteratureTypeCRUD_js_1.LiteratureTypeCRUD.objPage_CRUD = new LiteratureTypeCRUDEx();
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(LiteratureTypeCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
    }
    exports.LiteratureTypeCRUDEx = LiteratureTypeCRUDEx;
});
