(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/NewsAnnouncement/MessagePushCRUD.js", "../TS/L0_Entity/NewsAnnouncement/clsvMessagePushEN.js", "../TS/L3_ForWApi/NewsAnnouncement/clsvMessagePushWApi.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js"], factory);
    }
    ...
    */
    class MessagePushListEx extends MessagePushCRUD_js_1.MessagePushCRUD {
        constructor() {
            super(...arguments);
       ...
       */
        ...
        async BindGv_vMessagePush() {
            ...
            var strWhereCond = await this.CombinevMessagePushCondition();
            var intCurrPageIndex = (0, clsOperateList_js_1.GetCurrPageIndex)(this.objPager.currPageIndex); //获取当前页
            var arrvMessagePushObjLst = [];
            try {
                this.recCount = await (0, clsvMessagePushWApi_js_1.vMessagePush_GetRecCountByCondAsync)(strWhereCond);
                var objPagerPara = {
