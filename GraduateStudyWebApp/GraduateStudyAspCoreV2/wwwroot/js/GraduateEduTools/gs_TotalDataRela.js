(function (factory) {
    ...
    */
    class gs_TotalDataRela extends ResearchTopicCRUD_js_1.ResearchTopicCRUD {
        constructor() {
       ...
       */
        ...
        async GetRelaId() {
            ...
            try {
                const objgs_TotalDataStatistics = await (0, clsgs_TotalDataStatisticsWApi_js_1.gs_TotalDataStatistics_GetFirstObjAsync)(strWhereCond);
        ...
        async btnDelgs_TotalDataRela(strKeyId) {
            try {
                ...
                const objgs_TotalDataStatistics = await (0, clsgs_TotalDataStatisticsWApi_js_1.gs_TotalDataStatistics_GetFirstObjAsync)(strWhereCond1);
                if (objgs_TotalDataStatistics != null) {
                    var strWhereCond2 = " totalDataId1=" + strTotalDataId1 + " and totalDataId2 =" + objgs_TotalDataStatistics.totalDataId;
                    const objgs_TotalDataRela = await (0, clsgs_TotalDataRelaWApi_js_1.gs_TotalDataRela_GetFirstObjAsync)(strWhereCond2);
        ...
        async btnAddgs_TotalDataRela(strKeyId) {
            ...
            try {
                if (objgs_TotalDataStatistics != null) {
                    ...
                    objgs_TotalDataRelaEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate());
                    objgs_TotalDataRelaEN.SetUpdUser(clsPublocalStorage_js_1.clsPublocalStorage.userId);
                    objgs_TotalDataRelaEN.Setid_CurrEduCls(clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls);
