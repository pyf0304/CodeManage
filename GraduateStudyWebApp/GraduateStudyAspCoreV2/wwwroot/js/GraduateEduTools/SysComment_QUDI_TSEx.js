(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/GraduateEduTools/SysCommentCRUD.js", "../TS/L0_Entity/GraduateEduPaper/clsPaperEN.js", "../TS/L0_Entity/GraduateEduTools/clsSysCommentEN.js", "../TS/L0_Entity/GraduateEduTools/clsvSysCommentEN.js", "../TS/L0_Entity/GraduateEduTopic/clsConceptEN.js", "../TS/L0_Entity/GraduateEduTopic/clsTopicObjectiveEN.js", "../TS/L0_Entity/GraduateEduTopic/clsViewpointEN.js", "../TS/L3_ForWApi/GraduateEduPaper/clsPaperWApi.js", "../TS/L3_ForWApi/GraduateEduPaper/clsvPaperSubViewpointWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsvSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvConceptWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvTopicObjectiveWApi.js", "../TS/L3_ForWApi/GraduateEduTopic/clsvViewpointWApi.js", "../TS/L3_ForWApi/UserManage_Share/clsvUsersSimWApi.js", "../TS/PubConfig/clsSysPara4WebApi.js", "../TS/PubFun/clsOperateList.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
    ...
    */
    class SysComment_QUDI_TSEx extends SysCommentCRUD_js_1.SysCommentCRUD {
        ...
        async Page_Load() {
            ...
            try {
                ...
                if (clsPublocalStorage_js_1.clsPublocalStorage.userId != "") {
                    SysCommentCRUD_js_1.SysCommentCRUD.sortvSysCommentBy = "updDate Desc";
    ...
    */
       ...
       */
        async CombinevSysCommentCondition1() {
            ...
            var strUserId = "";
            var objUser = arrUsers.find(x => x.userId == this.userId_q);
            if (objUser != null) {
        ...
        async BindGv_vSysComment() {
            ...
            switch (strQueryStata) {
                case "1":
                    ...
                    arrPaperObjLst = await (0, clsPaperWApi_js_1.Paper_GetObjLstAsync)(strWhere);
            ...
            try {
                ...
                var objPagerPara = {
                    ...
                    orderBy: SysCommentCRUD_js_1.SysCommentCRUD.sortvSysCommentBy,
                ...
                if (ParentarrvSysCommentObjLst.length > 0) {
                    ...
                    if (RemainDatavSysCommentObjLst.length > 0) {
                        ...
                        console.error("Error: ", strMsg);
                        //console.trace();
                        (0, clsOperateList_js_1.ShowEmptyRecNumInfo)(SysComment_QUDI_TSEx.arrDivDataLst[intQueryStata], strMsg);
                        this.objPager.Hide(SysComment_QUDI_TSEx.arrDivName4Pager[intQueryStata]);
                        //return;
                    }
                }
