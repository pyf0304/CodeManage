(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass_Share/clsPubFun4Web.js", "../TS/L0_Entity/GraduateEduTools/clsSysScoreSummaryEN.js", "../TS/L3_ForWApi/DailyRunning_Share/clsvCurrEduClsStuWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysCommentWApi.js", "../TS/L3_ForWApi/GraduateEduTools/clsSysScoreSummaryWApi.js", "../TS/L3_ForWApi/InteractManage/clsgs_TagsWApi.js", "../TS/L3_ForWApi/InteractManage/clsvqa_AnswerWApi.js", "../TS/L3_ForWApiEx/GraduateEdu/clsSysCommentExWApi.js", "../TS/PubFun/clsPublocalStorage.js", "../TS/PubFun/clsString.js"], factory);
    }
    ...
    class CommentScore {
       ...
       */
        ...
        async Bind_PaperTags() {
            ...
            var strWhereCond4 = " 1=1 and updUser='" + strUserId + "' and id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "' order by updDate desc";
            //var intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
            //打分0045 表示标记打分（教师专属）
            var strWhereCond5 = " 1=1 and userId='" + strUserId + "' And scoreTypeId ='0045' And id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "'";
            try {
                //获取标记数据；
        ...
        async CurrEduClsStuTree() {
            ...
            var strWhereCond1 = " id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "'"; //得到评论表的条件；
            //得到讨论表的条件；010203代表属于讨论的类型；
            var strWhereCond3 = " id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "' And answerTypeId in ('01','02','03')";
            //打分00041 0042 表示讨论打分 和评价打分（教师专属）
            var strWhereCond4 = " scoreTypeId in('0041','0042','0045') And id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "'";
        ...
        async Bind_Qa_Answer() {
            ...
            var strId_CurrEducls = clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls;
            //得到讨论表的条件；010203代表属于讨论的类型；
            var strWhereCond3 = " 1=1 and updUser='" + strUserId + "' and id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "' And answerTypeId in ('01','02','03') order by updDate desc";
            var strWhereCond4 = " 1=1 and updUser='" + strUserId + "' and id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "'";
            //var intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
            //打分00041 0042 表示讨论打分 和评价打分（教师专属）
            var strWhereCond5 = " 1=1 and userId='" + strUserId + "' And scoreTypeId ='0041' And id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "'";
            try {
                //获取讨论数据；
                const responseObjLst1 = await (0, clsvqa_AnswerWApi_js_1.vqa_Answer_GetObjLstAsync)(strWhereCond3).then((jsonData) => {
                    arrvqa_AnswerObjLst = jsonData;
        ...
        async Bind_SysComment() {
            ...
            //var intCurrPageIndex = GetCurrPageIndex(this.objPager.currPageIndex);//获取当前页
            //打分00041 0042 表示讨论打分 和评价打分（教师专属）
            var strWhereCond5 = " 1=1 and userId='" + strUserId + "' And scoreTypeId ='0042' And id_CurrEduCls='" + clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls + "'";
            try {
                ////获取讨论数据；
        ...
        async SubmitScore_Click() {
            try {
                var strUserId = $("#hidStuId").val();
                var strUpdUser = clsPublocalStorage_js_1.clsPublocalStorage.userId;
                var strnum = $("#hidTabNum").val();
                var objSysScoreSummaryEN = new clsSysScoreSummaryEN_js_1.clsSysScoreSummaryEN();
                objSysScoreSummaryEN.SetUserId(strUserId);
                objSysScoreSummaryEN.SetScore($("#txtScoreName").val());
                objSysScoreSummaryEN.Setid_CurrEduCls(clsPublocalStorage_js_1.clsPublocalStorage.id_CurrEduCls);
                if (strnum == "1") {
                    //讨论
                ...
                objSysScoreSummaryEN.SetUpdDate(clsPubFun4Web_js_1.clsPubFun4Web.getNowDate()); // 修改日期
