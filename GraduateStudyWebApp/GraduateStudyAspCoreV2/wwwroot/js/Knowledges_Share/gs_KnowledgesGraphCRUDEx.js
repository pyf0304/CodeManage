(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../PagesBase/Knowledges_Share/gs_KnowledgesGraphCRUD.js", "./gs_KnowledgesGraph_EditEx.js", "../TS/PubFun/clsCommFunc4Ctrl.js", "../TS/PubFun/clsString.js"], factory);
    }
    ...
    /**
    * 类名:gs_KnowledgesGraphCRUDEx(界面:gs_KnowledgesGraphCRUD)
    * 表名:gs_KnowledgesGraph(01120873)
    * 版本:2023.03.10.1(服务器:WIN-SRV103-116)
    * 日期:2023/03/13 00:59:23
    * 生成者:
    工程名称:问卷调查(0112)
    ...
    **/
    class gs_KnowledgesGraphCRUDEx extends gs_KnowledgesGraphCRUD_js_1.gs_KnowledgesGraphCRUD {
        ...
        //public static mstrSortgs_KnowledgesGraphBy = "KnowledgeGraphId";
        /**
        * 每页记录数，在扩展类可以修改
        **/
        get pageSize() {
        ...
        BindGv(strType, strPara) {
            alert('该类没有绑定该函数：[this.BindGv_gs_KnowledgesGraph]！' + strType + strPara);
        ...
        **/
        static btn_Click(strCommandName, strKeyId) {
            let objPage;
            if (gs_KnowledgesGraphCRUD_js_1.gs_KnowledgesGraphCRUD.objPage_CRUD == null) {
                gs_KnowledgesGraphCRUD_js_1.gs_KnowledgesGraphCRUD.objPage_CRUD = new gs_KnowledgesGraphCRUDEx();
                objPage = gs_KnowledgesGraphCRUD_js_1.gs_KnowledgesGraphCRUD.objPage_CRUD;
            }
            else {
                objPage = gs_KnowledgesGraphCRUD_js_1.gs_KnowledgesGraphCRUD.objPage_CRUD;
            }
            const objPage_Edit = new gs_KnowledgesGraph_EditEx_js_1.gs_KnowledgesGraph_EditEx(objPage);
            let strMsg = '';
            ...
            switch (strCommandName) {
                ...
                case "ReOrder": //重序记录
                    ...
                    break;
                default:
                    strMsg = '命令:' + strCommandName + "在函数(gs_KnowledgesGraphCRUDExEx.btn_Click)中没有被处理！";
                    alert(strMsg);
                    break;
            }
        }
