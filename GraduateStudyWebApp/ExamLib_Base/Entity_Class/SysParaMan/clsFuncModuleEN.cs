...
public static string[] AttributeName = new string[] {"FuncModuleId", "FuncModuleName", "FuncModuleNameSim", "Memo", "UpdDate", "UpdUser", "OrderNum", "PrjId", "FuncModuleEnName", "UseStateId"};
