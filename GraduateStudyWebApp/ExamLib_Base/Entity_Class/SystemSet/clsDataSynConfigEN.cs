...
public static string[] AttributeName = new string[] {"mId", "TabName", "IsSynch", "SynCondition", "SynCondition4Web", "SynchCycle", "SynchDate", "SynchTime", "SenderUser", "SenderPwd", "smtp", "Receiver", "lastMailDate", "lastExecuteDate", "SynchStartTime", "SynchEndTime", "Memo"};
...
{
public const string _CurrTabName = "DataSynConfig"; //当前表名,与该类相关的表名
