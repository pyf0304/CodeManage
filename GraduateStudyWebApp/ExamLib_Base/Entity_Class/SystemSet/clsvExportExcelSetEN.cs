...
public static string[] AttributeName = new string[] {"IdExportExcel4Users", "ViewName", "TabName", "ViewTabName", "UserId", "UserName", "IsDefaultUser", "ExportFileName", "UpdDate", "UpdUserId", "Memo"};
