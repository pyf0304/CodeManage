...
public static string[] AttributeName = new string[] {"IdSchool", "SchoolId", "SchoolName", "SchoolENName", "SchoolNameA", "SchoolTypeId", "IsCurrentUse", "UpdDate", "UpdUserId", "Memo"};

protected string mstrIdSchool;    //学校流水号
protected string mstrSchoolId;    //学校编号
protected string mstrSchoolName;    //学校名称
protected string mstrSchoolENName;    //SchoolENName
...
//以下是属性变量
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string SchoolENName = "SchoolENName";    //SchoolENName
