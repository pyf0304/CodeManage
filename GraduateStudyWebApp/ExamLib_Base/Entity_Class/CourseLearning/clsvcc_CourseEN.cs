...
{
 /// <summary>
 /// 表vcc_Course的关键字(CourseId)的类型定义. 以便检查类型以及操作方便.
 /// (AutoGCLib.EntityLayer4CSharp:GeneCode)
 /// </summary>
public class K_CourseId_vcc_Course
{
...
public K_CourseId_vcc_Course(string strCourseId)
{
...
/// <param name="value">原类型表关键字</param>
 /// <returns>返回:[K_CourseId_vcc_Course]类型的对象</returns>
public static implicit operator K_CourseId_vcc_Course(string value)
{
return new K_CourseId_vcc_Course(value);
}
}
 /// <summary>
 /// v课程(vcc_Course)
...
public class clsvcc_CourseEN : clsEntityBase2
{
public static string _ConnectString = ""; //当前表名,所使用的连接,如果为空就使用系统默认的连接
public new const string _CurrTabName = "vcc_Course"; //当前表名,与该类相关的表名
...
public clsvcc_CourseEN(string strCourseId)
 {
strCourseId = strCourseId.Replace("'", "''");
if (strCourseId.Length > 8)
{
throw new Exception("在表:vcc_Course中,关键字长度不正确!");
}
if (string.IsNullOrEmpty(strCourseId)  ==  true)
{
throw new Exception("在表:vcc_Course中,关键字不能为空 或 null!");
}
try
{
...
get
{
if (strAttributeName  ==  convcc_Course.CourseId)
{
return mstrCourseId;
}
else if (strAttributeName  ==  convcc_Course.LikeCount)
{
return mintLikeCount;
}
else if (strAttributeName  ==  convcc_Course.CourseCode)
{
return mstrCourseCode;
}
else if (strAttributeName  ==  convcc_Course.CourseDescription)
{
return mstrCourseDescription;
}
else if (strAttributeName  ==  convcc_Course.CourseName)
{
return mstrCourseName;
}
else if (strAttributeName  ==  convcc_Course.CourseTypeId)
{
return mstrCourseTypeId;
}
else if (strAttributeName  ==  convcc_Course.CourseTypeName)
{
return mstrCourseTypeName;
}
else if (strAttributeName  ==  convcc_Course.CreateDate)
{
return mstrCreateDate;
}
else if (strAttributeName  ==  convcc_Course.ExcellentTypeId)
{
return mstrExcellentTypeId;
}
else if (strAttributeName  ==  convcc_Course.ExcellentTypeName)
{
return mstrExcellentTypeName;
}
else if (strAttributeName  ==  convcc_Course.ExcellentYear)
{
return mintExcellentYear;
}
else if (strAttributeName  ==  convcc_Course.IsBuildingCourse)
{
return mbolIsBuildingCourse;
}
else if (strAttributeName  ==  convcc_Course.IsDoubleLanguageCourse)
{
return mbolIsDoubleLanguageCourse;
}
else if (strAttributeName  ==  convcc_Course.IsOpen)
{
return mbolIsOpen;
}
else if (strAttributeName  ==  convcc_Course.IsRecommendedCourse)
{
return mbolIsRecommendedCourse;
}
else if (strAttributeName  ==  convcc_Course.IsSelfPropelledCourse)
{
return mbolIsSelfPropelledCourse;
}
else if (strAttributeName  ==  convcc_Course.OperationDate)
{
return mstrOperationDate;
}
else if (strAttributeName  ==  convcc_Course.OrderNum)
{
return mintOrderNum;
}
else if (strAttributeName  ==  convcc_Course.OuterLink)
{
return mstrOuterLink;
}
else if (strAttributeName  ==  convcc_Course.ViewCount)
{
return mintViewCount;
}
else if (strAttributeName  ==  convcc_Course.ThemeId)
{
return mstrThemeId;
}
else if (strAttributeName  ==  convcc_Course.ThemeName)
{
return mstrThemeName;
}
else if (strAttributeName  ==  convcc_Course.ExampleImgPath)
{
return mstrExampleImgPath;
}
else if (strAttributeName  ==  convcc_Course.IdXzMajor)
{
return mstrIdXzMajor;
}
else if (strAttributeName  ==  convcc_Course.MajorID)
{
return mstrMajorID;
}
else if (strAttributeName  ==  convcc_Course.MajorName)
{
return mstrMajorName;
}
else if (strAttributeName  ==  convcc_Course.IdXzCollege)
{
return mstrIdXzCollege;
}
else if (strAttributeName  ==  convcc_Course.CollegeId)
{
return mstrCollegeId;
}
else if (strAttributeName  ==  convcc_Course.CollegeName)
{
return mstrCollegeName;
}
else if (strAttributeName  ==  convcc_Course.CollegeNameA)
{
return mstrCollegeNameA;
}
else if (strAttributeName  ==  convcc_Course.Memo)
{
return mstrMemo;
}
return null;
...
mstrCourseId = value.ToString();
 AddUpdatedFld(convcc_Course.CourseId);
}
else if (strAttributeName  ==  convcc_Course.LikeCount)
{
mintLikeCount = TransNullToInt(value.ToString());
 AddUpdatedFld(convcc_Course.LikeCount);
}
else if (strAttributeName  ==  convcc_Course.CourseCode)
{
mstrCourseCode = value.ToString();
 AddUpdatedFld(convcc_Course.CourseCode);
}
else if (strAttributeName  ==  convcc_Course.CourseDescription)
{
mstrCourseDescription = value.ToString();
 AddUpdatedFld(convcc_Course.CourseDescription);
}
else if (strAttributeName  ==  convcc_Course.CourseName)
{
mstrCourseName = value.ToString();
 AddUpdatedFld(convcc_Course.CourseName);
}
else if (strAttributeName  ==  convcc_Course.CourseTypeId)
{
mstrCourseTypeId = value.ToString();
 AddUpdatedFld(convcc_Course.CourseTypeId);
}
else if (strAttributeName  ==  convcc_Course.CourseTypeName)
{
mstrCourseTypeName = value.ToString();
 AddUpdatedFld(convcc_Course.CourseTypeName);
}
else if (strAttributeName  ==  convcc_Course.CreateDate)
{
mstrCreateDate = value.ToString();
 AddUpdatedFld(convcc_Course.CreateDate);
}
else if (strAttributeName  ==  convcc_Course.ExcellentTypeId)
{
mstrExcellentTypeId = value.ToString();
 AddUpdatedFld(convcc_Course.ExcellentTypeId);
}
else if (strAttributeName  ==  convcc_Course.ExcellentTypeName)
{
mstrExcellentTypeName = value.ToString();
 AddUpdatedFld(convcc_Course.ExcellentTypeName);
}
else if (strAttributeName  ==  convcc_Course.ExcellentYear)
{
mintExcellentYear = TransNullToInt(value.ToString());
 AddUpdatedFld(convcc_Course.ExcellentYear);
}
else if (strAttributeName  ==  convcc_Course.IsBuildingCourse)
{
mbolIsBuildingCourse = TransNullToBool(value.ToString());
 AddUpdatedFld(convcc_Course.IsBuildingCourse);
}
else if (strAttributeName  ==  convcc_Course.IsDoubleLanguageCourse)
{
mbolIsDoubleLanguageCourse = TransNullToBool(value.ToString());
 AddUpdatedFld(convcc_Course.IsDoubleLanguageCourse);
}
else if (strAttributeName  ==  convcc_Course.IsOpen)
{
mbolIsOpen = TransNullToBool(value.ToString());
 AddUpdatedFld(convcc_Course.IsOpen);
}
else if (strAttributeName  ==  convcc_Course.IsRecommendedCourse)
{
mbolIsRecommendedCourse = TransNullToBool(value.ToString());
 AddUpdatedFld(convcc_Course.IsRecommendedCourse);
}
else if (strAttributeName  ==  convcc_Course.IsSelfPropelledCourse)
{
mbolIsSelfPropelledCourse = TransNullToBool(value.ToString());
 AddUpdatedFld(convcc_Course.IsSelfPropelledCourse);
}
else if (strAttributeName  ==  convcc_Course.OperationDate)
{
mstrOperationDate = value.ToString();
 AddUpdatedFld(convcc_Course.OperationDate);
}
else if (strAttributeName  ==  convcc_Course.OrderNum)
{
mintOrderNum = TransNullToInt(value.ToString());
 AddUpdatedFld(convcc_Course.OrderNum);
}
else if (strAttributeName  ==  convcc_Course.OuterLink)
{
mstrOuterLink = value.ToString();
 AddUpdatedFld(convcc_Course.OuterLink);
}
else if (strAttributeName  ==  convcc_Course.ViewCount)
{
mintViewCount = TransNullToInt(value.ToString());
 AddUpdatedFld(convcc_Course.ViewCount);
}
else if (strAttributeName  ==  convcc_Course.ThemeId)
{
mstrThemeId = value.ToString();
 AddUpdatedFld(convcc_Course.ThemeId);
}
else if (strAttributeName  ==  convcc_Course.ThemeName)
{
mstrThemeName = value.ToString();
 AddUpdatedFld(convcc_Course.ThemeName);
}
else if (strAttributeName  ==  convcc_Course.ExampleImgPath)
{
mstrExampleImgPath = value.ToString();
 AddUpdatedFld(convcc_Course.ExampleImgPath);
}
else if (strAttributeName  ==  convcc_Course.IdXzMajor)
{
mstrIdXzMajor = value.ToString();
 AddUpdatedFld(convcc_Course.IdXzMajor);
}
else if (strAttributeName  ==  convcc_Course.MajorID)
{
mstrMajorID = value.ToString();
 AddUpdatedFld(convcc_Course.MajorID);
}
else if (strAttributeName  ==  convcc_Course.MajorName)
{
mstrMajorName = value.ToString();
 AddUpdatedFld(convcc_Course.MajorName);
}
else if (strAttributeName  ==  convcc_Course.IdXzCollege)
{
mstrIdXzCollege = value.ToString();
 AddUpdatedFld(convcc_Course.IdXzCollege);
}
else if (strAttributeName  ==  convcc_Course.CollegeId)
{
mstrCollegeId = value.ToString();
 AddUpdatedFld(convcc_Course.CollegeId);
}
else if (strAttributeName  ==  convcc_Course.CollegeName)
{
mstrCollegeName = value.ToString();
 AddUpdatedFld(convcc_Course.CollegeName);
}
else if (strAttributeName  ==  convcc_Course.CollegeNameA)
{
mstrCollegeNameA = value.ToString();
 AddUpdatedFld(convcc_Course.CollegeNameA);
}
else if (strAttributeName  ==  convcc_Course.Memo)
{
mstrMemo = value.ToString();
 AddUpdatedFld(convcc_Course.Memo);
}
}
}
...
get
{
if (convcc_Course.CourseId  ==  AttributeName[intIndex])
{
return mstrCourseId;
}
else if (convcc_Course.LikeCount  ==  AttributeName[intIndex])
{
return mintLikeCount;
}
else if (convcc_Course.CourseCode  ==  AttributeName[intIndex])
{
return mstrCourseCode;
}
else if (convcc_Course.CourseDescription  ==  AttributeName[intIndex])
{
return mstrCourseDescription;
}
else if (convcc_Course.CourseName  ==  AttributeName[intIndex])
{
return mstrCourseName;
}
else if (convcc_Course.CourseTypeId  ==  AttributeName[intIndex])
{
return mstrCourseTypeId;
}
else if (convcc_Course.CourseTypeName  ==  AttributeName[intIndex])
{
return mstrCourseTypeName;
}
else if (convcc_Course.CreateDate  ==  AttributeName[intIndex])
{
return mstrCreateDate;
}
else if (convcc_Course.ExcellentTypeId  ==  AttributeName[intIndex])
{
return mstrExcellentTypeId;
}
else if (convcc_Course.ExcellentTypeName  ==  AttributeName[intIndex])
{
return mstrExcellentTypeName;
}
else if (convcc_Course.ExcellentYear  ==  AttributeName[intIndex])
{
return mintExcellentYear;
}
else if (convcc_Course.IsBuildingCourse  ==  AttributeName[intIndex])
{
return mbolIsBuildingCourse;
}
else if (convcc_Course.IsDoubleLanguageCourse  ==  AttributeName[intIndex])
{
return mbolIsDoubleLanguageCourse;
}
else if (convcc_Course.IsOpen  ==  AttributeName[intIndex])
{
return mbolIsOpen;
}
else if (convcc_Course.IsRecommendedCourse  ==  AttributeName[intIndex])
{
return mbolIsRecommendedCourse;
}
else if (convcc_Course.IsSelfPropelledCourse  ==  AttributeName[intIndex])
{
return mbolIsSelfPropelledCourse;
}
else if (convcc_Course.OperationDate  ==  AttributeName[intIndex])
{
return mstrOperationDate;
}
else if (convcc_Course.OrderNum  ==  AttributeName[intIndex])
{
return mintOrderNum;
}
else if (convcc_Course.OuterLink  ==  AttributeName[intIndex])
{
return mstrOuterLink;
}
else if (convcc_Course.ViewCount  ==  AttributeName[intIndex])
{
return mintViewCount;
}
else if (convcc_Course.ThemeId  ==  AttributeName[intIndex])
{
return mstrThemeId;
}
else if (convcc_Course.ThemeName  ==  AttributeName[intIndex])
{
return mstrThemeName;
}
else if (convcc_Course.ExampleImgPath  ==  AttributeName[intIndex])
{
return mstrExampleImgPath;
}
else if (convcc_Course.IdXzMajor  ==  AttributeName[intIndex])
{
return mstrIdXzMajor;
}
else if (convcc_Course.MajorID  ==  AttributeName[intIndex])
{
return mstrMajorID;
}
else if (convcc_Course.MajorName  ==  AttributeName[intIndex])
{
return mstrMajorName;
}
else if (convcc_Course.IdXzCollege  ==  AttributeName[intIndex])
{
return mstrIdXzCollege;
}
else if (convcc_Course.CollegeId  ==  AttributeName[intIndex])
{
return mstrCollegeId;
}
else if (convcc_Course.CollegeName  ==  AttributeName[intIndex])
{
return mstrCollegeName;
}
else if (convcc_Course.CollegeNameA  ==  AttributeName[intIndex])
{
return mstrCollegeNameA;
}
else if (convcc_Course.Memo  ==  AttributeName[intIndex])
{
return mstrMemo;
}
return null;
...
/// </summary>
 ...
 /// </summary>
public static class convcc_Course
{
public const string _CurrTabName = "vcc_Course"; //当前表名,与该类相关的表名
