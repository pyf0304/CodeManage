...
public static string[] AttributeName = new string[] {"mId", "IpAddress", "UserId", "RoleId", "QxPrjId", "Memo", "PrjName", "RoleName", "UserName", "DepartmentId", "UserStateId", "DepartmentName", "UserStateName", "StuTeacherId", "IdentityDesc", "IdentityId", "UpdDate", "UpdUserId"};
