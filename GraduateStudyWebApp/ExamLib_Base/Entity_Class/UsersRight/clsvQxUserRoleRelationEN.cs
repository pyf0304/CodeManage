...
public static string[] AttributeName = new string[] {"mId", "UserId", "RoleId", "QxPrjId", "Memo", "PrjName", "RoleName", "UserName", "DepartmentId", "UserStateId", "DepartmentName", "UserStateName", "IdentityDesc", "IdentityId", "StuTeacherId", "CollegeName", "IdXzCollege", "Password"};
...
//以下是属性变量
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string PrjName = "PrjName";    //PrjName
