...
public static string[] AttributeName = new string[] {"IdXzCollege", "CollegeId", "CollegeName", "CollegeIdInGP", "ClgEnglishName", "CollegeNameA", "UserType", "PhoneNumber", "WebSite", "IdSchool", "IdUni", "IsVisible4Tea", "IsVisible", "OrderNum", "ModifyDate", "ModifyUserId", "Memo"};
