...
namespace ExamLib.Entity
{
 ...
 /// </summary>
[Serializable]
public class clsvNoticeEN : clsEntityBase2
{
public const string _CurrTabName_S = "vNotice"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "NoticeID"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 7;
public static string[] AttributeName = new string[] {"Memo", "publisher", "NoticeID", "NoticeTitle", "NoticeContent", "NoticeDate", "BrowseTime"};
//以下是属性变量
...
public clsvNoticeEN(long lngNoticeID)
 {
 if (lngNoticeID  ==  0)
 {
...
else if (strAttributeName  ==  con_NoticeID)
{
return mlngNoticeID;
}
...
else if (con_NoticeID  ==  AttributeName[intIndex])
{
return mlngNoticeID;
}
...
/// <summary>
/// NoticeID(说明:;字段类型:bigint identity;字段长度:8;是否可空:True)
 /// (AGC_CSV7.BusinessLogicEx.clsPrjTabFldBLEx:ToString2)
/// </summary>
