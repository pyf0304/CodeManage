...
public static string[] AttributeName = new string[] {"UserId", "UserName", "DepartmentId", "IdXzCollege", "UserStateId", "IdGradeBase", "Password", "IdSchool", "Email", "PhoneNumber", "EffitiveBeginDate", "EffitiveEndDate", "StuTeacherId", "IdentityId", "OpenId", "UpdDate", "UpdUser", "IsSynch", "SynchDate", "IsArchive", "Memo"};
...
protected bool mbolIsArchive;    //是否归档
...
/// <summary>
/// 是否归档(说明:;字段类型:bit;字段长度:1;是否可空:True)
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToStringV2)
/// </summary>
  [DataMember]//非常重要
...
//以下是属性变量
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string IsArchive = "IsArchive";    //是否归档
