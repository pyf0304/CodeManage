...
protected string mstrUpDepartmentId;    //UpDepartmentId
protected string mstrDepartmentName;    //部门名称
protected string mstrUpDepartmentName;    //UpDepartmentName
protected string mstrDepartmentTypeName;    //DepartmentTypeName
protected string mstrDepartmentTypeId;    //DepartmentTypeId
protected string mstrDepartmentAbbrName;    //DepartmentAbbrName
...
else if (strAttributeName  ==  convQxUsers.CollegeName)
{
...
else if (strAttributeName  ==  convQxUsers.Email)
{
return mstrEmail;
}
return null;
...
mstrCollegeName = value.ToString();
 AddUpdatedFld(convQxUsers.CollegeName);
}
else if (strAttributeName  ==  convQxUsers.IdXzCollege)
{
...
mstrEmail = value.ToString();
 AddUpdatedFld(convQxUsers.Email);
}
}
}
...
else if (convQxUsers.CollegeName  ==  AttributeName[intIndex])
{
return mstrCollegeName;
}
...
else if (convQxUsers.Email  ==  AttributeName[intIndex])
{
return mstrEmail;
}
return null;
...
/// <summary>
/// UpDepartmentName(说明:;字段类型:varchar;字段长度:100;是否可空:True)
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToStringV2)
/// </summary>
  [DataMember]//非常重要
...
/// <summary>
/// DepartmentTypeName(说明:;字段类型:varchar;字段长度:50;是否可空:True)
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToStringV2)
/// </summary>
  [DataMember]//非常重要
...
//以下是属性变量
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string UpDepartmentId = "UpDepartmentId";    //UpDepartmentId
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string UpDepartmentName = "UpDepartmentName";    //UpDepartmentName

 /// <summary>
 /// 常量:"DepartmentTypeName"
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string DepartmentTypeName = "DepartmentTypeName";    //DepartmentTypeName
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst4ConstLevel)
 /// </summary>
 public const string DepartmentAbbrName = "DepartmentAbbrName";    //DepartmentAbbrName
