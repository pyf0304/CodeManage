...
try
{
objvQxUserRoleRelation4SynchEN.mId = TransNullToInt(objRow[convQxUserRoleRelation4Synch.mId].ToString().Trim()); //mId
...
try
{
 objvQxUserRoleRelation4SynchEN.mId = TransNullToInt(objDT.Rows[0][convQxUserRoleRelation4Synch.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objvQxUserRoleRelation4SynchEN.IpAddress = objDT.Rows[0][convQxUserRoleRelation4Synch.IpAddress].ToString().Trim(); //Ip地址(字段类型:varchar,字段长度:50,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserId = objDT.Rows[0][convQxUserRoleRelation4Synch.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 ...
 objvQxUserRoleRelation4SynchEN.QxPrjId = objDT.Rows[0][convQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 ...
 objvQxUserRoleRelation4SynchEN.PrjName = objDT.Rows[0][convQxUserRoleRelation4Synch.PrjName].ToString().Trim(); //PrjName(字段类型:varchar,字段长度:30,是否可空:True)
 objvQxUserRoleRelation4SynchEN.RoleName = objDT.Rows[0][convQxUserRoleRelation4Synch.RoleName].ToString().Trim(); //角色名(字段类型:varchar,字段长度:100,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserName = objDT.Rows[0][convQxUserRoleRelation4Synch.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objvQxUserRoleRelation4SynchEN.DepartmentId = objDT.Rows[0][convQxUserRoleRelation4Synch.DepartmentId].ToString().Trim(); //部门Id(字段类型:varchar,字段长度:8,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserStateId = objDT.Rows[0][convQxUserRoleRelation4Synch.UserStateId].ToString().Trim(); //用户状态Id(字段类型:char,字段长度:2,是否可空:True)
 objvQxUserRoleRelation4SynchEN.DepartmentName = objDT.Rows[0][convQxUserRoleRelation4Synch.DepartmentName].ToString().Trim(); //部门名称(字段类型:varchar,字段长度:100,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserStateName = objDT.Rows[0][convQxUserRoleRelation4Synch.UserStateName].ToString().Trim(); //用户状态名(字段类型:varchar,字段长度:20,是否可空:True)
 objvQxUserRoleRelation4SynchEN.StuTeacherId = objDT.Rows[0][convQxUserRoleRelation4Synch.StuTeacherId].ToString().Trim(); //学工号(字段类型:varchar,字段长度:20,是否可空:True)
 ...
 objvQxUserRoleRelation4SynchEN.IdentityId = objDT.Rows[0][convQxUserRoleRelation4Synch.IdentityId].ToString().Trim(); //身份Id(字段类型:char,字段长度:2,是否可空:False)
 objvQxUserRoleRelation4SynchEN.UpdDate = objDT.Rows[0][convQxUserRoleRelation4Synch.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UpdUserId = objDT.Rows[0][convQxUserRoleRelation4Synch.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 objvQxUserRoleRelation4SynchEN.mId = Int32.Parse(objRow[convQxUserRoleRelation4Synch.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objvQxUserRoleRelation4SynchEN.IpAddress = objRow[convQxUserRoleRelation4Synch.IpAddress].ToString().Trim(); //Ip地址(字段类型:varchar,字段长度:50,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserId = objRow[convQxUserRoleRelation4Synch.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objvQxUserRoleRelation4SynchEN.RoleId = objRow[convQxUserRoleRelation4Synch.RoleId].ToString().Trim(); //角色Id(字段类型:char,字段长度:8,是否可空:True)
 objvQxUserRoleRelation4SynchEN.QxPrjId = objRow[convQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 ...
 objvQxUserRoleRelation4SynchEN.PrjName = objRow[convQxUserRoleRelation4Synch.PrjName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.PrjName].ToString().Trim(); //PrjName(字段类型:varchar,字段长度:30,是否可空:True)
 objvQxUserRoleRelation4SynchEN.RoleName = objRow[convQxUserRoleRelation4Synch.RoleName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.RoleName].ToString().Trim(); //角色名(字段类型:varchar,字段长度:100,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserName = objRow[convQxUserRoleRelation4Synch.UserName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objvQxUserRoleRelation4SynchEN.DepartmentId = objRow[convQxUserRoleRelation4Synch.DepartmentId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.DepartmentId].ToString().Trim(); //部门Id(字段类型:varchar,字段长度:8,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserStateId = objRow[convQxUserRoleRelation4Synch.UserStateId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UserStateId].ToString().Trim(); //用户状态Id(字段类型:char,字段长度:2,是否可空:True)
 objvQxUserRoleRelation4SynchEN.DepartmentName = objRow[convQxUserRoleRelation4Synch.DepartmentName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.DepartmentName].ToString().Trim(); //部门名称(字段类型:varchar,字段长度:100,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UserStateName = objRow[convQxUserRoleRelation4Synch.UserStateName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UserStateName].ToString().Trim(); //用户状态名(字段类型:varchar,字段长度:20,是否可空:True)
 objvQxUserRoleRelation4SynchEN.StuTeacherId = objRow[convQxUserRoleRelation4Synch.StuTeacherId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.StuTeacherId].ToString().Trim(); //学工号(字段类型:varchar,字段长度:20,是否可空:True)
 objvQxUserRoleRelation4SynchEN.IdentityDesc = objRow[convQxUserRoleRelation4Synch.IdentityDesc] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.IdentityDesc].ToString().Trim(); //身份描述(字段类型:varchar,字段长度:20,是否可空:False)
 objvQxUserRoleRelation4SynchEN.IdentityId = objRow[convQxUserRoleRelation4Synch.IdentityId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.IdentityId].ToString().Trim(); //身份Id(字段类型:char,字段长度:2,是否可空:False)
 objvQxUserRoleRelation4SynchEN.UpdDate = objRow[convQxUserRoleRelation4Synch.UpdDate] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objvQxUserRoleRelation4SynchEN.UpdUserId = objRow[convQxUserRoleRelation4Synch.UpdUserId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
	clsvQxUserRoleRelation4SynchEN objvQxUserRoleRelation4SynchEN = new clsvQxUserRoleRelation4SynchEN()
{
mId = TransNullToInt(objRow[convQxUserRoleRelation4Synch.mId].ToString().Trim()), //mId
IpAddress = objRow[convQxUserRoleRelation4Synch.IpAddress].ToString().Trim(), //Ip地址
UserId = objRow[convQxUserRoleRelation4Synch.UserId].ToString().Trim(), //用户ID
RoleId = objRow[convQxUserRoleRelation4Synch.RoleId].ToString().Trim(), //角色Id
QxPrjId = objRow[convQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(), //QxPrjId
...
PrjName = objRow[convQxUserRoleRelation4Synch.PrjName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.PrjName].ToString().Trim(), //PrjName
RoleName = objRow[convQxUserRoleRelation4Synch.RoleName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.RoleName].ToString().Trim(), //角色名
UserName = objRow[convQxUserRoleRelation4Synch.UserName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UserName].ToString().Trim(), //用户名
DepartmentId = objRow[convQxUserRoleRelation4Synch.DepartmentId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.DepartmentId].ToString().Trim(), //部门Id
UserStateId = objRow[convQxUserRoleRelation4Synch.UserStateId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UserStateId].ToString().Trim(), //用户状态Id
DepartmentName = objRow[convQxUserRoleRelation4Synch.DepartmentName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.DepartmentName].ToString().Trim(), //部门名称
UserStateName = objRow[convQxUserRoleRelation4Synch.UserStateName] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UserStateName].ToString().Trim(), //用户状态名
StuTeacherId = objRow[convQxUserRoleRelation4Synch.StuTeacherId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.StuTeacherId].ToString().Trim(), //学工号
IdentityDesc = objRow[convQxUserRoleRelation4Synch.IdentityDesc] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.IdentityDesc].ToString().Trim(), //身份描述
IdentityId = objRow[convQxUserRoleRelation4Synch.IdentityId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.IdentityId].ToString().Trim(), //身份Id
UpdDate = objRow[convQxUserRoleRelation4Synch.UpdDate] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UpdDate].ToString().Trim(), //修改日期
UpdUserId = objRow[convQxUserRoleRelation4Synch.UpdUserId] == DBNull.Value ? null : objRow[convQxUserRoleRelation4Synch.UpdUserId].ToString().Trim() //修改用户Id
};
objvQxUserRoleRelation4SynchEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objvQxUserRoleRelation4SynchEN;
}
...
{
//检查字段长度
clsCheckSql.CheckFieldLen(objvQxUserRoleRelation4SynchEN.IpAddress, 50, convQxUserRoleRelation4Synch.IpAddress);
...
clsCheckSql.CheckFieldLen(objvQxUserRoleRelation4SynchEN.RoleName, 100, convQxUserRoleRelation4Synch.RoleName);
