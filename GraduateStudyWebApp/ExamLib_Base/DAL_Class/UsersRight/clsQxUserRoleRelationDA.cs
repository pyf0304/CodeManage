...
try
{
objQxUserRoleRelationEN.mId = TransNullToInt(objRow[conQxUserRoleRelation.mId].ToString().Trim()); //mId
...
try
{
 objQxUserRoleRelationEN.mId = TransNullToInt(objDT.Rows[0][conQxUserRoleRelation.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objQxUserRoleRelationEN.UserId = objDT.Rows[0][conQxUserRoleRelation.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objQxUserRoleRelationEN.RoleId = objDT.Rows[0][conQxUserRoleRelation.RoleId].ToString().Trim(); //角色Id(字段类型:char,字段长度:8,是否可空:True)
 objQxUserRoleRelationEN.QxPrjId = objDT.Rows[0][conQxUserRoleRelation.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 objQxUserRoleRelationEN.Memo = objDT.Rows[0][conQxUserRoleRelation.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 objQxUserRoleRelationEN.QuestionnaireSetId = objDT.Rows[0][conQxUserRoleRelation.QuestionnaireSetId].ToString().Trim(); //问卷集ID(字段类型:char,字段长度:4,是否可空:True)
 objQxUserRoleRelationEN.UpdDate = objDT.Rows[0][conQxUserRoleRelation.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUserRoleRelationEN.UpdUser = objDT.Rows[0][conQxUserRoleRelation.UpdUser].ToString().Trim(); //修改人(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUserRoleRelationEN.UpdUserId = objDT.Rows[0][conQxUserRoleRelation.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 objQxUserRoleRelationEN.mId = Int32.Parse(objRow[conQxUserRoleRelation.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objQxUserRoleRelationEN.UserId = objRow[conQxUserRoleRelation.UserId] == DBNull.Value ? null : objRow[conQxUserRoleRelation.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objQxUserRoleRelationEN.RoleId = objRow[conQxUserRoleRelation.RoleId].ToString().Trim(); //角色Id(字段类型:char,字段长度:8,是否可空:True)
 objQxUserRoleRelationEN.QxPrjId = objRow[conQxUserRoleRelation.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 ...
 objQxUserRoleRelationEN.QuestionnaireSetId = objRow[conQxUserRoleRelation.QuestionnaireSetId] == DBNull.Value ? null : objRow[conQxUserRoleRelation.QuestionnaireSetId].ToString().Trim(); //问卷集ID(字段类型:char,字段长度:4,是否可空:True)
 objQxUserRoleRelationEN.UpdDate = objRow[conQxUserRoleRelation.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUserRoleRelationEN.UpdUser = objRow[conQxUserRoleRelation.UpdUser].ToString().Trim(); //修改人(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUserRoleRelationEN.UpdUserId = objRow[conQxUserRoleRelation.UpdUserId] == DBNull.Value ? null : objRow[conQxUserRoleRelation.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
	clsQxUserRoleRelationEN objQxUserRoleRelationEN = new clsQxUserRoleRelationEN()
{
mId = TransNullToInt(objRow[conQxUserRoleRelation.mId].ToString().Trim()), //mId
UserId = objRow[conQxUserRoleRelation.UserId] == DBNull.Value ? null : objRow[conQxUserRoleRelation.UserId].ToString().Trim(), //用户ID
RoleId = objRow[conQxUserRoleRelation.RoleId].ToString().Trim(), //角色Id
QxPrjId = objRow[conQxUserRoleRelation.QxPrjId].ToString().Trim(), //QxPrjId
Memo = objRow[conQxUserRoleRelation.Memo] == DBNull.Value ? null : objRow[conQxUserRoleRelation.Memo].ToString().Trim(), //备注
QuestionnaireSetId = objRow[conQxUserRoleRelation.QuestionnaireSetId] == DBNull.Value ? null : objRow[conQxUserRoleRelation.QuestionnaireSetId].ToString().Trim(), //问卷集ID
UpdDate = objRow[conQxUserRoleRelation.UpdDate].ToString().Trim(), //修改日期
UpdUser = objRow[conQxUserRoleRelation.UpdUser].ToString().Trim(), //修改人
UpdUserId = objRow[conQxUserRoleRelation.UpdUserId] == DBNull.Value ? null : objRow[conQxUserRoleRelation.UpdUserId].ToString().Trim() //修改用户Id
};
objQxUserRoleRelationEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objQxUserRoleRelationEN;
}
...
objRow = objDS.Tables["QxUserRoleRelation"].NewRow();
 if (objQxUserRoleRelationEN.UserId !=  "")
 {
...
objRow[conQxUserRoleRelation.QxPrjId] = objQxUserRoleRelationEN.QxPrjId; //QxPrjId
 if (objQxUserRoleRelationEN.Memo !=  "")
 {
objRow[conQxUserRoleRelation.Memo] = objQxUserRoleRelationEN.Memo; //备注
 }
 if (objQxUserRoleRelationEN.QuestionnaireSetId !=  "")
 {
objRow[conQxUserRoleRelation.QuestionnaireSetId] = objQxUserRoleRelationEN.QuestionnaireSetId; //问卷集ID
 }
objRow[conQxUserRoleRelation.UpdDate] = objQxUserRoleRelationEN.UpdDate; //修改日期
objRow[conQxUserRoleRelation.UpdUser] = objQxUserRoleRelationEN.UpdUser; //修改人
 if (objQxUserRoleRelationEN.UpdUserId !=  "")
 {
objRow[conQxUserRoleRelation.UpdUserId] = objQxUserRoleRelationEN.UpdUserId; //修改用户Id
 }
...
StringBuilder strSQL = new StringBuilder();
 ...
 if (objQxUserRoleRelationEN.QuestionnaireSetId !=  null)
 {
 arrFieldListForInsert.Add(conQxUserRoleRelation.QuestionnaireSetId);
 var strQuestionnaireSetId = objQxUserRoleRelationEN.QuestionnaireSetId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 ...
 if (objQxUserRoleRelationEN.UpdUserId !=  null)
 {
 arrFieldListForInsert.Add(conQxUserRoleRelation.UpdUserId);
 var strUpdUserId = objQxUserRoleRelationEN.UpdUserId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
...
objRow[conQxUserRoleRelation.QxPrjId] = oRow[conQxUserRoleRelation.QxPrjId].ToString().Trim(); //QxPrjId
objRow[conQxUserRoleRelation.Memo] = oRow[conQxUserRoleRelation.Memo].ToString().Trim(); //备注
objRow[conQxUserRoleRelation.QuestionnaireSetId] = oRow[conQxUserRoleRelation.QuestionnaireSetId].ToString().Trim(); //问卷集ID
objRow[conQxUserRoleRelation.UpdDate] = oRow[conQxUserRoleRelation.UpdDate].ToString().Trim(); //修改日期
objRow[conQxUserRoleRelation.UpdUser] = oRow[conQxUserRoleRelation.UpdUser].ToString().Trim(); //修改人
objRow[conQxUserRoleRelation.UpdUserId] = oRow[conQxUserRoleRelation.UpdUserId].ToString().Trim(); //修改用户Id
 objDS.Tables[clsQxUserRoleRelationEN._CurrTabName].Rows.Add(objRow);
}
try
{
...
objRow[conQxUserRoleRelation.Memo] = objQxUserRoleRelationEN.Memo; //备注
 ...
 if (objQxUserRoleRelationEN.IsUpdated(conQxUserRoleRelation.QuestionnaireSetId))
 {
objRow[conQxUserRoleRelation.QuestionnaireSetId] = objQxUserRoleRelationEN.QuestionnaireSetId; //问卷集ID
 }
...
objRow[conQxUserRoleRelation.UpdUser] = objQxUserRoleRelationEN.UpdUser; //修改人
 ...
 if (objQxUserRoleRelationEN.IsUpdated(conQxUserRoleRelation.UpdUserId))
 {
objRow[conQxUserRoleRelation.UpdUserId] = objQxUserRoleRelationEN.UpdUserId; //修改用户Id
 }
try
...
sbSQL.AppendFormat("Update QxUserRoleRelation Set ");
 ...
 {
 var strQxPrjId = objQxUserRoleRelationEN.QxPrjId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strQxPrjId, conQxUserRoleRelation.QxPrjId); //QxPrjId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUserRoleRelation.QxPrjId); //QxPrjId
 }
 }
 ...
 {
 var strQuestionnaireSetId = objQxUserRoleRelationEN.QuestionnaireSetId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strQuestionnaireSetId, conQxUserRoleRelation.QuestionnaireSetId); //问卷集ID
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUserRoleRelation.QuestionnaireSetId); //问卷集ID
 }
 }
 ...
 {
 var strUpdUser = objQxUserRoleRelationEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUser, conQxUserRoleRelation.UpdUser); //修改人
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUserRoleRelation.UpdUser); //修改人
 }
 }
 ...
 {
 var strUpdUserId = objQxUserRoleRelationEN.UpdUserId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUserId, conQxUserRoleRelation.UpdUserId); //修改用户Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUserRoleRelation.UpdUserId); //修改用户Id
 }
 }
...
clsCheckSql.CheckFieldLen(objQxUserRoleRelationEN.QuestionnaireSetId, 4, conQxUserRoleRelation.QuestionnaireSetId);
...
clsCheckSql.CheckFieldLen(objQxUserRoleRelationEN.UpdUserId, 20, conQxUserRoleRelation.UpdUserId);
//检查字段外键固定长度
...
clsCheckSql.CheckSqlInjection4Field(objQxUserRoleRelationEN.QuestionnaireSetId, conQxUserRoleRelation.QuestionnaireSetId);
...
clsCheckSql.CheckSqlInjection4Field(objQxUserRoleRelationEN.UpdUserId, conQxUserRoleRelation.UpdUserId);
//检查外键字段长度
 objQxUserRoleRelationEN._IsCheckProperty = true;
}
