...
try
{
objQxRoleRightRelationEN.mId = TransNullToInt(objRow[conQxRoleRightRelation.mId].ToString().Trim()); //mId
...
objQxRoleRightRelationEN.QxPrjId = objRow[conQxRoleRightRelation.QxPrjId].ToString().Trim(); //QxPrjId
objQxRoleRightRelationEN.UpdDate = objRow[conQxRoleRightRelation.UpdDate].ToString().Trim(); //修改日期
objQxRoleRightRelationEN.UpdUser = objRow[conQxRoleRightRelation.UpdUser].ToString().Trim(); //修改人
...
try
{
 objQxRoleRightRelationEN.mId = TransNullToInt(objDT.Rows[0][conQxRoleRightRelation.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objQxRoleRightRelationEN.MyRoleId = objDT.Rows[0][conQxRoleRightRelation.MyRoleId].ToString().Trim(); //主角色Id(字段类型:char,字段长度:8,是否可空:False)
 objQxRoleRightRelationEN.RoleId = objDT.Rows[0][conQxRoleRightRelation.RoleId].ToString().Trim(); //角色Id(字段类型:char,字段长度:8,是否可空:True)
 objQxRoleRightRelationEN.QxPrjId = objDT.Rows[0][conQxRoleRightRelation.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 objQxRoleRightRelationEN.UpdDate = objDT.Rows[0][conQxRoleRightRelation.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxRoleRightRelationEN.UpdUser = objDT.Rows[0][conQxRoleRightRelation.UpdUser].ToString().Trim(); //修改人(字段类型:varchar,字段长度:20,是否可空:True)
...
try
{
 objQxRoleRightRelationEN.mId = Int32.Parse(objRow[conQxRoleRightRelation.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objQxRoleRightRelationEN.MyRoleId = objRow[conQxRoleRightRelation.MyRoleId].ToString().Trim(); //主角色Id(字段类型:char,字段长度:8,是否可空:False)
 objQxRoleRightRelationEN.RoleId = objRow[conQxRoleRightRelation.RoleId].ToString().Trim(); //角色Id(字段类型:char,字段长度:8,是否可空:True)
 objQxRoleRightRelationEN.QxPrjId = objRow[conQxRoleRightRelation.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 objQxRoleRightRelationEN.UpdDate = objRow[conQxRoleRightRelation.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxRoleRightRelationEN.UpdUser = objRow[conQxRoleRightRelation.UpdUser].ToString().Trim(); //修改人(字段类型:varchar,字段长度:20,是否可空:True)
...
try
{
	clsQxRoleRightRelationEN objQxRoleRightRelationEN = new clsQxRoleRightRelationEN()
{
mId = TransNullToInt(objRow[conQxRoleRightRelation.mId].ToString().Trim()), //mId
...
QxPrjId = objRow[conQxRoleRightRelation.QxPrjId].ToString().Trim(), //QxPrjId
UpdDate = objRow[conQxRoleRightRelation.UpdDate].ToString().Trim(), //修改日期
UpdUser = objRow[conQxRoleRightRelation.UpdUser].ToString().Trim(), //修改人
...
objRow[conQxRoleRightRelation.QxPrjId] = objQxRoleRightRelationEN.QxPrjId; //QxPrjId
objRow[conQxRoleRightRelation.UpdDate] = objQxRoleRightRelationEN.UpdDate; //修改日期
objRow[conQxRoleRightRelation.UpdUser] = objQxRoleRightRelationEN.UpdUser; //修改人
...
objRow[conQxRoleRightRelation.QxPrjId] = oRow[conQxRoleRightRelation.QxPrjId].ToString().Trim(); //QxPrjId
objRow[conQxRoleRightRelation.UpdDate] = oRow[conQxRoleRightRelation.UpdDate].ToString().Trim(); //修改日期
objRow[conQxRoleRightRelation.UpdUser] = oRow[conQxRoleRightRelation.UpdUser].ToString().Trim(); //修改人
...
sbSQL.AppendFormat("Update QxRoleRightRelation Set ");
 ...
 {
 var strQxPrjId = objQxRoleRightRelationEN.QxPrjId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strQxPrjId, conQxRoleRightRelation.QxPrjId); //QxPrjId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxRoleRightRelation.QxPrjId); //QxPrjId
 }
 }
 ...
 {
 var strUpdUser = objQxRoleRightRelationEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUser, conQxRoleRightRelation.UpdUser); //修改人
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxRoleRightRelation.UpdUser); //修改人
 }
 }
