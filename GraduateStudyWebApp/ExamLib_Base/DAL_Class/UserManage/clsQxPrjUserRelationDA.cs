...
try
{
objQxPrjUserRelationEN.mId = TransNullToInt(objRow[conQxPrjUserRelation.mId].ToString().Trim()); //mId
...
try
{
 objQxPrjUserRelationEN.mId = TransNullToInt(objDT.Rows[0][conQxPrjUserRelation.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objQxPrjUserRelationEN.QxPrjId = objDT.Rows[0][conQxPrjUserRelation.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 objQxPrjUserRelationEN.UserId = objDT.Rows[0][conQxPrjUserRelation.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objQxPrjUserRelationEN.UpdDate = objDT.Rows[0][conQxPrjUserRelation.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxPrjUserRelationEN.UpdUserId = objDT.Rows[0][conQxPrjUserRelation.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
...
try
{
 objQxPrjUserRelationEN.mId = Int32.Parse(objRow[conQxPrjUserRelation.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objQxPrjUserRelationEN.QxPrjId = objRow[conQxPrjUserRelation.QxPrjId].ToString().Trim(); //QxPrjId(字段类型:char,字段长度:4,是否可空:False)
 objQxPrjUserRelationEN.UserId = objRow[conQxPrjUserRelation.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objQxPrjUserRelationEN.UpdDate = objRow[conQxPrjUserRelation.UpdDate] == DBNull.Value ? null : objRow[conQxPrjUserRelation.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxPrjUserRelationEN.UpdUserId = objRow[conQxPrjUserRelation.UpdUserId] == DBNull.Value ? null : objRow[conQxPrjUserRelation.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
...
try
{
	clsQxPrjUserRelationEN objQxPrjUserRelationEN = new clsQxPrjUserRelationEN()
{
mId = TransNullToInt(objRow[conQxPrjUserRelation.mId].ToString().Trim()), //mId
QxPrjId = objRow[conQxPrjUserRelation.QxPrjId].ToString().Trim(), //QxPrjId
...
UpdUserId = objRow[conQxPrjUserRelation.UpdUserId] == DBNull.Value ? null : objRow[conQxPrjUserRelation.UpdUserId].ToString().Trim(), //修改用户Id
...
objRow[conQxPrjUserRelation.QxPrjId] = objQxPrjUserRelationEN.QxPrjId; //QxPrjId
...
objRow[conQxPrjUserRelation.UpdDate] = objQxPrjUserRelationEN.UpdDate; //修改日期
 ...
 if (objQxPrjUserRelationEN.UpdUserId !=  "")
 {
objRow[conQxPrjUserRelation.UpdUserId] = objQxPrjUserRelationEN.UpdUserId; //修改用户Id
 }
...
StringBuilder strSQL = new StringBuilder();
 ...
 if (objQxPrjUserRelationEN.UpdUserId !=  null)
 {
 arrFieldListForInsert.Add(conQxPrjUserRelation.UpdUserId);
 var strUpdUserId = objQxPrjUserRelationEN.UpdUserId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
...
objRow[conQxPrjUserRelation.QxPrjId] = oRow[conQxPrjUserRelation.QxPrjId].ToString().Trim(); //QxPrjId
...
objRow[conQxPrjUserRelation.UpdUserId] = oRow[conQxPrjUserRelation.UpdUserId].ToString().Trim(); //修改用户Id
...
objRow[conQxPrjUserRelation.UpdDate] = objQxPrjUserRelationEN.UpdDate; //修改日期
 ...
 if (objQxPrjUserRelationEN.IsUpdated(conQxPrjUserRelation.UpdUserId))
 {
objRow[conQxPrjUserRelation.UpdUserId] = objQxPrjUserRelationEN.UpdUserId; //修改用户Id
 }
...
sbSQL.AppendFormat("Update QxPrjUserRelation Set ");
 ...
 {
 var strQxPrjId = objQxPrjUserRelationEN.QxPrjId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strQxPrjId, conQxPrjUserRelation.QxPrjId); //QxPrjId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxPrjUserRelation.QxPrjId); //QxPrjId
 }
 }
 ...
 {
 var strUpdUserId = objQxPrjUserRelationEN.UpdUserId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUserId, conQxPrjUserRelation.UpdUserId); //修改用户Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxPrjUserRelation.UpdUserId); //修改用户Id
 }
 }
...
clsCheckSql.CheckFieldLen(objQxPrjUserRelationEN.UpdUserId, 20, conQxPrjUserRelation.UpdUserId);
...
clsCheckSql.CheckSqlInjection4Field(objQxPrjUserRelationEN.UpdUserId, conQxPrjUserRelation.UpdUserId);
