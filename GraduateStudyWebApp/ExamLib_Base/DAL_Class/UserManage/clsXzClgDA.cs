...
try
{
objXzClgEN.IdXzCollege = objRow[conXzClg.IdXzCollege].ToString().Trim(); //学院流水号
objXzClgEN.CollegeId = objRow[conXzClg.CollegeId].ToString().Trim(); //学院ID
objXzClgEN.CollegeName = objRow[conXzClg.CollegeName].ToString().Trim(); //学院名称
...
objXzClgEN.CollegeNameA = objRow[conXzClg.CollegeNameA].ToString().Trim(); //学院名称简写
objXzClgEN.UserType = objRow[conXzClg.UserType] == DBNull.Value ? null : objRow[conXzClg.UserType].ToString().Trim(); //用户类型
objXzClgEN.PhoneNumber = objRow[conXzClg.PhoneNumber] == DBNull.Value ? null : objRow[conXzClg.PhoneNumber].ToString().Trim(); //电话
objXzClgEN.WebSite = objRow[conXzClg.WebSite] == DBNull.Value ? null : objRow[conXzClg.WebSite].ToString().Trim(); //个人主页
objXzClgEN.IdSchool = objRow[conXzClg.IdSchool] == DBNull.Value ? null : objRow[conXzClg.IdSchool].ToString().Trim(); //学校流水号
objXzClgEN.IdUni = objRow[conXzClg.IdUni] == DBNull.Value ? null : objRow[conXzClg.IdUni].ToString().Trim(); //id_Uni
...
objXzClgEN.OrderNum = objRow[conXzClg.OrderNum] == DBNull.Value ? (int?)null : TransNullToInt(objRow[conXzClg.OrderNum].ToString().Trim()); //序号
...
try
{
 objXzClgEN.IdXzCollege = objDT.Rows[0][conXzClg.IdXzCollege].ToString().Trim(); //学院流水号(字段类型:char,字段长度:4,是否可空:True)
 objXzClgEN.CollegeId = objDT.Rows[0][conXzClg.CollegeId].ToString().Trim(); //学院ID(字段类型:varchar,字段长度:4,是否可空:False)
 objXzClgEN.CollegeName = objDT.Rows[0][conXzClg.CollegeName].ToString().Trim(); //学院名称(字段类型:varchar,字段长度:100,是否可空:False)
 ...
 objXzClgEN.CollegeNameA = objDT.Rows[0][conXzClg.CollegeNameA].ToString().Trim(); //学院名称简写(字段类型:varchar,字段长度:12,是否可空:True)
 objXzClgEN.UserType = objDT.Rows[0][conXzClg.UserType].ToString().Trim(); //用户类型(字段类型:varchar,字段长度:50,是否可空:True)
 objXzClgEN.PhoneNumber = objDT.Rows[0][conXzClg.PhoneNumber].ToString().Trim(); //电话(字段类型:varchar,字段长度:15,是否可空:True)
 objXzClgEN.WebSite = objDT.Rows[0][conXzClg.WebSite].ToString().Trim(); //个人主页(字段类型:varchar,字段长度:60,是否可空:True)
 objXzClgEN.IdSchool = objDT.Rows[0][conXzClg.IdSchool].ToString().Trim(); //学校流水号(字段类型:char,字段长度:4,是否可空:True)
 objXzClgEN.IdUni = objDT.Rows[0][conXzClg.IdUni].ToString().Trim(); //id_Uni(字段类型:char,字段长度:4,是否可空:True)
 ...
 objXzClgEN.OrderNum = TransNullToInt(objDT.Rows[0][conXzClg.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
try
{
 objXzClgEN.IdXzCollege = objRow[conXzClg.IdXzCollege].ToString().Trim(); //学院流水号(字段类型:char,字段长度:4,是否可空:True)
 objXzClgEN.CollegeId = objRow[conXzClg.CollegeId].ToString().Trim(); //学院ID(字段类型:varchar,字段长度:4,是否可空:False)
 objXzClgEN.CollegeName = objRow[conXzClg.CollegeName].ToString().Trim(); //学院名称(字段类型:varchar,字段长度:100,是否可空:False)
 ...
 objXzClgEN.CollegeNameA = objRow[conXzClg.CollegeNameA].ToString().Trim(); //学院名称简写(字段类型:varchar,字段长度:12,是否可空:True)
 ...
 objXzClgEN.PhoneNumber = objRow[conXzClg.PhoneNumber] == DBNull.Value ? null : objRow[conXzClg.PhoneNumber].ToString().Trim(); //电话(字段类型:varchar,字段长度:15,是否可空:True)
 objXzClgEN.WebSite = objRow[conXzClg.WebSite] == DBNull.Value ? null : objRow[conXzClg.WebSite].ToString().Trim(); //个人主页(字段类型:varchar,字段长度:60,是否可空:True)
 ...
 objXzClgEN.IdUni = objRow[conXzClg.IdUni] == DBNull.Value ? null : objRow[conXzClg.IdUni].ToString().Trim(); //id_Uni(字段类型:char,字段长度:4,是否可空:True)
 ...
 objXzClgEN.OrderNum = objRow[conXzClg.OrderNum] == DBNull.Value ? (int?)null : clsEntityBase2.TransNullToInt_S(objRow[conXzClg.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
try
{
	clsXzClgEN objXzClgEN = new clsXzClgEN()
{
IdXzCollege = objRow[conXzClg.IdXzCollege].ToString().Trim(), //学院流水号
CollegeId = objRow[conXzClg.CollegeId].ToString().Trim(), //学院ID
CollegeName = objRow[conXzClg.CollegeName].ToString().Trim(), //学院名称
...
CollegeNameA = objRow[conXzClg.CollegeNameA].ToString().Trim(), //学院名称简写
UserType = objRow[conXzClg.UserType] == DBNull.Value ? null : objRow[conXzClg.UserType].ToString().Trim(), //用户类型
PhoneNumber = objRow[conXzClg.PhoneNumber] == DBNull.Value ? null : objRow[conXzClg.PhoneNumber].ToString().Trim(), //电话
WebSite = objRow[conXzClg.WebSite] == DBNull.Value ? null : objRow[conXzClg.WebSite].ToString().Trim(), //个人主页
IdSchool = objRow[conXzClg.IdSchool] == DBNull.Value ? null : objRow[conXzClg.IdSchool].ToString().Trim(), //学校流水号
IdUni = objRow[conXzClg.IdUni] == DBNull.Value ? null : objRow[conXzClg.IdUni].ToString().Trim(), //id_Uni
...
OrderNum = objRow[conXzClg.OrderNum] == DBNull.Value ? (int?)null : TransNullToInt(objRow[conXzClg.OrderNum].ToString().Trim()), //序号
...
objRow[conXzClg.IdXzCollege] = objXzClgEN.IdXzCollege; //学院流水号
objRow[conXzClg.CollegeId] = objXzClgEN.CollegeId; //学院ID
objRow[conXzClg.CollegeName] = objXzClgEN.CollegeName; //学院名称
...
objRow[conXzClg.CollegeNameA] = objXzClgEN.CollegeNameA; //学院名称简写
...
objRow[conXzClg.UserType] = objXzClgEN.UserType; //用户类型
 ...
 {
objRow[conXzClg.PhoneNumber] = objXzClgEN.PhoneNumber; //电话
 }
 if (objXzClgEN.WebSite !=  "")
 {
objRow[conXzClg.WebSite] = objXzClgEN.WebSite; //个人主页
 }
...
objRow[conXzClg.IdXzCollege] = oRow[conXzClg.IdXzCollege].ToString().Trim(); //学院流水号
objRow[conXzClg.CollegeId] = oRow[conXzClg.CollegeId].ToString().Trim(); //学院ID
objRow[conXzClg.CollegeName] = oRow[conXzClg.CollegeName].ToString().Trim(); //学院名称
...
objRow[conXzClg.CollegeNameA] = oRow[conXzClg.CollegeNameA].ToString().Trim(); //学院名称简写
objRow[conXzClg.UserType] = oRow[conXzClg.UserType].ToString().Trim(); //用户类型
objRow[conXzClg.PhoneNumber] = oRow[conXzClg.PhoneNumber].ToString().Trim(); //电话
objRow[conXzClg.WebSite] = oRow[conXzClg.WebSite].ToString().Trim(); //个人主页
objRow[conXzClg.IdSchool] = oRow[conXzClg.IdSchool].ToString().Trim(); //学校流水号
objRow[conXzClg.IdUni] = oRow[conXzClg.IdUni].ToString().Trim(); //id_Uni
...
objRow[conXzClg.OrderNum] = oRow[conXzClg.OrderNum].ToString().Trim(); //序号
...
sbSQL.AppendFormat("Update XzClg Set ");
 ...
 {
 var strCollegeId = objXzClgEN.CollegeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strCollegeId, conXzClg.CollegeId); //学院ID
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.CollegeId); //学院ID
 }
 }
 ...
 {
 var strCollegeName = objXzClgEN.CollegeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strCollegeName, conXzClg.CollegeName); //学院名称
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.CollegeName); //学院名称
 }
 }
 ...
 {
 var strCollegeNameA = objXzClgEN.CollegeNameA.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strCollegeNameA, conXzClg.CollegeNameA); //学院名称简写
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.CollegeNameA); //学院名称简写
 }
 }
 ...
 {
 var strPhoneNumber = objXzClgEN.PhoneNumber.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strPhoneNumber, conXzClg.PhoneNumber); //电话
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.PhoneNumber); //电话
 }
 }
 ...
 {
 var strWebSite = objXzClgEN.WebSite.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strWebSite, conXzClg.WebSite); //个人主页
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.WebSite); //个人主页
 }
 }
 ...
 {
 var strIdUni = objXzClgEN.IdUni.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strIdUni, conXzClg.IdUni); //id_Uni
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.IdUni); //id_Uni
 }
 }
 ...
 if (objXzClgEN.OrderNum !=  null)
 {
 sbSQL.AppendFormat("{1} = {0},",objXzClgEN.OrderNum, conXzClg.OrderNum); //序号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzClg.OrderNum); //序号
 }
 }
...
sbSQL.AppendFormat("Update XzClg Set ");
 ...
 {
 var strCollegeNameA = objXzClgEN.CollegeNameA.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" CollegeNameA = '{0}',", strCollegeNameA); //学院名称简写
 }
 else
 {
 sbSQL.Append(" CollegeNameA = null,"); //学院名称简写
 }
 }
