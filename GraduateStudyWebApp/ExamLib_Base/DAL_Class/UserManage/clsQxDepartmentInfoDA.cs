...
objQxDepartmentInfoEN.DepartmentName = objRow[conQxDepartmentInfo.DepartmentName].ToString().Trim(); //部门名称
objQxDepartmentInfoEN.DepartmentAbbrName = objRow[conQxDepartmentInfo.DepartmentAbbrName] == DBNull.Value ? null : objRow[conQxDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //DepartmentAbbrName
objQxDepartmentInfoEN.DepartmentTypeId = objRow[conQxDepartmentInfo.DepartmentTypeId] == DBNull.Value ? null : objRow[conQxDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId
objQxDepartmentInfoEN.UpDepartmentId = objRow[conQxDepartmentInfo.UpDepartmentId] == DBNull.Value ? null : objRow[conQxDepartmentInfo.UpDepartmentId].ToString().Trim(); //UpDepartmentId
objQxDepartmentInfoEN.OrderNum = objRow[conQxDepartmentInfo.OrderNum] == DBNull.Value ? (int?)null : TransNullToInt(objRow[conQxDepartmentInfo.OrderNum].ToString().Trim()); //序号
...
try
{
 objQxDepartmentInfoEN.DepartmentId = objDT.Rows[0][conQxDepartmentInfo.DepartmentId].ToString().Trim(); //部门Id(字段类型:varchar,字段长度:8,是否可空:True)
 objQxDepartmentInfoEN.DepartmentName = objDT.Rows[0][conQxDepartmentInfo.DepartmentName].ToString().Trim(); //部门名称(字段类型:varchar,字段长度:100,是否可空:True)
 objQxDepartmentInfoEN.DepartmentAbbrName = objDT.Rows[0][conQxDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //DepartmentAbbrName(字段类型:varchar,字段长度:12,是否可空:True)
 objQxDepartmentInfoEN.DepartmentTypeId = objDT.Rows[0][conQxDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId(字段类型:char,字段长度:2,是否可空:True)
 objQxDepartmentInfoEN.UpDepartmentId = objDT.Rows[0][conQxDepartmentInfo.UpDepartmentId].ToString().Trim(); //UpDepartmentId(字段类型:varchar,字段长度:6,是否可空:True)
 objQxDepartmentInfoEN.OrderNum = TransNullToInt(objDT.Rows[0][conQxDepartmentInfo.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
try
{
 objQxDepartmentInfoEN.DepartmentId = objRow[conQxDepartmentInfo.DepartmentId].ToString().Trim(); //部门Id(字段类型:varchar,字段长度:8,是否可空:True)
 objQxDepartmentInfoEN.DepartmentName = objRow[conQxDepartmentInfo.DepartmentName].ToString().Trim(); //部门名称(字段类型:varchar,字段长度:100,是否可空:True)
 objQxDepartmentInfoEN.DepartmentAbbrName = objRow[conQxDepartmentInfo.DepartmentAbbrName] == DBNull.Value ? null : objRow[conQxDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //DepartmentAbbrName(字段类型:varchar,字段长度:12,是否可空:True)
 objQxDepartmentInfoEN.DepartmentTypeId = objRow[conQxDepartmentInfo.DepartmentTypeId] == DBNull.Value ? null : objRow[conQxDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId(字段类型:char,字段长度:2,是否可空:True)
 objQxDepartmentInfoEN.UpDepartmentId = objRow[conQxDepartmentInfo.UpDepartmentId] == DBNull.Value ? null : objRow[conQxDepartmentInfo.UpDepartmentId].ToString().Trim(); //UpDepartmentId(字段类型:varchar,字段长度:6,是否可空:True)
 objQxDepartmentInfoEN.OrderNum = objRow[conQxDepartmentInfo.OrderNum] == DBNull.Value ? (int?)null : clsEntityBase2.TransNullToInt_S(objRow[conQxDepartmentInfo.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
DepartmentName = objRow[conQxDepartmentInfo.DepartmentName].ToString().Trim(), //部门名称
DepartmentAbbrName = objRow[conQxDepartmentInfo.DepartmentAbbrName] == DBNull.Value ? null : objRow[conQxDepartmentInfo.DepartmentAbbrName].ToString().Trim(), //DepartmentAbbrName
DepartmentTypeId = objRow[conQxDepartmentInfo.DepartmentTypeId] == DBNull.Value ? null : objRow[conQxDepartmentInfo.DepartmentTypeId].ToString().Trim(), //DepartmentTypeId
UpDepartmentId = objRow[conQxDepartmentInfo.UpDepartmentId] == DBNull.Value ? null : objRow[conQxDepartmentInfo.UpDepartmentId].ToString().Trim(), //UpDepartmentId
OrderNum = objRow[conQxDepartmentInfo.OrderNum] == DBNull.Value ? (int?)null : TransNullToInt(objRow[conQxDepartmentInfo.OrderNum].ToString().Trim()), //序号
...
objRow[conQxDepartmentInfo.DepartmentName] = objQxDepartmentInfoEN.DepartmentName; //部门名称
 if (objQxDepartmentInfoEN.DepartmentAbbrName !=  "")
 {
objRow[conQxDepartmentInfo.DepartmentAbbrName] = objQxDepartmentInfoEN.DepartmentAbbrName; //DepartmentAbbrName
 }
 if (objQxDepartmentInfoEN.DepartmentTypeId !=  "")
 {
objRow[conQxDepartmentInfo.DepartmentTypeId] = objQxDepartmentInfoEN.DepartmentTypeId; //DepartmentTypeId
 }
 if (objQxDepartmentInfoEN.UpDepartmentId !=  "")
 {
objRow[conQxDepartmentInfo.UpDepartmentId] = objQxDepartmentInfoEN.UpDepartmentId; //UpDepartmentId
 }
objRow[conQxDepartmentInfo.OrderNum] = objQxDepartmentInfoEN.OrderNum; //序号
...
objRow[conQxDepartmentInfo.DepartmentName] = oRow[conQxDepartmentInfo.DepartmentName].ToString().Trim(); //部门名称
objRow[conQxDepartmentInfo.DepartmentAbbrName] = oRow[conQxDepartmentInfo.DepartmentAbbrName].ToString().Trim(); //DepartmentAbbrName
objRow[conQxDepartmentInfo.DepartmentTypeId] = oRow[conQxDepartmentInfo.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId
objRow[conQxDepartmentInfo.UpDepartmentId] = oRow[conQxDepartmentInfo.UpDepartmentId].ToString().Trim(); //UpDepartmentId
objRow[conQxDepartmentInfo.OrderNum] = oRow[conQxDepartmentInfo.OrderNum].ToString().Trim(); //序号
...
sbSQL.AppendFormat("Update QxDepartmentInfo Set ");
 ...
 {
 var strDepartmentName = objQxDepartmentInfoEN.DepartmentName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strDepartmentName, conQxDepartmentInfo.DepartmentName); //部门名称
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxDepartmentInfo.DepartmentName); //部门名称
 }
 }
 ...
 {
 var strDepartmentAbbrName = objQxDepartmentInfoEN.DepartmentAbbrName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strDepartmentAbbrName, conQxDepartmentInfo.DepartmentAbbrName); //DepartmentAbbrName
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxDepartmentInfo.DepartmentAbbrName); //DepartmentAbbrName
 }
 }
 ...
 {
 var strDepartmentTypeId = objQxDepartmentInfoEN.DepartmentTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strDepartmentTypeId, conQxDepartmentInfo.DepartmentTypeId); //DepartmentTypeId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxDepartmentInfo.DepartmentTypeId); //DepartmentTypeId
 }
 }
 ...
 {
 var strUpDepartmentId = objQxDepartmentInfoEN.UpDepartmentId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpDepartmentId, conQxDepartmentInfo.UpDepartmentId); //UpDepartmentId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxDepartmentInfo.UpDepartmentId); //UpDepartmentId
 }
 }
 ...
 if (objQxDepartmentInfoEN.OrderNum !=  null)
 {
 sbSQL.AppendFormat("{1} = {0},",objQxDepartmentInfoEN.OrderNum, conQxDepartmentInfo.OrderNum); //序号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxDepartmentInfo.OrderNum); //序号
 }
 }
...
sbSQL.AppendFormat("Update QxDepartmentInfo Set ");
 ...
 {
 var strDepartmentAbbrName = objQxDepartmentInfoEN.DepartmentAbbrName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DepartmentAbbrName = '{0}',", strDepartmentAbbrName); //DepartmentAbbrName
 }
 else
 {
 sbSQL.Append(" DepartmentAbbrName = null,"); //DepartmentAbbrName
 }
 }
 ...
 {
 var strDepartmentTypeId = objQxDepartmentInfoEN.DepartmentTypeId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DepartmentTypeId = '{0}',", strDepartmentTypeId); //DepartmentTypeId
 }
 else
 {
 ...
 {
 var strUpDepartmentId = objQxDepartmentInfoEN.UpDepartmentId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" UpDepartmentId = '{0}',", strUpDepartmentId); //UpDepartmentId
 }
 else
 {
 sbSQL.Append(" UpDepartmentId = null,"); //UpDepartmentId
 }
 }
...
clsCheckSql.CheckFieldLen(objQxDepartmentInfoEN.DepartmentAbbrName, 12, conQxDepartmentInfo.DepartmentAbbrName);
