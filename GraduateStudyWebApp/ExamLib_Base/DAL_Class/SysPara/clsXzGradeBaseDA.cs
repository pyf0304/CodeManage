...
objXzGradeBaseEN.GradeBaseNameA = objRow[conXzGradeBase.GradeBaseNameA] == DBNull.Value ? null : objRow[conXzGradeBase.GradeBaseNameA].ToString().Trim(); //年级名称缩写
...
objXzGradeBaseEN.ExecPlanTermIndex = objRow[conXzGradeBase.ExecPlanTermIndex] == DBNull.Value ? (short?)null : TransNullToShort(objRow[conXzGradeBase.ExecPlanTermIndex].ToString().Trim()); //生成执行计划学期
...
objXzGradeBaseEN.Prefix = objRow[conXzGradeBase.Prefix] == DBNull.Value ? null : objRow[conXzGradeBase.Prefix].ToString().Trim(); //前缀
objXzGradeBaseEN.PointCalcVersionId = objRow[conXzGradeBase.PointCalcVersionId] == DBNull.Value ? null : objRow[conXzGradeBase.PointCalcVersionId].ToString().Trim(); //绩点计算版本Id
...
objXzGradeBaseEN.IdStudyLevel = objRow[conXzGradeBase.IdStudyLevel] == DBNull.Value ? null : objRow[conXzGradeBase.IdStudyLevel].ToString().Trim(); //学段流水号
...
try
{
 ...
 objXzGradeBaseEN.GradeBaseName = objDT.Rows[0][conXzGradeBase.GradeBaseName].ToString().Trim(); //年级名称(字段类型:varchar,字段长度:50,是否可空:False)
 objXzGradeBaseEN.GradeBaseNameA = objDT.Rows[0][conXzGradeBase.GradeBaseNameA].ToString().Trim(); //年级名称缩写(字段类型:varchar,字段长度:10,是否可空:False)
 ...
 objXzGradeBaseEN.ExecPlanTermIndex = TransNullToShort(objDT.Rows[0][conXzGradeBase.ExecPlanTermIndex].ToString().Trim()); //生成执行计划学期(字段类型:smallint,字段长度:2,是否可空:True)
 ...
 objXzGradeBaseEN.Prefix = objDT.Rows[0][conXzGradeBase.Prefix].ToString().Trim(); //前缀(字段类型:char,字段长度:3,是否可空:True)
 objXzGradeBaseEN.PointCalcVersionId = objDT.Rows[0][conXzGradeBase.PointCalcVersionId].ToString().Trim(); //绩点计算版本Id(字段类型:char,字段长度:2,是否可空:False)
 ...
 objXzGradeBaseEN.IdStudyLevel = objDT.Rows[0][conXzGradeBase.IdStudyLevel].ToString().Trim(); //学段流水号(字段类型:char,字段长度:4,是否可空:True)
...
try
{
 ...
 objXzGradeBaseEN.GradeBaseName = objRow[conXzGradeBase.GradeBaseName].ToString().Trim(); //年级名称(字段类型:varchar,字段长度:50,是否可空:False)
 objXzGradeBaseEN.GradeBaseNameA = objRow[conXzGradeBase.GradeBaseNameA] == DBNull.Value ? null : objRow[conXzGradeBase.GradeBaseNameA].ToString().Trim(); //年级名称缩写(字段类型:varchar,字段长度:10,是否可空:False)
 ...
 objXzGradeBaseEN.ExecPlanTermIndex = objRow[conXzGradeBase.ExecPlanTermIndex] == DBNull.Value ? (short?)null : clsEntityBase2.TransNullToShort_S(objRow[conXzGradeBase.ExecPlanTermIndex].ToString().Trim()); //生成执行计划学期(字段类型:smallint,字段长度:2,是否可空:True)
 ...
 objXzGradeBaseEN.Prefix = objRow[conXzGradeBase.Prefix] == DBNull.Value ? null : objRow[conXzGradeBase.Prefix].ToString().Trim(); //前缀(字段类型:char,字段长度:3,是否可空:True)
 objXzGradeBaseEN.PointCalcVersionId = objRow[conXzGradeBase.PointCalcVersionId] == DBNull.Value ? null : objRow[conXzGradeBase.PointCalcVersionId].ToString().Trim(); //绩点计算版本Id(字段类型:char,字段长度:2,是否可空:False)
 ...
 objXzGradeBaseEN.IdStudyLevel = objRow[conXzGradeBase.IdStudyLevel] == DBNull.Value ? null : objRow[conXzGradeBase.IdStudyLevel].ToString().Trim(); //学段流水号(字段类型:char,字段长度:4,是否可空:True)
...
GradeBaseNameA = objRow[conXzGradeBase.GradeBaseNameA] == DBNull.Value ? null : objRow[conXzGradeBase.GradeBaseNameA].ToString().Trim(), //年级名称缩写
...
ExecPlanTermIndex = objRow[conXzGradeBase.ExecPlanTermIndex] == DBNull.Value ? (short?)null : TransNullToShort(objRow[conXzGradeBase.ExecPlanTermIndex].ToString().Trim()), //生成执行计划学期
...
Prefix = objRow[conXzGradeBase.Prefix] == DBNull.Value ? null : objRow[conXzGradeBase.Prefix].ToString().Trim(), //前缀
PointCalcVersionId = objRow[conXzGradeBase.PointCalcVersionId] == DBNull.Value ? null : objRow[conXzGradeBase.PointCalcVersionId].ToString().Trim(), //绩点计算版本Id
...
IdStudyLevel = objRow[conXzGradeBase.IdStudyLevel] == DBNull.Value ? null : objRow[conXzGradeBase.IdStudyLevel].ToString().Trim(), //学段流水号
...
objRow[conXzGradeBase.GradeBaseName] = objXzGradeBaseEN.GradeBaseName; //年级名称
 ...
 {
objRow[conXzGradeBase.GradeBaseNameA] = objXzGradeBaseEN.GradeBaseNameA; //年级名称缩写
 }
...
objRow[conXzGradeBase.AllowUpBaseInfo] = objXzGradeBaseEN.AllowUpBaseInfo; //允许修改基本信息
 ...
 {
objRow[conXzGradeBase.Prefix] = objXzGradeBaseEN.Prefix; //前缀
 }
 if (objXzGradeBaseEN.PointCalcVersionId !=  "")
 {
objRow[conXzGradeBase.PointCalcVersionId] = objXzGradeBaseEN.PointCalcVersionId; //绩点计算版本Id
 }
...
objRow[conXzGradeBase.ModifyDate] = objXzGradeBaseEN.ModifyDate; //修改日期
 ...
 {
objRow[conXzGradeBase.IdStudyLevel] = objXzGradeBaseEN.IdStudyLevel; //学段流水号
 }
...
objRow[conXzGradeBase.GradeBaseNameA] = oRow[conXzGradeBase.GradeBaseNameA].ToString().Trim(); //年级名称缩写
...
objRow[conXzGradeBase.Prefix] = oRow[conXzGradeBase.Prefix].ToString().Trim(); //前缀
objRow[conXzGradeBase.PointCalcVersionId] = oRow[conXzGradeBase.PointCalcVersionId].ToString().Trim(); //绩点计算版本Id
...
objRow[conXzGradeBase.IdStudyLevel] = oRow[conXzGradeBase.IdStudyLevel].ToString().Trim(); //学段流水号
...
sbSQL.AppendFormat("Update XzGradeBase Set ");
 ...
 {
 var strGradeBaseNameA = objXzGradeBaseEN.GradeBaseNameA.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strGradeBaseNameA, conXzGradeBase.GradeBaseNameA); //年级名称缩写
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzGradeBase.GradeBaseNameA); //年级名称缩写
 }
 }
 ...
 {
 var strPrefix = objXzGradeBaseEN.Prefix.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strPrefix, conXzGradeBase.Prefix); //前缀
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzGradeBase.Prefix); //前缀
 }
 }
 ...
 {
 var strPointCalcVersionId = objXzGradeBaseEN.PointCalcVersionId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strPointCalcVersionId, conXzGradeBase.PointCalcVersionId); //绩点计算版本Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzGradeBase.PointCalcVersionId); //绩点计算版本Id
 }
 }
 ...
 {
 var strIdStudyLevel = objXzGradeBaseEN.IdStudyLevel.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strIdStudyLevel, conXzGradeBase.IdStudyLevel); //学段流水号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzGradeBase.IdStudyLevel); //学段流水号
 }
 }
...
sbSQL.AppendFormat("Update XzGradeBase Set ");
 ...
 {
 var strGradeBaseNameA = objXzGradeBaseEN.GradeBaseNameA.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" GradeBaseNameA = '{0}',", strGradeBaseNameA); //年级名称缩写
 }
 else
 {
 sbSQL.Append(" GradeBaseNameA = null,"); //年级名称缩写
 }
 }
 ...
 {
 var strPointCalcVersionId = objXzGradeBaseEN.PointCalcVersionId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" PointCalcVersionId = '{0}',", strPointCalcVersionId); //绩点计算版本Id
 }
 else
 {
 sbSQL.Append(" PointCalcVersionId = null,"); //绩点计算版本Id
 }
 }
...
clsCheckSql.CheckFieldLen(objXzGradeBaseEN.GradeBaseName, 50, conXzGradeBase.GradeBaseName);
