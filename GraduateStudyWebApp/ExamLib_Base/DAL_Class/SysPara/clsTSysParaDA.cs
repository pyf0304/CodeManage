...
try
{
objTSysParaEN.mId = TransNullToInt(objRow[conTSysPara.mId].ToString().Trim()); //mId
...
try
{
 objTSysParaEN.mId = TransNullToInt(objDT.Rows[0][conTSysPara.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objTSysParaEN.SysParaName = objDT.Rows[0][conTSysPara.SysParaName].ToString().Trim(); //SysParaName(字段类型:varchar,字段长度:50,是否可空:False)
 objTSysParaEN.SysParaValue = objDT.Rows[0][conTSysPara.SysParaValue].ToString().Trim(); //SysParaValue(字段类型:varchar,字段长度:200,是否可空:False)
 objTSysParaEN.IdSchool = objDT.Rows[0][conTSysPara.IdSchool].ToString().Trim(); //学校流水号(字段类型:char,字段长度:4,是否可空:True)
 objTSysParaEN.SchoolId = objDT.Rows[0][conTSysPara.SchoolId].ToString().Trim(); //学校编号(字段类型:varchar,字段长度:10,是否可空:True)
 objTSysParaEN.ModifyDate = objDT.Rows[0][conTSysPara.ModifyDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objTSysParaEN.ModifyUser = objDT.Rows[0][conTSysPara.ModifyUser].ToString().Trim(); //ModifyUser(字段类型:varchar,字段长度:30,是否可空:True)
...
try
{
 objTSysParaEN.mId = Int32.Parse(objRow[conTSysPara.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objTSysParaEN.SysParaName = objRow[conTSysPara.SysParaName].ToString().Trim(); //SysParaName(字段类型:varchar,字段长度:50,是否可空:False)
 objTSysParaEN.SysParaValue = objRow[conTSysPara.SysParaValue].ToString().Trim(); //SysParaValue(字段类型:varchar,字段长度:200,是否可空:False)
 ...
 objTSysParaEN.SchoolId = objRow[conTSysPara.SchoolId] == DBNull.Value ? null : objRow[conTSysPara.SchoolId].ToString().Trim(); //学校编号(字段类型:varchar,字段长度:10,是否可空:True)
 ...
 objTSysParaEN.ModifyUser = objRow[conTSysPara.ModifyUser] == DBNull.Value ? null : objRow[conTSysPara.ModifyUser].ToString().Trim(); //ModifyUser(字段类型:varchar,字段长度:30,是否可空:True)
...
try
{
	clsTSysParaEN objTSysParaEN = new clsTSysParaEN()
{
mId = TransNullToInt(objRow[conTSysPara.mId].ToString().Trim()), //mId
SysParaName = objRow[conTSysPara.SysParaName].ToString().Trim(), //SysParaName
SysParaValue = objRow[conTSysPara.SysParaValue].ToString().Trim(), //SysParaValue
IdSchool = objRow[conTSysPara.IdSchool] == DBNull.Value ? null : objRow[conTSysPara.IdSchool].ToString().Trim(), //学校流水号
SchoolId = objRow[conTSysPara.SchoolId] == DBNull.Value ? null : objRow[conTSysPara.SchoolId].ToString().Trim(), //学校编号
...
objRow[conTSysPara.SysParaName] = objTSysParaEN.SysParaName; //SysParaName
objRow[conTSysPara.SysParaValue] = objTSysParaEN.SysParaValue; //SysParaValue
...
objRow[conTSysPara.IdSchool] = objTSysParaEN.IdSchool; //学校流水号
 ...
 {
objRow[conTSysPara.SchoolId] = objTSysParaEN.SchoolId; //学校编号
 }
...
objRow[conTSysPara.SysParaName] = oRow[conTSysPara.SysParaName].ToString().Trim(); //SysParaName
objRow[conTSysPara.SysParaValue] = oRow[conTSysPara.SysParaValue].ToString().Trim(); //SysParaValue
objRow[conTSysPara.IdSchool] = oRow[conTSysPara.IdSchool].ToString().Trim(); //学校流水号
objRow[conTSysPara.SchoolId] = oRow[conTSysPara.SchoolId].ToString().Trim(); //学校编号
...
sbSQL.AppendFormat("Update TSysPara Set ");
 ...
 {
 var strSysParaName = objTSysParaEN.SysParaName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSysParaName, conTSysPara.SysParaName); //SysParaName
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conTSysPara.SysParaName); //SysParaName
 }
 }
 ...
 {
 var strSysParaValue = objTSysParaEN.SysParaValue.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSysParaValue, conTSysPara.SysParaValue); //SysParaValue
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conTSysPara.SysParaValue); //SysParaValue
 }
 }
 ...
 {
 var strSchoolId = objTSysParaEN.SchoolId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSchoolId, conTSysPara.SchoolId); //学校编号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conTSysPara.SchoolId); //学校编号
 }
 }
...
clsCheckSql.CheckFieldLen(objTSysParaEN.SchoolId, 10, conTSysPara.SchoolId);
