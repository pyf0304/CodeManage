...
objUserRolesEN.RoleName = objRow[conUserRoles.RoleName].ToString().Trim(); //角色名
objUserRolesEN.QuestionnaireSetId = objRow[conUserRoles.QuestionnaireSetId] == DBNull.Value ? null : objRow[conUserRoles.QuestionnaireSetId].ToString().Trim(); //问卷集ID
objUserRolesEN.PrjId = objRow[conUserRoles.PrjId] == DBNull.Value ? null : objRow[conUserRoles.PrjId].ToString().Trim(); //PrjId
objUserRolesEN.Memo = objRow[conUserRoles.Memo] == DBNull.Value ? null : objRow[conUserRoles.Memo].ToString().Trim(); //备注
objUserRolesEN.IsInUse = TransNullToBool(objRow[conUserRoles.IsInUse].ToString().Trim()); //IsInUse
objUserRolesEN.UpdDate = objRow[conUserRoles.UpdDate] == DBNull.Value ? null : objRow[conUserRoles.UpdDate].ToString().Trim(); //修改日期
objUserRolesEN.UpdUserId = objRow[conUserRoles.UpdUserId] == DBNull.Value ? null : objRow[conUserRoles.UpdUserId].ToString().Trim(); //修改用户Id
}
 catch(Exception objException)
{
...
try
{
 ...
 objUserRolesEN.RoleName = objDT.Rows[0][conUserRoles.RoleName].ToString().Trim(); //角色名(字段类型:varchar,字段长度:100,是否可空:True)
 objUserRolesEN.QuestionnaireSetId = objDT.Rows[0][conUserRoles.QuestionnaireSetId].ToString().Trim(); //问卷集ID(字段类型:char,字段长度:4,是否可空:True)
 objUserRolesEN.PrjId = objDT.Rows[0][conUserRoles.PrjId].ToString().Trim(); //PrjId(字段类型:char,字段长度:4,是否可空:True)
 objUserRolesEN.Memo = objDT.Rows[0][conUserRoles.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 objUserRolesEN.IsInUse = TransNullToBool(objDT.Rows[0][conUserRoles.IsInUse].ToString().Trim()); //IsInUse(字段类型:bit,字段长度:1,是否可空:True)
 objUserRolesEN.UpdDate = objDT.Rows[0][conUserRoles.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objUserRolesEN.UpdUserId = objDT.Rows[0][conUserRoles.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 ...
 objUserRolesEN.RoleName = objRow[conUserRoles.RoleName].ToString().Trim(); //角色名(字段类型:varchar,字段长度:100,是否可空:True)
 objUserRolesEN.QuestionnaireSetId = objRow[conUserRoles.QuestionnaireSetId] == DBNull.Value ? null : objRow[conUserRoles.QuestionnaireSetId].ToString().Trim(); //问卷集ID(字段类型:char,字段长度:4,是否可空:True)
 objUserRolesEN.PrjId = objRow[conUserRoles.PrjId] == DBNull.Value ? null : objRow[conUserRoles.PrjId].ToString().Trim(); //PrjId(字段类型:char,字段长度:4,是否可空:True)
 objUserRolesEN.Memo = objRow[conUserRoles.Memo] == DBNull.Value ? null : objRow[conUserRoles.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
 ...
 objUserRolesEN.UpdDate = objRow[conUserRoles.UpdDate] == DBNull.Value ? null : objRow[conUserRoles.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objUserRolesEN.UpdUserId = objRow[conUserRoles.UpdUserId] == DBNull.Value ? null : objRow[conUserRoles.UpdUserId].ToString().Trim(); //修改用户Id(字段类型:varchar,字段长度:20,是否可空:True)
}
 catch(Exception objException)
{
...
RoleName = objRow[conUserRoles.RoleName].ToString().Trim(), //角色名
QuestionnaireSetId = objRow[conUserRoles.QuestionnaireSetId] == DBNull.Value ? null : objRow[conUserRoles.QuestionnaireSetId].ToString().Trim(), //问卷集ID
PrjId = objRow[conUserRoles.PrjId] == DBNull.Value ? null : objRow[conUserRoles.PrjId].ToString().Trim(), //PrjId
Memo = objRow[conUserRoles.Memo] == DBNull.Value ? null : objRow[conUserRoles.Memo].ToString().Trim(), //备注
IsInUse = TransNullToBool(objRow[conUserRoles.IsInUse].ToString().Trim()), //IsInUse
UpdDate = objRow[conUserRoles.UpdDate] == DBNull.Value ? null : objRow[conUserRoles.UpdDate].ToString().Trim(), //修改日期
UpdUserId = objRow[conUserRoles.UpdUserId] == DBNull.Value ? null : objRow[conUserRoles.UpdUserId].ToString().Trim() //修改用户Id
};
objUserRolesEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objUserRolesEN;
}
...
return bolIsExist;
 ...
 {
 objUserRolesEN.UpdDate = clsDateTime.getTodayDateTimeStr(1);
...
objRow[conUserRoles.RoleName] = objUserRolesEN.RoleName; //角色名
 if (objUserRolesEN.QuestionnaireSetId !=  "")
 {
objRow[conUserRoles.QuestionnaireSetId] = objUserRolesEN.QuestionnaireSetId; //问卷集ID
 }
 if (objUserRolesEN.PrjId !=  "")
 {
objRow[conUserRoles.PrjId] = objUserRolesEN.PrjId; //PrjId
 }
 if (objUserRolesEN.Memo !=  "")
 {
objRow[conUserRoles.Memo] = objUserRolesEN.Memo; //备注
 }
objRow[conUserRoles.IsInUse] = objUserRolesEN.IsInUse; //IsInUse
 if (objUserRolesEN.UpdDate !=  "")
 {
objRow[conUserRoles.UpdDate] = objUserRolesEN.UpdDate; //修改日期
 }
 if (objUserRolesEN.UpdUserId !=  "")
 {
objRow[conUserRoles.UpdUserId] = objUserRolesEN.UpdUserId; //修改用户Id
 }
...
StringBuilder strSQL = new StringBuilder();
 ...
 if (objUserRolesEN.QuestionnaireSetId  ==  "")
 {
 objUserRolesEN.QuestionnaireSetId = null;
 }
 if (objUserRolesEN.QuestionnaireSetId !=  null)
 {
 arrFieldListForInsert.Add(conUserRoles.QuestionnaireSetId);
 var strQuestionnaireSetId = objUserRolesEN.QuestionnaireSetId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 ...
 if (objUserRolesEN.UpdDate !=  null)
 {
 arrFieldListForInsert.Add(conUserRoles.UpdDate);
 var strUpdDate = objUserRolesEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strUpdDate + "'");
 }
 
 if (objUserRolesEN.UpdUserId !=  null)
 {
 arrFieldListForInsert.Add(conUserRoles.UpdUserId);
 var strUpdUserId = objUserRolesEN.UpdUserId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
...
objRow[conUserRoles.RoleName] = oRow[conUserRoles.RoleName].ToString().Trim(); //角色名
objRow[conUserRoles.QuestionnaireSetId] = oRow[conUserRoles.QuestionnaireSetId].ToString().Trim(); //问卷集ID
objRow[conUserRoles.PrjId] = oRow[conUserRoles.PrjId].ToString().Trim(); //PrjId
objRow[conUserRoles.Memo] = oRow[conUserRoles.Memo].ToString().Trim(); //备注
objRow[conUserRoles.IsInUse] = oRow[conUserRoles.IsInUse].ToString().Trim(); //IsInUse
objRow[conUserRoles.UpdDate] = oRow[conUserRoles.UpdDate].ToString().Trim(); //修改日期
objRow[conUserRoles.UpdUserId] = oRow[conUserRoles.UpdUserId].ToString().Trim(); //修改用户Id
 objDS.Tables[clsUserRolesEN._CurrTabName].Rows.Add(objRow);
}
try
{
...
objRow[conUserRoles.RoleName] = objUserRolesEN.RoleName; //角色名
 ...
 if (objUserRolesEN.IsUpdated(conUserRoles.QuestionnaireSetId))
 {
objRow[conUserRoles.QuestionnaireSetId] = objUserRolesEN.QuestionnaireSetId; //问卷集ID
 }
...
objRow[conUserRoles.IsInUse] = objUserRolesEN.IsInUse; //IsInUse
 ...
 if (objUserRolesEN.IsUpdated(conUserRoles.UpdDate))
 {
objRow[conUserRoles.UpdDate] = objUserRolesEN.UpdDate; //修改日期
 }
 if (objUserRolesEN.IsUpdated(conUserRoles.UpdUserId))
 {
objRow[conUserRoles.UpdUserId] = objUserRolesEN.UpdUserId; //修改用户Id
 }
try
...
sbSQL.AppendFormat("Update UserRoles Set ");
 ...
 {
 var strRoleName = objUserRolesEN.RoleName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strRoleName, conUserRoles.RoleName); //角色名
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conUserRoles.RoleName); //角色名
 }
 }
 ...
 {
 var strQuestionnaireSetId = objUserRolesEN.QuestionnaireSetId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strQuestionnaireSetId, conUserRoles.QuestionnaireSetId); //问卷集ID
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conUserRoles.QuestionnaireSetId); //问卷集ID
 }
 }
 ...
 {
 var strPrjId = objUserRolesEN.PrjId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strPrjId, conUserRoles.PrjId); //PrjId
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conUserRoles.PrjId); //PrjId
 }
 }
 ...
 {
 var strMemo = objUserRolesEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strMemo, conUserRoles.Memo); //备注
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conUserRoles.Memo); //备注
 }
 }
 ...
 {
 var strUpdDate = objUserRolesEN.UpdDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdDate, conUserRoles.UpdDate); //修改日期
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conUserRoles.UpdDate); //修改日期
 }
 }
 ...
 {
 var strUpdUserId = objUserRolesEN.UpdUserId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUserId, conUserRoles.UpdUserId); //修改用户Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conUserRoles.UpdUserId); //修改用户Id
 }
 }
...
objUserRolesENT.RoleName = objUserRolesENS.RoleName; //角色名
objUserRolesENT.QuestionnaireSetId = objUserRolesENS.QuestionnaireSetId; //问卷集ID
objUserRolesENT.PrjId = objUserRolesENS.PrjId; //PrjId
objUserRolesENT.Memo = objUserRolesENS.Memo; //备注
objUserRolesENT.IsInUse = objUserRolesENS.IsInUse; //IsInUse
objUserRolesENT.UpdDate = objUserRolesENS.UpdDate; //修改日期
objUserRolesENT.UpdUserId = objUserRolesENS.UpdUserId; //修改用户Id
}
...
clsCheckSql.CheckFieldLen(objUserRolesEN.RoleName, 100, conUserRoles.RoleName);
clsCheckSql.CheckFieldLen(objUserRolesEN.QuestionnaireSetId, 4, conUserRoles.QuestionnaireSetId);
...
clsCheckSql.CheckFieldLen(objUserRolesEN.UpdDate, 20, conUserRoles.UpdDate);
clsCheckSql.CheckFieldLen(objUserRolesEN.UpdUserId, 20, conUserRoles.UpdUserId);
//检查字段外键固定长度
clsCheckSql.CheckFieldForeignKey(objUserRolesEN.QuestionnaireSetId, 4, conUserRoles.QuestionnaireSetId);
...
clsCheckSql.CheckSqlInjection4Field(objUserRolesEN.QuestionnaireSetId, conUserRoles.QuestionnaireSetId);
...
clsCheckSql.CheckSqlInjection4Field(objUserRolesEN.UpdDate, conUserRoles.UpdDate);
clsCheckSql.CheckSqlInjection4Field(objUserRolesEN.UpdUserId, conUserRoles.UpdUserId);
//检查外键字段长度
clsCheckSql.CheckFieldForeignKey(objUserRolesEN.QuestionnaireSetId, 4, conUserRoles.QuestionnaireSetId);
 objUserRolesEN._IsCheckProperty = true;
}
