...
try
{
objQxDepartmentTypeEN.DepartmentTypeId = objRow[conQxDepartmentType.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId
objQxDepartmentTypeEN.DepartmentTypeName = objRow[conQxDepartmentType.DepartmentTypeName].ToString().Trim(); //DepartmentTypeName
...
try
{
 objQxDepartmentTypeEN.DepartmentTypeId = objDT.Rows[0][conQxDepartmentType.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId(字段类型:char,字段长度:2,是否可空:True)
 objQxDepartmentTypeEN.DepartmentTypeName = objDT.Rows[0][conQxDepartmentType.DepartmentTypeName].ToString().Trim(); //DepartmentTypeName(字段类型:varchar,字段长度:50,是否可空:True)
...
try
{
 objQxDepartmentTypeEN.DepartmentTypeId = objRow[conQxDepartmentType.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId(字段类型:char,字段长度:2,是否可空:True)
 objQxDepartmentTypeEN.DepartmentTypeName = objRow[conQxDepartmentType.DepartmentTypeName].ToString().Trim(); //DepartmentTypeName(字段类型:varchar,字段长度:50,是否可空:True)
...
try
{
	clsQxDepartmentTypeEN objQxDepartmentTypeEN = new clsQxDepartmentTypeEN()
{
DepartmentTypeId = objRow[conQxDepartmentType.DepartmentTypeId].ToString().Trim(), //DepartmentTypeId
DepartmentTypeName = objRow[conQxDepartmentType.DepartmentTypeName].ToString().Trim(), //DepartmentTypeName
...
objRow[conQxDepartmentType.DepartmentTypeId] = objQxDepartmentTypeEN.DepartmentTypeId; //DepartmentTypeId
objRow[conQxDepartmentType.DepartmentTypeName] = objQxDepartmentTypeEN.DepartmentTypeName; //DepartmentTypeName
...
objRow[conQxDepartmentType.DepartmentTypeId] = oRow[conQxDepartmentType.DepartmentTypeId].ToString().Trim(); //DepartmentTypeId
objRow[conQxDepartmentType.DepartmentTypeName] = oRow[conQxDepartmentType.DepartmentTypeName].ToString().Trim(); //DepartmentTypeName
...
sbSQL.AppendFormat("Update QxDepartmentType Set ");
 ...
 {
 var strDepartmentTypeName = objQxDepartmentTypeEN.DepartmentTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strDepartmentTypeName, conQxDepartmentType.DepartmentTypeName); //DepartmentTypeName
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxDepartmentType.DepartmentTypeName); //DepartmentTypeName
 }
 }
...
sbSQL.AppendFormat("Update QxDepartmentType Set ");
 ...
 {
 var strDepartmentTypeName = objQxDepartmentTypeEN.DepartmentTypeName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" DepartmentTypeName = '{0}',", strDepartmentTypeName); //DepartmentTypeName
 }
 else
 {
 sbSQL.Append(" DepartmentTypeName = null,"); //DepartmentTypeName
 }
 }
