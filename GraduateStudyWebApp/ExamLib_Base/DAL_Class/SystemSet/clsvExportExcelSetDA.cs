...
objvExportExcelSetEN.IsDefaultUser = TransNullToBool(objRow[convExportExcelSet.IsDefaultUser].ToString().Trim()); //是否默认用户
...
try
{
 ...
 objvExportExcelSetEN.ViewName = objDT.Rows[0][convExportExcelSet.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 objvExportExcelSetEN.TabName = objDT.Rows[0][convExportExcelSet.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 ...
 objvExportExcelSetEN.UserName = objDT.Rows[0][convExportExcelSet.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objvExportExcelSetEN.IsDefaultUser = TransNullToBool(objDT.Rows[0][convExportExcelSet.IsDefaultUser].ToString().Trim()); //是否默认用户(字段类型:bit,字段长度:1,是否可空:False)
...
try
{
 ...
 objvExportExcelSetEN.ViewName = objRow[convExportExcelSet.ViewName] == DBNull.Value ? null : objRow[convExportExcelSet.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 objvExportExcelSetEN.TabName = objRow[convExportExcelSet.TabName] == DBNull.Value ? null : objRow[convExportExcelSet.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 ...
 objvExportExcelSetEN.UserName = objRow[convExportExcelSet.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objvExportExcelSetEN.IsDefaultUser = clsEntityBase2.TransNullToBool_S(objRow[convExportExcelSet.IsDefaultUser].ToString().Trim()); //是否默认用户(字段类型:bit,字段长度:1,是否可空:False)
...
IsDefaultUser = TransNullToBool(objRow[convExportExcelSet.IsDefaultUser].ToString().Trim()), //是否默认用户
...
clsCheckSql.CheckFieldLen(objvExportExcelSetEN.ViewName, 50, convExportExcelSet.ViewName);
clsCheckSql.CheckFieldLen(objvExportExcelSetEN.TabName, 50, convExportExcelSet.TabName);
