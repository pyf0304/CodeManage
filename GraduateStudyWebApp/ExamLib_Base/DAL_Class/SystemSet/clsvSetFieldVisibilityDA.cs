...
objvSetFieldVisibilityEN.SchoolId = objRow[convSetFieldVisibility.SchoolId].ToString().Trim(); //学校编号
objvSetFieldVisibilityEN.SchoolName = objRow[convSetFieldVisibility.SchoolName].ToString().Trim(); //学校名称
objvSetFieldVisibilityEN.FuncModuleId = objRow[convSetFieldVisibility.FuncModuleId] == DBNull.Value ? null : objRow[convSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id
...
objvSetFieldVisibilityEN.FuncModuleEnName = objRow[convSetFieldVisibility.FuncModuleEnName] == DBNull.Value ? null : objRow[convSetFieldVisibility.FuncModuleEnName].ToString().Trim(); //FuncModuleEnName
...
try
{
 objvSetFieldVisibilityEN.mId = TransNullToInt(objDT.Rows[0][convSetFieldVisibility.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objvSetFieldVisibilityEN.SchoolId = objDT.Rows[0][convSetFieldVisibility.SchoolId].ToString().Trim(); //学校编号(字段类型:varchar,字段长度:10,是否可空:True)
 objvSetFieldVisibilityEN.SchoolName = objDT.Rows[0][convSetFieldVisibility.SchoolName].ToString().Trim(); //学校名称(字段类型:varchar,字段长度:50,是否可空:True)
 objvSetFieldVisibilityEN.FuncModuleId = objDT.Rows[0][convSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id(字段类型:char,字段长度:4,是否可空:True)
 ...
 objvSetFieldVisibilityEN.FuncModuleEnName = objDT.Rows[0][convSetFieldVisibility.FuncModuleEnName].ToString().Trim(); //FuncModuleEnName(字段类型:varchar,字段长度:30,是否可空:True)
 objvSetFieldVisibilityEN.ViewName = objDT.Rows[0][convSetFieldVisibility.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
...
try
{
 objvSetFieldVisibilityEN.mId = Int32.Parse(objRow[convSetFieldVisibility.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objvSetFieldVisibilityEN.SchoolId = objRow[convSetFieldVisibility.SchoolId].ToString().Trim(); //学校编号(字段类型:varchar,字段长度:10,是否可空:True)
 objvSetFieldVisibilityEN.SchoolName = objRow[convSetFieldVisibility.SchoolName].ToString().Trim(); //学校名称(字段类型:varchar,字段长度:50,是否可空:True)
 objvSetFieldVisibilityEN.FuncModuleId = objRow[convSetFieldVisibility.FuncModuleId] == DBNull.Value ? null : objRow[convSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id(字段类型:char,字段长度:4,是否可空:True)
 ...
 objvSetFieldVisibilityEN.FuncModuleEnName = objRow[convSetFieldVisibility.FuncModuleEnName] == DBNull.Value ? null : objRow[convSetFieldVisibility.FuncModuleEnName].ToString().Trim(); //FuncModuleEnName(字段类型:varchar,字段长度:30,是否可空:True)
 objvSetFieldVisibilityEN.ViewName = objRow[convSetFieldVisibility.ViewName] == DBNull.Value ? null : objRow[convSetFieldVisibility.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
...
SchoolId = objRow[convSetFieldVisibility.SchoolId].ToString().Trim(), //学校编号
SchoolName = objRow[convSetFieldVisibility.SchoolName].ToString().Trim(), //学校名称
FuncModuleId = objRow[convSetFieldVisibility.FuncModuleId] == DBNull.Value ? null : objRow[convSetFieldVisibility.FuncModuleId].ToString().Trim(), //功能模块Id
...
FuncModuleEnName = objRow[convSetFieldVisibility.FuncModuleEnName] == DBNull.Value ? null : objRow[convSetFieldVisibility.FuncModuleEnName].ToString().Trim(), //FuncModuleEnName
...
clsCheckSql.CheckFieldLen(objvSetFieldVisibilityEN.SchoolId, 10, convSetFieldVisibility.SchoolId);
clsCheckSql.CheckFieldLen(objvSetFieldVisibilityEN.SchoolName, 50, convSetFieldVisibility.SchoolName);
clsCheckSql.CheckFieldLen(objvSetFieldVisibilityEN.FuncModuleId, 4, convSetFieldVisibility.FuncModuleId);
...
clsCheckSql.CheckFieldLen(objvSetFieldVisibilityEN.ViewName, 50, convSetFieldVisibility.ViewName);
