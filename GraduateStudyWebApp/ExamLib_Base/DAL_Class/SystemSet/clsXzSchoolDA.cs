...
objXzSchoolEN.SchoolId = objRow[conXzSchool.SchoolId].ToString().Trim(); //学校编号
objXzSchoolEN.SchoolName = objRow[conXzSchool.SchoolName].ToString().Trim(); //学校名称
objXzSchoolEN.SchoolENName = objRow[conXzSchool.SchoolENName] == DBNull.Value ? null : objRow[conXzSchool.SchoolENName].ToString().Trim(); //SchoolENName
...
try
{
 ...
 objXzSchoolEN.SchoolId = objDT.Rows[0][conXzSchool.SchoolId].ToString().Trim(); //学校编号(字段类型:varchar,字段长度:10,是否可空:True)
 objXzSchoolEN.SchoolName = objDT.Rows[0][conXzSchool.SchoolName].ToString().Trim(); //学校名称(字段类型:varchar,字段长度:50,是否可空:True)
 objXzSchoolEN.SchoolENName = objDT.Rows[0][conXzSchool.SchoolENName].ToString().Trim(); //SchoolENName(字段类型:varchar,字段长度:50,是否可空:True)
...
try
{
 ...
 objXzSchoolEN.SchoolId = objRow[conXzSchool.SchoolId].ToString().Trim(); //学校编号(字段类型:varchar,字段长度:10,是否可空:True)
 objXzSchoolEN.SchoolName = objRow[conXzSchool.SchoolName].ToString().Trim(); //学校名称(字段类型:varchar,字段长度:50,是否可空:True)
 objXzSchoolEN.SchoolENName = objRow[conXzSchool.SchoolENName] == DBNull.Value ? null : objRow[conXzSchool.SchoolENName].ToString().Trim(); //SchoolENName(字段类型:varchar,字段长度:50,是否可空:True)
...
SchoolId = objRow[conXzSchool.SchoolId].ToString().Trim(), //学校编号
SchoolName = objRow[conXzSchool.SchoolName].ToString().Trim(), //学校名称
SchoolENName = objRow[conXzSchool.SchoolENName] == DBNull.Value ? null : objRow[conXzSchool.SchoolENName].ToString().Trim(), //SchoolENName
...
objRow[conXzSchool.SchoolId] = objXzSchoolEN.SchoolId; //学校编号
objRow[conXzSchool.SchoolName] = objXzSchoolEN.SchoolName; //学校名称
 if (objXzSchoolEN.SchoolENName !=  "")
 {
objRow[conXzSchool.SchoolENName] = objXzSchoolEN.SchoolENName; //SchoolENName
 }
...
objRow[conXzSchool.SchoolId] = oRow[conXzSchool.SchoolId].ToString().Trim(); //学校编号
objRow[conXzSchool.SchoolName] = oRow[conXzSchool.SchoolName].ToString().Trim(); //学校名称
objRow[conXzSchool.SchoolENName] = oRow[conXzSchool.SchoolENName].ToString().Trim(); //SchoolENName
...
sbSQL.AppendFormat("Update XzSchool Set ");
 ...
 {
 var strSchoolId = objXzSchoolEN.SchoolId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSchoolId, conXzSchool.SchoolId); //学校编号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzSchool.SchoolId); //学校编号
 }
 }
 ...
 {
 var strSchoolENName = objXzSchoolEN.SchoolENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSchoolENName, conXzSchool.SchoolENName); //SchoolENName
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conXzSchool.SchoolENName); //SchoolENName
 }
 }
...
sbSQL.AppendFormat("Update XzSchool Set ");
 ...
 {
 var strSchoolENName = objXzSchoolEN.SchoolENName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SchoolENName = '{0}',", strSchoolENName); //SchoolENName
 }
 else
 {
 sbSQL.Append(" SchoolENName = null,"); //SchoolENName
 }
 }
...
clsCheckSql.CheckFieldLen(objXzSchoolEN.SchoolId, 10, conXzSchool.SchoolId);
