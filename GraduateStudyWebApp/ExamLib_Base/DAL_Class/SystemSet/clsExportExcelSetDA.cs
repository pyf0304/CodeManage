...
objExportExcelSetEN.IsDefaultUser = TransNullToBool(objRow[conExportExcelSet.IsDefaultUser].ToString().Trim()); //是否默认用户
...
try
{
 ...
 objExportExcelSetEN.ViewName = objDT.Rows[0][conExportExcelSet.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 objExportExcelSetEN.TabName = objDT.Rows[0][conExportExcelSet.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 objExportExcelSetEN.UserId = objDT.Rows[0][conExportExcelSet.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objExportExcelSetEN.IsDefaultUser = TransNullToBool(objDT.Rows[0][conExportExcelSet.IsDefaultUser].ToString().Trim()); //是否默认用户(字段类型:bit,字段长度:1,是否可空:False)
...
try
{
 ...
 objExportExcelSetEN.ViewName = objRow[conExportExcelSet.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 objExportExcelSetEN.TabName = objRow[conExportExcelSet.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 objExportExcelSetEN.UserId = objRow[conExportExcelSet.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objExportExcelSetEN.IsDefaultUser = clsEntityBase2.TransNullToBool_S(objRow[conExportExcelSet.IsDefaultUser].ToString().Trim()); //是否默认用户(字段类型:bit,字段长度:1,是否可空:False)
...
IsDefaultUser = TransNullToBool(objRow[conExportExcelSet.IsDefaultUser].ToString().Trim()), //是否默认用户
...
objRow[conExportExcelSet.IsDefaultUser] = objExportExcelSetEN.IsDefaultUser; //是否默认用户
...
objRow[conExportExcelSet.IsDefaultUser] = oRow[conExportExcelSet.IsDefaultUser].ToString().Trim(); //是否默认用户
...
sbSQL.AppendFormat("Update ExportExcelSet Set ");
 ...
 if (objExportExcelSetEN.IsUpdated(conExportExcelSet.IsDefaultUser))
 {
 sbSQL.AppendFormat(" {1} = '{0}',", objExportExcelSetEN.IsDefaultUser == true?"1":"0", conExportExcelSet.IsDefaultUser); //是否默认用户
 }
...
sbSQL.AppendFormat("Update ExportExcelSet Set ");
 ...
 if (objExportExcelSetEN.IsUpdated(conExportExcelSet.IsDefaultUser))
 {
 sbSQL.AppendFormat(" IsDefaultUser = '{0}',", objExportExcelSetEN.IsDefaultUser == true?"1":"0"); //是否默认用户
 }
...
clsCheckSql.CheckFieldLen(objExportExcelSetEN.ViewName, 50, conExportExcelSet.ViewName);
clsCheckSql.CheckFieldLen(objExportExcelSetEN.TabName, 50, conExportExcelSet.TabName);
