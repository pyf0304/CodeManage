...
objvExportExcel4UsersEN.IsDefaultUser = TransNullToBool(objRow[convExportExcel4Users.IsDefaultUser].ToString().Trim()); //是否默认用户
...
try
{
 objvExportExcel4UsersEN.mId = TransNullToInt(objDT.Rows[0][convExportExcel4Users.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objvExportExcel4UsersEN.ViewName = objDT.Rows[0][convExportExcel4Users.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 objvExportExcel4UsersEN.TabName = objDT.Rows[0][convExportExcel4Users.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 ...
 objvExportExcel4UsersEN.UserName = objDT.Rows[0][convExportExcel4Users.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objvExportExcel4UsersEN.IsDefaultUser = TransNullToBool(objDT.Rows[0][convExportExcel4Users.IsDefaultUser].ToString().Trim()); //是否默认用户(字段类型:bit,字段长度:1,是否可空:False)
 ...
 objvExportExcel4UsersEN.OrderNum = TransNullToInt(objDT.Rows[0][convExportExcel4Users.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
try
{
 objvExportExcel4UsersEN.mId = Int32.Parse(objRow[convExportExcel4Users.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objvExportExcel4UsersEN.ViewName = objRow[convExportExcel4Users.ViewName] == DBNull.Value ? null : objRow[convExportExcel4Users.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 objvExportExcel4UsersEN.TabName = objRow[convExportExcel4Users.TabName] == DBNull.Value ? null : objRow[convExportExcel4Users.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 objvExportExcel4UsersEN.UserId = objRow[convExportExcel4Users.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objvExportExcel4UsersEN.UserName = objRow[convExportExcel4Users.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objvExportExcel4UsersEN.IsDefaultUser = clsEntityBase2.TransNullToBool_S(objRow[convExportExcel4Users.IsDefaultUser].ToString().Trim()); //是否默认用户(字段类型:bit,字段长度:1,是否可空:False)
 ...
 objvExportExcel4UsersEN.OrderNum = objRow[convExportExcel4Users.OrderNum] == DBNull.Value ? (int?)null : clsEntityBase2.TransNullToInt_S(objRow[convExportExcel4Users.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
IsDefaultUser = TransNullToBool(objRow[convExportExcel4Users.IsDefaultUser].ToString().Trim()), //是否默认用户
...
clsCheckSql.CheckFieldLen(objvExportExcel4UsersEN.ViewName, 50, convExportExcel4Users.ViewName);
clsCheckSql.CheckFieldLen(objvExportExcel4UsersEN.TabName, 50, convExportExcel4Users.TabName);
