...
try
{
 objDataSynConfigEN.mId = TransNullToInt(objDT.Rows[0][conDataSynConfig.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objDataSynConfigEN.TabName = objDT.Rows[0][conDataSynConfig.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 ...
 objDataSynConfigEN.Memo = objDT.Rows[0][conDataSynConfig.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 objDataSynConfigEN.mId = Int32.Parse(objRow[conDataSynConfig.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 objDataSynConfigEN.TabName = objRow[conDataSynConfig.TabName] == DBNull.Value ? null : objRow[conDataSynConfig.TabName].ToString().Trim(); //表名(字段类型:varchar,字段长度:50,是否可空:True)
 ...
 objDataSynConfigEN.Memo = objRow[conDataSynConfig.Memo] == DBNull.Value ? null : objRow[conDataSynConfig.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
Memo = objRow[conDataSynConfig.Memo] == DBNull.Value ? null : objRow[conDataSynConfig.Memo].ToString().Trim() //备注
};
objDataSynConfigEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objDataSynConfigEN;
}
...
objRow[conDataSynConfig.SynchEndTime] = objDataSynConfigEN.SynchEndTime; //同步结束时间
 ...
 {
objRow[conDataSynConfig.Memo] = objDataSynConfigEN.Memo; //备注
 }
...
StringBuilder strSQL = new StringBuilder();
 ...
 var strTabName = objDataSynConfigEN.TabName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 ...
 var strSynCondition = objDataSynConfigEN.SynCondition.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSynCondition + "'");
 }
 
 if (objDataSynConfigEN.SynCondition4Web !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SynCondition4Web);
 var strSynCondition4Web = objDataSynConfigEN.SynCondition4Web.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSynCondition4Web + "'");
 }
 
 if (objDataSynConfigEN.SynchCycle !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SynchCycle);
 var strSynchCycle = objDataSynConfigEN.SynchCycle.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSynchCycle + "'");
 }
 
 if (objDataSynConfigEN.SynchDate !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SynchDate);
 var strSynchDate = objDataSynConfigEN.SynchDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 ...
 var strSynchTime = objDataSynConfigEN.SynchTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSynchTime + "'");
 }
 
 if (objDataSynConfigEN.SenderUser !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SenderUser);
 var strSenderUser = objDataSynConfigEN.SenderUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSenderUser + "'");
 }
 
 if (objDataSynConfigEN.SenderPwd !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SenderPwd);
 var strSenderPwd = objDataSynConfigEN.SenderPwd.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSenderPwd + "'");
 }
 
 if (objDataSynConfigEN.smtp !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.smtp);
 var strsmtp = objDataSynConfigEN.smtp.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strsmtp + "'");
 }
 
 if (objDataSynConfigEN.Receiver !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.Receiver);
 var strReceiver = objDataSynConfigEN.Receiver.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strReceiver + "'");
 }
 
 if (objDataSynConfigEN.lastMailDate !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.lastMailDate);
 var strlastMailDate = objDataSynConfigEN.lastMailDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strlastMailDate + "'");
 }
 
 if (objDataSynConfigEN.lastExecuteDate !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.lastExecuteDate);
 var strlastExecuteDate = objDataSynConfigEN.lastExecuteDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strlastExecuteDate + "'");
 }
 
 if (objDataSynConfigEN.SynchStartTime !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SynchStartTime);
 var strSynchStartTime = objDataSynConfigEN.SynchStartTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSynchStartTime + "'");
 }
 
 if (objDataSynConfigEN.SynchEndTime !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.SynchEndTime);
 var strSynchEndTime = objDataSynConfigEN.SynchEndTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 arrValueListForInsert.Add("'" + strSynchEndTime + "'");
 }
 
 if (objDataSynConfigEN.Memo !=  null)
 {
 arrFieldListForInsert.Add(conDataSynConfig.Memo);
 var strMemo = objDataSynConfigEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
...
objRow[conDataSynConfig.Memo] = oRow[conDataSynConfig.Memo].ToString().Trim(); //备注
 objDS.Tables[clsDataSynConfigEN._CurrTabName].Rows.Add(objRow);
}
try
{
...
sbSQL.AppendFormat("Update DataSynConfig Set ");
 ...
 {
 var strTabName = objDataSynConfigEN.TabName.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strTabName, conDataSynConfig.TabName); //表名
 }
 else
 {
 ...
 {
 var strSynCondition = objDataSynConfigEN.SynCondition.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynCondition, conDataSynConfig.SynCondition); //同步条件
 }
 else
 {
 ...
 {
 var strSynCondition4Web = objDataSynConfigEN.SynCondition4Web.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynCondition4Web, conDataSynConfig.SynCondition4Web); //同步条件4Web
 }
 else
 {
 ...
 {
 var strSynchCycle = objDataSynConfigEN.SynchCycle.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynchCycle, conDataSynConfig.SynchCycle); //同步周期
 }
 else
 {
 ...
 {
 var strSynchDate = objDataSynConfigEN.SynchDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynchDate, conDataSynConfig.SynchDate); //同步日期
 }
 else
 {
 ...
 {
 var strSynchTime = objDataSynConfigEN.SynchTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynchTime, conDataSynConfig.SynchTime); //同步时间
 }
 else
 {
 ...
 {
 var strSenderUser = objDataSynConfigEN.SenderUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSenderUser, conDataSynConfig.SenderUser); //发送邮件用户
 }
 else
 {
 ...
 {
 var strSenderPwd = objDataSynConfigEN.SenderPwd.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSenderPwd, conDataSynConfig.SenderPwd); //发送邮件口令
 }
 else
 {
 ...
 {
 var strsmtp = objDataSynConfigEN.smtp.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strsmtp, conDataSynConfig.smtp); //发送邮件服务器
 }
 else
 {
 ...
 {
 var strReceiver = objDataSynConfigEN.Receiver.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strReceiver, conDataSynConfig.Receiver); //接收者
 }
 else
 {
 ...
 {
 var strlastMailDate = objDataSynConfigEN.lastMailDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strlastMailDate, conDataSynConfig.lastMailDate); //最后发邮件日期
 }
 else
 {
 ...
 {
 var strlastExecuteDate = objDataSynConfigEN.lastExecuteDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strlastExecuteDate, conDataSynConfig.lastExecuteDate); //最后执行日期
 }
 else
 {
 ...
 {
 var strSynchStartTime = objDataSynConfigEN.SynchStartTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynchStartTime, conDataSynConfig.SynchStartTime); //同步开始时间
 }
 else
 {
 ...
 {
 var strSynchEndTime = objDataSynConfigEN.SynchEndTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strSynchEndTime, conDataSynConfig.SynchEndTime); //同步结束时间
 }
 else
 {
 ...
 {
 var strMemo = objDataSynConfigEN.Memo.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strMemo, conDataSynConfig.Memo); //备注
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conDataSynConfig.Memo); //备注
 }
 }
...
sbSQL.AppendFormat("Update DataSynConfig Set ");
 ...
 {
 var strSynCondition = objDataSynConfigEN.SynCondition.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SynCondition = '{0}',", strSynCondition); //同步条件
 }
 else
 {
 ...
 {
 var strSynCondition4Web = objDataSynConfigEN.SynCondition4Web.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SynCondition4Web = '{0}',", strSynCondition4Web); //同步条件4Web
 }
 else
 {
 ...
 {
 var strSynchCycle = objDataSynConfigEN.SynchCycle.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SynchCycle = '{0}',", strSynchCycle); //同步周期
 }
 else
 {
 ...
 {
 var strSynchTime = objDataSynConfigEN.SynchTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SynchTime = '{0}',", strSynchTime); //同步时间
 }
 else
 {
 ...
 {
 var strSenderUser = objDataSynConfigEN.SenderUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SenderUser = '{0}',", strSenderUser); //发送邮件用户
 }
 else
 {
 ...
 {
 var strSenderPwd = objDataSynConfigEN.SenderPwd.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SenderPwd = '{0}',", strSenderPwd); //发送邮件口令
 }
 else
 {
 ...
 {
 var strsmtp = objDataSynConfigEN.smtp.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" smtp = '{0}',", strsmtp); //发送邮件服务器
 }
 else
 {
 ...
 {
 var strReceiver = objDataSynConfigEN.Receiver.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" Receiver = '{0}',", strReceiver); //接收者
 }
 else
 {
 ...
 {
 var strlastMailDate = objDataSynConfigEN.lastMailDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" lastMailDate = '{0}',", strlastMailDate); //最后发邮件日期
 }
 else
 {
 ...
 {
 var strlastExecuteDate = objDataSynConfigEN.lastExecuteDate.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" lastExecuteDate = '{0}',", strlastExecuteDate); //最后执行日期
 }
 else
 {
 ...
 {
 var strSynchStartTime = objDataSynConfigEN.SynchStartTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SynchStartTime = '{0}',", strSynchStartTime); //同步开始时间
 }
 else
 {
 ...
 {
 var strSynchEndTime = objDataSynConfigEN.SynchEndTime.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat(" SynchEndTime = '{0}',", strSynchEndTime); //同步结束时间
 }
 else
 {
...
//检查字段长度
clsCheckSql.CheckFieldLen(objDataSynConfigEN.TabName, 50, conDataSynConfig.TabName);
...
public string GetUniCondStr(clsDataSynConfigEN objDataSynConfigEN)
{
