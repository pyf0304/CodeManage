...
try
{
 objExportExcel4UsersEN.mId = TransNullToInt(objDT.Rows[0][conExportExcel4Users.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objExportExcel4UsersEN.OrderNum = TransNullToInt(objDT.Rows[0][conExportExcel4Users.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
...
try
{
 objExportExcel4UsersEN.mId = Int32.Parse(objRow[conExportExcel4Users.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objExportExcel4UsersEN.OrderNum = Int32.Parse(objRow[conExportExcel4Users.OrderNum].ToString().Trim()); //序号(字段类型:int,字段长度:4,是否可空:True)
