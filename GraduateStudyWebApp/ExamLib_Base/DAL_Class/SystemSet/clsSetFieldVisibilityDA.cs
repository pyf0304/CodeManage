...
objSetFieldVisibilityEN.FuncModuleId = objRow[conSetFieldVisibility.FuncModuleId] == DBNull.Value ? null : objRow[conSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id
...
objSetFieldVisibilityEN.Caption = objRow[conSetFieldVisibility.Caption] == DBNull.Value ? null : objRow[conSetFieldVisibility.Caption].ToString().Trim(); //标题
...
try
{
 objSetFieldVisibilityEN.mId = TransNullToInt(objDT.Rows[0][conSetFieldVisibility.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objSetFieldVisibilityEN.FuncModuleId = objDT.Rows[0][conSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id(字段类型:char,字段长度:4,是否可空:True)
 ...
 objSetFieldVisibilityEN.ViewName = objDT.Rows[0][conSetFieldVisibility.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
...
try
{
 objSetFieldVisibilityEN.mId = Int32.Parse(objRow[conSetFieldVisibility.mId].ToString().Trim()); //mId(字段类型:bigint,字段长度:8,是否可空:True)
 ...
 objSetFieldVisibilityEN.FuncModuleId = objRow[conSetFieldVisibility.FuncModuleId] == DBNull.Value ? null : objRow[conSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id(字段类型:char,字段长度:4,是否可空:True)
 ...
 objSetFieldVisibilityEN.ViewName = objRow[conSetFieldVisibility.ViewName] == DBNull.Value ? null : objRow[conSetFieldVisibility.ViewName].ToString().Trim(); //界面名称(字段类型:varchar,字段长度:50,是否可空:True)
 ...
 objSetFieldVisibilityEN.Caption = objRow[conSetFieldVisibility.Caption] == DBNull.Value ? null : objRow[conSetFieldVisibility.Caption].ToString().Trim(); //标题(字段类型:varchar,字段长度:200,是否可空:False)
...
FuncModuleId = objRow[conSetFieldVisibility.FuncModuleId] == DBNull.Value ? null : objRow[conSetFieldVisibility.FuncModuleId].ToString().Trim(), //功能模块Id
...
Caption = objRow[conSetFieldVisibility.Caption] == DBNull.Value ? null : objRow[conSetFieldVisibility.Caption].ToString().Trim(), //标题
...
objRow[conSetFieldVisibility.IdSchool] = objSetFieldVisibilityEN.IdSchool; //学校流水号
 ...
 {
objRow[conSetFieldVisibility.FuncModuleId] = objSetFieldVisibilityEN.FuncModuleId; //功能模块Id
 }
...
objRow[conSetFieldVisibility.FuncModuleId] = oRow[conSetFieldVisibility.FuncModuleId].ToString().Trim(); //功能模块Id
...
sbSQL.AppendFormat("Update SetFieldVisibility Set ");
 ...
 {
 var strFuncModuleId = objSetFieldVisibilityEN.FuncModuleId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strFuncModuleId, conSetFieldVisibility.FuncModuleId); //功能模块Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conSetFieldVisibility.FuncModuleId); //功能模块Id
 }
 }
...
clsCheckSql.CheckFieldLen(objSetFieldVisibilityEN.ViewName, 50, conSetFieldVisibility.ViewName);
