...
objQxUsersEN.IsArchive = TransNullToBool(objRow[conQxUsers.IsArchive].ToString().Trim()); //是否归档
...
try
{
 objQxUsersEN.UserId = objDT.Rows[0][conQxUsers.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objQxUsersEN.UserName = objDT.Rows[0][conQxUsers.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objQxUsersEN.DepartmentId = objDT.Rows[0][conQxUsers.DepartmentId].ToString().Trim(); //部门Id(字段类型:varchar,字段长度:8,是否可空:True)
 objQxUsersEN.IdXzCollege = objDT.Rows[0][conQxUsers.IdXzCollege].ToString().Trim(); //学院流水号(字段类型:char,字段长度:4,是否可空:True)
 objQxUsersEN.UserStateId = objDT.Rows[0][conQxUsers.UserStateId].ToString().Trim(); //用户状态Id(字段类型:char,字段长度:2,是否可空:True)
 objQxUsersEN.IdGradeBase = objDT.Rows[0][conQxUsers.IdGradeBase].ToString().Trim(); //年级流水号(字段类型:char,字段长度:4,是否可空:True)
 objQxUsersEN.Password = objDT.Rows[0][conQxUsers.Password].ToString().Trim(); //口令(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.IdSchool = objDT.Rows[0][conQxUsers.IdSchool].ToString().Trim(); //学校流水号(字段类型:char,字段长度:4,是否可空:True)
 objQxUsersEN.Email = objDT.Rows[0][conQxUsers.Email].ToString().Trim(); //电子邮箱(字段类型:varchar,字段长度:100,是否可空:True)
 objQxUsersEN.PhoneNumber = objDT.Rows[0][conQxUsers.PhoneNumber].ToString().Trim(); //电话(字段类型:varchar,字段长度:15,是否可空:True)
 ...
 objQxUsersEN.StuTeacherId = objDT.Rows[0][conQxUsers.StuTeacherId].ToString().Trim(); //学工号(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.IdentityId = objDT.Rows[0][conQxUsers.IdentityId].ToString().Trim(); //身份Id(字段类型:char,字段长度:2,是否可空:False)
 objQxUsersEN.OpenId = objDT.Rows[0][conQxUsers.OpenId].ToString().Trim(); //微信OpenId(字段类型:varchar,字段长度:50,是否可空:True)
 objQxUsersEN.UpdDate = objDT.Rows[0][conQxUsers.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.UpdUser = objDT.Rows[0][conQxUsers.UpdUser].ToString().Trim(); //修改人(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.IsSynch = TransNullToBool(objDT.Rows[0][conQxUsers.IsSynch].ToString().Trim()); //是否同步(字段类型:bit,字段长度:1,是否可空:False)
 objQxUsersEN.SynchDate = objDT.Rows[0][conQxUsers.SynchDate].ToString().Trim(); //同步日期(字段类型:varchar,字段长度:30,是否可空:False)
 objQxUsersEN.IsArchive = TransNullToBool(objDT.Rows[0][conQxUsers.IsArchive].ToString().Trim()); //是否归档(字段类型:bit,字段长度:1,是否可空:True)
...
try
{
 objQxUsersEN.UserId = objRow[conQxUsers.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:True)
 objQxUsersEN.UserName = objRow[conQxUsers.UserName].ToString().Trim(); //用户名(字段类型:varchar,字段长度:30,是否可空:True)
 objQxUsersEN.DepartmentId = objRow[conQxUsers.DepartmentId] == DBNull.Value ? null : objRow[conQxUsers.DepartmentId].ToString().Trim(); //部门Id(字段类型:varchar,字段长度:8,是否可空:True)
 objQxUsersEN.IdXzCollege = objRow[conQxUsers.IdXzCollege] == DBNull.Value ? null : objRow[conQxUsers.IdXzCollege].ToString().Trim(); //学院流水号(字段类型:char,字段长度:4,是否可空:True)
 objQxUsersEN.UserStateId = objRow[conQxUsers.UserStateId].ToString().Trim(); //用户状态Id(字段类型:char,字段长度:2,是否可空:True)
 ...
 objQxUsersEN.Password = objRow[conQxUsers.Password].ToString().Trim(); //口令(字段类型:varchar,字段长度:20,是否可空:True)
 ...
 objQxUsersEN.Email = objRow[conQxUsers.Email] == DBNull.Value ? null : objRow[conQxUsers.Email].ToString().Trim(); //电子邮箱(字段类型:varchar,字段长度:100,是否可空:True)
 objQxUsersEN.PhoneNumber = objRow[conQxUsers.PhoneNumber] == DBNull.Value ? null : objRow[conQxUsers.PhoneNumber].ToString().Trim(); //电话(字段类型:varchar,字段长度:15,是否可空:True)
 objQxUsersEN.EffitiveBeginDate = objRow[conQxUsers.EffitiveBeginDate].ToString().Trim(); //有效开始日期(字段类型:varchar,字段长度:14,是否可空:False)
 objQxUsersEN.EffitiveEndDate = objRow[conQxUsers.EffitiveEndDate].ToString().Trim(); //有效结束日期(字段类型:varchar,字段长度:14,是否可空:False)
 objQxUsersEN.StuTeacherId = objRow[conQxUsers.StuTeacherId].ToString().Trim(); //学工号(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.IdentityId = objRow[conQxUsers.IdentityId] == DBNull.Value ? null : objRow[conQxUsers.IdentityId].ToString().Trim(); //身份Id(字段类型:char,字段长度:2,是否可空:False)
 ...
 objQxUsersEN.UpdDate = objRow[conQxUsers.UpdDate] == DBNull.Value ? null : objRow[conQxUsers.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.UpdUser = objRow[conQxUsers.UpdUser] == DBNull.Value ? null : objRow[conQxUsers.UpdUser].ToString().Trim(); //修改人(字段类型:varchar,字段长度:20,是否可空:True)
 objQxUsersEN.IsSynch = clsEntityBase2.TransNullToBool_S(objRow[conQxUsers.IsSynch].ToString().Trim()); //是否同步(字段类型:bit,字段长度:1,是否可空:False)
 objQxUsersEN.SynchDate = objRow[conQxUsers.SynchDate] == DBNull.Value ? null : objRow[conQxUsers.SynchDate].ToString().Trim(); //同步日期(字段类型:varchar,字段长度:30,是否可空:False)
 objQxUsersEN.IsArchive = clsEntityBase2.TransNullToBool_S(objRow[conQxUsers.IsArchive].ToString().Trim()); //是否归档(字段类型:bit,字段长度:1,是否可空:True)
...
IdXzCollege = objRow[conQxUsers.IdXzCollege] == DBNull.Value ? null : objRow[conQxUsers.IdXzCollege].ToString().Trim(), //学院流水号
...
Email = objRow[conQxUsers.Email] == DBNull.Value ? null : objRow[conQxUsers.Email].ToString().Trim(), //电子邮箱
PhoneNumber = objRow[conQxUsers.PhoneNumber] == DBNull.Value ? null : objRow[conQxUsers.PhoneNumber].ToString().Trim(), //电话
EffitiveBeginDate = objRow[conQxUsers.EffitiveBeginDate].ToString().Trim(), //有效开始日期
EffitiveEndDate = objRow[conQxUsers.EffitiveEndDate].ToString().Trim(), //有效结束日期
StuTeacherId = objRow[conQxUsers.StuTeacherId].ToString().Trim(), //学工号
IdentityId = objRow[conQxUsers.IdentityId] == DBNull.Value ? null : objRow[conQxUsers.IdentityId].ToString().Trim(), //身份Id
...
UpdUser = objRow[conQxUsers.UpdUser] == DBNull.Value ? null : objRow[conQxUsers.UpdUser].ToString().Trim(), //修改人
...
IsArchive = TransNullToBool(objRow[conQxUsers.IsArchive].ToString().Trim()), //是否归档
...
objRow[conQxUsers.DepartmentId] = objQxUsersEN.DepartmentId; //部门Id
 ...
 {
objRow[conQxUsers.IdXzCollege] = objQxUsersEN.IdXzCollege; //学院流水号
 }
...
objRow[conQxUsers.IdSchool] = objQxUsersEN.IdSchool; //学校流水号
 ...
 {
objRow[conQxUsers.Email] = objQxUsersEN.Email; //电子邮箱
 }
 if (objQxUsersEN.PhoneNumber !=  "")
 {
objRow[conQxUsers.PhoneNumber] = objQxUsersEN.PhoneNumber; //电话
 }
...
objRow[conQxUsers.StuTeacherId] = objQxUsersEN.StuTeacherId; //学工号
 ...
 {
objRow[conQxUsers.IdentityId] = objQxUsersEN.IdentityId; //身份Id
 }
...
objRow[conQxUsers.UpdDate] = objQxUsersEN.UpdDate; //修改日期
 ...
 {
objRow[conQxUsers.UpdUser] = objQxUsersEN.UpdUser; //修改人
 }
...
objRow[conQxUsers.IsArchive] = objQxUsersEN.IsArchive; //是否归档
...
objRow[conQxUsers.IdXzCollege] = oRow[conQxUsers.IdXzCollege].ToString().Trim(); //学院流水号
...
objRow[conQxUsers.Email] = oRow[conQxUsers.Email].ToString().Trim(); //电子邮箱
objRow[conQxUsers.PhoneNumber] = oRow[conQxUsers.PhoneNumber].ToString().Trim(); //电话
...
objRow[conQxUsers.IdentityId] = oRow[conQxUsers.IdentityId].ToString().Trim(); //身份Id
...
objRow[conQxUsers.UpdUser] = oRow[conQxUsers.UpdUser].ToString().Trim(); //修改人
...
objRow[conQxUsers.IsArchive] = oRow[conQxUsers.IsArchive].ToString().Trim(); //是否归档
...
sbSQL.AppendFormat("Update QxUsers Set ");
 ...
 {
 var strIdXzCollege = objQxUsersEN.IdXzCollege.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strIdXzCollege, conQxUsers.IdXzCollege); //学院流水号
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUsers.IdXzCollege); //学院流水号
 }
 }
 ...
 {
 var strEmail = objQxUsersEN.Email.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strEmail, conQxUsers.Email); //电子邮箱
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUsers.Email); //电子邮箱
 }
 }
 ...
 {
 var strPhoneNumber = objQxUsersEN.PhoneNumber.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strPhoneNumber, conQxUsers.PhoneNumber); //电话
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUsers.PhoneNumber); //电话
 }
 }
 ...
 {
 var strIdentityId = objQxUsersEN.IdentityId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strIdentityId, conQxUsers.IdentityId); //身份Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUsers.IdentityId); //身份Id
 }
 }
 ...
 {
 var strUpdUser = objQxUsersEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUser, conQxUsers.UpdUser); //修改人
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUsers.UpdUser); //修改人
 }
 }
 ...
 if (objQxUsersEN.IsUpdated(conQxUsers.IsArchive))
 {
 sbSQL.AppendFormat(" {1} = '{0}',", objQxUsersEN.IsArchive == true?"1":"0", conQxUsers.IsArchive); //是否归档
 }
...
sbSQL.AppendFormat("Update QxUsers Set ");
 ...
 if (objQxUsersEN.IsUpdated(conQxUsers.IsArchive))
 {
 sbSQL.AppendFormat(" IsArchive = '{0}',", objQxUsersEN.IsArchive == true?"1":"0"); //是否归档
 }
...
clsCheckSql.CheckFieldNotNull(objQxUsersEN.EffitiveBeginDate, conQxUsers.EffitiveBeginDate);
clsCheckSql.CheckFieldNotNull(objQxUsersEN.EffitiveEndDate, conQxUsers.EffitiveEndDate);
clsCheckSql.CheckFieldNotNull(objQxUsersEN.StuTeacherId, conQxUsers.StuTeacherId);
//检查字段长度
