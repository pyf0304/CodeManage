...
namespace Pages.FrameAdmin
{
    public partial class indexBakModel : PageModel
    {
        ...
        //        strHtml = clsGeneMenuBLEx.GetUserMenuHTML2(strCurrPrjId, strCurrUserRoleId, strUserId);
        ...
        //      strUserId,
        //      clsvUserPrjGrantEN.con_LastVisitedDate);
        //    //System.Data.DataTable objDT = clsUserPrjGrantBL.GetUserPrjGrantT(strWhereCond);
        //    System.Data.DataTable objDT = clsUserPrjGrantBL.GetDataTable_UserPrjGrantV(strWhereCond);
        ...
        //        lblRoleName.Text = clsUserRolesBL.GetRoleNameByRoleId_Cache(clsCommonSession.RoleId);
        //        clsPrjDataBaseEN objPrjDataBase = clsPrjDataBaseBL.GetObjByPrjDataBaseId_Cache(clsPubVar.CurrPrjDataBaseId);
        //        clsProjectsEN objProject = clsProjectsBL.GetObjByPrjId_Cache(clsPubVar.CurrSelPrjId);
        ...
        //    new clsCommFun4BL4PrjTab().ReFreshCache();
        ...
        //    ///设置默认的数据库
        //    clsProjectsEN objProject = clsProjectsBL.GetObjByPrjId_Cache(objUserPrjGrant.PrjId);
        //    clsvUserDefaPrjDataBaseEN objvUserDefaPrjDataBaseEN = clsUserDefaPrjDataBaseBLEx.GetvUserDefaPrjDataBaseObjByPrjIdAndUserId(clsPubVar.CurrSelPrjId, clsCommonSession.UserId);
        //    if (objvUserDefaPrjDataBaseEN != null)
        //    {
        ...
        //{
        //    Session.Clear();
        //    string strScript = "<script language='javascript'>window.parent.location.href='../../Index.aspx'; </script>";
