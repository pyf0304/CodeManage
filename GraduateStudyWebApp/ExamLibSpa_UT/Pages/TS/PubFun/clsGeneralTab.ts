...
export class clsGeneralTab implements ILookup<any> {


    private mstrsf_UpdFldSetStr: string;     //字符型标签
    private mstrsf_FldComparisonOp: string;     //字符型标签
    
    private mintIntTag: Number;     //整型Tag
    private mstrStrTag: string;     //字符型标签
    private mbolIsCheckProperty;// : Bool;     //是否检查属性
    public static _CurrTabName: string = ""; //当前表名，与该类相关的表名
    public static _KeyFldName: string = ""; //当前表的关键字字段的名称
