...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../TS/FunClass/stuUserLoginInfo.js"], factory);
    }
    ...
    var Main = /** @class */ (function () {
        ...
        */
        Main.SetSessionAsync = function (Key, Value) {
     ...
     <return>值</return>
    */
        Main.GetSessionAsync = function (Key) {
            return new Promise(function (resolve, reject) {
                $.ajax({
