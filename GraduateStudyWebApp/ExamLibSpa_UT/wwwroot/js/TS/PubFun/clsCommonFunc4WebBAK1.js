(function (factory) {
    ...
    var clsCommonFunc4Web = /** @class */ (function () {
        ...
        */
                ...
                for (var j = 0; j < intColNum; j++) {
                    ...
                    switch (arrDataColumn[j].ColumnType) {
                        ...
                        case "LinkButton":
                            try {
                                var strKeyValue = objEN[strKey];
                                var btn1 = arrDataColumn[j].FuncName(strKeyValue, objEN[arrDataColumn[j].FldName]);
                                td.appendChild(btn1);
                                //var btn1: HTMLButtonElement = document.createElement("Button");
                                //btn1.innerText = arrDataColumn[j].Text;
                                //btn1.className = "btn btn-outline-info";
         ...
         * strKeyId：关键字
         */
        clsCommonFunc4Web.SetCkechedItem4KeyId = function (strKeyId) {
            var strCtrlId = "chk" + strKeyId;
            var chk4KeyId = document.getElementById(strCtrlId);
