(function (factory) {
    ...
    var stuRoleMenuByRoleIdsPara = /** @class */ (function () {
        function stuRoleMenuByRoleIdsPara() {
            /// <summary>
            /// 工程id
            /// </summary>
            this.QxPrjId = "";
        ...
        stuRoleMenuByRoleIdsPara.GetMapParam = function (objRoleMenuByRoleIdsPara) {
        ...
        return stuRoleMenuByRoleIdsPara;
    }());
