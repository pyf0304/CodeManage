 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCase_Resource_RelDAEx
 表名:PubClassCase_Resource_Rel(01120408)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:31:14
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsPubClassCase_Resource_RelDAEx : clsPubClassCase_Resource_RelDA
{
//以下是属性变量
...
/// </summary>
 public clsPubClassCase_Resource_RelDAEx()
 {
 }
}
}