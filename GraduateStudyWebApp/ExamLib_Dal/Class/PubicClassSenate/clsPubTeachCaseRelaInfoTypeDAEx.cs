 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubTeachCaseRelaInfoTypeDAEx
 表名:PubTeachCaseRelaInfoType(01120510)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:31:58
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsPubTeachCaseRelaInfoTypeDAEx : clsPubTeachCaseRelaInfoTypeDA
{
//以下是属性变量
...
/// </summary>
 public clsPubTeachCaseRelaInfoTypeDAEx()
 {
 }
}
}