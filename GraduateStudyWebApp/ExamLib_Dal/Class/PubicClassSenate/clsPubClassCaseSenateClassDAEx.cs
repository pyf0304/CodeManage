 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubClassCaseSenateClassDAEx
 表名:PubClassCaseSenateClass(01120509)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:31:38
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsPubClassCaseSenateClassDAEx : clsPubClassCaseSenateClassDA
{
//以下是属性变量
...
/// </summary>
 public clsPubClassCaseSenateClassDAEx()
 {
 }
}
}