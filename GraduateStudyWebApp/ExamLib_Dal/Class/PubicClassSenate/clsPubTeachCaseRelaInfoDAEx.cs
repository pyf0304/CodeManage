 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPubTeachCaseRelaInfoDAEx
 表名:PubTeachCaseRelaInfo(01120409)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:31:48
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsPubTeachCaseRelaInfoDAEx : clsPubTeachCaseRelaInfoDA
{
//以下是属性变量
...
/// </summary>
 public clsPubTeachCaseRelaInfoDAEx()
 {
 }
}
}