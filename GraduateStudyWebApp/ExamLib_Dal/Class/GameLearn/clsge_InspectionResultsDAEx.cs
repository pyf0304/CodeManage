 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_InspectionResultsDAEx
 表名:ge_InspectionResults(01120897)
 生成代码版本:2021.03.13.1
 生成日期:2021/03/16 16:58:41
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsge_InspectionResultsDAEx : clsge_InspectionResultsDA
{
//以下是属性变量
...
/// </summary>
 public clsge_InspectionResultsDAEx()
 {
 }
}
}