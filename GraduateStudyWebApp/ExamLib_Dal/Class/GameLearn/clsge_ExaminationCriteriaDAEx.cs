 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_ExaminationCriteriaDAEx
 表名:ge_ExaminationCriteria(01120898)
 生成代码版本:2021.03.13.1
 生成日期:2021/03/16 16:58:49
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsge_ExaminationCriteriaDAEx : clsge_ExaminationCriteriaDA
{
//以下是属性变量
...
/// </summary>
 public clsge_ExaminationCriteriaDAEx()
 {
 }
}
}