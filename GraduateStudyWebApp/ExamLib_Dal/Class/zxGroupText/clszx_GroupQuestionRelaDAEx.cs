 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_GroupQuestionRelaDAEx
 表名:zx_GroupQuestionRela(01120737)
 生成代码版本:2020.09.09.1
 生成日期:2020/09/15 14:31:39
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_GroupQuestionRelaDAEx : clszx_GroupQuestionRelaDA
{
//以下是属性变量
...
/// </summary>
 public clszx_GroupQuestionRelaDAEx()
 {
 }
}
}