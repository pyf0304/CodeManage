 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachingCaseResCaseDAEx
 表名:TeachingCaseResCase(01120377)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:35:48
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsTeachingCaseResCaseDAEx : clsTeachingCaseResCaseDA
{
//以下是属性变量
...
/// </summary>
 public clsTeachingCaseResCaseDAEx()
 {
 }
}
}