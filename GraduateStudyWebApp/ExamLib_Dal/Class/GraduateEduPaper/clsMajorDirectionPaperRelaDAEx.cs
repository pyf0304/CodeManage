 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMajorDirectionPaperRelaDAEx
 表名:MajorDirectionPaperRela(01120554)
 生成代码版本:2020.06.05.2
 生成日期:2020/06/12 23:25:22
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsMajorDirectionPaperRelaDAEx : clsMajorDirectionPaperRelaDA
{
//以下是属性变量
...
/// </summary>
 public clsMajorDirectionPaperRelaDAEx()
 {
 }
}
}