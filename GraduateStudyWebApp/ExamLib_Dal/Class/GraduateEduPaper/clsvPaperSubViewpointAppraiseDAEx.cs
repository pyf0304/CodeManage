 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvPaperSubViewpointAppraiseDAEx
 表名:vPaperSubViewpointAppraise(01120562)
 生成代码版本:2020.08.04.1
 生成日期:2020/08/06 19:32:23
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvPaperSubViewpointAppraiseDAEx : clsvPaperSubViewpointAppraiseDA
{
//以下是属性变量
...
/// </summary>
 public clsvPaperSubViewpointAppraiseDAEx()
 {
 }
}
}