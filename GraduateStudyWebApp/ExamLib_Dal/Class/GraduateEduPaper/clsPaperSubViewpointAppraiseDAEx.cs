 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPaperSubViewpointAppraiseDAEx
 表名:PaperSubViewpointAppraise(01120561)
 生成代码版本:2020.08.04.1
 生成日期:2020/08/06 19:32:31
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsPaperSubViewpointAppraiseDAEx : clsPaperSubViewpointAppraiseDA
{
//以下是属性变量
...
/// </summary>
 public clsPaperSubViewpointAppraiseDAEx()
 {
 }
}
}