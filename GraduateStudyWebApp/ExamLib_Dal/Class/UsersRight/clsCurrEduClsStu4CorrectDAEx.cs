 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCurrEduClsStu4CorrectDAEx
 表名:CurrEduClsStu4Correct(01120180)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/26 17:15:33
 生成者:pyf
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsCurrEduClsStu4CorrectDAEx : clsCurrEduClsStu4CorrectDA
{
//以下是属性变量
...
/// </summary>
 public clsCurrEduClsStu4CorrectDAEx()
 {
 }
}
}