 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_SysSecurityLevelDAEx
 表名:zx_SysSecurityLevel(01120826)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:59:07
 生成者:pyf
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_SysSecurityLevelDAEx : clszx_SysSecurityLevelDA
{
//以下是属性变量
...
/// </summary>
 public clszx_SysSecurityLevelDAEx()
 {
 }
}
}