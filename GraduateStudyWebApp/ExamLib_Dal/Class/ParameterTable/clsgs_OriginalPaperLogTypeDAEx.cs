 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsgs_OriginalPaperLogTypeDAEx
 表名:gs_OriginalPaperLogType(01120679)
 生成代码版本:2020.06.13.1
 生成日期:2020/06/16 17:10:15
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsgs_OriginalPaperLogTypeDAEx : clsgs_OriginalPaperLogTypeDA
{
//以下是属性变量
...
/// </summary>
 public clsgs_OriginalPaperLogTypeDAEx()
 {
 }
}
}