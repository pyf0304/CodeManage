 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroTeachCaseRelaInfoTypeDAEx
 表名:MicroTeachCaseRelaInfoType(01120317)
 生成代码版本:2021.02.21.1
 生成日期:2021/02/23 19:53:14
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsMicroTeachCaseRelaInfoTypeDAEx : clsMicroTeachCaseRelaInfoTypeDA
{
//以下是属性变量
...
/// </summary>
 public clsMicroTeachCaseRelaInfoTypeDAEx()
 {
 }
}
}