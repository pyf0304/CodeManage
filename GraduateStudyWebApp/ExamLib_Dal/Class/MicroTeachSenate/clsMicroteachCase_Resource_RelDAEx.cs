 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroteachCase_Resource_RelDAEx
 表名:MicroteachCase_Resource_Rel(01120369)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:30:40
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsMicroteachCase_Resource_RelDAEx : clsMicroteachCase_Resource_RelDA
{
//以下是属性变量
...
/// </summary>
 public clsMicroteachCase_Resource_RelDAEx()
 {
 }
}
}