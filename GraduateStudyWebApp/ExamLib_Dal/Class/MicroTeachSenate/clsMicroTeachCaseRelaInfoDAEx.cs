 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsMicroTeachCaseRelaInfoDAEx
 表名:MicroTeachCaseRelaInfo(01120318)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:30:51
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsMicroTeachCaseRelaInfoDAEx : clsMicroTeachCaseRelaInfoDA
{
//以下是属性变量
...
/// </summary>
 public clsMicroTeachCaseRelaInfoDAEx()
 {
 }
}
}