 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsgs_TotalDataStatisticsDAEx
 表名:gs_TotalDataStatistics(01120683)
 生成代码版本:2020.06.21.1
 生成日期:2020/06/23 22:48:09
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsgs_TotalDataStatisticsDAEx : clsgs_TotalDataStatisticsDA
{
//以下是属性变量
...
/// </summary>
 public clsgs_TotalDataStatisticsDAEx()
 {
 }
}
}