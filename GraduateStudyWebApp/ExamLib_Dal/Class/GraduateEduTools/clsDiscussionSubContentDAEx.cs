 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsDiscussionSubContentDAEx
 表名:DiscussionSubContent(01120587)
 生成代码版本:2020.02.19.1
 生成日期:2020/02/20 14:41:30
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsDiscussionSubContentDAEx : clsDiscussionSubContentDA
{
//以下是属性变量
...
/// </summary>
 public clsDiscussionSubContentDAEx()
 {
 }
}
}