 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_TotalDataStatisticsDAEx
 表名:zx_TotalDataStatistics(01120791)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:57:50
 生成者:pyf
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_TotalDataStatisticsDAEx : clszx_TotalDataStatisticsDA
{
//以下是属性变量
...
/// </summary>
 public clszx_TotalDataStatisticsDAEx()
 {
 }
}
}