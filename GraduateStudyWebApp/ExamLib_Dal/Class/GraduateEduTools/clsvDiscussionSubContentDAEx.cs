 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvDiscussionSubContentDAEx
 表名:vDiscussionSubContent(01120585)
 生成代码版本:2020.02.19.1
 生成日期:2020/02/20 14:41:24
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvDiscussionSubContentDAEx : clsvDiscussionSubContentDA
{
//以下是属性变量
...
/// </summary>
 public clsvDiscussionSubContentDAEx()
 {
 }
}
}