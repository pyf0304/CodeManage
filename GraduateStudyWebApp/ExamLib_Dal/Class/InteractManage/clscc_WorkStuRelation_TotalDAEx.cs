 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation_TotalDAEx
 表名:cc_WorkStuRelation_Total(01120167)
 生成代码版本:2021.06.20.1
 生成日期:2021/06/26 15:16:15
 生成者:pyf
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clscc_WorkStuRelation_TotalDAEx : clscc_WorkStuRelation_TotalDA
{
//以下是属性变量
...
/// </summary>
 public clscc_WorkStuRelation_TotalDAEx()
 {
 }
}
}