 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_WorkStuRelation_TotalByQuTypeDAEx
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clscc_WorkStuRelation_TotalByQuTypeDAEx : clscc_WorkStuRelation_TotalByQuTypeDA
{
//以下是属性变量
...
/// </summary>
 public clscc_WorkStuRelation_TotalByQuTypeDAEx()
 {
 }
}
}