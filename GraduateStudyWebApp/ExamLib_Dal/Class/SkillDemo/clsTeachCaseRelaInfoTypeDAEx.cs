 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsTeachCaseRelaInfoTypeDAEx
 表名:TeachCaseRelaInfoType(01120512)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:35:17
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsTeachCaseRelaInfoTypeDAEx : clsTeachCaseRelaInfoTypeDA
{
//以下是属性变量
...
/// </summary>
 public clsTeachCaseRelaInfoTypeDAEx()
 {
 }
}
}