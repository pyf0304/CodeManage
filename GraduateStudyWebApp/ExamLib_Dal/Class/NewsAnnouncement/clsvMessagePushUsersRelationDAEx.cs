 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvMessagePushUsersRelationDAEx
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvMessagePushUsersRelationDAEx : clsvMessagePushUsersRelationDA
{
//以下是属性变量
...
/// </summary>
 public clsvMessagePushUsersRelationDAEx()
 {
 }
}
}