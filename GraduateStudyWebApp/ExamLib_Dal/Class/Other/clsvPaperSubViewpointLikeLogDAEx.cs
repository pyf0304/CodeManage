 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvPaperSubViewpointLikeLogDAEx
 表名:vPaperSubViewpointLikeLog(01120563)
 生成代码版本:2020.08.03.1
 生成日期:2020/08/03 13:48:59
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvPaperSubViewpointLikeLogDAEx : clsvPaperSubViewpointLikeLogDA
{
//以下是属性变量
...
/// </summary>
 public clsvPaperSubViewpointLikeLogDAEx()
 {
 }
}
}