 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsPaperSubViewpointLikeLogDAEx
 表名:PaperSubViewpointLikeLog(01120560)
 生成代码版本:2020.08.04.1
 生成日期:2020/08/06 15:24:25
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsPaperSubViewpointLikeLogDAEx : clsPaperSubViewpointLikeLogDA
{
//以下是属性变量
...
/// </summary>
 public clsPaperSubViewpointLikeLogDAEx()
 {
 }
}
}