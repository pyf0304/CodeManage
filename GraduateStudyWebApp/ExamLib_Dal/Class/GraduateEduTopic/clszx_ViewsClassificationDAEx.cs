 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_ViewsClassificationDAEx
 表名:zx_ViewsClassification(01120806)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:58:23
 生成者:pyf
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_ViewsClassificationDAEx : clszx_ViewsClassificationDA
{
//以下是属性变量
...
/// </summary>
 public clszx_ViewsClassificationDAEx()
 {
 }
}
}