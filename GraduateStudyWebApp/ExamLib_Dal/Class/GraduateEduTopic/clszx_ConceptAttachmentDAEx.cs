 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_ConceptAttachmentDAEx
 表名:zx_ConceptAttachment(01120864)
 生成代码版本:2021.06.06.1
 生成日期:2021/06/14 23:58:37
 生成者:pyf
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_ConceptAttachmentDAEx : clszx_ConceptAttachmentDA
{
//以下是属性变量
...
/// </summary>
 public clszx_ConceptAttachmentDAEx()
 {
 }
}
}