 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvObjectiveAttachmentDAEx
 表名:vObjectiveAttachment(01120618)
 生成代码版本:2020.06.17.1
 生成日期:2020/06/18 18:54:43
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvObjectiveAttachmentDAEx : clsvObjectiveAttachmentDA
{
//以下是属性变量
...
/// </summary>
 public clsvObjectiveAttachmentDAEx()
 {
 }
}
}