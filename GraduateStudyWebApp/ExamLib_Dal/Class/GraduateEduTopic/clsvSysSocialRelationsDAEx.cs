 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvSysSocialRelationsDAEx
 表名:vSysSocialRelations(01120654)
 生成代码版本:2020.06.27.2
 生成日期:2020/06/30 16:02:17
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvSysSocialRelationsDAEx : clsvSysSocialRelationsDA
{
//以下是属性变量
...
/// </summary>
 public clsvSysSocialRelationsDAEx()
 {
 }
}
}