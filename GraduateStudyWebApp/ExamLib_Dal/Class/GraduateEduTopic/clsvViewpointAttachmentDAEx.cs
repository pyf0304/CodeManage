 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvViewpointAttachmentDAEx
 表名:vViewpointAttachment(01120593)
 生成代码版本:2020.08.03.1
 生成日期:2020/08/03 13:54:00
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvViewpointAttachmentDAEx : clsvViewpointAttachmentDA
{
//以下是属性变量
...
/// </summary>
 public clsvViewpointAttachmentDAEx()
 {
 }
}
}