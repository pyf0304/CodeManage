 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsRTTopicObjectiveRelaDAEx
 表名:RTTopicObjectiveRela(01120615)
 生成代码版本:2020.06.05.2
 生成日期:2020/06/12 23:26:30
 生成者:
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsRTTopicObjectiveRelaDAEx : clsRTTopicObjectiveRelaDA
{
//以下是属性变量
...
/// </summary>
 public clsRTTopicObjectiveRelaDAEx()
 {
 }
}
}