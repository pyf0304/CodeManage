 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_KnowledgesUserMasterDAEx
 表名:ge_KnowledgesUserMaster(01120892)
 生成代码版本:2021.03.10.1
 生成日期:2021/03/11 14:20:55
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsge_KnowledgesUserMasterDAEx : clsge_KnowledgesUserMasterDA
{
//以下是属性变量
...
/// </summary>
 public clsge_KnowledgesUserMasterDAEx()
 {
 }
}
}