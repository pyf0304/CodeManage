 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_PapersBigTopicDefaultDAEx
 表名:cc_PapersBigTopicDefault(01120088)
 生成代码版本:2022.11.19.1
 生成日期:2022/11/19 12:05:26
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clscc_PapersBigTopicDefaultDAEx : clscc_PapersBigTopicDefaultDA
{
//以下是属性变量
...
/// </summary>
 public clscc_PapersBigTopicDefaultDAEx()
 {
 }
}
}