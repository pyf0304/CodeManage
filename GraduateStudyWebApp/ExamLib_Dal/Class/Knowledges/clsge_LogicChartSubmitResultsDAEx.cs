 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsge_LogicChartSubmitResultsDAEx
 表名:ge_LogicChartSubmitResults(01120912)
 生成代码版本:2021.03.30.1
 生成日期:2021/04/03 19:01:00
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsge_LogicChartSubmitResultsDAEx : clsge_LogicChartSubmitResultsDA
{
//以下是属性变量
...
/// </summary>
 public clsge_LogicChartSubmitResultsDAEx()
 {
 }
}
}