 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_CourseExamPaperRelationshipDAEx
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvcc_CourseExamPaperRelationshipDAEx : clsvcc_CourseExamPaperRelationshipDA
{
//以下是属性变量
...
/// </summary>
 public clsvcc_CourseExamPaperRelationshipDAEx()
 {
 }
}
}