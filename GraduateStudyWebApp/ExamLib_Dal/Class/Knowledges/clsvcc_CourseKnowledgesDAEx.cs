 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvcc_CourseKnowledgesDAEx
 表名:vcc_CourseKnowledges(01120141)
 生成代码版本:2020.09.24.1
 生成日期:2020/09/28 14:50:49
 生成者:pyf2
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvcc_CourseKnowledgesDAEx : clsvcc_CourseKnowledgesDA
{
//以下是属性变量
...
/// </summary>
 public clsvcc_CourseKnowledgesDAEx()
 {
 }
}
}