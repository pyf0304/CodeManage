 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseExamPaperUserLogDAEx
 表名:cc_CourseExamPaperUserLog(01120090)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:24:44
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clscc_CourseExamPaperUserLogDAEx : clscc_CourseExamPaperUserLogDA
{
//以下是属性变量
...
/// </summary>
 public clscc_CourseExamPaperUserLogDAEx()
 {
 }
}
}