 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_SocialRelationsVerDAEx
 表名:zx_SocialRelationsVer(01120739)
 * 版本:2023.01.12.1(服务器:WIN-SRV103-116)
 日期:2023/01/12 15:22:13
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_SocialRelationsVerDAEx : clszx_SocialRelationsVerDA
{
//以下是属性变量
...
/// </summary>
 public clszx_SocialRelationsVerDAEx()
 {
 }
}
}