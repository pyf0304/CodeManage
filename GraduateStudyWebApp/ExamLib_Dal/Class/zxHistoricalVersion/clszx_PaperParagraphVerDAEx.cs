 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clszx_PaperParagraphVerDAEx
 表名:zx_PaperParagraphVer(01120760)
 * 版本:2023.01.12.1(服务器:WIN-SRV103-116)
 日期:2023/01/12 15:18:48
 生成者:pyf
 生成服务器IP:
 工程名称:问卷调查(0112)
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clszx_PaperParagraphVerDAEx : clszx_PaperParagraphVerDA
{
//以下是属性变量
...
/// </summary>
 public clszx_PaperParagraphVerDAEx()
 {
 }
}
}