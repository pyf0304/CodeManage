 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clscc_CourseStudentRelationDAEx
 表名:cc_CourseStudentRelation(01120150)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 17:25:05
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clscc_CourseStudentRelationDAEx : clscc_CourseStudentRelationDA
{
//以下是属性变量
...
/// </summary>
 public clscc_CourseStudentRelationDAEx()
 {
 }
}
}