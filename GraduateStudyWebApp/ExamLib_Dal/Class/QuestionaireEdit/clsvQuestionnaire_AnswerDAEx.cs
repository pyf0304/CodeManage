 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQuestionnaire_AnswerDAEx
 表名:vQuestionnaire_Answer(01120020)
 生成代码版本:2021.02.03.1
 生成日期:2021/02/08 18:51:20
 生成者:yy
...
namespace ExamLib.DAL
{
 ...
 /// </summary>
public class clsvQuestionnaire_AnswerDAEx : clsvQuestionnaire_AnswerDA
{
//以下是属性变量
...
/// </summary>
 public clsvQuestionnaire_AnswerDAEx()
 {
 }
}
}